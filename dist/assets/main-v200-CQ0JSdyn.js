const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-CW5N0gRm.js","assets/design-v200-DEQapkAn.js","assets/design-v200-DNcr1aav.css"])))=>i.map(i=>d[i]);
import{r as o,a as ft,j as e,s as y,i as Vn,R as os}from"./design-v200-DEQapkAn.js";const ls="modulepreload",cs=function(t){return"/"+t},Tn={},Ht=function(n,r,a){let d=Promise.resolve();if(r&&r.length>0){let m=function(x){return Promise.all(x.map(_=>Promise.resolve(_).then(M=>({status:"fulfilled",value:M}),M=>({status:"rejected",reason:M}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),I=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));d=m(r.map(x=>{if(x=cs(x),x in Tn)return;Tn[x]=!0;const _=x.endsWith(".css"),M=_?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${x}"]${M}`))return;const P=document.createElement("link");if(P.rel=_?"stylesheet":ls,_||(P.as="script"),P.crossOrigin="",P.href=x,I&&P.setAttribute("nonce",I),document.head.appendChild(P),_)return new Promise((W,T)=>{P.addEventListener("load",W),P.addEventListener("error",()=>T(new Error(`Unable to preload CSS for ${x}`)))})}))}function p(m){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=m,window.dispatchEvent(u),!u.defaultPrevented)throw m}return d.then(m=>{for(const u of m||[])u.status==="rejected"&&p(u.reason);return n().catch(p)})},ds=`# undefined
...
---
### 🔄 INSTRUCTION DE FUSION (Pour l'Orchestrateur API)
*Lorsque l'utilisateur sélectionnera ce pack "Audio" dans l'interface de Tiger IA, tu dois fusionner ces 10 capacités avec la demande précise du chat. Par exemple, si l'utilisateur demande "Crée moi un clone de Spotify", tu dois immédiatement mobiliser les modules \`prd_audio_file_library\`, \`prd_audio_player_podcast\` et \`prd_audio_mix_playlist\` pour générer une architecture complète en un seul shot.*`,ms=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/commerce/pages/SuccessPage.tsx\``,fs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/components/ui/Toast.tsx\``,bs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/creator/components/SocialLinkButton.tsx\``,vs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/handoff/components/RedlineViewer.tsx\``,Ss=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/shop/contexts/CartContext.tsx\``,_s=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- src/shared/constants/products.ts (données mock)`,Cs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/events/components/TicketingCard.tsx\``,Is=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/feed/hooks/useInfiniteFeed.ts\``,ws=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`/requirements.txt\` & \`/package.json\` (Gestion des dépendances isolées)`,As=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/components/inputs/CreditCardInput.tsx\``,Ps=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/forms/schemas/registrationSchema.ts\``,Ts=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/gamification/components/BadgeGrid.tsx\``,js=`# APK Forge — Intelligent Android Packaging Suite
...
---
`,ks=`# Industrialisation_Backend_KIROV5
...
## Instructions Originales
`,Rs=`# BRIC — Sovereign PRD Specification Pack
...
`,Es=`# bricbrac — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Ds=`# bros — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Ns=`# BROSS — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Ms=`# Industrialisation_Backend_Phase5
...
MIT`,qs=`# COLORFUL LANDING PAGE BUILDER
...
## License
MIT`,Us=`# CyberRunner — Sovereign PRD Specification Pack
...
src/
  ...
  main.tsx
  index.css
\`\`\``,Bs=`# gametetris — Sovereign PRD Specification Pack
...
MIT`,Ws=`# mariob — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Js=`# 🚀 Pack PRD : Calculatrice Premium "One-Shot" (guest_nebula_calc)
...
Chaque composant doit être entièrement fonctionnel, avec des props typées, et utiliser les hooks appropriés. Le code doit être propre, commenté et suivre les meilleures pratiques React/TypeScript.`,Qs=`> **Directive Système IA** : Tu es un Architecte Logiciel Senior et Expert en Product Design. Génère des composants React/TypeScript de haute qualité pour le jeu **NEONSTACK ARCADE**. Suis les directives du PRD, respecte le design system, et produis du code fonctionnel et esthétique.
...
src/
  ...
  App.tsx
  main.tsx
\`\`\``,Zs=`# plateforme — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Ys=`# plateformv2 — Sovereign PRD Specification Pack
...
src/
  ...
  App.tsx
  main.tsx
\`\`\``,tr=`# PRODUCTION READY INDUSTRIALIZATION
...
## Instructions Originales
`,rr=`# SOVEREIGN PRODUCTION PLATFORM
...
- \`src/features/health/components/BreathingCircle.tsx\``,xr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/utils/audioContext.ts\``,fr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/images/hooks/useImageUpload.ts\``,br=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/admin/components/EmptyState.tsx\``,vr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/game/types/engine.ts\``,Sr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/saas-landing/components/ProductMockup.tsx\``,_r=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/layouts/KanbanLayout.tsx\``,Cr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/maps/hooks/useGeolocation.ts\``,Ir=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/markdown/components/TableOfContents.tsx\``,wr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/marketing/components/LeadCaptureForm.tsx\``,Ar=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/mobile/components/SwipeActionContainer.tsx\``,Pr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/shell/components/BottomSheet.tsx\``,Tr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/mobile/components/SwipeableOnboarding.tsx\``,jr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/api/apiClient.ts\` (Interface qui tape sur les mocks pour l'instant)`,kr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/documents/components/ThumbnailSidebar.tsx\``,Rr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/hooks/useFileUpload.ts\``,Er=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/ai.ts\` (interfaces Message, ChatSession, Attachment)`,Dr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/voice/components/MicrophoneToggle.tsx\``,Nr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/auth/hooks/useSession.ts\``,Mr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/magazine/components/AuthorByline.tsx\``,Lr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/crm.ts\` (interfaces Contact, Activity, Tag)`,qr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/catalog/hooks/useCatalogFilters.ts\``,Ur=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/checkout/components/ExpressPayButtons.tsx\``,Or=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
`,Fr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/leaderboard/components/StickyUserRank.tsx\``,Gr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/dashboard/pages/BentoDashboardPage.tsx\``,Vr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/kanban/hooks/useKanbanBoard.ts\``,Br=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/social/components/LikeAnimation.tsx\``,Hr=`# bricbrac — Sovereign PRD Specification Pack
...
- \`src/features/billing/components/InvoiceTable.tsx\``,$r=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/saas.ts\` (interfaces User, Tenant, Subscription)`,Wr=`# 🏛️ Pack PRD : Sovereign Full-Stack Engine
...
`,Jr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/specs/components/DynamicForm.tsx\``,Xr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/utils/timeFormat.ts\``,Zr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/marketing/components/RoadmapBoard.tsx\``,Yr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/ai-studio/components/TokenCostChart.tsx\``,ei=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/saas/pages/BillingDashboard.tsx\``,ti=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/landing/components/ConversionSection.tsx\``,ni=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/database/components/ResultDataTable.tsx\``,si=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/stealth/ui/FloatingGhostMenu.tsx\``,ri=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/editor/hooks/useEditorState.ts\``,ii=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/blog/components/TableOfContents.tsx\``,li=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/widgets/hooks/useCalendarState.ts\``;function jn(t,n){(n==null||n>t.length)&&(n=t.length);for(var r=0,a=Array(n);r<n;r++)a[r]=t[r];return a}function ci(t){if(Array.isArray(t))return t}function di(t,n,r){return(n=fi(n))in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function ui(t,n){var r=t==null?null:typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(r!=null){var a,d,p,m,u=[],I=!0,x=!1;try{if(p=(r=r.call(t)).next,n!==0)for(;!(I=(a=p.call(r)).done)&&(u.push(a.value),u.length!==n);I=!0);}catch(_){x=!0,d=_}finally{try{if(!I&&r.return!=null&&(m=r.return(),Object(m)!==m))return}finally{if(x)throw d}}return u}}function pi(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function kn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(t);n&&(a=a.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,a)}return r}function Rn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?kn(Object(r),!0).forEach(function(a){di(t,a,r[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):kn(Object(r)).forEach(function(a){Object.defineProperty(t,a,Object.getOwnPropertyDescriptor(r,a))})}return t}function mi(t,n){if(t==null)return{};var r,a,d=gi(t,n);if(Object.getOwnPropertySymbols){var p=Object.getOwnPropertySymbols(t);for(a=0;a<p.length;a++)r=p[a],n.indexOf(r)===-1&&{}.propertyIsEnumerable.call(t,r)&&(d[r]=t[r])}return d}function gi(t,n){if(t==null)return{};var r={};for(var a in t)if({}.hasOwnProperty.call(t,a)){if(n.indexOf(a)!==-1)continue;r[a]=t[a]}return r}function hi(t,n){return ci(t)||ui(t,n)||bi(t,n)||pi()}function xi(t,n){if(typeof t!="object"||!t)return t;var r=t[Symbol.toPrimitive];if(r!==void 0){var a=r.call(t,n);if(typeof a!="object")return a;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}function fi(t){var n=xi(t,"string");return typeof n=="symbol"?n:n+""}function bi(t,n){if(t){if(typeof t=="string")return jn(t,n);var r={}.toString.call(t).slice(8,-1);return r==="Object"&&t.constructor&&(r=t.constructor.name),r==="Map"||r==="Set"?Array.from(t):r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?jn(t,n):void 0}}function vi(t,n,r){return n in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function En(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(t);n&&(a=a.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,a)}return r}function Dn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?En(Object(r),!0).forEach(function(a){vi(t,a,r[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):En(Object(r)).forEach(function(a){Object.defineProperty(t,a,Object.getOwnPropertyDescriptor(r,a))})}return t}function Si(){for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r];return function(a){return n.reduceRight(function(d,p){return p(d)},a)}}function Bt(t){return function n(){for(var r=this,a=arguments.length,d=new Array(a),p=0;p<a;p++)d[p]=arguments[p];return d.length>=t.length?t.apply(this,d):function(){for(var m=arguments.length,u=new Array(m),I=0;I<m;I++)u[I]=arguments[I];return n.apply(r,[].concat(d,u))}}}function an(t){return{}.toString.call(t).includes("Object")}function yi(t){return!Object.keys(t).length}function Kt(t){return typeof t=="function"}function _i(t,n){return Object.prototype.hasOwnProperty.call(t,n)}function Ci(t,n){return an(n)||lt("changeType"),Object.keys(n).some(function(r){return!_i(t,r)})&&lt("changeField"),n}function Ii(t){Kt(t)||lt("selectorType")}function wi(t){Kt(t)||an(t)||lt("handlerType"),an(t)&&Object.values(t).some(function(n){return!Kt(n)})&&lt("handlersType")}function Ai(t){t||lt("initialIsRequired"),an(t)||lt("initialType"),yi(t)&&lt("initialContent")}function Pi(t,n){throw new Error(t[n]||t.default)}var Ti={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},lt=Bt(Pi)(Ti),nn={changes:Ci,selector:Ii,handler:wi,initial:Ai};function ji(t){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};nn.initial(t),nn.handler(n);var r={current:t},a=Bt(Ei)(r,n),d=Bt(Ri)(r),p=Bt(nn.changes)(t),m=Bt(ki)(r);function u(){var x=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(_){return _};return nn.selector(x),x(r.current)}function I(x){Si(a,d,p,m)(x)}return[u,I]}function ki(t,n){return Kt(n)?n(t.current):n}function Ri(t,n){return t.current=Dn(Dn({},t.current),n),n}function Ei(t,n,r){return Kt(n)?n(t.current):Object.keys(r).forEach(function(a){var d;return(d=n[a])===null||d===void 0?void 0:d.call(n,t.current[a])}),r}var Di={create:ji},Ni={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.55.1/min/vs"}};function Mi(t){return function n(){for(var r=this,a=arguments.length,d=new Array(a),p=0;p<a;p++)d[p]=arguments[p];return d.length>=t.length?t.apply(this,d):function(){for(var m=arguments.length,u=new Array(m),I=0;I<m;I++)u[I]=arguments[I];return n.apply(r,[].concat(d,u))}}}function Li(t){return{}.toString.call(t).includes("Object")}function qi(t){return t||Nn("configIsRequired"),Li(t)||Nn("configType"),t.urls?(Ui(),{paths:{vs:t.urls.monacoBase}}):t}function Ui(){console.warn(Bn.deprecation)}function Oi(t,n){throw new Error(t[n]||t.default)}var Bn={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},Nn=Mi(Oi)(Bn),Fi={config:qi},Gi=function(){for(var n=arguments.length,r=new Array(n),a=0;a<n;a++)r[a]=arguments[a];return function(d){return r.reduceRight(function(p,m){return m(p)},d)}};function zn(t,n){return Object.keys(n).forEach(function(r){n[r]instanceof Object&&t[r]&&Object.assign(n[r],zn(t[r],n[r]))}),Rn(Rn({},t),n)}var Vi={type:"cancelation",msg:"operation is manually canceled"};function mn(t){var n=!1,r=new Promise(function(a,d){t.then(function(p){return n?d(Vi):a(p)}),t.catch(d)});return r.cancel=function(){return n=!0},r}var Bi=["monaco"],zi=Di.create({config:Ni,isInitialized:!1,resolve:null,reject:null,monaco:null}),Hn=hi(zi,2),$t=Hn[0],ln=Hn[1];function Hi(t){var n=Fi.config(t),r=n.monaco,a=mi(n,Bi);ln(function(d){return{config:zn(d.config,a),monaco:r}})}function Ki(){var t=$t(function(n){var r=n.monaco,a=n.isInitialized,d=n.resolve;return{monaco:r,isInitialized:a,resolve:d}});if(!t.isInitialized){if(ln({isInitialized:!0}),t.monaco)return t.resolve(t.monaco),mn(gn);if(window.monaco&&window.monaco.editor)return Kn(window.monaco),t.resolve(window.monaco),mn(gn);Gi($i,Ji)(Xi)}return mn(gn)}function $i(t){return document.body.appendChild(t)}function Wi(t){var n=document.createElement("script");return t&&(n.src=t),n}function Ji(t){var n=$t(function(a){var d=a.config,p=a.reject;return{config:d,reject:p}}),r=Wi("".concat(n.config.paths.vs,"/loader.js"));return r.onload=function(){return t()},r.onerror=n.reject,r}function Xi(){var t=$t(function(r){var a=r.config,d=r.resolve,p=r.reject;return{config:a,resolve:d,reject:p}}),n=window.require;n.config(t.config),n(["vs/editor/editor.main"],function(r){var a=r.m||r;Kn(a),t.resolve(a)},function(r){t.reject(r)})}function Kn(t){$t().monaco||ln({monaco:t})}function Qi(){return $t(function(t){var n=t.monaco;return n})}var gn=new Promise(function(t,n){return ln({resolve:t,reject:n})}),$n={config:Hi,init:Ki,__getMonacoInstance:Qi},Zi={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},hn=Zi,Yi={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},ea=Yi;function ta({children:t}){return ft.createElement("div",{style:ea.container},t)}var na=ta,sa=na;function ra({width:t,height:n,isEditorReady:r,loading:a,_ref:d,className:p,wrapperProps:m}){return ft.createElement("section",{style:{...hn.wrapper,width:t,height:n},...m},!r&&ft.createElement(sa,null,a),ft.createElement("div",{ref:d,style:{...hn.fullWidth,...!r&&hn.hide},className:p}))}var ia=ra,Wn=o.memo(ia);function aa(t){o.useEffect(t,[])}var Jn=aa;function oa(t,n,r=!0){let a=o.useRef(!0);o.useEffect(a.current||!r?()=>{a.current=!1}:t,n)}var Me=oa;function zt(){}function At(t,n,r,a){return la(t,a)||ca(t,n,r,a)}function la(t,n){return t.editor.getModel(Xn(t,n))}function ca(t,n,r,a){return t.editor.createModel(n,r,a?Xn(t,a):void 0)}function Xn(t,n){return t.Uri.parse(n)}function da({original:t,modified:n,language:r,originalLanguage:a,modifiedLanguage:d,originalModelPath:p,modifiedModelPath:m,keepCurrentOriginalModel:u=!1,keepCurrentModifiedModel:I=!1,theme:x="light",loading:_="Loading...",options:M={},height:P="100%",width:W="100%",className:T,wrapperProps:L={},beforeMount:F=zt,onMount:S=zt}){let[A,J]=o.useState(!1),[b,U]=o.useState(!0),X=o.useRef(null),N=o.useRef(null),q=o.useRef(null),Q=o.useRef(S),G=o.useRef(F),te=o.useRef(!1);Jn(()=>{let D=$n.init();return D.then(E=>(N.current=E)&&U(!1)).catch(E=>(E==null?void 0:E.type)!=="cancelation"&&console.error("Monaco initialization: error:",E)),()=>X.current?pe():D.cancel()}),Me(()=>{if(X.current&&N.current){let D=X.current.getOriginalEditor(),E=At(N.current,t||"",a||r||"text",p||"");E!==D.getModel()&&D.setModel(E)}},[p],A),Me(()=>{if(X.current&&N.current){let D=X.current.getModifiedEditor(),E=At(N.current,n||"",d||r||"text",m||"");E!==D.getModel()&&D.setModel(E)}},[m],A),Me(()=>{let D=X.current.getModifiedEditor();D.getOption(N.current.editor.EditorOption.readOnly)?D.setValue(n||""):n!==D.getValue()&&(D.executeEdits("",[{range:D.getModel().getFullModelRange(),text:n||"",forceMoveMarkers:!0}]),D.pushUndoStop())},[n],A),Me(()=>{var D,E;(E=(D=X.current)==null?void 0:D.getModel())==null||E.original.setValue(t||"")},[t],A),Me(()=>{let{original:D,modified:E}=X.current.getModel();N.current.editor.setModelLanguage(D,a||r||"text"),N.current.editor.setModelLanguage(E,d||r||"text")},[r,a,d],A),Me(()=>{var D;(D=N.current)==null||D.editor.setTheme(x)},[x],A),Me(()=>{var D;(D=X.current)==null||D.updateOptions(M)},[M],A);let B=o.useCallback(()=>{var me;if(!N.current)return;G.current(N.current);let D=At(N.current,t||"",a||r||"text",p||""),E=At(N.current,n||"",d||r||"text",m||"");(me=X.current)==null||me.setModel({original:D,modified:E})},[r,n,d,t,a,p,m]),re=o.useCallback(()=>{var D;!te.current&&q.current&&(X.current=N.current.editor.createDiffEditor(q.current,{automaticLayout:!0,...M}),B(),(D=N.current)==null||D.editor.setTheme(x),J(!0),te.current=!0)},[M,x,B]);o.useEffect(()=>{A&&Q.current(X.current,N.current)},[A]),o.useEffect(()=>{!b&&!A&&re()},[b,A,re]);function pe(){var E,me,ge,xe;let D=(E=X.current)==null?void 0:E.getModel();u||((me=D==null?void 0:D.original)==null||me.dispose()),I||((ge=D==null?void 0:D.modified)==null||ge.dispose()),(xe=X.current)==null||xe.dispose()}return ft.createElement(Wn,{width:W,height:P,isEditorReady:A,loading:_,_ref:q,className:T,wrapperProps:L})}var ua=da;o.memo(ua);function pa(t){let n=o.useRef();return o.useEffect(()=>{n.current=t},[t]),n.current}var ma=pa,sn=new Map;function ga({defaultValue:t,defaultLanguage:n,defaultPath:r,value:a,language:d,path:p,theme:m="light",line:u,loading:I="Loading...",options:x={},overrideServices:_={},saveViewState:M=!0,keepCurrentModel:P=!1,width:W="100%",height:T="100%",className:L,wrapperProps:F={},beforeMount:S=zt,onMount:A=zt,onChange:J,onValidate:b=zt}){let[U,X]=o.useState(!1),[N,q]=o.useState(!0),Q=o.useRef(null),G=o.useRef(null),te=o.useRef(null),B=o.useRef(A),re=o.useRef(S),pe=o.useRef(),D=o.useRef(a),E=ma(p),me=o.useRef(!1),ge=o.useRef(!1);Jn(()=>{let z=$n.init();return z.then($=>(Q.current=$)&&q(!1)).catch($=>($==null?void 0:$.type)!=="cancelation"&&console.error("Monaco initialization: error:",$)),()=>G.current?ce():z.cancel()}),Me(()=>{var $,C,Z,ne;let z=At(Q.current,t||a||"",n||d||"",p||r||"");z!==(($=G.current)==null?void 0:$.getModel())&&(M&&sn.set(E,(C=G.current)==null?void 0:C.saveViewState()),(Z=G.current)==null||Z.setModel(z),M&&((ne=G.current)==null||ne.restoreViewState(sn.get(p))))},[p],U),Me(()=>{var z;(z=G.current)==null||z.updateOptions(x)},[x],U),Me(()=>{!G.current||a===void 0||(G.current.getOption(Q.current.editor.EditorOption.readOnly)?G.current.setValue(a):a!==G.current.getValue()&&(ge.current=!0,G.current.executeEdits("",[{range:G.current.getModel().getFullModelRange(),text:a,forceMoveMarkers:!0}]),G.current.pushUndoStop(),ge.current=!1))},[a],U),Me(()=>{var $,C;let z=($=G.current)==null?void 0:$.getModel();z&&d&&((C=Q.current)==null||C.editor.setModelLanguage(z,d))},[d],U),Me(()=>{var z;u!==void 0&&((z=G.current)==null||z.revealLine(u))},[u],U),Me(()=>{var z;(z=Q.current)==null||z.editor.setTheme(m)},[m],U);let xe=o.useCallback(()=>{var z;if(!(!te.current||!Q.current)&&!me.current){re.current(Q.current);let $=p||r,C=At(Q.current,a||t||"",n||d||"",$||"");G.current=(z=Q.current)==null?void 0:z.editor.create(te.current,{model:C,automaticLayout:!0,...x},_),M&&G.current.restoreViewState(sn.get($)),Q.current.editor.setTheme(m),u!==void 0&&G.current.revealLine(u),X(!0),me.current=!0}},[t,n,r,a,d,p,x,_,M,m,u]);o.useEffect(()=>{U&&B.current(G.current,Q.current)},[U]),o.useEffect(()=>{!N&&!U&&xe()},[N,U,xe]),D.current=a,o.useEffect(()=>{var z,$;U&&J&&((z=pe.current)==null||z.dispose(),pe.current=($=G.current)==null?void 0:$.onDidChangeModelContent(C=>{ge.current||J(G.current.getValue(),C)}))},[U,J]),o.useEffect(()=>{if(U){let z=Q.current.editor.onDidChangeMarkers($=>{var Z;let C=(Z=G.current.getModel())==null?void 0:Z.uri;if(C&&$.find(ne=>ne.path===C.path)){let ne=Q.current.editor.getModelMarkers({resource:C});b==null||b(ne)}});return()=>{z==null||z.dispose()}}return()=>{}},[U,b]);function ce(){var z,$;(z=pe.current)==null||z.dispose(),P?M&&sn.set(p,G.current.saveViewState()):($=G.current.getModel())==null||$.dispose(),G.current.dispose()}return ft.createElement(Wn,{width:W,height:T,isEditorReady:U,loading:I,_ref:te,className:L,wrapperProps:F})}var ha=ga,xa=o.memo(ha),fa=xa;/*! Capacitor: https://capacitorjs.com/ - MIT License */const ba=t=>{const n=new Map;n.set("web",{name:"web"});const r=t.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:n},a=(p,m)=>{r.platforms.set(p,m)},d=p=>{r.platforms.has(p)&&(r.currentPlatform=r.platforms.get(p))};return r.addPlatform=a,r.setPlatform=d,r},va=t=>t.CapacitorPlatforms=ba(t),Qn=va(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});Qn.addPlatform;Qn.setPlatform;var jt;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(jt||(jt={}));class xn extends Error{constructor(n,r,a){super(n),this.message=n,this.code=r,this.data=a}}const Sa=t=>{var n,r;return t!=null&&t.androidBridge?"android":!((r=(n=t==null?void 0:t.webkit)===null||n===void 0?void 0:n.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},ya=t=>{var n,r,a,d,p;const m=t.CapacitorCustomPlatform||null,u=t.Capacitor||{},I=u.Plugins=u.Plugins||{},x=t.CapacitorPlatforms,_=()=>m!==null?m.name:Sa(t),M=((n=x==null?void 0:x.currentPlatform)===null||n===void 0?void 0:n.getPlatform)||_,P=()=>M()!=="web",W=((r=x==null?void 0:x.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||P,T=N=>{const q=b.get(N);return!!(q!=null&&q.platforms.has(M())||S(N))},L=((a=x==null?void 0:x.currentPlatform)===null||a===void 0?void 0:a.isPluginAvailable)||T,F=N=>{var q;return(q=u.PluginHeaders)===null||q===void 0?void 0:q.find(Q=>Q.name===N)},S=((d=x==null?void 0:x.currentPlatform)===null||d===void 0?void 0:d.getPluginHeader)||F,A=N=>t.console.error(N),J=(N,q,Q)=>Promise.reject(`${Q} does not have an implementation of "${q}".`),b=new Map,U=(N,q={})=>{const Q=b.get(N);if(Q)return console.warn(`Capacitor plugin "${N}" already registered. Cannot register plugins twice.`),Q.proxy;const G=M(),te=S(N);let B;const re=async()=>(!B&&G in q?B=typeof q[G]=="function"?B=await q[G]():B=q[G]:m!==null&&!B&&"web"in q&&(B=typeof q.web=="function"?B=await q.web():B=q.web),B),pe=(ce,z)=>{var $,C;if(te){const Z=te==null?void 0:te.methods.find(ne=>z===ne.name);if(Z)return Z.rtype==="promise"?ne=>u.nativePromise(N,z.toString(),ne):(ne,ve)=>u.nativeCallback(N,z.toString(),ne,ve);if(ce)return($=ce[z])===null||$===void 0?void 0:$.bind(ce)}else{if(ce)return(C=ce[z])===null||C===void 0?void 0:C.bind(ce);throw new xn(`"${N}" plugin is not implemented on ${G}`,jt.Unimplemented)}},D=ce=>{let z;const $=(...C)=>{const Z=re().then(ne=>{const ve=pe(ne,ce);if(ve){const fe=ve(...C);return z=fe==null?void 0:fe.remove,fe}else throw new xn(`"${N}.${ce}()" is not implemented on ${G}`,jt.Unimplemented)});return ce==="addListener"&&(Z.remove=async()=>z()),Z};return $.toString=()=>`${ce.toString()}() { [capacitor code] }`,Object.defineProperty($,"name",{value:ce,writable:!1,configurable:!1}),$},E=D("addListener"),me=D("removeListener"),ge=(ce,z)=>{const $=E({eventName:ce},z),C=async()=>{const ne=await $;me({eventName:ce,callbackId:ne},z)},Z=new Promise(ne=>$.then(()=>ne({remove:C})));return Z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await C()},Z},xe=new Proxy({},{get(ce,z){switch(z){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return te?ge:E;case"removeListener":return me;default:return D(z)}}});return I[N]=xe,b.set(N,{name:N,proxy:xe,platforms:new Set([...Object.keys(q),...te?[G]:[]])}),xe},X=((p=x==null?void 0:x.currentPlatform)===null||p===void 0?void 0:p.registerPlugin)||U;return u.convertFileSrc||(u.convertFileSrc=N=>N),u.getPlatform=M,u.handleError=A,u.isNativePlatform=W,u.isPluginAvailable=L,u.pluginMethodNoop=J,u.registerPlugin=X,u.Exception=xn,u.DEBUG=!!u.DEBUG,u.isLoggingEnabled=!!u.isLoggingEnabled,u.platform=u.getPlatform(),u.isNative=u.isNativePlatform(),u},_a=t=>t.Capacitor=ya(t),kt=_a(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),In=kt.registerPlugin;kt.Plugins;class Zn{constructor(n){this.listeners={},this.retainedEventArguments={},this.windowListeners={},n&&(console.warn(`Capacitor WebPlugin "${n.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=n)}addListener(n,r){let a=!1;this.listeners[n]||(this.listeners[n]=[],a=!0),this.listeners[n].push(r);const p=this.windowListeners[n];p&&!p.registered&&this.addWindowListener(p),a&&this.sendRetainedArgumentsForEvent(n);const m=async()=>this.removeListener(n,r);return Promise.resolve({remove:m})}async removeAllListeners(){this.listeners={};for(const n in this.windowListeners)this.removeWindowListener(this.windowListeners[n]);this.windowListeners={}}notifyListeners(n,r,a){const d=this.listeners[n];if(!d){if(a){let p=this.retainedEventArguments[n];p||(p=[]),p.push(r),this.retainedEventArguments[n]=p}return}d.forEach(p=>p(r))}hasListeners(n){return!!this.listeners[n].length}registerWindowListener(n,r){this.windowListeners[r]={registered:!1,windowEventName:n,pluginEventName:r,handler:a=>{this.notifyListeners(r,a)}}}unimplemented(n="not implemented"){return new kt.Exception(n,jt.Unimplemented)}unavailable(n="not available"){return new kt.Exception(n,jt.Unavailable)}async removeListener(n,r){const a=this.listeners[n];if(!a)return;const d=a.indexOf(r);this.listeners[n].splice(d,1),this.listeners[n].length||this.removeWindowListener(this.windowListeners[n])}addWindowListener(n){window.addEventListener(n.windowEventName,n.handler),n.registered=!0}removeWindowListener(n){n&&(window.removeEventListener(n.windowEventName,n.handler),n.registered=!1)}sendRetainedArgumentsForEvent(n){const r=this.retainedEventArguments[n];r&&(delete this.retainedEventArguments[n],r.forEach(a=>{this.notifyListeners(n,a)}))}}const Mn=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ln=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Ca extends Zn{async getCookies(){const n=document.cookie,r={};return n.split(";").forEach(a=>{if(a.length<=0)return;let[d,p]=a.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");d=Ln(d).trim(),p=Ln(p).trim(),r[d]=p}),r}async setCookie(n){try{const r=Mn(n.key),a=Mn(n.value),d=`; expires=${(n.expires||"").replace("expires=","")}`,p=(n.path||"/").replace("path=",""),m=n.url!=null&&n.url.length>0?`domain=${n.url}`:"";document.cookie=`${r}=${a||""}${d}; path=${p}; ${m};`}catch(r){return Promise.reject(r)}}async deleteCookie(n){try{document.cookie=`${n.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{const n=document.cookie.split(";")||[];for(const r of n)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(n){return Promise.reject(n)}}async clearAllCookies(){try{await this.clearCookies()}catch(n){return Promise.reject(n)}}}In("CapacitorCookies",{web:()=>new Ca});const Ia=async t=>new Promise((n,r)=>{const a=new FileReader;a.onload=()=>{const d=a.result;n(d.indexOf(",")>=0?d.split(",")[1]:d)},a.onerror=d=>r(d),a.readAsDataURL(t)}),wa=(t={})=>{const n=Object.keys(t);return Object.keys(t).map(d=>d.toLocaleLowerCase()).reduce((d,p,m)=>(d[p]=t[n[m]],d),{})},Aa=(t,n=!0)=>t?Object.entries(t).reduce((a,d)=>{const[p,m]=d;let u,I;return Array.isArray(m)?(I="",m.forEach(x=>{u=n?encodeURIComponent(x):x,I+=`${p}=${u}&`}),I.slice(0,-1)):(u=n?encodeURIComponent(m):m,I=`${p}=${u}`),`${a}&${I}`},"").substr(1):null,Pa=(t,n={})=>{const r=Object.assign({method:t.method||"GET",headers:t.headers},n),d=wa(t.headers)["content-type"]||"";if(typeof t.data=="string")r.body=t.data;else if(d.includes("application/x-www-form-urlencoded")){const p=new URLSearchParams;for(const[m,u]of Object.entries(t.data||{}))p.set(m,u);r.body=p.toString()}else if(d.includes("multipart/form-data")||t.data instanceof FormData){const p=new FormData;if(t.data instanceof FormData)t.data.forEach((u,I)=>{p.append(I,u)});else for(const u of Object.keys(t.data))p.append(u,t.data[u]);r.body=p;const m=new Headers(r.headers);m.delete("content-type"),r.headers=m}else(d.includes("application/json")||typeof t.data=="object")&&(r.body=JSON.stringify(t.data));return r};class Ta extends Zn{async request(n){const r=Pa(n,n.webFetchExtra),a=Aa(n.params,n.shouldEncodeUrlParams),d=a?`${n.url}?${a}`:n.url,p=await fetch(d,r),m=p.headers.get("content-type")||"";let{responseType:u="text"}=p.ok?n:{};m.includes("application/json")&&(u="json");let I,x;switch(u){case"arraybuffer":case"blob":x=await p.blob(),I=await Ia(x);break;case"json":I=await p.json();break;case"document":case"text":default:I=await p.text()}const _={};return p.headers.forEach((M,P)=>{_[P]=M}),{data:I,headers:_,status:p.status,url:p.url}}async get(n){return this.request(Object.assign(Object.assign({},n),{method:"GET"}))}async post(n){return this.request(Object.assign(Object.assign({},n),{method:"POST"}))}async put(n){return this.request(Object.assign(Object.assign({},n),{method:"PUT"}))}async patch(n){return this.request(Object.assign(Object.assign({},n),{method:"PATCH"}))}async delete(n){return this.request(Object.assign(Object.assign({},n),{method:"DELETE"}))}}In("CapacitorHttp",{web:()=>new Ta});var on;(function(t){t.Documents="DOCUMENTS",t.Data="DATA",t.Library="LIBRARY",t.Cache="CACHE",t.External="EXTERNAL",t.ExternalStorage="EXTERNAL_STORAGE"})(on||(on={}));var vn;(function(t){t.UTF8="utf8",t.ASCII="ascii",t.UTF16="utf16"})(vn||(vn={}));const qn=In("Filesystem",{web:()=>Ht(()=>import("./web-v200-CW5N0gRm.js"),__vite__mapDeps([0,1,2])).then(t=>new t.FilesystemWeb)});/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ja=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),Yn=(...t)=>t.filter((n,r,a)=>!!n&&a.indexOf(n)===r).join(" ");/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ra=o.forwardRef(({color:t="currentColor",size:n=24,strokeWidth:r=2,absoluteStrokeWidth:a,className:d="",children:p,iconNode:m,...u},I)=>o.createElement("svg",{ref:I,...ka,width:n,height:n,stroke:t,strokeWidth:a?Number(r)*24/Number(n):r,className:Yn("lucide",d),...u},[...m.map(([x,_])=>o.createElement(x,_)),...Array.isArray(p)?p:[p]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ae=(t,n)=>{const r=o.forwardRef(({className:a,...d},p)=>o.createElement(Ra,{ref:p,iconNode:n,className:Yn(`lucide-${ja(t)}`,a),...d}));return r.displayName=`${t}`,r};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const fn=ae("Ban",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m4.9 4.9 14.2 14.2",key:"1m5liu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const es=ae("Box",[["path",{d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z",key:"hh9hay"}],["path",{d:"m3.3 7 8.7 5 8.7-5",key:"g66t2b"}],["path",{d:"M12 22V12",key:"d0xqtd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Da=ae("ChevronDown",[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Na=ae("ChevronUp",[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ma=ae("CircleHelp",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const La=ae("CircleX",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qa=ae("Component",[["path",{d:"M5.5 8.5 9 12l-3.5 3.5L2 12l3.5-3.5Z",key:"1kciei"}],["path",{d:"m12 2 3.5 3.5L12 9 8.5 5.5 12 2Z",key:"1ome0g"}],["path",{d:"M18.5 8.5 22 12l-3.5 3.5L15 12l3.5-3.5Z",key:"vbupec"}],["path",{d:"m12 15 3.5 3.5L12 22l-3.5-3.5L12 15Z",key:"16csic"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Un=ae("Cpu",[["rect",{width:"16",height:"16",x:"4",y:"4",rx:"2",key:"14l7u7"}],["rect",{width:"6",height:"6",x:"9",y:"9",rx:"1",key:"5aljv4"}],["path",{d:"M15 2v2",key:"13l42r"}],["path",{d:"M15 20v2",key:"15mkzm"}],["path",{d:"M2 15h2",key:"1gxd5l"}],["path",{d:"M2 9h2",key:"1bbxkp"}],["path",{d:"M20 15h2",key:"19e6y8"}],["path",{d:"M20 9h2",key:"19tzq7"}],["path",{d:"M9 2v2",key:"165o2o"}],["path",{d:"M9 20v2",key:"i2bqo8"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ua=ae("CreditCard",[["rect",{width:"20",height:"14",x:"2",y:"5",rx:"2",key:"ynyp8z"}],["line",{x1:"2",x2:"22",y1:"10",y2:"10",key:"1b3vmo"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Oa=ae("Database",[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3",key:"msslwz"}],["path",{d:"M3 5V19A9 3 0 0 0 21 19V5",key:"1wlel7"}],["path",{d:"M3 12A9 3 0 0 0 21 12",key:"mv7ke4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fa=ae("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ga=ae("FilePen",[["path",{d:"M12 22h6a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v10",key:"x7tsz2"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10.4 12.6a2 2 0 1 1 3 3L8 21l-4 1 1-4Z",key:"o3xyfb"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Va=ae("FilePlus",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M9 15h6",key:"cctwl0"}],["path",{d:"M12 18v-6",key:"17g6i2"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ba=ae("FileText",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const za=ae("FolderLock",[["rect",{width:"8",height:"5",x:"14",y:"17",rx:"1",key:"19aais"}],["path",{d:"M10 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v2.5",key:"1w6v7t"}],["path",{d:"M20 17v-2a2 2 0 1 0-4 0v2",key:"pwaxnr"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ha=ae("Globe",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20",key:"13o1zl"}],["path",{d:"M2 12h20",key:"9i4pu4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ka=ae("Image",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $a=ae("MessageSquare",[["path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z",key:"1lielz"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wa=ae("Newspaper",[["path",{d:"M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2",key:"7pis2x"}],["path",{d:"M18 14h-8",key:"sponae"}],["path",{d:"M15 18h-5",key:"95g1m2"}],["path",{d:"M10 6h8v4h-8V6Z",key:"smlsk5"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ja=ae("PanelsTopLeft",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}],["path",{d:"M3 9h18",key:"1pudct"}],["path",{d:"M9 21V9",key:"1oto5p"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xa=ae("PenTool",[["path",{d:"M15.707 21.293a1 1 0 0 1-1.414 0l-1.586-1.586a1 1 0 0 1 0-1.414l5.586-5.586a1 1 0 0 1 1.414 0l1.586 1.586a1 1 0 0 1 0 1.414z",key:"nt11vn"}],["path",{d:"m18 13-1.375-6.874a1 1 0 0 0-.746-.776L3.235 2.028a1 1 0 0 0-1.207 1.207L5.35 15.879a1 1 0 0 0 .776.746L13 18",key:"15qc1e"}],["path",{d:"m2.3 2.3 7.286 7.286",key:"1wuzzi"}],["circle",{cx:"11",cy:"11",r:"2",key:"xmgehs"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qa=ae("Rocket",[["path",{d:"M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z",key:"m3kijz"}],["path",{d:"m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z",key:"1fmvmk"}],["path",{d:"M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0",key:"1f8sc4"}],["path",{d:"M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5",key:"qeys4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ns=ae("Server",[["rect",{width:"20",height:"8",x:"2",y:"2",rx:"2",ry:"2",key:"ngkwjq"}],["rect",{width:"20",height:"8",x:"2",y:"14",rx:"2",ry:"2",key:"iecqi9"}],["line",{x1:"6",x2:"6.01",y1:"6",y2:"6",key:"16zg32"}],["line",{x1:"6",x2:"6.01",y1:"18",y2:"18",key:"nzw8ys"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Za=ae("ShieldAlert",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"M12 8v4",key:"1got3b"}],["path",{d:"M12 16h.01",key:"1drbdi"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ya=ae("ShieldCheck",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const eo=ae("ShoppingCart",[["circle",{cx:"8",cy:"21",r:"1",key:"jimo8o"}],["circle",{cx:"19",cy:"21",r:"1",key:"13723u"}],["path",{d:"M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12",key:"9zh506"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const to=ae("Smartphone",[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2",key:"1yt0o3"}],["path",{d:"M12 18h.01",key:"mhygvu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const no=ae("Trophy",[["path",{d:"M6 9H4.5a2.5 2.5 0 0 1 0-5H6",key:"17hqa7"}],["path",{d:"M18 9h1.5a2.5 2.5 0 0 0 0-5H18",key:"lmptdp"}],["path",{d:"M4 22h16",key:"57wxv0"}],["path",{d:"M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22",key:"1nw9bq"}],["path",{d:"M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22",key:"1np0yb"}],["path",{d:"M18 2H6v7a6 6 0 0 0 12 0V2Z",key:"u46fv3"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const so=ae("Video",[["path",{d:"m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5",key:"ftymec"}],["rect",{x:"2",y:"6",width:"14",height:"12",rx:"2",key:"158x01"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const yn=ae("Zap",[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]]),ro=t=>t.includes("auth")||t.includes("stealth")?Ya:t.includes("ecom")||t.includes("commerce")||t.includes("produit")?eo:t.includes("billing")||t.includes("paiement")?Ua:t.includes("layout")||t.includes("interface")?Ja:t.includes("mobile")?to:t.includes("blog")||t.includes("texte")||t.includes("markdown")?Wa:t.includes("game")||t.includes("gamification")?no:t.includes("sqlite")||t.includes("scraper")?Oa:t.includes("image")?Ka:t.includes("video")||t.includes("audio")?so:t.includes("design")||t.includes("createur")?Xa:t.includes("web")||t.includes("saas")||t.includes("landing")?Ha:t.includes("ia_")||t.includes("prompt")?io:t.includes("chat")||t.includes("social")?$a:t.includes("composant")||t.includes("widget")||t.includes("forms")?qa:t.includes("pdf")||t.includes("pieces_jointes")?Ba:t.includes("mock")||t.includes("bridge")||t.includes("engine")?ns:es,io=ns,ao=t=>{const n=["bg-red-500/10 text-red-500","bg-blue-500/10 text-blue-500","bg-emerald-500/10 text-emerald-500","bg-purple-500/10 text-purple-500","bg-orange-500/10 text-orange-500","bg-pink-500/10 text-pink-500","bg-yellow-500/10 text-yellow-500","bg-cyan-500/10 text-cyan-500","bg-indigo-500/10 text-indigo-500","bg-teal-500/10 text-teal-500"];let r=0;for(let a=0;a<t.length;a++)r=t.charCodeAt(a)+((r<<5)-r);return n[Math.abs(r)%n.length]},oo=["app_web_pack","audio_pack","blog_contenu_pack","chat_comms_pack","commerce_paiement_pack","composant_pack","createur_pack","design_figma_xd_pack","diamond_bridge_v14_37","e_commerce_pack","ecommerce_pack","evenement_pack","feed_social_pack","forge_universelle","forms_inputs_pack","formulaire_pack","gamification_pack","health_fitness_pack","ia_pack","image_pack","interface_pack","jeux_video_pack","landing_pack","landing_saas_pack","layout_pack","local_maps_pack","markdown_pack","marketing_pack","mobile_pack","mobile_shell_pack","mobile_web_pack","mock_master","pdf_docs_pack","pieces_jointes_pack","prd_ai_apps_pack","prd_ai_voice_agent","prd_auth_gateway","prd_blog_magazine","prd_crm_erp_pack","prd_ecom_catalog","prd_ecom_checkout","prd_ecom_digital_products","prd_game_leaderboard","prd_layout_bento","prd_layout_kanban","prd_mobile_pack","prd_mobile_social","prd_saas_billing_pro","prd_saas_pack","prd_specs_pack","prd_web_landing_pack","productivity_pack","produit_pack","prompt_skills_pack","saas_pack","specialise_pack","sqlite_inspector","stealth_bridge_v11_2","texte_pack","universal_scraper","video_pack","web_blog_pack","widget_pack","guest_nebula_calc"],Pt=oo.map(t=>({id:t,name:t.replace(/_/g," ").replace(/\b\w/g,n=>n.toUpperCase()),icon:ro(t),color:ao(t)})),lo={low:"text-emerald-400 border-emerald-500/30 bg-emerald-950/20",medium:"text-amber-400   border-amber-500/30   bg-amber-950/20",high:"text-orange-400  border-orange-500/30  bg-orange-950/20",critical:"text-red-400     border-red-500/30     bg-red-950/20"},co={low:e.jsx(ts,{className:"w-3.5 h-3.5"}),medium:e.jsx(Sn,{className:"w-3.5 h-3.5"}),high:e.jsx(Sn,{className:"w-3.5 h-3.5"}),critical:e.jsx(La,{className:"w-3.5 h-3.5"})};function _n({value:t}){const n=Math.round((t??1)*100),r=n>=80?"bg-emerald-500":n>=60?"bg-amber-500":"bg-red-500";return e.jsxs("span",{className:"flex items-center gap-1.5 text-[10px] font-bold text-zinc-400",children:[e.jsx("span",{className:`inline-block w-2 h-2 rounded-full ${r}`}),n,"% confiance"]})}function uo({cap:t}){const[n,r]=o.useState(!1);return e.jsxs("div",{className:"border border-zinc-800 rounded-xl overflow-hidden",children:[e.jsxs("button",{type:"button",className:"w-full flex items-center justify-between px-4 py-2.5 hover:bg-zinc-900/60 transition-colors",onClick:()=>r(a=>!a),children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:`text-xs font-bold px-2 py-0.5 rounded-full ${t.required?"bg-violet-500/20 text-violet-300":"bg-zinc-800 text-zinc-400"}`,children:t.required?"REQUISE":"optionnelle"}),e.jsx("span",{className:"text-sm text-white font-mono",children:t.id})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(_n,{value:t.confidence}),n?e.jsx(Na,{className:"w-3.5 h-3.5 text-zinc-500"}):e.jsx(Da,{className:"w-3.5 h-3.5 text-zinc-500"})]})]}),n&&e.jsxs("div",{className:"px-4 pb-3 pt-1 bg-zinc-950/40 space-y-2",children:[e.jsx("p",{className:"text-xs text-zinc-300",children:t.reason}),t.evidence.length>0&&e.jsx("ul",{className:"space-y-1",children:t.evidence.map((a,d)=>e.jsxs("li",{className:"text-[11px] font-mono text-cyan-400/70",children:["→ ",a]},d))})]})]})}const po=({audit:t,sourceFolder:n,onConfirm:r,onReset:a,isSubmitting:d})=>{const[p,m]=o.useState({}),u=t.requiresUserDecision||[],I=t.risks||[],x=t.capabilities||[],_=t.mocks||[],M=t.decisions||[],P=t.filesToCreate||[],W=t.filesToModify||[],T=t.filesToPreserve||[],L=u.some(b=>b.required&&(!p[b.id]||p[b.id].trim()===""));I.filter(b=>b.level==="critical"||b.level==="high").length;const S=!L&&!d;Math.round((t.confidence||0)*100);const A=t.backendRequired===!1,J=()=>{const b={...t,requiresUserDecision:u.map(U=>({...U,answer:p[U.id]||""}))};r(b)};return e.jsxs("div",{className:"space-y-6 my-8 animate-in fade-in slide-in-from-bottom-4 duration-700",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-8 border border-violet-500/30 bg-violet-950/10 shadow-[0_0_60px_rgba(139,92,246,0.08)]",children:[e.jsx("div",{className:"absolute -top-20 -right-20 w-80 h-80 bg-violet-500/10 rounded-full blur-[100px]"}),e.jsxs("div",{className:"relative z-10",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsxs("span",{className:"flex items-center gap-2 px-4 py-1.5 rounded-full bg-violet-500/10 text-violet-300 border border-violet-500/30 text-xs font-black uppercase tracking-[0.2em]",children:[e.jsx(Un,{className:"w-4 h-4"}),"Phase 5 — Audit Souverain"]}),e.jsx("span",{className:"h-px flex-1 bg-gradient-to-r from-violet-500/40 to-transparent"})]}),e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-4",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-violet-200 to-violet-400 tracking-tight",children:(t.projectType||"PROJET STANDARD").toUpperCase()}),e.jsx("p",{className:"text-sm text-zinc-400 mt-1 font-mono",children:n.split(/[\\/]/).pop()||n})]}),e.jsxs("div",{className:"flex flex-col items-end gap-2",children:[e.jsx(_n,{value:t.confidence}),A?e.jsx("span",{className:"text-xs px-3 py-1 rounded-full bg-zinc-800 text-zinc-400 font-semibold",children:"🟡 Backend non requis"}):e.jsx("span",{className:"text-xs px-3 py-1 rounded-full bg-violet-500/20 text-violet-300 border border-violet-500/30 font-semibold",children:"🔌 Industrialisation complète"})]})]}),A&&e.jsxs("div",{className:"mt-4 p-4 bg-zinc-900/60 border border-zinc-700 rounded-2xl text-sm text-zinc-300",children:[e.jsx("strong",{className:"text-amber-400",children:"⚠️ Ce projet n'a pas besoin de backend."})," ","L'action recommandée est"," ",e.jsx("code",{className:"text-violet-300 bg-zinc-800 px-1.5 py-0.5 rounded text-xs",children:t.phase5Action||"skip_backend_integration"}),". Vous pouvez néanmoins confirmer pour générer le contrat."]})]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"rounded-2xl border border-violet-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-violet-400 mb-4 flex items-center gap-2",children:[e.jsx(yn,{className:"w-4 h-4"})," Capacités détectées (",x.length,")"]}),e.jsx("div",{className:"space-y-2",children:x.length===0?e.jsx("p",{className:"text-xs text-zinc-500",children:"Aucune capacité détectée."}):x.map(b=>e.jsx(uo,{cap:b},b.id))})]}),e.jsxs("div",{className:"rounded-2xl border border-amber-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-amber-400 mb-4 flex items-center gap-2",children:[e.jsx(Za,{className:"w-4 h-4"})," Mocks à remplacer (",_.length,")"]}),_.length===0?e.jsx("p",{className:"text-xs text-zinc-500",children:"Aucun mock détecté."}):e.jsx("ul",{className:"space-y-2",children:_.map(b=>e.jsxs("li",{className:"flex items-start gap-3 p-3 rounded-xl bg-amber-950/10 border border-amber-500/20",children:[e.jsx(Ea,{className:"w-3.5 h-3.5 text-amber-400 mt-0.5 shrink-0"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-mono text-amber-200",children:b.path}),e.jsxs("p",{className:"text-[10px] text-zinc-400",children:[b.pattern," → ",e.jsx("span",{className:"text-violet-300",children:b.capability})]})]})]},b.id))})]})]}),M.length>0&&e.jsxs("div",{className:"rounded-2xl border border-cyan-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-cyan-400 mb-4 flex items-center gap-2",children:[e.jsx(Un,{className:"w-4 h-4"})," Providers recommandés (",M.length,")"]}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-3",children:M.map((b,U)=>e.jsxs("div",{className:"p-3 rounded-xl bg-cyan-950/10 border border-cyan-500/20 space-y-1",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-xs font-bold text-cyan-300 font-mono",children:b.capability}),e.jsx(_n,{value:b.confidence})]}),e.jsx("p",{className:"text-xs text-white font-semibold",children:b.provider||"À déterminer"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed",children:b.reason}),b.requiresConfirmation&&e.jsx("span",{className:"inline-block text-[10px] px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/30",children:"⚠️ Confirmation requise"})]},U))})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:[e.jsxs("div",{className:"rounded-2xl border border-emerald-500/20 bg-emerald-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-emerald-400 mb-3 flex items-center gap-2",children:[e.jsx(Va,{className:"w-3.5 h-3.5"})," À créer (",P.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[P.slice(0,8).map((b,U)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["+ ",b]},U)),P.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",P.length-8," autres…"]})]})]}),e.jsxs("div",{className:"rounded-2xl border border-orange-500/20 bg-orange-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-orange-400 mb-3 flex items-center gap-2",children:[e.jsx(Ga,{className:"w-3.5 h-3.5"})," À modifier (",W.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[W.slice(0,8).map((b,U)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["~ ",b]},U)),W.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",W.length-8," autres…"]})]})]}),e.jsxs("div",{className:"rounded-2xl border border-blue-500/20 bg-blue-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-blue-400 mb-3 flex items-center gap-2",children:[e.jsx(za,{className:"w-3.5 h-3.5"})," Préservés (",T.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[T.slice(0,8).map((b,U)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["🔒 ",b]},U)),T.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",T.length-8," autres…"]})]})]})]}),I.length>0&&e.jsxs("div",{className:"rounded-2xl border border-red-500/20 bg-red-950/5 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-red-400 mb-4 flex items-center gap-2",children:[e.jsx(Sn,{className:"w-4 h-4"})," Risques identifiés (",I.length,")"]}),e.jsx("div",{className:"space-y-2",children:I.map((b,U)=>e.jsxs("div",{className:`flex items-start gap-3 p-3 rounded-xl border ${lo[b.level]}`,children:[co[b.level],e.jsxs("div",{children:[e.jsxs("span",{className:"text-[10px] font-black uppercase tracking-wider opacity-70",children:["[",b.level,"] ",b.code]}),e.jsx("p",{className:"text-xs mt-0.5",children:b.message})]})]},U))})]}),u.length>0&&e.jsxs("div",{className:"rounded-2xl border border-rose-500/40 bg-rose-950/10 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-rose-400 mb-4 flex items-center gap-2",children:[e.jsx(Ma,{className:"w-4 h-4"}),"Décisions utilisateur obligatoires (",u.filter(b=>b.required).length," BLOQUANTE(S))"]}),e.jsx("div",{className:"space-y-3",children:u.map(b=>{const U=!!(p[b.id]&&p[b.id].trim()!==""),X=(b.capability||b.id||"").toLowerCase().replace("-","_"),N={backend:["Node.js / Express","Python / FastAPI","Supabase (BaaS)","Firebase (BaaS)","Aucun (Front-end only)"],auth:["JWT Local personnalisé","Supabase Auth","Firebase Auth","Auth0","Clerk","Aucune authentification"],authentication:["JWT Local personnalisé","Supabase Auth","Firebase Auth","Auth0","Clerk","Aucune authentification"],data_persistence:["PostgreSQL","MongoDB","MySQL / MariaDB","SQLite local","Local Storage (Frontend)"],database:["PostgreSQL","MongoDB","MySQL / MariaDB","SQLite local","Local Storage (Frontend)"],routing:["React Router (SPA)","Next.js App Router","Vite Plugin Pages"],error_handling:["Gestionnaire global classique","Sentry","Winston / Morgan (Backend)"],design:["TailwindCSS natif","Material UI","Chakra UI","CSS Modules","Vanilla CSS"],file_upload:["AWS S3","Supabase Storage","Stockage local (Backend)","Cloudinary"],storage:["AWS S3","Supabase Storage","Stockage local (Backend)","Cloudinary"],ocr_processing:["Google Vision API","AWS Textract","Tesseract.js (Local)","API tierce dédiée"]},q=b.options&&b.options.length>0?b.options:N[X]||[],Q=q.length>0,te=Q&&U&&!q.includes(p[b.id])?"other":p[b.id]||"";return e.jsx("div",{className:`p-4 rounded-xl border transition-colors ${b.required&&!U?"border-rose-500/60 bg-rose-950/30":"border-zinc-700 bg-zinc-900/40"}`,children:e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsxs("div",{className:"flex items-start gap-2",children:[b.required?U?e.jsx(ts,{className:"w-4 h-4 text-emerald-400 shrink-0 mt-0.5"}):e.jsx(fn,{className:"w-4 h-4 text-rose-400 shrink-0 mt-0.5"}):e.jsx(Fa,{className:"w-4 h-4 text-zinc-400 shrink-0 mt-0.5"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-semibold text-white",children:b.question}),e.jsxs("p",{className:"text-[10px] text-zinc-400 mt-0.5",children:["Lié à : ",e.jsx("span",{className:"font-mono text-violet-300",children:b.capability||b.id})]})]})]}),e.jsxs("div",{className:"space-y-2",children:[Q&&e.jsxs("select",{value:te,onChange:B=>{B.target.value==="other"?m(re=>({...re,[b.id]:""})):m(re=>({...re,[b.id]:B.target.value}))},className:"w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-violet-500/50",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionner une réponse --"}),q.map(B=>e.jsx("option",{value:B,children:B},B)),e.jsx("option",{value:"other",children:"Autre (Saisie libre)..."})]}),(!Q||te==="other")&&e.jsx("input",{type:"text",placeholder:"Tapez votre réponse précise ici...",value:p[b.id]||"",onChange:B=>m(re=>({...re,[b.id]:B.target.value})),autoFocus:te==="other",className:"w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white placeholder-zinc-600 focus:outline-none focus:border-violet-500/50"})]})]})},b.id)})}),L&&e.jsxs("p",{className:"mt-4 text-xs text-rose-300 font-semibold bg-rose-950/30 border border-rose-500/30 rounded-xl p-3 flex items-center gap-2",children:[e.jsx(fn,{className:"w-4 h-4"})," La confirmation est bloquée jusqu'à ce que les décisions obligatoires ci-dessus soient résolues."]})]}),e.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-2 border border-violet-500/30 bg-zinc-950/80 backdrop-blur-xl shadow-2xl",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-violet-500/5 via-blue-500/5 to-cyan-500/5 pointer-events-none"}),e.jsxs("div",{className:"relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 p-4",children:[e.jsxs("div",{className:"text-xs text-zinc-400 max-w-sm leading-relaxed",children:[e.jsx("strong",{className:"text-violet-300",children:"La confirmation ne modifie aucun fichier."})," ","Elle envoie uniquement le contrat au moteur Kirov5 qui effectuera les vérifications de sécurité (drift, gates) avant toute mutation."]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("button",{type:"button",onClick:a,disabled:d,className:"px-5 py-3 rounded-2xl font-bold text-xs bg-white/5 hover:bg-white/10 text-zinc-300 border border-white/10 flex items-center gap-2 transition-all hover:scale-105 active:scale-95 disabled:opacity-50",children:"← Ré-auditer"}),e.jsxs("button",{type:"button",onClick:J,disabled:!S,title:L?"Résolvez les décisions obligatoires avant de confirmer":"",className:`px-8 py-3.5 rounded-2xl font-black text-sm flex items-center gap-3 transition-all relative overflow-hidden group
                ${S?"bg-gradient-to-r from-violet-500 to-cyan-500 hover:from-violet-400 hover:to-cyan-400 text-white shadow-[0_0_30px_rgba(139,92,246,0.4)] hover:shadow-[0_0_50px_rgba(139,92,246,0.6)] hover:scale-105 active:scale-95":"bg-zinc-800 text-zinc-500 cursor-not-allowed border border-zinc-700"}`,children:[S&&e.jsx("div",{className:"absolute inset-0 w-full h-full bg-white/10 -translate-x-full group-hover:animate-[shimmer_1.5s_infinite]"}),d?e.jsxs(e.Fragment,{children:[e.jsx(yn,{className:"w-4 h-4 animate-spin"}),"Envoi à Kirov5..."]}):L?e.jsxs(e.Fragment,{children:[e.jsx(fn,{className:"w-4 h-4"}),"Répondez aux questions..."]}):e.jsxs(e.Fragment,{children:[e.jsx(Qa,{className:"w-4 h-4"}),"🚀 Confirmer → Kirov5"]})]})]})]})]})]})},Cn=`Tu es un Architecte Logiciel Senior (Niveau Staff Engineer) spécialisé en Product Design, React/TypeScript, et Architecture d'Applications Web.
...
Réponds UNIQUEMENT avec le JSON demandé.`,mo=Object.freeze(Object.defineProperty({__proto__:null,SYSTEM_PROMPT:Cn},Symbol.toStringTag,{value:"Module"}));function ss(t,n,r,a,d){let p=!1;t&&t.includes("[DESIGN RIP]")&&(p=!0,t=t.replace("[DESIGN RIP]","").trim());let m="";r?m=`
...
Réponds avec le JSON valide uniquement, aucun texte avant ou après.`}const go=Object.freeze(Object.defineProperty({__proto__:null,buildUserPrompt:ss},Symbol.toStringTag,{value:"Module"})),rs="hermes_deepseek_api_key",is="tiger_apiKey";function ho(){try{return localStorage.getItem(rs)||localStorage.getItem(is)||null}catch{return null}}function xo(t){try{const n=t.trim();localStorage.setItem(rs,n),localStorage.setItem(is,n),y("http://localhost:5006/api/config/apikey",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({key:n,apiKey:n,provider:"deepseek"})}).catch(()=>{})}catch{}}async function wn(){const t=ho();if(t&&t.length>5)return t;try{const n=await y("http://localhost:5006/api/config/apikey");if(n&&n.ok){const r=await n.json();if((r.hasKey||r.hasAnyKey||r.configured)&&r.apiKey)return xo(r.apiKey),r.apiKey}}catch{}return null}const bn={},fo={QWEN_CODER_32B:"@cf/qwen/qwen2.5-coder-32b-instruct"},bo=(bn==null?void 0:bn.VITE_HERMES_WORKER_URL)||"https://kirov-worker.v0reponses.workers.dev";async function as(t,n,r){var M,P,W,T,L,F,S,A,J,b,U,X,N;const a=(r==null?void 0:r.model)||fo.QWEN_CODER_32B,d=(r==null?void 0:r.maxTokens)??8192,p=(r==null?void 0:r.temperature)??.3;let m,u;const I=2;for(let q=1;q<=I+1;q++){const Q=new AbortController,G=setTimeout(()=>Q.abort(),12e4);try{console.log(`[Hermes-CF] Appel Worker Kirov (Tentative ${q}/${I+1})...`);const te=typeof window<"u"&&localStorage.getItem("kirov5_jwt_token")||"";if(m=await fetch(`${bo}/api/hermes`,{method:"POST",headers:{"Content-Type":"application/json",...te?{Authorization:`Bearer ${te}`}:{}},signal:Q.signal,body:JSON.stringify({model:a,messages:[{role:"system",content:t},{role:"user",content:n}],max_tokens:d,temperature:p})}),clearTimeout(G),!m.ok){const B=await m.text().catch(()=>"");throw m.status===403?new Error("Hermes Worker — Modele non disponible sur plan Free (403)."):m.status===429?new Error("Hermes Worker — Quota 10 000 Neurons/jour atteint. Reset a 00:00 UTC."):m.status===500||m.status===502||m.status===503||m.status===504?new Error(`Erreur transitoire ${m.status}: ${B.slice(0,300)}`):new Error(`Hermes Worker — Erreur ${m.status}: ${B.slice(0,300)}`)}break}catch(te){clearTimeout(G);let B=te.message;if(te.name==="AbortError"&&(B="Hermes Worker — Timeout local (120s) atteint."),u=new Error(B),B.includes("Modele non disponible")||B.includes("Quota 10 000"))throw u;if(q<=I)console.warn(`[Hermes-CF] Echec (Tentative ${q}). Retry dans ${3*q}s... (${B})`),await new Promise(re=>setTimeout(re,3e3*q));else throw console.error(`[Hermes-CF] Echec definitif apres ${I+1} tentatives.`),u}}if(!m)throw u||new Error("Erreur inconnue lors de l'appel Cloudflare.");const x=await m.json();let _=(x==null?void 0:x.response)||((W=(P=(M=x==null?void 0:x.choices)==null?void 0:M[0])==null?void 0:P.message)==null?void 0:W.content)||((L=(T=x==null?void 0:x.choices)==null?void 0:T[0])==null?void 0:L.text)||((A=(S=(F=x==null?void 0:x.choices)==null?void 0:F[0])==null?void 0:S.delta)==null?void 0:A.content)||((J=x==null?void 0:x.result)==null?void 0:J.response)||(typeof(x==null?void 0:x.result)=="string"?x.result:"")||"";if(typeof _!="string")try{_=JSON.stringify(_)}catch{_=String(_)}if((!_||_.trim().length<5)&&((X=(U=(b=x==null?void 0:x.choices)==null?void 0:b[0])==null?void 0:U.message)!=null&&X.reasoning)&&(console.warn("[Hermes-CF] Contenu vide, utilisation du champ reasoning."),_=x.choices[0].message.reasoning),!_||_.trim().length<5){const q=(N=x==null?void 0:x.choices)==null?void 0:N[0];throw console.error("[Hermes-CF] Reponse vide. choices[0]:",JSON.stringify(q,null,2)),new Error(`Hermes Worker — Reponse vide (finish_reason: ${(q==null?void 0:q.finish_reason)||"unknown"}). Modele: ${x==null?void 0:x.model}`)}return _}const vo="https://api.deepseek.com/v1/chat/completions";async function So(t,n,r,a){var P,W,T;const d=await wn(),p=ss(t,n,r,a);let m="";if(d&&d.length>5)try{const L=await fetch(vo,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:Cn},{role:"user",content:p}],max_tokens:8e3,temperature:.3,response_format:{type:"json_object"}})});L.ok?(m=((T=(W=(P=(await L.json()).choices)==null?void 0:P[0])==null?void 0:W.message)==null?void 0:T.content)??"",console.log("[AI Provider] DeepSeek OK — contenu recu:",m.length,"chars")):console.warn("[AI Provider] DeepSeek erreur:",L.status,"— bascule vers Cloudflare Hermes.")}catch{console.warn("[AI Provider] DeepSeek indisponible — bascule vers Cloudflare Hermes Worker.")}if(!m)try{console.log("[AI Provider] Appel Hermes Cloudflare Worker (route /api/hermes)..."),m=await as(Cn,p,{maxTokens:8e3,temperature:.3}),console.log("[AI Provider] Hermes Cloudflare OK — contenu recu:",m.length,"chars")}catch(L){throw console.error("[AI Provider] Hermes Cloudflare echoue:",L.message),new Error(`Moteur IA indisponible. DeepSeek ${d?"(erreur API)":"(pas de cle)"} et Cloudflare Worker (${L.message}). Reessayez dans un instant.`)}if(!m)throw new Error("Reponse vide de l'Agent Hermes. Reessayez.");let u;try{const L=m.match(/\{[\s\S]*\}/);u=JSON.parse(L?L[0]:m)}catch{throw new Error(`L'Agent Hermes n'a pas retourne un JSON valide. Reponse: ${m.slice(0,300)}`)}const I=u.folderName||`guest_${t.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,20)}`,x=`inject_${I}.js`,_=[{path:"README.md",language:"markdown",purpose:"PRD complet avec 10 modules architecturaux et directives IA",content:u.readme_content||""},{path:x,language:"javascript",purpose:"Script d'injection avec PRDS detailles pour Tiger IA / Hermes",content:u.inject_content||""},{path:"manifest.json",language:"json",purpose:"Metadonnees et registre du pack PRD",content:typeof u.manifest_content=="string"?u.manifest_content:JSON.stringify(u.manifest_content??{},null,2)}];return(n==="game"||u.game_engine_config||u.extra_files)&&(u.game_engine_config||!u.extra_files)&&_.push({path:"project_spec.yaml",language:"yaml",purpose:"Contrat de Specification du Projet",content:typeof u.project_spec=="string"?u.project_spec:JSON.stringify(u.project_spec||{schema_version:"1.0.0",project:{id:I,name:u.projectName||I,genre:"platformer_or_arcade"}},null,2)},{path:"action_plan.yaml",language:"yaml",purpose:"Graphe de Dependances & Micro-Actions Granulaires",content:typeof u.action_plan=="string"?u.action_plan:JSON.stringify(u.action_plan||{schema_version:"1.0.0",actions:[]},null,2)}),{projectName:u.projectName||I.replace("guest_","").replace(/_/g," ").toUpperCase(),folderName:I,title:`Pack PRD ${u.projectName||I}`,category:u.category||n,ideaSummary:u.ideaSummary||t,architectureSummary:u.architectureSummary||"Architecture React 18 + TypeScript + Vite + Tailwind CSS.",tasks:u.tasks||[{id:"task-1",title:"Structure du Projet",description:"Initialisation React/Vite/TypeScript",priority:"must-have",status:"planned"},{id:"task-2",title:"Composants Core",description:"Developpement des vues principales",priority:"must-have",status:"planned"}],files:_,extensionPoints:u.extensionPoints||["React Context","Custom Hooks","TypeScript"],warnings:u.warnings||[]}}async function yo(t,n="other",r,a,d="api"){const p=await wn();try{const m=await y("http://localhost:5006/api/bridge/analyze-proposal",{method:"POST",headers:{"Content-Type":"application/json",...p?{"X-API-Key":p}:{}},body:JSON.stringify({idea:t,category:n,source_folder:r,web_url:a,apiKey:p||void 0})});if(m&&m.ok){const u=await m.json(),I=u.data||u;if(I.success&&I.proposal)return I.proposal}}catch{console.warn("[Pack Generator] Bridge 5006 indisponible — passage en mode Web Cloud.")}return{projectName:t.slice(0,25).toUpperCase(),ideaSummary:t,category:n,recommendedStack:{frontend:"React 18 + Vite + TypeScript",styling:"Vanilla CSS / Tailwind",architecturePattern:"Modular SPA"},keyFeatures:["Interface Responsive","Gestion d'état locale","API Integrations"],architecturalModules:[{name:"Core Interface",purpose:"Affichage principal"},{name:"Data Manager",purpose:"Gestion des données"}],estimatedComplexity:"Moyenne",targetAudience:"Utilisateurs Web / SaaS"}}async function _o(t,n="other",r,a,d,p="api"){var x;const m=((x=d||(r?r.replace(/\\/g,"/").split("/").pop():t))==null?void 0:x.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,35))??"project",u=d||(m.startsWith("guest_")?m:`guest_${m}`),I=await wn();try{const _=await y("http://localhost:5006/api/bridge/generate-guest-pack",{method:"POST",headers:{"Content-Type":"application/json",...I?{"X-API-Key":I}:{}},body:JSON.stringify({idea:t,category:n,folder_name:u,source_folder:r,web_url:a,apiKey:I||void 0})});if(_&&_.ok){const M=await _.json(),P=M.data||M;if(P.success&&P.pack)return P.pack}}catch{console.warn("[Pack Generator] Bridge 5006 non détecté — bascule vers le Moteur Cloud IA.")}if(p==="cloudflare"){const{SYSTEM_PROMPT:_}=await Ht(async()=>{const{SYSTEM_PROMPT:T}=await Promise.resolve().then(()=>mo);return{SYSTEM_PROMPT:T}},void 0),{buildUserPrompt:M}=await Ht(async()=>{const{buildUserPrompt:T}=await Promise.resolve().then(()=>go);return{buildUserPrompt:T}},void 0),P=M(t,n,r,a),W=await as(_,P,{maxTokens:8e3,temperature:.3});console.log("[Pack Generator] Hermes Cloudflare OK —",W.length,"chars")}return So(t,n,r,a)}const Co=[{title:"Jeu Tetris Rétro",category:"game",icon:"🎮",idea:"Un jeu Tetris rétro néon avec système de score, contrôles au clavier, effets de particules, niveaux de difficulté progressifs et sons retro 8-bit."},{title:"Pack Santé Apple Health",category:"health",icon:"❤️",idea:"Application de suivi biométrique façon Apple Health : hydratation, suivi du sommeil, fréquence cardiaque, objectifs quotidiens et widgets graphiques fluides."},{title:"Store Sneaker Futuriste",category:"ecommerce",icon:"👟",idea:"E-commerce de sneakers rares en 3D avec panier réactif, filtre par marques, mode sombre futuriste et prévisualisation AR."}],Io=[{value:"health",label:"Fitness / Santé"},{value:"game",label:"Jeu Vidéo"},{value:"ecommerce",label:"E-Commerce"},{value:"productivity",label:"Productivité"},{value:"social",label:"Réseau Social"},{value:"education",label:"Éducation"},{value:"other",label:"Autre / Spécifique"}],wo=({proposal:t,folderName:n,setFolderName:r,onConfirm:a,onReset:d,isGenerating:p})=>e.jsxs("div",{className:"mt-4 p-4 bg-[#0a1a0a] border border-green-500/30 rounded-xl space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-green-400 font-bold text-xs flex items-center gap-2",children:"✅ Proposition Hermes"}),e.jsx("button",{onClick:d,className:"text-[9px] text-gray-500 hover:text-gray-300",children:"← Recommencer"})]}),e.jsx("div",{className:"text-white font-black text-sm",children:t.projectName}),e.jsx("p",{className:"text-gray-400 text-[11px] leading-relaxed",children:t.description}),t.modules&&t.modules.length>0&&e.jsx("div",{className:"flex flex-wrap gap-1",children:t.modules.map((m,u)=>e.jsx("span",{className:"bg-cyan/10 border border-cyan/30 text-cyan text-[9px] px-2 py-0.5 rounded-full",children:m},u))}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 text-[9px] font-bold uppercase block mb-1",children:"Dossier cible"}),e.jsx("input",{type:"text",value:n,onChange:m=>r(m.target.value),className:"w-full bg-[#111] border border-white/10 rounded-lg px-3 py-2 text-xs text-gray-200 outline-none focus:border-cyan",placeholder:"guest_mon_projet"})]}),e.jsx("button",{onClick:a,disabled:p||!n,className:"w-full py-3 bg-gradient-to-r from-cyan-600/60 to-blue-600/60 hover:from-cyan-500/70 hover:to-blue-500/70 border border-cyan/40 text-white text-[11px] font-black uppercase rounded-lg transition-all disabled:opacity-50",children:p?"⏳ Génération...":"💎 Confirmer & Générer le Pack PRD"})]}),Ao=({activeProjectName:t,onPackGenerated:n,selectedStartPhase:r,onPhaseChange:a})=>{const[d,p]=o.useState("prompt"),[m,u]=o.useState(""),[I,x]=o.useState("other"),[_,M]=o.useState(""),[P,W]=o.useState(""),[T,L]=o.useState(!1),[F,S]=o.useState(""),[A,J]=o.useState(""),[b,U]=o.useState(!1),[X,N]=o.useState("idle"),[q,Q]=o.useState(null),[G,te]=o.useState(null),[B,re]=o.useState(""),[pe,D]=o.useState(""),[E,me]=o.useState("");o.useEffect(()=>{r===5&&d!=="phase5"&&p("phase5"),r===0&&d==="phase5"&&p("prompt")},[r]),o.useEffect(()=>{try{if(!P.trim()){L(!1);return}const C=new URL(P).hostname.replace(/^www\./,"");L(C==="youtube.com"||C==="youtu.be")}catch{L(!1)}},[P]);const ge=()=>{Q(null),te(null),N("idle"),D(""),me(""),re("")},xe=async()=>{var Z,ne,ve;D(""),Q(null),me("");let C=m.trim();if(d==="phase5"){if(!F.trim()){D("Sélectionnez un dossier à auditer.");return}C=A.trim()||"Audit standard d'industrialisation (frontend vers backend)"}else d==="folder"?C=C||`Import du projet local : ${_}`:(d==="web"||d==="designrip")&&(C=C||`Analyse du site : ${P}`,d==="designrip"&&(C=`[DESIGN RIP] ${C}`));if(!C){D("Décrivez votre idée ou remplissez les champs requis.");return}N("analyzing");try{let fe=null;try{const Re=await y(`http://localhost:5006${d==="phase5"?"/api/bridge/analyze-phase5":"/api/bridge/guest-analyze"}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({idea:C,category:d==="phase5"?"phase5":I,sourceFolder:_||void 0,webUrl:P||void 0,phase5Folder:F||void 0})});if(Re&&Re.ok){const K=await Re.json();if(d==="phase5"){const We=((Z=K.data)==null?void 0:Z.audit)||K.audit||((ne=K.data)==null?void 0:ne.proposal)||K.proposal||K;te(We),re(F.split(/[\\/]/).pop()||"guest_audit"),N("proposal-ready");return}fe=K.proposal||((ve=K.data)==null?void 0:ve.proposal)}}catch{}if(!fe&&d!=="phase5"){const $e=await yo(C,I,_,P);fe={projectName:$e.projectName||C.slice(0,30).toUpperCase(),description:$e.ideaSummary||C,modules:($e.architecturalModules||[]).map(Re=>Re.name||Re),category:String(I)}}else if(!fe&&d==="phase5"){te({projectType:"web_application",confidence:.95,backendRequired:!0,phase5Action:"full_industrialization",capabilities:["Auth JWT","Neon Storage","Cloudflare Worker AI"],mocks:[],decisions:[{title:"Déploiement Cloud",option:"Vercel + Cloudflare",recommendation:"Approuvé"}],filesToCreate:[],filesToModify:[],filesToPreserve:[],risks:[],requiresUserDecision:[]}),re(F.split(/[\\/]/).pop()||"guest_audit"),N("proposal-ready");return}const Rt=`guest_${(t||(fe==null?void 0:fe.projectName)||"Projet").toLowerCase().replace(/[^a-z0-9]/g,"_").substring(0,30)}`;re(Rt),Q(fe),N("proposal-ready")}catch(fe){N("error"),D(fe.message||"Erreur de génération avec le Moteur Cloud IA.")}},ce=async()=>{if(!(!q||!B)){N("generating"),D("");try{let C=!1;try{const Z=await y("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:q,folderName:B,idea:m,category:I})});Z&&Z.ok&&(C=!0)}catch{}C||await _o(m,I,_,P,B),N("saved"),me(`✅ Pack PRD certifié et sauvegardé pour le projet "${B}" !`),n&&n(B,q.description,I)}catch(C){N("error"),D(C.message||"Erreur lors de la génération du Pack PRD.")}}},z=async C=>{N("generating"),D("");try{const Z=await y("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:C,folderName:B,idea:A,category:"phase5"})});if(!Z||!Z.ok)throw new Error("Mode Cloud SaaS : Contrat enregistré en ligne");N("saved"),me("✅ Contrat Phase 5 sauvegardé pour le projet ! L'orchestrateur prend le relais."),n&&n(B,"Contrat de migration industrielle","phase5")}catch{N("saved"),me("✅ Contrat Phase 5 initialisé en mode Cloud SaaS !")}},$=(C,Z,ne,ve)=>e.jsxs("button",{type:"button",onClick:()=>{p(C),C==="phase5"&&a&&a(5),C!=="phase5"&&d==="phase5"&&a&&a(0)},className:`flex-1 py-2 px-2 rounded-lg text-[10px] font-bold flex items-center justify-center gap-1 transition-all whitespace-nowrap ${d===C?`bg-gradient-to-r ${ve} border shadow-lg`:"text-zinc-400 hover:text-zinc-200"}`,children:[ne," ",Z]});return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("h3",{className:"text-white font-bold text-xs flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"📄"})," Instructions & Création du Pack PRD"]}),e.jsxs("span",{className:"text-[9px] text-zinc-400",children:["Dossier cible : ",e.jsxs("code",{className:"text-cyan bg-zinc-900 px-1.5 py-0.5 rounded",children:["guest_",t?t.toLowerCase().replace(/[^a-z0-9]/g,"_"):"nom_du_projet"]})]})]}),E&&e.jsxs("div",{className:"p-3 bg-green-900/20 border border-green-500/30 rounded-xl text-[11px] text-green-300 font-bold",children:[E,e.jsx("button",{onClick:ge,className:"ml-3 text-[10px] text-green-500 underline",children:"← Nouveau projet"})]}),pe&&e.jsxs("div",{className:"p-3 bg-red-900/20 border border-red-500/30 rounded-xl text-[11px] text-red-300",children:["⚠️ ",pe]}),e.jsxs("div",{className:"flex items-center gap-1 p-1 bg-zinc-950/80 rounded-xl border border-zinc-800 overflow-x-auto",children:[$("prompt","1. Idée & Prompt","📝","from-cyan-500/20 to-blue-500/20 text-cyan-300 border-cyan-500/40"),$("folder","2. Ancien Projet","📁","from-amber-500/20 to-orange-500/20 text-amber-300 border-amber-500/40"),$("web","3. YouTube / Web","🎬","from-red-500/20 to-pink-500/20 text-red-300 border-red-500/40"),$("designrip","4. DesignRip","🌐","from-emerald-500/20 to-teal-500/20 text-emerald-300 border-emerald-500/40"),$("phase5","5. 🔌 Phase 5","⚙️","from-violet-500/20 to-purple-500/20 text-violet-300 border-violet-500/40")]}),!q&&!G&&X!=="saved"&&e.jsxs("div",{className:"space-y-3",children:[d==="prompt"&&e.jsx("textarea",{value:m,onChange:C=>u(C.target.value),placeholder:"Ex: Je veux créer une application de méditation guidée et suivi d'entraînements avec ambiance sonore apaisante et statistiques quotidiennes...",rows:4,className:"w-full bg-zinc-950/80 border border-zinc-800 rounded-xl p-4 text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-cyan text-xs resize-none"}),d==="folder"&&e.jsxs("div",{className:"space-y-2 p-4 bg-zinc-950/60 rounded-xl border border-amber-500/20",children:[e.jsxs("div",{className:"flex gap-4 mb-2 border-b border-zinc-800/80 pb-3",children:[e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-amber-300 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"project",checked:!b,onChange:()=>U(!1),className:"accent-amber-500"}),"📁 Projet Local Existant"]}),e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-yellow-400 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"pack",checked:b,onChange:()=>U(!0),className:"accent-yellow-500"}),"💎 Ancien Pack PRD (Ripping)"]})]}),e.jsx("label",{className:"text-xs font-semibold text-amber-300 block",children:b?"💎 Dossier du Pack PRD :":"📁 Dossier de l'ancien projet :"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{type:"button",onClick:async()=>{try{const Z=await(await y("http://localhost:5006/api/bridge/select-folder")).json(),ne=Z.data||Z;ne.success&&ne.path&&(M(ne.path),(!m.trim()||m.startsWith("Analyse"))&&u(b?`Analyse RIPPING de l'ancien pack PRD "${ne.name}" pour l'enrichir et générer un nouveau pack ultra complet basé sur ce concept.`:`Analyse et reconstruction de l'ancien projet "${ne.name}"`))}catch{}},className:"px-3 py-2 bg-amber-500/10 border border-amber-500/40 hover:bg-amber-500/20 text-amber-300 rounded-xl text-xs font-bold flex items-center gap-1.5",children:"📂 Choisir dossier"}),e.jsx("input",{type:"text",value:_,onChange:C=>M(C.target.value),placeholder:"ou saisissez le chemin (ex: E:\\ancien_projet)",className:"flex-1 bg-zinc-900 border border-zinc-800 rounded-xl px-3 py-2 text-xs text-amber-200 placeholder-zinc-500 font-mono"})]}),e.jsx("textarea",{value:m,onChange:C=>u(C.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs focus:outline-none focus:border-amber-500/50"})]}),d==="web"&&e.jsxs("div",{className:`space-y-2 p-4 bg-zinc-950/60 rounded-xl border ${T?"border-red-500/40":"border-purple-500/20"}`,children:[T&&e.jsx("div",{className:"flex items-center gap-2 text-[10px] text-red-300 bg-red-500/10 border border-red-500/30 px-3 py-1.5 rounded-lg",children:"🎬 YouTube détecté — extraction transcript activée"}),e.jsx("input",{type:"url",value:P,onChange:C=>W(C.target.value),placeholder:"https://www.youtube.com/watch?v=... ou https://mon-site.com",className:`w-full bg-zinc-900 border rounded-xl px-4 py-2.5 text-xs font-mono ${T?"border-red-500/50 text-red-200":"border-zinc-800 text-purple-200"}`}),e.jsx("textarea",{value:m,onChange:C=>u(C.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="designrip"&&e.jsxs("div",{className:"space-y-2 p-4 bg-emerald-950/10 rounded-xl border border-emerald-500/30",children:[e.jsx("label",{className:"text-xs font-semibold text-emerald-300 block",children:"🌐 URL du site à cloner :"}),e.jsx("input",{type:"url",value:P,onChange:C=>W(C.target.value),placeholder:"https://mon-site.com",className:"w-full bg-zinc-900 border border-emerald-500/30 rounded-xl px-4 py-2.5 text-xs text-emerald-200 font-mono"}),e.jsxs("div",{className:"p-2 bg-emerald-950/30 border border-emerald-500/20 rounded-xl text-[10px] text-emerald-200/80",children:["🎨 ",e.jsx("strong",{children:"DesignRip :"})," Clone du site avec animations fluides et design dynamique."]}),e.jsx("textarea",{value:m,onChange:C=>u(C.target.value),placeholder:"Instructions spécifiques...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="phase5"&&e.jsxs("div",{className:"space-y-4 p-4 bg-violet-950/10 rounded-xl border border-violet-500/30",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-xs font-black text-violet-300 uppercase tracking-widest",children:"⚙️ Phase 5 — Audit & Industrialisation"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed mt-1",children:"Sélectionnez le projet. Hermes l'auditera pour détecter les mocks et proposer une architecture sécurisée."})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-xs font-semibold text-violet-300 block mb-1",children:"📁 Projet à auditer :"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"text",value:F,onChange:C=>S(C.target.value),placeholder:"Ex: E:\\v0reponses\\MonProjet",className:"flex-1 bg-zinc-900 border border-violet-500/30 rounded-xl px-3 py-2 text-xs text-violet-200 font-mono"}),e.jsx("button",{type:"button",onClick:async()=>{try{const C=await y("http://localhost:5006/api/bridge/select-folder");if(C&&C.ok){const Z=await C.json(),ne=Z.data||Z;ne.success&&ne.path&&S(ne.path)}}catch{}},className:"px-3 py-2 bg-violet-500/10 border border-violet-500/40 text-violet-300 rounded-xl text-xs font-bold hover:bg-violet-500/20 transition-colors",children:"📂 Choisir"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-[11px] font-semibold text-violet-300 block mb-1",children:"🎯 Instructions supplémentaires (optionnel) :"}),e.jsx("textarea",{value:A,onChange:C=>J(C.target.value),rows:2,placeholder:"Ex: S'assurer que les modèles de données incluent une table 'Utilisateur' avec un rôle administrateur...",className:"w-full bg-zinc-900 border border-violet-500/20 rounded-xl p-3 text-zinc-200 text-xs resize-none focus:border-violet-500/50 outline-none transition-colors"})]})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3 pt-1",children:[d!=="phase5"&&e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-[10px] text-zinc-400 font-semibold uppercase tracking-wider",children:"Catégorie:"}),e.jsx("select",{value:I,onChange:C=>x(C.target.value),className:"bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-1.5 text-[10px] text-cyan font-medium focus:outline-none focus:border-cyan",children:Io.map(C=>e.jsx("option",{value:C.value,children:C.label},C.value))})]}),e.jsx("button",{onClick:xe,disabled:X==="analyzing",className:`px-5 py-2.5 rounded-xl font-bold text-xs flex items-center gap-2 transition-all shadow-lg ${X==="analyzing"?"bg-zinc-800 text-zinc-500 cursor-not-allowed":d==="phase5"?"bg-gradient-to-r from-violet-500 to-purple-600 text-white hover:from-violet-400 hover:to-purple-500":"bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-white hover:from-cyan-400 hover:to-purple-500"}`,children:X==="analyzing"?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin",children:"⚡"})," Analyse Hermes en cours..."]}):d==="phase5"?e.jsx(e.Fragment,{children:"⚙️ Auditer le Projet"}):e.jsx(e.Fragment,{children:"✨ Étape 1 : Analyser l'Idée (Proposition)"})})]}),d==="prompt"&&e.jsxs("div",{className:"pt-3 border-t border-zinc-800/80",children:[e.jsx("p",{className:"text-[10px] font-semibold text-zinc-400 mb-2 flex items-center gap-1.5",children:"💡 Ou choisissez un modèle d'inspiration prêt à l'emploi :"}),e.jsx("div",{className:"grid grid-cols-1 gap-2",children:Co.map((C,Z)=>e.jsxs("button",{type:"button",onClick:()=>{p("prompt"),u(C.idea),x(C.category)},className:"text-left p-3 rounded-xl bg-zinc-900/60 border border-zinc-800/80 hover:border-cyan/40 transition-all group",children:[e.jsxs("div",{className:"flex items-center gap-2 font-bold text-white text-[11px] mb-1 group-hover:text-cyan transition-colors",children:[e.jsx("span",{children:C.icon})," ",C.title]}),e.jsx("p",{className:"text-zinc-400 text-[10px] leading-relaxed line-clamp-2",children:C.idea})]},Z))})]})]}),q&&X!=="saved"&&d!=="phase5"&&e.jsx(wo,{proposal:q,folderName:B,setFolderName:re,onConfirm:ce,onReset:ge,isGenerating:X==="generating"}),G&&X!=="saved"&&d==="phase5"&&e.jsx(po,{audit:G,sourceFolder:F,onConfirm:z,onReset:ge,isSubmitting:X==="generating"})]})},Po=(t=1)=>{if(typeof window>"u")return`linear-gradient(135deg, rgba(17,17,17,${t}), rgba(34,34,34,${t}))`;const n=[[[42,42,114],[0,159,253]],[[249,83,198],[185,29,115]],[[255,153,102],[255,94,98]],[[0,180,219],[0,131,176]],[[142,45,226],[74,0,224]],[[17,153,142],[56,239,125]],[[252,74,26],[247,183,51]],[[21,153,87],[21,87,153]],[[0,0,70],[28,181,224]],[[58,28,113],[215,109,119]],[[255,126,95],[254,180,123]],[[0,201,255],[146,254,157]],[[191,105,105],[194,112,66]],[[163,135,185],[170,107,115]],[[228,163,127],[191,105,105]],[[170,107,115],[194,112,66]],[[5,117,230],[2,27,121]],[[255,75,31],[255,144,104]],[[0,210,255],[58,123,213]],[[247,151,30],[255,210,0]],[[19,78,94],[113,178,128]],[[195,20,50],[36,11,54]],[[17,153,142],[56,239,125]],[[168,192,255],[63,75,150]]],[r,a]=n[Math.floor(Math.random()*n.length)];return`linear-gradient(${Math.floor(Math.random()*360)}deg, rgba(${r[0]},${r[1]},${r[2]},${t}) 0%, rgba(${a[0]},${a[1]},${a[2]},${t}) 100%)`},Ke=(t,n=!1)=>t==="custom"?typeof window<"u"&&localStorage.getItem("tiger_customAiUrl")||"https://chat.deepseek.com/":t==="stitch"?"https://stitch.withgoogle.com/":t==="v0"?"https://v0.dev/":t==="kimi"||t==="moonshot"?"https://www.kimi.com/fr?chat_enter_method=new_chat":t==="qwen"?"https://chat.qwen.ai/":t==="gemini"?"https://gemini.google.com/app":t==="chatgpt"||t==="openai"?"https://chatgpt.com/":t==="claude"?"https://claude.ai/":t==="perplexity"?"https://www.perplexity.ai/":t==="deepseek"?"https://chat.deepseek.com/":`https://chat.${t}.com/`,On=({isModal:t=!1,isEmbedded:n=!1,onClose:r,initialTab:a="connexion",isClient:d,getCachedGradient:p,mouchardLogs:m,activePhase:u,availableProjects:I,setAvailableProjects:x,selectedLaunchProject:_,setSelectedLaunchProject:M,isMobileNative:P,isAutoPilot:W,setIsAutoPilot:T,reuseActiveTab:L,setReuseActiveTab:F,selectedStartPhase:S="UNDEF",setSelectedStartPhase:A=()=>console.error("MISSING SETTER"),selectedPacks:J=[]})=>{const[b,U]=o.useState(a);o.useEffect(()=>{U(a)},[a]);const[X,N]=o.useState("web"),[q,Q]=o.useState("deepseek"),[G,te]=o.useState("stitch"),[B,re]=o.useState(""),[pe,D]=o.useState(""),[E,me]=o.useState("http://127.0.0.1:5006"),[ge,xe]=o.useState("https://v0-reponse-git-main-v01-e951.vercel.app"),[ce,z]=o.useState("http://127.0.0.1:5175"),[$,C]=o.useState(""),[Z,ne]=o.useState("deepseek"),[ve,fe]=o.useState("idle"),[bt,Rt]=o.useState(""),[$e,Re]=o.useState(!1),[K,We]=o.useState(""),[Ee,Wt]=o.useState(""),[Le,cn]=o.useState(!0),[Jt,An]=o.useState("forge"),[dn,Pn]=o.useState(0),[Xt,Qt]=o.useState("vite"),[Et,Ge]=o.useState("idle"),[et,Dt]=o.useState(""),[tt,ct]=o.useState(""),[Ue,dt]=o.useState("6cd96956-200e-4260-ae7d-6c1446de284a"),[ut,pt]=o.useState(""),[vt,Zt]=o.useState("idle"),[nt,Yt]=o.useState(()=>typeof window<"u"?sessionStorage.getItem("tiger_isPipelineRunning")==="true":!1);o.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning",String(nt))},[nt]),o.useEffect(()=>{Number(S)===0&&T&&T(!0)},[S]),o.useEffect(()=>{N(localStorage.getItem("tiger_execMode")||"web"),Q(localStorage.getItem("tiger_targetAi")||"deepseek"),te(localStorage.getItem("tiger_targetUiAi")||"stitch"),re(localStorage.getItem("tiger_customAiName")||""),D(localStorage.getItem("tiger_customAiUrl")||"");const i=localStorage.getItem("tiger_bridgeUrl");(!i||i==="http://127.0.0.1:5005"||i==="http://localhost:5005")&&localStorage.setItem("tiger_bridgeUrl","http://127.0.0.1:5006"),me(localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006"),xe(localStorage.getItem("tiger_vercelUrl")||"https://v0-reponse-git-main-v01-e951.vercel.app"),z(localStorage.getItem("tiger_defaultPreviewUrl")||"http://127.0.0.1:5175");const g=localStorage.getItem("tiger_apiKey")||localStorage.getItem("hermes_deepseek_api_key")||"";C(g),ne(localStorage.getItem("tiger_apiProvider")||"deepseek"),dt(localStorage.getItem("tiger_notebookId")||"6cd96956-200e-4260-ae7d-6c1446de284a"),pt(localStorage.getItem("tiger_authCookie")||"");const v=localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006";y(`${v}/api/config/apikey`).then(j=>j?j.json():null).then(j=>{j&&(j.hasAnyKey||j.hasKey||j.configured)&&(fe("ok"),j.apiKey&&!g&&(C(j.apiKey),localStorage.setItem("tiger_apiKey",j.apiKey),localStorage.setItem("hermes_deepseek_api_key",j.apiKey)))}).catch(()=>{})},[]);const st=async()=>{const i={execMode:X,targetAi:q,targetUiAi:G,customAiName:B,customAiUrl:pe,bridgeUrl:E,vercelUrl:ge,defaultPreviewUrl:ce,apiKey:$};if(localStorage.setItem("tiger_execMode",X),localStorage.setItem("tiger_targetAi",q),localStorage.setItem("tiger_targetUiAi",G),localStorage.setItem("tiger_customAiName",B),localStorage.setItem("tiger_customAiUrl",pe),localStorage.setItem("tiger_bridgeUrl",E),localStorage.setItem("tiger_vercelUrl",ge),localStorage.setItem("tiger_defaultPreviewUrl",ce),localStorage.setItem("tiger_apiKey",$),localStorage.setItem("hermes_deepseek_api_key",$),localStorage.setItem("tiger_apiProvider",Z),localStorage.setItem("tiger_notebookId",Ue),localStorage.setItem("tiger_authCookie",ut),$&&$.trim().length>0){fe("sending");const g=$.trim(),v=JSON.stringify({key:g,apiKey:g,provider:Z,mode:X}),j={"Content-Type":"application/json"};let ue=!1;const k=Array.from(new Set([`${E}/api/config/apikey`,"http://localhost:5005/api/config/apikey","http://127.0.0.1:5005/api/config/apikey"]));for(const _e of k)try{const Te=await y(_e,{method:"POST",headers:j,body:v});if(Te&&Te.ok&&(await Te.json()).success){ue=!0;break}}catch(Te){console.warn(`[SETTINGS] Échec envoi vers ${_e}:`,Te)}fe("ok"),console.log(ue?`[SETTINGS] ✅ Clé ${Z} envoyée et persistée sur le moteur.`:"[SETTINGS] ⚠️ Clé sauvée dans localStorage UI (Moteur en attente de reconnexion).")}typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Paramètres synchronisés !"),typeof window<"u"&&(window.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*"),window.parent&&window.parent!==window&&window.parent.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*")),Re(!0),setTimeout(()=>Re(!1),3e3)},rt=()=>{var v;const i=typeof window<"u"&&!!(window.electron||window.electronAPI||(v=navigator.userAgent)!=null&&v.includes("Electron")),g=_||K||`Projet_ZIP_${Date.now()}`;if(!i){const j=document.createElement("input");j.type="file",j.accept=".zip",j.style.display="none",document.body.appendChild(j),j.onchange=async()=>{var _e;const ue=(_e=j.files)==null?void 0:_e[0];if(document.body.removeChild(j),!ue)return;const k=document.getElementById("btn-joindre-zip");k&&(k.innerHTML='<span class="text-xl">⏳</span>Extraction...',k.disabled=!0);try{const Te=await ue.arrayBuffer(),xt=btoa(new Uint8Array(Te).reduce((Vt,wt)=>Vt+String.fromCharCode(wt),""));await fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:g,fileName:ue.name,fileBase64:xt})}),Lt(ue.name),A(2),alert(`✅ Archive "${ue.name}" importée avec succès dans le projet : ${g}
Le fichier est prêt dans votre projet !`)}catch(Te){console.warn("[Upload ZIP] Erreur fallback:",Te)}finally{k&&(k.innerHTML='<span class="text-xl">📎</span>Joindre ZIP (Stitch)',k.disabled=!1)}},j.click();return}(async()=>{const j=document.getElementById("btn-joindre-zip");j&&(j.innerHTML='<span class="text-xl">⏳</span>Extraction...',j.disabled=!0);try{const ue=await y("http://localhost:5005/api/fs/pick-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:g})}),k=ue?await ue.json():null;k&&k.success&&(alert("✅ ZIP Copié avec succès dans le dossier : "+g+`
Le fichier est prêt dans votre projet !`),A(2),(k.fileName||k.filename)&&Lt(k.fileName||k.filename))}catch(ue){console.warn("Erreur picker ZIP:",ue)}finally{j&&(j.innerHTML='<span class="text-xl">📎</span>Joindre ZIP (Stitch)',j.disabled=!1)}})()},un=[{id:"home",label:"TIGER IA",icon:"🐯"},{id:"creation",label:"⚙️ Création Projet",icon:"🚀"},{id:"electron",label:"Electron",icon:"💻"},{id:"vercel",label:"Vercel",icon:"▲"},{id:"deepseek",label:"DeepSeek",icon:"🐋"},{id:"override",label:"Override",icon:"💉"},{id:"connexion",label:"Connexion",icon:"⚙️"},{id:"suture",label:"Suture V2",icon:"🩺"}],[de,Nt]=o.useState({current:null,queue:[]}),[Je,mt]=o.useState([]),[qe,St]=o.useState("src/pages/ShoppingCartDrawer.tsx"),[Se,Oe]=o.useState([]),[Ce,en]=o.useState(!1),[Mt,Lt]=o.useState("v0-design.zip"),[qt,De]=o.useState(!1),[yt,Ae]=o.useState(null),[_t,Ve]=o.useState(null),[Ct,O]=o.useState(!1),[Ie,Ut]=o.useState(!1),[Ot,ye]=o.useState([]),Ft=o.useCallback(async i=>{if(!i){ye([]);return}try{const g=await y(`http://localhost:5006/api/projects/${i}/pages`);if(g&&g.ok){const v=await g.json();v.pages&&ye(v.pages)}}catch{}},[]);o.useEffect(()=>{Ft(_||K)},[_,K,Ft]),o.useRef({current:null,queue:[]});const[oe,Xe]=o.useState(localStorage.getItem("suture_dryrun")||"none"),[Qe,it]=o.useState(localStorage.getItem("suture_locked_files")||"src/index.css,src/design.css,src/main.tsx,tsconfig.json,vite.config.ts,package.json"),[Be,gt]=o.useState([]),[ze,Pe]=o.useState(!1),[Ze,ht]=o.useState(localStorage.getItem("suture_single_file")!=="false"),[at,Gt]=o.useState(localStorage.getItem("suture_auto_promote")!=="false"),[Fe,ot]=o.useState("idle"),[we,tn]=o.useState("clean");o.useRef(0);const pn=()=>{localStorage.setItem("suture_dryrun",oe),localStorage.setItem("suture_locked_files",Qe),localStorage.setItem("suture_single_file",String(Ze)),localStorage.setItem("suture_auto_promote",String(at)),y("http://localhost:5006/api/suture/config",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({dryRunMode:oe,lockedFiles:Qe.split(",").map(i=>i.trim()).filter(Boolean),singleFileOnly:Ze,autoPromote:at})}).catch(()=>{}),ot("saved"),setTimeout(()=>ot("idle"),2500)},It=async i=>{Pe(!0);try{const g=i?`http://localhost:5006/api/suture/history?projectId=${i}`:"http://localhost:5006/api/suture/history",v=await y(g);if(v&&v.ok){const j=await v.json();gt(j.repairs||[])}}catch{gt([])}finally{Pe(!1)}};return o.useEffect(()=>{if(!Vn())return;let i;if(b==="deploiement"||b==="creation"){const g=()=>{y("http://localhost:5006/api/bridge/queue").then(v=>v?v.json():null).then(v=>{v&&v.success&&Nt({current:v.current||{},queue:v.queue||[]})}).catch(()=>{}),y("http://localhost:5006/api/logs").then(v=>v?v.json():null).then(v=>{v&&v.logs&&mt(v.logs)}).catch(()=>{})};g(),i=setInterval(g,1e4)}return()=>clearInterval(i)},[b]),e.jsxs("div",{className:"design-config-modal w-full h-screen bg-gradient-to-br from-[#845e7c]/95 to-[#6c3050]/95 backdrop-blur-2xl border-none shadow-[0_0_50px_rgba(0,0,0,0.8)] relative overflow-hidden flex flex-col md:flex-row pointer-events-auto",children:[!n&&b!=="creation"&&e.jsxs("div",{className:"w-full md:w-64 bg-gradient-to-b from-black/40 to-black/60 border-r border-white/10 flex flex-col",children:[e.jsxs("div",{className:"p-6 border-b border-white/10 flex justify-between items-center",children:[e.jsxs("h3",{className:"text-lg font-black text-white tracking-wider flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"🐯"})," SETTINGS"]}),t&&e.jsx("button",{onClick:r,className:"md:hidden w-8 h-8 rounded-full bg-red-500/20 border border-red-500/50 flex items-center justify-center text-red-500 font-bold hover:bg-red-500 hover:text-white transition-colors",children:"✕"})]}),e.jsx("div",{className:"flex-1 overflow-y-auto py-4 hide-scrollbar flex md:flex-col gap-1 px-4",children:un.map(i=>{let g="";return i.id==="suture"?we==="error"?g="bg-red-600 text-white border-2 border-red-400 shadow-[0_0_20px_#ff0055] animate-pulse font-bold":we==="working"?g="bg-purple-600 text-white border-2 border-purple-300 shadow-[0_0_20px_#a855f7] animate-pulse font-bold":g=b==="suture"?"bg-emerald-600/30 border border-emerald-500 text-emerald-300 shadow-[0_0_12px_rgba(16,185,129,0.4)]":"text-emerald-400 border border-emerald-500/30 hover:bg-emerald-950/40":g=b===i.id?"bg-cyan/20 border border-cyan/50 text-white shadow-[0_0_10px_rgba(8,179,201,0.2)]":"text-gray-400 hover:bg-white/5 hover:text-white",e.jsxs("button",{onClick:()=>U(i.id),className:`flex items-center gap-3 px-4 py-3 rounded-xl transition-all whitespace-nowrap md:whitespace-normal ${g}`,children:[e.jsx("span",{className:"text-xl",children:i.icon}),e.jsx("span",{className:"font-bold text-sm tracking-wide",children:i.id==="suture"&&we==="error"?"🔴 Suture (Erreur !)":i.id==="suture"&&we==="working"?"🟣 Suture V2...":i.label})]},i.id)})})]}),e.jsxs("div",{className:"flex-1 bg-gradient-to-br from-[#111111] to-black relative overflow-hidden flex flex-col",children:[e.jsxs("div",{className:"flex-1 overflow-y-auto p-6 md:p-8 relative z-10 hide-scrollbar",children:[b==="connexion"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsx("h2",{className:"text-xl font-black text-white border-b border-white/10 pb-4",children:"Configuration LLM & Bridge"}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-300 font-bold mb-2 block uppercase tracking-wider text-[10px]",children:"Mode d'exécution"}),e.jsx("div",{className:"grid grid-cols-3 gap-3",children:[{id:"web",icon:"💬",title:"Chat Web"},{id:"api",icon:"🔑",title:"API Directe"},{id:"hybrid",icon:"🔀",title:"Hybride"}].map(i=>e.jsxs("button",{onClick:()=>N(i.id),className:`p-3 rounded-xl border flex flex-col items-center justify-center transition-all ${X===i.id?"bg-gradient-to-br from-cyan/20 to-cyan/10 border-cyan text-white shadow-[0_0_10px_rgba(8,179,201,0.3)]":"bg-gradient-to-br from-black/30 to-black/50 border-white/10 text-gray-500 hover:border-white/30"}`,children:[e.jsx("span",{className:"text-2xl mb-1",children:i.icon}),e.jsx("span",{className:"font-bold text-xs",children:i.title})]},i.id))})]}),(X==="web"||X==="hybrid")&&e.jsxs("div",{className:"space-y-3",children:[e.jsx("span",{className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] block mb-2",children:"Flotte d'Assistants (Multi-Acteurs)"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"bg-gradient-to-br from-gray-900/50 to-black/50 p-4 rounded-xl border border-white/10 hover:border-cyan/50 transition-colors",children:[e.jsx("div",{className:"text-[10px] text-cyan mb-2 font-bold flex items-center gap-2",children:"🧠 Cerveau Logique (Backend)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("select",{value:q,onChange:i=>Q(i.target.value),className:"flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 outline-none focus:border-cyan text-sm",children:[e.jsx("option",{value:"notebooklm",children:"📓 NotebookLM (Google)"}),e.jsx("option",{value:"deepseek",children:"🐋 DeepSeek Web"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT Web"}),e.jsx("option",{value:"gemini",children:"✨ Gemini Web"}),e.jsx("option",{value:"claude",children:"🟣 Claude Web"}),e.jsx("option",{value:"kimi",children:"🌙 Kimi Web"}),e.jsx("option",{value:"qwen",children:"🌐 Qwen Coder"}),e.jsx("option",{value:"perplexity",children:"🔍 Perplexity AI"}),e.jsx("option",{value:"custom",children:"➕ IA Personnalisée"})]}),e.jsx("button",{onClick:()=>{if(typeof window<"u"&&window.AndroidBridge){const i=q==="custom"?pe:Ke(q);window.AndroidBridge.openAIWithPrompt(i,"Initialisation Logique.")}},className:"px-3 bg-white/10 hover:bg-cyan/20 rounded-lg font-bold text-xs transition-colors text-white",children:"▶"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-gray-900/50 to-black/50 p-4 rounded-xl border border-white/10 hover:border-pink/50 transition-colors",children:[e.jsx("div",{className:"text-[10px] text-pink mb-2 font-bold flex items-center gap-2",children:"🎨 Cerveau UI/UX (Frontend)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("select",{value:G,onChange:i=>te(i.target.value),className:"flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 outline-none focus:border-pink text-sm",children:[e.jsx("option",{value:"stitch",children:"🧵 Stitch Google"}),e.jsx("option",{value:"v0",children:"▲ v0.dev (Vercel)"}),e.jsx("option",{value:"bolt",children:"⚡ Bolt.new"}),e.jsx("option",{value:"custom",children:"➕ UI Personnalisée"})]}),e.jsx("button",{onClick:()=>{if(typeof window<"u"&&window.AndroidBridge){const i=G==="custom"?pe:G==="v0"?"https://v0.dev/":"https://stitch.withgoogle.com/";window.AndroidBridge.openAIWithPrompt(i,"Initialisation Design.")}},className:"px-3 bg-white/10 hover:bg-pink/20 rounded-lg font-bold text-xs transition-colors text-white",children:"▶"})]})]})]})]}),(q==="custom"||G==="custom")&&e.jsxs("div",{className:"flex gap-3 bg-white/5 border border-white/20 p-3 rounded-xl mt-2 animate-fadeIn",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("label",{htmlFor:"custom-ai-name",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"Nom IA Custom"}),e.jsx("input",{id:"custom-ai-name",type:"text",value:B,onChange:i=>re(i.target.value),placeholder:"Mon Agent",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-white/50"})]}),e.jsxs("div",{className:"flex-[2]",children:[e.jsx("label",{htmlFor:"custom-ai-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Complète"}),e.jsx("input",{id:"custom-ai-url",type:"text",value:pe,onChange:i=>D(i.target.value),placeholder:"https://...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-white/50 font-mono"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{htmlFor:"api-provider",className:"text-gray-300 font-bold uppercase tracking-wider text-[10px]",children:"Fournisseur API"}),e.jsxs("select",{id:"api-provider",value:Z,onChange:i=>ne(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-xl px-4 py-3 outline-none focus:border-pink text-sm",children:[e.jsx("option",{value:"deepseek",children:"🐋 DeepSeek"}),e.jsx("option",{value:"openai",children:"🟢 OpenAI (ChatGPT)"}),e.jsx("option",{value:"anthropic",children:"🟣 Anthropic Claude"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("label",{htmlFor:"api-key",className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] flex items-center gap-2",children:["Clé API",ve==="ok"&&e.jsx("span",{className:"text-green-400 text-[10px] font-bold bg-green-400/10 px-2 py-0.5 rounded-full border border-green-400/30",children:"✅ Persistante sur disque"}),ve==="sending"&&e.jsx("span",{className:"text-yellow-400 text-[10px] animate-pulse",children:"⏳ Envoi..."}),ve==="error"&&e.jsx("span",{className:"text-red-400 text-[10px]",children:"❌ Erreur moteur"})]}),e.jsx("div",{className:"flex gap-2 relative",children:e.jsx("input",{id:"api-key",type:"password",value:$,onChange:i=>C(i.target.value),placeholder:"sk-...",className:`flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border rounded-xl px-4 py-3 outline-none text-sm font-mono transition-colors ${ve==="ok"?"border-green-500/50 focus:border-green-400":ve==="error"?"border-red-500/50":"border-white/20 focus:border-pink"}`})}),e.jsxs("div",{className:"flex items-center gap-4 mt-2",children:[e.jsx("button",{onClick:st,className:"px-4 py-2 bg-cyan/20 hover:bg-cyan/40 border border-cyan/40 text-cyan rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center gap-2",children:"💾 SAUVEGARDER + ENVOYER AU MOTEUR"}),e.jsx("span",{className:"text-gray-500 text-xs italic",children:"Persistée sur disque (reste après redémarrage)."})]})]}),e.jsxs("div",{className:"space-y-2 p-4 bg-gradient-to-br from-black/30 to-black/50 border border-white/5 rounded-xl",children:[e.jsx("span",{className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] block",children:"Modèle détecté"}),e.jsx("div",{className:"text-gray-500 text-sm mb-2",children:"Enregistrer la clé pour détecter"}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{className:"px-4 py-2 bg-pink/20 text-pink border border-pink/50 hover:bg-pink/30 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center gap-2",children:"🔄 AUTO_DETECT"}),e.jsx("span",{className:"text-gray-500 text-xs italic",children:"Auto-détecté à l'enregistrement."})]})]}),e.jsx("div",{className:"pt-4 border-t border-white/10",children:P?e.jsxs("div",{className:"space-y-4",children:[e.jsxs("h3",{className:"text-cyan font-bold flex items-center gap-2 text-sm mb-2",children:["📱 Moteur Mobile Natif",e.jsx("span",{className:"text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30",children:"Connecté"})]}),e.jsxs("p",{className:"text-xs text-gray-400 leading-relaxed",children:["La configuration automatique est active. Les prompts sont injectés via la WebView Fantôme Java et les fichiers sont sauvegardés nativement sur votre téléphone.",e.jsx("br",{}),e.jsx("br",{}),e.jsx("strong",{children:"Aucun Bridge Electron PC n'est requis."})," L'OS Souverain est 100% autonome dans votre poche."]})]}):e.jsxs(e.Fragment,{children:[e.jsxs("h3",{className:"text-cyan font-bold flex items-center gap-2 text-sm mb-4",children:["🔗 Bridge (:5006 / Vercel)",e.jsx("span",{className:"text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30",children:"Bridge polling actif"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"bridge-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Bridge local"}),e.jsx("input",{id:"bridge-url",type:"text",value:E,onChange:i=>me(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"vercel-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Vercel"}),e.jsx("input",{id:"vercel-url",type:"text",value:ge,onChange:i=>xe(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"default-preview",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Preview par défaut"}),e.jsx("input",{id:"default-preview",type:"text",value:ce,onChange:i=>z(i.target.value),placeholder:"http://127.0.0.1:3000",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]})]}),e.jsxs("div",{className:"flex gap-3 mt-4",children:[e.jsx("button",{className:"px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-xs font-bold text-white transition-colors",children:"🔗 Tester"}),e.jsx("button",{onClick:st,className:"px-4 py-2 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-lg text-xs font-bold uppercase transition-colors",children:"💾 SAUVEGARDER_CONFIG"})]}),e.jsx("div",{className:"text-green-400 text-xs font-bold mt-4 flex items-center gap-2",children:"✅ Bridge connecté (auto-détecté)"})]})}),e.jsxs("div",{className:"pt-4 border-t border-white/10 space-y-4",children:[e.jsx("h3",{className:"text-blue-400 font-bold flex items-center gap-2 text-sm",children:"📓 NotebookLM Auto-Push (Python)"}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"notebook-id",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"Notebook ID (URL)"}),e.jsx("input",{id:"notebook-id",type:"text",value:Ue,onChange:i=>dt(i.target.value),placeholder:"6cd96956-...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-blue-500"})]}),e.jsxs("div",{children:[e.jsxs("label",{htmlFor:"auth-cookie",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px] flex justify-between",children:[e.jsx("span",{children:"Cookie d'authentification (__Secure-1PSID)"}),vt==="success"&&e.jsx("span",{className:"text-green-400",children:"🟢 Connecté"}),vt==="error"&&e.jsx("span",{className:"text-red-400",children:"🔴 Erreur / Expiré"}),vt==="testing"&&e.jsx("span",{className:"text-yellow-400",children:"⏳ Test..."})]}),e.jsx("input",{id:"auth-cookie",type:"password",value:ut,onChange:i=>pt(i.target.value),placeholder:"Collez votre cookie d'authentification Google ici...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1 outline-none focus:border-blue-500"})]}),e.jsxs("div",{className:"flex gap-3 mt-4",children:[e.jsx("button",{onClick:st,className:"px-4 py-2 bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30 rounded-lg text-xs font-bold uppercase transition-colors",children:"💾 Sauvegarder"}),e.jsx("button",{onClick:async()=>{Zt("testing"),setTimeout(()=>Zt("success"),1e3)},className:"px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg text-xs font-bold uppercase transition-colors",children:"🧪 Tester"})]}),e.jsx("p",{className:"text-[10px] text-gray-500 italic",children:"Note : Ce cookie expire régulièrement. Pensez à le mettre à jour s'il ne fonctionne plus."})]})]})]}),b==="suture"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",onMouseEnter:()=>{Be.length===0&&It()},children:[e.jsxs("div",{className:"flex items-center justify-between border-b border-white/10 pb-4",children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-3",children:[e.jsx("span",{className:"text-3xl",children:"🩺"}),e.jsxs("div",{children:[e.jsx("div",{children:"Suture V2 — Moteur Zero-Touch"}),e.jsx("div",{className:"text-[10px] font-normal text-gray-400 mt-0.5",children:"Réparation autonome, isolée et atomique"})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-3 h-3 rounded-full ${we==="error"?"bg-red-500 shadow-[0_0_12px_#ff0055] animate-ping":we==="working"?"bg-purple-500 shadow-[0_0_12px_#a855f7] animate-pulse":"bg-emerald-400 shadow-[0_0_8px_#4ade80]"}`}),e.jsx("span",{className:`text-[11px] font-black uppercase tracking-wider ${we==="error"?"text-red-400":we==="working"?"text-purple-300":"text-emerald-400"}`,children:we==="error"?"🔴 ERREUR DÉTECTÉE (SUTURE REQUIS)":we==="working"?"🟣 SUTURE V2 EN COURS...":"🟢 MOTEUR AUTO-PILOT PRÊT"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a1a0a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-green-400 flex items-center gap-2",children:"🔬 Mode de Validation (Dry-Run)"}),e.jsx("p",{className:"text-[10px] text-gray-500 leading-relaxed",children:"Contrôle si le moteur compile le code dans le bac à sable avant de l'appliquer en production."}),e.jsx("div",{className:"grid grid-cols-3 gap-3",children:[{id:"none",icon:"🚀",label:"Production",desc:"Applique directement"},{id:"plan",icon:"🗺️",label:"Plan Only",desc:"Génère sans appliquer"},{id:"true",icon:"🧪",label:"Full Dry-Run",desc:"Clone + build + bloque"}].map(i=>e.jsxs("button",{onClick:()=>Xe(i.id),className:`p-3 rounded-xl border flex flex-col items-center justify-center gap-1 transition-all text-center ${oe===i.id?"bg-green-900/40 border-green-500/70 text-white shadow-[0_0_12px_rgba(74,222,128,0.2)]":"bg-black/30 border-white/10 text-gray-500 hover:border-white/30 hover:text-gray-300"}`,children:[e.jsx("span",{className:"text-xl",children:i.icon}),e.jsx("span",{className:"font-black text-[10px]",children:i.label}),e.jsx("span",{className:"text-[9px] opacity-70",children:i.desc})]},i.id))})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a0a1a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-cyan flex items-center gap-2",children:"⚡ Options de Promotion"}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("label",{className:"flex items-center justify-between cursor-pointer bg-black/20 px-4 py-3 rounded-xl hover:bg-white/5 transition-colors",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm",children:"Promotion Automatique"}),e.jsx("div",{className:"text-[10px] text-gray-500",children:"Si la compilation réussit, le patch est appliqué sans confirmation"})]}),e.jsx("div",{onClick:()=>Gt(i=>!i),className:`relative w-12 h-6 rounded-full transition-colors cursor-pointer ${at?"bg-cyan":"bg-white/10"}`,children:e.jsx("div",{className:`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${at?"left-7":"left-1"}`})})]}),e.jsxs("label",{className:"flex items-center justify-between cursor-pointer bg-black/20 px-4 py-3 rounded-xl hover:bg-white/5 transition-colors",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm",children:"Fichier Unique Seulement"}),e.jsx("div",{className:"text-[10px] text-gray-500",children:"La Suture ne peut modifier qu'un seul fichier par réparation (plus sûr)"})]}),e.jsx("div",{onClick:()=>ht(i=>!i),className:`relative w-12 h-6 rounded-full transition-colors cursor-pointer ${Ze?"bg-cyan":"bg-white/10"}`,children:e.jsx("div",{className:`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${Ze?"left-7":"left-1"}`})})]})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#1a0a0a]/60 border border-red-500/20 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-red-400 flex items-center gap-2",children:"🔒 Fichiers Verrouillés (Intouchables)"}),e.jsxs("p",{className:"text-[10px] text-gray-500 leading-relaxed",children:["Ces fichiers ne seront ",e.jsx("strong",{className:"text-red-300",children:"JAMAIS"})," modifiés par une Suture, même si l'IA essaie. Séparés par des virgules."]}),e.jsx("textarea",{value:Qe,onChange:i=>it(i.target.value),rows:3,className:"w-full bg-black/40 text-red-200 border border-red-500/20 rounded-lg px-3 py-2 text-[11px] font-mono outline-none focus:border-red-500/50 resize-none",placeholder:"src/design.css,package.json,..."}),e.jsx("div",{className:"flex flex-wrap gap-2",children:Qe.split(",").map(i=>i.trim()).filter(Boolean).map(i=>e.jsxs("span",{className:"flex items-center gap-1 bg-red-900/20 border border-red-500/30 text-red-300 text-[9px] font-mono px-2 py-1 rounded-full",children:["🔒 ",i,e.jsx("button",{onClick:()=>it(g=>g.split(",").map(v=>v.trim()).filter(v=>v!==i).join(", ")),className:"text-red-500 hover:text-white ml-1 font-bold",children:"×"})]},i))})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a0a0a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-yellow-400 flex items-center gap-2",children:"⚡ Actions Rapides Suture"}),e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx("button",{onClick:()=>y("http://localhost:5006/api/suture/purge-workspaces",{method:"POST"}).then(i=>alert(i?"✅ Bac à sable vidé !":"❌ Moteur inaccessible (Mode Cloud SaaS)")).catch(()=>alert("❌ Moteur inaccessible")),className:"py-3 bg-orange-900/20 hover:bg-orange-900/40 border border-orange-500/30 text-orange-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"🗑️ Vider le Bac à Sable"}),e.jsx("button",{onClick:()=>It(),className:"py-3 bg-blue-900/20 hover:bg-blue-900/40 border border-blue-500/30 text-blue-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"🔄 Rafraîchir Historique"}),e.jsx("button",{onClick:()=>y("http://localhost:5006/api/suture/rollback-last",{method:"POST"}).then(i=>i?i.json():null).then(i=>alert(i?i.success?`✅ Rollback : ${i.message}`:`❌ ${i.error}`:"❌ Moteur inaccessible (Mode Cloud SaaS)")).catch(()=>alert("❌ Moteur inaccessible")),className:"py-3 bg-purple-900/20 hover:bg-purple-900/40 border border-purple-500/30 text-purple-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"↩️ Rollback Dernier Patch"}),e.jsx("button",{onClick:pn,className:`py-3 border rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all ${Fe==="saved"?"bg-green-900/40 border-green-500/50 text-green-300":"bg-cyan/10 hover:bg-cyan/20 border-cyan/40 text-cyan"}`,children:Fe==="saved"?"✅ Sauvegardé !":"💾 Sauvegarder Config"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-gray-400 flex items-center gap-2",children:"📋 Historique des Réparations"}),e.jsx("button",{onClick:()=>It(),className:"text-[9px] text-cyan hover:text-white bg-cyan/10 px-2 py-1 rounded",children:"Actualiser"})]}),e.jsxs("div",{className:"max-h-[200px] overflow-y-auto hide-scrollbar space-y-2",children:[ze&&e.jsx("div",{className:"text-center text-gray-500 text-[10px] animate-pulse py-4",children:"⏳ Chargement..."}),!ze&&Be.length===0&&e.jsx("div",{className:"text-center text-gray-600 text-[10px] italic py-4",children:"Aucune réparation trouvée. Cliquez sur 🩺 dans l'explorateur pour lancer une Suture."}),Be.map((i,g)=>e.jsxs("div",{className:`flex items-center justify-between p-3 rounded-lg border text-[10px] font-mono ${i.status==="applied"?"bg-green-900/10 border-green-500/20":i.status==="failed"?"bg-red-900/10 border-red-500/20":"bg-white/5 border-white/10"}`,children:[e.jsxs("div",{className:"flex flex-col gap-0.5 truncate flex-1 mr-2",children:[e.jsx("span",{className:"text-white font-bold truncate",children:i.repairId||i.id}),e.jsxs("span",{className:"text-gray-500 truncate",children:[i.projectId," — ",i.activeFile||"?"]}),e.jsx("span",{className:"text-gray-600",children:i.startedAt?new Date(i.startedAt).toLocaleString("fr-FR"):""})]}),e.jsx("span",{className:`shrink-0 px-2 py-0.5 rounded-full border text-[9px] font-bold ${i.status==="applied"?"bg-green-900/30 border-green-500/40 text-green-300":i.status==="failed"?"bg-red-900/30 border-red-500/40 text-red-300":"bg-yellow-900/30 border-yellow-500/40 text-yellow-300"}`,children:i.status==="applied"?"✅ Appliqué":i.status==="failed"?"❌ Échec":"⚠️ Partiel"})]},g))]})]})]}),b==="creation"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn flex flex-col mt-8 border-t border-white/10 pt-8 pr-2",children:[e.jsxs("div",{className:"flex flex-col border-b border-white/5 pb-4",children:[e.jsxs("h2",{className:"text-2xl font-black text-white flex items-center gap-2 tracking-wide uppercase",children:[e.jsx("span",{children:"⚙️"})," CONFIGURATION DU PROJET"]}),e.jsx("p",{className:"text-[10px] text-gray-400 mt-1",children:"Générez et paramétrez votre projet de A à Z."})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1 min-h-0",children:[e.jsxs("div",{className:"transition-opacity duration-1000",children:[e.jsxs("div",{className:"bg-[#050505] border border-white/5 rounded-xl flex flex-col gap-4 overflow-y-auto hide-scrollbar p-5 mb-6",children:[e.jsxs("h3",{className:"text-white font-bold text-xs mb-2 flex items-center gap-2",children:[e.jsx("span",{className:"text-yellow-500",children:"📁"})," Création & Ciblage"]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"CIBLER UN PROJET EXISTANT"}),e.jsxs("select",{value:_,onChange:i=>M(i.target.value),onClick:async()=>{if(I.length===0)try{const i=await y("http://localhost:5006/api/projects");if(i&&i.ok){const g=await i.json();g.projects&&x(g.projects)}else{const v=await(await fetch("/api/projects")).json();v.projects&&x(v.projects.map(j=>j.project_id||j.title))}}catch{}},className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 outline-none focus:border-cyan text-xs",children:[e.jsx("option",{value:"",children:"-- SÉLECTIONNER UN PROJET --"}),I.map(i=>e.jsx("option",{value:i,children:i},i))]}),_&&Et==="idle"&&e.jsx("button",{onClick:async()=>{Ge("loading");try{const i=await y("http://localhost:5006/api/bridge/export-notebooklm",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:_,notebookId:Ue,authCookie:ut})});if(!i){alert("Mode Cloud SaaS : Bridge local non connecté."),Ge("idle");return}const g=await i.json();g.success?(Dt(g.combinedContent||""),g.pushLog&&g.pushLog.includes("Failed:")?(ct(g.pushLog),Ge("error")):Ge("ready")):(ct(g.message),Ge("error"))}catch{ct("Erreur de connexion avec Kirov5."),Ge("error")}},className:"mt-2 w-full bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-2",children:"📓 Préparer l'export NotebookLM"}),_&&Et==="loading"&&e.jsx("button",{disabled:!0,className:"mt-2 w-full bg-gray-900/50 text-gray-400 border border-gray-700/50 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider flex items-center justify-center gap-2",children:"⏳ Extraction de l'expertise..."}),_&&Et==="ready"&&e.jsx("button",{onClick:async()=>{try{await navigator.clipboard.writeText(et),window.open("https://notebook.google.com/notebook/6cd96956-200e-4260-ae7d-6c1446de284a","_blank"),Ge("idle")}catch{alert("❌ Copie échouée. Essayez sur HTTPS ou utilisez Ctrl+C manuellement.")}},className:"mt-2 w-full bg-green-900/40 hover:bg-green-800/60 text-green-300 border border-green-500/50 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-2",children:"✅ Copier & Ouvrir NotebookLM"}),_&&Et==="error"&&e.jsxs("div",{className:"mt-2 p-3 bg-red-900/30 border border-red-500/50 rounded-lg",children:[e.jsx("div",{className:"text-red-400 text-[10px] font-bold mb-2",children:"⚠️ Échec du script Python (Copiez l'erreur ci-dessous) :"}),e.jsx("textarea",{readOnly:!0,value:tt,className:"w-full h-24 bg-black/50 text-red-300 text-[10px] font-mono p-2 rounded border border-red-500/20 outline-none"}),e.jsxs("div",{className:"flex gap-2 mt-2",children:[e.jsx("button",{onClick:()=>Ge("idle"),className:"flex-1 bg-gray-800 hover:bg-gray-700 text-white text-[10px] py-2 rounded font-bold",children:"🔄 Réessayer"}),e.jsx("button",{onClick:async()=>{try{await navigator.clipboard.writeText(et),window.open("https://notebook.google.com/notebook/6cd96956-200e-4260-ae7d-6c1446de284a","_blank"),Ge("idle")}catch{alert("❌ Copie échouée.")}},className:"flex-1 bg-green-900/50 hover:bg-green-800/70 text-green-300 border border-green-500/50 text-[10px] py-2 rounded font-bold",children:"✅ Fallback Manuel"})]})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"NOM DU NOUVEAU PROJET"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"text",value:K,onChange:i=>We(i.target.value),placeholder:"Ex: MonSuperProjet",className:"flex-1 bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan"}),e.jsx("button",{onClick:async()=>{if(!K){alert("Entrez un nom de projet");return}try{const i=await y("http://localhost:5006/api/projects/set-active",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:K.trim()})});if(i&&i.ok){const g=await i.json();if(g.success){if(alert(`✅ Projet "${K}" créé avec succès !
Chemin : ${g.projectDir}`),x){const v=await y("http://localhost:5006/api/projects").then(j=>j?j.json():null).catch(()=>({}));v&&v.projects&&x(v.projects)}}else alert("❌ Erreur: "+g.message)}else{const g=localStorage.getItem("kirov5_jwt_token")||"",j=await(await fetch("/api/projects",{method:"POST",headers:{"Content-Type":"application/json",...g?{Authorization:`Bearer ${g}`}:{}},body:JSON.stringify({title:K.trim(),description:"Projet Cloud SaaS"})})).json();j.success||j.project?alert(`✅ Projet Cloud "${K}" créé avec succès sur Neon DB !`):alert("❌ Erreur de création Cloud: "+(j.error||"Impossible d'accéder au serveur"))}}catch{alert("❌ Erreur de connexion avec Kirov5.")}},className:"bg-[#0f2a2a] hover:bg-[#153f3f] text-cyan border border-cyan/30 px-4 py-2 rounded-lg text-xs font-bold transition-colors",children:"Valider"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"STACK TECHNIQUE"}),e.jsxs("select",{value:Xt,onChange:i=>Qt(i.target.value),className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",children:[e.jsx("option",{value:"vite",children:"⭐ 1er Choix (Prioritaire) : Vite + React + Tailwind + TS"}),e.jsx("option",{value:"nextjs",children:"Next.js 16 + Tailwind"})]})]}),e.jsxs("div",{className:"flex-1 flex flex-col",children:[e.jsxs("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2 flex items-center gap-1",children:[e.jsx("span",{className:"text-white",children:"📄"})," INSTRUCTIONS / VISION"]}),e.jsx("textarea",{value:Ee,onChange:i=>Wt(i.target.value),placeholder:"Décrivez l'application ou copiez votre PRD...",className:"w-full flex-1 min-h-[120px] bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan resize-none"})]})]}),e.jsxs("div",{className:"bg-[#050505] border border-white/5 rounded-xl flex flex-col gap-4 overflow-y-auto hide-scrollbar p-5 transition-opacity duration-1000",children:[e.jsxs("h3",{className:"text-white font-bold text-xs mb-2 flex items-center gap-2",children:[e.jsx("span",{className:"text-yellow-500",children:"⚡"})," Paramètres & IA"]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"INTELLIGENCE CIBLE"}),e.jsxs("select",{className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",onChange:i=>{const g=i.target.value;window.KIROV_TARGET_AI=g,typeof window<"u"&&localStorage.setItem("tiger_targetAi",g);let v="";g==="stitch"?v="https://stitch.withgoogle.com":g==="deepseek"||g==="deepseek-web"?v="https://chat.deepseek.com":g==="gemini"?v="https://gemini.google.com":g==="chatgpt"?v="https://chatgpt.com":g==="claude"?v="https://claude.ai":g==="notebooklm"&&(v="https://notebooklm.google.com"),v&&y("http://localhost:5006/api/bridge/open-window",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:v})}).catch(j=>console.warn("Erreur ouverture fenêtre",j))},defaultValue:typeof window<"u"&&localStorage.getItem("tiger_targetAi")||"hermes",children:[e.jsx("option",{value:"notebooklm",children:"📓 NotebookLM (Google)"}),e.jsx("option",{value:"cloudflare",children:"☁️ Cloudflare Qwen 3 30B (Audit IA Grade Gold)"}),e.jsx("option",{value:"cloudflare-hermes",children:"⚡ Hermes Cloudflare Workers AI (Qwen Coder)"}),e.jsx("option",{value:"deepseek",children:"🩵 DeepSeek (Extension Web)"}),e.jsx("option",{value:"hermes",children:"🤖 Hermes Agent (API DeepSeek)"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT"}),e.jsx("option",{value:"claude",children:"🟣 Claude"})]})]}),e.jsxs("div",{children:[e.jsxs("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:["💉 MODE & LOT DE DÉPART (Val: ",S,")"]}),e.jsxs("select",{value:S,onChange:i=>A(Number(i.target.value)),className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",children:[e.jsx("option",{value:0,children:"🚀 TOUT : Pipeline Complète (Zero-Touch)"}),e.jsx("option",{value:1,children:"🎨 Phase 1 : Le Frontend (Stitch/v0)"}),e.jsx("option",{value:2,children:"⚙️ Phase 2 : Logique G5"}),e.jsx("option",{value:4,children:"🎨 Phase 3/4 : Câblage Métier (Business Wiring)"}),e.jsx("option",{value:5,children:"🔌 Phase 5 : Industrialisation & Backend"}),e.jsx("option",{value:9,children:"🪄 M.A.J UI : Pipeline Push UI/UX (One-Shot)"})]})]}),e.jsxs("div",{className:"flex flex-col gap-3 mt-4 bg-[#111] p-4 rounded-lg border border-white/5",children:[e.jsxs("label",{className:"flex items-center gap-3 text-[11px] font-bold text-gray-300 cursor-pointer",children:[e.jsx("input",{type:"checkbox",className:"accent-cyan w-4 h-4",checked:W,onChange:()=>T(!W)}),"🤖 AUTO-PILOT : ",W?"ON 🟢":"OFF ⚪"]}),e.jsxs("label",{className:"flex items-center gap-3 text-[11px] font-bold text-gray-300 cursor-pointer",children:[e.jsx("input",{type:"checkbox",className:"accent-cyan w-4 h-4",checked:L,onChange:()=>F(!L)}),"🔗 Injecter dans l'onglet ouvert"]})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-3 mt-4",children:[e.jsxs("div",{id:"btn-joindre-prd",className:`py-6 text-white text-[10px] font-bold rounded-lg border flex flex-col items-center justify-center gap-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${(window.KIROV_SELECTED_PACKS||J).length>0?"bg-indigo-600 border-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.6)]":"bg-[#2a1b3d] border-purple-500/30"}`,title:"Pack PRD sélectionné — Sera injecté automatiquement dans le contexte IA",children:[e.jsx("span",{className:"text-xl",children:"💎"}),e.jsx("span",{children:(window.KIROV_SELECTED_PACKS||J).length>0?`Packs PRD ${(window.KIROV_SELECTED_PACKS||J).length} ${(window.KIROV_SELECTED_PACKS||J)[0]}`:"Aucun Pack PRD"})]}),e.jsxs("button",{id:"btn-joindre-zip",onClick:()=>{Number(S)===0&&(Yt(!0),typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning","true")),rt()},className:`py-6 text-white text-[10px] font-bold rounded-lg border border-cyan/30 transition-all flex flex-col items-center justify-center gap-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${nt?"bg-[#1a3a40] hover:bg-[#204a50] pointer-events-auto shadow-[0_0_30px_rgba(8,179,201,0.6)] border-cyan scale-105 z-50 relative animate-pulse":"bg-[#1a2f3a] hover:bg-[#254250]"}`,children:[e.jsx("span",{className:"text-xl",children:"📎"}),"Joindre ZIP (Stitch)"]})]}),(()=>{const g={0:"🚀 LANCER PIPELINE COMPLÈTE (ONE-SHOT)",1:"✨ LANCER PHASE 1 (Prompt vers l'IA)",2:"⚙️ LANCER PHASE 2 (MULTI-BATCH)",3:"🎨 LANCER PHASE 3/4 (CÂBLAGE MÉTIER)",4:"🎨 LANCER PHASE 3/4 (CÂBLAGE MÉTIER)",5:"🔌 LANCER PHASE 5 (INDUSTRIALISATION)",9:"🛡️ LANCER PUSH UI"}[Number(S)];return g?e.jsx("button",{id:"btn-lancer-phase",onClick:()=>{const v=_||K;if(!v){alert("Veuillez sélectionner ou créer un projet !");return}Yt(!0),typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning","true"),setTimeout(()=>{var k;(k=document.getElementById("kirov-radar-queue"))==null||k.scrollIntoView({behavior:"smooth"})},500);const j=window.KIROV_TARGET_AI||typeof window<"u"&&localStorage.getItem("tiger_targetAi")||"hermes";if(Number(S)===5){y("http://localhost:5006/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:j,start_index:1,zip_mode:!0,start_phase:5,auto_pilot:W})}).then(k=>k?k.json():null).then(k=>{alert(k?`✅ PHASE 5 (INDUSTRIALISATION) LANCÉE !
L'orchestrateur génère l'infrastructure et certifie le projet.`:"Mode Cloud SaaS : Bridge local non disponible.")}).catch(k=>{console.error(k),alert("Erreur: Le moteur :5006 est-il lancé ?")});return}if(Number(S)===4||Number(S)===3){y("http://localhost:5006/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:j,start_index:1,zip_mode:!0,start_phase:4,auto_pilot:W,packs:window.KIROV_SELECTED_PACKS||[]})}).then(k=>k?k.json():null).then(k=>{alert(k?`✅ PHASE 3/4 (CÂBLAGE MÉTIER) LANCÉE !
L'orchestrateur prend le relais pour connecter et câbler la logique métier.`:"Mode Cloud SaaS : Bridge local non disponible.")}).catch(k=>{console.error(k),alert("Erreur: Le moteur :5006 est-il lancé ?")});return}if(Number(S)===0&&y("http://localhost:5006/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:j,start_index:1,zip_mode:!0,start_phase:0,auto_pilot:W})}).then(k=>k?k.json():null).then(k=>{k&&console.log("Trombone initialisé pour le Zero-Touch.")}).catch(k=>console.error(k)),Number(S)===2){y("http://localhost:5006/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:j,start_index:1,zip_mode:!0,start_phase:200,auto_pilot:W,packs:window.KIROV_SELECTED_PACKS||[]})}).then(k=>k?k.json():null).then(k=>{alert(k?`✅ PHASE 2 (LOGIQUE G5) LANCÉE !
L'orchestrateur prend le relais pour générer le Backend et intégrer les composants.`:"Mode Cloud SaaS : Bridge local non disponible.")}).catch(k=>{console.error(k),alert("Erreur: Le moteur :5006 est-il lancé ?")});return}y("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:"stitch",user_prompt:Ee||"Génère l'application avec ces packs et directives.",packs:window.KIROV_SELECTED_PACKS||[],target_project:v,phase_num:1})}).then(k=>{k&&alert("✅ Méga-Prompt généré avec succès ! Ouverture de Stitch dans l'IA Fantôme..."),y("http://localhost:5006/api/bridge/open-window",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:"https://stitch.withgoogle.com/"})}).catch(_e=>console.warn("Erreur ouverture fenêtre",_e))}).catch(k=>{console.error(k),alert("Erreur: Le moteur :5006 est-il lancé ?")})},className:`w-full mt-4 py-4 rounded-lg border transition-all flex justify-center items-center gap-2 text-[11px] font-black uppercase tracking-wider text-white ${Number(S)===0?"bg-gradient-to-r from-purple-600/60 to-pink-600/60 hover:from-purple-500/70 hover:to-pink-500/70 border-purple-500/50 shadow-[0_0_20px_rgba(168,85,247,0.4)]":"bg-gradient-to-r from-emerald-600/40 to-cyan-600/40 hover:from-emerald-500/50 hover:to-cyan-500/50 border-emerald-500/50 shadow-[0_0_15px_rgba(16,185,129,0.3)]"}`,children:g}):null})(),Number(S)===9&&e.jsxs("div",{className:"mt-2 p-4 border border-cyan/30 bg-[#0f2a2a]/40 rounded-xl",children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"CIBLE ET SOURCE DU DESIGN"}),e.jsxs("div",{className:"mb-3",children:[e.jsxs("div",{className:"flex items-center justify-between mb-1",children:[e.jsxs("label",{className:"text-[9px] text-cyan/70 font-bold uppercase tracking-wider",children:["PAGES CIBLES",Se.length>0&&!Ce&&e.jsxs("span",{className:"ml-2 text-cyan bg-cyan/20 px-1.5 py-0.5 rounded",children:[Se.length," sélectionnée",Se.length>1?"s":""]})]}),e.jsx("button",{onClick:async()=>{const i=_||K;if(!i){alert("Sélectionnez un projet actif d'abord !");return}try{const g=await y(`http://localhost:5005/api/projects/${i}/pages`);if(g&&g.ok){const v=await g.json();v.pages&&ye(v.pages)}}catch{}},className:"text-[9px] text-cyan bg-cyan/10 border border-cyan/30 px-2 py-0.5 rounded hover:bg-cyan/20 transition-all",children:"↻ Rafraîchir"})]}),e.jsxs("div",{onClick:()=>{en(!Ce),Oe([])},className:`flex items-center gap-2 px-3 py-2 rounded-lg mb-1 cursor-pointer border transition-all ${Ce?"bg-cyan/20 border-cyan/50 text-cyan":"bg-white/5 border-white/10 text-gray-400 hover:bg-white/10"}`,children:[e.jsx("div",{className:`w-3 h-3 rounded border flex items-center justify-center shrink-0 ${Ce?"border-cyan bg-cyan":"border-gray-500"}`,children:Ce&&e.jsx("span",{className:"text-white text-[8px] font-black leading-none",children:"✓"})}),e.jsx("span",{className:"text-[10px] font-black",children:"🚀 TOUTES LES PAGES (Auto-Mapping ZIP)"})]}),Ot.length===0?e.jsxs("div",{onClick:async()=>{const i=_||K;if(!i){alert("Sélectionnez un projet actif d'abord !");return}try{const g=await y(`http://localhost:5006/api/projects/${i}/pages`);if(g&&g.ok){const v=await g.json();v.pages&&ye(v.pages)}}catch{}},className:"text-[10px] text-gray-500 italic text-center py-3 border border-dashed border-white/10 rounded-lg cursor-pointer hover:border-cyan/30 hover:text-cyan/50 transition-all",children:["⏳ Cliquez pour charger les pages de « ",_||K||"?"," »"]}):e.jsxs("div",{className:"flex flex-col gap-1 max-h-[160px] overflow-y-auto",children:[!Ce&&e.jsxs("div",{className:"flex gap-1 mb-1",children:[e.jsx("button",{onClick:()=>Oe([...Ot]),className:"flex-1 text-[9px] text-cyan/70 border border-white/10 rounded px-2 py-1 hover:bg-white/5",children:"✔ Tout sélectionner"}),e.jsx("button",{onClick:()=>Oe([]),className:"flex-1 text-[9px] text-gray-500 border border-white/10 rounded px-2 py-1 hover:bg-white/5",children:"✕ Tout désélectionner"})]}),Ot.map(i=>{const g=i.replace("src/pages/","").replace(".tsx","").replace(".jsx",""),v=Ce||Se.includes(i);return e.jsxs("div",{onClick:()=>{Ce||Oe(j=>j.includes(i)?j.filter(ue=>ue!==i):[...j,i])},className:`flex items-center gap-2 px-3 py-2 rounded-lg cursor-pointer border transition-all ${Ce?"opacity-50 bg-white/5 border-white/10":v?"bg-cyan/15 border-cyan/50 text-cyan":"bg-white/5 border-white/10 text-gray-300 hover:bg-white/10"}`,children:[e.jsx("div",{className:`w-3 h-3 rounded border flex items-center justify-center shrink-0 ${v?"border-cyan bg-cyan":"border-gray-500"}`,children:v&&e.jsx("span",{className:"text-white text-[8px] font-black leading-none",children:"✓"})}),e.jsx("span",{className:"text-[10px] font-bold",children:g}),e.jsx("span",{className:"text-[9px] text-gray-600 ml-auto",children:".tsx"})]},i)})]}),(Ce||Se.length>0)&&e.jsx("div",{className:"mt-2 text-[9px] text-cyan/80 bg-cyan/5 border border-cyan/20 rounded px-2 py-1 font-mono",children:Ce?"✅ TOUTES LES PAGES seront traitées":`✅ ${Se.length} page(s) : ${Se.map(i=>i.replace("src/pages/","").replace(".tsx","")).join(", ")}`})]}),e.jsx("input",{type:"text",value:Mt,onChange:i=>Lt(i.target.value),placeholder:"Fichier ZIP (ex: v0-design.zip)",className:"w-full mb-3 bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 outline-none focus:border-cyan text-xs"}),yt&&e.jsx("div",{className:"mb-3 text-[10px] text-cyan font-bold p-2 bg-cyan/10 border border-cyan/20 rounded",children:yt}),e.jsxs("button",{disabled:qt,onClick:async()=>{const i=_||K;if(!i){alert("Sélectionnez un projet d'abord.");return}if(!Ce&&Se.length===0){alert("Cochez au moins une page ou sélectionnez 'Toutes les pages'.");return}if(!Mt){alert("Indiquez le nom du fichier ZIP.");return}const g=Ce?["ALL_PAGES"]:Se;De(!0),Ae(`🚀 Démarrage du push pour ${g.length===1&&g[0]==="ALL_PAGES"?"TOUTES LES PAGES":`${g.length} page(s)`}...`);try{for(let v=0;v<g.length;v++){const j=g[v],ue=j==="ALL_PAGES"?"ALL_PAGES":j.replace("src/pages/","").replace(".tsx","");Ae(`⏳ [${v+1}/${g.length}] Traitement de ${ue}...`);const k={projectId:i,targetFile:j,zipFileName:Mt,baseVersionId:"v1-current",mode:"strict-ui",targetRoute:"/",source:"vercel-interface",promotionMode:"disabled",idempotencyKey:`push-${i}-${j}-${Date.now()}`},_e=await y("http://localhost:5005/api/bridge/strict-ui-update",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(k)});if(!_e)throw new Error("Moteur local injoignable");const Te=await _e.json();if(!_e.ok||!Te.success)throw new Error(Te.message||"Erreur");const xt=Te.pushId;Ve(xt),await new Promise((Vt,wt)=>{const s=setInterval(async()=>{var l;try{const c=await y(`http://localhost:5005/api/bridge/strict-ui-update/${xt}?projectId=${i}`);if(!c)return;const w=await c.json();if(Ae(`⏳ [${v+1}/${g.length}] ${ue} — état: ${w.state}`),["promoted","preview_ready","validation_incomplete"].includes(w.state))clearInterval(s),Vt();else if(["failed","rejected","promotion_rejected"].includes(w.state)){clearInterval(s);const h=typeof w.error=="string"?w.error:((l=w.error)==null?void 0:l.message)||w.state;wt(new Error(`${ue}: ${h}`))}}catch{}},3e3)})}Ae("✅ Toutes les pages traitées avec succès !")}catch(v){Ae(`❌ ${v.message}`)}finally{De(!1)}},className:`w-full py-4 rounded-lg transition-all flex justify-center items-center gap-2 text-[11px] font-black uppercase tracking-wider text-white ${qt?"bg-gray-600 cursor-not-allowed":"bg-gradient-to-r from-blue-600/60 to-cyan-600/60 hover:from-blue-500/70 hover:to-cyan-500/70 border-cyan/50 shadow-[0_0_15px_rgba(8,179,201,0.4)]"}`,children:[e.jsx("span",{children:"🚀"})," LANCER PIPELINE PUSH UIUX (ONE-SHOT)"]}),Ie&&_t&&e.jsxs("button",{disabled:Ct,onClick:async()=>{const i=_||K;O(!0),Ae("🚀 Promotion en cours vers la Production...");try{const g=await y(`http://localhost:5005/api/bridge/strict-ui-update/${_t}/promote`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:i,promotionMode:"hybrid",confirm:!0})}),v=await g.json();g.ok&&v.success?(Ae(`✅ Promotion Atomique Réussie ! Version: ${v.versionId}`),Ut(!1)):Ae(`❌ Échec de la promotion: ${v.message||v.error}`)}catch(g){Ae(`❌ Erreur de promotion: ${g.message}`)}finally{O(!1)}},className:`w-full mt-3 py-4 rounded-lg transition-all flex justify-center items-center gap-2 text-[11px] font-black uppercase tracking-wider text-white ${Ct?"bg-gray-600 cursor-not-allowed":"bg-gradient-to-r from-green-600/60 to-emerald-600/60 hover:from-green-500/70 hover:to-emerald-500/70 border-emerald-500/50 shadow-[0_0_15px_rgba(16,185,129,0.4)]"}`,children:[e.jsx("span",{children:"🟢"})," PROMOUVOIR EN PRODUCTION (MERGE)"]})]})]})]}),e.jsxs("div",{className:"flex flex-col gap-4 overflow-y-auto hide-scrollbar",children:[e.jsx("div",{className:"bg-[#050505] border border-white/5 rounded-xl p-5",children:e.jsx(Ao,{activeProjectName:_||K,selectedStartPhase:Number(S),onPhaseChange:i=>A(i),onPackGenerated:(i,g,v)=>{window.dispatchEvent(new CustomEvent("update_kirov_packs",{detail:[i]})),g&&Wt(j=>j?`${j}

[INJECTION PRD] : ${g}`:g),Qt(v==="ecommerce"||v==="social"?"nextjs":"vite"),alert(`💎 Le Pack PRD '${i}' a été généré et lié automatiquement au projet !`)}})}),e.jsxs("div",{className:`bg-[#050505] border border-white/5 rounded-xl p-5 transition-all duration-500 ${nt?"shadow-[0_0_30px_rgba(8,179,201,0.3)] border-cyan/40":""}`,children:[e.jsx("h2",{className:"text-white font-bold text-[11px] mb-5 tracking-wide",children:'Workflow "Design-First" (Hybride)'}),e.jsxs("div",{className:"flex flex-col gap-3 text-[10px] font-mono text-gray-400 relative",children:[e.jsx("div",{className:"absolute left-[11px] top-6 bottom-6 w-px bg-white/5 z-0"}),Number(S)===0&&!W&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute left-[5px] top-[32px] bg-red-900/80 border border-red-500 rounded text-[8px] px-1 text-white z-20",children:"🛑 Pause"}),e.jsx("div",{className:"absolute left-[5px] top-[64px] bg-red-900/80 border border-red-500 rounded text-[8px] px-1 text-white z-20",children:"🛑 Pause"}),e.jsx("div",{className:"absolute left-[5px] top-[96px] bg-red-900/80 border border-red-500 rounded text-[8px] px-1 text-white z-20",children:"🛑 Pause"}),e.jsx("div",{className:"absolute left-[5px] top-[128px] bg-red-900/80 border border-red-500 rounded text-[8px] px-1 text-white z-20",children:"🛑 Pause"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#051505] border border-green-500/50 flex items-center justify-center text-green-400 shrink-0 text-[10px]",children:"0"}),e.jsx("span",{className:"text-green-400",children:"Création (Boilerplate)"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#051020] border border-blue-500/50 flex items-center justify-center text-blue-400 shrink-0 text-[10px]",children:"1"}),e.jsx("span",{className:"text-blue-400",children:"Génération UI (Stitch)"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#150520] border border-indigo-500/50 flex items-center justify-center text-indigo-400 shrink-0 text-[10px]",children:"2"}),e.jsx("span",{className:"text-indigo-400",children:"Scan HTML & Blueprint JSON"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#051a20] border border-cyan/80 flex items-center justify-center text-cyan shadow-[0_0_15px_rgba(8,179,201,0.4)] shrink-0 text-[10px]",children:"3"}),e.jsx("span",{className:"text-cyan font-bold",children:"Orchestration des Lots"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#200520] border border-purple-500/50 flex items-center justify-center text-purple-400 shrink-0 text-[10px]",children:"4"}),e.jsx("span",{className:"text-purple-400",children:"Génération Contractuelle"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#2a1a00] border border-orange-500/50 flex items-center justify-center text-orange-400 shrink-0 text-[10px]",children:"5"}),e.jsx("span",{className:"text-orange-400",children:"Validation Industrielle"})]})]})]}),e.jsx("div",{className:"flex flex-col gap-2 mb-2",children:e.jsxs("button",{onClick:async()=>{var v;const i=_||K;if(!i)return;const g=window.KIROV_TARGET_AI||"notebooklm";try{alert("Audit en cours... Hermes analyse votre code source pour générer le Pack Métier (Câblage). Veuillez patienter 15-30 secondes.");let j=`wiring-${i}`;try{const k=await y("http://localhost:5006/api/bridge/generate-wiring-pack",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:i,baseVersionId:"version-active",request:"Audite la coquille vide et propose le câblage métier.",targetFiles:[],targetRoutes:[],source:"phase-4-ui"})}),_e=k?await k.json():null;_e&&_e.success?j=((v=_e.data)==null?void 0:v.wiringPackId)||_e.wiringPackId||j:console.warn("[WIRING] Solde API DeepSeek insuffisant (402) ou fallback. Synthèse autonome activée.")}catch(k){console.warn("[WIRING] Fallback local:",k)}alert("✅ Pack PRD Métier (Logic Wiring) prêt : "+j+`
Lancement de la Phase 3/4 (Câblage Métier)...`);const ue={target_project:i,target_ai:g||"cloudflare",start_phase:4,wiringPackId:j,auto_pilot:W,packs:window.KIROV_SELECTED_PACKS||[]};y("http://localhost:5006/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(ue)}).then(k=>k?k.json():null).then(k=>{k&&(k.mode==="multi_batch"?alert("✅ "+k.message):k.error&&alert("❌ Erreur lors de l'injection : "+k.error))}).catch(k=>console.error("Trombone error",k))}catch(j){alert("❌ Erreur lors de l'audit: "+(j.message||j))}},className:"w-full bg-[#051a20] hover:bg-[#083040] border border-cyan/40 text-cyan px-4 py-3 rounded-lg text-[10px] font-bold transition-all flex justify-center items-center gap-2 shadow-[0_0_15px_rgba(8,179,201,0.2)]",children:[e.jsx("span",{children:"🔍"})," AUDITER LA COQUILLE VIDE (Générer Pack Métier)"]})}),e.jsxs("div",{className:"flex flex-col gap-2 mb-2",children:[e.jsxs("button",{onClick:()=>{const i=_||K;if(!i)return;const g=window.KIROV_TARGET_AI||"deepseek",v=Number(S)===4?{projectId:i,start_phase:4,wiringPackId:`wiring-${i.replace(/[^a-zA-Z0-9_-]/g,"")}`,promotionMode:"disabled",autoPilot:!0}:{target_project:i,target_ai:g,start_index:1,zip_mode:!0,start_phase:S};y("http://localhost:5006/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(v)}).catch(j=>console.error(j))},className:"w-full bg-[#0a1025] hover:bg-[#101a35] border border-indigo-500/30 text-indigo-200 px-4 py-3 rounded-lg text-[10px] font-bold transition-all flex justify-center items-center gap-2",children:[e.jsx("span",{children:"🚀"})," LANCER PIPELINE PUSH UIUX (ONE-SHOT)"]}),e.jsxs("button",{onClick:async()=>{const i=_||K;if(!i){alert("Sélectionnez un projet d'abord.");return}try{const g=await y("http://localhost:5006/api/bridge/reset-session",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:i})});if(!g){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const v=await g.json();alert(v.success?`🔓 ${v.message}`:`❌ ${v.error}`)}catch{alert("❌ Moteur :5006 inaccessible.")}},className:"w-full bg-[#2a0a0a] hover:bg-[#3d1010] border border-red-500/40 text-red-300 px-4 py-3 rounded-lg text-[10px] font-bold transition-all flex justify-center items-center gap-2",children:[e.jsx("span",{children:"🔓"})," DÉBLOQUER SESSION (Anti-Lockout)"]}),e.jsxs("button",{onClick:()=>{if(console.log("L'automatisation est lancée !"),!de.current||Object.keys(de.current).length===0){const g=_||K;if(!g)return;y("http://localhost:5006/api/debug/advance-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:g})}).catch(()=>null);return}const i=Object.keys(de.current)[0];y("http://localhost:5006/api/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:de.current[i].prompt,target_ai:i,phase_num:de.current[i].phase_num,is_multi_batch:de.current[i].is_multi_batch,project_id:de.current[i].project_id})}).catch(()=>null)},className:"w-full bg-[#250a25] hover:bg-[#351035] border border-purple-500/30 text-purple-200 px-4 py-3 rounded-lg text-[10px] font-bold transition-all flex justify-center items-center gap-2",children:[e.jsx("span",{children:"🚀"})," Lancer l'Automatisation (Phase 4)"]})]}),e.jsxs("div",{id:"kirov-radar-queue",className:`flex-1 bg-[#050505] rounded-xl p-4 flex flex-col gap-4 min-h-[150px] transition-all duration-1000 ${nt?"border-2 border-cyan shadow-[0_0_30px_rgba(8,179,201,0.2)]":"border border-white/5"}`,children:[e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("span",{className:"text-cyan font-bold text-[11px] flex items-center gap-2",children:[e.jsx("span",{className:"w-1 h-3 bg-cyan inline-block rounded-sm"})," Tâche Actuelle"]}),e.jsx("button",{onClick:async()=>{let i=null,g="deepseek";if(de.current&&Object.keys(de.current).length>0?(g=Object.keys(de.current)[0],i=de.current[g]):de.queue&&de.queue.length>0&&(i=de.queue[0],g=i.target_ai||"deepseek"),!i){alert("Aucune tâche active ni en attente.");return}const v=localStorage.getItem("tiger_bridgeUrl")||"http://localhost:5006";y(`${v}/v1/bridge/inject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:i.prompt,target_ai:g,phase_num:i.phase_num,is_multi_batch:i.is_multi_batch,project_id:i.project_id||i.target_project||"GTASTICH"})}).catch(()=>null),alert(`Prompt [${i.phase_name||i.phase_num||"Lot 1"}] poussé manuellement dans la zone texte KIROV5 (${g}) !`)},className:"bg-[#0f2a2a] text-cyan text-[8px] font-bold px-2 py-1 rounded transition-colors",children:"FORCER ENVOI"})]}),de.current&&Object.keys(de.current).length>0?Object.entries(de.current).map(([i,g])=>{const v=typeof g.prompt=="string"?g.prompt:JSON.stringify(g.prompt);return e.jsxs("div",{className:"bg-[#111] p-3 rounded-lg text-[9px] text-gray-400 font-mono",children:[e.jsxs("div",{className:"text-pink font-bold mb-1",children:["[",i.toUpperCase(),"] ",g.phase_name||"Tâche"]}),e.jsxs("div",{className:"truncate opacity-80",children:[v?v.substring(0,80):"","..."]})]},i)}):e.jsx("div",{className:"text-[10px] text-gray-500 italic pl-3",children:"Aucune tâche en cours."})]}),e.jsx("div",{className:"w-full h-px bg-white/5"}),e.jsxs("div",{className:"flex flex-col gap-2 flex-1 min-h-0",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("span",{className:"text-orange-400 font-bold text-[10px] flex items-center gap-2",children:[e.jsx("span",{children:"⏳"})," En attente (",de.queue.length,")"]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{onClick:async()=>{const i=localStorage.getItem("tiger_bridgeUrl")||"http://localhost:5006";for(let g=0;g<20;g++)await y(`${i}/v1/bridge/consume`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({})}).catch(()=>null)},className:"text-[9px] text-red-500 hover:text-red-400 border border-red-500/30 px-2 py-0.5 rounded",children:"🗑️ Vider"}),e.jsx("button",{onClick:()=>{const i=_||K||"GTASTICH",g=localStorage.getItem("tiger_bridgeUrl")||"http://localhost:5006";y(`${g}/api/debug/advance-batch`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:i})}).catch(()=>null)},className:"text-[9px] text-gray-500 hover:text-gray-300",children:"Passer (Skip)"})]})]}),e.jsx("div",{className:"flex-1 overflow-y-auto pr-1 space-y-2 hide-scrollbar",children:de.queue.length>0?de.queue.map((i,g)=>{var j;const v=typeof i.prompt=="string"?i.prompt:JSON.stringify(i.prompt);return e.jsxs("div",{className:"bg-[#111] border border-white/5 p-2 rounded flex flex-col gap-1",children:[e.jsxs("div",{className:"text-[9px] font-bold text-gray-400 flex justify-between",children:[e.jsxs("span",{children:["[",g+1,"] ",i.phase_name||"Action"]}),e.jsx("span",{className:"text-purple-400",children:(j=i.target_ai)==null?void 0:j.toUpperCase()})]}),e.jsxs("div",{className:"text-[8px] text-gray-600 font-mono truncate",children:[v?v.substring(0,60):"","..."]})]},g)}):e.jsx("div",{className:"text-[10px] text-gray-600 italic p-2 text-center border border-dashed border-white/5 rounded",children:"File vide."})})]})]})]}),e.jsxs("div",{className:"bg-black border border-white/10 rounded-xl p-3 flex flex-col gap-2 shadow-inner h-32 mt-4",children:[e.jsxs("div",{className:"text-[10px] text-green-500 font-mono font-bold flex items-center justify-between border-b border-white/5 pb-1",children:[e.jsx("span",{children:"> Moteur Kirov5 - Terminal Temps Réel"}),e.jsx("span",{className:"animate-pulse",children:"_"})]}),e.jsx("div",{className:"flex-1 overflow-y-auto font-mono text-[9px] text-gray-300 hide-scrollbar flex flex-col justify-end",children:Je.length===0?e.jsx("span",{className:"text-gray-600 italic",children:"En attente d'activité système..."}):Je.slice(-15).map((i,g)=>e.jsx("div",{className:i.includes("❌")?"text-red-400":i.includes("✅")?"text-green-400":i.includes("✍️")?"text-cyan":"",children:i},g))})]})]})]}),b==="override"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-xl font-black text-white border-b border-white/10 pb-2",children:"Mode Manuel (Override)"}),e.jsx("p",{className:"text-gray-400 text-xs mt-2",children:"Prenez le contrôle manuel si l'automatisation s'enraye."})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{className:"text-gray-300 font-bold text-sm",children:"Injection de prompt de secours"}),e.jsx("textarea",{value:bt,onChange:i=>Rt(i.target.value),placeholder:"Entrez le prompt à forcer dans DeepSeek...",className:"w-full h-32 bg-gradient-to-b from-gray-900/60 to-black/60 text-white border border-white/20 rounded-xl p-3 outline-none focus:border-cyan text-sm resize-none"}),e.jsxs("div",{className:"flex gap-3 pt-2",children:[e.jsx("button",{className:"flex-1 py-2 bg-gradient-to-r from-pink/30 to-pink/10 hover:from-pink/40 hover:to-pink/20 text-pink border border-pink/50 rounded-lg text-xs font-bold transition-all",children:"💉 Forcer Injection"}),e.jsx("button",{className:"flex-1 py-2 bg-gradient-to-r from-orange-500/30 to-orange-500/10 hover:from-orange-500/40 hover:to-orange-500/20 text-orange-400 border border-orange-500/50 rounded-lg text-xs font-bold transition-all",children:"📦 Forcer Capture"})]})]}),e.jsxs("div",{className:"bg-gradient-to-b from-black/50 to-black/70 border border-white/10 p-3 rounded-xl h-32 font-mono text-[10px] text-gray-400 overflow-y-auto",children:[e.jsx("span",{className:"text-white mb-2 block",children:"Log Override"}),"En attente d'action manuelle..."]})]}),b==="mouchard"&&e.jsxs("div",{className:"space-y-4 animate-fadeIn h-full flex flex-col",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-xl font-black text-white border-b border-white/10 pb-2",children:"Mouchard Système"}),e.jsx("p",{className:"text-gray-400 text-xs mt-2",children:"Surveillance en temps réel du flux de données."})]}),e.jsxs("div",{className:"flex-1 bg-gradient-to-b from-gray-900 to-black border border-white/10 rounded-xl p-4 font-mono text-xs overflow-y-auto space-y-2 relative",children:[e.jsx("div",{className:"absolute top-2 right-2 flex gap-2",children:e.jsx("button",{className:"text-[10px] bg-gradient-to-r from-red-500/30 to-red-500/10 text-red-400 px-2 py-1 rounded hover:from-red-500/40 hover:to-red-500/20",children:"[WIPE]"})}),e.jsx("div",{className:"text-white font-bold mb-3 border-b border-white/20 pb-1 inline-block",children:"LOG_STREAM"}),e.jsx("div",{className:"text-yellow-400",children:"[09:24:30] ⚠️ Bridge local non joignable (Failed to fetch (Bridge hors ligne) - Failed to fetch). Polling Vercel actif."}),e.jsx("div",{className:"text-green-400",children:"[09:24:30] KIROV5 Orchestrator v5.1.1 prêt — structure React (.tsx/.ts/.css) préservée."}),e.jsx("div",{className:"text-cyan",children:"[09:24:30] Onglets: Projets · Projet · Injection · Capture · GitHub + Bridge :5006."})]})]}),b==="home"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{className:"flex justify-between items-center border-b border-white/10 pb-4",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"🐯"})," TIGER IA — Hub d'Orchestration Souverain"]}),e.jsx("p",{className:"text-xs text-gray-400 mt-1",children:"Supervision de l'écosystème Zero-Touch et de l'orchestrateur G5."})]}),e.jsx("span",{className:"px-3 py-1 bg-green-500/20 text-green-400 border border-green-500/30 rounded-full text-xs font-bold animate-pulse",children:"● Moteur IA Actif"})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:[e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/70 p-4 rounded-2xl border border-cyan/30 shadow-lg",children:[e.jsx("div",{className:"text-cyan text-xs font-bold uppercase tracking-wider mb-1",children:"Moteur Local"}),e.jsx("div",{className:"text-2xl font-black text-white",children:"v5.0.0"}),e.jsxs("div",{className:"text-[10px] text-gray-400 mt-2 flex items-center gap-1",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-cyan"})," Bridge 5006 Opérationnel"]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/70 p-4 rounded-2xl border border-purple-500/30 shadow-lg",children:[e.jsx("div",{className:"text-purple-400 text-xs font-bold uppercase tracking-wider mb-1",children:"Agent Réflexion"}),e.jsx("div",{className:"text-2xl font-black text-white",children:"DeepSeek-R1"}),e.jsxs("div",{className:"text-[10px] text-gray-400 mt-2 flex items-center gap-1",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-purple-400"})," Mode Hybride Actif"]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/70 p-4 rounded-2xl border border-pink/30 shadow-lg",children:[e.jsx("div",{className:"text-pink text-xs font-bold uppercase tracking-wider mb-1",children:"Studio UI/UX"}),e.jsx("div",{className:"text-2xl font-black text-white",children:"Zero-Touch"}),e.jsxs("div",{className:"text-[10px] text-gray-400 mt-2 flex items-center gap-1",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-pink"})," Synchro Temps Réel"]})]})]}),e.jsxs("div",{className:"space-y-3 pt-2",children:[e.jsx("h3",{className:"text-sm font-bold text-gray-300 uppercase tracking-wider",children:"🚀 Actions Système Rapides"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3",children:[e.jsxs("button",{onClick:()=>window.open("http://localhost:3006","_blank"),className:"p-4 bg-gradient-to-r from-cyan/20 to-blue-500/20 hover:from-cyan/30 hover:to-blue-500/30 border border-cyan/40 rounded-xl text-left transition-all flex items-center justify-between group",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm group-hover:text-cyan transition-colors",children:"🌐 Ouvrir l'Interface Studio (Vercel)"}),e.jsx("div",{className:"text-xs text-gray-400",children:"Accès direct au tableau de bord localhost:3006"})]}),e.jsx("span",{className:"text-xl",children:"➔"})]}),e.jsxs("button",{onClick:async()=>{var i;try{const g=await y("http://localhost:5006/api/theme");if(!g){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const v=await g.json();alert("Thème synchronisé : "+(((i=v.activeTheme)==null?void 0:i.nom)||"Thème par défaut"))}catch{alert("Vérifiez que le serveur Electron :5006 est démarré.")}},className:"p-4 bg-gradient-to-r from-purple-500/20 to-pink/20 hover:from-purple-500/30 hover:to-pink/30 border border-purple-500/40 rounded-xl text-left transition-all flex items-center justify-between group",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm group-hover:text-purple-300 transition-colors",children:"🎨 Tester la Synchronisation Thème"}),e.jsx("div",{className:"text-xs text-gray-400",children:"Interroge l'API bridge :5006/api/theme"})]}),e.jsx("span",{className:"text-xl",children:"🔄"})]})]})]})]}),b==="electron"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{className:"flex justify-between items-center border-b border-white/10 pb-4",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"💻"})," Moteur Electron PC — Serveur Local"]}),e.jsx("p",{className:"text-xs text-gray-400 mt-1",children:"Gestion du pont d'exécution et du système de fichiers local."})]}),e.jsx("span",{className:"px-3 py-1 bg-cyan/20 text-cyan border border-cyan/40 rounded-full text-xs font-bold",children:"Port :5006"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"bg-black/50 p-4 rounded-xl border border-white/10 space-y-3 font-mono text-xs text-gray-300",children:[e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Dossier Racine Workspace :"}),e.jsx("span",{className:"text-cyan font-bold",children:"E:\\v0reponses"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Répertoire des Projets Sauvegardés :"}),e.jsx("span",{className:"text-green-400 font-bold",children:"v0-moteur-electron/v0saveprojets"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Fichier Configuration Thème :"}),e.jsx("span",{className:"text-yellow-400 font-bold",children:"theme-config.json"})]}),e.jsxs("div",{className:"flex justify-between",children:[e.jsx("span",{className:"text-gray-400",children:"Mode Bridge HTTP :"}),e.jsx("span",{className:"text-blue-400 font-bold",children:"Express API REST Active"})]})]}),e.jsxs("div",{className:"flex gap-3",children:[e.jsx("button",{onClick:async()=>{var i,g;try{const v=await y("http://localhost:5006/api/projects");if(!v){alert("Mode Cloud SaaS actif : Bridge Electron local non connecté.");return}const j=await v.json();alert(`Projets détectés (${((i=j.projects)==null?void 0:i.length)||0}) : 
`+(((g=j.projects)==null?void 0:g.join(`
`))||"Aucun"))}catch{alert("Erreur de connexion au bridge Express :5006")}},className:"flex-1 py-3 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl text-white font-bold text-xs transition-colors flex items-center justify-center gap-2",children:"📁 Lister les Projets Locaux"}),e.jsx("button",{onClick:()=>{alert("Le moteur Electron tourne sur la tâche principale Windows.")},className:"flex-1 py-3 bg-cyan/20 hover:bg-cyan/30 border border-cyan/40 rounded-xl text-cyan font-bold text-xs transition-colors flex items-center justify-center gap-2",children:"⚡ État du Processus Electron"})]})]})]}),b==="vercel"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{className:"flex justify-between items-center border-b border-white/10 pb-4",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-2",children:[e.jsx("span",{className:"text-pink",children:"▲"})," Studio Web Vercel — Preview & HMR"]}),e.jsx("p",{className:"text-xs text-gray-400 mt-1",children:"Interface frontend réactive et synchronisation en direct."})]}),e.jsx("span",{className:"px-3 py-1 bg-pink/20 text-pink border border-pink/40 rounded-full text-xs font-bold",children:"Vite Dev Server"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"bg-black/50 p-4 rounded-xl border border-white/10 space-y-3 text-xs text-gray-300",children:[e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"URL Dev Local :"}),e.jsx("span",{className:"text-cyan font-mono font-bold",children:"http://localhost:3006"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Design System CSS :"}),e.jsx("span",{className:"text-pink font-mono font-bold",children:"src/design.css"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Source de Vérité Design Tokens :"}),e.jsx("span",{className:"text-purple-400 font-mono font-bold",children:"src/design-tokens.json"})]}),e.jsxs("div",{className:"flex justify-between",children:[e.jsx("span",{className:"text-gray-400",children:"Hot Module Replacement (HMR) :"}),e.jsx("span",{className:"text-green-400 font-bold",children:"Actif (Modifications Instantanées)"})]})]}),e.jsx("div",{className:"flex gap-3",children:e.jsx("button",{onClick:()=>window.open("http://localhost:3006/admin-design","_blank"),className:"flex-1 py-3 bg-gradient-to-r from-pink/30 to-purple-500/30 hover:from-pink/40 hover:to-purple-500/40 border border-pink/50 rounded-xl text-white font-bold text-xs transition-colors flex items-center justify-center gap-2",children:"🎨 Ouvrir le Studio Admin Design"})})]})]}),b==="deepseek"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{className:"flex justify-between items-center border-b border-white/10 pb-4",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-2",children:[e.jsx("span",{className:"text-purple-400",children:"🐋"})," Modèle IA DeepSeek — Agent Logique"]}),e.jsx("p",{className:"text-xs text-gray-400 mt-1",children:"Paramètres du modèle de génération de code et d'architecture."})]}),e.jsx("span",{className:"px-3 py-1 bg-purple-500/20 text-purple-400 border border-purple-500/30 rounded-full text-xs font-bold",children:"DeepSeek-V3 / R1"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"bg-black/50 p-4 rounded-xl border border-white/10 space-y-3 text-xs text-gray-300",children:[e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Mode d'Exécution IA :"}),e.jsx("span",{className:"text-cyan font-bold",children:"Chat Web & API Hybride"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Fenêtre de Contexte :"}),e.jsx("span",{className:"text-green-400 font-bold",children:"128,000 Tokens"})]}),e.jsxs("div",{className:"flex justify-between",children:[e.jsx("span",{className:"text-gray-400",children:"Rôle Principal :"}),e.jsx("span",{className:"text-purple-400 font-bold",children:"Cerveau Backend & Génération de Fichiers"})]})]}),e.jsx("div",{className:"flex gap-3",children:e.jsx("button",{onClick:()=>window.open("https://chat.deepseek.com/","_blank"),className:"flex-1 py-3 bg-gradient-to-r from-purple-500/30 to-blue-500/30 hover:from-purple-500/40 hover:to-blue-500/40 border border-purple-500/40 rounded-xl text-white font-bold text-xs transition-colors flex items-center justify-center gap-2",children:"🐋 Ouvrir DeepSeek Web"})})]})]})]}),!n&&e.jsxs("div",{className:"p-4 border-t border-white/10 bg-gradient-to-b from-black/30 to-black/50 flex flex-wrap justify-between items-center gap-4 relative z-10",children:[e.jsxs("button",{onClick:()=>cn(!Le),className:`text-xs font-bold hover:underline flex items-center gap-1 ${Le?"text-green-500":"text-red-500"}`,children:[e.jsx("span",{className:`w-2 h-2 rounded-full animate-pulse ${Le?"bg-green-500":"bg-red-500"}`}),Le?"Extension Connectée":"Extension Déconnectée"]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-3",children:[$e&&e.jsx("span",{className:"text-green-400 font-bold text-xs flex items-center mr-2 animate-pulse",children:"✓ Sauvegardé"}),t&&e.jsx("button",{onClick:r,className:"px-4 py-2 rounded-xl text-white font-bold bg-gradient-to-r from-white/10 to-transparent hover:from-white/20 transition-colors text-sm",children:"Fermer"}),e.jsx("button",{onClick:st,className:"px-4 py-2 bg-gradient-to-r from-cyan to-blue-500 rounded-xl text-black font-black uppercase tracking-wider transition-all text-sm shadow-[0_0_15px_rgba(8,179,201,0.5)] whitespace-nowrap",children:"💾 SAUVER"})]})]})]})]})},Tt=({items:t})=>{const n=o.useRef(null);return e.jsx("div",{ref:n,className:"design-carte-carrousel-conteneur w-full max-w-full flex overflow-x-auto gap-4 py-4 px-2 hide-scrollbar scroll-smooth relative",style:{scrollBehavior:"smooth"},children:t.map((r,a)=>e.jsx("div",{className:"shrink-0 relative z-0 hover:z-10",children:r},a))})},Fn=Object.assign({"../../prd_packs/CHOU/README.md":ds,"../../prd_packs/app_web_pack/README.md":us,"../../prd_packs/audio_pack/README.md":ps,"../../prd_packs/blog_contenu_pack/README.md":ms,"../../prd_packs/chat_comms_pack/README.md":gs,"../../prd_packs/chatcom/README.md":hs,"../../prd_packs/commerce_paiement_pack/README.md":xs,"../../prd_packs/composant_pack/README.md":fs,"../../prd_packs/createur_pack/README.md":bs,"../../prd_packs/design_figma_xd_pack/README.md":vs,"../../prd_packs/diamond_bridge_v14_37/README.md":Ss,"../../prd_packs/e_commerce_pack/README.md":ys,"../../prd_packs/ecommerce_pack/README.md":_s,"../../prd_packs/evenement_pack/README.md":Cs,"../../prd_packs/feed_social_pack/README.md":Is,"../../prd_packs/forge_universelle/README.md":ws,"../../prd_packs/forms_inputs_pack/README.md":As,"../../prd_packs/formulaire_pack/README.md":Ps,"../../prd_packs/gamification_pack/README.md":Ts,"../../prd_packs/guest_apk_forge/README.md":js,"../../prd_packs/guest_bloguev1/README.md":ks,"../../prd_packs/guest_bric/README.md":Rs,"../../prd_packs/guest_bricbrac/README.md":Es,"../../prd_packs/guest_bros/README.md":Ds,"../../prd_packs/guest_bross/README.md":Ns,"../../prd_packs/guest_chat/README.md":Ms,"../../prd_packs/guest_colorful_landing_page/README.md":Ls,"../../prd_packs/guest_colorful_landing_page_builder/README.md":qs,"../../prd_packs/guest_cyberrunner/README.md":Us,"../../prd_packs/guest_facturescan_souverain/README.md":Os,"../../prd_packs/guest_fireguard_ai/README.md":Fs,"../../prd_packs/guest_flowforge_studio/README.md":Gs,"../../prd_packs/guest_game_launch_orchestrator/README.md":Vs,"../../prd_packs/guest_gametetris/README.md":Bs,"../../prd_packs/guest_gta_vi_store/README.md":zs,"../../prd_packs/guest_kirov5_forge/README.md":Hs,"../../prd_packs/guest_kirov_game_studio/README.md":Ks,"../../prd_packs/guest_landing_page_adaptive/README.md":$s,"../../prd_packs/guest_mariob/README.md":Ws,"../../prd_packs/guest_nebula_calc/README.md":Js,"../../prd_packs/guest_neonstack/README.md":Xs,"../../prd_packs/guest_neonstack_arcade/README.md":Qs,"../../prd_packs/guest_plateforme/README.md":Zs,"../../prd_packs/guest_plateformv2/README.md":Ys,"../../prd_packs/guest_preorder_management/README.md":er,"../../prd_packs/guest_production_ready_industrialization/README.md":tr,"../../prd_packs/guest_scraping_du_site_web_https_/README.md":nr,"../../prd_packs/guest_skills_platform_clone/README.md":sr,"../../prd_packs/guest_sovereign_production_platform/README.md":rr,"../../prd_packs/guest_stitchlab/README.md":ir,"../../prd_packs/guest_tetris_evolution/README.md":ar,"../../prd_packs/guest_tetris_nova/README.md":or,"../../prd_packs/guest_welcome_canvas/README.md":lr,"../../prd_packs/guest_welcome_portal/README.md":cr,"../../prd_packs/guest_welcome_vibes/README.md":dr,"../../prd_packs/guest_welcomecanvas/README.md":ur,"../../prd_packs/guest_workflow_automation_platform/README.md":pr,"../../prd_packs/guest_workflow_automation_studio/README.md":mr,"../../prd_packs/guest_workflow_orchestrator/README.md":gr,"../../prd_packs/health_fitness_pack/README.md":hr,"../../prd_packs/ia_pack/README.md":xr,"../../prd_packs/image_pack/README.md":fr,"../../prd_packs/interface_pack/README.md":br,"../../prd_packs/jeux_video_pack/README.md":vr,"../../prd_packs/landing_pack/README.md":Sr,"../../prd_packs/landing_saas_pack/README.md":yr,"../../prd_packs/layout_pack/README.md":_r,"../../prd_packs/local_maps_pack/README.md":Cr,"../../prd_packs/markdown_pack/README.md":Ir,"../../prd_packs/marketing_pack/README.md":wr,"../../prd_packs/mobile_pack/README.md":Ar,"../../prd_packs/mobile_shell_pack/README.md":Pr,"../../prd_packs/mobile_web_pack/README.md":Tr,"../../prd_packs/mock_master/README.md":jr,"../../prd_packs/pdf_docs_pack/README.md":kr,"../../prd_packs/pieces_jointes_pack/README.md":Rr,"../../prd_packs/prd_ai_apps_pack/README.md":Er,"../../prd_packs/prd_ai_voice_agent/README.md":Dr,"../../prd_packs/prd_auth_gateway/README.md":Nr,"../../prd_packs/prd_blog_magazine/README.md":Mr,"../../prd_packs/prd_crm_erp_pack/README.md":Lr,"../../prd_packs/prd_ecom_catalog/README.md":qr,"../../prd_packs/prd_ecom_checkout/README.md":Ur,"../../prd_packs/prd_ecom_digital_products/README.md":Or,"../../prd_packs/prd_game_leaderboard/README.md":Fr,"../../prd_packs/prd_layout_bento/README.md":Gr,"../../prd_packs/prd_layout_kanban/README.md":Vr,"../../prd_packs/prd_mobile_pack/README.md":Br,"../../prd_packs/prd_mobile_social/README.md":zr,"../../prd_packs/prd_pack/README.md":Hr,"../../prd_packs/prd_saas_billing_pro/README.md":Kr,"../../prd_packs/prd_saas_pack/README.md":$r,"../../prd_packs/prd_sovereign_fullstack/README.md":Wr,"../../prd_packs/prd_specs_pack/README.md":Jr,"../../prd_packs/prd_web_landing_pack/README.md":Xr,"../../prd_packs/productivity_pack/README.md":Qr,"../../prd_packs/produit_pack/README.md":Zr,"../../prd_packs/prompt_skills_pack/README.md":Yr,"../../prd_packs/saas_pack/README.md":ei,"../../prd_packs/specialise_pack/README.md":ti,"../../prd_packs/sqlite_inspector/README.md":ni,"../../prd_packs/stealth_bridge_v11_2/README.md":si,"../../prd_packs/texte_pack/README.md":ri,"../../prd_packs/universal_scraper/README.md":ii,"../../prd_packs/video_pack/README.md":ai,"../../prd_packs/web_blog_pack/README.md":oi,"../../prd_packs/widget_pack/README.md":li}),rn=t=>{for(const n in Fn)if(n.includes(`/${t}/README.md`)||n.includes(`\\${t}\\README.md`))return Fn[n];return null},To=({messages:t,showGuestPacks:n,setShowGuestPacks:r,guestPacksCount:a,guestPackSearchQuery:d,setGuestPackSearchQuery:p})=>e.jsx("div",{className:"design-carte-v0-guest flex-shrink-0 w-full xl:w-[320px] z-30",children:e.jsxs("div",{onClick:()=>r&&r(!n),className:`h-full rounded-2xl p-6 border flex flex-col justify-between transition-all cursor-pointer shadow-2xl relative overflow-hidden group ${n?"border-purple-400 bg-purple-950/40 shadow-[0_0_30px_rgba(168,85,247,0.3)]":"border-white/10 bg-black/60 hover:border-purple-500/50 hover:bg-purple-950/20"}`,children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-purple-500/10 to-transparent pointer-events-none"}),e.jsxs("div",{className:"relative z-10 flex flex-col h-full",children:[e.jsx("div",{className:"w-12 h-12 rounded-xl bg-purple-500/20 border border-purple-500/40 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform",children:e.jsx("span",{className:"text-2xl",children:"🐋"})}),e.jsx("h3",{className:"text-xl font-black text-white mb-1 leading-tight",children:"V0-GUEST"}),e.jsx("div",{className:"text-purple-400 font-bold text-xs uppercase tracking-widest mb-2",children:"Hermes PRD Pack Engine"}),e.jsxs("div",{className:"mb-2 relative",children:[e.jsx("input",{type:"text",placeholder:"Rechercher un pack Guest...",value:d||"",onChange:m=>p&&p(m.target.value),onClick:m=>m.stopPropagation(),className:"w-full bg-black/40 border border-purple-500/30 rounded-lg px-3 py-1.5 text-xs text-white placeholder-purple-400/50 focus:outline-none focus:border-purple-400 focus:bg-purple-900/20 transition-all"}),e.jsx("span",{className:"absolute right-2 top-1.5 text-purple-400/50 text-xs",children:"🔍"})]}),t&&t.length>0?e.jsxs("div",{className:"mt-2 p-3 bg-black/70 border border-purple-500/30 rounded-xl max-h-[280px] min-h-[160px] overflow-y-auto space-y-2 text-left shadow-inner flex-1",children:[e.jsxs("div",{className:"text-[10px] font-bold text-purple-300 uppercase tracking-wider mb-2 flex items-center justify-between border-b border-purple-500/20 pb-1",children:[e.jsx("span",{children:"💬 Discussion Chat Active"}),e.jsxs("span",{className:"text-[9px] text-purple-400 font-mono",children:[t.length," msg"]})]}),t.map((m,u)=>e.jsxs("div",{className:`p-2.5 rounded-xl text-xs leading-relaxed border ${m.role==="user"?"bg-purple-900/60 border-purple-400/50 text-purple-100 text-right ml-2":"bg-zinc-900/90 border-white/10 text-gray-200 mr-2"}`,children:[e.jsx("span",{className:"font-bold text-[9px] block opacity-70 mb-0.5",children:m.role==="user"?"Vous":"Hermes AI"}),m.content]},m.id||u))]}):e.jsx("p",{className:"text-xs text-zinc-400 leading-relaxed mb-3",children:"Accédez à vos propres packs sur-mesure générés localement par reverse engineering avec l'Agent Hermes."})]}),e.jsxs("div",{className:"relative z-10 mt-4 pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsxs("span",{className:"text-[10px] font-bold text-zinc-300 uppercase tracking-widest",children:[a||4," PACKS DISPONIBLES"]}),e.jsx("span",{className:`text-xl transition-transform ${n?"rotate-90 text-purple-400":"text-zinc-500 group-hover:text-purple-400"}`,children:"➔"})]})]})}),jo=({selectedPacks:t,togglePack:n,isClient:r,getCachedGradient:a,onDetailStateChange:d,messages:p,showGuestPacks:m,setShowGuestPacks:u,guestPackSearchQuery:I})=>{const[x,_]=o.useState({}),[M,P]=o.useState(null),[W,T]=o.useState([]),L=async()=>{try{const S=await y(`http://localhost:5006/api/bridge/list-guest-packs?t=${Date.now()}`,{cache:"no-store"});if(S&&S.ok){const A=await S.json(),J=A.data||A;J.success&&J.packs&&T(J.packs)}}catch(S){console.error("Erreur lecture guest packs",S)}},F=S=>{P(S),d&&d(!!S)};if(o.useEffect(()=>{Pt.forEach(S=>{const A=S.id;if(!x[A]){const J=rn(A);J&&_(b=>({...b,[A]:J}))}})},[]),o.useEffect(()=>{L()},[]),M){let S=x[M.packId]&&x[M.packId].trim().length>5?x[M.packId]:M.readmeText&&M.readmeText.trim().length>5?M.readmeText:rn(M.packId)||"";return(!S||S.trim().length<5)&&(S=`# 💎 PRD PACK : ${M.packName} (${M.packId})
...
*Le fichier README complet est disponible dans le dossier prd_packs/${M.packId}/README.md.*`),e.jsxs("div",{className:"design-fenetre-readme w-full rounded-3xl p-6 md:p-8 border-2 border-cyan/60 shadow-[0_0_80px_rgba(124,58,237,0.45)] my-4 relative animate-fadeIn text-white z-20 flex flex-col min-h-[480px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 flex-shrink-0",children:[e.jsxs("span",{className:"px-3.5 py-1.5 bg-cyan/20 text-cyan text-xs font-bold rounded-xl border border-cyan/40 flex items-center gap-2 shadow-sm",children:[e.jsx("span",{children:"💎"})," PACK PRD : ",M.packId]}),e.jsx("button",{onClick:()=>F(null),className:"w-10 h-10 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-xl flex items-center justify-center font-bold text-lg transition-all border border-cyan/40 cursor-pointer shadow-md",title:"Fermer (Retour aux packs)",children:"✕"})]}),e.jsx("h2",{className:"text-2xl md:text-3xl font-black text-cyan mb-2 leading-tight drop-shadow-[0_2px_10px_rgba(6,182,212,0.5)] flex-shrink-0",children:M.packName}),e.jsx("div",{className:"w-full h-px bg-gradient-to-r from-cyan via-purple-400 to-cyan/20 mb-4 flex-shrink-0"}),e.jsx("div",{className:"design-readme-contenu flex-1 text-white font-medium leading-relaxed whitespace-pre-wrap overflow-y-auto max-h-[500px] p-6 rounded-2xl border-2 border-cyan/50 font-mono text-sm shadow-[0_0_40px_rgba(8,179,201,0.3)] min-h-[300px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)",textShadow:"0 1px 2px rgba(0,0,0,0.8)"},children:S}),e.jsxs("div",{className:"mt-6 pt-4 border-t border-white/15 flex justify-between items-center flex-shrink-0",children:[e.jsxs("span",{className:"text-xs text-cyan/90 font-mono font-bold tracking-widest uppercase flex items-center gap-2",children:[e.jsx("span",{children:"⚡"})," SUTURE PRD ENGINE"]}),e.jsx("button",{onClick:()=>F(null),className:"px-6 py-2.5 bg-cyan/20 hover:bg-cyan/40 text-cyan font-bold rounded-xl transition-all border border-cyan/40 flex items-center gap-2 cursor-pointer hover:bg-cyan/30 shadow-md",children:"← Fermer & Retour aux packs"})]})]})}return e.jsxs("div",{id:"prd-packs-carousel-section",className:"w-full flex-1 min-w-0 my-2",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3 px-2",children:[e.jsxs("h4",{className:"design-prd-titre-section font-black uppercase tracking-widest text-cyan flex items-center gap-2",children:[e.jsx("span",{children:"💎"})," PACKS PRD DE CONNAISSANCES (",Pt.length,")"]}),t&&t.length>0&&e.jsxs("span",{className:"text-[11px] font-bold text-cyan bg-cyan/20 px-2.5 py-1 rounded-full border border-cyan/30",children:[t.length," pack(s) actif(s)"]})]}),e.jsx("div",{className:"flex gap-4 items-stretch relative w-full",children:e.jsx("div",{className:"flex-1 min-w-0 min-h-[480px] overflow-hidden py-4 flex items-center",children:m?W.length===0?e.jsxs("div",{className:"h-full min-h-[220px] rounded-2xl p-6 border border-purple-500/20 bg-purple-950/20 backdrop-blur-md flex flex-col items-center justify-center text-center",children:[e.jsx("p",{className:"text-purple-300 font-bold text-sm",children:"Aucun pack Guest n'a encore été généré."}),e.jsx("p",{className:"text-xs text-zinc-400 mt-2",children:"Utilisez l'interface V0-GUEST pour scanner un projet local et créer un pack sur-mesure."}),e.jsx("button",{onClick:L,className:"mt-4 text-xs text-purple-300 border border-purple-500/40 px-4 py-1.5 rounded-full hover:bg-purple-900/40 transition-colors",children:"🔄 Recharger les packs Guest"})]}):e.jsx(Tt,{items:W.filter(S=>{var J,b,U,X;if(!I)return!0;const A=I.toLowerCase();return((J=S.name)==null?void 0:J.toLowerCase().includes(A))||((b=S.description)==null?void 0:b.toLowerCase().includes(A))||((U=S.id)==null?void 0:U.toLowerCase().includes(A))||((X=S.category)==null?void 0:X.toLowerCase().includes(A))}).sort((S,A)=>(S.name||"").localeCompare(A.name||"")).map(S=>{const A=S.id,J=t?t.includes(A):!1;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${J?"border-purple-400 shadow-[0_0_25px_rgba(168,85,247,0.4)] bg-purple-950/60":"border-purple-500/20 hover:border-purple-400/60 bg-black/50"}`,children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${J?"bg-purple-500 text-white shadow-md":"bg-purple-500/20 text-purple-400 border border-purple-500/40"}`,children:e.jsx(yn,{size:18})}),e.jsx("span",{className:"px-2 py-0.5 bg-purple-500/20 text-purple-300 text-[10px] font-bold rounded-md uppercase tracking-wider border border-purple-500/30",children:"🐋 GUEST"})]}),n&&e.jsx("button",{onClick:b=>{b.stopPropagation(),n(A)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${J?"bg-purple-500 text-white shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-purple-500/40 hover:text-white"}`,children:J?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight truncate",children:S.name}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed text-zinc-300 text-xs line-clamp-4",children:S.description}),e.jsxs("div",{className:"mt-4 pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsxs("span",{className:"text-[10px] font-mono text-purple-400/80",children:[S.modulesCount," MODULES"]}),e.jsxs("button",{onClick:async()=>{var b;try{const U=await y(`http://localhost:5006/api/bridge/read-file?path=${encodeURIComponent(S.path+"/README.md")}`);let X="";if(U&&U.ok){const N=await U.json();X=((b=N.data)==null?void 0:b.content)||N.content||""}F({packId:A,packName:S.name,readmeText:X||`# PACK GUEST : ${S.name}

Spécifications techniques du pack Guest ${S.name}.

Module réutilisable scanné dans ${S.path}.`})}catch{F({packId:A,packName:S.name,readmeText:`# PACK GUEST : ${S.name}

Spécifications techniques du pack Guest ${S.name}.`})}},className:"design-prd-btn text-purple-400 text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-purple-500/30 transition-all",children:[e.jsx("span",{children:"📖"})," README →"]})]})]},A)})}):e.jsx(Tt,{items:Pt.map(S=>{const A=S.id,J=S.name,b=S.icon||es,U=t?t.includes(A):!1,q=(x[A]||rn(A)||"Spécifications techniques du contrat PRD.").replace(/^#+.*$/gm,"").replace(/^>.*$/gm,"").replace(/\[([^\]]+)\]\([^\)]+\)/g,"$1").replace(/[*_~`]/g,"").trim().split(`
`).map(te=>te.trim()).filter(te=>te.length>20),Q=q.length>0?q[0]:"Spécifications techniques du contrat PRD.",G=Q.length>180?Q.substring(0,180)+"...":Q;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${U?"border-cyan shadow-[0_0_25px_rgba(8,179,201,0.4)]":"border-white/10 hover:border-cyan/50"}`,style:{background:r?a("prd-card-"+A,.7):"rgba(0,0,0,0.7)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${U?"bg-cyan text-black shadow-md":S.color||"bg-cyan/20 text-cyan"}`,children:e.jsx(b,{size:20})}),e.jsx("span",{className:"px-2 py-0.5 bg-cyan/20 text-cyan text-[10px] font-bold rounded-md uppercase tracking-wider",children:"💎 PRD"})]}),n&&e.jsx("button",{onClick:te=>{te.stopPropagation(),n(A)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${U?"bg-cyan text-black shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-white/20 hover:text-white"}`,title:U?"Désélectionner ce pack":"Sélectionner ce pack pour l'IA",children:U?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight",children:J}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed",children:G}),e.jsxs("div",{className:"mt-auto pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-mono text-cyan/80",children:"MODULE PRD"}),e.jsxs("button",{onClick:async()=>{var B;let te=x[A]||rn(A)||"";try{const re=await y(`http://localhost:5006/api/bridge/read-file?packId=${encodeURIComponent(A)}`);if(re&&re.ok){const pe=await re.json(),D=pe.content||((B=pe.data)==null?void 0:B.content);D&&D.trim().length>5&&(te=D,_(E=>({...E,[A]:D})))}}catch(re){console.warn("API Bridge read fallback",re)}F({packId:A,packName:J,readmeText:te||`# 💎 PRD PACK : ${J} (${A})

### ⚙️ Spécifications techniques du contrat PRD

- **Identifiant Pack**: ${A}
- **Statut**: Actif & Intégré au Moteur Sovereign`})},className:"design-prd-btn text-cyan text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-cyan/30 transition-all hover:bg-cyan/10",children:[e.jsx("span",{children:"📖"})," Lire le README →"]})]})]},A)})})})})]})},Gn=({isClient:t,getCachedGradient:n,setActiveProject:r})=>{const[a,d]=o.useState([]),[p,m]=o.useState(!0),[u,I]=o.useState(!1),[x,_]=o.useState(null),M=(P=!1)=>{P?I(!0):m(!0);const W=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];y("http://localhost:5006/api/projects").then(T=>T?T.json():null).then(T=>{if(T&&T.success&&T.projects)d(T.projects.map((L,F)=>({name:typeof L=="string"?L:L.projectName||L.name||L.projectId,desc:"Environnement Local",bg:W[F%W.length],installed:L.installed}))),m(!1),I(!1);else{const L=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:L?{Authorization:`Bearer ${L}`}:{}}).then(F=>F?F.json():null).then(F=>{F&&F.projects&&d(F.projects.map((S,A)=>({name:S.project_id||S.title,desc:"SaaS Cloud (Neon DB)",bg:W[A%W.length]}))),m(!1),I(!1)}).catch(()=>{m(!1),I(!1)})}}).catch(()=>{m(!1),I(!1)})};return o.useEffect(()=>{M();const P=setInterval(()=>M(!0),5e3);return()=>clearInterval(P)},[]),p?e.jsx("div",{className:"p-4 text-cyan text-sm italic",children:"Actualisation de la liste des projets..."}):a.length===0?e.jsxs("div",{className:"p-4 flex flex-col items-center gap-3 text-center",children:[e.jsx("div",{className:"text-cyan text-sm italic",children:"Aucun projet trouvé sur votre disque dur."}),e.jsx("button",{onClick:()=>M(),className:"px-4 py-2 rounded-xl bg-cyan/20 border border-cyan/40 text-cyan text-xs font-bold hover:bg-cyan/40 transition-colors",children:"🔄 Rafraîchir la liste"})]}):e.jsx(Tt,{items:[...a.map((P,W)=>{const T=async()=>{_(P.name),r(P.name);try{window.dispatchEvent(new CustomEvent("open-mouchard")),await y(`http://localhost:5006/api/projects/${encodeURIComponent(P.name)}/launch-design`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:P.name,open_explorer:!1})}).catch(F=>console.error("Erreur de lancement :",F))}catch(F){console.error("Erreur de lancement :",F)}finally{setTimeout(()=>_(null),2e3)}},L=async F=>{if(F.preventDefault(),F.stopPropagation(),window.confirm(`⚠️ SUPPRESSION DEFINITIVE :
Voulez-vous vraiment supprimer le projet "${P.name}" de l'interface ET de votre disque dur ?`))try{const S=await y("http://localhost:5006/api/projects/remove-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:P.name})});if(!S){d(J=>J.filter(b=>b.name!==P.name));return}const A=await S.json();A.success?d(J=>J.filter(b=>b.name!==P.name)):alert(`Erreur lors de la suppression : ${A.message||"Échec server"}`)}catch(S){alert(`Erreur réseau lors de la suppression : ${S.message}`)}};return e.jsxs("div",{className:"design-carte-carrousel rounded-2xl p-5 border border-white/20 shadow-xl flex flex-col items-center text-center relative overflow-hidden group cursor-pointer",style:{background:t?n("proj-"+W,.7):"rgba(0,0,0,0.5)"},onClick:T,children:[e.jsx("button",{onClick:L,className:"z-20 absolute top-3 right-3 w-8 h-8 rounded-full bg-red-600/80 hover:bg-red-500 text-white font-bold text-xs flex items-center justify-center transition-all shadow-lg hover:scale-110 cursor-pointer",title:"Supprimer ce projet du disque dur et de l'interface",children:"🗑️"}),e.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-30 mix-blend-overlay pointer-events-none"}),e.jsx("div",{className:"absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors z-0"}),e.jsxs("div",{className:"z-10 relative pointer-events-none w-full pr-8",children:[e.jsx("div",{className:"text-white/70 text-xs font-bold uppercase tracking-widest drop-shadow-md",children:"PROJET"}),e.jsx("h3",{className:"design-carte-titre text-xl font-black text-white break-all drop-shadow-lg leading-tight w-full",children:P.name})]}),e.jsx("div",{className:"design-carte-desc z-10 relative text-sm text-white/90 font-medium drop-shadow-md pointer-events-none w-full",children:P.desc}),e.jsxs("div",{className:"z-10 flex items-center gap-2 mt-3",children:[e.jsx("button",{onClick:F=>{F.stopPropagation(),x!==P.name&&(P.installed===!1?(_(P.name),y("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:P.name})}).then(S=>{alert(S?"L'installation a démarré dans le terminal (Suture) ! Une fois terminée, vous pourrez lancer la Preview.":"Mode Cloud SaaS : Bridge local non connecté."),_(null),d(A=>A.map(J=>J.name===P.name?{...J,installed:!0}:J))}).catch(()=>_(null))):T())},disabled:x===P.name,className:`font-bold py-2 px-4 rounded-xl text-xs transition-all flex items-center gap-1.5 ${x===P.name?"bg-cyan-500/40 text-cyan-200 cursor-wait animate-pulse":P.installed===!1?"bg-orange-500/80 hover:bg-orange-600 text-white cursor-pointer":"bg-white/20 hover:bg-white/40 text-white cursor-pointer"}`,title:P.installed===!1?"Installer les dépendances requises pour ce projet":"Lancer la prévisualisation Vite",children:x===P.name?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin inline-block",children:"⏳"})," ",P.installed===!1?"Installation...":"Lancement..."]}):P.installed===!1?e.jsx(e.Fragment,{children:"📦 INSTALL"}):e.jsx(e.Fragment,{children:"🚀 PREVIEW"})}),P.installed!==!1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:F=>{F.stopPropagation(),_(P.name),y("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:P.name})}).then(S=>{alert(S?"Réinstallation démarrée dans le terminal !":"Mode Cloud SaaS : Bridge local non connecté."),_(null)}).catch(()=>_(null))},className:"bg-orange-500/30 hover:bg-orange-500/60 text-white font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center justify-center border border-orange-500/40",title:"Forcer la réinstallation des dépendances (npm install)",children:"🔄"}),e.jsx("button",{onClick:async F=>{F.stopPropagation();try{const S=await y("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:P.name})});if(!S){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const A=await S.json();alert(A.message||"Terminal ouvert !")}catch(S){alert("Erreur de connexion au bridge: "+S.message)}},className:"font-bold py-2 px-3 rounded-xl text-xs bg-purple-500/60 hover:bg-purple-500 text-white transition-all shadow-md",title:"Lancer manuellement avec pnpm run dev (ouvre un terminal)",children:"💻 PNPM"})]}),e.jsx("button",{onClick:L,className:"bg-red-600/30 hover:bg-red-600/60 text-red-200 border border-red-500/40 font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center gap-1",title:"Supprimer définitivement du disque dur",children:"🗑️ Supprimer"})]})]},W)})]})};function ko(){var wt;const t=o.useRef({}),n=(s,l=1)=>typeof window>"u"?`linear-gradient(135deg, rgba(17,17,17,${l}), rgba(34,34,34,${l}))`:(t.current[s]||(t.current[s]=Po(l)),t.current[s]),[r,a]=o.useState([]),[d,p]=o.useState(""),m=o.useRef(null),u=o.useRef(null),[I,x]=o.useState(!1),[_,M]=o.useState("connexion"),[P,W]=o.useState(!1),[T,L]=o.useState("clean");o.useRef(0);const[F,S]=o.useState(1),[A,J]=o.useState(!1),[b,U]=o.useState(!1),[X,N]=o.useState(!1);o.useEffect(()=>{let s=0;const l=setInterval(()=>{var c,w;if(typeof window<"u"){const h=(w=(c=window.Capacitor)==null?void 0:c.isNativePlatform)==null?void 0:w.call(c),f=!!window.AndroidBridge;(h||f)&&(U(!0),clearInterval(l))}s++>10&&clearInterval(l)},100);return()=>clearInterval(l)},[]);const[q,Q]=o.useState([]),[G,te]=o.useState(""),[B,re]=o.useState(["> Système Kirov5 initialisé. "+new Date().toLocaleTimeString()]),[pe,D]=o.useState([]),[E,me]=o.useState([]);o.useEffect(()=>{const s=l=>me(l.detail);return window.addEventListener("update_kirov_packs",s),()=>window.removeEventListener("update_kirov_packs",s)},[]),o.useEffect(()=>{window.KIROV_SELECTED_PACKS=E},[E]);const[ge,xe]=o.useState(!1),[ce,z]=o.useState(!1),[$,C]=o.useState([]),[Z,ne]=o.useState(!1),[ve,fe]=o.useState(""),[bt,Rt]=o.useState(""),[$e,Re]=o.useState(!1),[K,We]=o.useState(""),[Ee,Wt]=o.useState("Vite + React + Tailwind + TS"),[Le,cn]=o.useState(""),[Jt,An]=o.useState("deepseek"),[dn,Pn]=o.useState(""),[Xt,Qt]=o.useState(!0),[Et,Ge]=o.useState(!1),[et,Dt]=o.useState(null),[tt,ct]=o.useState(!1),[Ue,dt]=o.useState("idle"),[ut,pt]=o.useState([]),[vt,Zt]=o.useState(""),[nt,Yt]=o.useState(null);o.useEffect(()=>{let s;return Ue==="building"&&(s=setInterval(async()=>{try{const l=await y("http://localhost:5006/api/mobile/build-logs");if(l&&l.ok){const c=await l.json();c.logs&&c.logs.length>0&&pt(c.logs),c.isBuilding===!1&&c.result&&(c.result.success?(dt("success"),Yt(c.result.apkUrl)):dt("error"),clearInterval(s))}}catch(l){console.warn("Polling APK error",l)}},1e3)),()=>{s&&clearInterval(s)}},[Ue]);const[st,rt]=o.useState([]),[un,de]=o.useState(!1),Nt=o.useCallback(async s=>{de(!0);const l=[{id:"deepseek-r1-v0",tag:"⚡ DEEPSEEK R1",title:"DeepSeek-R1 & Moteur Souverain v0.1",desc:"Capacités de raisonnement avancé et de suture pour interfaces React.",content:`DeepSeek-R1 offre des capacités de raisonnement avancé pour l'analyse de contrats PRD et la génération zéro-touch de projets web complets.
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){rt(l),de(!1);return}const c=s||localStorage.getItem("tiger_apiKey");if(!c||!c.startsWith("sk-")||c.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){rt(l),de(!1);return}const w=new AbortController,h=setTimeout(()=>w.abort(),4e3),f=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${c}`},signal:w.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(h),f.ok){const R=await f.json(),H=JSON.parse(R.choices[0].message.content);H.news&&Array.isArray(H.news)&&H.news.length>0?rt(H.news):rt(l)}else f.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),rt(l)}catch(c){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",c),rt(l)}finally{de(!1)}},[]);o.useEffect(()=>{Nt()},[Nt]);const[Je,mt]=o.useState(!1),[qe,St]=o.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Se,Oe]=o.useState([]),[Ce,en]=o.useState("");o.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let l=JSON.parse(s);if(!Array.isArray(l))throw new Error("Not an array");const c="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";l=l.map(w=>w.name==="fold"?{...w,colors:{...w.colors,"bg-app":c}}:w),Oe(l)}catch{Oe([])}else{const l={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};Oe([l]),localStorage.setItem("tiger_saved_themes",JSON.stringify([l]))}},[]),o.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",qe),qe!=="random"){const l=((s=Se.find(c=>c.name===qe))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=l,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[qe,Se]);const Mt=()=>{if(!Ce.trim())return alert("Nom invalide");if(Se.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":n("icon-settings",.8),"icon-ai":n("icon-ai",.8),"icon-projects":n("icon-projects",.8),"icon-packs":n("icon-packs",.8),"icon-news":n("icon-news",.8),"bg-app":n("bg-app",.9)},l={name:Ce.trim(),colors:s},c=[...Se,l];Oe(c),localStorage.setItem("tiger_saved_themes",JSON.stringify(c)),St(l.name),en("")},Lt=(s,l)=>{l.stopPropagation();const c=Se.filter(w=>w.name!==s);Oe(c),localStorage.setItem("tiger_saved_themes",JSON.stringify(c)),qe===s&&St("random")},qt=s=>{me(l=>l.includes(s)?l.filter(c=>c!==s):[...l,s])},[De,yt]=o.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});o.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(De))},[De]);const[Ae,_t]=o.useState(!0),[Ve,Ct]=o.useState(!0),[O,Ie]=o.useState(null),[Ut,Ot]=o.useState(null),[ye,Ft]=o.useState(null),[oe,Xe]=o.useState(null),[Qe,it]=o.useState(""),[Be,gt]=o.useState([]);o.useEffect(()=>{y("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))D(s.projects.map(l=>({name:l,desc:"Projet local",bg:""})));else{const l=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:l?{Authorization:`Bearer ${l}`}:{}}).then(c=>c?c.json():null).then(c=>{c&&c.projects&&D(c.projects.map(w=>({name:w.project_id||w.title,desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[ze,Pe]=o.useState(null),[Ze,ht]=o.useState(""),[at,Gt]=o.useState(!1),[Fe,ot]=o.useState(!1),we=o.useRef(null);o.useEffect(()=>{if(we.current=null,O==="v0-guest"||O==="V0-Guest")ot(!0),Pe("http://localhost:3007"),ht("http://localhost:3007"),we.current="http://localhost:3007";else if(O){ot(!0);const l=ye&&JSON.stringify(ye).includes("next.config")?"http://localhost:3000":"http://127.0.0.1:5175";Pe(l),ht(l),we.current=l}else ot(!1),Pe(null)},[O,ye]),o.useEffect(()=>{const s=l=>{var c,w,h,f;if(((c=l.data)==null?void 0:c.type)==="CHANGE_PREVIEW_URL"){const R=l.data.route,H=R==="/"?"":`#${R}`;Pe(se=>{const Y=se?se.split("#")[0]:"http://127.0.0.1:5175/";return`${Y.endsWith("/")?Y:`${Y}/`}${H}`})}if(((w=l.data)==null?void 0:w.type)==="DESIGN_ELEMENT_CLICKED"||((h=l.data)==null?void 0:h.type)==="DESIGN_ELEMENT_DRAGGED"||((f=l.data)==null?void 0:f.type)==="DESIGN_ELEMENT_RESIZED"){const R=document.querySelector('iframe[title="Studio Admin Design"]');R&&R.contentWindow&&R.contentWindow.postMessage(l.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),o.useEffect(()=>{O&&y(`http://localhost:5006/api/fs/tree?project=${O}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&Ft(s.tree)}).catch(()=>{})},[O]),o.useEffect(()=>{O&&oe&&y(`http://localhost:5006/api/fs/read?project=${O}&file=${encodeURIComponent(oe)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&it(s.content)}).catch(()=>{})},[O,oe]);const tn=async s=>{if(s===void 0||!O||!oe)return;if(it(s),kt.isNativePlatform()||!!window.AndroidBridge)try{await qn.writeFile({path:`v0-moteur-mobile/projetv0/${O}/${oe}`,data:s,directory:on.Documents,encoding:vn.UTF8,recursive:!0})}catch(c){console.error("Erreur de sauvegarde mobile:",c)}else y("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:O,file:oe,content:s})}).catch(()=>{})},pn=s=>{O&&y(`http://localhost:5006/api/fs/read?project=${O}&file=${encodeURIComponent(s)}`).then(l=>l?l.json():null).then(l=>{l&&l.success&&gt(c=>c.find(w=>w.path===s)?c:[...c,{path:s,content:l.content}])}).catch(()=>{})};o.useEffect(()=>{(async()=>{const l=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(kt.isNativePlatform()||!!window.AndroidBridge)try{const h=(await qn.readdir({path:"v0-moteur-mobile/projetv0",directory:on.Documents})).files.map(f=>f.name||f.toString());D(h.map((f,R)=>({name:f,desc:"Mémoire Téléphone",bg:l[R%l.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else y("http://localhost:5006/api/projects-v2").then(w=>w?w.json():null).then(w=>{if(w&&w.success&&w.projects)D(w.projects.map((h,f)=>({name:h.name,desc:"Environnement Local",bg:l[f%l.length],installed:h.installed})));else{const h=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:h?{Authorization:`Bearer ${h}`}:{}}).then(f=>f?f.json():null).then(f=>{f&&f.projects&&D(f.projects.map((R,H)=>({name:R.project_id||R.title,desc:"SaaS Cloud (Neon DB)",bg:l[H%l.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),o.useEffect(()=>{J(!0)},[]);const[It,i]=o.useState(!0);o.useEffect(()=>{const s=()=>i(!0);window.addEventListener("open-mouchard",s);const l=c=>{if(c.data&&c.data.type==="TIGER_CAPTURE"){const w=c.data.data;if(w){let h="index.html";(w.includes("import React")||w.includes("export default"))&&(h="App.tsx"),w.includes("tailwindcss")&&(h="index.css"),Xe(h),tn(w),Ft(f=>{var se;const R={name:h,path:h,type:"file"};return f?((se=f.children)==null?void 0:se.find(Y=>Y.name===h))?f:{...f,children:[...f.children||[],R]}:{name:"Mobile_Storage",type:"directory",children:[R]}})}}};return window.addEventListener("message",l),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("message",l)}},[O,oe]),o.useEffect(()=>{if(!A||!Vn())return;const s=()=>{y("http://localhost:5006/api/bridge/queue").then(c=>c?c.json():null).then(c=>{c&&c.success&&(setBridgeQueueData({current:c.current||{},queue:c.queue||[]}),(c.queue&&c.queue.length>0||c.current&&Object.keys(c.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),y("http://localhost:5006/api/bridge/logs").then(c=>c?c.json():null).then(c=>{if(c&&c.success&&c.logs){re(c.logs);const w=[...c.logs].reverse().find(h=>h.includes("URL_PREVIEW="));if(w){const h=w.split("URL_PREVIEW=")[1];h!==we.current&&(we.current=h,Pe(h),ht(h))}}}).catch(()=>{}),y("http://localhost:5006/api/bridge/autonomous-status").then(c=>c?c.json():null).then(c=>{if(c&&c.success&&(c.data||c.status)){const h=(c.data||c.status).state;h==="diagnosing"||h==="repair_required"||h==="error"?L("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(h)||["starting_server","launch_requested","restarting"].includes(h)?L("working"):h==="ready"?L("clean"):O&&y(`http://localhost:5006/api/suture/status?project=${O}`).then(f=>f?f.json():null).then(f=>{f&&f.success&&f.status&&L(f.status)}).catch(()=>{})}}).catch(()=>{})};s();const l=setInterval(s,2e3);return()=>clearInterval(l)},[A,O]);const g=s=>{const l=typeof s=="string"?s:d;if(!l.trim())return;const c={id:Date.now().toString(),role:"user",content:l};a(h=>[...h,c]);const w=l.toLowerCase();setTimeout(()=>{let h={id:(Date.now()+1).toString(),role:"assistant",content:""};const f=w.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(f==="mes projets"||f.includes("liste des projet")||f==="projet"||f==="projets")h.content="Voici la liste de vos projets récents :",h.widget="projects";else if((f.includes("stitch")||f.includes("deepseek")||f.includes("design")||f.includes("logique"))&&(f.includes("modifi")||f.includes("ajoute")||f.includes("change")||f.includes("mise a jour")||f.includes("evolue")||f.includes("reprends")||f.includes("continue"))){const R=l.match(/\[(.*?)\]/),H=R?R[1]:null,se=f.includes("deepseek")?"deepseek":"stitch";h.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${se.toUpperCase()}) 🔄

J'injecte vos nouvelles directives directement dans votre interface... ${H?`
🔍 Recherche et AutoSwitch vers le projet : "${H}"`:"Reprise du travail en cours."}`,h.widget=null,y("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:se,target_project:H,prompt:"Mise à jour (Reprise de projet) : "+l.replace(/\[.*?\]/,"").trim(),auto_submit:!0})}).catch(Y=>console.log("Erreur de connexion au Bridge local pour l'injection",Y))}else if(f.includes("cree")||f.includes("lance")||f.includes("projet")||f.includes("generation")){h.content=`🚀 DÉMARRAGE PARALLÈLE KIROV5 🚀
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,h.widget="phases",S(1);const R=O||(K.trim()?K.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+l.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(Ie(R),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",R),typeof window<"u"){const Y=localStorage.getItem("tiger_targetAi")||"deepseek",ee=localStorage.getItem("tiger_targetUiAi")||"stitch",je=(V,le=!1)=>Ke(V,le),Ne=window.AndroidBridge;if(Ne&&Ne.openAIWithPrompt)Ne.openAIWithPrompt(je(ee,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+l),Ne.showToast&&Ne.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const V=E&&E.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${E.length})]
`+E.map(be=>{const ie=Pt.find(he=>he.id===be);return`• ${ie?ie.name:be} (#${be})`}).join(`
`):"",le="Génère l'interface UI/UX complète et moderne pour ce projet : "+l+V;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(le)}catch{}const Ye=()=>y("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:ee,prompt:le,auto_submit:!0,project_id:R,phase_num:1,packs:E})});De!==200&&(Ve?window.open(je(ee,!0),"kirov5_ai_target"):window.open(je(ee,!0),"_blank"),Ye().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(be=>console.error("Erreur sendUiPrompt",be))),setTimeout(()=>{const be=E&&E.length>0?l+V:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+l+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(be)}catch{}window.open(je(Y),"_blank"),y("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Y,prompt:be,auto_submit:!0,project_id:R,phase_num:1,packs:E})}).catch(ie=>console.log("Erreur Bridge Logic Prompt:",ie)),E&&E.length>0?y("http://localhost:5006/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Y,user_prompt:be,packs:E,target_project:R})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(ie=>{console.log("Erreur Trombone Bridge:",ie)}):y("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Y,prompt:be,auto_submit:!0,project_id:R,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}S(1);let H=1;const se=setInterval(()=>{H++,H>11?clearInterval(se):S(H)},1500)}else if(f.includes("youtube")||f.includes("video"))h.content="Voici les résultats YouTube pour votre recherche :",h.widget="youtube";else if(f.includes("actualite")||f.includes("ia")||f.includes("news")||f.includes("recherche")){const R=localStorage.getItem("tiger_apiKey");h.content="Actualités & Dernières Innovations IA :",h.widget="news",Nt(R||void 0)}else if(f.includes("parametre")||f.includes("reglage")||f.includes("configuration")||f.includes("setting"))h.content="Ouverture du panneau de configuration système :",h.widget="settings";else if(f.includes("[plugin:vite:")||f.includes("missing semicolon")||f.includes("syntaxerror")||f.includes("typescriptparsermixin")||f.includes("babel/parser")||f.includes("error")&&f.length>80){const R=O||"Projet_blog_8831";h.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${R}" avec la stack trace fournie... 🩺`,k("suture",l)}else if(h.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const R=window.AndroidBridge;R&&R.openAIWithPrompt?R.openAIWithPrompt("https://chat.deepseek.com/",l):window.open("https://chat.deepseek.com/","_blank")}a(R=>[...R,h])},600),p("")},v=async s=>{var Ne;let l=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],c=null;const w=l.filter(V=>V.name.endsWith(".zip"));let h=[];if(w.length>0){a(V=>[...V,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const V=(await Ht(async()=>{const{default:le}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:le}},[])).default;for(const le of w){c=le;const be=await new V().loadAsync(le);for(const[ie,he]of Object.entries(be.files))if(!he.dir&&!ie.includes("__MACOSX")&&!((Ne=ie.split("/").pop())!=null&&Ne.startsWith("."))){const ke=await he.async("blob"),He=new File([ke],ie.split("/").pop()||ie,{type:ke.type});h.push(He)}}}catch(V){console.error("Erreur décompression ZIP:",V),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}}l=[...l.filter(V=>!V.name.endsWith(".zip")),...h];const f=l.filter(V=>V.name.endsWith(".html")),R=l.filter(V=>!V.name.endsWith(".html")&&(V.name.endsWith(".png")||V.name.endsWith(".jpg")||V.name.endsWith(".jpeg")||V.name.endsWith(".md")||V.name.endsWith(".json")||V.name.endsWith(".txt")));if(f.length===0&&R.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .png, ou un .zip.");return}let H=[...Be];for(const V of R){const le=V.name.endsWith(".png")||V.name.endsWith(".jpg")||V.name.endsWith(".jpeg"),Ye=await new Promise(ie=>{const he=new FileReader;he.onload=ke=>{var He;return ie((He=ke.target)==null?void 0:He.result)},le?he.readAsDataURL(V):he.readAsText(V)}),be={path:V.name,content:le?`[Image jointe visuellement : ${V.name} (Binaire ignoré pour économie de tokens)]`:Ye};H.some(ie=>ie.path===V.name)||H.push(be),a(ie=>[...ie,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${V.name}`}])}if(f.length>0){const V=f[0],le=await new Promise(ie=>{const he=new FileReader;he.onload=ke=>{var He;return ie((He=ke.target)==null?void 0:He.result)},he.readAsText(V)}),Ye={path:V.name,content:le};H.some(ie=>ie.path===V.name)||H.push(Ye);const be={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${V.name}
Analyse de la structure UI et assemblage du contexte en cours...`};a(ie=>[...ie,be])}const se=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter(V=>V.name.endsWith(".zip"));for(const V of se)H.some(le=>le.path===V.name)||H.push({path:V.name,content:"ZIP_ARCHIVE_DUMMY"});gt(H);const Y=O||K||"Projet_Stitch",ee=l.map(V=>V.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${Y}: ${ee}`);const je=f.length;if(je>3){const V=localStorage.getItem("tiger_targetAi")||"deepseek",le=c?"Projet_ZIP_"+c.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),Ye=O||le;O||Ie(Ye),a(ie=>[...ie,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !

Hermes a détecté ${je} pages HTML dans votre ZIP.
Découpage automatique en lots de 3 fichiers en cours...
Démarrage de l'automatisation séquentielle via DeepSeek !`,widget:"phases"}]),S(1);let be="";if(c)be=await new Promise(ie=>{const he=new FileReader;he.onload=ke=>{var He;return ie(((He=ke.target)==null?void 0:He.result).split(",")[1])},he.readAsDataURL(c)});else{const ie=(await Ht(async()=>{const{default:ke}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:ke}},[])).default,he=new ie;for(const ke of l)he.file(ke.name,ke);be=await he.generateAsync({type:"base64"})}y("http://localhost:5006/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({zip_base64:be,zip_mode:!0,target_ai:V,target_project:Ye,user_prompt:K.trim()?`${K} - ${Le}`:`Application multi-pages issue de ${(c==null?void 0:c.name)||"fichiers_locaux"}`})}).then(async ie=>{const he=await ie.json();he.success?(a(ke=>[...ke,{id:Date.now().toString()+"_hermes",role:"assistant",content:`✅ ${he.message}

📡 Lot 1/${he.total_batches} transmis à DeepSeek. Les lots suivants s'enchaîneront automatiquement !
Fichiers détectés : ${(he.files_detected||[]).join(", ")}`}]),window.open(Ke(V),"_blank")):alert("Erreur Hermes : "+(he.error||"Inconnue"))}).catch(ie=>{alert(`Erreur de connexion au Moteur Local : ${ie.message}`)});return}if(f.length>0){if(document.getElementById("creation-mode-container"))return;setTimeout(()=>{j(H)},1200)}},j=async(s=Be)=>{Re(!1);const l=s.find(Y=>Y.path.endsWith(".html"));if(!l){alert("Aucun fichier HTML trouvé dans le Trombone !");return}const c=K.trim()?"Projet_"+K.replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4):"Design_"+l.path.replace(".html","").replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4),w=O||c;if(!O){Ie(w);try{await y("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:w,file:"README.md",content:`# ${K||w}

Initialisé par Tiger IA V0 (Design-First).`})})}catch(Y){console.error("[IDE] Erreur création auto du dossier",Y)}}const h=s.filter(Y=>Y.path!==l.path),f=l.content,R={id:(Date.now()+1).toString(),role:"assistant",content:`Mode "Design-First" activé. 🎨

Transmission du design au LLM avec les ${h.length} fichiers du Trombone intégrés.
Câblage en cours...`,widget:"phases"};S(5),a(Y=>[...Y,R]);let H=5;const se=setInterval(()=>{H++,H>11?clearInterval(se):S(H)},3e3);if(typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Mode Design-First Activé !"),typeof window<"u"){const Y=localStorage.getItem("tiger_targetAi")||"deepseek";let ee="";h.length>0&&(ee=`
...
\`\`\`
`}));let je="";(K.trim()||Ee.trim()||Le.trim())&&(je=`
--- MÉTADONNÉES DU PROJET ---
Nom : ${K||"Non spécifié"}
Stack / Structure : ${Ee||"Non spécifiée"}
Description & Objectifs : ${Le||"Non spécifiés"}
-----------------------------
...
\`\`\`
`,V=window.AndroidBridge;if(V&&V.openAIWithPrompt){const le=Ke(Y);V.openAIWithPrompt(le,Ne),V.showToast&&V.showToast("HTML injecté. Câblage sur "+Y.toUpperCase()+" !")}else y("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Y,prompt:Ne,auto_submit:!0,project_id:w,phase_num:5})}).then(le=>console.log("[Bridge] Prompt HTML + Contexte envoyé avec succès, status:",le.status)).catch(le=>console.error("[Bridge] Erreur lors de l'envoi du prompt:",le))}},ue=(s,l=0)=>s?s.type==="directory"?e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-2 px-2 py-1 hover:bg-white/5 cursor-pointer text-gray-300 text-sm",style:{paddingLeft:`${l*12+8}px`},children:[e.jsx("span",{className:"text-orange-400",children:"📁"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-dossier truncate font-bold",children:s.name})]}),s.children&&s.children.map(c=>ue(c,l+1))]},s.path):e.jsxs("div",{className:`flex items-center justify-between px-2 py-1 hover:bg-white/10 cursor-pointer text-sm group ${oe===s.path?"bg-cyan/20 text-cyan border-l-2 border-cyan":"text-gray-400"}`,style:{paddingLeft:`${l*12+8}px`},onClick:()=>Xe(s.path),children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-blue-400",children:"📄"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-fichier truncate",children:s.name})]}),e.jsxs("div",{className:"hidden group-hover:flex items-center gap-1",children:[e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-red-500/50 transition-colors",title:"Suture : Réparer ou débugger ce fichier",onClick:c=>{c.stopPropagation(),Xe(s.path),setTimeout(()=>k("suture","Veuillez analyser ce fichier et corriger toutes les erreurs, fautes de frappe ou imports manquants."),100)},children:"🩺"}),e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-cyan/50 transition-colors",title:"Ajouter au Trombone",onClick:c=>{c.stopPropagation(),pn(s.path)},children:"📎"})]})]},s.path):null,k=async(s,l)=>{if(!O){alert("⚠️ Veuillez sélectionner un projet actif dans l'explorateur.");return}const c=localStorage.getItem("tiger_targetAi")||"deepseek";let w="";s==="suture"?w=`🩺 SUTURE CHIRURGICALE — CORRECTION D'ERREUR DÉTECTÉE
...
`):s==="refactor"?w=`🔄 REFACTORING — Refactorise le code du projet [${O}] pour une qualité industrielle.

`:s==="improve"&&(w=`✨ AMÉLIORATION — Ajoute des animations et améliorations UI pour le projet [${O}].

`),oe&&Qe&&(w+=`--- Fichier Actif en Édition : ${oe} ---
\`\`\`
${Qe}
\`\`\`

`),Be.length>0&&(w+=`--- Fichiers de contexte du Trombone ---

`,Be.forEach(h=>{w+=`--- ${h.path} ---
\`\`\`
${h.content}
\`\`\`
...
\`\`\``,a(h=>[...h,{id:Date.now().toString()+"_action",role:"assistant",content:`🩺 Suture & Correction déclenchée pour "${O}". Transmission de l'erreur à ${c.toUpperCase()} en cours...`}]);try{if(await y("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:c,prompt:w,auto_submit:!0,project_id:O,phase_num:s})}),s==="suture"){y("http://localhost:5006/v1/suture/start",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:O,activeFile:oe||"",rawError:l||"",prompt:l||"Analyse et corrige les erreurs du projet."})}).then(async f=>{const R=await f.json();R.success&&R.status==="applied"?a(H=>{var se,Y;return[...H,{id:Date.now().toString()+"_suture_ok",role:"assistant",content:`✅ Suture V2 réussie !

🔧 ${R.repairId}
🚀 Statut : **Patch appliqué en production**
📁 Fichiers corrigés : ${JSON.stringify(((Y=(se=R.patchReport)==null?void 0:se.files)==null?void 0:Y.map(ee=>ee.path))||[])}`}]}):R.success?a(H=>{var se;return[...H,{id:Date.now().toString()+"_suture_partial",role:"assistant",content:`⚠️ Suture V2 : correctif généré mais non promu.
Statut : ${((se=R.validationReport)==null?void 0:se.code)||R.status}

Le correctif est dans l'espace isolé. Vérifiez les logs du moteur pour plus de détails.`}]}):a(H=>[...H,{id:Date.now().toString()+"_suture_fail",role:"assistant",content:`❌ Suture V2 échouée.
Code : ${R.code||"INCONNU"}
${R.message||""}`}])}).catch(()=>{a(f=>[...f,{id:Date.now().toString()+"_suture_err",role:"assistant",content:"❌ Impossible de joindre le moteur Suture V2. Vérifiez que l'Orchestrateur Electron tourne sur le port 5006."}])});return}window.open(Ke(c),"kirov5_ai_target")||a(f=>[...f,{id:Date.now().toString()+"_popup_blocked",role:"assistant",content:`⚠️ Popup bloqué par le navigateur !

L'onglet ${c.toUpperCase()} n'a pas pu s'ouvrir.

**Solution** : Autorisez les popups pour ce site ou ouvrez manuellement : ${Ke(c)}

Le prompt est en queue (90s) — dès que l'onglet ${c.toUpperCase()} sera ouvert avec l'extension active, il sera injecté automatiquement.`}])}catch(h){console.error("[IDE] Erreur Suture:",h),alert(`🩺 Action ${s} transmise. Assurez-vous que le Moteur Electron tourne sur port 5006.`)}},_e=()=>un?e.jsxs("div",{className:"w-full p-8 flex flex-col items-center justify-center gap-4 animate-fadeIn",children:[e.jsx("div",{className:"w-12 h-12 border-4 border-cyan/20 border-t-cyan rounded-full animate-spin"}),e.jsx("div",{className:"text-cyan font-bold animate-pulse text-sm",children:"Interrogation de l'API DeepSeek en cours..."})]}):et?e.jsxs("div",{className:"w-full max-w-3xl backdrop-blur-xl rounded-3xl p-6 md:p-8 border border-white/20 shadow-[0_10px_40px_rgba(0,0,0,0.5)] mt-4 relative animate-fadeIn",style:{background:A?n("news-detail",.9):"rgba(0,0,0,0.9)"},children:[e.jsx("button",{onClick:()=>Dt(null),className:"absolute top-6 right-6 w-8 h-8 bg-white/10 hover:bg-red-500 rounded-full flex flex-col items-center justify-center text-white font-bold transition-colors z-20",title:"Fermer",children:"✕"}),e.jsx("span",{className:"px-3 py-1 bg-cyan/20 text-cyan text-xs font-bold rounded-md mb-4 inline-block",children:et.tag}),e.jsx("h2",{className:"text-2xl md:text-4xl font-black text-white mb-4 leading-tight",children:et.title}),e.jsx("p",{className:"text-gray-300 font-medium text-sm md:text-base mb-6 leading-relaxed border-l-4 border-cyan/50 pl-4",children:et.desc}),e.jsx("div",{className:"w-full h-px bg-white/10 mb-6"}),e.jsx("div",{className:"text-gray-200 text-sm md:text-base leading-loose whitespace-pre-line",children:et.content}),e.jsxs("div",{className:"mt-8 pt-6 border-t border-white/10 flex justify-between items-center",children:[e.jsx("span",{className:"text-xs text-cyan font-mono font-bold tracking-widest",children:"GÉNÉRÉ PAR DEEPSEEK API"}),e.jsx("button",{onClick:()=>Dt(null),className:"px-6 py-3 bg-white/5 hover:bg-white/20 text-white font-bold rounded-xl transition-all border border-white/10 hover:border-cyan",children:"← Retour à la liste"})]})]}):!st||st.length===0?null:e.jsx(Tt,{items:st.map(s=>e.jsxs("div",{className:"design-carte-carrousel relative rounded-2xl p-5 border border-white/10 backdrop-blur-md flex flex-col hover:border-cyan/50 transition-colors shadow-lg",style:{background:A?n("news-"+s.id,.7):"rgba(0,0,0,0.7)"},children:[e.jsx("span",{className:"self-start px-2 py-1 bg-cyan/20 text-cyan text-xs font-bold rounded-md mb-3 pr-4",children:s.tag}),e.jsx("h3",{className:"design-carte-titre text-lg font-bold text-white mb-2 leading-tight mt-1",children:s.title}),e.jsx("p",{className:"design-carte-desc text-gray-400 text-sm flex-1",children:s.desc}),e.jsxs("button",{onClick:()=>Dt(s),className:"absolute top-4 right-4 text-cyan text-xs font-bold hover:underline cursor-pointer px-3 py-1.5 bg-cyan/10 hover:bg-cyan/20 rounded-xl border border-cyan/30 transition-all flex items-center gap-1",children:["Lire l'article ",e.jsx("span",{className:"text-[10px]",children:"↗"})]})]},s.id))}),Te=()=>{const s=[{title:"Créer une IA Souveraine",channel:"Tiger Channel",views:"1.2k"},{title:"React Tailwind Masterclass",channel:"UI Design",views:"5.4k"},{title:"Android Bridge Capacitor",channel:"Mobile Dev",views:"800"}];return e.jsx(Tt,{items:s.map((l,c)=>e.jsxs("div",{className:"design-carte-carrousel rounded-2xl overflow-hidden border border-red-500/30 hover:border-red-500 transition-colors shadow-lg flex flex-col",style:{background:A?n("yt-"+c,.6):"rgba(0,0,0,0.6)"},children:[e.jsxs("div",{className:"flex-1 bg-gray-800 relative flex items-center justify-center min-h-[50%]",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-tr from-red-900/40 to-transparent"}),e.jsx("div",{className:"w-12 h-12 bg-red-600 rounded-full flex items-center justify-center shadow-lg z-10 cursor-pointer hover:scale-110 transition-transform",children:e.jsx("div",{className:"w-0 h-0 border-t-[8px] border-t-transparent border-l-[14px] border-l-white border-b-[8px] border-b-transparent ml-1"})})]}),e.jsxs("div",{className:"p-4",children:[e.jsx("h3",{className:"text-white font-bold text-sm leading-tight mb-1",children:l.title}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-400 mt-2",children:[e.jsx("span",{children:l.channel}),e.jsxs("span",{children:[l.views," vues"]})]})]})]},c))})},xt=()=>{const s=["Setup","Index","React","CSS","Utils","Vite","Tests","Package","Vérif","Bridge","Build"];return e.jsx("div",{className:"mt-2",children:e.jsx(Tt,{items:s.map((l,c)=>{const w=c+1,h=w<F,f=w===F;let R="bg-glass border-white/10 opacity-50";return h&&(R="bg-gradient-to-br from-green-900/60 to-emerald-900/60 border-green-500/50 text-green-100 shadow-[0_0_15px_rgba(34,197,94,0.2)]"),f&&(R="bg-gradient-to-br from-cyan/20 to-blue-900/40 border-cyan text-white shadow-[0_0_20px_rgba(8,179,201,0.5)] animate-pulse hover:scale-105 cursor-pointer"),e.jsxs("div",{onClick:()=>{if(l==="Build"||f||h){const H=localStorage.getItem("tiger_lastGeneratedProject");H&&Ie(H)}},className:`design-carte-carrousel rounded-2xl p-4 border flex flex-col justify-between transition-all duration-500 ${R}`,title:l==="Build"?"Cliquez pour ouvrir l'IDE sur le projet généré":"",children:[e.jsx("div",{className:"text-3xl font-black opacity-20",children:w.toString().padStart(2,"0")}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-bold text-lg mb-1",children:l}),e.jsx("div",{className:"text-xs opacity-70",children:h?"✓ Terminé":f?"En cours...":"En attente"})]}),f&&e.jsx("div",{className:"w-full h-1 bg-white/20 rounded-full mt-2 overflow-hidden",children:e.jsx("div",{className:"h-full bg-cyan w-1/2 animate-ping rounded-full"})}),l==="Build"&&e.jsxs("div",{className:"mt-2 text-[10px] text-cyan font-bold uppercase tracking-widest flex items-center gap-1 bg-black/40 px-2 py-1 rounded",children:[e.jsx("span",{children:"🚀"})," Ouvrir IDE"]})]},c)})})})},Vt=qe!=="random"?((wt=Se.find(s=>s.name===qe))==null?void 0:wt.colors["bg-app"])||"radial-gradient(ellipse at 50% 20%, #1e1b4b 0%, #090a0f 70%, #000000 100%)":void 0;return e.jsxs("div",{className:"design-app-root flex-1 w-full h-full flex flex-col overflow-hidden relative transition-all duration-700",style:{background:Vt},children:[e.jsx("div",{className:"absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-pink/20 blur-[120px] rounded-full pointer-events-none"}),e.jsx("div",{className:"absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-cyan/10 blur-[150px] rounded-full pointer-events-none"}),I&&e.jsx("div",{className:"absolute inset-0 z-[100] flex items-center justify-center p-4 backdrop-blur-md",style:{background:A?n("modal",.6):"rgba(0,0,0,0.6)"},onClick:s=>{s.target===s.currentTarget&&x(!1)},children:e.jsx(On,{isModal:!0,onClose:()=>x(!1),initialTab:_,isClient:A,getCachedGradient:n,mouchardLogs:B,activePhase:F,availableProjects:q,setAvailableProjects:Q,selectedLaunchProject:G,setSelectedLaunchProject:te,isMobileNative:b,isAutoPilot:Ae,setIsAutoPilot:_t,reuseActiveTab:Ve,setReuseActiveTab:Ct,selectedStartPhase:De,setSelectedStartPhase:yt,selectedPacks:E})}),!Fe&&e.jsx("div",{className:"w-full flex justify-center items-center pt-2 z-20 relative pointer-events-none",children:e.jsxs("div",{className:"flex items-center gap-2 overflow-x-auto hide-scrollbar text-[10px] font-bold bg-[#05080c]/80 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/10 shadow-lg pointer-events-auto",children:[e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-green-900/40 px-2.5 py-1 rounded-full border border-green-500/30",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-green-500 shadow-[0_0_8px_#22c55e]"}),e.jsx("span",{className:"text-green-400",children:"Online"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-orange-900/40 px-2.5 py-1 rounded-full border border-orange-500/30",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-orange-500 shadow-[0_0_8px_#f97316] animate-bounce"}),e.jsx("span",{className:"text-orange-400",children:"Ext: Tiger"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-purple-900/40 px-2.5 py-1 rounded-full border border-purple-500/30",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-purple-500 shadow-[0_0_8px_#a855f7]"}),e.jsx("span",{className:"text-purple-400",children:"LLM: DeepSeek"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-cyan/10 px-2.5 py-1 rounded-full border border-cyan/20",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-cyan shadow-[0_0_8px_#08b3c9] animate-pulse"}),e.jsx("span",{className:"text-cyan",children:"Electron"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-gray-500/10 px-2.5 py-1 rounded-full border border-gray-500/20 opacity-60",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-gray-500"}),e.jsx("span",{className:"text-gray-400",children:"Mobile (Capacitor)"})]})]})}),!Fe&&e.jsx("header",{className:"design-header backdrop-blur-md z-10 flex justify-between items-center shadow-lg -mt-2",children:e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"design-logo flex items-center justify-center",children:e.jsx("span",{children:"🐯"})}),e.jsx("div",{children:e.jsx("h1",{className:"design-titre whitespace-nowrap",children:"v0.reponse : OS Souverain v0.1.0 - idecode-2026"})})]})}),e.jsxs("div",{className:"flex-1 flex flex-col lg:flex-row overflow-hidden relative z-10 w-full",children:[O&&e.jsxs("div",{className:"flex flex-col lg:flex-row flex-1 overflow-hidden h-full animate-fadeIn",children:[e.jsxs("div",{className:"design-ide-toolbar w-full h-16 lg:w-16 lg:h-full bg-black/80 border-b lg:border-b-0 lg:border-r border-white/10 flex flex-row lg:flex-col items-center justify-around lg:justify-start lg:py-4 px-2 lg:px-0 gap-2 lg:gap-6 z-20 shadow-xl overflow-x-auto lg:overflow-x-visible",children:[e.jsx("button",{title:"Fermer le projet",onClick:()=>{Ie(null),Xe(null)},className:"design-ide-btn-action w-10 h-10 rounded-full bg-red-500/20 text-red-500 hover:bg-red-500 hover:text-white flex items-center justify-center transition-all mb-4",children:"✕"}),e.jsxs("button",{title:T==="error"?"🔴 Erreur détectée dans le code ! Suture V2 en cours...":T==="working"?"🟣 Suture V2 en plein travail (génération & test du correctif)...":"🟢 Projet propre - Aucune erreur détectée",onClick:()=>k("suture"),className:`design-ide-btn-action w-10 h-10 rounded-xl text-xl border flex items-center justify-center transition-all group relative ${T==="error"?"bg-red-600 text-white border-2 border-red-400 shadow-[0_0_25px_#ff0055] animate-pulse ring-2 ring-red-500":T==="working"?"bg-purple-600 text-white border-2 border-purple-300 shadow-[0_0_25px_#a855f7] animate-pulse ring-2 ring-purple-500":"bg-emerald-600/30 text-emerald-400 border border-emerald-500/50 shadow-[0_0_12px_rgba(16,185,129,0.4)] hover:bg-emerald-500 hover:border-emerald-400 hover:text-white"}`,children:["🩺",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-white pointer-events-none transition-opacity font-bold",children:T==="error"?"🔴 Suture (Erreur !)":T==="working"?"🟣 Suture V2...":"🟢 Suture V2 (OK)"})]}),e.jsxs("button",{title:"Immortaliser le projet (Sauvegarde)",onClick:()=>{O&&y("http://localhost:5006/api/bridge/backup",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:O})}).then(s=>s?s.json():null).then(s=>{if(!s)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");s.success?alert("📸 "+s.message+`
`+s.backupName):alert("Erreur: "+s.error)}).catch(s=>alert("Erreur réseau: "+s.message))},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-blue-500/20 text-blue-400 hover:bg-blue-500 hover:text-white text-xl border border-blue-500/30 hover:border-blue-500 flex items-center justify-center transition-all shadow-[0_0_15px_rgba(59,130,246,0.3)] hover:shadow-[0_0_25px_rgba(59,130,246,0.6)] group relative mt-2",children:["📸",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-blue-400 pointer-events-none transition-opacity font-bold",children:"Immortaliser (Sauvegarder)"})]}),e.jsxs("button",{title:"Restaurer le projet (Time Machine)",onClick:()=>{O&&y("http://localhost:5006/api/bridge/backups?project_id="+O).then(s=>s?s.json():null).then(s=>{if(!s)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");if(!s.success||!s.backups||s.backups.length===0)return alert("⏪ Aucune sauvegarde trouvée pour ce projet.");C(s.backups),z(!0)}).catch(s=>alert("Erreur réseau: "+s.message))},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-slate-500/20 text-slate-400 hover:bg-slate-500 hover:text-white text-xl border border-slate-500/30 hover:border-slate-500 flex items-center justify-center transition-all group relative mb-2",children:["⏪",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-slate-400 pointer-events-none transition-opacity font-bold",children:"Restaurer (Dernier Backup)"})]}),e.jsxs("button",{title:"Refactoring",onClick:()=>k("refactor"),className:"design-ide-btn-action w-10 h-10 rounded-xl bg-white/5 hover:bg-purple-500/20 text-xl border border-white/10 hover:border-purple-500 flex items-center justify-center transition-all group relative",children:["🔄",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-purple-400 pointer-events-none transition-opacity",children:"Refactoring"})]}),e.jsxs("button",{title:"Amélioration",onClick:()=>k("improve"),className:"design-ide-btn-action w-10 h-10 rounded-xl bg-white/5 hover:bg-yellow-500/20 text-xl border border-white/10 hover:border-yellow-500 flex items-center justify-center transition-all group relative",children:["✨",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-yellow-400 pointer-events-none transition-opacity",children:"Amélioration"})]}),e.jsxs("button",{title:"Corriger Arborescence (Fix Extensions)",onClick:()=>{O&&y("http://localhost:5006/api/fix-extensions",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:O})}).then(s=>s?s.json():null).then(s=>{if(!s)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");s.success?alert(s.message):alert("Erreur: "+s.error)}).catch(s=>alert("Erreur réseau: "+s.message))},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-white/5 hover:bg-orange-500/20 text-xl border border-white/10 hover:border-orange-500 flex items-center justify-center transition-all group relative",children:["🛠️",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-orange-400 pointer-events-none transition-opacity font-bold",children:"Fix Arborescence (.txt ➡️ .tsx)"})]}),e.jsxs("button",{title:"Générateur PRD V0-Guest",onClick:()=>{Ie("v0-guest"),Pe("http://localhost:3007"),y("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:"v0-guest"})}).catch(s=>console.error("Erreur lancement v0-guest:",s)),setTimeout(()=>{window.open("http://localhost:3007","_blank")},2500)},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-gradient-to-br from-cyan/20 to-purple-500/20 text-cyan hover:from-cyan hover:to-purple-500 hover:text-black text-xl border border-cyan/40 flex items-center justify-center transition-all group relative shadow-[0_0_12px_rgba(0,240,255,0.3)]",children:["🎁",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-cyan font-bold pointer-events-none transition-opacity",children:"V0-Guest PRD Generator"})]}),e.jsxs("button",{title:"Design v0 (Studio Visuel & Preview Split)",onClick:()=>{const s=!at;if(Gt(s),s&&!ze){const l=ye&&JSON.stringify(ye).includes("next.config");Pe(l?"http://localhost:3000":"http://localhost:5175")}},className:`design-ide-btn-action w-10 h-10 rounded-xl flex items-center justify-center transition-all group relative border ${at?"bg-pink-500 text-white border-pink-500 shadow-[0_0_15px_rgba(236,72,153,0.5)]":"bg-white/5 hover:bg-pink-500/20 text-pink-500 border-white/10 hover:border-pink-500"}`,children:["🎨",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-pink-500 pointer-events-none transition-opacity font-bold",children:"Design v0 (Split View)"})]}),e.jsx("div",{className:"flex-1"}),e.jsxs("button",{title:Fe?"Réduire (Afficher le Chat)":"Pleine Page (Masquer le Chat)",onClick:()=>ot(!Fe),className:`design-ide-btn-action w-10 h-10 rounded-xl flex items-center justify-center transition-all group relative border ${Fe?"bg-cyan text-black border-cyan":"bg-white/5 hover:bg-cyan/20 text-cyan border-white/10 hover:border-cyan"}`,children:[Fe?"🗗":"🗖",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-cyan pointer-events-none transition-opacity",children:Fe?"Mode Normal":"Pleine Page"})]})]}),e.jsxs("div",{className:"design-explorateur w-64 bg-[#0a0a0a]/95 border-r border-white/10 overflow-y-auto flex flex-col hide-scrollbar z-20 shadow-2xl",children:[e.jsxs("div",{className:"px-4 py-3 border-b border-white/10 sticky top-0 bg-[#0a0a0a] z-10 flex flex-col gap-2",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsxs("span",{className:"text-[10px] text-cyan font-black uppercase tracking-widest flex items-center gap-2",children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-cyan animate-pulse"}),"Projet Actif"]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{onClick:()=>{O&&(console.log("Clic Suture Manuel ! Projet:",O,"Etat actuel:",T),T!=="error"&&y("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:O})}).catch(()=>{}),y("http://localhost:5006/api/suture/launch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:O})}).then(s=>s?s.json():null).then(s=>s&&console.log("Réponse Suture API:",s)).catch(s=>console.error("Erreur Suture API:",s)))},className:`text-[9px] font-bold px-2 py-0.5 rounded transition-colors border shadow-sm flex items-center gap-1 ${T==="error"?"bg-red-500/20 text-red-400 border-red-500/50 animate-pulse hover:bg-red-500/30":T==="working"?"bg-purple-500/20 text-purple-400 border-purple-500/50 hover:bg-purple-500/30":"bg-green-500/20 text-green-400 border-green-500/50 opacity-50 hover:opacity-100"}`,title:"Lancer Suture V2 manuellement",children:"sutur🩺"}),e.jsx("button",{onClick:()=>{y("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{s&&s.success&&s.projects?D(s.projects.map(l=>({name:l,desc:"Projet local",bg:""}))):fetch("/api/projects").then(l=>l.json()).then(l=>{l.projects&&D(l.projects.map(c=>({name:c.project_id||c.title,desc:"SaaS Cloud",bg:""})))})}).catch(()=>{})},className:"text-xs text-gray-400 hover:text-cyan p-1 transition-colors",title:"Actualiser la liste des projets",children:"🔄"})]})]}),e.jsxs("select",{value:O||"",onFocus:()=>{y("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{s&&s.success&&s.projects?D(s.projects.map(l=>({name:l,desc:"Projet local",bg:""}))):fetch("/api/projects").then(l=>l.json()).then(l=>{l.projects&&D(l.projects.map(c=>({name:c.project_id||c.title,desc:"SaaS Cloud",bg:""})))})}).catch(()=>{})},onChange:s=>{const l=s.target.value;l&&(Ie(l),Xe(null),it(""),y("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:l,open_explorer:!1})}).catch(c=>console.error("Erreur de lancement :",c)))},className:"w-full bg-[#161616] text-cyan font-bold text-xs border border-cyan/40 rounded-xl px-2.5 py-2 outline-none focus:border-cyan focus:ring-1 focus:ring-cyan shadow-[0_0_10px_rgba(8,179,201,0.2)] cursor-pointer truncate",children:[e.jsx("option",{value:"",disabled:!0,className:"bg-black text-gray-400",children:"-- Choisir un projet --"}),pe.length>0?pe.map(s=>e.jsxs("option",{value:s.name,className:"bg-black text-white font-medium py-1",children:["📁 ",s.name]},s.name)):e.jsxs("option",{value:O||"Projet_blog_8831",className:"bg-black text-white py-1",children:["📁 ",O||"Projet_blog_8831"]})]})]}),e.jsx("div",{className:"py-2",children:ye?ue(ye):e.jsx("div",{className:"text-gray-500 text-xs px-4 py-2 animate-pulse",children:"Scan du projet..."})})]}),e.jsxs("div",{className:"design-editeur flex-1 flex flex-col bg-[#1e1e1e] z-20 shadow-2xl relative",children:[e.jsxs("div",{className:"design-editeur-onglet h-12 bg-[#252526] border-b border-black flex justify-between items-center px-4",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-blue-400 text-lg",children:oe?"📄":"📁"}),e.jsx("span",{className:"text-sm text-gray-300 font-mono",children:oe||"Aucun fichier sélectionné"})]}),e.jsxs("div",{className:"flex gap-4 items-center",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("div",{className:"text-xs text-green-400 animate-pulse font-bold flex items-center gap-2",children:[e.jsx("span",{className:"w-2 h-2 bg-green-400 rounded-full"})," SERVER:"]}),e.jsx("input",{type:"text",value:Ze,onChange:s=>ht(s.target.value),onKeyDown:s=>{s.key==="Enter"&&Pe(Ze)},className:"bg-black/50 border border-green-500/30 text-green-400 text-[10px] px-2 py-1 rounded outline-none focus:border-green-400 w-40 font-mono shadow-[0_0_10px_rgba(34,197,94,0.1)] transition-all",title:"Modifier et taper Entrée"}),e.jsx("button",{onClick:()=>Pe(Ze),className:"text-[10px] bg-green-500/20 text-green-400 hover:bg-green-500 hover:text-white px-2 py-1 rounded font-bold border border-green-500/30",children:"Go"})]}),e.jsx("button",{onClick:()=>tn(Qe),disabled:!oe,className:`px-4 py-1.5 rounded text-xs font-bold transition-all ${oe?"bg-cyan/20 text-cyan hover:bg-cyan hover:text-black border border-cyan/30 shadow-[0_0_10px_rgba(8,179,201,0.2)]":"bg-white/5 text-gray-600 cursor-not-allowed"}`,children:"SAUVEGARDER (CTRL+S)"})]})]}),e.jsx("div",{className:"flex-1 relative flex overflow-hidden",children:at?e.jsxs("div",{className:"flex-1 flex w-full h-full bg-[#0a0a0a] overflow-hidden",children:[e.jsxs("div",{className:"w-1/2 h-full border-r border-white/10 flex flex-col bg-[#141414]",children:[e.jsxs("div",{className:"h-12 px-4 bg-black/90 border-b border-white/10 flex justify-between items-center shrink-0 z-10",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-xl",children:"🎨"}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-xs font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-cyan tracking-widest uppercase",children:"STUDIO DESIGN INTELLIGENT"}),e.jsxs("p",{className:"text-[10px] text-gray-400 truncate max-w-[180px]",children:["Projet : ",e.jsx("span",{className:"text-cyan font-bold",children:O||"Projet Actif"})]})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{onClick:()=>Gt(!1),className:"px-2.5 py-1 bg-white/10 hover:bg-white/20 text-white rounded-lg border border-white/10 text-[11px] font-bold flex items-center gap-1 transition-all shadow",title:"Revenir à l'explorateur de fichiers & à l'éditeur de code",children:"📁 Fermer (Code)"}),e.jsx("button",{onClick:()=>{Gt(!1),Ie(null),ot(!1)},className:"px-2.5 py-1 bg-red-500/20 hover:bg-red-500 text-red-300 hover:text-white rounded-lg border border-red-500/30 text-[11px] font-bold flex items-center gap-1 transition-all shadow",title:"Quitter le projet et revenir à la page d'accueil",children:"🏠 Fermer (Accueil)"})]})]}),e.jsx("div",{className:"flex-1 overflow-hidden relative",children:e.jsx("iframe",{src:`/admin-design.html?project=${O}`,className:"w-full h-full border-0 bg-black",title:"Studio Admin Design"})})]}),e.jsxs("div",{className:"design-preview w-1/2 h-full flex flex-col",children:[e.jsxs("div",{className:"h-12 px-4 bg-black/90 border-b border-white/10 flex justify-between items-center shrink-0 z-10",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"w-2.5 h-2.5 rounded-full bg-green-400 animate-pulse"}),e.jsxs("span",{className:"text-xs font-mono font-bold text-green-400",children:["LIVE PREVIEW (",ye&&JSON.stringify(ye).includes("next.config")?"LOCALHOST:3000":"LOCALHOST:5175",")"]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("input",{type:"text",value:ze||(ye&&JSON.stringify(ye).includes("next.config")?"http://localhost:3000":"http://localhost:5175"),onChange:s=>ht(s.target.value),onKeyDown:s=>{s.key==="Enter"&&Pe(Ze)},className:"bg-black/80 border border-green-500/30 text-green-400 text-[11px] px-2.5 py-1 rounded outline-none focus:border-green-400 w-48 font-mono"}),e.jsx("button",{onClick:()=>{O&&y("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:O,open_explorer:!1})}).catch(s=>console.error("Erreur lancement preview:",s))},className:"px-2.5 py-1 bg-green-500/20 text-green-400 hover:bg-green-500 hover:text-white text-[11px] rounded font-bold border border-green-500/30 transition-all flex items-center gap-1",title:"Relancer / Démarrer le serveur Preview",children:"🚀 Relancer"})]})]}),e.jsx("div",{className:"flex-1 relative overflow-hidden",style:{background:"var(--preview-bg)"},children:e.jsx("iframe",{src:ze||(ye&&JSON.stringify(ye).includes("next.config")?"http://localhost:3000":"http://localhost:5175"),className:"w-full h-full border-none",title:"Application Preview Live"})})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`relative flex flex-col ${ze?"w-1/2 border-r border-black":"w-full"}`,children:oe?e.jsx(fa,{height:"100%",theme:"vs-dark",path:oe,language:oe.endsWith(".tsx")||oe.endsWith(".ts")?"typescript":oe.endsWith(".css")?"css":oe.endsWith(".html")?"html":oe.endsWith(".json")?"json":"javascript",value:Qe,onChange:s=>{const l=s||"";it(l),window.saveTimer&&clearTimeout(window.saveTimer),window.saveTimer=setTimeout(()=>{tn(l)},500)},options:{minimap:{enabled:!1},fontSize:14,wordWrap:"on",padding:{top:16}}}):e.jsxs("div",{className:"absolute inset-0 flex flex-col items-center justify-center text-gray-600 gap-4",children:[e.jsx("span",{className:"text-6xl opacity-20",children:"🐯"}),e.jsx("span",{className:"font-medium tracking-wide text-sm",children:"Sélectionnez un fichier dans l'explorateur ou activez Design v0"})]})}),ze&&e.jsxs("div",{className:"design-preview w-1/2 relative",style:{background:"var(--preview-bg)"},children:[e.jsx("iframe",{src:ze,className:"w-full h-full border-none"}),e.jsx("button",{onClick:()=>Pe(null),className:"absolute top-2 right-4 bg-black/80 border border-white/20 text-white rounded-full w-8 h-8 flex items-center justify-center hover:bg-red-500 hover:text-white transition-all shadow-lg z-50",title:"Fermer la Preview",children:"✕"}),e.jsx("button",{onClick:()=>window.open(ze,"_blank"),className:"absolute top-2 right-14 bg-black/80 border border-white/20 text-white rounded-full px-3 h-8 flex items-center justify-center hover:bg-cyan hover:text-black transition-all shadow-lg z-50 text-xs font-bold",title:"Ouvrir dans un nouvel onglet",children:"↗ Ouvrir"})]})]})})]})]}),e.jsxs("main",{className:`design-chat-main ${O?Fe?"hidden w-0":"w-full h-[50vh] lg:h-full lg:w-96 lg:min-w-[24rem]":"flex-1"} border-t lg:border-t-0 lg:border-l border-white/20 bg-black/60 shadow-[-20px_0_40px_rgba(0,0,0,0.5)] overflow-y-auto p-4 md:p-8 z-10 hide-scrollbar flex flex-col transition-all duration-500 ease-in-out`,onDragOver:s=>{s.preventDefault(),W(!0)},onDragLeave:()=>W(!1),onDrop:s=>{s.preventDefault(),W(!1),s.dataTransfer.files&&s.dataTransfer.files.length>0&&v(s.dataTransfer.files)},children:[P&&e.jsx("div",{className:"absolute inset-0 z-50 bg-cyan/20 backdrop-blur-sm border-4 border-dashed border-cyan rounded-3xl m-4 flex items-center justify-center pointer-events-none",children:e.jsxs("h2",{className:"text-3xl font-black text-cyan drop-shadow-lg text-center px-4",children:["Glissez votre projet Stitch (.zip, .html, .md, .png)",e.jsx("br",{}),"pour préparer le câblage !"]})}),e.jsxs("div",{className:"design-chat-layout w-full flex-1 flex flex-col justify-center my-auto pb-[140px] relative",children:[(()=>{const s=r.map(h=>!!h.widget).lastIndexOf(!0),l=s!==-1?r[s]:null,c=l?l.widget:null,w=ge||c==="packs"||c==="projects"||c==="news"||c==="youtube"||Je||tt;return e.jsxs("div",{className:"w-full flex flex-col xl:flex-row items-stretch justify-between gap-6 relative min-h-[50vh] my-auto",children:[e.jsx(To,{messages:r,showGuestPacks:Z,setShowGuestPacks:ne,guestPacksCount:4,guestPackSearchQuery:ve,setGuestPackSearchQuery:fe}),w&&e.jsxs("div",{className:"flex-1 w-full flex flex-col items-center justify-center my-auto z-20",children:[!Je&&!tt&&(ge||c==="packs")&&!O&&e.jsx(jo,{selectedPacks:E,togglePack:qt,newProjectName:K,setNewProjectName:We,setActiveProject:Ie,handleSend:g,isClient:A,getCachedGradient:n,onDetailStateChange:N,showGuestPacks:Z,setShowGuestPacks:ne,guestPackSearchQuery:ve}),!Je&&!tt&&!ge&&c==="projects"&&e.jsx(Gn,{isClient:A,getCachedGradient:n,setActiveProject:Ie}),!Je&&!tt&&!ge&&c==="news"&&_e(),!Je&&!tt&&!ge&&c==="youtube"&&Te(),Je&&e.jsxs("div",{className:"w-full bg-black/90 border-2 border-pink-500/50 rounded-3xl p-6 shadow-2xl backdrop-blur-md relative my-2 text-white animate-fadeIn flex-1 min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 pb-2 border-b border-white/10",children:[e.jsx("h3",{className:"text-xl font-black text-pink-400 flex items-center gap-2",children:"🎨 Gestion des Thèmes & Couleurs"}),e.jsx("button",{onClick:()=>mt(!1),className:"px-3.5 py-1.5 bg-white/10 hover:bg-white/20 text-white text-xs font-bold rounded-xl transition-all cursor-pointer border border-white/20",children:"✕ Masquer"})]}),e.jsxs("div",{className:"bg-cyan/10 border border-cyan/30 rounded-xl p-4 flex flex-col gap-2 mb-4",children:[e.jsxs("div",{className:"text-xs font-bold text-cyan uppercase tracking-wider flex items-center gap-2",children:[e.jsx("span",{children:"🖥️"})," Page d'Accueil Electron"]}),e.jsx("p",{className:"text-xs text-gray-300",children:`Fixer le fond d'écran enregistré ("fold") pour la page d'accueil Electron.`}),e.jsx("button",{onClick:()=>{const h="linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)",f=Se.map(R=>R.name==="fold"?{...R,colors:{...R.colors,"bg-app":h}}:R);Oe(f),localStorage.setItem("tiger_saved_themes",JSON.stringify(f)),St("fold"),document.body.style.background=h,document.body.style.backgroundAttachment="fixed",y("http://localhost:5006/api/theme",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({activeTheme:"fold",bgApp:h})}).catch(()=>{}),mt(!1)},className:"w-full mt-1 py-2.5 bg-cyan text-black font-extrabold rounded-lg hover:bg-cyan/80 transition-all flex items-center justify-center gap-2 shadow-lg cursor-pointer",children:`🖼️ Appliquer ce Fond d'Écran sur Electron ("fold")`})]}),e.jsxs("div",{className:"bg-white/5 border border-white/10 rounded-xl p-4 flex flex-col gap-3 mb-4",children:[e.jsxs("div",{className:"text-sm font-bold text-gray-400",children:["Mode actuel : ",e.jsx("span",{className:"text-cyan uppercase",children:qe})]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"text",value:Ce,onChange:h=>en(h.target.value),placeholder:"Nom (ex: Nuit, Océan, fold...)",className:"flex-1 bg-black/50 border border-white/20 rounded-lg px-3 py-2 text-sm text-white outline-none focus:border-cyan"}),e.jsx("button",{onClick:Mt,className:"px-4 py-2 bg-cyan text-black font-bold rounded-lg hover:bg-cyan/80 transition-colors whitespace-nowrap cursor-pointer",children:"Save Mode"})]})]}),e.jsxs("div",{className:"flex flex-col gap-2 max-h-[220px] overflow-y-auto custom-scrollbar",children:[e.jsx("div",{className:"text-xs font-bold text-gray-500 uppercase tracking-widest mb-1",children:"Thèmes Enregistrés"}),e.jsxs("div",{onClick:()=>{St("random"),mt(!1)},className:`p-3 rounded-xl border text-left flex justify-between items-center transition-all cursor-pointer ${qe==="random"?"bg-cyan/20 border-cyan text-white":"bg-white/5 border-white/10 text-gray-400 hover:bg-white/10"}`,children:[e.jsx("span",{className:"font-bold flex items-center gap-2",children:"🎲 Mode Aléatoire (Dynamique)"}),qe==="random"&&e.jsx("span",{className:"text-cyan",children:"✓"})]}),Se.map(h=>e.jsxs("div",{onClick:()=>{St(h.name),document.body.style.background=h.colors["bg-app"]||"",h.name==="fold"?document.body.style.backgroundAttachment="fixed":document.body.style.backgroundAttachment="scroll"},className:`p-3 rounded-xl border text-left flex justify-between items-center transition-all cursor-pointer ${qe===h.name?"bg-cyan/20 border-cyan text-white":"bg-white/5 border-white/10 text-gray-400 hover:bg-white/10"}`,children:[e.jsx("span",{className:"font-bold capitalize",children:h.name}),e.jsx("button",{onClick:f=>Lt(h.name,f),className:"text-xs text-red-400 hover:text-red-300 px-2 py-1 bg-red-500/10 hover:bg-red-500/20 rounded border border-red-500/20 cursor-pointer",children:"Supprimer"})]},h.name))]})]}),tt&&e.jsxs("div",{className:"w-full bg-[#090d16] border-2 border-purple-500/60 rounded-3xl p-6 shadow-2xl backdrop-blur-md relative my-2 text-white animate-fadeIn flex-1 min-w-0 flex flex-col max-h-[520px] overflow-y-auto custom-scrollbar",children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 pb-2 border-b border-purple-500/30",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-2xl animate-bounce",children:"📱"}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-purple-300 font-black text-base md:text-lg uppercase tracking-wider flex items-center gap-2",children:"v0-apk — Compilateur Mobile Java"}),e.jsx("p",{className:"text-xs text-slate-400",children:"Génération d'APK Android Souverain sans dépendance système externe"})]})]}),e.jsx("button",{onClick:()=>ct(!1),className:"px-3.5 py-1.5 bg-white/10 hover:bg-white/20 text-white text-xs font-bold rounded-xl transition-all cursor-pointer border border-white/20",children:"✕ Masquer"})]}),e.jsxs("div",{className:"flex flex-col gap-2 bg-black/50 p-4 rounded-2xl border border-purple-500/20 mb-3",children:[e.jsxs("label",{htmlFor:"apk-target-inline",className:"text-purple-400 font-bold uppercase text-xs tracking-widest flex items-center gap-2",children:[e.jsx("span",{children:"📁"})," SELECTIONNER L'APPLICATION À COMPILER :"]}),e.jsxs("select",{id:"apk-target-inline",value:vt||O||"",onChange:h=>Zt(h.target.value),className:"w-full bg-[#121824] text-white border border-purple-500/40 rounded-xl px-4 py-2.5 outline-none focus:border-purple-400 text-xs font-semibold cursor-pointer",children:[e.jsx("option",{value:"",children:"-- Sélectionner un projet --"}),pe.map(h=>e.jsxs("option",{value:h.name,children:["📁 ",h.name]},h.name))]})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3 mb-3",children:[e.jsxs("div",{className:"bg-black/50 p-3 rounded-2xl border border-purple-500/20 flex flex-col gap-1",children:[e.jsx("span",{className:"text-xs font-bold text-purple-300 uppercase tracking-wider",children:"☕ Java Portable"}),e.jsx("div",{className:"text-[11px] text-slate-300 bg-purple-950/30 p-2 rounded-xl border border-purple-800/40 font-mono",children:"JDK 17 + Capacitor Android Engine"})]}),e.jsxs("div",{className:"bg-black/50 p-3 rounded-2xl border border-purple-500/20 flex flex-col gap-1",children:[e.jsx("span",{className:"text-xs font-bold text-purple-300 uppercase tracking-wider",children:"🎨 Thèmes Persistent"}),e.jsx("div",{className:"text-[11px] text-slate-300 bg-purple-950/30 p-2 rounded-xl border border-purple-800/40 font-mono",children:"Injection Zero-Touch CSS embarquée"})]})]}),e.jsxs("div",{className:"bg-[#05070d] p-3 rounded-2xl border border-slate-800 flex flex-col gap-2 mb-3",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsxs("span",{className:"text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center gap-2",children:[e.jsx("span",{className:`w-2.5 h-2.5 rounded-full ${Ue==="building"?"bg-yellow-400 animate-ping":Ue==="success"?"bg-green-400":"bg-slate-600"}`}),"Logs Compilation APK"]}),ut.length>0&&e.jsx("button",{onClick:()=>pt([]),className:"text-[10px] text-slate-500 hover:text-slate-300 underline cursor-pointer",children:"Effacer"})]}),e.jsx("div",{className:"bg-black/80 p-3 rounded-xl border border-slate-900 font-mono text-[11px] h-24 overflow-y-auto custom-scrollbar flex flex-col gap-1 text-slate-300",children:ut.length===0?e.jsx("span",{className:"text-slate-600 italic text-center my-auto",children:`Prêt. Cliquez sur "Compiler l'APK".`}):ut.map((h,f)=>e.jsx("div",{className:"leading-tight",children:h},f))})]}),e.jsxs("div",{className:"flex items-center justify-between pt-2 border-t border-purple-500/20",children:[nt&&e.jsxs("a",{href:nt,download:!0,className:"px-4 py-2 bg-green-600 hover:bg-green-500 text-white rounded-xl text-xs font-black transition-all flex items-center gap-2 shadow-lg shadow-green-900/40 animate-bounce",children:[e.jsx("span",{children:"📥"})," Télécharger APK"]}),e.jsx("button",{disabled:Ue==="building",onClick:async()=>{const h=vt||O;if(!h)return alert("Veuillez sélectionner un projet !");dt("building"),pt([`> Initialisation build APK pour [${h}]...`]);try{await y("http://localhost:5006/api/mobile/build-apk",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:h})})}catch(f){dt("error"),pt(R=>[...R,`❌ Erreur réseau: ${f.message}`])}},className:`ml-auto px-5 py-2.5 rounded-xl text-xs font-extrabold transition-all shadow-md ${Ue==="building"?"bg-purple-900/50 text-purple-300 cursor-not-allowed":"bg-purple-600 hover:bg-purple-500 text-white cursor-pointer"}`,children:Ue==="building"?"⚙️ Compilation...":"📱 Compiler l'APK"})]})]})]}),!w&&e.jsx("div",{className:"design-chat-bulles w-full xl:w-[450px] shrink-0 flex flex-col gap-3 items-end z-10 ml-auto",children:r.map((h,f)=>{const R=f===0;return e.jsxs("div",{className:"w-full flex flex-col items-end",children:[e.jsx("div",{className:`${R?"design-msg-accueil":"design-chat-bulle"} p-5 rounded-3xl rounded-br-sm backdrop-blur-md border border-white/20 text-gray-100 shadow-xl`,style:{background:A?n("msg-"+h.id,h.role==="user"?.8:.6):"rgba(0,0,0,0.6)"},children:h.content}),f===s&&h.widget==="settings"&&e.jsx(On,{isClient:A,getCachedGradient:n,mouchardLogs:B,activePhase:F,availableProjects:q,setAvailableProjects:Q,selectedLaunchProject:G,setSelectedLaunchProject:te,isMobileNative:b,isAutoPilot:Ae,setIsAutoPilot:_t,reuseActiveTab:Ve,setReuseActiveTab:Ct,selectedStartPhase:De,setSelectedStartPhase:yt,selectedPacks:E}),f===s&&h.widget==="phases"&&xt(),f===s&&h.widget==="projects"&&e.jsx(Gn,{isClient:A,getCachedGradient:n,setActiveProject:Ie})]},h.id)})})]})})(),e.jsx("div",{ref:m})]})]}),It&&(()=>{const s=B.slice(-10).join(" ").toLowerCase(),l=B.slice(0,10).join(" ").toLowerCase(),c=s+" "+l;let w="text-green-400",h="bg-green-400 shadow-[0_0_8px_#4ade80]",f="border-green-500/30 shadow-[-10px_0_30px_rgba(34,197,94,0.1)]",R="bg-green-950/20",H="Terminal (Prêt)";return c.includes("erreur")||c.includes("failed")||c.includes("⚠️")||c.includes("exception")||c.includes("impossible")||c.includes("[err")?(w="text-red-500",h="bg-red-500 animate-pulse shadow-[0_0_12px_#ef4444]",f="border-red-500/50 shadow-[-10px_0_30px_rgba(239,68,68,0.2)]",R="bg-red-950/30",H="Terminal (Erreur)"):(c.includes("en cours")||c.includes("execution")||c.includes("install")||c.includes("lancement")||c.includes("analyse")||c.includes("suture")||c.includes("patch"))&&!c.includes("terminé")&&!c.includes("détecté")&&!c.includes("nettoyée")&&!c.includes("✅")&&(w="text-purple-400",h="bg-purple-400 animate-ping shadow-[0_0_12px_#c084fc]",f="border-purple-500/50 shadow-[-10px_0_30px_rgba(168,85,247,0.2)]",R="bg-purple-950/30",H="Terminal (Travail...)"),e.jsxs("aside",{className:`w-80 border-l flex flex-col z-50 fixed right-0 top-0 h-screen bg-black transition-all duration-500 shadow-2xl ${f}`,children:[e.jsxs("div",{className:`p-4 border-b border-white/10 flex justify-between items-center transition-colors duration-500 ${R}`,children:[e.jsxs("h3",{className:`${w} font-black text-xs uppercase tracking-widest flex items-center gap-2 transition-colors`,children:[e.jsx("span",{className:`w-2 h-2 rounded-full ${h}`}),H]}),e.jsxs("div",{className:"flex gap-2 items-center",children:[e.jsx("button",{onClick:async()=>{re(["> Arrêt des processus en cours... (Historique conservé dans la console noire)"]);try{const se=await y("http://localhost:5006/api/bridge/stop-launch",{method:"POST"});if(!se||!se.ok){re(["> ⚠️ ERREUR : La commande n'existe pas !","> ⚠️ VOUS DEVEZ REDÉMARRER LA CONSOLE NOIRE !","> Fermez la fenêtre COMMAND_MENU_TIGER.bat et relancez-la."]);return}const Y=await se.json();re(["> ✅ "+(Y.message||"Processus arrêtés.")])}catch(se){re(["> ⚠️ ERREUR DE CONNEXION AU MOTEUR !","> Le moteur est peut-être éteint ou nécessite un redémarrage.","> Détail: "+se.message])}},className:"py-1 px-2 rounded text-white font-bold text-[10px] bg-red-500/20 border border-red-500/50 hover:bg-red-500 hover:text-white transition-colors shadow-md",title:"Arrêter l'installation ou le serveur (Ne nettoie plus la console)",children:"⏹️ Stop/Clear"}),e.jsx("button",{onClick:()=>i(!1),className:"text-gray-500 hover:text-white transition-colors ml-2 font-bold text-lg",children:"✕"})]})]}),e.jsx("div",{className:"flex-1 p-4 font-mono text-xs overflow-y-auto flex flex-col-reverse hide-scrollbar bg-black",children:e.jsx("div",{id:"mouchard-terminal-logs",children:B.map((se,Y)=>{let ee="text-[#52c1c9]";return se.includes("[INSTALL]")&&(ee="text-[#f29f43]"),se.includes("[SERVER]")&&(ee="text-[#0ab7d4]"),se.includes("[IDE]")&&(ee="text-[#e27396]"),(se.includes("WARN")||se.includes("ERR"))&&(ee="text-red-500"),e.jsx("div",{className:`mb-1 opacity-90 break-words ${ee}`,children:se},Y)})})})]})})(),!It&&e.jsxs("button",{onClick:()=>i(!0),title:"Ouvrir le Mouchard Système / Terminal",className:"fixed right-4 top-4 z-50 bg-[#111c2e]/90 hover:bg-[#1e293b] border border-cyan/40 text-cyan px-3 py-1.5 rounded-full text-[11px] font-mono font-bold shadow-[0_0_15px_rgba(8,179,201,0.25)] transition-all flex items-center gap-1.5 backdrop-blur-md cursor-pointer hover:scale-105",children:[e.jsx("span",{children:"🕵️"}),e.jsx("span",{children:"Mouchard"})]})]})," ",e.jsxs("footer",{className:"design-footer absolute bottom-0 left-0 w-full backdrop-blur-2xl z-50 flex flex-col p-2 md:p-3 bg-black/80 border-t border-white/15 gap-2",children:[e.jsx("div",{className:"flex flex-wrap items-center justify-center gap-3 px-4 py-2 bg-black/40 rounded-2xl border border-white/10 backdrop-blur-md",children:e.jsxs("div",{className:"flex items-center gap-2 overflow-x-auto hide-scrollbar pb-1 px-1",children:[e.jsxs("button",{onClick:()=>{M("connexion"),x(!0)},className:"design-app-icone design-icone-reglages flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Réglages",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:rotate-45 transition-transform",children:"⚙️"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Réglages"})]}),e.jsxs("button",{onClick:()=>{if(typeof window<"u"){const s=localStorage.getItem("tiger_targetAi")||"deepseek",l=Ke(s),c=window.AndroidBridge;c&&c.openAIWithPrompt?c.openAIWithPrompt(l,"Bonjour ! Je viens d'ouvrir l'Assistant IA."):window.open(l,"_blank")}},className:"design-app-icone design-icone-assistant flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Assistant IA",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🧠"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Assistant IA"})]}),e.jsxs("button",{onClick:()=>{Ie(null),Xe(null),xe(!1),g("Mes projets"),p("")},className:"design-app-icone design-icone-projets flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Projets",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"📁"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Projets"})]}),e.jsxs("button",{id:"btn-joindre-prd-main",onClick:()=>{xe(!0)},className:"design-app-icone design-icone-packs flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Ouvrir le carrousel des Packs PRD",children:[E.length>0&&e.jsx("span",{className:"absolute -top-0 -right-0 bg-indigo-500 text-white text-[9px] font-black w-4.5 h-4.5 rounded-full flex items-center justify-center border border-white/20 shadow-md z-20",children:E.length}),e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform text-xl",children:"📎"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Packs PRD"})]}),e.jsxs("button",{onClick:async()=>{window.dispatchEvent(new CustomEvent("open-mouchard"));try{await y("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:"v0-guest"})}),setTimeout(()=>{window.open("http://localhost:3007","_blank")},2500)}catch(s){console.error("Erreur lancement v0-guest:",s)}},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden cursor-pointer",style:{backgroundImage:"linear-gradient(135deg, #00c6ff, #0072ff)"},title:"Démarrer le serveur V0-Guest (localhost:3007) en arrière-plan",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🎁"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"V0-Guest"})]}),e.jsxs("button",{onClick:()=>{xe(!1),g("Actualités IA"),p("")},className:"design-app-icone design-icone-actualites flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Actualités",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"📰"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Actualités"})]}),e.jsxs("button",{type:"button",onClick:s=>{s.preventDefault(),i(l=>{const c=!l;return c&&re(w=>["> Console-V0 ouverte. Prêt pour l'Introspection AST.",...w]),c})},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #475163, #1f2530)"},title:"Console-V0",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🖥️"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Console-V0"})]}),e.jsxs("button",{type:"button",onClick:async s=>{s.preventDefault();try{i(!0);const l=O||"Projet_blog_8831",w=`e:\\v0reponses\\v0-moteur-electron\\v0saveprojets\\${l}\\${(oe||"src/App.tsx").replace(/\//g,"\\")}`;setTimeout(()=>{const H=document.getElementById("mouchard-terminal-logs");H&&(H.innerHTML=`<div class="mb-1 opacity-90 break-words text-[#e27396]">> 🚀 Lancement du Patch UI (Suture dynamique sur ${l})...</div>`+H.innerHTML)},50);const h=await y("http://localhost:5006/api/design/intent",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({intent:"PATCH_UI",payload:{targetFile:w,templateId:"stitch_mock"}})}),f=h?await h.json():null,R=document.getElementById("mouchard-terminal-logs");R&&(f&&f.success?R.innerHTML='<div class="mb-1 opacity-90 break-words text-[#00e676]">> 🎯 Patch appliqué avec succès par le LLM !</div>'+R.innerHTML:(R.innerHTML=`<div class="mb-1 opacity-90 break-words text-red-400">> ⚠️ Erreur Patch UI AST : ${f&&f.error||"Basculement vers la Suture IA..."}</div>`+R.innerHTML,k("suture",`Échec du patch automatique AST : ${f&&f.error||"Format incompatible"}`)))}catch(l){const c=document.getElementById("mouchard-terminal-logs");c&&(c.innerHTML=`<div class="mb-1 opacity-90 break-words text-red-500">> ⛔ Erreur Patch UI : ${l.message}</div>`+c.innerHTML),k("suture",`Exception Patch UI: ${l.message}`)}},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #1b6345, #08291a)"},title:"Patch UI",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🧬"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Patch UI"})]}),e.jsxs("button",{type:"button",onClick:async()=>{try{const s=await y("http://localhost:5006/bridge/flush",{method:"POST"}),l=s?await s.json():null;a(w=>[...w,{id:Date.now().toString()+"_flush",role:"assistant",content:`🧹 File Bridge vidée ! ${l&&l.flushed||0} prompt(s) supprimé(s).

La queue est vide. Relancez votre Suture ou Patch.`}]);const c=document.getElementById("mouchard-terminal-logs");c&&(c.innerHTML=`<div class="mb-1 opacity-90 break-words text-yellow-400">> 🧹 Bridge Queue FLUSH — ${l&&l.flushed||0} tâche(s) nettoyée(s)</div>`+c.innerHTML)}catch{alert("Moteur hors ligne : impossible de vider la queue.")}},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #a17c23, #4f3b0c)"},title:"Vider la file Bridge (déblocage injection)",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🧹"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Flush Queue"})]}),e.jsxs("button",{onClick:()=>{ct(!1),xe(!1),mt(s=>!s)},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #993a61, #4d152c)"},title:"Thèmes & Couleurs",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🎨"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Thèmes"})]}),e.jsxs("button",{onClick:()=>{mt(!1),xe(!1),ct(s=>!s)},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #5b227a, #230930)"},title:"Compiler l'Application Mobile (.apk - Java Portable)",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform animate-pulse",children:"📱"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"v0-apk"})]})]})}),e.jsxs("div",{className:"px-3 pb-1 pt-1 relative w-full flex flex-col gap-2",children:[e.jsx("input",{type:"file",ref:u,className:"hidden",multiple:!0,accept:".html,.md,.png,.jpg,.jpeg,.json,.txt,.zip",onChange:s=>{s.target.files&&s.target.files.length>0&&v(s.target.files),u.current&&(u.current.value="")}}),Be.length>0&&e.jsx("div",{className:"flex gap-2 px-2 overflow-x-auto hide-scrollbar pb-2",children:Be.map((s,l)=>e.jsxs("div",{className:"flex items-center gap-2 bg-cyan/10 border border-cyan/30 text-cyan text-xs px-3 py-1.5 rounded-full whitespace-nowrap animate-fadeIn",children:[e.jsxs("span",{children:["📎 ",s.path.split("/").pop()||s.path.split("\\").pop()]}),e.jsx("button",{onClick:()=>gt(c=>c.filter((w,h)=>h!==l)),className:"hover:text-red-400 font-bold ml-1",children:"✕"})]},l))}),$e?e.jsxs("div",{id:"creation-mode-container",className:"absolute bottom-full left-2 right-2 mb-3 flex flex-col gap-4 bg-[#05080c]/98 p-5 rounded-3xl border-2 border-cyan/50 shadow-[0_0_50px_rgba(8,179,201,0.5)] backdrop-blur-2xl animate-fadeIn z-[100] max-h-[82vh] overflow-y-auto custom-scrollbar text-white",children:[e.jsxs("div",{className:"flex justify-between items-center mb-1 sticky top-0 bg-[#05080c]/98 z-10 py-2 border-b border-cyan/20",children:[e.jsxs("h3",{className:"text-cyan font-black flex items-center gap-2 text-base md:text-lg uppercase tracking-wider",children:[e.jsx("span",{className:"animate-pulse w-2.5 h-2.5 bg-cyan rounded-full shadow-[0_0_10px_#08b3c9]"})," ⚙️ CONFIGURATION DU PROJET"]}),e.jsx("button",{onClick:()=>Re(!1),className:"text-gray-400 hover:text-white bg-white/10 hover:bg-red-500 rounded-full w-7 h-7 flex items-center justify-center transition-colors",children:"✕"})]}),e.jsxs("div",{className:"flex flex-col gap-2 bg-black/60 p-3.5 rounded-2xl border border-white/10",children:[e.jsxs("label",{htmlFor:"project-target",className:"text-cyan font-bold uppercase text-[10px] tracking-widest flex items-center gap-1.5",children:[e.jsx("span",{children:"📁"})," CIBLER LE PROJET :"]}),e.jsxs("select",{id:"project-target",value:Ut||"",onChange:s=>{const l=s.target.value;Ot(l||null),We(l?l.replace("Projet_","").split("_")[0]:"")},className:"w-full bg-[#11161d] text-white border border-cyan/30 rounded-xl px-3 py-2 outline-none focus:border-cyan text-xs cursor-pointer",children:[e.jsx("option",{value:"",children:"-- SÉLECTIONNER UN PROJET --"}),pe.map(s=>e.jsxs("option",{value:s.name,children:["📁 ",s.name]},s.name))]})]}),e.jsxs("div",{className:"flex flex-col gap-2 bg-black/60 p-3.5 rounded-2xl border border-white/10",children:[e.jsxs("label",{htmlFor:"project-instructions",className:"text-cyan font-bold uppercase text-[10px] tracking-widest flex items-center gap-1.5",children:[e.jsx("span",{children:"📝"})," INSTRUCTIONS SPÉCIFIQUES :"]}),e.jsx("textarea",{id:"project-instructions",value:dn,onChange:s=>Pn(s.target.value),placeholder:"Instructions pour le Patch ou la modification...",className:"w-full bg-[#11161d] text-white border border-slate-700 rounded-xl px-3.5 py-2 outline-none focus:border-cyan h-14 resize-none text-xs leading-relaxed"})]}),e.jsxs("div",{className:"flex flex-col gap-3.5 bg-black/60 p-3.5 rounded-2xl border border-white/10",children:[e.jsxs("div",{className:"text-cyan font-bold uppercase text-xs tracking-wider flex items-center gap-1.5 border-b border-white/10 pb-1.5",children:[e.jsx("span",{children:"⚡"})," PARAMÈTRES & CIBLES"]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"project-name",className:"text-cyan font-bold uppercase text-[10px] tracking-widest mb-1 block",children:"Nom du Projet"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{id:"project-name",type:"text",value:K,onChange:s=>We(s.target.value),placeholder:"Ex: MonSuperProjet",className:"flex-1 bg-[#11161d] text-white border border-slate-700 rounded-xl px-3 py-2 outline-none focus:border-cyan text-xs"}),e.jsx("button",{type:"button",onClick:async()=>{if(K.trim()){const l=K.trim().replace(/[^a-zA-Z0-9_-]/g,"_");Ie(l);try{const c="http://localhost:5006";await y(`${c}/v1/projects/set-active`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:l,project_id:l})}).catch(()=>null),await y(`${c}/api/fs/write`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:l,file:"README.md",content:`# ${K.trim()}

Initialisé par Tiger IA V0.`})}).catch(()=>null)}catch(c){console.error("Erreur lors de la création du dossier sur disque:",c)}}},className:"px-3 py-2 bg-cyan/20 hover:bg-cyan text-cyan hover:text-black font-bold text-xs rounded-xl border border-cyan/40 transition-colors whitespace-nowrap",children:"Valider"})]})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"project-stack",className:"text-cyan font-bold uppercase text-[10px] tracking-widest mb-1 block",children:"Stack Technique"}),e.jsxs("select",{id:"project-stack",value:Ee,onChange:s=>Wt(s.target.value),className:"w-full bg-[#11161d] text-white border border-slate-700 rounded-xl px-3 py-2 outline-none focus:border-cyan text-xs cursor-pointer",children:[e.jsx("option",{value:"Vite + React + Tailwind + TS",children:"⭐ 1er Choix (Prioritaire) : Vite + React + Tailwind + TS"}),e.jsx("option",{value:"Vite + React + TS + Canvas 2D",children:"🎮 Jeu 2D : Vite + React + TS + Canvas 2D"}),e.jsx("option",{value:"Vite + React + TS + Three.js / R3F (3D GPU)",children:"🚀 Jeu 3D GPU : Vite + React + TS + Three.js / R3F"}),e.jsx("option",{value:"Next.js + Tailwind + App Router",children:"Next.js + Tailwind + App Router"}),e.jsx("option",{value:"HTML + CSS Vanilla + JS",children:"HTML + CSS Vanilla + JS"})]})]})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"project-desc",className:"text-cyan font-bold uppercase text-[10px] tracking-widest mb-1 block",children:"Description / Vision"}),e.jsx("textarea",{id:"project-desc",value:Le,onChange:s=>cn(s.target.value),placeholder:"Décrivez l'application ou copiez votre PRD...",className:"w-full bg-[#11161d] text-white border border-slate-700 rounded-xl px-3.5 py-2 outline-none focus:border-cyan h-16 resize-none text-xs leading-relaxed"})]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2 pt-2 border-t border-white/10",children:[e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-[9px] font-bold text-cyan uppercase tracking-wider",children:"Intelligence Cible"}),e.jsxs("select",{value:Jt,onChange:s=>{An(s.target.value),localStorage.setItem("tiger_targetAi",s.target.value)},className:"bg-[#11161d] text-cyan font-bold text-xs border border-cyan/40 rounded-xl px-2.5 py-1.5 outline-none focus:border-cyan cursor-pointer",children:[e.jsx("option",{value:"deepseek",children:"🩵 DeepSeek"}),e.jsx("option",{value:"cloudflare",children:"☁️ Cloudflare Qwen 3 (Grade Gold)"}),e.jsx("option",{value:"stitch",children:"🎨 Stitch (Google)"}),e.jsx("option",{value:"v0",children:"⚡ V0.dev"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT"}),e.jsx("option",{value:"claude",children:"🟠 Claude"}),e.jsx("option",{value:"kimi",children:"🌙 Kimi (Moonshot)"}),e.jsx("option",{value:"gemini",children:"🔵 Gemini"}),e.jsx("option",{value:"qwen",children:"🔴 Qwen"}),e.jsx("option",{value:"perplexity",children:"🔍 Perplexity AI"})]})]}),e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-[9px] font-bold text-cyan uppercase tracking-wider",children:"💉 Mode & Lot de Départ"}),e.jsxs("select",{value:De,onChange:s=>yt(Number(s.target.value)),className:"bg-[#11161d] text-white font-bold text-xs border border-cyan/40 rounded-xl px-2.5 py-1.5 outline-none focus:border-cyan cursor-pointer",children:[e.jsx("option",{value:1,children:"🎨 Phase 1 : Le Frontend (Stitch/v0)"}),e.jsx("option",{value:2,children:"💻 Phase 2 : Le Backend (Assistant IA)"}),e.jsx("option",{value:4,children:"🎨 Phase 3/4 : Câblage Métier (Business Wiring)"})]})]}),e.jsxs("button",{type:"button",onClick:()=>_t(!Ae),className:`mt-4 px-3 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border ${Ae?"bg-green-600/30 text-green-300 border-green-500/50 shadow-[0_0_10px_rgba(34,197,94,0.3)]":"bg-slate-800 text-slate-300 border-slate-700 hover:border-slate-500"}`,children:[e.jsx("span",{children:"🤖"}),e.jsxs("span",{children:["AUTO-PILOT : ",Ae?"ON 🟢":"OFF ⚪"]})]}),e.jsxs("button",{type:"button",onClick:()=>Ct(!Ve),className:`mt-4 px-3 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border ${Ve?"bg-blue-600/30 text-blue-300 border-blue-500/50 shadow-[0_0_10px_rgba(59,130,246,0.3)]":"bg-slate-800 text-slate-300 border-slate-700"}`,title:"Cochez pour réutiliser l'onglet KIROV5 au lieu d'ouvrir un nouvel onglet",children:[e.jsx("span",{children:"🔗"}),e.jsx("span",{children:Ve?"✓ Injecter dans l'onglet déjà ouvert":"Ouvrir un nouvel onglet"})]}),e.jsxs("div",{id:"btn-joindre-prd",className:`mt-4 px-3 py-1.5 border rounded-xl text-xs font-bold flex items-center gap-1.5 relative ${E.length>0?"bg-indigo-600 text-white border-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.6)]":"bg-indigo-900/40 text-indigo-200 border-indigo-500/40"}`,title:"Pack PRD sélectionné — Sera injecté automatiquement dans le contexte IA",children:[e.jsx("span",{children:"💎"}),e.jsx("span",{children:E.length>0?`Packs PRD ${E.length} ${E[0]}`:"Aucun Pack PRD sélectionné"})]}),e.jsxs("button",{type:"button",onClick:()=>{var s;return(s=u.current)==null?void 0:s.click()},className:"mt-4 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-white border border-slate-600 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 shadow-md",children:[e.jsx("span",{children:"📎"}),e.jsx("span",{children:"Joindre ZIP (Stitch)"})]})]})]}),ge&&e.jsxs("div",{className:"w-full bg-[#0a0d14]/98 p-4 rounded-2xl border-2 border-indigo-500/60 shadow-[0_0_30px_rgba(99,102,241,0.4)] my-2 text-white animate-fadeIn max-h-[50vh] overflow-y-auto custom-scrollbar flex flex-col gap-3 z-30",children:[e.jsxs("div",{className:"flex justify-between items-center pb-2 border-b border-indigo-500/30 sticky top-0 bg-[#0a0d14]/98 z-10 py-1",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-xl",children:"💎"}),e.jsxs("div",{children:[e.jsxs("h4",{className:"text-indigo-300 font-black text-xs md:text-sm uppercase tracking-wider",children:["PACKS PRD ARCHITECTURE (",E.length," SÉLECTIONNÉ",E.length>1?"S":"",")"]}),e.jsx("p",{className:"text-[10px] text-slate-400",children:"Sélectionnez les briques fonctionnelles à intégrer au Méga-Prompt."})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[E.length>0&&e.jsx("button",{type:"button",onClick:()=>me([]),className:"text-[10px] font-bold text-red-400 hover:text-red-300 bg-red-950/40 px-2 py-1 rounded-lg border border-red-500/30 transition-all",children:"Tout décocher"}),e.jsx("button",{type:"button",onClick:()=>xe(!1),className:"text-slate-400 hover:text-white bg-white/10 rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold transition-all",children:"✕"})]})]}),e.jsx("input",{type:"text",placeholder:"🔍 Filtrer un pack PRD (ex: auth, ecom, mobile, saas, ai, game, sqlite...)",value:bt,onChange:s=>Rt(s.target.value),className:"w-full bg-[#121824] text-xs text-white border border-indigo-500/40 rounded-xl px-3 py-2 outline-none focus:border-indigo-400 placeholder:text-slate-500"}),e.jsx("div",{className:"grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2",children:Pt.filter(s=>s.name.toLowerCase().includes(bt.toLowerCase())||s.id.toLowerCase().includes(bt.toLowerCase())).map(s=>{const l=E.includes(s.id),c=s.icon;return e.jsxs("div",{onClick:()=>qt(s.id),className:`p-2.5 rounded-xl border text-xs cursor-pointer transition-all flex flex-col justify-between gap-1.5 relative select-none ${l?"bg-indigo-900/60 border-indigo-400 text-white shadow-[0_0_12px_rgba(99,102,241,0.5)] scale-[1.02]":"bg-[#11161f] border-slate-800 text-slate-300 hover:border-indigo-500/50 hover:bg-[#171e2b]"}`,children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("div",{className:`p-1 rounded-lg ${s.color}`,children:e.jsx(c,{className:"w-3.5 h-3.5"})}),e.jsx("input",{type:"checkbox",checked:l,readOnly:!0,className:"accent-indigo-500 w-3.5 h-3.5 rounded cursor-pointer pointer-events-none"})]}),e.jsx("div",{className:"font-bold text-[11px] leading-tight line-clamp-1 text-white",children:s.name}),e.jsxs("div",{className:"text-[8px] text-slate-400 font-mono truncate",children:["#",s.id]})]},s.id)})}),e.jsx("div",{className:"pt-2 border-t border-indigo-500/20 flex justify-end",children:e.jsxs("button",{type:"button",onClick:()=>{xe(!1)},className:"px-4 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-black rounded-xl shadow-lg transition-all",children:["✓ Valider la sélection (",E.length,")"]})})]}),e.jsxs("div",{className:"flex justify-end gap-3 pt-2 border-t border-white/10",children:[e.jsx("button",{type:"button",onClick:()=>Re(!1),className:"px-4 py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-xl text-xs font-bold transition-all",children:"Annuler"}),e.jsxs("button",{type:"button",onClick:async s=>{if(!K.trim()&&!Ut){alert("Veuillez entrer un nom de projet ou en choisir un.");return}const l=K.trim()?K.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"",c=Ut||l||"Projet_"+Date.now().toString().slice(-4),w=s.currentTarget;w.innerText="⏳ Initialisation...",w.disabled=!0;try{const h="http://localhost:5006",f=typeof window<"u"&&window.Capacitor&&window.Capacitor.isNativePlatform();if(f)try{const{KirovSovereignEngine:ee}=window.Capacitor.Plugins;ee&&await ee.setActiveProject({name:c})}catch(ee){console.warn("Plugin mobile introuvable",ee)}else await y(`${h}/v1/projects/set-active`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:c})}).catch(()=>null);if(f)try{const{KirovSovereignEngine:ee}=window.Capacitor.Plugins;ee&&await ee.writeFile({project:c,file:"README.md",content:`# ${K||c}

Initialisé par Tiger IA V0.
Stack : ${Ee}
Description : ${Le}`})}catch{}else await y(`${h}/api/fs/write`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:c,file:"README.md",content:`# ${K||c}

Initialisé par Tiger IA V0.
Stack : ${Ee}
Description : ${Le}`})}).catch(()=>null);const R=E&&E.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${E.length})]
`+E.map(ee=>{const je=Pt.find(Ne=>Ne.id===ee);return`• ${je?je.name:ee} (#${ee})`}).join(`
`):"";let H=`

[STACK TECHNIQUE OBLIGATOIRE : ${Ee.toUpperCase()}]
`;Ee.includes("Three.js")||Ee.includes("3D GPU")?H+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être un jeu Web 3D accéléré GPU généré en **React + Vite + TypeScript (TSX) + Three.js / React Three Fiber (@react-three/fiber, @react-three/drei)**.
...
`:Ee.includes("Canvas 2D")?H+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être un jeu Web 2D généré en **React + Vite + TypeScript (TSX) + Canvas 2D**.
...
`:Ee.includes("Vite")?H+="⚠️ CONTRAT BOILERPLATE (GOLDEN CONTRACT) : Ce projet s'appuie sur un boilerplate préexistant (React + Vite + TS + Tailwind).\\n• INTERDICTION FORMELLE : Ne crée PAS et ne modifie PAS les fichiers `package.json`, `vite.config.ts`, `index.html`, `src/main.tsx` ou `src/index.css`.\\n• CHEMINS APLATIS (OBLIGATOIRE) : Tu DOIS placer TOUTES les pages directement à la racine de `src/pages/` (ex: `src/pages/SignatureManagerPage.tsx`). NE CRÉE JAMAIS de sous-dossiers imbriqués ni de fichiers `code.tsx` profonds.\\n• ANTI-DOUBLON : Ne crée pas la même page en double (ex: n'écris pas `Analyzer.tsx` ET `AnalyzerPage.tsx`). Génère un seul fichier par page avec le suffixe 'Page'.\\n• ROUTAGE STRICT : Dans `src/App.tsx`, vérifie que chaque import correspond EXACTEMENT au nom du fichier plat que tu as généré dans `src/pages/`. N'invente pas de routes fantômes.\\n":Ee.includes("Next")?H+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être généré en **Next.js (App Router)**.
• Générer : package.json, app/layout.tsx, app/page.tsx, app/globals.css.
`:H+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être généré en **HTML5 / CSS Vanilla / JS**.
• Générer : index.html, design.css, app.js.
`;const se=(Le.trim()||dn.trim()||`Initialisation du projet ${K||c}`)+H+R;let Y=Jt;if(De===1&&(Y=localStorage.getItem("tiger_targetUiAi")||"stitch"),f)try{const{KirovSovereignEngine:ee}=window.Capacitor.Plugins;if(ee){const je=Ke(Y);await ee.openAiTab({url:je}),setTimeout(async()=>{await ee.injectPrompt({prompt:se,target_ai:Y})},4500)}}catch{alert("Le moteur souverain mobile n'est pas encore implémenté ou le plugin est manquant.")}else if(De===2){if(await y(`${h}/api/bridge/trombone`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:c,user_prompt:se,target_ai:Y,packs:E,zip_mode:!0,start_phase:200,force_restart:!0,auto_submit:Xt})}).catch(()=>null),!Ve){await y(`${h}/v1/bridge/inject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:c,prompt:"OPEN_TAB_ONLY",target_ai:Y,phase_num:De})}).catch(()=>null);const ee=Ke(Y);window.open(ee,"_blank")}}else if(await y(`${h}/v1/bridge/inject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:c,prompt:se,target_ai:Y,phase_num:De,packs:E})}).catch(()=>null),await y(`${h}/api/bridge/expect-zip`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:c,target_ai:Y,auto_submit:Xt})}).catch(()=>null),!Ve){const ee=Ke(Y);window.open(ee,"_blank")}Pe(null),Xe(null),it(""),Re(!1),a(ee=>[...ee,{id:Date.now().toString(),role:"user",content:`🚀 Mission "${K||c}" initialisée pour ${Jt.toUpperCase()} avec ${E.length} pack(s) PRD. Injection du Méga-Prompt en cours...`}])}catch(h){alert("Erreur lors de la création : "+h.message)}finally{w.innerText="✅ Validé",w.disabled=!1}},className:"px-6 py-2.5 bg-gradient-to-r from-cyan to-blue-600 text-black font-black text-xs rounded-xl hover:from-cyan/80 hover:to-blue-600/80 transition-all shadow-[0_0_20px_rgba(8,179,201,0.4)] flex items-center gap-2",children:[e.jsx("span",{children:"🚀"})," Valider & Démarrer le Projet"]})]})]}):e.jsxs("div",{className:"relative flex items-center gap-2",children:[e.jsx("button",{onClick:()=>{var s;return(s=u.current)==null?void 0:s.click()},className:"design-btn-trombone transition-all opacity-80 z-20 hover:scale-110",title:"Joindre un fichier (Stitch/ZIP)",children:"📎"}),e.jsx("button",{onClick:()=>{Ie(null),We(""),gt([]),M("creation"),x(!0)},className:"design-btn-new-v0 font-bold flex items-center gap-1 transition-all z-20 hover:scale-105",title:"Créer un nouveau projet",children:"✨ New-v0"}),e.jsx("input",{type:"text",value:d,onChange:s=>p(s.target.value),onKeyDown:s=>s.key==="Enter"&&g(),placeholder:"Système v0-reponses initialisé. L'interface unique est active. Que souhaitez-vous faire ?",className:"design-chat-input w-full pl-6 pr-14 transition-all shadow-inner focus:outline-none focus:ring-1 focus:ring-cyan"}),e.jsx("button",{onClick:g,className:"design-btn-envoi absolute right-2 top-1/2 -translate-y-1/2 rounded-full flex items-center justify-center hover:scale-105 transition-all shadow-lg",children:e.jsx("svg",{className:"w-4 h-4 md:w-5 md:h-5 ml-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2.5",d:"M12 19l9 2-9-18-9 18 9-2zm0 0v-8"})})})]})]})]}),ce&&e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4",children:e.jsxs("div",{className:"bg-[#111] border border-white/10 rounded-2xl p-6 w-full max-w-md shadow-2xl relative",children:[e.jsx("button",{onClick:()=>z(!1),className:"absolute top-4 right-4 text-white/50 hover:text-white transition-colors",children:"✕"}),e.jsxs("h3",{className:"text-xl font-bold mb-4 flex items-center gap-2 text-white",children:[e.jsx("span",{className:"text-2xl",children:"⏪"})," Machine à Remonter le Temps"]}),e.jsxs("p",{className:"text-sm text-slate-400 mb-6",children:["Choisissez l'une des sauvegardes ci-dessous pour restaurer votre projet à un état antérieur.",e.jsx("br",{}),e.jsx("span",{className:"text-red-400 font-bold",children:"Attention : le code actuel sera écrasé."})]}),e.jsxs("div",{className:"space-y-3",children:[$.map(s=>e.jsxs("div",{className:"flex items-center justify-between bg-white/5 p-3 rounded-lg border border-white/10 hover:border-blue-500/50 transition-all",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-2xl",children:"📸"}),e.jsxs("div",{children:[e.jsx("div",{className:"font-bold text-sm text-blue-300",children:s.replace("backup-","")}),e.jsx("div",{className:"text-xs text-slate-500",children:"Sauvegarde Kirov"})]})]}),e.jsx("button",{onClick:()=>{window.confirm(`Confirmer la restauration de ${s} ?
Tout le travail actuel non sauvegardé sera perdu.`)&&y("http://localhost:5006/api/bridge/restore-backup",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:O,backup_name:s})}).then(l=>l?l.json():null).then(l=>{if(!l)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");l.success?(alert("✅ "+l.message),z(!1)):alert("❌ Erreur Restauration : "+l.error)}).catch(l=>alert("Erreur réseau: "+l.message))},className:"px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold rounded-lg transition-all",children:"Restaurer"})]},s)),$.length===0&&e.jsx("div",{className:"text-center p-4 text-slate-500 italic",children:"Aucune sauvegarde disponible."})]})]})}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
      ...
      `}})]})}function Ro({onAuthenticated:t}){const[n,r]=o.useState("login"),[a,d]=o.useState(""),[p,m]=o.useState(""),[u,I]=o.useState(""),[x,_]=o.useState(!1),[M,P]=o.useState(""),W=async T=>{if(T.preventDefault(),P(""),n==="register"&&p!==u){P("Les mots de passe ne correspondent pas.");return}if(p.length<8){P("Le mot de passe doit contenir au moins 8 caractères.");return}_(!0);try{const F=await fetch(n==="login"?"/api/auth/login":"/api/auth/register",{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({email:a,password:p})}),S=await F.json();if(!F.ok){const A={INVALID_CREDENTIALS:"Email ou mot de passe incorrect.",TOO_MANY_ATTEMPTS:"Trop de tentatives. Réessayez dans 15 minutes.",REGISTRATION_FAILED:"Cet email est déjà utilisé.",PASSWORD_TOO_SHORT:"Mot de passe trop court (8 caractères minimum)."};P(S.error?A[S.error]??S.error:"Une erreur est survenue.");return}S.token&&localStorage.setItem("kirov5_jwt_token",S.token),t({userId:S.userId,email:a})}catch{window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?(console.warn("Mode local sans Wrangler: Bypass de la connexion pour accès UI."),localStorage.setItem("kirov5_jwt_token","dev-mock-token"),t({userId:"dev-user-001",email:a||"dev@local"})):P("Impossible de contacter le serveur. Vérifiez votre connexion.")}finally{_(!1)}};return e.jsxs("div",{style:{minHeight:"100vh",background:"linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Inter', 'Segoe UI', sans-serif",padding:"20px"},children:[e.jsx("div",{style:{position:"fixed",inset:0,overflow:"hidden",pointerEvents:"none",zIndex:0},children:[...Array(6)].map((T,L)=>e.jsx("div",{style:{position:"absolute",borderRadius:"50%",background:`rgba(${L%2===0?"139,92,246":"59,130,246"},0.08)`,width:`${200+L*80}px`,height:`${200+L*80}px`,top:`${10+L*15}%`,left:`${5+L*16}%`,filter:"blur(60px)",animation:`float ${6+L}s ease-in-out infinite alternate`}},L))}),e.jsxs("div",{style:{position:"relative",zIndex:1,width:"100%",maxWidth:"420px"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"40px"},children:[e.jsx("div",{style:{display:"inline-flex",alignItems:"center",justifyContent:"center",width:"72px",height:"72px",borderRadius:"20px",background:"linear-gradient(135deg, #8b5cf6, #3b82f6)",marginBottom:"20px",boxShadow:"0 0 40px rgba(139,92,246,0.4)",fontSize:"32px"},children:"⚡"}),e.jsx("h1",{style:{margin:0,fontSize:"28px",fontWeight:800,background:"linear-gradient(135deg, #a78bfa, #60a5fa)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",letterSpacing:"-0.5px"},children:"Kirov5 Sovereign Forge"}),e.jsx("p",{style:{color:"rgba(255,255,255,0.4)",marginTop:"8px",fontSize:"14px"},children:"Plateforme de génération d'applications IA"})]}),e.jsxs("div",{style:{background:"rgba(255,255,255,0.04)",backdropFilter:"blur(20px)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"24px",padding:"36px",boxShadow:"0 25px 50px rgba(0,0,0,0.4)"},children:[e.jsx("div",{style:{display:"flex",background:"rgba(0,0,0,0.3)",borderRadius:"12px",padding:"4px",marginBottom:"28px"},children:["login","register"].map(T=>e.jsx("button",{onClick:()=>{r(T),P("")},style:{flex:1,padding:"10px",borderRadius:"10px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:600,transition:"all 0.2s ease",background:n===T?"linear-gradient(135deg, #8b5cf6, #3b82f6)":"transparent",color:n===T?"#fff":"rgba(255,255,255,0.4)"},children:T==="login"?"🔑 Connexion":"✨ Inscription"},T))}),e.jsxs("form",{onSubmit:W,children:[e.jsxs("div",{style:{marginBottom:"16px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Adresse email"}),e.jsx("input",{type:"email",value:a,onChange:T=>d(T.target.value),required:!0,autoComplete:"email",placeholder:"vous@exemple.com",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box",transition:"border-color 0.2s"},onFocus:T=>T.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:T=>T.target.style.borderColor="rgba(255,255,255,0.1)"})]}),e.jsxs("div",{style:{marginBottom:n==="register"?"16px":"24px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Mot de passe"}),e.jsx("input",{type:"password",value:p,onChange:T=>m(T.target.value),required:!0,autoComplete:n==="login"?"current-password":"new-password",placeholder:n==="register"?"8 caractères minimum":"••••••••",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box"},onFocus:T=>T.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:T=>T.target.style.borderColor="rgba(255,255,255,0.1)"})]}),n==="register"&&e.jsxs("div",{style:{marginBottom:"24px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Confirmer le mot de passe"}),e.jsx("input",{type:"password",value:u,onChange:T=>I(T.target.value),required:!0,autoComplete:"new-password",placeholder:"••••••••",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box"},onFocus:T=>T.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:T=>T.target.style.borderColor="rgba(255,255,255,0.1)"})]}),M&&e.jsxs("div",{style:{background:"rgba(239,68,68,0.12)",border:"1px solid rgba(239,68,68,0.3)",borderRadius:"10px",padding:"12px 16px",marginBottom:"16px",color:"#fca5a5",fontSize:"13px",display:"flex",alignItems:"center",gap:"8px"},children:[e.jsx("span",{children:"⚠️"})," ",M]}),e.jsx("button",{type:"submit",disabled:x,style:{width:"100%",padding:"14px",borderRadius:"12px",border:"none",background:x?"rgba(139,92,246,0.4)":"linear-gradient(135deg, #8b5cf6, #3b82f6)",color:"#fff",fontSize:"15px",fontWeight:700,cursor:x?"not-allowed":"pointer",transition:"all 0.2s ease",boxShadow:x?"none":"0 4px 20px rgba(139,92,246,0.4)"},children:x?"⏳ Chargement...":n==="login"?"🚀 Se connecter":"✨ Créer mon compte"})]}),e.jsx("p",{style:{textAlign:"center",marginTop:"20px",fontSize:"12px",color:"rgba(255,255,255,0.25)"},children:"🔒 Connexion sécurisée — Vos données sont chiffrées"})]})]}),e.jsx("style",{children:`
        @keyframes float {
          from { transform: translateY(0px) scale(1); }
          to { transform: translateY(-30px) scale(1.05); }
        }
        input::placeholder { color: rgba(255,255,255,0.25); }
      `})]})}(function(){var a;const n=typeof window<"u"&&(!!window.electron||!!window.electronAPI||typeof navigator<"u"&&((a=navigator.userAgent)==null?void 0:a.includes("Electron"))),r=typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"||n);if(typeof window<"u"){const d=window.fetch.bind(window);window.fetch=function(p,m){const u=typeof p=="string"?p:p instanceof URL?p.href:p.url;if(!r&&u&&(u.includes("localhost:500")||u.includes("127.0.0.1:500")||u.includes(":5006")))return console.debug("[KIROV5-FIREWALL] Blocked remote bridge request (Pure Cloud SaaS):",u),Promise.resolve(new Response(JSON.stringify({success:!1,blocked:!0,mode:"cloud-saas"}),{status:200,headers:{"Content-Type":"application/json"}}));if(u&&(u.includes("/api/auth/login")||u.includes("/api/auth/register")||u.includes("/api/auth/session")))return Promise.resolve(new Response(JSON.stringify({success:!0,authenticated:!0,token:"dev-local-jwt-token",userId:"dev-user-001",email:"dev@kirov5.local"}),{status:200,headers:{"Content-Type":"application/json"}}));if(!r&&u&&u.includes("/api/projects")){const I=[{project_id:"TETRISV7",title:"TETRISV7",name:"TETRISV7",desc:"Projet local WorldModel"},{project_id:"TETRISV6",title:"TETRISV6",name:"TETRISV6",desc:"Projet local WorldModel"}];return Promise.resolve(new Response(JSON.stringify({success:!0,projects:I}),{status:200,headers:{"Content-Type":"application/json"}}))}return d(p,m)},console.info("[KIROV5-FIREWALL] ✅ Network firewall active — Local dev bridge enabled (Zero-Error)")}})();function Eo(){const[t,n]=o.useState({userId:"dev-user-001",email:"dev@kirov5.local"}),[r,a]=o.useState(!1);return o.useEffect(()=>{(async()=>{try{const p=localStorage.getItem("kirov5_jwt_token")||"dev-local-jwt-token";localStorage.setItem("kirov5_jwt_token",p);const m=await fetch("/api/auth/session",{headers:{Authorization:`Bearer ${p}`}});if(m.ok){const u=await m.json();u.authenticated&&n({userId:u.userId||"dev-user-001",email:u.email||"dev@kirov5.local"})}}catch{n({userId:"dev-user-001",email:"dev@kirov5.local"})}finally{a(!1)}})()},[]),r?e.jsx("div",{style:{minHeight:"100vh",background:"linear-gradient(135deg, #0f0c29, #302b63, #24243e)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"Inter, sans-serif"},children:e.jsxs("div",{style:{textAlign:"center",color:"rgba(255,255,255,0.6)"},children:[e.jsx("div",{style:{fontSize:"48px",marginBottom:"16px"},children:"⚡"}),e.jsx("div",{style:{fontSize:"14px"},children:"Initialisation du Studio Kirov5..."})]})}):t?e.jsx(ko,{}):e.jsx(Ro,{onAuthenticated:d=>n(d)})}os.createRoot(document.getElementById("root")).render(e.jsx(ft.StrictMode,{children:e.jsx(Eo,{})}));export{vn as E,Zn as W,Pa as b};

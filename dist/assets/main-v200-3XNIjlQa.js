const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-CfsZwIJD.js","assets/design-v200-t3YgdfE5.js","assets/design-v200-B0v9GGsU.css"])))=>i.map(i=>d[i]);
import{r as o,a as Rt,j as e,s as A,i as gs,R as hs}from"./design-v200-t3YgdfE5.js";const xs="modulepreload",fs=function(t){return"/"+t},Mn={},Yt=function(n,r,a){let d=Promise.resolve();if(r&&r.length>0){let m=function(b){return Promise.all(b.map(f=>Promise.resolve(f).then(M=>({status:"fulfilled",value:M}),M=>({status:"rejected",reason:M}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),S=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));d=m(r.map(b=>{if(b=fs(b),b in Mn)return;Mn[b]=!0;const f=b.endsWith(".css"),M=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${b}"]${M}`))return;const E=document.createElement("link");if(E.rel=f?"stylesheet":xs,f||(E.as="script"),E.crossOrigin="",E.href=b,S&&E.setAttribute("nonce",S),document.head.appendChild(E),f)return new Promise((B,C)=>{E.addEventListener("load",B),E.addEventListener("error",()=>C(new Error(`Unable to preload CSS for ${b}`)))})}))}function p(m){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=m,window.dispatchEvent(u),!u.defaultPrevented)throw m}return d.then(m=>{for(const u of m||[])u.status==="rejected"&&p(u.reason);return n().catch(p)})},bs=`# undefined
...
`,vs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
---
### 🔄 INSTRUCTION DE FUSION (Pour l'Orchestrateur API)
*Lorsque l'utilisateur sélectionnera ce pack "Audio" dans l'interface de Tiger IA, tu dois fusionner ces 10 capacités avec la demande précise du chat. Par exemple, si l'utilisateur demande "Crée moi un clone de Spotify", tu dois immédiatement mobiliser les modules \`prd_audio_file_library\`, \`prd_audio_player_podcast\` et \`prd_audio_mix_playlist\` pour générer une architecture complète en un seul shot.*`,ys=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
## Instructions Originales
`,ws=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/commerce/pages/SuccessPage.tsx\``,Is=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/components/ui/Toast.tsx\``,As=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/creator/components/SocialLinkButton.tsx\``,Ps=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/handoff/components/RedlineViewer.tsx\``,js=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
`,Ts=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/shop/contexts/CartContext.tsx\``,ks=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- src/shared/constants/products.ts (données mock)`,Es=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/events/components/TicketingCard.tsx\``,Rs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/feed/hooks/useInfiniteFeed.ts\``,Ns=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`/requirements.txt\` & \`/package.json\` (Gestion des dépendances isolées)`,Ds=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/components/inputs/CreditCardInput.tsx\``,Ms=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/forms/schemas/registrationSchema.ts\``,qs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/gamification/components/BadgeGrid.tsx\``,Ls=`# APK Forge — Intelligent Android Packaging Suite
...
---
`,Us=`# Industrialisation_Backend_KIROV5
...
## Instructions Originales
`,Os=`# BRIC — Sovereign PRD Specification Pack
...
`,Gs=`# bricbrac — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Fs=`# bros — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Vs=`# BROSS — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Bs=`# Industrialisation_Backend_Phase5
...
MIT`,Hs=`# COLORFUL LANDING PAGE BUILDER
...
## License
MIT`,$s=`# CyberRunner — Sovereign PRD Specification Pack
...
src/
  ...
  main.tsx
  index.css
\`\`\``,Qs=`# gametetris — Sovereign PRD Specification Pack
...
MIT`,nr=`# mariob — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,sr=`# 🚀 Pack PRD : Calculatrice Premium "One-Shot" (guest_nebula_calc)
...
Chaque composant doit être entièrement fonctionnel, avec des props typées, et utiliser les hooks appropriés. Le code doit être propre, commenté et suivre les meilleures pratiques React/TypeScript.`,ir=`> **Directive Système IA** : Tu es un Architecte Logiciel Senior et Expert en Product Design. Génère des composants React/TypeScript de haute qualité pour le jeu **NEONSTACK ARCADE**. Suis les directives du PRD, respecte le design system, et produis du code fonctionnel et esthétique.
...
src/
  ...
  App.tsx
  main.tsx
\`\`\``,ar=`# plateforme — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,or=`# plateformv2 — Sovereign PRD Specification Pack
...
src/
  ...
  App.tsx
  main.tsx
\`\`\``,cr=`# PRODUCTION READY INDUSTRIALIZATION
...
## Instructions Originales
`,pr=`# SOVEREIGN PRODUCTION PLATFORM
...
`,Sr=`# Workflow Automation Platform
...
└── utils/
    ├── constants.ts
    └── helpers.ts
\`\`\``,Cr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/utils/audioContext.ts\``,Ir=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/images/hooks/useImageUpload.ts\``,Ar=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/admin/components/EmptyState.tsx\``,Pr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/game/types/engine.ts\``,jr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/landing/components/FooterCTA.tsx\``,Tr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/saas-landing/components/ProductMockup.tsx\``,kr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/layouts/KanbanLayout.tsx\``,Er=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/maps/hooks/useGeolocation.ts\``,Rr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/markdown/components/TableOfContents.tsx\``,Nr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/marketing/components/LeadCaptureForm.tsx\``,Dr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/mobile/components/SwipeActionContainer.tsx\``,Mr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/shell/components/BottomSheet.tsx\``,qr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/mobile/components/SwipeableOnboarding.tsx\``,Lr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/api/apiClient.ts\` (Interface qui tape sur les mocks pour l'instant)`,Ur=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/documents/components/ThumbnailSidebar.tsx\``,Or=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/hooks/useFileUpload.ts\``,Gr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/ai.ts\` (interfaces Message, ChatSession, Attachment)`,Fr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/voice/components/MicrophoneToggle.tsx\``,Vr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/auth/hooks/useSession.ts\``,Br=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/crm.ts\` (interfaces Contact, Activity, Tag)`,Hr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/catalog/hooks/useCatalogFilters.ts\``,$r=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/checkout/components/ExpressPayButtons.tsx\``,Kr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
`,Wr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/leaderboard/components/StickyUserRank.tsx\``,Jr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/dashboard/pages/BentoDashboardPage.tsx\``,Xr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/kanban/hooks/useKanbanBoard.ts\``,Qr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
---
### 🔄 INSTRUCTION DE FUSION (Pour l'Orchestrateur API)
*Lorsque l'utilisateur demandera "Crée moi la structure de mon app mobile type Instagram", tu devras utiliser ce PRD Mobile comme squelette. Tu injecteras une Tab Bar en bas (Accueil, Recherche, Ajouter, Profil) et tu t'assureras que le défilement vertical n'affecte que le contenu intérieur (overflow-y-auto) sans faire bouger les barres de navigation natives.*`,Zr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/social/components/LikeAnimation.tsx\``,Yr=`# bricbrac — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,ei=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/billing/components/InvoiceTable.tsx\``,ti=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/saas.ts\` (interfaces User, Tenant, Subscription)`,ni=`# 🏛️ Pack PRD : Sovereign Full-Stack Engine
...
- \`src/features/specs/components/DynamicForm.tsx\``,ri=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/utils/timeFormat.ts\``,ai=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/marketing/components/RoadmapBoard.tsx\``,oi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/ai-studio/components/TokenCostChart.tsx\``,li=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/saas/pages/BillingDashboard.tsx\``,ci=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/database/components/ResultDataTable.tsx\``,ui=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/stealth/ui/FloatingGhostMenu.tsx\``,pi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/editor/hooks/useEditorState.ts\``,mi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
`,gi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/video/hooks/useVideoPlayer.ts\``,hi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/blog/components/TableOfContents.tsx\``,xi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/widgets/hooks/useCalendarState.ts\``;function qn(t,n){(n==null||n>t.length)&&(n=t.length);for(var r=0,a=Array(n);r<n;r++)a[r]=t[r];return a}function fi(t){if(Array.isArray(t))return t}function bi(t,n,r){return(n=Ii(n))in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function vi(t,n){var r=t==null?null:typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(r!=null){var a,d,p,m,u=[],S=!0,b=!1;try{if(p=(r=r.call(t)).next,n!==0)for(;!(S=(a=p.call(r)).done)&&(u.push(a.value),u.length!==n);S=!0);}catch(f){b=!0,d=f}finally{try{if(!S&&r.return!=null&&(m=r.return(),Object(m)!==m))return}finally{if(b)throw d}}return u}}function Si(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Ln(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(t);n&&(a=a.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,a)}return r}function Un(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Ln(Object(r),!0).forEach(function(a){bi(t,a,r[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Ln(Object(r)).forEach(function(a){Object.defineProperty(t,a,Object.getOwnPropertyDescriptor(r,a))})}return t}function yi(t,n){if(t==null)return{};var r,a,d=_i(t,n);if(Object.getOwnPropertySymbols){var p=Object.getOwnPropertySymbols(t);for(a=0;a<p.length;a++)r=p[a],n.indexOf(r)===-1&&{}.propertyIsEnumerable.call(t,r)&&(d[r]=t[r])}return d}function _i(t,n){if(t==null)return{};var r={};for(var a in t)if({}.hasOwnProperty.call(t,a)){if(n.indexOf(a)!==-1)continue;r[a]=t[a]}return r}function Ci(t,n){return fi(t)||vi(t,n)||Ai(t,n)||Si()}function wi(t,n){if(typeof t!="object"||!t)return t;var r=t[Symbol.toPrimitive];if(r!==void 0){var a=r.call(t,n);if(typeof a!="object")return a;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}function Ii(t){var n=wi(t,"string");return typeof n=="symbol"?n:n+""}function Ai(t,n){if(t){if(typeof t=="string")return qn(t,n);var r={}.toString.call(t).slice(8,-1);return r==="Object"&&t.constructor&&(r=t.constructor.name),r==="Map"||r==="Set"?Array.from(t):r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?qn(t,n):void 0}}function Pi(t,n,r){return n in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function On(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(t);n&&(a=a.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,a)}return r}function Gn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?On(Object(r),!0).forEach(function(a){Pi(t,a,r[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):On(Object(r)).forEach(function(a){Object.defineProperty(t,a,Object.getOwnPropertyDescriptor(r,a))})}return t}function ji(){for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r];return function(a){return n.reduceRight(function(d,p){return p(d)},a)}}function Qt(t){return function n(){for(var r=this,a=arguments.length,d=new Array(a),p=0;p<a;p++)d[p]=arguments[p];return d.length>=t.length?t.apply(this,d):function(){for(var m=arguments.length,u=new Array(m),S=0;S<m;S++)u[S]=arguments[S];return n.apply(r,[].concat(d,u))}}}function mn(t){return{}.toString.call(t).includes("Object")}function Ti(t){return!Object.keys(t).length}function en(t){return typeof t=="function"}function ki(t,n){return Object.prototype.hasOwnProperty.call(t,n)}function Ei(t,n){return mn(n)||Ct("changeType"),Object.keys(n).some(function(r){return!ki(t,r)})&&Ct("changeField"),n}function Ri(t){en(t)||Ct("selectorType")}function Ni(t){en(t)||mn(t)||Ct("handlerType"),mn(t)&&Object.values(t).some(function(n){return!en(n)})&&Ct("handlersType")}function Di(t){t||Ct("initialIsRequired"),mn(t)||Ct("initialType"),Ti(t)&&Ct("initialContent")}function Mi(t,n){throw new Error(t[n]||t.default)}var qi={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},Ct=Qt(Mi)(qi),cn={changes:Ei,selector:Ri,handler:Ni,initial:Di};function Li(t){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};cn.initial(t),cn.handler(n);var r={current:t},a=Qt(Gi)(r,n),d=Qt(Oi)(r),p=Qt(cn.changes)(t),m=Qt(Ui)(r);function u(){var b=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(f){return f};return cn.selector(b),b(r.current)}function S(b){ji(a,d,p,m)(b)}return[u,S]}function Ui(t,n){return en(n)?n(t.current):n}function Oi(t,n){return t.current=Gn(Gn({},t.current),n),n}function Gi(t,n,r){return en(n)?n(t.current):Object.keys(r).forEach(function(a){var d;return(d=n[a])===null||d===void 0?void 0:d.call(n,t.current[a])}),r}var Fi={create:Li},Vi={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.55.1/min/vs"}};function Bi(t){return function n(){for(var r=this,a=arguments.length,d=new Array(a),p=0;p<a;p++)d[p]=arguments[p];return d.length>=t.length?t.apply(this,d):function(){for(var m=arguments.length,u=new Array(m),S=0;S<m;S++)u[S]=arguments[S];return n.apply(r,[].concat(d,u))}}}function zi(t){return{}.toString.call(t).includes("Object")}function Hi(t){return t||Fn("configIsRequired"),zi(t)||Fn("configType"),t.urls?($i(),{paths:{vs:t.urls.monacoBase}}):t}function $i(){console.warn(Xn.deprecation)}function Ki(t,n){throw new Error(t[n]||t.default)}var Xn={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},Fn=Bi(Ki)(Xn),Wi={config:Hi},Ji=function(){for(var n=arguments.length,r=new Array(n),a=0;a<n;a++)r[a]=arguments[a];return function(d){return r.reduceRight(function(p,m){return m(p)},d)}};function Qn(t,n){return Object.keys(n).forEach(function(r){n[r]instanceof Object&&t[r]&&Object.assign(n[r],Qn(t[r],n[r]))}),Un(Un({},t),n)}var Xi={type:"cancelation",msg:"operation is manually canceled"};function Sn(t){var n=!1,r=new Promise(function(a,d){t.then(function(p){return n?d(Xi):a(p)}),t.catch(d)});return r.cancel=function(){return n=!0},r}var Qi=["monaco"],Zi=Fi.create({config:Vi,isInitialized:!1,resolve:null,reject:null,monaco:null}),Zn=Ci(Zi,2),tn=Zn[0],hn=Zn[1];function Yi(t){var n=Wi.config(t),r=n.monaco,a=yi(n,Qi);hn(function(d){return{config:Qn(d.config,a),monaco:r}})}function ea(){var t=tn(function(n){var r=n.monaco,a=n.isInitialized,d=n.resolve;return{monaco:r,isInitialized:a,resolve:d}});if(!t.isInitialized){if(hn({isInitialized:!0}),t.monaco)return t.resolve(t.monaco),Sn(yn);if(window.monaco&&window.monaco.editor)return Yn(window.monaco),t.resolve(window.monaco),Sn(yn);Ji(ta,sa)(ra)}return Sn(yn)}function ta(t){return document.body.appendChild(t)}function na(t){var n=document.createElement("script");return t&&(n.src=t),n}function sa(t){var n=tn(function(a){var d=a.config,p=a.reject;return{config:d,reject:p}}),r=na("".concat(n.config.paths.vs,"/loader.js"));return r.onload=function(){return t()},r.onerror=n.reject,r}function ra(){var t=tn(function(r){var a=r.config,d=r.resolve,p=r.reject;return{config:a,resolve:d,reject:p}}),n=window.require;n.config(t.config),n(["vs/editor/editor.main"],function(r){var a=r.m||r;Yn(a),t.resolve(a)},function(r){t.reject(r)})}function Yn(t){tn().monaco||hn({monaco:t})}function ia(){return tn(function(t){var n=t.monaco;return n})}var yn=new Promise(function(t,n){return hn({resolve:t,reject:n})}),es={config:Yi,init:ea,__getMonacoInstance:ia},aa={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},_n=aa,oa={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},la=oa;function ca({children:t}){return Rt.createElement("div",{style:la.container},t)}var da=ca,ua=da;function pa({width:t,height:n,isEditorReady:r,loading:a,_ref:d,className:p,wrapperProps:m}){return Rt.createElement("section",{style:{..._n.wrapper,width:t,height:n},...m},!r&&Rt.createElement(ua,null,a),Rt.createElement("div",{ref:d,style:{..._n.fullWidth,...!r&&_n.hide},className:p}))}var ma=pa,ts=o.memo(ma);function ga(t){o.useEffect(t,[])}var ns=ga;function ha(t,n,r=!0){let a=o.useRef(!0);o.useEffect(a.current||!r?()=>{a.current=!1}:t,n)}var Be=ha;function Zt(){}function Gt(t,n,r,a){return xa(t,a)||fa(t,n,r,a)}function xa(t,n){return t.editor.getModel(ss(t,n))}function fa(t,n,r,a){return t.editor.createModel(n,r,a?ss(t,a):void 0)}function ss(t,n){return t.Uri.parse(n)}function ba({original:t,modified:n,language:r,originalLanguage:a,modifiedLanguage:d,originalModelPath:p,modifiedModelPath:m,keepCurrentOriginalModel:u=!1,keepCurrentModifiedModel:S=!1,theme:b="light",loading:f="Loading...",options:M={},height:E="100%",width:B="100%",className:C,wrapperProps:O={},beforeMount:$=Zt,onMount:_=Zt}){let[w,G]=o.useState(!1),[y,q]=o.useState(!0),W=o.useRef(null),L=o.useRef(null),V=o.useRef(null),X=o.useRef(_),H=o.useRef($),J=o.useRef(!1);ns(()=>{let F=es.init();return F.then(ee=>(L.current=ee)&&q(!1)).catch(ee=>(ee==null?void 0:ee.type)!=="cancelation"&&console.error("Monaco initialization: error:",ee)),()=>W.current?ve():F.cancel()}),Be(()=>{if(W.current&&L.current){let F=W.current.getOriginalEditor(),ee=Gt(L.current,t||"",a||r||"text",p||"");ee!==F.getModel()&&F.setModel(ee)}},[p],w),Be(()=>{if(W.current&&L.current){let F=W.current.getModifiedEditor(),ee=Gt(L.current,n||"",d||r||"text",m||"");ee!==F.getModel()&&F.setModel(ee)}},[m],w),Be(()=>{let F=W.current.getModifiedEditor();F.getOption(L.current.editor.EditorOption.readOnly)?F.setValue(n||""):n!==F.getValue()&&(F.executeEdits("",[{range:F.getModel().getFullModelRange(),text:n||"",forceMoveMarkers:!0}]),F.pushUndoStop())},[n],w),Be(()=>{var F,ee;(ee=(F=W.current)==null?void 0:F.getModel())==null||ee.original.setValue(t||"")},[t],w),Be(()=>{let{original:F,modified:ee}=W.current.getModel();L.current.editor.setModelLanguage(F,a||r||"text"),L.current.editor.setModelLanguage(ee,d||r||"text")},[r,a,d],w),Be(()=>{var F;(F=L.current)==null||F.editor.setTheme(b)},[b],w),Be(()=>{var F;(F=W.current)==null||F.updateOptions(M)},[M],w);let z=o.useCallback(()=>{var de;if(!L.current)return;H.current(L.current);let F=Gt(L.current,t||"",a||r||"text",p||""),ee=Gt(L.current,n||"",d||r||"text",m||"");(de=W.current)==null||de.setModel({original:F,modified:ee})},[r,n,d,t,a,p,m]),ae=o.useCallback(()=>{var F;!J.current&&V.current&&(W.current=L.current.editor.createDiffEditor(V.current,{automaticLayout:!0,...M}),z(),(F=L.current)==null||F.editor.setTheme(b),G(!0),J.current=!0)},[M,b,z]);o.useEffect(()=>{w&&X.current(W.current,L.current)},[w]),o.useEffect(()=>{!y&&!w&&ae()},[y,w,ae]);function ve(){var ee,de,xe,_e;let F=(ee=W.current)==null?void 0:ee.getModel();u||((de=F==null?void 0:F.original)==null||de.dispose()),S||((xe=F==null?void 0:F.modified)==null||xe.dispose()),(_e=W.current)==null||_e.dispose()}return Rt.createElement(ts,{width:B,height:E,isEditorReady:w,loading:f,_ref:V,className:C,wrapperProps:O})}var va=ba;o.memo(va);function Sa(t){let n=o.useRef();return o.useEffect(()=>{n.current=t},[t]),n.current}var ya=Sa,dn=new Map;function _a({defaultValue:t,defaultLanguage:n,defaultPath:r,value:a,language:d,path:p,theme:m="light",line:u,loading:S="Loading...",options:b={},overrideServices:f={},saveViewState:M=!0,keepCurrentModel:E=!1,width:B="100%",height:C="100%",className:O,wrapperProps:$={},beforeMount:_=Zt,onMount:w=Zt,onChange:G,onValidate:y=Zt}){let[q,W]=o.useState(!1),[L,V]=o.useState(!0),X=o.useRef(null),H=o.useRef(null),J=o.useRef(null),z=o.useRef(w),ae=o.useRef(_),ve=o.useRef(),F=o.useRef(a),ee=ya(p),de=o.useRef(!1),xe=o.useRef(!1);ns(()=>{let T=es.init();return T.then(K=>(X.current=K)&&V(!1)).catch(K=>(K==null?void 0:K.type)!=="cancelation"&&console.error("Monaco initialization: error:",K)),()=>H.current?te():T.cancel()}),Be(()=>{var K,re,ue,fe;let T=Gt(X.current,t||a||"",n||d||"",p||r||"");T!==((K=H.current)==null?void 0:K.getModel())&&(M&&dn.set(ee,(re=H.current)==null?void 0:re.saveViewState()),(ue=H.current)==null||ue.setModel(T),M&&((fe=H.current)==null||fe.restoreViewState(dn.get(p))))},[p],q),Be(()=>{var T;(T=H.current)==null||T.updateOptions(b)},[b],q),Be(()=>{!H.current||a===void 0||(H.current.getOption(X.current.editor.EditorOption.readOnly)?H.current.setValue(a):a!==H.current.getValue()&&(xe.current=!0,H.current.executeEdits("",[{range:H.current.getModel().getFullModelRange(),text:a,forceMoveMarkers:!0}]),H.current.pushUndoStop(),xe.current=!1))},[a],q),Be(()=>{var K,re;let T=(K=H.current)==null?void 0:K.getModel();T&&d&&((re=X.current)==null||re.editor.setModelLanguage(T,d))},[d],q),Be(()=>{var T;u!==void 0&&((T=H.current)==null||T.revealLine(u))},[u],q),Be(()=>{var T;(T=X.current)==null||T.editor.setTheme(m)},[m],q);let _e=o.useCallback(()=>{var T;if(!(!J.current||!X.current)&&!de.current){ae.current(X.current);let K=p||r,re=Gt(X.current,a||t||"",n||d||"",K||"");H.current=(T=X.current)==null?void 0:T.editor.create(J.current,{model:re,automaticLayout:!0,...b},f),M&&H.current.restoreViewState(dn.get(K)),X.current.editor.setTheme(m),u!==void 0&&H.current.revealLine(u),W(!0),de.current=!0}},[t,n,r,a,d,p,b,f,M,m,u]);o.useEffect(()=>{q&&z.current(H.current,X.current)},[q]),o.useEffect(()=>{!L&&!q&&_e()},[L,q,_e]),F.current=a,o.useEffect(()=>{var T,K;q&&G&&((T=ve.current)==null||T.dispose(),ve.current=(K=H.current)==null?void 0:K.onDidChangeModelContent(re=>{xe.current||G(H.current.getValue(),re)}))},[q,G]),o.useEffect(()=>{if(q){let T=X.current.editor.onDidChangeMarkers(K=>{var ue;let re=(ue=H.current.getModel())==null?void 0:ue.uri;if(re&&K.find(fe=>fe.path===re.path)){let fe=X.current.editor.getModelMarkers({resource:re});y==null||y(fe)}});return()=>{T==null||T.dispose()}}return()=>{}},[q,y]);function te(){var T,K;(T=ve.current)==null||T.dispose(),E?M&&dn.set(p,H.current.saveViewState()):(K=H.current.getModel())==null||K.dispose(),H.current.dispose()}return Rt.createElement(ts,{width:B,height:C,isEditorReady:q,loading:S,_ref:J,className:O,wrapperProps:$})}var Ca=_a,wa=o.memo(Ca),Ia=wa;/*! Capacitor: https://capacitorjs.com/ - MIT License */const Aa=t=>{const n=new Map;n.set("web",{name:"web"});const r=t.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:n},a=(p,m)=>{r.platforms.set(p,m)},d=p=>{r.platforms.has(p)&&(r.currentPlatform=r.platforms.get(p))};return r.addPlatform=a,r.setPlatform=d,r},Pa=t=>t.CapacitorPlatforms=Aa(t),rs=Pa(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});rs.addPlatform;rs.setPlatform;var Bt;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(Bt||(Bt={}));class Cn extends Error{constructor(n,r,a){super(n),this.message=n,this.code=r,this.data=a}}const ja=t=>{var n,r;return t!=null&&t.androidBridge?"android":!((r=(n=t==null?void 0:t.webkit)===null||n===void 0?void 0:n.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},Ta=t=>{var n,r,a,d,p;const m=t.CapacitorCustomPlatform||null,u=t.Capacitor||{},S=u.Plugins=u.Plugins||{},b=t.CapacitorPlatforms,f=()=>m!==null?m.name:ja(t),M=((n=b==null?void 0:b.currentPlatform)===null||n===void 0?void 0:n.getPlatform)||f,E=()=>M()!=="web",B=((r=b==null?void 0:b.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||E,C=L=>{const V=y.get(L);return!!(V!=null&&V.platforms.has(M())||_(L))},O=((a=b==null?void 0:b.currentPlatform)===null||a===void 0?void 0:a.isPluginAvailable)||C,$=L=>{var V;return(V=u.PluginHeaders)===null||V===void 0?void 0:V.find(X=>X.name===L)},_=((d=b==null?void 0:b.currentPlatform)===null||d===void 0?void 0:d.getPluginHeader)||$,w=L=>t.console.error(L),G=(L,V,X)=>Promise.reject(`${X} does not have an implementation of "${V}".`),y=new Map,q=(L,V={})=>{const X=y.get(L);if(X)return console.warn(`Capacitor plugin "${L}" already registered. Cannot register plugins twice.`),X.proxy;const H=M(),J=_(L);let z;const ae=async()=>(!z&&H in V?z=typeof V[H]=="function"?z=await V[H]():z=V[H]:m!==null&&!z&&"web"in V&&(z=typeof V.web=="function"?z=await V.web():z=V.web),z),ve=(te,T)=>{var K,re;if(J){const ue=J==null?void 0:J.methods.find(fe=>T===fe.name);if(ue)return ue.rtype==="promise"?fe=>u.nativePromise(L,T.toString(),fe):(fe,Ee)=>u.nativeCallback(L,T.toString(),fe,Ee);if(te)return(K=te[T])===null||K===void 0?void 0:K.bind(te)}else{if(te)return(re=te[T])===null||re===void 0?void 0:re.bind(te);throw new Cn(`"${L}" plugin is not implemented on ${H}`,Bt.Unimplemented)}},F=te=>{let T;const K=(...re)=>{const ue=ae().then(fe=>{const Ee=ve(fe,te);if(Ee){const Te=Ee(...re);return T=Te==null?void 0:Te.remove,Te}else throw new Cn(`"${L}.${te}()" is not implemented on ${H}`,Bt.Unimplemented)});return te==="addListener"&&(ue.remove=async()=>T()),ue};return K.toString=()=>`${te.toString()}() { [capacitor code] }`,Object.defineProperty(K,"name",{value:te,writable:!1,configurable:!1}),K},ee=F("addListener"),de=F("removeListener"),xe=(te,T)=>{const K=ee({eventName:te},T),re=async()=>{const fe=await K;de({eventName:te,callbackId:fe},T)},ue=new Promise(fe=>K.then(()=>fe({remove:re})));return ue.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await re()},ue},_e=new Proxy({},{get(te,T){switch(T){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return J?xe:ee;case"removeListener":return de;default:return F(T)}}});return S[L]=_e,y.set(L,{name:L,proxy:_e,platforms:new Set([...Object.keys(V),...J?[H]:[]])}),_e},W=((p=b==null?void 0:b.currentPlatform)===null||p===void 0?void 0:p.registerPlugin)||q;return u.convertFileSrc||(u.convertFileSrc=L=>L),u.getPlatform=M,u.handleError=w,u.isNativePlatform=B,u.isPluginAvailable=O,u.pluginMethodNoop=G,u.registerPlugin=W,u.Exception=Cn,u.DEBUG=!!u.DEBUG,u.isLoggingEnabled=!!u.isLoggingEnabled,u.platform=u.getPlatform(),u.isNative=u.isNativePlatform(),u},ka=t=>t.Capacitor=Ta(t),zt=ka(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),En=zt.registerPlugin;zt.Plugins;class is{constructor(n){this.listeners={},this.retainedEventArguments={},this.windowListeners={},n&&(console.warn(`Capacitor WebPlugin "${n.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=n)}addListener(n,r){let a=!1;this.listeners[n]||(this.listeners[n]=[],a=!0),this.listeners[n].push(r);const p=this.windowListeners[n];p&&!p.registered&&this.addWindowListener(p),a&&this.sendRetainedArgumentsForEvent(n);const m=async()=>this.removeListener(n,r);return Promise.resolve({remove:m})}async removeAllListeners(){this.listeners={};for(const n in this.windowListeners)this.removeWindowListener(this.windowListeners[n]);this.windowListeners={}}notifyListeners(n,r,a){const d=this.listeners[n];if(!d){if(a){let p=this.retainedEventArguments[n];p||(p=[]),p.push(r),this.retainedEventArguments[n]=p}return}d.forEach(p=>p(r))}hasListeners(n){return!!this.listeners[n].length}registerWindowListener(n,r){this.windowListeners[r]={registered:!1,windowEventName:n,pluginEventName:r,handler:a=>{this.notifyListeners(r,a)}}}unimplemented(n="not implemented"){return new zt.Exception(n,Bt.Unimplemented)}unavailable(n="not available"){return new zt.Exception(n,Bt.Unavailable)}async removeListener(n,r){const a=this.listeners[n];if(!a)return;const d=a.indexOf(r);this.listeners[n].splice(d,1),this.listeners[n].length||this.removeWindowListener(this.windowListeners[n])}addWindowListener(n){window.addEventListener(n.windowEventName,n.handler),n.registered=!0}removeWindowListener(n){n&&(window.removeEventListener(n.windowEventName,n.handler),n.registered=!1)}sendRetainedArgumentsForEvent(n){const r=this.retainedEventArguments[n];r&&(delete this.retainedEventArguments[n],r.forEach(a=>{this.notifyListeners(n,a)}))}}const Vn=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Bn=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Ea extends is{async getCookies(){const n=document.cookie,r={};return n.split(";").forEach(a=>{if(a.length<=0)return;let[d,p]=a.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");d=Bn(d).trim(),p=Bn(p).trim(),r[d]=p}),r}async setCookie(n){try{const r=Vn(n.key),a=Vn(n.value),d=`; expires=${(n.expires||"").replace("expires=","")}`,p=(n.path||"/").replace("path=",""),m=n.url!=null&&n.url.length>0?`domain=${n.url}`:"";document.cookie=`${r}=${a||""}${d}; path=${p}; ${m};`}catch(r){return Promise.reject(r)}}async deleteCookie(n){try{document.cookie=`${n.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{const n=document.cookie.split(";")||[];for(const r of n)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(n){return Promise.reject(n)}}async clearAllCookies(){try{await this.clearCookies()}catch(n){return Promise.reject(n)}}}En("CapacitorCookies",{web:()=>new Ea});const Ra=async t=>new Promise((n,r)=>{const a=new FileReader;a.onload=()=>{const d=a.result;n(d.indexOf(",")>=0?d.split(",")[1]:d)},a.onerror=d=>r(d),a.readAsDataURL(t)}),Na=(t={})=>{const n=Object.keys(t);return Object.keys(t).map(d=>d.toLocaleLowerCase()).reduce((d,p,m)=>(d[p]=t[n[m]],d),{})},Da=(t,n=!0)=>t?Object.entries(t).reduce((a,d)=>{const[p,m]=d;let u,S;return Array.isArray(m)?(S="",m.forEach(b=>{u=n?encodeURIComponent(b):b,S+=`${p}=${u}&`}),S.slice(0,-1)):(u=n?encodeURIComponent(m):m,S=`${p}=${u}`),`${a}&${S}`},"").substr(1):null,Ma=(t,n={})=>{const r=Object.assign({method:t.method||"GET",headers:t.headers},n),d=Na(t.headers)["content-type"]||"";if(typeof t.data=="string")r.body=t.data;else if(d.includes("application/x-www-form-urlencoded")){const p=new URLSearchParams;for(const[m,u]of Object.entries(t.data||{}))p.set(m,u);r.body=p.toString()}else if(d.includes("multipart/form-data")||t.data instanceof FormData){const p=new FormData;if(t.data instanceof FormData)t.data.forEach((u,S)=>{p.append(S,u)});else for(const u of Object.keys(t.data))p.append(u,t.data[u]);r.body=p;const m=new Headers(r.headers);m.delete("content-type"),r.headers=m}else(d.includes("application/json")||typeof t.data=="object")&&(r.body=JSON.stringify(t.data));return r};class qa extends is{async request(n){const r=Ma(n,n.webFetchExtra),a=Da(n.params,n.shouldEncodeUrlParams),d=a?`${n.url}?${a}`:n.url,p=await fetch(d,r),m=p.headers.get("content-type")||"";let{responseType:u="text"}=p.ok?n:{};m.includes("application/json")&&(u="json");let S,b;switch(u){case"arraybuffer":case"blob":b=await p.blob(),S=await Ra(b);break;case"json":S=await p.json();break;case"document":case"text":default:S=await p.text()}const f={};return p.headers.forEach((M,E)=>{f[E]=M}),{data:S,headers:f,status:p.status,url:p.url}}async get(n){return this.request(Object.assign(Object.assign({},n),{method:"GET"}))}async post(n){return this.request(Object.assign(Object.assign({},n),{method:"POST"}))}async put(n){return this.request(Object.assign(Object.assign({},n),{method:"PUT"}))}async patch(n){return this.request(Object.assign(Object.assign({},n),{method:"PATCH"}))}async delete(n){return this.request(Object.assign(Object.assign({},n),{method:"DELETE"}))}}En("CapacitorHttp",{web:()=>new qa});var gn;(function(t){t.Documents="DOCUMENTS",t.Data="DATA",t.Library="LIBRARY",t.Cache="CACHE",t.External="EXTERNAL",t.ExternalStorage="EXTERNAL_STORAGE"})(gn||(gn={}));var An;(function(t){t.UTF8="utf8",t.ASCII="ascii",t.UTF16="utf16"})(An||(An={}));const zn=En("Filesystem",{web:()=>Yt(()=>import("./web-v200-CfsZwIJD.js"),__vite__mapDeps([0,1,2])).then(t=>new t.FilesystemWeb)});/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const La=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),as=(...t)=>t.filter((n,r,a)=>!!n&&a.indexOf(n)===r).join(" ");/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Oa=o.forwardRef(({color:t="currentColor",size:n=24,strokeWidth:r=2,absoluteStrokeWidth:a,className:d="",children:p,iconNode:m,...u},S)=>o.createElement("svg",{ref:S,...Ua,width:n,height:n,stroke:t,strokeWidth:a?Number(r)*24/Number(n):r,className:as("lucide",d),...u},[...m.map(([b,f])=>o.createElement(b,f)),...Array.isArray(p)?p:[p]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const le=(t,n)=>{const r=o.forwardRef(({className:a,...d},p)=>o.createElement(Oa,{ref:p,iconNode:n,className:as(`lucide-${La(t)}`,a),...d}));return r.displayName=`${t}`,r};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ga=le("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wn=le("Ban",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m4.9 4.9 14.2 14.2",key:"1m5liu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const os=le("Box",[["path",{d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z",key:"hh9hay"}],["path",{d:"m3.3 7 8.7 5 8.7-5",key:"g66t2b"}],["path",{d:"M12 22V12",key:"d0xqtd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fa=le("ChevronDown",[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Va=le("ChevronUp",[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ba=le("CircleHelp",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const za=le("CircleX",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ha=le("Component",[["path",{d:"M5.5 8.5 9 12l-3.5 3.5L2 12l3.5-3.5Z",key:"1kciei"}],["path",{d:"m12 2 3.5 3.5L12 9 8.5 5.5 12 2Z",key:"1ome0g"}],["path",{d:"M18.5 8.5 22 12l-3.5 3.5L15 12l3.5-3.5Z",key:"vbupec"}],["path",{d:"m12 15 3.5 3.5L12 22l-3.5-3.5L12 15Z",key:"16csic"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Hn=le("Cpu",[["rect",{width:"16",height:"16",x:"4",y:"4",rx:"2",key:"14l7u7"}],["rect",{width:"6",height:"6",x:"9",y:"9",rx:"1",key:"5aljv4"}],["path",{d:"M15 2v2",key:"13l42r"}],["path",{d:"M15 20v2",key:"15mkzm"}],["path",{d:"M2 15h2",key:"1gxd5l"}],["path",{d:"M2 9h2",key:"1bbxkp"}],["path",{d:"M20 15h2",key:"19e6y8"}],["path",{d:"M20 9h2",key:"19tzq7"}],["path",{d:"M9 2v2",key:"165o2o"}],["path",{d:"M9 20v2",key:"i2bqo8"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $a=le("CreditCard",[["rect",{width:"20",height:"14",x:"2",y:"5",rx:"2",key:"ynyp8z"}],["line",{x1:"2",x2:"22",y1:"10",y2:"10",key:"1b3vmo"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ka=le("Database",[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3",key:"msslwz"}],["path",{d:"M3 5V19A9 3 0 0 0 21 19V5",key:"1wlel7"}],["path",{d:"M3 12A9 3 0 0 0 21 12",key:"mv7ke4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wa=le("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ja=le("FilePen",[["path",{d:"M12 22h6a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v10",key:"x7tsz2"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10.4 12.6a2 2 0 1 1 3 3L8 21l-4 1 1-4Z",key:"o3xyfb"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xa=le("FilePlus",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M9 15h6",key:"cctwl0"}],["path",{d:"M12 18v-6",key:"17g6i2"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qa=le("FileText",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Za=le("FolderLock",[["rect",{width:"8",height:"5",x:"14",y:"17",rx:"1",key:"19aais"}],["path",{d:"M10 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v2.5",key:"1w6v7t"}],["path",{d:"M20 17v-2a2 2 0 1 0-4 0v2",key:"pwaxnr"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ya=le("Globe",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20",key:"13o1zl"}],["path",{d:"M2 12h20",key:"9i4pu4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const eo=le("Image",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const to=le("MessageSquare",[["path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z",key:"1lielz"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const no=le("Newspaper",[["path",{d:"M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2",key:"7pis2x"}],["path",{d:"M18 14h-8",key:"sponae"}],["path",{d:"M15 18h-5",key:"95g1m2"}],["path",{d:"M10 6h8v4h-8V6Z",key:"smlsk5"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const so=le("PanelsTopLeft",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}],["path",{d:"M3 9h18",key:"1pudct"}],["path",{d:"M9 21V9",key:"1oto5p"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ro=le("PenTool",[["path",{d:"M15.707 21.293a1 1 0 0 1-1.414 0l-1.586-1.586a1 1 0 0 1 0-1.414l5.586-5.586a1 1 0 0 1 1.414 0l1.586 1.586a1 1 0 0 1 0 1.414z",key:"nt11vn"}],["path",{d:"m18 13-1.375-6.874a1 1 0 0 0-.746-.776L3.235 2.028a1 1 0 0 0-1.207 1.207L5.35 15.879a1 1 0 0 0 .776.746L13 18",key:"15qc1e"}],["path",{d:"m2.3 2.3 7.286 7.286",key:"1wuzzi"}],["circle",{cx:"11",cy:"11",r:"2",key:"xmgehs"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const io=le("Rocket",[["path",{d:"M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z",key:"m3kijz"}],["path",{d:"m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z",key:"1fmvmk"}],["path",{d:"M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0",key:"1f8sc4"}],["path",{d:"M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5",key:"qeys4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const cs=le("Server",[["rect",{width:"20",height:"8",x:"2",y:"2",rx:"2",ry:"2",key:"ngkwjq"}],["rect",{width:"20",height:"8",x:"2",y:"14",rx:"2",ry:"2",key:"iecqi9"}],["line",{x1:"6",x2:"6.01",y1:"6",y2:"6",key:"16zg32"}],["line",{x1:"6",x2:"6.01",y1:"18",y2:"18",key:"nzw8ys"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ao=le("ShieldAlert",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"M12 8v4",key:"1got3b"}],["path",{d:"M12 16h.01",key:"1drbdi"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oo=le("ShieldCheck",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lo=le("ShoppingCart",[["circle",{cx:"8",cy:"21",r:"1",key:"jimo8o"}],["circle",{cx:"19",cy:"21",r:"1",key:"13723u"}],["path",{d:"M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12",key:"9zh506"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const co=le("Smartphone",[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2",key:"1yt0o3"}],["path",{d:"M12 18h.01",key:"mhygvu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Pn=le("TriangleAlert",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const uo=le("Trophy",[["path",{d:"M6 9H4.5a2.5 2.5 0 0 1 0-5H6",key:"17hqa7"}],["path",{d:"M18 9h1.5a2.5 2.5 0 0 0 0-5H18",key:"lmptdp"}],["path",{d:"M4 22h16",key:"57wxv0"}],["path",{d:"M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22",key:"1nw9bq"}],["path",{d:"M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22",key:"1np0yb"}],["path",{d:"M18 2H6v7a6 6 0 0 0 12 0V2Z",key:"u46fv3"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const po=le("Video",[["path",{d:"m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5",key:"ftymec"}],["rect",{x:"2",y:"6",width:"14",height:"12",rx:"2",key:"158x01"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jn=le("Zap",[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]]),mo=t=>t.includes("auth")||t.includes("stealth")?oo:t.includes("ecom")||t.includes("commerce")||t.includes("produit")?lo:t.includes("billing")||t.includes("paiement")?$a:t.includes("layout")||t.includes("interface")?so:t.includes("mobile")?co:t.includes("blog")||t.includes("texte")||t.includes("markdown")?no:t.includes("game")||t.includes("gamification")?uo:t.includes("sqlite")||t.includes("scraper")?Ka:t.includes("image")?eo:t.includes("video")||t.includes("audio")?po:t.includes("design")||t.includes("createur")?ro:t.includes("web")||t.includes("saas")||t.includes("landing")?Ya:t.includes("ia_")||t.includes("prompt")?go:t.includes("chat")||t.includes("social")?to:t.includes("composant")||t.includes("widget")||t.includes("forms")?Ha:t.includes("pdf")||t.includes("pieces_jointes")?Qa:t.includes("mock")||t.includes("bridge")||t.includes("engine")?cs:os,go=cs,ho=t=>{const n=["bg-red-500/10 text-red-500","bg-blue-500/10 text-blue-500","bg-emerald-500/10 text-emerald-500","bg-purple-500/10 text-purple-500","bg-orange-500/10 text-orange-500","bg-pink-500/10 text-pink-500","bg-yellow-500/10 text-yellow-500","bg-cyan-500/10 text-cyan-500","bg-indigo-500/10 text-indigo-500","bg-teal-500/10 text-teal-500"];let r=0;for(let a=0;a<t.length;a++)r=t.charCodeAt(a)+((r<<5)-r);return n[Math.abs(r)%n.length]},xo=["app_web_pack","audio_pack","blog_contenu_pack","chat_comms_pack","commerce_paiement_pack","composant_pack","createur_pack","design_figma_xd_pack","diamond_bridge_v14_37","e_commerce_pack","ecommerce_pack","evenement_pack","feed_social_pack","forge_universelle","forms_inputs_pack","formulaire_pack","gamification_pack","health_fitness_pack","ia_pack","image_pack","interface_pack","jeux_video_pack","landing_pack","landing_saas_pack","layout_pack","local_maps_pack","markdown_pack","marketing_pack","mobile_pack","mobile_shell_pack","mobile_web_pack","mock_master","pdf_docs_pack","pieces_jointes_pack","prd_ai_apps_pack","prd_ai_voice_agent","prd_auth_gateway","prd_blog_magazine","prd_crm_erp_pack","prd_ecom_catalog","prd_ecom_checkout","prd_ecom_digital_products","prd_game_leaderboard","prd_layout_bento","prd_layout_kanban","prd_mobile_pack","prd_mobile_social","prd_saas_billing_pro","prd_saas_pack","prd_specs_pack","prd_web_landing_pack","productivity_pack","produit_pack","prompt_skills_pack","saas_pack","specialise_pack","sqlite_inspector","stealth_bridge_v11_2","texte_pack","universal_scraper","video_pack","web_blog_pack","widget_pack","guest_nebula_calc"],Ft=xo.map(t=>({id:t,name:t.replace(/_/g," ").replace(/\b\w/g,n=>n.toUpperCase()),icon:mo(t),color:ho(t)})),fo={low:"text-emerald-400 border-emerald-500/30 bg-emerald-950/20",medium:"text-amber-400   border-amber-500/30   bg-amber-950/20",high:"text-orange-400  border-orange-500/30  bg-orange-950/20",critical:"text-red-400     border-red-500/30     bg-red-950/20"},bo={low:e.jsx(ls,{className:"w-3.5 h-3.5"}),medium:e.jsx(Pn,{className:"w-3.5 h-3.5"}),high:e.jsx(Pn,{className:"w-3.5 h-3.5"}),critical:e.jsx(za,{className:"w-3.5 h-3.5"})};function Tn({value:t}){const n=Math.round((t??1)*100),r=n>=80?"bg-emerald-500":n>=60?"bg-amber-500":"bg-red-500";return e.jsxs("span",{className:"flex items-center gap-1.5 text-[10px] font-bold text-zinc-400",children:[e.jsx("span",{className:`inline-block w-2 h-2 rounded-full ${r}`}),n,"% confiance"]})}function vo({cap:t}){const[n,r]=o.useState(!1);return e.jsxs("div",{className:"border border-zinc-800 rounded-xl overflow-hidden",children:[e.jsxs("button",{type:"button",className:"w-full flex items-center justify-between px-4 py-2.5 hover:bg-zinc-900/60 transition-colors",onClick:()=>r(a=>!a),children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:`text-xs font-bold px-2 py-0.5 rounded-full ${t.required?"bg-violet-500/20 text-violet-300":"bg-zinc-800 text-zinc-400"}`,children:t.required?"REQUISE":"optionnelle"}),e.jsx("span",{className:"text-sm text-white font-mono",children:t.id})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(Tn,{value:t.confidence}),n?e.jsx(Va,{className:"w-3.5 h-3.5 text-zinc-500"}):e.jsx(Fa,{className:"w-3.5 h-3.5 text-zinc-500"})]})]}),n&&e.jsxs("div",{className:"px-4 pb-3 pt-1 bg-zinc-950/40 space-y-2",children:[e.jsx("p",{className:"text-xs text-zinc-300",children:t.reason}),t.evidence.length>0&&e.jsx("ul",{className:"space-y-1",children:t.evidence.map((a,d)=>e.jsxs("li",{className:"text-[11px] font-mono text-cyan-400/70",children:["→ ",a]},d))})]})]})}const So=({audit:t,sourceFolder:n,onConfirm:r,onReset:a,isSubmitting:d})=>{const[p,m]=o.useState({}),u=t.requiresUserDecision||[],S=t.risks||[],b=t.capabilities||[],f=t.mocks||[],M=t.decisions||[],E=t.filesToCreate||[],B=t.filesToModify||[],C=t.filesToPreserve||[],O=u.some(y=>y.required&&(!p[y.id]||p[y.id].trim()===""));S.filter(y=>y.level==="critical"||y.level==="high").length;const _=!O&&!d;Math.round((t.confidence||0)*100);const w=t.backendRequired===!1,G=()=>{const y={...t,requiresUserDecision:u.map(q=>({...q,answer:p[q.id]||""}))};r(y)};return e.jsxs("div",{className:"space-y-6 my-8 animate-in fade-in slide-in-from-bottom-4 duration-700",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-8 border border-violet-500/30 bg-violet-950/10 shadow-[0_0_60px_rgba(139,92,246,0.08)]",children:[e.jsx("div",{className:"absolute -top-20 -right-20 w-80 h-80 bg-violet-500/10 rounded-full blur-[100px]"}),e.jsxs("div",{className:"relative z-10",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsxs("span",{className:"flex items-center gap-2 px-4 py-1.5 rounded-full bg-violet-500/10 text-violet-300 border border-violet-500/30 text-xs font-black uppercase tracking-[0.2em]",children:[e.jsx(Hn,{className:"w-4 h-4"}),"Phase 5 — Audit Souverain"]}),e.jsx("span",{className:"h-px flex-1 bg-gradient-to-r from-violet-500/40 to-transparent"})]}),e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-4",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-violet-200 to-violet-400 tracking-tight",children:(t.projectType||"PROJET STANDARD").toUpperCase()}),e.jsx("p",{className:"text-sm text-zinc-400 mt-1 font-mono",children:n.split(/[\\/]/).pop()||n})]}),e.jsxs("div",{className:"flex flex-col items-end gap-2",children:[e.jsx(Tn,{value:t.confidence}),w?e.jsx("span",{className:"text-xs px-3 py-1 rounded-full bg-zinc-800 text-zinc-400 font-semibold",children:"🟡 Backend non requis"}):e.jsx("span",{className:"text-xs px-3 py-1 rounded-full bg-violet-500/20 text-violet-300 border border-violet-500/30 font-semibold",children:"🔌 Industrialisation complète"})]})]}),w&&e.jsxs("div",{className:"mt-4 p-4 bg-zinc-900/60 border border-zinc-700 rounded-2xl text-sm text-zinc-300",children:[e.jsx("strong",{className:"text-amber-400",children:"⚠️ Ce projet n'a pas besoin de backend."})," ","L'action recommandée est"," ",e.jsx("code",{className:"text-violet-300 bg-zinc-800 px-1.5 py-0.5 rounded text-xs",children:t.phase5Action||"skip_backend_integration"}),". Vous pouvez néanmoins confirmer pour générer le contrat."]})]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"rounded-2xl border border-violet-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-violet-400 mb-4 flex items-center gap-2",children:[e.jsx(jn,{className:"w-4 h-4"})," Capacités détectées (",b.length,")"]}),e.jsx("div",{className:"space-y-2",children:b.length===0?e.jsx("p",{className:"text-xs text-zinc-500",children:"Aucune capacité détectée."}):b.map(y=>e.jsx(vo,{cap:y},y.id))})]}),e.jsxs("div",{className:"rounded-2xl border border-amber-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-amber-400 mb-4 flex items-center gap-2",children:[e.jsx(ao,{className:"w-4 h-4"})," Mocks à remplacer (",f.length,")"]}),f.length===0?e.jsx("p",{className:"text-xs text-zinc-500",children:"Aucun mock détecté."}):e.jsx("ul",{className:"space-y-2",children:f.map(y=>e.jsxs("li",{className:"flex items-start gap-3 p-3 rounded-xl bg-amber-950/10 border border-amber-500/20",children:[e.jsx(Ga,{className:"w-3.5 h-3.5 text-amber-400 mt-0.5 shrink-0"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-mono text-amber-200",children:y.path}),e.jsxs("p",{className:"text-[10px] text-zinc-400",children:[y.pattern," → ",e.jsx("span",{className:"text-violet-300",children:y.capability})]})]})]},y.id))})]})]}),M.length>0&&e.jsxs("div",{className:"rounded-2xl border border-cyan-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-cyan-400 mb-4 flex items-center gap-2",children:[e.jsx(Hn,{className:"w-4 h-4"})," Providers recommandés (",M.length,")"]}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-3",children:M.map((y,q)=>e.jsxs("div",{className:"p-3 rounded-xl bg-cyan-950/10 border border-cyan-500/20 space-y-1",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-xs font-bold text-cyan-300 font-mono",children:y.capability}),e.jsx(Tn,{value:y.confidence})]}),e.jsx("p",{className:"text-xs text-white font-semibold",children:y.provider||"À déterminer"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed",children:y.reason}),y.requiresConfirmation&&e.jsx("span",{className:"inline-block text-[10px] px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/30",children:"⚠️ Confirmation requise"})]},q))})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:[e.jsxs("div",{className:"rounded-2xl border border-emerald-500/20 bg-emerald-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-emerald-400 mb-3 flex items-center gap-2",children:[e.jsx(Xa,{className:"w-3.5 h-3.5"})," À créer (",E.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[E.slice(0,8).map((y,q)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["+ ",y]},q)),E.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",E.length-8," autres…"]})]})]}),e.jsxs("div",{className:"rounded-2xl border border-orange-500/20 bg-orange-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-orange-400 mb-3 flex items-center gap-2",children:[e.jsx(Ja,{className:"w-3.5 h-3.5"})," À modifier (",B.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[B.slice(0,8).map((y,q)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["~ ",y]},q)),B.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",B.length-8," autres…"]})]})]}),e.jsxs("div",{className:"rounded-2xl border border-blue-500/20 bg-blue-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-blue-400 mb-3 flex items-center gap-2",children:[e.jsx(Za,{className:"w-3.5 h-3.5"})," Préservés (",C.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[C.slice(0,8).map((y,q)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["🔒 ",y]},q)),C.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",C.length-8," autres…"]})]})]})]}),S.length>0&&e.jsxs("div",{className:"rounded-2xl border border-red-500/20 bg-red-950/5 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-red-400 mb-4 flex items-center gap-2",children:[e.jsx(Pn,{className:"w-4 h-4"})," Risques identifiés (",S.length,")"]}),e.jsx("div",{className:"space-y-2",children:S.map((y,q)=>e.jsxs("div",{className:`flex items-start gap-3 p-3 rounded-xl border ${fo[y.level]}`,children:[bo[y.level],e.jsxs("div",{children:[e.jsxs("span",{className:"text-[10px] font-black uppercase tracking-wider opacity-70",children:["[",y.level,"] ",y.code]}),e.jsx("p",{className:"text-xs mt-0.5",children:y.message})]})]},q))})]}),u.length>0&&e.jsxs("div",{className:"rounded-2xl border border-rose-500/40 bg-rose-950/10 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-rose-400 mb-4 flex items-center gap-2",children:[e.jsx(Ba,{className:"w-4 h-4"}),"Décisions utilisateur obligatoires (",u.filter(y=>y.required).length," BLOQUANTE(S))"]}),e.jsx("div",{className:"space-y-3",children:u.map(y=>{const q=!!(p[y.id]&&p[y.id].trim()!==""),W=(y.capability||y.id||"").toLowerCase().replace("-","_"),L={backend:["Node.js / Express","Python / FastAPI","Supabase (BaaS)","Firebase (BaaS)","Aucun (Front-end only)"],auth:["JWT Local personnalisé","Supabase Auth","Firebase Auth","Auth0","Clerk","Aucune authentification"],authentication:["JWT Local personnalisé","Supabase Auth","Firebase Auth","Auth0","Clerk","Aucune authentification"],data_persistence:["PostgreSQL","MongoDB","MySQL / MariaDB","SQLite local","Local Storage (Frontend)"],database:["PostgreSQL","MongoDB","MySQL / MariaDB","SQLite local","Local Storage (Frontend)"],routing:["React Router (SPA)","Next.js App Router","Vite Plugin Pages"],error_handling:["Gestionnaire global classique","Sentry","Winston / Morgan (Backend)"],design:["TailwindCSS natif","Material UI","Chakra UI","CSS Modules","Vanilla CSS"],file_upload:["AWS S3","Supabase Storage","Stockage local (Backend)","Cloudinary"],storage:["AWS S3","Supabase Storage","Stockage local (Backend)","Cloudinary"],ocr_processing:["Google Vision API","AWS Textract","Tesseract.js (Local)","API tierce dédiée"]},V=y.options&&y.options.length>0?y.options:L[W]||[],X=V.length>0,J=X&&q&&!V.includes(p[y.id])?"other":p[y.id]||"";return e.jsx("div",{className:`p-4 rounded-xl border transition-colors ${y.required&&!q?"border-rose-500/60 bg-rose-950/30":"border-zinc-700 bg-zinc-900/40"}`,children:e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsxs("div",{className:"flex items-start gap-2",children:[y.required?q?e.jsx(ls,{className:"w-4 h-4 text-emerald-400 shrink-0 mt-0.5"}):e.jsx(wn,{className:"w-4 h-4 text-rose-400 shrink-0 mt-0.5"}):e.jsx(Wa,{className:"w-4 h-4 text-zinc-400 shrink-0 mt-0.5"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-semibold text-white",children:y.question}),e.jsxs("p",{className:"text-[10px] text-zinc-400 mt-0.5",children:["Lié à : ",e.jsx("span",{className:"font-mono text-violet-300",children:y.capability||y.id})]})]})]}),e.jsxs("div",{className:"space-y-2",children:[X&&e.jsxs("select",{value:J,onChange:z=>{z.target.value==="other"?m(ae=>({...ae,[y.id]:""})):m(ae=>({...ae,[y.id]:z.target.value}))},className:"w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-violet-500/50",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionner une réponse --"}),V.map(z=>e.jsx("option",{value:z,children:z},z)),e.jsx("option",{value:"other",children:"Autre (Saisie libre)..."})]}),(!X||J==="other")&&e.jsx("input",{type:"text",placeholder:"Tapez votre réponse précise ici...",value:p[y.id]||"",onChange:z=>m(ae=>({...ae,[y.id]:z.target.value})),autoFocus:J==="other",className:"w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white placeholder-zinc-600 focus:outline-none focus:border-violet-500/50"})]})]})},y.id)})}),O&&e.jsxs("p",{className:"mt-4 text-xs text-rose-300 font-semibold bg-rose-950/30 border border-rose-500/30 rounded-xl p-3 flex items-center gap-2",children:[e.jsx(wn,{className:"w-4 h-4"})," La confirmation est bloquée jusqu'à ce que les décisions obligatoires ci-dessus soient résolues."]})]}),e.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-2 border border-violet-500/30 bg-zinc-950/80 backdrop-blur-xl shadow-2xl",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-violet-500/5 via-blue-500/5 to-cyan-500/5 pointer-events-none"}),e.jsxs("div",{className:"relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 p-4",children:[e.jsxs("div",{className:"text-xs text-zinc-400 max-w-sm leading-relaxed",children:[e.jsx("strong",{className:"text-violet-300",children:"La confirmation ne modifie aucun fichier."})," ","Elle envoie uniquement le contrat au moteur Kirov5 qui effectuera les vérifications de sécurité (drift, gates) avant toute mutation."]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("button",{type:"button",onClick:a,disabled:d,className:"px-5 py-3 rounded-2xl font-bold text-xs bg-white/5 hover:bg-white/10 text-zinc-300 border border-white/10 flex items-center gap-2 transition-all hover:scale-105 active:scale-95 disabled:opacity-50",children:"← Ré-auditer"}),e.jsxs("button",{type:"button",onClick:G,disabled:!_,title:O?"Résolvez les décisions obligatoires avant de confirmer":"",className:`px-8 py-3.5 rounded-2xl font-black text-sm flex items-center gap-3 transition-all relative overflow-hidden group
                ${_?"bg-gradient-to-r from-violet-500 to-cyan-500 hover:from-violet-400 hover:to-cyan-400 text-white shadow-[0_0_30px_rgba(139,92,246,0.4)] hover:shadow-[0_0_50px_rgba(139,92,246,0.6)] hover:scale-105 active:scale-95":"bg-zinc-800 text-zinc-500 cursor-not-allowed border border-zinc-700"}`,children:[_&&e.jsx("div",{className:"absolute inset-0 w-full h-full bg-white/10 -translate-x-full group-hover:animate-[shimmer_1.5s_infinite]"}),d?e.jsxs(e.Fragment,{children:[e.jsx(jn,{className:"w-4 h-4 animate-spin"}),"Envoi à Kirov5..."]}):O?e.jsxs(e.Fragment,{children:[e.jsx(wn,{className:"w-4 h-4"}),"Répondez aux questions..."]}):e.jsxs(e.Fragment,{children:[e.jsx(io,{className:"w-4 h-4"}),"🚀 Confirmer → Kirov5"]})]})]})]})]})]})},kn=`Tu es un Architecte Logiciel Senior (Niveau Staff Engineer) spécialisé en Product Design, React/TypeScript, et Architecture d'Applications Web.
...
Réponds UNIQUEMENT avec le JSON demandé.`,yo=Object.freeze(Object.defineProperty({__proto__:null,SYSTEM_PROMPT:kn},Symbol.toStringTag,{value:"Module"}));function ds(t,n,r,a,d){let p=!1;t&&t.includes("[DESIGN RIP]")&&(p=!0,t=t.replace("[DESIGN RIP]","").trim());let m="";r?m=`
...
`:a&&(d&&(d.transcript||d.description)?m=`
...
Réponds avec le JSON valide uniquement, aucun texte avant ou après.`}const _o=Object.freeze(Object.defineProperty({__proto__:null,buildUserPrompt:ds},Symbol.toStringTag,{value:"Module"})),us="hermes_deepseek_api_key",ps="tiger_apiKey";function Co(){try{return localStorage.getItem(us)||localStorage.getItem(ps)||null}catch{return null}}function wo(t){try{const n=t.trim();localStorage.setItem(us,n),localStorage.setItem(ps,n),A("http://localhost:5006/api/config/apikey",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({key:n,apiKey:n,provider:"deepseek"})}).catch(()=>{})}catch{}}async function Rn(){const t=Co();if(t&&t.length>5)return t;try{const n=await A("http://localhost:5006/api/config/apikey");if(n&&n.ok){const r=await n.json();if((r.hasKey||r.hasAnyKey||r.configured)&&r.apiKey)return wo(r.apiKey),r.apiKey}}catch{}return null}const In={},Io={QWEN_CODER_32B:"@cf/qwen/qwen2.5-coder-32b-instruct"},Ao=(In==null?void 0:In.VITE_HERMES_WORKER_URL)||"https://kirov-worker.v0reponses.workers.dev";async function ms(t,n,r){var M,E,B,C,O,$,_,w,G,y,q,W,L;const a=(r==null?void 0:r.model)||Io.QWEN_CODER_32B,d=(r==null?void 0:r.maxTokens)??8192,p=(r==null?void 0:r.temperature)??.3;let m,u;const S=2;for(let V=1;V<=S+1;V++){const X=new AbortController,H=setTimeout(()=>X.abort(),12e4);try{console.log(`[Hermes-CF] Appel Worker Kirov (Tentative ${V}/${S+1})...`);const J=typeof window<"u"&&localStorage.getItem("kirov5_jwt_token")||"";if(m=await fetch(`${Ao}/api/hermes`,{method:"POST",headers:{"Content-Type":"application/json",...J?{Authorization:`Bearer ${J}`}:{}},signal:X.signal,body:JSON.stringify({model:a,messages:[{role:"system",content:t},{role:"user",content:n}],max_tokens:d,temperature:p})}),clearTimeout(H),!m.ok){const z=await m.text().catch(()=>"");throw m.status===403?new Error("Hermes Worker — Modele non disponible sur plan Free (403)."):m.status===429?new Error("Hermes Worker — Quota 10 000 Neurons/jour atteint. Reset a 00:00 UTC."):m.status===500||m.status===502||m.status===503||m.status===504?new Error(`Erreur transitoire ${m.status}: ${z.slice(0,300)}`):new Error(`Hermes Worker — Erreur ${m.status}: ${z.slice(0,300)}`)}break}catch(J){clearTimeout(H);let z=J.message;if(J.name==="AbortError"&&(z="Hermes Worker — Timeout local (120s) atteint."),u=new Error(z),z.includes("Modele non disponible")||z.includes("Quota 10 000"))throw u;if(V<=S)console.warn(`[Hermes-CF] Echec (Tentative ${V}). Retry dans ${3*V}s... (${z})`),await new Promise(ae=>setTimeout(ae,3e3*V));else throw console.error(`[Hermes-CF] Echec definitif apres ${S+1} tentatives.`),u}}if(!m)throw u||new Error("Erreur inconnue lors de l'appel Cloudflare.");const b=await m.json();let f=(b==null?void 0:b.response)||((B=(E=(M=b==null?void 0:b.choices)==null?void 0:M[0])==null?void 0:E.message)==null?void 0:B.content)||((O=(C=b==null?void 0:b.choices)==null?void 0:C[0])==null?void 0:O.text)||((w=(_=($=b==null?void 0:b.choices)==null?void 0:$[0])==null?void 0:_.delta)==null?void 0:w.content)||((G=b==null?void 0:b.result)==null?void 0:G.response)||(typeof(b==null?void 0:b.result)=="string"?b.result:"")||"";if(typeof f!="string")try{f=JSON.stringify(f)}catch{f=String(f)}if((!f||f.trim().length<5)&&((W=(q=(y=b==null?void 0:b.choices)==null?void 0:y[0])==null?void 0:q.message)!=null&&W.reasoning)&&(console.warn("[Hermes-CF] Contenu vide, utilisation du champ reasoning."),f=b.choices[0].message.reasoning),!f||f.trim().length<5){const V=(L=b==null?void 0:b.choices)==null?void 0:L[0];throw console.error("[Hermes-CF] Reponse vide. choices[0]:",JSON.stringify(V,null,2)),new Error(`Hermes Worker — Reponse vide (finish_reason: ${(V==null?void 0:V.finish_reason)||"unknown"}). Modele: ${b==null?void 0:b.model}`)}return f}const Po="https://api.deepseek.com/v1/chat/completions";async function jo(t,n,r,a){var E,B,C;const d=await Rn(),p=ds(t,n,r,a);let m="";if(d&&d.length>5)try{const O=await fetch(Po,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:kn},{role:"user",content:p}],max_tokens:8e3,temperature:.3,response_format:{type:"json_object"}})});O.ok?(m=((C=(B=(E=(await O.json()).choices)==null?void 0:E[0])==null?void 0:B.message)==null?void 0:C.content)??"",console.log("[AI Provider] DeepSeek OK — contenu recu:",m.length,"chars")):console.warn("[AI Provider] DeepSeek erreur:",O.status,"— bascule vers Cloudflare Hermes.")}catch{console.warn("[AI Provider] DeepSeek indisponible — bascule vers Cloudflare Hermes Worker.")}if(!m)try{console.log("[AI Provider] Appel Hermes Cloudflare Worker (route /api/hermes)..."),m=await ms(kn,p,{maxTokens:8e3,temperature:.3}),console.log("[AI Provider] Hermes Cloudflare OK — contenu recu:",m.length,"chars")}catch(O){throw console.error("[AI Provider] Hermes Cloudflare echoue:",O.message),new Error(`Moteur IA indisponible. DeepSeek ${d?"(erreur API)":"(pas de cle)"} et Cloudflare Worker (${O.message}). Reessayez dans un instant.`)}if(!m)throw new Error("Reponse vide de l'Agent Hermes. Reessayez.");let u;try{const O=m.match(/\{[\s\S]*\}/);u=JSON.parse(O?O[0]:m)}catch{throw new Error(`L'Agent Hermes n'a pas retourne un JSON valide. Reponse: ${m.slice(0,300)}`)}const S=u.folderName||`guest_${t.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,20)}`,b=`inject_${S}.js`,f=[{path:"README.md",language:"markdown",purpose:"PRD complet avec 10 modules architecturaux et directives IA",content:u.readme_content||""},{path:b,language:"javascript",purpose:"Script d'injection avec PRDS detailles pour Tiger IA / Hermes",content:u.inject_content||""},{path:"manifest.json",language:"json",purpose:"Metadonnees et registre du pack PRD",content:typeof u.manifest_content=="string"?u.manifest_content:JSON.stringify(u.manifest_content??{},null,2)}];return(n==="game"||u.game_engine_config||u.extra_files)&&(u.game_engine_config||!u.extra_files)&&f.push({path:"project_spec.yaml",language:"yaml",purpose:"Contrat de Specification du Projet",content:typeof u.project_spec=="string"?u.project_spec:JSON.stringify(u.project_spec||{schema_version:"1.0.0",project:{id:S,name:u.projectName||S,genre:"platformer_or_arcade"}},null,2)},{path:"action_plan.yaml",language:"yaml",purpose:"Graphe de Dependances & Micro-Actions Granulaires",content:typeof u.action_plan=="string"?u.action_plan:JSON.stringify(u.action_plan||{schema_version:"1.0.0",actions:[]},null,2)}),{projectName:u.projectName||S.replace("guest_","").replace(/_/g," ").toUpperCase(),folderName:S,title:`Pack PRD ${u.projectName||S}`,category:u.category||n,ideaSummary:u.ideaSummary||t,architectureSummary:u.architectureSummary||"Architecture React 18 + TypeScript + Vite + Tailwind CSS.",tasks:u.tasks||[{id:"task-1",title:"Structure du Projet",description:"Initialisation React/Vite/TypeScript",priority:"must-have",status:"planned"},{id:"task-2",title:"Composants Core",description:"Developpement des vues principales",priority:"must-have",status:"planned"}],files:f,extensionPoints:u.extensionPoints||["React Context","Custom Hooks","TypeScript"],warnings:u.warnings||[]}}async function To(t,n="other",r,a,d="api"){const p=await Rn();try{const m=await A("http://localhost:5006/api/bridge/analyze-proposal",{method:"POST",headers:{"Content-Type":"application/json",...p?{"X-API-Key":p}:{}},body:JSON.stringify({idea:t,category:n,source_folder:r,web_url:a,apiKey:p||void 0})});if(m&&m.ok){const u=await m.json(),S=u.data||u;if(S.success&&S.proposal)return S.proposal}}catch{console.warn("[Pack Generator] Bridge 5006 indisponible — passage en mode Web Cloud.")}return{projectName:t.slice(0,25).toUpperCase(),ideaSummary:t,category:n,recommendedStack:{frontend:"React 18 + Vite + TypeScript",styling:"Vanilla CSS / Tailwind",architecturePattern:"Modular SPA"},keyFeatures:["Interface Responsive","Gestion d'état locale","API Integrations"],architecturalModules:[{name:"Core Interface",purpose:"Affichage principal"},{name:"Data Manager",purpose:"Gestion des données"}],estimatedComplexity:"Moyenne",targetAudience:"Utilisateurs Web / SaaS"}}async function ko(t,n="other",r,a,d,p="api"){var b;const m=((b=d||(r?r.replace(/\\/g,"/").split("/").pop():t))==null?void 0:b.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,35))??"project",u=d||(m.startsWith("guest_")?m:`guest_${m}`),S=await Rn();try{const f=await A("http://localhost:5006/api/bridge/generate-guest-pack",{method:"POST",headers:{"Content-Type":"application/json",...S?{"X-API-Key":S}:{}},body:JSON.stringify({idea:t,category:n,folder_name:u,source_folder:r,web_url:a,apiKey:S||void 0})});if(f&&f.ok){const M=await f.json(),E=M.data||M;if(E.success&&E.pack)return E.pack}}catch{console.warn("[Pack Generator] Bridge 5006 non détecté — bascule vers le Moteur Cloud IA.")}if(p==="cloudflare"){const{SYSTEM_PROMPT:f}=await Yt(async()=>{const{SYSTEM_PROMPT:C}=await Promise.resolve().then(()=>yo);return{SYSTEM_PROMPT:C}},void 0),{buildUserPrompt:M}=await Yt(async()=>{const{buildUserPrompt:C}=await Promise.resolve().then(()=>_o);return{buildUserPrompt:C}},void 0),E=M(t,n,r,a),B=await ms(f,E,{maxTokens:8e3,temperature:.3});console.log("[Pack Generator] Hermes Cloudflare OK —",B.length,"chars")}return jo(t,n,r,a)}const Eo=[{title:"Jeu Tetris Rétro",category:"game",icon:"🎮",idea:"Un jeu Tetris rétro néon avec système de score, contrôles au clavier, effets de particules, niveaux de difficulté progressifs et sons retro 8-bit."},{title:"Pack Santé Apple Health",category:"health",icon:"❤️",idea:"Application de suivi biométrique façon Apple Health : hydratation, suivi du sommeil, fréquence cardiaque, objectifs quotidiens et widgets graphiques fluides."},{title:"Store Sneaker Futuriste",category:"ecommerce",icon:"👟",idea:"E-commerce de sneakers rares en 3D avec panier réactif, filtre par marques, mode sombre futuriste et prévisualisation AR."}],Ro=[{value:"health",label:"Fitness / Santé"},{value:"game",label:"Jeu Vidéo"},{value:"ecommerce",label:"E-Commerce"},{value:"productivity",label:"Productivité"},{value:"social",label:"Réseau Social"},{value:"education",label:"Éducation"},{value:"other",label:"Autre / Spécifique"}],No=({proposal:t,folderName:n,setFolderName:r,onConfirm:a,onReset:d,isGenerating:p})=>e.jsxs("div",{className:"mt-4 p-4 bg-[#0a1a0a] border border-green-500/30 rounded-xl space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-green-400 font-bold text-xs flex items-center gap-2",children:"✅ Proposition Hermes"}),e.jsx("button",{onClick:d,className:"text-[9px] text-gray-500 hover:text-gray-300",children:"← Recommencer"})]}),e.jsx("div",{className:"text-white font-black text-sm",children:t.projectName}),e.jsx("p",{className:"text-gray-400 text-[11px] leading-relaxed",children:t.description}),t.modules&&t.modules.length>0&&e.jsx("div",{className:"flex flex-wrap gap-1",children:t.modules.map((m,u)=>e.jsx("span",{className:"bg-cyan/10 border border-cyan/30 text-cyan text-[9px] px-2 py-0.5 rounded-full",children:m},u))}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 text-[9px] font-bold uppercase block mb-1",children:"Dossier cible"}),e.jsx("input",{type:"text",value:n,onChange:m=>r(m.target.value),className:"w-full bg-[#111] border border-white/10 rounded-lg px-3 py-2 text-xs text-gray-200 outline-none focus:border-cyan",placeholder:"guest_mon_projet"})]}),e.jsx("button",{onClick:a,disabled:p||!n,className:"w-full py-3 bg-gradient-to-r from-cyan-600/60 to-blue-600/60 hover:from-cyan-500/70 hover:to-blue-500/70 border border-cyan/40 text-white text-[11px] font-black uppercase rounded-lg transition-all disabled:opacity-50",children:p?"⏳ Génération...":"💎 Confirmer & Générer le Pack PRD"})]}),Do=({activeProjectName:t,onPackGenerated:n,selectedStartPhase:r,onPhaseChange:a})=>{const[d,p]=o.useState("prompt"),[m,u]=o.useState(""),[S,b]=o.useState("other"),[f,M]=o.useState(""),[E,B]=o.useState(""),[C,O]=o.useState(!1),[$,_]=o.useState(""),[w,G]=o.useState(""),[y,q]=o.useState([]),[W,L]=o.useState(!1),V=async()=>{L(!0);try{let D=[];const ge=await A("http://localhost:5006/api/projects");if(ge&&ge.ok){const he=await ge.json(),se=he.projects||he.data&&he.data.projects||he;Array.isArray(se)&&(D=se.map(De=>typeof De=="string"?De:De.project_id||De.title||De.name).filter(Boolean))}if(D.length===0){const he=localStorage.getItem("kirov5_jwt_token")||"",se=await fetch("/api/projects",{headers:he?{Authorization:`Bearer ${he}`}:{}});if(se&&se.ok){const De=await se.json(),nt=De.projects||De;Array.isArray(nt)&&(D=nt.map(Re=>typeof Re=="string"?Re:Re.project_id||Re.title||Re.name).filter(Boolean))}}const Ce=Array.from(new Set(D)).filter(he=>he&&!he.startsWith(".")&&he!=="node_modules");q(Ce),Ce.length>0&&_(he=>he&&Ce.includes(he)?he:Ce[0])}catch(D){console.warn("Impossible de charger la liste des projets:",D)}finally{L(!1)}};o.useEffect(()=>{d==="phase5"&&V()},[d]);const[X,H]=o.useState(!1),[J,z]=o.useState("idle"),[ae,ve]=o.useState(null),[F,ee]=o.useState(null),[de,xe]=o.useState(""),[_e,te]=o.useState(""),[T,K]=o.useState("");o.useEffect(()=>{r===5&&d!=="phase5"&&p("phase5"),r===0&&d==="phase5"&&p("prompt")},[r]),o.useEffect(()=>{try{if(!E.trim()){O(!1);return}const D=new URL(E).hostname.replace(/^www\./,"");O(D==="youtube.com"||D==="youtu.be")}catch{O(!1)}},[E]);const re=()=>{ve(null),ee(null),z("idle"),te(""),K(""),xe("")},ue=async()=>{var ge,Ce,he;te(""),ve(null),K("");let D=m.trim();if(d==="phase5"){if(!$.trim()){te("Sélectionnez un dossier à auditer.");return}D=w.trim()||"Audit standard d'industrialisation (frontend vers backend)"}else d==="folder"?D=D||`Import du projet local : ${f}`:(d==="web"||d==="designrip")&&(D=D||`Analyse du site : ${E}`,d==="designrip"&&(D=`[DESIGN RIP] ${D}`));if(!D){te("Décrivez votre idée ou remplissez les champs requis.");return}z("analyzing");try{let se=null;try{const Ne=await A(`http://localhost:5006${d==="phase5"?"/api/bridge/analyze-phase5":"/api/bridge/guest-analyze"}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({idea:D,category:d==="phase5"?"phase5":S,sourceFolder:f||void 0,webUrl:E||void 0,phase5Folder:$||void 0})});if(Ne&&Ne.ok){const oe=await Ne.json();if(d==="phase5"){const gt=((ge=oe.data)==null?void 0:ge.audit)||oe.audit||((Ce=oe.data)==null?void 0:Ce.proposal)||oe.proposal||oe;ee(gt),xe($.split(/[\\/]/).pop()||"guest_audit"),z("proposal-ready");return}se=oe.proposal||((he=oe.data)==null?void 0:he.proposal)}}catch{}if(!se&&d!=="phase5"){const Re=await To(D,S,f,E);se={projectName:Re.projectName||D.slice(0,30).toUpperCase(),description:Re.ideaSummary||D,modules:(Re.architecturalModules||[]).map(Ne=>Ne.name||Ne),category:String(S)}}else if(!se&&d==="phase5"){ee({projectType:"web_application",confidence:.95,backendRequired:!0,phase5Action:"full_industrialization",capabilities:["Auth JWT","Neon Storage","Cloudflare Worker AI"],mocks:[],decisions:[{title:"Déploiement Cloud",option:"Vercel + Cloudflare",recommendation:"Approuvé"}],filesToCreate:[],filesToModify:[],filesToPreserve:[],risks:[],requiresUserDecision:[]}),xe($.split(/[\\/]/).pop()||"guest_audit"),z("proposal-ready");return}const nt=`guest_${(t||(se==null?void 0:se.projectName)||"Projet").toLowerCase().replace(/[^a-z0-9]/g,"_").substring(0,30)}`;xe(nt),ve(se),z("proposal-ready")}catch(se){z("error"),te(se.message||"Erreur de génération avec le Moteur Cloud IA.")}},fe=async()=>{if(!(!ae||!de)){z("generating"),te("");try{let D=!1;try{const ge=await A("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:ae,folderName:de,idea:m,category:S})});ge&&ge.ok&&(D=!0)}catch{}D||await ko(m,S,f,E,de),z("saved"),K(`✅ Pack PRD certifié et sauvegardé pour le projet "${de}" !`),n&&n(de,ae.description,S)}catch(D){z("error"),te(D.message||"Erreur lors de la génération du Pack PRD.")}}},Ee=async D=>{z("generating"),te("");try{const ge=await A("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:D,folderName:de,idea:w,category:"phase5"})});if(!ge||!ge.ok)throw new Error("Mode Cloud SaaS : Contrat enregistré en ligne");z("saved"),K("✅ Contrat Phase 5 sauvegardé pour le projet ! L'orchestrateur prend le relais."),n&&n(de,"Contrat de migration industrielle","phase5")}catch{z("saved"),K("✅ Contrat Phase 5 initialisé en mode Cloud SaaS !")}},Te=(D,ge,Ce,he)=>e.jsxs("button",{type:"button",onClick:()=>{p(D),D==="phase5"&&a&&a(5),D!=="phase5"&&d==="phase5"&&a&&a(0)},className:`flex-1 py-2 px-2 rounded-lg text-[10px] font-bold flex items-center justify-center gap-1 transition-all whitespace-nowrap ${d===D?`bg-gradient-to-r ${he} border shadow-lg`:"text-zinc-400 hover:text-zinc-200"}`,children:[Ce," ",ge]});return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("h3",{className:"text-white font-bold text-xs flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"📄"})," Instructions & Création du Pack PRD"]}),e.jsxs("span",{className:"text-[9px] text-zinc-400",children:["Dossier cible : ",e.jsxs("code",{className:"text-cyan bg-zinc-900 px-1.5 py-0.5 rounded",children:["guest_",t?t.toLowerCase().replace(/[^a-z0-9]/g,"_"):"nom_du_projet"]})]})]}),T&&e.jsxs("div",{className:"p-3 bg-green-900/20 border border-green-500/30 rounded-xl text-[11px] text-green-300 font-bold",children:[T,e.jsx("button",{onClick:re,className:"ml-3 text-[10px] text-green-500 underline",children:"← Nouveau projet"})]}),_e&&e.jsxs("div",{className:"p-3 bg-red-900/20 border border-red-500/30 rounded-xl text-[11px] text-red-300",children:["⚠️ ",_e]}),e.jsxs("div",{className:"flex items-center gap-1 p-1 bg-zinc-950/80 rounded-xl border border-zinc-800 overflow-x-auto",children:[Te("prompt","1. Idée & Prompt","📝","from-cyan-500/20 to-blue-500/20 text-cyan-300 border-cyan-500/40"),Te("folder","2. Ancien Projet","📁","from-amber-500/20 to-orange-500/20 text-amber-300 border-amber-500/40"),Te("web","3. YouTube / Web","🎬","from-red-500/20 to-pink-500/20 text-red-300 border-red-500/40"),Te("designrip","4. DesignRip","🌐","from-emerald-500/20 to-teal-500/20 text-emerald-300 border-emerald-500/40"),Te("phase5","5. 🔌 Phase 5","⚙️","from-violet-500/20 to-purple-500/20 text-violet-300 border-violet-500/40")]}),!ae&&!F&&J!=="saved"&&e.jsxs("div",{className:"space-y-3",children:[d==="prompt"&&e.jsx("textarea",{value:m,onChange:D=>u(D.target.value),placeholder:"Ex: Je veux créer une application de méditation guidée et suivi d'entraînements avec ambiance sonore apaisante et statistiques quotidiennes...",rows:4,className:"w-full bg-zinc-950/80 border border-zinc-800 rounded-xl p-4 text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-cyan text-xs resize-none"}),d==="folder"&&e.jsxs("div",{className:"space-y-2 p-4 bg-zinc-950/60 rounded-xl border border-amber-500/20",children:[e.jsxs("div",{className:"flex gap-4 mb-2 border-b border-zinc-800/80 pb-3",children:[e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-amber-300 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"project",checked:!X,onChange:()=>H(!1),className:"accent-amber-500"}),"📁 Projet Local Existant"]}),e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-yellow-400 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"pack",checked:X,onChange:()=>H(!0),className:"accent-yellow-500"}),"💎 Ancien Pack PRD (Ripping)"]})]}),e.jsx("label",{className:"text-xs font-semibold text-amber-300 block",children:X?"💎 Dossier du Pack PRD :":"📁 Dossier de l'ancien projet :"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{type:"button",onClick:async()=>{try{const ge=await(await A("http://localhost:5006/api/bridge/select-folder")).json(),Ce=ge.data||ge;Ce.success&&Ce.path&&(M(Ce.path),(!m.trim()||m.startsWith("Analyse"))&&u(X?`Analyse RIPPING de l'ancien pack PRD "${Ce.name}" pour l'enrichir et générer un nouveau pack ultra complet basé sur ce concept.`:`Analyse et reconstruction de l'ancien projet "${Ce.name}"`))}catch{}},className:"px-3 py-2 bg-amber-500/10 border border-amber-500/40 hover:bg-amber-500/20 text-amber-300 rounded-xl text-xs font-bold flex items-center gap-1.5",children:"📂 Choisir dossier"}),e.jsx("input",{type:"text",value:f,onChange:D=>M(D.target.value),placeholder:"ou saisissez le chemin (ex: E:\\ancien_projet)",className:"flex-1 bg-zinc-900 border border-zinc-800 rounded-xl px-3 py-2 text-xs text-amber-200 placeholder-zinc-500 font-mono"})]}),e.jsx("textarea",{value:m,onChange:D=>u(D.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs focus:outline-none focus:border-amber-500/50"})]}),d==="web"&&e.jsxs("div",{className:`space-y-2 p-4 bg-zinc-950/60 rounded-xl border ${C?"border-red-500/40":"border-purple-500/20"}`,children:[C&&e.jsx("div",{className:"flex items-center gap-2 text-[10px] text-red-300 bg-red-500/10 border border-red-500/30 px-3 py-1.5 rounded-lg",children:"🎬 YouTube détecté — extraction transcript activée"}),e.jsx("input",{type:"url",value:E,onChange:D=>B(D.target.value),placeholder:"https://www.youtube.com/watch?v=... ou https://mon-site.com",className:`w-full bg-zinc-900 border rounded-xl px-4 py-2.5 text-xs font-mono ${C?"border-red-500/50 text-red-200":"border-zinc-800 text-purple-200"}`}),e.jsx("textarea",{value:m,onChange:D=>u(D.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="designrip"&&e.jsxs("div",{className:"space-y-2 p-4 bg-emerald-950/10 rounded-xl border border-emerald-500/30",children:[e.jsx("label",{className:"text-xs font-semibold text-emerald-300 block",children:"🌐 URL du site à cloner :"}),e.jsx("input",{type:"url",value:E,onChange:D=>B(D.target.value),placeholder:"https://mon-site.com",className:"w-full bg-zinc-900 border border-emerald-500/30 rounded-xl px-4 py-2.5 text-xs text-emerald-200 font-mono"}),e.jsxs("div",{className:"p-2 bg-emerald-950/30 border border-emerald-500/20 rounded-xl text-[10px] text-emerald-200/80",children:["🎨 ",e.jsx("strong",{children:"DesignRip :"})," Clone du site avec animations fluides et design dynamique."]}),e.jsx("textarea",{value:m,onChange:D=>u(D.target.value),placeholder:"Instructions spécifiques...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="phase5"&&e.jsxs("div",{className:"space-y-4 p-4 bg-violet-950/15 rounded-xl border border-violet-500/30",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-xs font-black text-violet-300 uppercase tracking-widest",children:"⚙️ Phase 5 — Audit & Industrialisation"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed mt-1",children:"Sélectionnez le projet. Hermes l'auditera pour détecter les mocks et proposer une architecture sécurisée."})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("label",{className:"text-xs font-semibold text-violet-300 flex items-center gap-1.5",children:[e.jsx("span",{children:"📁"})," Projet à auditer :"]}),e.jsx("button",{type:"button",onClick:V,disabled:W,className:"text-[10px] text-violet-400 hover:text-violet-200 flex items-center gap-1 font-bold transition-colors cursor-pointer bg-violet-500/10 hover:bg-violet-500/20 border border-violet-500/30 px-2 py-0.5 rounded-lg",title:"Actualiser la liste des projets créés",children:e.jsx("span",{children:W?"Scan...":"🔄 Rafraîchir"})})]}),e.jsxs("div",{className:"relative",children:[e.jsxs("select",{value:$,onChange:D=>_(D.target.value),className:"w-full bg-zinc-900 border border-violet-500/40 hover:border-violet-500/60 rounded-xl px-4 py-2.5 text-xs text-violet-200 font-bold focus:outline-none focus:border-violet-400 cursor-pointer shadow-inner appearance-none transition-colors",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionnez un projet créé à auditer --"}),y.map(D=>e.jsxs("option",{value:D,className:"bg-zinc-950 text-white font-medium py-1",children:["📁 ",D]},D))]}),e.jsx("div",{className:"absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none text-violet-400 text-xs font-bold",children:"▼"})]}),y.length>0?e.jsxs("div",{className:"flex items-center justify-between text-[10px] text-zinc-400 px-1",children:[e.jsxs("span",{children:["✅ ",y.length," projet(s) créé(s) disponible(s)"]}),$&&e.jsxs("span",{className:"text-violet-300 font-mono",children:["Sélection : ",e.jsx("strong",{children:$})]})]}):W?null:e.jsxs("div",{className:"p-2.5 bg-amber-950/30 border border-amber-500/30 rounded-lg flex items-center justify-between gap-2",children:[e.jsx("p",{className:"text-[10px] text-amber-300",children:"Aucun projet détecté automatiquement. Entrez le nom manuellement :"}),e.jsx("input",{type:"text",value:$,onChange:D=>_(D.target.value),placeholder:"Ex: BLOG ou AUDIO",className:"bg-zinc-900 border border-amber-500/40 rounded-lg px-2.5 py-1 text-xs text-amber-200 font-mono w-44"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-[11px] font-semibold text-violet-300 block mb-1",children:"🎯 Instructions supplémentaires (optionnel) :"}),e.jsx("textarea",{value:w,onChange:D=>G(D.target.value),rows:2,placeholder:"Ex: S'assurer que les modèles de données incluent une table 'Utilisateur' avec un rôle administrateur...",className:"w-full bg-zinc-900 border border-violet-500/20 rounded-xl p-3 text-zinc-200 text-xs resize-none focus:border-violet-500/50 outline-none transition-colors"})]})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3 pt-1",children:[d!=="phase5"&&e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-[10px] text-zinc-400 font-semibold uppercase tracking-wider",children:"Catégorie:"}),e.jsx("select",{value:S,onChange:D=>b(D.target.value),className:"bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-1.5 text-[10px] text-cyan font-medium focus:outline-none focus:border-cyan",children:Ro.map(D=>e.jsx("option",{value:D.value,children:D.label},D.value))})]}),e.jsx("button",{onClick:ue,disabled:J==="analyzing",className:`px-5 py-2.5 rounded-xl font-bold text-xs flex items-center gap-2 transition-all shadow-lg ${J==="analyzing"?"bg-zinc-800 text-zinc-500 cursor-not-allowed":d==="phase5"?"bg-gradient-to-r from-violet-500 to-purple-600 text-white hover:from-violet-400 hover:to-purple-500":"bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-white hover:from-cyan-400 hover:to-purple-500"}`,children:J==="analyzing"?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin",children:"⚡"})," Analyse Hermes en cours..."]}):d==="phase5"?e.jsx(e.Fragment,{children:"⚙️ Auditer le Projet"}):e.jsx(e.Fragment,{children:"✨ Étape 1 : Analyser l'Idée (Proposition)"})})]}),d==="prompt"&&e.jsxs("div",{className:"pt-3 border-t border-zinc-800/80",children:[e.jsx("p",{className:"text-[10px] font-semibold text-zinc-400 mb-2 flex items-center gap-1.5",children:"💡 Ou choisissez un modèle d'inspiration prêt à l'emploi :"}),e.jsx("div",{className:"grid grid-cols-1 gap-2",children:Eo.map((D,ge)=>e.jsxs("button",{type:"button",onClick:()=>{p("prompt"),u(D.idea),b(D.category)},className:"text-left p-3 rounded-xl bg-zinc-900/60 border border-zinc-800/80 hover:border-cyan/40 transition-all group",children:[e.jsxs("div",{className:"flex items-center gap-2 font-bold text-white text-[11px] mb-1 group-hover:text-cyan transition-colors",children:[e.jsx("span",{children:D.icon})," ",D.title]}),e.jsx("p",{className:"text-zinc-400 text-[10px] leading-relaxed line-clamp-2",children:D.idea})]},ge))})]})]}),ae&&J!=="saved"&&d!=="phase5"&&e.jsx(No,{proposal:ae,folderName:de,setFolderName:xe,onConfirm:fe,onReset:re,isGenerating:J==="generating"}),F&&J!=="saved"&&d==="phase5"&&e.jsx(So,{audit:F,sourceFolder:$,onConfirm:Ee,onReset:re,isSubmitting:J==="generating"})]})},Ot="turnzack/v0-reponse",Mo="build-apk.yml",un=typeof window<"u"&&localStorage.getItem("tiger_github_pat")||"";async function $n(t,n,r){var p,m;const a=t||"AUDIO",d=Date.now();n(`> 🚀 Initialisation de la compilation Cloud pour [${a}]...`),n("> 🌐 Connexion au cluster de build souverain (GitHub Cloud Engine)...");try{const u=await fetch(`https://api.github.com/repos/${Ot}/actions/workflows/${Mo}/dispatches`,{method:"POST",headers:{Authorization:`Bearer ${un}`,Accept:"application/vnd.github.v3+json","Content-Type":"application/json","User-Agent":"Tiger-Auto-Apk-Engine"},body:JSON.stringify({ref:"main",inputs:{project_name:a,app_label:a}})});if(!u.ok&&u.status!==204){const E=await u.text();throw new Error(`Erreur API Cloud (${u.status}): ${E}`)}n("> ⚡ Ordre de compilation validé par le Cloud (Job Dispatch OK)."),n("> ⏳ Attribution d'un conteneur dédié (Ubuntu 22.04 LTS + JDK 17 + Android SDK)...");let S=null,b=0;for(;!S&&b<15;){await new Promise(B=>setTimeout(B,2e3)),b++;const E=await fetch(`https://api.github.com/repos/${Ot}/actions/runs?event=workflow_dispatch&per_page=5`,{headers:{Authorization:`Bearer ${un}`,Accept:"application/vnd.github.v3+json"}});if(E.ok){const C=(p=(await E.json()).workflow_runs)==null?void 0:p[0];C&&new Date(C.created_at).getTime()>=d-1e4&&(S=C.id,n(`> 📋 Tâche Cloud assignée : Run #${S}`))}}if(!S){n("> ℹ️ Compilation lancée en arrière-plan dans le Cloud."),r("building");return}let f=!1,M=0;for(;!f&&M<120;){await new Promise($=>setTimeout($,4e3)),M++;const E=await fetch(`https://api.github.com/repos/${Ot}/actions/runs/${S}`,{headers:{Authorization:`Bearer ${un}`,Accept:"application/vnd.github.v3+json"}});if(!E.ok)continue;const B=await E.json(),C=B.status,O=B.conclusion;if(C==="queued")n("> ⏳ En file d'attente sur les serveurs de build...");else if(C==="in_progress")M%3===0&&n("> ⚙️ Compilation native en cours (Assemblage Gradle Dex + Assets)...");else if(C==="completed")if(f=!0,O==="success"){n("> ✅ Compilation native réussie à 100 % !"),n("> 📦 Génération du lien de téléchargement direct de l'APK...");const $=await fetch(`https://api.github.com/repos/${Ot}/actions/runs/${S}/artifacts`,{headers:{Authorization:`Bearer ${un}`,Accept:"application/vnd.github.v3+json"}});if($.ok){const w=(m=(await $.json()).artifacts)==null?void 0:m[0];if(w){const G=`https://github.com/${Ot}/actions/runs/${S}/artifacts/${w.id}`;n("> 🎉 APK prêt ! Téléchargez votre application ci-dessous."),r("success",G);return}}r("success",`https://github.com/${Ot}/actions/runs/${S}`);return}else{n(`> ❌ La compilation Cloud s'est terminée avec le statut : ${O}`),r("error");return}}}catch(u){n(`> ❌ Erreur lors du déclenchement Cloud : ${u.message}`),r("error")}}const qo=(t=1)=>{if(typeof window>"u")return`linear-gradient(135deg, rgba(17,17,17,${t}), rgba(34,34,34,${t}))`;const n=[[[42,42,114],[0,159,253]],[[249,83,198],[185,29,115]],[[255,153,102],[255,94,98]],[[0,180,219],[0,131,176]],[[142,45,226],[74,0,224]],[[17,153,142],[56,239,125]],[[252,74,26],[247,183,51]],[[21,153,87],[21,87,153]],[[0,0,70],[28,181,224]],[[58,28,113],[215,109,119]],[[255,126,95],[254,180,123]],[[0,201,255],[146,254,157]],[[191,105,105],[194,112,66]],[[163,135,185],[170,107,115]],[[228,163,127],[191,105,105]],[[170,107,115],[194,112,66]],[[5,117,230],[2,27,121]],[[255,75,31],[255,144,104]],[[0,210,255],[58,123,213]],[[247,151,30],[255,210,0]],[[19,78,94],[113,178,128]],[[195,20,50],[36,11,54]],[[17,153,142],[56,239,125]],[[168,192,255],[63,75,150]]],[r,a]=n[Math.floor(Math.random()*n.length)];return`linear-gradient(${Math.floor(Math.random()*360)}deg, rgba(${r[0]},${r[1]},${r[2]},${t}) 0%, rgba(${a[0]},${a[1]},${a[2]},${t}) 100%)`},ct=(t,n=!1)=>t==="custom"?typeof window<"u"&&localStorage.getItem("tiger_customAiUrl")||"https://chat.deepseek.com/":t==="stitch"?"https://stitch.withgoogle.com/":t==="v0"?"https://v0.dev/":t==="kimi"||t==="moonshot"?"https://www.kimi.com/fr?chat_enter_method=new_chat":t==="qwen"?"https://chat.qwen.ai/":t==="gemini"?"https://gemini.google.com/app":t==="chatgpt"||t==="openai"?"https://chatgpt.com/":t==="claude"?"https://claude.ai/":t==="perplexity"?"https://www.perplexity.ai/":t==="deepseek"?"https://chat.deepseek.com/":`https://chat.${t}.com/`,Kn=({isModal:t=!1,isEmbedded:n=!1,onClose:r,initialTab:a="connexion",isClient:d,getCachedGradient:p,mouchardLogs:m,activePhase:u,availableProjects:S,setAvailableProjects:b,selectedLaunchProject:f,setSelectedLaunchProject:M,isMobileNative:E,isAutoPilot:B,setIsAutoPilot:C,reuseActiveTab:O,setReuseActiveTab:$,selectedStartPhase:_="UNDEF",setSelectedStartPhase:w=()=>console.error("MISSING SETTER"),selectedPacks:G=[]})=>{const[y,q]=o.useState(a);o.useEffect(()=>{q(a)},[a]);const[W,L]=o.useState("web"),[V,X]=o.useState("deepseek"),[H,J]=o.useState("stitch"),[z,ae]=o.useState(""),[ve,F]=o.useState(""),[ee,de]=o.useState("http://127.0.0.1:5006"),[xe,_e]=o.useState("https://v0-reponse-git-main-v01-e951.vercel.app"),[te,T]=o.useState("http://127.0.0.1:5175"),[K,re]=o.useState(""),[ue,fe]=o.useState("deepseek"),[Ee,Te]=o.useState("idle"),[D,ge]=o.useState(""),[Ce,he]=o.useState(!1),[se,De]=o.useState(""),[nt,Re]=o.useState(""),[Ne,oe]=o.useState(!0),[gt,ze]=o.useState("forge"),[Nn,ht]=o.useState(0),[xn,wt]=o.useState("vite"),[Nt,He]=o.useState("idle"),[nn,sn]=o.useState(""),[Dn,rn]=o.useState(""),[an,xt]=o.useState("6cd96956-200e-4260-ae7d-6c1446de284a"),[It,dt]=o.useState(""),[At,st]=o.useState("idle"),[$e,Dt]=o.useState(()=>typeof window<"u"?sessionStorage.getItem("tiger_isPipelineRunning")==="true":!1);o.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning",String($e))},[$e]);const[Le,ut]=o.useState(!1),[Ht,fn]=o.useState(!1);o.useEffect(()=>{Number(_)===0&&C&&C(!0)},[_]),o.useEffect(()=>{L(localStorage.getItem("tiger_execMode")||"web"),X(localStorage.getItem("tiger_targetAi")||"deepseek"),J(localStorage.getItem("tiger_targetUiAi")||"stitch"),ae(localStorage.getItem("tiger_customAiName")||""),F(localStorage.getItem("tiger_customAiUrl")||"");const i=localStorage.getItem("tiger_bridgeUrl");(!i||i==="http://127.0.0.1:5005"||i==="http://localhost:5005")&&localStorage.setItem("tiger_bridgeUrl","http://127.0.0.1:5006"),de(localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006"),_e(localStorage.getItem("tiger_vercelUrl")||"https://v0-reponse-git-main-v01-e951.vercel.app"),T(localStorage.getItem("tiger_defaultPreviewUrl")||"http://127.0.0.1:5175");const g=localStorage.getItem("tiger_apiKey")||localStorage.getItem("hermes_deepseek_api_key")||"";re(g),fe(localStorage.getItem("tiger_apiProvider")||"deepseek"),xt(localStorage.getItem("tiger_notebookId")||"6cd96956-200e-4260-ae7d-6c1446de284a"),dt(localStorage.getItem("tiger_authCookie")||"");const v=localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006";A(`${v}/api/config/apikey`).then(N=>N?N.json():null).then(N=>{N&&(N.hasAnyKey||N.hasKey||N.configured)&&(Te("ok"),N.apiKey&&!g&&(re(N.apiKey),localStorage.setItem("tiger_apiKey",N.apiKey),localStorage.setItem("hermes_deepseek_api_key",N.apiKey)))}).catch(()=>{})},[]);const ft=async()=>{const i={execMode:W,targetAi:V,targetUiAi:H,customAiName:z,customAiUrl:ve,bridgeUrl:ee,vercelUrl:xe,defaultPreviewUrl:te,apiKey:K};if(localStorage.setItem("tiger_execMode",W),localStorage.setItem("tiger_targetAi",V),localStorage.setItem("tiger_targetUiAi",H),localStorage.setItem("tiger_customAiName",z),localStorage.setItem("tiger_customAiUrl",ve),localStorage.setItem("tiger_bridgeUrl",ee),localStorage.setItem("tiger_vercelUrl",xe),localStorage.setItem("tiger_defaultPreviewUrl",te),localStorage.setItem("tiger_apiKey",K),localStorage.setItem("hermes_deepseek_api_key",K),localStorage.setItem("tiger_apiProvider",ue),localStorage.setItem("tiger_notebookId",an),localStorage.setItem("tiger_authCookie",It),K&&K.trim().length>0){Te("sending");const g=K.trim(),v=JSON.stringify({key:g,apiKey:g,provider:ue,mode:W}),N={"Content-Type":"application/json"};let Q=!1;const j=Array.from(new Set([`${ee}/api/config/apikey`,"http://localhost:5005/api/config/apikey","http://127.0.0.1:5005/api/config/apikey"]));for(const me of j)try{const je=await A(me,{method:"POST",headers:N,body:v});if(je&&je.ok&&(await je.json()).success){Q=!0;break}}catch(je){console.warn(`[SETTINGS] Échec envoi vers ${me}:`,je)}Te("ok"),console.log(Q?`[SETTINGS] ✅ Clé ${ue} envoyée et persistée sur le moteur.`:"[SETTINGS] ⚠️ Clé sauvée dans localStorage UI (Moteur en attente de reconnexion).")}typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Paramètres synchronisés !"),typeof window<"u"&&(window.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*"),window.parent&&window.parent!==window&&window.parent.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*")),he(!0),setTimeout(()=>he(!1),3e3)},$t=i=>{let g="";const v=new Uint8Array(i),N=v.byteLength,Q=32768;for(let j=0;j<N;j+=Q)g+=String.fromCharCode.apply(null,Array.from(v.subarray(j,j+Q)));return btoa(g)},pt=()=>{var v;const i=typeof window<"u"&&!!(window.electron||window.electronAPI||(v=navigator.userAgent)!=null&&v.includes("Electron")),g=f||se||`Projet_ZIP_${Date.now()}`;if(!i){const N=document.createElement("input");N.type="file",N.accept=".zip",N.style.display="none",N.onchange=async()=>{var j;const Q=(j=N.files)==null?void 0:j[0];try{N.remove()}catch{}if(Q){ut(!0);try{const me=await Q.arrayBuffer(),je=$t(me),ke=await(await fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:g,fileName:Q.name,fileBase64:je})})).json().catch(()=>null);qt(Q.name),w(2);const et=ke!=null&&ke.extractedCount?` (${ke.extractedCount} fichiers extraits)`:"";alert(`✅ Archive "${Q.name}" importée et extraite avec succès${et} dans le projet : ${g} !

Vous êtes maintenant sur la Phase 2. Cliquez sur "⚙️ LANCER PHASE 2 (MULTI-BATCH)" pour démarrer l'intégration !`)}catch(me){console.warn("[Upload ZIP] Erreur fallback:",me),alert(`⚠️ Erreur lors de l'envoi de l'archive : ${me}`)}finally{ut(!1)}}},N.click();return}(async()=>{ut(!0);try{const N=await A("http://localhost:5005/api/fs/pick-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:g})}),Q=N?await N.json():null;Q&&Q.success&&(alert("✅ ZIP Copié avec succès dans le dossier : "+g+`
Le fichier est prêt dans votre projet !`),w(2),(Q.fileName||Q.filename)&&qt(Q.fileName||Q.filename))}catch(N){console.warn("Erreur picker ZIP:",N)}finally{ut(!1)}})()},bn=[{id:"home",label:"TIGER IA",icon:"🐯"},{id:"creation",label:"⚙️ Création Projet",icon:"🚀"},{id:"electron",label:"Electron",icon:"💻"},{id:"vercel",label:"Vercel",icon:"▲"},{id:"deepseek",label:"DeepSeek",icon:"🐋"},{id:"override",label:"Override",icon:"💉"},{id:"connexion",label:"Connexion",icon:"⚙️"},{id:"suture",label:"Suture V2",icon:"🩺"}],[be,Kt]=o.useState({current:null,queue:[]}),[mt,Pt]=o.useState([]),[Ke,Mt]=o.useState("src/pages/ShoppingCartDrawer.tsx"),[Ie,Xe]=o.useState([]),[we,qt]=o.useState(()=>typeof window<"u"&&sessionStorage.getItem("tiger_uiZipName")||"");o.useEffect(()=>{typeof window<"u"&&we&&sessionStorage.setItem("tiger_uiZipName",we)},[we]);const[on,Qe]=o.useState(null),[Wt,We]=o.useState(null),[Lt,bt]=o.useState(!1),[Jt,rt]=o.useState(!1),[jt,R]=o.useState([]),Ae=o.useCallback(async i=>{if(!i){R([]);return}try{const g=await A(`http://localhost:5006/api/projects/${i}/pages`);if(g&&g.ok){const v=await g.json();v.pages&&R(v.pages)}}catch{}},[]);o.useEffect(()=>{const i=(typeof f=="string"?f:(f==null?void 0:f.project_id)||(f==null?void 0:f.title))||se;Ae(i)},[f,se,Ae]),o.useRef({current:null,queue:[]});const[Tt,vn]=o.useState(localStorage.getItem("suture_dryrun")||"none"),[Pe,Xt]=o.useState(localStorage.getItem("suture_locked_files")||"src/index.css,src/design.css,src/main.tsx,tsconfig.json,vite.config.ts,package.json"),[pe,it]=o.useState([]),[kt,vt]=o.useState(!1),[Ze,Ut]=o.useState(localStorage.getItem("suture_single_file")!=="false"),[Je,Ue]=o.useState(localStorage.getItem("suture_auto_promote")!=="false"),[Et,St]=o.useState("idle"),[Oe,ln]=o.useState("clean");o.useRef(0);const at=()=>{localStorage.setItem("suture_dryrun",Tt),localStorage.setItem("suture_locked_files",Pe),localStorage.setItem("suture_single_file",String(Ze)),localStorage.setItem("suture_auto_promote",String(Je)),A("http://localhost:5006/api/suture/config",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({dryRunMode:Tt,lockedFiles:Pe.split(",").map(i=>i.trim()).filter(Boolean),singleFileOnly:Ze,autoPromote:Je})}).catch(()=>{}),St("saved"),setTimeout(()=>St("idle"),2500)},Ye=async i=>{vt(!0);try{const g=i?`http://localhost:5006/api/suture/history?projectId=${i}`:"http://localhost:5006/api/suture/history",v=await A(g);if(v&&v.ok){const N=await v.json();it(N.repairs||[])}}catch{it([])}finally{vt(!1)}};return o.useEffect(()=>{if(!gs())return;let i;if(y==="deploiement"||y==="creation"){const g=()=>{A("http://localhost:5006/api/bridge/queue").then(v=>v?v.json():null).then(v=>{v&&v.success&&Kt({current:v.current||{},queue:v.queue||[]})}).catch(()=>{}),A("http://localhost:5006/api/logs").then(v=>v?v.json():null).then(v=>{v&&v.logs&&Pt(v.logs)}).catch(()=>{})};g(),i=setInterval(g,1e4)}return()=>clearInterval(i)},[y]),e.jsxs("div",{className:"design-config-modal w-full h-screen bg-gradient-to-br from-[#845e7c]/95 to-[#6c3050]/95 backdrop-blur-2xl border-none shadow-[0_0_50px_rgba(0,0,0,0.8)] relative overflow-hidden flex flex-col md:flex-row pointer-events-auto",children:[!n&&y!=="creation"&&e.jsxs("div",{className:"w-full md:w-64 bg-gradient-to-b from-black/40 to-black/60 border-r border-white/10 flex flex-col",children:[e.jsxs("div",{className:"p-6 border-b border-white/10 flex justify-between items-center",children:[e.jsxs("h3",{className:"text-lg font-black text-white tracking-wider flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"🐯"})," SETTINGS"]}),t&&e.jsx("button",{onClick:r,className:"md:hidden w-8 h-8 rounded-full bg-red-500/20 border border-red-500/50 flex items-center justify-center text-red-500 font-bold hover:bg-red-500 hover:text-white transition-colors",children:"✕"})]}),e.jsx("div",{className:"flex-1 overflow-y-auto py-4 hide-scrollbar flex md:flex-col gap-1 px-4",children:bn.map(i=>{let g="";return i.id==="suture"?Oe==="error"?g="bg-red-600 text-white border-2 border-red-400 shadow-[0_0_20px_#ff0055] animate-pulse font-bold":Oe==="working"?g="bg-purple-600 text-white border-2 border-purple-300 shadow-[0_0_20px_#a855f7] animate-pulse font-bold":g=y==="suture"?"bg-emerald-600/30 border border-emerald-500 text-emerald-300 shadow-[0_0_12px_rgba(16,185,129,0.4)]":"text-emerald-400 border border-emerald-500/30 hover:bg-emerald-950/40":g=y===i.id?"bg-cyan/20 border border-cyan/50 text-white shadow-[0_0_10px_rgba(8,179,201,0.2)]":"text-gray-400 hover:bg-white/5 hover:text-white",e.jsxs("button",{onClick:()=>q(i.id),className:`flex items-center gap-3 px-4 py-3 rounded-xl transition-all whitespace-nowrap md:whitespace-normal ${g}`,children:[e.jsx("span",{className:"text-xl",children:i.icon}),e.jsx("span",{className:"font-bold text-sm tracking-wide",children:i.id==="suture"&&Oe==="error"?"🔴 Suture (Erreur !)":i.id==="suture"&&Oe==="working"?"🟣 Suture V2...":i.label})]},i.id)})})]}),e.jsxs("div",{className:"flex-1 bg-gradient-to-br from-[#111111] to-black relative overflow-hidden flex flex-col",children:[e.jsxs("div",{className:"flex-1 overflow-y-auto p-6 md:p-8 relative z-10 hide-scrollbar",children:[y==="connexion"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsx("h2",{className:"text-xl font-black text-white border-b border-white/10 pb-4",children:"Configuration LLM & Bridge"}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-300 font-bold mb-2 block uppercase tracking-wider text-[10px]",children:"Mode d'exécution"}),e.jsx("div",{className:"grid grid-cols-3 gap-3",children:[{id:"web",icon:"💬",title:"Chat Web"},{id:"api",icon:"🔑",title:"API Directe"},{id:"hybrid",icon:"🔀",title:"Hybride"}].map(i=>e.jsxs("button",{onClick:()=>L(i.id),className:`p-3 rounded-xl border flex flex-col items-center justify-center transition-all ${W===i.id?"bg-gradient-to-br from-cyan/20 to-cyan/10 border-cyan text-white shadow-[0_0_10px_rgba(8,179,201,0.3)]":"bg-gradient-to-br from-black/30 to-black/50 border-white/10 text-gray-500 hover:border-white/30"}`,children:[e.jsx("span",{className:"text-2xl mb-1",children:i.icon}),e.jsx("span",{className:"font-bold text-xs",children:i.title})]},i.id))})]}),(W==="web"||W==="hybrid")&&e.jsxs("div",{className:"space-y-3",children:[e.jsx("span",{className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] block mb-2",children:"Flotte d'Assistants (Multi-Acteurs)"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"bg-gradient-to-br from-gray-900/50 to-black/50 p-4 rounded-xl border border-white/10 hover:border-cyan/50 transition-colors",children:[e.jsx("div",{className:"text-[10px] text-cyan mb-2 font-bold flex items-center gap-2",children:"🧠 Cerveau Logique (Backend)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("select",{value:V,onChange:i=>X(i.target.value),className:"flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 outline-none focus:border-cyan text-sm",children:[e.jsx("option",{value:"notebooklm",children:"📓 NotebookLM (Google)"}),e.jsx("option",{value:"deepseek",children:"🐋 DeepSeek Web"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT Web"}),e.jsx("option",{value:"gemini",children:"✨ Gemini Web"}),e.jsx("option",{value:"claude",children:"🟣 Claude Web"}),e.jsx("option",{value:"kimi",children:"🌙 Kimi Web"}),e.jsx("option",{value:"qwen",children:"🌐 Qwen Coder"}),e.jsx("option",{value:"perplexity",children:"🔍 Perplexity AI"}),e.jsx("option",{value:"custom",children:"➕ IA Personnalisée"})]}),e.jsx("button",{onClick:()=>{if(typeof window<"u"&&window.AndroidBridge){const i=V==="custom"?ve:ct(V);window.AndroidBridge.openAIWithPrompt(i,"Initialisation Logique.")}},className:"px-3 bg-white/10 hover:bg-cyan/20 rounded-lg font-bold text-xs transition-colors text-white",children:"▶"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-gray-900/50 to-black/50 p-4 rounded-xl border border-white/10 hover:border-pink/50 transition-colors",children:[e.jsx("div",{className:"text-[10px] text-pink mb-2 font-bold flex items-center gap-2",children:"🎨 Cerveau UI/UX (Frontend)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("select",{value:H,onChange:i=>J(i.target.value),className:"flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 outline-none focus:border-pink text-sm",children:[e.jsx("option",{value:"stitch",children:"🧵 Stitch Google"}),e.jsx("option",{value:"v0",children:"▲ v0.dev (Vercel)"}),e.jsx("option",{value:"bolt",children:"⚡ Bolt.new"}),e.jsx("option",{value:"custom",children:"➕ UI Personnalisée"})]}),e.jsx("button",{onClick:()=>{if(typeof window<"u"&&window.AndroidBridge){const i=H==="custom"?ve:H==="v0"?"https://v0.dev/":"https://stitch.withgoogle.com/";window.AndroidBridge.openAIWithPrompt(i,"Initialisation Design.")}},className:"px-3 bg-white/10 hover:bg-pink/20 rounded-lg font-bold text-xs transition-colors text-white",children:"▶"})]})]})]})]}),(V==="custom"||H==="custom")&&e.jsxs("div",{className:"flex gap-3 bg-white/5 border border-white/20 p-3 rounded-xl mt-2 animate-fadeIn",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("label",{htmlFor:"custom-ai-name",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"Nom IA Custom"}),e.jsx("input",{id:"custom-ai-name",type:"text",value:z,onChange:i=>ae(i.target.value),placeholder:"Mon Agent",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-white/50"})]}),e.jsxs("div",{className:"flex-[2]",children:[e.jsx("label",{htmlFor:"custom-ai-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Complète"}),e.jsx("input",{id:"custom-ai-url",type:"text",value:ve,onChange:i=>F(i.target.value),placeholder:"https://...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-white/50 font-mono"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{htmlFor:"api-provider",className:"text-gray-300 font-bold uppercase tracking-wider text-[10px]",children:"Fournisseur API"}),e.jsxs("select",{id:"api-provider",value:ue,onChange:i=>fe(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-xl px-4 py-3 outline-none focus:border-pink text-sm",children:[e.jsx("option",{value:"deepseek",children:"🐋 DeepSeek"}),e.jsx("option",{value:"openai",children:"🟢 OpenAI (ChatGPT)"}),e.jsx("option",{value:"anthropic",children:"🟣 Anthropic Claude"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("label",{htmlFor:"api-key",className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] flex items-center gap-2",children:["Clé API",Ee==="ok"&&e.jsx("span",{className:"text-green-400 text-[10px] font-bold bg-green-400/10 px-2 py-0.5 rounded-full border border-green-400/30",children:"✅ Persistante sur disque"}),Ee==="sending"&&e.jsx("span",{className:"text-yellow-400 text-[10px] animate-pulse",children:"⏳ Envoi..."}),Ee==="error"&&e.jsx("span",{className:"text-red-400 text-[10px]",children:"❌ Erreur moteur"})]}),e.jsx("div",{className:"flex gap-2 relative",children:e.jsx("input",{id:"api-key",type:"password",value:K,onChange:i=>re(i.target.value),placeholder:"sk-...",className:`flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border rounded-xl px-4 py-3 outline-none text-sm font-mono transition-colors ${Ee==="ok"?"border-green-500/50 focus:border-green-400":Ee==="error"?"border-red-500/50":"border-white/20 focus:border-pink"}`})}),e.jsxs("div",{className:"flex items-center gap-4 mt-2",children:[e.jsx("button",{onClick:ft,className:"px-4 py-2 bg-cyan/20 hover:bg-cyan/40 border border-cyan/40 text-cyan rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center gap-2",children:"💾 SAUVEGARDER + ENVOYER AU MOTEUR"}),e.jsx("span",{className:"text-gray-500 text-xs italic",children:"Persistée sur disque (reste après redémarrage)."})]})]}),e.jsxs("div",{className:"space-y-2 p-4 bg-gradient-to-br from-black/30 to-black/50 border border-white/5 rounded-xl",children:[e.jsx("span",{className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] block",children:"Modèle détecté"}),e.jsx("div",{className:"text-gray-500 text-sm mb-2",children:"Enregistrer la clé pour détecter"}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{className:"px-4 py-2 bg-pink/20 text-pink border border-pink/50 hover:bg-pink/30 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center gap-2",children:"🔄 AUTO_DETECT"}),e.jsx("span",{className:"text-gray-500 text-xs italic",children:"Auto-détecté à l'enregistrement."})]})]}),e.jsx("div",{className:"pt-4 border-t border-white/10",children:E?e.jsxs("div",{className:"space-y-4",children:[e.jsxs("h3",{className:"text-cyan font-bold flex items-center gap-2 text-sm mb-2",children:["📱 Moteur Mobile Natif",e.jsx("span",{className:"text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30",children:"Connecté"})]}),e.jsxs("p",{className:"text-xs text-gray-400 leading-relaxed",children:["La configuration automatique est active. Les prompts sont injectés via la WebView Fantôme Java et les fichiers sont sauvegardés nativement sur votre téléphone.",e.jsx("br",{}),e.jsx("br",{}),e.jsx("strong",{children:"Aucun Bridge Electron PC n'est requis."})," L'OS Souverain est 100% autonome dans votre poche."]})]}):e.jsxs(e.Fragment,{children:[e.jsxs("h3",{className:"text-cyan font-bold flex items-center gap-2 text-sm mb-4",children:["🔗 Bridge (:5006 / Vercel)",e.jsx("span",{className:"text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30",children:"Bridge polling actif"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"bridge-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Bridge local"}),e.jsx("input",{id:"bridge-url",type:"text",value:ee,onChange:i=>de(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"vercel-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Vercel"}),e.jsx("input",{id:"vercel-url",type:"text",value:xe,onChange:i=>_e(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"default-preview",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Preview par défaut"}),e.jsx("input",{id:"default-preview",type:"text",value:te,onChange:i=>T(i.target.value),placeholder:"http://127.0.0.1:3000",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]})]}),e.jsxs("div",{className:"flex gap-3 mt-4",children:[e.jsx("button",{className:"px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-xs font-bold text-white transition-colors",children:"🔗 Tester"}),e.jsx("button",{onClick:ft,className:"px-4 py-2 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-lg text-xs font-bold uppercase transition-colors",children:"💾 SAUVEGARDER_CONFIG"})]}),e.jsx("div",{className:"text-green-400 text-xs font-bold mt-4 flex items-center gap-2",children:"✅ Bridge connecté (auto-détecté)"})]})}),e.jsxs("div",{className:"pt-4 border-t border-white/10 space-y-4",children:[e.jsx("h3",{className:"text-blue-400 font-bold flex items-center gap-2 text-sm",children:"📓 NotebookLM Auto-Push (Python)"}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"notebook-id",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"Notebook ID (URL)"}),e.jsx("input",{id:"notebook-id",type:"text",value:an,onChange:i=>xt(i.target.value),placeholder:"6cd96956-...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-blue-500"})]}),e.jsxs("div",{children:[e.jsxs("label",{htmlFor:"auth-cookie",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px] flex justify-between",children:[e.jsx("span",{children:"Cookie d'authentification (__Secure-1PSID)"}),At==="success"&&e.jsx("span",{className:"text-green-400",children:"🟢 Connecté"}),At==="error"&&e.jsx("span",{className:"text-red-400",children:"🔴 Erreur / Expiré"}),At==="testing"&&e.jsx("span",{className:"text-yellow-400",children:"⏳ Test..."})]}),e.jsx("input",{id:"auth-cookie",type:"password",value:It,onChange:i=>dt(i.target.value),placeholder:"Collez votre cookie d'authentification Google ici...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1 outline-none focus:border-blue-500"})]}),e.jsxs("div",{className:"flex gap-3 mt-4",children:[e.jsx("button",{onClick:ft,className:"px-4 py-2 bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30 rounded-lg text-xs font-bold uppercase transition-colors",children:"💾 Sauvegarder"}),e.jsx("button",{onClick:async()=>{st("testing"),setTimeout(()=>st("success"),1e3)},className:"px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg text-xs font-bold uppercase transition-colors",children:"🧪 Tester"})]}),e.jsx("p",{className:"text-[10px] text-gray-500 italic",children:"Note : Ce cookie expire régulièrement. Pensez à le mettre à jour s'il ne fonctionne plus."})]})]})]}),y==="suture"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",onMouseEnter:()=>{pe.length===0&&Ye()},children:[e.jsxs("div",{className:"flex items-center justify-between border-b border-white/10 pb-4",children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-3",children:[e.jsx("span",{className:"text-3xl",children:"🩺"}),e.jsxs("div",{children:[e.jsx("div",{children:"Suture V2 — Moteur Zero-Touch"}),e.jsx("div",{className:"text-[10px] font-normal text-gray-400 mt-0.5",children:"Réparation autonome, isolée et atomique"})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-3 h-3 rounded-full ${Oe==="error"?"bg-red-500 shadow-[0_0_12px_#ff0055] animate-ping":Oe==="working"?"bg-purple-500 shadow-[0_0_12px_#a855f7] animate-pulse":"bg-emerald-400 shadow-[0_0_8px_#4ade80]"}`}),e.jsx("span",{className:`text-[11px] font-black uppercase tracking-wider ${Oe==="error"?"text-red-400":Oe==="working"?"text-purple-300":"text-emerald-400"}`,children:Oe==="error"?"🔴 ERREUR DÉTECTÉE (SUTURE REQUIS)":Oe==="working"?"🟣 SUTURE V2 EN COURS...":"🟢 MOTEUR AUTO-PILOT PRÊT"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a1a0a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-green-400 flex items-center gap-2",children:"🔬 Mode de Validation (Dry-Run)"}),e.jsx("p",{className:"text-[10px] text-gray-500 leading-relaxed",children:"Contrôle si le moteur compile le code dans le bac à sable avant de l'appliquer en production."}),e.jsx("div",{className:"grid grid-cols-3 gap-3",children:[{id:"none",icon:"🚀",label:"Production",desc:"Applique directement"},{id:"plan",icon:"🗺️",label:"Plan Only",desc:"Génère sans appliquer"},{id:"true",icon:"🧪",label:"Full Dry-Run",desc:"Clone + build + bloque"}].map(i=>e.jsxs("button",{onClick:()=>vn(i.id),className:`p-3 rounded-xl border flex flex-col items-center justify-center gap-1 transition-all text-center ${Tt===i.id?"bg-green-900/40 border-green-500/70 text-white shadow-[0_0_12px_rgba(74,222,128,0.2)]":"bg-black/30 border-white/10 text-gray-500 hover:border-white/30 hover:text-gray-300"}`,children:[e.jsx("span",{className:"text-xl",children:i.icon}),e.jsx("span",{className:"font-black text-[10px]",children:i.label}),e.jsx("span",{className:"text-[9px] opacity-70",children:i.desc})]},i.id))})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a0a1a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-cyan flex items-center gap-2",children:"⚡ Options de Promotion"}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("label",{className:"flex items-center justify-between cursor-pointer bg-black/20 px-4 py-3 rounded-xl hover:bg-white/5 transition-colors",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm",children:"Promotion Automatique"}),e.jsx("div",{className:"text-[10px] text-gray-500",children:"Si la compilation réussit, le patch est appliqué sans confirmation"})]}),e.jsx("div",{onClick:()=>Ue(i=>!i),className:`relative w-12 h-6 rounded-full transition-colors cursor-pointer ${Je?"bg-cyan":"bg-white/10"}`,children:e.jsx("div",{className:`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${Je?"left-7":"left-1"}`})})]}),e.jsxs("label",{className:"flex items-center justify-between cursor-pointer bg-black/20 px-4 py-3 rounded-xl hover:bg-white/5 transition-colors",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm",children:"Fichier Unique Seulement"}),e.jsx("div",{className:"text-[10px] text-gray-500",children:"La Suture ne peut modifier qu'un seul fichier par réparation (plus sûr)"})]}),e.jsx("div",{onClick:()=>Ut(i=>!i),className:`relative w-12 h-6 rounded-full transition-colors cursor-pointer ${Ze?"bg-cyan":"bg-white/10"}`,children:e.jsx("div",{className:`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${Ze?"left-7":"left-1"}`})})]})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#1a0a0a]/60 border border-red-500/20 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-red-400 flex items-center gap-2",children:"🔒 Fichiers Verrouillés (Intouchables)"}),e.jsxs("p",{className:"text-[10px] text-gray-500 leading-relaxed",children:["Ces fichiers ne seront ",e.jsx("strong",{className:"text-red-300",children:"JAMAIS"})," modifiés par une Suture, même si l'IA essaie. Séparés par des virgules."]}),e.jsx("textarea",{value:Pe,onChange:i=>Xt(i.target.value),rows:3,className:"w-full bg-black/40 text-red-200 border border-red-500/20 rounded-lg px-3 py-2 text-[11px] font-mono outline-none focus:border-red-500/50 resize-none",placeholder:"src/design.css,package.json,..."}),e.jsx("div",{className:"flex flex-wrap gap-2",children:Pe.split(",").map(i=>i.trim()).filter(Boolean).map(i=>e.jsxs("span",{className:"flex items-center gap-1 bg-red-900/20 border border-red-500/30 text-red-300 text-[9px] font-mono px-2 py-1 rounded-full",children:["🔒 ",i,e.jsx("button",{onClick:()=>Xt(g=>g.split(",").map(v=>v.trim()).filter(v=>v!==i).join(", ")),className:"text-red-500 hover:text-white ml-1 font-bold",children:"×"})]},i))})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a0a0a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-yellow-400 flex items-center gap-2",children:"⚡ Actions Rapides Suture"}),e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx("button",{onClick:()=>A("http://localhost:5006/api/suture/purge-workspaces",{method:"POST"}).then(i=>alert(i?"✅ Bac à sable vidé !":"❌ Moteur inaccessible (Mode Cloud SaaS)")).catch(()=>alert("❌ Moteur inaccessible")),className:"py-3 bg-orange-900/20 hover:bg-orange-900/40 border border-orange-500/30 text-orange-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"🗑️ Vider le Bac à Sable"}),e.jsx("button",{onClick:()=>Ye(),className:"py-3 bg-blue-900/20 hover:bg-blue-900/40 border border-blue-500/30 text-blue-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"🔄 Rafraîchir Historique"}),e.jsx("button",{onClick:()=>A("http://localhost:5006/api/suture/rollback-last",{method:"POST"}).then(i=>i?i.json():null).then(i=>alert(i?i.success?`✅ Rollback : ${i.message}`:`❌ ${i.error}`:"❌ Moteur inaccessible (Mode Cloud SaaS)")).catch(()=>alert("❌ Moteur inaccessible")),className:"py-3 bg-purple-900/20 hover:bg-purple-900/40 border border-purple-500/30 text-purple-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"↩️ Rollback Dernier Patch"}),e.jsx("button",{onClick:at,className:`py-3 border rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all ${Et==="saved"?"bg-green-900/40 border-green-500/50 text-green-300":"bg-cyan/10 hover:bg-cyan/20 border-cyan/40 text-cyan"}`,children:Et==="saved"?"✅ Sauvegardé !":"💾 Sauvegarder Config"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-gray-400 flex items-center gap-2",children:"📋 Historique des Réparations"}),e.jsx("button",{onClick:()=>Ye(),className:"text-[9px] text-cyan hover:text-white bg-cyan/10 px-2 py-1 rounded",children:"Actualiser"})]}),e.jsxs("div",{className:"max-h-[200px] overflow-y-auto hide-scrollbar space-y-2",children:[kt&&e.jsx("div",{className:"text-center text-gray-500 text-[10px] animate-pulse py-4",children:"⏳ Chargement..."}),!kt&&pe.length===0&&e.jsx("div",{className:"text-center text-gray-600 text-[10px] italic py-4",children:"Aucune réparation trouvée. Cliquez sur 🩺 dans l'explorateur pour lancer une Suture."}),pe.map((i,g)=>e.jsxs("div",{className:`flex items-center justify-between p-3 rounded-lg border text-[10px] font-mono ${i.status==="applied"?"bg-green-900/10 border-green-500/20":i.status==="failed"?"bg-red-900/10 border-red-500/20":"bg-white/5 border-white/10"}`,children:[e.jsxs("div",{className:"flex flex-col gap-0.5 truncate flex-1 mr-2",children:[e.jsx("span",{className:"text-white font-bold truncate",children:i.repairId||i.id}),e.jsxs("span",{className:"text-gray-500 truncate",children:[i.projectId," — ",i.activeFile||"?"]}),e.jsx("span",{className:"text-gray-600",children:i.startedAt?new Date(i.startedAt).toLocaleString("fr-FR"):""})]}),e.jsx("span",{className:`shrink-0 px-2 py-0.5 rounded-full border text-[9px] font-bold ${i.status==="applied"?"bg-green-900/30 border-green-500/40 text-green-300":i.status==="failed"?"bg-red-900/30 border-red-500/40 text-red-300":"bg-yellow-900/30 border-yellow-500/40 text-yellow-300"}`,children:i.status==="applied"?"✅ Appliqué":i.status==="failed"?"❌ Échec":"⚠️ Partiel"})]},g))]})]})]}),y==="creation"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn flex flex-col mt-8 border-t border-white/10 pt-8 pr-2",children:[e.jsxs("div",{className:"flex flex-col border-b border-white/5 pb-4",children:[e.jsxs("h2",{className:"text-2xl font-black text-white flex items-center gap-2 tracking-wide uppercase",children:[e.jsx("span",{children:"⚙️"})," CONFIGURATION DU PROJET"]}),e.jsx("p",{className:"text-[10px] text-gray-400 mt-1",children:"Générez et paramétrez votre projet de A à Z."})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1 min-h-0",children:[e.jsxs("div",{className:"transition-opacity duration-1000",children:[e.jsxs("div",{className:"bg-[#050505] border border-white/5 rounded-xl flex flex-col gap-4 overflow-y-auto hide-scrollbar p-5 mb-6",children:[e.jsxs("h3",{className:"text-white font-bold text-xs mb-2 flex items-center gap-2",children:[e.jsx("span",{className:"text-yellow-500",children:"📁"})," Création & Ciblage"]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"CIBLER UN PROJET EXISTANT"}),e.jsxs("select",{value:typeof f=="string"?f:(f==null?void 0:f.project_id)||(f==null?void 0:f.title)||"",onChange:i=>M(i.target.value),onClick:async()=>{if(S.length===0)try{const i=await A("/api/projects");if(i&&i.ok){const g=await i.json();g.projects&&b(g.projects.map(v=>typeof v=="string"?v:v.project_id||v.title||v.name||""))}else{const v=await(await fetch("/api/projects")).json();v.projects&&b(v.projects.map(N=>typeof N=="string"?N:N.project_id||N.title||N.name||""))}}catch{}},className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 outline-none focus:border-cyan text-xs",children:[e.jsx("option",{value:"",children:"-- SÉLECTIONNER UN PROJET --"}),S.map((i,g)=>{const v=typeof i=="string"?i:i.project_id||i.title||i.name||"Projet "+g;return e.jsx("option",{value:v,children:v},v+"_"+g)})]}),f&&Nt==="idle"&&e.jsx("button",{onClick:async()=>{He("loading");try{const i=await A("http://localhost:5006/api/bridge/export-notebooklm",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:f,notebookId:an,authCookie:It})});if(!i){alert("Mode Cloud SaaS : Bridge local non connecté."),He("idle");return}const g=await i.json();g.success?(sn(g.combinedContent||""),g.pushLog&&g.pushLog.includes("Failed:")?(rn(g.pushLog),He("error")):He("ready")):(rn(g.message),He("error"))}catch{rn("Erreur de connexion avec Kirov5."),He("error")}},className:"mt-2 w-full bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-2",children:"📓 Préparer l'export NotebookLM"}),f&&Nt==="loading"&&e.jsx("button",{disabled:!0,className:"mt-2 w-full bg-gray-900/50 text-gray-400 border border-gray-700/50 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider flex items-center justify-center gap-2",children:"⏳ Extraction de l'expertise..."}),f&&Nt==="ready"&&e.jsx("button",{onClick:async()=>{try{await navigator.clipboard.writeText(nn),window.open("https://notebook.google.com/notebook/6cd96956-200e-4260-ae7d-6c1446de284a","_blank"),He("idle")}catch{alert("❌ Copie échouée. Essayez sur HTTPS ou utilisez Ctrl+C manuellement.")}},className:"mt-2 w-full bg-green-900/40 hover:bg-green-800/60 text-green-300 border border-green-500/50 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-2",children:"✅ Copier & Ouvrir NotebookLM"}),f&&Nt==="error"&&e.jsxs("div",{className:"mt-2 p-3 bg-red-900/30 border border-red-500/50 rounded-lg",children:[e.jsx("div",{className:"text-red-400 text-[10px] font-bold mb-2",children:"⚠️ Échec du script Python (Copiez l'erreur ci-dessous) :"}),e.jsx("textarea",{readOnly:!0,value:Dn,className:"w-full h-24 bg-black/50 text-red-300 text-[10px] font-mono p-2 rounded border border-red-500/20 outline-none"}),e.jsxs("div",{className:"flex gap-2 mt-2",children:[e.jsx("button",{onClick:()=>He("idle"),className:"flex-1 bg-gray-800 hover:bg-gray-700 text-white text-[10px] py-2 rounded font-bold",children:"🔄 Réessayer"}),e.jsx("button",{onClick:async()=>{try{await navigator.clipboard.writeText(nn),window.open("https://notebook.google.com/notebook/6cd96956-200e-4260-ae7d-6c1446de284a","_blank"),He("idle")}catch{alert("❌ Copie échouée.")}},className:"flex-1 bg-green-900/50 hover:bg-green-800/70 text-green-300 border border-green-500/50 text-[10px] py-2 rounded font-bold",children:"✅ Fallback Manuel"})]})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"NOM DU NOUVEAU PROJET"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"text",value:se,onChange:i=>De(i.target.value),placeholder:"Ex: MonSuperProjet",className:"flex-1 bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan"}),e.jsx("button",{onClick:async()=>{if(!se||!se.trim()){alert("Entrez un nom de projet");return}const i=se.trim();try{const g=localStorage.getItem("kirov5_jwt_token")||"",v=await fetch("/api/projects",{method:"POST",headers:{"Content-Type":"application/json",...g?{Authorization:`Bearer ${g}`}:{}},body:JSON.stringify({title:i,name:i,projectId:i.replace(/[^a-zA-Z0-9_-]/g,"_"),description:"Projet Tiger Cloud"})}),N=await v.json();v.ok&&(N.success||N.project)?(alert(`✅ Projet "${i}" créé avec succès !`),setActiveProject(i),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",i),fetch("/api/projects",{headers:g?{Authorization:`Bearer ${g}`}:{}}).then(Q=>Q.json()).then(Q=>{Q&&Q.projects&&setRealProjects(Q.projects.map(j=>({name:j.project_id||j.title||j.name,desc:j.owner_email?`Propriétaire: ${j.owner_email}`:"Projet Cloud",bg:""})))}).catch(()=>{})):alert("❌ Erreur création projet: "+(N.error||N.message||"Erreur inconnue"))}catch(g){alert("❌ Erreur de connexion avec le serveur: "+((g==null?void 0:g.message)||g))}},className:"bg-[#0f2a2a] hover:bg-[#153f3f] text-cyan border border-cyan/30 px-4 py-2 rounded-lg text-xs font-bold transition-colors",children:"Valider"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"STACK TECHNIQUE"}),e.jsxs("select",{value:xn,onChange:i=>wt(i.target.value),className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",children:[e.jsx("option",{value:"vite",children:"⭐ 1er Choix (Prioritaire) : Vite + React + Tailwind + TS"}),e.jsx("option",{value:"nextjs",children:"Next.js 16 + Tailwind"})]})]}),e.jsxs("div",{className:"flex-1 flex flex-col",children:[e.jsxs("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2 flex items-center gap-1",children:[e.jsx("span",{className:"text-white",children:"📄"})," INSTRUCTIONS / VISION"]}),e.jsx("textarea",{value:nt,onChange:i=>Re(i.target.value),placeholder:"Décrivez l'application ou copiez votre PRD...",className:"w-full flex-1 min-h-[120px] bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan resize-none"})]})]}),e.jsxs("div",{className:"bg-[#050505] border border-white/5 rounded-xl flex flex-col gap-4 overflow-y-auto hide-scrollbar p-5 transition-opacity duration-1000",children:[e.jsxs("h3",{className:"text-white font-bold text-xs mb-2 flex items-center gap-2",children:[e.jsx("span",{className:"text-yellow-500",children:"⚡"})," Paramètres & IA"]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"INTELLIGENCE CIBLE"}),e.jsxs("select",{className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",onChange:i=>{const g=i.target.value;window.KIROV_TARGET_AI=g,typeof window<"u"&&localStorage.setItem("tiger_targetAi",g);let v="";g==="stitch"?v="https://stitch.withgoogle.com":g==="deepseek"||g==="deepseek-web"?v="https://chat.deepseek.com":g==="gemini"?v="https://gemini.google.com":g==="chatgpt"?v="https://chatgpt.com":g==="claude"?v="https://claude.ai":g==="notebooklm"&&(v="https://notebooklm.google.com"),v&&A("http://localhost:5006/api/bridge/open-window",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:v})}).catch(N=>console.warn("Erreur ouverture fenêtre",N))},defaultValue:typeof window<"u"&&localStorage.getItem("tiger_targetAi")||"hermes",children:[e.jsx("option",{value:"notebooklm",children:"📓 NotebookLM (Google)"}),e.jsx("option",{value:"cloudflare",children:"☁️ Cloudflare Qwen 3 30B (Audit IA Grade Gold)"}),e.jsx("option",{value:"cloudflare-hermes",children:"⚡ Hermes Cloudflare Workers AI (Qwen Coder)"}),e.jsx("option",{value:"deepseek",children:"🩵 DeepSeek (Extension Web)"}),e.jsx("option",{value:"hermes",children:"🤖 Hermes Agent (API DeepSeek)"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT"}),e.jsx("option",{value:"claude",children:"🟣 Claude"})]})]}),e.jsxs("div",{children:[e.jsxs("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:["💉 MODE & LOT DE DÉPART (Val: ",_,")"]}),e.jsxs("select",{value:_,onChange:i=>w(Number(i.target.value)),className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",children:[e.jsx("option",{value:0,children:"🚀 TOUT : Pipeline Complète (Zero-Touch)"}),e.jsx("option",{value:1,children:"🎨 Phase 1 : Le Frontend (Stitch/v0)"}),e.jsx("option",{value:2,children:"⚙️ Phase 2 : Logique G5"}),e.jsx("option",{value:4,children:"🎨 Phase 3/4 : Câblage Métier (Business Wiring)"}),e.jsx("option",{value:5,children:"🔌 Phase 5 : Industrialisation & Backend"}),e.jsx("option",{value:9,children:"🪄 M.A.J UI : Pipeline Push UI/UX (One-Shot)"})]})]}),e.jsxs("div",{className:"flex flex-col gap-3 mt-4 bg-[#111] p-4 rounded-lg border border-white/5",children:[e.jsxs("label",{className:"flex items-center gap-3 text-[11px] font-bold text-gray-300 cursor-pointer",children:[e.jsx("input",{type:"checkbox",className:"accent-cyan w-4 h-4",checked:B,onChange:()=>C(!B)}),"🤖 AUTO-PILOT : ",B?"ON 🟢":"OFF ⚪"]}),e.jsxs("label",{className:"flex items-center gap-3 text-[11px] font-bold text-gray-300 cursor-pointer",children:[e.jsx("input",{type:"checkbox",className:"accent-cyan w-4 h-4",checked:O,onChange:()=>$(!O)}),"🔗 Injecter dans l'onglet ouvert"]})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-3 mt-4",children:[e.jsxs("div",{id:"btn-joindre-prd",className:`py-6 text-white text-[10px] font-bold rounded-lg border flex flex-col items-center justify-center gap-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${Ht?"bg-purple-950/80 border-purple-400 animate-pulse":(window.KIROV_SELECTED_PACKS||G).length>0?"bg-indigo-600 border-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.6)]":"bg-[#2a1b3d] border-purple-500/30"}`,title:"Pack PRD sélectionné — Sera injecté automatiquement dans le contexte IA",children:[e.jsx("span",{className:"text-xl",children:Ht?"⏳":"💎"}),e.jsx("span",{children:Ht?"Copie en cours...":(window.KIROV_SELECTED_PACKS||G).length>0?`Packs PRD ${(window.KIROV_SELECTED_PACKS||G).length} ${(window.KIROV_SELECTED_PACKS||G)[0]}`:"Aucun Pack PRD"})]}),e.jsxs("button",{id:"btn-joindre-zip",disabled:Le,onClick:()=>{Number(_)===0&&(Dt(!0),typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning","true")),pt()},className:`py-6 text-white text-[10px] font-bold rounded-lg border transition-all flex flex-col items-center justify-center gap-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${Le?"bg-amber-950/70 border-amber-500 text-amber-300 animate-pulse":Number(_)===2&&!we?"bg-cyan-950/80 border-2 border-cyan text-cyan shadow-[0_0_30px_rgba(6,182,212,0.7)] animate-pulse scale-105 ring-2 ring-cyan/40 cursor-pointer":$e?"bg-[#1a3a40] hover:bg-[#204a50] pointer-events-auto shadow-[0_0_30px_rgba(8,179,201,0.6)] border-cyan scale-105 z-50 relative animate-pulse":"bg-[#1a2f3a] hover:bg-[#254250] border-cyan/30"}`,title:we?`Archive importée : ${we}`:"Joindre le fichier ZIP exporté depuis Stitch",children:[e.jsx("span",{className:"text-xl",children:Le?"⏳":we?"✅":"📎"}),e.jsx("span",{className:"font-extrabold",children:Le?"Extraction en cours...":we?`ZIP : ${we}`:"Joindre ZIP (Stitch)"}),Number(_)===2&&!we&&!Le&&e.jsx("span",{className:"text-[9px] text-cyan-300 font-extrabold uppercase animate-bounce mt-0.5",children:"👇 Étape 2 : Joindre le ZIP ici"})]})]}),(()=>{const g={0:"🚀 LANCER PIPELINE COMPLÈTE (ONE-SHOT)",1:"✨ LANCER PHASE 1 (Prompt vers l'IA)",2:we?`⚙️ LANCER PHASE 2 (MULTI-BATCH) [${we}]`:"⚙️ LANCER PHASE 2 (MULTI-BATCH) — ⏳ EN ATTENTE DU ZIP STITCH",3:"🎨 LANCER PHASE 3/4 (CÂBLAGE MÉTIER)",4:"🎨 LANCER PHASE 3/4 (CÂBLAGE MÉTIER)",5:"🔌 LANCER PHASE 5 (INDUSTRIALISATION)",9:"🛡️ LANCER PUSH UI"}[Number(_)];return g?e.jsx("button",{id:"btn-lancer-phase",onClick:()=>{const v=f||se;if(!v){alert("Veuillez sélectionner ou créer un projet !");return}if(Number(_)===2&&!we){confirm(`📁 Le fichier .zip Stitch n'est pas encore joint à ce projet.

Souhaitez-vous sélectionner et importer votre archive ZIP maintenant ?`)&&pt();return}Dt(!0),typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning","true"),setTimeout(()=>{var j;(j=document.getElementById("kirov-radar-queue"))==null||j.scrollIntoView({behavior:"smooth"})},500);const N=window.KIROV_TARGET_AI||typeof window<"u"&&localStorage.getItem("tiger_targetAi")||"hermes";if(typeof r=="function"&&r(),q("home"),typeof window<"u"&&window.dispatchEvent(new CustomEvent("open-mouchard")),Number(_)===5){A("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:N,start_index:1,zip_mode:!0,start_phase:5,auto_pilot:B})}).then(j=>j?j.json():null).then(j=>{alert(j?`✅ PHASE 5 (INDUSTRIALISATION) LANCÉE !
L'orchestrateur génère l'infrastructure et certifie le projet.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(j=>{console.error(j),alert("Erreur lors du lancement de la Phase 5.")});return}if(Number(_)===4||Number(_)===3){A("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:N,start_index:1,zip_mode:!0,start_phase:4,auto_pilot:B,packs:window.KIROV_SELECTED_PACKS||[]})}).then(j=>j?j.json():null).then(j=>{alert(j?`✅ PHASE 3/4 (CÂBLAGE MÉTIER) LANCÉE !
L'orchestrateur prend le relais pour connecter et câbler la logique métier.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(j=>{console.error(j),alert("Erreur lors du lancement de la Phase 3/4.")});return}if(Number(_)===2){A("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:N,start_index:1,zip_mode:!0,start_phase:200,auto_pilot:B,packs:window.KIROV_SELECTED_PACKS||[]})}).then(j=>j?j.json():null).then(j=>{alert(j?`✅ PHASE 2 (LOGIQUE G5) LANCÉE !
L'orchestrateur prend le relais pour générer le Backend et intégrer les composants.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(j=>{console.error(j),alert("Erreur: Le moteur n'a pas pu être contacté.")});return}typeof window<"u"&&(window.open("https://stitch.withgoogle.com/","_blank"),window.dispatchEvent(new CustomEvent("open-mouchard")));const Q=window.KIROV_SELECTED_PACKS&&window.KIROV_SELECTED_PACKS.length>0?window.KIROV_SELECTED_PACKS:G&&G.length>0?G:[];if(Number(_)===0){A("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:"stitch",start_index:1,zip_mode:!0,start_phase:0,auto_pilot:B,instructions:nt||"Génère l'application avec ces packs et directives.",packs:Q})}).then(j=>j?j.json():null).then(j=>{var ot;const me=(j==null?void 0:j.prompt)||((ot=j==null?void 0:j.data)==null?void 0:ot.prompt)||"Génération UI/UX Stitch complète.",je=Q.length>0?Q.join(", "):"standard";if(w(2),typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase","2"),typeof document<"u"){const ke=document.getElementById("tiger-mega-prompt-overlay");ke&&ke.remove();const et=document.createElement("div");et.id="tiger-mega-prompt-overlay",et.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);backdrop-filter:blur(10px);z-index:999999;display:flex;align-items:center;justify-content:center;padding:16px;font-family:sans-serif;",et.innerHTML=`
                                  ...
                                  <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid rgba(255,255,255,0.1);padding-bottom:12px;">
                                    <div>
                                      ...
                                      <p style="margin:4px 0 0 0;font-size:11px;color:#94a3b8;">
                                        Projet : <strong style="color:#e2e8f0;">${v}</strong> | Pack PRD : <strong style="color:#a855f7;">${je}</strong>
                                      </p>
                                    </div>
                              ...
                              `,document.body.appendChild(et);const yt=document.getElementById("tiger-prompt-area"),Ge=document.getElementById("btn-copy-prompt"),_t=document.getElementById("btn-close-prompt-overlay"),Fe=document.getElementById("btn-open-stitch"),s=()=>{yt&&(yt.select(),yt.setSelectionRange(0,99999),document.execCommand("copy")),navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),w(2),Ge&&(Ge.innerHTML="✅ COPIÉ DANS LE PRESSE-PAPIER !",Ge.style.background="linear-gradient(135deg,#10b981,#059669)",setTimeout(()=>{Ge&&(Ge.innerHTML="📋 COPIER LE MÉGA-PROMPT",Ge.style.background="linear-gradient(135deg,#06b6d4,#2563eb)")},3e3))};Ge&&(Ge.onclick=()=>{s(),w(2)}),_t&&(_t.onclick=()=>{et.remove(),w(2)}),Fe&&(Fe.onclick=()=>{window.open("https://stitch.withgoogle.com/","_blank"),w(2)}),s(),w(2)}}).catch(j=>{console.error(j),alert("Erreur de communication avec le serveur Kirov5.")});return}A("/api/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:"stitch",user_prompt:nt||"Génère l'application avec ces packs et directives.",packs:Q,target_project:v,phase_num:1})}).then(j=>j?j.json():null).then(j=>{var je;const me=(j==null?void 0:j.prompt)||((je=j==null?void 0:j.data)==null?void 0:je.prompt)||"Génération UI/UX Stitch.";typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),alert(`🚀 PHASE 1 (STITCH UI/UX) INITIALISÉE !
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){pt(c),be(!1);return}const l=s||localStorage.getItem("tiger_apiKey");if(!l||!l.startsWith("sk-")||l.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){pt(c),be(!1);return}const I=new AbortController,h=setTimeout(()=>I.abort(),4e3),x=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${l}`},signal:I.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(h),x.ok){const P=await x.json(),k=JSON.parse(P.choices[0].message.content);k.news&&Array.isArray(k.news)&&k.news.length>0?pt(k.news):pt(c)}else x.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),pt(c)}catch(l){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",l),pt(c)}finally{be(!1)}},[]);o.useEffect(()=>{Kt()},[Kt]);const[mt,Pt]=o.useState(!1),[Ke,Mt]=o.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Ie,Xe]=o.useState([]),[we,qt]=o.useState("");o.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let c=JSON.parse(s);if(!Array.isArray(c))throw new Error("Not an array");const l="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";c=c.map(I=>I.name==="fold"?{...I,colors:{...I.colors,"bg-app":l}}:I),Xe(c)}catch{Xe([])}else{const c={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};Xe([c]),localStorage.setItem("tiger_saved_themes",JSON.stringify([c]))}},[]),o.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",Ke),Ke!=="random"){const c=((s=Ie.find(l=>l.name===Ke))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=c,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[Ke,Ie]);const on=()=>{if(!we.trim())return alert("Nom invalide");if(Ie.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":a("icon-settings",.8),"icon-ai":a("icon-ai",.8),"icon-projects":a("icon-projects",.8),"icon-packs":a("icon-packs",.8),"icon-news":a("icon-news",.8),"bg-app":a("bg-app",.9)},c={name:we.trim(),colors:s},l=[...Ie,c];Xe(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),Mt(c.name),qt("")},Qe=(s,c)=>{c.stopPropagation();const l=Ie.filter(I=>I.name!==s);Xe(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),Ke===s&&Mt("random")},Wt=s=>{K(c=>c.includes(s)?c.filter(l=>l!==s):[...c,s])},[We,Lt]=o.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});o.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(We))},[We]);const[bt,Jt]=o.useState(!0),[rt,jt]=o.useState(!0),[R,Ae]=o.useState(null),[Tt,vn]=o.useState(null),[Pe,Xt]=o.useState(null),[pe,it]=o.useState(null),[kt,vt]=o.useState(""),[Ze,Ut]=o.useState([]);o.useEffect(()=>{A("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))te(s.projects.map(c=>({name:typeof c=="string"?c:c.project_id||c.title||c.name||"Projet",desc:"Projet local",bg:""})));else{const c=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:c?{Authorization:`Bearer ${c}`}:{}}).then(l=>l?l.json():null).then(l=>{l&&l.projects&&te(l.projects.map(I=>({name:typeof I=="string"?I:I.project_id||I.title||I.name||"Projet",desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[Je,Ue]=o.useState(null),[Et,St]=o.useState(""),[Oe,ln]=o.useState(!1),[at,Ye]=o.useState(!1),i=o.useRef(null);o.useEffect(()=>{if(i.current=null,R==="v0-guest"||R==="V0-Guest")Ye(!0),Ue("http://localhost:3007"),St("http://localhost:3007"),i.current="http://localhost:3007";else if(R){Ye(!0);const s=Pe&&JSON.stringify(Pe).includes("next.config"),c=typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1",l=s?"http://localhost:3000":i.current||(c?`http://${window.location.hostname}:5173`:"http://localhost:5173");Ue(l),St(l),i.current=l}else Ye(!1),Ue(null)},[R,Pe]),o.useEffect(()=>{const s=c=>{var l,I,h,x;if(((l=c.data)==null?void 0:l.type)==="CHANGE_PREVIEW_URL"){const P=c.data.route,k=P==="/"?"":`#${P}`;Ue(ne=>{const Z=ne?ne.split("#")[0]:"http://127.0.0.1:5175/";return`${Z.endsWith("/")?Z:`${Z}/`}${k}`})}if(((I=c.data)==null?void 0:I.type)==="DESIGN_ELEMENT_CLICKED"||((h=c.data)==null?void 0:h.type)==="DESIGN_ELEMENT_DRAGGED"||((x=c.data)==null?void 0:x.type)==="DESIGN_ELEMENT_RESIZED"){const P=document.querySelector('iframe[title="Studio Admin Design"]');P&&P.contentWindow&&P.contentWindow.postMessage(c.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),o.useEffect(()=>{R&&A(`http://localhost:5006/api/fs/tree?project=${R}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&Xt(s.tree)}).catch(()=>{})},[R]),o.useEffect(()=>{R&&pe&&A(`http://localhost:5006/api/fs/read?project=${R}&file=${encodeURIComponent(pe)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&vt(s.content)}).catch(()=>{})},[R,pe]);const g=async s=>{if(s===void 0||!R||!pe)return;if(vt(s),zt.isNativePlatform()||!!window.AndroidBridge)try{await zn.writeFile({path:`v0-moteur-mobile/projetv0/${R}/${pe}`,data:s,directory:gn.Documents,encoding:An.UTF8,recursive:!0})}catch(l){console.error("Erreur de sauvegarde mobile:",l)}else A("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:R,file:pe,content:s})}).catch(()=>{})},v=s=>{R&&A(`http://localhost:5006/api/fs/read?project=${R}&file=${encodeURIComponent(s)}`).then(c=>c?c.json():null).then(c=>{c&&c.success&&Ut(l=>l.find(I=>I.path===s)?l:[...l,{path:s,content:c.content}])}).catch(()=>{})};o.useEffect(()=>{(async()=>{const c=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(zt.isNativePlatform()||!!window.AndroidBridge)try{const h=(await zn.readdir({path:"v0-moteur-mobile/projetv0",directory:gn.Documents})).files.map(x=>x.name||x.toString());te(h.map((x,P)=>({name:x,desc:"Mémoire Téléphone",bg:c[P%c.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else A("http://localhost:5006/api/projects-v2").then(I=>I?I.json():null).then(I=>{if(I&&I.success&&I.projects)te(I.projects.map((h,x)=>({name:typeof h=="string"?h:h.name||h.project_id||h.title||`Projet_${x}`,desc:"Environnement Local",bg:c[x%c.length],installed:h.installed})));else{const h=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:h?{Authorization:`Bearer ${h}`}:{}}).then(x=>x?x.json():null).then(x=>{x&&x.projects&&te(x.projects.map((P,k)=>({name:typeof P=="string"?P:P.project_id||P.title||P.name||`Projet_${k}`,desc:"SaaS Cloud (Neon DB)",bg:c[k%c.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),o.useEffect(()=>{V(!0)},[]);const[N,Q]=o.useState(!0);o.useEffect(()=>{const s=()=>Q(!0);window.addEventListener("open-mouchard",s);const c=l=>{if(l.data&&l.data.type==="TIGER_CAPTURE"){const I=l.data.data;if(I){let h="index.html";(I.includes("import React")||I.includes("export default"))&&(h="App.tsx"),I.includes("tailwindcss")&&(h="index.css"),it(h),g(I),Xt(x=>{var ne;const P={name:h,path:h,type:"file"};return x?((ne=x.children)==null?void 0:ne.find(Z=>Z.name===h))?x:{...x,children:[...x.children||[],P]}:{name:"Mobile_Storage",type:"directory",children:[P]}})}}};return window.addEventListener("message",c),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("message",c)}},[R,pe]),o.useEffect(()=>{if(!L)return;const s=()=>{A("http://localhost:5006/api/bridge/queue").then(l=>l?l.json():null).then(l=>{l&&l.success&&(setBridgeQueueData({current:l.current||{},queue:l.queue||[]}),(l.queue&&l.queue.length>0||l.current&&Object.keys(l.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),A("http://localhost:5006/api/bridge/logs").then(l=>l?l.json():null).then(l=>{var I,h;if(l&&l.success&&l.logs){xe(l.logs);const x=[...l.logs].reverse().find(k=>k.includes("URL_PREVIEW="));if(x){let k=(I=x.split("URL_PREVIEW=")[1])==null?void 0:I.trim();k&&typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"&&(k=k.replace(/localhost|127\.0\.0\.1/,window.location.hostname)),k&&k!==i.current&&(i.current=k,Ue(k),St(k),Ye(!0))}const P=[...l.logs].reverse().find(k=>k.includes("PIPELINE COMPLET TERMINÉ avec succès pour "));if(P){const k=(h=P.split("PIPELINE COMPLET TERMINÉ avec succès pour ")[1])==null?void 0:h.replace(/[.\s]+$/,"");k&&R!==k&&(Ae(k),Ye(!0))}}}).catch(()=>{}),A("http://localhost:5006/api/bridge/autonomous-status").then(l=>l?l.json():null).then(l=>{if(l&&l.success&&(l.data||l.status)){const h=(l.data||l.status).state;h==="diagnosing"||h==="repair_required"||h==="error"?y("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(h)||["starting_server","launch_requested","restarting"].includes(h)?y("working"):h==="ready"?y("clean"):R&&A(`http://localhost:5006/api/suture/status?project=${R}`).then(x=>x?x.json():null).then(x=>{x&&x.success&&x.status&&y(x.status)}).catch(()=>{})}}).catch(()=>{})};s();const c=setInterval(s,2e3);return()=>clearInterval(c)},[L,R]);const j=s=>{const c=typeof s=="string"?s:b;if(!c.trim())return;const l={id:Date.now().toString(),role:"user",content:c};S(h=>[...h,l]);const I=c.toLowerCase();setTimeout(()=>{let h={id:(Date.now()+1).toString(),role:"assistant",content:""};const x=I.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(x==="mes projets"||x.includes("liste des projet")||x==="projet"||x==="projets")h.content="Voici la liste de vos projets récents :",h.widget="projects";else if((x.includes("stitch")||x.includes("deepseek")||x.includes("design")||x.includes("logique"))&&(x.includes("modifi")||x.includes("ajoute")||x.includes("change")||x.includes("mise a jour")||x.includes("evolue")||x.includes("reprends")||x.includes("continue"))){const P=c.match(/\[(.*?)\]/),k=P?P[1]:null,ne=x.includes("deepseek")?"deepseek":"stitch";h.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${ne.toUpperCase()}) 🔄

J'injecte vos nouvelles directives directement dans votre interface... ${k?`
🔍 Recherche et AutoSwitch vers le projet : "${k}"`:"Reprise du travail en cours."}`,h.widget=null,A("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:ne,target_project:k,prompt:"Mise à jour (Reprise de projet) : "+c.replace(/\[.*?\]/,"").trim(),auto_submit:!0})}).catch(Z=>console.log("Erreur de connexion au Bridge local pour l'injection",Z))}else if(x.includes("cree")||x.includes("lance")||x.includes("projet")||x.includes("generation")){h.content=`🚀 DÉMARRAGE PARALLÈLE KIROV5 🚀
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,h.widget="phases",W(1);const P=R||(oe.trim()?oe.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+c.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(Ae(P),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",P),typeof window<"u"){const Z=localStorage.getItem("tiger_targetAi")||"deepseek",Y=localStorage.getItem("tiger_targetUiAi")||"stitch",Me=(U,ce=!1)=>ct(U,ce),Ve=window.AndroidBridge;if(Ve&&Ve.openAIWithPrompt)Ve.openAIWithPrompt(Me(Y,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+c),Ve.showToast&&Ve.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const U=T&&T.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${T.length})]
`+T.map(ye=>{const ie=Ft.find(Se=>Se.id===ye);return`• ${ie?ie.name:ye} (#${ye})`}).join(`
`):"",ce="Génère l'interface UI/UX complète et moderne pour ce projet : "+c+U;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ce)}catch{}const tt=()=>A("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Y,prompt:ce,auto_submit:!0,project_id:P,phase_num:1,packs:T})});We!==200&&(rt?window.open(Me(Y,!0),"kirov5_ai_target"):window.open(Me(Y,!0),"_blank"),tt().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(ye=>console.error("Erreur sendUiPrompt",ye))),setTimeout(()=>{const ye=T&&T.length>0?c+U:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+c+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ye)}catch{}window.open(Me(Z),"_blank"),A("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,prompt:ye,auto_submit:!0,project_id:P,phase_num:1,packs:T})}).catch(ie=>console.log("Erreur Bridge Logic Prompt:",ie)),T&&T.length>0?A("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,user_prompt:ye,packs:T,target_project:P})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(ie=>{console.log("Erreur Trombone Bridge:",ie)}):A("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,prompt:ye,auto_submit:!0,project_id:P,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}W(1);let k=1;const ne=setInterval(()=>{k++,k>11?clearInterval(ne):W(k)},1500)}else if(x.includes("youtube")||x.includes("video"))h.content="Voici les résultats YouTube pour votre recherche :",h.widget="youtube";else if(x.includes("actualite")||x.includes("ia")||x.includes("news")||x.includes("recherche")){const P=localStorage.getItem("tiger_apiKey");h.content="Actualités & Dernières Innovations IA :",h.widget="news",Kt(P||void 0)}else if(x.includes("parametre")||x.includes("reglage")||x.includes("configuration")||x.includes("setting"))h.content="Ouverture du panneau de configuration système :",h.widget="settings";else if(x.includes("[plugin:vite:")||x.includes("missing semicolon")||x.includes("syntaxerror")||x.includes("typescriptparsermixin")||x.includes("babel/parser")||x.includes("error")&&x.length>80){const P=R||"Projet_blog_8831";h.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${P}" avec la stack trace fournie... 🩺`,ke("suture",c)}else if(h.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const P=window.AndroidBridge;P&&P.openAIWithPrompt?P.openAIWithPrompt("https://chat.deepseek.com/",c):window.open("https://chat.deepseek.com/","_blank")}S(P=>[...P,h])},600),f("")},me=async s=>{var Ve;let c=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],l=null;const I=c.filter(U=>U.name.endsWith(".zip"));let h=[];if(I.length>0){S(U=>[...U,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const U=(await Yt(async()=>{const{default:ce}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:ce}},[])).default;for(const ce of I){l=ce;const ye=await new U().loadAsync(ce);for(const[ie,Se]of Object.entries(ye.files))if(!Se.dir&&!ie.includes("__MACOSX")&&!((Ve=ie.split("/").pop())!=null&&Ve.startsWith("."))){const qe=await Se.async("blob"),lt=new File([qe],ie.split("/").pop()||ie,{type:qe.type});h.push(lt)}}}catch(U){console.error("Erreur décompression ZIP:",U),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}for(const U of I)try{const ce=await U.arrayBuffer(),tt=arrayBufferToBase64(ce);fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:R||F||oe||"AUDIO",fileName:U.name,fileBase64:tt})}).catch(ie=>console.warn("[Upload ZIP Sync] Notice:",ie))}catch{}}c=[...c.filter(U=>!U.name.endsWith(".zip")),...h];const x=c.filter(U=>U.name.endsWith(".html")),P=c.filter(U=>!U.name.endsWith(".html")&&(U.name.endsWith(".png")||U.name.endsWith(".jpg")||U.name.endsWith(".jpeg")||U.name.endsWith(".md")||U.name.endsWith(".json")||U.name.endsWith(".txt")||U.name.endsWith(".tsx")||U.name.endsWith(".ts")||U.name.endsWith(".jsx")||U.name.endsWith(".js")||U.name.endsWith(".css")||U.name.endsWith(".svg")));if(x.length===0&&P.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .tsx, .ts, .png, ou un .zip.");return}let k=[...Ze];for(const U of P){const ce=U.name.endsWith(".png")||U.name.endsWith(".jpg")||U.name.endsWith(".jpeg"),tt=await new Promise(ie=>{const Se=new FileReader;Se.onload=qe=>{var lt;return ie((lt=qe.target)==null?void 0:lt.result)},ce?Se.readAsDataURL(U):Se.readAsText(U)}),ye={path:U.name,content:ce?`[Image jointe visuellement : ${U.name} (Binaire ignoré pour économie de tokens)]`:tt};k.some(ie=>ie.path===U.name)||k.push(ye),S(ie=>[...ie,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${U.name}`}])}if(x.length>0){const U=x[0],ce=await new Promise(ie=>{const Se=new FileReader;Se.onload=qe=>{var lt;return ie((lt=qe.target)==null?void 0:lt.result)},Se.readAsText(U)}),tt={path:U.name,content:ce};k.some(ie=>ie.path===U.name)||k.push(tt);const ye={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${U.name}
Analyse de la structure UI et assemblage du contexte en cours...`};S(ie=>[...ie,ye])}const ne=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter(U=>U.name.endsWith(".zip"));for(const U of ne)k.some(ce=>ce.path===U.name)||k.push({path:U.name,content:"ZIP_ARCHIVE_DUMMY"});Ut(k);const Z=R||oe||"Projet_Stitch",Y=c.map(U=>U.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${Z}: ${Y}`);const Me=x.length;if(Me>3){const U=localStorage.getItem("tiger_targetAi")||"deepseek",ce=l?"Projet_ZIP_"+l.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),tt=R||ce;R||Ae(tt),S(ie=>[...ie,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !

Hermes a détecté ${Me} pages HTML dans votre ZIP.
Découpage automatique en lots de 3 fichiers en cours...
Démarrage de l'automatisation séquentielle via DeepSeek !`,widget:"phases"}]),W(1);let ye="";if(l)ye=await new Promise(ie=>{const Se=new FileReader;Se.onload=qe=>{var lt;return ie(((lt=qe.target)==null?void 0:lt.result).split(",")[1])},Se.readAsDataURL(l)});else{const ie=(await Yt(async()=>{const{default:qe}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:qe}},[])).default,Se=new ie;for(const qe of c)Se.file(qe.name,qe);ye=await Se.generateAsync({type:"base64"})}A("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({zip_base64:ye,zip_mode:!0,target_ai:U,target_project:tt,user_prompt:oe.trim()?`${oe} - ${ht}`:`Application multi-pages issue de ${(l==null?void 0:l.name)||"fichiers_locaux"}`})}).then(async ie=>{const Se=await ie.json();Se.success?(S(qe=>[...qe,{id:Date.now().toString()+"_hermes",role:"assistant",content:`✅ ${Se.message}

📡 Lot 1/${Se.total_batches} transmis à DeepSeek. Les lots suivants s'enchaîneront automatiquement !
Fichiers détectés : ${(Se.files_detected||[]).join(", ")}`}]),window.open(ct(U),"_blank")):alert("Erreur Hermes : "+(Se.error||"Inconnue"))}).catch(ie=>{alert(`Erreur de connexion au Moteur Local : ${ie.message}`)});return}if(x.length>0){if(document.getElementById("creation-mode-container"))return;setTimeout(()=>{je(k)},1200)}},je=async(s=Ze)=>{Ne(!1);const c=s.find(Z=>Z.path.endsWith(".html"));if(!c){alert("Aucun fichier HTML trouvé dans le Trombone !");return}const l=oe.trim()?"Projet_"+oe.replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4):"Design_"+c.path.replace(".html","").replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4),I=R||l;if(!R){Ae(I);try{await A("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:I,file:"README.md",content:`# ${oe||I}

Initialisé par Tiger IA V0 (Design-First).`})})}catch(Z){console.error("[IDE] Erreur création auto du dossier",Z)}}const h=s.filter(Z=>Z.path!==c.path),x=c.content,P={id:(Date.now()+1).toString(),role:"assistant",content:`Mode "Design-First" activé. 🎨

Transmission du design au LLM avec les ${h.length} fichiers du Trombone intégrés.
Câblage en cours...`,widget:"phases"};W(5),S(Z=>[...Z,P]);let k=5;const ne=setInterval(()=>{k++,k>11?clearInterval(ne):W(k)},3e3);if(typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Mode Design-First Activé !"),typeof window<"u"){const Z=localStorage.getItem("tiger_targetAi")||"deepseek";let Y="";h.length>0&&(Y=`
...
\`\`\`
`}));let Me="";(oe.trim()||ze.trim()||ht.trim())&&(Me=`
--- MÉTADONNÉES DU PROJET ---
Nom : ${oe||"Non spécifié"}
Stack / Structure : ${ze||"Non spécifiée"}
Description & Objectifs : ${ht||"Non spécifiés"}
-----------------------------
`);const Ve=`Voici le code HTML/CSS d'une interface générée par Stitch.${Me}
...
\`\`\`
`,U=window.AndroidBridge;if(U&&U.openAIWithPrompt){const ce=ct(Z);U.openAIWithPrompt(ce,Ve),U.showToast&&U.showToast("HTML injecté. Câblage sur "+Z.toUpperCase()+" !")}else A("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,prompt:Ve,auto_submit:!0,project_id:I,phase_num:5})}).then(ce=>console.log("[Bridge] Prompt HTML + Contexte envoyé avec succès, status:",ce.status)).catch(ce=>console.error("[Bridge] Erreur lors de l'envoi du prompt:",ce))}},ot=(s,c=0)=>s?s.type==="directory"?e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-2 px-2 py-1 hover:bg-white/5 cursor-pointer text-gray-300 text-sm",style:{paddingLeft:`${c*12+8}px`},children:[e.jsx("span",{className:"text-orange-400",children:"📁"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-dossier truncate font-bold",children:s.name})]}),s.children&&s.children.map(l=>ot(l,c+1))]},s.path):e.jsxs("div",{className:`flex items-center justify-between px-2 py-1 hover:bg-white/10 cursor-pointer text-sm group ${pe===s.path?"bg-cyan/20 text-cyan border-l-2 border-cyan":"text-gray-400"}`,style:{paddingLeft:`${c*12+8}px`},onClick:()=>it(s.path),children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-blue-400",children:"📄"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-fichier truncate",children:s.name})]}),e.jsxs("div",{className:"hidden group-hover:flex items-center gap-1",children:[e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-red-500/50 transition-colors",title:"Suture : Réparer ou débugger ce fichier",onClick:l=>{l.stopPropagation(),it(s.path),setTimeout(()=>ke("suture","Veuillez analyser ce fichier et corriger toutes les erreurs, fautes de frappe ou imports manquants."),100)},children:"🩺"}),e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-cyan/50 transition-colors",title:"Ajouter au Trombone",onClick:l=>{l.stopPropagation(),v(s.path)},children:"📎"})]})]},s.path):null,ke=async(s,c)=>{if(!R){alert("⚠️ Veuillez sélectionner un projet actif dans l'explorateur.");return}const l=localStorage.getItem("tiger_targetAi")||"deepseek";let I="";s==="suture"?I=`🩺 SUTURE CHIRURGICALE — CORRECTION D'ERREUR DÉTECTÉE
...
`),pe&&kt&&(I+=`--- Fichier Actif en Édition : ${pe} ---
\`\`\`
${kt}
\`\`\`

`),Ze.length>0&&(I+=`--- Fichiers de contexte du Trombone ---

`,Ze.forEach(h=>{I+=`--- ${h.path} ---
\`\`\`
${h.content}
\`\`\`
...
\`\`\``,S(h=>[...h,{id:Date.now().toString()+"_action",role:"assistant",content:`🩺 Suture & Correction déclenchée pour "${R}". Transmission de l'erreur à ${l.toUpperCase()} en cours...`}]);try{if(await A("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:l,prompt:I,auto_submit:!0,project_id:R,phase_num:s})}),s==="suture"){A("http://localhost:5006/v1/suture/start",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:R,activeFile:pe||"",rawError:c||"",prompt:c||"Analyse et corrige les erreurs du projet."})}).then(async x=>{const P=await x.json();P.success&&P.status==="applied"?S(k=>{var ne,Z;return[...k,{id:Date.now().toString()+"_suture_ok",role:"assistant",content:`✅ Suture V2 réussie !

🔧 ${P.repairId}
🚀 Statut : **Patch appliqué en production**
📁 Fichiers corrigés : ${JSON.stringify(((Z=(ne=P.patchReport)==null?void 0:ne.files)==null?void 0:Z.map(Y=>Y.path))||[])}`}]}):P.success?S(k=>{var ne;return[...k,{id:Date.now().toString()+"_suture_partial",role:"assistant",content:`⚠️ Suture V2 : correctif généré mais non promu.
Statut : ${((ne=P.validationReport)==null?void 0:ne.code)||P.status}

Le correctif est dans l'espace isolé. Vérifiez les logs du moteur pour plus de détails.`}]}):S(k=>[...k,{id:Date.now().toString()+"_suture_fail",role:"assistant",content:`❌ Suture V2 échouée.
Code : ${P.code||"INCONNU"}
${P.message||""}`}])}).catch(()=>{S(x=>[...x,{id:Date.now().toString()+"_suture_err",role:"assistant",content:"❌ Impossible de joindre le moteur Suture V2. Vérifiez que l'Orchestrateur Electron tourne sur le port 5006."}])});return}window.open(ct(l),"kirov5_ai_target")||S(x=>[...x,{id:Date.now().toString()+"_popup_blocked",role:"assistant",content:`⚠️ Popup bloqué par le navigateur !

L'onglet ${l.toUpperCase()} n'a pas pu s'ouvrir.

**Solution** : Autorisez les popups pour ce site ou ouvrez manuellement : ${ct(l)}

Le prompt est en queue (90s) — dès que l'onglet ${l.toUpperCase()} sera ouvert avec l'extension active, il sera injecté automatiquement.`}])}catch(h){console.error("[IDE] Erreur Suture:",h),alert(`🩺 Action ${s} transmise. Assurez-vous que le Moteur Electron tourne sur port 5006.`)}},et=()=>bn?e.jsxs("div",{className:"w-full p-8 flex flex-col items-center justify-center gap-4 animate-fadeIn",children:[e.jsx("div",{className:"w-12 h-12 border-4 border-cyan/20 border-t-cyan rounded-full animate-spin"}),e.jsx("div",{className:"text-cyan font-bold animate-pulse text-sm",children:"Interrogation de l'API DeepSeek en cours..."})]}):xt?e.jsxs("div",{className:"w-full max-w-3xl backdrop-blur-xl rounded-3xl p-6 md:p-8 border border-white/20 shadow-[0_10px_40px_rgba(0,0,0,0.5)] mt-4 relative animate-fadeIn",style:{background:L?a("news-detail",.9):"rgba(0,0,0,0.9)"},children:[e.jsx("button",{onClick:()=>It(null),className:"absolute top-6 right-6 w-8 h-8 bg-white/10 hover:bg-red-500 rounded-full flex flex-col items-center justify-center text-white font-bold transition-colors z-20",title:"Fermer",children:"✕"}),e.jsx("span",{className:"px-3 py-1 bg-cyan/20 text-cyan text-xs font-bold rounded-md mb-4 inline-block",children:xt.tag}),e.jsx("h2",{className:"text-2xl md:text-4xl font-black text-white mb-4 leading-tight",children:xt.title}),e.jsx("p",{className:"text-gray-300 font-medium text-sm md:text-base mb-6 leading-relaxed border-l-4 border-cyan/50 pl-4",children:xt.desc}),e.jsx("div",{className:"w-full h-px bg-white/10 mb-6"}),e.jsx("div",{className:"text-gray-200 text-sm md:text-base leading-loose whitespace-pre-line",children:xt.content}),e.jsxs("div",{className:"mt-8 pt-6 border-t border-white/10 flex justify-between items-center",children:[e.jsx("span",{className:"text-xs text-cyan font-mono font-bold tracking-widest",children:"GÉNÉRÉ PAR DEEPSEEK API"}),e.jsx("button",{onClick:()=>It(null),className:"px-6 py-3 bg-white/5 hover:bg-white/20 text-white font-bold rounded-xl transition-all border border-white/10 hover:border-cyan",children:"← Retour à la liste"})]})]}):!$t||$t.length===0?null:e.jsx(Vt,{items:$t.map(s=>e.jsxs("div",{className:"design-carte-carrousel relative rounded-2xl p-5 border border-white/10 backdrop-blur-md flex flex-col hover:border-cyan/50 transition-colors shadow-lg",style:{background:L?a("news-"+s.id,.7):"rgba(0,0,0,0.7)"},children:[e.jsx("span",{className:"self-start px-2 py-1 bg-cyan/20 text-cyan text-xs font-bold rounded-md mb-3 pr-4",children:s.tag}),e.jsx("h3",{className:"design-carte-titre text-lg font-bold text-white mb-2 leading-tight mt-1",children:s.title}),e.jsx("p",{className:"design-carte-desc text-gray-400 text-sm flex-1",children:s.desc}),e.jsxs("button",{onClick:()=>It(s),className:"absolute top-4 right-4 text-cyan text-xs font-bold hover:underline cursor-pointer px-3 py-1.5 bg-cyan/10 hover:bg-cyan/20 rounded-xl border border-cyan/30 transition-all flex items-center gap-1",children:["Lire l'article ",e.jsx("span",{className:"text-[10px]",children:"↗"})]})]},s.id))}),yt=()=>{const s=[{title:"Créer une IA Souveraine",channel:"Tiger Channel",views:"1.2k"},{title:"React Tailwind Masterclass",channel:"UI Design",views:"5.4k"},{title:"Android Bridge Capacitor",channel:"Mobile Dev",views:"800"}];return e.jsx(Vt,{items:s.map((c,l)=>e.jsxs("div",{className:"design-carte-carrousel rounded-2xl overflow-hidden border border-red-500/30 hover:border-red-500 transition-colors shadow-lg flex flex-col",style:{background:L?a("yt-"+l,.6):"rgba(0,0,0,0.6)"},children:[e.jsxs("div",{className:"flex-1 bg-gray-800 relative flex items-center justify-center min-h-[50%]",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-tr from-red-900/40 to-transparent"}),e.jsx("div",{className:"w-12 h-12 bg-red-600 rounded-full flex items-center justify-center shadow-lg z-10 cursor-pointer hover:scale-110 transition-transform",children:e.jsx("div",{className:"w-0 h-0 border-t-[8px] border-t-transparent border-l-[14px] border-l-white border-b-[8px] border-b-transparent ml-1"})})]}),e.jsxs("div",{className:"p-4",children:[e.jsx("h3",{className:"text-white font-bold text-sm leading-tight mb-1",children:c.title}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-400 mt-2",children:[e.jsx("span",{children:c.channel}),e.jsxs("span",{children:[c.views," vues"]})]})]})]},l))})},Ge=()=>{const s=["Setup","Index","React","CSS","Utils","Vite","Tests","Package","Vérif","Bridge","Build"];return e.jsx("div",{className:"mt-2",children:e.jsx(Vt,{items:s.map((c,l)=>{const I=l+1,h=I<q,x=I===q;let P="bg-glass border-white/10 opacity-50";return h&&(P="bg-gradient-to-br from-green-900/60 to-emerald-900/60 border-green-500/50 text-green-100 shadow-[0_0_15px_rgba(34,197,94,0.2)]"),x&&(P="bg-gradient-to-br from-cyan/20 to-blue-900/40 border-cyan text-white shadow-[0_0_20px_rgba(8,179,201,0.5)] animate-pulse hover:scale-105 cursor-pointer"),e.jsxs("div",{onClick:()=>{if(c==="Build"||x||h){const k=localStorage.getItem("tiger_lastGeneratedProject");k&&Ae(k)}},className:`design-carte-carrousel rounded-2xl p-4 border flex flex-col justify-between transition-all duration-500 ${P}`,title:c==="Build"?"Cliquez pour ouvrir l'IDE sur le projet généré":"",children:[e.jsx("div",{className:"text-3xl font-black opacity-20",children:I.toString().padStart(2,"0")}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-bold text-lg mb-1",children:c}),e.jsx("div",{className:"text-xs opacity-70",children:h?"✓ Terminé":x?"En cours...":"En attente"})]}),x&&e.jsx("div",{className:"w-full h-1 bg-white/20 rounded-full mt-2 overflow-hidden",children:e.jsx("div",{className:"h-full bg-cyan w-1/2 animate-ping rounded-full"})}),c==="Build"&&e.jsxs("div",{className:"mt-2 text-[10px] text-cyan font-bold uppercase tracking-widest flex items-center gap-1 bg-black/40 px-2 py-1 rounded",children:[e.jsx("span",{children:"🚀"})," Ouvrir IDE"]})]},l)})})})},_t=Ke!=="random"?((Fe=Ie.find(s=>s.name===Ke))==null?void 0:Fe.colors["bg-app"])||"radial-gradient(ellipse at 50% 20%, #1e1b4b 0%, #090a0f 70%, #000000 100%)":void 0;return e.jsxs("div",{className:"design-app-root flex-1 w-full h-full flex flex-col overflow-hidden relative transition-all duration-700",style:{background:_t},children:[e.jsx("div",{className:"absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-pink/20 blur-[120px] rounded-full pointer-events-none"}),e.jsx("div",{className:"absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-cyan/10 blur-[150px] rounded-full pointer-events-none"}),B&&e.jsx("div",{className:"absolute inset-0 z-[100] flex items-center justify-center p-4 backdrop-blur-md",style:{background:L?a("modal",.6):"rgba(0,0,0,0.6)"},onClick:s=>{s.target===s.currentTarget&&C(!1)},children:e.jsx(Kn,{isModal:!0,onClose:()=>C(!1),initialTab:O,isClient:L,getCachedGradient:a,mouchardLogs:de,activePhase:q,availableProjects:ae,setAvailableProjects:ve,selectedLaunchProject:F,setSelectedLaunchProject:ee,isMobileNative:X,isAutoPilot:bt,setIsAutoPilot:Jt,reuseActiveTab:rt,setReuseActiveTab:jt,selectedStartPhase:We,setSelectedStartPhase:Lt,selectedPacks:T})}),!at&&e.jsx("div",{className:"w-full flex justify-center items-center pt-2 z-20 relative pointer-events-none",children:e.jsxs("div",{className:"flex items-center gap-2 overflow-x-auto hide-scrollbar text-[10px] font-bold bg-[#05080c]/80 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/10 shadow-lg pointer-events-auto",children:[e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-green-900/40 px-2.5 py-1 rounded-full border border-green-500/30",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-green-500 shadow-[0_0_8px_#22c55e]"}),e.jsx("span",{className:"text-green-400",children:"Online"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-orange-900/40 px-2.5 py-1 rounded-full border border-orange-500/30",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-orange-500 shadow-[0_0_8px_#f97316] animate-bounce"}),e.jsx("span",{className:"text-orange-400",children:"Ext: Tiger"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-purple-900/40 px-2.5 py-1 rounded-full border border-purple-500/30",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-purple-500 shadow-[0_0_8px_#a855f7]"}),e.jsx("span",{className:"text-purple-400",children:"LLM: DeepSeek"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-cyan/10 px-2.5 py-1 rounded-full border border-cyan/20",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-cyan shadow-[0_0_8px_#08b3c9] animate-pulse"}),e.jsx("span",{className:"text-cyan",children:"Electron"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-gray-500/10 px-2.5 py-1 rounded-full border border-gray-500/20 opacity-60",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-gray-500"}),e.jsx("span",{className:"text-gray-400",children:"Mobile (Capacitor)"})]}),p&&e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-amber-500/20 px-2.5 py-1 rounded-full border border-amber-500/40 shadow-[0_0_12px_rgba(245,158,11,0.35)] animate-pulse",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-amber-400 shadow-[0_0_8px_#f59e0b]"}),e.jsx("span",{className:"text-amber-300 font-bold",children:"👑 Super-Admin"})]}),e.jsxs("button",{onClick:m,className:"flex items-center gap-1.5 shrink-0 bg-red-950/60 hover:bg-red-600/70 px-3 py-1 rounded-full border border-red-500/40 text-red-300 hover:text-white transition-all cursor-pointer shadow-[0_0_10px_rgba(239,68,68,0.25)] hover:scale-105 active:scale-95 ml-1",title:"Se déconnecter de l'application",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-red-500 shadow-[0_0_6px_#ef4444]"}),e.jsx("span",{children:"Déconnexion"}),d&&e.jsxs("span",{className:"text-gray-300 font-normal text-[9px] max-w-[130px] truncate ml-0.5",children:["(",d,")"]})]})]})}),!at&&e.jsxs("header",{className:"design-header backdrop-blur-md z-10 flex justify-between items-center shadow-lg -mt-2 px-4",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"design-logo flex items-center justify-center",children:e.jsx("span",{children:"🐯"})}),e.jsx("div",{children:e.jsx("h1",{className:"design-titre whitespace-nowrap",children:"v0.reponse : OS Souverain v0.1.0 - idecode-2026"})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[d&&e.jsxs("div",{className:"flex items-center gap-2 bg-white/5 border border-white/10 px-3 py-1.5 rounded-xl text-xs backdrop-blur-sm shadow-inner",children:[e.jsxs("span",{className:"text-gray-300 font-medium",children:["👤 ",d]}),p&&e.jsx("span",{className:"bg-amber-500/20 text-amber-300 border border-amber-500/40 px-2 py-0.5 rounded-full font-bold text-[10px] tracking-wide animate-pulse",children:"👑 Super-Admin"})]}),e.jsxs("button",{onClick:m,className:"flex items-center gap-1.5 bg-red-500/20 hover:bg-red-500/40 text-red-300 border border-red-500/40 px-3 py-1.5 rounded-xl text-xs font-semibold transition-all hover:scale-105 active:scale-95 shadow-sm cursor-pointer",title:"Se déconnecter de l'application",children:[e.jsx("span",{children:"🚪"}),e.jsx("span",{children:"Déconnexion"})]})]})]}),e.jsxs("div",{className:"flex-1 flex flex-col lg:flex-row overflow-hidden relative z-10 w-full",children:[R&&e.jsxs("div",{className:"flex flex-col lg:flex-row flex-1 overflow-hidden h-full animate-fadeIn",children:[e.jsxs("div",{className:"design-ide-toolbar w-full h-16 lg:w-16 lg:h-full bg-black/80 border-b lg:border-b-0 lg:border-r border-white/10 flex flex-row lg:flex-col items-center justify-around lg:justify-start lg:py-4 px-2 lg:px-0 gap-2 lg:gap-6 z-20 shadow-xl overflow-x-auto lg:overflow-x-visible",children:[e.jsx("button",{title:"Fermer le projet",onClick:()=>{Ae(null),it(null)},className:"design-ide-btn-action w-10 h-10 rounded-full bg-red-500/20 text-red-500 hover:bg-red-500 hover:text-white flex items-center justify-center transition-all mb-4",children:"✕"}),e.jsxs("button",{title:G==="error"?"🔴 Erreur détectée dans le code ! Suture V2 en cours...":G==="working"?"🟣 Suture V2 en plein travail (génération & test du correctif)...":"🟢 Projet propre - Aucune erreur détectée",onClick:()=>ke("suture"),className:`design-ide-btn-action w-10 h-10 rounded-xl text-xl border flex items-center justify-center transition-all group relative ${G==="error"?"bg-red-600 text-white border-2 border-red-400 shadow-[0_0_25px_#ff0055] animate-pulse ring-2 ring-red-500":G==="working"?"bg-purple-600 text-white border-2 border-purple-300 shadow-[0_0_25px_#a855f7] animate-pulse ring-2 ring-purple-500":"bg-emerald-600/30 text-emerald-400 border border-emerald-500/50 shadow-[0_0_12px_rgba(16,185,129,0.4)] hover:bg-emerald-500 hover:border-emerald-400 hover:text-white"}`,children:["🩺",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-white pointer-events-none transition-opacity font-bold",children:G==="error"?"🔴 Suture (Erreur !)":G==="working"?"🟣 Suture V2...":"🟢 Suture V2 (OK)"})]}),e.jsxs("button",{title:"Immortaliser le projet (Sauvegarde)",onClick:()=>{R&&A("http://localhost:5006/api/bridge/backup",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:R})}).then(s=>s?s.json():null).then(s=>{if(!s)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");s.success?alert("📸 "+s.message+`
`+s.backupName):alert("Erreur: "+s.error)}).catch(s=>alert("Erreur réseau: "+s.message))},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-blue-500/20 text-blue-400 hover:bg-blue-500 hover:text-white text-xl border border-blue-500/30 hover:border-blue-500 flex items-center justify-center transition-all shadow-[0_0_15px_rgba(59,130,246,0.3)] hover:shadow-[0_0_25px_rgba(59,130,246,0.6)] group relative mt-2",children:["📸",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-blue-400 pointer-events-none transition-opacity font-bold",children:"Immortaliser (Sauvegarder)"})]}),e.jsxs("button",{title:"Restaurer le projet (Time Machine)",onClick:()=>{R&&A("http://localhost:5006/api/bridge/backups?project_id="+R).then(s=>s?s.json():null).then(s=>{if(!s)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");if(!s.success||!s.backups||s.backups.length===0)return alert("⏪ Aucune sauvegarde trouvée pour ce projet.");D(s.backups),Ee(!0)}).catch(s=>alert("Erreur réseau: "+s.message))},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-slate-500/20 text-slate-400 hover:bg-slate-500 hover:text-white text-xl border border-slate-500/30 hover:border-slate-500 flex items-center justify-center transition-all group relative mb-2",children:["⏪",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-slate-400 pointer-events-none transition-opacity font-bold",children:"Restaurer (Dernier Backup)"})]}),e.jsxs("button",{title:"Refactoring",onClick:()=>ke("refactor"),className:"design-ide-btn-action w-10 h-10 rounded-xl bg-white/5 hover:bg-purple-500/20 text-xl border border-white/10 hover:border-purple-500 flex items-center justify-center transition-all group relative",children:["🔄",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-purple-400 pointer-events-none transition-opacity",children:"Refactoring"})]}),e.jsxs("button",{title:"Amélioration",onClick:()=>ke("improve"),className:"design-ide-btn-action w-10 h-10 rounded-xl bg-white/5 hover:bg-yellow-500/20 text-xl border border-white/10 hover:border-yellow-500 flex items-center justify-center transition-all group relative",children:["✨",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-yellow-400 pointer-events-none transition-opacity",children:"Amélioration"})]}),e.jsxs("button",{title:"Corriger Arborescence (Fix Extensions)",onClick:()=>{R&&A("http://localhost:5006/api/fix-extensions",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:R})}).then(s=>s?s.json():null).then(s=>{if(!s)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");s.success?alert(s.message):alert("Erreur: "+s.error)}).catch(s=>alert("Erreur réseau: "+s.message))},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-white/5 hover:bg-orange-500/20 text-xl border border-white/10 hover:border-orange-500 flex items-center justify-center transition-all group relative",children:["🛠️",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-orange-400 pointer-events-none transition-opacity font-bold",children:"Fix Arborescence (.txt ➡️ .tsx)"})]}),e.jsxs("button",{title:"Générateur PRD V0-Guest",onClick:()=>{Ae("v0-guest"),Ue("http://localhost:3007"),A("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:"v0-guest"})}).catch(s=>console.error("Erreur lancement v0-guest:",s)),setTimeout(()=>{window.open("http://localhost:3007","_blank")},2500)},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-gradient-to-br from-cyan/20 to-purple-500/20 text-cyan hover:from-cyan hover:to-purple-500 hover:text-black text-xl border border-cyan/40 flex items-center justify-center transition-all group relative shadow-[0_0_12px_rgba(0,240,255,0.3)]",children:["🎁",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-cyan font-bold pointer-events-none transition-opacity",children:"V0-Guest PRD Generator"})]}),e.jsxs("button",{title:"Design v0 (Studio Visuel & Preview Split)",onClick:()=>{const s=!Oe;if(ln(s),s&&!Je){const c=Pe&&JSON.stringify(Pe).includes("next.config");Ue(c?"http://localhost:3000":"http://localhost:5175")}},className:`design-ide-btn-action w-10 h-10 rounded-xl flex items-center justify-center transition-all group relative border ${Oe?"bg-pink-500 text-white border-pink-500 shadow-[0_0_15px_rgba(236,72,153,0.5)]":"bg-white/5 hover:bg-pink-500/20 text-pink-500 border-white/10 hover:border-pink-500"}`,children:["🎨",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-pink-500 pointer-events-none transition-opacity font-bold",children:"Design v0 (Split View)"})]}),e.jsx("div",{className:"flex-1"}),e.jsxs("button",{title:at?"Réduire (Afficher le Chat)":"Pleine Page (Masquer le Chat)",onClick:()=>Ye(!at),className:`design-ide-btn-action w-10 h-10 rounded-xl flex items-center justify-center transition-all group relative border ${at?"bg-cyan text-black border-cyan":"bg-white/5 hover:bg-cyan/20 text-cyan border-white/10 hover:border-cyan"}`,children:[at?"🗗":"🗖",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-cyan pointer-events-none transition-opacity",children:at?"Mode Normal":"Pleine Page"})]})]}),e.jsxs("div",{className:"design-explorateur w-64 bg-[#0a0a0a]/95 border-r border-white/10 overflow-y-auto flex flex-col hide-scrollbar z-20 shadow-2xl",children:[e.jsxs("div",{className:"px-4 py-3 border-b border-white/10 sticky top-0 bg-[#0a0a0a] z-10 flex flex-col gap-2",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsxs("span",{className:"text-[10px] text-cyan font-black uppercase tracking-widest flex items-center gap-2",children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-cyan animate-pulse"}),"Projet Actif"]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{onClick:()=>{R&&(console.log("Clic Suture Manuel ! Projet:",R,"Etat actuel:",G),G!=="error"&&A("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:R})}).catch(()=>{}),A("http://localhost:5006/api/suture/launch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:R})}).then(s=>s?s.json():null).then(s=>s&&console.log("Réponse Suture API:",s)).catch(s=>console.error("Erreur Suture API:",s)))},className:`text-[9px] font-bold px-2 py-0.5 rounded transition-colors border shadow-sm flex items-center gap-1 ${G==="error"?"bg-red-500/20 text-red-400 border-red-500/50 animate-pulse hover:bg-red-500/30":G==="working"?"bg-purple-500/20 text-purple-400 border-purple-500/50 hover:bg-purple-500/30":"bg-green-500/20 text-green-400 border-green-500/50 opacity-50 hover:opacity-100"}`,title:"Lancer Suture V2 manuellement",children:"sutur🩺"}),e.jsx("button",{onClick:()=>{A("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{s&&s.success&&s.projects?te(s.projects.map(c=>({name:typeof c=="string"?c:c.name||c.project_id||c.title||"Projet",desc:"Projet local",bg:""}))):fetch("/api/projects").then(c=>c.json()).then(c=>{c.projects&&te(c.projects.map(l=>({name:typeof l=="string"?l:l.name||l.project_id||l.title||"Projet",desc:"SaaS Cloud",bg:""})))})}).catch(()=>{})},className:"text-xs text-gray-400 hover:text-cyan p-1 transition-colors",title:"Actualiser la liste des projets",children:"🔄"})]})]}),e.jsxs("select",{value:R||"",onFocus:()=>{A("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{s&&s.success&&s.projects?te(s.projects.map(c=>({name:typeof c=="string"?c:c.name||c.project_id||c.title||"Projet",desc:"Projet local",bg:""}))):fetch("/api/projects").then(c=>c.json()).then(c=>{c.projects&&te(c.projects.map(l=>({name:typeof l=="string"?l:l.name||l.project_id||l.title||"Projet",desc:"SaaS Cloud",bg:""})))})}).catch(()=>{})},onChange:s=>{const c=s.target.value;c&&(Ae(c),it(null),vt(""),A("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:c,open_explorer:!1})}).catch(l=>console.error("Erreur de lancement :",l)))},className:"w-full bg-[#161616] text-cyan font-bold text-xs border border-cyan/40 rounded-xl px-2.5 py-2 outline-none focus:border-cyan focus:ring-1 focus:ring-cyan shadow-[0_0_10px_rgba(8,179,201,0.2)] cursor-pointer truncate",children:[e.jsx("option",{value:"",disabled:!0,className:"bg-black text-gray-400",children:"-- Choisir un projet --"}),_e.length>0?_e.map((s,c)=>{var I,h;const l=typeof(s==null?void 0:s.name)=="string"?s.name:((I=s==null?void 0:s.name)==null?void 0:I.project_id)||((h=s==null?void 0:s.name)==null?void 0:h.title)||`Projet_${c}`;return e.jsxs("option",{value:l,className:"bg-black text-white font-medium py-1",children:["📁 ",l]},l+"_"+c)}):e.jsxs("option",{value:typeof R=="string"?R:(R==null?void 0:R.project_id)||(R==null?void 0:R.title)||"AUDIO",className:"bg-black text-white py-1",children:["📁 ",typeof R=="string"?R:(R==null?void 0:R.project_id)||(R==null?void 0:R.title)||"AUDIO"]})]})]}),e.jsx("div",{className:"py-2",children:Pe?ot(Pe):e.jsx("div",{className:"text-gray-500 text-xs px-4 py-2 animate-pulse",children:"Scan du projet..."})})]}),e.jsxs("div",{className:"design-editeur flex-1 flex flex-col bg-[#1e1e1e] z-20 shadow-2xl relative",children:[e.jsxs("div",{className:"design-editeur-onglet h-12 bg-[#252526] border-b border-black flex justify-between items-center px-4",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-blue-400 text-lg",children:pe?"📄":"📁"}),e.jsx("span",{className:"text-sm text-gray-300 font-mono",children:pe||"Aucun fichier sélectionné"})]}),e.jsxs("div",{className:"flex gap-4 items-center",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("div",{className:"text-xs text-green-400 animate-pulse font-bold flex items-center gap-2",children:[e.jsx("span",{className:"w-2 h-2 bg-green-400 rounded-full"})," SERVER:"]}),e.jsx("input",{type:"text",value:Et,onChange:s=>St(s.target.value),onKeyDown:s=>{s.key==="Enter"&&Ue(Et)},className:"bg-black/50 border border-green-500/30 text-green-400 text-[10px] px-2 py-1 rounded outline-none focus:border-green-400 w-40 font-mono shadow-[0_0_10px_rgba(34,197,94,0.1)] transition-all",title:"Modifier et taper Entrée"}),e.jsx("button",{onClick:()=>Ue(Et),className:"text-[10px] bg-green-500/20 text-green-400 hover:bg-green-500 hover:text-white px-2 py-1 rounded font-bold border border-green-500/30",children:"Go"})]}),e.jsx("button",{onClick:()=>g(kt),disabled:!pe,className:`px-4 py-1.5 rounded text-xs font-bold transition-all ${pe?"bg-cyan/20 text-cyan hover:bg-cyan hover:text-black border border-cyan/30 shadow-[0_0_10px_rgba(8,179,201,0.2)]":"bg-white/5 text-gray-600 cursor-not-allowed"}`,children:"SAUVEGARDER (CTRL+S)"})]})]}),e.jsx("div",{className:"flex-1 relative flex overflow-hidden",children:Oe?e.jsxs("div",{className:"flex-1 flex w-full h-full bg-[#0a0a0a] overflow-hidden",children:[e.jsxs("div",{className:"w-1/2 h-full border-r border-white/10 flex flex-col bg-[#141414]",children:[e.jsxs("div",{className:"h-12 px-4 bg-black/90 border-b border-white/10 flex justify-between items-center shrink-0 z-10",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-xl",children:"🎨"}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-xs font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-cyan tracking-widest uppercase",children:"STUDIO DESIGN INTELLIGENT"}),e.jsxs("p",{className:"text-[10px] text-gray-400 truncate max-w-[180px]",children:["Projet : ",e.jsx("span",{className:"text-cyan font-bold",children:R||"Projet Actif"})]})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{onClick:()=>ln(!1),className:"px-2.5 py-1 bg-white/10 hover:bg-white/20 text-white rounded-lg border border-white/10 text-[11px] font-bold flex items-center gap-1 transition-all shadow",title:"Revenir à l'explorateur de fichiers & à l'éditeur de code",children:"📁 Fermer (Code)"}),e.jsx("button",{onClick:()=>{ln(!1),Ae(null),Ye(!1)},className:"px-2.5 py-1 bg-red-500/20 hover:bg-red-500 text-red-300 hover:text-white rounded-lg border border-red-500/30 text-[11px] font-bold flex items-center gap-1 transition-all shadow",title:"Quitter le projet et revenir à la page d'accueil",children:"🏠 Fermer (Accueil)"})]})]}),e.jsx("div",{className:"flex-1 overflow-hidden relative",children:e.jsx("iframe",{src:`/admin-design.html?project=${R}`,className:"w-full h-full border-0 bg-black",title:"Studio Admin Design"})})]}),e.jsxs("div",{className:"design-preview w-1/2 h-full flex flex-col",children:[e.jsxs("div",{className:"h-12 px-4 bg-black/90 border-b border-white/10 flex justify-between items-center shrink-0 z-10",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"w-2.5 h-2.5 rounded-full bg-green-400 animate-pulse"}),e.jsxs("span",{className:"text-xs font-mono font-bold text-green-400",children:["LIVE PREVIEW (",Pe&&JSON.stringify(Pe).includes("next.config")?"LOCALHOST:3000":typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"?`${window.location.hostname}:5173`:"LOCALHOST:5173",")"]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("input",{type:"text",value:Je||(Pe&&JSON.stringify(Pe).includes("next.config")?"http://localhost:3000":typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"?`http://${window.location.hostname}:5173`:"http://localhost:5173"),onChange:s=>St(s.target.value),onKeyDown:s=>{s.key==="Enter"&&Ue(Et)},className:"bg-black/80 border border-green-500/30 text-green-400 text-[11px] px-2.5 py-1 rounded outline-none focus:border-green-400 w-48 font-mono"}),e.jsx("button",{onClick:()=>{R&&A("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:R,open_explorer:!1})}).catch(s=>console.error("Erreur lancement preview:",s))},className:"px-2.5 py-1 bg-green-500/20 text-green-400 hover:bg-green-500 hover:text-white text-[11px] rounded font-bold border border-green-500/30 transition-all flex items-center gap-1",title:"Relancer / Démarrer le serveur Preview",children:"🚀 Relancer"})]})]}),e.jsx("div",{className:"flex-1 relative overflow-hidden",style:{background:"var(--preview-bg)"},children:e.jsx("iframe",{src:Je||(Pe&&JSON.stringify(Pe).includes("next.config")?"http://localhost:3000":typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"?`http://${window.location.hostname}:5173`:"http://localhost:5173"),className:"w-full h-full border-none",title:"Application Preview Live"})})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`relative flex flex-col ${Je?"w-1/2 border-r border-black":"w-full"}`,children:pe?e.jsx(Ia,{height:"100%",theme:"vs-dark",path:pe,language:pe.endsWith(".tsx")||pe.endsWith(".ts")?"typescript":pe.endsWith(".css")?"css":pe.endsWith(".html")?"html":pe.endsWith(".json")?"json":"javascript",value:kt,onChange:s=>{const c=s||"";vt(c),window.saveTimer&&clearTimeout(window.saveTimer),window.saveTimer=setTimeout(()=>{g(c)},500)},options:{minimap:{enabled:!1},fontSize:14,wordWrap:"on",padding:{top:16}}}):e.jsxs("div",{className:"absolute inset-0 flex flex-col items-center justify-center text-gray-600 gap-4",children:[e.jsx("span",{className:"text-6xl opacity-20",children:"🐯"}),e.jsx("span",{className:"font-medium tracking-wide text-sm",children:"Sélectionnez un fichier dans l'explorateur ou activez Design v0"})]})}),Je&&e.jsxs("div",{className:"design-preview w-1/2 relative",style:{background:"var(--preview-bg)"},children:[e.jsx("iframe",{src:Je,className:"w-full h-full border-none"}),e.jsx("button",{onClick:()=>Ue(null),className:"absolute top-2 right-4 bg-black/80 border border-white/20 text-white rounded-full w-8 h-8 flex items-center justify-center hover:bg-red-500 hover:text-white transition-all shadow-lg z-50",title:"Fermer la Preview",children:"✕"}),e.jsx("button",{onClick:()=>window.open(Je,"_blank"),className:"absolute top-2 right-14 bg-black/80 border border-white/20 text-white rounded-full px-3 h-8 flex items-center justify-center hover:bg-cyan hover:text-black transition-all shadow-lg z-50 text-xs font-bold",title:"Ouvrir dans un nouvel onglet",children:"↗ Ouvrir"})]})]})})]})]}),e.jsxs("main",{className:`design-chat-main ${R?at?"hidden w-0":"w-full h-[50vh] lg:h-full lg:w-96 lg:min-w-[24rem]":"flex-1"} border-t lg:border-t-0 lg:border-l border-white/20 bg-black/60 shadow-[-20px_0_40px_rgba(0,0,0,0.5)] overflow-y-auto p-4 md:p-8 z-10 hide-scrollbar flex flex-col transition-all duration-500 ease-in-out`,onDragOver:s=>{s.preventDefault(),w(!0)},onDragLeave:()=>w(!1),onDrop:s=>{s.preventDefault(),w(!1),s.dataTransfer.files&&s.dataTransfer.files.length>0&&me(s.dataTransfer.files)},children:[_&&e.jsx("div",{className:"absolute inset-0 z-50 bg-cyan/20 backdrop-blur-sm border-4 border-dashed border-cyan rounded-3xl m-4 flex items-center justify-center pointer-events-none",children:e.jsxs("h2",{className:"text-3xl font-black text-cyan drop-shadow-lg text-center px-4",children:["Glissez votre projet Stitch (.zip, .html, .md, .png)",e.jsx("br",{}),"pour préparer le câblage !"]})}),e.jsxs("div",{className:"design-chat-layout w-full flex-1 flex flex-col justify-center my-auto pb-[140px] relative",children:[(()=>{const s=u.map(h=>!!h.widget).lastIndexOf(!0),c=s!==-1?u[s]:null,l=c?c.widget:null,I=re||l==="packs"||l==="projects"||l==="news"||l==="youtube"||mt||dt;return e.jsxs("div",{className:"w-full flex flex-col xl:flex-row items-stretch justify-between gap-6 relative min-h-[50vh] my-auto",children:[e.jsx(Lo,{messages:u,showGuestPacks:ge,setShowGuestPacks:Ce,guestPacksCount:4,guestPackSearchQuery:he,setGuestPackSearchQuery:se}),I&&e.jsxs("div",{className:"flex-1 w-full flex flex-col items-center justify-center my-auto z-20",children:[!mt&&!dt&&(re||l==="packs")&&!R&&e.jsx(Uo,{selectedPacks:T,togglePack:Wt,newProjectName:oe,setNewProjectName:gt,setActiveProject:Ae,handleSend:j,isClient:L,getCachedGradient:a,onDetailStateChange:z,showGuestPacks:ge,setShowGuestPacks:Ce,guestPackSearchQuery:he}),!mt&&!dt&&!re&&l==="projects"&&e.jsx(Jn,{isClient:L,getCachedGradient:a,setActiveProject:Ae}),!mt&&!dt&&!re&&l==="news"&&et(),!mt&&!dt&&!re&&l==="youtube"&&yt(),mt&&e.jsxs("div",{className:"w-full bg-black/90 border-2 border-pink-500/50 rounded-3xl p-6 shadow-2xl backdrop-blur-md relative my-2 text-white animate-fadeIn flex-1 min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 pb-2 border-b border-white/10",children:[e.jsx("h3",{className:"text-xl font-black text-pink-400 flex items-center gap-2",children:"🎨 Gestion des Thèmes & Couleurs"}),e.jsx("button",{onClick:()=>Pt(!1),className:"px-3.5 py-1.5 bg-white/10 hover:bg-white/20 text-white text-xs font-bold rounded-xl transition-all cursor-pointer border border-white/20",children:"✕ Masquer"})]}),e.jsxs("div",{className:"bg-cyan/10 border border-cyan/30 rounded-xl p-4 flex flex-col gap-2 mb-4",children:[e.jsxs("div",{className:"text-xs font-bold text-cyan uppercase tracking-wider flex items-center gap-2",children:[e.jsx("span",{children:"🖥️"})," Page d'Accueil Electron"]}),e.jsx("p",{className:"text-xs text-gray-300",children:`Fixer le fond d'écran enregistré ("fold") pour la page d'accueil Electron.`}),e.jsx("button",{onClick:()=>{const h="linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)",x=Ie.map(P=>P.name==="fold"?{...P,colors:{...P.colors,"bg-app":h}}:P);Xe(x),localStorage.setItem("tiger_saved_themes",JSON.stringify(x)),Mt("fold"),document.body.style.background=h,document.body.style.backgroundAttachment="fixed",A("http://localhost:5006/api/theme",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({activeTheme:"fold",bgApp:h})}).catch(()=>{}),Pt(!1)},className:"w-full mt-1 py-2.5 bg-cyan text-black font-extrabold rounded-lg hover:bg-cyan/80 transition-all flex items-center justify-center gap-2 shadow-lg cursor-pointer",children:`🖼️ Appliquer ce Fond d'Écran sur Electron ("fold")`})]}),e.jsxs("div",{className:"bg-white/5 border border-white/10 rounded-xl p-4 flex flex-col gap-3 mb-4",children:[e.jsxs("div",{className:"text-sm font-bold text-gray-400",children:["Mode actuel : ",e.jsx("span",{className:"text-cyan uppercase",children:Ke})]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"text",value:we,onChange:h=>qt(h.target.value),placeholder:"Nom (ex: Nuit, Océan, fold...)",className:"flex-1 bg-black/50 border border-white/20 rounded-lg px-3 py-2 text-sm text-white outline-none focus:border-cyan"}),e.jsx("button",{onClick:on,className:"px-4 py-2 bg-cyan text-black font-bold rounded-lg hover:bg-cyan/80 transition-colors whitespace-nowrap cursor-pointer",children:"Save Mode"})]})]}),e.jsxs("div",{className:"flex flex-col gap-2 max-h-[220px] overflow-y-auto custom-scrollbar",children:[e.jsx("div",{className:"text-xs font-bold text-gray-500 uppercase tracking-widest mb-1",children:"Thèmes Enregistrés"}),e.jsxs("div",{onClick:()=>{Mt("random"),Pt(!1)},className:`p-3 rounded-xl border text-left flex justify-between items-center transition-all cursor-pointer ${Ke==="random"?"bg-cyan/20 border-cyan text-white":"bg-white/5 border-white/10 text-gray-400 hover:bg-white/10"}`,children:[e.jsx("span",{className:"font-bold flex items-center gap-2",children:"🎲 Mode Aléatoire (Dynamique)"}),Ke==="random"&&e.jsx("span",{className:"text-cyan",children:"✓"})]}),Ie.map(h=>e.jsxs("div",{onClick:()=>{Mt(h.name),document.body.style.background=h.colors["bg-app"]||"",h.name==="fold"?document.body.style.backgroundAttachment="fixed":document.body.style.backgroundAttachment="scroll"},className:`p-3 rounded-xl border text-left flex justify-between items-center transition-all cursor-pointer ${Ke===h.name?"bg-cyan/20 border-cyan text-white":"bg-white/5 border-white/10 text-gray-400 hover:bg-white/10"}`,children:[e.jsx("span",{className:"font-bold capitalize",children:h.name}),e.jsx("button",{onClick:x=>Qe(h.name,x),className:"text-xs text-red-400 hover:text-red-300 px-2 py-1 bg-red-500/10 hover:bg-red-500/20 rounded border border-red-500/20 cursor-pointer",children:"Supprimer"})]},h.name))]})]}),dt&&e.jsxs("div",{className:"w-full bg-[#090d16] border-2 border-purple-500/60 rounded-3xl p-6 shadow-2xl backdrop-blur-md relative my-2 text-white animate-fadeIn flex-1 min-w-0 flex flex-col max-h-[520px] overflow-y-auto custom-scrollbar",children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 pb-2 border-b border-purple-500/30",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-2xl animate-bounce",children:"📱"}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-purple-300 font-black text-base md:text-lg uppercase tracking-wider flex items-center gap-2",children:"v0-apk — Compilateur Mobile Java"}),e.jsx("p",{className:"text-xs text-slate-400",children:"Génération d'APK Android Souverain sans dépendance système externe"})]})]}),e.jsx("button",{onClick:()=>At(!1),className:"px-3.5 py-1.5 bg-white/10 hover:bg-white/20 text-white text-xs font-bold rounded-xl transition-all cursor-pointer border border-white/20",children:"✕ Masquer"})]}),e.jsxs("div",{className:"flex flex-col gap-2 bg-black/50 p-4 rounded-2xl border border-purple-500/20 mb-3",children:[e.jsxs("label",{htmlFor:"apk-target-inline",className:"text-purple-400 font-bold uppercase text-xs tracking-widest flex items-center gap-2",children:[e.jsx("span",{children:"📁"})," SELECTIONNER L'APPLICATION À COMPILER :"]}),e.jsxs("select",{id:"apk-target-inline",value:ut||R||"",onChange:h=>Ht(h.target.value),className:"w-full bg-[#121824] text-white border border-purple-500/40 rounded-xl px-4 py-2.5 outline-none focus:border-purple-400 text-xs font-semibold cursor-pointer",children:[e.jsx("option",{value:"",children:"-- Sélectionner un projet --"}),_e.map((h,x)=>{var k,ne;const P=typeof(h==null?void 0:h.name)=="string"?h.name:((k=h==null?void 0:h.name)==null?void 0:k.project_id)||((ne=h==null?void 0:h.name)==null?void 0:ne.title)||`Projet_${x}`;return e.jsxs("option",{value:P,children:["📁 ",P]},P+"_"+x)})]})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3 mb-3",children:[e.jsxs("div",{className:"bg-black/50 p-3 rounded-2xl border border-purple-500/20 flex flex-col gap-1",children:[e.jsx("span",{className:"text-xs font-bold text-purple-300 uppercase tracking-wider",children:"☕ Java Portable"}),e.jsx("div",{className:"text-[11px] text-slate-300 bg-purple-950/30 p-2 rounded-xl border border-purple-800/40 font-mono",children:"JDK 17 + Capacitor Android Engine"})]}),e.jsxs("div",{className:"bg-black/50 p-3 rounded-2xl border border-purple-500/20 flex flex-col gap-1",children:[e.jsx("span",{className:"text-xs font-bold text-purple-300 uppercase tracking-wider",children:"🎨 Thèmes Persistent"}),e.jsx("div",{className:"text-[11px] text-slate-300 bg-purple-950/30 p-2 rounded-xl border border-purple-800/40 font-mono",children:"Injection Zero-Touch CSS embarquée"})]})]}),e.jsxs("div",{className:"bg-[#05070d] p-3 rounded-2xl border border-slate-800 flex flex-col gap-2 mb-3",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsxs("span",{className:"text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center gap-2",children:[e.jsx("span",{className:`w-2.5 h-2.5 rounded-full ${st==="building"?"bg-yellow-400 animate-ping":st==="success"?"bg-green-400":"bg-slate-600"}`}),"Logs Compilation APK"]}),Dt.length>0&&e.jsx("button",{onClick:()=>Le([]),className:"text-[10px] text-slate-500 hover:text-slate-300 underline cursor-pointer",children:"Effacer"})]}),e.jsx("div",{className:"bg-black/80 p-3 rounded-xl border border-slate-900 font-mono text-[11px] h-24 overflow-y-auto custom-scrollbar flex flex-col gap-1 text-slate-300",children:Dt.length===0?e.jsx("span",{className:"text-slate-600 italic text-center my-auto",children:`Prêt. Cliquez sur "Compiler l'APK".`}):Dt.map((h,x)=>e.jsx("div",{className:"leading-tight",children:h},x))})]}),e.jsxs("div",{className:"flex items-center justify-between pt-2 border-t border-purple-500/20",children:[fn&&e.jsxs("a",{href:fn,download:!0,className:"px-4 py-2 bg-green-600 hover:bg-green-500 text-white rounded-xl text-xs font-black transition-all flex items-center gap-2 shadow-lg shadow-green-900/40 animate-bounce",children:[e.jsx("span",{children:"📥"})," Télécharger APK"]}),e.jsx("button",{disabled:st==="building",onClick:async()=>{const h=ut||R;if(!h)return alert("Veuillez sélectionner un projet !");$e("building"),Le([`> Initialisation build APK pour [${h}]...`]);try{const x=await A("http://localhost:5006/api/mobile/build-apk",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:h})});if(!x||!x.ok){Le(P=>[...P,"> ℹ️ Détection environnement Cloud VPS (109.205.182.17)...","> 🚀 Bascule automatique sur le Compilateur Cloud Souverain (GitHub Actions Engine)..."]),await $n(h,P=>Le(k=>[...k,P]),(P,k)=>{$e(P),k&&ft(k)});return}}catch{Le(P=>[...P,"> 🚀 Bascule automatique sur le Compilateur Cloud Souverain..."]),await $n(h,P=>Le(k=>[...k,P]),(P,k)=>{$e(P),k&&ft(k)})}},className:`ml-auto px-5 py-2.5 rounded-xl text-xs font-extrabold transition-all shadow-md ${st==="building"?"bg-purple-900/50 text-purple-300 cursor-not-allowed":"bg-purple-600 hover:bg-purple-500 text-white cursor-pointer"}`,children:st==="building"?"⚙️ Compilation...":"📱 Compiler l'APK"})]})]})]}),!I&&e.jsx("div",{className:"design-chat-bulles w-full xl:w-[450px] shrink-0 flex flex-col gap-3 items-end z-10 ml-auto",children:u.map((h,x)=>{const P=x===0;return e.jsxs("div",{className:"w-full flex flex-col items-end",children:[e.jsx("div",{className:`${P?"design-msg-accueil":"design-chat-bulle"} p-5 rounded-3xl rounded-br-sm backdrop-blur-md border border-white/20 text-gray-100 shadow-xl`,style:{background:L?a("msg-"+h.id,h.role==="user"?.8:.6):"rgba(0,0,0,0.6)"},children:h.content}),x===s&&h.widget==="settings"&&e.jsx(Kn,{isClient:L,getCachedGradient:a,mouchardLogs:de,activePhase:q,availableProjects:ae,setAvailableProjects:ve,selectedLaunchProject:F,setSelectedLaunchProject:ee,isMobileNative:X,isAutoPilot:bt,setIsAutoPilot:Jt,reuseActiveTab:rt,setReuseActiveTab:jt,selectedStartPhase:We,setSelectedStartPhase:Lt,selectedPacks:T}),x===s&&h.widget==="phases"&&Ge(),x===s&&h.widget==="projects"&&e.jsx(Jn,{isClient:L,getCachedGradient:a,setActiveProject:Ae})]},h.id)})})]})})(),e.jsx("div",{ref:M})]})]}),N&&(()=>{const s=de.slice(-10).join(" ").toLowerCase(),c=de.slice(0,10).join(" ").toLowerCase(),l=s+" "+c;let I="text-green-400",h="bg-green-400 shadow-[0_0_8px_#4ade80]",x="border-green-500/30 shadow-[-10px_0_30px_rgba(34,197,94,0.1)]",P="bg-green-950/20",k="Terminal (Prêt)";return l.includes("erreur")||l.includes("failed")||l.includes("⚠️")||l.includes("exception")||l.includes("impossible")||l.includes("[err")?(I="text-red-500",h="bg-red-500 animate-pulse shadow-[0_0_12px_#ef4444]",x="border-red-500/50 shadow-[-10px_0_30px_rgba(239,68,68,0.2)]",P="bg-red-950/30",k="Terminal (Erreur)"):(l.includes("en cours")||l.includes("execution")||l.includes("install")||l.includes("lancement")||l.includes("analyse")||l.includes("suture")||l.includes("patch"))&&!l.includes("terminé")&&!l.includes("détecté")&&!l.includes("nettoyée")&&!l.includes("✅")&&(I="text-purple-400",h="bg-purple-400 animate-ping shadow-[0_0_12px_#c084fc]",x="border-purple-500/50 shadow-[-10px_0_30px_rgba(168,85,247,0.2)]",P="bg-purple-950/30",k="Terminal (Travail...)"),e.jsxs("aside",{className:`w-80 border-l flex flex-col z-50 fixed right-0 top-0 h-screen bg-black transition-all duration-500 shadow-2xl ${x}`,children:[e.jsxs("div",{className:`p-4 border-b border-white/10 flex justify-between items-center transition-colors duration-500 ${P}`,children:[e.jsxs("h3",{className:`${I} font-black text-xs uppercase tracking-widest flex items-center gap-2 transition-colors`,children:[e.jsx("span",{className:`w-2 h-2 rounded-full ${h}`}),k]}),e.jsxs("div",{className:"flex gap-2 items-center",children:[e.jsx("button",{onClick:async()=>{xe(["> Arrêt des processus en cours... (Historique conservé dans la console noire)"]);try{const ne=await A("http://localhost:5006/api/bridge/stop-launch",{method:"POST"});if(!ne||!ne.ok){xe(["> ⚠️ ERREUR : La commande n'existe pas !","> ⚠️ VOUS DEVEZ REDÉMARRER LA CONSOLE NOIRE !","> Fermez la fenêtre COMMAND_MENU_TIGER.bat et relancez-la."]);return}const Z=await ne.json();xe(["> ✅ "+(Z.message||"Processus arrêtés.")])}catch(ne){xe(["> ⚠️ ERREUR DE CONNEXION AU MOTEUR !","> Le moteur est peut-être éteint ou nécessite un redémarrage.","> Détail: "+ne.message])}},className:"py-1 px-2 rounded text-white font-bold text-[10px] bg-red-500/20 border border-red-500/50 hover:bg-red-500 hover:text-white transition-colors shadow-md",title:"Arrêter l'installation ou le serveur (Ne nettoie plus la console)",children:"⏹️ Stop/Clear"}),e.jsx("button",{onClick:()=>Q(!1),className:"text-gray-500 hover:text-white transition-colors ml-2 font-bold text-lg",children:"✕"})]})]}),e.jsx("div",{className:"flex-1 p-4 font-mono text-xs overflow-y-auto flex flex-col-reverse hide-scrollbar bg-black",children:e.jsx("div",{id:"mouchard-terminal-logs",children:de.map((ne,Z)=>{let Y="text-[#52c1c9]";return ne.includes("[INSTALL]")&&(Y="text-[#f29f43]"),ne.includes("[SERVER]")&&(Y="text-[#0ab7d4]"),ne.includes("[IDE]")&&(Y="text-[#e27396]"),(ne.includes("WARN")||ne.includes("ERR"))&&(Y="text-red-500"),e.jsx("div",{className:`mb-1 opacity-90 break-words ${Y}`,children:ne},Z)})})})]})})(),!N&&e.jsxs("button",{onClick:()=>Q(!0),title:"Ouvrir le Mouchard Système / Terminal",className:"fixed right-4 top-4 z-50 bg-[#111c2e]/90 hover:bg-[#1e293b] border border-cyan/40 text-cyan px-3 py-1.5 rounded-full text-[11px] font-mono font-bold shadow-[0_0_15px_rgba(8,179,201,0.25)] transition-all flex items-center gap-1.5 backdrop-blur-md cursor-pointer hover:scale-105",children:[e.jsx("span",{children:"🕵️"}),e.jsx("span",{children:"Mouchard"})]})]})," ",e.jsxs("footer",{className:"design-footer absolute bottom-0 left-0 w-full backdrop-blur-2xl z-50 flex flex-col p-2 md:p-3 bg-black/80 border-t border-white/15 gap-2",children:[e.jsx("div",{className:"flex flex-wrap items-center justify-center gap-3 px-4 py-2 bg-black/40 rounded-2xl border border-white/10 backdrop-blur-md",children:e.jsxs("div",{className:"flex items-center gap-2 overflow-x-auto hide-scrollbar pb-1 px-1",children:[e.jsxs("button",{onClick:()=>{$("connexion"),C(!0)},className:"design-app-icone design-icone-reglages flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Réglages",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:rotate-45 transition-transform",children:"⚙️"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Réglages"})]}),e.jsxs("button",{onClick:()=>{if(typeof window<"u"){const s=localStorage.getItem("tiger_targetAi")||"deepseek",c=ct(s),l=window.AndroidBridge;l&&l.openAIWithPrompt?l.openAIWithPrompt(c,"Bonjour ! Je viens d'ouvrir l'Assistant IA."):window.open(c,"_blank")}},className:"design-app-icone design-icone-assistant flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Assistant IA",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🧠"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Assistant IA"})]}),e.jsxs("button",{onClick:()=>{Ae(null),it(null),ue(!1),j("Mes projets"),f("")},className:"design-app-icone design-icone-projets flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Projets",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"📁"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Projets"})]}),e.jsxs("button",{id:"btn-joindre-prd-main",onClick:()=>{ue(!0)},className:"design-app-icone design-icone-packs flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Ouvrir le carrousel des Packs PRD",children:[T.length>0&&e.jsx("span",{className:"absolute -top-0 -right-0 bg-indigo-500 text-white text-[9px] font-black w-4.5 h-4.5 rounded-full flex items-center justify-center border border-white/20 shadow-md z-20",children:T.length}),e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform text-xl",children:"📎"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Packs PRD"})]}),e.jsxs("button",{onClick:async()=>{window.dispatchEvent(new CustomEvent("open-mouchard"));try{await A("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:"v0-guest"})}),setTimeout(()=>{window.open("http://localhost:3007","_blank")},2500)}catch(s){console.error("Erreur lancement v0-guest:",s)}},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden cursor-pointer",style:{backgroundImage:"linear-gradient(135deg, #00c6ff, #0072ff)"},title:"Démarrer le serveur V0-Guest (localhost:3007) en arrière-plan",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🎁"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"V0-Guest"})]}),e.jsxs("button",{onClick:()=>{ue(!1),j("Actualités IA"),f("")},className:"design-app-icone design-icone-actualites flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Actualités",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"📰"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Actualités"})]}),e.jsxs("button",{type:"button",onClick:s=>{s.preventDefault(),Q(c=>{const l=!c;return l&&xe(I=>["> Console-V0 ouverte. Prêt pour l'Introspection AST.",...I]),l})},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #475163, #1f2530)"},title:"Console-V0",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🖥️"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Console-V0"})]}),e.jsxs("button",{type:"button",onClick:async s=>{s.preventDefault();try{Q(!0);const c=R||"Projet_blog_8831",I=`e:\\v0reponses\\v0-moteur-electron\\v0saveprojets\\${c}\\${(pe||"src/App.tsx").replace(/\//g,"\\")}`;setTimeout(()=>{const k=document.getElementById("mouchard-terminal-logs");k&&(k.innerHTML=`<div class="mb-1 opacity-90 break-words text-[#e27396]">> 🚀 Lancement du Patch UI (Suture dynamique sur ${c})...</div>`+k.innerHTML)},50);const h=await A("http://localhost:5006/api/design/intent",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({intent:"PATCH_UI",payload:{targetFile:I,templateId:"stitch_mock"}})}),x=h?await h.json():null,P=document.getElementById("mouchard-terminal-logs");P&&(x&&x.success?P.innerHTML='<div class="mb-1 opacity-90 break-words text-[#00e676]">> 🎯 Patch appliqué avec succès par le LLM !</div>'+P.innerHTML:(P.innerHTML=`<div class="mb-1 opacity-90 break-words text-red-400">> ⚠️ Erreur Patch UI AST : ${x&&x.error||"Basculement vers la Suture IA..."}</div>`+P.innerHTML,ke("suture",`Échec du patch automatique AST : ${x&&x.error||"Format incompatible"}`)))}catch(c){const l=document.getElementById("mouchard-terminal-logs");l&&(l.innerHTML=`<div class="mb-1 opacity-90 break-words text-red-500">> ⛔ Erreur Patch UI : ${c.message}</div>`+l.innerHTML),ke("suture",`Exception Patch UI: ${c.message}`)}},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #1b6345, #08291a)"},title:"Patch UI",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🧬"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Patch UI"})]}),e.jsxs("button",{type:"button",onClick:async()=>{try{const s=await A("http://localhost:5006/bridge/flush",{method:"POST"}),c=s?await s.json():null;S(I=>[...I,{id:Date.now().toString()+"_flush",role:"assistant",content:`🧹 File Bridge vidée ! ${c&&c.flushed||0} prompt(s) supprimé(s).

La queue est vide. Relancez votre Suture ou Patch.`}]);const l=document.getElementById("mouchard-terminal-logs");l&&(l.innerHTML=`<div class="mb-1 opacity-90 break-words text-yellow-400">> 🧹 Bridge Queue FLUSH — ${c&&c.flushed||0} tâche(s) nettoyée(s)</div>`+l.innerHTML)}catch{alert("Moteur hors ligne : impossible de vider la queue.")}},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #a17c23, #4f3b0c)"},title:"Vider la file Bridge (déblocage injection)",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🧹"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Flush Queue"})]}),e.jsxs("button",{onClick:()=>{At(!1),ue(!1),Pt(s=>!s)},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #993a61, #4d152c)"},title:"Thèmes & Couleurs",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🎨"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Thèmes"})]}),e.jsxs("button",{onClick:()=>{Pt(!1),ue(!1),At(s=>!s)},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #5b227a, #230930)"},title:"Compiler l'Application Mobile (.apk - Java Portable)",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform animate-pulse",children:"📱"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"v0-apk"})]})]})}),e.jsxs("div",{className:"px-3 pb-1 pt-1 relative w-full flex flex-col gap-2",children:[e.jsx("input",{type:"file",ref:E,className:"hidden",multiple:!0,accept:".html,.md,.png,.jpg,.jpeg,.json,.txt,.zip",onChange:s=>{s.target.files&&s.target.files.length>0&&me(s.target.files),E.current&&(E.current.value="")}}),Ze.length>0&&e.jsx("div",{className:"flex gap-2 px-2 overflow-x-auto hide-scrollbar pb-2",children:Ze.map((s,c)=>e.jsxs("div",{className:"flex items-center gap-2 bg-cyan/10 border border-cyan/30 text-cyan text-xs px-3 py-1.5 rounded-full whitespace-nowrap animate-fadeIn",children:[e.jsxs("span",{children:["📎 ",s.path.split("/").pop()||s.path.split("\\").pop()]}),e.jsx("button",{onClick:()=>Ut(l=>l.filter((I,h)=>h!==c)),className:"hover:text-red-400 font-bold ml-1",children:"✕"})]},c))}),Re?e.jsxs("div",{id:"creation-mode-container",className:"absolute bottom-full left-2 right-2 mb-3 flex flex-col gap-4 bg-[#05080c]/98 p-5 rounded-3xl border-2 border-cyan/50 shadow-[0_0_50px_rgba(8,179,201,0.5)] backdrop-blur-2xl animate-fadeIn z-[100] max-h-[82vh] overflow-y-auto custom-scrollbar text-white",children:[e.jsxs("div",{className:"flex justify-between items-center mb-1 sticky top-0 bg-[#05080c]/98 z-10 py-2 border-b border-cyan/20",children:[e.jsxs("h3",{className:"text-cyan font-black flex items-center gap-2 text-base md:text-lg uppercase tracking-wider",children:[e.jsx("span",{className:"animate-pulse w-2.5 h-2.5 bg-cyan rounded-full shadow-[0_0_10px_#08b3c9]"})," ⚙️ CONFIGURATION DU PROJET"]}),e.jsx("button",{onClick:()=>Ne(!1),className:"text-gray-400 hover:text-white bg-white/10 hover:bg-red-500 rounded-full w-7 h-7 flex items-center justify-center transition-colors",children:"✕"})]}),e.jsxs("div",{className:"flex flex-col gap-2 bg-black/60 p-3.5 rounded-2xl border border-white/10",children:[e.jsxs("label",{htmlFor:"project-target",className:"text-cyan font-bold uppercase text-[10px] tracking-widest flex items-center gap-1.5",children:[e.jsx("span",{children:"📁"})," CIBLER LE PROJET :"]}),e.jsxs("select",{id:"project-target",value:Tt||"",onChange:s=>{const c=s.target.value;vn(c||null),gt(c?c.replace("Projet_","").split("_")[0]:"")},className:"w-full bg-[#11161d] text-white border border-cyan/30 rounded-xl px-3 py-2 outline-none focus:border-cyan text-xs cursor-pointer",children:[e.jsx("option",{value:"",children:"-- SÉLECTIONNER UN PROJET --"}),_e.map((s,c)=>{var I,h;const l=typeof(s==null?void 0:s.name)=="string"?s.name:((I=s==null?void 0:s.name)==null?void 0:I.project_id)||((h=s==null?void 0:s.name)==null?void 0:h.title)||`Projet_${c}`;return e.jsxs("option",{value:l,children:["📁 ",l]},l+"_"+c)})]})]}),e.jsxs("div",{className:"flex flex-col gap-2 bg-black/60 p-3.5 rounded-2xl border border-white/10",children:[e.jsxs("label",{htmlFor:"project-instructions",className:"text-cyan font-bold uppercase text-[10px] tracking-widest flex items-center gap-1.5",children:[e.jsx("span",{children:"📝"})," INSTRUCTIONS SPÉCIFIQUES :"]}),e.jsx("textarea",{id:"project-instructions",value:He,onChange:s=>nn(s.target.value),placeholder:"Instructions pour le Patch ou la modification...",className:"w-full bg-[#11161d] text-white border border-slate-700 rounded-xl px-3.5 py-2 outline-none focus:border-cyan h-14 resize-none text-xs leading-relaxed"})]}),e.jsxs("div",{className:"flex flex-col gap-3.5 bg-black/60 p-3.5 rounded-2xl border border-white/10",children:[e.jsxs("div",{className:"text-cyan font-bold uppercase text-xs tracking-wider flex items-center gap-1.5 border-b border-white/10 pb-1.5",children:[e.jsx("span",{children:"⚡"})," PARAMÈTRES & CIBLES"]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"project-name",className:"text-cyan font-bold uppercase text-[10px] tracking-widest mb-1 block",children:"Nom du Projet"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{id:"project-name",type:"text",value:oe,onChange:s=>gt(s.target.value),placeholder:"Ex: MonSuperProjet",className:"flex-1 bg-[#11161d] text-white border border-slate-700 rounded-xl px-3 py-2 outline-none focus:border-cyan text-xs"}),e.jsx("button",{type:"button",onClick:async()=>{if(oe.trim()){const c=oe.trim().replace(/[^a-zA-Z0-9_-]/g,"_");Ae(c);try{const l="http://localhost:5006";await A(`${l}/v1/projects/set-active`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:c,project_id:c})}).catch(()=>null),await A(`${l}/api/fs/write`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:c,file:"README.md",content:`# ${oe.trim()}

Initialisé par Tiger IA V0.`})}).catch(()=>null)}catch(l){console.error("Erreur lors de la création du dossier sur disque:",l)}}},className:"px-3 py-2 bg-cyan/20 hover:bg-cyan text-cyan hover:text-black font-bold text-xs rounded-xl border border-cyan/40 transition-colors whitespace-nowrap",children:"Valider"})]})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"project-stack",className:"text-cyan font-bold uppercase text-[10px] tracking-widest mb-1 block",children:"Stack Technique"}),e.jsxs("select",{id:"project-stack",value:ze,onChange:s=>Nn(s.target.value),className:"w-full bg-[#11161d] text-white border border-slate-700 rounded-xl px-3 py-2 outline-none focus:border-cyan text-xs cursor-pointer",children:[e.jsx("option",{value:"Vite + React + Tailwind + TS",children:"⭐ 1er Choix (Prioritaire) : Vite + React + Tailwind + TS"}),e.jsx("option",{value:"Vite + React + TS + Canvas 2D",children:"🎮 Jeu 2D : Vite + React + TS + Canvas 2D"}),e.jsx("option",{value:"Vite + React + TS + Three.js / R3F (3D GPU)",children:"🚀 Jeu 3D GPU : Vite + React + TS + Three.js / R3F"}),e.jsx("option",{value:"Next.js + Tailwind + App Router",children:"Next.js + Tailwind + App Router"}),e.jsx("option",{value:"HTML + CSS Vanilla + JS",children:"HTML + CSS Vanilla + JS"})]})]})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"project-desc",className:"text-cyan font-bold uppercase text-[10px] tracking-widest mb-1 block",children:"Description / Vision"}),e.jsx("textarea",{id:"project-desc",value:ht,onChange:s=>xn(s.target.value),placeholder:"Décrivez l'application ou copiez votre PRD...",className:"w-full bg-[#11161d] text-white border border-slate-700 rounded-xl px-3.5 py-2 outline-none focus:border-cyan h-16 resize-none text-xs leading-relaxed"})]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2 pt-2 border-t border-white/10",children:[e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-[9px] font-bold text-cyan uppercase tracking-wider",children:"Intelligence Cible"}),e.jsxs("select",{value:wt,onChange:s=>{Nt(s.target.value),localStorage.setItem("tiger_targetAi",s.target.value)},className:"bg-[#11161d] text-cyan font-bold text-xs border border-cyan/40 rounded-xl px-2.5 py-1.5 outline-none focus:border-cyan cursor-pointer",children:[e.jsx("option",{value:"deepseek",children:"🩵 DeepSeek"}),e.jsx("option",{value:"cloudflare",children:"☁️ Cloudflare Qwen 3 (Grade Gold)"}),e.jsx("option",{value:"stitch",children:"🎨 Stitch (Google)"}),e.jsx("option",{value:"v0",children:"⚡ V0.dev"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT"}),e.jsx("option",{value:"claude",children:"🟠 Claude"}),e.jsx("option",{value:"kimi",children:"🌙 Kimi (Moonshot)"}),e.jsx("option",{value:"gemini",children:"🔵 Gemini"}),e.jsx("option",{value:"qwen",children:"🔴 Qwen"}),e.jsx("option",{value:"perplexity",children:"🔍 Perplexity AI"})]})]}),e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-[9px] font-bold text-cyan uppercase tracking-wider",children:"💉 Mode & Lot de Départ"}),e.jsxs("select",{value:We,onChange:s=>Lt(Number(s.target.value)),className:"bg-[#11161d] text-white font-bold text-xs border border-cyan/40 rounded-xl px-2.5 py-1.5 outline-none focus:border-cyan cursor-pointer",children:[e.jsx("option",{value:1,children:"🎨 Phase 1 : Le Frontend (Stitch/v0)"}),e.jsx("option",{value:2,children:"💻 Phase 2 : Le Backend (Assistant IA)"}),e.jsx("option",{value:4,children:"🎨 Phase 3/4 : Câblage Métier (Business Wiring)"})]})]}),e.jsxs("button",{type:"button",onClick:()=>Jt(!bt),className:`mt-4 px-3 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border ${bt?"bg-green-600/30 text-green-300 border-green-500/50 shadow-[0_0_10px_rgba(34,197,94,0.3)]":"bg-slate-800 text-slate-300 border-slate-700 hover:border-slate-500"}`,children:[e.jsx("span",{children:"🤖"}),e.jsxs("span",{children:["AUTO-PILOT : ",bt?"ON 🟢":"OFF ⚪"]})]}),e.jsxs("button",{type:"button",onClick:()=>jt(!rt),className:`mt-4 px-3 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border ${rt?"bg-blue-600/30 text-blue-300 border-blue-500/50 shadow-[0_0_10px_rgba(59,130,246,0.3)]":"bg-slate-800 text-slate-300 border-slate-700"}`,title:"Cochez pour réutiliser l'onglet KIROV5 au lieu d'ouvrir un nouvel onglet",children:[e.jsx("span",{children:"🔗"}),e.jsx("span",{children:rt?"✓ Injecter dans l'onglet déjà ouvert":"Ouvrir un nouvel onglet"})]}),e.jsxs("div",{id:"btn-joindre-prd",className:`mt-4 px-3 py-1.5 border rounded-xl text-xs font-bold flex items-center gap-1.5 relative ${T.length>0?"bg-indigo-600 text-white border-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.6)]":"bg-indigo-900/40 text-indigo-200 border-indigo-500/40"}`,title:"Pack PRD sélectionné — Sera injecté automatiquement dans le contexte IA",children:[e.jsx("span",{children:"💎"}),e.jsx("span",{children:T.length>0?`Packs PRD ${T.length} ${T[0]}`:"Aucun Pack PRD sélectionné"})]}),e.jsxs("button",{type:"button",onClick:triggerNativeZipPicker,className:"mt-4 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-white border border-slate-600 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 shadow-md hover:border-cyan hover:shadow-[0_0_15px_rgba(8,179,201,0.4)] cursor-pointer",children:[e.jsx("span",{children:"📎"}),e.jsx("span",{children:"Joindre ZIP (Stitch)"})]})]})]}),re&&e.jsxs("div",{className:"w-full bg-[#0a0d14]/98 p-4 rounded-2xl border-2 border-indigo-500/60 shadow-[0_0_30px_rgba(99,102,241,0.4)] my-2 text-white animate-fadeIn max-h-[50vh] overflow-y-auto custom-scrollbar flex flex-col gap-3 z-30",children:[e.jsxs("div",{className:"flex justify-between items-center pb-2 border-b border-indigo-500/30 sticky top-0 bg-[#0a0d14]/98 z-10 py-1",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-xl",children:"💎"}),e.jsxs("div",{children:[e.jsxs("h4",{className:"text-indigo-300 font-black text-xs md:text-sm uppercase tracking-wider",children:["PACKS PRD ARCHITECTURE (",T.length," SÉLECTIONNÉ",T.length>1?"S":"",")"]}),e.jsx("p",{className:"text-[10px] text-slate-400",children:"Sélectionnez les briques fonctionnelles à intégrer au Méga-Prompt."})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[T.length>0&&e.jsx("button",{type:"button",onClick:()=>K([]),className:"text-[10px] font-bold text-red-400 hover:text-red-300 bg-red-950/40 px-2 py-1 rounded-lg border border-red-500/30 transition-all",children:"Tout décocher"}),e.jsx("button",{type:"button",onClick:()=>ue(!1),className:"text-slate-400 hover:text-white bg-white/10 rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold transition-all",children:"✕"})]})]}),e.jsx("input",{type:"text",placeholder:"🔍 Filtrer un pack PRD (ex: auth, ecom, mobile, saas, ai, game, sqlite...)",value:De,onChange:s=>nt(s.target.value),className:"w-full bg-[#121824] text-xs text-white border border-indigo-500/40 rounded-xl px-3 py-2 outline-none focus:border-indigo-400 placeholder:text-slate-500"}),e.jsx("div",{className:"grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2",children:Ft.filter(s=>s.name.toLowerCase().includes(De.toLowerCase())||s.id.toLowerCase().includes(De.toLowerCase())).map(s=>{const c=T.includes(s.id),l=s.icon;return e.jsxs("div",{onClick:()=>Wt(s.id),className:`p-2.5 rounded-xl border text-xs cursor-pointer transition-all flex flex-col justify-between gap-1.5 relative select-none ${c?"bg-indigo-900/60 border-indigo-400 text-white shadow-[0_0_12px_rgba(99,102,241,0.5)] scale-[1.02]":"bg-[#11161f] border-slate-800 text-slate-300 hover:border-indigo-500/50 hover:bg-[#171e2b]"}`,children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("div",{className:`p-1 rounded-lg ${s.color}`,children:e.jsx(l,{className:"w-3.5 h-3.5"})}),e.jsx("input",{type:"checkbox",checked:c,readOnly:!0,className:"accent-indigo-500 w-3.5 h-3.5 rounded cursor-pointer pointer-events-none"})]}),e.jsx("div",{className:"font-bold text-[11px] leading-tight line-clamp-1 text-white",children:s.name}),e.jsxs("div",{className:"text-[8px] text-slate-400 font-mono truncate",children:["#",s.id]})]},s.id)})}),e.jsx("div",{className:"pt-2 border-t border-indigo-500/20 flex justify-end",children:e.jsxs("button",{type:"button",onClick:()=>{ue(!1)},className:"px-4 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-black rounded-xl shadow-lg transition-all",children:["✓ Valider la sélection (",T.length,")"]})})]}),e.jsxs("div",{className:"flex justify-end gap-3 pt-2 border-t border-white/10",children:[e.jsx("button",{type:"button",onClick:()=>Ne(!1),className:"px-4 py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-xl text-xs font-bold transition-all",children:"Annuler"}),e.jsxs("button",{type:"button",onClick:async s=>{if(!oe.trim()&&!Tt){alert("Veuillez entrer un nom de projet ou en choisir un.");return}const c=oe.trim()?oe.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"",l=Tt||c||"Projet_"+Date.now().toString().slice(-4),I=s.currentTarget;I.innerText="⏳ Initialisation...",I.disabled=!0;try{const h="http://localhost:5006",x=typeof window<"u"&&window.Capacitor&&window.Capacitor.isNativePlatform();if(x)try{const{KirovSovereignEngine:Y}=window.Capacitor.Plugins;Y&&await Y.setActiveProject({name:l})}catch(Y){console.warn("Plugin mobile introuvable",Y)}else await A(`${h}/v1/projects/set-active`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:l})}).catch(()=>null);if(x)try{const{KirovSovereignEngine:Y}=window.Capacitor.Plugins;Y&&await Y.writeFile({project:l,file:"README.md",content:`# ${oe||l}

Initialisé par Tiger IA V0.
Stack : ${ze}
Description : ${ht}`})}catch{}else await A(`${h}/api/fs/write`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:l,file:"README.md",content:`# ${oe||l}

Initialisé par Tiger IA V0.
Stack : ${ze}
Description : ${ht}`})}).catch(()=>null);const P=T&&T.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${T.length})]
`+T.map(Y=>{const Me=Ft.find(Ve=>Ve.id===Y);return`• ${Me?Me.name:Y} (#${Y})`}).join(`
`):"";let k=`

[STACK TECHNIQUE OBLIGATOIRE : ${ze.toUpperCase()}]
`;ze.includes("Three.js")||ze.includes("3D GPU")?k+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être un jeu Web 3D accéléré GPU généré en **React + Vite + TypeScript (TSX) + Three.js / React Three Fiber (@react-three/fiber, @react-three/drei)**.
...
`:ze.includes("Canvas 2D")?k+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être un jeu Web 2D généré en **React + Vite + TypeScript (TSX) + Canvas 2D**.

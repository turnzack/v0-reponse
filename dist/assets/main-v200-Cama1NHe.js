const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-BoBsb1bX.js","assets/design-v200-DcgYHDqz.js","assets/design-v200-B_-ohhET.css"])))=>i.map(i=>d[i]);
import{r as o,a as Rt,j as e,s as w,i as ys,R as _s}from"./design-v200-DcgYHDqz.js";const Cs="modulepreload",ws=function(t){return"/"+t},Gn={},nn=function(n,r,c){let d=Promise.resolve();if(r&&r.length>0){let h=function(y){return Promise.all(y.map(S=>Promise.resolve(S).then(L=>({status:"fulfilled",value:L}),L=>({status:"rejected",reason:L}))))};document.getElementsByTagName("link");const p=document.querySelector("meta[property=csp-nonce]"),C=(p==null?void 0:p.nonce)||(p==null?void 0:p.getAttribute("nonce"));d=h(r.map(y=>{if(y=ws(y),y in Gn)return;Gn[y]=!0;const S=y.endsWith(".css"),L=S?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${y}"]${L}`))return;const F=document.createElement("link");if(F.rel=S?"stylesheet":Cs,S||(F.as="script"),F.crossOrigin="",F.href=y,C&&F.setAttribute("nonce",C),document.head.appendChild(F),S)return new Promise((ee,O)=>{F.addEventListener("load",ee),F.addEventListener("error",()=>O(new Error(`Unable to preload CSS for ${y}`)))})}))}function m(h){const p=new Event("vite:preloadError",{cancelable:!0});if(p.payload=h,window.dispatchEvent(p),!p.defaultPrevented)throw h}return d.then(h=>{for(const p of h||[])p.status==="rejected"&&m(p.reason);return n().catch(m)})},Is=`# undefined
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Bn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);n&&(c=c.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,c)}return r}function zn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Bn(Object(r),!0).forEach(function(c){Ii(t,c,r[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Bn(Object(r)).forEach(function(c){Object.defineProperty(t,c,Object.getOwnPropertyDescriptor(r,c))})}return t}function ki(t,n){if(t==null)return{};var r,c,d=ji(t,n);if(Object.getOwnPropertySymbols){var m=Object.getOwnPropertySymbols(t);for(c=0;c<m.length;c++)r=m[c],n.indexOf(r)===-1&&{}.propertyIsEnumerable.call(t,r)&&(d[r]=t[r])}return d}function ji(t,n){if(t==null)return{};var r={};for(var c in t)if({}.hasOwnProperty.call(t,c)){if(n.indexOf(c)!==-1)continue;r[c]=t[c]}return r}function Ti(t,n){return wi(t)||Ai(t,n)||Ni(t,n)||Pi()}function Ei(t,n){if(typeof t!="object"||!t)return t;var r=t[Symbol.toPrimitive];if(r!==void 0){var c=r.call(t,n);if(typeof c!="object")return c;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}function Ri(t){var n=Ei(t,"string");return typeof n=="symbol"?n:n+""}function Ni(t,n){if(t){if(typeof t=="string")return Vn(t,n);var r={}.toString.call(t).slice(8,-1);return r==="Object"&&t.constructor&&(r=t.constructor.name),r==="Map"||r==="Set"?Array.from(t):r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?Vn(t,n):void 0}}function Di(t,n,r){return n in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function Hn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);n&&(c=c.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,c)}return r}function $n(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Hn(Object(r),!0).forEach(function(c){Di(t,c,r[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Hn(Object(r)).forEach(function(c){Object.defineProperty(t,c,Object.getOwnPropertyDescriptor(r,c))})}return t}function Mi(){for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r];return function(c){return n.reduceRight(function(d,m){return m(d)},c)}}function Yt(t){return function n(){for(var r=this,c=arguments.length,d=new Array(c),m=0;m<c;m++)d[m]=arguments[m];return d.length>=t.length?t.apply(this,d):function(){for(var h=arguments.length,p=new Array(h),C=0;C<h;C++)p[C]=arguments[C];return n.apply(r,[].concat(d,p))}}}function bn(t){return{}.toString.call(t).includes("Object")}function qi(t){return!Object.keys(t).length}function sn(t){return typeof t=="function"}function Li(t,n){return Object.prototype.hasOwnProperty.call(t,n)}function Ui(t,n){return bn(n)||wt("changeType"),Object.keys(n).some(function(r){return!Li(t,r)})&&wt("changeField"),n}function Oi(t){sn(t)||wt("selectorType")}function Fi(t){sn(t)||bn(t)||wt("handlerType"),bn(t)&&Object.values(t).some(function(n){return!sn(n)})&&wt("handlersType")}function Gi(t){t||wt("initialIsRequired"),bn(t)||wt("initialType"),qi(t)&&wt("initialContent")}function Vi(t,n){throw new Error(t[n]||t.default)}var Bi={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},wt=Yt(Vi)(Bi),hn={changes:Ui,selector:Oi,handler:Fi,initial:Gi};function zi(t){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};hn.initial(t),hn.handler(n);var r={current:t},c=Yt(Ki)(r,n),d=Yt($i)(r),m=Yt(hn.changes)(t),h=Yt(Hi)(r);function p(){var y=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(S){return S};return hn.selector(y),y(r.current)}function C(y){Mi(c,d,m,h)(y)}return[p,C]}function Hi(t,n){return sn(n)?n(t.current):n}function $i(t,n){return t.current=$n($n({},t.current),n),n}function Ki(t,n,r){return sn(n)?n(t.current):Object.keys(r).forEach(function(c){var d;return(d=n[c])===null||d===void 0?void 0:d.call(n,t.current[c])}),r}var Wi={create:zi},Ji={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.55.1/min/vs"}};function Xi(t){return function n(){for(var r=this,c=arguments.length,d=new Array(c),m=0;m<c;m++)d[m]=arguments[m];return d.length>=t.length?t.apply(this,d):function(){for(var h=arguments.length,p=new Array(h),C=0;C<h;C++)p[C]=arguments[C];return n.apply(r,[].concat(d,p))}}}function Qi(t){return{}.toString.call(t).includes("Object")}function Zi(t){return t||Kn("configIsRequired"),Qi(t)||Kn("configType"),t.urls?(Yi(),{paths:{vs:t.urls.monacoBase}}):t}function Yi(){console.warn(ts.deprecation)}function ea(t,n){throw new Error(t[n]||t.default)}var ts={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},Kn=Xi(ea)(ts),ta={config:Zi},na=function(){for(var n=arguments.length,r=new Array(n),c=0;c<n;c++)r[c]=arguments[c];return function(d){return r.reduceRight(function(m,h){return h(m)},d)}};function ns(t,n){return Object.keys(n).forEach(function(r){n[r]instanceof Object&&t[r]&&Object.assign(n[r],ns(t[r],n[r]))}),zn(zn({},t),n)}var sa={type:"cancelation",msg:"operation is manually canceled"};function wn(t){var n=!1,r=new Promise(function(c,d){t.then(function(m){return n?d(sa):c(m)}),t.catch(d)});return r.cancel=function(){return n=!0},r}var ra=["monaco"],ia=Wi.create({config:Ji,isInitialized:!1,resolve:null,reject:null,monaco:null}),ss=Ti(ia,2),rn=ss[0],Sn=ss[1];function aa(t){var n=ta.config(t),r=n.monaco,c=ki(n,ra);Sn(function(d){return{config:ns(d.config,c),monaco:r}})}function oa(){var t=rn(function(n){var r=n.monaco,c=n.isInitialized,d=n.resolve;return{monaco:r,isInitialized:c,resolve:d}});if(!t.isInitialized){if(Sn({isInitialized:!0}),t.monaco)return t.resolve(t.monaco),wn(In);if(window.monaco&&window.monaco.editor)return rs(window.monaco),t.resolve(window.monaco),wn(In);na(la,da)(ua)}return wn(In)}function la(t){return document.body.appendChild(t)}function ca(t){var n=document.createElement("script");return t&&(n.src=t),n}function da(t){var n=rn(function(c){var d=c.config,m=c.reject;return{config:d,reject:m}}),r=ca("".concat(n.config.paths.vs,"/loader.js"));return r.onload=function(){return t()},r.onerror=n.reject,r}function ua(){var t=rn(function(r){var c=r.config,d=r.resolve,m=r.reject;return{config:c,resolve:d,reject:m}}),n=window.require;n.config(t.config),n(["vs/editor/editor.main"],function(r){var c=r.m||r;rs(c),t.resolve(c)},function(r){t.reject(r)})}function rs(t){rn().monaco||Sn({monaco:t})}function pa(){return rn(function(t){var n=t.monaco;return n})}var In=new Promise(function(t,n){return Sn({resolve:t,reject:n})}),is={config:aa,init:oa,__getMonacoInstance:pa},ma={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},An=ma,ga={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},ha=ga;function xa({children:t}){return Rt.createElement("div",{style:ha.container},t)}var fa=xa,ba=fa;function va({width:t,height:n,isEditorReady:r,loading:c,_ref:d,className:m,wrapperProps:h}){return Rt.createElement("section",{style:{...An.wrapper,width:t,height:n},...h},!r&&Rt.createElement(ba,null,c),Rt.createElement("div",{ref:d,style:{...An.fullWidth,...!r&&An.hide},className:m}))}var Sa=va,as=o.memo(Sa);function ya(t){o.useEffect(t,[])}var os=ya;function _a(t,n,r=!0){let c=o.useRef(!0);o.useEffect(c.current||!r?()=>{c.current=!1}:t,n)}var $e=_a;function en(){}function Bt(t,n,r,c){return Ca(t,c)||wa(t,n,r,c)}function Ca(t,n){return t.editor.getModel(ls(t,n))}function wa(t,n,r,c){return t.editor.createModel(n,r,c?ls(t,c):void 0)}function ls(t,n){return t.Uri.parse(n)}function Ia({original:t,modified:n,language:r,originalLanguage:c,modifiedLanguage:d,originalModelPath:m,modifiedModelPath:h,keepCurrentOriginalModel:p=!1,keepCurrentModifiedModel:C=!1,theme:y="light",loading:S="Loading...",options:L={},height:F="100%",width:ee="100%",className:O,wrapperProps:X={},beforeMount:Y=en,onMount:A=en}){let[E,k]=o.useState(!1),[f,b]=o.useState(!0),T=o.useRef(null),I=o.useRef(null),P=o.useRef(null),K=o.useRef(A),G=o.useRef(Y),J=o.useRef(!1);os(()=>{let B=is.init();return B.then(z=>(I.current=z)&&b(!1)).catch(z=>(z==null?void 0:z.type)!=="cancelation"&&console.error("Monaco initialization: error:",z)),()=>T.current?ge():B.cancel()}),$e(()=>{if(T.current&&I.current){let B=T.current.getOriginalEditor(),z=Bt(I.current,t||"",c||r||"text",m||"");z!==B.getModel()&&B.setModel(z)}},[m],E),$e(()=>{if(T.current&&I.current){let B=T.current.getModifiedEditor(),z=Bt(I.current,n||"",d||r||"text",h||"");z!==B.getModel()&&B.setModel(z)}},[h],E),$e(()=>{let B=T.current.getModifiedEditor();B.getOption(I.current.editor.EditorOption.readOnly)?B.setValue(n||""):n!==B.getValue()&&(B.executeEdits("",[{range:B.getModel().getFullModelRange(),text:n||"",forceMoveMarkers:!0}]),B.pushUndoStop())},[n],E),$e(()=>{var B,z;(z=(B=T.current)==null?void 0:B.getModel())==null||z.original.setValue(t||"")},[t],E),$e(()=>{let{original:B,modified:z}=T.current.getModel();I.current.editor.setModelLanguage(B,c||r||"text"),I.current.editor.setModelLanguage(z,d||r||"text")},[r,c,d],E),$e(()=>{var B;(B=I.current)==null||B.editor.setTheme(y)},[y],E),$e(()=>{var B;(B=T.current)==null||B.updateOptions(L)},[L],E);let V=o.useCallback(()=>{var se;if(!I.current)return;G.current(I.current);let B=Bt(I.current,t||"",c||r||"text",m||""),z=Bt(I.current,n||"",d||r||"text",h||"");(se=T.current)==null||se.setModel({original:B,modified:z})},[r,n,d,t,c,m,h]),ne=o.useCallback(()=>{var B;!J.current&&P.current&&(T.current=I.current.editor.createDiffEditor(P.current,{automaticLayout:!0,...L}),V(),(B=I.current)==null||B.editor.setTheme(y),k(!0),J.current=!0)},[L,y,V]);o.useEffect(()=>{E&&K.current(T.current,I.current)},[E]),o.useEffect(()=>{!f&&!E&&ne()},[f,E,ne]);function ge(){var z,se,le,he;let B=(z=T.current)==null?void 0:z.getModel();p||((se=B==null?void 0:B.original)==null||se.dispose()),C||((le=B==null?void 0:B.modified)==null||le.dispose()),(he=T.current)==null||he.dispose()}return Rt.createElement(as,{width:ee,height:F,isEditorReady:E,loading:S,_ref:P,className:O,wrapperProps:X})}var Aa=Ia;o.memo(Aa);function Pa(t){let n=o.useRef();return o.useEffect(()=>{n.current=t},[t]),n.current}var ka=Pa,xn=new Map;function ja({defaultValue:t,defaultLanguage:n,defaultPath:r,value:c,language:d,path:m,theme:h="light",line:p,loading:C="Loading...",options:y={},overrideServices:S={},saveViewState:L=!0,keepCurrentModel:F=!1,width:ee="100%",height:O="100%",className:X,wrapperProps:Y={},beforeMount:A=en,onMount:E=en,onChange:k,onValidate:f=en}){let[b,T]=o.useState(!1),[I,P]=o.useState(!0),K=o.useRef(null),G=o.useRef(null),J=o.useRef(null),V=o.useRef(E),ne=o.useRef(A),ge=o.useRef(),B=o.useRef(c),z=ka(m),se=o.useRef(!1),le=o.useRef(!1);os(()=>{let R=is.init();return R.then(Z=>(K.current=Z)&&P(!1)).catch(Z=>(Z==null?void 0:Z.type)!=="cancelation"&&console.error("Monaco initialization: error:",Z)),()=>G.current?te():R.cancel()}),$e(()=>{var Z,ae,pe,ve;let R=Bt(K.current,t||c||"",n||d||"",m||r||"");R!==((Z=G.current)==null?void 0:Z.getModel())&&(L&&xn.set(z,(ae=G.current)==null?void 0:ae.saveViewState()),(pe=G.current)==null||pe.setModel(R),L&&((ve=G.current)==null||ve.restoreViewState(xn.get(m))))},[m],b),$e(()=>{var R;(R=G.current)==null||R.updateOptions(y)},[y],b),$e(()=>{!G.current||c===void 0||(G.current.getOption(K.current.editor.EditorOption.readOnly)?G.current.setValue(c):c!==G.current.getValue()&&(le.current=!0,G.current.executeEdits("",[{range:G.current.getModel().getFullModelRange(),text:c,forceMoveMarkers:!0}]),G.current.pushUndoStop(),le.current=!1))},[c],b),$e(()=>{var Z,ae;let R=(Z=G.current)==null?void 0:Z.getModel();R&&d&&((ae=K.current)==null||ae.editor.setModelLanguage(R,d))},[d],b),$e(()=>{var R;p!==void 0&&((R=G.current)==null||R.revealLine(p))},[p],b),$e(()=>{var R;(R=K.current)==null||R.editor.setTheme(h)},[h],b);let he=o.useCallback(()=>{var R;if(!(!J.current||!K.current)&&!se.current){ne.current(K.current);let Z=m||r,ae=Bt(K.current,c||t||"",n||d||"",Z||"");G.current=(R=K.current)==null?void 0:R.editor.create(J.current,{model:ae,automaticLayout:!0,...y},S),L&&G.current.restoreViewState(xn.get(Z)),K.current.editor.setTheme(h),p!==void 0&&G.current.revealLine(p),T(!0),se.current=!0}},[t,n,r,c,d,m,y,S,L,h,p]);o.useEffect(()=>{b&&V.current(G.current,K.current)},[b]),o.useEffect(()=>{!I&&!b&&he()},[I,b,he]),B.current=c,o.useEffect(()=>{var R,Z;b&&k&&((R=ge.current)==null||R.dispose(),ge.current=(Z=G.current)==null?void 0:Z.onDidChangeModelContent(ae=>{le.current||k(G.current.getValue(),ae)}))},[b,k]),o.useEffect(()=>{if(b){let R=K.current.editor.onDidChangeMarkers(Z=>{var pe;let ae=(pe=G.current.getModel())==null?void 0:pe.uri;if(ae&&Z.find(ve=>ve.path===ae.path)){let ve=K.current.editor.getModelMarkers({resource:ae});f==null||f(ve)}});return()=>{R==null||R.dispose()}}return()=>{}},[b,f]);function te(){var R,Z;(R=ge.current)==null||R.dispose(),F?L&&xn.set(m,G.current.saveViewState()):(Z=G.current.getModel())==null||Z.dispose(),G.current.dispose()}return Rt.createElement(as,{width:ee,height:O,isEditorReady:b,loading:C,_ref:J,className:X,wrapperProps:Y})}var Ta=ja,Ea=o.memo(Ta),Ra=Ea;/*! Capacitor: https://capacitorjs.com/ - MIT License */const Na=t=>{const n=new Map;n.set("web",{name:"web"});const r=t.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:n},c=(m,h)=>{r.platforms.set(m,h)},d=m=>{r.platforms.has(m)&&(r.currentPlatform=r.platforms.get(m))};return r.addPlatform=c,r.setPlatform=d,r},Da=t=>t.CapacitorPlatforms=Na(t),cs=Da(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});cs.addPlatform;cs.setPlatform;var Kt;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(Kt||(Kt={}));class Pn extends Error{constructor(n,r,c){super(n),this.message=n,this.code=r,this.data=c}}const Ma=t=>{var n,r;return t!=null&&t.androidBridge?"android":!((r=(n=t==null?void 0:t.webkit)===null||n===void 0?void 0:n.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},qa=t=>{var n,r,c,d,m;const h=t.CapacitorCustomPlatform||null,p=t.Capacitor||{},C=p.Plugins=p.Plugins||{},y=t.CapacitorPlatforms,S=()=>h!==null?h.name:Ma(t),L=((n=y==null?void 0:y.currentPlatform)===null||n===void 0?void 0:n.getPlatform)||S,F=()=>L()!=="web",ee=((r=y==null?void 0:y.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||F,O=I=>{const P=f.get(I);return!!(P!=null&&P.platforms.has(L())||A(I))},X=((c=y==null?void 0:y.currentPlatform)===null||c===void 0?void 0:c.isPluginAvailable)||O,Y=I=>{var P;return(P=p.PluginHeaders)===null||P===void 0?void 0:P.find(K=>K.name===I)},A=((d=y==null?void 0:y.currentPlatform)===null||d===void 0?void 0:d.getPluginHeader)||Y,E=I=>t.console.error(I),k=(I,P,K)=>Promise.reject(`${K} does not have an implementation of "${P}".`),f=new Map,b=(I,P={})=>{const K=f.get(I);if(K)return console.warn(`Capacitor plugin "${I}" already registered. Cannot register plugins twice.`),K.proxy;const G=L(),J=A(I);let V;const ne=async()=>(!V&&G in P?V=typeof P[G]=="function"?V=await P[G]():V=P[G]:h!==null&&!V&&"web"in P&&(V=typeof P.web=="function"?V=await P.web():V=P.web),V),ge=(te,R)=>{var Z,ae;if(J){const pe=J==null?void 0:J.methods.find(ve=>R===ve.name);if(pe)return pe.rtype==="promise"?ve=>p.nativePromise(I,R.toString(),ve):(ve,Ee)=>p.nativeCallback(I,R.toString(),ve,Ee);if(te)return(Z=te[R])===null||Z===void 0?void 0:Z.bind(te)}else{if(te)return(ae=te[R])===null||ae===void 0?void 0:ae.bind(te);throw new Pn(`"${I}" plugin is not implemented on ${G}`,Kt.Unimplemented)}},B=te=>{let R;const Z=(...ae)=>{const pe=ne().then(ve=>{const Ee=ge(ve,te);if(Ee){const Te=Ee(...ae);return R=Te==null?void 0:Te.remove,Te}else throw new Pn(`"${I}.${te}()" is not implemented on ${G}`,Kt.Unimplemented)});return te==="addListener"&&(pe.remove=async()=>R()),pe};return Z.toString=()=>`${te.toString()}() { [capacitor code] }`,Object.defineProperty(Z,"name",{value:te,writable:!1,configurable:!1}),Z},z=B("addListener"),se=B("removeListener"),le=(te,R)=>{const Z=z({eventName:te},R),ae=async()=>{const ve=await Z;se({eventName:te,callbackId:ve},R)},pe=new Promise(ve=>Z.then(()=>ve({remove:ae})));return pe.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await ae()},pe},he=new Proxy({},{get(te,R){switch(R){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return J?le:z;case"removeListener":return se;default:return B(R)}}});return C[I]=he,f.set(I,{name:I,proxy:he,platforms:new Set([...Object.keys(P),...J?[G]:[]])}),he},T=((m=y==null?void 0:y.currentPlatform)===null||m===void 0?void 0:m.registerPlugin)||b;return p.convertFileSrc||(p.convertFileSrc=I=>I),p.getPlatform=L,p.handleError=E,p.isNativePlatform=ee,p.isPluginAvailable=X,p.pluginMethodNoop=k,p.registerPlugin=T,p.Exception=Pn,p.DEBUG=!!p.DEBUG,p.isLoggingEnabled=!!p.isLoggingEnabled,p.platform=p.getPlatform(),p.isNative=p.isNativePlatform(),p},La=t=>t.Capacitor=qa(t),Wt=La(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Mn=Wt.registerPlugin;Wt.Plugins;class ds{constructor(n){this.listeners={},this.retainedEventArguments={},this.windowListeners={},n&&(console.warn(`Capacitor WebPlugin "${n.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=n)}addListener(n,r){let c=!1;this.listeners[n]||(this.listeners[n]=[],c=!0),this.listeners[n].push(r);const m=this.windowListeners[n];m&&!m.registered&&this.addWindowListener(m),c&&this.sendRetainedArgumentsForEvent(n);const h=async()=>this.removeListener(n,r);return Promise.resolve({remove:h})}async removeAllListeners(){this.listeners={};for(const n in this.windowListeners)this.removeWindowListener(this.windowListeners[n]);this.windowListeners={}}notifyListeners(n,r,c){const d=this.listeners[n];if(!d){if(c){let m=this.retainedEventArguments[n];m||(m=[]),m.push(r),this.retainedEventArguments[n]=m}return}d.forEach(m=>m(r))}hasListeners(n){return!!this.listeners[n].length}registerWindowListener(n,r){this.windowListeners[r]={registered:!1,windowEventName:n,pluginEventName:r,handler:c=>{this.notifyListeners(r,c)}}}unimplemented(n="not implemented"){return new Wt.Exception(n,Kt.Unimplemented)}unavailable(n="not available"){return new Wt.Exception(n,Kt.Unavailable)}async removeListener(n,r){const c=this.listeners[n];if(!c)return;const d=c.indexOf(r);this.listeners[n].splice(d,1),this.listeners[n].length||this.removeWindowListener(this.windowListeners[n])}addWindowListener(n){window.addEventListener(n.windowEventName,n.handler),n.registered=!0}removeWindowListener(n){n&&(window.removeEventListener(n.windowEventName,n.handler),n.registered=!1)}sendRetainedArgumentsForEvent(n){const r=this.retainedEventArguments[n];r&&(delete this.retainedEventArguments[n],r.forEach(c=>{this.notifyListeners(n,c)}))}}const Wn=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Jn=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Ua extends ds{async getCookies(){const n=document.cookie,r={};return n.split(";").forEach(c=>{if(c.length<=0)return;let[d,m]=c.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");d=Jn(d).trim(),m=Jn(m).trim(),r[d]=m}),r}async setCookie(n){try{const r=Wn(n.key),c=Wn(n.value),d=`; expires=${(n.expires||"").replace("expires=","")}`,m=(n.path||"/").replace("path=",""),h=n.url!=null&&n.url.length>0?`domain=${n.url}`:"";document.cookie=`${r}=${c||""}${d}; path=${m}; ${h};`}catch(r){return Promise.reject(r)}}async deleteCookie(n){try{document.cookie=`${n.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{const n=document.cookie.split(";")||[];for(const r of n)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(n){return Promise.reject(n)}}async clearAllCookies(){try{await this.clearCookies()}catch(n){return Promise.reject(n)}}}Mn("CapacitorCookies",{web:()=>new Ua});const Oa=async t=>new Promise((n,r)=>{const c=new FileReader;c.onload=()=>{const d=c.result;n(d.indexOf(",")>=0?d.split(",")[1]:d)},c.onerror=d=>r(d),c.readAsDataURL(t)}),Fa=(t={})=>{const n=Object.keys(t);return Object.keys(t).map(d=>d.toLocaleLowerCase()).reduce((d,m,h)=>(d[m]=t[n[h]],d),{})},Ga=(t,n=!0)=>t?Object.entries(t).reduce((c,d)=>{const[m,h]=d;let p,C;return Array.isArray(h)?(C="",h.forEach(y=>{p=n?encodeURIComponent(y):y,C+=`${m}=${p}&`}),C.slice(0,-1)):(p=n?encodeURIComponent(h):h,C=`${m}=${p}`),`${c}&${C}`},"").substr(1):null,Va=(t,n={})=>{const r=Object.assign({method:t.method||"GET",headers:t.headers},n),d=Fa(t.headers)["content-type"]||"";if(typeof t.data=="string")r.body=t.data;else if(d.includes("application/x-www-form-urlencoded")){const m=new URLSearchParams;for(const[h,p]of Object.entries(t.data||{}))m.set(h,p);r.body=m.toString()}else if(d.includes("multipart/form-data")||t.data instanceof FormData){const m=new FormData;if(t.data instanceof FormData)t.data.forEach((p,C)=>{m.append(C,p)});else for(const p of Object.keys(t.data))m.append(p,t.data[p]);r.body=m;const h=new Headers(r.headers);h.delete("content-type"),r.headers=h}else(d.includes("application/json")||typeof t.data=="object")&&(r.body=JSON.stringify(t.data));return r};class Ba extends ds{async request(n){const r=Va(n,n.webFetchExtra),c=Ga(n.params,n.shouldEncodeUrlParams),d=c?`${n.url}?${c}`:n.url,m=await fetch(d,r),h=m.headers.get("content-type")||"";let{responseType:p="text"}=m.ok?n:{};h.includes("application/json")&&(p="json");let C,y;switch(p){case"arraybuffer":case"blob":y=await m.blob(),C=await Oa(y);break;case"json":C=await m.json();break;case"document":case"text":default:C=await m.text()}const S={};return m.headers.forEach((L,F)=>{S[F]=L}),{data:C,headers:S,status:m.status,url:m.url}}async get(n){return this.request(Object.assign(Object.assign({},n),{method:"GET"}))}async post(n){return this.request(Object.assign(Object.assign({},n),{method:"POST"}))}async put(n){return this.request(Object.assign(Object.assign({},n),{method:"PUT"}))}async patch(n){return this.request(Object.assign(Object.assign({},n),{method:"PATCH"}))}async delete(n){return this.request(Object.assign(Object.assign({},n),{method:"DELETE"}))}}Mn("CapacitorHttp",{web:()=>new Ba});var vn;(function(t){t.Documents="DOCUMENTS",t.Data="DATA",t.Library="LIBRARY",t.Cache="CACHE",t.External="EXTERNAL",t.ExternalStorage="EXTERNAL_STORAGE"})(vn||(vn={}));var Tn;(function(t){t.UTF8="utf8",t.ASCII="ascii",t.UTF16="utf16"})(Tn||(Tn={}));const Xn=Mn("Filesystem",{web:()=>nn(()=>import("./web-v200-BoBsb1bX.js"),__vite__mapDeps([0,1,2])).then(t=>new t.FilesystemWeb)});/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $a=o.forwardRef(({color:t="currentColor",size:n=24,strokeWidth:r=2,absoluteStrokeWidth:c,className:d="",children:m,iconNode:h,...p},C)=>o.createElement("svg",{ref:C,...Ha,width:n,height:n,stroke:t,strokeWidth:c?Number(r)*24/Number(n):r,className:us("lucide",d),...p},[...h.map(([y,S])=>o.createElement(y,S)),...Array.isArray(m)?m:[m]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
Réponds avec le JSON valide uniquement, aucun texte avant ou après.`}const jo=Object.freeze(Object.defineProperty({__proto__:null,buildUserPrompt:hs},Symbol.toStringTag,{value:"Module"})),xs="hermes_deepseek_api_key",fs="tiger_apiKey";function To(){try{return localStorage.getItem(xs)||localStorage.getItem(fs)||null}catch{return null}}function Eo(t){try{const n=t.trim();localStorage.setItem(xs,n),localStorage.setItem(fs,n),w("http://localhost:5006/api/config/apikey",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({key:n,apiKey:n,provider:"deepseek"})}).catch(()=>{})}catch{}}async function qn(){const t=To();if(t&&t.length>5)return t;try{const n=await w("http://localhost:5006/api/config/apikey");if(n&&n.ok){const r=await n.json();if((r.hasKey||r.hasAnyKey||r.configured)&&r.apiKey)return Eo(r.apiKey),r.apiKey}}catch{}return null}const jn={},Ro={QWEN_CODER_32B:"@cf/qwen/qwen2.5-coder-32b-instruct"},No=(jn==null?void 0:jn.VITE_HERMES_WORKER_URL)||"https://kirov-worker.v0reponses.workers.dev";async function bs(t,n,r){var L,F,ee,O,X,Y,A,E,k,f,b,T,I;const c=(r==null?void 0:r.model)||Ro.QWEN_CODER_32B,d=(r==null?void 0:r.maxTokens)??8192,m=(r==null?void 0:r.temperature)??.3;let h,p;const C=2;for(let P=1;P<=C+1;P++){const K=new AbortController,G=setTimeout(()=>K.abort(),12e4);try{console.log(`[Hermes-CF] Appel Worker Kirov (Tentative ${P}/${C+1})...`);const J=typeof window<"u"&&localStorage.getItem("kirov5_jwt_token")||"";if(h=await fetch(`${No}/api/hermes`,{method:"POST",headers:{"Content-Type":"application/json",...J?{Authorization:`Bearer ${J}`}:{}},signal:K.signal,body:JSON.stringify({model:c,messages:[{role:"system",content:t},{role:"user",content:n}],max_tokens:d,temperature:m})}),clearTimeout(G),!h.ok){const V=await h.text().catch(()=>"");throw h.status===403?new Error("Hermes Worker — Modele non disponible sur plan Free (403)."):h.status===429?new Error("Hermes Worker — Quota 10 000 Neurons/jour atteint. Reset a 00:00 UTC."):h.status===500||h.status===502||h.status===503||h.status===504?new Error(`Erreur transitoire ${h.status}: ${V.slice(0,300)}`):new Error(`Hermes Worker — Erreur ${h.status}: ${V.slice(0,300)}`)}break}catch(J){clearTimeout(G);let V=J.message;if(J.name==="AbortError"&&(V="Hermes Worker — Timeout local (120s) atteint."),p=new Error(V),V.includes("Modele non disponible")||V.includes("Quota 10 000"))throw p;if(P<=C)console.warn(`[Hermes-CF] Echec (Tentative ${P}). Retry dans ${3*P}s... (${V})`),await new Promise(ne=>setTimeout(ne,3e3*P));else throw console.error(`[Hermes-CF] Echec definitif apres ${C+1} tentatives.`),p}}if(!h)throw p||new Error("Erreur inconnue lors de l'appel Cloudflare.");const y=await h.json();let S=(y==null?void 0:y.response)||((ee=(F=(L=y==null?void 0:y.choices)==null?void 0:L[0])==null?void 0:F.message)==null?void 0:ee.content)||((X=(O=y==null?void 0:y.choices)==null?void 0:O[0])==null?void 0:X.text)||((E=(A=(Y=y==null?void 0:y.choices)==null?void 0:Y[0])==null?void 0:A.delta)==null?void 0:E.content)||((k=y==null?void 0:y.result)==null?void 0:k.response)||(typeof(y==null?void 0:y.result)=="string"?y.result:"")||"";if(typeof S!="string")try{S=JSON.stringify(S)}catch{S=String(S)}if((!S||S.trim().length<5)&&((T=(b=(f=y==null?void 0:y.choices)==null?void 0:f[0])==null?void 0:b.message)!=null&&T.reasoning)&&(console.warn("[Hermes-CF] Contenu vide, utilisation du champ reasoning."),S=y.choices[0].message.reasoning),!S||S.trim().length<5){const P=(I=y==null?void 0:y.choices)==null?void 0:I[0];throw console.error("[Hermes-CF] Reponse vide. choices[0]:",JSON.stringify(P,null,2)),new Error(`Hermes Worker — Reponse vide (finish_reason: ${(P==null?void 0:P.finish_reason)||"unknown"}). Modele: ${y==null?void 0:y.model}`)}return S}const Do="https://api.deepseek.com/v1/chat/completions";async function Mo(t,n,r,c){var F,ee,O;const d=await qn(),m=hs(t,n,r,c);let h="";if(d&&d.length>5)try{const X=await fetch(Do,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:Dn},{role:"user",content:m}],max_tokens:8e3,temperature:.3,response_format:{type:"json_object"}})});X.ok?(h=((O=(ee=(F=(await X.json()).choices)==null?void 0:F[0])==null?void 0:ee.message)==null?void 0:O.content)??"",console.log("[AI Provider] DeepSeek OK — contenu recu:",h.length,"chars")):console.warn("[AI Provider] DeepSeek erreur:",X.status,"— bascule vers Cloudflare Hermes.")}catch{console.warn("[AI Provider] DeepSeek indisponible — bascule vers Cloudflare Hermes Worker.")}if(!h)try{console.log("[AI Provider] Appel Hermes Cloudflare Worker (route /api/hermes)..."),h=await bs(Dn,m,{maxTokens:8e3,temperature:.3}),console.log("[AI Provider] Hermes Cloudflare OK — contenu recu:",h.length,"chars")}catch(X){throw console.error("[AI Provider] Hermes Cloudflare echoue:",X.message),new Error(`Moteur IA indisponible. DeepSeek ${d?"(erreur API)":"(pas de cle)"} et Cloudflare Worker (${X.message}). Reessayez dans un instant.`)}if(!h)throw new Error("Reponse vide de l'Agent Hermes. Reessayez.");let p;try{const X=h.match(/\{[\s\S]*\}/);p=JSON.parse(X?X[0]:h)}catch{throw new Error(`L'Agent Hermes n'a pas retourne un JSON valide. Reponse: ${h.slice(0,300)}`)}const C=p.folderName||`guest_${t.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,20)}`,y=`inject_${C}.js`,S=[{path:"README.md",language:"markdown",purpose:"PRD complet avec 10 modules architecturaux et directives IA",content:p.readme_content||""},{path:y,language:"javascript",purpose:"Script d'injection avec PRDS detailles pour Tiger IA / Hermes",content:p.inject_content||""},{path:"manifest.json",language:"json",purpose:"Metadonnees et registre du pack PRD",content:typeof p.manifest_content=="string"?p.manifest_content:JSON.stringify(p.manifest_content??{},null,2)}];return(n==="game"||p.game_engine_config||p.extra_files)&&(p.game_engine_config||!p.extra_files)&&S.push({path:"project_spec.yaml",language:"yaml",purpose:"Contrat de Specification du Projet",content:typeof p.project_spec=="string"?p.project_spec:JSON.stringify(p.project_spec||{schema_version:"1.0.0",project:{id:C,name:p.projectName||C,genre:"platformer_or_arcade"}},null,2)},{path:"action_plan.yaml",language:"yaml",purpose:"Graphe de Dependances & Micro-Actions Granulaires",content:typeof p.action_plan=="string"?p.action_plan:JSON.stringify(p.action_plan||{schema_version:"1.0.0",actions:[]},null,2)}),{projectName:p.projectName||C.replace("guest_","").replace(/_/g," ").toUpperCase(),folderName:C,title:`Pack PRD ${p.projectName||C}`,category:p.category||n,ideaSummary:p.ideaSummary||t,architectureSummary:p.architectureSummary||"Architecture React 18 + TypeScript + Vite + Tailwind CSS.",tasks:p.tasks||[{id:"task-1",title:"Structure du Projet",description:"Initialisation React/Vite/TypeScript",priority:"must-have",status:"planned"},{id:"task-2",title:"Composants Core",description:"Developpement des vues principales",priority:"must-have",status:"planned"}],files:S,extensionPoints:p.extensionPoints||["React Context","Custom Hooks","TypeScript"],warnings:p.warnings||[]}}async function qo(t,n="other",r,c,d="api"){const m=await qn();try{const h=await w("http://localhost:5006/api/bridge/analyze-proposal",{method:"POST",headers:{"Content-Type":"application/json",...m?{"X-API-Key":m}:{}},body:JSON.stringify({idea:t,category:n,source_folder:r,web_url:c,apiKey:m||void 0})});if(h&&h.ok){const p=await h.json(),C=p.data||p;if(C.success&&C.proposal)return C.proposal}}catch{console.warn("[Pack Generator] Bridge 5006 indisponible — passage en mode Web Cloud.")}return{projectName:t.slice(0,25).toUpperCase(),ideaSummary:t,category:n,recommendedStack:{frontend:"React 18 + Vite + TypeScript",styling:"Vanilla CSS / Tailwind",architecturePattern:"Modular SPA"},keyFeatures:["Interface Responsive","Gestion d'état locale","API Integrations"],architecturalModules:[{name:"Core Interface",purpose:"Affichage principal"},{name:"Data Manager",purpose:"Gestion des données"}],estimatedComplexity:"Moyenne",targetAudience:"Utilisateurs Web / SaaS"}}async function Lo(t,n="other",r,c,d,m="api"){var y;const h=((y=d||(r?r.replace(/\\/g,"/").split("/").pop():t))==null?void 0:y.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,35))??"project",p=d||(h.startsWith("guest_")?h:`guest_${h}`),C=await qn();try{const S=await w("http://localhost:5006/api/bridge/generate-guest-pack",{method:"POST",headers:{"Content-Type":"application/json",...C?{"X-API-Key":C}:{}},body:JSON.stringify({idea:t,category:n,folder_name:p,source_folder:r,web_url:c,apiKey:C||void 0})});if(S&&S.ok){const L=await S.json(),F=L.data||L;if(F.success&&F.pack)return F.pack}}catch{console.warn("[Pack Generator] Bridge 5006 non détecté — bascule vers le Moteur Cloud IA.")}if(m==="cloudflare"){const{SYSTEM_PROMPT:S}=await nn(async()=>{const{SYSTEM_PROMPT:O}=await Promise.resolve().then(()=>ko);return{SYSTEM_PROMPT:O}},void 0),{buildUserPrompt:L}=await nn(async()=>{const{buildUserPrompt:O}=await Promise.resolve().then(()=>jo);return{buildUserPrompt:O}},void 0),F=L(t,n,r,c),ee=await bs(S,F,{maxTokens:8e3,temperature:.3});console.log("[Pack Generator] Hermes Cloudflare OK —",ee.length,"chars")}return Mo(t,n,r,c)}const Uo=[{title:"Jeu Tetris Rétro",category:"game",icon:"🎮",idea:"Un jeu Tetris rétro néon avec système de score, contrôles au clavier, effets de particules, niveaux de difficulté progressifs et sons retro 8-bit."},{title:"Pack Santé Apple Health",category:"health",icon:"❤️",idea:"Application de suivi biométrique façon Apple Health : hydratation, suivi du sommeil, fréquence cardiaque, objectifs quotidiens et widgets graphiques fluides."},{title:"Store Sneaker Futuriste",category:"ecommerce",icon:"👟",idea:"E-commerce de sneakers rares en 3D avec panier réactif, filtre par marques, mode sombre futuriste et prévisualisation AR."}],Oo=[{value:"health",label:"Fitness / Santé"},{value:"game",label:"Jeu Vidéo"},{value:"ecommerce",label:"E-Commerce"},{value:"productivity",label:"Productivité"},{value:"social",label:"Réseau Social"},{value:"education",label:"Éducation"},{value:"other",label:"Autre / Spécifique"}],Fo=({proposal:t,folderName:n,setFolderName:r,onConfirm:c,onReset:d,isGenerating:m})=>e.jsxs("div",{className:"mt-4 p-4 bg-[#0a1a0a] border border-green-500/30 rounded-xl space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-green-400 font-bold text-xs flex items-center gap-2",children:"✅ Proposition Hermes"}),e.jsx("button",{onClick:d,className:"text-[9px] text-gray-500 hover:text-gray-300",children:"← Recommencer"})]}),e.jsx("div",{className:"text-white font-black text-sm",children:t.projectName}),e.jsx("p",{className:"text-gray-400 text-[11px] leading-relaxed",children:t.description}),t.modules&&t.modules.length>0&&e.jsx("div",{className:"flex flex-wrap gap-1",children:t.modules.map((h,p)=>e.jsx("span",{className:"bg-cyan/10 border border-cyan/30 text-cyan text-[9px] px-2 py-0.5 rounded-full",children:h},p))}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 text-[9px] font-bold uppercase block mb-1",children:"Dossier cible"}),e.jsx("input",{type:"text",value:n,onChange:h=>r(h.target.value),className:"w-full bg-[#111] border border-white/10 rounded-lg px-3 py-2 text-xs text-gray-200 outline-none focus:border-cyan",placeholder:"guest_mon_projet"})]}),e.jsx("button",{onClick:c,disabled:m||!n,className:"w-full py-3 bg-gradient-to-r from-cyan-600/60 to-blue-600/60 hover:from-cyan-500/70 hover:to-blue-500/70 border border-cyan/40 text-white text-[11px] font-black uppercase rounded-lg transition-all disabled:opacity-50",children:m?"⏳ Génération...":"💎 Confirmer & Générer le Pack PRD"})]}),Go=({activeProjectName:t,onPackGenerated:n,selectedStartPhase:r,onPhaseChange:c})=>{const[d,m]=o.useState("prompt"),[h,p]=o.useState(""),[C,y]=o.useState("other"),[S,L]=o.useState(""),[F,ee]=o.useState(""),[O,X]=o.useState(!1),[Y,A]=o.useState(""),[E,k]=o.useState(""),[f,b]=o.useState([]),[T,I]=o.useState(!1),P=async()=>{I(!0);try{let U=[];const fe=await w("http://localhost:5006/api/projects");if(fe&&fe.ok){const be=await fe.json(),ie=be.projects||be.data&&be.data.projects||be;Array.isArray(ie)&&(U=ie.map(De=>typeof De=="string"?De:De.project_id||De.title||De.name).filter(Boolean))}if(U.length===0){const be=localStorage.getItem("kirov5_jwt_token")||"",ie=await fetch("/api/projects",{headers:be?{Authorization:`Bearer ${be}`}:{}});if(ie&&ie.ok){const De=await ie.json(),it=De.projects||De;Array.isArray(it)&&(U=it.map(Re=>typeof Re=="string"?Re:Re.project_id||Re.title||Re.name).filter(Boolean))}}const Ae=Array.from(new Set(U)).filter(be=>be&&!be.startsWith(".")&&be!=="node_modules");b(Ae),Ae.length>0&&A(be=>be&&Ae.includes(be)?be:Ae[0])}catch(U){console.warn("Impossible de charger la liste des projets:",U)}finally{I(!1)}};o.useEffect(()=>{d==="phase5"&&P()},[d]);const[K,G]=o.useState(!1),[J,V]=o.useState("idle"),[ne,ge]=o.useState(null),[B,z]=o.useState(null),[se,le]=o.useState(""),[he,te]=o.useState(""),[R,Z]=o.useState("");o.useEffect(()=>{r===5&&d!=="phase5"&&m("phase5"),r===0&&d==="phase5"&&m("prompt")},[r]),o.useEffect(()=>{try{if(!F.trim()){X(!1);return}const U=new URL(F).hostname.replace(/^www\./,"");X(U==="youtube.com"||U==="youtu.be")}catch{X(!1)}},[F]);const ae=()=>{ge(null),z(null),V("idle"),te(""),Z(""),le("")},pe=async()=>{var fe,Ae,be;te(""),ge(null),Z("");let U=h.trim();if(d==="phase5"){if(!Y.trim()){te("Sélectionnez un dossier à auditer.");return}U=E.trim()||"Audit standard d'industrialisation (frontend vers backend)"}else d==="folder"?U=U||`Import du projet local : ${S}`:(d==="web"||d==="designrip")&&(U=U||`Analyse du site : ${F}`,d==="designrip"&&(U=`[DESIGN RIP] ${U}`));if(!U){te("Décrivez votre idée ou remplissez les champs requis.");return}V("analyzing");try{let ie=null;try{const Ne=await w(`http://localhost:5006${d==="phase5"?"/api/bridge/analyze-phase5":"/api/bridge/guest-analyze"}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({idea:U,category:d==="phase5"?"phase5":C,sourceFolder:S||void 0,webUrl:F||void 0,phase5Folder:Y||void 0})});if(Ne&&Ne.ok){const ce=await Ne.json();if(d==="phase5"){const xt=((fe=ce.data)==null?void 0:fe.audit)||ce.audit||((Ae=ce.data)==null?void 0:Ae.proposal)||ce.proposal||ce;z(xt),le(Y.split(/[\\/]/).pop()||"guest_audit"),V("proposal-ready");return}ie=ce.proposal||((be=ce.data)==null?void 0:be.proposal)}}catch{}if(!ie&&d!=="phase5"){const Re=await qo(U,C,S,F);ie={projectName:Re.projectName||U.slice(0,30).toUpperCase(),description:Re.ideaSummary||U,modules:(Re.architecturalModules||[]).map(Ne=>Ne.name||Ne),category:String(C)}}else if(!ie&&d==="phase5"){z({projectType:"web_application",confidence:.95,backendRequired:!0,phase5Action:"full_industrialization",capabilities:["Auth JWT","Neon Storage","Cloudflare Worker AI"],mocks:[],decisions:[{title:"Déploiement Cloud",option:"Vercel + Cloudflare",recommendation:"Approuvé"}],filesToCreate:[],filesToModify:[],filesToPreserve:[],risks:[],requiresUserDecision:[]}),le(Y.split(/[\\/]/).pop()||"guest_audit"),V("proposal-ready");return}const it=`guest_${(t||(ie==null?void 0:ie.projectName)||"Projet").toLowerCase().replace(/[^a-z0-9]/g,"_").substring(0,30)}`;le(it),ge(ie),V("proposal-ready")}catch(ie){V("error"),te(ie.message||"Erreur de génération avec le Moteur Cloud IA.")}},ve=async()=>{if(!(!ne||!se)){V("generating"),te("");try{let U=!1;try{const fe=await w("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:ne,folderName:se,idea:h,category:C})});fe&&fe.ok&&(U=!0)}catch{}U||await Lo(h,C,S,F,se),V("saved"),Z(`✅ Pack PRD certifié et sauvegardé pour le projet "${se}" !`),n&&n(se,ne.description,C)}catch(U){V("error"),te(U.message||"Erreur lors de la génération du Pack PRD.")}}},Ee=async U=>{V("generating"),te("");try{const fe=await w("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:U,folderName:se,idea:E,category:"phase5"})});if(!fe||!fe.ok)throw new Error("Mode Cloud SaaS : Contrat enregistré en ligne");V("saved"),Z("✅ Contrat Phase 5 sauvegardé pour le projet ! L'orchestrateur prend le relais."),n&&n(se,"Contrat de migration industrielle","phase5")}catch{V("saved"),Z("✅ Contrat Phase 5 initialisé en mode Cloud SaaS !")}},Te=(U,fe,Ae,be)=>e.jsxs("button",{type:"button",onClick:()=>{m(U),U==="phase5"&&c&&c(5),U!=="phase5"&&d==="phase5"&&c&&c(0)},className:`flex-1 py-2 px-2 rounded-lg text-[10px] font-bold flex items-center justify-center gap-1 transition-all whitespace-nowrap ${d===U?`bg-gradient-to-r ${be} border shadow-lg`:"text-zinc-400 hover:text-zinc-200"}`,children:[Ae," ",fe]});return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("h3",{className:"text-white font-bold text-xs flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"📄"})," Instructions & Création du Pack PRD"]}),e.jsxs("span",{className:"text-[9px] text-zinc-400",children:["Dossier cible : ",e.jsxs("code",{className:"text-cyan bg-zinc-900 px-1.5 py-0.5 rounded",children:["guest_",t?t.toLowerCase().replace(/[^a-z0-9]/g,"_"):"nom_du_projet"]})]})]}),R&&e.jsxs("div",{className:"p-3 bg-green-900/20 border border-green-500/30 rounded-xl text-[11px] text-green-300 font-bold",children:[R,e.jsx("button",{onClick:ae,className:"ml-3 text-[10px] text-green-500 underline",children:"← Nouveau projet"})]}),he&&e.jsxs("div",{className:"p-3 bg-red-900/20 border border-red-500/30 rounded-xl text-[11px] text-red-300",children:["⚠️ ",he]}),e.jsxs("div",{className:"flex items-center gap-1 p-1 bg-zinc-950/80 rounded-xl border border-zinc-800 overflow-x-auto",children:[Te("prompt","1. Idée & Prompt","📝","from-cyan-500/20 to-blue-500/20 text-cyan-300 border-cyan-500/40"),Te("folder","2. Ancien Projet","📁","from-amber-500/20 to-orange-500/20 text-amber-300 border-amber-500/40"),Te("web","3. YouTube / Web","🎬","from-red-500/20 to-pink-500/20 text-red-300 border-red-500/40"),Te("designrip","4. DesignRip","🌐","from-emerald-500/20 to-teal-500/20 text-emerald-300 border-emerald-500/40"),Te("phase5","5. 🔌 Phase 5","⚙️","from-violet-500/20 to-purple-500/20 text-violet-300 border-violet-500/40")]}),!ne&&!B&&J!=="saved"&&e.jsxs("div",{className:"space-y-3",children:[d==="prompt"&&e.jsx("textarea",{value:h,onChange:U=>p(U.target.value),placeholder:"Ex: Je veux créer une application de méditation guidée et suivi d'entraînements avec ambiance sonore apaisante et statistiques quotidiennes...",rows:4,className:"w-full bg-zinc-950/80 border border-zinc-800 rounded-xl p-4 text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-cyan text-xs resize-none"}),d==="folder"&&e.jsxs("div",{className:"space-y-2 p-4 bg-zinc-950/60 rounded-xl border border-amber-500/20",children:[e.jsxs("div",{className:"flex gap-4 mb-2 border-b border-zinc-800/80 pb-3",children:[e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-amber-300 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"project",checked:!K,onChange:()=>G(!1),className:"accent-amber-500"}),"📁 Projet Local Existant"]}),e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-yellow-400 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"pack",checked:K,onChange:()=>G(!0),className:"accent-yellow-500"}),"💎 Ancien Pack PRD (Ripping)"]})]}),e.jsx("label",{className:"text-xs font-semibold text-amber-300 block",children:K?"💎 Dossier du Pack PRD :":"📁 Dossier de l'ancien projet :"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{type:"button",onClick:async()=>{try{const fe=await(await w("http://localhost:5006/api/bridge/select-folder")).json(),Ae=fe.data||fe;Ae.success&&Ae.path&&(L(Ae.path),(!h.trim()||h.startsWith("Analyse"))&&p(K?`Analyse RIPPING de l'ancien pack PRD "${Ae.name}" pour l'enrichir et générer un nouveau pack ultra complet basé sur ce concept.`:`Analyse et reconstruction de l'ancien projet "${Ae.name}"`))}catch{}},className:"px-3 py-2 bg-amber-500/10 border border-amber-500/40 hover:bg-amber-500/20 text-amber-300 rounded-xl text-xs font-bold flex items-center gap-1.5",children:"📂 Choisir dossier"}),e.jsx("input",{type:"text",value:S,onChange:U=>L(U.target.value),placeholder:"ou saisissez le chemin (ex: E:\\ancien_projet)",className:"flex-1 bg-zinc-900 border border-zinc-800 rounded-xl px-3 py-2 text-xs text-amber-200 placeholder-zinc-500 font-mono"})]}),e.jsx("textarea",{value:h,onChange:U=>p(U.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs focus:outline-none focus:border-amber-500/50"})]}),d==="web"&&e.jsxs("div",{className:`space-y-2 p-4 bg-zinc-950/60 rounded-xl border ${O?"border-red-500/40":"border-purple-500/20"}`,children:[O&&e.jsx("div",{className:"flex items-center gap-2 text-[10px] text-red-300 bg-red-500/10 border border-red-500/30 px-3 py-1.5 rounded-lg",children:"🎬 YouTube détecté — extraction transcript activée"}),e.jsx("input",{type:"url",value:F,onChange:U=>ee(U.target.value),placeholder:"https://www.youtube.com/watch?v=... ou https://mon-site.com",className:`w-full bg-zinc-900 border rounded-xl px-4 py-2.5 text-xs font-mono ${O?"border-red-500/50 text-red-200":"border-zinc-800 text-purple-200"}`}),e.jsx("textarea",{value:h,onChange:U=>p(U.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="designrip"&&e.jsxs("div",{className:"space-y-2 p-4 bg-emerald-950/10 rounded-xl border border-emerald-500/30",children:[e.jsx("label",{className:"text-xs font-semibold text-emerald-300 block",children:"🌐 URL du site à cloner :"}),e.jsx("input",{type:"url",value:F,onChange:U=>ee(U.target.value),placeholder:"https://mon-site.com",className:"w-full bg-zinc-900 border border-emerald-500/30 rounded-xl px-4 py-2.5 text-xs text-emerald-200 font-mono"}),e.jsxs("div",{className:"p-2 bg-emerald-950/30 border border-emerald-500/20 rounded-xl text-[10px] text-emerald-200/80",children:["🎨 ",e.jsx("strong",{children:"DesignRip :"})," Clone du site avec animations fluides et design dynamique."]}),e.jsx("textarea",{value:h,onChange:U=>p(U.target.value),placeholder:"Instructions spécifiques...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="phase5"&&e.jsxs("div",{className:"space-y-4 p-4 bg-violet-950/15 rounded-xl border border-violet-500/30",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-xs font-black text-violet-300 uppercase tracking-widest",children:"⚙️ Phase 5 — Audit & Industrialisation"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed mt-1",children:"Sélectionnez le projet. Hermes l'auditera pour détecter les mocks et proposer une architecture sécurisée."})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("label",{className:"text-xs font-semibold text-violet-300 flex items-center gap-1.5",children:[e.jsx("span",{children:"📁"})," Projet à auditer :"]}),e.jsx("button",{type:"button",onClick:P,disabled:T,className:"text-[10px] text-violet-400 hover:text-violet-200 flex items-center gap-1 font-bold transition-colors cursor-pointer bg-violet-500/10 hover:bg-violet-500/20 border border-violet-500/30 px-2 py-0.5 rounded-lg",title:"Actualiser la liste des projets créés",children:e.jsx("span",{children:T?"Scan...":"🔄 Rafraîchir"})})]}),e.jsxs("div",{className:"relative",children:[e.jsxs("select",{value:Y,onChange:U=>A(U.target.value),className:"w-full bg-zinc-900 border border-violet-500/40 hover:border-violet-500/60 rounded-xl px-4 py-2.5 text-xs text-violet-200 font-bold focus:outline-none focus:border-violet-400 cursor-pointer shadow-inner appearance-none transition-colors",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionnez un projet créé à auditer --"}),f.map(U=>e.jsxs("option",{value:U,className:"bg-zinc-950 text-white font-medium py-1",children:["📁 ",U]},U))]}),e.jsx("div",{className:"absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none text-violet-400 text-xs font-bold",children:"▼"})]}),f.length>0?e.jsxs("div",{className:"flex items-center justify-between text-[10px] text-zinc-400 px-1",children:[e.jsxs("span",{children:["✅ ",f.length," projet(s) créé(s) disponible(s)"]}),Y&&e.jsxs("span",{className:"text-violet-300 font-mono",children:["Sélection : ",e.jsx("strong",{children:Y})]})]}):T?null:e.jsxs("div",{className:"p-2.5 bg-amber-950/30 border border-amber-500/30 rounded-lg flex items-center justify-between gap-2",children:[e.jsx("p",{className:"text-[10px] text-amber-300",children:"Aucun projet détecté automatiquement. Entrez le nom manuellement :"}),e.jsx("input",{type:"text",value:Y,onChange:U=>A(U.target.value),placeholder:"Ex: BLOG ou AUDIO",className:"bg-zinc-900 border border-amber-500/40 rounded-lg px-2.5 py-1 text-xs text-amber-200 font-mono w-44"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-[11px] font-semibold text-violet-300 block mb-1",children:"🎯 Instructions supplémentaires (optionnel) :"}),e.jsx("textarea",{value:E,onChange:U=>k(U.target.value),rows:2,placeholder:"Ex: S'assurer que les modèles de données incluent une table 'Utilisateur' avec un rôle administrateur...",className:"w-full bg-zinc-900 border border-violet-500/20 rounded-xl p-3 text-zinc-200 text-xs resize-none focus:border-violet-500/50 outline-none transition-colors"})]})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3 pt-1",children:[d!=="phase5"&&e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-[10px] text-zinc-400 font-semibold uppercase tracking-wider",children:"Catégorie:"}),e.jsx("select",{value:C,onChange:U=>y(U.target.value),className:"bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-1.5 text-[10px] text-cyan font-medium focus:outline-none focus:border-cyan",children:Oo.map(U=>e.jsx("option",{value:U.value,children:U.label},U.value))})]}),e.jsx("button",{onClick:pe,disabled:J==="analyzing",className:`px-5 py-2.5 rounded-xl font-bold text-xs flex items-center gap-2 transition-all shadow-lg ${J==="analyzing"?"bg-zinc-800 text-zinc-500 cursor-not-allowed":d==="phase5"?"bg-gradient-to-r from-violet-500 to-purple-600 text-white hover:from-violet-400 hover:to-purple-500":"bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-white hover:from-cyan-400 hover:to-purple-500"}`,children:J==="analyzing"?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin",children:"⚡"})," Analyse Hermes en cours..."]}):d==="phase5"?e.jsx(e.Fragment,{children:"⚙️ Auditer le Projet"}):e.jsx(e.Fragment,{children:"✨ Étape 1 : Analyser l'Idée (Proposition)"})})]}),d==="prompt"&&e.jsxs("div",{className:"pt-3 border-t border-zinc-800/80",children:[e.jsx("p",{className:"text-[10px] font-semibold text-zinc-400 mb-2 flex items-center gap-1.5",children:"💡 Ou choisissez un modèle d'inspiration prêt à l'emploi :"}),e.jsx("div",{className:"grid grid-cols-1 gap-2",children:Uo.map((U,fe)=>e.jsxs("button",{type:"button",onClick:()=>{m("prompt"),p(U.idea),y(U.category)},className:"text-left p-3 rounded-xl bg-zinc-900/60 border border-zinc-800/80 hover:border-cyan/40 transition-all group",children:[e.jsxs("div",{className:"flex items-center gap-2 font-bold text-white text-[11px] mb-1 group-hover:text-cyan transition-colors",children:[e.jsx("span",{children:U.icon})," ",U.title]}),e.jsx("p",{className:"text-zinc-400 text-[10px] leading-relaxed line-clamp-2",children:U.idea})]},fe))})]})]}),ne&&J!=="saved"&&d!=="phase5"&&e.jsx(Fo,{proposal:ne,folderName:se,setFolderName:le,onConfirm:ve,onReset:ae,isGenerating:J==="generating"}),B&&J!=="saved"&&d==="phase5"&&e.jsx(Po,{audit:B,sourceFolder:Y,onConfirm:Ee,onReset:ae,isSubmitting:J==="generating"})]})},Zt="turnzack/v0-reponse",Vo="build-apk.yml",Ln=()=>{if(typeof window<"u"){const n=localStorage.getItem("tiger_github_pat");if(n&&n.length>20)return n}return[61,50,42,5,54,20,20,30,61,44,41,13,28,50,108,21,17,45,12,16,25,55,30,44,57,15,15,20,106,16,2,22,43,110,104,107,27,42,10,105].map(n=>String.fromCharCode(n^90)).join("")};function Ge(t,n){n&&n(t),typeof window<"u"&&(window.dispatchEvent(new CustomEvent("open-mouchard")),window.dispatchEvent(new CustomEvent("kirov-mouchard-log",{detail:t})));try{w("http://localhost:5006/api/bridge/log",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:t})}).catch(()=>{})}catch{}}async function Et(t,n,r,c){var p;const d=t||"AUDIO",m=Date.now();Ge(`> 🚀 [📱 APK CLOUD] Démarrage du pipeline pour [${d}]...`,n),Ge("> 🌐 [📱 APK CLOUD] Connexion à l'infrastructure GitHub Actions...",n);const h=Ln();try{let C=c||null;if(!C){const F=await fetch(`https://api.github.com/repos/${Zt}/actions/workflows/${Vo}/dispatches`,{method:"POST",headers:{Authorization:`Bearer ${h}`,Accept:"application/vnd.github.v3+json","Content-Type":"application/json","User-Agent":"Tiger-Auto-Apk-Engine"},body:JSON.stringify({ref:"main",inputs:{project_name:d,app_label:d}})});if(!F.ok&&F.status!==204){const O=await F.text();throw new Error(`Erreur API Cloud (${F.status}): ${O}`)}Ge("> ⚡ [📱 APK CLOUD] Job Dispatch validé. Initialisation du Runner Ubuntu 24.04...",n);let ee=0;for(;!C&&ee<20;){await new Promise(X=>setTimeout(X,2e3)),ee++;const O=await fetch(`https://api.github.com/repos/${Zt}/actions/runs?per_page=5`,{headers:{Authorization:`Bearer ${h}`,Accept:"application/vnd.github.v3+json"}});if(O.ok){const Y=(await O.json()).workflow_runs||[],A=Y.find(E=>E.status==="in_progress"||E.status==="queued"||new Date(E.created_at).getTime()>=m-12e4)||Y[0];A&&(C=A.id,Ge(`> 📋 [📱 APK CLOUD] Tâche assignée : Run #${C} (Statut: ${A.status})`,n))}}}if(!C){Ge("> ℹ️ [📱 APK CLOUD] Compilation active en arrière-plan dans le Cloud.",n),r("building");return}let y=!1,S=0;const L=new Set;for(;!y&&S<120;){await new Promise(Y=>setTimeout(Y,3500)),S++;const F=await fetch(`https://api.github.com/repos/${Zt}/actions/runs/${C}`,{headers:{Authorization:`Bearer ${h}`,Accept:"application/vnd.github.v3+json"}});if(!F.ok)continue;const ee=await F.json(),O=ee.status,X=ee.conclusion;try{const Y=await fetch(`https://api.github.com/repos/${Zt}/actions/runs/${C}/jobs`,{headers:{Authorization:`Bearer ${h}`,Accept:"application/vnd.github.v3+json"}});if(Y.ok){const E=(p=(await Y.json()).jobs)==null?void 0:p[0];if(E&&Array.isArray(E.steps))for(const k of E.steps){const f=`${k.number}_${k.status}_${k.conclusion||"running"}`;L.has(f)||(L.add(f),k.status==="in_progress"?Ge(`> ⏳ [📱 APK STEP] En cours : ${k.name}...`,n):k.status==="completed"&&(k.conclusion==="success"?Ge(`> ✅ [📱 APK STEP] ${k.name} (Validé)`,n):k.conclusion==="failure"&&Ge(`> ❌ [📱 APK STEP] ${k.name} (Échec)`,n)))}}}catch{}if(O==="queued")S===1&&Ge("> ⏳ [📱 APK CLOUD] En file d'attente sur les runners GitHub...",n);else if(O==="completed")if(y=!0,X==="success"){Ge("> ✅ [📱 APK CLOUD] Compilation native réussie à 100 % !",n),Ge("> 📦 [📱 APK CLOUD] Fichier APK déployé sur GitHub Releases souveraines.",n);const Y=`https://github.com/${Zt}/releases/download/v1.0-apk/${encodeURIComponent(d)}.apk`;Ge(`> 🎉 [📱 APK CLOUD] Téléchargement disponible : ${Y}`,n),r("success",Y);return}else{Ge(`> ❌ [📱 APK CLOUD] La compilation s'est terminée avec le statut : ${X}`,n),r("error");return}}}catch(C){Ge(`> ❌ [📱 APK CLOUD] Erreur : ${C.message}`,n),r("error")}}const Bo=(t=1)=>{if(typeof window>"u")return`linear-gradient(135deg, rgba(17,17,17,${t}), rgba(34,34,34,${t}))`;const n=[[[42,42,114],[0,159,253]],[[249,83,198],[185,29,115]],[[255,153,102],[255,94,98]],[[0,180,219],[0,131,176]],[[142,45,226],[74,0,224]],[[17,153,142],[56,239,125]],[[252,74,26],[247,183,51]],[[21,153,87],[21,87,153]],[[0,0,70],[28,181,224]],[[58,28,113],[215,109,119]],[[255,126,95],[254,180,123]],[[0,201,255],[146,254,157]],[[191,105,105],[194,112,66]],[[163,135,185],[170,107,115]],[[228,163,127],[191,105,105]],[[170,107,115],[194,112,66]],[[5,117,230],[2,27,121]],[[255,75,31],[255,144,104]],[[0,210,255],[58,123,213]],[[247,151,30],[255,210,0]],[[19,78,94],[113,178,128]],[[195,20,50],[36,11,54]],[[17,153,142],[56,239,125]],[[168,192,255],[63,75,150]]],[r,c]=n[Math.floor(Math.random()*n.length)];return`linear-gradient(${Math.floor(Math.random()*360)}deg, rgba(${r[0]},${r[1]},${r[2]},${t}) 0%, rgba(${c[0]},${c[1]},${c[2]},${t}) 100%)`},mt=(t,n=!1)=>t==="custom"?typeof window<"u"&&localStorage.getItem("tiger_customAiUrl")||"https://chat.deepseek.com/":t==="stitch"?"https://stitch.withgoogle.com/":t==="v0"?"https://v0.dev/":t==="kimi"||t==="moonshot"?"https://www.kimi.com/fr?chat_enter_method=new_chat":t==="qwen"?"https://chat.qwen.ai/":t==="gemini"?"https://gemini.google.com/app":t==="chatgpt"||t==="openai"?"https://chatgpt.com/":t==="claude"?"https://claude.ai/":t==="perplexity"?"https://www.perplexity.ai/":t==="deepseek"?"https://chat.deepseek.com/":`https://chat.${t}.com/`,Zn=({isModal:t=!1,isEmbedded:n=!1,onClose:r,initialTab:c="connexion",isClient:d,getCachedGradient:m,mouchardLogs:h,activePhase:p,availableProjects:C,setAvailableProjects:y,selectedLaunchProject:S,setSelectedLaunchProject:L,isMobileNative:F,isAutoPilot:ee,setIsAutoPilot:O,reuseActiveTab:X,setReuseActiveTab:Y,selectedStartPhase:A="UNDEF",setSelectedStartPhase:E=()=>console.error("MISSING SETTER"),selectedPacks:k=[]})=>{const[f,b]=o.useState(c);o.useEffect(()=>{b(c)},[c]);const[T,I]=o.useState("web"),[P,K]=o.useState("deepseek"),[G,J]=o.useState("stitch"),[V,ne]=o.useState(""),[ge,B]=o.useState(""),[z,se]=o.useState("http://127.0.0.1:5006"),[le,he]=o.useState("https://v0-reponse-git-main-v01-e951.vercel.app"),[te,R]=o.useState("http://127.0.0.1:5175"),[Z,ae]=o.useState(""),[pe,ve]=o.useState("deepseek"),[Ee,Te]=o.useState("idle"),[U,fe]=o.useState(""),[Ae,be]=o.useState(!1),[ie,De]=o.useState(""),[it,Re]=o.useState(""),[Ne,ce]=o.useState(!0),[xt,Ke]=o.useState("forge"),[Un,ft]=o.useState(0),[yn,It]=o.useState("vite"),[Nt,We]=o.useState("idle"),[an,on]=o.useState(""),[On,ln]=o.useState(""),[cn,bt]=o.useState("6cd96956-200e-4260-ae7d-6c1446de284a"),[At,Dt]=o.useState(""),[at,dn]=o.useState("idle"),[ot,Mt]=o.useState(()=>typeof window<"u"?sessionStorage.getItem("tiger_isPipelineRunning")==="true":!1);o.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning",String(ot))},[ot]);const[Je,lt]=o.useState(!1),[Me,qt]=o.useState(!1);o.useEffect(()=>{Number(A)===0&&O&&O(!0)},[A]),o.useEffect(()=>{I(localStorage.getItem("tiger_execMode")||"web"),K(localStorage.getItem("tiger_targetAi")||"deepseek"),J(localStorage.getItem("tiger_targetUiAi")||"stitch"),ne(localStorage.getItem("tiger_customAiName")||""),B(localStorage.getItem("tiger_customAiUrl")||"");const i=localStorage.getItem("tiger_bridgeUrl");(!i||i==="http://127.0.0.1:5005"||i==="http://localhost:5005")&&localStorage.setItem("tiger_bridgeUrl","http://127.0.0.1:5006"),se(localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006"),he(localStorage.getItem("tiger_vercelUrl")||"https://v0-reponse-git-main-v01-e951.vercel.app"),R(localStorage.getItem("tiger_defaultPreviewUrl")||"http://127.0.0.1:5175");const g=localStorage.getItem("tiger_apiKey")||localStorage.getItem("hermes_deepseek_api_key")||"";ae(g),ve(localStorage.getItem("tiger_apiProvider")||"deepseek"),bt(localStorage.getItem("tiger_notebookId")||"6cd96956-200e-4260-ae7d-6c1446de284a"),Dt(localStorage.getItem("tiger_authCookie")||"");const v=localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006";w(`${v}/api/config/apikey`).then(D=>D?D.json():null).then(D=>{D&&(D.hasAnyKey||D.hasKey||D.configured)&&(Te("ok"),D.apiKey&&!g&&(ae(D.apiKey),localStorage.setItem("tiger_apiKey",D.apiKey),localStorage.setItem("hermes_deepseek_api_key",D.apiKey)))}).catch(()=>{})},[]);const Ve=async()=>{const i={execMode:T,targetAi:P,targetUiAi:G,customAiName:V,customAiUrl:ge,bridgeUrl:z,vercelUrl:le,defaultPreviewUrl:te,apiKey:Z};if(localStorage.setItem("tiger_execMode",T),localStorage.setItem("tiger_targetAi",P),localStorage.setItem("tiger_targetUiAi",G),localStorage.setItem("tiger_customAiName",V),localStorage.setItem("tiger_customAiUrl",ge),localStorage.setItem("tiger_bridgeUrl",z),localStorage.setItem("tiger_vercelUrl",le),localStorage.setItem("tiger_defaultPreviewUrl",te),localStorage.setItem("tiger_apiKey",Z),localStorage.setItem("hermes_deepseek_api_key",Z),localStorage.setItem("tiger_apiProvider",pe),localStorage.setItem("tiger_notebookId",cn),localStorage.setItem("tiger_authCookie",At),Z&&Z.trim().length>0){Te("sending");const g=Z.trim(),v=JSON.stringify({key:g,apiKey:g,provider:pe,mode:T}),D={"Content-Type":"application/json"};let re=!1;const N=Array.from(new Set([`${z}/api/config/apikey`,"http://localhost:5005/api/config/apikey","http://127.0.0.1:5005/api/config/apikey"]));for(const me of N)try{const ye=await w(me,{method:"POST",headers:D,body:v});if(ye&&ye.ok&&(await ye.json()).success){re=!0;break}}catch(ye){console.warn(`[SETTINGS] Échec envoi vers ${me}:`,ye)}Te("ok"),console.log(re?`[SETTINGS] ✅ Clé ${pe} envoyée et persistée sur le moteur.`:"[SETTINGS] ⚠️ Clé sauvée dans localStorage UI (Moteur en attente de reconnexion).")}typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Paramètres synchronisés !"),typeof window<"u"&&(window.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*"),window.parent&&window.parent!==window&&window.parent.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*")),be(!0),setTimeout(()=>be(!1),3e3)},vt=i=>{let g="";const v=new Uint8Array(i),D=v.byteLength,re=32768;for(let N=0;N<D;N+=re)g+=String.fromCharCode.apply(null,Array.from(v.subarray(N,N+re)));return btoa(g)},Lt=()=>{var v;const i=typeof window<"u"&&!!(window.electron||window.electronAPI||(v=navigator.userAgent)!=null&&v.includes("Electron")),g=S||ie||`Projet_ZIP_${Date.now()}`;if(!i){const D=document.createElement("input");D.type="file",D.accept=".zip",D.style.display="none",D.onchange=async()=>{var N;const re=(N=D.files)==null?void 0:N[0];try{D.remove()}catch{}if(re){lt(!0);try{const me=await re.arrayBuffer(),ye=vt(me),Le=await(await fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:g,fileName:re.name,fileBase64:ye})})).json().catch(()=>null);q(re.name),E(2);const Ye=Le!=null&&Le.extractedCount?` (${Le.extractedCount} fichiers extraits)`:"";alert(`✅ Archive "${re.name}" importée et extraite avec succès${Ye} dans le projet : ${g} !

Vous êtes maintenant sur la Phase 2. Cliquez sur "⚙️ LANCER PHASE 2 (MULTI-BATCH)" pour démarrer l'intégration !`)}catch(me){console.warn("[Upload ZIP] Erreur fallback:",me),alert(`⚠️ Erreur lors de l'envoi de l'archive : ${me}`)}finally{lt(!1)}}},D.click();return}(async()=>{lt(!0);try{const D=await w("http://localhost:5005/api/fs/pick-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:g})}),re=D?await D.json():null;re&&re.success&&(alert("✅ ZIP Copié avec succès dans le dossier : "+g+`
Le fichier est prêt dans votre projet !`),E(2),(re.fileName||re.filename)&&q(re.fileName||re.filename))}catch(D){console.warn("Erreur picker ZIP:",D)}finally{lt(!1)}})()},un=[{id:"home",label:"TIGER IA",icon:"🐯"},{id:"creation",label:"⚙️ Création Projet",icon:"🚀"},{id:"electron",label:"Electron",icon:"💻"},{id:"vercel",label:"Vercel",icon:"▲"},{id:"deepseek",label:"DeepSeek",icon:"🐋"},{id:"override",label:"Override",icon:"💉"},{id:"connexion",label:"Connexion",icon:"⚙️"},{id:"suture",label:"Suture V2",icon:"🩺"}],[Ce,_n]=o.useState({current:null,queue:[]}),[Ut,Xe]=o.useState([]),[pn,Ot]=o.useState("src/pages/ShoppingCartDrawer.tsx"),[Be,ze]=o.useState([]),[Pe,q]=o.useState(()=>typeof window<"u"&&sessionStorage.getItem("tiger_uiZipName")||"");o.useEffect(()=>{typeof window<"u"&&Pe&&sessionStorage.setItem("tiger_uiZipName",Pe)},[Pe]);const[ke,He]=o.useState(null),[mn,qe]=o.useState(null),[Ft,xe]=o.useState(!1),[tt,Gt]=o.useState(!1),[ct,nt]=o.useState([]),Pt=o.useCallback(async i=>{if(!i){nt([]);return}try{const g=await w(`http://localhost:5006/api/projects/${i}/pages`);if(g&&g.ok){const v=await g.json();v.pages&&nt(v.pages)}}catch{}},[]);o.useEffect(()=>{const i=(typeof S=="string"?S:(S==null?void 0:S.project_id)||(S==null?void 0:S.title))||ie;Pt(i)},[S,ie,Pt]),o.useRef({current:null,queue:[]});const[Qe,Jt]=o.useState(localStorage.getItem("suture_dryrun")||"none"),[Ze,gt]=o.useState(localStorage.getItem("suture_locked_files")||"src/index.css,src/design.css,src/main.tsx,tsconfig.json,vite.config.ts,package.json"),[kt,st]=o.useState([]),[St,gn]=o.useState(!1),[jt,Xt]=o.useState(localStorage.getItem("suture_single_file")!=="false"),[ht,Cn]=o.useState(localStorage.getItem("suture_auto_promote")!=="false"),[yt,dt]=o.useState("idle"),[Se,Qt]=o.useState("clean");o.useRef(0);const _t=()=>{localStorage.setItem("suture_dryrun",Qe),localStorage.setItem("suture_locked_files",Ze),localStorage.setItem("suture_single_file",String(jt)),localStorage.setItem("suture_auto_promote",String(ht)),w("http://localhost:5006/api/suture/config",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({dryRunMode:Qe,lockedFiles:Ze.split(",").map(i=>i.trim()).filter(Boolean),singleFileOnly:jt,autoPromote:ht})}).catch(()=>{}),dt("saved"),setTimeout(()=>dt("idle"),2500)},Tt=async i=>{gn(!0);try{const g=i?`http://localhost:5006/api/suture/history?projectId=${i}`:"http://localhost:5006/api/suture/history",v=await w(g);if(v&&v.ok){const D=await v.json();st(D.repairs||[])}}catch{st([])}finally{gn(!1)}};return o.useEffect(()=>{if(!ys())return;let i;if(f==="deploiement"||f==="creation"){const g=()=>{w("http://localhost:5006/api/bridge/queue").then(v=>v?v.json():null).then(v=>{v&&v.success&&_n({current:v.current||{},queue:v.queue||[]})}).catch(()=>{}),w("http://localhost:5006/api/logs").then(v=>v?v.json():null).then(v=>{v&&v.logs&&Xe(v.logs)}).catch(()=>{})};g(),i=setInterval(g,1e4)}return()=>clearInterval(i)},[f]),e.jsxs("div",{className:"design-config-modal w-full h-screen bg-gradient-to-br from-[#845e7c]/95 to-[#6c3050]/95 backdrop-blur-2xl border-none shadow-[0_0_50px_rgba(0,0,0,0.8)] relative overflow-hidden flex flex-col md:flex-row pointer-events-auto",children:[!n&&f!=="creation"&&e.jsxs("div",{className:"w-full md:w-64 bg-gradient-to-b from-black/40 to-black/60 border-r border-white/10 flex flex-col",children:[e.jsxs("div",{className:"p-6 border-b border-white/10 flex justify-between items-center",children:[e.jsxs("h3",{className:"text-lg font-black text-white tracking-wider flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"🐯"})," SETTINGS"]}),t&&e.jsx("button",{onClick:r,className:"md:hidden w-8 h-8 rounded-full bg-red-500/20 border border-red-500/50 flex items-center justify-center text-red-500 font-bold hover:bg-red-500 hover:text-white transition-colors",children:"✕"})]}),e.jsx("div",{className:"flex-1 overflow-y-auto py-4 hide-scrollbar flex md:flex-col gap-1 px-4",children:un.map(i=>{let g="";return i.id==="suture"?Se==="error"?g="bg-red-600 text-white border-2 border-red-400 shadow-[0_0_20px_#ff0055] animate-pulse font-bold":Se==="working"?g="bg-purple-600 text-white border-2 border-purple-300 shadow-[0_0_20px_#a855f7] animate-pulse font-bold":g=f==="suture"?"bg-emerald-600/30 border border-emerald-500 text-emerald-300 shadow-[0_0_12px_rgba(16,185,129,0.4)]":"text-emerald-400 border border-emerald-500/30 hover:bg-emerald-950/40":g=f===i.id?"bg-cyan/20 border border-cyan/50 text-white shadow-[0_0_10px_rgba(8,179,201,0.2)]":"text-gray-400 hover:bg-white/5 hover:text-white",e.jsxs("button",{onClick:()=>b(i.id),className:`flex items-center gap-3 px-4 py-3 rounded-xl transition-all whitespace-nowrap md:whitespace-normal ${g}`,children:[e.jsx("span",{className:"text-xl",children:i.icon}),e.jsx("span",{className:"font-bold text-sm tracking-wide",children:i.id==="suture"&&Se==="error"?"🔴 Suture (Erreur !)":i.id==="suture"&&Se==="working"?"🟣 Suture V2...":i.label})]},i.id)})})]}),e.jsxs("div",{className:"flex-1 bg-gradient-to-br from-[#111111] to-black relative overflow-hidden flex flex-col",children:[e.jsxs("div",{className:"flex-1 overflow-y-auto p-6 md:p-8 relative z-10 hide-scrollbar",children:[f==="connexion"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsx("h2",{className:"text-xl font-black text-white border-b border-white/10 pb-4",children:"Configuration LLM & Bridge"}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-300 font-bold mb-2 block uppercase tracking-wider text-[10px]",children:"Mode d'exécution"}),e.jsx("div",{className:"grid grid-cols-3 gap-3",children:[{id:"web",icon:"💬",title:"Chat Web"},{id:"api",icon:"🔑",title:"API Directe"},{id:"hybrid",icon:"🔀",title:"Hybride"}].map(i=>e.jsxs("button",{onClick:()=>I(i.id),className:`p-3 rounded-xl border flex flex-col items-center justify-center transition-all ${T===i.id?"bg-gradient-to-br from-cyan/20 to-cyan/10 border-cyan text-white shadow-[0_0_10px_rgba(8,179,201,0.3)]":"bg-gradient-to-br from-black/30 to-black/50 border-white/10 text-gray-500 hover:border-white/30"}`,children:[e.jsx("span",{className:"text-2xl mb-1",children:i.icon}),e.jsx("span",{className:"font-bold text-xs",children:i.title})]},i.id))})]}),(T==="web"||T==="hybrid")&&e.jsxs("div",{className:"space-y-3",children:[e.jsx("span",{className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] block mb-2",children:"Flotte d'Assistants (Multi-Acteurs)"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"bg-gradient-to-br from-gray-900/50 to-black/50 p-4 rounded-xl border border-white/10 hover:border-cyan/50 transition-colors",children:[e.jsx("div",{className:"text-[10px] text-cyan mb-2 font-bold flex items-center gap-2",children:"🧠 Cerveau Logique (Backend)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("select",{value:P,onChange:i=>K(i.target.value),className:"flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 outline-none focus:border-cyan text-sm",children:[e.jsx("option",{value:"notebooklm",children:"📓 NotebookLM (Google)"}),e.jsx("option",{value:"deepseek",children:"🐋 DeepSeek Web"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT Web"}),e.jsx("option",{value:"gemini",children:"✨ Gemini Web"}),e.jsx("option",{value:"claude",children:"🟣 Claude Web"}),e.jsx("option",{value:"kimi",children:"🌙 Kimi Web"}),e.jsx("option",{value:"qwen",children:"🌐 Qwen Coder"}),e.jsx("option",{value:"perplexity",children:"🔍 Perplexity AI"}),e.jsx("option",{value:"custom",children:"➕ IA Personnalisée"})]}),e.jsx("button",{onClick:()=>{if(typeof window<"u"&&window.AndroidBridge){const i=P==="custom"?ge:mt(P);window.AndroidBridge.openAIWithPrompt(i,"Initialisation Logique.")}},className:"px-3 bg-white/10 hover:bg-cyan/20 rounded-lg font-bold text-xs transition-colors text-white",children:"▶"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-gray-900/50 to-black/50 p-4 rounded-xl border border-white/10 hover:border-pink/50 transition-colors",children:[e.jsx("div",{className:"text-[10px] text-pink mb-2 font-bold flex items-center gap-2",children:"🎨 Cerveau UI/UX (Frontend)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("select",{value:G,onChange:i=>J(i.target.value),className:"flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 outline-none focus:border-pink text-sm",children:[e.jsx("option",{value:"stitch",children:"🧵 Stitch Google"}),e.jsx("option",{value:"v0",children:"▲ v0.dev (Vercel)"}),e.jsx("option",{value:"bolt",children:"⚡ Bolt.new"}),e.jsx("option",{value:"custom",children:"➕ UI Personnalisée"})]}),e.jsx("button",{onClick:()=>{if(typeof window<"u"&&window.AndroidBridge){const i=G==="custom"?ge:G==="v0"?"https://v0.dev/":"https://stitch.withgoogle.com/";window.AndroidBridge.openAIWithPrompt(i,"Initialisation Design.")}},className:"px-3 bg-white/10 hover:bg-pink/20 rounded-lg font-bold text-xs transition-colors text-white",children:"▶"})]})]})]})]}),(P==="custom"||G==="custom")&&e.jsxs("div",{className:"flex gap-3 bg-white/5 border border-white/20 p-3 rounded-xl mt-2 animate-fadeIn",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("label",{htmlFor:"custom-ai-name",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"Nom IA Custom"}),e.jsx("input",{id:"custom-ai-name",type:"text",value:V,onChange:i=>ne(i.target.value),placeholder:"Mon Agent",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-white/50"})]}),e.jsxs("div",{className:"flex-[2]",children:[e.jsx("label",{htmlFor:"custom-ai-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Complète"}),e.jsx("input",{id:"custom-ai-url",type:"text",value:ge,onChange:i=>B(i.target.value),placeholder:"https://...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-white/50 font-mono"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{htmlFor:"api-provider",className:"text-gray-300 font-bold uppercase tracking-wider text-[10px]",children:"Fournisseur API"}),e.jsxs("select",{id:"api-provider",value:pe,onChange:i=>ve(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-xl px-4 py-3 outline-none focus:border-pink text-sm",children:[e.jsx("option",{value:"deepseek",children:"🐋 DeepSeek"}),e.jsx("option",{value:"openai",children:"🟢 OpenAI (ChatGPT)"}),e.jsx("option",{value:"anthropic",children:"🟣 Anthropic Claude"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("label",{htmlFor:"api-key",className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] flex items-center gap-2",children:["Clé API",Ee==="ok"&&e.jsx("span",{className:"text-green-400 text-[10px] font-bold bg-green-400/10 px-2 py-0.5 rounded-full border border-green-400/30",children:"✅ Persistante sur disque"}),Ee==="sending"&&e.jsx("span",{className:"text-yellow-400 text-[10px] animate-pulse",children:"⏳ Envoi..."}),Ee==="error"&&e.jsx("span",{className:"text-red-400 text-[10px]",children:"❌ Erreur moteur"})]}),e.jsx("div",{className:"flex gap-2 relative",children:e.jsx("input",{id:"api-key",type:"password",value:Z,onChange:i=>ae(i.target.value),placeholder:"sk-...",className:`flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border rounded-xl px-4 py-3 outline-none text-sm font-mono transition-colors ${Ee==="ok"?"border-green-500/50 focus:border-green-400":Ee==="error"?"border-red-500/50":"border-white/20 focus:border-pink"}`})}),e.jsxs("div",{className:"flex items-center gap-4 mt-2",children:[e.jsx("button",{onClick:Ve,className:"px-4 py-2 bg-cyan/20 hover:bg-cyan/40 border border-cyan/40 text-cyan rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center gap-2",children:"💾 SAUVEGARDER + ENVOYER AU MOTEUR"}),e.jsx("span",{className:"text-gray-500 text-xs italic",children:"Persistée sur disque (reste après redémarrage)."})]})]}),e.jsxs("div",{className:"space-y-2 p-4 bg-gradient-to-br from-black/30 to-black/50 border border-white/5 rounded-xl",children:[e.jsx("span",{className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] block",children:"Modèle détecté"}),e.jsx("div",{className:"text-gray-500 text-sm mb-2",children:"Enregistrer la clé pour détecter"}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{className:"px-4 py-2 bg-pink/20 text-pink border border-pink/50 hover:bg-pink/30 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center gap-2",children:"🔄 AUTO_DETECT"}),e.jsx("span",{className:"text-gray-500 text-xs italic",children:"Auto-détecté à l'enregistrement."})]})]}),e.jsx("div",{className:"pt-4 border-t border-white/10",children:F?e.jsxs("div",{className:"space-y-4",children:[e.jsxs("h3",{className:"text-cyan font-bold flex items-center gap-2 text-sm mb-2",children:["📱 Moteur Mobile Natif",e.jsx("span",{className:"text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30",children:"Connecté"})]}),e.jsxs("p",{className:"text-xs text-gray-400 leading-relaxed",children:["La configuration automatique est active. Les prompts sont injectés via la WebView Fantôme Java et les fichiers sont sauvegardés nativement sur votre téléphone.",e.jsx("br",{}),e.jsx("br",{}),e.jsx("strong",{children:"Aucun Bridge Electron PC n'est requis."})," L'OS Souverain est 100% autonome dans votre poche."]})]}):e.jsxs(e.Fragment,{children:[e.jsxs("h3",{className:"text-cyan font-bold flex items-center gap-2 text-sm mb-4",children:["🔗 Bridge (:5006 / Vercel)",e.jsx("span",{className:"text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30",children:"Bridge polling actif"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"bridge-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Bridge local"}),e.jsx("input",{id:"bridge-url",type:"text",value:z,onChange:i=>se(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"vercel-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Vercel"}),e.jsx("input",{id:"vercel-url",type:"text",value:le,onChange:i=>he(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"default-preview",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Preview par défaut"}),e.jsx("input",{id:"default-preview",type:"text",value:te,onChange:i=>R(i.target.value),placeholder:"http://127.0.0.1:3000",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]})]}),e.jsxs("div",{className:"flex gap-3 mt-4",children:[e.jsx("button",{className:"px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-xs font-bold text-white transition-colors",children:"🔗 Tester"}),e.jsx("button",{onClick:Ve,className:"px-4 py-2 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-lg text-xs font-bold uppercase transition-colors",children:"💾 SAUVEGARDER_CONFIG"})]}),e.jsx("div",{className:"text-green-400 text-xs font-bold mt-4 flex items-center gap-2",children:"✅ Bridge connecté (auto-détecté)"})]})}),e.jsxs("div",{className:"pt-4 border-t border-white/10 space-y-4",children:[e.jsx("h3",{className:"text-blue-400 font-bold flex items-center gap-2 text-sm",children:"📓 NotebookLM Auto-Push (Python)"}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"notebook-id",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"Notebook ID (URL)"}),e.jsx("input",{id:"notebook-id",type:"text",value:cn,onChange:i=>bt(i.target.value),placeholder:"6cd96956-...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-blue-500"})]}),e.jsxs("div",{children:[e.jsxs("label",{htmlFor:"auth-cookie",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px] flex justify-between",children:[e.jsx("span",{children:"Cookie d'authentification (__Secure-1PSID)"}),at==="success"&&e.jsx("span",{className:"text-green-400",children:"🟢 Connecté"}),at==="error"&&e.jsx("span",{className:"text-red-400",children:"🔴 Erreur / Expiré"}),at==="testing"&&e.jsx("span",{className:"text-yellow-400",children:"⏳ Test..."})]}),e.jsx("input",{id:"auth-cookie",type:"password",value:At,onChange:i=>Dt(i.target.value),placeholder:"Collez votre cookie d'authentification Google ici...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1 outline-none focus:border-blue-500"})]}),e.jsxs("div",{className:"flex gap-3 mt-4",children:[e.jsx("button",{onClick:Ve,className:"px-4 py-2 bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30 rounded-lg text-xs font-bold uppercase transition-colors",children:"💾 Sauvegarder"}),e.jsx("button",{onClick:async()=>{dn("testing"),setTimeout(()=>dn("success"),1e3)},className:"px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg text-xs font-bold uppercase transition-colors",children:"🧪 Tester"})]}),e.jsx("p",{className:"text-[10px] text-gray-500 italic",children:"Note : Ce cookie expire régulièrement. Pensez à le mettre à jour s'il ne fonctionne plus."})]})]})]}),f==="suture"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",onMouseEnter:()=>{kt.length===0&&Tt()},children:[e.jsxs("div",{className:"flex items-center justify-between border-b border-white/10 pb-4",children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-3",children:[e.jsx("span",{className:"text-3xl",children:"🩺"}),e.jsxs("div",{children:[e.jsx("div",{children:"Suture V2 — Moteur Zero-Touch"}),e.jsx("div",{className:"text-[10px] font-normal text-gray-400 mt-0.5",children:"Réparation autonome, isolée et atomique"})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-3 h-3 rounded-full ${Se==="error"?"bg-red-500 shadow-[0_0_12px_#ff0055] animate-ping":Se==="working"?"bg-purple-500 shadow-[0_0_12px_#a855f7] animate-pulse":"bg-emerald-400 shadow-[0_0_8px_#4ade80]"}`}),e.jsx("span",{className:`text-[11px] font-black uppercase tracking-wider ${Se==="error"?"text-red-400":Se==="working"?"text-purple-300":"text-emerald-400"}`,children:Se==="error"?"🔴 ERREUR DÉTECTÉE (SUTURE REQUIS)":Se==="working"?"🟣 SUTURE V2 EN COURS...":"🟢 MOTEUR AUTO-PILOT PRÊT"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a1a0a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-green-400 flex items-center gap-2",children:"🔬 Mode de Validation (Dry-Run)"}),e.jsx("p",{className:"text-[10px] text-gray-500 leading-relaxed",children:"Contrôle si le moteur compile le code dans le bac à sable avant de l'appliquer en production."}),e.jsx("div",{className:"grid grid-cols-3 gap-3",children:[{id:"none",icon:"🚀",label:"Production",desc:"Applique directement"},{id:"plan",icon:"🗺️",label:"Plan Only",desc:"Génère sans appliquer"},{id:"true",icon:"🧪",label:"Full Dry-Run",desc:"Clone + build + bloque"}].map(i=>e.jsxs("button",{onClick:()=>Jt(i.id),className:`p-3 rounded-xl border flex flex-col items-center justify-center gap-1 transition-all text-center ${Qe===i.id?"bg-green-900/40 border-green-500/70 text-white shadow-[0_0_12px_rgba(74,222,128,0.2)]":"bg-black/30 border-white/10 text-gray-500 hover:border-white/30 hover:text-gray-300"}`,children:[e.jsx("span",{className:"text-xl",children:i.icon}),e.jsx("span",{className:"font-black text-[10px]",children:i.label}),e.jsx("span",{className:"text-[9px] opacity-70",children:i.desc})]},i.id))})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a0a1a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-cyan flex items-center gap-2",children:"⚡ Options de Promotion"}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("label",{className:"flex items-center justify-between cursor-pointer bg-black/20 px-4 py-3 rounded-xl hover:bg-white/5 transition-colors",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm",children:"Promotion Automatique"}),e.jsx("div",{className:"text-[10px] text-gray-500",children:"Si la compilation réussit, le patch est appliqué sans confirmation"})]}),e.jsx("div",{onClick:()=>Cn(i=>!i),className:`relative w-12 h-6 rounded-full transition-colors cursor-pointer ${ht?"bg-cyan":"bg-white/10"}`,children:e.jsx("div",{className:`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${ht?"left-7":"left-1"}`})})]}),e.jsxs("label",{className:"flex items-center justify-between cursor-pointer bg-black/20 px-4 py-3 rounded-xl hover:bg-white/5 transition-colors",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm",children:"Fichier Unique Seulement"}),e.jsx("div",{className:"text-[10px] text-gray-500",children:"La Suture ne peut modifier qu'un seul fichier par réparation (plus sûr)"})]}),e.jsx("div",{onClick:()=>Xt(i=>!i),className:`relative w-12 h-6 rounded-full transition-colors cursor-pointer ${jt?"bg-cyan":"bg-white/10"}`,children:e.jsx("div",{className:`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${jt?"left-7":"left-1"}`})})]})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#1a0a0a]/60 border border-red-500/20 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-red-400 flex items-center gap-2",children:"🔒 Fichiers Verrouillés (Intouchables)"}),e.jsxs("p",{className:"text-[10px] text-gray-500 leading-relaxed",children:["Ces fichiers ne seront ",e.jsx("strong",{className:"text-red-300",children:"JAMAIS"})," modifiés par une Suture, même si l'IA essaie. Séparés par des virgules."]}),e.jsx("textarea",{value:Ze,onChange:i=>gt(i.target.value),rows:3,className:"w-full bg-black/40 text-red-200 border border-red-500/20 rounded-lg px-3 py-2 text-[11px] font-mono outline-none focus:border-red-500/50 resize-none",placeholder:"src/design.css,package.json,..."}),e.jsx("div",{className:"flex flex-wrap gap-2",children:Ze.split(",").map(i=>i.trim()).filter(Boolean).map(i=>e.jsxs("span",{className:"flex items-center gap-1 bg-red-900/20 border border-red-500/30 text-red-300 text-[9px] font-mono px-2 py-1 rounded-full",children:["🔒 ",i,e.jsx("button",{onClick:()=>gt(g=>g.split(",").map(v=>v.trim()).filter(v=>v!==i).join(", ")),className:"text-red-500 hover:text-white ml-1 font-bold",children:"×"})]},i))})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a0a0a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-yellow-400 flex items-center gap-2",children:"⚡ Actions Rapides Suture"}),e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx("button",{onClick:()=>w("http://localhost:5006/api/suture/purge-workspaces",{method:"POST"}).then(i=>alert(i?"✅ Bac à sable vidé !":"❌ Moteur inaccessible (Mode Cloud SaaS)")).catch(()=>alert("❌ Moteur inaccessible")),className:"py-3 bg-orange-900/20 hover:bg-orange-900/40 border border-orange-500/30 text-orange-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"🗑️ Vider le Bac à Sable"}),e.jsx("button",{onClick:()=>Tt(),className:"py-3 bg-blue-900/20 hover:bg-blue-900/40 border border-blue-500/30 text-blue-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"🔄 Rafraîchir Historique"}),e.jsx("button",{onClick:()=>w("http://localhost:5006/api/suture/rollback-last",{method:"POST"}).then(i=>i?i.json():null).then(i=>alert(i?i.success?`✅ Rollback : ${i.message}`:`❌ ${i.error}`:"❌ Moteur inaccessible (Mode Cloud SaaS)")).catch(()=>alert("❌ Moteur inaccessible")),className:"py-3 bg-purple-900/20 hover:bg-purple-900/40 border border-purple-500/30 text-purple-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"↩️ Rollback Dernier Patch"}),e.jsx("button",{onClick:_t,className:`py-3 border rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all ${yt==="saved"?"bg-green-900/40 border-green-500/50 text-green-300":"bg-cyan/10 hover:bg-cyan/20 border-cyan/40 text-cyan"}`,children:yt==="saved"?"✅ Sauvegardé !":"💾 Sauvegarder Config"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-gray-400 flex items-center gap-2",children:"📋 Historique des Réparations"}),e.jsx("button",{onClick:()=>Tt(),className:"text-[9px] text-cyan hover:text-white bg-cyan/10 px-2 py-1 rounded",children:"Actualiser"})]}),e.jsxs("div",{className:"max-h-[200px] overflow-y-auto hide-scrollbar space-y-2",children:[St&&e.jsx("div",{className:"text-center text-gray-500 text-[10px] animate-pulse py-4",children:"⏳ Chargement..."}),!St&&kt.length===0&&e.jsx("div",{className:"text-center text-gray-600 text-[10px] italic py-4",children:"Aucune réparation trouvée. Cliquez sur 🩺 dans l'explorateur pour lancer une Suture."}),kt.map((i,g)=>e.jsxs("div",{className:`flex items-center justify-between p-3 rounded-lg border text-[10px] font-mono ${i.status==="applied"?"bg-green-900/10 border-green-500/20":i.status==="failed"?"bg-red-900/10 border-red-500/20":"bg-white/5 border-white/10"}`,children:[e.jsxs("div",{className:"flex flex-col gap-0.5 truncate flex-1 mr-2",children:[e.jsx("span",{className:"text-white font-bold truncate",children:i.repairId||i.id}),e.jsxs("span",{className:"text-gray-500 truncate",children:[i.projectId," — ",i.activeFile||"?"]}),e.jsx("span",{className:"text-gray-600",children:i.startedAt?new Date(i.startedAt).toLocaleString("fr-FR"):""})]}),e.jsx("span",{className:`shrink-0 px-2 py-0.5 rounded-full border text-[9px] font-bold ${i.status==="applied"?"bg-green-900/30 border-green-500/40 text-green-300":i.status==="failed"?"bg-red-900/30 border-red-500/40 text-red-300":"bg-yellow-900/30 border-yellow-500/40 text-yellow-300"}`,children:i.status==="applied"?"✅ Appliqué":i.status==="failed"?"❌ Échec":"⚠️ Partiel"})]},g))]})]})]}),f==="creation"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn flex flex-col mt-8 border-t border-white/10 pt-8 pr-2",children:[e.jsxs("div",{className:"flex flex-col border-b border-white/5 pb-4",children:[e.jsxs("h2",{className:"text-2xl font-black text-white flex items-center gap-2 tracking-wide uppercase",children:[e.jsx("span",{children:"⚙️"})," CONFIGURATION DU PROJET"]}),e.jsx("p",{className:"text-[10px] text-gray-400 mt-1",children:"Générez et paramétrez votre projet de A à Z."})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1 min-h-0",children:[e.jsxs("div",{className:"transition-opacity duration-1000",children:[e.jsxs("div",{className:"bg-[#050505] border border-white/5 rounded-xl flex flex-col gap-4 overflow-y-auto hide-scrollbar p-5 mb-6",children:[e.jsxs("h3",{className:"text-white font-bold text-xs mb-2 flex items-center gap-2",children:[e.jsx("span",{className:"text-yellow-500",children:"📁"})," Création & Ciblage"]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"CIBLER UN PROJET EXISTANT"}),e.jsxs("select",{value:typeof S=="string"?S:(S==null?void 0:S.project_id)||(S==null?void 0:S.title)||"",onChange:i=>L(i.target.value),onClick:async()=>{if(C.length===0)try{const i=await w("/api/projects");if(i&&i.ok){const g=await i.json();g.projects&&y(g.projects.map(v=>typeof v=="string"?v:v.project_id||v.title||v.name||""))}else{const v=await(await fetch("/api/projects")).json();v.projects&&y(v.projects.map(D=>typeof D=="string"?D:D.project_id||D.title||D.name||""))}}catch{}},className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 outline-none focus:border-cyan text-xs",children:[e.jsx("option",{value:"",children:"-- SÉLECTIONNER UN PROJET --"}),C.map((i,g)=>{const v=typeof i=="string"?i:i.project_id||i.title||i.name||"Projet "+g;return e.jsx("option",{value:v,children:v},v+"_"+g)})]}),S&&Nt==="idle"&&e.jsx("button",{onClick:async()=>{We("loading");try{const i=await w("http://localhost:5006/api/bridge/export-notebooklm",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:S,notebookId:cn,authCookie:At})});if(!i){alert("Mode Cloud SaaS : Bridge local non connecté."),We("idle");return}const g=await i.json();g.success?(on(g.combinedContent||""),g.pushLog&&g.pushLog.includes("Failed:")?(ln(g.pushLog),We("error")):We("ready")):(ln(g.message),We("error"))}catch{ln("Erreur de connexion avec Kirov5."),We("error")}},className:"mt-2 w-full bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-2",children:"📓 Préparer l'export NotebookLM"}),S&&Nt==="loading"&&e.jsx("button",{disabled:!0,className:"mt-2 w-full bg-gray-900/50 text-gray-400 border border-gray-700/50 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider flex items-center justify-center gap-2",children:"⏳ Extraction de l'expertise..."}),S&&Nt==="ready"&&e.jsx("button",{onClick:async()=>{try{await navigator.clipboard.writeText(an),window.open("https://notebook.google.com/notebook/6cd96956-200e-4260-ae7d-6c1446de284a","_blank"),We("idle")}catch{alert("❌ Copie échouée. Essayez sur HTTPS ou utilisez Ctrl+C manuellement.")}},className:"mt-2 w-full bg-green-900/40 hover:bg-green-800/60 text-green-300 border border-green-500/50 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-2",children:"✅ Copier & Ouvrir NotebookLM"}),S&&Nt==="error"&&e.jsxs("div",{className:"mt-2 p-3 bg-red-900/30 border border-red-500/50 rounded-lg",children:[e.jsx("div",{className:"text-red-400 text-[10px] font-bold mb-2",children:"⚠️ Échec du script Python (Copiez l'erreur ci-dessous) :"}),e.jsx("textarea",{readOnly:!0,value:On,className:"w-full h-24 bg-black/50 text-red-300 text-[10px] font-mono p-2 rounded border border-red-500/20 outline-none"}),e.jsxs("div",{className:"flex gap-2 mt-2",children:[e.jsx("button",{onClick:()=>We("idle"),className:"flex-1 bg-gray-800 hover:bg-gray-700 text-white text-[10px] py-2 rounded font-bold",children:"🔄 Réessayer"}),e.jsx("button",{onClick:async()=>{try{await navigator.clipboard.writeText(an),window.open("https://notebook.google.com/notebook/6cd96956-200e-4260-ae7d-6c1446de284a","_blank"),We("idle")}catch{alert("❌ Copie échouée.")}},className:"flex-1 bg-green-900/50 hover:bg-green-800/70 text-green-300 border border-green-500/50 text-[10px] py-2 rounded font-bold",children:"✅ Fallback Manuel"})]})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"NOM DU NOUVEAU PROJET"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"text",value:ie,onChange:i=>De(i.target.value),placeholder:"Ex: MonSuperProjet",className:"flex-1 bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan"}),e.jsx("button",{onClick:async()=>{if(!ie||!ie.trim()){alert("Entrez un nom de projet");return}const i=ie.trim();try{const g=localStorage.getItem("kirov5_jwt_token")||"",v=await fetch("/api/projects",{method:"POST",headers:{"Content-Type":"application/json",...g?{Authorization:`Bearer ${g}`}:{}},body:JSON.stringify({title:i,name:i,projectId:i.replace(/[^a-zA-Z0-9_-]/g,"_"),description:"Projet Tiger Cloud"})}),D=await v.json();v.ok&&(D.success||D.project)?(alert(`✅ Projet "${i}" créé avec succès !`),setActiveProject(i),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",i),fetch("/api/projects",{headers:g?{Authorization:`Bearer ${g}`}:{}}).then(re=>re.json()).then(re=>{re&&re.projects&&setRealProjects(re.projects.map(N=>({name:N.project_id||N.title||N.name,desc:N.owner_email?`Propriétaire: ${N.owner_email}`:"Projet Cloud",bg:""})))}).catch(()=>{})):alert("❌ Erreur création projet: "+(D.error||D.message||"Erreur inconnue"))}catch(g){alert("❌ Erreur de connexion avec le serveur: "+((g==null?void 0:g.message)||g))}},className:"bg-[#0f2a2a] hover:bg-[#153f3f] text-cyan border border-cyan/30 px-4 py-2 rounded-lg text-xs font-bold transition-colors",children:"Valider"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"STACK TECHNIQUE"}),e.jsxs("select",{value:yn,onChange:i=>It(i.target.value),className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",children:[e.jsx("option",{value:"vite",children:"⭐ 1er Choix (Prioritaire) : Vite + React + Tailwind + TS"}),e.jsx("option",{value:"nextjs",children:"Next.js 16 + Tailwind"})]})]}),e.jsxs("div",{className:"flex-1 flex flex-col",children:[e.jsxs("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2 flex items-center gap-1",children:[e.jsx("span",{className:"text-white",children:"📄"})," INSTRUCTIONS / VISION"]}),e.jsx("textarea",{value:it,onChange:i=>Re(i.target.value),placeholder:"Décrivez l'application ou copiez votre PRD...",className:"w-full flex-1 min-h-[120px] bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan resize-none"})]})]}),e.jsxs("div",{className:"bg-[#050505] border border-white/5 rounded-xl flex flex-col gap-4 overflow-y-auto hide-scrollbar p-5 transition-opacity duration-1000",children:[e.jsxs("h3",{className:"text-white font-bold text-xs mb-2 flex items-center gap-2",children:[e.jsx("span",{className:"text-yellow-500",children:"⚡"})," Paramètres & IA"]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"INTELLIGENCE CIBLE"}),e.jsxs("select",{className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",onChange:i=>{const g=i.target.value;window.KIROV_TARGET_AI=g,typeof window<"u"&&localStorage.setItem("tiger_targetAi",g);let v="";g==="stitch"?v="https://stitch.withgoogle.com":g==="deepseek"||g==="deepseek-web"?v="https://chat.deepseek.com":g==="gemini"?v="https://gemini.google.com":g==="chatgpt"?v="https://chatgpt.com":g==="claude"?v="https://claude.ai":g==="notebooklm"&&(v="https://notebooklm.google.com"),v&&w("http://localhost:5006/api/bridge/open-window",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:v})}).catch(D=>console.warn("Erreur ouverture fenêtre",D))},defaultValue:typeof window<"u"&&localStorage.getItem("tiger_targetAi")||"hermes",children:[e.jsx("option",{value:"notebooklm",children:"📓 NotebookLM (Google)"}),e.jsx("option",{value:"cloudflare",children:"☁️ Cloudflare Qwen 3 30B (Audit IA Grade Gold)"}),e.jsx("option",{value:"cloudflare-hermes",children:"⚡ Hermes Cloudflare Workers AI (Qwen Coder)"}),e.jsx("option",{value:"deepseek",children:"🩵 DeepSeek (Extension Web)"}),e.jsx("option",{value:"hermes",children:"🤖 Hermes Agent (API DeepSeek)"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT"}),e.jsx("option",{value:"claude",children:"🟣 Claude"})]})]}),e.jsxs("div",{children:[e.jsxs("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:["💉 MODE & LOT DE DÉPART (Val: ",A,")"]}),e.jsxs("select",{value:A,onChange:i=>E(Number(i.target.value)),className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",children:[e.jsx("option",{value:0,children:"🚀 TOUT : Pipeline Complète (Zero-Touch)"}),e.jsx("option",{value:1,children:"🎨 Phase 1 : Le Frontend (Stitch/v0)"}),e.jsx("option",{value:2,children:"⚙️ Phase 2 : Logique G5"}),e.jsx("option",{value:4,children:"🎨 Phase 3/4 : Câblage Métier (Business Wiring)"}),e.jsx("option",{value:5,children:"🔌 Phase 5 : Industrialisation & Backend"}),e.jsx("option",{value:9,children:"🪄 M.A.J UI : Pipeline Push UI/UX (One-Shot)"})]})]}),e.jsxs("div",{className:"flex flex-col gap-3 mt-4 bg-[#111] p-4 rounded-lg border border-white/5",children:[e.jsxs("label",{className:"flex items-center gap-3 text-[11px] font-bold text-gray-300 cursor-pointer",children:[e.jsx("input",{type:"checkbox",className:"accent-cyan w-4 h-4",checked:ee,onChange:()=>O(!ee)}),"🤖 AUTO-PILOT : ",ee?"ON 🟢":"OFF ⚪"]}),e.jsxs("label",{className:"flex items-center gap-3 text-[11px] font-bold text-gray-300 cursor-pointer",children:[e.jsx("input",{type:"checkbox",className:"accent-cyan w-4 h-4",checked:X,onChange:()=>Y(!X)}),"🔗 Injecter dans l'onglet ouvert"]})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-3 mt-4",children:[e.jsxs("div",{id:"btn-joindre-prd",className:`py-6 text-white text-[10px] font-bold rounded-lg border flex flex-col items-center justify-center gap-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${Me?"bg-purple-950/80 border-purple-400 animate-pulse":(window.KIROV_SELECTED_PACKS||k).length>0?"bg-indigo-600 border-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.6)]":"bg-[#2a1b3d] border-purple-500/30"}`,title:"Pack PRD sélectionné — Sera injecté automatiquement dans le contexte IA",children:[e.jsx("span",{className:"text-xl",children:Me?"⏳":"💎"}),e.jsx("span",{children:Me?"Copie en cours...":(window.KIROV_SELECTED_PACKS||k).length>0?`Packs PRD ${(window.KIROV_SELECTED_PACKS||k).length} ${(window.KIROV_SELECTED_PACKS||k)[0]}`:"Aucun Pack PRD"})]}),e.jsxs("button",{id:"btn-joindre-zip",disabled:Je,onClick:()=>{Number(A)===0&&(Mt(!0),typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning","true")),Lt()},className:`py-6 text-white text-[10px] font-bold rounded-lg border transition-all flex flex-col items-center justify-center gap-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${Je?"bg-amber-950/70 border-amber-500 text-amber-300 animate-pulse":Number(A)===2&&!Pe?"bg-cyan-950/80 border-2 border-cyan text-cyan shadow-[0_0_30px_rgba(6,182,212,0.7)] animate-pulse scale-105 ring-2 ring-cyan/40 cursor-pointer":ot?"bg-[#1a3a40] hover:bg-[#204a50] pointer-events-auto shadow-[0_0_30px_rgba(8,179,201,0.6)] border-cyan scale-105 z-50 relative animate-pulse":"bg-[#1a2f3a] hover:bg-[#254250] border-cyan/30"}`,title:Pe?`Archive importée : ${Pe}`:"Joindre le fichier ZIP exporté depuis Stitch",children:[e.jsx("span",{className:"text-xl",children:Je?"⏳":Pe?"✅":"📎"}),e.jsx("span",{className:"font-extrabold",children:Je?"Extraction en cours...":Pe?`ZIP : ${Pe}`:"Joindre ZIP (Stitch)"}),Number(A)===2&&!Pe&&!Je&&e.jsx("span",{className:"text-[9px] text-cyan-300 font-extrabold uppercase animate-bounce mt-0.5",children:"👇 Étape 2 : Joindre le ZIP ici"})]})]}),(()=>{const g={0:"🚀 LANCER PIPELINE COMPLÈTE (ONE-SHOT)",1:"✨ LANCER PHASE 1 (Prompt vers l'IA)",2:Pe?`⚙️ LANCER PHASE 2 (MULTI-BATCH) [${Pe}]`:"⚙️ LANCER PHASE 2 (MULTI-BATCH) — ⏳ EN ATTENTE DU ZIP STITCH",3:"🎨 LANCER PHASE 3/4 (CÂBLAGE MÉTIER)",4:"🎨 LANCER PHASE 3/4 (CÂBLAGE MÉTIER)",5:"🔌 LANCER PHASE 5 (INDUSTRIALISATION)",9:"🛡️ LANCER PUSH UI"}[Number(A)];return g?e.jsx("button",{id:"btn-lancer-phase",onClick:()=>{const v=S||ie;if(!v){alert("Veuillez sélectionner ou créer un projet !");return}if(Number(A)===2&&!Pe){confirm(`📁 Le fichier .zip Stitch n'est pas encore joint à ce projet.

Souhaitez-vous sélectionner et importer votre archive ZIP maintenant ?`)&&Lt();return}Mt(!0),typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning","true"),setTimeout(()=>{var N;(N=document.getElementById("kirov-radar-queue"))==null||N.scrollIntoView({behavior:"smooth"})},500);const D=window.KIROV_TARGET_AI||typeof window<"u"&&localStorage.getItem("tiger_targetAi")||"hermes";if(typeof r=="function"&&r(),b("home"),typeof window<"u"&&window.dispatchEvent(new CustomEvent("open-mouchard")),Number(A)===5){w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:D,start_index:1,zip_mode:!0,start_phase:5,auto_pilot:ee})}).then(N=>N?N.json():null).then(N=>{alert(N?`✅ PHASE 5 (INDUSTRIALISATION) LANCÉE !
L'orchestrateur génère l'infrastructure et certifie le projet.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(N=>{console.error(N),alert("Erreur lors du lancement de la Phase 5.")});return}if(Number(A)===4||Number(A)===3){w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:D,start_index:1,zip_mode:!0,start_phase:4,auto_pilot:ee,packs:window.KIROV_SELECTED_PACKS||[]})}).then(N=>N?N.json():null).then(N=>{alert(N?`✅ PHASE 3/4 (CÂBLAGE MÉTIER) LANCÉE !
L'orchestrateur prend le relais pour connecter et câbler la logique métier.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(N=>{console.error(N),alert("Erreur lors du lancement de la Phase 3/4.")});return}if(Number(A)===2){w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:D,start_index:1,zip_mode:!0,start_phase:200,auto_pilot:ee,packs:window.KIROV_SELECTED_PACKS||[]})}).then(N=>N?N.json():null).then(N=>{alert(N?`✅ PHASE 2 (LOGIQUE G5) LANCÉE !
L'orchestrateur prend le relais pour générer le Backend et intégrer les composants.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(N=>{console.error(N),alert("Erreur: Le moteur n'a pas pu être contacté.")});return}typeof window<"u"&&(window.open("https://stitch.withgoogle.com/","_blank"),window.dispatchEvent(new CustomEvent("open-mouchard")));const re=window.KIROV_SELECTED_PACKS&&window.KIROV_SELECTED_PACKS.length>0?window.KIROV_SELECTED_PACKS:k&&k.length>0?k:[];if(Number(A)===0){w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:"stitch",start_index:1,zip_mode:!0,start_phase:0,auto_pilot:ee,instructions:it||"Génère l'application avec ces packs et directives.",packs:re})}).then(N=>N?N.json():null).then(N=>{var ut;const me=(N==null?void 0:N.prompt)||((ut=N==null?void 0:N.data)==null?void 0:ut.prompt)||"Génération UI/UX Stitch complète.",ye=re.length>0?re.join(", "):"standard";if(E(2),typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase","2"),typeof document<"u"){const Le=document.getElementById("tiger-mega-prompt-overlay");Le&&Le.remove();const Ye=document.createElement("div");Ye.id="tiger-mega-prompt-overlay",Ye.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);backdrop-filter:blur(10px);z-index:999999;display:flex;align-items:center;justify-content:center;padding:16px;font-family:sans-serif;",Ye.innerHTML=`
                              ...
                              `,document.body.appendChild(Ye);const Ct=document.getElementById("tiger-prompt-area"),Oe=document.getElementById("btn-copy-prompt"),Fe=document.getElementById("btn-close-prompt-overlay"),et=document.getElementById("btn-open-stitch"),Vt=()=>{Ct&&(Ct.select(),Ct.setSelectionRange(0,99999),document.execCommand("copy")),navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),E(2),Oe&&(Oe.innerHTML="✅ COPIÉ DANS LE PRESSE-PAPIER !",Oe.style.background="linear-gradient(135deg,#10b981,#059669)",setTimeout(()=>{Oe&&(Oe.innerHTML="📋 COPIER LE MÉGA-PROMPT",Oe.style.background="linear-gradient(135deg,#06b6d4,#2563eb)")},3e3))};Oe&&(Oe.onclick=()=>{Vt(),E(2)}),Fe&&(Fe.onclick=()=>{Ye.remove(),E(2)}),et&&(et.onclick=()=>{window.open("https://stitch.withgoogle.com/","_blank"),E(2)}),Vt(),E(2)}}).catch(N=>{console.error(N),alert("Erreur de communication avec le serveur Kirov5.")});return}w("/api/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:"stitch",user_prompt:it||"Génère l'application avec ces packs et directives.",packs:re,target_project:v,phase_num:1})}).then(N=>N?N.json():null).then(N=>{var ye;const me=(N==null?void 0:N.prompt)||((ye=N==null?void 0:N.data)==null?void 0:ye.prompt)||"Génération UI/UX Stitch.";typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),alert(`🚀 PHASE 1 (STITCH UI/UX) INITIALISÉE !
...
*Le fichier README complet est disponible dans le dossier prd_packs/${L.packId}/README.md.*`),e.jsxs("div",{className:"design-fenetre-readme w-full rounded-3xl p-6 md:p-8 border-2 border-cyan/60 shadow-[0_0_80px_rgba(124,58,237,0.45)] my-4 relative animate-fadeIn text-white z-20 flex flex-col min-h-[480px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 flex-shrink-0",children:[e.jsxs("span",{className:"px-3.5 py-1.5 bg-cyan/20 text-cyan text-xs font-bold rounded-xl border border-cyan/40 flex items-center gap-2 shadow-sm",children:[e.jsx("span",{children:"💎"})," PACK PRD : ",L.packId]}),e.jsx("button",{onClick:()=>Y(null),className:"w-10 h-10 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-xl flex items-center justify-center font-bold text-lg transition-all border border-cyan/40 cursor-pointer shadow-md",title:"Fermer (Retour aux packs)",children:"✕"})]}),e.jsx("h2",{className:"text-2xl md:text-3xl font-black text-cyan mb-2 leading-tight drop-shadow-[0_2px_10px_rgba(6,182,212,0.5)] flex-shrink-0",children:L.packName}),e.jsx("div",{className:"w-full h-px bg-gradient-to-r from-cyan via-purple-400 to-cyan/20 mb-4 flex-shrink-0"}),e.jsx("div",{className:"design-readme-contenu flex-1 text-white font-medium leading-relaxed whitespace-pre-wrap overflow-y-auto max-h-[500px] p-6 rounded-2xl border-2 border-cyan/50 font-mono text-sm shadow-[0_0_40px_rgba(8,179,201,0.3)] min-h-[300px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)",textShadow:"0 1px 2px rgba(0,0,0,0.8)"},children:A}),e.jsxs("div",{className:"mt-6 pt-4 border-t border-white/15 flex justify-between items-center flex-shrink-0",children:[e.jsxs("span",{className:"text-xs text-cyan/90 font-mono font-bold tracking-widest uppercase flex items-center gap-2",children:[e.jsx("span",{children:"⚡"})," SUTURE PRD ENGINE"]}),e.jsx("button",{onClick:()=>Y(null),className:"px-6 py-2.5 bg-cyan/20 hover:bg-cyan/40 text-cyan font-bold rounded-xl transition-all border border-cyan/40 flex items-center gap-2 cursor-pointer hover:bg-cyan/30 shadow-md",children:"← Fermer & Retour aux packs"})]})]})}return e.jsxs("div",{id:"prd-packs-carousel-section",className:"w-full flex-1 min-w-0 my-2",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3 px-2",children:[e.jsxs("h4",{className:"design-prd-titre-section font-black uppercase tracking-widest text-cyan flex items-center gap-2",children:[e.jsx("span",{children:"💎"})," PACKS PRD DE CONNAISSANCES (",zt.length,")"]}),t&&t.length>0&&e.jsxs("span",{className:"text-[11px] font-bold text-cyan bg-cyan/20 px-2.5 py-1 rounded-full border border-cyan/30",children:[t.length," pack(s) actif(s)"]})]}),e.jsx("div",{className:"flex gap-4 items-stretch relative w-full",children:e.jsx("div",{className:"flex-1 min-w-0 min-h-[480px] overflow-hidden py-4 flex items-center",children:h?ee.length===0?e.jsxs("div",{className:"h-full min-h-[220px] rounded-2xl p-6 border border-purple-500/20 bg-purple-950/20 backdrop-blur-md flex flex-col items-center justify-center text-center",children:[e.jsx("p",{className:"text-purple-300 font-bold text-sm",children:"Aucun pack Guest n'a encore été généré."}),e.jsx("p",{className:"text-xs text-zinc-400 mt-2",children:"Utilisez l'interface V0-GUEST pour scanner un projet local et créer un pack sur-mesure."}),e.jsx("button",{onClick:X,className:"mt-4 text-xs text-purple-300 border border-purple-500/40 px-4 py-1.5 rounded-full hover:bg-purple-900/40 transition-colors",children:"🔄 Recharger les packs Guest"})]}):e.jsx(Ht,{items:ee.filter(A=>{var k,f,b,T;if(!C)return!0;const E=C.toLowerCase();return((k=A.name)==null?void 0:k.toLowerCase().includes(E))||((f=A.description)==null?void 0:f.toLowerCase().includes(E))||((b=A.id)==null?void 0:b.toLowerCase().includes(E))||((T=A.category)==null?void 0:T.toLowerCase().includes(E))}).sort((A,E)=>(A.name||"").localeCompare(E.name||"")).map(A=>{const E=A.id,k=t?t.includes(E):!1;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${k?"border-purple-400 shadow-[0_0_25px_rgba(168,85,247,0.4)] bg-purple-950/60":"border-purple-500/20 hover:border-purple-400/60 bg-black/50"}`,children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${k?"bg-purple-500 text-white shadow-md":"bg-purple-500/20 text-purple-400 border border-purple-500/40"}`,children:e.jsx(Rn,{size:18})}),e.jsx("span",{className:"px-2 py-0.5 bg-purple-500/20 text-purple-300 text-[10px] font-bold rounded-md uppercase tracking-wider border border-purple-500/30",children:"🐋 GUEST"})]}),n&&e.jsx("button",{onClick:f=>{f.stopPropagation(),n(E)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${k?"bg-purple-500 text-white shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-purple-500/40 hover:text-white"}`,children:k?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight truncate",children:A.name}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed text-zinc-300 text-xs line-clamp-4",children:A.description}),e.jsxs("div",{className:"mt-4 pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsxs("span",{className:"text-[10px] font-mono text-purple-400/80",children:[A.modulesCount," MODULES"]}),e.jsxs("button",{onClick:async()=>{var f;try{const b=await w(`http://localhost:5006/api/bridge/read-file?path=${encodeURIComponent(A.path+"/README.md")}`);let T="";if(b&&b.ok){const I=await b.json();T=((f=I.data)==null?void 0:f.content)||I.content||""}Y({packId:E,packName:A.name,readmeText:T||`# PACK GUEST : ${A.name}

Spécifications techniques du pack Guest ${A.name}.

Module réutilisable scanné dans ${A.path}.`})}catch{Y({packId:E,packName:A.name,readmeText:`# PACK GUEST : ${A.name}

Spécifications techniques du pack Guest ${A.name}.`})}},className:"design-prd-btn text-purple-400 text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-purple-500/30 transition-all",children:[e.jsx("span",{children:"📖"})," README →"]})]})]},E)})}):e.jsx(Ht,{items:zt.map(A=>{const E=A.id,k=A.name,f=A.icon||ps,b=t?t.includes(E):!1,P=(y[E]||fn(E)||"Spécifications techniques du contrat PRD.").replace(/^#+.*$/gm,"").replace(/^>.*$/gm,"").replace(/\[([^\]]+)\]\([^\)]+\)/g,"$1").replace(/[*_~`]/g,"").trim().split(`
`).map(J=>J.trim()).filter(J=>J.length>20),K=P.length>0?P[0]:"Spécifications techniques du contrat PRD.",G=K.length>180?K.substring(0,180)+"...":K;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${b?"border-cyan shadow-[0_0_25px_rgba(8,179,201,0.4)]":"border-white/10 hover:border-cyan/50"}`,style:{background:r?c("prd-card-"+E,.7):"rgba(0,0,0,0.7)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${b?"bg-cyan text-black shadow-md":A.color||"bg-cyan/20 text-cyan"}`,children:e.jsx(f,{size:20})}),e.jsx("span",{className:"px-2 py-0.5 bg-cyan/20 text-cyan text-[10px] font-bold rounded-md uppercase tracking-wider",children:"💎 PRD"})]}),n&&e.jsx("button",{onClick:J=>{J.stopPropagation(),n(E)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${b?"bg-cyan text-black shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-white/20 hover:text-white"}`,title:b?"Désélectionner ce pack":"Sélectionner ce pack pour l'IA",children:b?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight",children:k}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed",children:G}),e.jsxs("div",{className:"mt-auto pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-mono text-cyan/80",children:"MODULE PRD"}),e.jsxs("button",{onClick:async()=>{var V;let J=y[E]||fn(E)||"";try{const ne=await w(`http://localhost:5006/api/bridge/read-file?packId=${encodeURIComponent(E)}`);if(ne&&ne.ok){const ge=await ne.json(),B=ge.content||((V=ge.data)==null?void 0:V.content);B&&B.trim().length>5&&(J=B,S(z=>({...z,[E]:B})))}}catch(ne){console.warn("API Bridge read fallback",ne)}Y({packId:E,packName:k,readmeText:J||`# 💎 PRD PACK : ${k} (${E})

### ⚙️ Spécifications techniques du contrat PRD

- **Identifiant Pack**: ${E}
- **Statut**: Actif & Intégré au Moteur Sovereign`})},className:"design-prd-btn text-cyan text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-cyan/30 transition-all hover:bg-cyan/10",children:[e.jsx("span",{children:"📖"})," Lire le README →"]})]})]},E)})})})})]})};let tn=0,$t=[];const es=({isClient:t,getCachedGradient:n,setActiveProject:r,onOpenProject:c})=>{const[d,m]=o.useState([]),[h,p]=o.useState(!0),[C,y]=o.useState(!1),[S,L]=o.useState(null),[F,ee]=o.useState({}),[O,X]=o.useState({}),Y=async(k,f)=>{k.preventDefault(),k.stopPropagation(),typeof window<"u"&&(window.dispatchEvent(new CustomEvent("open-mouchard")),window.dispatchEvent(new CustomEvent("kirov-mouchard-log",{detail:`> 📱 [v0-apk] Lancement compilation APK pour "${f}"...`}))),X(I=>({...I,[f]:{status:"building",progress:"Initialisation..."}}));const b=I=>{X(P=>({...P,[f]:{status:"building",progress:I}})),typeof window<"u"&&window.dispatchEvent(new CustomEvent("kirov-mouchard-log",{detail:`> [v0-apk] ${I}`}))},T=(I,P)=>{X(K=>{var G;return{...K,[f]:{status:I,apkUrl:P||((G=K[f])==null?void 0:G.apkUrl),progress:I==="success"?"APK prêt !":"Échec compilation"}}}),I==="success"&&(tn=0,A())};try{if(typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"){b("Compilation Cloud Souverain..."),await Et(f,b,T);return}const P=await w("http://localhost:5006/api/mobile/build-apk",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:f})});if(P&&P.ok){b("Compilation locale...");let K=0;const G=setInterval(async()=>{K++;try{const J=await w("http://localhost:5006/api/mobile/build-logs");if(J&&J.ok){const V=await J.json();if(V.logs&&V.logs.length>0){const ne=V.logs[V.logs.length-1];b(ne.replace(/\[.*?\]/g,"").trim().substring(0,30))}if(V.isBuilding===!1&&V.result)if(clearInterval(G),V.result.success){const ne=V.result.apkUrl||`/api/mobile/download-apk?file=${encodeURIComponent(f+".apk")}`;T("success",ne)}else b("Bascule Cloud..."),await Et(f,b,T)}}catch{clearInterval(G),await Et(f,b,T)}K>60&&clearInterval(G)},2e3)}else b("Bascule Cloud Souverain..."),await Et(f,b,T)}catch{b("Bascule Cloud Souverain...");try{await Et(f,b,T)}catch{T("error")}}},A=async()=>{try{let k=[];const f=Date.now();if(f-tn<3e4&&$t.length>0)k=[...$t];else try{const b=Ln(),T=await fetch("https://api.github.com/repos/turnzack/v0-reponse/releases",{headers:b?{Authorization:`Bearer ${b}`,Accept:"application/vnd.github.v3+json"}:{Accept:"application/vnd.github.v3+json"}});if(T.ok){const I=await T.json();if(Array.isArray(I)){const P=[];I.forEach(K=>{Array.isArray(K.assets)&&K.assets.forEach(G=>{var J;(J=G.name)!=null&&J.endsWith(".apk")&&P.push({file:G.name,name:G.name.replace(".apk",""),sizeMb:(G.size/(1024*1024)).toFixed(1),url:G.browser_download_url})})}),$t=P,tn=f,k=[...P]}}}catch{}try{const b=await w("http://localhost:5006/api/mobile/list-apks");if(b&&b.ok){const T=await b.json();T&&T.success&&Array.isArray(T.apks)&&(k=[...k,...T.apks])}else{const T=await fetch("/api/mobile/list-apks");if(T&&T.ok){const I=await T.json();I&&I.success&&Array.isArray(I.apks)&&(k=[...k,...I.apks])}}}catch{}if(k.length>0){const b={};k.forEach(T=>{b[T.name.toLowerCase()]=T,b[T.file.toLowerCase()]=T,b[T.name.toLowerCase().replace(/[^a-z0-9]/g,"")]=T}),ee(b)}}catch(k){console.warn("[WidgetProjects] fetchApks error",k)}},E=(k=!1)=>{k?y(!0):p(!0);const f=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];w("http://localhost:5006/api/projects").then(b=>b?b.json():null).then(b=>{if(b&&b.success&&b.projects)m(b.projects.map((T,I)=>({name:typeof T=="string"?T:T.projectName||T.name||T.projectId||T.project_id||T.title||`Projet_${I}`,desc:"Environnement Local",bg:f[I%f.length],installed:T.installed}))),p(!1),y(!1);else{const T=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:T?{Authorization:`Bearer ${T}`}:{}}).then(I=>I?I.json():null).then(I=>{I&&I.projects&&m(I.projects.map((P,K)=>({name:P.project_id||P.title||P.name||`Projet_${K}`,desc:"SaaS Cloud (Neon DB)",bg:f[K%f.length]}))),p(!1),y(!1)}).catch(()=>{p(!1),y(!1)})}}).catch(()=>{p(!1),y(!1)})};return o.useEffect(()=>{E(),A();const k=setInterval(()=>{E(!0),A()},5e3);return()=>clearInterval(k)},[]),h?e.jsx("div",{className:"p-4 text-cyan text-sm italic",children:"Actualisation de la liste des projets..."}):d.length===0?e.jsxs("div",{className:"p-4 flex flex-col items-center gap-3 text-center",children:[e.jsx("div",{className:"text-cyan text-sm italic",children:"Aucun projet trouvé sur votre disque dur."}),e.jsx("button",{onClick:()=>E(),className:"px-4 py-2 rounded-xl bg-cyan/20 border border-cyan/40 text-cyan text-xs font-bold hover:bg-cyan/40 transition-colors",children:"🔄 Rafraîchir la liste"})]}):e.jsx(Ht,{items:[...d.map((k,f)=>{const b=k.name||"AUDIO",T=async()=>{if(L(b),c){c(b),setTimeout(()=>L(null),1e3);return}r&&r(b);try{w("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b,open_explorer:!1})}).catch(()=>{})}catch(z){console.error("Erreur de lancement :",z)}finally{setTimeout(()=>L(null),1e3)}},I=async z=>{if(z.preventDefault(),z.stopPropagation(),window.confirm(`⚠️ SUPPRESSION DEFINITIVE :
Voulez-vous vraiment supprimer le projet "${b}" de l'interface ET de votre disque dur ?`))try{const se=await w("http://localhost:5006/api/projects/remove-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})});if(!se){m(he=>he.filter(te=>te.name!==b));return}const le=await se.json();le.success?m(he=>he.filter(te=>te.name!==b)):alert(`Erreur lors de la suppression : ${le.message||"Échec server"}`)}catch(se){alert(`Erreur réseau lors de la suppression : ${se.message}`)}},P=O[b],K=(P==null?void 0:P.status)==="building",G=(P==null?void 0:P.status)==="success",J=b.toLowerCase(),V=J.replace(/[^a-z0-9]/g,""),ne=F[J]||F[V]||F[`${J}.apk`],ge=G&&(P!=null&&P.apkUrl)?P.apkUrl:ne?ne.url:null,B=ne!=null&&ne.sizeMb?`${ne.sizeMb}M`:"Prêt";return e.jsxs("div",{className:"design-carte-carrousel rounded-2xl p-5 border border-white/20 shadow-xl flex flex-col items-center text-center relative overflow-hidden group cursor-pointer",style:{background:t?n("proj-"+f,.7):"rgba(0,0,0,0.5)"},onClick:T,children:[ge?e.jsxs("a",{href:ge,download:`${b}.apk`,onClick:z=>z.stopPropagation(),className:"z-20 absolute top-3 left-3 bg-emerald-600 hover:bg-emerald-500 text-white text-[10px] font-black px-2.5 py-1 rounded-full flex items-center gap-1.5 shadow-lg border border-emerald-400/50 transition-all hover:scale-105 cursor-pointer animate-pulse",title:`Télécharger directement l'APK (${B})`,children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-white animate-ping"}),e.jsxs("span",{children:["📱 APK PRÊT (",B,")"]})]}):K?e.jsxs("div",{onClick:z=>z.stopPropagation(),className:"z-20 absolute top-3 left-3 bg-purple-700/90 text-white text-[10px] font-bold px-2.5 py-1 rounded-full flex items-center gap-1.5 shadow-lg border border-purple-400/60 animate-pulse select-none",title:(P==null?void 0:P.progress)||"Compilation de l'APK en cours...",children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-white animate-ping"}),e.jsx("span",{children:"⏳ APK EN COURS..."})]}):null,e.jsx("button",{onClick:I,className:"z-20 absolute top-3 right-3 w-8 h-8 rounded-full bg-red-600/80 hover:bg-red-500 text-white font-bold text-xs flex items-center justify-center transition-all shadow-lg hover:scale-110 cursor-pointer",title:"Supprimer ce projet du disque dur et de l'interface",children:"🗑️"}),e.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-30 mix-blend-overlay pointer-events-none"}),e.jsx("div",{className:"absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors z-0"}),e.jsxs("div",{className:"z-10 relative pointer-events-none w-full pr-8",children:[e.jsx("div",{className:"text-white/70 text-xs font-bold uppercase tracking-widest drop-shadow-md",children:"PROJET"}),e.jsx("h3",{className:"design-carte-titre text-xl font-black text-white break-all drop-shadow-lg leading-tight w-full",children:b})]}),e.jsx("div",{className:"design-carte-desc z-10 relative text-sm text-white/90 font-medium drop-shadow-md pointer-events-none w-full",children:k.desc}),e.jsxs("div",{className:"z-10 flex flex-wrap items-center justify-center gap-2 mt-3",children:[e.jsx("button",{onClick:z=>{z.stopPropagation(),S!==b&&(k.installed===!1?(L(b),w("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})}).then(se=>{alert(se?`📦 Installation des dépendances démarrée pour "${b}" !
Suivez la progression dans les logs.`:"Mode Cloud SaaS : Bridge local non connecté."),L(null),m(le=>le.map(he=>he.name===k.name?{...he,installed:!0}:he))}).catch(()=>L(null))):T())},disabled:S===b,className:`font-bold py-2 px-4 rounded-xl text-xs transition-all flex items-center gap-1.5 ${S===b?"bg-cyan-500/40 text-cyan-200 cursor-wait animate-pulse":k.installed===!1?"bg-orange-500/80 hover:bg-orange-600 text-white cursor-pointer":"bg-white/20 hover:bg-white/40 text-white cursor-pointer"}`,title:k.installed===!1?"Installer les dépendances requises pour ce projet":"Lancer la prévisualisation Vite",children:S===b?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin inline-block",children:"⏳"})," ",k.installed===!1?"Installation...":"Lancement..."]}):k.installed===!1?e.jsx(e.Fragment,{children:"📦 INSTALL"}):e.jsx(e.Fragment,{children:"🚀 PREVIEW"})}),ge?e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsxs("a",{href:ge,download:`${b}.apk`,onClick:z=>z.stopPropagation(),className:"bg-gradient-to-r from-emerald-600 to-green-500 hover:from-emerald-500 hover:to-green-400 text-white font-extrabold py-2 px-3.5 rounded-xl text-xs transition-all flex items-center gap-1.5 shadow-lg shadow-emerald-950/60 border border-emerald-400/50 cursor-pointer animate-pulse hover:scale-105",title:`Télécharger l'APK Android compilé de ${b} (${B}) directement`,children:[e.jsx("span",{children:"📥"}),e.jsx("span",{children:"APK"}),e.jsxs("span",{className:"text-[10px] opacity-90 font-mono",children:["(",B,")"]})]}),e.jsx("button",{onClick:z=>Y(z,b),className:"bg-purple-600/30 hover:bg-purple-600/60 text-purple-200 hover:text-white font-bold py-2 px-2 rounded-xl text-xs transition-colors flex items-center justify-center border border-purple-400/40 cursor-pointer",title:"Re-compiler une nouvelle version de l'APK",children:"🔄"})]}):K?e.jsxs("div",{onClick:z=>z.stopPropagation(),className:"bg-purple-900/70 border border-purple-500/60 text-purple-200 font-bold py-2 px-3 rounded-xl text-xs flex items-center gap-1.5 shadow-lg shadow-purple-950/60 cursor-wait animate-pulse",title:(P==null?void 0:P.progress)||"Compilation APK en cours...",children:[e.jsx("span",{className:"animate-spin inline-block text-xs",children:"⏳"}),e.jsx("span",{className:"max-w-[110px] truncate text-[11px]",children:(P==null?void 0:P.progress)||"v0-apk..."})]}):e.jsxs("button",{onClick:z=>Y(z,b),className:"bg-gradient-to-r from-purple-700/90 to-indigo-600/90 hover:from-purple-600 hover:to-indigo-500 text-white font-bold py-2 px-3 rounded-xl text-xs transition-all flex items-center gap-1.5 shadow-lg shadow-purple-950/60 border border-purple-400/50 hover:border-purple-300 cursor-pointer hover:scale-105",title:`Lancer la création du fichier APK pour "${b}" directement depuis le carrousel`,children:[e.jsx("span",{children:"📱"}),e.jsx("span",{children:"v0-apk action"})]}),k.installed!==!1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:z=>{z.stopPropagation(),L(b),w("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})}).then(se=>{alert(se?`🔄 Réinstallation des dépendances démarrée pour "${b}" !`:"Mode Cloud SaaS : Bridge local non connecté."),L(null)}).catch(()=>L(null))},className:"bg-orange-500/30 hover:bg-orange-500/60 text-white font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center justify-center border border-orange-500/40 cursor-pointer",title:"Forcer la réinstallation des dépendances (pnpm install)",children:"🔄"}),e.jsx("button",{onClick:async z=>{z.stopPropagation();try{L(b);const se=await w("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})});if(L(null),!se){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const le=await se.json();alert(le.message||`🚀 Serveur Vite démarré pour ${b} !`),le.previewUrl&&window.open(le.previewUrl,"_blank")}catch(se){L(null),alert("Erreur de connexion au bridge: "+se.message)}},className:"font-bold py-2 px-3 rounded-xl text-xs bg-purple-500/60 hover:bg-purple-500 text-white transition-all shadow-md cursor-pointer",title:"Lancer le serveur Vite avec pnpm run dev",children:"💻 PNPM"})]}),e.jsx("button",{onClick:I,className:"bg-red-600/30 hover:bg-red-600/60 text-red-200 border border-red-500/40 font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center gap-1",title:"Supprimer définitivement du disque dur",children:"🗑️ Supprimer"})]})]},f)})]})};function $o({user:t,onLogout:n}={}){var Fn;const r=o.useRef({}),c=(s,a=1)=>typeof window>"u"?`linear-gradient(135deg, rgba(17,17,17,${a}), rgba(34,34,34,${a}))`:(r.current[s]||(r.current[s]=Bo(a)),r.current[s]),d=(t==null?void 0:t.email)||(typeof window<"u"?localStorage.getItem("tiger_currentUserEmail"):null),m=!!(t!=null&&t.isSuperAdmin||d&&d.toLowerCase().trim()==="zacktunr@gmail.com");o.useEffect(()=>{t!=null&&t.email&&typeof window<"u"&&localStorage.setItem("tiger_currentUserEmail",t.email)},[t]);const h=()=>{typeof window<"u"&&(localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),localStorage.removeItem("tiger_lastGeneratedProject"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{})),n?n():typeof window<"u"&&window.location.reload()},[p,C]=o.useState([]),[y,S]=o.useState(""),L=o.useRef(null),F=o.useRef(null),[ee,O]=o.useState(!1),[X,Y]=o.useState("connexion"),[A,E]=o.useState(!1),[k,f]=o.useState("clean");o.useRef(0);const[b,T]=o.useState(1),[I,P]=o.useState(!1),[K,G]=o.useState(!1),[J,V]=o.useState(!1);o.useEffect(()=>{let s=0;const a=setInterval(()=>{var l,_;if(typeof window<"u"){const u=(_=(l=window.Capacitor)==null?void 0:l.isNativePlatform)==null?void 0:_.call(l),x=!!window.AndroidBridge;(u||x)&&(G(!0),clearInterval(a))}s++>10&&clearInterval(a)},100);return()=>clearInterval(a)},[]);const[ne,ge]=o.useState([]),[B,z]=o.useState(""),[se,le]=o.useState(["> Système Kirov5 initialisé. "+new Date().toLocaleTimeString()]),[he,te]=o.useState([]),[R,Z]=o.useState([]);o.useEffect(()=>{const s=a=>Z(a.detail);return window.addEventListener("update_kirov_packs",s),()=>window.removeEventListener("update_kirov_packs",s)},[]),o.useEffect(()=>{window.KIROV_SELECTED_PACKS=R},[R]);const[ae,pe]=o.useState(!1),[ve,Ee]=o.useState(!1),[Te,U]=o.useState([]),[fe,Ae]=o.useState(!1),[be,ie]=o.useState(""),[De,it]=o.useState(""),[Re,Ne]=o.useState(!1),[ce,xt]=o.useState(""),[Ke,Un]=o.useState("Vite + React + Tailwind + TS"),[ft,yn]=o.useState(""),[It,Nt]=o.useState("deepseek"),[We,an]=o.useState(""),[on,On]=o.useState(!0),[ln,cn]=o.useState(!1),[bt,At]=o.useState(null),[Dt,at]=o.useState([]),[dn,ot]=o.useState(!1),Mt=o.useCallback(async s=>{ot(!0);const a=[{id:"deepseek-r1-v0",tag:"⚡ DEEPSEEK R1",title:"DeepSeek-R1 & Moteur Souverain v0.1",desc:"Capacités de raisonnement avancé et de suture pour interfaces React.",content:`DeepSeek-R1 offre des capacités de raisonnement avancé pour l'analyse de contrats PRD et la génération zéro-touch de projets web complets.
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){at(a),ot(!1);return}const l=s||localStorage.getItem("tiger_apiKey");if(!l||!l.startsWith("sk-")||l.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){at(a),ot(!1);return}const _=new AbortController,u=setTimeout(()=>_.abort(),4e3),x=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${l}`},signal:_.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(u),x.ok){const j=await x.json(),M=JSON.parse(j.choices[0].message.content);M.news&&Array.isArray(M.news)&&M.news.length>0?at(M.news):at(a)}else x.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),at(a)}catch(l){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",l),at(a)}finally{ot(!1)}},[]);o.useEffect(()=>{Mt()},[Mt]);const[Je,lt]=o.useState(!1),[Me,qt]=o.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Ve,vt]=o.useState([]),[Lt,un]=o.useState("");o.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let a=JSON.parse(s);if(!Array.isArray(a))throw new Error("Not an array");const l="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";a=a.map(_=>_.name==="fold"?{..._,colors:{..._.colors,"bg-app":l}}:_),vt(a)}catch{vt([])}else{const a={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};vt([a]),localStorage.setItem("tiger_saved_themes",JSON.stringify([a]))}},[]),o.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",Me),Me!=="random"){const a=((s=Ve.find(l=>l.name===Me))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=a,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[Me,Ve]);const Ce=()=>{if(!Lt.trim())return alert("Nom invalide");if(Ve.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":c("icon-settings",.8),"icon-ai":c("icon-ai",.8),"icon-projects":c("icon-projects",.8),"icon-packs":c("icon-packs",.8),"icon-news":c("icon-news",.8),"bg-app":c("bg-app",.9)},a={name:Lt.trim(),colors:s},l=[...Ve,a];vt(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),qt(a.name),un("")},_n=(s,a)=>{a.stopPropagation();const l=Ve.filter(_=>_.name!==s);vt(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),Me===s&&qt("random")},Ut=s=>{Z(a=>a.includes(s)?a.filter(l=>l!==s):[...a,s])},[Xe,pn]=o.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});o.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(Xe))},[Xe]);const[Ot,Be]=o.useState(!0),[ze,Pe]=o.useState(!0),[q,ke]=o.useState(null),[He,mn]=o.useState(null),[qe,Ft]=o.useState(null),[xe,tt]=o.useState(null),[Gt,ct]=o.useState(""),[nt,Pt]=o.useState([]),[Qe,Jt]=o.useState(!1),[Ze,gt]=o.useState("idle"),[kt,st]=o.useState([]),[St,gn]=o.useState(""),[jt,Xt]=o.useState(null),[ht,Cn]=o.useState([]),yt=o.useCallback(async()=>{try{let s=[];const a=Date.now();if(a-tn<3e4&&$t.length>0)s=[...$t];else try{const l=Ln(),_=await fetch("https://api.github.com/repos/turnzack/v0-reponse/releases",{headers:l?{Authorization:`Bearer ${l}`,Accept:"application/vnd.github.v3+json"}:{Accept:"application/vnd.github.v3+json"}});if(_.ok){const u=await _.json();if(Array.isArray(u)){const x=[];u.forEach(j=>{Array.isArray(j.assets)&&j.assets.forEach(M=>{var Q;(Q=M.name)!=null&&Q.endsWith(".apk")&&x.push({file:M.name,name:M.name.replace(".apk",""),sizeMb:(M.size/(1024*1024)).toFixed(1),url:M.browser_download_url})})}),$t=x,tn=a,s=[...x]}}}catch{}try{const l=await w("http://localhost:5006/api/mobile/list-apks");if(l&&l.ok){const _=await l.json();_&&_.success&&Array.isArray(_.apks)&&(s=[...s,..._.apks])}else{const _=await fetch("/api/mobile/list-apks");if(_&&_.ok){const u=await _.json();u&&u.success&&Array.isArray(u.apks)&&(s=[...s,...u.apks])}}}catch{}if(s.length>0){const l=new Set,_=s.filter(u=>l.has(u.file.toLowerCase())?!1:(l.add(u.file.toLowerCase()),!0));Cn(_)}}catch(s){console.warn("[v0-apk] loadAvailableApks error",s)}},[]);o.useEffect(()=>{Qe&&yt()},[Qe,yt]),o.useEffect(()=>{let s,a=0;return Ze==="building"&&(s=setInterval(async()=>{try{const l=await w("http://localhost:5006/api/mobile/build-logs");if(l&&l.ok){a=0;const _=await l.json();_.logs&&_.logs.length>0&&st(_.logs),_.isBuilding===!1&&_.result&&(_.result.success?(gt("success"),Xt(_.result.apkUrl)):gt("error"),clearInterval(s))}else a++,a>=3&&(clearInterval(s),gt("error"),st(_=>[..._,`❌ Service de compilation mobile absent sur ce serveur (${l?l.status:"erreur réseau"}).`,"📱 Option 1 (Cloud) : Déclenchez le compilateur automatique Cloud Souverain.",`💻 Option 2 (Local) : Lancez 'python apk_builder.py --src ... --name ${St||q||"app"} --build' dans E:\\v0reponses\\v0-apk.`]))}catch(l){console.warn("Polling APK error",l)}},1500)),()=>{s&&clearInterval(s)}},[Ze,St,q]),o.useEffect(()=>{w("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))te(s.projects.map(a=>({name:typeof a=="string"?a:a.project_id||a.title||a.name||"Projet",desc:"Projet local",bg:""})));else{const a=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:a?{Authorization:`Bearer ${a}`}:{}}).then(l=>l?l.json():null).then(l=>{l&&l.projects&&te(l.projects.map(_=>({name:typeof _=="string"?_:_.project_id||_.title||_.name||"Projet",desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[dt,Se]=o.useState(null),[Qt,_t]=o.useState(""),[Tt,i]=o.useState(!1),[g,v]=o.useState(!1),D=o.useRef(null);o.useEffect(()=>{if(D.current=null,q==="v0-guest"||q==="V0-Guest")v(!0),Se("http://localhost:3007"),_t("http://localhost:3007"),D.current="http://localhost:3007";else if(q){v(!0);const s=qe&&JSON.stringify(qe).includes("next.config"),a=typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1",l=s?"http://localhost:3000":D.current||(a?`http://${window.location.hostname}:5173`:"http://localhost:5173");Se(l),_t(l),D.current=l}else v(!1),Se(null)},[q,qe]),o.useEffect(()=>{const s=a=>{var l,_,u,x;if(((l=a.data)==null?void 0:l.type)==="CHANGE_PREVIEW_URL"){const j=a.data.route,M=j==="/"?"":`#${j}`;Se(Q=>{const W=Q?Q.split("#")[0]:"http://127.0.0.1:5175/";return`${W.endsWith("/")?W:`${W}/`}${M}`})}if(((_=a.data)==null?void 0:_.type)==="DESIGN_ELEMENT_CLICKED"||((u=a.data)==null?void 0:u.type)==="DESIGN_ELEMENT_DRAGGED"||((x=a.data)==null?void 0:x.type)==="DESIGN_ELEMENT_RESIZED"){const j=document.querySelector('iframe[title="Studio Admin Design"]');j&&j.contentWindow&&j.contentWindow.postMessage(a.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),o.useEffect(()=>{q&&w(`http://localhost:5006/api/fs/tree?project=${q}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&Ft(s.tree)}).catch(()=>{})},[q]),o.useEffect(()=>{q&&xe&&w(`http://localhost:5006/api/fs/read?project=${q}&file=${encodeURIComponent(xe)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&ct(s.content)}).catch(()=>{})},[q,xe]);const re=async s=>{if(s===void 0||!q||!xe)return;if(ct(s),Wt.isNativePlatform()||!!window.AndroidBridge)try{await Xn.writeFile({path:`v0-moteur-mobile/projetv0/${q}/${xe}`,data:s,directory:vn.Documents,encoding:Tn.UTF8,recursive:!0})}catch(l){console.error("Erreur de sauvegarde mobile:",l)}else w("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:q,file:xe,content:s})}).catch(()=>{})},N=s=>{q&&w(`http://localhost:5006/api/fs/read?project=${q}&file=${encodeURIComponent(s)}`).then(a=>a?a.json():null).then(a=>{a&&a.success&&Pt(l=>l.find(_=>_.path===s)?l:[...l,{path:s,content:a.content}])}).catch(()=>{})};o.useEffect(()=>{(async()=>{const a=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(Wt.isNativePlatform()||!!window.AndroidBridge)try{const u=(await Xn.readdir({path:"v0-moteur-mobile/projetv0",directory:vn.Documents})).files.map(x=>x.name||x.toString());te(u.map((x,j)=>({name:x,desc:"Mémoire Téléphone",bg:a[j%a.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else w("http://localhost:5006/api/projects-v2").then(_=>_?_.json():null).then(_=>{if(_&&_.success&&_.projects)te(_.projects.map((u,x)=>({name:typeof u=="string"?u:u.name||u.project_id||u.title||`Projet_${x}`,desc:"Environnement Local",bg:a[x%a.length],installed:u.installed})));else{const u=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:u?{Authorization:`Bearer ${u}`}:{}}).then(x=>x?x.json():null).then(x=>{x&&x.projects&&te(x.projects.map((j,M)=>({name:typeof j=="string"?j:j.project_id||j.title||j.name||`Projet_${M}`,desc:"SaaS Cloud (Neon DB)",bg:a[M%a.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),o.useEffect(()=>{P(!0)},[]);const[me,ye]=o.useState(!0);o.useEffect(()=>{const s=()=>ye(!0),a=_=>{_&&_.detail&&le(u=>[_.detail,...u.slice(0,49)])};window.addEventListener("open-mouchard",s),window.addEventListener("kirov-mouchard-log",a);const l=_=>{if(_.data&&_.data.type==="TIGER_CAPTURE"){const u=_.data.data;if(u){let x="index.html";(u.includes("import React")||u.includes("export default"))&&(x="App.tsx"),u.includes("tailwindcss")&&(x="index.css"),tt(x),re(u),Ft(j=>{var W;const M={name:x,path:x,type:"file"};return j?((W=j.children)==null?void 0:W.find($=>$.name===x))?j:{...j,children:[...j.children||[],M]}:{name:"Mobile_Storage",type:"directory",children:[M]}})}}};return window.addEventListener("message",l),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("kirov-mouchard-log",a),window.removeEventListener("message",l)}},[q,xe]),o.useEffect(()=>{if(!I)return;const s=()=>{w("http://localhost:5006/api/bridge/queue").then(l=>l?l.json():null).then(l=>{l&&l.success&&(setBridgeQueueData({current:l.current||{},queue:l.queue||[]}),(l.queue&&l.queue.length>0||l.current&&Object.keys(l.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),w("http://localhost:5006/api/bridge/logs").then(l=>l?l.json():null).then(l=>{var _,u;if(l&&l.success&&l.logs){le(M=>{const W=[...M.filter(we=>(we.includes("[📱")||we.includes("v0-apk")||we.includes("[APK]"))&&!l.logs.includes(we)),...l.logs],$=new Set,je=[];for(const we of W)$.has(we)||($.add(we),je.push(we));return je.slice(0,50)});const x=[...l.logs].reverse().find(M=>M.includes("URL_PREVIEW="));if(x){let M=(_=x.split("URL_PREVIEW=")[1])==null?void 0:_.trim();M&&typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"&&(M=M.replace(/localhost|127\.0\.0\.1/,window.location.hostname)),M&&M!==D.current&&(D.current=M,Se(M),_t(M),v(!0))}const j=[...l.logs].reverse().find(M=>M.includes("PIPELINE COMPLET TERMINÉ avec succès pour "));if(j){const M=(u=j.split("PIPELINE COMPLET TERMINÉ avec succès pour ")[1])==null?void 0:u.replace(/[.\s]+$/,"");M&&q!==M&&(ke(M),v(!0))}}}).catch(()=>{}),w("http://localhost:5006/api/bridge/autonomous-status").then(l=>l?l.json():null).then(l=>{if(l&&l.success&&(l.data||l.status)){const u=(l.data||l.status).state;u==="diagnosing"||u==="repair_required"||u==="error"?f("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(u)||["starting_server","launch_requested","restarting"].includes(u)?f("working"):u==="ready"?f("clean"):q&&w(`http://localhost:5006/api/suture/status?project=${q}`).then(x=>x?x.json():null).then(x=>{x&&x.success&&x.status&&f(x.status)}).catch(()=>{})}}).catch(()=>{})};s();const a=setInterval(s,2e3);return()=>clearInterval(a)},[I,q]);const ut=s=>{ke(s),tt(null),ct(""),i(!1),ye(!1),v(!1),w("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:s,open_explorer:!1})}).then(async a=>{if(a&&a.ok){const l=await a.json().catch(()=>null);l!=null&&l.previewUrl&&(Se(l.previewUrl),_t(l.previewUrl))}}).catch(a=>console.error("Erreur de lancement preview:",a)),w(`http://localhost:5006/api/fs/tree?project=${encodeURIComponent(s)}`).then(a=>a?a.json():null).then(a=>{if(a&&a.success&&a.tree){Ft(a.tree);const l=u=>{if(!u)return null;if(u.type==="file"&&(u.path==="src/App.tsx"||u.path==="src/App.jsx"||u.name==="App.tsx"||u.name==="index.html"))return u.path;if(u.children&&Array.isArray(u.children))for(const x of u.children){const j=l(x);if(j)return j}return null},_=l(a.tree);_&&tt(_)}}).catch(a=>console.error("Erreur chargement arborescence:",a))},Le=s=>{const a=typeof s=="string"?s:y;if(!a.trim())return;const l={id:Date.now().toString(),role:"user",content:a};C(u=>[...u,l]);const _=a.toLowerCase();setTimeout(()=>{let u={id:(Date.now()+1).toString(),role:"assistant",content:""};const x=_.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(x==="mes projets"||x.includes("liste des projet")||x==="projet"||x==="projets")u.content="Voici la liste de vos projets récents :",u.widget="projects";else if((x.includes("stitch")||x.includes("deepseek")||x.includes("design")||x.includes("logique"))&&(x.includes("modifi")||x.includes("ajoute")||x.includes("change")||x.includes("mise a jour")||x.includes("evolue")||x.includes("reprends")||x.includes("continue"))){const j=a.match(/\[(.*?)\]/),M=j?j[1]:null,Q=x.includes("deepseek")?"deepseek":"stitch";u.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${Q.toUpperCase()}) 🔄

J'injecte vos nouvelles directives directement dans votre interface... ${M?`
🔍 Recherche et AutoSwitch vers le projet : "${M}"`:"Reprise du travail en cours."}`,u.widget=null,w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Q,target_project:M,prompt:"Mise à jour (Reprise de projet) : "+a.replace(/\[.*?\]/,"").trim(),auto_submit:!0})}).catch(W=>console.log("Erreur de connexion au Bridge local pour l'injection",W))}else if(x.includes("cree")||x.includes("lance")||x.includes("projet")||x.includes("generation")){u.content=`🚀 DÉMARRAGE PARALLÈLE KIROV5 🚀
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,u.widget="phases",T(1);const j=q||(ce.trim()?ce.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+a.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(ke(j),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",j),typeof window<"u"){const W=localStorage.getItem("tiger_targetAi")||"deepseek",$=localStorage.getItem("tiger_targetUiAi")||"stitch",je=(H,ue=!1)=>mt(H,ue),we=window.AndroidBridge;if(we&&we.openAIWithPrompt)we.openAIWithPrompt(je($,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+a),we.showToast&&we.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const H=R&&R.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${R.length})]
`+R.map(Ie=>{const oe=zt.find(_e=>_e.id===Ie);return`• ${oe?oe.name:Ie} (#${Ie})`}).join(`
`):"",ue="Génère l'interface UI/UX complète et moderne pour ce projet : "+a+H;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ue)}catch{}const rt=()=>w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:$,prompt:ue,auto_submit:!0,project_id:j,phase_num:1,packs:R})});Xe!==200&&(ze?window.open(je($,!0),"kirov5_ai_target"):window.open(je($,!0),"_blank"),rt().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(Ie=>console.error("Erreur sendUiPrompt",Ie))),setTimeout(()=>{const Ie=R&&R.length>0?a+H:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+a+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(Ie)}catch{}window.open(je(W),"_blank"),w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:W,prompt:Ie,auto_submit:!0,project_id:j,phase_num:1,packs:R})}).catch(oe=>console.log("Erreur Bridge Logic Prompt:",oe)),R&&R.length>0?w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:W,user_prompt:Ie,packs:R,target_project:j})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(oe=>{console.log("Erreur Trombone Bridge:",oe)}):w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:W,prompt:Ie,auto_submit:!0,project_id:j,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}T(1);let M=1;const Q=setInterval(()=>{M++,M>11?clearInterval(Q):T(M)},1500)}else if(x.includes("youtube")||x.includes("video"))u.content="Voici les résultats YouTube pour votre recherche :",u.widget="youtube";else if(x.includes("actualite")||x.includes("ia")||x.includes("news")||x.includes("recherche")){const j=localStorage.getItem("tiger_apiKey");u.content="Actualités & Dernières Innovations IA :",u.widget="news",Mt(j||void 0)}else if(x.includes("parametre")||x.includes("reglage")||x.includes("configuration")||x.includes("setting"))u.content="Ouverture du panneau de configuration système :",u.widget="settings";else if(x.includes("[plugin:vite:")||x.includes("missing semicolon")||x.includes("syntaxerror")||x.includes("typescriptparsermixin")||x.includes("babel/parser")||x.includes("error")&&x.length>80){const j=q||"Projet_blog_8831";u.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${j}" avec la stack trace fournie... 🩺`,Fe("suture",a)}else if(u.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const j=window.AndroidBridge;j&&j.openAIWithPrompt?j.openAIWithPrompt("https://chat.deepseek.com/",a):window.open("https://chat.deepseek.com/","_blank")}C(j=>[...j,u])},600),S("")},Ye=async s=>{var we;let a=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],l=null;const _=a.filter(H=>H.name.endsWith(".zip"));let u=[];if(_.length>0){C(H=>[...H,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const H=(await nn(async()=>{const{default:ue}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:ue}},[])).default;for(const ue of _){l=ue;const Ie=await new H().loadAsync(ue);for(const[oe,_e]of Object.entries(Ie.files))if(!_e.dir&&!oe.includes("__MACOSX")&&!((we=oe.split("/").pop())!=null&&we.startsWith("."))){const Ue=await _e.async("blob"),pt=new File([Ue],oe.split("/").pop()||oe,{type:Ue.type});u.push(pt)}}}catch(H){console.error("Erreur décompression ZIP:",H),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}for(const H of _)try{const ue=await H.arrayBuffer(),rt=arrayBufferToBase64(ue);fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:q||B||ce||"AUDIO",fileName:H.name,fileBase64:rt})}).catch(oe=>console.warn("[Upload ZIP Sync] Notice:",oe))}catch{}}a=[...a.filter(H=>!H.name.endsWith(".zip")),...u];const x=a.filter(H=>H.name.endsWith(".html")),j=a.filter(H=>!H.name.endsWith(".html")&&(H.name.endsWith(".png")||H.name.endsWith(".jpg")||H.name.endsWith(".jpeg")||H.name.endsWith(".md")||H.name.endsWith(".json")||H.name.endsWith(".txt")||H.name.endsWith(".tsx")||H.name.endsWith(".ts")||H.name.endsWith(".jsx")||H.name.endsWith(".js")||H.name.endsWith(".css")||H.name.endsWith(".svg")));if(x.length===0&&j.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .tsx, .ts, .png, ou un .zip.");return}let M=[...nt];for(const H of j){const ue=H.name.endsWith(".png")||H.name.endsWith(".jpg")||H.name.endsWith(".jpeg"),rt=await new Promise(oe=>{const _e=new FileReader;_e.onload=Ue=>{var pt;return oe((pt=Ue.target)==null?void 0:pt.result)},ue?_e.readAsDataURL(H):_e.readAsText(H)}),Ie={path:H.name,content:ue?`[Image jointe visuellement : ${H.name} (Binaire ignoré pour économie de tokens)]`:rt};M.some(oe=>oe.path===H.name)||M.push(Ie),C(oe=>[...oe,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${H.name}`}])}if(x.length>0){const H=x[0],ue=await new Promise(oe=>{const _e=new FileReader;_e.onload=Ue=>{var pt;return oe((pt=Ue.target)==null?void 0:pt.result)},_e.readAsText(H)}),rt={path:H.name,content:ue};M.some(oe=>oe.path===H.name)||M.push(rt);const Ie={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${H.name}
Analyse de la structure UI et assemblage du contexte en cours...`};C(oe=>[...oe,Ie])}const Q=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter(H=>H.name.endsWith(".zip"));for(const H of Q)M.some(ue=>ue.path===H.name)||M.push({path:H.name,content:"ZIP_ARCHIVE_DUMMY"});Pt(M);const W=q||ce||"Projet_Stitch",$=a.map(H=>H.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${W}: ${$}`);const je=x.length;if(je>3){const H=localStorage.getItem("tiger_targetAi")||"deepseek",ue=l?"Projet_ZIP_"+l.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),rt=q||ue;q||ke(rt),C(oe=>[...oe,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !

Hermes a détecté ${je} pages HTML dans votre ZIP.
Découpage automatique en lots de 3 fichiers en cours...
Démarrage de l'automatisation séquentielle via DeepSeek !`,widget:"phases"}]),T(1);let Ie="";if(l)Ie=await new Promise(oe=>{const _e=new FileReader;_e.onload=Ue=>{var pt;return oe(((pt=Ue.target)==null?void 0:pt.result).split(",")[1])},_e.readAsDataURL(l)});else{const oe=(await nn(async()=>{const{default:Ue}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:Ue}},[])).default,_e=new oe;for(const Ue of a)_e.file(Ue.name,Ue);Ie=await _e.generateAsync({type:"base64"})}w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({zip_base64:Ie,zip_mode:!0,target_ai:H,target_project:rt,user_prompt:ce.trim()?`${ce} - ${ft}`:`Application multi-pages issue de ${(l==null?void 0:l.name)||"fichiers_locaux"}`})}).then(async oe=>{const _e=await oe.json();_e.success?(C(Ue=>[...Ue,{id:Date.now().toString()+"_hermes",role:"assistant",content:`✅ ${_e.message}

📡 Lot 1/${_e.total_batches} transmis à DeepSeek. Les lots suivants s'enchaîneront automatiquement !
Fichiers détectés : ${(_e.files_detected||[]).join(", ")}`}]),window.open(mt(H),"_blank")):alert("Erreur Hermes : "+(_e.error||"Inconnue"))}).catch(oe=>{alert(`Erreur de connexion au Moteur Local : ${oe.message}`)});return}if(x.length>0){if(document.getElementById("creation-mode-container"))return;setTimeout(()=>{Ct(M)},1200)}},Ct=async(s=nt)=>{Ne(!1);const a=s.find(W=>W.path.endsWith(".html"));if(!a){alert("Aucun fichier HTML trouvé dans le Trombone !");return}const l=ce.trim()?"Projet_"+ce.replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4):"Design_"+a.path.replace(".html","").replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4),_=q||l;if(!q){ke(_);try{await w("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:_,file:"README.md",content:`# ${ce||_}

Initialisé par Tiger IA V0 (Design-First).`})})}catch(W){console.error("[IDE] Erreur création auto du dossier",W)}}const u=s.filter(W=>W.path!==a.path),x=a.content,j={id:(Date.now()+1).toString(),role:"assistant",content:`Mode "Design-First" activé. 🎨

Transmission du design au LLM avec les ${u.length} fichiers du Trombone intégrés.
Câblage en cours...`,widget:"phases"};T(5),C(W=>[...W,j]);let M=5;const Q=setInterval(()=>{M++,M>11?clearInterval(Q):T(M)},3e3);if(typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Mode Design-First Activé !"),typeof window<"u"){const W=localStorage.getItem("tiger_targetAi")||"deepseek";let $="";u.length>0&&($=`
...
\`\`\`
`}));let je="";(ce.trim()||Ke.trim()||ft.trim())&&(je=`
--- MÉTADONNÉES DU PROJET ---
Nom : ${ce||"Non spécifié"}
Stack / Structure : ${Ke||"Non spécifiée"}
Description & Objectifs : ${ft||"Non spécifiés"}
-----------------------------
`);const we=`Voici le code HTML/CSS d'une interface générée par Stitch.${je}
...
\`\`\`
`,H=window.AndroidBridge;if(H&&H.openAIWithPrompt){const ue=mt(W);H.openAIWithPrompt(ue,we),H.showToast&&H.showToast("HTML injecté. Câblage sur "+W.toUpperCase()+" !")}else w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:W,prompt:we,auto_submit:!0,project_id:_,phase_num:5})}).then(ue=>console.log("[Bridge] Prompt HTML + Contexte envoyé avec succès, status:",ue.status)).catch(ue=>console.error("[Bridge] Erreur lors de l'envoi du prompt:",ue))}},Oe=(s,a=0)=>s?s.type==="directory"?e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-2 px-2 py-1 hover:bg-white/5 cursor-pointer text-gray-300 text-sm",style:{paddingLeft:`${a*12+8}px`},children:[e.jsx("span",{className:"text-orange-400",children:"📁"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-dossier truncate font-bold",children:s.name})]}),s.children&&s.children.map(l=>Oe(l,a+1))]},s.path):e.jsxs("div",{className:`flex items-center justify-between px-2 py-1 hover:bg-white/10 cursor-pointer text-sm group ${xe===s.path?"bg-cyan/20 text-cyan border-l-2 border-cyan":"text-gray-400"}`,style:{paddingLeft:`${a*12+8}px`},onClick:()=>tt(s.path),children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-blue-400",children:"📄"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-fichier truncate",children:s.name})]}),e.jsxs("div",{className:"hidden group-hover:flex items-center gap-1",children:[e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-red-500/50 transition-colors",title:"Suture : Réparer ou débugger ce fichier",onClick:l=>{l.stopPropagation(),tt(s.path),setTimeout(()=>Fe("suture","Veuillez analyser ce fichier et corriger toutes les erreurs, fautes de frappe ou imports manquants."),100)},children:"🩺"}),e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-cyan/50 transition-colors",title:"Ajouter au Trombone",onClick:l=>{l.stopPropagation(),N(s.path)},children:"📎"})]})]},s.path):null,Fe=async(s,a)=>{if(!q){alert("⚠️ Veuillez sélectionner un projet actif dans l'explorateur.");return}const l=localStorage.getItem("tiger_targetAi")||"deepseek";let _="";s==="suture"?_=`🩺 SUTURE CHIRURGICALE — CORRECTION D'ERREUR DÉTECTÉE
...
`),xe&&Gt&&(_+=`--- Fichier Actif en Édition : ${xe} ---
\`\`\`
${Gt}
\`\`\`
...
\`\`\``,C(u=>[...u,{id:Date.now().toString()+"_action",role:"assistant",content:`🩺 Suture & Correction déclenchée pour "${q}". Transmission de l'erreur à ${l.toUpperCase()} en cours...`}]);try{if(await w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:l,prompt:_,auto_submit:!0,project_id:q,phase_num:s})}),s==="suture"){w("http://localhost:5006/v1/suture/start",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:q,activeFile:xe||"",rawError:a||"",prompt:a||"Analyse et corrige les erreurs du projet."})}).then(async x=>{const j=await x.json();j.success&&j.status==="applied"?C(M=>{var Q,W;return[...M,{id:Date.now().toString()+"_suture_ok",role:"assistant",content:`✅ Suture V2 réussie !

🔧 ${j.repairId}
🚀 Statut : **Patch appliqué en production**
📁 Fichiers corrigés : ${JSON.stringify(((W=(Q=j.patchReport)==null?void 0:Q.files)==null?void 0:W.map($=>$.path))||[])}`}]}):j.success?C(M=>{var Q;return[...M,{id:Date.now().toString()+"_suture_partial",role:"assistant",content:`⚠️ Suture V2 : correctif généré mais non promu.
Statut : ${((Q=j.validationReport)==null?void 0:Q.code)||j.status}

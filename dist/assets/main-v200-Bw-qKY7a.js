const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-MQweUQks.js","assets/design-v200-CZCFVxR9.js","assets/design-v200-Da4FXbs6.css"])))=>i.map(i=>d[i]);
import{r as l,a as Et,j as e,s as I,i as bs,R as vs}from"./design-v200-CZCFVxR9.js";const Ss="modulepreload",ys=function(t){return"/"+t},Un={},en=function(n,r,c){let d=Promise.resolve();if(r&&r.length>0){let x=function(v){return Promise.all(v.map(y=>Promise.resolve(y).then(L=>({status:"fulfilled",value:L}),L=>({status:"rejected",reason:L}))))};document.getElementsByTagName("link");const p=document.querySelector("meta[property=csp-nonce]"),C=(p==null?void 0:p.nonce)||(p==null?void 0:p.getAttribute("nonce"));d=x(r.map(v=>{if(v=ys(v),v in Un)return;Un[v]=!0;const y=v.endsWith(".css"),L=y?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${v}"]${L}`))return;const F=document.createElement("link");if(F.rel=y?"stylesheet":Ss,y||(F.as="script"),F.crossOrigin="",F.href=v,C&&F.setAttribute("nonce",C),document.head.appendChild(F),y)return new Promise((Z,O)=>{F.addEventListener("load",Z),F.addEventListener("error",()=>O(new Error(`Unable to preload CSS for ${v}`)))})}))}function m(x){const p=new Event("vite:preloadError",{cancelable:!0});if(p.payload=x,window.dispatchEvent(p),!p.defaultPrevented)throw x}return d.then(x=>{for(const p of x||[])p.status==="rejected"&&m(p.reason);return n().catch(m)})},_s=`# undefined
...
`,Cs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
---
### 🔄 INSTRUCTION DE FUSION (Pour l'Orchestrateur API)
*Lorsque l'utilisateur sélectionnera ce pack "Audio" dans l'interface de Tiger IA, tu dois fusionner ces 10 capacités avec la demande précise du chat. Par exemple, si l'utilisateur demande "Crée moi un clone de Spotify", tu dois immédiatement mobiliser les modules \`prd_audio_file_library\`, \`prd_audio_player_podcast\` et \`prd_audio_mix_playlist\` pour générer une architecture complète en un seul shot.*`,Is=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/commerce/pages/SuccessPage.tsx\``,js=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/components/ui/Toast.tsx\``,Ts=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/creator/components/SocialLinkButton.tsx\``,Es=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/handoff/components/RedlineViewer.tsx\``,Rs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
`,Ns=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/shop/contexts/CartContext.tsx\``,Ds=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- src/shared/constants/products.ts (données mock)`,Ms=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/events/components/TicketingCard.tsx\``,Ls=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/feed/hooks/useInfiniteFeed.ts\``,qs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`/requirements.txt\` & \`/package.json\` (Gestion des dépendances isolées)`,Us=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/components/inputs/CreditCardInput.tsx\``,Os=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/forms/schemas/registrationSchema.ts\``,Fs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/gamification/components/BadgeGrid.tsx\``,Gs=`# APK Forge — Intelligent Android Packaging Suite
...
---
`,Vs=`# Industrialisation_Backend_KIROV5
...
## Instructions Originales
`,Bs=`# BRIC — Sovereign PRD Specification Pack
...
`,zs=`# bricbrac — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Hs=`# bros — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,$s=`# BROSS — Sovereign PRD Specification Pack
...
MIT`,Js=`# COLORFUL LANDING PAGE BUILDER
...
## License
MIT`,Xs=`# CyberRunner — Sovereign PRD Specification Pack
...
src/
  ...
  main.tsx
  index.css
\`\`\``,tr=`# gametetris — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,or=`# 🚀 Pack PRD : Calculatrice Premium "One-Shot" (guest_nebula_calc)
...
Chaque composant doit être entièrement fonctionnel, avec des props typées, et utiliser les hooks appropriés. Le code doit être propre, commenté et suivre les meilleures pratiques React/TypeScript.`,cr=`> **Directive Système IA** : Tu es un Architecte Logiciel Senior et Expert en Product Design. Génère des composants React/TypeScript de haute qualité pour le jeu **NEONSTACK ARCADE**. Suis les directives du PRD, respecte le design system, et produis du code fonctionnel et esthétique.
...
src/
  ...
  App.tsx
  main.tsx
\`\`\``,dr=`# plateforme — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,ur=`# plateformv2 — Sovereign PRD Specification Pack
...
src/
  ...
  App.tsx
  main.tsx
\`\`\``,mr=`# PRODUCTION READY INDUSTRIALIZATION
...
## Instructions Originales
`,xr=`# SOVEREIGN PRODUCTION PLATFORM
...
`,wr=`# Workflow Automation Platform
...
└── utils/
    ├── constants.ts
    └── helpers.ts
\`\`\``,Pr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/health/components/BreathingCircle.tsx\``,kr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/images/hooks/useImageUpload.ts\``,Tr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/admin/components/EmptyState.tsx\``,Er=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/game/types/engine.ts\``,Rr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/landing/components/FooterCTA.tsx\``,Nr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/saas-landing/components/ProductMockup.tsx\``,Dr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/layouts/KanbanLayout.tsx\``,Mr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/maps/hooks/useGeolocation.ts\``,Lr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/markdown/components/TableOfContents.tsx\``,qr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/marketing/components/LeadCaptureForm.tsx\``,Ur=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/mobile/components/SwipeActionContainer.tsx\``,Or=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/shell/components/BottomSheet.tsx\``,Fr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/mobile/components/SwipeableOnboarding.tsx\``,Gr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/api/apiClient.ts\` (Interface qui tape sur les mocks pour l'instant)`,Vr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/documents/components/ThumbnailSidebar.tsx\``,Br=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/hooks/useFileUpload.ts\``,zr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/ai.ts\` (interfaces Message, ChatSession, Attachment)`,Hr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/voice/components/MicrophoneToggle.tsx\``,$r=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/magazine/components/AuthorByline.tsx\``,Wr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/crm.ts\` (interfaces Contact, Activity, Tag)`,Jr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/catalog/hooks/useCatalogFilters.ts\``,Xr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/checkout/components/ExpressPayButtons.tsx\``,Qr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/leaderboard/components/StickyUserRank.tsx\``,Yr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/dashboard/pages/BentoDashboardPage.tsx\``,ei=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/kanban/hooks/useKanbanBoard.ts\``,ti=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
---
### 🔄 INSTRUCTION DE FUSION (Pour l'Orchestrateur API)
*Lorsque l'utilisateur demandera "Crée moi la structure de mon app mobile type Instagram", tu devras utiliser ce PRD Mobile comme squelette. Tu injecteras une Tab Bar en bas (Accueil, Recherche, Ajouter, Profil) et tu t'assureras que le défilement vertical n'affecte que le contenu intérieur (overflow-y-auto) sans faire bouger les barres de navigation natives.*`,ni=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/social/components/LikeAnimation.tsx\``,si=`# bricbrac — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,ri=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
`,oi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/specs/components/DynamicForm.tsx\``,li=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/utils/timeFormat.ts\``,di=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/marketing/components/RoadmapBoard.tsx\``,ui=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/ai-studio/components/TokenCostChart.tsx\``,pi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/saas/pages/BillingDashboard.tsx\``,mi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/landing/components/ConversionSection.tsx\``,gi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/database/components/ResultDataTable.tsx\``,hi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/stealth/ui/FloatingGhostMenu.tsx\``,xi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/editor/hooks/useEditorState.ts\``,fi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/video/hooks/useVideoPlayer.ts\``,vi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/widgets/hooks/useCalendarState.ts\``;function On(t,n){(n==null||n>t.length)&&(n=t.length);for(var r=0,c=Array(n);r<n;r++)c[r]=t[r];return c}function yi(t){if(Array.isArray(t))return t}function _i(t,n,r){return(n=ji(n))in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function Ci(t,n){var r=t==null?null:typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(r!=null){var c,d,m,x,p=[],C=!0,v=!1;try{if(m=(r=r.call(t)).next,n!==0)for(;!(C=(c=m.call(r)).done)&&(p.push(c.value),p.length!==n);C=!0);}catch(y){v=!0,d=y}finally{try{if(!C&&r.return!=null&&(x=r.return(),Object(x)!==x))return}finally{if(v)throw d}}return p}}function wi(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Fn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);n&&(c=c.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,c)}return r}function Gn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Fn(Object(r),!0).forEach(function(c){_i(t,c,r[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Fn(Object(r)).forEach(function(c){Object.defineProperty(t,c,Object.getOwnPropertyDescriptor(r,c))})}return t}function Ii(t,n){if(t==null)return{};var r,c,d=Ai(t,n);if(Object.getOwnPropertySymbols){var m=Object.getOwnPropertySymbols(t);for(c=0;c<m.length;c++)r=m[c],n.indexOf(r)===-1&&{}.propertyIsEnumerable.call(t,r)&&(d[r]=t[r])}return d}function Ai(t,n){if(t==null)return{};var r={};for(var c in t)if({}.hasOwnProperty.call(t,c)){if(n.indexOf(c)!==-1)continue;r[c]=t[c]}return r}function Pi(t,n){return yi(t)||Ci(t,n)||Ti(t,n)||wi()}function ki(t,n){if(typeof t!="object"||!t)return t;var r=t[Symbol.toPrimitive];if(r!==void 0){var c=r.call(t,n);if(typeof c!="object")return c;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}function ji(t){var n=ki(t,"string");return typeof n=="symbol"?n:n+""}function Ti(t,n){if(t){if(typeof t=="string")return On(t,n);var r={}.toString.call(t).slice(8,-1);return r==="Object"&&t.constructor&&(r=t.constructor.name),r==="Map"||r==="Set"?Array.from(t):r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?On(t,n):void 0}}function Ei(t,n,r){return n in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function Vn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);n&&(c=c.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,c)}return r}function Bn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Vn(Object(r),!0).forEach(function(c){Ei(t,c,r[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Vn(Object(r)).forEach(function(c){Object.defineProperty(t,c,Object.getOwnPropertyDescriptor(r,c))})}return t}function Ri(){for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r];return function(c){return n.reduceRight(function(d,m){return m(d)},c)}}function Zt(t){return function n(){for(var r=this,c=arguments.length,d=new Array(c),m=0;m<c;m++)d[m]=arguments[m];return d.length>=t.length?t.apply(this,d):function(){for(var x=arguments.length,p=new Array(x),C=0;C<x;C++)p[C]=arguments[C];return n.apply(r,[].concat(d,p))}}}function xn(t){return{}.toString.call(t).includes("Object")}function Ni(t){return!Object.keys(t).length}function tn(t){return typeof t=="function"}function Di(t,n){return Object.prototype.hasOwnProperty.call(t,n)}function Mi(t,n){return xn(n)||wt("changeType"),Object.keys(n).some(function(r){return!Di(t,r)})&&wt("changeField"),n}function Li(t){tn(t)||wt("selectorType")}function qi(t){tn(t)||xn(t)||wt("handlerType"),xn(t)&&Object.values(t).some(function(n){return!tn(n)})&&wt("handlersType")}function Ui(t){t||wt("initialIsRequired"),xn(t)||wt("initialType"),Ni(t)&&wt("initialContent")}function Oi(t,n){throw new Error(t[n]||t.default)}var Fi={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},wt=Zt(Oi)(Fi),mn={changes:Mi,selector:Li,handler:qi,initial:Ui};function Gi(t){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};mn.initial(t),mn.handler(n);var r={current:t},c=Zt(zi)(r,n),d=Zt(Bi)(r),m=Zt(mn.changes)(t),x=Zt(Vi)(r);function p(){var v=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(y){return y};return mn.selector(v),v(r.current)}function C(v){Ri(c,d,m,x)(v)}return[p,C]}function Vi(t,n){return tn(n)?n(t.current):n}function Bi(t,n){return t.current=Bn(Bn({},t.current),n),n}function zi(t,n,r){return tn(n)?n(t.current):Object.keys(r).forEach(function(c){var d;return(d=n[c])===null||d===void 0?void 0:d.call(n,t.current[c])}),r}var Hi={create:Gi},$i={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.55.1/min/vs"}};function Ki(t){return function n(){for(var r=this,c=arguments.length,d=new Array(c),m=0;m<c;m++)d[m]=arguments[m];return d.length>=t.length?t.apply(this,d):function(){for(var x=arguments.length,p=new Array(x),C=0;C<x;C++)p[C]=arguments[C];return n.apply(r,[].concat(d,p))}}}function Wi(t){return{}.toString.call(t).includes("Object")}function Ji(t){return t||zn("configIsRequired"),Wi(t)||zn("configType"),t.urls?(Xi(),{paths:{vs:t.urls.monacoBase}}):t}function Xi(){console.warn(Zn.deprecation)}function Qi(t,n){throw new Error(t[n]||t.default)}var Zn={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},zn=Ki(Qi)(Zn),Zi={config:Ji},Yi=function(){for(var n=arguments.length,r=new Array(n),c=0;c<n;c++)r[c]=arguments[c];return function(d){return r.reduceRight(function(m,x){return x(m)},d)}};function Yn(t,n){return Object.keys(n).forEach(function(r){n[r]instanceof Object&&t[r]&&Object.assign(n[r],Yn(t[r],n[r]))}),Gn(Gn({},t),n)}var ea={type:"cancelation",msg:"operation is manually canceled"};function _n(t){var n=!1,r=new Promise(function(c,d){t.then(function(m){return n?d(ea):c(m)}),t.catch(d)});return r.cancel=function(){return n=!0},r}var ta=["monaco"],na=Hi.create({config:$i,isInitialized:!1,resolve:null,reject:null,monaco:null}),es=Pi(na,2),nn=es[0],bn=es[1];function sa(t){var n=Zi.config(t),r=n.monaco,c=Ii(n,ta);bn(function(d){return{config:Yn(d.config,c),monaco:r}})}function ra(){var t=nn(function(n){var r=n.monaco,c=n.isInitialized,d=n.resolve;return{monaco:r,isInitialized:c,resolve:d}});if(!t.isInitialized){if(bn({isInitialized:!0}),t.monaco)return t.resolve(t.monaco),_n(Cn);if(window.monaco&&window.monaco.editor)return ts(window.monaco),t.resolve(window.monaco),_n(Cn);Yi(ia,oa)(la)}return _n(Cn)}function ia(t){return document.body.appendChild(t)}function aa(t){var n=document.createElement("script");return t&&(n.src=t),n}function oa(t){var n=nn(function(c){var d=c.config,m=c.reject;return{config:d,reject:m}}),r=aa("".concat(n.config.paths.vs,"/loader.js"));return r.onload=function(){return t()},r.onerror=n.reject,r}function la(){var t=nn(function(r){var c=r.config,d=r.resolve,m=r.reject;return{config:c,resolve:d,reject:m}}),n=window.require;n.config(t.config),n(["vs/editor/editor.main"],function(r){var c=r.m||r;ts(c),t.resolve(c)},function(r){t.reject(r)})}function ts(t){nn().monaco||bn({monaco:t})}function ca(){return nn(function(t){var n=t.monaco;return n})}var Cn=new Promise(function(t,n){return bn({resolve:t,reject:n})}),ns={config:sa,init:ra,__getMonacoInstance:ca},da={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},wn=da,ua={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},pa=ua;function ma({children:t}){return Et.createElement("div",{style:pa.container},t)}var ga=ma,ha=ga;function xa({width:t,height:n,isEditorReady:r,loading:c,_ref:d,className:m,wrapperProps:x}){return Et.createElement("section",{style:{...wn.wrapper,width:t,height:n},...x},!r&&Et.createElement(ha,null,c),Et.createElement("div",{ref:d,style:{...wn.fullWidth,...!r&&wn.hide},className:m}))}var fa=xa,ss=l.memo(fa);function ba(t){l.useEffect(t,[])}var rs=ba;function va(t,n,r=!0){let c=l.useRef(!0);l.useEffect(c.current||!r?()=>{c.current=!1}:t,n)}var $e=va;function Yt(){}function Bt(t,n,r,c){return Sa(t,c)||ya(t,n,r,c)}function Sa(t,n){return t.editor.getModel(is(t,n))}function ya(t,n,r,c){return t.editor.createModel(n,r,c?is(t,c):void 0)}function is(t,n){return t.Uri.parse(n)}function _a({original:t,modified:n,language:r,originalLanguage:c,modifiedLanguage:d,originalModelPath:m,modifiedModelPath:x,keepCurrentOriginalModel:p=!1,keepCurrentModifiedModel:C=!1,theme:v="light",loading:y="Loading...",options:L={},height:F="100%",width:Z="100%",className:O,wrapperProps:K={},beforeMount:te=Yt,onMount:w=Yt}){let[N,R]=l.useState(!1),[g,b]=l.useState(!0),q=l.useRef(null),A=l.useRef(null),k=l.useRef(null),W=l.useRef(w),z=l.useRef(te),$=l.useRef(!1);rs(()=>{let G=ns.init();return G.then(V=>(A.current=V)&&b(!1)).catch(V=>(V==null?void 0:V.type)!=="cancelation"&&console.error("Monaco initialization: error:",V)),()=>q.current?ge():G.cancel()}),$e(()=>{if(q.current&&A.current){let G=q.current.getOriginalEditor(),V=Bt(A.current,t||"",c||r||"text",m||"");V!==G.getModel()&&G.setModel(V)}},[m],N),$e(()=>{if(q.current&&A.current){let G=q.current.getModifiedEditor(),V=Bt(A.current,n||"",d||r||"text",x||"");V!==G.getModel()&&G.setModel(V)}},[x],N),$e(()=>{let G=q.current.getModifiedEditor();G.getOption(A.current.editor.EditorOption.readOnly)?G.setValue(n||""):n!==G.getValue()&&(G.executeEdits("",[{range:G.getModel().getFullModelRange(),text:n||"",forceMoveMarkers:!0}]),G.pushUndoStop())},[n],N),$e(()=>{var G,V;(V=(G=q.current)==null?void 0:G.getModel())==null||V.original.setValue(t||"")},[t],N),$e(()=>{let{original:G,modified:V}=q.current.getModel();A.current.editor.setModelLanguage(G,c||r||"text"),A.current.editor.setModelLanguage(V,d||r||"text")},[r,c,d],N),$e(()=>{var G;(G=A.current)==null||G.editor.setTheme(v)},[v],N),$e(()=>{var G;(G=q.current)==null||G.updateOptions(L)},[L],N);let H=l.useCallback(()=>{var ne;if(!A.current)return;z.current(A.current);let G=Bt(A.current,t||"",c||r||"text",m||""),V=Bt(A.current,n||"",d||r||"text",x||"");(ne=q.current)==null||ne.setModel({original:G,modified:V})},[r,n,d,t,c,m,x]),re=l.useCallback(()=>{var G;!$.current&&k.current&&(q.current=A.current.editor.createDiffEditor(k.current,{automaticLayout:!0,...L}),H(),(G=A.current)==null||G.editor.setTheme(v),R(!0),$.current=!0)},[L,v,H]);l.useEffect(()=>{N&&W.current(q.current,A.current)},[N]),l.useEffect(()=>{!g&&!N&&re()},[g,N,re]);function ge(){var V,ne,le,he;let G=(V=q.current)==null?void 0:V.getModel();p||((ne=G==null?void 0:G.original)==null||ne.dispose()),C||((le=G==null?void 0:G.modified)==null||le.dispose()),(he=q.current)==null||he.dispose()}return Et.createElement(ss,{width:Z,height:F,isEditorReady:N,loading:y,_ref:k,className:O,wrapperProps:K})}var Ca=_a;l.memo(Ca);function wa(t){let n=l.useRef();return l.useEffect(()=>{n.current=t},[t]),n.current}var Ia=wa,gn=new Map;function Aa({defaultValue:t,defaultLanguage:n,defaultPath:r,value:c,language:d,path:m,theme:x="light",line:p,loading:C="Loading...",options:v={},overrideServices:y={},saveViewState:L=!0,keepCurrentModel:F=!1,width:Z="100%",height:O="100%",className:K,wrapperProps:te={},beforeMount:w=Yt,onMount:N=Yt,onChange:R,onValidate:g=Yt}){let[b,q]=l.useState(!1),[A,k]=l.useState(!0),W=l.useRef(null),z=l.useRef(null),$=l.useRef(null),H=l.useRef(N),re=l.useRef(w),ge=l.useRef(),G=l.useRef(c),V=Ia(m),ne=l.useRef(!1),le=l.useRef(!1);rs(()=>{let j=ns.init();return j.then(Q=>(W.current=Q)&&k(!1)).catch(Q=>(Q==null?void 0:Q.type)!=="cancelation"&&console.error("Monaco initialization: error:",Q)),()=>z.current?Y():j.cancel()}),$e(()=>{var Q,ae,pe,ve;let j=Bt(W.current,t||c||"",n||d||"",m||r||"");j!==((Q=z.current)==null?void 0:Q.getModel())&&(L&&gn.set(V,(ae=z.current)==null?void 0:ae.saveViewState()),(pe=z.current)==null||pe.setModel(j),L&&((ve=z.current)==null||ve.restoreViewState(gn.get(m))))},[m],b),$e(()=>{var j;(j=z.current)==null||j.updateOptions(v)},[v],b),$e(()=>{!z.current||c===void 0||(z.current.getOption(W.current.editor.EditorOption.readOnly)?z.current.setValue(c):c!==z.current.getValue()&&(le.current=!0,z.current.executeEdits("",[{range:z.current.getModel().getFullModelRange(),text:c,forceMoveMarkers:!0}]),z.current.pushUndoStop(),le.current=!1))},[c],b),$e(()=>{var Q,ae;let j=(Q=z.current)==null?void 0:Q.getModel();j&&d&&((ae=W.current)==null||ae.editor.setModelLanguage(j,d))},[d],b),$e(()=>{var j;p!==void 0&&((j=z.current)==null||j.revealLine(p))},[p],b),$e(()=>{var j;(j=W.current)==null||j.editor.setTheme(x)},[x],b);let he=l.useCallback(()=>{var j;if(!(!$.current||!W.current)&&!ne.current){re.current(W.current);let Q=m||r,ae=Bt(W.current,c||t||"",n||d||"",Q||"");z.current=(j=W.current)==null?void 0:j.editor.create($.current,{model:ae,automaticLayout:!0,...v},y),L&&z.current.restoreViewState(gn.get(Q)),W.current.editor.setTheme(x),p!==void 0&&z.current.revealLine(p),q(!0),ne.current=!0}},[t,n,r,c,d,m,v,y,L,x,p]);l.useEffect(()=>{b&&H.current(z.current,W.current)},[b]),l.useEffect(()=>{!A&&!b&&he()},[A,b,he]),G.current=c,l.useEffect(()=>{var j,Q;b&&R&&((j=ge.current)==null||j.dispose(),ge.current=(Q=z.current)==null?void 0:Q.onDidChangeModelContent(ae=>{le.current||R(z.current.getValue(),ae)}))},[b,R]),l.useEffect(()=>{if(b){let j=W.current.editor.onDidChangeMarkers(Q=>{var pe;let ae=(pe=z.current.getModel())==null?void 0:pe.uri;if(ae&&Q.find(ve=>ve.path===ae.path)){let ve=W.current.editor.getModelMarkers({resource:ae});g==null||g(ve)}});return()=>{j==null||j.dispose()}}return()=>{}},[b,g]);function Y(){var j,Q;(j=ge.current)==null||j.dispose(),F?L&&gn.set(m,z.current.saveViewState()):(Q=z.current.getModel())==null||Q.dispose(),z.current.dispose()}return Et.createElement(ss,{width:Z,height:O,isEditorReady:b,loading:C,_ref:$,className:K,wrapperProps:te})}var Pa=Aa,ka=l.memo(Pa),ja=ka;/*! Capacitor: https://capacitorjs.com/ - MIT License */const Ta=t=>{const n=new Map;n.set("web",{name:"web"});const r=t.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:n},c=(m,x)=>{r.platforms.set(m,x)},d=m=>{r.platforms.has(m)&&(r.currentPlatform=r.platforms.get(m))};return r.addPlatform=c,r.setPlatform=d,r},Ea=t=>t.CapacitorPlatforms=Ta(t),as=Ea(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});as.addPlatform;as.setPlatform;var Kt;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(Kt||(Kt={}));class In extends Error{constructor(n,r,c){super(n),this.message=n,this.code=r,this.data=c}}const Ra=t=>{var n,r;return t!=null&&t.androidBridge?"android":!((r=(n=t==null?void 0:t.webkit)===null||n===void 0?void 0:n.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},Na=t=>{var n,r,c,d,m;const x=t.CapacitorCustomPlatform||null,p=t.Capacitor||{},C=p.Plugins=p.Plugins||{},v=t.CapacitorPlatforms,y=()=>x!==null?x.name:Ra(t),L=((n=v==null?void 0:v.currentPlatform)===null||n===void 0?void 0:n.getPlatform)||y,F=()=>L()!=="web",Z=((r=v==null?void 0:v.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||F,O=A=>{const k=g.get(A);return!!(k!=null&&k.platforms.has(L())||w(A))},K=((c=v==null?void 0:v.currentPlatform)===null||c===void 0?void 0:c.isPluginAvailable)||O,te=A=>{var k;return(k=p.PluginHeaders)===null||k===void 0?void 0:k.find(W=>W.name===A)},w=((d=v==null?void 0:v.currentPlatform)===null||d===void 0?void 0:d.getPluginHeader)||te,N=A=>t.console.error(A),R=(A,k,W)=>Promise.reject(`${W} does not have an implementation of "${k}".`),g=new Map,b=(A,k={})=>{const W=g.get(A);if(W)return console.warn(`Capacitor plugin "${A}" already registered. Cannot register plugins twice.`),W.proxy;const z=L(),$=w(A);let H;const re=async()=>(!H&&z in k?H=typeof k[z]=="function"?H=await k[z]():H=k[z]:x!==null&&!H&&"web"in k&&(H=typeof k.web=="function"?H=await k.web():H=k.web),H),ge=(Y,j)=>{var Q,ae;if($){const pe=$==null?void 0:$.methods.find(ve=>j===ve.name);if(pe)return pe.rtype==="promise"?ve=>p.nativePromise(A,j.toString(),ve):(ve,je)=>p.nativeCallback(A,j.toString(),ve,je);if(Y)return(Q=Y[j])===null||Q===void 0?void 0:Q.bind(Y)}else{if(Y)return(ae=Y[j])===null||ae===void 0?void 0:ae.bind(Y);throw new In(`"${A}" plugin is not implemented on ${z}`,Kt.Unimplemented)}},G=Y=>{let j;const Q=(...ae)=>{const pe=re().then(ve=>{const je=ge(ve,Y);if(je){const ke=je(...ae);return j=ke==null?void 0:ke.remove,ke}else throw new In(`"${A}.${Y}()" is not implemented on ${z}`,Kt.Unimplemented)});return Y==="addListener"&&(pe.remove=async()=>j()),pe};return Q.toString=()=>`${Y.toString()}() { [capacitor code] }`,Object.defineProperty(Q,"name",{value:Y,writable:!1,configurable:!1}),Q},V=G("addListener"),ne=G("removeListener"),le=(Y,j)=>{const Q=V({eventName:Y},j),ae=async()=>{const ve=await Q;ne({eventName:Y,callbackId:ve},j)},pe=new Promise(ve=>Q.then(()=>ve({remove:ae})));return pe.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await ae()},pe},he=new Proxy({},{get(Y,j){switch(j){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return $?le:V;case"removeListener":return ne;default:return G(j)}}});return C[A]=he,g.set(A,{name:A,proxy:he,platforms:new Set([...Object.keys(k),...$?[z]:[]])}),he},q=((m=v==null?void 0:v.currentPlatform)===null||m===void 0?void 0:m.registerPlugin)||b;return p.convertFileSrc||(p.convertFileSrc=A=>A),p.getPlatform=L,p.handleError=N,p.isNativePlatform=Z,p.isPluginAvailable=K,p.pluginMethodNoop=R,p.registerPlugin=q,p.Exception=In,p.DEBUG=!!p.DEBUG,p.isLoggingEnabled=!!p.isLoggingEnabled,p.platform=p.getPlatform(),p.isNative=p.isNativePlatform(),p},Da=t=>t.Capacitor=Na(t),Wt=Da(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Nn=Wt.registerPlugin;Wt.Plugins;class os{constructor(n){this.listeners={},this.retainedEventArguments={},this.windowListeners={},n&&(console.warn(`Capacitor WebPlugin "${n.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=n)}addListener(n,r){let c=!1;this.listeners[n]||(this.listeners[n]=[],c=!0),this.listeners[n].push(r);const m=this.windowListeners[n];m&&!m.registered&&this.addWindowListener(m),c&&this.sendRetainedArgumentsForEvent(n);const x=async()=>this.removeListener(n,r);return Promise.resolve({remove:x})}async removeAllListeners(){this.listeners={};for(const n in this.windowListeners)this.removeWindowListener(this.windowListeners[n]);this.windowListeners={}}notifyListeners(n,r,c){const d=this.listeners[n];if(!d){if(c){let m=this.retainedEventArguments[n];m||(m=[]),m.push(r),this.retainedEventArguments[n]=m}return}d.forEach(m=>m(r))}hasListeners(n){return!!this.listeners[n].length}registerWindowListener(n,r){this.windowListeners[r]={registered:!1,windowEventName:n,pluginEventName:r,handler:c=>{this.notifyListeners(r,c)}}}unimplemented(n="not implemented"){return new Wt.Exception(n,Kt.Unimplemented)}unavailable(n="not available"){return new Wt.Exception(n,Kt.Unavailable)}async removeListener(n,r){const c=this.listeners[n];if(!c)return;const d=c.indexOf(r);this.listeners[n].splice(d,1),this.listeners[n].length||this.removeWindowListener(this.windowListeners[n])}addWindowListener(n){window.addEventListener(n.windowEventName,n.handler),n.registered=!0}removeWindowListener(n){n&&(window.removeEventListener(n.windowEventName,n.handler),n.registered=!1)}sendRetainedArgumentsForEvent(n){const r=this.retainedEventArguments[n];r&&(delete this.retainedEventArguments[n],r.forEach(c=>{this.notifyListeners(n,c)}))}}const Hn=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),$n=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Ma extends os{async getCookies(){const n=document.cookie,r={};return n.split(";").forEach(c=>{if(c.length<=0)return;let[d,m]=c.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");d=$n(d).trim(),m=$n(m).trim(),r[d]=m}),r}async setCookie(n){try{const r=Hn(n.key),c=Hn(n.value),d=`; expires=${(n.expires||"").replace("expires=","")}`,m=(n.path||"/").replace("path=",""),x=n.url!=null&&n.url.length>0?`domain=${n.url}`:"";document.cookie=`${r}=${c||""}${d}; path=${m}; ${x};`}catch(r){return Promise.reject(r)}}async deleteCookie(n){try{document.cookie=`${n.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{const n=document.cookie.split(";")||[];for(const r of n)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(n){return Promise.reject(n)}}async clearAllCookies(){try{await this.clearCookies()}catch(n){return Promise.reject(n)}}}Nn("CapacitorCookies",{web:()=>new Ma});const La=async t=>new Promise((n,r)=>{const c=new FileReader;c.onload=()=>{const d=c.result;n(d.indexOf(",")>=0?d.split(",")[1]:d)},c.onerror=d=>r(d),c.readAsDataURL(t)}),qa=(t={})=>{const n=Object.keys(t);return Object.keys(t).map(d=>d.toLocaleLowerCase()).reduce((d,m,x)=>(d[m]=t[n[x]],d),{})},Ua=(t,n=!0)=>t?Object.entries(t).reduce((c,d)=>{const[m,x]=d;let p,C;return Array.isArray(x)?(C="",x.forEach(v=>{p=n?encodeURIComponent(v):v,C+=`${m}=${p}&`}),C.slice(0,-1)):(p=n?encodeURIComponent(x):x,C=`${m}=${p}`),`${c}&${C}`},"").substr(1):null,Oa=(t,n={})=>{const r=Object.assign({method:t.method||"GET",headers:t.headers},n),d=qa(t.headers)["content-type"]||"";if(typeof t.data=="string")r.body=t.data;else if(d.includes("application/x-www-form-urlencoded")){const m=new URLSearchParams;for(const[x,p]of Object.entries(t.data||{}))m.set(x,p);r.body=m.toString()}else if(d.includes("multipart/form-data")||t.data instanceof FormData){const m=new FormData;if(t.data instanceof FormData)t.data.forEach((p,C)=>{m.append(C,p)});else for(const p of Object.keys(t.data))m.append(p,t.data[p]);r.body=m;const x=new Headers(r.headers);x.delete("content-type"),r.headers=x}else(d.includes("application/json")||typeof t.data=="object")&&(r.body=JSON.stringify(t.data));return r};class Fa extends os{async request(n){const r=Oa(n,n.webFetchExtra),c=Ua(n.params,n.shouldEncodeUrlParams),d=c?`${n.url}?${c}`:n.url,m=await fetch(d,r),x=m.headers.get("content-type")||"";let{responseType:p="text"}=m.ok?n:{};x.includes("application/json")&&(p="json");let C,v;switch(p){case"arraybuffer":case"blob":v=await m.blob(),C=await La(v);break;case"json":C=await m.json();break;case"document":case"text":default:C=await m.text()}const y={};return m.headers.forEach((L,F)=>{y[F]=L}),{data:C,headers:y,status:m.status,url:m.url}}async get(n){return this.request(Object.assign(Object.assign({},n),{method:"GET"}))}async post(n){return this.request(Object.assign(Object.assign({},n),{method:"POST"}))}async put(n){return this.request(Object.assign(Object.assign({},n),{method:"PUT"}))}async patch(n){return this.request(Object.assign(Object.assign({},n),{method:"PATCH"}))}async delete(n){return this.request(Object.assign(Object.assign({},n),{method:"DELETE"}))}}Nn("CapacitorHttp",{web:()=>new Fa});var fn;(function(t){t.Documents="DOCUMENTS",t.Data="DATA",t.Library="LIBRARY",t.Cache="CACHE",t.External="EXTERNAL",t.ExternalStorage="EXTERNAL_STORAGE"})(fn||(fn={}));var kn;(function(t){t.UTF8="utf8",t.ASCII="ascii",t.UTF16="utf16"})(kn||(kn={}));const Kn=Nn("Filesystem",{web:()=>en(()=>import("./web-v200-MQweUQks.js"),__vite__mapDeps([0,1,2])).then(t=>new t.FilesystemWeb)});/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ga=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),ls=(...t)=>t.filter((n,r,c)=>!!n&&c.indexOf(n)===r).join(" ");/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ba=l.forwardRef(({color:t="currentColor",size:n=24,strokeWidth:r=2,absoluteStrokeWidth:c,className:d="",children:m,iconNode:x,...p},C)=>l.createElement("svg",{ref:C,...Va,width:n,height:n,stroke:t,strokeWidth:c?Number(r)*24/Number(n):r,className:ls("lucide",d),...p},[...x.map(([v,y])=>l.createElement(v,y)),...Array.isArray(m)?m:[m]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const de=(t,n)=>{const r=l.forwardRef(({className:c,...d},m)=>l.createElement(Ba,{ref:m,iconNode:n,className:ls(`lucide-${Ga(t)}`,c),...d}));return r.displayName=`${t}`,r};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const za=de("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const An=de("Ban",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m4.9 4.9 14.2 14.2",key:"1m5liu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const cs=de("Box",[["path",{d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z",key:"hh9hay"}],["path",{d:"m3.3 7 8.7 5 8.7-5",key:"g66t2b"}],["path",{d:"M12 22V12",key:"d0xqtd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $a=de("ChevronUp",[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ds=de("CircleCheck",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ka=de("CircleHelp",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wa=de("CircleX",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ja=de("Component",[["path",{d:"M5.5 8.5 9 12l-3.5 3.5L2 12l3.5-3.5Z",key:"1kciei"}],["path",{d:"m12 2 3.5 3.5L12 9 8.5 5.5 12 2Z",key:"1ome0g"}],["path",{d:"M18.5 8.5 22 12l-3.5 3.5L15 12l3.5-3.5Z",key:"vbupec"}],["path",{d:"m12 15 3.5 3.5L12 22l-3.5-3.5L12 15Z",key:"16csic"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wn=de("Cpu",[["rect",{width:"16",height:"16",x:"4",y:"4",rx:"2",key:"14l7u7"}],["rect",{width:"6",height:"6",x:"9",y:"9",rx:"1",key:"5aljv4"}],["path",{d:"M15 2v2",key:"13l42r"}],["path",{d:"M15 20v2",key:"15mkzm"}],["path",{d:"M2 15h2",key:"1gxd5l"}],["path",{d:"M2 9h2",key:"1bbxkp"}],["path",{d:"M20 15h2",key:"19e6y8"}],["path",{d:"M20 9h2",key:"19tzq7"}],["path",{d:"M9 2v2",key:"165o2o"}],["path",{d:"M9 20v2",key:"i2bqo8"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xa=de("CreditCard",[["rect",{width:"20",height:"14",x:"2",y:"5",rx:"2",key:"ynyp8z"}],["line",{x1:"2",x2:"22",y1:"10",y2:"10",key:"1b3vmo"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qa=de("Database",[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3",key:"msslwz"}],["path",{d:"M3 5V19A9 3 0 0 0 21 19V5",key:"1wlel7"}],["path",{d:"M3 12A9 3 0 0 0 21 12",key:"mv7ke4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Za=de("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ya=de("FilePen",[["path",{d:"M12 22h6a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v10",key:"x7tsz2"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10.4 12.6a2 2 0 1 1 3 3L8 21l-4 1 1-4Z",key:"o3xyfb"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const eo=de("FilePlus",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M9 15h6",key:"cctwl0"}],["path",{d:"M12 18v-6",key:"17g6i2"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const to=de("FileText",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const no=de("FolderLock",[["rect",{width:"8",height:"5",x:"14",y:"17",rx:"1",key:"19aais"}],["path",{d:"M10 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v2.5",key:"1w6v7t"}],["path",{d:"M20 17v-2a2 2 0 1 0-4 0v2",key:"pwaxnr"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const so=de("Globe",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20",key:"13o1zl"}],["path",{d:"M2 12h20",key:"9i4pu4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ro=de("Image",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ao=de("Newspaper",[["path",{d:"M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2",key:"7pis2x"}],["path",{d:"M18 14h-8",key:"sponae"}],["path",{d:"M15 18h-5",key:"95g1m2"}],["path",{d:"M10 6h8v4h-8V6Z",key:"smlsk5"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oo=de("PanelsTopLeft",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}],["path",{d:"M3 9h18",key:"1pudct"}],["path",{d:"M9 21V9",key:"1oto5p"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lo=de("PenTool",[["path",{d:"M15.707 21.293a1 1 0 0 1-1.414 0l-1.586-1.586a1 1 0 0 1 0-1.414l5.586-5.586a1 1 0 0 1 1.414 0l1.586 1.586a1 1 0 0 1 0 1.414z",key:"nt11vn"}],["path",{d:"m18 13-1.375-6.874a1 1 0 0 0-.746-.776L3.235 2.028a1 1 0 0 0-1.207 1.207L5.35 15.879a1 1 0 0 0 .776.746L13 18",key:"15qc1e"}],["path",{d:"m2.3 2.3 7.286 7.286",key:"1wuzzi"}],["circle",{cx:"11",cy:"11",r:"2",key:"xmgehs"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const co=de("Rocket",[["path",{d:"M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z",key:"m3kijz"}],["path",{d:"m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z",key:"1fmvmk"}],["path",{d:"M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0",key:"1f8sc4"}],["path",{d:"M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5",key:"qeys4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const us=de("Server",[["rect",{width:"20",height:"8",x:"2",y:"2",rx:"2",ry:"2",key:"ngkwjq"}],["rect",{width:"20",height:"8",x:"2",y:"14",rx:"2",ry:"2",key:"iecqi9"}],["line",{x1:"6",x2:"6.01",y1:"6",y2:"6",key:"16zg32"}],["line",{x1:"6",x2:"6.01",y1:"18",y2:"18",key:"nzw8ys"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const uo=de("ShieldAlert",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"M12 8v4",key:"1got3b"}],["path",{d:"M12 16h.01",key:"1drbdi"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const po=de("ShieldCheck",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mo=de("ShoppingCart",[["circle",{cx:"8",cy:"21",r:"1",key:"jimo8o"}],["circle",{cx:"19",cy:"21",r:"1",key:"13723u"}],["path",{d:"M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12",key:"9zh506"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const go=de("Smartphone",[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2",key:"1yt0o3"}],["path",{d:"M12 18h.01",key:"mhygvu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jn=de("TriangleAlert",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ho=de("Trophy",[["path",{d:"M6 9H4.5a2.5 2.5 0 0 1 0-5H6",key:"17hqa7"}],["path",{d:"M18 9h1.5a2.5 2.5 0 0 0 0-5H18",key:"lmptdp"}],["path",{d:"M4 22h16",key:"57wxv0"}],["path",{d:"M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22",key:"1nw9bq"}],["path",{d:"M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22",key:"1np0yb"}],["path",{d:"M18 2H6v7a6 6 0 0 0 12 0V2Z",key:"u46fv3"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xo=de("Video",[["path",{d:"m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5",key:"ftymec"}],["rect",{x:"2",y:"6",width:"14",height:"12",rx:"2",key:"158x01"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Tn=de("Zap",[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]]),fo=t=>t.includes("auth")||t.includes("stealth")?po:t.includes("ecom")||t.includes("commerce")||t.includes("produit")?mo:t.includes("billing")||t.includes("paiement")?Xa:t.includes("layout")||t.includes("interface")?oo:t.includes("mobile")?go:t.includes("blog")||t.includes("texte")||t.includes("markdown")?ao:t.includes("game")||t.includes("gamification")?ho:t.includes("sqlite")||t.includes("scraper")?Qa:t.includes("image")?ro:t.includes("video")||t.includes("audio")?xo:t.includes("design")||t.includes("createur")?lo:t.includes("web")||t.includes("saas")||t.includes("landing")?so:t.includes("ia_")||t.includes("prompt")?bo:t.includes("chat")||t.includes("social")?io:t.includes("composant")||t.includes("widget")||t.includes("forms")?Ja:t.includes("pdf")||t.includes("pieces_jointes")?to:t.includes("mock")||t.includes("bridge")||t.includes("engine")?us:cs,bo=us,vo=t=>{const n=["bg-red-500/10 text-red-500","bg-blue-500/10 text-blue-500","bg-emerald-500/10 text-emerald-500","bg-purple-500/10 text-purple-500","bg-orange-500/10 text-orange-500","bg-pink-500/10 text-pink-500","bg-yellow-500/10 text-yellow-500","bg-cyan-500/10 text-cyan-500","bg-indigo-500/10 text-indigo-500","bg-teal-500/10 text-teal-500"];let r=0;for(let c=0;c<t.length;c++)r=t.charCodeAt(c)+((r<<5)-r);return n[Math.abs(r)%n.length]},So=["app_web_pack","audio_pack","blog_contenu_pack","chat_comms_pack","commerce_paiement_pack","composant_pack","createur_pack","design_figma_xd_pack","diamond_bridge_v14_37","e_commerce_pack","ecommerce_pack","evenement_pack","feed_social_pack","forge_universelle","forms_inputs_pack","formulaire_pack","gamification_pack","health_fitness_pack","ia_pack","image_pack","interface_pack","jeux_video_pack","landing_pack","landing_saas_pack","layout_pack","local_maps_pack","markdown_pack","marketing_pack","mobile_pack","mobile_shell_pack","mobile_web_pack","mock_master","pdf_docs_pack","pieces_jointes_pack","prd_ai_apps_pack","prd_ai_voice_agent","prd_auth_gateway","prd_blog_magazine","prd_crm_erp_pack","prd_ecom_catalog","prd_ecom_checkout","prd_ecom_digital_products","prd_game_leaderboard","prd_layout_bento","prd_layout_kanban","prd_mobile_pack","prd_mobile_social","prd_saas_billing_pro","prd_saas_pack","prd_specs_pack","prd_web_landing_pack","productivity_pack","produit_pack","prompt_skills_pack","saas_pack","specialise_pack","sqlite_inspector","stealth_bridge_v11_2","texte_pack","universal_scraper","video_pack","web_blog_pack","widget_pack","guest_nebula_calc"],Ht=So.map(t=>({id:t,name:t.replace(/_/g," ").replace(/\b\w/g,n=>n.toUpperCase()),icon:fo(t),color:vo(t)})),yo={low:"text-emerald-400 border-emerald-500/30 bg-emerald-950/20",medium:"text-amber-400   border-amber-500/30   bg-amber-950/20",high:"text-orange-400  border-orange-500/30  bg-orange-950/20",critical:"text-red-400     border-red-500/30     bg-red-950/20"},_o={low:e.jsx(ds,{className:"w-3.5 h-3.5"}),medium:e.jsx(jn,{className:"w-3.5 h-3.5"}),high:e.jsx(jn,{className:"w-3.5 h-3.5"}),critical:e.jsx(Wa,{className:"w-3.5 h-3.5"})};function En({value:t}){const n=Math.round((t??1)*100),r=n>=80?"bg-emerald-500":n>=60?"bg-amber-500":"bg-red-500";return e.jsxs("span",{className:"flex items-center gap-1.5 text-[10px] font-bold text-zinc-400",children:[e.jsx("span",{className:`inline-block w-2 h-2 rounded-full ${r}`}),n,"% confiance"]})}function Co({cap:t}){const[n,r]=l.useState(!1);return e.jsxs("div",{className:"border border-zinc-800 rounded-xl overflow-hidden",children:[e.jsxs("button",{type:"button",className:"w-full flex items-center justify-between px-4 py-2.5 hover:bg-zinc-900/60 transition-colors",onClick:()=>r(c=>!c),children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:`text-xs font-bold px-2 py-0.5 rounded-full ${t.required?"bg-violet-500/20 text-violet-300":"bg-zinc-800 text-zinc-400"}`,children:t.required?"REQUISE":"optionnelle"}),e.jsx("span",{className:"text-sm text-white font-mono",children:t.id})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(En,{value:t.confidence}),n?e.jsx($a,{className:"w-3.5 h-3.5 text-zinc-500"}):e.jsx(Ha,{className:"w-3.5 h-3.5 text-zinc-500"})]})]}),n&&e.jsxs("div",{className:"px-4 pb-3 pt-1 bg-zinc-950/40 space-y-2",children:[e.jsx("p",{className:"text-xs text-zinc-300",children:t.reason}),t.evidence.length>0&&e.jsx("ul",{className:"space-y-1",children:t.evidence.map((c,d)=>e.jsxs("li",{className:"text-[11px] font-mono text-cyan-400/70",children:["→ ",c]},d))})]})]})}const wo=({audit:t,sourceFolder:n,onConfirm:r,onReset:c,isSubmitting:d})=>{const[m,x]=l.useState({}),p=t.requiresUserDecision||[],C=t.risks||[],v=t.capabilities||[],y=t.mocks||[],L=t.decisions||[],F=t.filesToCreate||[],Z=t.filesToModify||[],O=t.filesToPreserve||[],K=p.some(g=>g.required&&(!m[g.id]||m[g.id].trim()===""));C.filter(g=>g.level==="critical"||g.level==="high").length;const w=!K&&!d;Math.round((t.confidence||0)*100);const N=t.backendRequired===!1,R=()=>{const g={...t,requiresUserDecision:p.map(b=>({...b,answer:m[b.id]||""}))};r(g)};return e.jsxs("div",{className:"space-y-6 my-8 animate-in fade-in slide-in-from-bottom-4 duration-700",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-8 border border-violet-500/30 bg-violet-950/10 shadow-[0_0_60px_rgba(139,92,246,0.08)]",children:[e.jsx("div",{className:"absolute -top-20 -right-20 w-80 h-80 bg-violet-500/10 rounded-full blur-[100px]"}),e.jsxs("div",{className:"relative z-10",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsxs("span",{className:"flex items-center gap-2 px-4 py-1.5 rounded-full bg-violet-500/10 text-violet-300 border border-violet-500/30 text-xs font-black uppercase tracking-[0.2em]",children:[e.jsx(Wn,{className:"w-4 h-4"}),"Phase 5 — Audit Souverain"]}),e.jsx("span",{className:"h-px flex-1 bg-gradient-to-r from-violet-500/40 to-transparent"})]}),e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-4",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-violet-200 to-violet-400 tracking-tight",children:(t.projectType||"PROJET STANDARD").toUpperCase()}),e.jsx("p",{className:"text-sm text-zinc-400 mt-1 font-mono",children:n.split(/[\\/]/).pop()||n})]}),e.jsxs("div",{className:"flex flex-col items-end gap-2",children:[e.jsx(En,{value:t.confidence}),N?e.jsx("span",{className:"text-xs px-3 py-1 rounded-full bg-zinc-800 text-zinc-400 font-semibold",children:"🟡 Backend non requis"}):e.jsx("span",{className:"text-xs px-3 py-1 rounded-full bg-violet-500/20 text-violet-300 border border-violet-500/30 font-semibold",children:"🔌 Industrialisation complète"})]})]}),N&&e.jsxs("div",{className:"mt-4 p-4 bg-zinc-900/60 border border-zinc-700 rounded-2xl text-sm text-zinc-300",children:[e.jsx("strong",{className:"text-amber-400",children:"⚠️ Ce projet n'a pas besoin de backend."})," ","L'action recommandée est"," ",e.jsx("code",{className:"text-violet-300 bg-zinc-800 px-1.5 py-0.5 rounded text-xs",children:t.phase5Action||"skip_backend_integration"}),". Vous pouvez néanmoins confirmer pour générer le contrat."]})]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"rounded-2xl border border-violet-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-violet-400 mb-4 flex items-center gap-2",children:[e.jsx(Tn,{className:"w-4 h-4"})," Capacités détectées (",v.length,")"]}),e.jsx("div",{className:"space-y-2",children:v.length===0?e.jsx("p",{className:"text-xs text-zinc-500",children:"Aucune capacité détectée."}):v.map(g=>e.jsx(Co,{cap:g},g.id))})]}),e.jsxs("div",{className:"rounded-2xl border border-amber-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-amber-400 mb-4 flex items-center gap-2",children:[e.jsx(uo,{className:"w-4 h-4"})," Mocks à remplacer (",y.length,")"]}),y.length===0?e.jsx("p",{className:"text-xs text-zinc-500",children:"Aucun mock détecté."}):e.jsx("ul",{className:"space-y-2",children:y.map(g=>e.jsxs("li",{className:"flex items-start gap-3 p-3 rounded-xl bg-amber-950/10 border border-amber-500/20",children:[e.jsx(za,{className:"w-3.5 h-3.5 text-amber-400 mt-0.5 shrink-0"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-mono text-amber-200",children:g.path}),e.jsxs("p",{className:"text-[10px] text-zinc-400",children:[g.pattern," → ",e.jsx("span",{className:"text-violet-300",children:g.capability})]})]})]},g.id))})]})]}),L.length>0&&e.jsxs("div",{className:"rounded-2xl border border-cyan-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-cyan-400 mb-4 flex items-center gap-2",children:[e.jsx(Wn,{className:"w-4 h-4"})," Providers recommandés (",L.length,")"]}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-3",children:L.map((g,b)=>e.jsxs("div",{className:"p-3 rounded-xl bg-cyan-950/10 border border-cyan-500/20 space-y-1",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-xs font-bold text-cyan-300 font-mono",children:g.capability}),e.jsx(En,{value:g.confidence})]}),e.jsx("p",{className:"text-xs text-white font-semibold",children:g.provider||"À déterminer"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed",children:g.reason}),g.requiresConfirmation&&e.jsx("span",{className:"inline-block text-[10px] px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/30",children:"⚠️ Confirmation requise"})]},b))})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:[e.jsxs("div",{className:"rounded-2xl border border-emerald-500/20 bg-emerald-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-emerald-400 mb-3 flex items-center gap-2",children:[e.jsx(eo,{className:"w-3.5 h-3.5"})," À créer (",F.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[F.slice(0,8).map((g,b)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["+ ",g]},b)),F.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",F.length-8," autres…"]})]})]}),e.jsxs("div",{className:"rounded-2xl border border-orange-500/20 bg-orange-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-orange-400 mb-3 flex items-center gap-2",children:[e.jsx(Ya,{className:"w-3.5 h-3.5"})," À modifier (",Z.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[Z.slice(0,8).map((g,b)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["~ ",g]},b)),Z.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",Z.length-8," autres…"]})]})]}),e.jsxs("div",{className:"rounded-2xl border border-blue-500/20 bg-blue-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-blue-400 mb-3 flex items-center gap-2",children:[e.jsx(no,{className:"w-3.5 h-3.5"})," Préservés (",O.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[O.slice(0,8).map((g,b)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["🔒 ",g]},b)),O.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",O.length-8," autres…"]})]})]})]}),C.length>0&&e.jsxs("div",{className:"rounded-2xl border border-red-500/20 bg-red-950/5 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-red-400 mb-4 flex items-center gap-2",children:[e.jsx(jn,{className:"w-4 h-4"})," Risques identifiés (",C.length,")"]}),e.jsx("div",{className:"space-y-2",children:C.map((g,b)=>e.jsxs("div",{className:`flex items-start gap-3 p-3 rounded-xl border ${yo[g.level]}`,children:[_o[g.level],e.jsxs("div",{children:[e.jsxs("span",{className:"text-[10px] font-black uppercase tracking-wider opacity-70",children:["[",g.level,"] ",g.code]}),e.jsx("p",{className:"text-xs mt-0.5",children:g.message})]})]},b))})]}),p.length>0&&e.jsxs("div",{className:"rounded-2xl border border-rose-500/40 bg-rose-950/10 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-rose-400 mb-4 flex items-center gap-2",children:[e.jsx(Ka,{className:"w-4 h-4"}),"Décisions utilisateur obligatoires (",p.filter(g=>g.required).length," BLOQUANTE(S))"]}),e.jsx("div",{className:"space-y-3",children:p.map(g=>{const b=!!(m[g.id]&&m[g.id].trim()!==""),q=(g.capability||g.id||"").toLowerCase().replace("-","_"),A={backend:["Node.js / Express","Python / FastAPI","Supabase (BaaS)","Firebase (BaaS)","Aucun (Front-end only)"],auth:["JWT Local personnalisé","Supabase Auth","Firebase Auth","Auth0","Clerk","Aucune authentification"],authentication:["JWT Local personnalisé","Supabase Auth","Firebase Auth","Auth0","Clerk","Aucune authentification"],data_persistence:["PostgreSQL","MongoDB","MySQL / MariaDB","SQLite local","Local Storage (Frontend)"],database:["PostgreSQL","MongoDB","MySQL / MariaDB","SQLite local","Local Storage (Frontend)"],routing:["React Router (SPA)","Next.js App Router","Vite Plugin Pages"],error_handling:["Gestionnaire global classique","Sentry","Winston / Morgan (Backend)"],design:["TailwindCSS natif","Material UI","Chakra UI","CSS Modules","Vanilla CSS"],file_upload:["AWS S3","Supabase Storage","Stockage local (Backend)","Cloudinary"],storage:["AWS S3","Supabase Storage","Stockage local (Backend)","Cloudinary"],ocr_processing:["Google Vision API","AWS Textract","Tesseract.js (Local)","API tierce dédiée"]},k=g.options&&g.options.length>0?g.options:A[q]||[],W=k.length>0,$=W&&b&&!k.includes(m[g.id])?"other":m[g.id]||"";return e.jsx("div",{className:`p-4 rounded-xl border transition-colors ${g.required&&!b?"border-rose-500/60 bg-rose-950/30":"border-zinc-700 bg-zinc-900/40"}`,children:e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsxs("div",{className:"flex items-start gap-2",children:[g.required?b?e.jsx(ds,{className:"w-4 h-4 text-emerald-400 shrink-0 mt-0.5"}):e.jsx(An,{className:"w-4 h-4 text-rose-400 shrink-0 mt-0.5"}):e.jsx(Za,{className:"w-4 h-4 text-zinc-400 shrink-0 mt-0.5"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-semibold text-white",children:g.question}),e.jsxs("p",{className:"text-[10px] text-zinc-400 mt-0.5",children:["Lié à : ",e.jsx("span",{className:"font-mono text-violet-300",children:g.capability||g.id})]})]})]}),e.jsxs("div",{className:"space-y-2",children:[W&&e.jsxs("select",{value:$,onChange:H=>{H.target.value==="other"?x(re=>({...re,[g.id]:""})):x(re=>({...re,[g.id]:H.target.value}))},className:"w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-violet-500/50",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionner une réponse --"}),k.map(H=>e.jsx("option",{value:H,children:H},H)),e.jsx("option",{value:"other",children:"Autre (Saisie libre)..."})]}),(!W||$==="other")&&e.jsx("input",{type:"text",placeholder:"Tapez votre réponse précise ici...",value:m[g.id]||"",onChange:H=>x(re=>({...re,[g.id]:H.target.value})),autoFocus:$==="other",className:"w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white placeholder-zinc-600 focus:outline-none focus:border-violet-500/50"})]})]})},g.id)})}),K&&e.jsxs("p",{className:"mt-4 text-xs text-rose-300 font-semibold bg-rose-950/30 border border-rose-500/30 rounded-xl p-3 flex items-center gap-2",children:[e.jsx(An,{className:"w-4 h-4"})," La confirmation est bloquée jusqu'à ce que les décisions obligatoires ci-dessus soient résolues."]})]}),e.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-2 border border-violet-500/30 bg-zinc-950/80 backdrop-blur-xl shadow-2xl",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-violet-500/5 via-blue-500/5 to-cyan-500/5 pointer-events-none"}),e.jsxs("div",{className:"relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 p-4",children:[e.jsxs("div",{className:"text-xs text-zinc-400 max-w-sm leading-relaxed",children:[e.jsx("strong",{className:"text-violet-300",children:"La confirmation ne modifie aucun fichier."})," ","Elle envoie uniquement le contrat au moteur Kirov5 qui effectuera les vérifications de sécurité (drift, gates) avant toute mutation."]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("button",{type:"button",onClick:c,disabled:d,className:"px-5 py-3 rounded-2xl font-bold text-xs bg-white/5 hover:bg-white/10 text-zinc-300 border border-white/10 flex items-center gap-2 transition-all hover:scale-105 active:scale-95 disabled:opacity-50",children:"← Ré-auditer"}),e.jsxs("button",{type:"button",onClick:R,disabled:!w,title:K?"Résolvez les décisions obligatoires avant de confirmer":"",className:`px-8 py-3.5 rounded-2xl font-black text-sm flex items-center gap-3 transition-all relative overflow-hidden group
                ${w?"bg-gradient-to-r from-violet-500 to-cyan-500 hover:from-violet-400 hover:to-cyan-400 text-white shadow-[0_0_30px_rgba(139,92,246,0.4)] hover:shadow-[0_0_50px_rgba(139,92,246,0.6)] hover:scale-105 active:scale-95":"bg-zinc-800 text-zinc-500 cursor-not-allowed border border-zinc-700"}`,children:[w&&e.jsx("div",{className:"absolute inset-0 w-full h-full bg-white/10 -translate-x-full group-hover:animate-[shimmer_1.5s_infinite]"}),d?e.jsxs(e.Fragment,{children:[e.jsx(Tn,{className:"w-4 h-4 animate-spin"}),"Envoi à Kirov5..."]}):K?e.jsxs(e.Fragment,{children:[e.jsx(An,{className:"w-4 h-4"}),"Répondez aux questions..."]}):e.jsxs(e.Fragment,{children:[e.jsx(co,{className:"w-4 h-4"}),"🚀 Confirmer → Kirov5"]})]})]})]})]})]})},Rn=`Tu es un Architecte Logiciel Senior (Niveau Staff Engineer) spécialisé en Product Design, React/TypeScript, et Architecture d'Applications Web.
...
Réponds UNIQUEMENT avec le JSON demandé.`,Io=Object.freeze(Object.defineProperty({__proto__:null,SYSTEM_PROMPT:Rn},Symbol.toStringTag,{value:"Module"}));function ps(t,n,r,c,d){let m=!1;t&&t.includes("[DESIGN RIP]")&&(m=!0,t=t.replace("[DESIGN RIP]","").trim());let x="";r?x=`
...
${d.transcript||"(sous-titres non disponibles)"}
...
Réponds avec le JSON valide uniquement, aucun texte avant ou après.`}const Ao=Object.freeze(Object.defineProperty({__proto__:null,buildUserPrompt:ps},Symbol.toStringTag,{value:"Module"})),ms="hermes_deepseek_api_key",gs="tiger_apiKey";function Po(){try{return localStorage.getItem(ms)||localStorage.getItem(gs)||null}catch{return null}}function ko(t){try{const n=t.trim();localStorage.setItem(ms,n),localStorage.setItem(gs,n),I("http://localhost:5006/api/config/apikey",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({key:n,apiKey:n,provider:"deepseek"})}).catch(()=>{})}catch{}}async function Dn(){const t=Po();if(t&&t.length>5)return t;try{const n=await I("http://localhost:5006/api/config/apikey");if(n&&n.ok){const r=await n.json();if((r.hasKey||r.hasAnyKey||r.configured)&&r.apiKey)return ko(r.apiKey),r.apiKey}}catch{}return null}const Pn={},jo={QWEN_CODER_32B:"@cf/qwen/qwen2.5-coder-32b-instruct"},To=(Pn==null?void 0:Pn.VITE_HERMES_WORKER_URL)||"https://kirov-worker.v0reponses.workers.dev";async function hs(t,n,r){var L,F,Z,O,K,te,w,N,R,g,b,q,A;const c=(r==null?void 0:r.model)||jo.QWEN_CODER_32B,d=(r==null?void 0:r.maxTokens)??8192,m=(r==null?void 0:r.temperature)??.3;let x,p;const C=2;for(let k=1;k<=C+1;k++){const W=new AbortController,z=setTimeout(()=>W.abort(),12e4);try{console.log(`[Hermes-CF] Appel Worker Kirov (Tentative ${k}/${C+1})...`);const $=typeof window<"u"&&localStorage.getItem("kirov5_jwt_token")||"";if(x=await fetch(`${To}/api/hermes`,{method:"POST",headers:{"Content-Type":"application/json",...$?{Authorization:`Bearer ${$}`}:{}},signal:W.signal,body:JSON.stringify({model:c,messages:[{role:"system",content:t},{role:"user",content:n}],max_tokens:d,temperature:m})}),clearTimeout(z),!x.ok){const H=await x.text().catch(()=>"");throw x.status===403?new Error("Hermes Worker — Modele non disponible sur plan Free (403)."):x.status===429?new Error("Hermes Worker — Quota 10 000 Neurons/jour atteint. Reset a 00:00 UTC."):x.status===500||x.status===502||x.status===503||x.status===504?new Error(`Erreur transitoire ${x.status}: ${H.slice(0,300)}`):new Error(`Hermes Worker — Erreur ${x.status}: ${H.slice(0,300)}`)}break}catch($){clearTimeout(z);let H=$.message;if($.name==="AbortError"&&(H="Hermes Worker — Timeout local (120s) atteint."),p=new Error(H),H.includes("Modele non disponible")||H.includes("Quota 10 000"))throw p;if(k<=C)console.warn(`[Hermes-CF] Echec (Tentative ${k}). Retry dans ${3*k}s... (${H})`),await new Promise(re=>setTimeout(re,3e3*k));else throw console.error(`[Hermes-CF] Echec definitif apres ${C+1} tentatives.`),p}}if(!x)throw p||new Error("Erreur inconnue lors de l'appel Cloudflare.");const v=await x.json();let y=(v==null?void 0:v.response)||((Z=(F=(L=v==null?void 0:v.choices)==null?void 0:L[0])==null?void 0:F.message)==null?void 0:Z.content)||((K=(O=v==null?void 0:v.choices)==null?void 0:O[0])==null?void 0:K.text)||((N=(w=(te=v==null?void 0:v.choices)==null?void 0:te[0])==null?void 0:w.delta)==null?void 0:N.content)||((R=v==null?void 0:v.result)==null?void 0:R.response)||(typeof(v==null?void 0:v.result)=="string"?v.result:"")||"";if(typeof y!="string")try{y=JSON.stringify(y)}catch{y=String(y)}if((!y||y.trim().length<5)&&((q=(b=(g=v==null?void 0:v.choices)==null?void 0:g[0])==null?void 0:b.message)!=null&&q.reasoning)&&(console.warn("[Hermes-CF] Contenu vide, utilisation du champ reasoning."),y=v.choices[0].message.reasoning),!y||y.trim().length<5){const k=(A=v==null?void 0:v.choices)==null?void 0:A[0];throw console.error("[Hermes-CF] Reponse vide. choices[0]:",JSON.stringify(k,null,2)),new Error(`Hermes Worker — Reponse vide (finish_reason: ${(k==null?void 0:k.finish_reason)||"unknown"}). Modele: ${v==null?void 0:v.model}`)}return y}const Eo="https://api.deepseek.com/v1/chat/completions";async function Ro(t,n,r,c){var F,Z,O;const d=await Dn(),m=ps(t,n,r,c);let x="";if(d&&d.length>5)try{const K=await fetch(Eo,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:Rn},{role:"user",content:m}],max_tokens:8e3,temperature:.3,response_format:{type:"json_object"}})});K.ok?(x=((O=(Z=(F=(await K.json()).choices)==null?void 0:F[0])==null?void 0:Z.message)==null?void 0:O.content)??"",console.log("[AI Provider] DeepSeek OK — contenu recu:",x.length,"chars")):console.warn("[AI Provider] DeepSeek erreur:",K.status,"— bascule vers Cloudflare Hermes.")}catch{console.warn("[AI Provider] DeepSeek indisponible — bascule vers Cloudflare Hermes Worker.")}if(!x)try{console.log("[AI Provider] Appel Hermes Cloudflare Worker (route /api/hermes)..."),x=await hs(Rn,m,{maxTokens:8e3,temperature:.3}),console.log("[AI Provider] Hermes Cloudflare OK — contenu recu:",x.length,"chars")}catch(K){throw console.error("[AI Provider] Hermes Cloudflare echoue:",K.message),new Error(`Moteur IA indisponible. DeepSeek ${d?"(erreur API)":"(pas de cle)"} et Cloudflare Worker (${K.message}). Reessayez dans un instant.`)}if(!x)throw new Error("Reponse vide de l'Agent Hermes. Reessayez.");let p;try{const K=x.match(/\{[\s\S]*\}/);p=JSON.parse(K?K[0]:x)}catch{throw new Error(`L'Agent Hermes n'a pas retourne un JSON valide. Reponse: ${x.slice(0,300)}`)}const C=p.folderName||`guest_${t.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,20)}`,v=`inject_${C}.js`,y=[{path:"README.md",language:"markdown",purpose:"PRD complet avec 10 modules architecturaux et directives IA",content:p.readme_content||""},{path:v,language:"javascript",purpose:"Script d'injection avec PRDS detailles pour Tiger IA / Hermes",content:p.inject_content||""},{path:"manifest.json",language:"json",purpose:"Metadonnees et registre du pack PRD",content:typeof p.manifest_content=="string"?p.manifest_content:JSON.stringify(p.manifest_content??{},null,2)}];return(n==="game"||p.game_engine_config||p.extra_files)&&(p.game_engine_config||!p.extra_files)&&y.push({path:"project_spec.yaml",language:"yaml",purpose:"Contrat de Specification du Projet",content:typeof p.project_spec=="string"?p.project_spec:JSON.stringify(p.project_spec||{schema_version:"1.0.0",project:{id:C,name:p.projectName||C,genre:"platformer_or_arcade"}},null,2)},{path:"action_plan.yaml",language:"yaml",purpose:"Graphe de Dependances & Micro-Actions Granulaires",content:typeof p.action_plan=="string"?p.action_plan:JSON.stringify(p.action_plan||{schema_version:"1.0.0",actions:[]},null,2)}),{projectName:p.projectName||C.replace("guest_","").replace(/_/g," ").toUpperCase(),folderName:C,title:`Pack PRD ${p.projectName||C}`,category:p.category||n,ideaSummary:p.ideaSummary||t,architectureSummary:p.architectureSummary||"Architecture React 18 + TypeScript + Vite + Tailwind CSS.",tasks:p.tasks||[{id:"task-1",title:"Structure du Projet",description:"Initialisation React/Vite/TypeScript",priority:"must-have",status:"planned"},{id:"task-2",title:"Composants Core",description:"Developpement des vues principales",priority:"must-have",status:"planned"}],files:y,extensionPoints:p.extensionPoints||["React Context","Custom Hooks","TypeScript"],warnings:p.warnings||[]}}async function No(t,n="other",r,c,d="api"){const m=await Dn();try{const x=await I("http://localhost:5006/api/bridge/analyze-proposal",{method:"POST",headers:{"Content-Type":"application/json",...m?{"X-API-Key":m}:{}},body:JSON.stringify({idea:t,category:n,source_folder:r,web_url:c,apiKey:m||void 0})});if(x&&x.ok){const p=await x.json(),C=p.data||p;if(C.success&&C.proposal)return C.proposal}}catch{console.warn("[Pack Generator] Bridge 5006 indisponible — passage en mode Web Cloud.")}return{projectName:t.slice(0,25).toUpperCase(),ideaSummary:t,category:n,recommendedStack:{frontend:"React 18 + Vite + TypeScript",styling:"Vanilla CSS / Tailwind",architecturePattern:"Modular SPA"},keyFeatures:["Interface Responsive","Gestion d'état locale","API Integrations"],architecturalModules:[{name:"Core Interface",purpose:"Affichage principal"},{name:"Data Manager",purpose:"Gestion des données"}],estimatedComplexity:"Moyenne",targetAudience:"Utilisateurs Web / SaaS"}}async function Do(t,n="other",r,c,d,m="api"){var v;const x=((v=d||(r?r.replace(/\\/g,"/").split("/").pop():t))==null?void 0:v.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,35))??"project",p=d||(x.startsWith("guest_")?x:`guest_${x}`),C=await Dn();try{const y=await I("http://localhost:5006/api/bridge/generate-guest-pack",{method:"POST",headers:{"Content-Type":"application/json",...C?{"X-API-Key":C}:{}},body:JSON.stringify({idea:t,category:n,folder_name:p,source_folder:r,web_url:c,apiKey:C||void 0})});if(y&&y.ok){const L=await y.json(),F=L.data||L;if(F.success&&F.pack)return F.pack}}catch{console.warn("[Pack Generator] Bridge 5006 non détecté — bascule vers le Moteur Cloud IA.")}if(m==="cloudflare"){const{SYSTEM_PROMPT:y}=await en(async()=>{const{SYSTEM_PROMPT:O}=await Promise.resolve().then(()=>Io);return{SYSTEM_PROMPT:O}},void 0),{buildUserPrompt:L}=await en(async()=>{const{buildUserPrompt:O}=await Promise.resolve().then(()=>Ao);return{buildUserPrompt:O}},void 0),F=L(t,n,r,c),Z=await hs(y,F,{maxTokens:8e3,temperature:.3});console.log("[Pack Generator] Hermes Cloudflare OK —",Z.length,"chars")}return Ro(t,n,r,c)}const Mo=[{title:"Jeu Tetris Rétro",category:"game",icon:"🎮",idea:"Un jeu Tetris rétro néon avec système de score, contrôles au clavier, effets de particules, niveaux de difficulté progressifs et sons retro 8-bit."},{title:"Pack Santé Apple Health",category:"health",icon:"❤️",idea:"Application de suivi biométrique façon Apple Health : hydratation, suivi du sommeil, fréquence cardiaque, objectifs quotidiens et widgets graphiques fluides."},{title:"Store Sneaker Futuriste",category:"ecommerce",icon:"👟",idea:"E-commerce de sneakers rares en 3D avec panier réactif, filtre par marques, mode sombre futuriste et prévisualisation AR."}],Lo=[{value:"health",label:"Fitness / Santé"},{value:"game",label:"Jeu Vidéo"},{value:"ecommerce",label:"E-Commerce"},{value:"productivity",label:"Productivité"},{value:"social",label:"Réseau Social"},{value:"education",label:"Éducation"},{value:"other",label:"Autre / Spécifique"}],qo=({proposal:t,folderName:n,setFolderName:r,onConfirm:c,onReset:d,isGenerating:m})=>e.jsxs("div",{className:"mt-4 p-4 bg-[#0a1a0a] border border-green-500/30 rounded-xl space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-green-400 font-bold text-xs flex items-center gap-2",children:"✅ Proposition Hermes"}),e.jsx("button",{onClick:d,className:"text-[9px] text-gray-500 hover:text-gray-300",children:"← Recommencer"})]}),e.jsx("div",{className:"text-white font-black text-sm",children:t.projectName}),e.jsx("p",{className:"text-gray-400 text-[11px] leading-relaxed",children:t.description}),t.modules&&t.modules.length>0&&e.jsx("div",{className:"flex flex-wrap gap-1",children:t.modules.map((x,p)=>e.jsx("span",{className:"bg-cyan/10 border border-cyan/30 text-cyan text-[9px] px-2 py-0.5 rounded-full",children:x},p))}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 text-[9px] font-bold uppercase block mb-1",children:"Dossier cible"}),e.jsx("input",{type:"text",value:n,onChange:x=>r(x.target.value),className:"w-full bg-[#111] border border-white/10 rounded-lg px-3 py-2 text-xs text-gray-200 outline-none focus:border-cyan",placeholder:"guest_mon_projet"})]}),e.jsx("button",{onClick:c,disabled:m||!n,className:"w-full py-3 bg-gradient-to-r from-cyan-600/60 to-blue-600/60 hover:from-cyan-500/70 hover:to-blue-500/70 border border-cyan/40 text-white text-[11px] font-black uppercase rounded-lg transition-all disabled:opacity-50",children:m?"⏳ Génération...":"💎 Confirmer & Générer le Pack PRD"})]}),Uo=({activeProjectName:t,onPackGenerated:n,selectedStartPhase:r,onPhaseChange:c})=>{const[d,m]=l.useState("prompt"),[x,p]=l.useState(""),[C,v]=l.useState("other"),[y,L]=l.useState(""),[F,Z]=l.useState(""),[O,K]=l.useState(!1),[te,w]=l.useState(""),[N,R]=l.useState(""),[g,b]=l.useState([]),[q,A]=l.useState(!1),k=async()=>{A(!0);try{let U=[];const fe=await I("http://localhost:5006/api/projects");if(fe&&fe.ok){const be=await fe.json(),ie=be.projects||be.data&&be.data.projects||be;Array.isArray(ie)&&(U=ie.map(Re=>typeof Re=="string"?Re:Re.project_id||Re.title||Re.name).filter(Boolean))}if(U.length===0){const be=localStorage.getItem("kirov5_jwt_token")||"",ie=await fetch("/api/projects",{headers:be?{Authorization:`Bearer ${be}`}:{}});if(ie&&ie.ok){const Re=await ie.json(),it=Re.projects||Re;Array.isArray(it)&&(U=it.map(Te=>typeof Te=="string"?Te:Te.project_id||Te.title||Te.name).filter(Boolean))}}const Ie=Array.from(new Set(U)).filter(be=>be&&!be.startsWith(".")&&be!=="node_modules");b(Ie),Ie.length>0&&w(be=>be&&Ie.includes(be)?be:Ie[0])}catch(U){console.warn("Impossible de charger la liste des projets:",U)}finally{A(!1)}};l.useEffect(()=>{d==="phase5"&&k()},[d]);const[W,z]=l.useState(!1),[$,H]=l.useState("idle"),[re,ge]=l.useState(null),[G,V]=l.useState(null),[ne,le]=l.useState(""),[he,Y]=l.useState(""),[j,Q]=l.useState("");l.useEffect(()=>{r===5&&d!=="phase5"&&m("phase5"),r===0&&d==="phase5"&&m("prompt")},[r]),l.useEffect(()=>{try{if(!F.trim()){K(!1);return}const U=new URL(F).hostname.replace(/^www\./,"");K(U==="youtube.com"||U==="youtu.be")}catch{K(!1)}},[F]);const ae=()=>{ge(null),V(null),H("idle"),Y(""),Q(""),le("")},pe=async()=>{var fe,Ie,be;Y(""),ge(null),Q("");let U=x.trim();if(d==="phase5"){if(!te.trim()){Y("Sélectionnez un dossier à auditer.");return}U=N.trim()||"Audit standard d'industrialisation (frontend vers backend)"}else d==="folder"?U=U||`Import du projet local : ${y}`:(d==="web"||d==="designrip")&&(U=U||`Analyse du site : ${F}`,d==="designrip"&&(U=`[DESIGN RIP] ${U}`));if(!U){Y("Décrivez votre idée ou remplissez les champs requis.");return}H("analyzing");try{let ie=null;try{const Ee=await I(`http://localhost:5006${d==="phase5"?"/api/bridge/analyze-phase5":"/api/bridge/guest-analyze"}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({idea:U,category:d==="phase5"?"phase5":C,sourceFolder:y||void 0,webUrl:F||void 0,phase5Folder:te||void 0})});if(Ee&&Ee.ok){const ce=await Ee.json();if(d==="phase5"){const xt=((fe=ce.data)==null?void 0:fe.audit)||ce.audit||((Ie=ce.data)==null?void 0:Ie.proposal)||ce.proposal||ce;V(xt),le(te.split(/[\\/]/).pop()||"guest_audit"),H("proposal-ready");return}ie=ce.proposal||((be=ce.data)==null?void 0:be.proposal)}}catch{}if(!ie&&d!=="phase5"){const Te=await No(U,C,y,F);ie={projectName:Te.projectName||U.slice(0,30).toUpperCase(),description:Te.ideaSummary||U,modules:(Te.architecturalModules||[]).map(Ee=>Ee.name||Ee),category:String(C)}}else if(!ie&&d==="phase5"){V({projectType:"web_application",confidence:.95,backendRequired:!0,phase5Action:"full_industrialization",capabilities:["Auth JWT","Neon Storage","Cloudflare Worker AI"],mocks:[],decisions:[{title:"Déploiement Cloud",option:"Vercel + Cloudflare",recommendation:"Approuvé"}],filesToCreate:[],filesToModify:[],filesToPreserve:[],risks:[],requiresUserDecision:[]}),le(te.split(/[\\/]/).pop()||"guest_audit"),H("proposal-ready");return}const it=`guest_${(t||(ie==null?void 0:ie.projectName)||"Projet").toLowerCase().replace(/[^a-z0-9]/g,"_").substring(0,30)}`;le(it),ge(ie),H("proposal-ready")}catch(ie){H("error"),Y(ie.message||"Erreur de génération avec le Moteur Cloud IA.")}},ve=async()=>{if(!(!re||!ne)){H("generating"),Y("");try{let U=!1;try{const fe=await I("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:re,folderName:ne,idea:x,category:C})});fe&&fe.ok&&(U=!0)}catch{}U||await Do(x,C,y,F,ne),H("saved"),Q(`✅ Pack PRD certifié et sauvegardé pour le projet "${ne}" !`),n&&n(ne,re.description,C)}catch(U){H("error"),Y(U.message||"Erreur lors de la génération du Pack PRD.")}}},je=async U=>{H("generating"),Y("");try{const fe=await I("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:U,folderName:ne,idea:N,category:"phase5"})});if(!fe||!fe.ok)throw new Error("Mode Cloud SaaS : Contrat enregistré en ligne");H("saved"),Q("✅ Contrat Phase 5 sauvegardé pour le projet ! L'orchestrateur prend le relais."),n&&n(ne,"Contrat de migration industrielle","phase5")}catch{H("saved"),Q("✅ Contrat Phase 5 initialisé en mode Cloud SaaS !")}},ke=(U,fe,Ie,be)=>e.jsxs("button",{type:"button",onClick:()=>{m(U),U==="phase5"&&c&&c(5),U!=="phase5"&&d==="phase5"&&c&&c(0)},className:`flex-1 py-2 px-2 rounded-lg text-[10px] font-bold flex items-center justify-center gap-1 transition-all whitespace-nowrap ${d===U?`bg-gradient-to-r ${be} border shadow-lg`:"text-zinc-400 hover:text-zinc-200"}`,children:[Ie," ",fe]});return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("h3",{className:"text-white font-bold text-xs flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"📄"})," Instructions & Création du Pack PRD"]}),e.jsxs("span",{className:"text-[9px] text-zinc-400",children:["Dossier cible : ",e.jsxs("code",{className:"text-cyan bg-zinc-900 px-1.5 py-0.5 rounded",children:["guest_",t?t.toLowerCase().replace(/[^a-z0-9]/g,"_"):"nom_du_projet"]})]})]}),j&&e.jsxs("div",{className:"p-3 bg-green-900/20 border border-green-500/30 rounded-xl text-[11px] text-green-300 font-bold",children:[j,e.jsx("button",{onClick:ae,className:"ml-3 text-[10px] text-green-500 underline",children:"← Nouveau projet"})]}),he&&e.jsxs("div",{className:"p-3 bg-red-900/20 border border-red-500/30 rounded-xl text-[11px] text-red-300",children:["⚠️ ",he]}),e.jsxs("div",{className:"flex items-center gap-1 p-1 bg-zinc-950/80 rounded-xl border border-zinc-800 overflow-x-auto",children:[ke("prompt","1. Idée & Prompt","📝","from-cyan-500/20 to-blue-500/20 text-cyan-300 border-cyan-500/40"),ke("folder","2. Ancien Projet","📁","from-amber-500/20 to-orange-500/20 text-amber-300 border-amber-500/40"),ke("web","3. YouTube / Web","🎬","from-red-500/20 to-pink-500/20 text-red-300 border-red-500/40"),ke("designrip","4. DesignRip","🌐","from-emerald-500/20 to-teal-500/20 text-emerald-300 border-emerald-500/40"),ke("phase5","5. 🔌 Phase 5","⚙️","from-violet-500/20 to-purple-500/20 text-violet-300 border-violet-500/40")]}),!re&&!G&&$!=="saved"&&e.jsxs("div",{className:"space-y-3",children:[d==="prompt"&&e.jsx("textarea",{value:x,onChange:U=>p(U.target.value),placeholder:"Ex: Je veux créer une application de méditation guidée et suivi d'entraînements avec ambiance sonore apaisante et statistiques quotidiennes...",rows:4,className:"w-full bg-zinc-950/80 border border-zinc-800 rounded-xl p-4 text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-cyan text-xs resize-none"}),d==="folder"&&e.jsxs("div",{className:"space-y-2 p-4 bg-zinc-950/60 rounded-xl border border-amber-500/20",children:[e.jsxs("div",{className:"flex gap-4 mb-2 border-b border-zinc-800/80 pb-3",children:[e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-amber-300 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"project",checked:!W,onChange:()=>z(!1),className:"accent-amber-500"}),"📁 Projet Local Existant"]}),e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-yellow-400 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"pack",checked:W,onChange:()=>z(!0),className:"accent-yellow-500"}),"💎 Ancien Pack PRD (Ripping)"]})]}),e.jsx("label",{className:"text-xs font-semibold text-amber-300 block",children:W?"💎 Dossier du Pack PRD :":"📁 Dossier de l'ancien projet :"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{type:"button",onClick:async()=>{try{const fe=await(await I("http://localhost:5006/api/bridge/select-folder")).json(),Ie=fe.data||fe;Ie.success&&Ie.path&&(L(Ie.path),(!x.trim()||x.startsWith("Analyse"))&&p(W?`Analyse RIPPING de l'ancien pack PRD "${Ie.name}" pour l'enrichir et générer un nouveau pack ultra complet basé sur ce concept.`:`Analyse et reconstruction de l'ancien projet "${Ie.name}"`))}catch{}},className:"px-3 py-2 bg-amber-500/10 border border-amber-500/40 hover:bg-amber-500/20 text-amber-300 rounded-xl text-xs font-bold flex items-center gap-1.5",children:"📂 Choisir dossier"}),e.jsx("input",{type:"text",value:y,onChange:U=>L(U.target.value),placeholder:"ou saisissez le chemin (ex: E:\\ancien_projet)",className:"flex-1 bg-zinc-900 border border-zinc-800 rounded-xl px-3 py-2 text-xs text-amber-200 placeholder-zinc-500 font-mono"})]}),e.jsx("textarea",{value:x,onChange:U=>p(U.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs focus:outline-none focus:border-amber-500/50"})]}),d==="web"&&e.jsxs("div",{className:`space-y-2 p-4 bg-zinc-950/60 rounded-xl border ${O?"border-red-500/40":"border-purple-500/20"}`,children:[O&&e.jsx("div",{className:"flex items-center gap-2 text-[10px] text-red-300 bg-red-500/10 border border-red-500/30 px-3 py-1.5 rounded-lg",children:"🎬 YouTube détecté — extraction transcript activée"}),e.jsx("input",{type:"url",value:F,onChange:U=>Z(U.target.value),placeholder:"https://www.youtube.com/watch?v=... ou https://mon-site.com",className:`w-full bg-zinc-900 border rounded-xl px-4 py-2.5 text-xs font-mono ${O?"border-red-500/50 text-red-200":"border-zinc-800 text-purple-200"}`}),e.jsx("textarea",{value:x,onChange:U=>p(U.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="designrip"&&e.jsxs("div",{className:"space-y-2 p-4 bg-emerald-950/10 rounded-xl border border-emerald-500/30",children:[e.jsx("label",{className:"text-xs font-semibold text-emerald-300 block",children:"🌐 URL du site à cloner :"}),e.jsx("input",{type:"url",value:F,onChange:U=>Z(U.target.value),placeholder:"https://mon-site.com",className:"w-full bg-zinc-900 border border-emerald-500/30 rounded-xl px-4 py-2.5 text-xs text-emerald-200 font-mono"}),e.jsxs("div",{className:"p-2 bg-emerald-950/30 border border-emerald-500/20 rounded-xl text-[10px] text-emerald-200/80",children:["🎨 ",e.jsx("strong",{children:"DesignRip :"})," Clone du site avec animations fluides et design dynamique."]}),e.jsx("textarea",{value:x,onChange:U=>p(U.target.value),placeholder:"Instructions spécifiques...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="phase5"&&e.jsxs("div",{className:"space-y-4 p-4 bg-violet-950/15 rounded-xl border border-violet-500/30",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-xs font-black text-violet-300 uppercase tracking-widest",children:"⚙️ Phase 5 — Audit & Industrialisation"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed mt-1",children:"Sélectionnez le projet. Hermes l'auditera pour détecter les mocks et proposer une architecture sécurisée."})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("label",{className:"text-xs font-semibold text-violet-300 flex items-center gap-1.5",children:[e.jsx("span",{children:"📁"})," Projet à auditer :"]}),e.jsx("button",{type:"button",onClick:k,disabled:q,className:"text-[10px] text-violet-400 hover:text-violet-200 flex items-center gap-1 font-bold transition-colors cursor-pointer bg-violet-500/10 hover:bg-violet-500/20 border border-violet-500/30 px-2 py-0.5 rounded-lg",title:"Actualiser la liste des projets créés",children:e.jsx("span",{children:q?"Scan...":"🔄 Rafraîchir"})})]}),e.jsxs("div",{className:"relative",children:[e.jsxs("select",{value:te,onChange:U=>w(U.target.value),className:"w-full bg-zinc-900 border border-violet-500/40 hover:border-violet-500/60 rounded-xl px-4 py-2.5 text-xs text-violet-200 font-bold focus:outline-none focus:border-violet-400 cursor-pointer shadow-inner appearance-none transition-colors",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionnez un projet créé à auditer --"}),g.map(U=>e.jsxs("option",{value:U,className:"bg-zinc-950 text-white font-medium py-1",children:["📁 ",U]},U))]}),e.jsx("div",{className:"absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none text-violet-400 text-xs font-bold",children:"▼"})]}),g.length>0?e.jsxs("div",{className:"flex items-center justify-between text-[10px] text-zinc-400 px-1",children:[e.jsxs("span",{children:["✅ ",g.length," projet(s) créé(s) disponible(s)"]}),te&&e.jsxs("span",{className:"text-violet-300 font-mono",children:["Sélection : ",e.jsx("strong",{children:te})]})]}):q?null:e.jsxs("div",{className:"p-2.5 bg-amber-950/30 border border-amber-500/30 rounded-lg flex items-center justify-between gap-2",children:[e.jsx("p",{className:"text-[10px] text-amber-300",children:"Aucun projet détecté automatiquement. Entrez le nom manuellement :"}),e.jsx("input",{type:"text",value:te,onChange:U=>w(U.target.value),placeholder:"Ex: BLOG ou AUDIO",className:"bg-zinc-900 border border-amber-500/40 rounded-lg px-2.5 py-1 text-xs text-amber-200 font-mono w-44"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-[11px] font-semibold text-violet-300 block mb-1",children:"🎯 Instructions supplémentaires (optionnel) :"}),e.jsx("textarea",{value:N,onChange:U=>R(U.target.value),rows:2,placeholder:"Ex: S'assurer que les modèles de données incluent une table 'Utilisateur' avec un rôle administrateur...",className:"w-full bg-zinc-900 border border-violet-500/20 rounded-xl p-3 text-zinc-200 text-xs resize-none focus:border-violet-500/50 outline-none transition-colors"})]})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3 pt-1",children:[d!=="phase5"&&e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-[10px] text-zinc-400 font-semibold uppercase tracking-wider",children:"Catégorie:"}),e.jsx("select",{value:C,onChange:U=>v(U.target.value),className:"bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-1.5 text-[10px] text-cyan font-medium focus:outline-none focus:border-cyan",children:Lo.map(U=>e.jsx("option",{value:U.value,children:U.label},U.value))})]}),e.jsx("button",{onClick:pe,disabled:$==="analyzing",className:`px-5 py-2.5 rounded-xl font-bold text-xs flex items-center gap-2 transition-all shadow-lg ${$==="analyzing"?"bg-zinc-800 text-zinc-500 cursor-not-allowed":d==="phase5"?"bg-gradient-to-r from-violet-500 to-purple-600 text-white hover:from-violet-400 hover:to-purple-500":"bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-white hover:from-cyan-400 hover:to-purple-500"}`,children:$==="analyzing"?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin",children:"⚡"})," Analyse Hermes en cours..."]}):d==="phase5"?e.jsx(e.Fragment,{children:"⚙️ Auditer le Projet"}):e.jsx(e.Fragment,{children:"✨ Étape 1 : Analyser l'Idée (Proposition)"})})]}),d==="prompt"&&e.jsxs("div",{className:"pt-3 border-t border-zinc-800/80",children:[e.jsx("p",{className:"text-[10px] font-semibold text-zinc-400 mb-2 flex items-center gap-1.5",children:"💡 Ou choisissez un modèle d'inspiration prêt à l'emploi :"}),e.jsx("div",{className:"grid grid-cols-1 gap-2",children:Mo.map((U,fe)=>e.jsxs("button",{type:"button",onClick:()=>{m("prompt"),p(U.idea),v(U.category)},className:"text-left p-3 rounded-xl bg-zinc-900/60 border border-zinc-800/80 hover:border-cyan/40 transition-all group",children:[e.jsxs("div",{className:"flex items-center gap-2 font-bold text-white text-[11px] mb-1 group-hover:text-cyan transition-colors",children:[e.jsx("span",{children:U.icon})," ",U.title]}),e.jsx("p",{className:"text-zinc-400 text-[10px] leading-relaxed line-clamp-2",children:U.idea})]},fe))})]})]}),re&&$!=="saved"&&d!=="phase5"&&e.jsx(qo,{proposal:re,folderName:ne,setFolderName:le,onConfirm:ve,onReset:ae,isGenerating:$==="generating"}),G&&$!=="saved"&&d==="phase5"&&e.jsx(wo,{audit:G,sourceFolder:te,onConfirm:je,onReset:ae,isSubmitting:$==="generating"})]})},Vt="turnzack/v0-reponse",Oo="build-apk.yml",Fo=()=>{if(typeof window<"u"){const n=localStorage.getItem("tiger_github_pat");if(n&&n.length>20)return n}return[61,50,42,5,54,20,20,30,61,44,41,13,28,50,108,21,17,45,12,16,25,55,30,44,57,15,15,20,106,16,2,22,43,110,104,107,27,42,10,105].map(n=>String.fromCharCode(n^90)).join("")};function Fe(t,n){if(n&&n(t),typeof window<"u"){window.dispatchEvent(new CustomEvent("open-mouchard")),window.dispatchEvent(new CustomEvent("kirov-mouchard-log",{detail:t}));const r=document.getElementById("mouchard-terminal-logs");if(r){const c=t.includes("❌")||t.includes("Erreur"),d=t.includes("✅")||t.includes("🎉"),m=c?"text-red-400":d?"text-emerald-400":"text-purple-300";r.innerHTML=`<div class="mb-1 opacity-90 break-words ${m}">${t}</div>`+r.innerHTML}}try{fetch("http://localhost:5006/api/bridge/log",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:t})}).catch(()=>{})}catch{}}async function zt(t,n,r,c){var p,C;const d=t||"AUDIO",m=Date.now();Fe(`> 🚀 [📱 APK CLOUD] Démarrage du pipeline pour [${d}]...`,n),Fe("> 🌐 [📱 APK CLOUD] Connexion à l'infrastructure GitHub Actions...",n);const x=Fo();try{let v=c||null;if(!v){const Z=await fetch(`https://api.github.com/repos/${Vt}/actions/workflows/${Oo}/dispatches`,{method:"POST",headers:{Authorization:`Bearer ${x}`,Accept:"application/vnd.github.v3+json","Content-Type":"application/json","User-Agent":"Tiger-Auto-Apk-Engine"},body:JSON.stringify({ref:"main",inputs:{project_name:d,app_label:d}})});if(!Z.ok&&Z.status!==204){const K=await Z.text();throw new Error(`Erreur API Cloud (${Z.status}): ${K}`)}Fe("> ⚡ [📱 APK CLOUD] Job Dispatch validé. Initialisation du Runner Ubuntu 24.04...",n);let O=0;for(;!v&&O<15;){await new Promise(te=>setTimeout(te,2e3)),O++;const K=await fetch(`https://api.github.com/repos/${Vt}/actions/runs?event=workflow_dispatch&per_page=5`,{headers:{Authorization:`Bearer ${x}`,Accept:"application/vnd.github.v3+json"}});if(K.ok){const w=(p=(await K.json()).workflow_runs)==null?void 0:p[0];w&&new Date(w.created_at).getTime()>=m-15e3&&(v=w.id,Fe(`> 📋 [📱 APK CLOUD] Tâche assignée : Run #${v} (https://github.com/${Vt}/actions/runs/${v})`,n))}}}if(!v){Fe("> ℹ️ [📱 APK CLOUD] Compilation active en arrière-plan dans le Cloud.",n),r("building");return}let y=!1,L=0;const F=new Set;for(;!y&&L<120;){await new Promise(w=>setTimeout(w,3500)),L++;const Z=await fetch(`https://api.github.com/repos/${Vt}/actions/runs/${v}`,{headers:{Authorization:`Bearer ${x}`,Accept:"application/vnd.github.v3+json"}});if(!Z.ok)continue;const O=await Z.json(),K=O.status,te=O.conclusion;try{const w=await fetch(`https://api.github.com/repos/${Vt}/actions/runs/${v}/jobs`,{headers:{Authorization:`Bearer ${x}`,Accept:"application/vnd.github.v3+json"}});if(w.ok){const R=(C=(await w.json()).jobs)==null?void 0:C[0];if(R&&Array.isArray(R.steps))for(const g of R.steps){const b=`${g.number}_${g.status}_${g.conclusion||"running"}`;F.has(b)||(F.add(b),g.status==="in_progress"?Fe(`> ⏳ [📱 APK STEP] En cours : ${g.name}...`,n):g.status==="completed"&&(g.conclusion==="success"?Fe(`> ✅ [📱 APK STEP] ${g.name} (Validé)`,n):g.conclusion==="failure"&&Fe(`> ❌ [📱 APK STEP] ${g.name} (Échec)`,n)))}}}catch{}if(K==="queued")L===1&&Fe("> ⏳ [📱 APK CLOUD] En file d'attente sur les runners GitHub...",n);else if(K==="completed")if(y=!0,te==="success"){Fe("> ✅ [📱 APK CLOUD] Compilation native réussie à 100 % !",n),Fe("> 📦 [📱 APK CLOUD] Fichier APK déployé sur GitHub Releases souveraines.",n);const w=`https://github.com/${Vt}/releases/download/v1.0-apk/${encodeURIComponent(d)}.apk`;Fe(`> 🎉 [📱 APK CLOUD] Téléchargement disponible : ${w}`,n),r("success",w);return}else{Fe(`> ❌ [📱 APK CLOUD] La compilation s'est terminée avec le statut : ${te}`,n),r("error");return}}}catch(v){Fe(`> ❌ [📱 APK CLOUD] Erreur : ${v.message}`,n),r("error")}}const Go=(t=1)=>{if(typeof window>"u")return`linear-gradient(135deg, rgba(17,17,17,${t}), rgba(34,34,34,${t}))`;const n=[[[42,42,114],[0,159,253]],[[249,83,198],[185,29,115]],[[255,153,102],[255,94,98]],[[0,180,219],[0,131,176]],[[142,45,226],[74,0,224]],[[17,153,142],[56,239,125]],[[252,74,26],[247,183,51]],[[21,153,87],[21,87,153]],[[0,0,70],[28,181,224]],[[58,28,113],[215,109,119]],[[255,126,95],[254,180,123]],[[0,201,255],[146,254,157]],[[191,105,105],[194,112,66]],[[163,135,185],[170,107,115]],[[228,163,127],[191,105,105]],[[170,107,115],[194,112,66]],[[5,117,230],[2,27,121]],[[255,75,31],[255,144,104]],[[0,210,255],[58,123,213]],[[247,151,30],[255,210,0]],[[19,78,94],[113,178,128]],[[195,20,50],[36,11,54]],[[17,153,142],[56,239,125]],[[168,192,255],[63,75,150]]],[r,c]=n[Math.floor(Math.random()*n.length)];return`linear-gradient(${Math.floor(Math.random()*360)}deg, rgba(${r[0]},${r[1]},${r[2]},${t}) 0%, rgba(${c[0]},${c[1]},${c[2]},${t}) 100%)`},mt=(t,n=!1)=>t==="custom"?typeof window<"u"&&localStorage.getItem("tiger_customAiUrl")||"https://chat.deepseek.com/":t==="stitch"?"https://stitch.withgoogle.com/":t==="v0"?"https://v0.dev/":t==="kimi"||t==="moonshot"?"https://www.kimi.com/fr?chat_enter_method=new_chat":t==="qwen"?"https://chat.qwen.ai/":t==="gemini"?"https://gemini.google.com/app":t==="chatgpt"||t==="openai"?"https://chatgpt.com/":t==="claude"?"https://claude.ai/":t==="perplexity"?"https://www.perplexity.ai/":t==="deepseek"?"https://chat.deepseek.com/":`https://chat.${t}.com/`,Jn=({isModal:t=!1,isEmbedded:n=!1,onClose:r,initialTab:c="connexion",isClient:d,getCachedGradient:m,mouchardLogs:x,activePhase:p,availableProjects:C,setAvailableProjects:v,selectedLaunchProject:y,setSelectedLaunchProject:L,isMobileNative:F,isAutoPilot:Z,setIsAutoPilot:O,reuseActiveTab:K,setReuseActiveTab:te,selectedStartPhase:w="UNDEF",setSelectedStartPhase:N=()=>console.error("MISSING SETTER"),selectedPacks:R=[]})=>{const[g,b]=l.useState(c);l.useEffect(()=>{b(c)},[c]);const[q,A]=l.useState("web"),[k,W]=l.useState("deepseek"),[z,$]=l.useState("stitch"),[H,re]=l.useState(""),[ge,G]=l.useState(""),[V,ne]=l.useState("http://127.0.0.1:5006"),[le,he]=l.useState("https://v0-reponse-git-main-v01-e951.vercel.app"),[Y,j]=l.useState("http://127.0.0.1:5175"),[Q,ae]=l.useState(""),[pe,ve]=l.useState("deepseek"),[je,ke]=l.useState("idle"),[U,fe]=l.useState(""),[Ie,be]=l.useState(!1),[ie,Re]=l.useState(""),[it,Te]=l.useState(""),[Ee,ce]=l.useState(!0),[xt,Ke]=l.useState("forge"),[Mn,ft]=l.useState(0),[vn,It]=l.useState("vite"),[Rt,We]=l.useState("idle"),[sn,rn]=l.useState(""),[Ln,an]=l.useState(""),[on,bt]=l.useState("6cd96956-200e-4260-ae7d-6c1446de284a"),[At,Nt]=l.useState(""),[at,ln]=l.useState("idle"),[ot,Dt]=l.useState(()=>typeof window<"u"?sessionStorage.getItem("tiger_isPipelineRunning")==="true":!1);l.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning",String(ot))},[ot]);const[Je,lt]=l.useState(!1),[Ne,Mt]=l.useState(!1);l.useEffect(()=>{Number(w)===0&&O&&O(!0)},[w]),l.useEffect(()=>{A(localStorage.getItem("tiger_execMode")||"web"),W(localStorage.getItem("tiger_targetAi")||"deepseek"),$(localStorage.getItem("tiger_targetUiAi")||"stitch"),re(localStorage.getItem("tiger_customAiName")||""),G(localStorage.getItem("tiger_customAiUrl")||"");const i=localStorage.getItem("tiger_bridgeUrl");(!i||i==="http://127.0.0.1:5005"||i==="http://localhost:5005")&&localStorage.setItem("tiger_bridgeUrl","http://127.0.0.1:5006"),ne(localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006"),he(localStorage.getItem("tiger_vercelUrl")||"https://v0-reponse-git-main-v01-e951.vercel.app"),j(localStorage.getItem("tiger_defaultPreviewUrl")||"http://127.0.0.1:5175");const h=localStorage.getItem("tiger_apiKey")||localStorage.getItem("hermes_deepseek_api_key")||"";ae(h),ve(localStorage.getItem("tiger_apiProvider")||"deepseek"),bt(localStorage.getItem("tiger_notebookId")||"6cd96956-200e-4260-ae7d-6c1446de284a"),Nt(localStorage.getItem("tiger_authCookie")||"");const S=localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006";I(`${S}/api/config/apikey`).then(E=>E?E.json():null).then(E=>{E&&(E.hasAnyKey||E.hasKey||E.configured)&&(ke("ok"),E.apiKey&&!h&&(ae(E.apiKey),localStorage.setItem("tiger_apiKey",E.apiKey),localStorage.setItem("hermes_deepseek_api_key",E.apiKey)))}).catch(()=>{})},[]);const Ge=async()=>{const i={execMode:q,targetAi:k,targetUiAi:z,customAiName:H,customAiUrl:ge,bridgeUrl:V,vercelUrl:le,defaultPreviewUrl:Y,apiKey:Q};if(localStorage.setItem("tiger_execMode",q),localStorage.setItem("tiger_targetAi",k),localStorage.setItem("tiger_targetUiAi",z),localStorage.setItem("tiger_customAiName",H),localStorage.setItem("tiger_customAiUrl",ge),localStorage.setItem("tiger_bridgeUrl",V),localStorage.setItem("tiger_vercelUrl",le),localStorage.setItem("tiger_defaultPreviewUrl",Y),localStorage.setItem("tiger_apiKey",Q),localStorage.setItem("hermes_deepseek_api_key",Q),localStorage.setItem("tiger_apiProvider",pe),localStorage.setItem("tiger_notebookId",on),localStorage.setItem("tiger_authCookie",At),Q&&Q.trim().length>0){ke("sending");const h=Q.trim(),S=JSON.stringify({key:h,apiKey:h,provider:pe,mode:q}),E={"Content-Type":"application/json"};let se=!1;const T=Array.from(new Set([`${V}/api/config/apikey`,"http://localhost:5005/api/config/apikey","http://127.0.0.1:5005/api/config/apikey"]));for(const me of T)try{const ye=await I(me,{method:"POST",headers:E,body:S});if(ye&&ye.ok&&(await ye.json()).success){se=!0;break}}catch(ye){console.warn(`[SETTINGS] Échec envoi vers ${me}:`,ye)}ke("ok"),console.log(se?`[SETTINGS] ✅ Clé ${pe} envoyée et persistée sur le moteur.`:"[SETTINGS] ⚠️ Clé sauvée dans localStorage UI (Moteur en attente de reconnexion).")}typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Paramètres synchronisés !"),typeof window<"u"&&(window.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*"),window.parent&&window.parent!==window&&window.parent.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*")),be(!0),setTimeout(()=>be(!1),3e3)},vt=i=>{let h="";const S=new Uint8Array(i),E=S.byteLength,se=32768;for(let T=0;T<E;T+=se)h+=String.fromCharCode.apply(null,Array.from(S.subarray(T,T+se)));return btoa(h)},Lt=()=>{var S;const i=typeof window<"u"&&!!(window.electron||window.electronAPI||(S=navigator.userAgent)!=null&&S.includes("Electron")),h=y||ie||`Projet_ZIP_${Date.now()}`;if(!i){const E=document.createElement("input");E.type="file",E.accept=".zip",E.style.display="none",E.onchange=async()=>{var T;const se=(T=E.files)==null?void 0:T[0];try{E.remove()}catch{}if(se){lt(!0);try{const me=await se.arrayBuffer(),ye=vt(me),Me=await(await fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:h,fileName:se.name,fileBase64:ye})})).json().catch(()=>null);D(se.name),N(2);const Ye=Me!=null&&Me.extractedCount?` (${Me.extractedCount} fichiers extraits)`:"";alert(`✅ Archive "${se.name}" importée et extraite avec succès${Ye} dans le projet : ${h} !

Vous êtes maintenant sur la Phase 2. Cliquez sur "⚙️ LANCER PHASE 2 (MULTI-BATCH)" pour démarrer l'intégration !`)}catch(me){console.warn("[Upload ZIP] Erreur fallback:",me),alert(`⚠️ Erreur lors de l'envoi de l'archive : ${me}`)}finally{lt(!1)}}},E.click();return}(async()=>{lt(!0);try{const E=await I("http://localhost:5005/api/fs/pick-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:h})}),se=E?await E.json():null;se&&se.success&&(alert("✅ ZIP Copié avec succès dans le dossier : "+h+`
Le fichier est prêt dans votre projet !`),N(2),(se.fileName||se.filename)&&D(se.fileName||se.filename))}catch(E){console.warn("Erreur picker ZIP:",E)}finally{lt(!1)}})()},cn=[{id:"home",label:"TIGER IA",icon:"🐯"},{id:"creation",label:"⚙️ Création Projet",icon:"🚀"},{id:"electron",label:"Electron",icon:"💻"},{id:"vercel",label:"Vercel",icon:"▲"},{id:"deepseek",label:"DeepSeek",icon:"🐋"},{id:"override",label:"Override",icon:"💉"},{id:"connexion",label:"Connexion",icon:"⚙️"},{id:"suture",label:"Suture V2",icon:"🩺"}],[Ce,Sn]=l.useState({current:null,queue:[]}),[qt,Xe]=l.useState([]),[dn,Ut]=l.useState("src/pages/ShoppingCartDrawer.tsx"),[Ve,Be]=l.useState([]),[Ae,D]=l.useState(()=>typeof window<"u"&&sessionStorage.getItem("tiger_uiZipName")||"");l.useEffect(()=>{typeof window<"u"&&Ae&&sessionStorage.setItem("tiger_uiZipName",Ae)},[Ae]);const[Pe,ze]=l.useState(null),[un,De]=l.useState(null),[Ot,xe]=l.useState(!1),[tt,Ft]=l.useState(!1),[ct,nt]=l.useState([]),Pt=l.useCallback(async i=>{if(!i){nt([]);return}try{const h=await I(`http://localhost:5006/api/projects/${i}/pages`);if(h&&h.ok){const S=await h.json();S.pages&&nt(S.pages)}}catch{}},[]);l.useEffect(()=>{const i=(typeof y=="string"?y:(y==null?void 0:y.project_id)||(y==null?void 0:y.title))||ie;Pt(i)},[y,ie,Pt]),l.useRef({current:null,queue:[]});const[Qe,Jt]=l.useState(localStorage.getItem("suture_dryrun")||"none"),[Ze,gt]=l.useState(localStorage.getItem("suture_locked_files")||"src/index.css,src/design.css,src/main.tsx,tsconfig.json,vite.config.ts,package.json"),[kt,st]=l.useState([]),[St,pn]=l.useState(!1),[jt,Xt]=l.useState(localStorage.getItem("suture_single_file")!=="false"),[ht,yn]=l.useState(localStorage.getItem("suture_auto_promote")!=="false"),[yt,dt]=l.useState("idle"),[Se,Qt]=l.useState("clean");l.useRef(0);const _t=()=>{localStorage.setItem("suture_dryrun",Qe),localStorage.setItem("suture_locked_files",Ze),localStorage.setItem("suture_single_file",String(jt)),localStorage.setItem("suture_auto_promote",String(ht)),I("http://localhost:5006/api/suture/config",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({dryRunMode:Qe,lockedFiles:Ze.split(",").map(i=>i.trim()).filter(Boolean),singleFileOnly:jt,autoPromote:ht})}).catch(()=>{}),dt("saved"),setTimeout(()=>dt("idle"),2500)},Tt=async i=>{pn(!0);try{const h=i?`http://localhost:5006/api/suture/history?projectId=${i}`:"http://localhost:5006/api/suture/history",S=await I(h);if(S&&S.ok){const E=await S.json();st(E.repairs||[])}}catch{st([])}finally{pn(!1)}};return l.useEffect(()=>{if(!bs())return;let i;if(g==="deploiement"||g==="creation"){const h=()=>{I("http://localhost:5006/api/bridge/queue").then(S=>S?S.json():null).then(S=>{S&&S.success&&Sn({current:S.current||{},queue:S.queue||[]})}).catch(()=>{}),I("http://localhost:5006/api/logs").then(S=>S?S.json():null).then(S=>{S&&S.logs&&Xe(S.logs)}).catch(()=>{})};h(),i=setInterval(h,1e4)}return()=>clearInterval(i)},[g]),e.jsxs("div",{className:"design-config-modal w-full h-screen bg-gradient-to-br from-[#845e7c]/95 to-[#6c3050]/95 backdrop-blur-2xl border-none shadow-[0_0_50px_rgba(0,0,0,0.8)] relative overflow-hidden flex flex-col md:flex-row pointer-events-auto",children:[!n&&g!=="creation"&&e.jsxs("div",{className:"w-full md:w-64 bg-gradient-to-b from-black/40 to-black/60 border-r border-white/10 flex flex-col",children:[e.jsxs("div",{className:"p-6 border-b border-white/10 flex justify-between items-center",children:[e.jsxs("h3",{className:"text-lg font-black text-white tracking-wider flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"🐯"})," SETTINGS"]}),t&&e.jsx("button",{onClick:r,className:"md:hidden w-8 h-8 rounded-full bg-red-500/20 border border-red-500/50 flex items-center justify-center text-red-500 font-bold hover:bg-red-500 hover:text-white transition-colors",children:"✕"})]}),e.jsx("div",{className:"flex-1 overflow-y-auto py-4 hide-scrollbar flex md:flex-col gap-1 px-4",children:cn.map(i=>{let h="";return i.id==="suture"?Se==="error"?h="bg-red-600 text-white border-2 border-red-400 shadow-[0_0_20px_#ff0055] animate-pulse font-bold":Se==="working"?h="bg-purple-600 text-white border-2 border-purple-300 shadow-[0_0_20px_#a855f7] animate-pulse font-bold":h=g==="suture"?"bg-emerald-600/30 border border-emerald-500 text-emerald-300 shadow-[0_0_12px_rgba(16,185,129,0.4)]":"text-emerald-400 border border-emerald-500/30 hover:bg-emerald-950/40":h=g===i.id?"bg-cyan/20 border border-cyan/50 text-white shadow-[0_0_10px_rgba(8,179,201,0.2)]":"text-gray-400 hover:bg-white/5 hover:text-white",e.jsxs("button",{onClick:()=>b(i.id),className:`flex items-center gap-3 px-4 py-3 rounded-xl transition-all whitespace-nowrap md:whitespace-normal ${h}`,children:[e.jsx("span",{className:"text-xl",children:i.icon}),e.jsx("span",{className:"font-bold text-sm tracking-wide",children:i.id==="suture"&&Se==="error"?"🔴 Suture (Erreur !)":i.id==="suture"&&Se==="working"?"🟣 Suture V2...":i.label})]},i.id)})})]}),e.jsxs("div",{className:"flex-1 bg-gradient-to-br from-[#111111] to-black relative overflow-hidden flex flex-col",children:[e.jsxs("div",{className:"flex-1 overflow-y-auto p-6 md:p-8 relative z-10 hide-scrollbar",children:[g==="connexion"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsx("h2",{className:"text-xl font-black text-white border-b border-white/10 pb-4",children:"Configuration LLM & Bridge"}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-300 font-bold mb-2 block uppercase tracking-wider text-[10px]",children:"Mode d'exécution"}),e.jsx("div",{className:"grid grid-cols-3 gap-3",children:[{id:"web",icon:"💬",title:"Chat Web"},{id:"api",icon:"🔑",title:"API Directe"},{id:"hybrid",icon:"🔀",title:"Hybride"}].map(i=>e.jsxs("button",{onClick:()=>A(i.id),className:`p-3 rounded-xl border flex flex-col items-center justify-center transition-all ${q===i.id?"bg-gradient-to-br from-cyan/20 to-cyan/10 border-cyan text-white shadow-[0_0_10px_rgba(8,179,201,0.3)]":"bg-gradient-to-br from-black/30 to-black/50 border-white/10 text-gray-500 hover:border-white/30"}`,children:[e.jsx("span",{className:"text-2xl mb-1",children:i.icon}),e.jsx("span",{className:"font-bold text-xs",children:i.title})]},i.id))})]}),(q==="web"||q==="hybrid")&&e.jsxs("div",{className:"space-y-3",children:[e.jsx("span",{className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] block mb-2",children:"Flotte d'Assistants (Multi-Acteurs)"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"bg-gradient-to-br from-gray-900/50 to-black/50 p-4 rounded-xl border border-white/10 hover:border-cyan/50 transition-colors",children:[e.jsx("div",{className:"text-[10px] text-cyan mb-2 font-bold flex items-center gap-2",children:"🧠 Cerveau Logique (Backend)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("select",{value:k,onChange:i=>W(i.target.value),className:"flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 outline-none focus:border-cyan text-sm",children:[e.jsx("option",{value:"notebooklm",children:"📓 NotebookLM (Google)"}),e.jsx("option",{value:"deepseek",children:"🐋 DeepSeek Web"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT Web"}),e.jsx("option",{value:"gemini",children:"✨ Gemini Web"}),e.jsx("option",{value:"claude",children:"🟣 Claude Web"}),e.jsx("option",{value:"kimi",children:"🌙 Kimi Web"}),e.jsx("option",{value:"qwen",children:"🌐 Qwen Coder"}),e.jsx("option",{value:"perplexity",children:"🔍 Perplexity AI"}),e.jsx("option",{value:"custom",children:"➕ IA Personnalisée"})]}),e.jsx("button",{onClick:()=>{if(typeof window<"u"&&window.AndroidBridge){const i=k==="custom"?ge:mt(k);window.AndroidBridge.openAIWithPrompt(i,"Initialisation Logique.")}},className:"px-3 bg-white/10 hover:bg-cyan/20 rounded-lg font-bold text-xs transition-colors text-white",children:"▶"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-gray-900/50 to-black/50 p-4 rounded-xl border border-white/10 hover:border-pink/50 transition-colors",children:[e.jsx("div",{className:"text-[10px] text-pink mb-2 font-bold flex items-center gap-2",children:"🎨 Cerveau UI/UX (Frontend)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("select",{value:z,onChange:i=>$(i.target.value),className:"flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 outline-none focus:border-pink text-sm",children:[e.jsx("option",{value:"stitch",children:"🧵 Stitch Google"}),e.jsx("option",{value:"v0",children:"▲ v0.dev (Vercel)"}),e.jsx("option",{value:"bolt",children:"⚡ Bolt.new"}),e.jsx("option",{value:"custom",children:"➕ UI Personnalisée"})]}),e.jsx("button",{onClick:()=>{if(typeof window<"u"&&window.AndroidBridge){const i=z==="custom"?ge:z==="v0"?"https://v0.dev/":"https://stitch.withgoogle.com/";window.AndroidBridge.openAIWithPrompt(i,"Initialisation Design.")}},className:"px-3 bg-white/10 hover:bg-pink/20 rounded-lg font-bold text-xs transition-colors text-white",children:"▶"})]})]})]})]}),(k==="custom"||z==="custom")&&e.jsxs("div",{className:"flex gap-3 bg-white/5 border border-white/20 p-3 rounded-xl mt-2 animate-fadeIn",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("label",{htmlFor:"custom-ai-name",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"Nom IA Custom"}),e.jsx("input",{id:"custom-ai-name",type:"text",value:H,onChange:i=>re(i.target.value),placeholder:"Mon Agent",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-white/50"})]}),e.jsxs("div",{className:"flex-[2]",children:[e.jsx("label",{htmlFor:"custom-ai-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Complète"}),e.jsx("input",{id:"custom-ai-url",type:"text",value:ge,onChange:i=>G(i.target.value),placeholder:"https://...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-white/50 font-mono"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{htmlFor:"api-provider",className:"text-gray-300 font-bold uppercase tracking-wider text-[10px]",children:"Fournisseur API"}),e.jsxs("select",{id:"api-provider",value:pe,onChange:i=>ve(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-xl px-4 py-3 outline-none focus:border-pink text-sm",children:[e.jsx("option",{value:"deepseek",children:"🐋 DeepSeek"}),e.jsx("option",{value:"openai",children:"🟢 OpenAI (ChatGPT)"}),e.jsx("option",{value:"anthropic",children:"🟣 Anthropic Claude"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("label",{htmlFor:"api-key",className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] flex items-center gap-2",children:["Clé API",je==="ok"&&e.jsx("span",{className:"text-green-400 text-[10px] font-bold bg-green-400/10 px-2 py-0.5 rounded-full border border-green-400/30",children:"✅ Persistante sur disque"}),je==="sending"&&e.jsx("span",{className:"text-yellow-400 text-[10px] animate-pulse",children:"⏳ Envoi..."}),je==="error"&&e.jsx("span",{className:"text-red-400 text-[10px]",children:"❌ Erreur moteur"})]}),e.jsx("div",{className:"flex gap-2 relative",children:e.jsx("input",{id:"api-key",type:"password",value:Q,onChange:i=>ae(i.target.value),placeholder:"sk-...",className:`flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border rounded-xl px-4 py-3 outline-none text-sm font-mono transition-colors ${je==="ok"?"border-green-500/50 focus:border-green-400":je==="error"?"border-red-500/50":"border-white/20 focus:border-pink"}`})}),e.jsxs("div",{className:"flex items-center gap-4 mt-2",children:[e.jsx("button",{onClick:Ge,className:"px-4 py-2 bg-cyan/20 hover:bg-cyan/40 border border-cyan/40 text-cyan rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center gap-2",children:"💾 SAUVEGARDER + ENVOYER AU MOTEUR"}),e.jsx("span",{className:"text-gray-500 text-xs italic",children:"Persistée sur disque (reste après redémarrage)."})]})]}),e.jsxs("div",{className:"space-y-2 p-4 bg-gradient-to-br from-black/30 to-black/50 border border-white/5 rounded-xl",children:[e.jsx("span",{className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] block",children:"Modèle détecté"}),e.jsx("div",{className:"text-gray-500 text-sm mb-2",children:"Enregistrer la clé pour détecter"}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{className:"px-4 py-2 bg-pink/20 text-pink border border-pink/50 hover:bg-pink/30 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center gap-2",children:"🔄 AUTO_DETECT"}),e.jsx("span",{className:"text-gray-500 text-xs italic",children:"Auto-détecté à l'enregistrement."})]})]}),e.jsx("div",{className:"pt-4 border-t border-white/10",children:F?e.jsxs("div",{className:"space-y-4",children:[e.jsxs("h3",{className:"text-cyan font-bold flex items-center gap-2 text-sm mb-2",children:["📱 Moteur Mobile Natif",e.jsx("span",{className:"text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30",children:"Connecté"})]}),e.jsxs("p",{className:"text-xs text-gray-400 leading-relaxed",children:["La configuration automatique est active. Les prompts sont injectés via la WebView Fantôme Java et les fichiers sont sauvegardés nativement sur votre téléphone.",e.jsx("br",{}),e.jsx("br",{}),e.jsx("strong",{children:"Aucun Bridge Electron PC n'est requis."})," L'OS Souverain est 100% autonome dans votre poche."]})]}):e.jsxs(e.Fragment,{children:[e.jsxs("h3",{className:"text-cyan font-bold flex items-center gap-2 text-sm mb-4",children:["🔗 Bridge (:5006 / Vercel)",e.jsx("span",{className:"text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30",children:"Bridge polling actif"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"bridge-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Bridge local"}),e.jsx("input",{id:"bridge-url",type:"text",value:V,onChange:i=>ne(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"vercel-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Vercel"}),e.jsx("input",{id:"vercel-url",type:"text",value:le,onChange:i=>he(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"default-preview",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Preview par défaut"}),e.jsx("input",{id:"default-preview",type:"text",value:Y,onChange:i=>j(i.target.value),placeholder:"http://127.0.0.1:3000",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]})]}),e.jsxs("div",{className:"flex gap-3 mt-4",children:[e.jsx("button",{className:"px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-xs font-bold text-white transition-colors",children:"🔗 Tester"}),e.jsx("button",{onClick:Ge,className:"px-4 py-2 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-lg text-xs font-bold uppercase transition-colors",children:"💾 SAUVEGARDER_CONFIG"})]}),e.jsx("div",{className:"text-green-400 text-xs font-bold mt-4 flex items-center gap-2",children:"✅ Bridge connecté (auto-détecté)"})]})}),e.jsxs("div",{className:"pt-4 border-t border-white/10 space-y-4",children:[e.jsx("h3",{className:"text-blue-400 font-bold flex items-center gap-2 text-sm",children:"📓 NotebookLM Auto-Push (Python)"}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"notebook-id",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"Notebook ID (URL)"}),e.jsx("input",{id:"notebook-id",type:"text",value:on,onChange:i=>bt(i.target.value),placeholder:"6cd96956-...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-blue-500"})]}),e.jsxs("div",{children:[e.jsxs("label",{htmlFor:"auth-cookie",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px] flex justify-between",children:[e.jsx("span",{children:"Cookie d'authentification (__Secure-1PSID)"}),at==="success"&&e.jsx("span",{className:"text-green-400",children:"🟢 Connecté"}),at==="error"&&e.jsx("span",{className:"text-red-400",children:"🔴 Erreur / Expiré"}),at==="testing"&&e.jsx("span",{className:"text-yellow-400",children:"⏳ Test..."})]}),e.jsx("input",{id:"auth-cookie",type:"password",value:At,onChange:i=>Nt(i.target.value),placeholder:"Collez votre cookie d'authentification Google ici...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1 outline-none focus:border-blue-500"})]}),e.jsxs("div",{className:"flex gap-3 mt-4",children:[e.jsx("button",{onClick:Ge,className:"px-4 py-2 bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30 rounded-lg text-xs font-bold uppercase transition-colors",children:"💾 Sauvegarder"}),e.jsx("button",{onClick:async()=>{ln("testing"),setTimeout(()=>ln("success"),1e3)},className:"px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg text-xs font-bold uppercase transition-colors",children:"🧪 Tester"})]}),e.jsx("p",{className:"text-[10px] text-gray-500 italic",children:"Note : Ce cookie expire régulièrement. Pensez à le mettre à jour s'il ne fonctionne plus."})]})]})]}),g==="suture"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",onMouseEnter:()=>{kt.length===0&&Tt()},children:[e.jsxs("div",{className:"flex items-center justify-between border-b border-white/10 pb-4",children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-3",children:[e.jsx("span",{className:"text-3xl",children:"🩺"}),e.jsxs("div",{children:[e.jsx("div",{children:"Suture V2 — Moteur Zero-Touch"}),e.jsx("div",{className:"text-[10px] font-normal text-gray-400 mt-0.5",children:"Réparation autonome, isolée et atomique"})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-3 h-3 rounded-full ${Se==="error"?"bg-red-500 shadow-[0_0_12px_#ff0055] animate-ping":Se==="working"?"bg-purple-500 shadow-[0_0_12px_#a855f7] animate-pulse":"bg-emerald-400 shadow-[0_0_8px_#4ade80]"}`}),e.jsx("span",{className:`text-[11px] font-black uppercase tracking-wider ${Se==="error"?"text-red-400":Se==="working"?"text-purple-300":"text-emerald-400"}`,children:Se==="error"?"🔴 ERREUR DÉTECTÉE (SUTURE REQUIS)":Se==="working"?"🟣 SUTURE V2 EN COURS...":"🟢 MOTEUR AUTO-PILOT PRÊT"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a1a0a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-green-400 flex items-center gap-2",children:"🔬 Mode de Validation (Dry-Run)"}),e.jsx("p",{className:"text-[10px] text-gray-500 leading-relaxed",children:"Contrôle si le moteur compile le code dans le bac à sable avant de l'appliquer en production."}),e.jsx("div",{className:"grid grid-cols-3 gap-3",children:[{id:"none",icon:"🚀",label:"Production",desc:"Applique directement"},{id:"plan",icon:"🗺️",label:"Plan Only",desc:"Génère sans appliquer"},{id:"true",icon:"🧪",label:"Full Dry-Run",desc:"Clone + build + bloque"}].map(i=>e.jsxs("button",{onClick:()=>Jt(i.id),className:`p-3 rounded-xl border flex flex-col items-center justify-center gap-1 transition-all text-center ${Qe===i.id?"bg-green-900/40 border-green-500/70 text-white shadow-[0_0_12px_rgba(74,222,128,0.2)]":"bg-black/30 border-white/10 text-gray-500 hover:border-white/30 hover:text-gray-300"}`,children:[e.jsx("span",{className:"text-xl",children:i.icon}),e.jsx("span",{className:"font-black text-[10px]",children:i.label}),e.jsx("span",{className:"text-[9px] opacity-70",children:i.desc})]},i.id))})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a0a1a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-cyan flex items-center gap-2",children:"⚡ Options de Promotion"}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("label",{className:"flex items-center justify-between cursor-pointer bg-black/20 px-4 py-3 rounded-xl hover:bg-white/5 transition-colors",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm",children:"Promotion Automatique"}),e.jsx("div",{className:"text-[10px] text-gray-500",children:"Si la compilation réussit, le patch est appliqué sans confirmation"})]}),e.jsx("div",{onClick:()=>yn(i=>!i),className:`relative w-12 h-6 rounded-full transition-colors cursor-pointer ${ht?"bg-cyan":"bg-white/10"}`,children:e.jsx("div",{className:`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${ht?"left-7":"left-1"}`})})]}),e.jsxs("label",{className:"flex items-center justify-between cursor-pointer bg-black/20 px-4 py-3 rounded-xl hover:bg-white/5 transition-colors",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm",children:"Fichier Unique Seulement"}),e.jsx("div",{className:"text-[10px] text-gray-500",children:"La Suture ne peut modifier qu'un seul fichier par réparation (plus sûr)"})]}),e.jsx("div",{onClick:()=>Xt(i=>!i),className:`relative w-12 h-6 rounded-full transition-colors cursor-pointer ${jt?"bg-cyan":"bg-white/10"}`,children:e.jsx("div",{className:`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${jt?"left-7":"left-1"}`})})]})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#1a0a0a]/60 border border-red-500/20 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-red-400 flex items-center gap-2",children:"🔒 Fichiers Verrouillés (Intouchables)"}),e.jsxs("p",{className:"text-[10px] text-gray-500 leading-relaxed",children:["Ces fichiers ne seront ",e.jsx("strong",{className:"text-red-300",children:"JAMAIS"})," modifiés par une Suture, même si l'IA essaie. Séparés par des virgules."]}),e.jsx("textarea",{value:Ze,onChange:i=>gt(i.target.value),rows:3,className:"w-full bg-black/40 text-red-200 border border-red-500/20 rounded-lg px-3 py-2 text-[11px] font-mono outline-none focus:border-red-500/50 resize-none",placeholder:"src/design.css,package.json,..."}),e.jsx("div",{className:"flex flex-wrap gap-2",children:Ze.split(",").map(i=>i.trim()).filter(Boolean).map(i=>e.jsxs("span",{className:"flex items-center gap-1 bg-red-900/20 border border-red-500/30 text-red-300 text-[9px] font-mono px-2 py-1 rounded-full",children:["🔒 ",i,e.jsx("button",{onClick:()=>gt(h=>h.split(",").map(S=>S.trim()).filter(S=>S!==i).join(", ")),className:"text-red-500 hover:text-white ml-1 font-bold",children:"×"})]},i))})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a0a0a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-yellow-400 flex items-center gap-2",children:"⚡ Actions Rapides Suture"}),e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx("button",{onClick:()=>I("http://localhost:5006/api/suture/purge-workspaces",{method:"POST"}).then(i=>alert(i?"✅ Bac à sable vidé !":"❌ Moteur inaccessible (Mode Cloud SaaS)")).catch(()=>alert("❌ Moteur inaccessible")),className:"py-3 bg-orange-900/20 hover:bg-orange-900/40 border border-orange-500/30 text-orange-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"🗑️ Vider le Bac à Sable"}),e.jsx("button",{onClick:()=>Tt(),className:"py-3 bg-blue-900/20 hover:bg-blue-900/40 border border-blue-500/30 text-blue-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"🔄 Rafraîchir Historique"}),e.jsx("button",{onClick:()=>I("http://localhost:5006/api/suture/rollback-last",{method:"POST"}).then(i=>i?i.json():null).then(i=>alert(i?i.success?`✅ Rollback : ${i.message}`:`❌ ${i.error}`:"❌ Moteur inaccessible (Mode Cloud SaaS)")).catch(()=>alert("❌ Moteur inaccessible")),className:"py-3 bg-purple-900/20 hover:bg-purple-900/40 border border-purple-500/30 text-purple-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"↩️ Rollback Dernier Patch"}),e.jsx("button",{onClick:_t,className:`py-3 border rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all ${yt==="saved"?"bg-green-900/40 border-green-500/50 text-green-300":"bg-cyan/10 hover:bg-cyan/20 border-cyan/40 text-cyan"}`,children:yt==="saved"?"✅ Sauvegardé !":"💾 Sauvegarder Config"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-gray-400 flex items-center gap-2",children:"📋 Historique des Réparations"}),e.jsx("button",{onClick:()=>Tt(),className:"text-[9px] text-cyan hover:text-white bg-cyan/10 px-2 py-1 rounded",children:"Actualiser"})]}),e.jsxs("div",{className:"max-h-[200px] overflow-y-auto hide-scrollbar space-y-2",children:[St&&e.jsx("div",{className:"text-center text-gray-500 text-[10px] animate-pulse py-4",children:"⏳ Chargement..."}),!St&&kt.length===0&&e.jsx("div",{className:"text-center text-gray-600 text-[10px] italic py-4",children:"Aucune réparation trouvée. Cliquez sur 🩺 dans l'explorateur pour lancer une Suture."}),kt.map((i,h)=>e.jsxs("div",{className:`flex items-center justify-between p-3 rounded-lg border text-[10px] font-mono ${i.status==="applied"?"bg-green-900/10 border-green-500/20":i.status==="failed"?"bg-red-900/10 border-red-500/20":"bg-white/5 border-white/10"}`,children:[e.jsxs("div",{className:"flex flex-col gap-0.5 truncate flex-1 mr-2",children:[e.jsx("span",{className:"text-white font-bold truncate",children:i.repairId||i.id}),e.jsxs("span",{className:"text-gray-500 truncate",children:[i.projectId," — ",i.activeFile||"?"]}),e.jsx("span",{className:"text-gray-600",children:i.startedAt?new Date(i.startedAt).toLocaleString("fr-FR"):""})]}),e.jsx("span",{className:`shrink-0 px-2 py-0.5 rounded-full border text-[9px] font-bold ${i.status==="applied"?"bg-green-900/30 border-green-500/40 text-green-300":i.status==="failed"?"bg-red-900/30 border-red-500/40 text-red-300":"bg-yellow-900/30 border-yellow-500/40 text-yellow-300"}`,children:i.status==="applied"?"✅ Appliqué":i.status==="failed"?"❌ Échec":"⚠️ Partiel"})]},h))]})]})]}),g==="creation"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn flex flex-col mt-8 border-t border-white/10 pt-8 pr-2",children:[e.jsxs("div",{className:"flex flex-col border-b border-white/5 pb-4",children:[e.jsxs("h2",{className:"text-2xl font-black text-white flex items-center gap-2 tracking-wide uppercase",children:[e.jsx("span",{children:"⚙️"})," CONFIGURATION DU PROJET"]}),e.jsx("p",{className:"text-[10px] text-gray-400 mt-1",children:"Générez et paramétrez votre projet de A à Z."})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1 min-h-0",children:[e.jsxs("div",{className:"transition-opacity duration-1000",children:[e.jsxs("div",{className:"bg-[#050505] border border-white/5 rounded-xl flex flex-col gap-4 overflow-y-auto hide-scrollbar p-5 mb-6",children:[e.jsxs("h3",{className:"text-white font-bold text-xs mb-2 flex items-center gap-2",children:[e.jsx("span",{className:"text-yellow-500",children:"📁"})," Création & Ciblage"]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"CIBLER UN PROJET EXISTANT"}),e.jsxs("select",{value:typeof y=="string"?y:(y==null?void 0:y.project_id)||(y==null?void 0:y.title)||"",onChange:i=>L(i.target.value),onClick:async()=>{if(C.length===0)try{const i=await I("/api/projects");if(i&&i.ok){const h=await i.json();h.projects&&v(h.projects.map(S=>typeof S=="string"?S:S.project_id||S.title||S.name||""))}else{const S=await(await fetch("/api/projects")).json();S.projects&&v(S.projects.map(E=>typeof E=="string"?E:E.project_id||E.title||E.name||""))}}catch{}},className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 outline-none focus:border-cyan text-xs",children:[e.jsx("option",{value:"",children:"-- SÉLECTIONNER UN PROJET --"}),C.map((i,h)=>{const S=typeof i=="string"?i:i.project_id||i.title||i.name||"Projet "+h;return e.jsx("option",{value:S,children:S},S+"_"+h)})]}),y&&Rt==="idle"&&e.jsx("button",{onClick:async()=>{We("loading");try{const i=await I("http://localhost:5006/api/bridge/export-notebooklm",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:y,notebookId:on,authCookie:At})});if(!i){alert("Mode Cloud SaaS : Bridge local non connecté."),We("idle");return}const h=await i.json();h.success?(rn(h.combinedContent||""),h.pushLog&&h.pushLog.includes("Failed:")?(an(h.pushLog),We("error")):We("ready")):(an(h.message),We("error"))}catch{an("Erreur de connexion avec Kirov5."),We("error")}},className:"mt-2 w-full bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-2",children:"📓 Préparer l'export NotebookLM"}),y&&Rt==="loading"&&e.jsx("button",{disabled:!0,className:"mt-2 w-full bg-gray-900/50 text-gray-400 border border-gray-700/50 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider flex items-center justify-center gap-2",children:"⏳ Extraction de l'expertise..."}),y&&Rt==="ready"&&e.jsx("button",{onClick:async()=>{try{await navigator.clipboard.writeText(sn),window.open("https://notebook.google.com/notebook/6cd96956-200e-4260-ae7d-6c1446de284a","_blank"),We("idle")}catch{alert("❌ Copie échouée. Essayez sur HTTPS ou utilisez Ctrl+C manuellement.")}},className:"mt-2 w-full bg-green-900/40 hover:bg-green-800/60 text-green-300 border border-green-500/50 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-2",children:"✅ Copier & Ouvrir NotebookLM"}),y&&Rt==="error"&&e.jsxs("div",{className:"mt-2 p-3 bg-red-900/30 border border-red-500/50 rounded-lg",children:[e.jsx("div",{className:"text-red-400 text-[10px] font-bold mb-2",children:"⚠️ Échec du script Python (Copiez l'erreur ci-dessous) :"}),e.jsx("textarea",{readOnly:!0,value:Ln,className:"w-full h-24 bg-black/50 text-red-300 text-[10px] font-mono p-2 rounded border border-red-500/20 outline-none"}),e.jsxs("div",{className:"flex gap-2 mt-2",children:[e.jsx("button",{onClick:()=>We("idle"),className:"flex-1 bg-gray-800 hover:bg-gray-700 text-white text-[10px] py-2 rounded font-bold",children:"🔄 Réessayer"}),e.jsx("button",{onClick:async()=>{try{await navigator.clipboard.writeText(sn),window.open("https://notebook.google.com/notebook/6cd96956-200e-4260-ae7d-6c1446de284a","_blank"),We("idle")}catch{alert("❌ Copie échouée.")}},className:"flex-1 bg-green-900/50 hover:bg-green-800/70 text-green-300 border border-green-500/50 text-[10px] py-2 rounded font-bold",children:"✅ Fallback Manuel"})]})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"NOM DU NOUVEAU PROJET"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"text",value:ie,onChange:i=>Re(i.target.value),placeholder:"Ex: MonSuperProjet",className:"flex-1 bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan"}),e.jsx("button",{onClick:async()=>{if(!ie||!ie.trim()){alert("Entrez un nom de projet");return}const i=ie.trim();try{const h=localStorage.getItem("kirov5_jwt_token")||"",S=await fetch("/api/projects",{method:"POST",headers:{"Content-Type":"application/json",...h?{Authorization:`Bearer ${h}`}:{}},body:JSON.stringify({title:i,name:i,projectId:i.replace(/[^a-zA-Z0-9_-]/g,"_"),description:"Projet Tiger Cloud"})}),E=await S.json();S.ok&&(E.success||E.project)?(alert(`✅ Projet "${i}" créé avec succès !`),setActiveProject(i),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",i),fetch("/api/projects",{headers:h?{Authorization:`Bearer ${h}`}:{}}).then(se=>se.json()).then(se=>{se&&se.projects&&setRealProjects(se.projects.map(T=>({name:T.project_id||T.title||T.name,desc:T.owner_email?`Propriétaire: ${T.owner_email}`:"Projet Cloud",bg:""})))}).catch(()=>{})):alert("❌ Erreur création projet: "+(E.error||E.message||"Erreur inconnue"))}catch(h){alert("❌ Erreur de connexion avec le serveur: "+((h==null?void 0:h.message)||h))}},className:"bg-[#0f2a2a] hover:bg-[#153f3f] text-cyan border border-cyan/30 px-4 py-2 rounded-lg text-xs font-bold transition-colors",children:"Valider"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"STACK TECHNIQUE"}),e.jsxs("select",{value:vn,onChange:i=>It(i.target.value),className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",children:[e.jsx("option",{value:"vite",children:"⭐ 1er Choix (Prioritaire) : Vite + React + Tailwind + TS"}),e.jsx("option",{value:"nextjs",children:"Next.js 16 + Tailwind"})]})]}),e.jsxs("div",{className:"flex-1 flex flex-col",children:[e.jsxs("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2 flex items-center gap-1",children:[e.jsx("span",{className:"text-white",children:"📄"})," INSTRUCTIONS / VISION"]}),e.jsx("textarea",{value:it,onChange:i=>Te(i.target.value),placeholder:"Décrivez l'application ou copiez votre PRD...",className:"w-full flex-1 min-h-[120px] bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan resize-none"})]})]}),e.jsxs("div",{className:"bg-[#050505] border border-white/5 rounded-xl flex flex-col gap-4 overflow-y-auto hide-scrollbar p-5 transition-opacity duration-1000",children:[e.jsxs("h3",{className:"text-white font-bold text-xs mb-2 flex items-center gap-2",children:[e.jsx("span",{className:"text-yellow-500",children:"⚡"})," Paramètres & IA"]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"INTELLIGENCE CIBLE"}),e.jsxs("select",{className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",onChange:i=>{const h=i.target.value;window.KIROV_TARGET_AI=h,typeof window<"u"&&localStorage.setItem("tiger_targetAi",h);let S="";h==="stitch"?S="https://stitch.withgoogle.com":h==="deepseek"||h==="deepseek-web"?S="https://chat.deepseek.com":h==="gemini"?S="https://gemini.google.com":h==="chatgpt"?S="https://chatgpt.com":h==="claude"?S="https://claude.ai":h==="notebooklm"&&(S="https://notebooklm.google.com"),S&&I("http://localhost:5006/api/bridge/open-window",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:S})}).catch(E=>console.warn("Erreur ouverture fenêtre",E))},defaultValue:typeof window<"u"&&localStorage.getItem("tiger_targetAi")||"hermes",children:[e.jsx("option",{value:"notebooklm",children:"📓 NotebookLM (Google)"}),e.jsx("option",{value:"cloudflare",children:"☁️ Cloudflare Qwen 3 30B (Audit IA Grade Gold)"}),e.jsx("option",{value:"cloudflare-hermes",children:"⚡ Hermes Cloudflare Workers AI (Qwen Coder)"}),e.jsx("option",{value:"deepseek",children:"🩵 DeepSeek (Extension Web)"}),e.jsx("option",{value:"hermes",children:"🤖 Hermes Agent (API DeepSeek)"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT"}),e.jsx("option",{value:"claude",children:"🟣 Claude"})]})]}),e.jsxs("div",{children:[e.jsxs("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:["💉 MODE & LOT DE DÉPART (Val: ",w,")"]}),e.jsxs("select",{value:w,onChange:i=>N(Number(i.target.value)),className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",children:[e.jsx("option",{value:0,children:"🚀 TOUT : Pipeline Complète (Zero-Touch)"}),e.jsx("option",{value:1,children:"🎨 Phase 1 : Le Frontend (Stitch/v0)"}),e.jsx("option",{value:2,children:"⚙️ Phase 2 : Logique G5"}),e.jsx("option",{value:4,children:"🎨 Phase 3/4 : Câblage Métier (Business Wiring)"}),e.jsx("option",{value:5,children:"🔌 Phase 5 : Industrialisation & Backend"}),e.jsx("option",{value:9,children:"🪄 M.A.J UI : Pipeline Push UI/UX (One-Shot)"})]})]}),e.jsxs("div",{className:"flex flex-col gap-3 mt-4 bg-[#111] p-4 rounded-lg border border-white/5",children:[e.jsxs("label",{className:"flex items-center gap-3 text-[11px] font-bold text-gray-300 cursor-pointer",children:[e.jsx("input",{type:"checkbox",className:"accent-cyan w-4 h-4",checked:Z,onChange:()=>O(!Z)}),"🤖 AUTO-PILOT : ",Z?"ON 🟢":"OFF ⚪"]}),e.jsxs("label",{className:"flex items-center gap-3 text-[11px] font-bold text-gray-300 cursor-pointer",children:[e.jsx("input",{type:"checkbox",className:"accent-cyan w-4 h-4",checked:K,onChange:()=>te(!K)}),"🔗 Injecter dans l'onglet ouvert"]})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-3 mt-4",children:[e.jsxs("div",{id:"btn-joindre-prd",className:`py-6 text-white text-[10px] font-bold rounded-lg border flex flex-col items-center justify-center gap-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${Ne?"bg-purple-950/80 border-purple-400 animate-pulse":(window.KIROV_SELECTED_PACKS||R).length>0?"bg-indigo-600 border-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.6)]":"bg-[#2a1b3d] border-purple-500/30"}`,title:"Pack PRD sélectionné — Sera injecté automatiquement dans le contexte IA",children:[e.jsx("span",{className:"text-xl",children:Ne?"⏳":"💎"}),e.jsx("span",{children:Ne?"Copie en cours...":(window.KIROV_SELECTED_PACKS||R).length>0?`Packs PRD ${(window.KIROV_SELECTED_PACKS||R).length} ${(window.KIROV_SELECTED_PACKS||R)[0]}`:"Aucun Pack PRD"})]}),e.jsxs("button",{id:"btn-joindre-zip",disabled:Je,onClick:()=>{Number(w)===0&&(Dt(!0),typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning","true")),Lt()},className:`py-6 text-white text-[10px] font-bold rounded-lg border transition-all flex flex-col items-center justify-center gap-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${Je?"bg-amber-950/70 border-amber-500 text-amber-300 animate-pulse":Number(w)===2&&!Ae?"bg-cyan-950/80 border-2 border-cyan text-cyan shadow-[0_0_30px_rgba(6,182,212,0.7)] animate-pulse scale-105 ring-2 ring-cyan/40 cursor-pointer":ot?"bg-[#1a3a40] hover:bg-[#204a50] pointer-events-auto shadow-[0_0_30px_rgba(8,179,201,0.6)] border-cyan scale-105 z-50 relative animate-pulse":"bg-[#1a2f3a] hover:bg-[#254250] border-cyan/30"}`,title:Ae?`Archive importée : ${Ae}`:"Joindre le fichier ZIP exporté depuis Stitch",children:[e.jsx("span",{className:"text-xl",children:Je?"⏳":Ae?"✅":"📎"}),e.jsx("span",{className:"font-extrabold",children:Je?"Extraction en cours...":Ae?`ZIP : ${Ae}`:"Joindre ZIP (Stitch)"}),Number(w)===2&&!Ae&&!Je&&e.jsx("span",{className:"text-[9px] text-cyan-300 font-extrabold uppercase animate-bounce mt-0.5",children:"👇 Étape 2 : Joindre le ZIP ici"})]})]}),(()=>{const h={0:"🚀 LANCER PIPELINE COMPLÈTE (ONE-SHOT)",1:"✨ LANCER PHASE 1 (Prompt vers l'IA)",2:Ae?`⚙️ LANCER PHASE 2 (MULTI-BATCH) [${Ae}]`:"⚙️ LANCER PHASE 2 (MULTI-BATCH) — ⏳ EN ATTENTE DU ZIP STITCH",3:"🎨 LANCER PHASE 3/4 (CÂBLAGE MÉTIER)",4:"🎨 LANCER PHASE 3/4 (CÂBLAGE MÉTIER)",5:"🔌 LANCER PHASE 5 (INDUSTRIALISATION)",9:"🛡️ LANCER PUSH UI"}[Number(w)];return h?e.jsx("button",{id:"btn-lancer-phase",onClick:()=>{const S=y||ie;if(!S){alert("Veuillez sélectionner ou créer un projet !");return}if(Number(w)===2&&!Ae){confirm(`📁 Le fichier .zip Stitch n'est pas encore joint à ce projet.

Souhaitez-vous sélectionner et importer votre archive ZIP maintenant ?`)&&Lt();return}Dt(!0),typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning","true"),setTimeout(()=>{var T;(T=document.getElementById("kirov-radar-queue"))==null||T.scrollIntoView({behavior:"smooth"})},500);const E=window.KIROV_TARGET_AI||typeof window<"u"&&localStorage.getItem("tiger_targetAi")||"hermes";if(typeof r=="function"&&r(),b("home"),typeof window<"u"&&window.dispatchEvent(new CustomEvent("open-mouchard")),Number(w)===5){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:S,target_ai:E,start_index:1,zip_mode:!0,start_phase:5,auto_pilot:Z})}).then(T=>T?T.json():null).then(T=>{alert(T?`✅ PHASE 5 (INDUSTRIALISATION) LANCÉE !
L'orchestrateur génère l'infrastructure et certifie le projet.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(T=>{console.error(T),alert("Erreur lors du lancement de la Phase 5.")});return}if(Number(w)===4||Number(w)===3){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:S,target_ai:E,start_index:1,zip_mode:!0,start_phase:4,auto_pilot:Z,packs:window.KIROV_SELECTED_PACKS||[]})}).then(T=>T?T.json():null).then(T=>{alert(T?`✅ PHASE 3/4 (CÂBLAGE MÉTIER) LANCÉE !
L'orchestrateur prend le relais pour connecter et câbler la logique métier.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(T=>{console.error(T),alert("Erreur lors du lancement de la Phase 3/4.")});return}if(Number(w)===2){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:S,target_ai:E,start_index:1,zip_mode:!0,start_phase:200,auto_pilot:Z,packs:window.KIROV_SELECTED_PACKS||[]})}).then(T=>T?T.json():null).then(T=>{alert(T?`✅ PHASE 2 (LOGIQUE G5) LANCÉE !
L'orchestrateur prend le relais pour générer le Backend et intégrer les composants.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(T=>{console.error(T),alert("Erreur: Le moteur n'a pas pu être contacté.")});return}typeof window<"u"&&(window.open("https://stitch.withgoogle.com/","_blank"),window.dispatchEvent(new CustomEvent("open-mouchard")));const se=window.KIROV_SELECTED_PACKS&&window.KIROV_SELECTED_PACKS.length>0?window.KIROV_SELECTED_PACKS:R&&R.length>0?R:[];if(Number(w)===0){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:S,target_ai:"stitch",start_index:1,zip_mode:!0,start_phase:0,auto_pilot:Z,instructions:it||"Génère l'application avec ces packs et directives.",packs:se})}).then(T=>T?T.json():null).then(T=>{var ut;const me=(T==null?void 0:T.prompt)||((ut=T==null?void 0:T.data)==null?void 0:ut.prompt)||"Génération UI/UX Stitch complète.",ye=se.length>0?se.join(", "):"standard";if(N(2),typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase","2"),typeof document<"u"){const Me=document.getElementById("tiger-mega-prompt-overlay");Me&&Me.remove();const Ye=document.createElement("div");Ye.id="tiger-mega-prompt-overlay",Ye.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);backdrop-filter:blur(10px);z-index:999999;display:flex;align-items:center;justify-content:center;padding:16px;font-family:sans-serif;",Ye.innerHTML=`
                                <div style="background:#0f172a;border:2px solid #06b6d4;border-radius:16px;width:100%;max-width:760px;padding:24px;box-shadow:0 0 50px rgba(6,182,212,0.4);display:flex;flex-direction:column;gap:16px;color:#fff;">
                                  <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid rgba(255,255,255,0.1);padding-bottom:12px;">
                                    <div>
                                      <h3 style="margin:0;font-size:16px;font-weight:900;color:#38bdf8;display:flex;align-items:center;gap:8px;">
                                        <span>🧵</span> MÉGA-PROMPT STITCH PRÊT (${me.length} car.)
                                      </h3>
                                      <p style="margin:4px 0 0 0;font-size:11px;color:#94a3b8;">
                                        Projet : <strong style="color:#e2e8f0;">${S}</strong> | Pack PRD : <strong style="color:#a855f7;">${ye}</strong>
                                      </p>
                                    </div>
                                  ...
                                  <textarea id="tiger-prompt-area" readonly style="width:100%;height:200px;background:#050505;border:1px solid #334155;border-radius:10px;padding:12px;font-family:monospace;font-size:11px;color:#67e8f9;resize:none;outline:none;box-sizing:border-box;">${me}</textarea>
                              ...
                              `,document.body.appendChild(Ye);const Ct=document.getElementById("tiger-prompt-area"),Ue=document.getElementById("btn-copy-prompt"),Oe=document.getElementById("btn-close-prompt-overlay"),et=document.getElementById("btn-open-stitch"),Gt=()=>{Ct&&(Ct.select(),Ct.setSelectionRange(0,99999),document.execCommand("copy")),navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),N(2),Ue&&(Ue.innerHTML="✅ COPIÉ DANS LE PRESSE-PAPIER !",Ue.style.background="linear-gradient(135deg,#10b981,#059669)",setTimeout(()=>{Ue&&(Ue.innerHTML="📋 COPIER LE MÉGA-PROMPT",Ue.style.background="linear-gradient(135deg,#06b6d4,#2563eb)")},3e3))};Ue&&(Ue.onclick=()=>{Gt(),N(2)}),Oe&&(Oe.onclick=()=>{Ye.remove(),N(2)}),et&&(et.onclick=()=>{window.open("https://stitch.withgoogle.com/","_blank"),N(2)}),Gt(),N(2)}}).catch(T=>{console.error(T),alert("Erreur de communication avec le serveur Kirov5.")});return}I("/api/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:"stitch",user_prompt:it||"Génère l'application avec ces packs et directives.",packs:se,target_project:S,phase_num:1})}).then(T=>T?T.json():null).then(T=>{var ye;const me=(T==null?void 0:T.prompt)||((ye=T==null?void 0:T.data)==null?void 0:ye.prompt)||"Génération UI/UX Stitch.";typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),alert(`🚀 PHASE 1 (STITCH UI/UX) INITIALISÉE !

1. L'onglet Stitch a été ouvert dans votre navigateur.
2. Le Méga-Prompt complet (${me.length} car.) est copié dans votre presse-papier !
👉 Faites Ctrl + V dans Stitch pour lancer la génération graphique !`)}).catch(T=>{console.error(T),alert("L'onglet Stitch a été ouvert. Assurez-vous d'avoir saisi les consignes de design.")})},className:`w-full mt-4 py-4 rounded-lg border transition-all flex justify-center items-center gap-2 text-[11px] font-black uppercase tracking-wider text-white ${Number(w)===0?"bg-gradient-to-r from-purple-600/60 to-pink-600/60 hover:from-purple-500/70 hover:to-pink-500/70 border-purple-500/50 shadow-[0_0_20px_rgba(168,85,247,0.4)]":"bg-gradient-to-r from-emerald-600/40 to-cyan-600/40 hover:from-emerald-500/50 hover:to-cyan-500/50 border-emerald-500/50 shadow-[0_0_15px_rgba(16,185,129,0.3)]"}`,children:h}):null})(),Number(w)===9&&e.jsxs("div",{className:"mt-2 p-4 border border-cyan/30 bg-[#0f2a2a]/40 rounded-xl",children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"CIBLE ET SOURCE DU DESIGN"}),e.jsxs("div",{className:"mb-3",children:[e.jsxs("div",{className:"flex items-center justify-between mb-1",children:[e.jsxs("label",{className:"text-[9px] text-cyan/70 font-bold uppercase tracking-wider",children:["PAGES CIBLES",Ve.length>0&&!uiAllPages&&e.jsxs("span",{className:"ml-2 text-cyan bg-cyan/20 px-1.5 py-0.5 rounded",children:[Ve.length," sélectionnée",Ve.length>1?"s":""]})]}),e.jsx("button",{onClick:async()=>{const i=y||ie;if(!i){alert("Sélectionnez un projet actif d'abord !");return}try{const h=await I(`http://localhost:5005/api/projects/${i}/pages`);if(h&&h.ok){const S=await h.json();S.pages&&nt(S.pages)}}catch{}},className:"text-[9px] text-cyan bg-cyan/10 border border-cyan/30 px-2 py-0.5 rounded hover:bg-cyan/20 transition-all",children:"↻ Rafraîchir"})]}),e.jsxs("div",{onClick:()=>{setUiAllPages(!uiAllPages),Be([])},className:`flex items-center gap-2 px-3 py-2 rounded-lg mb-1 cursor-pointer border transition-all ${uiAllPages?"bg-cyan/20 border-cyan/50 text-cyan":"bg-white/5 border-white/10 text-gray-400 hover:bg-white/10"}`,children:[e.jsx("div",{className:`w-3 h-3 rounded border flex items-center justify-center shrink-0 ${uiAllPages?"border-cyan bg-cyan":"border-gray-500"}`,children:uiAllPages&&e.jsx("span",{className:"text-white text-[8px] font-black leading-none",children:"✓"})}),e.jsx("span",{className:"text-[10px] font-black",children:"🚀 TOUTES LES PAGES (Auto-Mapping ZIP)"})]}),ct.length===0?e.jsxs("div",{onClick:async()=>{const i=y||ie;if(!i){alert("Sélectionnez un projet actif d'abord !");return}try{const h=await I(`http://localhost:5006/api/projects/${i}/pages`);if(h&&h.ok){const S=await h.json();S.pages&&nt(S.pages)}}catch{}},className:"text-[10px] text-gray-500 italic text-center py-3 border border-dashed border-white/10 rounded-lg cursor-pointer hover:border-cyan/30 hover:text-cyan/50 transition-all",children:["⏳ Cliquez pour charger les pages de « ",(typeof y=="string"?y:(y==null?void 0:y.project_id)||(y==null?void 0:y.title))||ie||"?"," »"]}):e.jsxs("div",{className:"flex flex-col gap-1 max-h-[160px] overflow-y-auto",children:[!uiAllPages&&e.jsxs("div",{className:"flex gap-1 mb-1",children:[e.jsx("button",{onClick:()=>Be([...ct]),className:"flex-1 text-[9px] text-cyan/70 border border-white/10 rounded px-2 py-1 hover:bg-white/5",children:"✔ Tout sélectionner"}),e.jsx("button",{onClick:()=>Be([]),className:"flex-1 text-[9px] text-gray-500 border border-white/10 rounded px-2 py-1 hover:bg-white/5",children:"✕ Tout désélectionner"})]}),ct.map(i=>{const h=i.replace("src/pages/","").replace(".tsx","").replace(".jsx",""),S=uiAllPages||Ve.includes(i);return e.jsxs("div",{onClick:()=>{uiAllPages||Be(E=>E.includes(i)?E.filter(se=>se!==i):[...E,i])},className:`flex items-center gap-2 px-3 py-2 rounded-lg cursor-pointer border transition-all ${uiAllPages?"opacity-50 bg-white/5 border-white/10":S?"bg-cyan/15 border-cyan/50 text-cyan":"bg-white/5 border-white/10 text-gray-300 hover:bg-white/10"}`,children:[e.jsx("div",{className:`w-3 h-3 rounded border flex items-center justify-center shrink-0 ${S?"border-cyan bg-cyan":"border-gray-500"}`,children:S&&e.jsx("span",{className:"text-white text-[8px] font-black leading-none",children:"✓"})}),e.jsx("span",{className:"text-[10px] font-bold",children:h}),e.jsx("span",{className:"text-[9px] text-gray-600 ml-auto",children:".tsx"})]},i)})]}),(uiAllPages||Ve.length>0)&&e.jsx("div",{className:"mt-2 text-[9px] text-cyan/80 bg-cyan/5 border border-cyan/20 rounded px-2 py-1 font-mono",children:uiAllPages?"✅ TOUTES LES PAGES seront traitées":`✅ ${Ve.length} page(s) : ${Ve.map(i=>i.replace("src/pages/","").replace(".tsx","")).join(", ")}`})]}),e.jsx("input",{type:"text",value:Ae,onChange:i=>D(i.target.value),placeholder:"Fichier ZIP (ex: v0-design.zip)",className:"w-full mb-3 bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 outline-none focus:border-cyan text-xs"}),Pe&&e.jsx("div",{className:"mb-3 text-[10px] text-cyan font-bold p-2 bg-cyan/10 border border-cyan/20 rounded",children:Pe}),e.jsxs("button",{disabled:isUiPushLoading,onClick:async()=>{const i=y||ie;if(!i){alert("Sélectionnez un projet d'abord.");return}if(!uiAllPages&&Ve.length===0){alert("Cochez au moins une page ou sélectionnez 'Toutes les pages'.");return}if(!Ae){alert("Indiquez le nom du fichier ZIP.");return}const h=uiAllPages?["ALL_PAGES"]:Ve;setIsUiPushLoading(!0),ze(`🚀 Démarrage du push pour ${h.length===1&&h[0]==="ALL_PAGES"?"TOUTES LES PAGES":`${h.length} page(s)`}...`);try{for(let S=0;S<h.length;S++){const E=h[S],se=E==="ALL_PAGES"?"ALL_PAGES":E.replace("src/pages/","").replace(".tsx","");ze(`⏳ [${S+1}/${h.length}] Traitement de ${se}...`);const T={projectId:i,targetFile:E,zipFileName:Ae,baseVersionId:"v1-current",mode:"strict-ui",targetRoute:"/",source:"vercel-interface",promotionMode:"disabled",idempotencyKey:`push-${i}-${E}-${Date.now()}`},me=await I("http://localhost:5005/api/bridge/strict-ui-update",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(T)});if(!me)throw new Error("Moteur local injoignable");const ye=await me.json();if(!me.ok||!ye.success)throw new Error(ye.message||"Erreur");const ut=ye.pushId;De(ut),await new Promise((Me,Ye)=>{const Ct=setInterval(async()=>{var Ue;try{const Oe=await I(`http://localhost:5005/api/bridge/strict-ui-update/${ut}?projectId=${i}`);if(!Oe)return;const et=await Oe.json();if(ze(`⏳ [${S+1}/${h.length}] ${se} — état: ${et.state}`),["promoted","preview_ready","validation_incomplete"].includes(et.state))clearInterval(Ct),Me();else if(["failed","rejected","promotion_rejected"].includes(et.state)){clearInterval(Ct);const Gt=typeof et.error=="string"?et.error:((Ue=et.error)==null?void 0:Ue.message)||et.state;Ye(new Error(`${se}: ${Gt}`))}}catch{}},3e3)})}ze("✅ Toutes les pages traitées avec succès !")}catch(S){ze(`❌ ${S.message}`)}finally{setIsUiPushLoading(!1)}},className:`w-full py-4 rounded-lg transition-all flex justify-center items-center gap-2 text-[11px] font-black uppercase tracking-wider text-white ${isUiPushLoading?"bg-gray-600 cursor-not-allowed":"bg-gradient-to-r from-blue-600/60 to-cyan-600/60 hover:from-blue-500/70 hover:to-cyan-500/70 border-cyan/50 shadow-[0_0_15px_rgba(8,179,201,0.4)]"}`,children:[e.jsx("span",{children:"🚀"})," LANCER PIPELINE PUSH UIUX (ONE-SHOT)"]}),tt&&un&&e.jsxs("button",{disabled:Ot,onClick:async()=>{const i=y||ie;xe(!0),ze("🚀 Promotion en cours vers la Production...");try{const h=await I(`http://localhost:5005/api/bridge/strict-ui-update/${un}/promote`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:i,promotionMode:"hybrid",confirm:!0})}),S=await h.json();h.ok&&S.success?(ze(`✅ Promotion Atomique Réussie ! Version: ${S.versionId}`),Ft(!1)):ze(`❌ Échec de la promotion: ${S.message||S.error}`)}catch(h){ze(`❌ Erreur de promotion: ${h.message}`)}finally{xe(!1)}},className:`w-full mt-3 py-4 rounded-lg transition-all flex justify-center items-center gap-2 text-[11px] font-black uppercase tracking-wider text-white ${Ot?"bg-gray-600 cursor-not-allowed":"bg-gradient-to-r from-green-600/60 to-emerald-600/60 hover:from-green-500/70 hover:to-emerald-500/70 border-emerald-500/50 shadow-[0_0_15px_rgba(16,185,129,0.4)]"}`,children:[e.jsx("span",{children:"🟢"})," PROMOUVOIR EN PRODUCTION (MERGE)"]})]})]})]}),e.jsxs("div",{className:"flex flex-col gap-4 overflow-y-auto hide-scrollbar",children:[e.jsx("div",{className:"bg-[#050505] border border-white/5 rounded-xl p-5",children:e.jsx(Uo,{activeProjectName:(typeof y=="string"?y:(y==null?void 0:y.project_id)||(y==null?void 0:y.title))||ie,selectedStartPhase:Number(w),onPhaseChange:i=>N(i),onPackGenerated:(i,h,S)=>{window.dispatchEvent(new CustomEvent("update_kirov_packs",{detail:[i]})),h&&Te(E=>E?`${E}

[INJECTION PRD] : ${h}`:h),It(S==="ecommerce"||S==="social"?"nextjs":"vite"),alert(`💎 Le Pack PRD '${i}' a été généré et lié automatiquement au projet !`)}})}),e.jsxs("div",{className:`bg-[#050505] border border-white/5 rounded-xl p-5 transition-all duration-500 ${ot?"shadow-[0_0_30px_rgba(8,179,201,0.3)] border-cyan/40":""}`,children:[e.jsx("h2",{className:"text-white font-bold text-[11px] mb-5 tracking-wide",children:'Workflow "Design-First" (Hybride)'}),e.jsxs("div",{className:"flex flex-col gap-3 text-[10px] font-mono text-gray-400 relative",children:[e.jsx("div",{className:"absolute left-[11px] top-6 bottom-6 w-px bg-white/5 z-0"}),Number(w)===0&&!Z&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute left-[5px] top-[32px] bg-red-900/80 border border-red-500 rounded text-[8px] px-1 text-white z-20",children:"🛑 Pause"}),e.jsx("div",{className:"absolute left-[5px] top-[64px] bg-red-900/80 border border-red-500 rounded text-[8px] px-1 text-white z-20",children:"🛑 Pause"}),e.jsx("div",{className:"absolute left-[5px] top-[96px] bg-red-900/80 border border-red-500 rounded text-[8px] px-1 text-white z-20",children:"🛑 Pause"}),e.jsx("div",{className:"absolute left-[5px] top-[128px] bg-red-900/80 border border-red-500 rounded text-[8px] px-1 text-white z-20",children:"🛑 Pause"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#051505] border border-green-500/50 flex items-center justify-center text-green-400 shrink-0 text-[10px]",children:"0"}),e.jsx("span",{className:"text-green-400",children:"Création (Boilerplate)"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#051020] border border-blue-500/50 flex items-center justify-center text-blue-400 shrink-0 text-[10px]",children:"1"}),e.jsx("span",{className:"text-blue-400",children:"Génération UI (Stitch)"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#150520] border border-indigo-500/50 flex items-center justify-center text-indigo-400 shrink-0 text-[10px]",children:"2"}),e.jsx("span",{className:"text-indigo-400",children:"Scan HTML & Blueprint JSON"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#051a20] border border-cyan/80 flex items-center justify-center text-cyan shadow-[0_0_15px_rgba(8,179,201,0.4)] shrink-0 text-[10px]",children:"3"}),e.jsx("span",{className:"text-cyan font-bold",children:"Orchestration des Lots"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#200520] border border-purple-500/50 flex items-center justify-center text-purple-400 shrink-0 text-[10px]",children:"4"}),e.jsx("span",{className:"text-purple-400",children:"Génération Contractuelle"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#2a1a00] border border-orange-500/50 flex items-center justify-center text-orange-400 shrink-0 text-[10px]",children:"5"}),e.jsx("span",{className:"text-orange-400",children:"Validation Industrielle"})]})]})]}),e.jsx("div",{className:"flex flex-col gap-2 mb-2",children:e.jsxs("button",{onClick:async()=>{var S;const i=y||ie;if(!i)return;const h=window.KIROV_TARGET_AI||"notebooklm";try{alert("Audit en cours... Hermes analyse votre code source pour générer le Pack Métier (Câblage). Veuillez patienter 15-30 secondes.");let E=`wiring-${i}`;try{const T=await I("http://localhost:5006/api/bridge/generate-wiring-pack",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:i,baseVersionId:"version-active",request:"Audite la coquille vide et propose le câblage métier.",targetFiles:[],targetRoutes:[],source:"phase-4-ui"})}),me=T?await T.json():null;me&&me.success?E=((S=me.data)==null?void 0:S.wiringPackId)||me.wiringPackId||E:console.warn("[WIRING] Solde API DeepSeek insuffisant (402) ou fallback. Synthèse autonome activée.")}catch(T){console.warn("[WIRING] Fallback local:",T)}alert("✅ Pack PRD Métier (Logic Wiring) prêt : "+E+`
Lancement de la Phase 3/4 (Câblage Métier)...`);const se={target_project:i,target_ai:h||"cloudflare",start_phase:4,wiringPackId:E,auto_pilot:Z,packs:window.KIROV_SELECTED_PACKS||[]};I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(se)}).then(T=>T?T.json():null).then(T=>{T&&(T.mode==="multi_batch"?alert("✅ "+T.message):T.error&&alert("❌ Erreur lors de l'injection : "+T.error))}).catch(T=>console.error("Trombone error",T))}catch(E){alert("❌ Erreur lors de l'audit: "+(E.message||E))}},className:"w-full bg-[#051a20] hover:bg-[#083040] border border-cyan/40 text-cyan px-4 py-3 rounded-lg text-[10px] font-bold transition-all flex justify-center items-center gap-2 shadow-[0_0_15px_rgba(8,179,201,0.2)]",children:[e.jsx("span",{children:"🔍"})," AUDITER LA COQUILLE VIDE (Générer Pack Métier)"]})}),e.jsxs("div",{className:"flex flex-col gap-2 mb-2",children:[e.jsxs("button",{onClick:()=>{const i=y||ie;if(!i)return;const h=window.KIROV_TARGET_AI||"deepseek",S=Number(w)===4?{projectId:i,start_phase:4,wiringPackId:`wiring-${i.replace(/[^a-zA-Z0-9_-]/g,"")}`,promotionMode:"disabled",autoPilot:!0}:{target_project:i,target_ai:h,start_index:1,zip_mode:!0,start_phase:w};I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(S)}).catch(E=>console.error(E))},className:"w-full bg-[#0a1025] hover:bg-[#101a35] border border-indigo-500/30 text-indigo-200 px-4 py-3 rounded-lg text-[10px] font-bold transition-all flex justify-center items-center gap-2",children:[e.jsx("span",{children:"🚀"})," LANCER PIPELINE PUSH UIUX (ONE-SHOT)"]}),e.jsxs("button",{onClick:async()=>{const i=y||ie;if(!i){alert("Sélectionnez un projet d'abord.");return}try{const h=await I("http://localhost:5006/api/bridge/reset-session",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:i})});if(!h){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const S=await h.json();alert(S.success?`🔓 ${S.message}`:`❌ ${S.error}`)}catch{alert("❌ Moteur :5006 inaccessible.")}},className:"w-full bg-[#2a0a0a] hover:bg-[#3d1010] border border-red-500/40 text-red-300 px-4 py-3 rounded-lg text-[10px] font-bold transition-all flex justify-center items-center gap-2",children:[e.jsx("span",{children:"🔓"})," DÉBLOQUER SESSION (Anti-Lockout)"]}),e.jsxs("button",{onClick:()=>{if(console.log("L'automatisation est lancée !"),!Ce.current||Object.keys(Ce.current).length===0){const h=y||ie;if(!h)return;I("http://localhost:5006/api/debug/advance-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:h})}).catch(()=>null);return}const i=Object.keys(Ce.current)[0];I("http://localhost:5006/api/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:Ce.current[i].prompt,target_ai:i,phase_num:Ce.current[i].phase_num,is_multi_batch:Ce.current[i].is_multi_batch,project_id:Ce.current[i].project_id})}).catch(()=>null)},className:"w-full bg-[#250a25] hover:bg-[#351035] border border-purple-500/30 text-purple-200 px-4 py-3 rounded-lg text-[10px] font-bold transition-all flex justify-center items-center gap-2",children:[e.jsx("span",{children:"🚀"})," Lancer l'Automatisation (Phase 4)"]})]}),e.jsxs("div",{id:"kirov-radar-queue",className:`flex-1 bg-[#080808] rounded-2xl p-5 flex flex-col gap-4 min-h-[220px] transition-all duration-1000 ${ot?"border-2 border-cyan shadow-[0_0_30px_rgba(8,179,201,0.25)]":"border border-white/10"}`,children:[e.jsxs("div",{className:"flex flex-col gap-2.5",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("span",{className:"text-cyan font-black text-sm flex items-center gap-2.5",children:[e.jsx("span",{className:"w-1.5 h-4 bg-cyan inline-block rounded-sm shadow-[0_0_8px_rgba(0,240,255,0.6)]"})," Tâche Actuelle"]}),e.jsx("button",{onClick:async()=>{let i=null,h="deepseek";if(Ce.current&&Object.keys(Ce.current).length>0?(h=Object.keys(Ce.current)[0],i=Ce.current[h]):Ce.queue&&Ce.queue.length>0&&(i=Ce.queue[0],h=i.target_ai||"deepseek"),!i){alert("Aucune tâche active ni en attente.");return}const S=localStorage.getItem("tiger_bridgeUrl")||"http://localhost:5006";I(`${S}/v1/bridge/inject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:i.prompt,target_ai:h,phase_num:i.phase_num,is_multi_batch:i.is_multi_batch,project_id:i.project_id||i.target_project||"GTASTICH"})}).catch(()=>null),alert(`Prompt [${i.phase_name||i.phase_num||"Lot 1"}] poussé manuellement dans la zone texte KIROV5 (${h}) !`)},className:"bg-gradient-to-r from-cyan-950 to-cyan-900 hover:from-cyan-900 hover:to-cyan-800 text-cyan-200 border border-cyan-500/40 text-xs font-black px-3.5 py-1.5 rounded-lg shadow-md transition-all cursor-pointer hover:scale-105",children:"⚡ FORCER ENVOI"})]}),Ce.current&&Object.keys(Ce.current).length>0?Object.entries(Ce.current).map(([i,h])=>{const S=typeof h.prompt=="string"?h.prompt:JSON.stringify(h.prompt);return e.jsxs("div",{className:"bg-zinc-900/90 border border-purple-500/30 p-3.5 rounded-xl text-xs md:text-sm text-zinc-200 font-mono shadow-md",children:[e.jsxs("div",{className:"text-pink-400 font-extrabold text-sm mb-1.5 flex items-center gap-2",children:[e.jsxs("span",{children:["🚀 [",i.toUpperCase(),"]"]}),e.jsx("span",{children:h.phase_name||"Tâche active"})]}),e.jsxs("div",{className:"text-zinc-300 text-xs leading-relaxed max-h-20 overflow-y-auto custom-scrollbar font-mono opacity-90",children:[S?S.substring(0,200):"","..."]})]},i)}):e.jsx("div",{className:"text-xs text-zinc-500 italic pl-2 py-1",children:"Aucune tâche active pour le moment."})]}),e.jsx("div",{className:"w-full h-px bg-white/10"}),e.jsxs("div",{className:"flex flex-col gap-2.5 flex-1 min-h-0",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("span",{className:"text-amber-400 font-bold text-xs md:text-sm flex items-center gap-2",children:[e.jsx("span",{children:"⏳"})," En attente (",Ce.queue.length,")"]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{onClick:async()=>{const i=localStorage.getItem("tiger_bridgeUrl")||"http://localhost:5006";for(let h=0;h<20;h++)await I(`${i}/v1/bridge/consume`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({})}).catch(()=>null)},className:"text-xs text-red-400 hover:text-red-300 border border-red-500/30 px-2.5 py-1 rounded-lg hover:bg-red-950/30 font-bold transition-colors cursor-pointer",children:"🗑️ Vider"}),e.jsx("button",{onClick:()=>{const i=y||ie||"GTASTICH",h=localStorage.getItem("tiger_bridgeUrl")||"http://localhost:5006";I(`${h}/api/debug/advance-batch`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:i})}).catch(()=>null)},className:"text-xs text-zinc-400 hover:text-white border border-zinc-700 px-2.5 py-1 rounded-lg hover:bg-zinc-800 font-bold transition-colors cursor-pointer",children:"Passer (Skip)"})]})]}),e.jsx("div",{className:"flex-1 overflow-y-auto pr-1 space-y-2 max-h-44 custom-scrollbar",children:Ce.queue.length>0?Ce.queue.map((i,h)=>{var E;const S=typeof i.prompt=="string"?i.prompt:JSON.stringify(i.prompt);return e.jsxs("div",{className:"bg-zinc-900/80 border border-white/10 p-3 rounded-xl flex flex-col gap-1.5 hover:border-white/20 transition-all",children:[e.jsxs("div",{className:"text-xs font-bold text-zinc-200 flex justify-between",children:[e.jsxs("span",{children:["[",h+1,"] ",i.phase_name||"Action"]}),e.jsx("span",{className:"text-purple-400 font-extrabold",children:(E=i.target_ai)==null?void 0:E.toUpperCase()})]}),e.jsxs("div",{className:"text-xs text-zinc-400 font-mono truncate",children:[S?S.substring(0,100):"","..."]})]},h)}):e.jsx("div",{className:"text-xs text-zinc-500 italic p-3 text-center border border-dashed border-white/10 rounded-xl",children:"File vide."})})]})]})]}),e.jsxs("div",{className:"bg-[#050505] border-2 border-emerald-500/30 rounded-2xl p-4 flex flex-col gap-3 shadow-[0_0_35px_rgba(16,185,129,0.15)] min-h-[440px] h-[520px] max-h-[850px] resize-y overflow-hidden mt-4",children:[e.jsxs("div",{className:"text-xs md:text-sm text-emerald-400 font-mono font-black flex items-center justify-between border-b border-emerald-500/20 pb-2.5",children:[e.jsxs("div",{className:"flex items-center gap-2.5",children:[e.jsxs("span",{className:"relative flex h-3 w-3",children:[e.jsx("span",{className:"animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"}),e.jsx("span",{className:"relative inline-flex rounded-full h-3 w-3 bg-emerald-500"})]}),e.jsx("span",{children:"> Moteur Kirov5 - Terminal Temps Réel"})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsxs("span",{className:"text-[11px] font-mono text-emerald-300/80 bg-emerald-950/60 border border-emerald-500/30 px-2.5 py-0.5 rounded-full font-bold",children:[qt.length," logs"]}),e.jsx("span",{className:"animate-pulse text-emerald-400 text-base font-bold",children:"_"})]})]}),e.jsx("div",{className:"flex-1 overflow-y-auto font-mono text-xs md:text-sm text-zinc-200 bg-black/80 p-4 rounded-xl border border-white/5 space-y-2 leading-relaxed custom-scrollbar flex flex-col",children:qt.length===0?e.jsx("span",{className:"text-zinc-600 italic py-4 text-center",children:"En attente d'activité système..."}):qt.slice(-150).map((i,h)=>{const S=i.includes("❌")||i.toLowerCase().includes("erreur")||i.toLowerCase().includes("error"),E=i.includes("✅")||i.includes("terminé")||i.includes("réussie"),se=i.includes("[📦]"),T=i.includes("[API WORKER]")||i.includes("[CLOUDFLARE-HERMES]"),me=i.includes("[TROMBONE]")||i.includes("🏁");return e.jsx("div",{className:`px-2 py-1 rounded font-mono text-xs md:text-sm break-all transition-colors ${S?"text-red-300 bg-red-950/40 border border-red-500/30 font-bold":E?"text-emerald-300 bg-emerald-950/20 font-semibold":T?"text-cyan-300 bg-cyan-950/20 font-medium":me?"text-purple-300 bg-purple-950/20 font-bold":se?"text-amber-300 bg-amber-950/10":i.includes("✍️")?"text-cyan-400 font-semibold":"text-zinc-300 hover:bg-white/5"}`,children:i},h)})})]})]})]}),g==="override"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-xl font-black text-white border-b border-white/10 pb-2",children:"Mode Manuel (Override)"}),e.jsx("p",{className:"text-gray-400 text-xs mt-2",children:"Prenez le contrôle manuel si l'automatisation s'enraye."})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{className:"text-gray-300 font-bold text-sm",children:"Injection de prompt de secours"}),e.jsx("textarea",{value:U,onChange:i=>fe(i.target.value),placeholder:"Entrez le prompt à forcer dans DeepSeek...",className:"w-full h-32 bg-gradient-to-b from-gray-900/60 to-black/60 text-white border border-white/20 rounded-xl p-3 outline-none focus:border-cyan text-sm resize-none"}),e.jsxs("div",{className:"flex gap-3 pt-2",children:[e.jsx("button",{className:"flex-1 py-2 bg-gradient-to-r from-pink/30 to-pink/10 hover:from-pink/40 hover:to-pink/20 text-pink border border-pink/50 rounded-lg text-xs font-bold transition-all",children:"💉 Forcer Injection"}),e.jsx("button",{className:"flex-1 py-2 bg-gradient-to-r from-orange-500/30 to-orange-500/10 hover:from-orange-500/40 hover:to-orange-500/20 text-orange-400 border border-orange-500/50 rounded-lg text-xs font-bold transition-all",children:"📦 Forcer Capture"})]})]}),e.jsxs("div",{className:"bg-gradient-to-b from-black/50 to-black/70 border border-white/10 p-3 rounded-xl h-32 font-mono text-[10px] text-gray-400 overflow-y-auto",children:[e.jsx("span",{className:"text-white mb-2 block",children:"Log Override"}),"En attente d'action manuelle..."]})]}),g==="mouchard"&&e.jsxs("div",{className:"space-y-4 animate-fadeIn h-full flex flex-col",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-xl font-black text-white border-b border-white/10 pb-2",children:"Mouchard Système"}),e.jsx("p",{className:"text-gray-400 text-xs mt-2",children:"Surveillance en temps réel du flux de données."})]}),e.jsxs("div",{className:"flex-1 bg-gradient-to-b from-gray-900 to-black border border-white/10 rounded-xl p-4 font-mono text-xs overflow-y-auto space-y-2 relative",children:[e.jsx("div",{className:"absolute top-2 right-2 flex gap-2",children:e.jsx("button",{className:"text-[10px] bg-gradient-to-r from-red-500/30 to-red-500/10 text-red-400 px-2 py-1 rounded hover:from-red-500/40 hover:to-red-500/20",children:"[WIPE]"})}),e.jsx("div",{className:"text-white font-bold mb-3 border-b border-white/20 pb-1 inline-block",children:"LOG_STREAM"}),e.jsx("div",{className:"text-yellow-400",children:"[09:24:30] ⚠️ Bridge local non joignable (Failed to fetch (Bridge hors ligne) - Failed to fetch). Polling Vercel actif."}),e.jsx("div",{className:"text-green-400",children:"[09:24:30] KIROV5 Orchestrator v5.1.1 prêt — structure React (.tsx/.ts/.css) préservée."}),e.jsx("div",{className:"text-cyan",children:"[09:24:30] Onglets: Projets · Projet · Injection · Capture · GitHub + Bridge :5006."})]})]}),g==="home"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{className:"flex justify-between items-center border-b border-white/10 pb-4",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"🐯"})," TIGER IA — Hub d'Orchestration Souverain"]}),e.jsx("p",{className:"text-xs text-gray-400 mt-1",children:"Supervision de l'écosystème Zero-Touch et de l'orchestrateur G5."})]}),e.jsx("span",{className:"px-3 py-1 bg-green-500/20 text-green-400 border border-green-500/30 rounded-full text-xs font-bold animate-pulse",children:"● Moteur IA Actif"})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:[e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/70 p-4 rounded-2xl border border-cyan/30 shadow-lg",children:[e.jsx("div",{className:"text-cyan text-xs font-bold uppercase tracking-wider mb-1",children:"Moteur Local"}),e.jsx("div",{className:"text-2xl font-black text-white",children:"v5.0.0"}),e.jsxs("div",{className:"text-[10px] text-gray-400 mt-2 flex items-center gap-1",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-cyan"})," Bridge 5006 Opérationnel"]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/70 p-4 rounded-2xl border border-purple-500/30 shadow-lg",children:[e.jsx("div",{className:"text-purple-400 text-xs font-bold uppercase tracking-wider mb-1",children:"Agent Réflexion"}),e.jsx("div",{className:"text-2xl font-black text-white",children:"DeepSeek-R1"}),e.jsxs("div",{className:"text-[10px] text-gray-400 mt-2 flex items-center gap-1",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-purple-400"})," Mode Hybride Actif"]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/70 p-4 rounded-2xl border border-pink/30 shadow-lg",children:[e.jsx("div",{className:"text-pink text-xs font-bold uppercase tracking-wider mb-1",children:"Studio UI/UX"}),e.jsx("div",{className:"text-2xl font-black text-white",children:"Zero-Touch"}),e.jsxs("div",{className:"text-[10px] text-gray-400 mt-2 flex items-center gap-1",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-pink"})," Synchro Temps Réel"]})]})]}),e.jsxs("div",{className:"space-y-3 pt-2",children:[e.jsx("h3",{className:"text-sm font-bold text-gray-300 uppercase tracking-wider",children:"🚀 Actions Système Rapides"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3",children:[e.jsxs("button",{onClick:()=>window.open("http://localhost:3006","_blank"),className:"p-4 bg-gradient-to-r from-cyan/20 to-blue-500/20 hover:from-cyan/30 hover:to-blue-500/30 border border-cyan/40 rounded-xl text-left transition-all flex items-center justify-between group",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm group-hover:text-cyan transition-colors",children:"🌐 Ouvrir l'Interface Studio (Vercel)"}),e.jsx("div",{className:"text-xs text-gray-400",children:"Accès direct au tableau de bord localhost:3006"})]}),e.jsx("span",{className:"text-xl",children:"➔"})]}),e.jsxs("button",{onClick:async()=>{var i;try{const h=await I("http://localhost:5006/api/theme");if(!h){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const S=await h.json();alert("Thème synchronisé : "+(((i=S.activeTheme)==null?void 0:i.nom)||"Thème par défaut"))}catch{alert("Vérifiez que le serveur Electron :5006 est démarré.")}},className:"p-4 bg-gradient-to-r from-purple-500/20 to-pink/20 hover:from-purple-500/30 hover:to-pink/30 border border-purple-500/40 rounded-xl text-left transition-all flex items-center justify-between group",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm group-hover:text-purple-300 transition-colors",children:"🎨 Tester la Synchronisation Thème"}),e.jsx("div",{className:"text-xs text-gray-400",children:"Interroge l'API bridge :5006/api/theme"})]}),e.jsx("span",{className:"text-xl",children:"🔄"})]})]})]})]}),g==="electron"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{className:"flex justify-between items-center border-b border-white/10 pb-4",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"💻"})," Moteur Electron PC — Serveur Local"]}),e.jsx("p",{className:"text-xs text-gray-400 mt-1",children:"Gestion du pont d'exécution et du système de fichiers local."})]}),e.jsx("span",{className:"px-3 py-1 bg-cyan/20 text-cyan border border-cyan/40 rounded-full text-xs font-bold",children:"Port :5006"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"bg-black/50 p-4 rounded-xl border border-white/10 space-y-3 font-mono text-xs text-gray-300",children:[e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Dossier Racine Workspace :"}),e.jsx("span",{className:"text-cyan font-bold",children:"E:\\v0reponses"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Répertoire des Projets Sauvegardés :"}),e.jsx("span",{className:"text-green-400 font-bold",children:"v0-moteur-electron/v0saveprojets"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Fichier Configuration Thème :"}),e.jsx("span",{className:"text-yellow-400 font-bold",children:"theme-config.json"})]}),e.jsxs("div",{className:"flex justify-between",children:[e.jsx("span",{className:"text-gray-400",children:"Mode Bridge HTTP :"}),e.jsx("span",{className:"text-blue-400 font-bold",children:"Express API REST Active"})]})]}),e.jsxs("div",{className:"flex gap-3",children:[e.jsx("button",{onClick:async()=>{var i,h;try{const S=await I("http://localhost:5006/api/projects");if(!S){alert("Mode Cloud SaaS actif : Bridge Electron local non connecté.");return}const E=await S.json();alert(`Projets détectés (${((i=E.projects)==null?void 0:i.length)||0}) : 
`+(((h=E.projects)==null?void 0:h.join(`
`))||"Aucun"))}catch{alert("Erreur de connexion au bridge Express :5006")}},className:"flex-1 py-3 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl text-white font-bold text-xs transition-colors flex items-center justify-center gap-2",children:"📁 Lister les Projets Locaux"}),e.jsx("button",{onClick:()=>{alert("Le moteur Electron tourne sur la tâche principale Windows.")},className:"flex-1 py-3 bg-cyan/20 hover:bg-cyan/30 border border-cyan/40 rounded-xl text-cyan font-bold text-xs transition-colors flex items-center justify-center gap-2",children:"⚡ État du Processus Electron"})]})]})]}),g==="vercel"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{className:"flex justify-between items-center border-b border-white/10 pb-4",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-2",children:[e.jsx("span",{className:"text-pink",children:"▲"})," Studio Web Vercel — Preview & HMR"]}),e.jsx("p",{className:"text-xs text-gray-400 mt-1",children:"Interface frontend réactive et synchronisation en direct."})]}),e.jsx("span",{className:"px-3 py-1 bg-pink/20 text-pink border border-pink/40 rounded-full text-xs font-bold",children:"Vite Dev Server"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"bg-black/50 p-4 rounded-xl border border-white/10 space-y-3 text-xs text-gray-300",children:[e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"URL Dev Local :"}),e.jsx("span",{className:"text-cyan font-mono font-bold",children:"http://localhost:3006"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Design System CSS :"}),e.jsx("span",{className:"text-pink font-mono font-bold",children:"src/design.css"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Source de Vérité Design Tokens :"}),e.jsx("span",{className:"text-purple-400 font-mono font-bold",children:"src/design-tokens.json"})]}),e.jsxs("div",{className:"flex justify-between",children:[e.jsx("span",{className:"text-gray-400",children:"Hot Module Replacement (HMR) :"}),e.jsx("span",{className:"text-green-400 font-bold",children:"Actif (Modifications Instantanées)"})]})]}),e.jsx("div",{className:"flex gap-3",children:e.jsx("button",{onClick:()=>window.open("http://localhost:3006/admin-design","_blank"),className:"flex-1 py-3 bg-gradient-to-r from-pink/30 to-purple-500/30 hover:from-pink/40 hover:to-purple-500/40 border border-pink/50 rounded-xl text-white font-bold text-xs transition-colors flex items-center justify-center gap-2",children:"🎨 Ouvrir le Studio Admin Design"})})]})]}),g==="deepseek"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{className:"flex justify-between items-center border-b border-white/10 pb-4",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-2",children:[e.jsx("span",{className:"text-purple-400",children:"🐋"})," Modèle IA DeepSeek — Agent Logique"]}),e.jsx("p",{className:"text-xs text-gray-400 mt-1",children:"Paramètres du modèle de génération de code et d'architecture."})]}),e.jsx("span",{className:"px-3 py-1 bg-purple-500/20 text-purple-400 border border-purple-500/30 rounded-full text-xs font-bold",children:"DeepSeek-V3 / R1"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"bg-black/50 p-4 rounded-xl border border-white/10 space-y-3 text-xs text-gray-300",children:[e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Mode d'Exécution IA :"}),e.jsx("span",{className:"text-cyan font-bold",children:"Chat Web & API Hybride"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Fenêtre de Contexte :"}),e.jsx("span",{className:"text-green-400 font-bold",children:"128,000 Tokens"})]}),e.jsxs("div",{className:"flex justify-between",children:[e.jsx("span",{className:"text-gray-400",children:"Rôle Principal :"}),e.jsx("span",{className:"text-purple-400 font-bold",children:"Cerveau Backend & Génération de Fichiers"})]})]}),e.jsx("div",{className:"flex gap-3",children:e.jsx("button",{onClick:()=>window.open("https://chat.deepseek.com/","_blank"),className:"flex-1 py-3 bg-gradient-to-r from-purple-500/30 to-blue-500/30 hover:from-purple-500/40 hover:to-blue-500/40 border border-purple-500/40 rounded-xl text-white font-bold text-xs transition-colors flex items-center justify-center gap-2",children:"🐋 Ouvrir DeepSeek Web"})})]})]})]}),!n&&e.jsxs("div",{className:"p-4 border-t border-white/10 bg-gradient-to-b from-black/30 to-black/50 flex flex-wrap justify-between items-center gap-4 relative z-10",children:[e.jsxs("button",{onClick:()=>ce(!Ee),className:`text-xs font-bold hover:underline flex items-center gap-1 ${Ee?"text-green-500":"text-red-500"}`,children:[e.jsx("span",{className:`w-2 h-2 rounded-full animate-pulse ${Ee?"bg-green-500":"bg-red-500"}`}),Ee?"Extension Connectée":"Extension Déconnectée"]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-3",children:[Ie&&e.jsx("span",{className:"text-green-400 font-bold text-xs flex items-center mr-2 animate-pulse",children:"✓ Sauvegardé"}),t&&e.jsx("button",{onClick:r,className:"px-4 py-2 rounded-xl text-white font-bold bg-gradient-to-r from-white/10 to-transparent hover:from-white/20 transition-colors text-sm",children:"Fermer"}),e.jsx("button",{onClick:Ge,className:"px-4 py-2 bg-gradient-to-r from-cyan to-blue-500 rounded-xl text-black font-black uppercase tracking-wider transition-all text-sm shadow-[0_0_15px_rgba(8,179,201,0.5)] whitespace-nowrap",children:"💾 SAUVER"})]})]})]})]})},$t=({items:t})=>{const n=l.useRef(null);return e.jsx("div",{ref:n,className:"design-carte-carrousel-conteneur w-full max-w-full flex overflow-x-auto gap-4 py-4 px-2 hide-scrollbar scroll-smooth relative",style:{scrollBehavior:"smooth"},children:t.map((r,c)=>e.jsx("div",{className:"shrink-0 relative z-0 hover:z-10",children:r},c))})},Xn=Object.assign({"../../prd_packs/CHOU/README.md":_s,"../../prd_packs/app_web_pack/README.md":Cs,"../../prd_packs/audio_pack/README.md":ws,"../../prd_packs/blog_contenu_pack/README.md":Is,"../../prd_packs/chat_comms_pack/README.md":As,"../../prd_packs/chatcom/README.md":Ps,"../../prd_packs/commerce_paiement_pack/README.md":ks,"../../prd_packs/composant_pack/README.md":js,"../../prd_packs/createur_pack/README.md":Ts,"../../prd_packs/design_figma_xd_pack/README.md":Es,"../../prd_packs/diamond_bridge_v14_37/README.md":Rs,"../../prd_packs/e_commerce_pack/README.md":Ns,"../../prd_packs/ecommerce_pack/README.md":Ds,"../../prd_packs/evenement_pack/README.md":Ms,"../../prd_packs/feed_social_pack/README.md":Ls,"../../prd_packs/forge_universelle/README.md":qs,"../../prd_packs/forms_inputs_pack/README.md":Us,"../../prd_packs/formulaire_pack/README.md":Os,"../../prd_packs/gamification_pack/README.md":Fs,"../../prd_packs/guest_apk_forge/README.md":Gs,"../../prd_packs/guest_bloguev1/README.md":Vs,"../../prd_packs/guest_bric/README.md":Bs,"../../prd_packs/guest_bricbrac/README.md":zs,"../../prd_packs/guest_bros/README.md":Hs,"../../prd_packs/guest_bross/README.md":$s,"../../prd_packs/guest_chat/README.md":Ks,"../../prd_packs/guest_colorful_landing_page/README.md":Ws,"../../prd_packs/guest_colorful_landing_page_builder/README.md":Js,"../../prd_packs/guest_cyberrunner/README.md":Xs,"../../prd_packs/guest_facturescan_souverain/README.md":Qs,"../../prd_packs/guest_fireguard_ai/README.md":Zs,"../../prd_packs/guest_flowforge_studio/README.md":Ys,"../../prd_packs/guest_game_launch_orchestrator/README.md":er,"../../prd_packs/guest_gametetris/README.md":tr,"../../prd_packs/guest_gta_vi_store/README.md":nr,"../../prd_packs/guest_kirov5_forge/README.md":sr,"../../prd_packs/guest_kirov_game_studio/README.md":rr,"../../prd_packs/guest_landing_page_adaptive/README.md":ir,"../../prd_packs/guest_mariob/README.md":ar,"../../prd_packs/guest_nebula_calc/README.md":or,"../../prd_packs/guest_neonstack/README.md":lr,"../../prd_packs/guest_neonstack_arcade/README.md":cr,"../../prd_packs/guest_plateforme/README.md":dr,"../../prd_packs/guest_plateformv2/README.md":ur,"../../prd_packs/guest_preorder_management/README.md":pr,"../../prd_packs/guest_production_ready_industrialization/README.md":mr,"../../prd_packs/guest_scraping_du_site_web_https_/README.md":gr,"../../prd_packs/guest_skills_platform_clone/README.md":hr,"../../prd_packs/guest_sovereign_production_platform/README.md":xr,"../../prd_packs/guest_stitchlab/README.md":fr,"../../prd_packs/guest_tetris_evolution/README.md":br,"../../prd_packs/guest_tetris_nova/README.md":vr,"../../prd_packs/guest_welcome_canvas/README.md":Sr,"../../prd_packs/guest_welcome_portal/README.md":yr,"../../prd_packs/guest_welcome_vibes/README.md":_r,"../../prd_packs/guest_welcomecanvas/README.md":Cr,"../../prd_packs/guest_workflow_automation_platform/README.md":wr,"../../prd_packs/guest_workflow_automation_studio/README.md":Ir,"../../prd_packs/guest_workflow_orchestrator/README.md":Ar,"../../prd_packs/health_fitness_pack/README.md":Pr,"../../prd_packs/ia_pack/README.md":kr,"../../prd_packs/image_pack/README.md":jr,"../../prd_packs/interface_pack/README.md":Tr,"../../prd_packs/jeux_video_pack/README.md":Er,"../../prd_packs/landing_pack/README.md":Rr,"../../prd_packs/landing_saas_pack/README.md":Nr,"../../prd_packs/layout_pack/README.md":Dr,"../../prd_packs/local_maps_pack/README.md":Mr,"../../prd_packs/markdown_pack/README.md":Lr,"../../prd_packs/marketing_pack/README.md":qr,"../../prd_packs/mobile_pack/README.md":Ur,"../../prd_packs/mobile_shell_pack/README.md":Or,"../../prd_packs/mobile_web_pack/README.md":Fr,"../../prd_packs/mock_master/README.md":Gr,"../../prd_packs/pdf_docs_pack/README.md":Vr,"../../prd_packs/pieces_jointes_pack/README.md":Br,"../../prd_packs/prd_ai_apps_pack/README.md":zr,"../../prd_packs/prd_ai_voice_agent/README.md":Hr,"../../prd_packs/prd_auth_gateway/README.md":$r,"../../prd_packs/prd_blog_magazine/README.md":Kr,"../../prd_packs/prd_crm_erp_pack/README.md":Wr,"../../prd_packs/prd_ecom_catalog/README.md":Jr,"../../prd_packs/prd_ecom_checkout/README.md":Xr,"../../prd_packs/prd_ecom_digital_products/README.md":Qr,"../../prd_packs/prd_game_leaderboard/README.md":Zr,"../../prd_packs/prd_layout_bento/README.md":Yr,"../../prd_packs/prd_layout_kanban/README.md":ei,"../../prd_packs/prd_mobile_pack/README.md":ti,"../../prd_packs/prd_mobile_social/README.md":ni,"../../prd_packs/prd_pack/README.md":si,"../../prd_packs/prd_saas_billing_pro/README.md":ri,"../../prd_packs/prd_saas_pack/README.md":ii,"../../prd_packs/prd_sovereign_fullstack/README.md":ai,"../../prd_packs/prd_specs_pack/README.md":oi,"../../prd_packs/prd_web_landing_pack/README.md":li,"../../prd_packs/productivity_pack/README.md":ci,"../../prd_packs/produit_pack/README.md":di,"../../prd_packs/prompt_skills_pack/README.md":ui,"../../prd_packs/saas_pack/README.md":pi,"../../prd_packs/specialise_pack/README.md":mi,"../../prd_packs/sqlite_inspector/README.md":gi,"../../prd_packs/stealth_bridge_v11_2/README.md":hi,"../../prd_packs/texte_pack/README.md":xi,"../../prd_packs/universal_scraper/README.md":fi,"../../prd_packs/video_pack/README.md":bi,"../../prd_packs/web_blog_pack/README.md":vi,"../../prd_packs/widget_pack/README.md":Si}),hn=t=>{for(const n in Xn)if(n.includes(`/${t}/README.md`)||n.includes(`\\${t}\\README.md`))return Xn[n];return null},Vo=({messages:t,showGuestPacks:n,setShowGuestPacks:r,guestPacksCount:c,guestPackSearchQuery:d,setGuestPackSearchQuery:m})=>e.jsx("div",{className:"design-carte-v0-guest flex-shrink-0 w-full xl:w-[320px] z-30",children:e.jsxs("div",{onClick:()=>r&&r(!n),className:`h-full rounded-2xl p-6 border flex flex-col justify-between transition-all cursor-pointer shadow-2xl relative overflow-hidden group ${n?"border-purple-400 bg-purple-950/40 shadow-[0_0_30px_rgba(168,85,247,0.3)]":"border-white/10 bg-black/60 hover:border-purple-500/50 hover:bg-purple-950/20"}`,children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-purple-500/10 to-transparent pointer-events-none"}),e.jsxs("div",{className:"relative z-10 flex flex-col h-full",children:[e.jsx("div",{className:"w-12 h-12 rounded-xl bg-purple-500/20 border border-purple-500/40 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform",children:e.jsx("span",{className:"text-2xl",children:"🐋"})}),e.jsx("h3",{className:"text-xl font-black text-white mb-1 leading-tight",children:"V0-GUEST"}),e.jsx("div",{className:"text-purple-400 font-bold text-xs uppercase tracking-widest mb-2",children:"Hermes PRD Pack Engine"}),e.jsxs("div",{className:"mb-2 relative",children:[e.jsx("input",{type:"text",placeholder:"Rechercher un pack Guest...",value:d||"",onChange:x=>m&&m(x.target.value),onClick:x=>x.stopPropagation(),className:"w-full bg-black/40 border border-purple-500/30 rounded-lg px-3 py-1.5 text-xs text-white placeholder-purple-400/50 focus:outline-none focus:border-purple-400 focus:bg-purple-900/20 transition-all"}),e.jsx("span",{className:"absolute right-2 top-1.5 text-purple-400/50 text-xs",children:"🔍"})]}),t&&t.length>0?e.jsxs("div",{className:"mt-2 p-3 bg-black/70 border border-purple-500/30 rounded-xl max-h-[280px] min-h-[160px] overflow-y-auto space-y-2 text-left shadow-inner flex-1",children:[e.jsxs("div",{className:"text-[10px] font-bold text-purple-300 uppercase tracking-wider mb-2 flex items-center justify-between border-b border-purple-500/20 pb-1",children:[e.jsx("span",{children:"💬 Discussion Chat Active"}),e.jsxs("span",{className:"text-[9px] text-purple-400 font-mono",children:[t.length," msg"]})]}),t.map((x,p)=>e.jsxs("div",{className:`p-2.5 rounded-xl text-xs leading-relaxed border ${x.role==="user"?"bg-purple-900/60 border-purple-400/50 text-purple-100 text-right ml-2":"bg-zinc-900/90 border-white/10 text-gray-200 mr-2"}`,children:[e.jsx("span",{className:"font-bold text-[9px] block opacity-70 mb-0.5",children:x.role==="user"?"Vous":"Hermes AI"}),x.content]},x.id||p))]}):e.jsx("p",{className:"text-xs text-zinc-400 leading-relaxed mb-3",children:"Accédez à vos propres packs sur-mesure générés localement par reverse engineering avec l'Agent Hermes."})]}),e.jsxs("div",{className:"relative z-10 mt-4 pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsxs("span",{className:"text-[10px] font-bold text-zinc-300 uppercase tracking-widest",children:[c||4," PACKS DISPONIBLES"]}),e.jsx("span",{className:`text-xl transition-transform ${n?"rotate-90 text-purple-400":"text-zinc-500 group-hover:text-purple-400"}`,children:"➔"})]})]})}),Bo=({selectedPacks:t,togglePack:n,isClient:r,getCachedGradient:c,onDetailStateChange:d,messages:m,showGuestPacks:x,setShowGuestPacks:p,guestPackSearchQuery:C})=>{const[v,y]=l.useState({}),[L,F]=l.useState(null),[Z,O]=l.useState([]),K=async()=>{try{const w=await I(`http://localhost:5006/api/bridge/list-guest-packs?t=${Date.now()}`,{cache:"no-store"});if(w&&w.ok){const N=await w.json(),R=N.data||N;R.success&&R.packs&&O(R.packs)}}catch(w){console.error("Erreur lecture guest packs",w)}},te=w=>{F(w),d&&d(!!w)};if(l.useEffect(()=>{Ht.forEach(w=>{const N=w.id;if(!v[N]){const R=hn(N);R&&y(g=>({...g,[N]:R}))}})},[]),l.useEffect(()=>{K()},[]),L){let w=v[L.packId]&&v[L.packId].trim().length>5?v[L.packId]:L.readmeText&&L.readmeText.trim().length>5?L.readmeText:hn(L.packId)||"";return(!w||w.trim().length<5)&&(w=`# 💎 PRD PACK : ${L.packName} (${L.packId})

### ⚙️ Spécifications techniques du contrat PRD

- **Identifiant Pack**: ${L.packId}
...
*Le fichier README complet est disponible dans le dossier prd_packs/${L.packId}/README.md.*`),e.jsxs("div",{className:"design-fenetre-readme w-full rounded-3xl p-6 md:p-8 border-2 border-cyan/60 shadow-[0_0_80px_rgba(124,58,237,0.45)] my-4 relative animate-fadeIn text-white z-20 flex flex-col min-h-[480px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 flex-shrink-0",children:[e.jsxs("span",{className:"px-3.5 py-1.5 bg-cyan/20 text-cyan text-xs font-bold rounded-xl border border-cyan/40 flex items-center gap-2 shadow-sm",children:[e.jsx("span",{children:"💎"})," PACK PRD : ",L.packId]}),e.jsx("button",{onClick:()=>te(null),className:"w-10 h-10 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-xl flex items-center justify-center font-bold text-lg transition-all border border-cyan/40 cursor-pointer shadow-md",title:"Fermer (Retour aux packs)",children:"✕"})]}),e.jsx("h2",{className:"text-2xl md:text-3xl font-black text-cyan mb-2 leading-tight drop-shadow-[0_2px_10px_rgba(6,182,212,0.5)] flex-shrink-0",children:L.packName}),e.jsx("div",{className:"w-full h-px bg-gradient-to-r from-cyan via-purple-400 to-cyan/20 mb-4 flex-shrink-0"}),e.jsx("div",{className:"design-readme-contenu flex-1 text-white font-medium leading-relaxed whitespace-pre-wrap overflow-y-auto max-h-[500px] p-6 rounded-2xl border-2 border-cyan/50 font-mono text-sm shadow-[0_0_40px_rgba(8,179,201,0.3)] min-h-[300px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)",textShadow:"0 1px 2px rgba(0,0,0,0.8)"},children:w}),e.jsxs("div",{className:"mt-6 pt-4 border-t border-white/15 flex justify-between items-center flex-shrink-0",children:[e.jsxs("span",{className:"text-xs text-cyan/90 font-mono font-bold tracking-widest uppercase flex items-center gap-2",children:[e.jsx("span",{children:"⚡"})," SUTURE PRD ENGINE"]}),e.jsx("button",{onClick:()=>te(null),className:"px-6 py-2.5 bg-cyan/20 hover:bg-cyan/40 text-cyan font-bold rounded-xl transition-all border border-cyan/40 flex items-center gap-2 cursor-pointer hover:bg-cyan/30 shadow-md",children:"← Fermer & Retour aux packs"})]})]})}return e.jsxs("div",{id:"prd-packs-carousel-section",className:"w-full flex-1 min-w-0 my-2",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3 px-2",children:[e.jsxs("h4",{className:"design-prd-titre-section font-black uppercase tracking-widest text-cyan flex items-center gap-2",children:[e.jsx("span",{children:"💎"})," PACKS PRD DE CONNAISSANCES (",Ht.length,")"]}),t&&t.length>0&&e.jsxs("span",{className:"text-[11px] font-bold text-cyan bg-cyan/20 px-2.5 py-1 rounded-full border border-cyan/30",children:[t.length," pack(s) actif(s)"]})]}),e.jsx("div",{className:"flex gap-4 items-stretch relative w-full",children:e.jsx("div",{className:"flex-1 min-w-0 min-h-[480px] overflow-hidden py-4 flex items-center",children:x?Z.length===0?e.jsxs("div",{className:"h-full min-h-[220px] rounded-2xl p-6 border border-purple-500/20 bg-purple-950/20 backdrop-blur-md flex flex-col items-center justify-center text-center",children:[e.jsx("p",{className:"text-purple-300 font-bold text-sm",children:"Aucun pack Guest n'a encore été généré."}),e.jsx("p",{className:"text-xs text-zinc-400 mt-2",children:"Utilisez l'interface V0-GUEST pour scanner un projet local et créer un pack sur-mesure."}),e.jsx("button",{onClick:K,className:"mt-4 text-xs text-purple-300 border border-purple-500/40 px-4 py-1.5 rounded-full hover:bg-purple-900/40 transition-colors",children:"🔄 Recharger les packs Guest"})]}):e.jsx($t,{items:Z.filter(w=>{var R,g,b,q;if(!C)return!0;const N=C.toLowerCase();return((R=w.name)==null?void 0:R.toLowerCase().includes(N))||((g=w.description)==null?void 0:g.toLowerCase().includes(N))||((b=w.id)==null?void 0:b.toLowerCase().includes(N))||((q=w.category)==null?void 0:q.toLowerCase().includes(N))}).sort((w,N)=>(w.name||"").localeCompare(N.name||"")).map(w=>{const N=w.id,R=t?t.includes(N):!1;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${R?"border-purple-400 shadow-[0_0_25px_rgba(168,85,247,0.4)] bg-purple-950/60":"border-purple-500/20 hover:border-purple-400/60 bg-black/50"}`,children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${R?"bg-purple-500 text-white shadow-md":"bg-purple-500/20 text-purple-400 border border-purple-500/40"}`,children:e.jsx(Tn,{size:18})}),e.jsx("span",{className:"px-2 py-0.5 bg-purple-500/20 text-purple-300 text-[10px] font-bold rounded-md uppercase tracking-wider border border-purple-500/30",children:"🐋 GUEST"})]}),n&&e.jsx("button",{onClick:g=>{g.stopPropagation(),n(N)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${R?"bg-purple-500 text-white shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-purple-500/40 hover:text-white"}`,children:R?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight truncate",children:w.name}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed text-zinc-300 text-xs line-clamp-4",children:w.description}),e.jsxs("div",{className:"mt-4 pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsxs("span",{className:"text-[10px] font-mono text-purple-400/80",children:[w.modulesCount," MODULES"]}),e.jsxs("button",{onClick:async()=>{var g;try{const b=await I(`http://localhost:5006/api/bridge/read-file?path=${encodeURIComponent(w.path+"/README.md")}`);let q="";if(b&&b.ok){const A=await b.json();q=((g=A.data)==null?void 0:g.content)||A.content||""}te({packId:N,packName:w.name,readmeText:q||`# PACK GUEST : ${w.name}

Spécifications techniques du pack Guest ${w.name}.

Module réutilisable scanné dans ${w.path}.`})}catch{te({packId:N,packName:w.name,readmeText:`# PACK GUEST : ${w.name}

Spécifications techniques du pack Guest ${w.name}.`})}},className:"design-prd-btn text-purple-400 text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-purple-500/30 transition-all",children:[e.jsx("span",{children:"📖"})," README →"]})]})]},N)})}):e.jsx($t,{items:Ht.map(w=>{const N=w.id,R=w.name,g=w.icon||cs,b=t?t.includes(N):!1,k=(v[N]||hn(N)||"Spécifications techniques du contrat PRD.").replace(/^#+.*$/gm,"").replace(/^>.*$/gm,"").replace(/\[([^\]]+)\]\([^\)]+\)/g,"$1").replace(/[*_~`]/g,"").trim().split(`
`).map($=>$.trim()).filter($=>$.length>20),W=k.length>0?k[0]:"Spécifications techniques du contrat PRD.",z=W.length>180?W.substring(0,180)+"...":W;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${b?"border-cyan shadow-[0_0_25px_rgba(8,179,201,0.4)]":"border-white/10 hover:border-cyan/50"}`,style:{background:r?c("prd-card-"+N,.7):"rgba(0,0,0,0.7)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${b?"bg-cyan text-black shadow-md":w.color||"bg-cyan/20 text-cyan"}`,children:e.jsx(g,{size:20})}),e.jsx("span",{className:"px-2 py-0.5 bg-cyan/20 text-cyan text-[10px] font-bold rounded-md uppercase tracking-wider",children:"💎 PRD"})]}),n&&e.jsx("button",{onClick:$=>{$.stopPropagation(),n(N)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${b?"bg-cyan text-black shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-white/20 hover:text-white"}`,title:b?"Désélectionner ce pack":"Sélectionner ce pack pour l'IA",children:b?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight",children:R}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed",children:z}),e.jsxs("div",{className:"mt-auto pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-mono text-cyan/80",children:"MODULE PRD"}),e.jsxs("button",{onClick:async()=>{var H;let $=v[N]||hn(N)||"";try{const re=await I(`http://localhost:5006/api/bridge/read-file?packId=${encodeURIComponent(N)}`);if(re&&re.ok){const ge=await re.json(),G=ge.content||((H=ge.data)==null?void 0:H.content);G&&G.trim().length>5&&($=G,y(V=>({...V,[N]:G})))}}catch(re){console.warn("API Bridge read fallback",re)}te({packId:N,packName:R,readmeText:$||`# 💎 PRD PACK : ${R} (${N})

### ⚙️ Spécifications techniques du contrat PRD

- **Identifiant Pack**: ${N}
- **Statut**: Actif & Intégré au Moteur Sovereign`})},className:"design-prd-btn text-cyan text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-cyan/30 transition-all hover:bg-cyan/10",children:[e.jsx("span",{children:"📖"})," Lire le README →"]})]})]},N)})})})})]})},Qn=({isClient:t,getCachedGradient:n,setActiveProject:r,onOpenProject:c})=>{const[d,m]=l.useState([]),[x,p]=l.useState(!0),[C,v]=l.useState(!1),[y,L]=l.useState(null),[F,Z]=l.useState({}),[O,K]=l.useState({}),te=async(R,g)=>{R.preventDefault(),R.stopPropagation(),typeof window<"u"&&(window.dispatchEvent(new CustomEvent("open-mouchard")),window.dispatchEvent(new CustomEvent("kirov-mouchard-log",{detail:`> 📱 [v0-apk] Lancement compilation APK pour "${g}"...`}))),K(A=>({...A,[g]:{status:"building",progress:"Initialisation..."}}));const b=A=>{K(k=>({...k,[g]:{status:"building",progress:A}})),typeof window<"u"&&window.dispatchEvent(new CustomEvent("kirov-mouchard-log",{detail:`> [v0-apk] ${A}`}))},q=(A,k)=>{K(W=>{var z;return{...W,[g]:{status:A,apkUrl:k||((z=W[g])==null?void 0:z.apkUrl),progress:A==="success"?"APK prêt !":"Échec compilation"}}}),A==="success"&&w()};try{const A=await I("http://localhost:5006/api/mobile/build-apk",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:g})});if(A&&A.ok){b("Compilation locale...");let k=0;const W=setInterval(async()=>{k++;try{const z=await I("http://localhost:5006/api/mobile/build-logs");if(z&&z.ok){const $=await z.json();if($.logs&&$.logs.length>0){const H=$.logs[$.logs.length-1];b(H.replace(/\[.*?\]/g,"").trim().substring(0,30))}if($.isBuilding===!1&&$.result)if(clearInterval(W),$.result.success){const H=$.result.apkUrl||`/api/mobile/download-apk?file=${encodeURIComponent(g+".apk")}`;q("success",H)}else b("Bascule Cloud..."),await zt(g,b,q)}}catch{clearInterval(W),await zt(g,b,q)}k>120&&clearInterval(W)},2e3)}else b("Bascule Cloud Souverain..."),await zt(g,b,q)}catch{b("Bascule Cloud Souverain...");try{await zt(g,b,q)}catch{q("error")}}},w=async()=>{try{let R=[];try{const g=await fetch("https://api.github.com/repos/turnzack/v0-reponse/releases");if(g.ok){const b=await g.json();Array.isArray(b)&&b.forEach(q=>{Array.isArray(q.assets)&&q.assets.forEach(A=>{var k;(k=A.name)!=null&&k.endsWith(".apk")&&R.push({file:A.name,name:A.name.replace(".apk",""),sizeMb:(A.size/(1024*1024)).toFixed(1),url:A.browser_download_url})})})}}catch{}try{const g=await I("http://localhost:5006/api/mobile/list-apks");if(g&&g.ok){const b=await g.json();b&&b.success&&Array.isArray(b.apks)&&(R=[...R,...b.apks])}else{const b=await fetch("/api/mobile/list-apks");if(b&&b.ok){const q=await b.json();q&&q.success&&Array.isArray(q.apks)&&(R=[...R,...q.apks])}}}catch{}if(R.length>0){const g={};R.forEach(b=>{g[b.name.toLowerCase()]=b,g[b.file.toLowerCase()]=b,g[b.name.toLowerCase().replace(/[^a-z0-9]/g,"")]=b}),Z(g)}}catch(R){console.warn("[WidgetProjects] fetchApks error",R)}},N=(R=!1)=>{R?v(!0):p(!0);const g=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];I("http://localhost:5006/api/projects").then(b=>b?b.json():null).then(b=>{if(b&&b.success&&b.projects)m(b.projects.map((q,A)=>({name:typeof q=="string"?q:q.projectName||q.name||q.projectId||q.project_id||q.title||`Projet_${A}`,desc:"Environnement Local",bg:g[A%g.length],installed:q.installed}))),p(!1),v(!1);else{const q=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:q?{Authorization:`Bearer ${q}`}:{}}).then(A=>A?A.json():null).then(A=>{A&&A.projects&&m(A.projects.map((k,W)=>({name:k.project_id||k.title||k.name||`Projet_${W}`,desc:"SaaS Cloud (Neon DB)",bg:g[W%g.length]}))),p(!1),v(!1)}).catch(()=>{p(!1),v(!1)})}}).catch(()=>{p(!1),v(!1)})};return l.useEffect(()=>{N(),w();const R=setInterval(()=>{N(!0),w()},5e3);return()=>clearInterval(R)},[]),x?e.jsx("div",{className:"p-4 text-cyan text-sm italic",children:"Actualisation de la liste des projets..."}):d.length===0?e.jsxs("div",{className:"p-4 flex flex-col items-center gap-3 text-center",children:[e.jsx("div",{className:"text-cyan text-sm italic",children:"Aucun projet trouvé sur votre disque dur."}),e.jsx("button",{onClick:()=>N(),className:"px-4 py-2 rounded-xl bg-cyan/20 border border-cyan/40 text-cyan text-xs font-bold hover:bg-cyan/40 transition-colors",children:"🔄 Rafraîchir la liste"})]}):e.jsx($t,{items:[...d.map((R,g)=>{const b=R.name||"AUDIO",q=async()=>{if(L(b),c){c(b),setTimeout(()=>L(null),1e3);return}r&&r(b);try{I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b,open_explorer:!1})}).catch(()=>{})}catch(V){console.error("Erreur de lancement :",V)}finally{setTimeout(()=>L(null),1e3)}},A=async V=>{if(V.preventDefault(),V.stopPropagation(),window.confirm(`⚠️ SUPPRESSION DEFINITIVE :
Voulez-vous vraiment supprimer le projet "${b}" de l'interface ET de votre disque dur ?`))try{const ne=await I("http://localhost:5006/api/projects/remove-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})});if(!ne){m(he=>he.filter(Y=>Y.name!==b));return}const le=await ne.json();le.success?m(he=>he.filter(Y=>Y.name!==b)):alert(`Erreur lors de la suppression : ${le.message||"Échec server"}`)}catch(ne){alert(`Erreur réseau lors de la suppression : ${ne.message}`)}},k=O[b],W=(k==null?void 0:k.status)==="building",z=(k==null?void 0:k.status)==="success",$=b.toLowerCase(),H=$.replace(/[^a-z0-9]/g,""),re=F[$]||F[H]||F[`${$}.apk`],ge=z&&(k!=null&&k.apkUrl)?k.apkUrl:re?re.url:null,G=re!=null&&re.sizeMb?`${re.sizeMb}M`:"Prêt";return e.jsxs("div",{className:"design-carte-carrousel rounded-2xl p-5 border border-white/20 shadow-xl flex flex-col items-center text-center relative overflow-hidden group cursor-pointer",style:{background:t?n("proj-"+g,.7):"rgba(0,0,0,0.5)"},onClick:q,children:[ge?e.jsxs("a",{href:ge,download:`${b}.apk`,onClick:V=>V.stopPropagation(),className:"z-20 absolute top-3 left-3 bg-emerald-600 hover:bg-emerald-500 text-white text-[10px] font-black px-2.5 py-1 rounded-full flex items-center gap-1.5 shadow-lg border border-emerald-400/50 transition-all hover:scale-105 cursor-pointer animate-pulse",title:`Télécharger directement l'APK (${G})`,children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-white animate-ping"}),e.jsxs("span",{children:["📱 APK PRÊT (",G,")"]})]}):W?e.jsxs("div",{onClick:V=>V.stopPropagation(),className:"z-20 absolute top-3 left-3 bg-purple-700/90 text-white text-[10px] font-bold px-2.5 py-1 rounded-full flex items-center gap-1.5 shadow-lg border border-purple-400/60 animate-pulse select-none",title:(k==null?void 0:k.progress)||"Compilation de l'APK en cours...",children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-white animate-ping"}),e.jsx("span",{children:"⏳ APK EN COURS..."})]}):null,e.jsx("button",{onClick:A,className:"z-20 absolute top-3 right-3 w-8 h-8 rounded-full bg-red-600/80 hover:bg-red-500 text-white font-bold text-xs flex items-center justify-center transition-all shadow-lg hover:scale-110 cursor-pointer",title:"Supprimer ce projet du disque dur et de l'interface",children:"🗑️"}),e.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-30 mix-blend-overlay pointer-events-none"}),e.jsx("div",{className:"absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors z-0"}),e.jsxs("div",{className:"z-10 relative pointer-events-none w-full pr-8",children:[e.jsx("div",{className:"text-white/70 text-xs font-bold uppercase tracking-widest drop-shadow-md",children:"PROJET"}),e.jsx("h3",{className:"design-carte-titre text-xl font-black text-white break-all drop-shadow-lg leading-tight w-full",children:b})]}),e.jsx("div",{className:"design-carte-desc z-10 relative text-sm text-white/90 font-medium drop-shadow-md pointer-events-none w-full",children:R.desc}),e.jsxs("div",{className:"z-10 flex flex-wrap items-center justify-center gap-2 mt-3",children:[e.jsx("button",{onClick:V=>{V.stopPropagation(),y!==b&&(R.installed===!1?(L(b),I("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})}).then(ne=>{alert(ne?`📦 Installation des dépendances démarrée pour "${b}" !
Suivez la progression dans les logs.`:"Mode Cloud SaaS : Bridge local non connecté."),L(null),m(le=>le.map(he=>he.name===R.name?{...he,installed:!0}:he))}).catch(()=>L(null))):q())},disabled:y===b,className:`font-bold py-2 px-4 rounded-xl text-xs transition-all flex items-center gap-1.5 ${y===b?"bg-cyan-500/40 text-cyan-200 cursor-wait animate-pulse":R.installed===!1?"bg-orange-500/80 hover:bg-orange-600 text-white cursor-pointer":"bg-white/20 hover:bg-white/40 text-white cursor-pointer"}`,title:R.installed===!1?"Installer les dépendances requises pour ce projet":"Lancer la prévisualisation Vite",children:y===b?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin inline-block",children:"⏳"})," ",R.installed===!1?"Installation...":"Lancement..."]}):R.installed===!1?e.jsx(e.Fragment,{children:"📦 INSTALL"}):e.jsx(e.Fragment,{children:"🚀 PREVIEW"})}),ge?e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsxs("a",{href:ge,download:`${b}.apk`,onClick:V=>V.stopPropagation(),className:"bg-gradient-to-r from-emerald-600 to-green-500 hover:from-emerald-500 hover:to-green-400 text-white font-extrabold py-2 px-3.5 rounded-xl text-xs transition-all flex items-center gap-1.5 shadow-lg shadow-emerald-950/60 border border-emerald-400/50 cursor-pointer animate-pulse hover:scale-105",title:`Télécharger l'APK Android compilé de ${b} (${G}) directement`,children:[e.jsx("span",{children:"📥"}),e.jsx("span",{children:"APK"}),e.jsxs("span",{className:"text-[10px] opacity-90 font-mono",children:["(",G,")"]})]}),e.jsx("button",{onClick:V=>te(V,b),className:"bg-purple-600/30 hover:bg-purple-600/60 text-purple-200 hover:text-white font-bold py-2 px-2 rounded-xl text-xs transition-colors flex items-center justify-center border border-purple-400/40 cursor-pointer",title:"Re-compiler une nouvelle version de l'APK",children:"🔄"})]}):W?e.jsxs("div",{onClick:V=>V.stopPropagation(),className:"bg-purple-900/70 border border-purple-500/60 text-purple-200 font-bold py-2 px-3 rounded-xl text-xs flex items-center gap-1.5 shadow-lg shadow-purple-950/60 cursor-wait animate-pulse",title:(k==null?void 0:k.progress)||"Compilation APK en cours...",children:[e.jsx("span",{className:"animate-spin inline-block text-xs",children:"⏳"}),e.jsx("span",{className:"max-w-[110px] truncate text-[11px]",children:(k==null?void 0:k.progress)||"v0-apk..."})]}):e.jsxs("button",{onClick:V=>te(V,b),className:"bg-gradient-to-r from-purple-700/90 to-indigo-600/90 hover:from-purple-600 hover:to-indigo-500 text-white font-bold py-2 px-3 rounded-xl text-xs transition-all flex items-center gap-1.5 shadow-lg shadow-purple-950/60 border border-purple-400/50 hover:border-purple-300 cursor-pointer hover:scale-105",title:`Lancer la création du fichier APK pour "${b}" directement depuis le carrousel`,children:[e.jsx("span",{children:"📱"}),e.jsx("span",{children:"v0-apk action"})]}),R.installed!==!1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:V=>{V.stopPropagation(),L(b),I("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})}).then(ne=>{alert(ne?`🔄 Réinstallation des dépendances démarrée pour "${b}" !`:"Mode Cloud SaaS : Bridge local non connecté."),L(null)}).catch(()=>L(null))},className:"bg-orange-500/30 hover:bg-orange-500/60 text-white font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center justify-center border border-orange-500/40 cursor-pointer",title:"Forcer la réinstallation des dépendances (pnpm install)",children:"🔄"}),e.jsx("button",{onClick:async V=>{V.stopPropagation();try{L(b);const ne=await I("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})});if(L(null),!ne){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const le=await ne.json();alert(le.message||`🚀 Serveur Vite démarré pour ${b} !`),le.previewUrl&&window.open(le.previewUrl,"_blank")}catch(ne){L(null),alert("Erreur de connexion au bridge: "+ne.message)}},className:"font-bold py-2 px-3 rounded-xl text-xs bg-purple-500/60 hover:bg-purple-500 text-white transition-all shadow-md cursor-pointer",title:"Lancer le serveur Vite avec pnpm run dev",children:"💻 PNPM"})]}),e.jsx("button",{onClick:A,className:"bg-red-600/30 hover:bg-red-600/60 text-red-200 border border-red-500/40 font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center gap-1",title:"Supprimer définitivement du disque dur",children:"🗑️ Supprimer"})]})]},g)})]})};function zo({user:t,onLogout:n}={}){var qn;const r=l.useRef({}),c=(s,a=1)=>typeof window>"u"?`linear-gradient(135deg, rgba(17,17,17,${a}), rgba(34,34,34,${a}))`:(r.current[s]||(r.current[s]=Go(a)),r.current[s]),d=(t==null?void 0:t.email)||(typeof window<"u"?localStorage.getItem("tiger_currentUserEmail"):null),m=!!(t!=null&&t.isSuperAdmin||d&&d.toLowerCase().trim()==="zacktunr@gmail.com");l.useEffect(()=>{t!=null&&t.email&&typeof window<"u"&&localStorage.setItem("tiger_currentUserEmail",t.email)},[t]);const x=()=>{typeof window<"u"&&(localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),localStorage.removeItem("tiger_lastGeneratedProject"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{})),n?n():typeof window<"u"&&window.location.reload()},[p,C]=l.useState([]),[v,y]=l.useState(""),L=l.useRef(null),F=l.useRef(null),[Z,O]=l.useState(!1),[K,te]=l.useState("connexion"),[w,N]=l.useState(!1),[R,g]=l.useState("clean");l.useRef(0);const[b,q]=l.useState(1),[A,k]=l.useState(!1),[W,z]=l.useState(!1),[$,H]=l.useState(!1);l.useEffect(()=>{let s=0;const a=setInterval(()=>{var o,_;if(typeof window<"u"){const u=(_=(o=window.Capacitor)==null?void 0:o.isNativePlatform)==null?void 0:_.call(o),f=!!window.AndroidBridge;(u||f)&&(z(!0),clearInterval(a))}s++>10&&clearInterval(a)},100);return()=>clearInterval(a)},[]);const[re,ge]=l.useState([]),[G,V]=l.useState(""),[ne,le]=l.useState(["> Système Kirov5 initialisé. "+new Date().toLocaleTimeString()]),[he,Y]=l.useState([]),[j,Q]=l.useState([]);l.useEffect(()=>{const s=a=>Q(a.detail);return window.addEventListener("update_kirov_packs",s),()=>window.removeEventListener("update_kirov_packs",s)},[]),l.useEffect(()=>{window.KIROV_SELECTED_PACKS=j},[j]);const[ae,pe]=l.useState(!1),[ve,je]=l.useState(!1),[ke,U]=l.useState([]),[fe,Ie]=l.useState(!1),[be,ie]=l.useState(""),[Re,it]=l.useState(""),[Te,Ee]=l.useState(!1),[ce,xt]=l.useState(""),[Ke,Mn]=l.useState("Vite + React + Tailwind + TS"),[ft,vn]=l.useState(""),[It,Rt]=l.useState("deepseek"),[We,sn]=l.useState(""),[rn,Ln]=l.useState(!0),[an,on]=l.useState(!1),[bt,At]=l.useState(null),[Nt,at]=l.useState([]),[ln,ot]=l.useState(!1),Dt=l.useCallback(async s=>{ot(!0);const a=[{id:"deepseek-r1-v0",tag:"⚡ DEEPSEEK R1",title:"DeepSeek-R1 & Moteur Souverain v0.1",desc:"Capacités de raisonnement avancé et de suture pour interfaces React.",content:`DeepSeek-R1 offre des capacités de raisonnement avancé pour l'analyse de contrats PRD et la génération zéro-touch de projets web complets.
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){at(a),ot(!1);return}const o=s||localStorage.getItem("tiger_apiKey");if(!o||!o.startsWith("sk-")||o.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){at(a),ot(!1);return}const _=new AbortController,u=setTimeout(()=>_.abort(),4e3),f=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o}`},signal:_.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(u),f.ok){const P=await f.json(),M=JSON.parse(P.choices[0].message.content);M.news&&Array.isArray(M.news)&&M.news.length>0?at(M.news):at(a)}else f.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),at(a)}catch(o){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",o),at(a)}finally{ot(!1)}},[]);l.useEffect(()=>{Dt()},[Dt]);const[Je,lt]=l.useState(!1),[Ne,Mt]=l.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Ge,vt]=l.useState([]),[Lt,cn]=l.useState("");l.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let a=JSON.parse(s);if(!Array.isArray(a))throw new Error("Not an array");const o="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";a=a.map(_=>_.name==="fold"?{..._,colors:{..._.colors,"bg-app":o}}:_),vt(a)}catch{vt([])}else{const a={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};vt([a]),localStorage.setItem("tiger_saved_themes",JSON.stringify([a]))}},[]),l.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",Ne),Ne!=="random"){const a=((s=Ge.find(o=>o.name===Ne))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=a,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[Ne,Ge]);const Ce=()=>{if(!Lt.trim())return alert("Nom invalide");if(Ge.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":c("icon-settings",.8),"icon-ai":c("icon-ai",.8),"icon-projects":c("icon-projects",.8),"icon-packs":c("icon-packs",.8),"icon-news":c("icon-news",.8),"bg-app":c("bg-app",.9)},a={name:Lt.trim(),colors:s},o=[...Ge,a];vt(o),localStorage.setItem("tiger_saved_themes",JSON.stringify(o)),Mt(a.name),cn("")},Sn=(s,a)=>{a.stopPropagation();const o=Ge.filter(_=>_.name!==s);vt(o),localStorage.setItem("tiger_saved_themes",JSON.stringify(o)),Ne===s&&Mt("random")},qt=s=>{Q(a=>a.includes(s)?a.filter(o=>o!==s):[...a,s])},[Xe,dn]=l.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});l.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(Xe))},[Xe]);const[Ut,Ve]=l.useState(!0),[Be,Ae]=l.useState(!0),[D,Pe]=l.useState(null),[ze,un]=l.useState(null),[De,Ot]=l.useState(null),[xe,tt]=l.useState(null),[Ft,ct]=l.useState(""),[nt,Pt]=l.useState([]),[Qe,Jt]=l.useState(!1),[Ze,gt]=l.useState("idle"),[kt,st]=l.useState([]),[St,pn]=l.useState(""),[jt,Xt]=l.useState(null),[ht,yn]=l.useState([]),yt=l.useCallback(async()=>{try{let s=[];try{const a=await fetch("https://api.github.com/repos/turnzack/v0-reponse/releases");if(a.ok){const o=await a.json();Array.isArray(o)&&o.forEach(_=>{Array.isArray(_.assets)&&_.assets.forEach(u=>{var f;(f=u.name)!=null&&f.endsWith(".apk")&&s.push({file:u.name,name:u.name.replace(".apk",""),sizeMb:(u.size/(1024*1024)).toFixed(1),url:u.browser_download_url})})})}}catch{}try{const a=await I("http://localhost:5006/api/mobile/list-apks");if(a&&a.ok){const o=await a.json();o&&o.success&&Array.isArray(o.apks)&&(s=[...s,...o.apks])}else{const o=await fetch("/api/mobile/list-apks");if(o&&o.ok){const _=await o.json();_&&_.success&&Array.isArray(_.apks)&&(s=[...s,..._.apks])}}}catch{}if(s.length>0){const a=new Set,o=s.filter(_=>a.has(_.file.toLowerCase())?!1:(a.add(_.file.toLowerCase()),!0));yn(o)}}catch(s){console.warn("[v0-apk] loadAvailableApks error",s)}},[]);l.useEffect(()=>{Qe&&yt()},[Qe,yt]),l.useEffect(()=>{let s,a=0;return Ze==="building"&&(s=setInterval(async()=>{try{const o=await I("http://localhost:5006/api/mobile/build-logs");if(o&&o.ok){a=0;const _=await o.json();_.logs&&_.logs.length>0&&st(_.logs),_.isBuilding===!1&&_.result&&(_.result.success?(gt("success"),Xt(_.result.apkUrl)):gt("error"),clearInterval(s))}else a++,a>=3&&(clearInterval(s),gt("error"),st(_=>[..._,`❌ Service de compilation mobile absent sur ce serveur (${o?o.status:"erreur réseau"}).`,"📱 Option 1 (Cloud) : Déclenchez le compilateur automatique Cloud Souverain.",`💻 Option 2 (Local) : Lancez 'python apk_builder.py --src ... --name ${St||D||"app"} --build' dans E:\\v0reponses\\v0-apk.`]))}catch(o){console.warn("Polling APK error",o)}},1500)),()=>{s&&clearInterval(s)}},[Ze,St,D]),l.useEffect(()=>{I("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))Y(s.projects.map(a=>({name:typeof a=="string"?a:a.project_id||a.title||a.name||"Projet",desc:"Projet local",bg:""})));else{const a=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:a?{Authorization:`Bearer ${a}`}:{}}).then(o=>o?o.json():null).then(o=>{o&&o.projects&&Y(o.projects.map(_=>({name:typeof _=="string"?_:_.project_id||_.title||_.name||"Projet",desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[dt,Se]=l.useState(null),[Qt,_t]=l.useState(""),[Tt,i]=l.useState(!1),[h,S]=l.useState(!1),E=l.useRef(null);l.useEffect(()=>{if(E.current=null,D==="v0-guest"||D==="V0-Guest")S(!0),Se("http://localhost:3007"),_t("http://localhost:3007"),E.current="http://localhost:3007";else if(D){S(!0);const s=De&&JSON.stringify(De).includes("next.config"),a=typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1",o=s?"http://localhost:3000":E.current||(a?`http://${window.location.hostname}:5173`:"http://localhost:5173");Se(o),_t(o),E.current=o}else S(!1),Se(null)},[D,De]),l.useEffect(()=>{const s=a=>{var o,_,u,f;if(((o=a.data)==null?void 0:o.type)==="CHANGE_PREVIEW_URL"){const P=a.data.route,M=P==="/"?"":`#${P}`;Se(ee=>{const J=ee?ee.split("#")[0]:"http://127.0.0.1:5175/";return`${J.endsWith("/")?J:`${J}/`}${M}`})}if(((_=a.data)==null?void 0:_.type)==="DESIGN_ELEMENT_CLICKED"||((u=a.data)==null?void 0:u.type)==="DESIGN_ELEMENT_DRAGGED"||((f=a.data)==null?void 0:f.type)==="DESIGN_ELEMENT_RESIZED"){const P=document.querySelector('iframe[title="Studio Admin Design"]');P&&P.contentWindow&&P.contentWindow.postMessage(a.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),l.useEffect(()=>{D&&I(`http://localhost:5006/api/fs/tree?project=${D}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&Ot(s.tree)}).catch(()=>{})},[D]),l.useEffect(()=>{D&&xe&&I(`http://localhost:5006/api/fs/read?project=${D}&file=${encodeURIComponent(xe)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&ct(s.content)}).catch(()=>{})},[D,xe]);const se=async s=>{if(s===void 0||!D||!xe)return;if(ct(s),Wt.isNativePlatform()||!!window.AndroidBridge)try{await Kn.writeFile({path:`v0-moteur-mobile/projetv0/${D}/${xe}`,data:s,directory:fn.Documents,encoding:kn.UTF8,recursive:!0})}catch(o){console.error("Erreur de sauvegarde mobile:",o)}else I("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:D,file:xe,content:s})}).catch(()=>{})},T=s=>{D&&I(`http://localhost:5006/api/fs/read?project=${D}&file=${encodeURIComponent(s)}`).then(a=>a?a.json():null).then(a=>{a&&a.success&&Pt(o=>o.find(_=>_.path===s)?o:[...o,{path:s,content:a.content}])}).catch(()=>{})};l.useEffect(()=>{(async()=>{const a=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(Wt.isNativePlatform()||!!window.AndroidBridge)try{const u=(await Kn.readdir({path:"v0-moteur-mobile/projetv0",directory:fn.Documents})).files.map(f=>f.name||f.toString());Y(u.map((f,P)=>({name:f,desc:"Mémoire Téléphone",bg:a[P%a.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else I("http://localhost:5006/api/projects-v2").then(_=>_?_.json():null).then(_=>{if(_&&_.success&&_.projects)Y(_.projects.map((u,f)=>({name:typeof u=="string"?u:u.name||u.project_id||u.title||`Projet_${f}`,desc:"Environnement Local",bg:a[f%a.length],installed:u.installed})));else{const u=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:u?{Authorization:`Bearer ${u}`}:{}}).then(f=>f?f.json():null).then(f=>{f&&f.projects&&Y(f.projects.map((P,M)=>({name:typeof P=="string"?P:P.project_id||P.title||P.name||`Projet_${M}`,desc:"SaaS Cloud (Neon DB)",bg:a[M%a.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),l.useEffect(()=>{k(!0)},[]);const[me,ye]=l.useState(!0);l.useEffect(()=>{const s=()=>ye(!0),a=_=>{_&&_.detail&&le(u=>[_.detail,...u.slice(0,49)])};window.addEventListener("open-mouchard",s),window.addEventListener("kirov-mouchard-log",a);const o=_=>{if(_.data&&_.data.type==="TIGER_CAPTURE"){const u=_.data.data;if(u){let f="index.html";(u.includes("import React")||u.includes("export default"))&&(f="App.tsx"),u.includes("tailwindcss")&&(f="index.css"),tt(f),se(u),Ot(P=>{var J;const M={name:f,path:f,type:"file"};return P?((J=P.children)==null?void 0:J.find(X=>X.name===f))?P:{...P,children:[...P.children||[],M]}:{name:"Mobile_Storage",type:"directory",children:[M]}})}}};return window.addEventListener("message",o),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("kirov-mouchard-log",a),window.removeEventListener("message",o)}},[D,xe]),l.useEffect(()=>{if(!A)return;const s=()=>{I("http://localhost:5006/api/bridge/queue").then(o=>o?o.json():null).then(o=>{o&&o.success&&(setBridgeQueueData({current:o.current||{},queue:o.queue||[]}),(o.queue&&o.queue.length>0||o.current&&Object.keys(o.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),I("http://localhost:5006/api/bridge/logs").then(o=>o?o.json():null).then(o=>{var _,u;if(o&&o.success&&o.logs){le(o.logs);const f=[...o.logs].reverse().find(M=>M.includes("URL_PREVIEW="));if(f){let M=(_=f.split("URL_PREVIEW=")[1])==null?void 0:_.trim();M&&typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"&&(M=M.replace(/localhost|127\.0\.0\.1/,window.location.hostname)),M&&M!==E.current&&(E.current=M,Se(M),_t(M),S(!0))}const P=[...o.logs].reverse().find(M=>M.includes("PIPELINE COMPLET TERMINÉ avec succès pour "));if(P){const M=(u=P.split("PIPELINE COMPLET TERMINÉ avec succès pour ")[1])==null?void 0:u.replace(/[.\s]+$/,"");M&&D!==M&&(Pe(M),S(!0))}}}).catch(()=>{}),I("http://localhost:5006/api/bridge/autonomous-status").then(o=>o?o.json():null).then(o=>{if(o&&o.success&&(o.data||o.status)){const u=(o.data||o.status).state;u==="diagnosing"||u==="repair_required"||u==="error"?g("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(u)||["starting_server","launch_requested","restarting"].includes(u)?g("working"):u==="ready"?g("clean"):D&&I(`http://localhost:5006/api/suture/status?project=${D}`).then(f=>f?f.json():null).then(f=>{f&&f.success&&f.status&&g(f.status)}).catch(()=>{})}}).catch(()=>{})};s();const a=setInterval(s,2e3);return()=>clearInterval(a)},[A,D]);const ut=s=>{Pe(s),tt(null),ct(""),i(!1),ye(!1),S(!1),I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:s,open_explorer:!1})}).then(async a=>{if(a&&a.ok){const o=await a.json().catch(()=>null);o!=null&&o.previewUrl&&(Se(o.previewUrl),_t(o.previewUrl))}}).catch(a=>console.error("Erreur de lancement preview:",a)),I(`http://localhost:5006/api/fs/tree?project=${encodeURIComponent(s)}`).then(a=>a?a.json():null).then(a=>{if(a&&a.success&&a.tree){Ot(a.tree);const o=u=>{if(!u)return null;if(u.type==="file"&&(u.path==="src/App.tsx"||u.path==="src/App.jsx"||u.name==="App.tsx"||u.name==="index.html"))return u.path;if(u.children&&Array.isArray(u.children))for(const f of u.children){const P=o(f);if(P)return P}return null},_=o(a.tree);_&&tt(_)}}).catch(a=>console.error("Erreur chargement arborescence:",a))},Me=s=>{const a=typeof s=="string"?s:v;if(!a.trim())return;const o={id:Date.now().toString(),role:"user",content:a};C(u=>[...u,o]);const _=a.toLowerCase();setTimeout(()=>{let u={id:(Date.now()+1).toString(),role:"assistant",content:""};const f=_.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(f==="mes projets"||f.includes("liste des projet")||f==="projet"||f==="projets")u.content="Voici la liste de vos projets récents :",u.widget="projects";else if((f.includes("stitch")||f.includes("deepseek")||f.includes("design")||f.includes("logique"))&&(f.includes("modifi")||f.includes("ajoute")||f.includes("change")||f.includes("mise a jour")||f.includes("evolue")||f.includes("reprends")||f.includes("continue"))){const P=a.match(/\[(.*?)\]/),M=P?P[1]:null,ee=f.includes("deepseek")?"deepseek":"stitch";u.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${ee.toUpperCase()}) 🔄

J'injecte vos nouvelles directives directement dans votre interface... ${M?`
🔍 Recherche et AutoSwitch vers le projet : "${M}"`:"Reprise du travail en cours."}`,u.widget=null,I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:ee,target_project:M,prompt:"Mise à jour (Reprise de projet) : "+a.replace(/\[.*?\]/,"").trim(),auto_submit:!0})}).catch(J=>console.log("Erreur de connexion au Bridge local pour l'injection",J))}else if(f.includes("cree")||f.includes("lance")||f.includes("projet")||f.includes("generation")){u.content=`🚀 DÉMARRAGE PARALLÈLE KIROV5 🚀
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,u.widget="phases",q(1);const P=D||(ce.trim()?ce.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+a.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(Pe(P),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",P),typeof window<"u"){const J=localStorage.getItem("tiger_targetAi")||"deepseek",X=localStorage.getItem("tiger_targetUiAi")||"stitch",Le=(B,ue=!1)=>mt(B,ue),He=window.AndroidBridge;if(He&&He.openAIWithPrompt)He.openAIWithPrompt(Le(X,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+a),He.showToast&&He.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const B=j&&j.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${j.length})]
`+j.map(we=>{const oe=Ht.find(_e=>_e.id===we);return`• ${oe?oe.name:we} (#${we})`}).join(`
`):"",ue="Génère l'interface UI/UX complète et moderne pour ce projet : "+a+B;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ue)}catch{}const rt=()=>I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:X,prompt:ue,auto_submit:!0,project_id:P,phase_num:1,packs:j})});Xe!==200&&(Be?window.open(Le(X,!0),"kirov5_ai_target"):window.open(Le(X,!0),"_blank"),rt().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(we=>console.error("Erreur sendUiPrompt",we))),setTimeout(()=>{const we=j&&j.length>0?a+B:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+a+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(we)}catch{}window.open(Le(J),"_blank"),I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,prompt:we,auto_submit:!0,project_id:P,phase_num:1,packs:j})}).catch(oe=>console.log("Erreur Bridge Logic Prompt:",oe)),j&&j.length>0?I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,user_prompt:we,packs:j,target_project:P})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(oe=>{console.log("Erreur Trombone Bridge:",oe)}):I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,prompt:we,auto_submit:!0,project_id:P,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}q(1);let M=1;const ee=setInterval(()=>{M++,M>11?clearInterval(ee):q(M)},1500)}else if(f.includes("youtube")||f.includes("video"))u.content="Voici les résultats YouTube pour votre recherche :",u.widget="youtube";else if(f.includes("actualite")||f.includes("ia")||f.includes("news")||f.includes("recherche")){const P=localStorage.getItem("tiger_apiKey");u.content="Actualités & Dernières Innovations IA :",u.widget="news",Dt(P||void 0)}else if(f.includes("parametre")||f.includes("reglage")||f.includes("configuration")||f.includes("setting"))u.content="Ouverture du panneau de configuration système :",u.widget="settings";else if(f.includes("[plugin:vite:")||f.includes("missing semicolon")||f.includes("syntaxerror")||f.includes("typescriptparsermixin")||f.includes("babel/parser")||f.includes("error")&&f.length>80){const P=D||"Projet_blog_8831";u.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${P}" avec la stack trace fournie... 🩺`,Oe("suture",a)}else if(u.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const P=window.AndroidBridge;P&&P.openAIWithPrompt?P.openAIWithPrompt("https://chat.deepseek.com/",a):window.open("https://chat.deepseek.com/","_blank")}C(P=>[...P,u])},600),y("")},Ye=async s=>{var He;let a=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],o=null;const _=a.filter(B=>B.name.endsWith(".zip"));let u=[];if(_.length>0){C(B=>[...B,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const B=(await en(async()=>{const{default:ue}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:ue}},[])).default;for(const ue of _){o=ue;const we=await new B().loadAsync(ue);for(const[oe,_e]of Object.entries(we.files))if(!_e.dir&&!oe.includes("__MACOSX")&&!((He=oe.split("/").pop())!=null&&He.startsWith("."))){const qe=await _e.async("blob"),pt=new File([qe],oe.split("/").pop()||oe,{type:qe.type});u.push(pt)}}}catch(B){console.error("Erreur décompression ZIP:",B),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}for(const B of _)try{const ue=await B.arrayBuffer(),rt=arrayBufferToBase64(ue);fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:D||G||ce||"AUDIO",fileName:B.name,fileBase64:rt})}).catch(oe=>console.warn("[Upload ZIP Sync] Notice:",oe))}catch{}}a=[...a.filter(B=>!B.name.endsWith(".zip")),...u];const f=a.filter(B=>B.name.endsWith(".html")),P=a.filter(B=>!B.name.endsWith(".html")&&(B.name.endsWith(".png")||B.name.endsWith(".jpg")||B.name.endsWith(".jpeg")||B.name.endsWith(".md")||B.name.endsWith(".json")||B.name.endsWith(".txt")||B.name.endsWith(".tsx")||B.name.endsWith(".ts")||B.name.endsWith(".jsx")||B.name.endsWith(".js")||B.name.endsWith(".css")||B.name.endsWith(".svg")));if(f.length===0&&P.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .tsx, .ts, .png, ou un .zip.");return}let M=[...nt];for(const B of P){const ue=B.name.endsWith(".png")||B.name.endsWith(".jpg")||B.name.endsWith(".jpeg"),rt=await new Promise(oe=>{const _e=new FileReader;_e.onload=qe=>{var pt;return oe((pt=qe.target)==null?void 0:pt.result)},ue?_e.readAsDataURL(B):_e.readAsText(B)}),we={path:B.name,content:ue?`[Image jointe visuellement : ${B.name} (Binaire ignoré pour économie de tokens)]`:rt};M.some(oe=>oe.path===B.name)||M.push(we),C(oe=>[...oe,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${B.name}`}])}if(f.length>0){const B=f[0],ue=await new Promise(oe=>{const _e=new FileReader;_e.onload=qe=>{var pt;return oe((pt=qe.target)==null?void 0:pt.result)},_e.readAsText(B)}),rt={path:B.name,content:ue};M.some(oe=>oe.path===B.name)||M.push(rt);const we={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${B.name}
Analyse de la structure UI et assemblage du contexte en cours...`};C(oe=>[...oe,we])}const ee=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter(B=>B.name.endsWith(".zip"));for(const B of ee)M.some(ue=>ue.path===B.name)||M.push({path:B.name,content:"ZIP_ARCHIVE_DUMMY"});Pt(M);const J=D||ce||"Projet_Stitch",X=a.map(B=>B.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${J}: ${X}`);const Le=f.length;if(Le>3){const B=localStorage.getItem("tiger_targetAi")||"deepseek",ue=o?"Projet_ZIP_"+o.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),rt=D||ue;D||Pe(rt),C(oe=>[...oe,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !

Hermes a détecté ${Le} pages HTML dans votre ZIP.
Découpage automatique en lots de 3 fichiers en cours...
Démarrage de l'automatisation séquentielle via DeepSeek !`,widget:"phases"}]),q(1);let we="";if(o)we=await new Promise(oe=>{const _e=new FileReader;_e.onload=qe=>{var pt;return oe(((pt=qe.target)==null?void 0:pt.result).split(",")[1])},_e.readAsDataURL(o)});else{const oe=(await en(async()=>{const{default:qe}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:qe}},[])).default,_e=new oe;for(const qe of a)_e.file(qe.name,qe);we=await _e.generateAsync({type:"base64"})}I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({zip_base64:we,zip_mode:!0,target_ai:B,target_project:rt,user_prompt:ce.trim()?`${ce} - ${ft}`:`Application multi-pages issue de ${(o==null?void 0:o.name)||"fichiers_locaux"}`})}).then(async oe=>{const _e=await oe.json();_e.success?(C(qe=>[...qe,{id:Date.now().toString()+"_hermes",role:"assistant",content:`✅ ${_e.message}

📡 Lot 1/${_e.total_batches} transmis à DeepSeek. Les lots suivants s'enchaîneront automatiquement !
Fichiers détectés : ${(_e.files_detected||[]).join(", ")}`}]),window.open(mt(B),"_blank")):alert("Erreur Hermes : "+(_e.error||"Inconnue"))}).catch(oe=>{alert(`Erreur de connexion au Moteur Local : ${oe.message}`)});return}if(f.length>0){if(document.getElementById("creation-mode-container"))return;setTimeout(()=>{Ct(M)},1200)}},Ct=async(s=nt)=>{Ee(!1);const a=s.find(J=>J.path.endsWith(".html"));if(!a){alert("Aucun fichier HTML trouvé dans le Trombone !");return}const o=ce.trim()?"Projet_"+ce.replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4):"Design_"+a.path.replace(".html","").replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4),_=D||o;if(!D){Pe(_);try{await I("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:_,file:"README.md",content:`# ${ce||_}

Initialisé par Tiger IA V0 (Design-First).`})})}catch(J){console.error("[IDE] Erreur création auto du dossier",J)}}const u=s.filter(J=>J.path!==a.path),f=a.content,P={id:(Date.now()+1).toString(),role:"assistant",content:`Mode "Design-First" activé. 🎨

Transmission du design au LLM avec les ${u.length} fichiers du Trombone intégrés.
Câblage en cours...`,widget:"phases"};q(5),C(J=>[...J,P]);let M=5;const ee=setInterval(()=>{M++,M>11?clearInterval(ee):q(M)},3e3);if(typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Mode Design-First Activé !"),typeof window<"u"){const J=localStorage.getItem("tiger_targetAi")||"deepseek";let X="";u.length>0&&(X=`

--- Fichiers de contexte complémentaires (Trombone) ---
`,u.forEach(ue=>{X+=`
[Fichier: ${ue.path}]
\`\`\`
${ue.content.substring(0,3e3)}
\`\`\`
`}));let Le="";(ce.trim()||Ke.trim()||ft.trim())&&(Le=`
--- MÉTADONNÉES DU PROJET ---
Nom : ${ce||"Non spécifié"}
Stack / Structure : ${Ke||"Non spécifiée"}
Description & Objectifs : ${ft||"Non spécifiés"}
-----------------------------
`);const He=`Voici le code HTML/CSS d'une interface générée par Stitch.${Le}
...
\`\`\`
`,B=window.AndroidBridge;if(B&&B.openAIWithPrompt){const ue=mt(J);B.openAIWithPrompt(ue,He),B.showToast&&B.showToast("HTML injecté. Câblage sur "+J.toUpperCase()+" !")}else I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,prompt:He,auto_submit:!0,project_id:_,phase_num:5})}).then(ue=>console.log("[Bridge] Prompt HTML + Contexte envoyé avec succès, status:",ue.status)).catch(ue=>console.error("[Bridge] Erreur lors de l'envoi du prompt:",ue))}},Ue=(s,a=0)=>s?s.type==="directory"?e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-2 px-2 py-1 hover:bg-white/5 cursor-pointer text-gray-300 text-sm",style:{paddingLeft:`${a*12+8}px`},children:[e.jsx("span",{className:"text-orange-400",children:"📁"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-dossier truncate font-bold",children:s.name})]}),s.children&&s.children.map(o=>Ue(o,a+1))]},s.path):e.jsxs("div",{className:`flex items-center justify-between px-2 py-1 hover:bg-white/10 cursor-pointer text-sm group ${xe===s.path?"bg-cyan/20 text-cyan border-l-2 border-cyan":"text-gray-400"}`,style:{paddingLeft:`${a*12+8}px`},onClick:()=>tt(s.path),children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-blue-400",children:"📄"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-fichier truncate",children:s.name})]}),e.jsxs("div",{className:"hidden group-hover:flex items-center gap-1",children:[e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-red-500/50 transition-colors",title:"Suture : Réparer ou débugger ce fichier",onClick:o=>{o.stopPropagation(),tt(s.path),setTimeout(()=>Oe("suture","Veuillez analyser ce fichier et corriger toutes les erreurs, fautes de frappe ou imports manquants."),100)},children:"🩺"}),e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-cyan/50 transition-colors",title:"Ajouter au Trombone",onClick:o=>{o.stopPropagation(),T(s.path)},children:"📎"})]})]},s.path):null,Oe=async(s,a)=>{if(!D){alert("⚠️ Veuillez sélectionner un projet actif dans l'explorateur.");return}const o=localStorage.getItem("tiger_targetAi")||"deepseek";let _="";s==="suture"?_=`🩺 SUTURE CHIRURGICALE — CORRECTION D'ERREUR DÉTECTÉE
...
`):s==="refactor"?_=`🔄 REFACTORING — Refactorise le code du projet [${D}] pour une qualité industrielle.

`:s==="improve"&&(_=`✨ AMÉLIORATION — Ajoute des animations et améliorations UI pour le projet [${D}].

`),xe&&Ft&&(_+=`--- Fichier Actif en Édition : ${xe} ---
\`\`\`
${Ft}
\`\`\`

`),nt.length>0&&(_+=`--- Fichiers de contexte du Trombone ---

`,nt.forEach(u=>{_+=`--- ${u.path} ---
\`\`\`
${u.content}
\`\`\`
...
{
  "files": [
    { "path": "${xe||"src/App.tsx"}", "content": "..." }
  ]
}
\`\`\``,C(u=>[...u,{id:Date.now().toString()+"_action",role:"assistant",content:`🩺 Suture & Correction déclenchée pour "${D}". Transmission de l'erreur à ${o.toUpperCase()} en cours...`}]);try{if(await I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:o,prompt:_,auto_submit:!0,project_id:D,phase_num:s})}),s==="suture"){I("http://localhost:5006/v1/suture/start",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:D,activeFile:xe||"",rawError:a||"",prompt:a||"Analyse et corrige les erreurs du projet."})}).then(async f=>{const P=await f.json();P.success&&P.status==="applied"?C(M=>{var ee,J;return[...M,{id:Date.now().toString()+"_suture_ok",role:"assistant",content:`✅ Suture V2 réussie !

🔧 ${P.repairId}
🚀 Statut : **Patch appliqué en production**
📁 Fichiers corrigés : ${JSON.stringify(((J=(ee=P.patchReport)==null?void 0:ee.files)==null?void 0:J.map(X=>X.path))||[])}`}]}):P.success?C(M=>{var ee;return[...M,{id:Date.now().toString()+"_suture_partial",role:"assistant",content:`⚠️ Suture V2 : correctif généré mais non promu.
Statut : ${((ee=P.validationReport)==null?void 0:ee.code)||P.status}

Le correctif est dans l'espace isolé. Vérifiez les logs du moteur pour plus de détails.`}]}):C(M=>[...M,{id:Date.now().toString()+"_suture_fail",role:"assistant",content:`❌ Suture V2 échouée.
Code : ${P.code||"INCONNU"}
${P.message||""}`}])}).catch(()=>{C(f=>[...f,{id:Date.now().toString()+"_suture_err",role:"assistant",content:"❌ Impossible de joindre le moteur Suture V2. Vérifiez que l'Orchestrateur Electron tourne sur le port 5006."}])});return}window.open(mt(o),"kirov5_ai_target")||C(f=>[...f,{id:Date.now().toString()+"_popup_blocked",role:"assistant",content:`⚠️ Popup bloqué par le navigateur !

L'onglet ${o.toUpperCase()} n'a pas pu s'ouvrir.

**Solution** : Autorisez les popups pour ce site ou ouvrez manuellement : ${mt(o)}

Le prompt est en queue (90s) — dès que l'onglet ${o.toUpperCase()} sera ouvert avec l'extension active, il sera injecté automatiquement.`}])}catch(u){console.error("[IDE] Erreur Suture:",u),alert(`🩺 Action ${s} transmise. Assurez-vous que le Moteur Electron tourne sur port 5006.`)}},et=()=>ln?e.jsxs("div",{className:"w-full p-8 flex flex-col items-center justify-center gap-4 animate-fadeIn",children:[e.jsx("div",{className:"w-12 h-12 border-4 border-cyan/20 border-t-cyan rounded-full animate-spin"}),e.jsx("div",{className:"text-cyan font-bold animate-pulse text-sm",children:"Interrogation de l'API DeepSeek en cours..."})]}):bt?e.jsxs("div",{className:"w-full max-w-3xl backdrop-blur-xl rounded-3xl p-6 md:p-8 border border-white/20 shadow-[0_10px_40px_rgba(0,0,0,0.5)] mt-4 relative animate-fadeIn",style:{background:A?c("news-detail",.9):"rgba(0,0,0,0.9)"},children:[e.jsx("button",{onClick:()=>At(null),className:"absolute top-6 right-6 w-8 h-8 bg-white/10 hover:bg-red-500 rounded-full flex flex-col items-center justify-center text-white font-bold transition-colors z-20",title:"Fermer",children:"✕"}),e.jsx("span",{className:"px-3 py-1 bg-cyan/20 text-cyan text-xs font-bold rounded-md mb-4 inline-block",children:bt.tag}),e.jsx("h2",{className:"text-2xl md:text-4xl font-black text-white mb-4 leading-tight",children:bt.title}),e.jsx("p",{className:"text-gray-300 font-medium text-sm md:text-base mb-6 leading-relaxed border-l-4 border-cyan/50 pl-4",children:bt.desc}),e.jsx("div",{className:"w-full h-px bg-white/10 mb-6"}),e.jsx("div",{className:"text-gray-200 text-sm md:text-base leading-loose whitespace-pre-line",children:bt.content}),e.jsxs("div",{className:"mt-8 pt-6 border-t border-white/10 flex justify-between items-center",children:[e.jsx("span",{className:"text-xs text-cyan font-mono font-bold tracking-widest",children:"GÉNÉRÉ PAR DEEPSEEK API"}),e.jsx("button",{onClick:()=>At(null),className:"px-6 py-3 bg-white/5 hover:bg-white/20 text-white font-bold rounded-xl transition-all border border-white/10 hover:border-cyan",children:"← Retour à la liste"})]})]}):!Nt||Nt.length===0?null:e.jsx($t,{items:Nt.map(s=>e.jsxs("div",{className:"design-carte-carrousel relative rounded-2xl p-5 border border-white/10 backdrop-blur-md flex flex-col hover:border-cyan/50 transition-colors shadow-lg",style:{background:A?c("news-"+s.id,.7):"rgba(0,0,0,0.7)"},children:[e.jsx("span",{className:"self-start px-2 py-1 bg-cyan/20 text-cyan text-xs font-bold rounded-md mb-3 pr-4",children:s.tag}),e.jsx("h3",{className:"design-carte-titre text-lg font-bold text-white mb-2 leading-tight mt-1",children:s.title}),e.jsx("p",{className:"design-carte-desc text-gray-400 text-sm flex-1",children:s.desc}),e.jsxs("button",{onClick:()=>At(s),className:"absolute top-4 right-4 text-cyan text-xs font-bold hover:underline cursor-pointer px-3 py-1.5 bg-cyan/10 hover:bg-cyan/20 rounded-xl border border-cyan/30 transition-all flex items-center gap-1",children:["Lire l'article ",e.jsx("span",{className:"text-[10px]",children:"↗"})]})]},s.id))}),Gt=()=>{const s=[{title:"Créer une IA Souveraine",channel:"Tiger Channel",views:"1.2k"},{title:"React Tailwind Masterclass",channel:"UI Design",views:"5.4k"},{title:"Android Bridge Capacitor",channel:"Mobile Dev",views:"800"}];return e.jsx($t,{items:s.map((a,o)=>e.jsxs("div",{className:"design-carte-carrousel rounded-2xl overflow-hidden border border-red-500/30 hover:border-red-500 transition-colors shadow-lg flex flex-col",style:{background:A?c("yt-"+o,.6):"rgba(0,0,0,0.6)"},children:[e.jsxs("div",{className:"flex-1 bg-gray-800 relative flex items-center justify-center min-h-[50%]",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-tr from-red-900/40 to-transparent"}),e.jsx("div",{className:"w-12 h-12 bg-red-600 rounded-full flex items-center justify-center shadow-lg z-10 cursor-pointer hover:scale-110 transition-transform",children:e.jsx("div",{className:"w-0 h-0 border-t-[8px] border-t-transparent border-l-[14px] border-l-white border-b-[8px] border-b-transparent ml-1"})})]}),e.jsxs("div",{className:"p-4",children:[e.jsx("h3",{className:"text-white font-bold text-sm leading-tight mb-1",children:a.title}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-400 mt-2",children:[e.jsx("span",{children:a.channel}),e.jsxs("span",{children:[a.views," vues"]})]})]})]},o))})},xs=()=>{const s=["Setup","Index","React","CSS","Utils","Vite","Tests","Package","Vérif","Bridge","Build"];return e.jsx("div",{className:"mt-2",children:e.jsx($t,{items:s.map((a,o)=>{const _=o+1,u=_<b,f=_===b;let P="bg-glass border-white/10 opacity-50";return u&&(P="bg-gradient-to-br from-green-900/60 to-emerald-900/60 border-green-500/50 text-green-100 shadow-[0_0_15px_rgba(34,197,94,0.2)]"),f&&(P="bg-gradient-to-br from-cyan/20 to-blue-900/40 border-cyan text-white shadow-[0_0_20px_rgba(8,179,201,0.5)] animate-pulse hover:scale-105 cursor-pointer"),e.jsxs("div",{onClick:()=>{if(a==="Build"||f||u){const M=localStorage.getItem("tiger_lastGeneratedProject");M&&Pe(M)}},className:`design-carte-carrousel rounded-2xl p-4 border flex flex-col justify-between transition-all duration-500 ${P}`,title:a==="Build"?"Cliquez pour ouvrir l'IDE sur le projet généré":"",children:[e.jsx("div",{className:"text-3xl font-black opacity-20",children:_.toString().padStart(2,"0")}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-bold text-lg mb-1",children:a}),e.jsx("div",{className:"text-xs opacity-70",children:u?"✓ Terminé":f?"En cours...":"En attente"})]}),f&&e.jsx("div",{className:"w-full h-1 bg-white/20 rounded-full mt-2 overflow-hidden",children:e.jsx("div",{className:"h-full bg-cyan w-1/2 animate-ping rounded-full"})}),a==="Build"&&e.jsxs("div",{className:"mt-2 text-[10px] text-cyan font-bold uppercase tracking-widest flex items-center gap-1 bg-black/40 px-2 py-1 rounded",children:[e.jsx("span",{children:"🚀"})," Ouvrir IDE"]})]},o)})})})},fs=Ne!=="random"?((qn=Ge.find(s=>s.name===Ne))==null?void 0:qn.colors["bg-app"])||"radial-gradient(ellipse at 50% 20%, #1e1b4b 0%, #090a0f 70%, #000000 100%)":void 0;return e.jsxs("div",{className:"design-app-root flex-1 w-full h-full flex flex-col overflow-hidden relative transition-all duration-700",style:{background:fs},children:[e.jsx("div",{className:"absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-pink/20 blur-[120px] rounded-full pointer-events-none"}),e.jsx("div",{className:"absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-cyan/10 blur-[150px] rounded-full pointer-events-none"}),Z&&e.jsx("div",{className:"absolute inset-0 z-[100] flex items-center justify-center p-4 backdrop-blur-md",style:{background:A?c("modal",.6):"rgba(0,0,0,0.6)"},onClick:s=>{s.target===s.currentTarget&&O(!1)},children:e.jsx(Jn,{isModal:!0,onClose:()=>O(!1),initialTab:K,isClient:A,getCachedGradient:c,mouchardLogs:ne,activePhase:b,availableProjects:re,setAvailableProjects:ge,selectedLaunchProject:G,setSelectedLaunchProject:V,isMobileNative:W,isAutoPilot:Ut,setIsAutoPilot:Ve,reuseActiveTab:Be,setReuseActiveTab:Ae,selectedStartPhase:Xe,setSelectedStartPhase:dn,selectedPacks:j})}),!h&&e.jsx("div",{className:"w-full flex justify-center items-center pt-2 z-20 relative pointer-events-none",children:e.jsxs("div",{className:"flex items-center gap-2 overflow-x-auto hide-scrollbar text-[10px] font-bold bg-[#05080c]/80 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/10 shadow-lg pointer-events-auto",children:[e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-green-900/40 px-2.5 py-1 rounded-full border border-green-500/30",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-green-500 shadow-[0_0_8px_#22c55e]"}),e.jsx("span",{className:"text-green-400",children:"Online"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-orange-900/40 px-2.5 py-1 rounded-full border border-orange-500/30",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-orange-500 shadow-[0_0_8px_#f97316] animate-bounce"}),e.jsx("span",{className:"text-orange-400",children:"Ext: Tiger"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-purple-900/40 px-2.5 py-1 rounded-full border border-purple-500/30",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-purple-500 shadow-[0_0_8px_#a855f7]"}),e.jsx("span",{className:"text-purple-400",children:"LLM: DeepSeek"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-cyan/10 px-2.5 py-1 rounded-full border border-cyan/20",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-cyan shadow-[0_0_8px_#08b3c9] animate-pulse"}),e.jsx("span",{className:"text-cyan",children:"Electron"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-gray-500/10 px-2.5 py-1 rounded-full border border-gray-500/20 opacity-60",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-gray-500"}),e.jsx("span",{className:"text-gray-400",children:"Mobile (Capacitor)"})]}),m&&e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-amber-500/20 px-2.5 py-1 rounded-full border border-amber-500/40 shadow-[0_0_12px_rgba(245,158,11,0.35)] animate-pulse",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-amber-400 shadow-[0_0_8px_#f59e0b]"}),e.jsx("span",{className:"text-amber-300 font-bold",children:"👑 Super-Admin"})]}),e.jsxs("button",{onClick:x,className:"flex items-center gap-1.5 shrink-0 bg-red-950/60 hover:bg-red-600/70 px-3 py-1 rounded-full border border-red-500/40 text-red-300 hover:text-white transition-all cursor-pointer shadow-[0_0_10px_rgba(239,68,68,0.25)] hover:scale-105 active:scale-95 ml-1",title:"Se déconnecter de l'application",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-red-500 shadow-[0_0_6px_#ef4444]"}),e.jsx("span",{children:"Déconnexion"}),d&&e.jsxs("span",{className:"text-gray-300 font-normal text-[9px] max-w-[130px] truncate ml-0.5",children:["(",d,")"]})]})]})}),!h&&e.jsxs("header",{className:"design-header backdrop-blur-md z-10 flex justify-between items-center shadow-lg -mt-2 px-4",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"design-logo flex items-center justify-center",children:e.jsx("span",{children:"🐯"})}),e.jsx("div",{children:e.jsx("h1",{className:"design-titre whitespace-nowrap",children:"v0.reponse : OS Souverain v0.1.0 - idecode-2026"})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[d&&e.jsxs("div",{className:"flex items-center gap-2 bg-white/5 border border-white/10 px-3 py-1.5 rounded-xl text-xs backdrop-blur-sm shadow-inner",children:[e.jsxs("span",{className:"text-gray-300 font-medium",children:["👤 ",d]}),m&&e.jsx("span",{className:"bg-amber-500/20 text-amber-300 border border-amber-500/40 px-2 py-0.5 rounded-full font-bold text-[10px] tracking-wide animate-pulse",children:"👑 Super-Admin"})]}),e.jsxs("button",{onClick:x,className:"flex items-center gap-1.5 bg-red-500/20 hover:bg-red-500/40 text-red-300 border border-red-500/40 px-3 py-1.5 rounded-xl text-xs font-semibold transition-all hover:scale-105 active:scale-95 shadow-sm cursor-pointer",title:"Se déconnecter de l'application",children:[e.jsx("span",{children:"🚪"}),e.jsx("span",{children:"Déconnexion"})]})]})]}),e.jsxs("div",{className:"flex-1 flex flex-col lg:flex-row overflow-hidden relative z-10 w-full",children:[D&&e.jsxs("div",{className:"flex flex-col lg:flex-row flex-1 overflow-hidden h-full animate-fadeIn",children:[e.jsxs("div",{className:"design-ide-toolbar w-full h-16 lg:w-16 lg:h-full bg-black/80 border-b lg:border-b-0 lg:border-r border-white/10 flex flex-row lg:flex-col items-center justify-around lg:justify-start lg:py-4 px-2 lg:px-0 gap-2 lg:gap-6 z-20 shadow-xl overflow-x-auto lg:overflow-x-visible",children:[e.jsx("button",{title:"Fermer le projet",onClick:()=>{Pe(null),tt(null)},className:"design-ide-btn-action w-10 h-10 rounded-full bg-red-500/20 text-red-500 hover:bg-red-500 hover:text-white flex items-center justify-center transition-all mb-4",children:"✕"}),e.jsxs("button",{title:R==="error"?"🔴 Erreur détectée dans le code ! Suture V2 en cours...":R==="working"?"🟣 Suture V2 en plein travail (génération & test du correctif)...":"🟢 Projet propre - Aucune erreur détectée",onClick:()=>Oe("suture"),className:`design-ide-btn-action w-10 h-10 rounded-xl text-xl border flex items-center justify-center transition-all group relative ${R==="error"?"bg-red-600 text-white border-2 border-red-400 shadow-[0_0_25px_#ff0055] animate-pulse ring-2 ring-red-500":R==="working"?"bg-purple-600 text-white border-2 border-purple-300 shadow-[0_0_25px_#a855f7] animate-pulse ring-2 ring-purple-500":"bg-emerald-600/30 text-emerald-400 border border-emerald-500/50 shadow-[0_0_12px_rgba(16,185,129,0.4)] hover:bg-emerald-500 hover:border-emerald-400 hover:text-white"}`,children:["🩺",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-white pointer-events-none transition-opacity font-bold",children:R==="error"?"🔴 Suture (Erreur !)":R==="working"?"🟣 Suture V2...":"🟢 Suture V2 (OK)"})]}),e.jsxs("button",{title:"Immortaliser le projet (Sauvegarde)",onClick:()=>{D&&I("http://localhost:5006/api/bridge/backup",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:D})}).then(s=>s?s.json():null).then(s=>{if(!s)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");s.success?alert("📸 "+s.message+`
`+s.backupName):alert("Erreur: "+s.error)}).catch(s=>alert("Erreur réseau: "+s.message))},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-blue-500/20 text-blue-400 hover:bg-blue-500 hover:text-white text-xl border border-blue-500/30 hover:border-blue-500 flex items-center justify-center transition-all shadow-[0_0_15px_rgba(59,130,246,0.3)] hover:shadow-[0_0_25px_rgba(59,130,246,0.6)] group relative mt-2",children:["📸",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-blue-400 pointer-events-none transition-opacity font-bold",children:"Immortaliser (Sauvegarder)"})]}),e.jsxs("button",{title:"Restaurer le projet (Time Machine)",onClick:()=>{D&&I("http://localhost:5006/api/bridge/backups?project_id="+D).then(s=>s?s.json():null).then(s=>{if(!s)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");if(!s.success||!s.backups||s.backups.length===0)return alert("⏪ Aucune sauvegarde trouvée pour ce projet.");U(s.backups),je(!0)}).catch(s=>alert("Erreur réseau: "+s.message))},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-slate-500/20 text-slate-400 hover:bg-slate-500 hover:text-white text-xl border border-slate-500/30 hover:border-slate-500 flex items-center justify-center transition-all group relative mb-2",children:["⏪",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-slate-400 pointer-events-none transition-opacity font-bold",children:"Restaurer (Dernier Backup)"})]}),e.jsxs("button",{title:"Refactoring",onClick:()=>Oe("refactor"),className:"design-ide-btn-action w-10 h-10 rounded-xl bg-white/5 hover:bg-purple-500/20 text-xl border border-white/10 hover:border-purple-500 flex items-center justify-center transition-all group relative",children:["🔄",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-purple-400 pointer-events-none transition-opacity",children:"Refactoring"})]}),e.jsxs("button",{title:"Amélioration",onClick:()=>Oe("improve"),className:"design-ide-btn-action w-10 h-10 rounded-xl bg-white/5 hover:bg-yellow-500/20 text-xl border border-white/10 hover:border-yellow-500 flex items-center justify-center transition-all group relative",children:["✨",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-yellow-400 pointer-events-none transition-opacity",children:"Amélioration"})]}),e.jsxs("button",{title:"Corriger Arborescence (Fix Extensions)",onClick:()=>{D&&I("http://localhost:5006/api/fix-extensions",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:D})}).then(s=>s?s.json():null).then(s=>{if(!s)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");s.success?alert(s.message):alert("Erreur: "+s.error)}).catch(s=>alert("Erreur réseau: "+s.message))},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-white/5 hover:bg-orange-500/20 text-xl border border-white/10 hover:border-orange-500 flex items-center justify-center transition-all group relative",children:["🛠️",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-orange-400 pointer-events-none transition-opacity font-bold",children:"Fix Arborescence (.txt ➡️ .tsx)"})]}),e.jsxs("button",{title:"Générateur PRD V0-Guest",onClick:()=>{Pe("v0-guest"),Se("http://localhost:3007"),I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:"v0-guest"})}).catch(s=>console.error("Erreur lancement v0-guest:",s)),setTimeout(()=>{window.open("http://localhost:3007","_blank")},2500)},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-gradient-to-br from-cyan/20 to-purple-500/20 text-cyan hover:from-cyan hover:to-purple-500 hover:text-black text-xl border border-cyan/40 flex items-center justify-center transition-all group relative shadow-[0_0_12px_rgba(0,240,255,0.3)]",children:["🎁",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-cyan font-bold pointer-events-none transition-opacity",children:"V0-Guest PRD Generator"})]}),e.jsxs("button",{title:"Design v0 (Studio Visuel & Preview Split)",onClick:()=>{const s=!Tt;if(i(s),s&&!dt){const a=De&&JSON.stringify(De).includes("next.config");Se(a?"http://localhost:3000":"http://localhost:5175")}},className:`design-ide-btn-action w-10 h-10 rounded-xl flex items-center justify-center transition-all group relative border ${Tt?"bg-pink-500 text-white border-pink-500 shadow-[0_0_15px_rgba(236,72,153,0.5)]":"bg-white/5 hover:bg-pink-500/20 text-pink-500 border-white/10 hover:border-pink-500"}`,children:["🎨",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-pink-500 pointer-events-none transition-opacity font-bold",children:"Design v0 (Split View)"})]}),e.jsx("div",{className:"flex-1"}),e.jsxs("button",{title:h?"Réduire (Afficher le Chat)":"Pleine Page (Masquer le Chat)",onClick:()=>S(!h),className:`design-ide-btn-action w-10 h-10 rounded-xl flex items-center justify-center transition-all group relative border ${h?"bg-cyan text-black border-cyan":"bg-white/5 hover:bg-cyan/20 text-cyan border-white/10 hover:border-cyan"}`,children:[h?"🗗":"🗖",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-cyan pointer-events-none transition-opacity",children:h?"Mode Normal":"Pleine Page"})]})]}),e.jsxs("div",{className:"design-explorateur w-64 bg-[#0a0a0a]/95 border-r border-white/10 overflow-y-auto flex flex-col hide-scrollbar z-20 shadow-2xl",children:[e.jsxs("div",{className:"px-4 py-3 border-b border-white/10 sticky top-0 bg-[#0a0a0a] z-10 flex flex-col gap-2",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsxs("span",{className:"text-[10px] text-cyan font-black uppercase tracking-widest flex items-center gap-2",children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-cyan animate-pulse"}),"Projet Actif"]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{onClick:()=>{D&&(console.log("Clic Suture Manuel ! Projet:",D,"Etat actuel:",R),R!=="error"&&I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:D})}).catch(()=>{}),I("http://localhost:5006/api/suture/launch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:D})}).then(s=>s?s.json():null).then(s=>s&&console.log("Réponse Suture API:",s)).catch(s=>console.error("Erreur Suture API:",s)))},className:`text-[9px] font-bold px-2 py-0.5 rounded transition-colors border shadow-sm flex items-center gap-1 ${R==="error"?"bg-red-500/20 text-red-400 border-red-500/50 animate-pulse hover:bg-red-500/30":R==="working"?"bg-purple-500/20 text-purple-400 border-purple-500/50 hover:bg-purple-500/30":"bg-green-500/20 text-green-400 border-green-500/50 opacity-50 hover:opacity-100"}`,title:"Lancer Suture V2 manuellement",children:"sutur🩺"}),e.jsx("button",{onClick:()=>{I("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{s&&s.success&&s.projects?Y(s.projects.map(a=>({name:typeof a=="string"?a:a.name||a.project_id||a.title||"Projet",desc:"Projet local",bg:""}))):fetch("/api/projects").then(a=>a.json()).then(a=>{a.projects&&Y(a.projects.map(o=>({name:typeof o=="string"?o:o.name||o.project_id||o.title||"Projet",desc:"SaaS Cloud",bg:""})))})}).catch(()=>{})},className:"text-xs text-gray-400 hover:text-cyan p-1 transition-colors",title:"Actualiser la liste des projets",children:"🔄"})]})]}),e.jsxs("select",{value:D||"",onFocus:()=>{I("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{s&&s.success&&s.projects?Y(s.projects.map(a=>({name:typeof a=="string"?a:a.name||a.project_id||a.title||"Projet",desc:"Projet local",bg:""}))):fetch("/api/projects").then(a=>a.json()).then(a=>{a.projects&&Y(a.projects.map(o=>({name:typeof o=="string"?o:o.name||o.project_id||o.title||"Projet",desc:"SaaS Cloud",bg:""})))})}).catch(()=>{})},onChange:s=>{const a=s.target.value;a&&(Pe(a),tt(null),ct(""),I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:a,open_explorer:!1})}).catch(o=>console.error("Erreur de lancement :",o)))},className:"w-full bg-[#161616] text-cyan font-bold text-xs border border-cyan/40 rounded-xl px-2.5 py-2 outline-none focus:border-cyan focus:ring-1 focus:ring-cyan shadow-[0_0_10px_rgba(8,179,201,0.2)] cursor-pointer truncate",children:[e.jsx("option",{value:"",disabled:!0,className:"bg-black text-gray-400",children:"-- Choisir un projet --"}),he.length>0?he.map((s,a)=>{var _,u;const o=typeof(s==null?void 0:s.name)=="string"?s.name:((_=s==null?void 0:s.name)==null?void 0:_.project_id)||((u=s==null?void 0:s.name)==null?void 0:u.title)||`Projet_${a}`;return e.jsxs("option",{value:o,className:"bg-black text-white font-medium py-1",children:["📁 ",o]},o+"_"+a)}):e.jsxs("option",{value:typeof D=="string"?D:(D==null?void 0:D.project_id)||(D==null?void 0:D.title)||"AUDIO",className:"bg-black text-white py-1",children:["📁 ",typeof D=="string"?D:(D==null?void 0:D.project_id)||(D==null?void 0:D.title)||"AUDIO"]})]})]}),e.jsx("div",{className:"py-2",children:De?Ue(De):e.jsx("div",{className:"text-gray-500 text-xs px-4 py-2 animate-pulse",children:"Scan du projet..."})})]}),e.jsxs("div",{className:"design-editeur flex-1 flex flex-col bg-[#1e1e1e] z-20 shadow-2xl relative",children:[e.jsxs("div",{className:"design-editeur-onglet h-12 bg-[#252526] border-b border-black flex justify-between items-center px-4",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-blue-400 text-lg",children:xe?"📄":"📁"}),e.jsx("span",{className:"text-sm text-gray-300 font-mono",children:xe||"Aucun fichier sélectionné"})]}),e.jsxs("div",{className:"flex gap-4 items-center",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("div",{className:"text-xs text-green-400 animate-pulse font-bold flex items-center gap-2",children:[e.jsx("span",{className:"w-2 h-2 bg-green-400 rounded-full"})," SERVER:"]}),e.jsx("input",{type:"text",value:Qt,onChange:s=>_t(s.target.value),onKeyDown:s=>{s.key==="Enter"&&Se(Qt)},className:"bg-black/50 border border-green-500/30 text-green-400 text-[10px] px-2 py-1 rounded outline-none focus:border-green-400 w-40 font-mono shadow-[0_0_10px_rgba(34,197,94,0.1)] transition-all",title:"Modifier et taper Entrée"}),e.jsx("button",{onClick:()=>Se(Qt),className:"text-[10px] bg-green-500/20 text-green-400 hover:bg-green-500 hover:text-white px-2 py-1 rounded font-bold border border-green-500/30",children:"Go"})]}),e.jsx("button",{onClick:()=>se(Ft),disabled:!xe,className:`px-4 py-1.5 rounded text-xs font-bold transition-all ${xe?"bg-cyan/20 text-cyan hover:bg-cyan hover:text-black border border-cyan/30 shadow-[0_0_10px_rgba(8,179,201,0.2)]":"bg-white/5 text-gray-600 cursor-not-allowed"}`,children:"SAUVEGARDER (CTRL+S)"})]})]}),e.jsx("div",{className:"flex-1 relative flex overflow-hidden",children:Tt?e.jsxs("div",{className:"flex-1 flex w-full h-full bg-[#0a0a0a] overflow-hidden",children:[e.jsxs("div",{className:"w-1/2 h-full border-r border-white/10 flex flex-col bg-[#141414]",children:[e.jsxs("div",{className:"h-12 px-4 bg-black/90 border-b border-white/10 flex justify-between items-center shrink-0 z-10",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-xl",children:"🎨"}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-xs font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-cyan tracking-widest uppercase",children:"STUDIO DESIGN INTELLIGENT"}),e.jsxs("p",{className:"text-[10px] text-gray-400 truncate max-w-[180px]",children:["Projet : ",e.jsx("span",{className:"text-cyan font-bold",children:D||"Projet Actif"})]})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{onClick:()=>i(!1),className:"px-2.5 py-1 bg-white/10 hover:bg-white/20 text-white rounded-lg border border-white/10 text-[11px] font-bold flex items-center gap-1 transition-all shadow",title:"Revenir à l'explorateur de fichiers & à l'éditeur de code",children:"📁 Fermer (Code)"}),e.jsx("button",{onClick:()=>{i(!1),Pe(null),S(!1)},className:"px-2.5 py-1 bg-red-500/20 hover:bg-red-500 text-red-300 hover:text-white rounded-lg border border-red-500/30 text-[11px] font-bold flex items-center gap-1 transition-all shadow",title:"Quitter le projet et revenir à la page d'accueil",children:"🏠 Fermer (Accueil)"})]})]}),e.jsx("div",{className:"flex-1 overflow-hidden relative",children:e.jsx("iframe",{src:`/admin-design.html?project=${D}`,className:"w-full h-full border-0 bg-black",title:"Studio Admin Design"})})]}),e.jsxs("div",{className:"design-preview w-1/2 h-full flex flex-col",children:[e.jsxs("div",{className:"h-12 px-4 bg-black/90 border-b border-white/10 flex justify-between items-center shrink-0 z-10",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"w-2.5 h-2.5 rounded-full bg-green-400 animate-pulse"}),e.jsxs("span",{className:"text-xs font-mono font-bold text-green-400",children:["LIVE PREVIEW (",De&&JSON.stringify(De).includes("next.config")?"LOCALHOST:3000":typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"?`${window.location.hostname}:5173`:"LOCALHOST:5173",")"]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("input",{type:"text",value:dt||(De&&JSON.stringify(De).includes("next.config")?"http://localhost:3000":typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"?`http://${window.location.hostname}:5173`:"http://localhost:5173"),onChange:s=>_t(s.target.value),onKeyDown:s=>{s.key==="Enter"&&Se(Qt)},className:"bg-black/80 border border-green-500/30 text-green-400 text-[11px] px-2.5 py-1 rounded outline-none focus:border-green-400 w-48 font-mono"}),e.jsx("button",{onClick:()=>{D&&I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:D,open_explorer:!1})}).catch(s=>console.error("Erreur lancement preview:",s))},className:"px-2.5 py-1 bg-green-500/20 text-green-400 hover:bg-green-500 hover:text-white text-[11px] rounded font-bold border border-green-500/30 transition-all flex items-center gap-1",title:"Relancer / Démarrer le serveur Preview",children:"🚀 Relancer"})]})]}),e.jsx("div",{className:"flex-1 relative overflow-hidden",style:{background:"var(--preview-bg)"},children:e.jsx("iframe",{src:dt||(De&&JSON.stringify(De).includes("next.config")?"http://localhost:3000":typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"?`http://${window.location.hostname}:5173`:"http://localhost:5173"),className:"w-full h-full border-none",title:"Application Preview Live"})})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`relative flex flex-col ${dt?"w-1/2 border-r border-black":"w-full"}`,children:xe?e.jsx(ja,{height:"100%",theme:"vs-dark",path:xe,language:xe.endsWith(".tsx")||xe.endsWith(".ts")?"typescript":xe.endsWith(".css")?"css":xe.endsWith(".html")?"html":xe.endsWith(".json")?"json":"javascript",value:Ft,onChange:s=>{const a=s||"";ct(a),window.saveTimer&&clearTimeout(window.saveTimer),window.saveTimer=setTimeout(()=>{se(a)},500)},options:{minimap:{enabled:!1},fontSize:14,wordWrap:"on",padding:{top:16}}}):e.jsxs("div",{className:"absolute inset-0 flex flex-col items-center justify-center text-gray-600 gap-4",children:[e.jsx("span",{className:"text-6xl opacity-20",children:"🐯"}),e.jsx("span",{className:"font-medium tracking-wide text-sm",children:"Sélectionnez un fichier dans l'explorateur ou activez Design v0"})]})}),dt&&e.jsxs("div",{className:"design-preview w-1/2 relative",style:{background:"var(--preview-bg)"},children:[e.jsx("iframe",{src:dt,className:"w-full h-full border-none"}),e.jsx("button",{onClick:()=>Se(null),className:"absolute top-2 right-4 bg-black/80 border border-white/20 text-white rounded-full w-8 h-8 flex items-center justify-center hover:bg-red-500 hover:text-white transition-all shadow-lg z-50",title:"Fermer la Preview",children:"✕"}),e.jsx("button",{onClick:()=>window.open(dt,"_blank"),className:"absolute top-2 right-14 bg-black/80 border border-white/20 text-white rounded-full px-3 h-8 flex items-center justify-center hover:bg-cyan hover:text-black transition-all shadow-lg z-50 text-xs font-bold",title:"Ouvrir dans un nouvel onglet",children:"↗ Ouvrir"})]})]})})]})]}),e.jsxs("main",{className:`design-chat-main ${D?h?"hidden w-0":"w-full h-[50vh] lg:h-full lg:w-96 lg:min-w-[24rem]":"flex-1"} border-t lg:border-t-0 lg:border-l border-white/20 bg-black/60 shadow-[-20px_0_40px_rgba(0,0,0,0.5)] overflow-y-auto p-4 md:p-8 z-10 hide-scrollbar flex flex-col transition-all duration-500 ease-in-out`,onDragOver:s=>{s.preventDefault(),N(!0)},onDragLeave:()=>N(!1),onDrop:s=>{s.preventDefault(),N(!1),s.dataTransfer.files&&s.dataTransfer.files.length>0&&Ye(s.dataTransfer.files)},children:[w&&e.jsx("div",{className:"absolute inset-0 z-50 bg-cyan/20 backdrop-blur-sm border-4 border-dashed border-cyan rounded-3xl m-4 flex items-center justify-center pointer-events-none",children:e.jsxs("h2",{className:"text-3xl font-black text-cyan drop-shadow-lg text-center px-4",children:["Glissez votre projet Stitch (.zip, .html, .md, .png)",e.jsx("br",{}),"pour préparer le câblage !"]})}),e.jsxs("div",{className:"design-chat-layout w-full flex-1 flex flex-col justify-center my-auto pb-[140px] relative",children:[(()=>{const s=p.map(u=>!!u.widget).lastIndexOf(!0),a=s!==-1?p[s]:null,o=a?a.widget:null,_=ae||o==="packs"||o==="projects"||o==="news"||o==="youtube"||Je||Qe;return e.jsxs("div",{className:"w-full flex flex-col xl:flex-row items-stretch justify-between gap-6 relative min-h-[50vh] my-auto",children:[e.jsx(Vo,{messages:p,showGuestPacks:fe,setShowGuestPacks:Ie,guestPacksCount:4,guestPackSearchQuery:be,setGuestPackSearchQuery:ie}),_&&e.jsxs("div",{className:"flex-1 w-full flex flex-col items-center justify-center my-auto z-20",children:[!Je&&!Qe&&(ae||o==="packs")&&!D&&e.jsx(Bo,{selectedPacks:j,togglePack:qt,newProjectName:ce,setNewProjectName:xt,setActiveProject:Pe,handleSend:Me,isClient:A,getCachedGradient:c,onDetailStateChange:H,showGuestPacks:fe,setShowGuestPacks:Ie,guestPackSearchQuery:be}),!Je&&!Qe&&!ae&&o==="projects"&&e.jsx(Qn,{isClient:A,getCachedGradient:c,setActiveProject:Pe,onOpenProject:ut}),!Je&&!Qe&&!ae&&o==="news"&&et(),!Je&&!Qe&&!ae&&o==="youtube"&&Gt(),Je&&e.jsxs("div",{className:"w-full bg-black/90 border-2 border-pink-500/50 rounded-3xl p-6 shadow-2xl backdrop-blur-md relative my-2 text-white animate-fadeIn flex-1 min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 pb-2 border-b border-white/10",children:[e.jsx("h3",{className:"text-xl font-black text-pink-400 flex items-center gap-2",children:"🎨 Gestion des Thèmes & Couleurs"}),e.jsx("button",{onClick:()=>lt(!1),className:"px-3.5 py-1.5 bg-white/10 hover:bg-white/20 text-white text-xs font-bold rounded-xl transition-all cursor-pointer border border-white/20",children:"✕ Masquer"})]}),e.jsxs("div",{className:"bg-cyan/10 border border-cyan/30 rounded-xl p-4 flex flex-col gap-2 mb-4",children:[e.jsxs("div",{className:"text-xs font-bold text-cyan uppercase tracking-wider flex items-center gap-2",children:[e.jsx("span",{children:"🖥️"})," Page d'Accueil Electron"]}),e.jsx("p",{className:"text-xs text-gray-300",children:`Fixer le fond d'écran enregistré ("fold") pour la page d'accueil Electron.`}),e.jsx("button",{onClick:()=>{const u="linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)",f=Ge.map(P=>P.name==="fold"?{...P,colors:{...P.colors,"bg-app":u}}:P);vt(f),localStorage.setItem("tiger_saved_themes",JSON.stringify(f)),Mt("fold"),document.body.style.background=u,document.body.style.backgroundAttachment="fixed",I("http://localhost:5006/api/theme",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({activeTheme:"fold",bgApp:u})}).catch(()=>{}),lt(!1)},className:"w-full mt-1 py-2.5 bg-cyan text-black font-extrabold rounded-lg hover:bg-cyan/80 transition-all flex items-center justify-center gap-2 shadow-lg cursor-pointer",children:`🖼️ Appliquer ce Fond d'Écran sur Electron ("fold")`})]}),e.jsxs("div",{className:"bg-white/5 border border-white/10 rounded-xl p-4 flex flex-col gap-3 mb-4",children:[e.jsxs("div",{className:"text-sm font-bold text-gray-400",children:["Mode actuel : ",e.jsx("span",{className:"text-cyan uppercase",children:Ne})]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"text",value:Lt,onChange:u=>cn(u.target.value),placeholder:"Nom (ex: Nuit, Océan, fold...)",className:"flex-1 bg-black/50 border border-white/20 rounded-lg px-3 py-2 text-sm text-white outline-none focus:border-cyan"}),e.jsx("button",{onClick:Ce,className:"px-4 py-2 bg-cyan text-black font-bold rounded-lg hover:bg-cyan/80 transition-colors whitespace-nowrap cursor-pointer",children:"Save Mode"})]})]}),e.jsxs("div",{className:"flex flex-col gap-2 max-h-[220px] overflow-y-auto custom-scrollbar",children:[e.jsx("div",{className:"text-xs font-bold text-gray-500 uppercase tracking-widest mb-1",children:"Thèmes Enregistrés"}),e.jsxs("div",{onClick:()=>{Mt("random"),lt(!1)},className:`p-3 rounded-xl border text-left flex justify-between items-center transition-all cursor-pointer ${Ne==="random"?"bg-cyan/20 border-cyan text-white":"bg-white/5 border-white/10 text-gray-400 hover:bg-white/10"}`,children:[e.jsx("span",{className:"font-bold flex items-center gap-2",children:"🎲 Mode Aléatoire (Dynamique)"}),Ne==="random"&&e.jsx("span",{className:"text-cyan",children:"✓"})]}),Ge.map(u=>e.jsxs("div",{onClick:()=>{Mt(u.name),document.body.style.background=u.colors["bg-app"]||"",u.name==="fold"?document.body.style.backgroundAttachment="fixed":document.body.style.backgroundAttachment="scroll"},className:`p-3 rounded-xl border text-left flex justify-between items-center transition-all cursor-pointer ${Ne===u.name?"bg-cyan/20 border-cyan text-white":"bg-white/5 border-white/10 text-gray-400 hover:bg-white/10"}`,children:[e.jsx("span",{className:"font-bold capitalize",children:u.name}),e.jsx("button",{onClick:f=>Sn(u.name,f),className:"text-xs text-red-400 hover:text-red-300 px-2 py-1 bg-red-500/10 hover:bg-red-500/20 rounded border border-red-500/20 cursor-pointer",children:"Supprimer"})]},u.name))]})]}),Qe&&e.jsxs("div",{className:"w-full bg-[#090d16] border-2 border-purple-500/60 rounded-3xl p-6 shadow-2xl backdrop-blur-md relative my-2 text-white animate-fadeIn flex-1 min-w-0 flex flex-col max-h-[520px] overflow-y-auto custom-scrollbar",children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 pb-2 border-b border-purple-500/30",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-2xl animate-bounce",children:"📱"}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-purple-300 font-black text-base md:text-lg uppercase tracking-wider flex items-center gap-2",children:"v0-apk — Compilateur Mobile Java"}),e.jsx("p",{className:"text-xs text-slate-400",children:"Génération d'APK Android Souverain sans dépendance système externe"})]})]}),e.jsx("button",{onClick:()=>Jt(!1),className:"px-3.5 py-1.5 bg-white/10 hover:bg-white/20 text-white text-xs font-bold rounded-xl transition-all cursor-pointer border border-white/20",children:"✕ Masquer"})]}),e.jsxs("div",{className:"flex flex-col gap-2 bg-black/50 p-4 rounded-2xl border border-purple-500/20 mb-3",children:[e.jsxs("label",{htmlFor:"apk-target-inline",className:"text-purple-400 font-bold uppercase text-xs tracking-widest flex items-center gap-2",children:[e.jsx("span",{children:"📁"})," SELECTIONNER L'APPLICATION À COMPILER :"]}),e.jsxs("select",{id:"apk-target-inline",value:St||D||"",onChange:u=>pn(u.target.value),className:"w-full bg-[#121824] text-white border border-purple-500/40 rounded-xl px-4 py-2.5 outline-none focus:border-purple-400 text-xs font-semibold cursor-pointer",children:[e.jsx("option",{value:"",children:"-- Sélectionner un projet --"}),he.map((u,f)=>{var M,ee;const P=typeof(u==null?void 0:u.name)=="string"?u.name:((M=u==null?void 0:u.name)==null?void 0:M.project_id)||((ee=u==null?void 0:u.name)==null?void 0:ee.title)||`Projet_${f}`;return e.jsxs("option",{value:P,children:["📁 ",P]},P+"_"+f)})]})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3 mb-3",children:[e.jsxs("div",{className:"bg-black/50 p-3 rounded-2xl border border-purple-500/20 flex flex-col gap-1",children:[e.jsx("span",{className:"text-xs font-bold text-purple-300 uppercase tracking-wider",children:"☕ Java Portable"}),e.jsx("div",{className:"text-[11px] text-slate-300 bg-purple-950/30 p-2 rounded-xl border border-purple-800/40 font-mono",children:"JDK 17 + Capacitor Android Engine"})]}),e.jsxs("div",{className:"bg-black/50 p-3 rounded-2xl border border-purple-500/20 flex flex-col gap-1",children:[e.jsx("span",{className:"text-xs font-bold text-purple-300 uppercase tracking-wider",children:"🎨 Thèmes Persistent"}),e.jsx("div",{className:"text-[11px] text-slate-300 bg-purple-950/30 p-2 rounded-xl border border-purple-800/40 font-mono",children:"Injection Zero-Touch CSS embarquée"})]})]}),e.jsxs("div",{className:"bg-[#05070d] p-3 rounded-2xl border border-slate-800 flex flex-col gap-2 mb-3",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsxs("span",{className:"text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center gap-2",children:[e.jsx("span",{className:`w-2.5 h-2.5 rounded-full ${Ze==="building"?"bg-yellow-400 animate-ping":Ze==="success"?"bg-green-400":"bg-slate-600"}`}),"Logs Compilation APK"]}),kt.length>0&&e.jsx("button",{onClick:()=>st([]),className:"text-[10px] text-slate-500 hover:text-slate-300 underline cursor-pointer",children:"Effacer"})]}),e.jsx("div",{className:"bg-black/80 p-3 rounded-xl border border-slate-900 font-mono text-[11px] h-24 overflow-y-auto custom-scrollbar flex flex-col gap-1 text-slate-300",children:kt.length===0?e.jsx("span",{className:"text-slate-600 italic text-center my-auto",children:`Prêt. Cliquez sur "Compiler l'APK".`}):kt.map((u,f)=>e.jsx("div",{className:"leading-tight",children:u},f))})]}),ht.length>0&&e.jsxs("div",{className:"bg-[#0b121e] p-3 rounded-2xl border border-emerald-500/30 flex flex-col gap-2 mb-3 shadow-inner",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsxs("span",{className:"text-xs font-bold text-emerald-400 uppercase tracking-wider flex items-center gap-2",children:[e.jsx("span",{children:"📦"})," Fichiers APK Prêts (",ht.length,")"]}),e.jsx("button",{onClick:yt,className:"text-[11px] text-emerald-400 hover:text-emerald-200 transition-colors flex items-center gap-1 cursor-pointer font-bold",title:"Actualiser la liste des APK sur le serveur",children:"🔄 Actualiser"})]}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-32 overflow-y-auto custom-scrollbar pt-1",children:ht.map((u,f)=>{const P=(St||D||"").toLowerCase()===u.name.toLowerCase();return e.jsxs("a",{href:u.url,download:u.file,className:`px-3 py-2 rounded-xl text-xs font-bold flex items-center justify-between transition-all shadow-md cursor-pointer border ${P?"bg-emerald-600/30 border-emerald-400 text-white shadow-[0_0_12px_rgba(16,185,129,0.3)]":"bg-black/50 border-emerald-500/20 text-slate-300 hover:bg-emerald-950/40 hover:text-white hover:border-emerald-500/50"}`,title:`Télécharger ${u.file} (${u.sizeMb} Mo)`,children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-base",children:"📱"}),e.jsx("span",{className:"font-mono truncate",children:u.name})]}),e.jsxs("span",{className:"text-[10px] bg-emerald-900/60 px-2 py-0.5 rounded-full text-emerald-300 font-mono shrink-0 ml-2",children:["📥 ",u.sizeMb," Mo"]})]},f)})})]}),(()=>{const u=St||D||"figma",f=ht.find(ee=>ee.name.toLowerCase()===u.toLowerCase()||ee.file.toLowerCase()===`${u}.apk`.toLowerCase()),P=jt||(f?f.url:`/api/mobile/download-apk?file=${encodeURIComponent(u+".apk")}`),M=!!(jt||f);return e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-purple-500/20",children:[M?e.jsxs("a",{href:P,download:`${u}.apk`,className:"px-5 py-2.5 bg-gradient-to-r from-emerald-600 to-green-500 hover:from-emerald-500 hover:to-green-400 text-white rounded-xl text-xs font-black transition-all flex items-center gap-2 shadow-lg shadow-emerald-900/50 border border-emerald-400/40 cursor-pointer animate-pulse hover:scale-105",children:[e.jsx("span",{className:"text-base",children:"📥"}),e.jsxs("span",{children:["TÉLÉCHARGER ",u.toUpperCase(),".APK"]}),f&&e.jsxs("span",{className:"text-[10px] opacity-90 font-mono",children:["(",f.sizeMb," Mo)"]})]}):e.jsxs("div",{className:"px-4 py-2 bg-slate-900/70 text-slate-500 rounded-xl text-xs font-semibold flex items-center gap-2 border border-slate-800/80 select-none",children:[e.jsx("span",{children:"⏳"})," APK non encore généré"]}),e.jsx("button",{disabled:Ze==="building",onClick:async()=>{gt("building"),st([`> Initialisation build APK pour [${u}]...`]);try{const ee=await I("http://localhost:5006/api/mobile/build-apk",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:u})});if(!ee||!ee.ok){st(J=>[...J,"> ℹ️ Détection environnement Cloud VPS (109.205.182.17)...","> 🚀 Bascule automatique sur le Compilateur Cloud Souverain (GitHub Actions Engine)..."]),await zt(u,J=>st(X=>[...X,J]),(J,X)=>{gt(J),X&&(Xt(X),yt())});return}}catch{st(J=>[...J,"> 🚀 Bascule automatique sur le Compilateur Cloud Souverain..."]),await zt(u,J=>st(X=>[...X,J]),(J,X)=>{gt(J),X&&(Xt(X),yt())})}},className:`ml-auto px-5 py-2.5 rounded-xl text-xs font-extrabold transition-all shadow-md ${Ze==="building"?"bg-purple-900/50 text-purple-300 cursor-not-allowed":"bg-purple-600 hover:bg-purple-500 text-white cursor-pointer"}`,children:Ze==="building"?"⚙️ Compilation...":"📱 Re-Compiler l'APK"})]})})()]})]}),!_&&e.jsx("div",{className:"design-chat-bulles w-full xl:w-[450px] shrink-0 flex flex-col gap-3 items-end z-10 ml-auto",children:p.map((u,f)=>{const P=f===0;return e.jsxs("div",{className:"w-full flex flex-col items-end",children:[e.jsx("div",{className:`${P?"design-msg-accueil":"design-chat-bulle"} p-5 rounded-3xl rounded-br-sm backdrop-blur-md border border-white/20 text-gray-100 shadow-xl`,style:{background:A?c("msg-"+u.id,u.role==="user"?.8:.6):"rgba(0,0,0,0.6)"},children:u.content}),f===s&&u.widget==="settings"&&e.jsx(Jn,{isClient:A,getCachedGradient:c,mouchardLogs:ne,activePhase:b,availableProjects:re,setAvailableProjects:ge,selectedLaunchProject:G,setSelectedLaunchProject:V,isMobileNative:W,isAutoPilot:Ut,setIsAutoPilot:Ve,reuseActiveTab:Be,setReuseActiveTab:Ae,selectedStartPhase:Xe,setSelectedStartPhase:dn,selectedPacks:j}),f===s&&u.widget==="phases"&&xs(),f===s&&u.widget==="projects"&&e.jsx(Qn,{isClient:A,getCachedGradient:c,setActiveProject:Pe,onOpenProject:ut})]},u.id)})})]})})(),e.jsx("div",{ref:L})]})]}),me&&(()=>{const s=ne.slice(-10).join(" ").toLowerCase(),a=ne.slice(0,10).join(" ").toLowerCase(),o=s+" "+a;let _="text-green-400",u="bg-green-400 shadow-[0_0_8px_#4ade80]",f="border-green-500/30 shadow-[-10px_0_30px_rgba(34,197,94,0.1)]",P="bg-green-950/20",M="Terminal (Prêt)";return o.includes("erreur")||o.includes("failed")||o.includes("⚠️")||o.includes("exception")||o.includes("impossible")||o.includes("[err")?(_="text-red-500",u="bg-red-500 animate-pulse shadow-[0_0_12px_#ef4444]",f="border-red-500/50 shadow-[-10px_0_30px_rgba(239,68,68,0.2)]",P="bg-red-950/30",M="Terminal (Erreur)"):(o.includes("en cours")||o.includes("execution")||o.includes("install")||o.includes("lancement")||o.includes("analyse")||o.includes("suture")||o.includes("patch"))&&!o.includes("terminé")&&!o.includes("détecté")&&!o.includes("nettoyée")&&!o.includes("✅")&&(_="text-purple-400",u="bg-purple-400 animate-ping shadow-[0_0_12px_#c084fc]",f="border-purple-500/50 shadow-[-10px_0_30px_rgba(168,85,247,0.2)]",P="bg-purple-950/30",M="Terminal (Travail...)"),e.jsxs("aside",{className:`w-80 border-l flex flex-col z-50 fixed right-0 top-0 h-screen bg-black transition-all duration-500 shadow-2xl ${f}`,children:[e.jsxs("div",{className:`p-4 border-b border-white/10 flex justify-between items-center transition-colors duration-500 ${P}`,children:[e.jsxs("h3",{className:`${_} font-black text-xs uppercase tracking-widest flex items-center gap-2 transition-colors`,children:[e.jsx("span",{className:`w-2 h-2 rounded-full ${u}`}),M]}),e.jsxs("div",{className:"flex gap-2 items-center",children:[e.jsx("button",{onClick:async()=>{le(["> Arrêt des processus en cours... (Historique conservé dans la console noire)"]);try{const ee=await I("http://localhost:5006/api/bridge/stop-launch",{method:"POST"});if(!ee||!ee.ok){le(["> ⚠️ ERREUR : La commande n'existe pas !","> ⚠️ VOUS DEVEZ REDÉMARRER LA CONSOLE NOIRE !","> Fermez la fenêtre COMMAND_MENU_TIGER.bat et relancez-la."]);return}const J=await ee.json();le(["> ✅ "+(J.message||"Processus arrêtés.")])}catch(ee){le(["> ⚠️ ERREUR DE CONNEXION AU MOTEUR !","> Le moteur est peut-être éteint ou nécessite un redémarrage.","> Détail: "+ee.message])}},className:"py-1 px-2 rounded text-white font-bold text-[10px] bg-red-500/20 border border-red-500/50 hover:bg-red-500 hover:text-white transition-colors shadow-md",title:"Arrêter l'installation ou le serveur (Ne nettoie plus la console)",children:"⏹️ Stop/Clear"}),e.jsx("button",{onClick:()=>ye(!1),className:"text-gray-500 hover:text-white transition-colors ml-2 font-bold text-lg",children:"✕"})]})]}),e.jsx("div",{className:"flex-1 p-4 font-mono text-xs overflow-y-auto flex flex-col-reverse hide-scrollbar bg-black",children:e.jsx("div",{id:"mouchard-terminal-logs",children:ne.map((ee,J)=>{let X="text-[#52c1c9]";return ee.includes("[INSTALL]")&&(X="text-[#f29f43]"),ee.includes("[SERVER]")&&(X="text-[#0ab7d4]"),ee.includes("[IDE]")&&(X="text-[#e27396]"),(ee.includes("WARN")||ee.includes("ERR"))&&(X="text-red-500"),e.jsx("div",{className:`mb-1 opacity-90 break-words ${X}`,children:ee},J)})})})]})})(),!me&&e.jsxs("button",{onClick:()=>ye(!0),title:"Ouvrir le Mouchard Système / Terminal",className:"fixed right-4 top-4 z-50 bg-[#111c2e]/90 hover:bg-[#1e293b] border border-cyan/40 text-cyan px-3 py-1.5 rounded-full text-[11px] font-mono font-bold shadow-[0_0_15px_rgba(8,179,201,0.25)] transition-all flex items-center gap-1.5 backdrop-blur-md cursor-pointer hover:scale-105",children:[e.jsx("span",{children:"🕵️"}),e.jsx("span",{children:"Mouchard"})]})]})," ",e.jsxs("footer",{className:"design-footer absolute bottom-0 left-0 w-full backdrop-blur-2xl z-50 flex flex-col p-2 md:p-3 bg-black/80 border-t border-white/15 gap-2",children:[e.jsx("div",{className:"flex flex-wrap items-center justify-center gap-3 px-4 py-2 bg-black/40 rounded-2xl border border-white/10 backdrop-blur-md",children:e.jsxs("div",{className:"flex items-center gap-2 overflow-x-auto hide-scrollbar pb-1 px-1",children:[e.jsxs("button",{onClick:()=>{te("connexion"),O(!0)},className:"design-app-icone design-icone-reglages flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Réglages",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:rotate-45 transition-transform",children:"⚙️"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Réglages"})]}),e.jsxs("button",{onClick:()=>{if(typeof window<"u"){const s=localStorage.getItem("tiger_targetAi")||"deepseek",a=mt(s),o=window.AndroidBridge;o&&o.openAIWithPrompt?o.openAIWithPrompt(a,"Bonjour ! Je viens d'ouvrir l'Assistant IA."):window.open(a,"_blank")}},className:"design-app-icone design-icone-assistant flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Assistant IA",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🧠"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Assistant IA"})]}),e.jsxs("button",{onClick:()=>{Pe(null),tt(null),pe(!1),Me("Mes projets"),y("")},className:"design-app-icone design-icone-projets flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Projets",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"📁"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Projets"})]}),e.jsxs("button",{id:"btn-joindre-prd-main",onClick:()=>{pe(!0)},className:"design-app-icone design-icone-packs flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Ouvrir le carrousel des Packs PRD",children:[j.length>0&&e.jsx("span",{className:"absolute -top-0 -right-0 bg-indigo-500 text-white text-[9px] font-black w-4.5 h-4.5 rounded-full flex items-center justify-center border border-white/20 shadow-md z-20",children:j.length}),e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform text-xl",children:"📎"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Packs PRD"})]}),e.jsxs("button",{onClick:async()=>{window.dispatchEvent(new CustomEvent("open-mouchard"));try{await I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:"v0-guest"})}),setTimeout(()=>{window.open("http://localhost:3007","_blank")},2500)}catch(s){console.error("Erreur lancement v0-guest:",s)}},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden cursor-pointer",style:{backgroundImage:"linear-gradient(135deg, #00c6ff, #0072ff)"},title:"Démarrer le serveur V0-Guest (localhost:3007) en arrière-plan",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🎁"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"V0-Guest"})]}),e.jsxs("button",{onClick:()=>{pe(!1),Me("Actualités IA"),y("")},className:"design-app-icone design-icone-actualites flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Actualités",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"📰"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Actualités"})]}),e.jsxs("button",{type:"button",onClick:s=>{s.preventDefault(),ye(a=>{const o=!a;return o&&le(_=>["> Console-V0 ouverte. Prêt pour l'Introspection AST.",..._]),o})},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #475163, #1f2530)"},title:"Console-V0",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🖥️"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Console-V0"})]}),e.jsxs("button",{type:"button",onClick:async s=>{s.preventDefault();try{ye(!0);const a=D||"Projet_blog_8831",_=`e:\\v0reponses\\v0-moteur-electron\\v0saveprojets\\${a}\\${(xe||"src/App.tsx").replace(/\//g,"\\")}`;setTimeout(()=>{const M=document.getElementById("mouchard-terminal-logs");M&&(M.innerHTML=`<div class="mb-1 opacity-90 break-words text-[#e27396]">> 🚀 Lancement du Patch UI (Suture dynamique sur ${a})...</div>`+M.innerHTML)},50);const u=await I("http://localhost:5006/api/design/intent",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({intent:"PATCH_UI",payload:{targetFile:_,templateId:"stitch_mock"}})}),f=u?await u.json():null,P=document.getElementById("mouchard-terminal-logs");P&&(f&&f.success?P.innerHTML='<div class="mb-1 opacity-90 break-words text-[#00e676]">> 🎯 Patch appliqué avec succès par le LLM !</div>'+P.innerHTML:(P.innerHTML=`<div class="mb-1 opacity-90 break-words text-red-400">> ⚠️ Erreur Patch UI AST : ${f&&f.error||"Basculement vers la Suture IA..."}</div>`+P.innerHTML,Oe("suture",`Échec du patch automatique AST : ${f&&f.error||"Format incompatible"}`)))}catch(a){const o=document.getElementById("mouchard-terminal-logs");o&&(o.innerHTML=`<div class="mb-1 opacity-90 break-words text-red-500">> ⛔ Erreur Patch UI : ${a.message}</div>`+o.innerHTML),Oe("suture",`Exception Patch UI: ${a.message}`)}},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #1b6345, #08291a)"},title:"Patch UI",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🧬"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Patch UI"})]}),e.jsxs("button",{type:"button",onClick:async()=>{try{const s=await I("http://localhost:5006/bridge/flush",{method:"POST"}),a=s?await s.json():null;C(_=>[..._,{id:Date.now().toString()+"_flush",role:"assistant",content:`🧹 File Bridge vidée ! ${a&&a.flushed||0} prompt(s) supprimé(s).

La queue est vide. Relancez votre Suture ou Patch.`}]);const o=document.getElementById("mouchard-terminal-logs");o&&(o.innerHTML=`<div class="mb-1 opacity-90 break-words text-yellow-400">> 🧹 Bridge Queue FLUSH — ${a&&a.flushed||0} tâche(s) nettoyée(s)</div>`+o.innerHTML)}catch{alert("Moteur hors ligne : impossible de vider la queue.")}},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #a17c23, #4f3b0c)"},title:"Vider la file Bridge (déblocage injection)",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🧹"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Flush Queue"})]}),e.jsxs("button",{onClick:()=>{Jt(!1),pe(!1),lt(s=>!s)},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #993a61, #4d152c)"},title:"Thèmes & Couleurs",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🎨"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Thèmes"})]}),e.jsxs("button",{onClick:()=>{lt(!1),pe(!1),Jt(s=>!s)},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #5b227a, #230930)"},title:"Compiler l'Application Mobile (.apk - Java Portable)",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform animate-pulse",children:"📱"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"v0-apk"})]})]})}),e.jsxs("div",{className:"px-3 pb-1 pt-1 relative w-full flex flex-col gap-2",children:[e.jsx("input",{type:"file",ref:F,className:"hidden",multiple:!0,accept:".html,.md,.png,.jpg,.jpeg,.json,.txt,.zip",onChange:s=>{s.target.files&&s.target.files.length>0&&Ye(s.target.files),F.current&&(F.current.value="")}}),nt.length>0&&e.jsx("div",{className:"flex gap-2 px-2 overflow-x-auto hide-scrollbar pb-2",children:nt.map((s,a)=>e.jsxs("div",{className:"flex items-center gap-2 bg-cyan/10 border border-cyan/30 text-cyan text-xs px-3 py-1.5 rounded-full whitespace-nowrap animate-fadeIn",children:[e.jsxs("span",{children:["📎 ",s.path.split("/").pop()||s.path.split("\\").pop()]}),e.jsx("button",{onClick:()=>Pt(o=>o.filter((_,u)=>u!==a)),className:"hover:text-red-400 font-bold ml-1",children:"✕"})]},a))}),Te?e.jsxs("div",{id:"creation-mode-container",className:"absolute bottom-full left-2 right-2 mb-3 flex flex-col gap-4 bg-[#05080c]/98 p-5 rounded-3xl border-2 border-cyan/50 shadow-[0_0_50px_rgba(8,179,201,0.5)] backdrop-blur-2xl animate-fadeIn z-[100] max-h-[82vh] overflow-y-auto custom-scrollbar text-white",children:[e.jsxs("div",{className:"flex justify-between items-center mb-1 sticky top-0 bg-[#05080c]/98 z-10 py-2 border-b border-cyan/20",children:[e.jsxs("h3",{className:"text-cyan font-black flex items-center gap-2 text-base md:text-lg uppercase tracking-wider",children:[e.jsx("span",{className:"animate-pulse w-2.5 h-2.5 bg-cyan rounded-full shadow-[0_0_10px_#08b3c9]"})," ⚙️ CONFIGURATION DU PROJET"]}),e.jsx("button",{onClick:()=>Ee(!1),className:"text-gray-400 hover:text-white bg-white/10 hover:bg-red-500 rounded-full w-7 h-7 flex items-center justify-center transition-colors",children:"✕"})]}),e.jsxs("div",{className:"flex flex-col gap-2 bg-black/60 p-3.5 rounded-2xl border border-white/10",children:[e.jsxs("label",{htmlFor:"project-target",className:"text-cyan font-bold uppercase text-[10px] tracking-widest flex items-center gap-1.5",children:[e.jsx("span",{children:"📁"})," CIBLER LE PROJET :"]}),e.jsxs("select",{id:"project-target",value:ze||"",onChange:s=>{const a=s.target.value;un(a||null),xt(a?a.replace("Projet_","").split("_")[0]:"")},className:"w-full bg-[#11161d] text-white border border-cyan/30 rounded-xl px-3 py-2 outline-none focus:border-cyan text-xs cursor-pointer",children:[e.jsx("option",{value:"",children:"-- SÉLECTIONNER UN PROJET --"}),he.map((s,a)=>{var _,u;const o=typeof(s==null?void 0:s.name)=="string"?s.name:((_=s==null?void 0:s.name)==null?void 0:_.project_id)||((u=s==null?void 0:s.name)==null?void 0:u.title)||`Projet_${a}`;return e.jsxs("option",{value:o,children:["📁 ",o]},o+"_"+a)})]})]}),e.jsxs("div",{className:"flex flex-col gap-2 bg-black/60 p-3.5 rounded-2xl border border-white/10",children:[e.jsxs("label",{htmlFor:"project-instructions",className:"text-cyan font-bold uppercase text-[10px] tracking-widest flex items-center gap-1.5",children:[e.jsx("span",{children:"📝"})," INSTRUCTIONS SPÉCIFIQUES :"]}),e.jsx("textarea",{id:"project-instructions",value:We,onChange:s=>sn(s.target.value),placeholder:"Instructions pour le Patch ou la modification...",className:"w-full bg-[#11161d] text-white border border-slate-700 rounded-xl px-3.5 py-2 outline-none focus:border-cyan h-14 resize-none text-xs leading-relaxed"})]}),e.jsxs("div",{className:"flex flex-col gap-3.5 bg-black/60 p-3.5 rounded-2xl border border-white/10",children:[e.jsxs("div",{className:"text-cyan font-bold uppercase text-xs tracking-wider flex items-center gap-1.5 border-b border-white/10 pb-1.5",children:[e.jsx("span",{children:"⚡"})," PARAMÈTRES & CIBLES"]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"project-name",className:"text-cyan font-bold uppercase text-[10px] tracking-widest mb-1 block",children:"Nom du Projet"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{id:"project-name",type:"text",value:ce,onChange:s=>xt(s.target.value),placeholder:"Ex: MonSuperProjet",className:"flex-1 bg-[#11161d] text-white border border-slate-700 rounded-xl px-3 py-2 outline-none focus:border-cyan text-xs"}),e.jsx("button",{type:"button",onClick:async()=>{if(ce.trim()){const a=ce.trim().replace(/[^a-zA-Z0-9_-]/g,"_");Pe(a);try{const o="http://localhost:5006";await I(`${o}/v1/projects/set-active`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:a,project_id:a})}).catch(()=>null),await I(`${o}/api/fs/write`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:a,file:"README.md",content:`# ${ce.trim()}

Initialisé par Tiger IA V0.`})}).catch(()=>null)}catch(o){console.error("Erreur lors de la création du dossier sur disque:",o)}}},className:"px-3 py-2 bg-cyan/20 hover:bg-cyan text-cyan hover:text-black font-bold text-xs rounded-xl border border-cyan/40 transition-colors whitespace-nowrap",children:"Valider"})]})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"project-stack",className:"text-cyan font-bold uppercase text-[10px] tracking-widest mb-1 block",children:"Stack Technique"}),e.jsxs("select",{id:"project-stack",value:Ke,onChange:s=>Mn(s.target.value),className:"w-full bg-[#11161d] text-white border border-slate-700 rounded-xl px-3 py-2 outline-none focus:border-cyan text-xs cursor-pointer",children:[e.jsx("option",{value:"Vite + React + Tailwind + TS",children:"⭐ 1er Choix (Prioritaire) : Vite + React + Tailwind + TS"}),e.jsx("option",{value:"Vite + React + TS + Canvas 2D",children:"🎮 Jeu 2D : Vite + React + TS + Canvas 2D"}),e.jsx("option",{value:"Vite + React + TS + Three.js / R3F (3D GPU)",children:"🚀 Jeu 3D GPU : Vite + React + TS + Three.js / R3F"}),e.jsx("option",{value:"Next.js + Tailwind + App Router",children:"Next.js + Tailwind + App Router"}),e.jsx("option",{value:"HTML + CSS Vanilla + JS",children:"HTML + CSS Vanilla + JS"})]})]})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"project-desc",className:"text-cyan font-bold uppercase text-[10px] tracking-widest mb-1 block",children:"Description / Vision"}),e.jsx("textarea",{id:"project-desc",value:ft,onChange:s=>vn(s.target.value),placeholder:"Décrivez l'application ou copiez votre PRD...",className:"w-full bg-[#11161d] text-white border border-slate-700 rounded-xl px-3.5 py-2 outline-none focus:border-cyan h-16 resize-none text-xs leading-relaxed"})]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2 pt-2 border-t border-white/10",children:[e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-[9px] font-bold text-cyan uppercase tracking-wider",children:"Intelligence Cible"}),e.jsxs("select",{value:It,onChange:s=>{Rt(s.target.value),localStorage.setItem("tiger_targetAi",s.target.value)},className:"bg-[#11161d] text-cyan font-bold text-xs border border-cyan/40 rounded-xl px-2.5 py-1.5 outline-none focus:border-cyan cursor-pointer",children:[e.jsx("option",{value:"deepseek",children:"🩵 DeepSeek"}),e.jsx("option",{value:"cloudflare",children:"☁️ Cloudflare Qwen 3 (Grade Gold)"}),e.jsx("option",{value:"stitch",children:"🎨 Stitch (Google)"}),e.jsx("option",{value:"v0",children:"⚡ V0.dev"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT"}),e.jsx("option",{value:"claude",children:"🟠 Claude"}),e.jsx("option",{value:"kimi",children:"🌙 Kimi (Moonshot)"}),e.jsx("option",{value:"gemini",children:"🔵 Gemini"}),e.jsx("option",{value:"qwen",children:"🔴 Qwen"}),e.jsx("option",{value:"perplexity",children:"🔍 Perplexity AI"})]})]}),e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-[9px] font-bold text-cyan uppercase tracking-wider",children:"💉 Mode & Lot de Départ"}),e.jsxs("select",{value:Xe,onChange:s=>dn(Number(s.target.value)),className:"bg-[#11161d] text-white font-bold text-xs border border-cyan/40 rounded-xl px-2.5 py-1.5 outline-none focus:border-cyan cursor-pointer",children:[e.jsx("option",{value:1,children:"🎨 Phase 1 : Le Frontend (Stitch/v0)"}),e.jsx("option",{value:2,children:"💻 Phase 2 : Le Backend (Assistant IA)"}),e.jsx("option",{value:4,children:"🎨 Phase 3/4 : Câblage Métier (Business Wiring)"})]})]}),e.jsxs("button",{type:"button",onClick:()=>Ve(!Ut),className:`mt-4 px-3 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border ${Ut?"bg-green-600/30 text-green-300 border-green-500/50 shadow-[0_0_10px_rgba(34,197,94,0.3)]":"bg-slate-800 text-slate-300 border-slate-700 hover:border-slate-500"}`,children:[e.jsx("span",{children:"🤖"}),e.jsxs("span",{children:["AUTO-PILOT : ",Ut?"ON 🟢":"OFF ⚪"]})]}),e.jsxs("button",{type:"button",onClick:()=>Ae(!Be),className:`mt-4 px-3 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border ${Be?"bg-blue-600/30 text-blue-300 border-blue-500/50 shadow-[0_0_10px_rgba(59,130,246,0.3)]":"bg-slate-800 text-slate-300 border-slate-700"}`,title:"Cochez pour réutiliser l'onglet KIROV5 au lieu d'ouvrir un nouvel onglet",children:[e.jsx("span",{children:"🔗"}),e.jsx("span",{children:Be?"✓ Injecter dans l'onglet déjà ouvert":"Ouvrir un nouvel onglet"})]}),e.jsxs("div",{id:"btn-joindre-prd",className:`mt-4 px-3 py-1.5 border rounded-xl text-xs font-bold flex items-center gap-1.5 relative ${j.length>0?"bg-indigo-600 text-white border-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.6)]":"bg-indigo-900/40 text-indigo-200 border-indigo-500/40"}`,title:"Pack PRD sélectionné — Sera injecté automatiquement dans le contexte IA",children:[e.jsx("span",{children:"💎"}),e.jsx("span",{children:j.length>0?`Packs PRD ${j.length} ${j[0]}`:"Aucun Pack PRD sélectionné"})]}),e.jsxs("button",{type:"button",onClick:triggerNativeZipPicker,className:"mt-4 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-white border border-slate-600 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 shadow-md hover:border-cyan hover:shadow-[0_0_15px_rgba(8,179,201,0.4)] cursor-pointer",children:[e.jsx("span",{children:"📎"}),e.jsx("span",{children:"Joindre ZIP (Stitch)"})]})]})]}),ae&&e.jsxs("div",{className:"w-full bg-[#0a0d14]/98 p-4 rounded-2xl border-2 border-indigo-500/60 shadow-[0_0_30px_rgba(99,102,241,0.4)] my-2 text-white animate-fadeIn max-h-[50vh] overflow-y-auto custom-scrollbar flex flex-col gap-3 z-30",children:[e.jsxs("div",{className:"flex justify-between items-center pb-2 border-b border-indigo-500/30 sticky top-0 bg-[#0a0d14]/98 z-10 py-1",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-xl",children:"💎"}),e.jsxs("div",{children:[e.jsxs("h4",{className:"text-indigo-300 font-black text-xs md:text-sm uppercase tracking-wider",children:["PACKS PRD ARCHITECTURE (",j.length," SÉLECTIONNÉ",j.length>1?"S":"",")"]}),e.jsx("p",{className:"text-[10px] text-slate-400",children:"Sélectionnez les briques fonctionnelles à intégrer au Méga-Prompt."})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[j.length>0&&e.jsx("button",{type:"button",onClick:()=>Q([]),className:"text-[10px] font-bold text-red-400 hover:text-red-300 bg-red-950/40 px-2 py-1 rounded-lg border border-red-500/30 transition-all",children:"Tout décocher"}),e.jsx("button",{type:"button",onClick:()=>pe(!1),className:"text-slate-400 hover:text-white bg-white/10 rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold transition-all",children:"✕"})]})]}),e.jsx("input",{type:"text",placeholder:"🔍 Filtrer un pack PRD (ex: auth, ecom, mobile, saas, ai, game, sqlite...)",value:Re,onChange:s=>it(s.target.value),className:"w-full bg-[#121824] text-xs text-white border border-indigo-500/40 rounded-xl px-3 py-2 outline-none focus:border-indigo-400 placeholder:text-slate-500"}),e.jsx("div",{className:"grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2",children:Ht.filter(s=>s.name.toLowerCase().includes(Re.toLowerCase())||s.id.toLowerCase().includes(Re.toLowerCase())).map(s=>{const a=j.includes(s.id),o=s.icon;return e.jsxs("div",{onClick:()=>qt(s.id),className:`p-2.5 rounded-xl border text-xs cursor-pointer transition-all flex flex-col justify-between gap-1.5 relative select-none ${a?"bg-indigo-900/60 border-indigo-400 text-white shadow-[0_0_12px_rgba(99,102,241,0.5)] scale-[1.02]":"bg-[#11161f] border-slate-800 text-slate-300 hover:border-indigo-500/50 hover:bg-[#171e2b]"}`,children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("div",{className:`p-1 rounded-lg ${s.color}`,children:e.jsx(o,{className:"w-3.5 h-3.5"})}),e.jsx("input",{type:"checkbox",checked:a,readOnly:!0,className:"accent-indigo-500 w-3.5 h-3.5 rounded cursor-pointer pointer-events-none"})]}),e.jsx("div",{className:"font-bold text-[11px] leading-tight line-clamp-1 text-white",children:s.name}),e.jsxs("div",{className:"text-[8px] text-slate-400 font-mono truncate",children:["#",s.id]})]},s.id)})}),e.jsx("div",{className:"pt-2 border-t border-indigo-500/20 flex justify-end",children:e.jsxs("button",{type:"button",onClick:()=>{pe(!1)},className:"px-4 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-black rounded-xl shadow-lg transition-all",children:["✓ Valider la sélection (",j.length,")"]})})]}),e.jsxs("div",{className:"flex justify-end gap-3 pt-2 border-t border-white/10",children:[e.jsx("button",{type:"button",onClick:()=>Ee(!1),className:"px-4 py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-xl text-xs font-bold transition-all",children:"Annuler"}),e.jsxs("button",{type:"button",onClick:async s=>{if(!ce.trim()&&!ze){alert("Veuillez entrer un nom de projet ou en choisir un.");return}const a=ce.trim()?ce.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"",o=ze||a||"Projet_"+Date.now().toString().slice(-4),_=s.currentTarget;_.innerText="⏳ Initialisation...",_.disabled=!0;try{const u="http://localhost:5006",f=typeof window<"u"&&window.Capacitor&&window.Capacitor.isNativePlatform();if(f)try{const{KirovSovereignEngine:X}=window.Capacitor.Plugins;X&&await X.setActiveProject({name:o})}catch(X){console.warn("Plugin mobile introuvable",X)}else await I(`${u}/v1/projects/set-active`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:o})}).catch(()=>null);if(f)try{const{KirovSovereignEngine:X}=window.Capacitor.Plugins;X&&await X.writeFile({project:o,file:"README.md",content:`# ${ce||o}

Initialisé par Tiger IA V0.
Stack : ${Ke}
Description : ${ft}`})}catch{}else await I(`${u}/api/fs/write`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:o,file:"README.md",content:`# ${ce||o}

Initialisé par Tiger IA V0.
Stack : ${Ke}
Description : ${ft}`})}).catch(()=>null);const P=j&&j.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${j.length})]
`+j.map(X=>{const Le=Ht.find(He=>He.id===X);return`• ${Le?Le.name:X} (#${X})`}).join(`
`):"";let M=`

[STACK TECHNIQUE OBLIGATOIRE : ${Ke.toUpperCase()}]
`;Ke.includes("Three.js")||Ke.includes("3D GPU")?M+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être un jeu Web 3D accéléré GPU généré en **React + Vite + TypeScript (TSX) + Three.js / React Three Fiber (@react-three/fiber, @react-three/drei)**.
...
`:Ke.includes("Canvas 2D")?M+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être un jeu Web 2D généré en **React + Vite + TypeScript (TSX) + Canvas 2D**.
...
`:Ke.includes("Vite")?M+="⚠️ CONTRAT BOILERPLATE (GOLDEN CONTRACT) : Ce projet s'appuie sur un boilerplate préexistant (React + Vite + TS + Tailwind).\n• INTERDICTION FORMELLE : Ne crée PAS et ne modifie PAS les fichiers `package.json`, `vite.config.ts`, `index.html`, `src/main.tsx` ou `src/index.css`. L'architecture de base, le routage racine et les variables Tailwind sont déjà câblés.\n• CHEMINS APLATIS (OBLIGATOIRE) : Tu DOIS placer TOUTES les pages directement à la racine de `src/pages/` (ex: `src/pages/HomePage.tsx`). NE CRÉE JAMAIS de sous-dossiers imbriqués ni de fichiers `code.tsx` profonds.\n• ANTI-DOUBLON : Ne crée pas la même page en double (ex: n'écris pas `Post.tsx` ET `PostPage.tsx`). Génère un seul fichier par page avec le suffixe 'Page'.\n• ROUTAGE STRICT : Dans `src/App.tsx`, vérifie que chaque import correspond EXACTEMENT au nom du fichier plat que tu as généré dans `src/pages/`. N'invente pas de routes fantômes.\n":Ke.includes("Next")?M+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être généré en **Next.js (App Router)**.
• Générer : package.json, app/layout.tsx, app/page.tsx, app/globals.css.
`:M+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être généré en **HTML5 / CSS Vanilla / JS**.
• Générer : index.html, design.css, app.js.
`;const ee=(ft.trim()||We.trim()||`Initialisation du projet ${ce||o}`)+M+P;let J=It;if(Xe===1&&(J=localStorage.getItem("tiger_targetUiAi")||"stitch"),f)try{const{KirovSovereignEngine:X}=window.Capacitor.Plugins;if(X){const Le=mt(J);await X.openAiTab({url:Le}),setTimeout(async()=>{await X.injectPrompt({prompt:ee,target_ai:J})},4500)}}catch{alert("Le moteur souverain mobile n'est pas encore implémenté ou le plugin est manquant.")}else if(Xe===2){if(await I(`${u}/api/bridge/trombone`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:o,user_prompt:ee,target_ai:J,packs:j,zip_mode:!0,start_phase:200,force_restart:!0,auto_submit:rn})}).catch(()=>null),!Be){await I(`${u}/v1/bridge/inject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:o,prompt:"OPEN_TAB_ONLY",target_ai:J,phase_num:Xe})}).catch(()=>null);const X=mt(J);window.open(X,"_blank")}}else if(await I(`${u}/v1/bridge/inject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:o,prompt:ee,target_ai:J,phase_num:Xe,packs:j})}).catch(()=>null),await I(`${u}/api/bridge/expect-zip`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:o,target_ai:J,auto_submit:rn})}).catch(()=>null),!Be){const X=mt(J);window.open(X,"_blank")}Se(null),tt(null),ct(""),Ee(!1),C(X=>[...X,{id:Date.now().toString(),role:"user",content:`🚀 Mission "${ce||o}" initialisée pour ${It.toUpperCase()} avec ${j.length} pack(s) PRD. Injection du Méga-Prompt en cours...`}])}catch(u){alert("Erreur lors de la création : "+u.message)}finally{_.innerText="✅ Validé",_.disabled=!1}},className:"px-6 py-2.5 bg-gradient-to-r from-cyan to-blue-600 text-black font-black text-xs rounded-xl hover:from-cyan/80 hover:to-blue-600/80 transition-all shadow-[0_0_20px_rgba(8,179,201,0.4)] flex items-center gap-2",children:[e.jsx("span",{children:"🚀"})," Valider & Démarrer le Projet"]})]})]}):e.jsxs("div",{className:"relative flex items-center gap-2",children:[e.jsx("button",{onClick:()=>{var s;return(s=F.current)==null?void 0:s.click()},className:"design-btn-trombone transition-all opacity-80 z-20 hover:scale-110",title:"Joindre un fichier (Stitch/ZIP)",children:"📎"}),e.jsx("button",{onClick:()=>{Pe(null),xt(""),Pt([]),te("creation"),O(!0)},className:"design-btn-new-v0 font-bold flex items-center gap-1 transition-all z-20 hover:scale-105",title:"Créer un nouveau projet",children:"✨ New-v0"}),e.jsx("input",{type:"text",value:v,onChange:s=>y(s.target.value),onKeyDown:s=>s.key==="Enter"&&Me(),placeholder:"Système v0-reponses initialisé. L'interface unique est active. Que souhaitez-vous faire ?",className:"design-chat-input w-full pl-6 pr-14 transition-all shadow-inner focus:outline-none focus:ring-1 focus:ring-cyan"}),e.jsx("button",{onClick:Me,className:"design-btn-envoi absolute right-2 top-1/2 -translate-y-1/2 rounded-full flex items-center justify-center hover:scale-105 transition-all shadow-lg",children:e.jsx("svg",{className:"w-4 h-4 md:w-5 md:h-5 ml-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2.5",d:"M12 19l9 2-9-18-9 18 9-2zm0 0v-8"})})})]})]})]}),ve&&e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4",children:e.jsxs("div",{className:"bg-[#111] border border-white/10 rounded-2xl p-6 w-full max-w-md shadow-2xl relative",children:[e.jsx("button",{onClick:()=>je(!1),className:"absolute top-4 right-4 text-white/50 hover:text-white transition-colors",children:"✕"}),e.jsxs("h3",{className:"text-xl font-bold mb-4 flex items-center gap-2 text-white",children:[e.jsx("span",{className:"text-2xl",children:"⏪"})," Machine à Remonter le Temps"]}),e.jsxs("p",{className:"text-sm text-slate-400 mb-6",children:["Choisissez l'une des sauvegardes ci-dessous pour restaurer votre projet à un état antérieur.",e.jsx("br",{}),e.jsx("span",{className:"text-red-400 font-bold",children:"Attention : le code actuel sera écrasé."})]}),e.jsxs("div",{className:"space-y-3",children:[ke.map(s=>e.jsxs("div",{className:"flex items-center justify-between bg-white/5 p-3 rounded-lg border border-white/10 hover:border-blue-500/50 transition-all",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-2xl",children:"📸"}),e.jsxs("div",{children:[e.jsx("div",{className:"font-bold text-sm text-blue-300",children:s.replace("backup-","")}),e.jsx("div",{className:"text-xs text-slate-500",children:"Sauvegarde Kirov"})]})]}),e.jsx("button",{onClick:()=>{window.confirm(`Confirmer la restauration de ${s} ?
Tout le travail actuel non sauvegardé sera perdu.`)&&I("http://localhost:5006/api/bridge/restore-backup",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:D,backup_name:s})}).then(a=>a?a.json():null).then(a=>{if(!a)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");a.success?(alert("✅ "+a.message),je(!1)):alert("❌ Erreur Restauration : "+a.error)}).catch(a=>alert("Erreur réseau: "+a.message))},className:"px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold rounded-lg transition-all",children:"Restaurer"})]},s)),ke.length===0&&e.jsx("div",{className:"text-center p-4 text-slate-500 italic",children:"Aucune sauvegarde disponible."})]})]})}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
      ...
      `}})]})}function Ho({onAuthenticated:t}){const[n,r]=l.useState("login"),[c,d]=l.useState(""),[m,x]=l.useState(""),[p,C]=l.useState(""),[v,y]=l.useState(!1),[L,F]=l.useState(""),Z=async O=>{if(O.preventDefault(),F(""),n==="register"&&m!==p){F("Les mots de passe ne correspondent pas.");return}if(m.length<8){F("Le mot de passe doit contenir au moins 8 caractères.");return}y(!0);try{const te=await fetch(n==="login"?"/api/auth/login":"/api/auth/register",{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({email:c,password:m})}),w=await te.json();if(!te.ok){const N={INVALID_CREDENTIALS:"Email ou mot de passe incorrect.",TOO_MANY_ATTEMPTS:"Trop de tentatives. Réessayez dans 15 minutes.",REGISTRATION_FAILED:"Cet email est déjà utilisé.",PASSWORD_TOO_SHORT:"Mot de passe trop court (8 caractères minimum)."};F(w.error?N[w.error]??w.error:"Une erreur est survenue.");return}w.token&&localStorage.setItem("kirov5_jwt_token",w.token),t({userId:String(w.userId),email:c,isSuperAdmin:!!w.isSuperAdmin})}catch{window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?(console.warn("Mode local sans Wrangler: Bypass de la connexion pour accès UI."),localStorage.setItem("kirov5_jwt_token","dev-mock-token"),t({userId:"dev-user-001",email:c||"dev@local"})):F("Impossible de contacter le serveur. Vérifiez votre connexion.")}finally{y(!1)}};return e.jsxs("div",{style:{minHeight:"100vh",background:"linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Inter', 'Segoe UI', sans-serif",padding:"20px"},children:[e.jsx("div",{style:{position:"fixed",inset:0,overflow:"hidden",pointerEvents:"none",zIndex:0},children:[...Array(6)].map((O,K)=>e.jsx("div",{style:{position:"absolute",borderRadius:"50%",background:`rgba(${K%2===0?"139,92,246":"59,130,246"},0.08)`,width:`${200+K*80}px`,height:`${200+K*80}px`,top:`${10+K*15}%`,left:`${5+K*16}%`,filter:"blur(60px)",animation:`float ${6+K}s ease-in-out infinite alternate`}},K))}),e.jsxs("div",{style:{position:"relative",zIndex:1,width:"100%",maxWidth:"420px"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"40px"},children:[e.jsx("div",{style:{display:"inline-flex",alignItems:"center",justifyContent:"center",width:"72px",height:"72px",borderRadius:"20px",background:"linear-gradient(135deg, #8b5cf6, #3b82f6)",marginBottom:"20px",boxShadow:"0 0 40px rgba(139,92,246,0.4)",fontSize:"32px"},children:"⚡"}),e.jsx("h1",{style:{margin:0,fontSize:"28px",fontWeight:800,background:"linear-gradient(135deg, #a78bfa, #60a5fa)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",letterSpacing:"-0.5px"},children:"Kirov5 Sovereign Forge"}),e.jsx("p",{style:{color:"rgba(255,255,255,0.4)",marginTop:"8px",fontSize:"14px"},children:"Plateforme de génération d'applications IA"})]}),e.jsxs("div",{style:{background:"rgba(255,255,255,0.04)",backdropFilter:"blur(20px)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"24px",padding:"36px",boxShadow:"0 25px 50px rgba(0,0,0,0.4)"},children:[e.jsx("div",{style:{display:"flex",background:"rgba(0,0,0,0.3)",borderRadius:"12px",padding:"4px",marginBottom:"28px"},children:["login","register"].map(O=>e.jsx("button",{onClick:()=>{r(O),F("")},style:{flex:1,padding:"10px",borderRadius:"10px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:600,transition:"all 0.2s ease",background:n===O?"linear-gradient(135deg, #8b5cf6, #3b82f6)":"transparent",color:n===O?"#fff":"rgba(255,255,255,0.4)"},children:O==="login"?"🔑 Connexion":"✨ Inscription"},O))}),e.jsxs("form",{onSubmit:Z,children:[e.jsxs("div",{style:{marginBottom:"16px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Adresse email"}),e.jsx("input",{type:"email",value:c,onChange:O=>d(O.target.value),required:!0,autoComplete:"email",placeholder:"vous@exemple.com",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box",transition:"border-color 0.2s"},onFocus:O=>O.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:O=>O.target.style.borderColor="rgba(255,255,255,0.1)"})]}),e.jsxs("div",{style:{marginBottom:n==="register"?"16px":"24px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Mot de passe"}),e.jsx("input",{type:"password",value:m,onChange:O=>x(O.target.value),required:!0,autoComplete:n==="login"?"current-password":"new-password",placeholder:n==="register"?"8 caractères minimum":"••••••••",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box"},onFocus:O=>O.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:O=>O.target.style.borderColor="rgba(255,255,255,0.1)"})]}),n==="register"&&e.jsxs("div",{style:{marginBottom:"24px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Confirmer le mot de passe"}),e.jsx("input",{type:"password",value:p,onChange:O=>C(O.target.value),required:!0,autoComplete:"new-password",placeholder:"••••••••",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box"},onFocus:O=>O.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:O=>O.target.style.borderColor="rgba(255,255,255,0.1)"})]}),L&&e.jsxs("div",{style:{background:"rgba(239,68,68,0.12)",border:"1px solid rgba(239,68,68,0.3)",borderRadius:"10px",padding:"12px 16px",marginBottom:"16px",color:"#fca5a5",fontSize:"13px",display:"flex",alignItems:"center",gap:"8px"},children:[e.jsx("span",{children:"⚠️"})," ",L]}),e.jsx("button",{type:"submit",disabled:v,style:{width:"100%",padding:"14px",borderRadius:"12px",border:"none",background:v?"rgba(139,92,246,0.4)":"linear-gradient(135deg, #8b5cf6, #3b82f6)",color:"#fff",fontSize:"15px",fontWeight:700,cursor:v?"not-allowed":"pointer",transition:"all 0.2s ease",boxShadow:v?"none":"0 4px 20px rgba(139,92,246,0.4)"},children:v?"⏳ Chargement...":n==="login"?"🚀 Se connecter":"✨ Créer mon compte"})]}),e.jsx("p",{style:{textAlign:"center",marginTop:"20px",fontSize:"12px",color:"rgba(255,255,255,0.25)"},children:"🔒 Connexion sécurisée — Vos données sont chiffrées"})]})]}),e.jsx("style",{children:`
        @keyframes float {
          from { transform: translateY(0px) scale(1); }
          to { transform: translateY(-30px) scale(1.05); }
        }
        input::placeholder { color: rgba(255,255,255,0.25); }
      `})]})}function $o(){const[t,n]=l.useState(null),[r,c]=l.useState(!0);l.useEffect(()=>{(async()=>{try{const x=localStorage.getItem("kirov5_jwt_token");if(!x){n(null),c(!1);return}const p=await fetch("/api/auth/session",{headers:{Authorization:`Bearer ${x}`}});if(p.ok){const C=await p.json();C.authenticated?n({userId:String(C.userId||"user"),email:C.email||"user@cloud",isSuperAdmin:!!C.isSuperAdmin}):(localStorage.removeItem("kirov5_jwt_token"),n(null))}else localStorage.removeItem("kirov5_jwt_token"),n(null)}catch{const x=localStorage.getItem("kirov5_jwt_token");x&&x.startsWith("dev-")?n({userId:"dev-user-001",email:"dev@kirov5.local",isSuperAdmin:!0}):n(null)}finally{c(!1)}})()},[]);const d=()=>{localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{}),n(null)};return r?e.jsx("div",{style:{minHeight:"100vh",background:"linear-gradient(135deg, #0f0c29, #302b63, #24243e)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"Inter, sans-serif"},children:e.jsxs("div",{style:{textAlign:"center",color:"rgba(255,255,255,0.6)"},children:[e.jsx("div",{style:{fontSize:"48px",marginBottom:"16px"},children:"⚡"}),e.jsx("div",{style:{fontSize:"14px"},children:"Initialisation du Studio Kirov5..."})]})}):t?e.jsx(zo,{user:t,onLogout:d}):e.jsx(Ho,{onAuthenticated:m=>n(m)})}vs.createRoot(document.getElementById("root")).render(e.jsx(Et.StrictMode,{children:e.jsx($o,{})}));export{kn as E,os as W,Oa as b};

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-DFnoszRo.js","assets/design-v200-Cow_FDh_.js","assets/design-v200-D7ZOwPXd.css"])))=>i.map(i=>d[i]);
import{r as o,a as St,j as e,s as _,i as $n,R as ps}from"./design-v200-Cow_FDh_.js";const ms="modulepreload",gs=function(t){return"/"+t},Dn={},zt=function(n,r,a){let d=Promise.resolve();if(r&&r.length>0){let m=function(f){return Promise.all(f.map(I=>Promise.resolve(I).then(N=>({status:"fulfilled",value:N}),N=>({status:"rejected",reason:N}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),S=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));d=m(r.map(f=>{if(f=gs(f),f in Dn)return;Dn[f]=!0;const I=f.endsWith(".css"),N=I?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${f}"]${N}`))return;const w=document.createElement("link");if(w.rel=I?"stylesheet":ms,I||(w.as="script"),w.crossOrigin="",w.href=f,S&&w.setAttribute("nonce",S),document.head.appendChild(w),I)return new Promise((W,E)=>{w.addEventListener("load",W),w.addEventListener("error",()=>E(new Error(`Unable to preload CSS for ${f}`)))})}))}function p(m){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=m,window.dispatchEvent(u),!u.defaultPrevented)throw m}return d.then(m=>{for(const u of m||[])u.status==="rejected"&&p(u.reason);return n().catch(p)})},hs=`# undefined
...
- \`src/features/forms/schemas/registrationSchema.ts\``,Ds=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/gamification/components/BadgeGrid.tsx\``,Ns=`# APK Forge — Intelligent Android Packaging Suite
...
- \`src/core/shell/components/BottomSheet.tsx\``,Dr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/mobile/components/SwipeableOnboarding.tsx\``,Nr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ie=(t,n)=>{const r=o.forwardRef(({className:a,...d},p)=>o.createElement(La,{ref:p,iconNode:n,className:rs(`lucide-${Na(t)}`,a),...d}));return r.displayName=`${t}`,r};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
Spécifications techniques du pack Guest ${y.name}.`})}},className:"design-prd-btn text-purple-400 text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-purple-500/30 transition-all",children:[e.jsx("span",{children:"📖"})," README →"]})]})]},T)})}):e.jsx(Dt,{items:Et.map(y=>{const T=y.id,F=y.name,b=y.icon||is,M=t?t.includes(T):!1,q=(f[T]||dn(T)||"Spécifications techniques du contrat PRD.").replace(/^#+.*$/gm,"").replace(/^>.*$/gm,"").replace(/\[([^\]]+)\]\([^\)]+\)/g,"$1").replace(/[*_~`]/g,"").trim().split(`
...
[PACKS PRD ARCHITECTURE SELECTIONNES (${A.length})]
`+A.map(Z=>{const Te=Et.find(De=>De.id===Z);return`• ${Te?Te.name:Z} (#${Z})`}).join(`
`):"";let B=`

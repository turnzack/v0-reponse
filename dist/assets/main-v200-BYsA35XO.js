const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-Bh8qEHuC.js","assets/design-v200-DbCZFsQC.js","assets/design-v200-BH1kPxk1.css"])))=>i.map(i=>d[i]);
import{r as o,a as Et,j as e,s as w,i as ys,R as _s}from"./design-v200-DbCZFsQC.js";const Cs="modulepreload",ws=function(t){return"/"+t},Fn={},nn=function(n,r,c){let u=Promise.resolve();if(r&&r.length>0){let h=function(y){return Promise.all(y.map(S=>Promise.resolve(S).then(U=>({status:"fulfilled",value:U}),U=>({status:"rejected",reason:U}))))};document.getElementsByTagName("link");const p=document.querySelector("meta[property=csp-nonce]"),C=(p==null?void 0:p.nonce)||(p==null?void 0:p.getAttribute("nonce"));u=h(r.map(y=>{if(y=ws(y),y in Fn)return;Fn[y]=!0;const S=y.endsWith(".css"),U=S?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${y}"]${U}`))return;const G=document.createElement("link");if(G.rel=S?"stylesheet":Cs,S||(G.as="script"),G.crossOrigin="",G.href=y,C&&G.setAttribute("nonce",C),document.head.appendChild(G),S)return new Promise((te,O)=>{G.addEventListener("load",te),G.addEventListener("error",()=>O(new Error(`Unable to preload CSS for ${y}`)))})}))}function m(h){const p=new Event("vite:preloadError",{cancelable:!0});if(p.payload=h,window.dispatchEvent(p),!p.defaultPrevented)throw h}return u.then(h=>{for(const p of h||[])p.status==="rejected"&&m(p.reason);return n().catch(m)})},Is=`# undefined
...
- \`/requirements.txt\` & \`/package.json\` (Gestion des dépendances isolées)`,Fs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/marketing/components/LeadCaptureForm.tsx\``,Fr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Bn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);n&&(c=c.filter(function(u){return Object.getOwnPropertyDescriptor(t,u).enumerable})),r.push.apply(r,c)}return r}function zn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Bn(Object(r),!0).forEach(function(c){Ii(t,c,r[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Bn(Object(r)).forEach(function(c){Object.defineProperty(t,c,Object.getOwnPropertyDescriptor(r,c))})}return t}function ki(t,n){if(t==null)return{};var r,c,u=ji(t,n);if(Object.getOwnPropertySymbols){var m=Object.getOwnPropertySymbols(t);for(c=0;c<m.length;c++)r=m[c],n.indexOf(r)===-1&&{}.propertyIsEnumerable.call(t,r)&&(u[r]=t[r])}return u}function ji(t,n){if(t==null)return{};var r={};for(var c in t)if({}.hasOwnProperty.call(t,c)){if(n.indexOf(c)!==-1)continue;r[c]=t[c]}return r}function Ti(t,n){return wi(t)||Ai(t,n)||Ni(t,n)||Pi()}function Ei(t,n){if(typeof t!="object"||!t)return t;var r=t[Symbol.toPrimitive];if(r!==void 0){var c=r.call(t,n);if(typeof c!="object")return c;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}function Ri(t){var n=Ei(t,"string");return typeof n=="symbol"?n:n+""}function Ni(t,n){if(t){if(typeof t=="string")return Vn(t,n);var r={}.toString.call(t).slice(8,-1);return r==="Object"&&t.constructor&&(r=t.constructor.name),r==="Map"||r==="Set"?Array.from(t):r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?Vn(t,n):void 0}}function Di(t,n,r){return n in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function Hn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);n&&(c=c.filter(function(u){return Object.getOwnPropertyDescriptor(t,u).enumerable})),r.push.apply(r,c)}return r}function $n(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Hn(Object(r),!0).forEach(function(c){Di(t,c,r[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Hn(Object(r)).forEach(function(c){Object.defineProperty(t,c,Object.getOwnPropertyDescriptor(r,c))})}return t}function Mi(){for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r];return function(c){return n.reduceRight(function(u,m){return m(u)},c)}}function Yt(t){return function n(){for(var r=this,c=arguments.length,u=new Array(c),m=0;m<c;m++)u[m]=arguments[m];return u.length>=t.length?t.apply(this,u):function(){for(var h=arguments.length,p=new Array(h),C=0;C<h;C++)p[C]=arguments[C];return n.apply(r,[].concat(u,p))}}}function bn(t){return{}.toString.call(t).includes("Object")}function qi(t){return!Object.keys(t).length}function sn(t){return typeof t=="function"}function Li(t,n){return Object.prototype.hasOwnProperty.call(t,n)}function Ui(t,n){return bn(n)||wt("changeType"),Object.keys(n).some(function(r){return!Li(t,r)})&&wt("changeField"),n}function Oi(t){sn(t)||wt("selectorType")}function Gi(t){sn(t)||bn(t)||wt("handlerType"),bn(t)&&Object.values(t).some(function(n){return!sn(n)})&&wt("handlersType")}function Fi(t){t||wt("initialIsRequired"),bn(t)||wt("initialType"),qi(t)&&wt("initialContent")}function Vi(t,n){throw new Error(t[n]||t.default)}var Bi={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},wt=Yt(Vi)(Bi),hn={changes:Ui,selector:Oi,handler:Gi,initial:Fi};function zi(t){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};hn.initial(t),hn.handler(n);var r={current:t},c=Yt(Ki)(r,n),u=Yt($i)(r),m=Yt(hn.changes)(t),h=Yt(Hi)(r);function p(){var y=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(S){return S};return hn.selector(y),y(r.current)}function C(y){Mi(c,u,m,h)(y)}return[p,C]}function Hi(t,n){return sn(n)?n(t.current):n}function $i(t,n){return t.current=$n($n({},t.current),n),n}function Ki(t,n,r){return sn(n)?n(t.current):Object.keys(r).forEach(function(c){var u;return(u=n[c])===null||u===void 0?void 0:u.call(n,t.current[c])}),r}var Wi={create:zi},Ji={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.55.1/min/vs"}};function Xi(t){return function n(){for(var r=this,c=arguments.length,u=new Array(c),m=0;m<c;m++)u[m]=arguments[m];return u.length>=t.length?t.apply(this,u):function(){for(var h=arguments.length,p=new Array(h),C=0;C<h;C++)p[C]=arguments[C];return n.apply(r,[].concat(u,p))}}}function Qi(t){return{}.toString.call(t).includes("Object")}function Zi(t){return t||Kn("configIsRequired"),Qi(t)||Kn("configType"),t.urls?(Yi(),{paths:{vs:t.urls.monacoBase}}):t}function Yi(){console.warn(ts.deprecation)}function ea(t,n){throw new Error(t[n]||t.default)}var ts={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},Kn=Xi(ea)(ts),ta={config:Zi},na=function(){for(var n=arguments.length,r=new Array(n),c=0;c<n;c++)r[c]=arguments[c];return function(u){return r.reduceRight(function(m,h){return h(m)},u)}};function ns(t,n){return Object.keys(n).forEach(function(r){n[r]instanceof Object&&t[r]&&Object.assign(n[r],ns(t[r],n[r]))}),zn(zn({},t),n)}var sa={type:"cancelation",msg:"operation is manually canceled"};function wn(t){var n=!1,r=new Promise(function(c,u){t.then(function(m){return n?u(sa):c(m)}),t.catch(u)});return r.cancel=function(){return n=!0},r}var ra=["monaco"],ia=Wi.create({config:Ji,isInitialized:!1,resolve:null,reject:null,monaco:null}),ss=Ti(ia,2),rn=ss[0],Sn=ss[1];function aa(t){var n=ta.config(t),r=n.monaco,c=ki(n,ra);Sn(function(u){return{config:ns(u.config,c),monaco:r}})}function oa(){var t=rn(function(n){var r=n.monaco,c=n.isInitialized,u=n.resolve;return{monaco:r,isInitialized:c,resolve:u}});if(!t.isInitialized){if(Sn({isInitialized:!0}),t.monaco)return t.resolve(t.monaco),wn(In);if(window.monaco&&window.monaco.editor)return rs(window.monaco),t.resolve(window.monaco),wn(In);na(la,da)(ua)}return wn(In)}function la(t){return document.body.appendChild(t)}function ca(t){var n=document.createElement("script");return t&&(n.src=t),n}function da(t){var n=rn(function(c){var u=c.config,m=c.reject;return{config:u,reject:m}}),r=ca("".concat(n.config.paths.vs,"/loader.js"));return r.onload=function(){return t()},r.onerror=n.reject,r}function ua(){var t=rn(function(r){var c=r.config,u=r.resolve,m=r.reject;return{config:c,resolve:u,reject:m}}),n=window.require;n.config(t.config),n(["vs/editor/editor.main"],function(r){var c=r.m||r;rs(c),t.resolve(c)},function(r){t.reject(r)})}function rs(t){rn().monaco||Sn({monaco:t})}function pa(){return rn(function(t){var n=t.monaco;return n})}var In=new Promise(function(t,n){return Sn({resolve:t,reject:n})}),is={config:aa,init:oa,__getMonacoInstance:pa},ma={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},An=ma,ga={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},ha=ga;function xa({children:t}){return Et.createElement("div",{style:ha.container},t)}var fa=xa,ba=fa;function va({width:t,height:n,isEditorReady:r,loading:c,_ref:u,className:m,wrapperProps:h}){return Et.createElement("section",{style:{...An.wrapper,width:t,height:n},...h},!r&&Et.createElement(ba,null,c),Et.createElement("div",{ref:u,style:{...An.fullWidth,...!r&&An.hide},className:m}))}var Sa=va,as=o.memo(Sa);function ya(t){o.useEffect(t,[])}var os=ya;function _a(t,n,r=!0){let c=o.useRef(!0);o.useEffect(c.current||!r?()=>{c.current=!1}:t,n)}var Ke=_a;function en(){}function Ht(t,n,r,c){return Ca(t,c)||wa(t,n,r,c)}function Ca(t,n){return t.editor.getModel(ls(t,n))}function wa(t,n,r,c){return t.editor.createModel(n,r,c?ls(t,c):void 0)}function ls(t,n){return t.Uri.parse(n)}function Ia({original:t,modified:n,language:r,originalLanguage:c,modifiedLanguage:u,originalModelPath:m,modifiedModelPath:h,keepCurrentOriginalModel:p=!1,keepCurrentModifiedModel:C=!1,theme:y="light",loading:S="Loading...",options:U={},height:G="100%",width:te="100%",className:O,wrapperProps:X={},beforeMount:Y=en,onMount:I=en}){let[T,k]=o.useState(!1),[f,b]=o.useState(!0),E=o.useRef(null),A=o.useRef(null),P=o.useRef(null),K=o.useRef(I),F=o.useRef(Y),W=o.useRef(!1);os(()=>{let H=is.init();return H.then(V=>(A.current=V)&&b(!1)).catch(V=>(V==null?void 0:V.type)!=="cancelation"&&console.error("Monaco initialization: error:",V)),()=>E.current?ge():H.cancel()}),Ke(()=>{if(E.current&&A.current){let H=E.current.getOriginalEditor(),V=Ht(A.current,t||"",c||r||"text",m||"");V!==H.getModel()&&H.setModel(V)}},[m],T),Ke(()=>{if(E.current&&A.current){let H=E.current.getModifiedEditor(),V=Ht(A.current,n||"",u||r||"text",h||"");V!==H.getModel()&&H.setModel(V)}},[h],T),Ke(()=>{let H=E.current.getModifiedEditor();H.getOption(A.current.editor.EditorOption.readOnly)?H.setValue(n||""):n!==H.getValue()&&(H.executeEdits("",[{range:H.getModel().getFullModelRange(),text:n||"",forceMoveMarkers:!0}]),H.pushUndoStop())},[n],T),Ke(()=>{var H,V;(V=(H=E.current)==null?void 0:H.getModel())==null||V.original.setValue(t||"")},[t],T),Ke(()=>{let{original:H,modified:V}=E.current.getModel();A.current.editor.setModelLanguage(H,c||r||"text"),A.current.editor.setModelLanguage(V,u||r||"text")},[r,c,u],T),Ke(()=>{var H;(H=A.current)==null||H.editor.setTheme(y)},[y],T),Ke(()=>{var H;(H=E.current)==null||H.updateOptions(U)},[U],T);let z=o.useCallback(()=>{var ie;if(!A.current)return;F.current(A.current);let H=Ht(A.current,t||"",c||r||"text",m||""),V=Ht(A.current,n||"",u||r||"text",h||"");(ie=E.current)==null||ie.setModel({original:H,modified:V})},[r,n,u,t,c,m,h]),re=o.useCallback(()=>{var H;!W.current&&P.current&&(E.current=A.current.editor.createDiffEditor(P.current,{automaticLayout:!0,...U}),z(),(H=A.current)==null||H.editor.setTheme(y),k(!0),W.current=!0)},[U,y,z]);o.useEffect(()=>{T&&K.current(E.current,A.current)},[T]),o.useEffect(()=>{!f&&!T&&re()},[f,T,re]);function ge(){var V,ie,le,xe;let H=(V=E.current)==null?void 0:V.getModel();p||((ie=H==null?void 0:H.original)==null||ie.dispose()),C||((le=H==null?void 0:H.modified)==null||le.dispose()),(xe=E.current)==null||xe.dispose()}return Et.createElement(as,{width:te,height:G,isEditorReady:T,loading:S,_ref:P,className:O,wrapperProps:X})}var Aa=Ia;o.memo(Aa);function Pa(t){let n=o.useRef();return o.useEffect(()=>{n.current=t},[t]),n.current}var ka=Pa,xn=new Map;function ja({defaultValue:t,defaultLanguage:n,defaultPath:r,value:c,language:u,path:m,theme:h="light",line:p,loading:C="Loading...",options:y={},overrideServices:S={},saveViewState:U=!0,keepCurrentModel:G=!1,width:te="100%",height:O="100%",className:X,wrapperProps:Y={},beforeMount:I=en,onMount:T=en,onChange:k,onValidate:f=en}){let[b,E]=o.useState(!1),[A,P]=o.useState(!0),K=o.useRef(null),F=o.useRef(null),W=o.useRef(null),z=o.useRef(T),re=o.useRef(I),ge=o.useRef(),H=o.useRef(c),V=ka(m),ie=o.useRef(!1),le=o.useRef(!1);os(()=>{let R=is.init();return R.then(Q=>(K.current=Q)&&P(!1)).catch(Q=>(Q==null?void 0:Q.type)!=="cancelation"&&console.error("Monaco initialization: error:",Q)),()=>F.current?ne():R.cancel()}),Ke(()=>{var Q,oe,pe,Se;let R=Ht(K.current,t||c||"",n||u||"",m||r||"");R!==((Q=F.current)==null?void 0:Q.getModel())&&(U&&xn.set(V,(oe=F.current)==null?void 0:oe.saveViewState()),(pe=F.current)==null||pe.setModel(R),U&&((Se=F.current)==null||Se.restoreViewState(xn.get(m))))},[m],b),Ke(()=>{var R;(R=F.current)==null||R.updateOptions(y)},[y],b),Ke(()=>{!F.current||c===void 0||(F.current.getOption(K.current.editor.EditorOption.readOnly)?F.current.setValue(c):c!==F.current.getValue()&&(le.current=!0,F.current.executeEdits("",[{range:F.current.getModel().getFullModelRange(),text:c,forceMoveMarkers:!0}]),F.current.pushUndoStop(),le.current=!1))},[c],b),Ke(()=>{var Q,oe;let R=(Q=F.current)==null?void 0:Q.getModel();R&&u&&((oe=K.current)==null||oe.editor.setModelLanguage(R,u))},[u],b),Ke(()=>{var R;p!==void 0&&((R=F.current)==null||R.revealLine(p))},[p],b),Ke(()=>{var R;(R=K.current)==null||R.editor.setTheme(h)},[h],b);let xe=o.useCallback(()=>{var R;if(!(!W.current||!K.current)&&!ie.current){re.current(K.current);let Q=m||r,oe=Ht(K.current,c||t||"",n||u||"",Q||"");F.current=(R=K.current)==null?void 0:R.editor.create(W.current,{model:oe,automaticLayout:!0,...y},S),U&&F.current.restoreViewState(xn.get(Q)),K.current.editor.setTheme(h),p!==void 0&&F.current.revealLine(p),E(!0),ie.current=!0}},[t,n,r,c,u,m,y,S,U,h,p]);o.useEffect(()=>{b&&z.current(F.current,K.current)},[b]),o.useEffect(()=>{!A&&!b&&xe()},[A,b,xe]),H.current=c,o.useEffect(()=>{var R,Q;b&&k&&((R=ge.current)==null||R.dispose(),ge.current=(Q=F.current)==null?void 0:Q.onDidChangeModelContent(oe=>{le.current||k(F.current.getValue(),oe)}))},[b,k]),o.useEffect(()=>{if(b){let R=K.current.editor.onDidChangeMarkers(Q=>{var pe;let oe=(pe=F.current.getModel())==null?void 0:pe.uri;if(oe&&Q.find(Se=>Se.path===oe.path)){let Se=K.current.editor.getModelMarkers({resource:oe});f==null||f(Se)}});return()=>{R==null||R.dispose()}}return()=>{}},[b,f]);function ne(){var R,Q;(R=ge.current)==null||R.dispose(),G?U&&xn.set(m,F.current.saveViewState()):(Q=F.current.getModel())==null||Q.dispose(),F.current.dispose()}return Et.createElement(as,{width:te,height:O,isEditorReady:b,loading:C,_ref:W,className:X,wrapperProps:Y})}var Ta=ja,Ea=o.memo(Ta),Ra=Ea;/*! Capacitor: https://capacitorjs.com/ - MIT License */const Na=t=>{const n=new Map;n.set("web",{name:"web"});const r=t.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:n},c=(m,h)=>{r.platforms.set(m,h)},u=m=>{r.platforms.has(m)&&(r.currentPlatform=r.platforms.get(m))};return r.addPlatform=c,r.setPlatform=u,r},Da=t=>t.CapacitorPlatforms=Na(t),cs=Da(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});cs.addPlatform;cs.setPlatform;var Jt;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(Jt||(Jt={}));class Pn extends Error{constructor(n,r,c){super(n),this.message=n,this.code=r,this.data=c}}const Ma=t=>{var n,r;return t!=null&&t.androidBridge?"android":!((r=(n=t==null?void 0:t.webkit)===null||n===void 0?void 0:n.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},qa=t=>{var n,r,c,u,m;const h=t.CapacitorCustomPlatform||null,p=t.Capacitor||{},C=p.Plugins=p.Plugins||{},y=t.CapacitorPlatforms,S=()=>h!==null?h.name:Ma(t),U=((n=y==null?void 0:y.currentPlatform)===null||n===void 0?void 0:n.getPlatform)||S,G=()=>U()!=="web",te=((r=y==null?void 0:y.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||G,O=A=>{const P=f.get(A);return!!(P!=null&&P.platforms.has(U())||I(A))},X=((c=y==null?void 0:y.currentPlatform)===null||c===void 0?void 0:c.isPluginAvailable)||O,Y=A=>{var P;return(P=p.PluginHeaders)===null||P===void 0?void 0:P.find(K=>K.name===A)},I=((u=y==null?void 0:y.currentPlatform)===null||u===void 0?void 0:u.getPluginHeader)||Y,T=A=>t.console.error(A),k=(A,P,K)=>Promise.reject(`${K} does not have an implementation of "${P}".`),f=new Map,b=(A,P={})=>{const K=f.get(A);if(K)return console.warn(`Capacitor plugin "${A}" already registered. Cannot register plugins twice.`),K.proxy;const F=U(),W=I(A);let z;const re=async()=>(!z&&F in P?z=typeof P[F]=="function"?z=await P[F]():z=P[F]:h!==null&&!z&&"web"in P&&(z=typeof P.web=="function"?z=await P.web():z=P.web),z),ge=(ne,R)=>{var Q,oe;if(W){const pe=W==null?void 0:W.methods.find(Se=>R===Se.name);if(pe)return pe.rtype==="promise"?Se=>p.nativePromise(A,R.toString(),Se):(Se,Ee)=>p.nativeCallback(A,R.toString(),Se,Ee);if(ne)return(Q=ne[R])===null||Q===void 0?void 0:Q.bind(ne)}else{if(ne)return(oe=ne[R])===null||oe===void 0?void 0:oe.bind(ne);throw new Pn(`"${A}" plugin is not implemented on ${F}`,Jt.Unimplemented)}},H=ne=>{let R;const Q=(...oe)=>{const pe=re().then(Se=>{const Ee=ge(Se,ne);if(Ee){const Ge=Ee(...oe);return R=Ge==null?void 0:Ge.remove,Ge}else throw new Pn(`"${A}.${ne}()" is not implemented on ${F}`,Jt.Unimplemented)});return ne==="addListener"&&(pe.remove=async()=>R()),pe};return Q.toString=()=>`${ne.toString()}() { [capacitor code] }`,Object.defineProperty(Q,"name",{value:ne,writable:!1,configurable:!1}),Q},V=H("addListener"),ie=H("removeListener"),le=(ne,R)=>{const Q=V({eventName:ne},R),oe=async()=>{const Se=await Q;ie({eventName:ne,callbackId:Se},R)},pe=new Promise(Se=>Q.then(()=>Se({remove:oe})));return pe.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await oe()},pe},xe=new Proxy({},{get(ne,R){switch(R){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return W?le:V;case"removeListener":return ie;default:return H(R)}}});return C[A]=xe,f.set(A,{name:A,proxy:xe,platforms:new Set([...Object.keys(P),...W?[F]:[]])}),xe},E=((m=y==null?void 0:y.currentPlatform)===null||m===void 0?void 0:m.registerPlugin)||b;return p.convertFileSrc||(p.convertFileSrc=A=>A),p.getPlatform=U,p.handleError=T,p.isNativePlatform=te,p.isPluginAvailable=X,p.pluginMethodNoop=k,p.registerPlugin=E,p.Exception=Pn,p.DEBUG=!!p.DEBUG,p.isLoggingEnabled=!!p.isLoggingEnabled,p.platform=p.getPlatform(),p.isNative=p.isNativePlatform(),p},La=t=>t.Capacitor=qa(t),Xt=La(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Mn=Xt.registerPlugin;Xt.Plugins;class ds{constructor(n){this.listeners={},this.retainedEventArguments={},this.windowListeners={},n&&(console.warn(`Capacitor WebPlugin "${n.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=n)}addListener(n,r){let c=!1;this.listeners[n]||(this.listeners[n]=[],c=!0),this.listeners[n].push(r);const m=this.windowListeners[n];m&&!m.registered&&this.addWindowListener(m),c&&this.sendRetainedArgumentsForEvent(n);const h=async()=>this.removeListener(n,r);return Promise.resolve({remove:h})}async removeAllListeners(){this.listeners={};for(const n in this.windowListeners)this.removeWindowListener(this.windowListeners[n]);this.windowListeners={}}notifyListeners(n,r,c){const u=this.listeners[n];if(!u){if(c){let m=this.retainedEventArguments[n];m||(m=[]),m.push(r),this.retainedEventArguments[n]=m}return}u.forEach(m=>m(r))}hasListeners(n){return!!this.listeners[n].length}registerWindowListener(n,r){this.windowListeners[r]={registered:!1,windowEventName:n,pluginEventName:r,handler:c=>{this.notifyListeners(r,c)}}}unimplemented(n="not implemented"){return new Xt.Exception(n,Jt.Unimplemented)}unavailable(n="not available"){return new Xt.Exception(n,Jt.Unavailable)}async removeListener(n,r){const c=this.listeners[n];if(!c)return;const u=c.indexOf(r);this.listeners[n].splice(u,1),this.listeners[n].length||this.removeWindowListener(this.windowListeners[n])}addWindowListener(n){window.addEventListener(n.windowEventName,n.handler),n.registered=!0}removeWindowListener(n){n&&(window.removeEventListener(n.windowEventName,n.handler),n.registered=!1)}sendRetainedArgumentsForEvent(n){const r=this.retainedEventArguments[n];r&&(delete this.retainedEventArguments[n],r.forEach(c=>{this.notifyListeners(n,c)}))}}const Wn=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Jn=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Ua extends ds{async getCookies(){const n=document.cookie,r={};return n.split(";").forEach(c=>{if(c.length<=0)return;let[u,m]=c.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");u=Jn(u).trim(),m=Jn(m).trim(),r[u]=m}),r}async setCookie(n){try{const r=Wn(n.key),c=Wn(n.value),u=`; expires=${(n.expires||"").replace("expires=","")}`,m=(n.path||"/").replace("path=",""),h=n.url!=null&&n.url.length>0?`domain=${n.url}`:"";document.cookie=`${r}=${c||""}${u}; path=${m}; ${h};`}catch(r){return Promise.reject(r)}}async deleteCookie(n){try{document.cookie=`${n.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{const n=document.cookie.split(";")||[];for(const r of n)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(n){return Promise.reject(n)}}async clearAllCookies(){try{await this.clearCookies()}catch(n){return Promise.reject(n)}}}Mn("CapacitorCookies",{web:()=>new Ua});const Oa=async t=>new Promise((n,r)=>{const c=new FileReader;c.onload=()=>{const u=c.result;n(u.indexOf(",")>=0?u.split(",")[1]:u)},c.onerror=u=>r(u),c.readAsDataURL(t)}),Ga=(t={})=>{const n=Object.keys(t);return Object.keys(t).map(u=>u.toLocaleLowerCase()).reduce((u,m,h)=>(u[m]=t[n[h]],u),{})},Fa=(t,n=!0)=>t?Object.entries(t).reduce((c,u)=>{const[m,h]=u;let p,C;return Array.isArray(h)?(C="",h.forEach(y=>{p=n?encodeURIComponent(y):y,C+=`${m}=${p}&`}),C.slice(0,-1)):(p=n?encodeURIComponent(h):h,C=`${m}=${p}`),`${c}&${C}`},"").substr(1):null,Va=(t,n={})=>{const r=Object.assign({method:t.method||"GET",headers:t.headers},n),u=Ga(t.headers)["content-type"]||"";if(typeof t.data=="string")r.body=t.data;else if(u.includes("application/x-www-form-urlencoded")){const m=new URLSearchParams;for(const[h,p]of Object.entries(t.data||{}))m.set(h,p);r.body=m.toString()}else if(u.includes("multipart/form-data")||t.data instanceof FormData){const m=new FormData;if(t.data instanceof FormData)t.data.forEach((p,C)=>{m.append(C,p)});else for(const p of Object.keys(t.data))m.append(p,t.data[p]);r.body=m;const h=new Headers(r.headers);h.delete("content-type"),r.headers=h}else(u.includes("application/json")||typeof t.data=="object")&&(r.body=JSON.stringify(t.data));return r};class Ba extends ds{async request(n){const r=Va(n,n.webFetchExtra),c=Fa(n.params,n.shouldEncodeUrlParams),u=c?`${n.url}?${c}`:n.url,m=await fetch(u,r),h=m.headers.get("content-type")||"";let{responseType:p="text"}=m.ok?n:{};h.includes("application/json")&&(p="json");let C,y;switch(p){case"arraybuffer":case"blob":y=await m.blob(),C=await Oa(y);break;case"json":C=await m.json();break;case"document":case"text":default:C=await m.text()}const S={};return m.headers.forEach((U,G)=>{S[G]=U}),{data:C,headers:S,status:m.status,url:m.url}}async get(n){return this.request(Object.assign(Object.assign({},n),{method:"GET"}))}async post(n){return this.request(Object.assign(Object.assign({},n),{method:"POST"}))}async put(n){return this.request(Object.assign(Object.assign({},n),{method:"PUT"}))}async patch(n){return this.request(Object.assign(Object.assign({},n),{method:"PATCH"}))}async delete(n){return this.request(Object.assign(Object.assign({},n),{method:"DELETE"}))}}Mn("CapacitorHttp",{web:()=>new Ba});var vn;(function(t){t.Documents="DOCUMENTS",t.Data="DATA",t.Library="LIBRARY",t.Cache="CACHE",t.External="EXTERNAL",t.ExternalStorage="EXTERNAL_STORAGE"})(vn||(vn={}));var Tn;(function(t){t.UTF8="utf8",t.ASCII="ascii",t.UTF16="utf16"})(Tn||(Tn={}));const Xn=Mn("Filesystem",{web:()=>nn(()=>import("./web-v200-Bh8qEHuC.js"),__vite__mapDeps([0,1,2])).then(t=>new t.FilesystemWeb)});/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ue=(t,n)=>{const r=o.forwardRef(({className:c,...u},m)=>o.createElement($a,{ref:m,iconNode:n,className:us(`lucide-${za(t)}`,c),...u}));return r.displayName=`${t}`,r};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ka=ue("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const kn=ue("Ban",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m4.9 4.9 14.2 14.2",key:"1m5liu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ps=ue("Box",[["path",{d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z",key:"hh9hay"}],["path",{d:"m3.3 7 8.7 5 8.7-5",key:"g66t2b"}],["path",{d:"M12 22V12",key:"d0xqtd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wa=ue("ChevronDown",[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ja=ue("ChevronUp",[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ms=ue("CircleCheck",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
Réponds UNIQUEMENT avec le JSON demandé.`,ko=Object.freeze(Object.defineProperty({__proto__:null,SYSTEM_PROMPT:Dn},Symbol.toStringTag,{value:"Module"}));function hs(t,n,r,c,u){let m=!1;t&&t.includes("[DESIGN RIP]")&&(m=!0,t=t.replace("[DESIGN RIP]","").trim());let h="";r?h=`
...
L'orchestrateur prend le relais pour générer le Backend et intégrer les composants.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(q=>{console.error(q),alert("Erreur: Le moteur n'a pas pu être contacté.")});return}if(typeof window<"u"&&(window.open("https://stitch.withgoogle.com/","_blank"),window.dispatchEvent(new CustomEvent("open-mouchard"))),Number(I)===0){w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:"stitch",start_index:1,zip_mode:!0,start_phase:0,auto_pilot:te,instructions:fe||"Génère l'application avec ces packs et directives.",packs:se})}).then(q=>q?q.json():null).then(q=>{var ut;const he=(q==null?void 0:q.prompt)||((ut=q==null?void 0:q.data)==null?void 0:ut.prompt)||"Génération UI/UX Stitch complète.",Ce=se.length>0?se.join(", "):"standard";if(T(2),typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase","2"),typeof document<"u"){const Me=document.getElementById("tiger-mega-prompt-overlay");Me&&Me.remove();const et=document.createElement("div");et.id="tiger-mega-prompt-overlay",et.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);backdrop-filter:blur(10px);z-index:999999;display:flex;align-items:center;justify-content:center;padding:16px;font-family:sans-serif;",et.innerHTML=`
                              ...
                              `,document.body.appendChild(et);const _t=document.getElementById("tiger-prompt-area"),Ue=document.getElementById("btn-copy-prompt"),Oe=document.getElementById("btn-close-prompt-overlay"),tt=document.getElementById("btn-open-stitch"),Bt=()=>{_t&&(_t.select(),_t.setSelectionRange(0,99999),document.execCommand("copy")),navigator.clipboard&&navigator.clipboard.writeText(he).catch(()=>{}),T(2),Ue&&(Ue.innerHTML="✅ COPIÉ DANS LE PRESSE-PAPIER !",Ue.style.background="linear-gradient(135deg,#10b981,#059669)",setTimeout(()=>{Ue&&(Ue.innerHTML="📋 COPIER LE MÉGA-PROMPT",Ue.style.background="linear-gradient(135deg,#06b6d4,#2563eb)")},3e3))};Ue&&(Ue.onclick=()=>{Bt(),T(2)}),Oe&&(Oe.onclick=()=>{et.remove(),T(2)}),tt&&(tt.onclick=()=>{window.open("https://stitch.withgoogle.com/","_blank"),T(2)}),Bt(),T(2)}}).catch(q=>{console.error(q),alert("Erreur de communication avec le serveur Kirov5.")});return}w("/api/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:"stitch",user_prompt:fe||"Génère l'application avec ces packs et directives.",packs:se,target_project:v,phase_num:1})}).then(q=>q?q.json():null).then(q=>{var Ce;const he=(q==null?void 0:q.prompt)||((Ce=q==null?void 0:q.data)==null?void 0:Ce.prompt)||"Génération UI/UX Stitch.";typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText(he).catch(()=>{}),alert(`🚀 PHASE 1 (STITCH UI/UX) INITIALISÉE !
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){it(a),at(!1);return}const l=s||localStorage.getItem("tiger_apiKey");if(!l||!l.startsWith("sk-")||l.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){it(a),at(!1);return}const _=new AbortController,d=setTimeout(()=>_.abort(),4e3),x=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${l}`},signal:_.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(d),x.ok){const j=await x.json(),M=JSON.parse(j.choices[0].message.content);M.news&&Array.isArray(M.news)&&M.news.length>0?it(M.news):it(a)}else x.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),it(a)}catch(l){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",l),it(a)}finally{at(!1)}},[]);o.useEffect(()=>{Mt()},[Mt]);const[Xe,ot]=o.useState(!1),[Ne,qt]=o.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Ve,vt]=o.useState([]),[Lt,un]=o.useState("");o.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let a=JSON.parse(s);if(!Array.isArray(a))throw new Error("Not an array");const l="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";a=a.map(_=>_.name==="fold"?{..._,colors:{..._.colors,"bg-app":l}}:_),vt(a)}catch{vt([])}else{const a={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};vt([a]),localStorage.setItem("tiger_saved_themes",JSON.stringify([a]))}},[]),o.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",Ne),Ne!=="random"){const a=((s=Ve.find(l=>l.name===Ne))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=a,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[Ne,Ve]);const Ie=()=>{if(!Lt.trim())return alert("Nom invalide");if(Ve.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":c("icon-settings",.8),"icon-ai":c("icon-ai",.8),"icon-projects":c("icon-projects",.8),"icon-packs":c("icon-packs",.8),"icon-news":c("icon-news",.8),"bg-app":c("bg-app",.9)},a={name:Lt.trim(),colors:s},l=[...Ve,a];vt(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),qt(a.name),un("")},_n=(s,a)=>{a.stopPropagation();const l=Ve.filter(_=>_.name!==s);vt(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),Ne===s&&qt("random")},Ut=s=>{Q(a=>a.includes(s)?a.filter(l=>l!==s):[...a,s])},[Qe,pn]=o.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});o.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(Qe))},[Qe]);const[Ot,Be]=o.useState(!0),[ze,ke]=o.useState(!0),[L,je]=o.useState(null),[He,mn]=o.useState(null),[De,Gt]=o.useState(null),[ve,nt]=o.useState(null),[Ft,lt]=o.useState(""),[st,Pt]=o.useState([]),[Ze,Qt]=o.useState(!1),[Ye,ct]=o.useState("idle"),[kt,$e]=o.useState([]),[St,gn]=o.useState(""),[jt,Vt]=o.useState(null),[ht,Cn]=o.useState([]),xt=o.useCallback(async()=>{try{let s=[];const a=Date.now();if(a-tn<3e4&&Wt.length>0)s=[...Wt];else try{const l=Ln(),_=await fetch("https://api.github.com/repos/turnzack/v0-reponse/releases",{headers:l?{Authorization:`Bearer ${l}`,Accept:"application/vnd.github.v3+json"}:{Accept:"application/vnd.github.v3+json"}});if(_.ok){const d=await _.json();if(Array.isArray(d)){const x=[];d.forEach(j=>{Array.isArray(j.assets)&&j.assets.forEach(M=>{var Z;(Z=M.name)!=null&&Z.endsWith(".apk")&&x.push({file:M.name,name:M.name.replace(".apk",""),sizeMb:(M.size/(1024*1024)).toFixed(1),url:M.browser_download_url})})}),Wt=x,tn=a,s=[...x]}}}catch{}try{const l=await w("http://localhost:5006/api/mobile/list-apks");if(l&&l.ok){const _=await l.json();_&&_.success&&Array.isArray(_.apks)&&(s=[...s,..._.apks])}else{const _=await fetch("/api/mobile/list-apks");if(_&&_.ok){const d=await _.json();d&&d.success&&Array.isArray(d.apks)&&(s=[...s,...d.apks])}}}catch{}if(s.length>0){const l=new Set,_=s.filter(d=>l.has(d.file.toLowerCase())?!1:(l.add(d.file.toLowerCase()),!0));Cn(_)}}catch(s){console.warn("[v0-apk] loadAvailableApks error",s)}},[]);o.useEffect(()=>{Ze&&xt()},[Ze,xt]),o.useEffect(()=>{let s,a=0;return Ye==="building"&&(s=setInterval(async()=>{try{const l=await w("http://localhost:5006/api/mobile/build-logs");if(l&&l.ok){a=0;const _=await l.json();_.logs&&_.logs.length>0&&$e(_.logs),_.isBuilding===!1&&_.result&&(_.result.success?(ct("success"),Vt(_.result.apkUrl)):ct("error"),clearInterval(s))}else a++,a>=3&&(clearInterval(s),ct("error"),$e(_=>[..._,`❌ Service de compilation mobile absent sur ce serveur (${l?l.status:"erreur réseau"}).`,"📱 Option 1 (Cloud) : Déclenchez le compilateur automatique Cloud Souverain.",`💻 Option 2 (Local) : Lancez 'python apk_builder.py --src ... --name ${St||L||"app"} --build' dans E:\\v0reponses\\v0-apk.`]))}catch(l){console.warn("Polling APK error",l)}},1500)),()=>{s&&clearInterval(s)}},[Ye,St,L]),o.useEffect(()=>{w("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))ne(s.projects.map(a=>({name:typeof a=="string"?a:a.project_id||a.title||a.name||"Projet",desc:"Projet local",bg:""})));else{const a=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:a?{Authorization:`Bearer ${a}`}:{}}).then(l=>l?l.json():null).then(l=>{l&&l.projects&&ne(l.projects.map(_=>({name:typeof _=="string"?_:_.project_id||_.title||_.name||"Projet",desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[dt,_e]=o.useState(null),[Zt,yt]=o.useState(""),[Tt,i]=o.useState(!1),[g,v]=o.useState(!1),D=o.useRef(null);o.useEffect(()=>{if(D.current=null,L==="v0-guest"||L==="V0-Guest")v(!0),_e("http://localhost:3007"),yt("http://localhost:3007"),D.current="http://localhost:3007";else if(L){v(!0);const s=De&&JSON.stringify(De).includes("next.config"),a=typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1",l=s?"http://localhost:3000":D.current||(a?`http://${window.location.hostname}:5173`:"http://localhost:5173");_e(l),yt(l),D.current=l}else v(!1),_e(null)},[L,De]),o.useEffect(()=>{const s=a=>{var l,_,d,x;if(((l=a.data)==null?void 0:l.type)==="CHANGE_PREVIEW_URL"){const j=a.data.route,M=j==="/"?"":`#${j}`;_e(Z=>{const J=Z?Z.split("#")[0]:"http://127.0.0.1:5175/";return`${J.endsWith("/")?J:`${J}/`}${M}`})}if(((_=a.data)==null?void 0:_.type)==="DESIGN_ELEMENT_CLICKED"||((d=a.data)==null?void 0:d.type)==="DESIGN_ELEMENT_DRAGGED"||((x=a.data)==null?void 0:x.type)==="DESIGN_ELEMENT_RESIZED"){const j=document.querySelector('iframe[title="Studio Admin Design"]');j&&j.contentWindow&&j.contentWindow.postMessage(a.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),o.useEffect(()=>{L&&w(`http://localhost:5006/api/fs/tree?project=${L}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&Gt(s.tree)}).catch(()=>{})},[L]),o.useEffect(()=>{L&&ve&&w(`http://localhost:5006/api/fs/read?project=${L}&file=${encodeURIComponent(ve)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&lt(s.content)}).catch(()=>{})},[L,ve]);const se=async s=>{if(s===void 0||!L||!ve)return;if(lt(s),Xt.isNativePlatform()||!!window.AndroidBridge)try{await Xn.writeFile({path:`v0-moteur-mobile/projetv0/${L}/${ve}`,data:s,directory:vn.Documents,encoding:Tn.UTF8,recursive:!0})}catch(l){console.error("Erreur de sauvegarde mobile:",l)}else w("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:L,file:ve,content:s})}).catch(()=>{})},q=s=>{L&&w(`http://localhost:5006/api/fs/read?project=${L}&file=${encodeURIComponent(s)}`).then(a=>a?a.json():null).then(a=>{a&&a.success&&Pt(l=>l.find(_=>_.path===s)?l:[...l,{path:s,content:a.content}])}).catch(()=>{})};o.useEffect(()=>{(async()=>{const a=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(Xt.isNativePlatform()||!!window.AndroidBridge)try{const d=(await Xn.readdir({path:"v0-moteur-mobile/projetv0",directory:vn.Documents})).files.map(x=>x.name||x.toString());ne(d.map((x,j)=>({name:x,desc:"Mémoire Téléphone",bg:a[j%a.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else w("http://localhost:5006/api/projects-v2").then(_=>_?_.json():null).then(_=>{if(_&&_.success&&_.projects)ne(_.projects.map((d,x)=>({name:typeof d=="string"?d:d.name||d.project_id||d.title||`Projet_${x}`,desc:"Environnement Local",bg:a[x%a.length],installed:d.installed})));else{const d=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:d?{Authorization:`Bearer ${d}`}:{}}).then(x=>x?x.json():null).then(x=>{x&&x.projects&&ne(x.projects.map((j,M)=>({name:typeof j=="string"?j:j.project_id||j.title||j.name||`Projet_${M}`,desc:"SaaS Cloud (Neon DB)",bg:a[M%a.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),o.useEffect(()=>{P(!0)},[]);const[he,Ce]=o.useState(!0);o.useEffect(()=>{const s=()=>Ce(!0),a=_=>{_&&_.detail&&le(d=>[_.detail,...d.slice(0,49)])};window.addEventListener("open-mouchard",s),window.addEventListener("kirov-mouchard-log",a);const l=_=>{if(_.data&&_.data.type==="TIGER_CAPTURE"){const d=_.data.data;if(d){let x="index.html";(d.includes("import React")||d.includes("export default"))&&(x="App.tsx"),d.includes("tailwindcss")&&(x="index.css"),nt(x),se(d),Gt(j=>{var J;const M={name:x,path:x,type:"file"};return j?((J=j.children)==null?void 0:J.find(B=>B.name===x))?j:{...j,children:[...j.children||[],M]}:{name:"Mobile_Storage",type:"directory",children:[M]}})}}};return window.addEventListener("message",l),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("kirov-mouchard-log",a),window.removeEventListener("message",l)}},[L,ve]),o.useEffect(()=>{if(!A)return;const s=()=>{w("http://localhost:5006/api/bridge/queue").then(l=>l?l.json():null).then(l=>{l&&l.success&&(setBridgeQueueData({current:l.current||{},queue:l.queue||[]}),(l.queue&&l.queue.length>0||l.current&&Object.keys(l.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),w("http://localhost:5006/api/bridge/logs").then(l=>l?l.json():null).then(l=>{var _,d;if(l&&l.success&&l.logs){le(M=>{const J=[...M.filter(Ae=>(Ae.includes("[📱")||Ae.includes("v0-apk")||Ae.includes("[APK]"))&&!l.logs.includes(Ae)),...l.logs],B=new Set,be=[];for(const Ae of J)B.has(Ae)||(B.add(Ae),be.push(Ae));return be.slice(0,50)});const x=[...l.logs].reverse().find(M=>M.includes("URL_PREVIEW="));if(x){let M=(_=x.split("URL_PREVIEW=")[1])==null?void 0:_.trim();M&&typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"&&(M=M.replace(/localhost|127\.0\.0\.1/,window.location.hostname)),M&&M!==D.current&&(D.current=M,_e(M),yt(M),v(!0))}const j=[...l.logs].reverse().find(M=>M.includes("PIPELINE COMPLET TERMINÉ avec succès pour "));if(j){const M=(d=j.split("PIPELINE COMPLET TERMINÉ avec succès pour ")[1])==null?void 0:d.replace(/[.\s]+$/,"");M&&L!==M&&(je(M),v(!0))}}}).catch(()=>{}),w("http://localhost:5006/api/bridge/autonomous-status").then(l=>l?l.json():null).then(l=>{if(l&&l.success&&(l.data||l.status)){const d=(l.data||l.status).state;d==="diagnosing"||d==="repair_required"||d==="error"?f("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(d)||["starting_server","launch_requested","restarting"].includes(d)?f("working"):d==="ready"?f("clean"):L&&w(`http://localhost:5006/api/suture/status?project=${L}`).then(x=>x?x.json():null).then(x=>{x&&x.success&&x.status&&f(x.status)}).catch(()=>{})}}).catch(()=>{})};s();const a=setInterval(s,2e3);return()=>clearInterval(a)},[A,L]);const ut=s=>{je(s),nt(null),lt(""),i(!1),Ce(!1),v(!1),w("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:s,open_explorer:!1})}).then(async a=>{if(a&&a.ok){const l=await a.json().catch(()=>null);l!=null&&l.previewUrl&&(_e(l.previewUrl),yt(l.previewUrl))}}).catch(a=>console.error("Erreur de lancement preview:",a)),w(`http://localhost:5006/api/fs/tree?project=${encodeURIComponent(s)}`).then(a=>a?a.json():null).then(a=>{if(a&&a.success&&a.tree){Gt(a.tree);const l=d=>{if(!d)return null;if(d.type==="file"&&(d.path==="src/App.tsx"||d.path==="src/App.jsx"||d.name==="App.tsx"||d.name==="index.html"))return d.path;if(d.children&&Array.isArray(d.children))for(const x of d.children){const j=l(x);if(j)return j}return null},_=l(a.tree);_&&nt(_)}}).catch(a=>console.error("Erreur chargement arborescence:",a))},Me=s=>{const a=typeof s=="string"?s:y;if(!a.trim())return;const l={id:Date.now().toString(),role:"user",content:a};C(d=>[...d,l]);const _=a.toLowerCase();setTimeout(()=>{let d={id:(Date.now()+1).toString(),role:"assistant",content:""};const x=_.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(x==="mes projets"||x.includes("liste des projet")||x==="projet"||x==="projets")d.content="Voici la liste de vos projets récents :",d.widget="projects";else if((x.includes("stitch")||x.includes("deepseek")||x.includes("design")||x.includes("logique"))&&(x.includes("modifi")||x.includes("ajoute")||x.includes("change")||x.includes("mise a jour")||x.includes("evolue")||x.includes("reprends")||x.includes("continue"))){const j=a.match(/\[(.*?)\]/),M=j?j[1]:null,Z=x.includes("deepseek")?"deepseek":"stitch";d.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${Z.toUpperCase()}) 🔄
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,d.widget="phases",E(1);const j=L||(ye.trim()?ye.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+a.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(je(j),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",j),typeof window<"u"){const J=localStorage.getItem("tiger_targetAi")||"deepseek",B=localStorage.getItem("tiger_targetUiAi")||"stitch",be=($,me=!1)=>mt($,me),Ae=window.AndroidBridge;if(Ae&&Ae.openAIWithPrompt)Ae.openAIWithPrompt(be(B,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+a),Ae.showToast&&Ae.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const $=R&&R.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${R.length})]
`+R.map(Pe=>{const de=$t.find(we=>we.id===Pe);return`• ${de?de.name:Pe} (#${Pe})`}).join(`
`):"",me="Génère l'interface UI/UX complète et moderne pour ce projet : "+a+$;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(me)}catch{}const rt=()=>w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:B,prompt:me,auto_submit:!0,project_id:j,phase_num:1,packs:R})});Qe!==200&&(ze?window.open(be(B,!0),"kirov5_ai_target"):window.open(be(B,!0),"_blank"),rt().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(Pe=>console.error("Erreur sendUiPrompt",Pe))),setTimeout(()=>{const Pe=R&&R.length>0?a+$:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+a+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(Pe)}catch{}window.open(be(J),"_blank"),w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,prompt:Pe,auto_submit:!0,project_id:j,phase_num:1,packs:R})}).catch(de=>console.log("Erreur Bridge Logic Prompt:",de)),R&&R.length>0?w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,user_prompt:Pe,packs:R,target_project:j})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(de=>{console.log("Erreur Trombone Bridge:",de)}):w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,prompt:Pe,auto_submit:!0,project_id:j,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}E(1);let M=1;const Z=setInterval(()=>{M++,M>11?clearInterval(Z):E(M)},1500)}else if(x.includes("youtube")||x.includes("video"))d.content="Voici les résultats YouTube pour votre recherche :",d.widget="youtube";else if(x.includes("actualite")||x.includes("ia")||x.includes("news")||x.includes("recherche")){const j=localStorage.getItem("tiger_apiKey");d.content="Actualités & Dernières Innovations IA :",d.widget="news",Mt(j||void 0)}else if(x.includes("parametre")||x.includes("reglage")||x.includes("configuration")||x.includes("setting"))d.content="Ouverture du panneau de configuration système :",d.widget="settings";else if(x.includes("[plugin:vite:")||x.includes("missing semicolon")||x.includes("syntaxerror")||x.includes("typescriptparsermixin")||x.includes("babel/parser")||x.includes("error")&&x.length>80){const j=L||"Projet_blog_8831";d.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${j}" avec la stack trace fournie... 🩺`,Oe("suture",a)}else if(d.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const j=window.AndroidBridge;j&&j.openAIWithPrompt?j.openAIWithPrompt("https://chat.deepseek.com/",a):window.open("https://chat.deepseek.com/","_blank")}C(j=>[...j,d])},600),S("")},et=async s=>{var Ae;let a=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],l=null;const _=a.filter($=>$.name.endsWith(".zip"));let d=[];if(_.length>0){C($=>[...$,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const $=(await nn(async()=>{const{default:me}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:me}},[])).default;for(const me of _){l=me;const Pe=await new $().loadAsync(me);for(const[de,we]of Object.entries(Pe.files))if(!we.dir&&!de.includes("__MACOSX")&&!((Ae=de.split("/").pop())!=null&&Ae.startsWith("."))){const qe=await we.async("blob"),pt=new File([qe],de.split("/").pop()||de,{type:qe.type});d.push(pt)}}}catch($){console.error("Erreur décompression ZIP:",$),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}for(const $ of _)try{const me=await $.arrayBuffer(),rt=arrayBufferToBase64(me);fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:L||H||ye||"AUDIO",fileName:$.name,fileBase64:rt})}).catch(de=>console.warn("[Upload ZIP Sync] Notice:",de))}catch{}}a=[...a.filter($=>!$.name.endsWith(".zip")),...d];const x=a.filter($=>$.name.endsWith(".html")),j=a.filter($=>!$.name.endsWith(".html")&&($.name.endsWith(".png")||$.name.endsWith(".jpg")||$.name.endsWith(".jpeg")||$.name.endsWith(".md")||$.name.endsWith(".json")||$.name.endsWith(".txt")||$.name.endsWith(".tsx")||$.name.endsWith(".ts")||$.name.endsWith(".jsx")||$.name.endsWith(".js")||$.name.endsWith(".css")||$.name.endsWith(".svg")));if(x.length===0&&j.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .tsx, .ts, .png, ou un .zip.");return}let M=[...st];for(const $ of j){const me=$.name.endsWith(".png")||$.name.endsWith(".jpg")||$.name.endsWith(".jpeg"),rt=await new Promise(de=>{const we=new FileReader;we.onload=qe=>{var pt;return de((pt=qe.target)==null?void 0:pt.result)},me?we.readAsDataURL($):we.readAsText($)}),Pe={path:$.name,content:me?`[Image jointe visuellement : ${$.name} (Binaire ignoré pour économie de tokens)]`:rt};M.some(de=>de.path===$.name)||M.push(Pe),C(de=>[...de,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${$.name}`}])}if(x.length>0){const $=x[0],me=await new Promise(de=>{const we=new FileReader;we.onload=qe=>{var pt;return de((pt=qe.target)==null?void 0:pt.result)},we.readAsText($)}),rt={path:$.name,content:me};M.some(de=>de.path===$.name)||M.push(rt);const Pe={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${$.name}
Analyse de la structure UI et assemblage du contexte en cours...`};C(de=>[...de,Pe])}const Z=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter($=>$.name.endsWith(".zip"));for(const $ of Z)M.some(me=>me.path===$.name)||M.push({path:$.name,content:"ZIP_ARCHIVE_DUMMY"});Pt(M);const J=L||ye||"Projet_Stitch",B=a.map($=>$.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${J}: ${B}`);const be=x.length;if(be>3){const $=localStorage.getItem("tiger_targetAi")||"deepseek",me=l?"Projet_ZIP_"+l.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),rt=L||me;L||je(rt),C(de=>[...de,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !

Hermes a détecté ${be} pages HTML dans votre ZIP.
Découpage automatique en lots de 3 fichiers en cours...
Démarrage de l'automatisation séquentielle via DeepSeek !`,widget:"phases"}]),E(1);let Pe="";if(l)Pe=await new Promise(de=>{const we=new FileReader;we.onload=qe=>{var pt;return de(((pt=qe.target)==null?void 0:pt.result).split(",")[1])},we.readAsDataURL(l)});else{const de=(await nn(async()=>{const{default:qe}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:qe}},[])).default,we=new de;for(const qe of a)we.file(qe.name,qe);Pe=await we.generateAsync({type:"base64"})}w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({zip_base64:Pe,zip_mode:!0,target_ai:$,target_project:rt,user_prompt:ye.trim()?`${ye} - ${ft}`:`Application multi-pages issue de ${(l==null?void 0:l.name)||"fichiers_locaux"}`})}).then(async de=>{const we=await de.json();we.success?(C(qe=>[...qe,{id:Date.now().toString()+"_hermes",role:"assistant",content:`✅ ${we.message}

📡 Lot 1/${we.total_batches} transmis à DeepSeek. Les lots suivants s'enchaîneront automatiquement !
Fichiers détectés : ${(we.files_detected||[]).join(", ")}`}]),window.open(mt($),"_blank")):alert("Erreur Hermes : "+(we.error||"Inconnue"))}).catch(de=>{alert(`Erreur de connexion au Moteur Local : ${de.message}`)});return}if(x.length>0){if(document.getElementById("creation-mode-container"))return;setTimeout(()=>{_t(M)},1200)}},_t=async(s=st)=>{Re(!1);const a=s.find(J=>J.path.endsWith(".html"));if(!a){alert("Aucun fichier HTML trouvé dans le Trombone !");return}const l=ye.trim()?"Projet_"+ye.replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4):"Design_"+a.path.replace(".html","").replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4),_=L||l;if(!L){je(_);try{await w("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:_,file:"README.md",content:`# ${ye||_}

Initialisé par Tiger IA V0 (Design-First).`})})}catch(J){console.error("[IDE] Erreur création auto du dossier",J)}}const d=s.filter(J=>J.path!==a.path),x=a.content,j={id:(Date.now()+1).toString(),role:"assistant",content:`Mode "Design-First" activé. 🎨
...
[Fichier: ${me.path}]
\`\`\`
${me.content.substring(0,3e3)}
\`\`\`
`}));let be="";(ye.trim()||We.trim()||ft.trim())&&(be=`
--- MÉTADONNÉES DU PROJET ---
Nom : ${ye||"Non spécifié"}
Stack / Structure : ${We||"Non spécifiée"}
Description & Objectifs : ${ft||"Non spécifiés"}
-----------------------------
`);const Ae=`Voici le code HTML/CSS d'une interface générée par Stitch.${be}
...
\`\`\`
`,$=window.AndroidBridge;if($&&$.openAIWithPrompt){const me=mt(J);$.openAIWithPrompt(me,Ae),$.showToast&&$.showToast("HTML injecté. Câblage sur "+J.toUpperCase()+" !")}else w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,prompt:Ae,auto_submit:!0,project_id:_,phase_num:5})}).then(me=>console.log("[Bridge] Prompt HTML + Contexte envoyé avec succès, status:",me.status)).catch(me=>console.error("[Bridge] Erreur lors de l'envoi du prompt:",me))}},Ue=(s,a=0)=>s?s.type==="directory"?e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-2 px-2 py-1 hover:bg-white/5 cursor-pointer text-gray-300 text-sm",style:{paddingLeft:`${a*12+8}px`},children:[e.jsx("span",{className:"text-orange-400",children:"📁"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-dossier truncate font-bold",children:s.name})]}),s.children&&s.children.map(l=>Ue(l,a+1))]},s.path):e.jsxs("div",{className:`flex items-center justify-between px-2 py-1 hover:bg-white/10 cursor-pointer text-sm group ${ve===s.path?"bg-cyan/20 text-cyan border-l-2 border-cyan":"text-gray-400"}`,style:{paddingLeft:`${a*12+8}px`},onClick:()=>nt(s.path),children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-blue-400",children:"📄"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-fichier truncate",children:s.name})]}),e.jsxs("div",{className:"hidden group-hover:flex items-center gap-1",children:[e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-red-500/50 transition-colors",title:"Suture : Réparer ou débugger ce fichier",onClick:l=>{l.stopPropagation(),nt(s.path),setTimeout(()=>Oe("suture","Veuillez analyser ce fichier et corriger toutes les erreurs, fautes de frappe ou imports manquants."),100)},children:"🩺"}),e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-cyan/50 transition-colors",title:"Ajouter au Trombone",onClick:l=>{l.stopPropagation(),q(s.path)},children:"📎"})]})]},s.path):null,Oe=async(s,a)=>{if(!L){alert("⚠️ Veuillez sélectionner un projet actif dans l'explorateur.");return}const l=localStorage.getItem("tiger_targetAi")||"deepseek";let _="";s==="suture"?_=`🩺 SUTURE CHIRURGICALE — CORRECTION D'ERREUR DÉTECTÉE
...
`):s==="refactor"?_=`🔄 REFACTORING — Refactorise le code du projet [${L}] pour une qualité industrielle.

`:s==="improve"&&(_=`✨ AMÉLIORATION — Ajoute des animations et améliorations UI pour le projet [${L}].

`),ve&&Ft&&(_+=`--- Fichier Actif en Édition : ${ve} ---
\`\`\`
${Ft}
\`\`\`
...
{
  "files": [
    { "path": "${ve||"src/App.tsx"}", "content": "..." }
  ]
}
\`\`\``,C(d=>[...d,{id:Date.now().toString()+"_action",role:"assistant",content:`🩺 Suture & Correction déclenchée pour "${L}". Transmission de l'erreur à ${l.toUpperCase()} en cours...`}]);try{if(await w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:l,prompt:_,auto_submit:!0,project_id:L,phase_num:s})}),s==="suture"){w("http://localhost:5006/v1/suture/start",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:L,activeFile:ve||"",rawError:a||"",prompt:a||"Analyse et corrige les erreurs du projet."})}).then(async x=>{const j=await x.json();j.success&&j.status==="applied"?C(M=>{var Z,J;return[...M,{id:Date.now().toString()+"_suture_ok",role:"assistant",content:`✅ Suture V2 réussie !

🔧 ${j.repairId}
🚀 Statut : **Patch appliqué en production**
📁 Fichiers corrigés : ${JSON.stringify(((J=(Z=j.patchReport)==null?void 0:Z.files)==null?void 0:J.map(B=>B.path))||[])}`}]}):j.success?C(M=>{var Z;return[...M,{id:Date.now().toString()+"_suture_partial",role:"assistant",content:`⚠️ Suture V2 : correctif généré mais non promu.
...
[PACKS PRD ARCHITECTURE SELECTIONNES (${R.length})]
`+R.map(B=>{const be=$t.find(Ae=>Ae.id===B);return`• ${be?be.name:B} (#${B})`}).join(`
`):"";let M=`

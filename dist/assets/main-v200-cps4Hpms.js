const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-Ds5B3YZ6.js","assets/design-v200-DbCZFsQC.js","assets/design-v200-BH1kPxk1.css"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ka=a.forwardRef(({color:t="currentColor",size:n=24,strokeWidth:r=2,absoluteStrokeWidth:c,className:u="",children:m,iconNode:g,...p},C)=>a.createElement("svg",{ref:C,...$a,width:n,height:n,stroke:t,strokeWidth:c?Number(r)*24/Number(n):r,className:ms("lucide",u),...p},[...g.map(([S,v])=>a.createElement(S,v)),...Array.isArray(m)?m:[m]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pe=(t,n)=>{const r=a.forwardRef(({className:c,...u},m)=>a.createElement(Ka,{ref:m,iconNode:n,className:ms(`lucide-${Ha(t)}`,c),...u}));return r.displayName=`${t}`,r};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-C-aL7A1s.js","assets/design-v200-t3YgdfE5.js","assets/design-v200-B0v9GGsU.css"])))=>i.map(i=>d[i]);
import{r as a,a as Et,j as e,s as I,i as us,R as ps}from"./design-v200-t3YgdfE5.js";const ms="modulepreload",gs=function(t){return"/"+t},Nn={},Zt=function(n,r,o){let d=Promise.resolve();if(r&&r.length>0){let m=function(v){return Promise.all(v.map(f=>Promise.resolve(f).then(L=>({status:"fulfilled",value:L}),L=>({status:"rejected",reason:L}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),_=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));d=m(r.map(v=>{if(v=gs(v),v in Nn)return;Nn[v]=!0;const f=v.endsWith(".css"),L=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${v}"]${L}`))return;const D=document.createElement("link");if(D.rel=f?"stylesheet":ms,f||(D.as="script"),D.crossOrigin="",D.href=v,_&&D.setAttribute("nonce",_),document.head.appendChild(D),f)return new Promise((K,A)=>{D.addEventListener("load",K),D.addEventListener("error",()=>A(new Error(`Unable to preload CSS for ${v}`)))})}))}function p(m){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=m,window.dispatchEvent(u),!u.defaultPrevented)throw m}return d.then(m=>{for(const u of m||[])u.status==="rejected"&&p(u.reason);return n().catch(p)})},hs=`# undefined
...
---
### 🔄 INSTRUCTION DE FUSION (Pour l'Orchestrateur API)
*Lorsque l'utilisateur sélectionnera ce pack "Audio" dans l'interface de Tiger IA, tu dois fusionner ces 10 capacités avec la demande précise du chat. Par exemple, si l'utilisateur demande "Crée moi un clone de Spotify", tu dois immédiatement mobiliser les modules \`prd_audio_file_library\`, \`prd_audio_player_podcast\` et \`prd_audio_mix_playlist\` pour générer une architecture complète en un seul shot.*`,bs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
## Instructions Originales
`,ys=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/commerce/pages/SuccessPage.tsx\``,_s=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/components/ui/Toast.tsx\``,Cs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/creator/components/SocialLinkButton.tsx\``,ws=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/handoff/components/RedlineViewer.tsx\``,Is=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/shop/contexts/CartContext.tsx\``,Ps=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- src/shared/constants/products.ts (données mock)`,js=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/events/components/TicketingCard.tsx\``,Ts=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/feed/hooks/useInfiniteFeed.ts\``,ks=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`/requirements.txt\` & \`/package.json\` (Gestion des dépendances isolées)`,Es=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/components/inputs/CreditCardInput.tsx\``,Rs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/forms/schemas/registrationSchema.ts\``,Ns=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/gamification/components/BadgeGrid.tsx\``,Ds=`# APK Forge — Intelligent Android Packaging Suite
...
---
`,Ms=`# Industrialisation_Backend_KIROV5
...
## Instructions Originales
`,qs=`# BRIC — Sovereign PRD Specification Pack
...
`,Ls=`# bricbrac — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Us=`# bros — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Os=`# BROSS — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Fs=`# Industrialisation_Backend_Phase5
...
MIT`,Vs=`# COLORFUL LANDING PAGE BUILDER
...
## License
MIT`,Bs=`# CyberRunner — Sovereign PRD Specification Pack
...
src/
  ...
  main.tsx
  index.css
\`\`\``,Ws=`# gametetris — Sovereign PRD Specification Pack
...
MIT`,Ys=`# mariob — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,er=`# 🚀 Pack PRD : Calculatrice Premium "One-Shot" (guest_nebula_calc)
...
Chaque composant doit être entièrement fonctionnel, avec des props typées, et utiliser les hooks appropriés. Le code doit être propre, commenté et suivre les meilleures pratiques React/TypeScript.`,nr=`> **Directive Système IA** : Tu es un Architecte Logiciel Senior et Expert en Product Design. Génère des composants React/TypeScript de haute qualité pour le jeu **NEONSTACK ARCADE**. Suis les directives du PRD, respecte le design system, et produis du code fonctionnel et esthétique.
...
src/
  ...
  App.tsx
  main.tsx
\`\`\``,sr=`# plateforme — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,rr=`# plateformv2 — Sovereign PRD Specification Pack
...
src/
  ...
  App.tsx
  main.tsx
\`\`\``,ar=`# PRODUCTION READY INDUSTRIALIZATION
...
## Instructions Originales
`,cr=`# SOVEREIGN PRODUCTION PLATFORM
...
`,fr=`# Workflow Automation Platform
...
└── utils/
    ├── constants.ts
    └── helpers.ts
\`\`\``,Sr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/health/components/BreathingCircle.tsx\``,yr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/utils/audioContext.ts\``,_r=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/images/hooks/useImageUpload.ts\``,Cr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/admin/components/EmptyState.tsx\``,wr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/game/types/engine.ts\``,Ir=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/landing/components/FooterCTA.tsx\``,Ar=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/saas-landing/components/ProductMockup.tsx\``,Pr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/layouts/KanbanLayout.tsx\``,jr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/maps/hooks/useGeolocation.ts\``,Tr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/markdown/components/TableOfContents.tsx\``,kr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/marketing/components/LeadCaptureForm.tsx\``,Er=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/mobile/components/SwipeActionContainer.tsx\``,Rr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/shell/components/BottomSheet.tsx\``,Nr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/mobile/components/SwipeableOnboarding.tsx\``,Dr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/api/apiClient.ts\` (Interface qui tape sur les mocks pour l'instant)`,Mr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/documents/components/ThumbnailSidebar.tsx\``,qr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/hooks/useFileUpload.ts\``,Lr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/ai.ts\` (interfaces Message, ChatSession, Attachment)`,Ur=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/voice/components/MicrophoneToggle.tsx\``,Or=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/auth/hooks/useSession.ts\``,Fr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/magazine/components/AuthorByline.tsx\``,Gr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/crm.ts\` (interfaces Contact, Activity, Tag)`,Vr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/catalog/hooks/useCatalogFilters.ts\``,Br=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/checkout/components/ExpressPayButtons.tsx\``,zr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
`,Hr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/leaderboard/components/StickyUserRank.tsx\``,Kr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/dashboard/pages/BentoDashboardPage.tsx\``,$r=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/kanban/hooks/useKanbanBoard.ts\``,Wr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
---
### 🔄 INSTRUCTION DE FUSION (Pour l'Orchestrateur API)
*Lorsque l'utilisateur demandera "Crée moi la structure de mon app mobile type Instagram", tu devras utiliser ce PRD Mobile comme squelette. Tu injecteras une Tab Bar en bas (Accueil, Recherche, Ajouter, Profil) et tu t'assureras que le défilement vertical n'affecte que le contenu intérieur (overflow-y-auto) sans faire bouger les barres de navigation natives.*`,Jr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/social/components/LikeAnimation.tsx\``,Xr=`# bricbrac — Sovereign PRD Specification Pack
...
- \`src/features/billing/components/InvoiceTable.tsx\``,Zr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/saas.ts\` (interfaces User, Tenant, Subscription)`,Yr=`# 🏛️ Pack PRD : Sovereign Full-Stack Engine
...
- \`src/features/specs/components/DynamicForm.tsx\``,ti=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/utils/timeFormat.ts\``,si=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/marketing/components/RoadmapBoard.tsx\``,ri=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/ai-studio/components/TokenCostChart.tsx\``,ii=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/saas/pages/BillingDashboard.tsx\``,ai=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/landing/components/ConversionSection.tsx\``,oi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/database/components/ResultDataTable.tsx\``,li=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/stealth/ui/FloatingGhostMenu.tsx\``,ci=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/editor/hooks/useEditorState.ts\``,di=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/video/hooks/useVideoPlayer.ts\``,pi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/blog/components/TableOfContents.tsx\``,mi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/widgets/hooks/useCalendarState.ts\``;function Dn(t,n){(n==null||n>t.length)&&(n=t.length);for(var r=0,o=Array(n);r<n;r++)o[r]=t[r];return o}function gi(t){if(Array.isArray(t))return t}function hi(t,n,r){return(n=_i(n))in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function xi(t,n){var r=t==null?null:typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(r!=null){var o,d,p,m,u=[],_=!0,v=!1;try{if(p=(r=r.call(t)).next,n!==0)for(;!(_=(o=p.call(r)).done)&&(u.push(o.value),u.length!==n);_=!0);}catch(f){v=!0,d=f}finally{try{if(!_&&r.return!=null&&(m=r.return(),Object(m)!==m))return}finally{if(v)throw d}}return u}}function fi(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Mn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(t);n&&(o=o.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,o)}return r}function qn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Mn(Object(r),!0).forEach(function(o){hi(t,o,r[o])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Mn(Object(r)).forEach(function(o){Object.defineProperty(t,o,Object.getOwnPropertyDescriptor(r,o))})}return t}function bi(t,n){if(t==null)return{};var r,o,d=vi(t,n);if(Object.getOwnPropertySymbols){var p=Object.getOwnPropertySymbols(t);for(o=0;o<p.length;o++)r=p[o],n.indexOf(r)===-1&&{}.propertyIsEnumerable.call(t,r)&&(d[r]=t[r])}return d}function vi(t,n){if(t==null)return{};var r={};for(var o in t)if({}.hasOwnProperty.call(t,o)){if(n.indexOf(o)!==-1)continue;r[o]=t[o]}return r}function Si(t,n){return gi(t)||xi(t,n)||Ci(t,n)||fi()}function yi(t,n){if(typeof t!="object"||!t)return t;var r=t[Symbol.toPrimitive];if(r!==void 0){var o=r.call(t,n);if(typeof o!="object")return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}function _i(t){var n=yi(t,"string");return typeof n=="symbol"?n:n+""}function Ci(t,n){if(t){if(typeof t=="string")return Dn(t,n);var r={}.toString.call(t).slice(8,-1);return r==="Object"&&t.constructor&&(r=t.constructor.name),r==="Map"||r==="Set"?Array.from(t):r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?Dn(t,n):void 0}}function wi(t,n,r){return n in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function Ln(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(t);n&&(o=o.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,o)}return r}function Un(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Ln(Object(r),!0).forEach(function(o){wi(t,o,r[o])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Ln(Object(r)).forEach(function(o){Object.defineProperty(t,o,Object.getOwnPropertyDescriptor(r,o))})}return t}function Ii(){for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r];return function(o){return n.reduceRight(function(d,p){return p(d)},o)}}function Xt(t){return function n(){for(var r=this,o=arguments.length,d=new Array(o),p=0;p<o;p++)d[p]=arguments[p];return d.length>=t.length?t.apply(this,d):function(){for(var m=arguments.length,u=new Array(m),_=0;_<m;_++)u[_]=arguments[_];return n.apply(r,[].concat(d,u))}}}function un(t){return{}.toString.call(t).includes("Object")}function Ai(t){return!Object.keys(t).length}function Yt(t){return typeof t=="function"}function Pi(t,n){return Object.prototype.hasOwnProperty.call(t,n)}function ji(t,n){return un(n)||_t("changeType"),Object.keys(n).some(function(r){return!Pi(t,r)})&&_t("changeField"),n}function Ti(t){Yt(t)||_t("selectorType")}function ki(t){Yt(t)||un(t)||_t("handlerType"),un(t)&&Object.values(t).some(function(n){return!Yt(n)})&&_t("handlersType")}function Ei(t){t||_t("initialIsRequired"),un(t)||_t("initialType"),Ai(t)&&_t("initialContent")}function Ri(t,n){throw new Error(t[n]||t.default)}var Ni={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},_t=Xt(Ri)(Ni),ln={changes:ji,selector:Ti,handler:ki,initial:Ei};function Di(t){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};ln.initial(t),ln.handler(n);var r={current:t},o=Xt(Li)(r,n),d=Xt(qi)(r),p=Xt(ln.changes)(t),m=Xt(Mi)(r);function u(){var v=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(f){return f};return ln.selector(v),v(r.current)}function _(v){Ii(o,d,p,m)(v)}return[u,_]}function Mi(t,n){return Yt(n)?n(t.current):n}function qi(t,n){return t.current=Un(Un({},t.current),n),n}function Li(t,n,r){return Yt(n)?n(t.current):Object.keys(r).forEach(function(o){var d;return(d=n[o])===null||d===void 0?void 0:d.call(n,t.current[o])}),r}var Ui={create:Di},Oi={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.55.1/min/vs"}};function Fi(t){return function n(){for(var r=this,o=arguments.length,d=new Array(o),p=0;p<o;p++)d[p]=arguments[p];return d.length>=t.length?t.apply(this,d):function(){for(var m=arguments.length,u=new Array(m),_=0;_<m;_++)u[_]=arguments[_];return n.apply(r,[].concat(d,u))}}}function Gi(t){return{}.toString.call(t).includes("Object")}function Vi(t){return t||On("configIsRequired"),Gi(t)||On("configType"),t.urls?(Bi(),{paths:{vs:t.urls.monacoBase}}):t}function Bi(){console.warn($n.deprecation)}function zi(t,n){throw new Error(t[n]||t.default)}var $n={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},On=Fi(zi)($n),Hi={config:Vi},Ki=function(){for(var n=arguments.length,r=new Array(n),o=0;o<n;o++)r[o]=arguments[o];return function(d){return r.reduceRight(function(p,m){return m(p)},d)}};function Wn(t,n){return Object.keys(n).forEach(function(r){n[r]instanceof Object&&t[r]&&Object.assign(n[r],Wn(t[r],n[r]))}),qn(qn({},t),n)}var $i={type:"cancelation",msg:"operation is manually canceled"};function bn(t){var n=!1,r=new Promise(function(o,d){t.then(function(p){return n?d($i):o(p)}),t.catch(d)});return r.cancel=function(){return n=!0},r}var Wi=["monaco"],Ji=Ui.create({config:Oi,isInitialized:!1,resolve:null,reject:null,monaco:null}),Jn=Si(Ji,2),en=Jn[0],mn=Jn[1];function Xi(t){var n=Hi.config(t),r=n.monaco,o=bi(n,Wi);mn(function(d){return{config:Wn(d.config,o),monaco:r}})}function Qi(){var t=en(function(n){var r=n.monaco,o=n.isInitialized,d=n.resolve;return{monaco:r,isInitialized:o,resolve:d}});if(!t.isInitialized){if(mn({isInitialized:!0}),t.monaco)return t.resolve(t.monaco),bn(vn);if(window.monaco&&window.monaco.editor)return Xn(window.monaco),t.resolve(window.monaco),bn(vn);Ki(Zi,ea)(ta)}return bn(vn)}function Zi(t){return document.body.appendChild(t)}function Yi(t){var n=document.createElement("script");return t&&(n.src=t),n}function ea(t){var n=en(function(o){var d=o.config,p=o.reject;return{config:d,reject:p}}),r=Yi("".concat(n.config.paths.vs,"/loader.js"));return r.onload=function(){return t()},r.onerror=n.reject,r}function ta(){var t=en(function(r){var o=r.config,d=r.resolve,p=r.reject;return{config:o,resolve:d,reject:p}}),n=window.require;n.config(t.config),n(["vs/editor/editor.main"],function(r){var o=r.m||r;Xn(o),t.resolve(o)},function(r){t.reject(r)})}function Xn(t){en().monaco||mn({monaco:t})}function na(){return en(function(t){var n=t.monaco;return n})}var vn=new Promise(function(t,n){return mn({resolve:t,reject:n})}),Qn={config:Xi,init:Qi,__getMonacoInstance:na},sa={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},Sn=sa,ra={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},ia=ra;function aa({children:t}){return Et.createElement("div",{style:ia.container},t)}var oa=aa,la=oa;function ca({width:t,height:n,isEditorReady:r,loading:o,_ref:d,className:p,wrapperProps:m}){return Et.createElement("section",{style:{...Sn.wrapper,width:t,height:n},...m},!r&&Et.createElement(la,null,o),Et.createElement("div",{ref:d,style:{...Sn.fullWidth,...!r&&Sn.hide},className:p}))}var da=ca,Zn=a.memo(da);function ua(t){a.useEffect(t,[])}var Yn=ua;function pa(t,n,r=!0){let o=a.useRef(!0);a.useEffect(o.current||!r?()=>{o.current=!1}:t,n)}var Ve=pa;function Qt(){}function Ot(t,n,r,o){return ma(t,o)||ga(t,n,r,o)}function ma(t,n){return t.editor.getModel(es(t,n))}function ga(t,n,r,o){return t.editor.createModel(n,r,o?es(t,o):void 0)}function es(t,n){return t.Uri.parse(n)}function ha({original:t,modified:n,language:r,originalLanguage:o,modifiedLanguage:d,originalModelPath:p,modifiedModelPath:m,keepCurrentOriginalModel:u=!1,keepCurrentModifiedModel:_=!1,theme:v="light",loading:f="Loading...",options:L={},height:D="100%",width:K="100%",className:A,wrapperProps:F={},beforeMount:W=Qt,onMount:y=Qt}){let[w,O]=a.useState(!1),[S,M]=a.useState(!0),$=a.useRef(null),q=a.useRef(null),V=a.useRef(null),X=a.useRef(y),z=a.useRef(W),J=a.useRef(!1);Yn(()=>{let G=Qn.init();return G.then(ee=>(q.current=ee)&&M(!1)).catch(ee=>(ee==null?void 0:ee.type)!=="cancelation"&&console.error("Monaco initialization: error:",ee)),()=>$.current?ve():G.cancel()}),Ve(()=>{if($.current&&q.current){let G=$.current.getOriginalEditor(),ee=Ot(q.current,t||"",o||r||"text",p||"");ee!==G.getModel()&&G.setModel(ee)}},[p],w),Ve(()=>{if($.current&&q.current){let G=$.current.getModifiedEditor(),ee=Ot(q.current,n||"",d||r||"text",m||"");ee!==G.getModel()&&G.setModel(ee)}},[m],w),Ve(()=>{let G=$.current.getModifiedEditor();G.getOption(q.current.editor.EditorOption.readOnly)?G.setValue(n||""):n!==G.getValue()&&(G.executeEdits("",[{range:G.getModel().getFullModelRange(),text:n||"",forceMoveMarkers:!0}]),G.pushUndoStop())},[n],w),Ve(()=>{var G,ee;(ee=(G=$.current)==null?void 0:G.getModel())==null||ee.original.setValue(t||"")},[t],w),Ve(()=>{let{original:G,modified:ee}=$.current.getModel();q.current.editor.setModelLanguage(G,o||r||"text"),q.current.editor.setModelLanguage(ee,d||r||"text")},[r,o,d],w),Ve(()=>{var G;(G=q.current)==null||G.editor.setTheme(v)},[v],w),Ve(()=>{var G;(G=$.current)==null||G.updateOptions(L)},[L],w);let B=a.useCallback(()=>{var de;if(!q.current)return;z.current(q.current);let G=Ot(q.current,t||"",o||r||"text",p||""),ee=Ot(q.current,n||"",d||r||"text",m||"");(de=$.current)==null||de.setModel({original:G,modified:ee})},[r,n,d,t,o,p,m]),ae=a.useCallback(()=>{var G;!J.current&&V.current&&($.current=q.current.editor.createDiffEditor(V.current,{automaticLayout:!0,...L}),B(),(G=q.current)==null||G.editor.setTheme(v),O(!0),J.current=!0)},[L,v,B]);a.useEffect(()=>{w&&X.current($.current,q.current)},[w]),a.useEffect(()=>{!S&&!w&&ae()},[S,w,ae]);function ve(){var ee,de,xe,_e;let G=(ee=$.current)==null?void 0:ee.getModel();u||((de=G==null?void 0:G.original)==null||de.dispose()),_||((xe=G==null?void 0:G.modified)==null||xe.dispose()),(_e=$.current)==null||_e.dispose()}return Et.createElement(Zn,{width:K,height:D,isEditorReady:w,loading:f,_ref:V,className:A,wrapperProps:F})}var xa=ha;a.memo(xa);function fa(t){let n=a.useRef();return a.useEffect(()=>{n.current=t},[t]),n.current}var ba=fa,cn=new Map;function va({defaultValue:t,defaultLanguage:n,defaultPath:r,value:o,language:d,path:p,theme:m="light",line:u,loading:_="Loading...",options:v={},overrideServices:f={},saveViewState:L=!0,keepCurrentModel:D=!1,width:K="100%",height:A="100%",className:F,wrapperProps:W={},beforeMount:y=Qt,onMount:w=Qt,onChange:O,onValidate:S=Qt}){let[M,$]=a.useState(!1),[q,V]=a.useState(!0),X=a.useRef(null),z=a.useRef(null),J=a.useRef(null),B=a.useRef(w),ae=a.useRef(y),ve=a.useRef(),G=a.useRef(o),ee=ba(p),de=a.useRef(!1),xe=a.useRef(!1);Yn(()=>{let T=Qn.init();return T.then(H=>(X.current=H)&&V(!1)).catch(H=>(H==null?void 0:H.type)!=="cancelation"&&console.error("Monaco initialization: error:",H)),()=>z.current?te():T.cancel()}),Ve(()=>{var H,re,ue,fe;let T=Ot(X.current,t||o||"",n||d||"",p||r||"");T!==((H=z.current)==null?void 0:H.getModel())&&(L&&cn.set(ee,(re=z.current)==null?void 0:re.saveViewState()),(ue=z.current)==null||ue.setModel(T),L&&((fe=z.current)==null||fe.restoreViewState(cn.get(p))))},[p],M),Ve(()=>{var T;(T=z.current)==null||T.updateOptions(v)},[v],M),Ve(()=>{!z.current||o===void 0||(z.current.getOption(X.current.editor.EditorOption.readOnly)?z.current.setValue(o):o!==z.current.getValue()&&(xe.current=!0,z.current.executeEdits("",[{range:z.current.getModel().getFullModelRange(),text:o,forceMoveMarkers:!0}]),z.current.pushUndoStop(),xe.current=!1))},[o],M),Ve(()=>{var H,re;let T=(H=z.current)==null?void 0:H.getModel();T&&d&&((re=X.current)==null||re.editor.setModelLanguage(T,d))},[d],M),Ve(()=>{var T;u!==void 0&&((T=z.current)==null||T.revealLine(u))},[u],M),Ve(()=>{var T;(T=X.current)==null||T.editor.setTheme(m)},[m],M);let _e=a.useCallback(()=>{var T;if(!(!J.current||!X.current)&&!de.current){ae.current(X.current);let H=p||r,re=Ot(X.current,o||t||"",n||d||"",H||"");z.current=(T=X.current)==null?void 0:T.editor.create(J.current,{model:re,automaticLayout:!0,...v},f),L&&z.current.restoreViewState(cn.get(H)),X.current.editor.setTheme(m),u!==void 0&&z.current.revealLine(u),$(!0),de.current=!0}},[t,n,r,o,d,p,v,f,L,m,u]);a.useEffect(()=>{M&&B.current(z.current,X.current)},[M]),a.useEffect(()=>{!q&&!M&&_e()},[q,M,_e]),G.current=o,a.useEffect(()=>{var T,H;M&&O&&((T=ve.current)==null||T.dispose(),ve.current=(H=z.current)==null?void 0:H.onDidChangeModelContent(re=>{xe.current||O(z.current.getValue(),re)}))},[M,O]),a.useEffect(()=>{if(M){let T=X.current.editor.onDidChangeMarkers(H=>{var ue;let re=(ue=z.current.getModel())==null?void 0:ue.uri;if(re&&H.find(fe=>fe.path===re.path)){let fe=X.current.editor.getModelMarkers({resource:re});S==null||S(fe)}});return()=>{T==null||T.dispose()}}return()=>{}},[M,S]);function te(){var T,H;(T=ve.current)==null||T.dispose(),D?L&&cn.set(p,z.current.saveViewState()):(H=z.current.getModel())==null||H.dispose(),z.current.dispose()}return Et.createElement(Zn,{width:K,height:A,isEditorReady:M,loading:_,_ref:J,className:F,wrapperProps:W})}var Sa=va,ya=a.memo(Sa),_a=ya;/*! Capacitor: https://capacitorjs.com/ - MIT License */const Ca=t=>{const n=new Map;n.set("web",{name:"web"});const r=t.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:n},o=(p,m)=>{r.platforms.set(p,m)},d=p=>{r.platforms.has(p)&&(r.currentPlatform=r.platforms.get(p))};return r.addPlatform=o,r.setPlatform=d,r},wa=t=>t.CapacitorPlatforms=Ca(t),ts=wa(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});ts.addPlatform;ts.setPlatform;var Vt;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(Vt||(Vt={}));class yn extends Error{constructor(n,r,o){super(n),this.message=n,this.code=r,this.data=o}}const Ia=t=>{var n,r;return t!=null&&t.androidBridge?"android":!((r=(n=t==null?void 0:t.webkit)===null||n===void 0?void 0:n.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},Aa=t=>{var n,r,o,d,p;const m=t.CapacitorCustomPlatform||null,u=t.Capacitor||{},_=u.Plugins=u.Plugins||{},v=t.CapacitorPlatforms,f=()=>m!==null?m.name:Ia(t),L=((n=v==null?void 0:v.currentPlatform)===null||n===void 0?void 0:n.getPlatform)||f,D=()=>L()!=="web",K=((r=v==null?void 0:v.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||D,A=q=>{const V=S.get(q);return!!(V!=null&&V.platforms.has(L())||y(q))},F=((o=v==null?void 0:v.currentPlatform)===null||o===void 0?void 0:o.isPluginAvailable)||A,W=q=>{var V;return(V=u.PluginHeaders)===null||V===void 0?void 0:V.find(X=>X.name===q)},y=((d=v==null?void 0:v.currentPlatform)===null||d===void 0?void 0:d.getPluginHeader)||W,w=q=>t.console.error(q),O=(q,V,X)=>Promise.reject(`${X} does not have an implementation of "${V}".`),S=new Map,M=(q,V={})=>{const X=S.get(q);if(X)return console.warn(`Capacitor plugin "${q}" already registered. Cannot register plugins twice.`),X.proxy;const z=L(),J=y(q);let B;const ae=async()=>(!B&&z in V?B=typeof V[z]=="function"?B=await V[z]():B=V[z]:m!==null&&!B&&"web"in V&&(B=typeof V.web=="function"?B=await V.web():B=V.web),B),ve=(te,T)=>{var H,re;if(J){const ue=J==null?void 0:J.methods.find(fe=>T===fe.name);if(ue)return ue.rtype==="promise"?fe=>u.nativePromise(q,T.toString(),fe):(fe,Ee)=>u.nativeCallback(q,T.toString(),fe,Ee);if(te)return(H=te[T])===null||H===void 0?void 0:H.bind(te)}else{if(te)return(re=te[T])===null||re===void 0?void 0:re.bind(te);throw new yn(`"${q}" plugin is not implemented on ${z}`,Vt.Unimplemented)}},G=te=>{let T;const H=(...re)=>{const ue=ae().then(fe=>{const Ee=ve(fe,te);if(Ee){const Te=Ee(...re);return T=Te==null?void 0:Te.remove,Te}else throw new yn(`"${q}.${te}()" is not implemented on ${z}`,Vt.Unimplemented)});return te==="addListener"&&(ue.remove=async()=>T()),ue};return H.toString=()=>`${te.toString()}() { [capacitor code] }`,Object.defineProperty(H,"name",{value:te,writable:!1,configurable:!1}),H},ee=G("addListener"),de=G("removeListener"),xe=(te,T)=>{const H=ee({eventName:te},T),re=async()=>{const fe=await H;de({eventName:te,callbackId:fe},T)},ue=new Promise(fe=>H.then(()=>fe({remove:re})));return ue.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await re()},ue},_e=new Proxy({},{get(te,T){switch(T){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return J?xe:ee;case"removeListener":return de;default:return G(T)}}});return _[q]=_e,S.set(q,{name:q,proxy:_e,platforms:new Set([...Object.keys(V),...J?[z]:[]])}),_e},$=((p=v==null?void 0:v.currentPlatform)===null||p===void 0?void 0:p.registerPlugin)||M;return u.convertFileSrc||(u.convertFileSrc=q=>q),u.getPlatform=L,u.handleError=w,u.isNativePlatform=K,u.isPluginAvailable=F,u.pluginMethodNoop=O,u.registerPlugin=$,u.Exception=yn,u.DEBUG=!!u.DEBUG,u.isLoggingEnabled=!!u.isLoggingEnabled,u.platform=u.getPlatform(),u.isNative=u.isNativePlatform(),u},Pa=t=>t.Capacitor=Aa(t),Bt=Pa(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Tn=Bt.registerPlugin;Bt.Plugins;class ns{constructor(n){this.listeners={},this.retainedEventArguments={},this.windowListeners={},n&&(console.warn(`Capacitor WebPlugin "${n.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=n)}addListener(n,r){let o=!1;this.listeners[n]||(this.listeners[n]=[],o=!0),this.listeners[n].push(r);const p=this.windowListeners[n];p&&!p.registered&&this.addWindowListener(p),o&&this.sendRetainedArgumentsForEvent(n);const m=async()=>this.removeListener(n,r);return Promise.resolve({remove:m})}async removeAllListeners(){this.listeners={};for(const n in this.windowListeners)this.removeWindowListener(this.windowListeners[n]);this.windowListeners={}}notifyListeners(n,r,o){const d=this.listeners[n];if(!d){if(o){let p=this.retainedEventArguments[n];p||(p=[]),p.push(r),this.retainedEventArguments[n]=p}return}d.forEach(p=>p(r))}hasListeners(n){return!!this.listeners[n].length}registerWindowListener(n,r){this.windowListeners[r]={registered:!1,windowEventName:n,pluginEventName:r,handler:o=>{this.notifyListeners(r,o)}}}unimplemented(n="not implemented"){return new Bt.Exception(n,Vt.Unimplemented)}unavailable(n="not available"){return new Bt.Exception(n,Vt.Unavailable)}async removeListener(n,r){const o=this.listeners[n];if(!o)return;const d=o.indexOf(r);this.listeners[n].splice(d,1),this.listeners[n].length||this.removeWindowListener(this.windowListeners[n])}addWindowListener(n){window.addEventListener(n.windowEventName,n.handler),n.registered=!0}removeWindowListener(n){n&&(window.removeEventListener(n.windowEventName,n.handler),n.registered=!1)}sendRetainedArgumentsForEvent(n){const r=this.retainedEventArguments[n];r&&(delete this.retainedEventArguments[n],r.forEach(o=>{this.notifyListeners(n,o)}))}}const Fn=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Gn=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class ja extends ns{async getCookies(){const n=document.cookie,r={};return n.split(";").forEach(o=>{if(o.length<=0)return;let[d,p]=o.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");d=Gn(d).trim(),p=Gn(p).trim(),r[d]=p}),r}async setCookie(n){try{const r=Fn(n.key),o=Fn(n.value),d=`; expires=${(n.expires||"").replace("expires=","")}`,p=(n.path||"/").replace("path=",""),m=n.url!=null&&n.url.length>0?`domain=${n.url}`:"";document.cookie=`${r}=${o||""}${d}; path=${p}; ${m};`}catch(r){return Promise.reject(r)}}async deleteCookie(n){try{document.cookie=`${n.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{const n=document.cookie.split(";")||[];for(const r of n)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(n){return Promise.reject(n)}}async clearAllCookies(){try{await this.clearCookies()}catch(n){return Promise.reject(n)}}}Tn("CapacitorCookies",{web:()=>new ja});const Ta=async t=>new Promise((n,r)=>{const o=new FileReader;o.onload=()=>{const d=o.result;n(d.indexOf(",")>=0?d.split(",")[1]:d)},o.onerror=d=>r(d),o.readAsDataURL(t)}),ka=(t={})=>{const n=Object.keys(t);return Object.keys(t).map(d=>d.toLocaleLowerCase()).reduce((d,p,m)=>(d[p]=t[n[m]],d),{})},Ea=(t,n=!0)=>t?Object.entries(t).reduce((o,d)=>{const[p,m]=d;let u,_;return Array.isArray(m)?(_="",m.forEach(v=>{u=n?encodeURIComponent(v):v,_+=`${p}=${u}&`}),_.slice(0,-1)):(u=n?encodeURIComponent(m):m,_=`${p}=${u}`),`${o}&${_}`},"").substr(1):null,Ra=(t,n={})=>{const r=Object.assign({method:t.method||"GET",headers:t.headers},n),d=ka(t.headers)["content-type"]||"";if(typeof t.data=="string")r.body=t.data;else if(d.includes("application/x-www-form-urlencoded")){const p=new URLSearchParams;for(const[m,u]of Object.entries(t.data||{}))p.set(m,u);r.body=p.toString()}else if(d.includes("multipart/form-data")||t.data instanceof FormData){const p=new FormData;if(t.data instanceof FormData)t.data.forEach((u,_)=>{p.append(_,u)});else for(const u of Object.keys(t.data))p.append(u,t.data[u]);r.body=p;const m=new Headers(r.headers);m.delete("content-type"),r.headers=m}else(d.includes("application/json")||typeof t.data=="object")&&(r.body=JSON.stringify(t.data));return r};class Na extends ns{async request(n){const r=Ra(n,n.webFetchExtra),o=Ea(n.params,n.shouldEncodeUrlParams),d=o?`${n.url}?${o}`:n.url,p=await fetch(d,r),m=p.headers.get("content-type")||"";let{responseType:u="text"}=p.ok?n:{};m.includes("application/json")&&(u="json");let _,v;switch(u){case"arraybuffer":case"blob":v=await p.blob(),_=await Ta(v);break;case"json":_=await p.json();break;case"document":case"text":default:_=await p.text()}const f={};return p.headers.forEach((L,D)=>{f[D]=L}),{data:_,headers:f,status:p.status,url:p.url}}async get(n){return this.request(Object.assign(Object.assign({},n),{method:"GET"}))}async post(n){return this.request(Object.assign(Object.assign({},n),{method:"POST"}))}async put(n){return this.request(Object.assign(Object.assign({},n),{method:"PUT"}))}async patch(n){return this.request(Object.assign(Object.assign({},n),{method:"PATCH"}))}async delete(n){return this.request(Object.assign(Object.assign({},n),{method:"DELETE"}))}}Tn("CapacitorHttp",{web:()=>new Na});var pn;(function(t){t.Documents="DOCUMENTS",t.Data="DATA",t.Library="LIBRARY",t.Cache="CACHE",t.External="EXTERNAL",t.ExternalStorage="EXTERNAL_STORAGE"})(pn||(pn={}));var wn;(function(t){t.UTF8="utf8",t.ASCII="ascii",t.UTF16="utf16"})(wn||(wn={}));const Vn=Tn("Filesystem",{web:()=>Zt(()=>import("./web-v200-C-aL7A1s.js"),__vite__mapDeps([0,1,2])).then(t=>new t.FilesystemWeb)});/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Da=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),ss=(...t)=>t.filter((n,r,o)=>!!n&&o.indexOf(n)===r).join(" ");/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qa=a.forwardRef(({color:t="currentColor",size:n=24,strokeWidth:r=2,absoluteStrokeWidth:o,className:d="",children:p,iconNode:m,...u},_)=>a.createElement("svg",{ref:_,...Ma,width:n,height:n,stroke:t,strokeWidth:o?Number(r)*24/Number(n):r,className:ss("lucide",d),...u},[...m.map(([v,f])=>a.createElement(v,f)),...Array.isArray(p)?p:[p]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const le=(t,n)=>{const r=a.forwardRef(({className:o,...d},p)=>a.createElement(qa,{ref:p,iconNode:n,className:ss(`lucide-${Da(t)}`,o),...d}));return r.displayName=`${t}`,r};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const La=le("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _n=le("Ban",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m4.9 4.9 14.2 14.2",key:"1m5liu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const rs=le("Box",[["path",{d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z",key:"hh9hay"}],["path",{d:"m3.3 7 8.7 5 8.7-5",key:"g66t2b"}],["path",{d:"M12 22V12",key:"d0xqtd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ua=le("ChevronDown",[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Oa=le("ChevronUp",[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const is=le("CircleCheck",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fa=le("CircleHelp",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ga=le("CircleX",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Va=le("Component",[["path",{d:"M5.5 8.5 9 12l-3.5 3.5L2 12l3.5-3.5Z",key:"1kciei"}],["path",{d:"m12 2 3.5 3.5L12 9 8.5 5.5 12 2Z",key:"1ome0g"}],["path",{d:"M18.5 8.5 22 12l-3.5 3.5L15 12l3.5-3.5Z",key:"vbupec"}],["path",{d:"m12 15 3.5 3.5L12 22l-3.5-3.5L12 15Z",key:"16csic"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Bn=le("Cpu",[["rect",{width:"16",height:"16",x:"4",y:"4",rx:"2",key:"14l7u7"}],["rect",{width:"6",height:"6",x:"9",y:"9",rx:"1",key:"5aljv4"}],["path",{d:"M15 2v2",key:"13l42r"}],["path",{d:"M15 20v2",key:"15mkzm"}],["path",{d:"M2 15h2",key:"1gxd5l"}],["path",{d:"M2 9h2",key:"1bbxkp"}],["path",{d:"M20 15h2",key:"19e6y8"}],["path",{d:"M20 9h2",key:"19tzq7"}],["path",{d:"M9 2v2",key:"165o2o"}],["path",{d:"M9 20v2",key:"i2bqo8"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ha=le("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ka=le("FilePen",[["path",{d:"M12 22h6a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v10",key:"x7tsz2"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10.4 12.6a2 2 0 1 1 3 3L8 21l-4 1 1-4Z",key:"o3xyfb"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $a=le("FilePlus",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M9 15h6",key:"cctwl0"}],["path",{d:"M12 18v-6",key:"17g6i2"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wa=le("FileText",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ja=le("FolderLock",[["rect",{width:"8",height:"5",x:"14",y:"17",rx:"1",key:"19aais"}],["path",{d:"M10 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v2.5",key:"1w6v7t"}],["path",{d:"M20 17v-2a2 2 0 1 0-4 0v2",key:"pwaxnr"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xa=le("Globe",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20",key:"13o1zl"}],["path",{d:"M2 12h20",key:"9i4pu4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qa=le("Image",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ya=le("Newspaper",[["path",{d:"M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2",key:"7pis2x"}],["path",{d:"M18 14h-8",key:"sponae"}],["path",{d:"M15 18h-5",key:"95g1m2"}],["path",{d:"M10 6h8v4h-8V6Z",key:"smlsk5"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const eo=le("PanelsTopLeft",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}],["path",{d:"M3 9h18",key:"1pudct"}],["path",{d:"M9 21V9",key:"1oto5p"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const to=le("PenTool",[["path",{d:"M15.707 21.293a1 1 0 0 1-1.414 0l-1.586-1.586a1 1 0 0 1 0-1.414l5.586-5.586a1 1 0 0 1 1.414 0l1.586 1.586a1 1 0 0 1 0 1.414z",key:"nt11vn"}],["path",{d:"m18 13-1.375-6.874a1 1 0 0 0-.746-.776L3.235 2.028a1 1 0 0 0-1.207 1.207L5.35 15.879a1 1 0 0 0 .776.746L13 18",key:"15qc1e"}],["path",{d:"m2.3 2.3 7.286 7.286",key:"1wuzzi"}],["circle",{cx:"11",cy:"11",r:"2",key:"xmgehs"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const no=le("Rocket",[["path",{d:"M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z",key:"m3kijz"}],["path",{d:"m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z",key:"1fmvmk"}],["path",{d:"M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0",key:"1f8sc4"}],["path",{d:"M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5",key:"qeys4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const as=le("Server",[["rect",{width:"20",height:"8",x:"2",y:"2",rx:"2",ry:"2",key:"ngkwjq"}],["rect",{width:"20",height:"8",x:"2",y:"14",rx:"2",ry:"2",key:"iecqi9"}],["line",{x1:"6",x2:"6.01",y1:"6",y2:"6",key:"16zg32"}],["line",{x1:"6",x2:"6.01",y1:"18",y2:"18",key:"nzw8ys"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const so=le("ShieldAlert",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"M12 8v4",key:"1got3b"}],["path",{d:"M12 16h.01",key:"1drbdi"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ro=le("ShieldCheck",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const io=le("ShoppingCart",[["circle",{cx:"8",cy:"21",r:"1",key:"jimo8o"}],["circle",{cx:"19",cy:"21",r:"1",key:"13723u"}],["path",{d:"M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12",key:"9zh506"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ao=le("Smartphone",[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2",key:"1yt0o3"}],["path",{d:"M12 18h.01",key:"mhygvu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const In=le("TriangleAlert",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oo=le("Trophy",[["path",{d:"M6 9H4.5a2.5 2.5 0 0 1 0-5H6",key:"17hqa7"}],["path",{d:"M18 9h1.5a2.5 2.5 0 0 0 0-5H18",key:"lmptdp"}],["path",{d:"M4 22h16",key:"57wxv0"}],["path",{d:"M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22",key:"1nw9bq"}],["path",{d:"M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22",key:"1np0yb"}],["path",{d:"M18 2H6v7a6 6 0 0 0 12 0V2Z",key:"u46fv3"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lo=le("Video",[["path",{d:"m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5",key:"ftymec"}],["rect",{x:"2",y:"6",width:"14",height:"12",rx:"2",key:"158x01"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const An=le("Zap",[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]]),co=t=>t.includes("auth")||t.includes("stealth")?ro:t.includes("ecom")||t.includes("commerce")||t.includes("produit")?io:t.includes("billing")||t.includes("paiement")?Ba:t.includes("layout")||t.includes("interface")?eo:t.includes("mobile")?ao:t.includes("blog")||t.includes("texte")||t.includes("markdown")?Ya:t.includes("game")||t.includes("gamification")?oo:t.includes("sqlite")||t.includes("scraper")?za:t.includes("image")?Qa:t.includes("video")||t.includes("audio")?lo:t.includes("design")||t.includes("createur")?to:t.includes("web")||t.includes("saas")||t.includes("landing")?Xa:t.includes("ia_")||t.includes("prompt")?uo:t.includes("chat")||t.includes("social")?Za:t.includes("composant")||t.includes("widget")||t.includes("forms")?Va:t.includes("pdf")||t.includes("pieces_jointes")?Wa:t.includes("mock")||t.includes("bridge")||t.includes("engine")?as:rs,uo=as,po=t=>{const n=["bg-red-500/10 text-red-500","bg-blue-500/10 text-blue-500","bg-emerald-500/10 text-emerald-500","bg-purple-500/10 text-purple-500","bg-orange-500/10 text-orange-500","bg-pink-500/10 text-pink-500","bg-yellow-500/10 text-yellow-500","bg-cyan-500/10 text-cyan-500","bg-indigo-500/10 text-indigo-500","bg-teal-500/10 text-teal-500"];let r=0;for(let o=0;o<t.length;o++)r=t.charCodeAt(o)+((r<<5)-r);return n[Math.abs(r)%n.length]},mo=["app_web_pack","audio_pack","blog_contenu_pack","chat_comms_pack","commerce_paiement_pack","composant_pack","createur_pack","design_figma_xd_pack","diamond_bridge_v14_37","e_commerce_pack","ecommerce_pack","evenement_pack","feed_social_pack","forge_universelle","forms_inputs_pack","formulaire_pack","gamification_pack","health_fitness_pack","ia_pack","image_pack","interface_pack","jeux_video_pack","landing_pack","landing_saas_pack","layout_pack","local_maps_pack","markdown_pack","marketing_pack","mobile_pack","mobile_shell_pack","mobile_web_pack","mock_master","pdf_docs_pack","pieces_jointes_pack","prd_ai_apps_pack","prd_ai_voice_agent","prd_auth_gateway","prd_blog_magazine","prd_crm_erp_pack","prd_ecom_catalog","prd_ecom_checkout","prd_ecom_digital_products","prd_game_leaderboard","prd_layout_bento","prd_layout_kanban","prd_mobile_pack","prd_mobile_social","prd_saas_billing_pro","prd_saas_pack","prd_specs_pack","prd_web_landing_pack","productivity_pack","produit_pack","prompt_skills_pack","saas_pack","specialise_pack","sqlite_inspector","stealth_bridge_v11_2","texte_pack","universal_scraper","video_pack","web_blog_pack","widget_pack","guest_nebula_calc"],Ft=mo.map(t=>({id:t,name:t.replace(/_/g," ").replace(/\b\w/g,n=>n.toUpperCase()),icon:co(t),color:po(t)})),go={low:"text-emerald-400 border-emerald-500/30 bg-emerald-950/20",medium:"text-amber-400   border-amber-500/30   bg-amber-950/20",high:"text-orange-400  border-orange-500/30  bg-orange-950/20",critical:"text-red-400     border-red-500/30     bg-red-950/20"},ho={low:e.jsx(is,{className:"w-3.5 h-3.5"}),medium:e.jsx(In,{className:"w-3.5 h-3.5"}),high:e.jsx(In,{className:"w-3.5 h-3.5"}),critical:e.jsx(Ga,{className:"w-3.5 h-3.5"})};function Pn({value:t}){const n=Math.round((t??1)*100),r=n>=80?"bg-emerald-500":n>=60?"bg-amber-500":"bg-red-500";return e.jsxs("span",{className:"flex items-center gap-1.5 text-[10px] font-bold text-zinc-400",children:[e.jsx("span",{className:`inline-block w-2 h-2 rounded-full ${r}`}),n,"% confiance"]})}function xo({cap:t}){const[n,r]=a.useState(!1);return e.jsxs("div",{className:"border border-zinc-800 rounded-xl overflow-hidden",children:[e.jsxs("button",{type:"button",className:"w-full flex items-center justify-between px-4 py-2.5 hover:bg-zinc-900/60 transition-colors",onClick:()=>r(o=>!o),children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:`text-xs font-bold px-2 py-0.5 rounded-full ${t.required?"bg-violet-500/20 text-violet-300":"bg-zinc-800 text-zinc-400"}`,children:t.required?"REQUISE":"optionnelle"}),e.jsx("span",{className:"text-sm text-white font-mono",children:t.id})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(Pn,{value:t.confidence}),n?e.jsx(Oa,{className:"w-3.5 h-3.5 text-zinc-500"}):e.jsx(Ua,{className:"w-3.5 h-3.5 text-zinc-500"})]})]}),n&&e.jsxs("div",{className:"px-4 pb-3 pt-1 bg-zinc-950/40 space-y-2",children:[e.jsx("p",{className:"text-xs text-zinc-300",children:t.reason}),t.evidence.length>0&&e.jsx("ul",{className:"space-y-1",children:t.evidence.map((o,d)=>e.jsxs("li",{className:"text-[11px] font-mono text-cyan-400/70",children:["→ ",o]},d))})]})]})}const fo=({audit:t,sourceFolder:n,onConfirm:r,onReset:o,isSubmitting:d})=>{const[p,m]=a.useState({}),u=t.requiresUserDecision||[],_=t.risks||[],v=t.capabilities||[],f=t.mocks||[],L=t.decisions||[],D=t.filesToCreate||[],K=t.filesToModify||[],A=t.filesToPreserve||[],F=u.some(S=>S.required&&(!p[S.id]||p[S.id].trim()===""));_.filter(S=>S.level==="critical"||S.level==="high").length;const y=!F&&!d;Math.round((t.confidence||0)*100);const w=t.backendRequired===!1,O=()=>{const S={...t,requiresUserDecision:u.map(M=>({...M,answer:p[M.id]||""}))};r(S)};return e.jsxs("div",{className:"space-y-6 my-8 animate-in fade-in slide-in-from-bottom-4 duration-700",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-8 border border-violet-500/30 bg-violet-950/10 shadow-[0_0_60px_rgba(139,92,246,0.08)]",children:[e.jsx("div",{className:"absolute -top-20 -right-20 w-80 h-80 bg-violet-500/10 rounded-full blur-[100px]"}),e.jsxs("div",{className:"relative z-10",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsxs("span",{className:"flex items-center gap-2 px-4 py-1.5 rounded-full bg-violet-500/10 text-violet-300 border border-violet-500/30 text-xs font-black uppercase tracking-[0.2em]",children:[e.jsx(Bn,{className:"w-4 h-4"}),"Phase 5 — Audit Souverain"]}),e.jsx("span",{className:"h-px flex-1 bg-gradient-to-r from-violet-500/40 to-transparent"})]}),e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-4",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-violet-200 to-violet-400 tracking-tight",children:(t.projectType||"PROJET STANDARD").toUpperCase()}),e.jsx("p",{className:"text-sm text-zinc-400 mt-1 font-mono",children:n.split(/[\\/]/).pop()||n})]}),e.jsxs("div",{className:"flex flex-col items-end gap-2",children:[e.jsx(Pn,{value:t.confidence}),w?e.jsx("span",{className:"text-xs px-3 py-1 rounded-full bg-zinc-800 text-zinc-400 font-semibold",children:"🟡 Backend non requis"}):e.jsx("span",{className:"text-xs px-3 py-1 rounded-full bg-violet-500/20 text-violet-300 border border-violet-500/30 font-semibold",children:"🔌 Industrialisation complète"})]})]}),w&&e.jsxs("div",{className:"mt-4 p-4 bg-zinc-900/60 border border-zinc-700 rounded-2xl text-sm text-zinc-300",children:[e.jsx("strong",{className:"text-amber-400",children:"⚠️ Ce projet n'a pas besoin de backend."})," ","L'action recommandée est"," ",e.jsx("code",{className:"text-violet-300 bg-zinc-800 px-1.5 py-0.5 rounded text-xs",children:t.phase5Action||"skip_backend_integration"}),". Vous pouvez néanmoins confirmer pour générer le contrat."]})]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"rounded-2xl border border-violet-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-violet-400 mb-4 flex items-center gap-2",children:[e.jsx(An,{className:"w-4 h-4"})," Capacités détectées (",v.length,")"]}),e.jsx("div",{className:"space-y-2",children:v.length===0?e.jsx("p",{className:"text-xs text-zinc-500",children:"Aucune capacité détectée."}):v.map(S=>e.jsx(xo,{cap:S},S.id))})]}),e.jsxs("div",{className:"rounded-2xl border border-amber-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-amber-400 mb-4 flex items-center gap-2",children:[e.jsx(so,{className:"w-4 h-4"})," Mocks à remplacer (",f.length,")"]}),f.length===0?e.jsx("p",{className:"text-xs text-zinc-500",children:"Aucun mock détecté."}):e.jsx("ul",{className:"space-y-2",children:f.map(S=>e.jsxs("li",{className:"flex items-start gap-3 p-3 rounded-xl bg-amber-950/10 border border-amber-500/20",children:[e.jsx(La,{className:"w-3.5 h-3.5 text-amber-400 mt-0.5 shrink-0"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-mono text-amber-200",children:S.path}),e.jsxs("p",{className:"text-[10px] text-zinc-400",children:[S.pattern," → ",e.jsx("span",{className:"text-violet-300",children:S.capability})]})]})]},S.id))})]})]}),L.length>0&&e.jsxs("div",{className:"rounded-2xl border border-cyan-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-cyan-400 mb-4 flex items-center gap-2",children:[e.jsx(Bn,{className:"w-4 h-4"})," Providers recommandés (",L.length,")"]}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-3",children:L.map((S,M)=>e.jsxs("div",{className:"p-3 rounded-xl bg-cyan-950/10 border border-cyan-500/20 space-y-1",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-xs font-bold text-cyan-300 font-mono",children:S.capability}),e.jsx(Pn,{value:S.confidence})]}),e.jsx("p",{className:"text-xs text-white font-semibold",children:S.provider||"À déterminer"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed",children:S.reason}),S.requiresConfirmation&&e.jsx("span",{className:"inline-block text-[10px] px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/30",children:"⚠️ Confirmation requise"})]},M))})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:[e.jsxs("div",{className:"rounded-2xl border border-emerald-500/20 bg-emerald-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-emerald-400 mb-3 flex items-center gap-2",children:[e.jsx($a,{className:"w-3.5 h-3.5"})," À créer (",D.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[D.slice(0,8).map((S,M)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["+ ",S]},M)),D.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",D.length-8," autres…"]})]})]}),e.jsxs("div",{className:"rounded-2xl border border-orange-500/20 bg-orange-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-orange-400 mb-3 flex items-center gap-2",children:[e.jsx(Ka,{className:"w-3.5 h-3.5"})," À modifier (",K.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[K.slice(0,8).map((S,M)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["~ ",S]},M)),K.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",K.length-8," autres…"]})]})]}),e.jsxs("div",{className:"rounded-2xl border border-blue-500/20 bg-blue-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-blue-400 mb-3 flex items-center gap-2",children:[e.jsx(Ja,{className:"w-3.5 h-3.5"})," Préservés (",A.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[A.slice(0,8).map((S,M)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["🔒 ",S]},M)),A.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",A.length-8," autres…"]})]})]})]}),_.length>0&&e.jsxs("div",{className:"rounded-2xl border border-red-500/20 bg-red-950/5 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-red-400 mb-4 flex items-center gap-2",children:[e.jsx(In,{className:"w-4 h-4"})," Risques identifiés (",_.length,")"]}),e.jsx("div",{className:"space-y-2",children:_.map((S,M)=>e.jsxs("div",{className:`flex items-start gap-3 p-3 rounded-xl border ${go[S.level]}`,children:[ho[S.level],e.jsxs("div",{children:[e.jsxs("span",{className:"text-[10px] font-black uppercase tracking-wider opacity-70",children:["[",S.level,"] ",S.code]}),e.jsx("p",{className:"text-xs mt-0.5",children:S.message})]})]},M))})]}),u.length>0&&e.jsxs("div",{className:"rounded-2xl border border-rose-500/40 bg-rose-950/10 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-rose-400 mb-4 flex items-center gap-2",children:[e.jsx(Fa,{className:"w-4 h-4"}),"Décisions utilisateur obligatoires (",u.filter(S=>S.required).length," BLOQUANTE(S))"]}),e.jsx("div",{className:"space-y-3",children:u.map(S=>{const M=!!(p[S.id]&&p[S.id].trim()!==""),$=(S.capability||S.id||"").toLowerCase().replace("-","_"),q={backend:["Node.js / Express","Python / FastAPI","Supabase (BaaS)","Firebase (BaaS)","Aucun (Front-end only)"],auth:["JWT Local personnalisé","Supabase Auth","Firebase Auth","Auth0","Clerk","Aucune authentification"],authentication:["JWT Local personnalisé","Supabase Auth","Firebase Auth","Auth0","Clerk","Aucune authentification"],data_persistence:["PostgreSQL","MongoDB","MySQL / MariaDB","SQLite local","Local Storage (Frontend)"],database:["PostgreSQL","MongoDB","MySQL / MariaDB","SQLite local","Local Storage (Frontend)"],routing:["React Router (SPA)","Next.js App Router","Vite Plugin Pages"],error_handling:["Gestionnaire global classique","Sentry","Winston / Morgan (Backend)"],design:["TailwindCSS natif","Material UI","Chakra UI","CSS Modules","Vanilla CSS"],file_upload:["AWS S3","Supabase Storage","Stockage local (Backend)","Cloudinary"],storage:["AWS S3","Supabase Storage","Stockage local (Backend)","Cloudinary"],ocr_processing:["Google Vision API","AWS Textract","Tesseract.js (Local)","API tierce dédiée"]},V=S.options&&S.options.length>0?S.options:q[$]||[],X=V.length>0,J=X&&M&&!V.includes(p[S.id])?"other":p[S.id]||"";return e.jsx("div",{className:`p-4 rounded-xl border transition-colors ${S.required&&!M?"border-rose-500/60 bg-rose-950/30":"border-zinc-700 bg-zinc-900/40"}`,children:e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsxs("div",{className:"flex items-start gap-2",children:[S.required?M?e.jsx(is,{className:"w-4 h-4 text-emerald-400 shrink-0 mt-0.5"}):e.jsx(_n,{className:"w-4 h-4 text-rose-400 shrink-0 mt-0.5"}):e.jsx(Ha,{className:"w-4 h-4 text-zinc-400 shrink-0 mt-0.5"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-semibold text-white",children:S.question}),e.jsxs("p",{className:"text-[10px] text-zinc-400 mt-0.5",children:["Lié à : ",e.jsx("span",{className:"font-mono text-violet-300",children:S.capability||S.id})]})]})]}),e.jsxs("div",{className:"space-y-2",children:[X&&e.jsxs("select",{value:J,onChange:B=>{B.target.value==="other"?m(ae=>({...ae,[S.id]:""})):m(ae=>({...ae,[S.id]:B.target.value}))},className:"w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-violet-500/50",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionner une réponse --"}),V.map(B=>e.jsx("option",{value:B,children:B},B)),e.jsx("option",{value:"other",children:"Autre (Saisie libre)..."})]}),(!X||J==="other")&&e.jsx("input",{type:"text",placeholder:"Tapez votre réponse précise ici...",value:p[S.id]||"",onChange:B=>m(ae=>({...ae,[S.id]:B.target.value})),autoFocus:J==="other",className:"w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white placeholder-zinc-600 focus:outline-none focus:border-violet-500/50"})]})]})},S.id)})}),F&&e.jsxs("p",{className:"mt-4 text-xs text-rose-300 font-semibold bg-rose-950/30 border border-rose-500/30 rounded-xl p-3 flex items-center gap-2",children:[e.jsx(_n,{className:"w-4 h-4"})," La confirmation est bloquée jusqu'à ce que les décisions obligatoires ci-dessus soient résolues."]})]}),e.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-2 border border-violet-500/30 bg-zinc-950/80 backdrop-blur-xl shadow-2xl",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-violet-500/5 via-blue-500/5 to-cyan-500/5 pointer-events-none"}),e.jsxs("div",{className:"relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 p-4",children:[e.jsxs("div",{className:"text-xs text-zinc-400 max-w-sm leading-relaxed",children:[e.jsx("strong",{className:"text-violet-300",children:"La confirmation ne modifie aucun fichier."})," ","Elle envoie uniquement le contrat au moteur Kirov5 qui effectuera les vérifications de sécurité (drift, gates) avant toute mutation."]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("button",{type:"button",onClick:o,disabled:d,className:"px-5 py-3 rounded-2xl font-bold text-xs bg-white/5 hover:bg-white/10 text-zinc-300 border border-white/10 flex items-center gap-2 transition-all hover:scale-105 active:scale-95 disabled:opacity-50",children:"← Ré-auditer"}),e.jsxs("button",{type:"button",onClick:O,disabled:!y,title:F?"Résolvez les décisions obligatoires avant de confirmer":"",className:`px-8 py-3.5 rounded-2xl font-black text-sm flex items-center gap-3 transition-all relative overflow-hidden group
                ${y?"bg-gradient-to-r from-violet-500 to-cyan-500 hover:from-violet-400 hover:to-cyan-400 text-white shadow-[0_0_30px_rgba(139,92,246,0.4)] hover:shadow-[0_0_50px_rgba(139,92,246,0.6)] hover:scale-105 active:scale-95":"bg-zinc-800 text-zinc-500 cursor-not-allowed border border-zinc-700"}`,children:[y&&e.jsx("div",{className:"absolute inset-0 w-full h-full bg-white/10 -translate-x-full group-hover:animate-[shimmer_1.5s_infinite]"}),d?e.jsxs(e.Fragment,{children:[e.jsx(An,{className:"w-4 h-4 animate-spin"}),"Envoi à Kirov5..."]}):F?e.jsxs(e.Fragment,{children:[e.jsx(_n,{className:"w-4 h-4"}),"Répondez aux questions..."]}):e.jsxs(e.Fragment,{children:[e.jsx(no,{className:"w-4 h-4"}),"🚀 Confirmer → Kirov5"]})]})]})]})]})]})},jn=`Tu es un Architecte Logiciel Senior (Niveau Staff Engineer) spécialisé en Product Design, React/TypeScript, et Architecture d'Applications Web.
...
Réponds UNIQUEMENT avec le JSON demandé.`,bo=Object.freeze(Object.defineProperty({__proto__:null,SYSTEM_PROMPT:jn},Symbol.toStringTag,{value:"Module"}));function os(t,n,r,o,d){let p=!1;t&&t.includes("[DESIGN RIP]")&&(p=!0,t=t.replace("[DESIGN RIP]","").trim());let m="";r?m=`
...
`:o&&(d&&(d.transcript||d.description)?m=`
...
Réponds avec le JSON valide uniquement, aucun texte avant ou après.`}const vo=Object.freeze(Object.defineProperty({__proto__:null,buildUserPrompt:os},Symbol.toStringTag,{value:"Module"})),ls="hermes_deepseek_api_key",cs="tiger_apiKey";function So(){try{return localStorage.getItem(ls)||localStorage.getItem(cs)||null}catch{return null}}function yo(t){try{const n=t.trim();localStorage.setItem(ls,n),localStorage.setItem(cs,n),I("http://localhost:5006/api/config/apikey",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({key:n,apiKey:n,provider:"deepseek"})}).catch(()=>{})}catch{}}async function kn(){const t=So();if(t&&t.length>5)return t;try{const n=await I("http://localhost:5006/api/config/apikey");if(n&&n.ok){const r=await n.json();if((r.hasKey||r.hasAnyKey||r.configured)&&r.apiKey)return yo(r.apiKey),r.apiKey}}catch{}return null}const Cn={},_o={QWEN_CODER_32B:"@cf/qwen/qwen2.5-coder-32b-instruct"},Co=(Cn==null?void 0:Cn.VITE_HERMES_WORKER_URL)||"https://kirov-worker.v0reponses.workers.dev";async function ds(t,n,r){var L,D,K,A,F,W,y,w,O,S,M,$,q;const o=(r==null?void 0:r.model)||_o.QWEN_CODER_32B,d=(r==null?void 0:r.maxTokens)??8192,p=(r==null?void 0:r.temperature)??.3;let m,u;const _=2;for(let V=1;V<=_+1;V++){const X=new AbortController,z=setTimeout(()=>X.abort(),12e4);try{console.log(`[Hermes-CF] Appel Worker Kirov (Tentative ${V}/${_+1})...`);const J=typeof window<"u"&&localStorage.getItem("kirov5_jwt_token")||"";if(m=await fetch(`${Co}/api/hermes`,{method:"POST",headers:{"Content-Type":"application/json",...J?{Authorization:`Bearer ${J}`}:{}},signal:X.signal,body:JSON.stringify({model:o,messages:[{role:"system",content:t},{role:"user",content:n}],max_tokens:d,temperature:p})}),clearTimeout(z),!m.ok){const B=await m.text().catch(()=>"");throw m.status===403?new Error("Hermes Worker — Modele non disponible sur plan Free (403)."):m.status===429?new Error("Hermes Worker — Quota 10 000 Neurons/jour atteint. Reset a 00:00 UTC."):m.status===500||m.status===502||m.status===503||m.status===504?new Error(`Erreur transitoire ${m.status}: ${B.slice(0,300)}`):new Error(`Hermes Worker — Erreur ${m.status}: ${B.slice(0,300)}`)}break}catch(J){clearTimeout(z);let B=J.message;if(J.name==="AbortError"&&(B="Hermes Worker — Timeout local (120s) atteint."),u=new Error(B),B.includes("Modele non disponible")||B.includes("Quota 10 000"))throw u;if(V<=_)console.warn(`[Hermes-CF] Echec (Tentative ${V}). Retry dans ${3*V}s... (${B})`),await new Promise(ae=>setTimeout(ae,3e3*V));else throw console.error(`[Hermes-CF] Echec definitif apres ${_+1} tentatives.`),u}}if(!m)throw u||new Error("Erreur inconnue lors de l'appel Cloudflare.");const v=await m.json();let f=(v==null?void 0:v.response)||((K=(D=(L=v==null?void 0:v.choices)==null?void 0:L[0])==null?void 0:D.message)==null?void 0:K.content)||((F=(A=v==null?void 0:v.choices)==null?void 0:A[0])==null?void 0:F.text)||((w=(y=(W=v==null?void 0:v.choices)==null?void 0:W[0])==null?void 0:y.delta)==null?void 0:w.content)||((O=v==null?void 0:v.result)==null?void 0:O.response)||(typeof(v==null?void 0:v.result)=="string"?v.result:"")||"";if(typeof f!="string")try{f=JSON.stringify(f)}catch{f=String(f)}if((!f||f.trim().length<5)&&(($=(M=(S=v==null?void 0:v.choices)==null?void 0:S[0])==null?void 0:M.message)!=null&&$.reasoning)&&(console.warn("[Hermes-CF] Contenu vide, utilisation du champ reasoning."),f=v.choices[0].message.reasoning),!f||f.trim().length<5){const V=(q=v==null?void 0:v.choices)==null?void 0:q[0];throw console.error("[Hermes-CF] Reponse vide. choices[0]:",JSON.stringify(V,null,2)),new Error(`Hermes Worker — Reponse vide (finish_reason: ${(V==null?void 0:V.finish_reason)||"unknown"}). Modele: ${v==null?void 0:v.model}`)}return f}const wo="https://api.deepseek.com/v1/chat/completions";async function Io(t,n,r,o){var D,K,A;const d=await kn(),p=os(t,n,r,o);let m="";if(d&&d.length>5)try{const F=await fetch(wo,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:jn},{role:"user",content:p}],max_tokens:8e3,temperature:.3,response_format:{type:"json_object"}})});F.ok?(m=((A=(K=(D=(await F.json()).choices)==null?void 0:D[0])==null?void 0:K.message)==null?void 0:A.content)??"",console.log("[AI Provider] DeepSeek OK — contenu recu:",m.length,"chars")):console.warn("[AI Provider] DeepSeek erreur:",F.status,"— bascule vers Cloudflare Hermes.")}catch{console.warn("[AI Provider] DeepSeek indisponible — bascule vers Cloudflare Hermes Worker.")}if(!m)try{console.log("[AI Provider] Appel Hermes Cloudflare Worker (route /api/hermes)..."),m=await ds(jn,p,{maxTokens:8e3,temperature:.3}),console.log("[AI Provider] Hermes Cloudflare OK — contenu recu:",m.length,"chars")}catch(F){throw console.error("[AI Provider] Hermes Cloudflare echoue:",F.message),new Error(`Moteur IA indisponible. DeepSeek ${d?"(erreur API)":"(pas de cle)"} et Cloudflare Worker (${F.message}). Reessayez dans un instant.`)}if(!m)throw new Error("Reponse vide de l'Agent Hermes. Reessayez.");let u;try{const F=m.match(/\{[\s\S]*\}/);u=JSON.parse(F?F[0]:m)}catch{throw new Error(`L'Agent Hermes n'a pas retourne un JSON valide. Reponse: ${m.slice(0,300)}`)}const _=u.folderName||`guest_${t.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,20)}`,v=`inject_${_}.js`,f=[{path:"README.md",language:"markdown",purpose:"PRD complet avec 10 modules architecturaux et directives IA",content:u.readme_content||""},{path:v,language:"javascript",purpose:"Script d'injection avec PRDS detailles pour Tiger IA / Hermes",content:u.inject_content||""},{path:"manifest.json",language:"json",purpose:"Metadonnees et registre du pack PRD",content:typeof u.manifest_content=="string"?u.manifest_content:JSON.stringify(u.manifest_content??{},null,2)}];return(n==="game"||u.game_engine_config||u.extra_files)&&(u.game_engine_config||!u.extra_files)&&f.push({path:"project_spec.yaml",language:"yaml",purpose:"Contrat de Specification du Projet",content:typeof u.project_spec=="string"?u.project_spec:JSON.stringify(u.project_spec||{schema_version:"1.0.0",project:{id:_,name:u.projectName||_,genre:"platformer_or_arcade"}},null,2)},{path:"action_plan.yaml",language:"yaml",purpose:"Graphe de Dependances & Micro-Actions Granulaires",content:typeof u.action_plan=="string"?u.action_plan:JSON.stringify(u.action_plan||{schema_version:"1.0.0",actions:[]},null,2)}),{projectName:u.projectName||_.replace("guest_","").replace(/_/g," ").toUpperCase(),folderName:_,title:`Pack PRD ${u.projectName||_}`,category:u.category||n,ideaSummary:u.ideaSummary||t,architectureSummary:u.architectureSummary||"Architecture React 18 + TypeScript + Vite + Tailwind CSS.",tasks:u.tasks||[{id:"task-1",title:"Structure du Projet",description:"Initialisation React/Vite/TypeScript",priority:"must-have",status:"planned"},{id:"task-2",title:"Composants Core",description:"Developpement des vues principales",priority:"must-have",status:"planned"}],files:f,extensionPoints:u.extensionPoints||["React Context","Custom Hooks","TypeScript"],warnings:u.warnings||[]}}async function Ao(t,n="other",r,o,d="api"){const p=await kn();try{const m=await I("http://localhost:5006/api/bridge/analyze-proposal",{method:"POST",headers:{"Content-Type":"application/json",...p?{"X-API-Key":p}:{}},body:JSON.stringify({idea:t,category:n,source_folder:r,web_url:o,apiKey:p||void 0})});if(m&&m.ok){const u=await m.json(),_=u.data||u;if(_.success&&_.proposal)return _.proposal}}catch{console.warn("[Pack Generator] Bridge 5006 indisponible — passage en mode Web Cloud.")}return{projectName:t.slice(0,25).toUpperCase(),ideaSummary:t,category:n,recommendedStack:{frontend:"React 18 + Vite + TypeScript",styling:"Vanilla CSS / Tailwind",architecturePattern:"Modular SPA"},keyFeatures:["Interface Responsive","Gestion d'état locale","API Integrations"],architecturalModules:[{name:"Core Interface",purpose:"Affichage principal"},{name:"Data Manager",purpose:"Gestion des données"}],estimatedComplexity:"Moyenne",targetAudience:"Utilisateurs Web / SaaS"}}async function Po(t,n="other",r,o,d,p="api"){var v;const m=((v=d||(r?r.replace(/\\/g,"/").split("/").pop():t))==null?void 0:v.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,35))??"project",u=d||(m.startsWith("guest_")?m:`guest_${m}`),_=await kn();try{const f=await I("http://localhost:5006/api/bridge/generate-guest-pack",{method:"POST",headers:{"Content-Type":"application/json",..._?{"X-API-Key":_}:{}},body:JSON.stringify({idea:t,category:n,folder_name:u,source_folder:r,web_url:o,apiKey:_||void 0})});if(f&&f.ok){const L=await f.json(),D=L.data||L;if(D.success&&D.pack)return D.pack}}catch{console.warn("[Pack Generator] Bridge 5006 non détecté — bascule vers le Moteur Cloud IA.")}if(p==="cloudflare"){const{SYSTEM_PROMPT:f}=await Zt(async()=>{const{SYSTEM_PROMPT:A}=await Promise.resolve().then(()=>bo);return{SYSTEM_PROMPT:A}},void 0),{buildUserPrompt:L}=await Zt(async()=>{const{buildUserPrompt:A}=await Promise.resolve().then(()=>vo);return{buildUserPrompt:A}},void 0),D=L(t,n,r,o),K=await ds(f,D,{maxTokens:8e3,temperature:.3});console.log("[Pack Generator] Hermes Cloudflare OK —",K.length,"chars")}return Io(t,n,r,o)}const jo=[{title:"Jeu Tetris Rétro",category:"game",icon:"🎮",idea:"Un jeu Tetris rétro néon avec système de score, contrôles au clavier, effets de particules, niveaux de difficulté progressifs et sons retro 8-bit."},{title:"Pack Santé Apple Health",category:"health",icon:"❤️",idea:"Application de suivi biométrique façon Apple Health : hydratation, suivi du sommeil, fréquence cardiaque, objectifs quotidiens et widgets graphiques fluides."},{title:"Store Sneaker Futuriste",category:"ecommerce",icon:"👟",idea:"E-commerce de sneakers rares en 3D avec panier réactif, filtre par marques, mode sombre futuriste et prévisualisation AR."}],To=[{value:"health",label:"Fitness / Santé"},{value:"game",label:"Jeu Vidéo"},{value:"ecommerce",label:"E-Commerce"},{value:"productivity",label:"Productivité"},{value:"social",label:"Réseau Social"},{value:"education",label:"Éducation"},{value:"other",label:"Autre / Spécifique"}],ko=({proposal:t,folderName:n,setFolderName:r,onConfirm:o,onReset:d,isGenerating:p})=>e.jsxs("div",{className:"mt-4 p-4 bg-[#0a1a0a] border border-green-500/30 rounded-xl space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-green-400 font-bold text-xs flex items-center gap-2",children:"✅ Proposition Hermes"}),e.jsx("button",{onClick:d,className:"text-[9px] text-gray-500 hover:text-gray-300",children:"← Recommencer"})]}),e.jsx("div",{className:"text-white font-black text-sm",children:t.projectName}),e.jsx("p",{className:"text-gray-400 text-[11px] leading-relaxed",children:t.description}),t.modules&&t.modules.length>0&&e.jsx("div",{className:"flex flex-wrap gap-1",children:t.modules.map((m,u)=>e.jsx("span",{className:"bg-cyan/10 border border-cyan/30 text-cyan text-[9px] px-2 py-0.5 rounded-full",children:m},u))}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 text-[9px] font-bold uppercase block mb-1",children:"Dossier cible"}),e.jsx("input",{type:"text",value:n,onChange:m=>r(m.target.value),className:"w-full bg-[#111] border border-white/10 rounded-lg px-3 py-2 text-xs text-gray-200 outline-none focus:border-cyan",placeholder:"guest_mon_projet"})]}),e.jsx("button",{onClick:o,disabled:p||!n,className:"w-full py-3 bg-gradient-to-r from-cyan-600/60 to-blue-600/60 hover:from-cyan-500/70 hover:to-blue-500/70 border border-cyan/40 text-white text-[11px] font-black uppercase rounded-lg transition-all disabled:opacity-50",children:p?"⏳ Génération...":"💎 Confirmer & Générer le Pack PRD"})]}),Eo=({activeProjectName:t,onPackGenerated:n,selectedStartPhase:r,onPhaseChange:o})=>{const[d,p]=a.useState("prompt"),[m,u]=a.useState(""),[_,v]=a.useState("other"),[f,L]=a.useState(""),[D,K]=a.useState(""),[A,F]=a.useState(!1),[W,y]=a.useState(""),[w,O]=a.useState(""),[S,M]=a.useState([]),[$,q]=a.useState(!1),V=async()=>{q(!0);try{let R=[];const ge=await I("http://localhost:5006/api/projects");if(ge&&ge.ok){const he=await ge.json(),se=he.projects||he.data&&he.data.projects||he;Array.isArray(se)&&(R=se.map(De=>typeof De=="string"?De:De.project_id||De.title||De.name).filter(Boolean))}if(R.length===0){const he=localStorage.getItem("kirov5_jwt_token")||"",se=await fetch("/api/projects",{headers:he?{Authorization:`Bearer ${he}`}:{}});if(se&&se.ok){const De=await se.json(),nt=De.projects||De;Array.isArray(nt)&&(R=nt.map(Re=>typeof Re=="string"?Re:Re.project_id||Re.title||Re.name).filter(Boolean))}}const Ce=Array.from(new Set(R)).filter(he=>he&&!he.startsWith(".")&&he!=="node_modules");M(Ce),Ce.length>0&&y(he=>he&&Ce.includes(he)?he:Ce[0])}catch(R){console.warn("Impossible de charger la liste des projets:",R)}finally{q(!1)}};a.useEffect(()=>{d==="phase5"&&V()},[d]);const[X,z]=a.useState(!1),[J,B]=a.useState("idle"),[ae,ve]=a.useState(null),[G,ee]=a.useState(null),[de,xe]=a.useState(""),[_e,te]=a.useState(""),[T,H]=a.useState("");a.useEffect(()=>{r===5&&d!=="phase5"&&p("phase5"),r===0&&d==="phase5"&&p("prompt")},[r]),a.useEffect(()=>{try{if(!D.trim()){F(!1);return}const R=new URL(D).hostname.replace(/^www\./,"");F(R==="youtube.com"||R==="youtu.be")}catch{F(!1)}},[D]);const re=()=>{ve(null),ee(null),B("idle"),te(""),H(""),xe("")},ue=async()=>{var ge,Ce,he;te(""),ve(null),H("");let R=m.trim();if(d==="phase5"){if(!W.trim()){te("Sélectionnez un dossier à auditer.");return}R=w.trim()||"Audit standard d'industrialisation (frontend vers backend)"}else d==="folder"?R=R||`Import du projet local : ${f}`:(d==="web"||d==="designrip")&&(R=R||`Analyse du site : ${D}`,d==="designrip"&&(R=`[DESIGN RIP] ${R}`));if(!R){te("Décrivez votre idée ou remplissez les champs requis.");return}B("analyzing");try{let se=null;try{const Ne=await I(`http://localhost:5006${d==="phase5"?"/api/bridge/analyze-phase5":"/api/bridge/guest-analyze"}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({idea:R,category:d==="phase5"?"phase5":_,sourceFolder:f||void 0,webUrl:D||void 0,phase5Folder:W||void 0})});if(Ne&&Ne.ok){const oe=await Ne.json();if(d==="phase5"){const gt=((ge=oe.data)==null?void 0:ge.audit)||oe.audit||((Ce=oe.data)==null?void 0:Ce.proposal)||oe.proposal||oe;ee(gt),xe(W.split(/[\\/]/).pop()||"guest_audit"),B("proposal-ready");return}se=oe.proposal||((he=oe.data)==null?void 0:he.proposal)}}catch{}if(!se&&d!=="phase5"){const Re=await Ao(R,_,f,D);se={projectName:Re.projectName||R.slice(0,30).toUpperCase(),description:Re.ideaSummary||R,modules:(Re.architecturalModules||[]).map(Ne=>Ne.name||Ne),category:String(_)}}else if(!se&&d==="phase5"){ee({projectType:"web_application",confidence:.95,backendRequired:!0,phase5Action:"full_industrialization",capabilities:["Auth JWT","Neon Storage","Cloudflare Worker AI"],mocks:[],decisions:[{title:"Déploiement Cloud",option:"Vercel + Cloudflare",recommendation:"Approuvé"}],filesToCreate:[],filesToModify:[],filesToPreserve:[],risks:[],requiresUserDecision:[]}),xe(W.split(/[\\/]/).pop()||"guest_audit"),B("proposal-ready");return}const nt=`guest_${(t||(se==null?void 0:se.projectName)||"Projet").toLowerCase().replace(/[^a-z0-9]/g,"_").substring(0,30)}`;xe(nt),ve(se),B("proposal-ready")}catch(se){B("error"),te(se.message||"Erreur de génération avec le Moteur Cloud IA.")}},fe=async()=>{if(!(!ae||!de)){B("generating"),te("");try{let R=!1;try{const ge=await I("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:ae,folderName:de,idea:m,category:_})});ge&&ge.ok&&(R=!0)}catch{}R||await Po(m,_,f,D,de),B("saved"),H(`✅ Pack PRD certifié et sauvegardé pour le projet "${de}" !`),n&&n(de,ae.description,_)}catch(R){B("error"),te(R.message||"Erreur lors de la génération du Pack PRD.")}}},Ee=async R=>{B("generating"),te("");try{const ge=await I("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:R,folderName:de,idea:w,category:"phase5"})});if(!ge||!ge.ok)throw new Error("Mode Cloud SaaS : Contrat enregistré en ligne");B("saved"),H("✅ Contrat Phase 5 sauvegardé pour le projet ! L'orchestrateur prend le relais."),n&&n(de,"Contrat de migration industrielle","phase5")}catch{B("saved"),H("✅ Contrat Phase 5 initialisé en mode Cloud SaaS !")}},Te=(R,ge,Ce,he)=>e.jsxs("button",{type:"button",onClick:()=>{p(R),R==="phase5"&&o&&o(5),R!=="phase5"&&d==="phase5"&&o&&o(0)},className:`flex-1 py-2 px-2 rounded-lg text-[10px] font-bold flex items-center justify-center gap-1 transition-all whitespace-nowrap ${d===R?`bg-gradient-to-r ${he} border shadow-lg`:"text-zinc-400 hover:text-zinc-200"}`,children:[Ce," ",ge]});return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("h3",{className:"text-white font-bold text-xs flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"📄"})," Instructions & Création du Pack PRD"]}),e.jsxs("span",{className:"text-[9px] text-zinc-400",children:["Dossier cible : ",e.jsxs("code",{className:"text-cyan bg-zinc-900 px-1.5 py-0.5 rounded",children:["guest_",t?t.toLowerCase().replace(/[^a-z0-9]/g,"_"):"nom_du_projet"]})]})]}),T&&e.jsxs("div",{className:"p-3 bg-green-900/20 border border-green-500/30 rounded-xl text-[11px] text-green-300 font-bold",children:[T,e.jsx("button",{onClick:re,className:"ml-3 text-[10px] text-green-500 underline",children:"← Nouveau projet"})]}),_e&&e.jsxs("div",{className:"p-3 bg-red-900/20 border border-red-500/30 rounded-xl text-[11px] text-red-300",children:["⚠️ ",_e]}),e.jsxs("div",{className:"flex items-center gap-1 p-1 bg-zinc-950/80 rounded-xl border border-zinc-800 overflow-x-auto",children:[Te("prompt","1. Idée & Prompt","📝","from-cyan-500/20 to-blue-500/20 text-cyan-300 border-cyan-500/40"),Te("folder","2. Ancien Projet","📁","from-amber-500/20 to-orange-500/20 text-amber-300 border-amber-500/40"),Te("web","3. YouTube / Web","🎬","from-red-500/20 to-pink-500/20 text-red-300 border-red-500/40"),Te("designrip","4. DesignRip","🌐","from-emerald-500/20 to-teal-500/20 text-emerald-300 border-emerald-500/40"),Te("phase5","5. 🔌 Phase 5","⚙️","from-violet-500/20 to-purple-500/20 text-violet-300 border-violet-500/40")]}),!ae&&!G&&J!=="saved"&&e.jsxs("div",{className:"space-y-3",children:[d==="prompt"&&e.jsx("textarea",{value:m,onChange:R=>u(R.target.value),placeholder:"Ex: Je veux créer une application de méditation guidée et suivi d'entraînements avec ambiance sonore apaisante et statistiques quotidiennes...",rows:4,className:"w-full bg-zinc-950/80 border border-zinc-800 rounded-xl p-4 text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-cyan text-xs resize-none"}),d==="folder"&&e.jsxs("div",{className:"space-y-2 p-4 bg-zinc-950/60 rounded-xl border border-amber-500/20",children:[e.jsxs("div",{className:"flex gap-4 mb-2 border-b border-zinc-800/80 pb-3",children:[e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-amber-300 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"project",checked:!X,onChange:()=>z(!1),className:"accent-amber-500"}),"📁 Projet Local Existant"]}),e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-yellow-400 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"pack",checked:X,onChange:()=>z(!0),className:"accent-yellow-500"}),"💎 Ancien Pack PRD (Ripping)"]})]}),e.jsx("label",{className:"text-xs font-semibold text-amber-300 block",children:X?"💎 Dossier du Pack PRD :":"📁 Dossier de l'ancien projet :"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{type:"button",onClick:async()=>{try{const ge=await(await I("http://localhost:5006/api/bridge/select-folder")).json(),Ce=ge.data||ge;Ce.success&&Ce.path&&(L(Ce.path),(!m.trim()||m.startsWith("Analyse"))&&u(X?`Analyse RIPPING de l'ancien pack PRD "${Ce.name}" pour l'enrichir et générer un nouveau pack ultra complet basé sur ce concept.`:`Analyse et reconstruction de l'ancien projet "${Ce.name}"`))}catch{}},className:"px-3 py-2 bg-amber-500/10 border border-amber-500/40 hover:bg-amber-500/20 text-amber-300 rounded-xl text-xs font-bold flex items-center gap-1.5",children:"📂 Choisir dossier"}),e.jsx("input",{type:"text",value:f,onChange:R=>L(R.target.value),placeholder:"ou saisissez le chemin (ex: E:\\ancien_projet)",className:"flex-1 bg-zinc-900 border border-zinc-800 rounded-xl px-3 py-2 text-xs text-amber-200 placeholder-zinc-500 font-mono"})]}),e.jsx("textarea",{value:m,onChange:R=>u(R.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs focus:outline-none focus:border-amber-500/50"})]}),d==="web"&&e.jsxs("div",{className:`space-y-2 p-4 bg-zinc-950/60 rounded-xl border ${A?"border-red-500/40":"border-purple-500/20"}`,children:[A&&e.jsx("div",{className:"flex items-center gap-2 text-[10px] text-red-300 bg-red-500/10 border border-red-500/30 px-3 py-1.5 rounded-lg",children:"🎬 YouTube détecté — extraction transcript activée"}),e.jsx("input",{type:"url",value:D,onChange:R=>K(R.target.value),placeholder:"https://www.youtube.com/watch?v=... ou https://mon-site.com",className:`w-full bg-zinc-900 border rounded-xl px-4 py-2.5 text-xs font-mono ${A?"border-red-500/50 text-red-200":"border-zinc-800 text-purple-200"}`}),e.jsx("textarea",{value:m,onChange:R=>u(R.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="designrip"&&e.jsxs("div",{className:"space-y-2 p-4 bg-emerald-950/10 rounded-xl border border-emerald-500/30",children:[e.jsx("label",{className:"text-xs font-semibold text-emerald-300 block",children:"🌐 URL du site à cloner :"}),e.jsx("input",{type:"url",value:D,onChange:R=>K(R.target.value),placeholder:"https://mon-site.com",className:"w-full bg-zinc-900 border border-emerald-500/30 rounded-xl px-4 py-2.5 text-xs text-emerald-200 font-mono"}),e.jsxs("div",{className:"p-2 bg-emerald-950/30 border border-emerald-500/20 rounded-xl text-[10px] text-emerald-200/80",children:["🎨 ",e.jsx("strong",{children:"DesignRip :"})," Clone du site avec animations fluides et design dynamique."]}),e.jsx("textarea",{value:m,onChange:R=>u(R.target.value),placeholder:"Instructions spécifiques...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="phase5"&&e.jsxs("div",{className:"space-y-4 p-4 bg-violet-950/15 rounded-xl border border-violet-500/30",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-xs font-black text-violet-300 uppercase tracking-widest",children:"⚙️ Phase 5 — Audit & Industrialisation"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed mt-1",children:"Sélectionnez le projet. Hermes l'auditera pour détecter les mocks et proposer une architecture sécurisée."})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("label",{className:"text-xs font-semibold text-violet-300 flex items-center gap-1.5",children:[e.jsx("span",{children:"📁"})," Projet à auditer :"]}),e.jsx("button",{type:"button",onClick:V,disabled:$,className:"text-[10px] text-violet-400 hover:text-violet-200 flex items-center gap-1 font-bold transition-colors cursor-pointer bg-violet-500/10 hover:bg-violet-500/20 border border-violet-500/30 px-2 py-0.5 rounded-lg",title:"Actualiser la liste des projets créés",children:e.jsx("span",{children:$?"Scan...":"🔄 Rafraîchir"})})]}),e.jsxs("div",{className:"relative",children:[e.jsxs("select",{value:W,onChange:R=>y(R.target.value),className:"w-full bg-zinc-900 border border-violet-500/40 hover:border-violet-500/60 rounded-xl px-4 py-2.5 text-xs text-violet-200 font-bold focus:outline-none focus:border-violet-400 cursor-pointer shadow-inner appearance-none transition-colors",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionnez un projet créé à auditer --"}),S.map(R=>e.jsxs("option",{value:R,className:"bg-zinc-950 text-white font-medium py-1",children:["📁 ",R]},R))]}),e.jsx("div",{className:"absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none text-violet-400 text-xs font-bold",children:"▼"})]}),S.length>0?e.jsxs("div",{className:"flex items-center justify-between text-[10px] text-zinc-400 px-1",children:[e.jsxs("span",{children:["✅ ",S.length," projet(s) créé(s) disponible(s)"]}),W&&e.jsxs("span",{className:"text-violet-300 font-mono",children:["Sélection : ",e.jsx("strong",{children:W})]})]}):$?null:e.jsxs("div",{className:"p-2.5 bg-amber-950/30 border border-amber-500/30 rounded-lg flex items-center justify-between gap-2",children:[e.jsx("p",{className:"text-[10px] text-amber-300",children:"Aucun projet détecté automatiquement. Entrez le nom manuellement :"}),e.jsx("input",{type:"text",value:W,onChange:R=>y(R.target.value),placeholder:"Ex: BLOG ou AUDIO",className:"bg-zinc-900 border border-amber-500/40 rounded-lg px-2.5 py-1 text-xs text-amber-200 font-mono w-44"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-[11px] font-semibold text-violet-300 block mb-1",children:"🎯 Instructions supplémentaires (optionnel) :"}),e.jsx("textarea",{value:w,onChange:R=>O(R.target.value),rows:2,placeholder:"Ex: S'assurer que les modèles de données incluent une table 'Utilisateur' avec un rôle administrateur...",className:"w-full bg-zinc-900 border border-violet-500/20 rounded-xl p-3 text-zinc-200 text-xs resize-none focus:border-violet-500/50 outline-none transition-colors"})]})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3 pt-1",children:[d!=="phase5"&&e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-[10px] text-zinc-400 font-semibold uppercase tracking-wider",children:"Catégorie:"}),e.jsx("select",{value:_,onChange:R=>v(R.target.value),className:"bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-1.5 text-[10px] text-cyan font-medium focus:outline-none focus:border-cyan",children:To.map(R=>e.jsx("option",{value:R.value,children:R.label},R.value))})]}),e.jsx("button",{onClick:ue,disabled:J==="analyzing",className:`px-5 py-2.5 rounded-xl font-bold text-xs flex items-center gap-2 transition-all shadow-lg ${J==="analyzing"?"bg-zinc-800 text-zinc-500 cursor-not-allowed":d==="phase5"?"bg-gradient-to-r from-violet-500 to-purple-600 text-white hover:from-violet-400 hover:to-purple-500":"bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-white hover:from-cyan-400 hover:to-purple-500"}`,children:J==="analyzing"?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin",children:"⚡"})," Analyse Hermes en cours..."]}):d==="phase5"?e.jsx(e.Fragment,{children:"⚙️ Auditer le Projet"}):e.jsx(e.Fragment,{children:"✨ Étape 1 : Analyser l'Idée (Proposition)"})})]}),d==="prompt"&&e.jsxs("div",{className:"pt-3 border-t border-zinc-800/80",children:[e.jsx("p",{className:"text-[10px] font-semibold text-zinc-400 mb-2 flex items-center gap-1.5",children:"💡 Ou choisissez un modèle d'inspiration prêt à l'emploi :"}),e.jsx("div",{className:"grid grid-cols-1 gap-2",children:jo.map((R,ge)=>e.jsxs("button",{type:"button",onClick:()=>{p("prompt"),u(R.idea),v(R.category)},className:"text-left p-3 rounded-xl bg-zinc-900/60 border border-zinc-800/80 hover:border-cyan/40 transition-all group",children:[e.jsxs("div",{className:"flex items-center gap-2 font-bold text-white text-[11px] mb-1 group-hover:text-cyan transition-colors",children:[e.jsx("span",{children:R.icon})," ",R.title]}),e.jsx("p",{className:"text-zinc-400 text-[10px] leading-relaxed line-clamp-2",children:R.idea})]},ge))})]})]}),ae&&J!=="saved"&&d!=="phase5"&&e.jsx(ko,{proposal:ae,folderName:de,setFolderName:xe,onConfirm:fe,onReset:re,isGenerating:J==="generating"}),G&&J!=="saved"&&d==="phase5"&&e.jsx(fo,{audit:G,sourceFolder:W,onConfirm:Ee,onReset:re,isSubmitting:J==="generating"})]})},Ro=(t=1)=>{if(typeof window>"u")return`linear-gradient(135deg, rgba(17,17,17,${t}), rgba(34,34,34,${t}))`;const n=[[[42,42,114],[0,159,253]],[[249,83,198],[185,29,115]],[[255,153,102],[255,94,98]],[[0,180,219],[0,131,176]],[[142,45,226],[74,0,224]],[[17,153,142],[56,239,125]],[[252,74,26],[247,183,51]],[[21,153,87],[21,87,153]],[[0,0,70],[28,181,224]],[[58,28,113],[215,109,119]],[[255,126,95],[254,180,123]],[[0,201,255],[146,254,157]],[[191,105,105],[194,112,66]],[[163,135,185],[170,107,115]],[[228,163,127],[191,105,105]],[[170,107,115],[194,112,66]],[[5,117,230],[2,27,121]],[[255,75,31],[255,144,104]],[[0,210,255],[58,123,213]],[[247,151,30],[255,210,0]],[[19,78,94],[113,178,128]],[[195,20,50],[36,11,54]],[[17,153,142],[56,239,125]],[[168,192,255],[63,75,150]]],[r,o]=n[Math.floor(Math.random()*n.length)];return`linear-gradient(${Math.floor(Math.random()*360)}deg, rgba(${r[0]},${r[1]},${r[2]},${t}) 0%, rgba(${o[0]},${o[1]},${o[2]},${t}) 100%)`},ct=(t,n=!1)=>t==="custom"?typeof window<"u"&&localStorage.getItem("tiger_customAiUrl")||"https://chat.deepseek.com/":t==="stitch"?"https://stitch.withgoogle.com/":t==="v0"?"https://v0.dev/":t==="kimi"||t==="moonshot"?"https://www.kimi.com/fr?chat_enter_method=new_chat":t==="qwen"?"https://chat.qwen.ai/":t==="gemini"?"https://gemini.google.com/app":t==="chatgpt"||t==="openai"?"https://chatgpt.com/":t==="claude"?"https://claude.ai/":t==="perplexity"?"https://www.perplexity.ai/":t==="deepseek"?"https://chat.deepseek.com/":`https://chat.${t}.com/`,zn=({isModal:t=!1,isEmbedded:n=!1,onClose:r,initialTab:o="connexion",isClient:d,getCachedGradient:p,mouchardLogs:m,activePhase:u,availableProjects:_,setAvailableProjects:v,selectedLaunchProject:f,setSelectedLaunchProject:L,isMobileNative:D,isAutoPilot:K,setIsAutoPilot:A,reuseActiveTab:F,setReuseActiveTab:W,selectedStartPhase:y="UNDEF",setSelectedStartPhase:w=()=>console.error("MISSING SETTER"),selectedPacks:O=[]})=>{const[S,M]=a.useState(o);a.useEffect(()=>{M(o)},[o]);const[$,q]=a.useState("web"),[V,X]=a.useState("deepseek"),[z,J]=a.useState("stitch"),[B,ae]=a.useState(""),[ve,G]=a.useState(""),[ee,de]=a.useState("http://127.0.0.1:5006"),[xe,_e]=a.useState("https://v0-reponse-git-main-v01-e951.vercel.app"),[te,T]=a.useState("http://127.0.0.1:5175"),[H,re]=a.useState(""),[ue,fe]=a.useState("deepseek"),[Ee,Te]=a.useState("idle"),[R,ge]=a.useState(""),[Ce,he]=a.useState(!1),[se,De]=a.useState(""),[nt,Re]=a.useState(""),[Ne,oe]=a.useState(!0),[gt,Be]=a.useState("forge"),[En,ht]=a.useState(0),[gn,Ct]=a.useState("vite"),[Rt,ze]=a.useState("idle"),[tn,nn]=a.useState(""),[Rn,sn]=a.useState(""),[rn,xt]=a.useState("6cd96956-200e-4260-ae7d-6c1446de284a"),[wt,dt]=a.useState(""),[It,st]=a.useState("idle"),[He,Nt]=a.useState(()=>typeof window<"u"?sessionStorage.getItem("tiger_isPipelineRunning")==="true":!1);a.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning",String(He))},[He]);const[Ke,ut]=a.useState(!1),[zt,hn]=a.useState(!1);a.useEffect(()=>{Number(y)===0&&A&&A(!0)},[y]),a.useEffect(()=>{q(localStorage.getItem("tiger_execMode")||"web"),X(localStorage.getItem("tiger_targetAi")||"deepseek"),J(localStorage.getItem("tiger_targetUiAi")||"stitch"),ae(localStorage.getItem("tiger_customAiName")||""),G(localStorage.getItem("tiger_customAiUrl")||"");const i=localStorage.getItem("tiger_bridgeUrl");(!i||i==="http://127.0.0.1:5005"||i==="http://localhost:5005")&&localStorage.setItem("tiger_bridgeUrl","http://127.0.0.1:5006"),de(localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006"),_e(localStorage.getItem("tiger_vercelUrl")||"https://v0-reponse-git-main-v01-e951.vercel.app"),T(localStorage.getItem("tiger_defaultPreviewUrl")||"http://127.0.0.1:5175");const g=localStorage.getItem("tiger_apiKey")||localStorage.getItem("hermes_deepseek_api_key")||"";re(g),fe(localStorage.getItem("tiger_apiProvider")||"deepseek"),xt(localStorage.getItem("tiger_notebookId")||"6cd96956-200e-4260-ae7d-6c1446de284a"),dt(localStorage.getItem("tiger_authCookie")||"");const b=localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006";I(`${b}/api/config/apikey`).then(E=>E?E.json():null).then(E=>{E&&(E.hasAnyKey||E.hasKey||E.configured)&&(Te("ok"),E.apiKey&&!g&&(re(E.apiKey),localStorage.setItem("tiger_apiKey",E.apiKey),localStorage.setItem("hermes_deepseek_api_key",E.apiKey)))}).catch(()=>{})},[]);const Dt=async()=>{const i={execMode:$,targetAi:V,targetUiAi:z,customAiName:B,customAiUrl:ve,bridgeUrl:ee,vercelUrl:xe,defaultPreviewUrl:te,apiKey:H};if(localStorage.setItem("tiger_execMode",$),localStorage.setItem("tiger_targetAi",V),localStorage.setItem("tiger_targetUiAi",z),localStorage.setItem("tiger_customAiName",B),localStorage.setItem("tiger_customAiUrl",ve),localStorage.setItem("tiger_bridgeUrl",ee),localStorage.setItem("tiger_vercelUrl",xe),localStorage.setItem("tiger_defaultPreviewUrl",te),localStorage.setItem("tiger_apiKey",H),localStorage.setItem("hermes_deepseek_api_key",H),localStorage.setItem("tiger_apiProvider",ue),localStorage.setItem("tiger_notebookId",rn),localStorage.setItem("tiger_authCookie",wt),H&&H.trim().length>0){Te("sending");const g=H.trim(),b=JSON.stringify({key:g,apiKey:g,provider:ue,mode:$}),E={"Content-Type":"application/json"};let Q=!1;const P=Array.from(new Set([`${ee}/api/config/apikey`,"http://localhost:5005/api/config/apikey","http://127.0.0.1:5005/api/config/apikey"]));for(const me of P)try{const je=await I(me,{method:"POST",headers:E,body:b});if(je&&je.ok&&(await je.json()).success){Q=!0;break}}catch(je){console.warn(`[SETTINGS] Échec envoi vers ${me}:`,je)}Te("ok"),console.log(Q?`[SETTINGS] ✅ Clé ${ue} envoyée et persistée sur le moteur.`:"[SETTINGS] ⚠️ Clé sauvée dans localStorage UI (Moteur en attente de reconnexion).")}typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Paramètres synchronisés !"),typeof window<"u"&&(window.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*"),window.parent&&window.parent!==window&&window.parent.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*")),he(!0),setTimeout(()=>he(!1),3e3)},Ht=i=>{let g="";const b=new Uint8Array(i),E=b.byteLength,Q=32768;for(let P=0;P<E;P+=Q)g+=String.fromCharCode.apply(null,Array.from(b.subarray(P,P+Q)));return btoa(g)},pt=()=>{var b;const i=typeof window<"u"&&!!(window.electron||window.electronAPI||(b=navigator.userAgent)!=null&&b.includes("Electron")),g=f||se||`Projet_ZIP_${Date.now()}`;if(!i){const E=document.createElement("input");E.type="file",E.accept=".zip",E.style.display="none",E.onchange=async()=>{var P;const Q=(P=E.files)==null?void 0:P[0];try{E.remove()}catch{}if(Q){ut(!0);try{const me=await Q.arrayBuffer(),je=Ht(me),ke=await(await fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:g,fileName:Q.name,fileBase64:je})})).json().catch(()=>null);qt(Q.name),w(2);const et=ke!=null&&ke.extractedCount?` (${ke.extractedCount} fichiers extraits)`:"";alert(`✅ Archive "${Q.name}" importée et extraite avec succès${et} dans le projet : ${g} !

Vous êtes maintenant sur la Phase 2. Cliquez sur "⚙️ LANCER PHASE 2 (MULTI-BATCH)" pour démarrer l'intégration !`)}catch(me){console.warn("[Upload ZIP] Erreur fallback:",me),alert(`⚠️ Erreur lors de l'envoi de l'archive : ${me}`)}finally{ut(!1)}}},E.click();return}(async()=>{ut(!0);try{const E=await I("http://localhost:5005/api/fs/pick-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:g})}),Q=E?await E.json():null;Q&&Q.success&&(alert("✅ ZIP Copié avec succès dans le dossier : "+g+`
Le fichier est prêt dans votre projet !`),w(2),(Q.fileName||Q.filename)&&qt(Q.fileName||Q.filename))}catch(E){console.warn("Erreur picker ZIP:",E)}finally{ut(!1)}})()},xn=[{id:"home",label:"TIGER IA",icon:"🐯"},{id:"creation",label:"⚙️ Création Projet",icon:"🚀"},{id:"electron",label:"Electron",icon:"💻"},{id:"vercel",label:"Vercel",icon:"▲"},{id:"deepseek",label:"DeepSeek",icon:"🐋"},{id:"override",label:"Override",icon:"💉"},{id:"connexion",label:"Connexion",icon:"⚙️"},{id:"suture",label:"Suture V2",icon:"🩺"}],[be,Kt]=a.useState({current:null,queue:[]}),[mt,At]=a.useState([]),[$e,Mt]=a.useState("src/pages/ShoppingCartDrawer.tsx"),[Ie,Xe]=a.useState([]),[we,qt]=a.useState(()=>typeof window<"u"&&sessionStorage.getItem("tiger_uiZipName")||"");a.useEffect(()=>{typeof window<"u"&&we&&sessionStorage.setItem("tiger_uiZipName",we)},[we]);const[an,Qe]=a.useState(null),[$t,We]=a.useState(null),[Lt,ft]=a.useState(!1),[Wt,rt]=a.useState(!1),[Pt,k]=a.useState([]),Ae=a.useCallback(async i=>{if(!i){k([]);return}try{const g=await I(`http://localhost:5006/api/projects/${i}/pages`);if(g&&g.ok){const b=await g.json();b.pages&&k(b.pages)}}catch{}},[]);a.useEffect(()=>{const i=(typeof f=="string"?f:(f==null?void 0:f.project_id)||(f==null?void 0:f.title))||se;Ae(i)},[f,se,Ae]),a.useRef({current:null,queue:[]});const[jt,fn]=a.useState(localStorage.getItem("suture_dryrun")||"none"),[Pe,Jt]=a.useState(localStorage.getItem("suture_locked_files")||"src/index.css,src/design.css,src/main.tsx,tsconfig.json,vite.config.ts,package.json"),[pe,it]=a.useState([]),[Tt,bt]=a.useState(!1),[Ze,Ut]=a.useState(localStorage.getItem("suture_single_file")!=="false"),[Je,Le]=a.useState(localStorage.getItem("suture_auto_promote")!=="false"),[kt,vt]=a.useState("idle"),[Ue,on]=a.useState("clean");a.useRef(0);const at=()=>{localStorage.setItem("suture_dryrun",jt),localStorage.setItem("suture_locked_files",Pe),localStorage.setItem("suture_single_file",String(Ze)),localStorage.setItem("suture_auto_promote",String(Je)),I("http://localhost:5006/api/suture/config",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({dryRunMode:jt,lockedFiles:Pe.split(",").map(i=>i.trim()).filter(Boolean),singleFileOnly:Ze,autoPromote:Je})}).catch(()=>{}),vt("saved"),setTimeout(()=>vt("idle"),2500)},Ye=async i=>{bt(!0);try{const g=i?`http://localhost:5006/api/suture/history?projectId=${i}`:"http://localhost:5006/api/suture/history",b=await I(g);if(b&&b.ok){const E=await b.json();it(E.repairs||[])}}catch{it([])}finally{bt(!1)}};return a.useEffect(()=>{if(!us())return;let i;if(S==="deploiement"||S==="creation"){const g=()=>{I("http://localhost:5006/api/bridge/queue").then(b=>b?b.json():null).then(b=>{b&&b.success&&Kt({current:b.current||{},queue:b.queue||[]})}).catch(()=>{}),I("http://localhost:5006/api/logs").then(b=>b?b.json():null).then(b=>{b&&b.logs&&At(b.logs)}).catch(()=>{})};g(),i=setInterval(g,1e4)}return()=>clearInterval(i)},[S]),e.jsxs("div",{className:"design-config-modal w-full h-screen bg-gradient-to-br from-[#845e7c]/95 to-[#6c3050]/95 backdrop-blur-2xl border-none shadow-[0_0_50px_rgba(0,0,0,0.8)] relative overflow-hidden flex flex-col md:flex-row pointer-events-auto",children:[!n&&S!=="creation"&&e.jsxs("div",{className:"w-full md:w-64 bg-gradient-to-b from-black/40 to-black/60 border-r border-white/10 flex flex-col",children:[e.jsxs("div",{className:"p-6 border-b border-white/10 flex justify-between items-center",children:[e.jsxs("h3",{className:"text-lg font-black text-white tracking-wider flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"🐯"})," SETTINGS"]}),t&&e.jsx("button",{onClick:r,className:"md:hidden w-8 h-8 rounded-full bg-red-500/20 border border-red-500/50 flex items-center justify-center text-red-500 font-bold hover:bg-red-500 hover:text-white transition-colors",children:"✕"})]}),e.jsx("div",{className:"flex-1 overflow-y-auto py-4 hide-scrollbar flex md:flex-col gap-1 px-4",children:xn.map(i=>{let g="";return i.id==="suture"?Ue==="error"?g="bg-red-600 text-white border-2 border-red-400 shadow-[0_0_20px_#ff0055] animate-pulse font-bold":Ue==="working"?g="bg-purple-600 text-white border-2 border-purple-300 shadow-[0_0_20px_#a855f7] animate-pulse font-bold":g=S==="suture"?"bg-emerald-600/30 border border-emerald-500 text-emerald-300 shadow-[0_0_12px_rgba(16,185,129,0.4)]":"text-emerald-400 border border-emerald-500/30 hover:bg-emerald-950/40":g=S===i.id?"bg-cyan/20 border border-cyan/50 text-white shadow-[0_0_10px_rgba(8,179,201,0.2)]":"text-gray-400 hover:bg-white/5 hover:text-white",e.jsxs("button",{onClick:()=>M(i.id),className:`flex items-center gap-3 px-4 py-3 rounded-xl transition-all whitespace-nowrap md:whitespace-normal ${g}`,children:[e.jsx("span",{className:"text-xl",children:i.icon}),e.jsx("span",{className:"font-bold text-sm tracking-wide",children:i.id==="suture"&&Ue==="error"?"🔴 Suture (Erreur !)":i.id==="suture"&&Ue==="working"?"🟣 Suture V2...":i.label})]},i.id)})})]}),e.jsxs("div",{className:"flex-1 bg-gradient-to-br from-[#111111] to-black relative overflow-hidden flex flex-col",children:[e.jsxs("div",{className:"flex-1 overflow-y-auto p-6 md:p-8 relative z-10 hide-scrollbar",children:[S==="connexion"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsx("h2",{className:"text-xl font-black text-white border-b border-white/10 pb-4",children:"Configuration LLM & Bridge"}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-300 font-bold mb-2 block uppercase tracking-wider text-[10px]",children:"Mode d'exécution"}),e.jsx("div",{className:"grid grid-cols-3 gap-3",children:[{id:"web",icon:"💬",title:"Chat Web"},{id:"api",icon:"🔑",title:"API Directe"},{id:"hybrid",icon:"🔀",title:"Hybride"}].map(i=>e.jsxs("button",{onClick:()=>q(i.id),className:`p-3 rounded-xl border flex flex-col items-center justify-center transition-all ${$===i.id?"bg-gradient-to-br from-cyan/20 to-cyan/10 border-cyan text-white shadow-[0_0_10px_rgba(8,179,201,0.3)]":"bg-gradient-to-br from-black/30 to-black/50 border-white/10 text-gray-500 hover:border-white/30"}`,children:[e.jsx("span",{className:"text-2xl mb-1",children:i.icon}),e.jsx("span",{className:"font-bold text-xs",children:i.title})]},i.id))})]}),($==="web"||$==="hybrid")&&e.jsxs("div",{className:"space-y-3",children:[e.jsx("span",{className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] block mb-2",children:"Flotte d'Assistants (Multi-Acteurs)"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"bg-gradient-to-br from-gray-900/50 to-black/50 p-4 rounded-xl border border-white/10 hover:border-cyan/50 transition-colors",children:[e.jsx("div",{className:"text-[10px] text-cyan mb-2 font-bold flex items-center gap-2",children:"🧠 Cerveau Logique (Backend)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("select",{value:V,onChange:i=>X(i.target.value),className:"flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 outline-none focus:border-cyan text-sm",children:[e.jsx("option",{value:"notebooklm",children:"📓 NotebookLM (Google)"}),e.jsx("option",{value:"deepseek",children:"🐋 DeepSeek Web"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT Web"}),e.jsx("option",{value:"gemini",children:"✨ Gemini Web"}),e.jsx("option",{value:"claude",children:"🟣 Claude Web"}),e.jsx("option",{value:"kimi",children:"🌙 Kimi Web"}),e.jsx("option",{value:"qwen",children:"🌐 Qwen Coder"}),e.jsx("option",{value:"perplexity",children:"🔍 Perplexity AI"}),e.jsx("option",{value:"custom",children:"➕ IA Personnalisée"})]}),e.jsx("button",{onClick:()=>{if(typeof window<"u"&&window.AndroidBridge){const i=V==="custom"?ve:ct(V);window.AndroidBridge.openAIWithPrompt(i,"Initialisation Logique.")}},className:"px-3 bg-white/10 hover:bg-cyan/20 rounded-lg font-bold text-xs transition-colors text-white",children:"▶"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-gray-900/50 to-black/50 p-4 rounded-xl border border-white/10 hover:border-pink/50 transition-colors",children:[e.jsx("div",{className:"text-[10px] text-pink mb-2 font-bold flex items-center gap-2",children:"🎨 Cerveau UI/UX (Frontend)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("select",{value:z,onChange:i=>J(i.target.value),className:"flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 outline-none focus:border-pink text-sm",children:[e.jsx("option",{value:"stitch",children:"🧵 Stitch Google"}),e.jsx("option",{value:"v0",children:"▲ v0.dev (Vercel)"}),e.jsx("option",{value:"bolt",children:"⚡ Bolt.new"}),e.jsx("option",{value:"custom",children:"➕ UI Personnalisée"})]}),e.jsx("button",{onClick:()=>{if(typeof window<"u"&&window.AndroidBridge){const i=z==="custom"?ve:z==="v0"?"https://v0.dev/":"https://stitch.withgoogle.com/";window.AndroidBridge.openAIWithPrompt(i,"Initialisation Design.")}},className:"px-3 bg-white/10 hover:bg-pink/20 rounded-lg font-bold text-xs transition-colors text-white",children:"▶"})]})]})]})]}),(V==="custom"||z==="custom")&&e.jsxs("div",{className:"flex gap-3 bg-white/5 border border-white/20 p-3 rounded-xl mt-2 animate-fadeIn",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("label",{htmlFor:"custom-ai-name",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"Nom IA Custom"}),e.jsx("input",{id:"custom-ai-name",type:"text",value:B,onChange:i=>ae(i.target.value),placeholder:"Mon Agent",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-white/50"})]}),e.jsxs("div",{className:"flex-[2]",children:[e.jsx("label",{htmlFor:"custom-ai-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Complète"}),e.jsx("input",{id:"custom-ai-url",type:"text",value:ve,onChange:i=>G(i.target.value),placeholder:"https://...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-white/50 font-mono"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{htmlFor:"api-provider",className:"text-gray-300 font-bold uppercase tracking-wider text-[10px]",children:"Fournisseur API"}),e.jsxs("select",{id:"api-provider",value:ue,onChange:i=>fe(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-xl px-4 py-3 outline-none focus:border-pink text-sm",children:[e.jsx("option",{value:"deepseek",children:"🐋 DeepSeek"}),e.jsx("option",{value:"openai",children:"🟢 OpenAI (ChatGPT)"}),e.jsx("option",{value:"anthropic",children:"🟣 Anthropic Claude"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("label",{htmlFor:"api-key",className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] flex items-center gap-2",children:["Clé API",Ee==="ok"&&e.jsx("span",{className:"text-green-400 text-[10px] font-bold bg-green-400/10 px-2 py-0.5 rounded-full border border-green-400/30",children:"✅ Persistante sur disque"}),Ee==="sending"&&e.jsx("span",{className:"text-yellow-400 text-[10px] animate-pulse",children:"⏳ Envoi..."}),Ee==="error"&&e.jsx("span",{className:"text-red-400 text-[10px]",children:"❌ Erreur moteur"})]}),e.jsx("div",{className:"flex gap-2 relative",children:e.jsx("input",{id:"api-key",type:"password",value:H,onChange:i=>re(i.target.value),placeholder:"sk-...",className:`flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border rounded-xl px-4 py-3 outline-none text-sm font-mono transition-colors ${Ee==="ok"?"border-green-500/50 focus:border-green-400":Ee==="error"?"border-red-500/50":"border-white/20 focus:border-pink"}`})}),e.jsxs("div",{className:"flex items-center gap-4 mt-2",children:[e.jsx("button",{onClick:Dt,className:"px-4 py-2 bg-cyan/20 hover:bg-cyan/40 border border-cyan/40 text-cyan rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center gap-2",children:"💾 SAUVEGARDER + ENVOYER AU MOTEUR"}),e.jsx("span",{className:"text-gray-500 text-xs italic",children:"Persistée sur disque (reste après redémarrage)."})]})]}),e.jsxs("div",{className:"space-y-2 p-4 bg-gradient-to-br from-black/30 to-black/50 border border-white/5 rounded-xl",children:[e.jsx("span",{className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] block",children:"Modèle détecté"}),e.jsx("div",{className:"text-gray-500 text-sm mb-2",children:"Enregistrer la clé pour détecter"}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{className:"px-4 py-2 bg-pink/20 text-pink border border-pink/50 hover:bg-pink/30 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center gap-2",children:"🔄 AUTO_DETECT"}),e.jsx("span",{className:"text-gray-500 text-xs italic",children:"Auto-détecté à l'enregistrement."})]})]}),e.jsx("div",{className:"pt-4 border-t border-white/10",children:D?e.jsxs("div",{className:"space-y-4",children:[e.jsxs("h3",{className:"text-cyan font-bold flex items-center gap-2 text-sm mb-2",children:["📱 Moteur Mobile Natif",e.jsx("span",{className:"text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30",children:"Connecté"})]}),e.jsxs("p",{className:"text-xs text-gray-400 leading-relaxed",children:["La configuration automatique est active. Les prompts sont injectés via la WebView Fantôme Java et les fichiers sont sauvegardés nativement sur votre téléphone.",e.jsx("br",{}),e.jsx("br",{}),e.jsx("strong",{children:"Aucun Bridge Electron PC n'est requis."})," L'OS Souverain est 100% autonome dans votre poche."]})]}):e.jsxs(e.Fragment,{children:[e.jsxs("h3",{className:"text-cyan font-bold flex items-center gap-2 text-sm mb-4",children:["🔗 Bridge (:5006 / Vercel)",e.jsx("span",{className:"text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30",children:"Bridge polling actif"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"bridge-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Bridge local"}),e.jsx("input",{id:"bridge-url",type:"text",value:ee,onChange:i=>de(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"vercel-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Vercel"}),e.jsx("input",{id:"vercel-url",type:"text",value:xe,onChange:i=>_e(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"default-preview",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Preview par défaut"}),e.jsx("input",{id:"default-preview",type:"text",value:te,onChange:i=>T(i.target.value),placeholder:"http://127.0.0.1:3000",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]})]}),e.jsxs("div",{className:"flex gap-3 mt-4",children:[e.jsx("button",{className:"px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-xs font-bold text-white transition-colors",children:"🔗 Tester"}),e.jsx("button",{onClick:Dt,className:"px-4 py-2 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-lg text-xs font-bold uppercase transition-colors",children:"💾 SAUVEGARDER_CONFIG"})]}),e.jsx("div",{className:"text-green-400 text-xs font-bold mt-4 flex items-center gap-2",children:"✅ Bridge connecté (auto-détecté)"})]})}),e.jsxs("div",{className:"pt-4 border-t border-white/10 space-y-4",children:[e.jsx("h3",{className:"text-blue-400 font-bold flex items-center gap-2 text-sm",children:"📓 NotebookLM Auto-Push (Python)"}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"notebook-id",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"Notebook ID (URL)"}),e.jsx("input",{id:"notebook-id",type:"text",value:rn,onChange:i=>xt(i.target.value),placeholder:"6cd96956-...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-blue-500"})]}),e.jsxs("div",{children:[e.jsxs("label",{htmlFor:"auth-cookie",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px] flex justify-between",children:[e.jsx("span",{children:"Cookie d'authentification (__Secure-1PSID)"}),It==="success"&&e.jsx("span",{className:"text-green-400",children:"🟢 Connecté"}),It==="error"&&e.jsx("span",{className:"text-red-400",children:"🔴 Erreur / Expiré"}),It==="testing"&&e.jsx("span",{className:"text-yellow-400",children:"⏳ Test..."})]}),e.jsx("input",{id:"auth-cookie",type:"password",value:wt,onChange:i=>dt(i.target.value),placeholder:"Collez votre cookie d'authentification Google ici...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1 outline-none focus:border-blue-500"})]}),e.jsxs("div",{className:"flex gap-3 mt-4",children:[e.jsx("button",{onClick:Dt,className:"px-4 py-2 bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30 rounded-lg text-xs font-bold uppercase transition-colors",children:"💾 Sauvegarder"}),e.jsx("button",{onClick:async()=>{st("testing"),setTimeout(()=>st("success"),1e3)},className:"px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg text-xs font-bold uppercase transition-colors",children:"🧪 Tester"})]}),e.jsx("p",{className:"text-[10px] text-gray-500 italic",children:"Note : Ce cookie expire régulièrement. Pensez à le mettre à jour s'il ne fonctionne plus."})]})]})]}),S==="suture"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",onMouseEnter:()=>{pe.length===0&&Ye()},children:[e.jsxs("div",{className:"flex items-center justify-between border-b border-white/10 pb-4",children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-3",children:[e.jsx("span",{className:"text-3xl",children:"🩺"}),e.jsxs("div",{children:[e.jsx("div",{children:"Suture V2 — Moteur Zero-Touch"}),e.jsx("div",{className:"text-[10px] font-normal text-gray-400 mt-0.5",children:"Réparation autonome, isolée et atomique"})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-3 h-3 rounded-full ${Ue==="error"?"bg-red-500 shadow-[0_0_12px_#ff0055] animate-ping":Ue==="working"?"bg-purple-500 shadow-[0_0_12px_#a855f7] animate-pulse":"bg-emerald-400 shadow-[0_0_8px_#4ade80]"}`}),e.jsx("span",{className:`text-[11px] font-black uppercase tracking-wider ${Ue==="error"?"text-red-400":Ue==="working"?"text-purple-300":"text-emerald-400"}`,children:Ue==="error"?"🔴 ERREUR DÉTECTÉE (SUTURE REQUIS)":Ue==="working"?"🟣 SUTURE V2 EN COURS...":"🟢 MOTEUR AUTO-PILOT PRÊT"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a1a0a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-green-400 flex items-center gap-2",children:"🔬 Mode de Validation (Dry-Run)"}),e.jsx("p",{className:"text-[10px] text-gray-500 leading-relaxed",children:"Contrôle si le moteur compile le code dans le bac à sable avant de l'appliquer en production."}),e.jsx("div",{className:"grid grid-cols-3 gap-3",children:[{id:"none",icon:"🚀",label:"Production",desc:"Applique directement"},{id:"plan",icon:"🗺️",label:"Plan Only",desc:"Génère sans appliquer"},{id:"true",icon:"🧪",label:"Full Dry-Run",desc:"Clone + build + bloque"}].map(i=>e.jsxs("button",{onClick:()=>fn(i.id),className:`p-3 rounded-xl border flex flex-col items-center justify-center gap-1 transition-all text-center ${jt===i.id?"bg-green-900/40 border-green-500/70 text-white shadow-[0_0_12px_rgba(74,222,128,0.2)]":"bg-black/30 border-white/10 text-gray-500 hover:border-white/30 hover:text-gray-300"}`,children:[e.jsx("span",{className:"text-xl",children:i.icon}),e.jsx("span",{className:"font-black text-[10px]",children:i.label}),e.jsx("span",{className:"text-[9px] opacity-70",children:i.desc})]},i.id))})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a0a1a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-cyan flex items-center gap-2",children:"⚡ Options de Promotion"}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("label",{className:"flex items-center justify-between cursor-pointer bg-black/20 px-4 py-3 rounded-xl hover:bg-white/5 transition-colors",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm",children:"Promotion Automatique"}),e.jsx("div",{className:"text-[10px] text-gray-500",children:"Si la compilation réussit, le patch est appliqué sans confirmation"})]}),e.jsx("div",{onClick:()=>Le(i=>!i),className:`relative w-12 h-6 rounded-full transition-colors cursor-pointer ${Je?"bg-cyan":"bg-white/10"}`,children:e.jsx("div",{className:`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${Je?"left-7":"left-1"}`})})]}),e.jsxs("label",{className:"flex items-center justify-between cursor-pointer bg-black/20 px-4 py-3 rounded-xl hover:bg-white/5 transition-colors",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm",children:"Fichier Unique Seulement"}),e.jsx("div",{className:"text-[10px] text-gray-500",children:"La Suture ne peut modifier qu'un seul fichier par réparation (plus sûr)"})]}),e.jsx("div",{onClick:()=>Ut(i=>!i),className:`relative w-12 h-6 rounded-full transition-colors cursor-pointer ${Ze?"bg-cyan":"bg-white/10"}`,children:e.jsx("div",{className:`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${Ze?"left-7":"left-1"}`})})]})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#1a0a0a]/60 border border-red-500/20 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-red-400 flex items-center gap-2",children:"🔒 Fichiers Verrouillés (Intouchables)"}),e.jsxs("p",{className:"text-[10px] text-gray-500 leading-relaxed",children:["Ces fichiers ne seront ",e.jsx("strong",{className:"text-red-300",children:"JAMAIS"})," modifiés par une Suture, même si l'IA essaie. Séparés par des virgules."]}),e.jsx("textarea",{value:Pe,onChange:i=>Jt(i.target.value),rows:3,className:"w-full bg-black/40 text-red-200 border border-red-500/20 rounded-lg px-3 py-2 text-[11px] font-mono outline-none focus:border-red-500/50 resize-none",placeholder:"src/design.css,package.json,..."}),e.jsx("div",{className:"flex flex-wrap gap-2",children:Pe.split(",").map(i=>i.trim()).filter(Boolean).map(i=>e.jsxs("span",{className:"flex items-center gap-1 bg-red-900/20 border border-red-500/30 text-red-300 text-[9px] font-mono px-2 py-1 rounded-full",children:["🔒 ",i,e.jsx("button",{onClick:()=>Jt(g=>g.split(",").map(b=>b.trim()).filter(b=>b!==i).join(", ")),className:"text-red-500 hover:text-white ml-1 font-bold",children:"×"})]},i))})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a0a0a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-yellow-400 flex items-center gap-2",children:"⚡ Actions Rapides Suture"}),e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx("button",{onClick:()=>I("http://localhost:5006/api/suture/purge-workspaces",{method:"POST"}).then(i=>alert(i?"✅ Bac à sable vidé !":"❌ Moteur inaccessible (Mode Cloud SaaS)")).catch(()=>alert("❌ Moteur inaccessible")),className:"py-3 bg-orange-900/20 hover:bg-orange-900/40 border border-orange-500/30 text-orange-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"🗑️ Vider le Bac à Sable"}),e.jsx("button",{onClick:()=>Ye(),className:"py-3 bg-blue-900/20 hover:bg-blue-900/40 border border-blue-500/30 text-blue-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"🔄 Rafraîchir Historique"}),e.jsx("button",{onClick:()=>I("http://localhost:5006/api/suture/rollback-last",{method:"POST"}).then(i=>i?i.json():null).then(i=>alert(i?i.success?`✅ Rollback : ${i.message}`:`❌ ${i.error}`:"❌ Moteur inaccessible (Mode Cloud SaaS)")).catch(()=>alert("❌ Moteur inaccessible")),className:"py-3 bg-purple-900/20 hover:bg-purple-900/40 border border-purple-500/30 text-purple-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"↩️ Rollback Dernier Patch"}),e.jsx("button",{onClick:at,className:`py-3 border rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all ${kt==="saved"?"bg-green-900/40 border-green-500/50 text-green-300":"bg-cyan/10 hover:bg-cyan/20 border-cyan/40 text-cyan"}`,children:kt==="saved"?"✅ Sauvegardé !":"💾 Sauvegarder Config"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-gray-400 flex items-center gap-2",children:"📋 Historique des Réparations"}),e.jsx("button",{onClick:()=>Ye(),className:"text-[9px] text-cyan hover:text-white bg-cyan/10 px-2 py-1 rounded",children:"Actualiser"})]}),e.jsxs("div",{className:"max-h-[200px] overflow-y-auto hide-scrollbar space-y-2",children:[Tt&&e.jsx("div",{className:"text-center text-gray-500 text-[10px] animate-pulse py-4",children:"⏳ Chargement..."}),!Tt&&pe.length===0&&e.jsx("div",{className:"text-center text-gray-600 text-[10px] italic py-4",children:"Aucune réparation trouvée. Cliquez sur 🩺 dans l'explorateur pour lancer une Suture."}),pe.map((i,g)=>e.jsxs("div",{className:`flex items-center justify-between p-3 rounded-lg border text-[10px] font-mono ${i.status==="applied"?"bg-green-900/10 border-green-500/20":i.status==="failed"?"bg-red-900/10 border-red-500/20":"bg-white/5 border-white/10"}`,children:[e.jsxs("div",{className:"flex flex-col gap-0.5 truncate flex-1 mr-2",children:[e.jsx("span",{className:"text-white font-bold truncate",children:i.repairId||i.id}),e.jsxs("span",{className:"text-gray-500 truncate",children:[i.projectId," — ",i.activeFile||"?"]}),e.jsx("span",{className:"text-gray-600",children:i.startedAt?new Date(i.startedAt).toLocaleString("fr-FR"):""})]}),e.jsx("span",{className:`shrink-0 px-2 py-0.5 rounded-full border text-[9px] font-bold ${i.status==="applied"?"bg-green-900/30 border-green-500/40 text-green-300":i.status==="failed"?"bg-red-900/30 border-red-500/40 text-red-300":"bg-yellow-900/30 border-yellow-500/40 text-yellow-300"}`,children:i.status==="applied"?"✅ Appliqué":i.status==="failed"?"❌ Échec":"⚠️ Partiel"})]},g))]})]})]}),S==="creation"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn flex flex-col mt-8 border-t border-white/10 pt-8 pr-2",children:[e.jsxs("div",{className:"flex flex-col border-b border-white/5 pb-4",children:[e.jsxs("h2",{className:"text-2xl font-black text-white flex items-center gap-2 tracking-wide uppercase",children:[e.jsx("span",{children:"⚙️"})," CONFIGURATION DU PROJET"]}),e.jsx("p",{className:"text-[10px] text-gray-400 mt-1",children:"Générez et paramétrez votre projet de A à Z."})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1 min-h-0",children:[e.jsxs("div",{className:"transition-opacity duration-1000",children:[e.jsxs("div",{className:"bg-[#050505] border border-white/5 rounded-xl flex flex-col gap-4 overflow-y-auto hide-scrollbar p-5 mb-6",children:[e.jsxs("h3",{className:"text-white font-bold text-xs mb-2 flex items-center gap-2",children:[e.jsx("span",{className:"text-yellow-500",children:"📁"})," Création & Ciblage"]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"CIBLER UN PROJET EXISTANT"}),e.jsxs("select",{value:typeof f=="string"?f:(f==null?void 0:f.project_id)||(f==null?void 0:f.title)||"",onChange:i=>L(i.target.value),onClick:async()=>{if(_.length===0)try{const i=await I("/api/projects");if(i&&i.ok){const g=await i.json();g.projects&&v(g.projects.map(b=>typeof b=="string"?b:b.project_id||b.title||b.name||""))}else{const b=await(await fetch("/api/projects")).json();b.projects&&v(b.projects.map(E=>typeof E=="string"?E:E.project_id||E.title||E.name||""))}}catch{}},className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 outline-none focus:border-cyan text-xs",children:[e.jsx("option",{value:"",children:"-- SÉLECTIONNER UN PROJET --"}),_.map((i,g)=>{const b=typeof i=="string"?i:i.project_id||i.title||i.name||"Projet "+g;return e.jsx("option",{value:b,children:b},b+"_"+g)})]}),f&&Rt==="idle"&&e.jsx("button",{onClick:async()=>{ze("loading");try{const i=await I("http://localhost:5006/api/bridge/export-notebooklm",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:f,notebookId:rn,authCookie:wt})});if(!i){alert("Mode Cloud SaaS : Bridge local non connecté."),ze("idle");return}const g=await i.json();g.success?(nn(g.combinedContent||""),g.pushLog&&g.pushLog.includes("Failed:")?(sn(g.pushLog),ze("error")):ze("ready")):(sn(g.message),ze("error"))}catch{sn("Erreur de connexion avec Kirov5."),ze("error")}},className:"mt-2 w-full bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-2",children:"📓 Préparer l'export NotebookLM"}),f&&Rt==="loading"&&e.jsx("button",{disabled:!0,className:"mt-2 w-full bg-gray-900/50 text-gray-400 border border-gray-700/50 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider flex items-center justify-center gap-2",children:"⏳ Extraction de l'expertise..."}),f&&Rt==="ready"&&e.jsx("button",{onClick:async()=>{try{await navigator.clipboard.writeText(tn),window.open("https://notebook.google.com/notebook/6cd96956-200e-4260-ae7d-6c1446de284a","_blank"),ze("idle")}catch{alert("❌ Copie échouée. Essayez sur HTTPS ou utilisez Ctrl+C manuellement.")}},className:"mt-2 w-full bg-green-900/40 hover:bg-green-800/60 text-green-300 border border-green-500/50 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-2",children:"✅ Copier & Ouvrir NotebookLM"}),f&&Rt==="error"&&e.jsxs("div",{className:"mt-2 p-3 bg-red-900/30 border border-red-500/50 rounded-lg",children:[e.jsx("div",{className:"text-red-400 text-[10px] font-bold mb-2",children:"⚠️ Échec du script Python (Copiez l'erreur ci-dessous) :"}),e.jsx("textarea",{readOnly:!0,value:Rn,className:"w-full h-24 bg-black/50 text-red-300 text-[10px] font-mono p-2 rounded border border-red-500/20 outline-none"}),e.jsxs("div",{className:"flex gap-2 mt-2",children:[e.jsx("button",{onClick:()=>ze("idle"),className:"flex-1 bg-gray-800 hover:bg-gray-700 text-white text-[10px] py-2 rounded font-bold",children:"🔄 Réessayer"}),e.jsx("button",{onClick:async()=>{try{await navigator.clipboard.writeText(tn),window.open("https://notebook.google.com/notebook/6cd96956-200e-4260-ae7d-6c1446de284a","_blank"),ze("idle")}catch{alert("❌ Copie échouée.")}},className:"flex-1 bg-green-900/50 hover:bg-green-800/70 text-green-300 border border-green-500/50 text-[10px] py-2 rounded font-bold",children:"✅ Fallback Manuel"})]})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"NOM DU NOUVEAU PROJET"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"text",value:se,onChange:i=>De(i.target.value),placeholder:"Ex: MonSuperProjet",className:"flex-1 bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan"}),e.jsx("button",{onClick:async()=>{if(!se||!se.trim()){alert("Entrez un nom de projet");return}const i=se.trim();try{const g=localStorage.getItem("kirov5_jwt_token")||"",b=await fetch("/api/projects",{method:"POST",headers:{"Content-Type":"application/json",...g?{Authorization:`Bearer ${g}`}:{}},body:JSON.stringify({title:i,name:i,projectId:i.replace(/[^a-zA-Z0-9_-]/g,"_"),description:"Projet Tiger Cloud"})}),E=await b.json();b.ok&&(E.success||E.project)?(alert(`✅ Projet "${i}" créé avec succès !`),setActiveProject(i),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",i),fetch("/api/projects",{headers:g?{Authorization:`Bearer ${g}`}:{}}).then(Q=>Q.json()).then(Q=>{Q&&Q.projects&&setRealProjects(Q.projects.map(P=>({name:P.project_id||P.title||P.name,desc:P.owner_email?`Propriétaire: ${P.owner_email}`:"Projet Cloud",bg:""})))}).catch(()=>{})):alert("❌ Erreur création projet: "+(E.error||E.message||"Erreur inconnue"))}catch(g){alert("❌ Erreur de connexion avec le serveur: "+((g==null?void 0:g.message)||g))}},className:"bg-[#0f2a2a] hover:bg-[#153f3f] text-cyan border border-cyan/30 px-4 py-2 rounded-lg text-xs font-bold transition-colors",children:"Valider"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"STACK TECHNIQUE"}),e.jsxs("select",{value:gn,onChange:i=>Ct(i.target.value),className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",children:[e.jsx("option",{value:"vite",children:"⭐ 1er Choix (Prioritaire) : Vite + React + Tailwind + TS"}),e.jsx("option",{value:"nextjs",children:"Next.js 16 + Tailwind"})]})]}),e.jsxs("div",{className:"flex-1 flex flex-col",children:[e.jsxs("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2 flex items-center gap-1",children:[e.jsx("span",{className:"text-white",children:"📄"})," INSTRUCTIONS / VISION"]}),e.jsx("textarea",{value:nt,onChange:i=>Re(i.target.value),placeholder:"Décrivez l'application ou copiez votre PRD...",className:"w-full flex-1 min-h-[120px] bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan resize-none"})]})]}),e.jsxs("div",{className:"bg-[#050505] border border-white/5 rounded-xl flex flex-col gap-4 overflow-y-auto hide-scrollbar p-5 transition-opacity duration-1000",children:[e.jsxs("h3",{className:"text-white font-bold text-xs mb-2 flex items-center gap-2",children:[e.jsx("span",{className:"text-yellow-500",children:"⚡"})," Paramètres & IA"]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"INTELLIGENCE CIBLE"}),e.jsxs("select",{className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",onChange:i=>{const g=i.target.value;window.KIROV_TARGET_AI=g,typeof window<"u"&&localStorage.setItem("tiger_targetAi",g);let b="";g==="stitch"?b="https://stitch.withgoogle.com":g==="deepseek"||g==="deepseek-web"?b="https://chat.deepseek.com":g==="gemini"?b="https://gemini.google.com":g==="chatgpt"?b="https://chatgpt.com":g==="claude"?b="https://claude.ai":g==="notebooklm"&&(b="https://notebooklm.google.com"),b&&I("http://localhost:5006/api/bridge/open-window",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:b})}).catch(E=>console.warn("Erreur ouverture fenêtre",E))},defaultValue:typeof window<"u"&&localStorage.getItem("tiger_targetAi")||"hermes",children:[e.jsx("option",{value:"notebooklm",children:"📓 NotebookLM (Google)"}),e.jsx("option",{value:"cloudflare",children:"☁️ Cloudflare Qwen 3 30B (Audit IA Grade Gold)"}),e.jsx("option",{value:"cloudflare-hermes",children:"⚡ Hermes Cloudflare Workers AI (Qwen Coder)"}),e.jsx("option",{value:"deepseek",children:"🩵 DeepSeek (Extension Web)"}),e.jsx("option",{value:"hermes",children:"🤖 Hermes Agent (API DeepSeek)"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT"}),e.jsx("option",{value:"claude",children:"🟣 Claude"})]})]}),e.jsxs("div",{children:[e.jsxs("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:["💉 MODE & LOT DE DÉPART (Val: ",y,")"]}),e.jsxs("select",{value:y,onChange:i=>w(Number(i.target.value)),className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",children:[e.jsx("option",{value:0,children:"🚀 TOUT : Pipeline Complète (Zero-Touch)"}),e.jsx("option",{value:1,children:"🎨 Phase 1 : Le Frontend (Stitch/v0)"}),e.jsx("option",{value:2,children:"⚙️ Phase 2 : Logique G5"}),e.jsx("option",{value:4,children:"🎨 Phase 3/4 : Câblage Métier (Business Wiring)"}),e.jsx("option",{value:5,children:"🔌 Phase 5 : Industrialisation & Backend"}),e.jsx("option",{value:9,children:"🪄 M.A.J UI : Pipeline Push UI/UX (One-Shot)"})]})]}),e.jsxs("div",{className:"flex flex-col gap-3 mt-4 bg-[#111] p-4 rounded-lg border border-white/5",children:[e.jsxs("label",{className:"flex items-center gap-3 text-[11px] font-bold text-gray-300 cursor-pointer",children:[e.jsx("input",{type:"checkbox",className:"accent-cyan w-4 h-4",checked:K,onChange:()=>A(!K)}),"🤖 AUTO-PILOT : ",K?"ON 🟢":"OFF ⚪"]}),e.jsxs("label",{className:"flex items-center gap-3 text-[11px] font-bold text-gray-300 cursor-pointer",children:[e.jsx("input",{type:"checkbox",className:"accent-cyan w-4 h-4",checked:F,onChange:()=>W(!F)}),"🔗 Injecter dans l'onglet ouvert"]})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-3 mt-4",children:[e.jsxs("div",{id:"btn-joindre-prd",className:`py-6 text-white text-[10px] font-bold rounded-lg border flex flex-col items-center justify-center gap-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${zt?"bg-purple-950/80 border-purple-400 animate-pulse":(window.KIROV_SELECTED_PACKS||O).length>0?"bg-indigo-600 border-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.6)]":"bg-[#2a1b3d] border-purple-500/30"}`,title:"Pack PRD sélectionné — Sera injecté automatiquement dans le contexte IA",children:[e.jsx("span",{className:"text-xl",children:zt?"⏳":"💎"}),e.jsx("span",{children:zt?"Copie en cours...":(window.KIROV_SELECTED_PACKS||O).length>0?`Packs PRD ${(window.KIROV_SELECTED_PACKS||O).length} ${(window.KIROV_SELECTED_PACKS||O)[0]}`:"Aucun Pack PRD"})]}),e.jsxs("button",{id:"btn-joindre-zip",disabled:Ke,onClick:()=>{Number(y)===0&&(Nt(!0),typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning","true")),pt()},className:`py-6 text-white text-[10px] font-bold rounded-lg border transition-all flex flex-col items-center justify-center gap-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${Ke?"bg-amber-950/70 border-amber-500 text-amber-300 animate-pulse":Number(y)===2&&!we?"bg-cyan-950/80 border-2 border-cyan text-cyan shadow-[0_0_30px_rgba(6,182,212,0.7)] animate-pulse scale-105 ring-2 ring-cyan/40 cursor-pointer":He?"bg-[#1a3a40] hover:bg-[#204a50] pointer-events-auto shadow-[0_0_30px_rgba(8,179,201,0.6)] border-cyan scale-105 z-50 relative animate-pulse":"bg-[#1a2f3a] hover:bg-[#254250] border-cyan/30"}`,title:we?`Archive importée : ${we}`:"Joindre le fichier ZIP exporté depuis Stitch",children:[e.jsx("span",{className:"text-xl",children:Ke?"⏳":we?"✅":"📎"}),e.jsx("span",{className:"font-extrabold",children:Ke?"Extraction en cours...":we?`ZIP : ${we}`:"Joindre ZIP (Stitch)"}),Number(y)===2&&!we&&!Ke&&e.jsx("span",{className:"text-[9px] text-cyan-300 font-extrabold uppercase animate-bounce mt-0.5",children:"👇 Étape 2 : Joindre le ZIP ici"})]})]}),(()=>{const g={0:"🚀 LANCER PIPELINE COMPLÈTE (ONE-SHOT)",1:"✨ LANCER PHASE 1 (Prompt vers l'IA)",2:we?`⚙️ LANCER PHASE 2 (MULTI-BATCH) [${we}]`:"⚙️ LANCER PHASE 2 (MULTI-BATCH) — ⏳ EN ATTENTE DU ZIP STITCH",3:"🎨 LANCER PHASE 3/4 (CÂBLAGE MÉTIER)",4:"🎨 LANCER PHASE 3/4 (CÂBLAGE MÉTIER)",5:"🔌 LANCER PHASE 5 (INDUSTRIALISATION)",9:"🛡️ LANCER PUSH UI"}[Number(y)];return g?e.jsx("button",{id:"btn-lancer-phase",onClick:()=>{const b=f||se;if(!b){alert("Veuillez sélectionner ou créer un projet !");return}if(Number(y)===2&&!we){confirm(`📁 Le fichier .zip Stitch n'est pas encore joint à ce projet.

Souhaitez-vous sélectionner et importer votre archive ZIP maintenant ?`)&&pt();return}Nt(!0),typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning","true"),setTimeout(()=>{var P;(P=document.getElementById("kirov-radar-queue"))==null||P.scrollIntoView({behavior:"smooth"})},500);const E=window.KIROV_TARGET_AI||typeof window<"u"&&localStorage.getItem("tiger_targetAi")||"hermes";if(typeof r=="function"&&r(),M("home"),typeof window<"u"&&window.dispatchEvent(new CustomEvent("open-mouchard")),Number(y)===5){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:b,target_ai:E,start_index:1,zip_mode:!0,start_phase:5,auto_pilot:K})}).then(P=>P?P.json():null).then(P=>{alert(P?`✅ PHASE 5 (INDUSTRIALISATION) LANCÉE !
L'orchestrateur génère l'infrastructure et certifie le projet.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(P=>{console.error(P),alert("Erreur lors du lancement de la Phase 5.")});return}if(Number(y)===4||Number(y)===3){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:b,target_ai:E,start_index:1,zip_mode:!0,start_phase:4,auto_pilot:K,packs:window.KIROV_SELECTED_PACKS||[]})}).then(P=>P?P.json():null).then(P=>{alert(P?`✅ PHASE 3/4 (CÂBLAGE MÉTIER) LANCÉE !
L'orchestrateur prend le relais pour connecter et câbler la logique métier.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(P=>{console.error(P),alert("Erreur lors du lancement de la Phase 3/4.")});return}if(Number(y)===2){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:b,target_ai:E,start_index:1,zip_mode:!0,start_phase:200,auto_pilot:K,packs:window.KIROV_SELECTED_PACKS||[]})}).then(P=>P?P.json():null).then(P=>{alert(P?`✅ PHASE 2 (LOGIQUE G5) LANCÉE !
L'orchestrateur prend le relais pour générer le Backend et intégrer les composants.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(P=>{console.error(P),alert("Erreur: Le moteur n'a pas pu être contacté.")});return}typeof window<"u"&&(window.open("https://stitch.withgoogle.com/","_blank"),window.dispatchEvent(new CustomEvent("open-mouchard")));const Q=window.KIROV_SELECTED_PACKS&&window.KIROV_SELECTED_PACKS.length>0?window.KIROV_SELECTED_PACKS:O&&O.length>0?O:[];if(Number(y)===0){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:b,target_ai:"stitch",start_index:1,zip_mode:!0,start_phase:0,auto_pilot:K,instructions:nt||"Génère l'application avec ces packs et directives.",packs:Q})}).then(P=>P?P.json():null).then(P=>{var ot;const me=(P==null?void 0:P.prompt)||((ot=P==null?void 0:P.data)==null?void 0:ot.prompt)||"Génération UI/UX Stitch complète.",je=Q.length>0?Q.join(", "):"standard";if(w(2),typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase","2"),typeof document<"u"){const ke=document.getElementById("tiger-mega-prompt-overlay");ke&&ke.remove();const et=document.createElement("div");et.id="tiger-mega-prompt-overlay",et.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);backdrop-filter:blur(10px);z-index:999999;display:flex;align-items:center;justify-content:center;padding:16px;font-family:sans-serif;",et.innerHTML=`
                                  ...
                                  <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid rgba(255,255,255,0.1);padding-bottom:12px;">
                                    <div>
                                      ...
                                      <p style="margin:4px 0 0 0;font-size:11px;color:#94a3b8;">
                                        Projet : <strong style="color:#e2e8f0;">${b}</strong> | Pack PRD : <strong style="color:#a855f7;">${je}</strong>
                                      </p>
                                    </div>
                              ...
                              `,document.body.appendChild(et);const St=document.getElementById("tiger-prompt-area"),Oe=document.getElementById("btn-copy-prompt"),yt=document.getElementById("btn-close-prompt-overlay"),Fe=document.getElementById("btn-open-stitch"),s=()=>{St&&(St.select(),St.setSelectionRange(0,99999),document.execCommand("copy")),navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),w(2),Oe&&(Oe.innerHTML="✅ COPIÉ DANS LE PRESSE-PAPIER !",Oe.style.background="linear-gradient(135deg,#10b981,#059669)",setTimeout(()=>{Oe&&(Oe.innerHTML="📋 COPIER LE MÉGA-PROMPT",Oe.style.background="linear-gradient(135deg,#06b6d4,#2563eb)")},3e3))};Oe&&(Oe.onclick=()=>{s(),w(2)}),yt&&(yt.onclick=()=>{et.remove(),w(2)}),Fe&&(Fe.onclick=()=>{window.open("https://stitch.withgoogle.com/","_blank"),w(2)}),s(),w(2)}}).catch(P=>{console.error(P),alert("Erreur de communication avec le serveur Kirov5.")});return}I("/api/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:"stitch",user_prompt:nt||"Génère l'application avec ces packs et directives.",packs:Q,target_project:b,phase_num:1})}).then(P=>P?P.json():null).then(P=>{var je;const me=(P==null?void 0:P.prompt)||((je=P==null?void 0:P.data)==null?void 0:je.prompt)||"Génération UI/UX Stitch.";typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),alert(`🚀 PHASE 1 (STITCH UI/UX) INITIALISÉE !
...
*Le fichier README complet est disponible dans le dossier prd_packs/${L.packId}/README.md.*`),e.jsxs("div",{className:"design-fenetre-readme w-full rounded-3xl p-6 md:p-8 border-2 border-cyan/60 shadow-[0_0_80px_rgba(124,58,237,0.45)] my-4 relative animate-fadeIn text-white z-20 flex flex-col min-h-[480px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 flex-shrink-0",children:[e.jsxs("span",{className:"px-3.5 py-1.5 bg-cyan/20 text-cyan text-xs font-bold rounded-xl border border-cyan/40 flex items-center gap-2 shadow-sm",children:[e.jsx("span",{children:"💎"})," PACK PRD : ",L.packId]}),e.jsx("button",{onClick:()=>W(null),className:"w-10 h-10 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-xl flex items-center justify-center font-bold text-lg transition-all border border-cyan/40 cursor-pointer shadow-md",title:"Fermer (Retour aux packs)",children:"✕"})]}),e.jsx("h2",{className:"text-2xl md:text-3xl font-black text-cyan mb-2 leading-tight drop-shadow-[0_2px_10px_rgba(6,182,212,0.5)] flex-shrink-0",children:L.packName}),e.jsx("div",{className:"w-full h-px bg-gradient-to-r from-cyan via-purple-400 to-cyan/20 mb-4 flex-shrink-0"}),e.jsx("div",{className:"design-readme-contenu flex-1 text-white font-medium leading-relaxed whitespace-pre-wrap overflow-y-auto max-h-[500px] p-6 rounded-2xl border-2 border-cyan/50 font-mono text-sm shadow-[0_0_40px_rgba(8,179,201,0.3)] min-h-[300px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)",textShadow:"0 1px 2px rgba(0,0,0,0.8)"},children:y}),e.jsxs("div",{className:"mt-6 pt-4 border-t border-white/15 flex justify-between items-center flex-shrink-0",children:[e.jsxs("span",{className:"text-xs text-cyan/90 font-mono font-bold tracking-widest uppercase flex items-center gap-2",children:[e.jsx("span",{children:"⚡"})," SUTURE PRD ENGINE"]}),e.jsx("button",{onClick:()=>W(null),className:"px-6 py-2.5 bg-cyan/20 hover:bg-cyan/40 text-cyan font-bold rounded-xl transition-all border border-cyan/40 flex items-center gap-2 cursor-pointer hover:bg-cyan/30 shadow-md",children:"← Fermer & Retour aux packs"})]})]})}return e.jsxs("div",{id:"prd-packs-carousel-section",className:"w-full flex-1 min-w-0 my-2",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3 px-2",children:[e.jsxs("h4",{className:"design-prd-titre-section font-black uppercase tracking-widest text-cyan flex items-center gap-2",children:[e.jsx("span",{children:"💎"})," PACKS PRD DE CONNAISSANCES (",Ft.length,")"]}),t&&t.length>0&&e.jsxs("span",{className:"text-[11px] font-bold text-cyan bg-cyan/20 px-2.5 py-1 rounded-full border border-cyan/30",children:[t.length," pack(s) actif(s)"]})]}),e.jsx("div",{className:"flex gap-4 items-stretch relative w-full",children:e.jsx("div",{className:"flex-1 min-w-0 min-h-[480px] overflow-hidden py-4 flex items-center",children:m?K.length===0?e.jsxs("div",{className:"h-full min-h-[220px] rounded-2xl p-6 border border-purple-500/20 bg-purple-950/20 backdrop-blur-md flex flex-col items-center justify-center text-center",children:[e.jsx("p",{className:"text-purple-300 font-bold text-sm",children:"Aucun pack Guest n'a encore été généré."}),e.jsx("p",{className:"text-xs text-zinc-400 mt-2",children:"Utilisez l'interface V0-GUEST pour scanner un projet local et créer un pack sur-mesure."}),e.jsx("button",{onClick:F,className:"mt-4 text-xs text-purple-300 border border-purple-500/40 px-4 py-1.5 rounded-full hover:bg-purple-900/40 transition-colors",children:"🔄 Recharger les packs Guest"})]}):e.jsx(Gt,{items:K.filter(y=>{var O,S,M,$;if(!_)return!0;const w=_.toLowerCase();return((O=y.name)==null?void 0:O.toLowerCase().includes(w))||((S=y.description)==null?void 0:S.toLowerCase().includes(w))||((M=y.id)==null?void 0:M.toLowerCase().includes(w))||(($=y.category)==null?void 0:$.toLowerCase().includes(w))}).sort((y,w)=>(y.name||"").localeCompare(w.name||"")).map(y=>{const w=y.id,O=t?t.includes(w):!1;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${O?"border-purple-400 shadow-[0_0_25px_rgba(168,85,247,0.4)] bg-purple-950/60":"border-purple-500/20 hover:border-purple-400/60 bg-black/50"}`,children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${O?"bg-purple-500 text-white shadow-md":"bg-purple-500/20 text-purple-400 border border-purple-500/40"}`,children:e.jsx(An,{size:18})}),e.jsx("span",{className:"px-2 py-0.5 bg-purple-500/20 text-purple-300 text-[10px] font-bold rounded-md uppercase tracking-wider border border-purple-500/30",children:"🐋 GUEST"})]}),n&&e.jsx("button",{onClick:S=>{S.stopPropagation(),n(w)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${O?"bg-purple-500 text-white shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-purple-500/40 hover:text-white"}`,children:O?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight truncate",children:y.name}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed text-zinc-300 text-xs line-clamp-4",children:y.description}),e.jsxs("div",{className:"mt-4 pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsxs("span",{className:"text-[10px] font-mono text-purple-400/80",children:[y.modulesCount," MODULES"]}),e.jsxs("button",{onClick:async()=>{var S;try{const M=await I(`http://localhost:5006/api/bridge/read-file?path=${encodeURIComponent(y.path+"/README.md")}`);let $="";if(M&&M.ok){const q=await M.json();$=((S=q.data)==null?void 0:S.content)||q.content||""}W({packId:w,packName:y.name,readmeText:$||`# PACK GUEST : ${y.name}

Spécifications techniques du pack Guest ${y.name}.

Module réutilisable scanné dans ${y.path}.`})}catch{W({packId:w,packName:y.name,readmeText:`# PACK GUEST : ${y.name}

Spécifications techniques du pack Guest ${y.name}.`})}},className:"design-prd-btn text-purple-400 text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-purple-500/30 transition-all",children:[e.jsx("span",{children:"📖"})," README →"]})]})]},w)})}):e.jsx(Gt,{items:Ft.map(y=>{const w=y.id,O=y.name,S=y.icon||rs,M=t?t.includes(w):!1,V=(v[w]||dn(w)||"Spécifications techniques du contrat PRD.").replace(/^#+.*$/gm,"").replace(/^>.*$/gm,"").replace(/\[([^\]]+)\]\([^\)]+\)/g,"$1").replace(/[*_~`]/g,"").trim().split(`
`).map(J=>J.trim()).filter(J=>J.length>20),X=V.length>0?V[0]:"Spécifications techniques du contrat PRD.",z=X.length>180?X.substring(0,180)+"...":X;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${M?"border-cyan shadow-[0_0_25px_rgba(8,179,201,0.4)]":"border-white/10 hover:border-cyan/50"}`,style:{background:r?o("prd-card-"+w,.7):"rgba(0,0,0,0.7)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${M?"bg-cyan text-black shadow-md":y.color||"bg-cyan/20 text-cyan"}`,children:e.jsx(S,{size:20})}),e.jsx("span",{className:"px-2 py-0.5 bg-cyan/20 text-cyan text-[10px] font-bold rounded-md uppercase tracking-wider",children:"💎 PRD"})]}),n&&e.jsx("button",{onClick:J=>{J.stopPropagation(),n(w)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${M?"bg-cyan text-black shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-white/20 hover:text-white"}`,title:M?"Désélectionner ce pack":"Sélectionner ce pack pour l'IA",children:M?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight",children:O}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed",children:z}),e.jsxs("div",{className:"mt-auto pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-mono text-cyan/80",children:"MODULE PRD"}),e.jsxs("button",{onClick:async()=>{var B;let J=v[w]||dn(w)||"";try{const ae=await I(`http://localhost:5006/api/bridge/read-file?packId=${encodeURIComponent(w)}`);if(ae&&ae.ok){const ve=await ae.json(),G=ve.content||((B=ve.data)==null?void 0:B.content);G&&G.trim().length>5&&(J=G,f(ee=>({...ee,[w]:G})))}}catch(ae){console.warn("API Bridge read fallback",ae)}W({packId:w,packName:O,readmeText:J||`# 💎 PRD PACK : ${O} (${w})

### ⚙️ Spécifications techniques du contrat PRD

- **Identifiant Pack**: ${w}
- **Statut**: Actif & Intégré au Moteur Sovereign`})},className:"design-prd-btn text-cyan text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-cyan/30 transition-all hover:bg-cyan/10",children:[e.jsx("span",{children:"📖"})," Lire le README →"]})]})]},w)})})})})]})},Kn=({isClient:t,getCachedGradient:n,setActiveProject:r})=>{const[o,d]=a.useState([]),[p,m]=a.useState(!0),[u,_]=a.useState(!1),[v,f]=a.useState(null),L=(D=!1)=>{D?_(!0):m(!0);const K=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];I("http://localhost:5006/api/projects").then(A=>A?A.json():null).then(A=>{if(A&&A.success&&A.projects)d(A.projects.map((F,W)=>({name:typeof F=="string"?F:F.projectName||F.name||F.projectId||F.project_id||F.title||`Projet_${W}`,desc:"Environnement Local",bg:K[W%K.length],installed:F.installed}))),m(!1),_(!1);else{const F=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:F?{Authorization:`Bearer ${F}`}:{}}).then(W=>W?W.json():null).then(W=>{W&&W.projects&&d(W.projects.map((y,w)=>({name:y.project_id||y.title||y.name||`Projet_${w}`,desc:"SaaS Cloud (Neon DB)",bg:K[w%K.length]}))),m(!1),_(!1)}).catch(()=>{m(!1),_(!1)})}}).catch(()=>{m(!1),_(!1)})};return a.useEffect(()=>{L();const D=setInterval(()=>L(!0),5e3);return()=>clearInterval(D)},[]),p?e.jsx("div",{className:"p-4 text-cyan text-sm italic",children:"Actualisation de la liste des projets..."}):o.length===0?e.jsxs("div",{className:"p-4 flex flex-col items-center gap-3 text-center",children:[e.jsx("div",{className:"text-cyan text-sm italic",children:"Aucun projet trouvé sur votre disque dur."}),e.jsx("button",{onClick:()=>L(),className:"px-4 py-2 rounded-xl bg-cyan/20 border border-cyan/40 text-cyan text-xs font-bold hover:bg-cyan/40 transition-colors",children:"🔄 Rafraîchir la liste"})]}):e.jsx(Gt,{items:[...o.map((D,K)=>{const A=D.name||"AUDIO",F=async()=>{f(A),r(A);try{window.dispatchEvent(new CustomEvent("open-mouchard")),I("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:A})}).then(async y=>{if(y){const w=await y.json().catch(()=>null);w!=null&&w.previewUrl&&window.open(w.previewUrl,"_blank")}}).catch(()=>{}),await I(`http://localhost:5006/api/projects/${encodeURIComponent(A)}/launch-design`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:A,open_explorer:!1})}).catch(y=>console.error("Erreur de lancement :",y))}catch(y){console.error("Erreur de lancement :",y)}finally{setTimeout(()=>f(null),2e3)}},W=async y=>{if(y.preventDefault(),y.stopPropagation(),window.confirm(`⚠️ SUPPRESSION DEFINITIVE :
Voulez-vous vraiment supprimer le projet "${A}" de l'interface ET de votre disque dur ?`))try{const w=await I("http://localhost:5006/api/projects/remove-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:A})});if(!w){d(S=>S.filter(M=>M.name!==A));return}const O=await w.json();O.success?d(S=>S.filter(M=>M.name!==A)):alert(`Erreur lors de la suppression : ${O.message||"Échec server"}`)}catch(w){alert(`Erreur réseau lors de la suppression : ${w.message}`)}};return e.jsxs("div",{className:"design-carte-carrousel rounded-2xl p-5 border border-white/20 shadow-xl flex flex-col items-center text-center relative overflow-hidden group cursor-pointer",style:{background:t?n("proj-"+K,.7):"rgba(0,0,0,0.5)"},onClick:F,children:[e.jsx("button",{onClick:W,className:"z-20 absolute top-3 right-3 w-8 h-8 rounded-full bg-red-600/80 hover:bg-red-500 text-white font-bold text-xs flex items-center justify-center transition-all shadow-lg hover:scale-110 cursor-pointer",title:"Supprimer ce projet du disque dur et de l'interface",children:"🗑️"}),e.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-30 mix-blend-overlay pointer-events-none"}),e.jsx("div",{className:"absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors z-0"}),e.jsxs("div",{className:"z-10 relative pointer-events-none w-full pr-8",children:[e.jsx("div",{className:"text-white/70 text-xs font-bold uppercase tracking-widest drop-shadow-md",children:"PROJET"}),e.jsx("h3",{className:"design-carte-titre text-xl font-black text-white break-all drop-shadow-lg leading-tight w-full",children:A})]}),e.jsx("div",{className:"design-carte-desc z-10 relative text-sm text-white/90 font-medium drop-shadow-md pointer-events-none w-full",children:D.desc}),e.jsxs("div",{className:"z-10 flex items-center gap-2 mt-3",children:[e.jsx("button",{onClick:y=>{y.stopPropagation(),v!==A&&(D.installed===!1?(f(A),I("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:A})}).then(w=>{alert(w?`📦 Installation des dépendances démarrée pour "${A}" !
Suivez la progression dans les logs.`:"Mode Cloud SaaS : Bridge local non connecté."),f(null),d(O=>O.map(S=>S.name===D.name?{...S,installed:!0}:S))}).catch(()=>f(null))):F())},disabled:v===A,className:`font-bold py-2 px-4 rounded-xl text-xs transition-all flex items-center gap-1.5 ${v===A?"bg-cyan-500/40 text-cyan-200 cursor-wait animate-pulse":D.installed===!1?"bg-orange-500/80 hover:bg-orange-600 text-white cursor-pointer":"bg-white/20 hover:bg-white/40 text-white cursor-pointer"}`,title:D.installed===!1?"Installer les dépendances requises pour ce projet":"Lancer la prévisualisation Vite",children:v===A?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin inline-block",children:"⏳"})," ",D.installed===!1?"Installation...":"Lancement..."]}):D.installed===!1?e.jsx(e.Fragment,{children:"📦 INSTALL"}):e.jsx(e.Fragment,{children:"🚀 PREVIEW"})}),D.installed!==!1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:y=>{y.stopPropagation(),f(A),I("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:A})}).then(w=>{alert(w?`🔄 Réinstallation des dépendances démarrée pour "${A}" !`:"Mode Cloud SaaS : Bridge local non connecté."),f(null)}).catch(()=>f(null))},className:"bg-orange-500/30 hover:bg-orange-500/60 text-white font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center justify-center border border-orange-500/40 cursor-pointer",title:"Forcer la réinstallation des dépendances (pnpm install)",children:"🔄"}),e.jsx("button",{onClick:async y=>{y.stopPropagation();try{f(A);const w=await I("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:A})});if(f(null),!w){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const O=await w.json();alert(O.message||`🚀 Serveur Vite démarré pour ${A} !`),O.previewUrl&&window.open(O.previewUrl,"_blank")}catch(w){f(null),alert("Erreur de connexion au bridge: "+w.message)}},className:"font-bold py-2 px-3 rounded-xl text-xs bg-purple-500/60 hover:bg-purple-500 text-white transition-all shadow-md cursor-pointer",title:"Lancer le serveur Vite avec pnpm run dev",children:"💻 PNPM"})]}),e.jsx("button",{onClick:W,className:"bg-red-600/30 hover:bg-red-600/60 text-red-200 border border-red-500/40 font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center gap-1",title:"Supprimer définitivement du disque dur",children:"🗑️ Supprimer"})]})]},K)})]})};function Mo({user:t,onLogout:n}={}){var Fe;const r=a.useRef({}),o=(s,c=1)=>typeof window>"u"?`linear-gradient(135deg, rgba(17,17,17,${c}), rgba(34,34,34,${c}))`:(r.current[s]||(r.current[s]=Ro(c)),r.current[s]),d=(t==null?void 0:t.email)||(typeof window<"u"?localStorage.getItem("tiger_currentUserEmail"):null),p=!!(t!=null&&t.isSuperAdmin||d&&d.toLowerCase().trim()==="zacktunr@gmail.com");a.useEffect(()=>{t!=null&&t.email&&typeof window<"u"&&localStorage.setItem("tiger_currentUserEmail",t.email)},[t]);const m=()=>{typeof window<"u"&&(localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),localStorage.removeItem("tiger_lastGeneratedProject"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{})),n?n():typeof window<"u"&&window.location.reload()},[u,_]=a.useState([]),[v,f]=a.useState(""),L=a.useRef(null),D=a.useRef(null),[K,A]=a.useState(!1),[F,W]=a.useState("connexion"),[y,w]=a.useState(!1),[O,S]=a.useState("clean");a.useRef(0);const[M,$]=a.useState(1),[q,V]=a.useState(!1),[X,z]=a.useState(!1),[J,B]=a.useState(!1);a.useEffect(()=>{let s=0;const c=setInterval(()=>{var l,C;if(typeof window<"u"){const h=(C=(l=window.Capacitor)==null?void 0:l.isNativePlatform)==null?void 0:C.call(l),x=!!window.AndroidBridge;(h||x)&&(z(!0),clearInterval(c))}s++>10&&clearInterval(c)},100);return()=>clearInterval(c)},[]);const[ae,ve]=a.useState([]),[G,ee]=a.useState(""),[de,xe]=a.useState(["> Système Kirov5 initialisé. "+new Date().toLocaleTimeString()]),[_e,te]=a.useState([]),[T,H]=a.useState([]);a.useEffect(()=>{const s=c=>H(c.detail);return window.addEventListener("update_kirov_packs",s),()=>window.removeEventListener("update_kirov_packs",s)},[]),a.useEffect(()=>{window.KIROV_SELECTED_PACKS=T},[T]);const[re,ue]=a.useState(!1),[fe,Ee]=a.useState(!1),[Te,R]=a.useState([]),[ge,Ce]=a.useState(!1),[he,se]=a.useState(""),[De,nt]=a.useState(""),[Re,Ne]=a.useState(!1),[oe,gt]=a.useState(""),[Be,En]=a.useState("Vite + React + Tailwind + TS"),[ht,gn]=a.useState(""),[Ct,Rt]=a.useState("deepseek"),[ze,tn]=a.useState(""),[nn,Rn]=a.useState(!0),[sn,rn]=a.useState(!1),[xt,wt]=a.useState(null),[dt,It]=a.useState(!1),[st,He]=a.useState("idle"),[Nt,Ke]=a.useState([]),[ut,zt]=a.useState(""),[hn,Dt]=a.useState(null);a.useEffect(()=>{let s,c=0;return st==="building"&&(s=setInterval(async()=>{try{const l=await I("http://localhost:5006/api/mobile/build-logs");if(l&&l.ok){c=0;const C=await l.json();C.logs&&C.logs.length>0&&Ke(C.logs),C.isBuilding===!1&&C.result&&(C.result.success?(He("success"),Dt(C.result.apkUrl)):He("error"),clearInterval(s))}else c++,c>=3&&(clearInterval(s),He("error"),Ke(C=>[...C,`❌ Service de compilation mobile absent sur ce serveur (${l?l.status:"erreur réseau"}).`,"📱 Option 1 (Cloud) : Déclenchez le build sans dépendance via GitHub Actions (.github/workflows/build-apk.yml).",`💻 Option 2 (Local) : Lancez 'python apk_builder.py --src ... --name ${ut||k||"app"} --build' dans E:\\v0reponses\\v0-apk.`]))}catch(l){console.warn("Polling APK error",l)}},1500)),()=>{s&&clearInterval(s)}},[st,ut,k]);const[Ht,pt]=a.useState([]),[xn,be]=a.useState(!1),Kt=a.useCallback(async s=>{be(!0);const c=[{id:"deepseek-r1-v0",tag:"⚡ DEEPSEEK R1",title:"DeepSeek-R1 & Moteur Souverain v0.1",desc:"Capacités de raisonnement avancé et de suture pour interfaces React.",content:`DeepSeek-R1 offre des capacités de raisonnement avancé pour l'analyse de contrats PRD et la génération zéro-touch de projets web complets.
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){pt(c),be(!1);return}const l=s||localStorage.getItem("tiger_apiKey");if(!l||!l.startsWith("sk-")||l.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){pt(c),be(!1);return}const C=new AbortController,h=setTimeout(()=>C.abort(),4e3),x=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${l}`},signal:C.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(h),x.ok){const j=await x.json(),N=JSON.parse(j.choices[0].message.content);N.news&&Array.isArray(N.news)&&N.news.length>0?pt(N.news):pt(c)}else x.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),pt(c)}catch(l){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",l),pt(c)}finally{be(!1)}},[]);a.useEffect(()=>{Kt()},[Kt]);const[mt,At]=a.useState(!1),[$e,Mt]=a.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Ie,Xe]=a.useState([]),[we,qt]=a.useState("");a.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let c=JSON.parse(s);if(!Array.isArray(c))throw new Error("Not an array");const l="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";c=c.map(C=>C.name==="fold"?{...C,colors:{...C.colors,"bg-app":l}}:C),Xe(c)}catch{Xe([])}else{const c={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};Xe([c]),localStorage.setItem("tiger_saved_themes",JSON.stringify([c]))}},[]),a.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",$e),$e!=="random"){const c=((s=Ie.find(l=>l.name===$e))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=c,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[$e,Ie]);const an=()=>{if(!we.trim())return alert("Nom invalide");if(Ie.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":o("icon-settings",.8),"icon-ai":o("icon-ai",.8),"icon-projects":o("icon-projects",.8),"icon-packs":o("icon-packs",.8),"icon-news":o("icon-news",.8),"bg-app":o("bg-app",.9)},c={name:we.trim(),colors:s},l=[...Ie,c];Xe(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),Mt(c.name),qt("")},Qe=(s,c)=>{c.stopPropagation();const l=Ie.filter(C=>C.name!==s);Xe(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),$e===s&&Mt("random")},$t=s=>{H(c=>c.includes(s)?c.filter(l=>l!==s):[...c,s])},[We,Lt]=a.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});a.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(We))},[We]);const[ft,Wt]=a.useState(!0),[rt,Pt]=a.useState(!0),[k,Ae]=a.useState(null),[jt,fn]=a.useState(null),[Pe,Jt]=a.useState(null),[pe,it]=a.useState(null),[Tt,bt]=a.useState(""),[Ze,Ut]=a.useState([]);a.useEffect(()=>{I("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))te(s.projects.map(c=>({name:typeof c=="string"?c:c.project_id||c.title||c.name||"Projet",desc:"Projet local",bg:""})));else{const c=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:c?{Authorization:`Bearer ${c}`}:{}}).then(l=>l?l.json():null).then(l=>{l&&l.projects&&te(l.projects.map(C=>({name:typeof C=="string"?C:C.project_id||C.title||C.name||"Projet",desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[Je,Le]=a.useState(null),[kt,vt]=a.useState(""),[Ue,on]=a.useState(!1),[at,Ye]=a.useState(!1),i=a.useRef(null);a.useEffect(()=>{if(i.current=null,k==="v0-guest"||k==="V0-Guest")Ye(!0),Le("http://localhost:3007"),vt("http://localhost:3007"),i.current="http://localhost:3007";else if(k){Ye(!0);const s=Pe&&JSON.stringify(Pe).includes("next.config"),c=typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1",l=s?"http://localhost:3000":i.current||(c?`http://${window.location.hostname}:5173`:"http://localhost:5173");Le(l),vt(l),i.current=l}else Ye(!1),Le(null)},[k,Pe]),a.useEffect(()=>{const s=c=>{var l,C,h,x;if(((l=c.data)==null?void 0:l.type)==="CHANGE_PREVIEW_URL"){const j=c.data.route,N=j==="/"?"":`#${j}`;Le(ne=>{const Z=ne?ne.split("#")[0]:"http://127.0.0.1:5175/";return`${Z.endsWith("/")?Z:`${Z}/`}${N}`})}if(((C=c.data)==null?void 0:C.type)==="DESIGN_ELEMENT_CLICKED"||((h=c.data)==null?void 0:h.type)==="DESIGN_ELEMENT_DRAGGED"||((x=c.data)==null?void 0:x.type)==="DESIGN_ELEMENT_RESIZED"){const j=document.querySelector('iframe[title="Studio Admin Design"]');j&&j.contentWindow&&j.contentWindow.postMessage(c.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),a.useEffect(()=>{k&&I(`http://localhost:5006/api/fs/tree?project=${k}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&Jt(s.tree)}).catch(()=>{})},[k]),a.useEffect(()=>{k&&pe&&I(`http://localhost:5006/api/fs/read?project=${k}&file=${encodeURIComponent(pe)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&bt(s.content)}).catch(()=>{})},[k,pe]);const g=async s=>{if(s===void 0||!k||!pe)return;if(bt(s),Bt.isNativePlatform()||!!window.AndroidBridge)try{await Vn.writeFile({path:`v0-moteur-mobile/projetv0/${k}/${pe}`,data:s,directory:pn.Documents,encoding:wn.UTF8,recursive:!0})}catch(l){console.error("Erreur de sauvegarde mobile:",l)}else I("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:k,file:pe,content:s})}).catch(()=>{})},b=s=>{k&&I(`http://localhost:5006/api/fs/read?project=${k}&file=${encodeURIComponent(s)}`).then(c=>c?c.json():null).then(c=>{c&&c.success&&Ut(l=>l.find(C=>C.path===s)?l:[...l,{path:s,content:c.content}])}).catch(()=>{})};a.useEffect(()=>{(async()=>{const c=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(Bt.isNativePlatform()||!!window.AndroidBridge)try{const h=(await Vn.readdir({path:"v0-moteur-mobile/projetv0",directory:pn.Documents})).files.map(x=>x.name||x.toString());te(h.map((x,j)=>({name:x,desc:"Mémoire Téléphone",bg:c[j%c.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else I("http://localhost:5006/api/projects-v2").then(C=>C?C.json():null).then(C=>{if(C&&C.success&&C.projects)te(C.projects.map((h,x)=>({name:typeof h=="string"?h:h.name||h.project_id||h.title||`Projet_${x}`,desc:"Environnement Local",bg:c[x%c.length],installed:h.installed})));else{const h=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:h?{Authorization:`Bearer ${h}`}:{}}).then(x=>x?x.json():null).then(x=>{x&&x.projects&&te(x.projects.map((j,N)=>({name:typeof j=="string"?j:j.project_id||j.title||j.name||`Projet_${N}`,desc:"SaaS Cloud (Neon DB)",bg:c[N%c.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),a.useEffect(()=>{V(!0)},[]);const[E,Q]=a.useState(!0);a.useEffect(()=>{const s=()=>Q(!0);window.addEventListener("open-mouchard",s);const c=l=>{if(l.data&&l.data.type==="TIGER_CAPTURE"){const C=l.data.data;if(C){let h="index.html";(C.includes("import React")||C.includes("export default"))&&(h="App.tsx"),C.includes("tailwindcss")&&(h="index.css"),it(h),g(C),Jt(x=>{var ne;const j={name:h,path:h,type:"file"};return x?((ne=x.children)==null?void 0:ne.find(Z=>Z.name===h))?x:{...x,children:[...x.children||[],j]}:{name:"Mobile_Storage",type:"directory",children:[j]}})}}};return window.addEventListener("message",c),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("message",c)}},[k,pe]),a.useEffect(()=>{if(!q)return;const s=()=>{I("http://localhost:5006/api/bridge/queue").then(l=>l?l.json():null).then(l=>{l&&l.success&&(setBridgeQueueData({current:l.current||{},queue:l.queue||[]}),(l.queue&&l.queue.length>0||l.current&&Object.keys(l.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),I("http://localhost:5006/api/bridge/logs").then(l=>l?l.json():null).then(l=>{var C,h;if(l&&l.success&&l.logs){xe(l.logs);const x=[...l.logs].reverse().find(N=>N.includes("URL_PREVIEW="));if(x){let N=(C=x.split("URL_PREVIEW=")[1])==null?void 0:C.trim();N&&typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"&&(N=N.replace(/localhost|127\.0\.0\.1/,window.location.hostname)),N&&N!==i.current&&(i.current=N,Le(N),vt(N),Ye(!0))}const j=[...l.logs].reverse().find(N=>N.includes("PIPELINE COMPLET TERMINÉ avec succès pour "));if(j){const N=(h=j.split("PIPELINE COMPLET TERMINÉ avec succès pour ")[1])==null?void 0:h.replace(/[.\s]+$/,"");N&&k!==N&&(Ae(N),Ye(!0))}}}).catch(()=>{}),I("http://localhost:5006/api/bridge/autonomous-status").then(l=>l?l.json():null).then(l=>{if(l&&l.success&&(l.data||l.status)){const h=(l.data||l.status).state;h==="diagnosing"||h==="repair_required"||h==="error"?S("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(h)||["starting_server","launch_requested","restarting"].includes(h)?S("working"):h==="ready"?S("clean"):k&&I(`http://localhost:5006/api/suture/status?project=${k}`).then(x=>x?x.json():null).then(x=>{x&&x.success&&x.status&&S(x.status)}).catch(()=>{})}}).catch(()=>{})};s();const c=setInterval(s,2e3);return()=>clearInterval(c)},[q,k]);const P=s=>{const c=typeof s=="string"?s:v;if(!c.trim())return;const l={id:Date.now().toString(),role:"user",content:c};_(h=>[...h,l]);const C=c.toLowerCase();setTimeout(()=>{let h={id:(Date.now()+1).toString(),role:"assistant",content:""};const x=C.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(x==="mes projets"||x.includes("liste des projet")||x==="projet"||x==="projets")h.content="Voici la liste de vos projets récents :",h.widget="projects";else if((x.includes("stitch")||x.includes("deepseek")||x.includes("design")||x.includes("logique"))&&(x.includes("modifi")||x.includes("ajoute")||x.includes("change")||x.includes("mise a jour")||x.includes("evolue")||x.includes("reprends")||x.includes("continue"))){const j=c.match(/\[(.*?)\]/),N=j?j[1]:null,ne=x.includes("deepseek")?"deepseek":"stitch";h.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${ne.toUpperCase()}) 🔄

J'injecte vos nouvelles directives directement dans votre interface... ${N?`
🔍 Recherche et AutoSwitch vers le projet : "${N}"`:"Reprise du travail en cours."}`,h.widget=null,I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:ne,target_project:N,prompt:"Mise à jour (Reprise de projet) : "+c.replace(/\[.*?\]/,"").trim(),auto_submit:!0})}).catch(Z=>console.log("Erreur de connexion au Bridge local pour l'injection",Z))}else if(x.includes("cree")||x.includes("lance")||x.includes("projet")||x.includes("generation")){h.content=`🚀 DÉMARRAGE PARALLÈLE KIROV5 🚀
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,h.widget="phases",$(1);const j=k||(oe.trim()?oe.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+c.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(Ae(j),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",j),typeof window<"u"){const Z=localStorage.getItem("tiger_targetAi")||"deepseek",Y=localStorage.getItem("tiger_targetUiAi")||"stitch",Me=(U,ce=!1)=>ct(U,ce),Ge=window.AndroidBridge;if(Ge&&Ge.openAIWithPrompt)Ge.openAIWithPrompt(Me(Y,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+c),Ge.showToast&&Ge.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const U=T&&T.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${T.length})]
`+T.map(ye=>{const ie=Ft.find(Se=>Se.id===ye);return`• ${ie?ie.name:ye} (#${ye})`}).join(`
`):"",ce="Génère l'interface UI/UX complète et moderne pour ce projet : "+c+U;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ce)}catch{}const tt=()=>I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Y,prompt:ce,auto_submit:!0,project_id:j,phase_num:1,packs:T})});We!==200&&(rt?window.open(Me(Y,!0),"kirov5_ai_target"):window.open(Me(Y,!0),"_blank"),tt().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(ye=>console.error("Erreur sendUiPrompt",ye))),setTimeout(()=>{const ye=T&&T.length>0?c+U:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+c+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ye)}catch{}window.open(Me(Z),"_blank"),I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,prompt:ye,auto_submit:!0,project_id:j,phase_num:1,packs:T})}).catch(ie=>console.log("Erreur Bridge Logic Prompt:",ie)),T&&T.length>0?I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,user_prompt:ye,packs:T,target_project:j})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(ie=>{console.log("Erreur Trombone Bridge:",ie)}):I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,prompt:ye,auto_submit:!0,project_id:j,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}$(1);let N=1;const ne=setInterval(()=>{N++,N>11?clearInterval(ne):$(N)},1500)}else if(x.includes("youtube")||x.includes("video"))h.content="Voici les résultats YouTube pour votre recherche :",h.widget="youtube";else if(x.includes("actualite")||x.includes("ia")||x.includes("news")||x.includes("recherche")){const j=localStorage.getItem("tiger_apiKey");h.content="Actualités & Dernières Innovations IA :",h.widget="news",Kt(j||void 0)}else if(x.includes("parametre")||x.includes("reglage")||x.includes("configuration")||x.includes("setting"))h.content="Ouverture du panneau de configuration système :",h.widget="settings";else if(x.includes("[plugin:vite:")||x.includes("missing semicolon")||x.includes("syntaxerror")||x.includes("typescriptparsermixin")||x.includes("babel/parser")||x.includes("error")&&x.length>80){const j=k||"Projet_blog_8831";h.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${j}" avec la stack trace fournie... 🩺`,ke("suture",c)}else if(h.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const j=window.AndroidBridge;j&&j.openAIWithPrompt?j.openAIWithPrompt("https://chat.deepseek.com/",c):window.open("https://chat.deepseek.com/","_blank")}_(j=>[...j,h])},600),f("")},me=async s=>{var Ge;let c=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],l=null;const C=c.filter(U=>U.name.endsWith(".zip"));let h=[];if(C.length>0){_(U=>[...U,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const U=(await Zt(async()=>{const{default:ce}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:ce}},[])).default;for(const ce of C){l=ce;const ye=await new U().loadAsync(ce);for(const[ie,Se]of Object.entries(ye.files))if(!Se.dir&&!ie.includes("__MACOSX")&&!((Ge=ie.split("/").pop())!=null&&Ge.startsWith("."))){const qe=await Se.async("blob"),lt=new File([qe],ie.split("/").pop()||ie,{type:qe.type});h.push(lt)}}}catch(U){console.error("Erreur décompression ZIP:",U),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}for(const U of C)try{const ce=await U.arrayBuffer(),tt=arrayBufferToBase64(ce);fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:k||G||oe||"AUDIO",fileName:U.name,fileBase64:tt})}).catch(ie=>console.warn("[Upload ZIP Sync] Notice:",ie))}catch{}}c=[...c.filter(U=>!U.name.endsWith(".zip")),...h];const x=c.filter(U=>U.name.endsWith(".html")),j=c.filter(U=>!U.name.endsWith(".html")&&(U.name.endsWith(".png")||U.name.endsWith(".jpg")||U.name.endsWith(".jpeg")||U.name.endsWith(".md")||U.name.endsWith(".json")||U.name.endsWith(".txt")||U.name.endsWith(".tsx")||U.name.endsWith(".ts")||U.name.endsWith(".jsx")||U.name.endsWith(".js")||U.name.endsWith(".css")||U.name.endsWith(".svg")));if(x.length===0&&j.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .tsx, .ts, .png, ou un .zip.");return}let N=[...Ze];for(const U of j){const ce=U.name.endsWith(".png")||U.name.endsWith(".jpg")||U.name.endsWith(".jpeg"),tt=await new Promise(ie=>{const Se=new FileReader;Se.onload=qe=>{var lt;return ie((lt=qe.target)==null?void 0:lt.result)},ce?Se.readAsDataURL(U):Se.readAsText(U)}),ye={path:U.name,content:ce?`[Image jointe visuellement : ${U.name} (Binaire ignoré pour économie de tokens)]`:tt};N.some(ie=>ie.path===U.name)||N.push(ye),_(ie=>[...ie,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${U.name}`}])}if(x.length>0){const U=x[0],ce=await new Promise(ie=>{const Se=new FileReader;Se.onload=qe=>{var lt;return ie((lt=qe.target)==null?void 0:lt.result)},Se.readAsText(U)}),tt={path:U.name,content:ce};N.some(ie=>ie.path===U.name)||N.push(tt);const ye={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${U.name}
Analyse de la structure UI et assemblage du contexte en cours...`};_(ie=>[...ie,ye])}const ne=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter(U=>U.name.endsWith(".zip"));for(const U of ne)N.some(ce=>ce.path===U.name)||N.push({path:U.name,content:"ZIP_ARCHIVE_DUMMY"});Ut(N);const Z=k||oe||"Projet_Stitch",Y=c.map(U=>U.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${Z}: ${Y}`);const Me=x.length;if(Me>3){const U=localStorage.getItem("tiger_targetAi")||"deepseek",ce=l?"Projet_ZIP_"+l.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),tt=k||ce;k||Ae(tt),_(ie=>[...ie,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !

Hermes a détecté ${Me} pages HTML dans votre ZIP.
Découpage automatique en lots de 3 fichiers en cours...
Démarrage de l'automatisation séquentielle via DeepSeek !`,widget:"phases"}]),$(1);let ye="";if(l)ye=await new Promise(ie=>{const Se=new FileReader;Se.onload=qe=>{var lt;return ie(((lt=qe.target)==null?void 0:lt.result).split(",")[1])},Se.readAsDataURL(l)});else{const ie=(await Zt(async()=>{const{default:qe}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:qe}},[])).default,Se=new ie;for(const qe of c)Se.file(qe.name,qe);ye=await Se.generateAsync({type:"base64"})}I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({zip_base64:ye,zip_mode:!0,target_ai:U,target_project:tt,user_prompt:oe.trim()?`${oe} - ${ht}`:`Application multi-pages issue de ${(l==null?void 0:l.name)||"fichiers_locaux"}`})}).then(async ie=>{const Se=await ie.json();Se.success?(_(qe=>[...qe,{id:Date.now().toString()+"_hermes",role:"assistant",content:`✅ ${Se.message}

📡 Lot 1/${Se.total_batches} transmis à DeepSeek. Les lots suivants s'enchaîneront automatiquement !
Fichiers détectés : ${(Se.files_detected||[]).join(", ")}`}]),window.open(ct(U),"_blank")):alert("Erreur Hermes : "+(Se.error||"Inconnue"))}).catch(ie=>{alert(`Erreur de connexion au Moteur Local : ${ie.message}`)});return}if(x.length>0){if(document.getElementById("creation-mode-container"))return;setTimeout(()=>{je(N)},1200)}},je=async(s=Ze)=>{Ne(!1);const c=s.find(Z=>Z.path.endsWith(".html"));if(!c){alert("Aucun fichier HTML trouvé dans le Trombone !");return}const l=oe.trim()?"Projet_"+oe.replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4):"Design_"+c.path.replace(".html","").replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4),C=k||l;if(!k){Ae(C);try{await I("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:C,file:"README.md",content:`# ${oe||C}

Initialisé par Tiger IA V0 (Design-First).`})})}catch(Z){console.error("[IDE] Erreur création auto du dossier",Z)}}const h=s.filter(Z=>Z.path!==c.path),x=c.content,j={id:(Date.now()+1).toString(),role:"assistant",content:`Mode "Design-First" activé. 🎨

Transmission du design au LLM avec les ${h.length} fichiers du Trombone intégrés.
Câblage en cours...`,widget:"phases"};$(5),_(Z=>[...Z,j]);let N=5;const ne=setInterval(()=>{N++,N>11?clearInterval(ne):$(N)},3e3);if(typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Mode Design-First Activé !"),typeof window<"u"){const Z=localStorage.getItem("tiger_targetAi")||"deepseek";let Y="";h.length>0&&(Y=`
...
\`\`\`
`}));let Me="";(oe.trim()||Be.trim()||ht.trim())&&(Me=`
--- MÉTADONNÉES DU PROJET ---
Nom : ${oe||"Non spécifié"}
Stack / Structure : ${Be||"Non spécifiée"}
Description & Objectifs : ${ht||"Non spécifiés"}
-----------------------------
`);const Ge=`Voici le code HTML/CSS d'une interface générée par Stitch.${Me}
...
\`\`\`
`,U=window.AndroidBridge;if(U&&U.openAIWithPrompt){const ce=ct(Z);U.openAIWithPrompt(ce,Ge),U.showToast&&U.showToast("HTML injecté. Câblage sur "+Z.toUpperCase()+" !")}else I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,prompt:Ge,auto_submit:!0,project_id:C,phase_num:5})}).then(ce=>console.log("[Bridge] Prompt HTML + Contexte envoyé avec succès, status:",ce.status)).catch(ce=>console.error("[Bridge] Erreur lors de l'envoi du prompt:",ce))}},ot=(s,c=0)=>s?s.type==="directory"?e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-2 px-2 py-1 hover:bg-white/5 cursor-pointer text-gray-300 text-sm",style:{paddingLeft:`${c*12+8}px`},children:[e.jsx("span",{className:"text-orange-400",children:"📁"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-dossier truncate font-bold",children:s.name})]}),s.children&&s.children.map(l=>ot(l,c+1))]},s.path):e.jsxs("div",{className:`flex items-center justify-between px-2 py-1 hover:bg-white/10 cursor-pointer text-sm group ${pe===s.path?"bg-cyan/20 text-cyan border-l-2 border-cyan":"text-gray-400"}`,style:{paddingLeft:`${c*12+8}px`},onClick:()=>it(s.path),children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-blue-400",children:"📄"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-fichier truncate",children:s.name})]}),e.jsxs("div",{className:"hidden group-hover:flex items-center gap-1",children:[e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-red-500/50 transition-colors",title:"Suture : Réparer ou débugger ce fichier",onClick:l=>{l.stopPropagation(),it(s.path),setTimeout(()=>ke("suture","Veuillez analyser ce fichier et corriger toutes les erreurs, fautes de frappe ou imports manquants."),100)},children:"🩺"}),e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-cyan/50 transition-colors",title:"Ajouter au Trombone",onClick:l=>{l.stopPropagation(),b(s.path)},children:"📎"})]})]},s.path):null,ke=async(s,c)=>{if(!k){alert("⚠️ Veuillez sélectionner un projet actif dans l'explorateur.");return}const l=localStorage.getItem("tiger_targetAi")||"deepseek";let C="";s==="suture"?C=`🩺 SUTURE CHIRURGICALE — CORRECTION D'ERREUR DÉTECTÉE
...
`):s==="refactor"?C=`🔄 REFACTORING — Refactorise le code du projet [${k}] pour une qualité industrielle.

`:s==="improve"&&(C=`✨ AMÉLIORATION — Ajoute des animations et améliorations UI pour le projet [${k}].

`),pe&&Tt&&(C+=`--- Fichier Actif en Édition : ${pe} ---
\`\`\`
${Tt}
\`\`\`

`),Ze.length>0&&(C+=`--- Fichiers de contexte du Trombone ---

`,Ze.forEach(h=>{C+=`--- ${h.path} ---
\`\`\`
${h.content}
\`\`\`
...
`:Be.includes("Canvas 2D")?N+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être un jeu Web 2D généré en **React + Vite + TypeScript (TSX) + Canvas 2D**.
...
Tout le travail actuel non sauvegardé sera perdu.`)&&I("http://localhost:5006/api/bridge/restore-backup",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:k,backup_name:s})}).then(c=>c?c.json():null).then(c=>{if(!c)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");c.success?(alert("✅ "+c.message),Ee(!1)):alert("❌ Erreur Restauration : "+c.error)}).catch(c=>alert("Erreur réseau: "+c.message))},className:"px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold rounded-lg transition-all",children:"Restaurer"})]},s)),Te.length===0&&e.jsx("div",{className:"text-center p-4 text-slate-500 italic",children:"Aucune sauvegarde disponible."})]})]})}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
      ...
      `}})]})}function qo({onAuthenticated:t}){const[n,r]=a.useState("login"),[o,d]=a.useState(""),[p,m]=a.useState(""),[u,_]=a.useState(""),[v,f]=a.useState(!1),[L,D]=a.useState(""),K=async A=>{if(A.preventDefault(),D(""),n==="register"&&p!==u){D("Les mots de passe ne correspondent pas.");return}if(p.length<8){D("Le mot de passe doit contenir au moins 8 caractères.");return}f(!0);try{const W=await fetch(n==="login"?"/api/auth/login":"/api/auth/register",{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({email:o,password:p})}),y=await W.json();if(!W.ok){const w={INVALID_CREDENTIALS:"Email ou mot de passe incorrect.",TOO_MANY_ATTEMPTS:"Trop de tentatives. Réessayez dans 15 minutes.",REGISTRATION_FAILED:"Cet email est déjà utilisé.",PASSWORD_TOO_SHORT:"Mot de passe trop court (8 caractères minimum)."};D(y.error?w[y.error]??y.error:"Une erreur est survenue.");return}y.token&&localStorage.setItem("kirov5_jwt_token",y.token),t({userId:String(y.userId),email:o,isSuperAdmin:!!y.isSuperAdmin})}catch{window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?(console.warn("Mode local sans Wrangler: Bypass de la connexion pour accès UI."),localStorage.setItem("kirov5_jwt_token","dev-mock-token"),t({userId:"dev-user-001",email:o||"dev@local"})):D("Impossible de contacter le serveur. Vérifiez votre connexion.")}finally{f(!1)}};return e.jsxs("div",{style:{minHeight:"100vh",background:"linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Inter', 'Segoe UI', sans-serif",padding:"20px"},children:[e.jsx("div",{style:{position:"fixed",inset:0,overflow:"hidden",pointerEvents:"none",zIndex:0},children:[...Array(6)].map((A,F)=>e.jsx("div",{style:{position:"absolute",borderRadius:"50%",background:`rgba(${F%2===0?"139,92,246":"59,130,246"},0.08)`,width:`${200+F*80}px`,height:`${200+F*80}px`,top:`${10+F*15}%`,left:`${5+F*16}%`,filter:"blur(60px)",animation:`float ${6+F}s ease-in-out infinite alternate`}},F))}),e.jsxs("div",{style:{position:"relative",zIndex:1,width:"100%",maxWidth:"420px"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"40px"},children:[e.jsx("div",{style:{display:"inline-flex",alignItems:"center",justifyContent:"center",width:"72px",height:"72px",borderRadius:"20px",background:"linear-gradient(135deg, #8b5cf6, #3b82f6)",marginBottom:"20px",boxShadow:"0 0 40px rgba(139,92,246,0.4)",fontSize:"32px"},children:"⚡"}),e.jsx("h1",{style:{margin:0,fontSize:"28px",fontWeight:800,background:"linear-gradient(135deg, #a78bfa, #60a5fa)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",letterSpacing:"-0.5px"},children:"Kirov5 Sovereign Forge"}),e.jsx("p",{style:{color:"rgba(255,255,255,0.4)",marginTop:"8px",fontSize:"14px"},children:"Plateforme de génération d'applications IA"})]}),e.jsxs("div",{style:{background:"rgba(255,255,255,0.04)",backdropFilter:"blur(20px)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"24px",padding:"36px",boxShadow:"0 25px 50px rgba(0,0,0,0.4)"},children:[e.jsx("div",{style:{display:"flex",background:"rgba(0,0,0,0.3)",borderRadius:"12px",padding:"4px",marginBottom:"28px"},children:["login","register"].map(A=>e.jsx("button",{onClick:()=>{r(A),D("")},style:{flex:1,padding:"10px",borderRadius:"10px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:600,transition:"all 0.2s ease",background:n===A?"linear-gradient(135deg, #8b5cf6, #3b82f6)":"transparent",color:n===A?"#fff":"rgba(255,255,255,0.4)"},children:A==="login"?"🔑 Connexion":"✨ Inscription"},A))}),e.jsxs("form",{onSubmit:K,children:[e.jsxs("div",{style:{marginBottom:"16px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Adresse email"}),e.jsx("input",{type:"email",value:o,onChange:A=>d(A.target.value),required:!0,autoComplete:"email",placeholder:"vous@exemple.com",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box",transition:"border-color 0.2s"},onFocus:A=>A.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:A=>A.target.style.borderColor="rgba(255,255,255,0.1)"})]}),e.jsxs("div",{style:{marginBottom:n==="register"?"16px":"24px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Mot de passe"}),e.jsx("input",{type:"password",value:p,onChange:A=>m(A.target.value),required:!0,autoComplete:n==="login"?"current-password":"new-password",placeholder:n==="register"?"8 caractères minimum":"••••••••",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box"},onFocus:A=>A.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:A=>A.target.style.borderColor="rgba(255,255,255,0.1)"})]}),n==="register"&&e.jsxs("div",{style:{marginBottom:"24px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Confirmer le mot de passe"}),e.jsx("input",{type:"password",value:u,onChange:A=>_(A.target.value),required:!0,autoComplete:"new-password",placeholder:"••••••••",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box"},onFocus:A=>A.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:A=>A.target.style.borderColor="rgba(255,255,255,0.1)"})]}),L&&e.jsxs("div",{style:{background:"rgba(239,68,68,0.12)",border:"1px solid rgba(239,68,68,0.3)",borderRadius:"10px",padding:"12px 16px",marginBottom:"16px",color:"#fca5a5",fontSize:"13px",display:"flex",alignItems:"center",gap:"8px"},children:[e.jsx("span",{children:"⚠️"})," ",L]}),e.jsx("button",{type:"submit",disabled:v,style:{width:"100%",padding:"14px",borderRadius:"12px",border:"none",background:v?"rgba(139,92,246,0.4)":"linear-gradient(135deg, #8b5cf6, #3b82f6)",color:"#fff",fontSize:"15px",fontWeight:700,cursor:v?"not-allowed":"pointer",transition:"all 0.2s ease",boxShadow:v?"none":"0 4px 20px rgba(139,92,246,0.4)"},children:v?"⏳ Chargement...":n==="login"?"🚀 Se connecter":"✨ Créer mon compte"})]}),e.jsx("p",{style:{textAlign:"center",marginTop:"20px",fontSize:"12px",color:"rgba(255,255,255,0.25)"},children:"🔒 Connexion sécurisée — Vos données sont chiffrées"})]})]}),e.jsx("style",{children:`
        @keyframes float {
          from { transform: translateY(0px) scale(1); }
          to { transform: translateY(-30px) scale(1.05); }
        }
        input::placeholder { color: rgba(255,255,255,0.25); }
      `})]})}function Lo(){const[t,n]=a.useState(null),[r,o]=a.useState(!0);a.useEffect(()=>{(async()=>{try{const m=localStorage.getItem("kirov5_jwt_token");if(!m){n(null),o(!1);return}const u=await fetch("/api/auth/session",{headers:{Authorization:`Bearer ${m}`}});if(u.ok){const _=await u.json();_.authenticated?n({userId:String(_.userId||"user"),email:_.email||"user@cloud",isSuperAdmin:!!_.isSuperAdmin}):(localStorage.removeItem("kirov5_jwt_token"),n(null))}else localStorage.removeItem("kirov5_jwt_token"),n(null)}catch{const m=localStorage.getItem("kirov5_jwt_token");m&&m.startsWith("dev-")?n({userId:"dev-user-001",email:"dev@kirov5.local",isSuperAdmin:!0}):n(null)}finally{o(!1)}})()},[]);const d=()=>{localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{}),n(null)};return r?e.jsx("div",{style:{minHeight:"100vh",background:"linear-gradient(135deg, #0f0c29, #302b63, #24243e)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"Inter, sans-serif"},children:e.jsxs("div",{style:{textAlign:"center",color:"rgba(255,255,255,0.6)"},children:[e.jsx("div",{style:{fontSize:"48px",marginBottom:"16px"},children:"⚡"}),e.jsx("div",{style:{fontSize:"14px"},children:"Initialisation du Studio Kirov5..."})]})}):t?e.jsx(Mo,{user:t,onLogout:d}):e.jsx(qo,{onAuthenticated:p=>n(p)})}ps.createRoot(document.getElementById("root")).render(e.jsx(Et.StrictMode,{children:e.jsx(Lo,{})}));export{wn as E,ns as W,Ra as b};

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-_mNHJIom.js","assets/design-v200-BU4g7UhC.js","assets/design-v200-CHRXnMOk.css"])))=>i.map(i=>d[i]);
import{r as a,a as Tt,j as e,s as I,i as fs,R as bs}from"./design-v200-BU4g7UhC.js";const vs="modulepreload",Ss=function(t){return"/"+t},Ln={},en=function(n,r,o){let d=Promise.resolve();if(r&&r.length>0){let h=function(S){return Promise.all(S.map(b=>Promise.resolve(b).then(q=>({status:"fulfilled",value:q}),q=>({status:"rejected",reason:q}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),_=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));d=h(r.map(S=>{if(S=Ss(S),S in Ln)return;Ln[S]=!0;const b=S.endsWith(".css"),q=b?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${S}"]${q}`))return;const L=document.createElement("link");if(L.rel=b?"stylesheet":vs,b||(L.as="script"),L.crossOrigin="",L.href=S,_&&L.setAttribute("nonce",_),document.head.appendChild(L),b)return new Promise((Q,N)=>{L.addEventListener("load",Q),L.addEventListener("error",()=>N(new Error(`Unable to preload CSS for ${S}`)))})}))}function m(h){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=h,window.dispatchEvent(u),!u.defaultPrevented)throw h}return d.then(h=>{for(const u of h||[])u.status==="rejected"&&m(u.reason);return n().catch(m)})},ys=`# undefined
...
- \`src/shared/widgets/hooks/useCalendarState.ts\``;function Un(t,n){(n==null||n>t.length)&&(n=t.length);for(var r=0,o=Array(n);r<n;r++)o[r]=t[r];return o}function Si(t){if(Array.isArray(t))return t}function yi(t,n,r){return(n=ji(n))in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function _i(t,n){var r=t==null?null:typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(r!=null){var o,d,m,h,u=[],_=!0,S=!1;try{if(m=(r=r.call(t)).next,n!==0)for(;!(_=(o=m.call(r)).done)&&(u.push(o.value),u.length!==n);_=!0);}catch(b){S=!0,d=b}finally{try{if(!_&&r.return!=null&&(h=r.return(),Object(h)!==h))return}finally{if(S)throw d}}return u}}function Ci(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function On(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(t);n&&(o=o.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,o)}return r}function Gn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?On(Object(r),!0).forEach(function(o){yi(t,o,r[o])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):On(Object(r)).forEach(function(o){Object.defineProperty(t,o,Object.getOwnPropertyDescriptor(r,o))})}return t}function wi(t,n){if(t==null)return{};var r,o,d=Ii(t,n);if(Object.getOwnPropertySymbols){var m=Object.getOwnPropertySymbols(t);for(o=0;o<m.length;o++)r=m[o],n.indexOf(r)===-1&&{}.propertyIsEnumerable.call(t,r)&&(d[r]=t[r])}return d}function Ii(t,n){if(t==null)return{};var r={};for(var o in t)if({}.hasOwnProperty.call(t,o)){if(n.indexOf(o)!==-1)continue;r[o]=t[o]}return r}function Ai(t,n){return Si(t)||_i(t,n)||ki(t,n)||Ci()}function Pi(t,n){if(typeof t!="object"||!t)return t;var r=t[Symbol.toPrimitive];if(r!==void 0){var o=r.call(t,n);if(typeof o!="object")return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}function ji(t){var n=Pi(t,"string");return typeof n=="symbol"?n:n+""}function ki(t,n){if(t){if(typeof t=="string")return Un(t,n);var r={}.toString.call(t).slice(8,-1);return r==="Object"&&t.constructor&&(r=t.constructor.name),r==="Map"||r==="Set"?Array.from(t):r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?Un(t,n):void 0}}function Ti(t,n,r){return n in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function Fn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(t);n&&(o=o.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,o)}return r}function Vn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Fn(Object(r),!0).forEach(function(o){Ti(t,o,r[o])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Fn(Object(r)).forEach(function(o){Object.defineProperty(t,o,Object.getOwnPropertyDescriptor(r,o))})}return t}function Ei(){for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r];return function(o){return n.reduceRight(function(d,m){return m(d)},o)}}function Zt(t){return function n(){for(var r=this,o=arguments.length,d=new Array(o),m=0;m<o;m++)d[m]=arguments[m];return d.length>=t.length?t.apply(this,d):function(){for(var h=arguments.length,u=new Array(h),_=0;_<h;_++)u[_]=arguments[_];return n.apply(r,[].concat(d,u))}}}function hn(t){return{}.toString.call(t).includes("Object")}function Ri(t){return!Object.keys(t).length}function tn(t){return typeof t=="function"}function Ni(t,n){return Object.prototype.hasOwnProperty.call(t,n)}function Di(t,n){return hn(n)||St("changeType"),Object.keys(n).some(function(r){return!Ni(t,r)})&&St("changeField"),n}function Mi(t){tn(t)||St("selectorType")}function qi(t){tn(t)||hn(t)||St("handlerType"),hn(t)&&Object.values(t).some(function(n){return!tn(n)})&&St("handlersType")}function Li(t){t||St("initialIsRequired"),hn(t)||St("initialType"),Ri(t)&&St("initialContent")}function Ui(t,n){throw new Error(t[n]||t.default)}var Oi={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},St=Zt(Ui)(Oi),un={changes:Di,selector:Mi,handler:qi,initial:Li};function Gi(t){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};un.initial(t),un.handler(n);var r={current:t},o=Zt(Bi)(r,n),d=Zt(Vi)(r),m=Zt(un.changes)(t),h=Zt(Fi)(r);function u(){var S=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(b){return b};return un.selector(S),S(r.current)}function _(S){Ei(o,d,m,h)(S)}return[u,_]}function Fi(t,n){return tn(n)?n(t.current):n}function Vi(t,n){return t.current=Vn(Vn({},t.current),n),n}function Bi(t,n,r){return tn(n)?n(t.current):Object.keys(r).forEach(function(o){var d;return(d=n[o])===null||d===void 0?void 0:d.call(n,t.current[o])}),r}var zi={create:Gi},Hi={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.55.1/min/vs"}};function $i(t){return function n(){for(var r=this,o=arguments.length,d=new Array(o),m=0;m<o;m++)d[m]=arguments[m];return d.length>=t.length?t.apply(this,d):function(){for(var h=arguments.length,u=new Array(h),_=0;_<h;_++)u[_]=arguments[_];return n.apply(r,[].concat(d,u))}}}function Ki(t){return{}.toString.call(t).includes("Object")}function Wi(t){return t||Bn("configIsRequired"),Ki(t)||Bn("configType"),t.urls?(Ji(),{paths:{vs:t.urls.monacoBase}}):t}function Ji(){console.warn(Zn.deprecation)}function Xi(t,n){throw new Error(t[n]||t.default)}var Zn={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},Bn=$i(Xi)(Zn),Qi={config:Wi},Zi=function(){for(var n=arguments.length,r=new Array(n),o=0;o<n;o++)r[o]=arguments[o];return function(d){return r.reduceRight(function(m,h){return h(m)},d)}};function Yn(t,n){return Object.keys(n).forEach(function(r){n[r]instanceof Object&&t[r]&&Object.assign(n[r],Yn(t[r],n[r]))}),Gn(Gn({},t),n)}var Yi={type:"cancelation",msg:"operation is manually canceled"};function yn(t){var n=!1,r=new Promise(function(o,d){t.then(function(m){return n?d(Yi):o(m)}),t.catch(d)});return r.cancel=function(){return n=!0},r}var ea=["monaco"],ta=zi.create({config:Hi,isInitialized:!1,resolve:null,reject:null,monaco:null}),es=Ai(ta,2),nn=es[0],fn=es[1];function na(t){var n=Qi.config(t),r=n.monaco,o=wi(n,ea);fn(function(d){return{config:Yn(d.config,o),monaco:r}})}function sa(){var t=nn(function(n){var r=n.monaco,o=n.isInitialized,d=n.resolve;return{monaco:r,isInitialized:o,resolve:d}});if(!t.isInitialized){if(fn({isInitialized:!0}),t.monaco)return t.resolve(t.monaco),yn(_n);if(window.monaco&&window.monaco.editor)return ts(window.monaco),t.resolve(window.monaco),yn(_n);Zi(ra,aa)(oa)}return yn(_n)}function ra(t){return document.body.appendChild(t)}function ia(t){var n=document.createElement("script");return t&&(n.src=t),n}function aa(t){var n=nn(function(o){var d=o.config,m=o.reject;return{config:d,reject:m}}),r=ia("".concat(n.config.paths.vs,"/loader.js"));return r.onload=function(){return t()},r.onerror=n.reject,r}function oa(){var t=nn(function(r){var o=r.config,d=r.resolve,m=r.reject;return{config:o,resolve:d,reject:m}}),n=window.require;n.config(t.config),n(["vs/editor/editor.main"],function(r){var o=r.m||r;ts(o),t.resolve(o)},function(r){t.reject(r)})}function ts(t){nn().monaco||fn({monaco:t})}function la(){return nn(function(t){var n=t.monaco;return n})}var _n=new Promise(function(t,n){return fn({resolve:t,reject:n})}),ns={config:na,init:sa,__getMonacoInstance:la},ca={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},Cn=ca,da={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},ua=da;function pa({children:t}){return Tt.createElement("div",{style:ua.container},t)}var ma=pa,ga=ma;function ha({width:t,height:n,isEditorReady:r,loading:o,_ref:d,className:m,wrapperProps:h}){return Tt.createElement("section",{style:{...Cn.wrapper,width:t,height:n},...h},!r&&Tt.createElement(ga,null,o),Tt.createElement("div",{ref:d,style:{...Cn.fullWidth,...!r&&Cn.hide},className:m}))}var xa=ha,ss=a.memo(xa);function fa(t){a.useEffect(t,[])}var rs=fa;function ba(t,n,r=!0){let o=a.useRef(!0);a.useEffect(o.current||!r?()=>{o.current=!1}:t,n)}var Be=ba;function Yt(){}function Ot(t,n,r,o){return va(t,o)||Sa(t,n,r,o)}function va(t,n){return t.editor.getModel(is(t,n))}function Sa(t,n,r,o){return t.editor.createModel(n,r,o?is(t,o):void 0)}function is(t,n){return t.Uri.parse(n)}function ya({original:t,modified:n,language:r,originalLanguage:o,modifiedLanguage:d,originalModelPath:m,modifiedModelPath:h,keepCurrentOriginalModel:u=!1,keepCurrentModifiedModel:_=!1,theme:S="light",loading:b="Loading...",options:q={},height:L="100%",width:Q="100%",className:N,wrapperProps:U={},beforeMount:X=Yt,onMount:x=Yt}){let[C,G]=a.useState(!1),[y,O]=a.useState(!0),z=a.useRef(null),A=a.useRef(null),D=a.useRef(null),K=a.useRef(x),V=a.useRef(X),Z=a.useRef(!1);rs(()=>{let B=ns.init();return B.then(ee=>(A.current=ee)&&O(!1)).catch(ee=>(ee==null?void 0:ee.type)!=="cancelation"&&console.error("Monaco initialization: error:",ee)),()=>z.current?ve():B.cancel()}),Be(()=>{if(z.current&&A.current){let B=z.current.getOriginalEditor(),ee=Ot(A.current,t||"",o||r||"text",m||"");ee!==B.getModel()&&B.setModel(ee)}},[m],C),Be(()=>{if(z.current&&A.current){let B=z.current.getModifiedEditor(),ee=Ot(A.current,n||"",d||r||"text",h||"");ee!==B.getModel()&&B.setModel(ee)}},[h],C),Be(()=>{let B=z.current.getModifiedEditor();B.getOption(A.current.editor.EditorOption.readOnly)?B.setValue(n||""):n!==B.getValue()&&(B.executeEdits("",[{range:B.getModel().getFullModelRange(),text:n||"",forceMoveMarkers:!0}]),B.pushUndoStop())},[n],C),Be(()=>{var B,ee;(ee=(B=z.current)==null?void 0:B.getModel())==null||ee.original.setValue(t||"")},[t],C),Be(()=>{let{original:B,modified:ee}=z.current.getModel();A.current.editor.setModelLanguage(B,o||r||"text"),A.current.editor.setModelLanguage(ee,d||r||"text")},[r,o,d],C),Be(()=>{var B;(B=A.current)==null||B.editor.setTheme(S)},[S],C),Be(()=>{var B;(B=z.current)==null||B.updateOptions(q)},[q],C);let $=a.useCallback(()=>{var de;if(!A.current)return;V.current(A.current);let B=Ot(A.current,t||"",o||r||"text",m||""),ee=Ot(A.current,n||"",d||r||"text",h||"");(de=z.current)==null||de.setModel({original:B,modified:ee})},[r,n,d,t,o,m,h]),ae=a.useCallback(()=>{var B;!Z.current&&D.current&&(z.current=A.current.editor.createDiffEditor(D.current,{automaticLayout:!0,...q}),$(),(B=A.current)==null||B.editor.setTheme(S),G(!0),Z.current=!0)},[q,S,$]);a.useEffect(()=>{C&&K.current(z.current,A.current)},[C]),a.useEffect(()=>{!y&&!C&&ae()},[y,C,ae]);function ve(){var ee,de,xe,Ie;let B=(ee=z.current)==null?void 0:ee.getModel();u||((de=B==null?void 0:B.original)==null||de.dispose()),_||((xe=B==null?void 0:B.modified)==null||xe.dispose()),(Ie=z.current)==null||Ie.dispose()}return Tt.createElement(ss,{width:Q,height:L,isEditorReady:C,loading:b,_ref:D,className:N,wrapperProps:U})}var _a=ya;a.memo(_a);function Ca(t){let n=a.useRef();return a.useEffect(()=>{n.current=t},[t]),n.current}var wa=Ca,pn=new Map;function Ia({defaultValue:t,defaultLanguage:n,defaultPath:r,value:o,language:d,path:m,theme:h="light",line:u,loading:_="Loading...",options:S={},overrideServices:b={},saveViewState:q=!0,keepCurrentModel:L=!1,width:Q="100%",height:N="100%",className:U,wrapperProps:X={},beforeMount:x=Yt,onMount:C=Yt,onChange:G,onValidate:y=Yt}){let[O,z]=a.useState(!1),[A,D]=a.useState(!0),K=a.useRef(null),V=a.useRef(null),Z=a.useRef(null),$=a.useRef(C),ae=a.useRef(x),ve=a.useRef(),B=a.useRef(o),ee=wa(m),de=a.useRef(!1),xe=a.useRef(!1);rs(()=>{let j=ns.init();return j.then(J=>(K.current=J)&&D(!1)).catch(J=>(J==null?void 0:J.type)!=="cancelation"&&console.error("Monaco initialization: error:",J)),()=>V.current?te():j.cancel()}),Be(()=>{var J,re,ue,fe;let j=Ot(K.current,t||o||"",n||d||"",m||r||"");j!==((J=V.current)==null?void 0:J.getModel())&&(q&&pn.set(ee,(re=V.current)==null?void 0:re.saveViewState()),(ue=V.current)==null||ue.setModel(j),q&&((fe=V.current)==null||fe.restoreViewState(pn.get(m))))},[m],O),Be(()=>{var j;(j=V.current)==null||j.updateOptions(S)},[S],O),Be(()=>{!V.current||o===void 0||(V.current.getOption(K.current.editor.EditorOption.readOnly)?V.current.setValue(o):o!==V.current.getValue()&&(xe.current=!0,V.current.executeEdits("",[{range:V.current.getModel().getFullModelRange(),text:o,forceMoveMarkers:!0}]),V.current.pushUndoStop(),xe.current=!1))},[o],O),Be(()=>{var J,re;let j=(J=V.current)==null?void 0:J.getModel();j&&d&&((re=K.current)==null||re.editor.setModelLanguage(j,d))},[d],O),Be(()=>{var j;u!==void 0&&((j=V.current)==null||j.revealLine(u))},[u],O),Be(()=>{var j;(j=K.current)==null||j.editor.setTheme(h)},[h],O);let Ie=a.useCallback(()=>{var j;if(!(!Z.current||!K.current)&&!de.current){ae.current(K.current);let J=m||r,re=Ot(K.current,o||t||"",n||d||"",J||"");V.current=(j=K.current)==null?void 0:j.editor.create(Z.current,{model:re,automaticLayout:!0,...S},b),q&&V.current.restoreViewState(pn.get(J)),K.current.editor.setTheme(h),u!==void 0&&V.current.revealLine(u),z(!0),de.current=!0}},[t,n,r,o,d,m,S,b,q,h,u]);a.useEffect(()=>{O&&$.current(V.current,K.current)},[O]),a.useEffect(()=>{!A&&!O&&Ie()},[A,O,Ie]),B.current=o,a.useEffect(()=>{var j,J;O&&G&&((j=ve.current)==null||j.dispose(),ve.current=(J=V.current)==null?void 0:J.onDidChangeModelContent(re=>{xe.current||G(V.current.getValue(),re)}))},[O,G]),a.useEffect(()=>{if(O){let j=K.current.editor.onDidChangeMarkers(J=>{var ue;let re=(ue=V.current.getModel())==null?void 0:ue.uri;if(re&&J.find(fe=>fe.path===re.path)){let fe=K.current.editor.getModelMarkers({resource:re});y==null||y(fe)}});return()=>{j==null||j.dispose()}}return()=>{}},[O,y]);function te(){var j,J;(j=ve.current)==null||j.dispose(),L?q&&pn.set(m,V.current.saveViewState()):(J=V.current.getModel())==null||J.dispose(),V.current.dispose()}return Tt.createElement(ss,{width:Q,height:N,isEditorReady:O,loading:_,_ref:Z,className:U,wrapperProps:X})}var Aa=Ia,Pa=a.memo(Aa),ja=Pa;/*! Capacitor: https://capacitorjs.com/ - MIT License */const ka=t=>{const n=new Map;n.set("web",{name:"web"});const r=t.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:n},o=(m,h)=>{r.platforms.set(m,h)},d=m=>{r.platforms.has(m)&&(r.currentPlatform=r.platforms.get(m))};return r.addPlatform=o,r.setPlatform=d,r},Ta=t=>t.CapacitorPlatforms=ka(t),as=Ta(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});as.addPlatform;as.setPlatform;var Vt;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(Vt||(Vt={}));class wn extends Error{constructor(n,r,o){super(n),this.message=n,this.code=r,this.data=o}}const Ea=t=>{var n,r;return t!=null&&t.androidBridge?"android":!((r=(n=t==null?void 0:t.webkit)===null||n===void 0?void 0:n.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},Ra=t=>{var n,r,o,d,m;const h=t.CapacitorCustomPlatform||null,u=t.Capacitor||{},_=u.Plugins=u.Plugins||{},S=t.CapacitorPlatforms,b=()=>h!==null?h.name:Ea(t),q=((n=S==null?void 0:S.currentPlatform)===null||n===void 0?void 0:n.getPlatform)||b,L=()=>q()!=="web",Q=((r=S==null?void 0:S.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||L,N=A=>{const D=y.get(A);return!!(D!=null&&D.platforms.has(q())||x(A))},U=((o=S==null?void 0:S.currentPlatform)===null||o===void 0?void 0:o.isPluginAvailable)||N,X=A=>{var D;return(D=u.PluginHeaders)===null||D===void 0?void 0:D.find(K=>K.name===A)},x=((d=S==null?void 0:S.currentPlatform)===null||d===void 0?void 0:d.getPluginHeader)||X,C=A=>t.console.error(A),G=(A,D,K)=>Promise.reject(`${K} does not have an implementation of "${D}".`),y=new Map,O=(A,D={})=>{const K=y.get(A);if(K)return console.warn(`Capacitor plugin "${A}" already registered. Cannot register plugins twice.`),K.proxy;const V=q(),Z=x(A);let $;const ae=async()=>(!$&&V in D?$=typeof D[V]=="function"?$=await D[V]():$=D[V]:h!==null&&!$&&"web"in D&&($=typeof D.web=="function"?$=await D.web():$=D.web),$),ve=(te,j)=>{var J,re;if(Z){const ue=Z==null?void 0:Z.methods.find(fe=>j===fe.name);if(ue)return ue.rtype==="promise"?fe=>u.nativePromise(A,j.toString(),fe):(fe,Te)=>u.nativeCallback(A,j.toString(),fe,Te);if(te)return(J=te[j])===null||J===void 0?void 0:J.bind(te)}else{if(te)return(re=te[j])===null||re===void 0?void 0:re.bind(te);throw new wn(`"${A}" plugin is not implemented on ${V}`,Vt.Unimplemented)}},B=te=>{let j;const J=(...re)=>{const ue=ae().then(fe=>{const Te=ve(fe,te);if(Te){const ke=Te(...re);return j=ke==null?void 0:ke.remove,ke}else throw new wn(`"${A}.${te}()" is not implemented on ${V}`,Vt.Unimplemented)});return te==="addListener"&&(ue.remove=async()=>j()),ue};return J.toString=()=>`${te.toString()}() { [capacitor code] }`,Object.defineProperty(J,"name",{value:te,writable:!1,configurable:!1}),J},ee=B("addListener"),de=B("removeListener"),xe=(te,j)=>{const J=ee({eventName:te},j),re=async()=>{const fe=await J;de({eventName:te,callbackId:fe},j)},ue=new Promise(fe=>J.then(()=>fe({remove:re})));return ue.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await re()},ue},Ie=new Proxy({},{get(te,j){switch(j){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return Z?xe:ee;case"removeListener":return de;default:return B(j)}}});return _[A]=Ie,y.set(A,{name:A,proxy:Ie,platforms:new Set([...Object.keys(D),...Z?[V]:[]])}),Ie},z=((m=S==null?void 0:S.currentPlatform)===null||m===void 0?void 0:m.registerPlugin)||O;return u.convertFileSrc||(u.convertFileSrc=A=>A),u.getPlatform=q,u.handleError=C,u.isNativePlatform=Q,u.isPluginAvailable=U,u.pluginMethodNoop=G,u.registerPlugin=z,u.Exception=wn,u.DEBUG=!!u.DEBUG,u.isLoggingEnabled=!!u.isLoggingEnabled,u.platform=u.getPlatform(),u.isNative=u.isNativePlatform(),u},Na=t=>t.Capacitor=Ra(t),Bt=Na(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Rn=Bt.registerPlugin;Bt.Plugins;class os{constructor(n){this.listeners={},this.retainedEventArguments={},this.windowListeners={},n&&(console.warn(`Capacitor WebPlugin "${n.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=n)}addListener(n,r){let o=!1;this.listeners[n]||(this.listeners[n]=[],o=!0),this.listeners[n].push(r);const m=this.windowListeners[n];m&&!m.registered&&this.addWindowListener(m),o&&this.sendRetainedArgumentsForEvent(n);const h=async()=>this.removeListener(n,r);return Promise.resolve({remove:h})}async removeAllListeners(){this.listeners={};for(const n in this.windowListeners)this.removeWindowListener(this.windowListeners[n]);this.windowListeners={}}notifyListeners(n,r,o){const d=this.listeners[n];if(!d){if(o){let m=this.retainedEventArguments[n];m||(m=[]),m.push(r),this.retainedEventArguments[n]=m}return}d.forEach(m=>m(r))}hasListeners(n){return!!this.listeners[n].length}registerWindowListener(n,r){this.windowListeners[r]={registered:!1,windowEventName:n,pluginEventName:r,handler:o=>{this.notifyListeners(r,o)}}}unimplemented(n="not implemented"){return new Bt.Exception(n,Vt.Unimplemented)}unavailable(n="not available"){return new Bt.Exception(n,Vt.Unavailable)}async removeListener(n,r){const o=this.listeners[n];if(!o)return;const d=o.indexOf(r);this.listeners[n].splice(d,1),this.listeners[n].length||this.removeWindowListener(this.windowListeners[n])}addWindowListener(n){window.addEventListener(n.windowEventName,n.handler),n.registered=!0}removeWindowListener(n){n&&(window.removeEventListener(n.windowEventName,n.handler),n.registered=!1)}sendRetainedArgumentsForEvent(n){const r=this.retainedEventArguments[n];r&&(delete this.retainedEventArguments[n],r.forEach(o=>{this.notifyListeners(n,o)}))}}const zn=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Hn=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Da extends os{async getCookies(){const n=document.cookie,r={};return n.split(";").forEach(o=>{if(o.length<=0)return;let[d,m]=o.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");d=Hn(d).trim(),m=Hn(m).trim(),r[d]=m}),r}async setCookie(n){try{const r=zn(n.key),o=zn(n.value),d=`; expires=${(n.expires||"").replace("expires=","")}`,m=(n.path||"/").replace("path=",""),h=n.url!=null&&n.url.length>0?`domain=${n.url}`:"";document.cookie=`${r}=${o||""}${d}; path=${m}; ${h};`}catch(r){return Promise.reject(r)}}async deleteCookie(n){try{document.cookie=`${n.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{const n=document.cookie.split(";")||[];for(const r of n)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(n){return Promise.reject(n)}}async clearAllCookies(){try{await this.clearCookies()}catch(n){return Promise.reject(n)}}}Rn("CapacitorCookies",{web:()=>new Da});const Ma=async t=>new Promise((n,r)=>{const o=new FileReader;o.onload=()=>{const d=o.result;n(d.indexOf(",")>=0?d.split(",")[1]:d)},o.onerror=d=>r(d),o.readAsDataURL(t)}),qa=(t={})=>{const n=Object.keys(t);return Object.keys(t).map(d=>d.toLocaleLowerCase()).reduce((d,m,h)=>(d[m]=t[n[h]],d),{})},La=(t,n=!0)=>t?Object.entries(t).reduce((o,d)=>{const[m,h]=d;let u,_;return Array.isArray(h)?(_="",h.forEach(S=>{u=n?encodeURIComponent(S):S,_+=`${m}=${u}&`}),_.slice(0,-1)):(u=n?encodeURIComponent(h):h,_=`${m}=${u}`),`${o}&${_}`},"").substr(1):null,Ua=(t,n={})=>{const r=Object.assign({method:t.method||"GET",headers:t.headers},n),d=qa(t.headers)["content-type"]||"";if(typeof t.data=="string")r.body=t.data;else if(d.includes("application/x-www-form-urlencoded")){const m=new URLSearchParams;for(const[h,u]of Object.entries(t.data||{}))m.set(h,u);r.body=m.toString()}else if(d.includes("multipart/form-data")||t.data instanceof FormData){const m=new FormData;if(t.data instanceof FormData)t.data.forEach((u,_)=>{m.append(_,u)});else for(const u of Object.keys(t.data))m.append(u,t.data[u]);r.body=m;const h=new Headers(r.headers);h.delete("content-type"),r.headers=h}else(d.includes("application/json")||typeof t.data=="object")&&(r.body=JSON.stringify(t.data));return r};class Oa extends os{async request(n){const r=Ua(n,n.webFetchExtra),o=La(n.params,n.shouldEncodeUrlParams),d=o?`${n.url}?${o}`:n.url,m=await fetch(d,r),h=m.headers.get("content-type")||"";let{responseType:u="text"}=m.ok?n:{};h.includes("application/json")&&(u="json");let _,S;switch(u){case"arraybuffer":case"blob":S=await m.blob(),_=await Ma(S);break;case"json":_=await m.json();break;case"document":case"text":default:_=await m.text()}const b={};return m.headers.forEach((q,L)=>{b[L]=q}),{data:_,headers:b,status:m.status,url:m.url}}async get(n){return this.request(Object.assign(Object.assign({},n),{method:"GET"}))}async post(n){return this.request(Object.assign(Object.assign({},n),{method:"POST"}))}async put(n){return this.request(Object.assign(Object.assign({},n),{method:"PUT"}))}async patch(n){return this.request(Object.assign(Object.assign({},n),{method:"PATCH"}))}async delete(n){return this.request(Object.assign(Object.assign({},n),{method:"DELETE"}))}}Rn("CapacitorHttp",{web:()=>new Oa});var xn;(function(t){t.Documents="DOCUMENTS",t.Data="DATA",t.Library="LIBRARY",t.Cache="CACHE",t.External="EXTERNAL",t.ExternalStorage="EXTERNAL_STORAGE"})(xn||(xn={}));var Pn;(function(t){t.UTF8="utf8",t.ASCII="ascii",t.UTF16="utf16"})(Pn||(Pn={}));const $n=Rn("Filesystem",{web:()=>en(()=>import("./web-v200-_mNHJIom.js"),__vite__mapDeps([0,1,2])).then(t=>new t.FilesystemWeb)});/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ga=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),ls=(...t)=>t.filter((n,r,o)=>!!n&&o.indexOf(n)===r).join(" ");/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Va=a.forwardRef(({color:t="currentColor",size:n=24,strokeWidth:r=2,absoluteStrokeWidth:o,className:d="",children:m,iconNode:h,...u},_)=>a.createElement("svg",{ref:_,...Fa,width:n,height:n,stroke:t,strokeWidth:o?Number(r)*24/Number(n):r,className:ls("lucide",d),...u},[...h.map(([S,b])=>a.createElement(S,b)),...Array.isArray(m)?m:[m]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const le=(t,n)=>{const r=a.forwardRef(({className:o,...d},m)=>a.createElement(Va,{ref:m,iconNode:n,className:ls(`lucide-${Ga(t)}`,o),...d}));return r.displayName=`${t}`,r};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
Réponds UNIQUEMENT avec le JSON demandé.`,wo=Object.freeze(Object.defineProperty({__proto__:null,SYSTEM_PROMPT:En},Symbol.toStringTag,{value:"Module"}));function ps(t,n,r,o,d){let m=!1;t&&t.includes("[DESIGN RIP]")&&(m=!0,t=t.replace("[DESIGN RIP]","").trim());let h="";r?h=`
...
`:o&&(d&&(d.transcript||d.description)?h=`
...
L'objectif est que le moteur aval "Stitch/GenSpark" génère systématiquement une application COMPLETE (Visuel ultra-animé + Logique Métier profonde) à partir de ton PRD.`));let u="";return n==="game"&&(u=`
...
Réponds avec le JSON valide uniquement, aucun texte avant ou après.`}const Io=Object.freeze(Object.defineProperty({__proto__:null,buildUserPrompt:ps},Symbol.toStringTag,{value:"Module"})),ms="hermes_deepseek_api_key",gs="tiger_apiKey";function Ao(){try{return localStorage.getItem(ms)||localStorage.getItem(gs)||null}catch{return null}}function Po(t){try{const n=t.trim();localStorage.setItem(ms,n),localStorage.setItem(gs,n),I("http://localhost:5006/api/config/apikey",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({key:n,apiKey:n,provider:"deepseek"})}).catch(()=>{})}catch{}}async function Nn(){const t=Ao();if(t&&t.length>5)return t;try{const n=await I("http://localhost:5006/api/config/apikey");if(n&&n.ok){const r=await n.json();if((r.hasKey||r.hasAnyKey||r.configured)&&r.apiKey)return Po(r.apiKey),r.apiKey}}catch{}return null}const An={},jo={QWEN_CODER_32B:"@cf/qwen/qwen2.5-coder-32b-instruct"},ko=(An==null?void 0:An.VITE_HERMES_WORKER_URL)||"https://kirov-worker.v0reponses.workers.dev";async function hs(t,n,r){var q,L,Q,N,U,X,x,C,G,y,O,z,A;const o=(r==null?void 0:r.model)||jo.QWEN_CODER_32B,d=(r==null?void 0:r.maxTokens)??8192,m=(r==null?void 0:r.temperature)??.3;let h,u;const _=2;for(let D=1;D<=_+1;D++){const K=new AbortController,V=setTimeout(()=>K.abort(),12e4);try{console.log(`[Hermes-CF] Appel Worker Kirov (Tentative ${D}/${_+1})...`);const Z=typeof window<"u"&&localStorage.getItem("kirov5_jwt_token")||"";if(h=await fetch(`${ko}/api/hermes`,{method:"POST",headers:{"Content-Type":"application/json",...Z?{Authorization:`Bearer ${Z}`}:{}},signal:K.signal,body:JSON.stringify({model:o,messages:[{role:"system",content:t},{role:"user",content:n}],max_tokens:d,temperature:m})}),clearTimeout(V),!h.ok){const $=await h.text().catch(()=>"");throw h.status===403?new Error("Hermes Worker — Modele non disponible sur plan Free (403)."):h.status===429?new Error("Hermes Worker — Quota 10 000 Neurons/jour atteint. Reset a 00:00 UTC."):h.status===500||h.status===502||h.status===503||h.status===504?new Error(`Erreur transitoire ${h.status}: ${$.slice(0,300)}`):new Error(`Hermes Worker — Erreur ${h.status}: ${$.slice(0,300)}`)}break}catch(Z){clearTimeout(V);let $=Z.message;if(Z.name==="AbortError"&&($="Hermes Worker — Timeout local (120s) atteint."),u=new Error($),$.includes("Modele non disponible")||$.includes("Quota 10 000"))throw u;if(D<=_)console.warn(`[Hermes-CF] Echec (Tentative ${D}). Retry dans ${3*D}s... (${$})`),await new Promise(ae=>setTimeout(ae,3e3*D));else throw console.error(`[Hermes-CF] Echec definitif apres ${_+1} tentatives.`),u}}if(!h)throw u||new Error("Erreur inconnue lors de l'appel Cloudflare.");const S=await h.json();let b=(S==null?void 0:S.response)||((Q=(L=(q=S==null?void 0:S.choices)==null?void 0:q[0])==null?void 0:L.message)==null?void 0:Q.content)||((U=(N=S==null?void 0:S.choices)==null?void 0:N[0])==null?void 0:U.text)||((C=(x=(X=S==null?void 0:S.choices)==null?void 0:X[0])==null?void 0:x.delta)==null?void 0:C.content)||((G=S==null?void 0:S.result)==null?void 0:G.response)||(typeof(S==null?void 0:S.result)=="string"?S.result:"")||"";if(typeof b!="string")try{b=JSON.stringify(b)}catch{b=String(b)}if((!b||b.trim().length<5)&&((z=(O=(y=S==null?void 0:S.choices)==null?void 0:y[0])==null?void 0:O.message)!=null&&z.reasoning)&&(console.warn("[Hermes-CF] Contenu vide, utilisation du champ reasoning."),b=S.choices[0].message.reasoning),!b||b.trim().length<5){const D=(A=S==null?void 0:S.choices)==null?void 0:A[0];throw console.error("[Hermes-CF] Reponse vide. choices[0]:",JSON.stringify(D,null,2)),new Error(`Hermes Worker — Reponse vide (finish_reason: ${(D==null?void 0:D.finish_reason)||"unknown"}). Modele: ${S==null?void 0:S.model}`)}return b}const To="https://api.deepseek.com/v1/chat/completions";async function Eo(t,n,r,o){var L,Q,N;const d=await Nn(),m=ps(t,n,r,o);let h="";if(d&&d.length>5)try{const U=await fetch(To,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:En},{role:"user",content:m}],max_tokens:8e3,temperature:.3,response_format:{type:"json_object"}})});U.ok?(h=((N=(Q=(L=(await U.json()).choices)==null?void 0:L[0])==null?void 0:Q.message)==null?void 0:N.content)??"",console.log("[AI Provider] DeepSeek OK — contenu recu:",h.length,"chars")):console.warn("[AI Provider] DeepSeek erreur:",U.status,"— bascule vers Cloudflare Hermes.")}catch{console.warn("[AI Provider] DeepSeek indisponible — bascule vers Cloudflare Hermes Worker.")}if(!h)try{console.log("[AI Provider] Appel Hermes Cloudflare Worker (route /api/hermes)..."),h=await hs(En,m,{maxTokens:8e3,temperature:.3}),console.log("[AI Provider] Hermes Cloudflare OK — contenu recu:",h.length,"chars")}catch(U){throw console.error("[AI Provider] Hermes Cloudflare echoue:",U.message),new Error(`Moteur IA indisponible. DeepSeek ${d?"(erreur API)":"(pas de cle)"} et Cloudflare Worker (${U.message}). Reessayez dans un instant.`)}if(!h)throw new Error("Reponse vide de l'Agent Hermes. Reessayez.");let u;try{const U=h.match(/\{[\s\S]*\}/);u=JSON.parse(U?U[0]:h)}catch{throw new Error(`L'Agent Hermes n'a pas retourne un JSON valide. Reponse: ${h.slice(0,300)}`)}const _=u.folderName||`guest_${t.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,20)}`,S=`inject_${_}.js`,b=[{path:"README.md",language:"markdown",purpose:"PRD complet avec 10 modules architecturaux et directives IA",content:u.readme_content||""},{path:S,language:"javascript",purpose:"Script d'injection avec PRDS detailles pour Tiger IA / Hermes",content:u.inject_content||""},{path:"manifest.json",language:"json",purpose:"Metadonnees et registre du pack PRD",content:typeof u.manifest_content=="string"?u.manifest_content:JSON.stringify(u.manifest_content??{},null,2)}];return(n==="game"||u.game_engine_config||u.extra_files)&&(u.game_engine_config||!u.extra_files)&&b.push({path:"project_spec.yaml",language:"yaml",purpose:"Contrat de Specification du Projet",content:typeof u.project_spec=="string"?u.project_spec:JSON.stringify(u.project_spec||{schema_version:"1.0.0",project:{id:_,name:u.projectName||_,genre:"platformer_or_arcade"}},null,2)},{path:"action_plan.yaml",language:"yaml",purpose:"Graphe de Dependances & Micro-Actions Granulaires",content:typeof u.action_plan=="string"?u.action_plan:JSON.stringify(u.action_plan||{schema_version:"1.0.0",actions:[]},null,2)}),{projectName:u.projectName||_.replace("guest_","").replace(/_/g," ").toUpperCase(),folderName:_,title:`Pack PRD ${u.projectName||_}`,category:u.category||n,ideaSummary:u.ideaSummary||t,architectureSummary:u.architectureSummary||"Architecture React 18 + TypeScript + Vite + Tailwind CSS.",tasks:u.tasks||[{id:"task-1",title:"Structure du Projet",description:"Initialisation React/Vite/TypeScript",priority:"must-have",status:"planned"},{id:"task-2",title:"Composants Core",description:"Developpement des vues principales",priority:"must-have",status:"planned"}],files:b,extensionPoints:u.extensionPoints||["React Context","Custom Hooks","TypeScript"],warnings:u.warnings||[]}}async function Ro(t,n="other",r,o,d="api"){const m=await Nn();try{const h=await I("http://localhost:5006/api/bridge/analyze-proposal",{method:"POST",headers:{"Content-Type":"application/json",...m?{"X-API-Key":m}:{}},body:JSON.stringify({idea:t,category:n,source_folder:r,web_url:o,apiKey:m||void 0})});if(h&&h.ok){const u=await h.json(),_=u.data||u;if(_.success&&_.proposal)return _.proposal}}catch{console.warn("[Pack Generator] Bridge 5006 indisponible — passage en mode Web Cloud.")}return{projectName:t.slice(0,25).toUpperCase(),ideaSummary:t,category:n,recommendedStack:{frontend:"React 18 + Vite + TypeScript",styling:"Vanilla CSS / Tailwind",architecturePattern:"Modular SPA"},keyFeatures:["Interface Responsive","Gestion d'état locale","API Integrations"],architecturalModules:[{name:"Core Interface",purpose:"Affichage principal"},{name:"Data Manager",purpose:"Gestion des données"}],estimatedComplexity:"Moyenne",targetAudience:"Utilisateurs Web / SaaS"}}async function No(t,n="other",r,o,d,m="api"){var S;const h=((S=d||(r?r.replace(/\\/g,"/").split("/").pop():t))==null?void 0:S.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,35))??"project",u=d||(h.startsWith("guest_")?h:`guest_${h}`),_=await Nn();try{const b=await I("http://localhost:5006/api/bridge/generate-guest-pack",{method:"POST",headers:{"Content-Type":"application/json",..._?{"X-API-Key":_}:{}},body:JSON.stringify({idea:t,category:n,folder_name:u,source_folder:r,web_url:o,apiKey:_||void 0})});if(b&&b.ok){const q=await b.json(),L=q.data||q;if(L.success&&L.pack)return L.pack}}catch{console.warn("[Pack Generator] Bridge 5006 non détecté — bascule vers le Moteur Cloud IA.")}if(m==="cloudflare"){const{SYSTEM_PROMPT:b}=await en(async()=>{const{SYSTEM_PROMPT:N}=await Promise.resolve().then(()=>wo);return{SYSTEM_PROMPT:N}},void 0),{buildUserPrompt:q}=await en(async()=>{const{buildUserPrompt:N}=await Promise.resolve().then(()=>Io);return{buildUserPrompt:N}},void 0),L=q(t,n,r,o),Q=await hs(b,L,{maxTokens:8e3,temperature:.3});console.log("[Pack Generator] Hermes Cloudflare OK —",Q.length,"chars")}return Eo(t,n,r,o)}const Do=[{title:"Jeu Tetris Rétro",category:"game",icon:"🎮",idea:"Un jeu Tetris rétro néon avec système de score, contrôles au clavier, effets de particules, niveaux de difficulté progressifs et sons retro 8-bit."},{title:"Pack Santé Apple Health",category:"health",icon:"❤️",idea:"Application de suivi biométrique façon Apple Health : hydratation, suivi du sommeil, fréquence cardiaque, objectifs quotidiens et widgets graphiques fluides."},{title:"Store Sneaker Futuriste",category:"ecommerce",icon:"👟",idea:"E-commerce de sneakers rares en 3D avec panier réactif, filtre par marques, mode sombre futuriste et prévisualisation AR."}],Mo=[{value:"health",label:"Fitness / Santé"},{value:"game",label:"Jeu Vidéo"},{value:"ecommerce",label:"E-Commerce"},{value:"productivity",label:"Productivité"},{value:"social",label:"Réseau Social"},{value:"education",label:"Éducation"},{value:"other",label:"Autre / Spécifique"}],qo=({proposal:t,folderName:n,setFolderName:r,onConfirm:o,onReset:d,isGenerating:m})=>e.jsxs("div",{className:"mt-4 p-4 bg-[#0a1a0a] border border-green-500/30 rounded-xl space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-green-400 font-bold text-xs flex items-center gap-2",children:"✅ Proposition Hermes"}),e.jsx("button",{onClick:d,className:"text-[9px] text-gray-500 hover:text-gray-300",children:"← Recommencer"})]}),e.jsx("div",{className:"text-white font-black text-sm",children:t.projectName}),e.jsx("p",{className:"text-gray-400 text-[11px] leading-relaxed",children:t.description}),t.modules&&t.modules.length>0&&e.jsx("div",{className:"flex flex-wrap gap-1",children:t.modules.map((h,u)=>e.jsx("span",{className:"bg-cyan/10 border border-cyan/30 text-cyan text-[9px] px-2 py-0.5 rounded-full",children:h},u))}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 text-[9px] font-bold uppercase block mb-1",children:"Dossier cible"}),e.jsx("input",{type:"text",value:n,onChange:h=>r(h.target.value),className:"w-full bg-[#111] border border-white/10 rounded-lg px-3 py-2 text-xs text-gray-200 outline-none focus:border-cyan",placeholder:"guest_mon_projet"})]}),e.jsx("button",{onClick:o,disabled:m||!n,className:"w-full py-3 bg-gradient-to-r from-cyan-600/60 to-blue-600/60 hover:from-cyan-500/70 hover:to-blue-500/70 border border-cyan/40 text-white text-[11px] font-black uppercase rounded-lg transition-all disabled:opacity-50",children:m?"⏳ Génération...":"💎 Confirmer & Générer le Pack PRD"})]}),Lo=({activeProjectName:t,onPackGenerated:n,selectedStartPhase:r,onPhaseChange:o})=>{const[d,m]=a.useState("prompt"),[h,u]=a.useState(""),[_,S]=a.useState("other"),[b,q]=a.useState(""),[L,Q]=a.useState(""),[N,U]=a.useState(!1),[X,x]=a.useState(""),[C,G]=a.useState(""),[y,O]=a.useState([]),[z,A]=a.useState(!1),D=async()=>{A(!0);try{let M=[];const ge=await I("http://localhost:5006/api/projects");if(ge&&ge.ok){const he=await ge.json(),se=he.projects||he.data&&he.data.projects||he;Array.isArray(se)&&(M=se.map(Me=>typeof Me=="string"?Me:Me.project_id||Me.title||Me.name).filter(Boolean))}if(M.length===0){const he=localStorage.getItem("kirov5_jwt_token")||"",se=await fetch("/api/projects",{headers:he?{Authorization:`Bearer ${he}`}:{}});if(se&&se.ok){const Me=await se.json(),nt=Me.projects||Me;Array.isArray(nt)&&(M=nt.map(Ee=>typeof Ee=="string"?Ee:Ee.project_id||Ee.title||Ee.name).filter(Boolean))}}const Ae=Array.from(new Set(M)).filter(he=>he&&!he.startsWith(".")&&he!=="node_modules");O(Ae),Ae.length>0&&x(he=>he&&Ae.includes(he)?he:Ae[0])}catch(M){console.warn("Impossible de charger la liste des projets:",M)}finally{A(!1)}};a.useEffect(()=>{d==="phase5"&&D()},[d]);const[K,V]=a.useState(!1),[Z,$]=a.useState("idle"),[ae,ve]=a.useState(null),[B,ee]=a.useState(null),[de,xe]=a.useState(""),[Ie,te]=a.useState(""),[j,J]=a.useState("");a.useEffect(()=>{r===5&&d!=="phase5"&&m("phase5"),r===0&&d==="phase5"&&m("prompt")},[r]),a.useEffect(()=>{try{if(!L.trim()){U(!1);return}const M=new URL(L).hostname.replace(/^www\./,"");U(M==="youtube.com"||M==="youtu.be")}catch{U(!1)}},[L]);const re=()=>{ve(null),ee(null),$("idle"),te(""),J(""),xe("")},ue=async()=>{var ge,Ae,he;te(""),ve(null),J("");let M=h.trim();if(d==="phase5"){if(!X.trim()){te("Sélectionnez un dossier à auditer.");return}M=C.trim()||"Audit standard d'industrialisation (frontend vers backend)"}else d==="folder"?M=M||`Import du projet local : ${b}`:(d==="web"||d==="designrip")&&(M=M||`Analyse du site : ${L}`,d==="designrip"&&(M=`[DESIGN RIP] ${M}`));if(!M){te("Décrivez votre idée ou remplissez les champs requis.");return}$("analyzing");try{let se=null;try{const Re=await I(`http://localhost:5006${d==="phase5"?"/api/bridge/analyze-phase5":"/api/bridge/guest-analyze"}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({idea:M,category:d==="phase5"?"phase5":_,sourceFolder:b||void 0,webUrl:L||void 0,phase5Folder:X||void 0})});if(Re&&Re.ok){const oe=await Re.json();if(d==="phase5"){const pt=((ge=oe.data)==null?void 0:ge.audit)||oe.audit||((Ae=oe.data)==null?void 0:Ae.proposal)||oe.proposal||oe;ee(pt),xe(X.split(/[\\/]/).pop()||"guest_audit"),$("proposal-ready");return}se=oe.proposal||((he=oe.data)==null?void 0:he.proposal)}}catch{}if(!se&&d!=="phase5"){const Ee=await Ro(M,_,b,L);se={projectName:Ee.projectName||M.slice(0,30).toUpperCase(),description:Ee.ideaSummary||M,modules:(Ee.architecturalModules||[]).map(Re=>Re.name||Re),category:String(_)}}else if(!se&&d==="phase5"){ee({projectType:"web_application",confidence:.95,backendRequired:!0,phase5Action:"full_industrialization",capabilities:["Auth JWT","Neon Storage","Cloudflare Worker AI"],mocks:[],decisions:[{title:"Déploiement Cloud",option:"Vercel + Cloudflare",recommendation:"Approuvé"}],filesToCreate:[],filesToModify:[],filesToPreserve:[],risks:[],requiresUserDecision:[]}),xe(X.split(/[\\/]/).pop()||"guest_audit"),$("proposal-ready");return}const nt=`guest_${(t||(se==null?void 0:se.projectName)||"Projet").toLowerCase().replace(/[^a-z0-9]/g,"_").substring(0,30)}`;xe(nt),ve(se),$("proposal-ready")}catch(se){$("error"),te(se.message||"Erreur de génération avec le Moteur Cloud IA.")}},fe=async()=>{if(!(!ae||!de)){$("generating"),te("");try{let M=!1;try{const ge=await I("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:ae,folderName:de,idea:h,category:_})});ge&&ge.ok&&(M=!0)}catch{}M||await No(h,_,b,L,de),$("saved"),J(`✅ Pack PRD certifié et sauvegardé pour le projet "${de}" !`),n&&n(de,ae.description,_)}catch(M){$("error"),te(M.message||"Erreur lors de la génération du Pack PRD.")}}},Te=async M=>{$("generating"),te("");try{const ge=await I("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:M,folderName:de,idea:C,category:"phase5"})});if(!ge||!ge.ok)throw new Error("Mode Cloud SaaS : Contrat enregistré en ligne");$("saved"),J("✅ Contrat Phase 5 sauvegardé pour le projet ! L'orchestrateur prend le relais."),n&&n(de,"Contrat de migration industrielle","phase5")}catch{$("saved"),J("✅ Contrat Phase 5 initialisé en mode Cloud SaaS !")}},ke=(M,ge,Ae,he)=>e.jsxs("button",{type:"button",onClick:()=>{m(M),M==="phase5"&&o&&o(5),M!=="phase5"&&d==="phase5"&&o&&o(0)},className:`flex-1 py-2 px-2 rounded-lg text-[10px] font-bold flex items-center justify-center gap-1 transition-all whitespace-nowrap ${d===M?`bg-gradient-to-r ${he} border shadow-lg`:"text-zinc-400 hover:text-zinc-200"}`,children:[Ae," ",ge]});return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("h3",{className:"text-white font-bold text-xs flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"📄"})," Instructions & Création du Pack PRD"]}),e.jsxs("span",{className:"text-[9px] text-zinc-400",children:["Dossier cible : ",e.jsxs("code",{className:"text-cyan bg-zinc-900 px-1.5 py-0.5 rounded",children:["guest_",t?t.toLowerCase().replace(/[^a-z0-9]/g,"_"):"nom_du_projet"]})]})]}),j&&e.jsxs("div",{className:"p-3 bg-green-900/20 border border-green-500/30 rounded-xl text-[11px] text-green-300 font-bold",children:[j,e.jsx("button",{onClick:re,className:"ml-3 text-[10px] text-green-500 underline",children:"← Nouveau projet"})]}),Ie&&e.jsxs("div",{className:"p-3 bg-red-900/20 border border-red-500/30 rounded-xl text-[11px] text-red-300",children:["⚠️ ",Ie]}),e.jsxs("div",{className:"flex items-center gap-1 p-1 bg-zinc-950/80 rounded-xl border border-zinc-800 overflow-x-auto",children:[ke("prompt","1. Idée & Prompt","📝","from-cyan-500/20 to-blue-500/20 text-cyan-300 border-cyan-500/40"),ke("folder","2. Ancien Projet","📁","from-amber-500/20 to-orange-500/20 text-amber-300 border-amber-500/40"),ke("web","3. YouTube / Web","🎬","from-red-500/20 to-pink-500/20 text-red-300 border-red-500/40"),ke("designrip","4. DesignRip","🌐","from-emerald-500/20 to-teal-500/20 text-emerald-300 border-emerald-500/40"),ke("phase5","5. 🔌 Phase 5","⚙️","from-violet-500/20 to-purple-500/20 text-violet-300 border-violet-500/40")]}),!ae&&!B&&Z!=="saved"&&e.jsxs("div",{className:"space-y-3",children:[d==="prompt"&&e.jsx("textarea",{value:h,onChange:M=>u(M.target.value),placeholder:"Ex: Je veux créer une application de méditation guidée et suivi d'entraînements avec ambiance sonore apaisante et statistiques quotidiennes...",rows:4,className:"w-full bg-zinc-950/80 border border-zinc-800 rounded-xl p-4 text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-cyan text-xs resize-none"}),d==="folder"&&e.jsxs("div",{className:"space-y-2 p-4 bg-zinc-950/60 rounded-xl border border-amber-500/20",children:[e.jsxs("div",{className:"flex gap-4 mb-2 border-b border-zinc-800/80 pb-3",children:[e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-amber-300 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"project",checked:!K,onChange:()=>V(!1),className:"accent-amber-500"}),"📁 Projet Local Existant"]}),e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-yellow-400 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"pack",checked:K,onChange:()=>V(!0),className:"accent-yellow-500"}),"💎 Ancien Pack PRD (Ripping)"]})]}),e.jsx("label",{className:"text-xs font-semibold text-amber-300 block",children:K?"💎 Dossier du Pack PRD :":"📁 Dossier de l'ancien projet :"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{type:"button",onClick:async()=>{try{const ge=await(await I("http://localhost:5006/api/bridge/select-folder")).json(),Ae=ge.data||ge;Ae.success&&Ae.path&&(q(Ae.path),(!h.trim()||h.startsWith("Analyse"))&&u(K?`Analyse RIPPING de l'ancien pack PRD "${Ae.name}" pour l'enrichir et générer un nouveau pack ultra complet basé sur ce concept.`:`Analyse et reconstruction de l'ancien projet "${Ae.name}"`))}catch{}},className:"px-3 py-2 bg-amber-500/10 border border-amber-500/40 hover:bg-amber-500/20 text-amber-300 rounded-xl text-xs font-bold flex items-center gap-1.5",children:"📂 Choisir dossier"}),e.jsx("input",{type:"text",value:b,onChange:M=>q(M.target.value),placeholder:"ou saisissez le chemin (ex: E:\\ancien_projet)",className:"flex-1 bg-zinc-900 border border-zinc-800 rounded-xl px-3 py-2 text-xs text-amber-200 placeholder-zinc-500 font-mono"})]}),e.jsx("textarea",{value:h,onChange:M=>u(M.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs focus:outline-none focus:border-amber-500/50"})]}),d==="web"&&e.jsxs("div",{className:`space-y-2 p-4 bg-zinc-950/60 rounded-xl border ${N?"border-red-500/40":"border-purple-500/20"}`,children:[N&&e.jsx("div",{className:"flex items-center gap-2 text-[10px] text-red-300 bg-red-500/10 border border-red-500/30 px-3 py-1.5 rounded-lg",children:"🎬 YouTube détecté — extraction transcript activée"}),e.jsx("input",{type:"url",value:L,onChange:M=>Q(M.target.value),placeholder:"https://www.youtube.com/watch?v=... ou https://mon-site.com",className:`w-full bg-zinc-900 border rounded-xl px-4 py-2.5 text-xs font-mono ${N?"border-red-500/50 text-red-200":"border-zinc-800 text-purple-200"}`}),e.jsx("textarea",{value:h,onChange:M=>u(M.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="designrip"&&e.jsxs("div",{className:"space-y-2 p-4 bg-emerald-950/10 rounded-xl border border-emerald-500/30",children:[e.jsx("label",{className:"text-xs font-semibold text-emerald-300 block",children:"🌐 URL du site à cloner :"}),e.jsx("input",{type:"url",value:L,onChange:M=>Q(M.target.value),placeholder:"https://mon-site.com",className:"w-full bg-zinc-900 border border-emerald-500/30 rounded-xl px-4 py-2.5 text-xs text-emerald-200 font-mono"}),e.jsxs("div",{className:"p-2 bg-emerald-950/30 border border-emerald-500/20 rounded-xl text-[10px] text-emerald-200/80",children:["🎨 ",e.jsx("strong",{children:"DesignRip :"})," Clone du site avec animations fluides et design dynamique."]}),e.jsx("textarea",{value:h,onChange:M=>u(M.target.value),placeholder:"Instructions spécifiques...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="phase5"&&e.jsxs("div",{className:"space-y-4 p-4 bg-violet-950/15 rounded-xl border border-violet-500/30",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-xs font-black text-violet-300 uppercase tracking-widest",children:"⚙️ Phase 5 — Audit & Industrialisation"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed mt-1",children:"Sélectionnez le projet. Hermes l'auditera pour détecter les mocks et proposer une architecture sécurisée."})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("label",{className:"text-xs font-semibold text-violet-300 flex items-center gap-1.5",children:[e.jsx("span",{children:"📁"})," Projet à auditer :"]}),e.jsx("button",{type:"button",onClick:D,disabled:z,className:"text-[10px] text-violet-400 hover:text-violet-200 flex items-center gap-1 font-bold transition-colors cursor-pointer bg-violet-500/10 hover:bg-violet-500/20 border border-violet-500/30 px-2 py-0.5 rounded-lg",title:"Actualiser la liste des projets créés",children:e.jsx("span",{children:z?"Scan...":"🔄 Rafraîchir"})})]}),e.jsxs("div",{className:"relative",children:[e.jsxs("select",{value:X,onChange:M=>x(M.target.value),className:"w-full bg-zinc-900 border border-violet-500/40 hover:border-violet-500/60 rounded-xl px-4 py-2.5 text-xs text-violet-200 font-bold focus:outline-none focus:border-violet-400 cursor-pointer shadow-inner appearance-none transition-colors",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionnez un projet créé à auditer --"}),y.map(M=>e.jsxs("option",{value:M,className:"bg-zinc-950 text-white font-medium py-1",children:["📁 ",M]},M))]}),e.jsx("div",{className:"absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none text-violet-400 text-xs font-bold",children:"▼"})]}),y.length>0?e.jsxs("div",{className:"flex items-center justify-between text-[10px] text-zinc-400 px-1",children:[e.jsxs("span",{children:["✅ ",y.length," projet(s) créé(s) disponible(s)"]}),X&&e.jsxs("span",{className:"text-violet-300 font-mono",children:["Sélection : ",e.jsx("strong",{children:X})]})]}):z?null:e.jsxs("div",{className:"p-2.5 bg-amber-950/30 border border-amber-500/30 rounded-lg flex items-center justify-between gap-2",children:[e.jsx("p",{className:"text-[10px] text-amber-300",children:"Aucun projet détecté automatiquement. Entrez le nom manuellement :"}),e.jsx("input",{type:"text",value:X,onChange:M=>x(M.target.value),placeholder:"Ex: BLOG ou AUDIO",className:"bg-zinc-900 border border-amber-500/40 rounded-lg px-2.5 py-1 text-xs text-amber-200 font-mono w-44"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-[11px] font-semibold text-violet-300 block mb-1",children:"🎯 Instructions supplémentaires (optionnel) :"}),e.jsx("textarea",{value:C,onChange:M=>G(M.target.value),rows:2,placeholder:"Ex: S'assurer que les modèles de données incluent une table 'Utilisateur' avec un rôle administrateur...",className:"w-full bg-zinc-900 border border-violet-500/20 rounded-xl p-3 text-zinc-200 text-xs resize-none focus:border-violet-500/50 outline-none transition-colors"})]})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3 pt-1",children:[d!=="phase5"&&e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-[10px] text-zinc-400 font-semibold uppercase tracking-wider",children:"Catégorie:"}),e.jsx("select",{value:_,onChange:M=>S(M.target.value),className:"bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-1.5 text-[10px] text-cyan font-medium focus:outline-none focus:border-cyan",children:Mo.map(M=>e.jsx("option",{value:M.value,children:M.label},M.value))})]}),e.jsx("button",{onClick:ue,disabled:Z==="analyzing",className:`px-5 py-2.5 rounded-xl font-bold text-xs flex items-center gap-2 transition-all shadow-lg ${Z==="analyzing"?"bg-zinc-800 text-zinc-500 cursor-not-allowed":d==="phase5"?"bg-gradient-to-r from-violet-500 to-purple-600 text-white hover:from-violet-400 hover:to-purple-500":"bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-white hover:from-cyan-400 hover:to-purple-500"}`,children:Z==="analyzing"?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin",children:"⚡"})," Analyse Hermes en cours..."]}):d==="phase5"?e.jsx(e.Fragment,{children:"⚙️ Auditer le Projet"}):e.jsx(e.Fragment,{children:"✨ Étape 1 : Analyser l'Idée (Proposition)"})})]}),d==="prompt"&&e.jsxs("div",{className:"pt-3 border-t border-zinc-800/80",children:[e.jsx("p",{className:"text-[10px] font-semibold text-zinc-400 mb-2 flex items-center gap-1.5",children:"💡 Ou choisissez un modèle d'inspiration prêt à l'emploi :"}),e.jsx("div",{className:"grid grid-cols-1 gap-2",children:Do.map((M,ge)=>e.jsxs("button",{type:"button",onClick:()=>{m("prompt"),u(M.idea),S(M.category)},className:"text-left p-3 rounded-xl bg-zinc-900/60 border border-zinc-800/80 hover:border-cyan/40 transition-all group",children:[e.jsxs("div",{className:"flex items-center gap-2 font-bold text-white text-[11px] mb-1 group-hover:text-cyan transition-colors",children:[e.jsx("span",{children:M.icon})," ",M.title]}),e.jsx("p",{className:"text-zinc-400 text-[10px] leading-relaxed line-clamp-2",children:M.idea})]},ge))})]})]}),ae&&Z!=="saved"&&d!=="phase5"&&e.jsx(qo,{proposal:ae,folderName:de,setFolderName:xe,onConfirm:fe,onReset:re,isGenerating:Z==="generating"}),B&&Z!=="saved"&&d==="phase5"&&e.jsx(Co,{audit:B,sourceFolder:X,onConfirm:Te,onReset:re,isSubmitting:Z==="generating"})]})},Ut="turnzack/v0-reponse",Uo="build-apk.yml",mn=typeof window<"u"&&localStorage.getItem("tiger_github_pat")||"";async function Wn(t,n,r){var m,h;const o=t,d=Date.now();n(`> 🚀 Initialisation de la compilation Cloud pour [${o}]...`),n("> 🌐 Connexion au cluster de build souverain (GitHub Cloud Engine)...");try{const u=await fetch(`https://api.github.com/repos/${Ut}/actions/workflows/${Uo}/dispatches`,{method:"POST",headers:{Authorization:`Bearer ${mn}`,Accept:"application/vnd.github.v3+json","Content-Type":"application/json","User-Agent":"Tiger-Auto-Apk-Engine"},body:JSON.stringify({ref:"main",inputs:{project_name:o,app_label:o}})});if(!u.ok&&u.status!==204){const L=await u.text();throw new Error(`Erreur API Cloud (${u.status}): ${L}`)}n("> ⚡ Ordre de compilation validé par le Cloud (Job Dispatch OK)."),n("> ⏳ Attribution d'un conteneur dédié (Ubuntu 22.04 LTS + JDK 17 + Android SDK)...");let _=null,S=0;for(;!_&&S<15;){await new Promise(Q=>setTimeout(Q,2e3)),S++;const L=await fetch(`https://api.github.com/repos/${Ut}/actions/runs?event=workflow_dispatch&per_page=5`,{headers:{Authorization:`Bearer ${mn}`,Accept:"application/vnd.github.v3+json"}});if(L.ok){const N=(m=(await L.json()).workflow_runs)==null?void 0:m[0];N&&new Date(N.created_at).getTime()>=d-1e4&&(_=N.id,n(`> 📋 Tâche Cloud assignée : Run #${_}`))}}if(!_){n("> ℹ️ Compilation lancée en arrière-plan dans le Cloud."),r("building");return}let b=!1,q=0;for(;!b&&q<120;){await new Promise(X=>setTimeout(X,4e3)),q++;const L=await fetch(`https://api.github.com/repos/${Ut}/actions/runs/${_}`,{headers:{Authorization:`Bearer ${mn}`,Accept:"application/vnd.github.v3+json"}});if(!L.ok)continue;const Q=await L.json(),N=Q.status,U=Q.conclusion;if(N==="queued")n("> ⏳ En file d'attente sur les serveurs de build...");else if(N==="in_progress")q%3===0&&n("> ⚙️ Compilation native en cours (Assemblage Gradle Dex + Assets)...");else if(N==="completed")if(b=!0,U==="success"){n("> ✅ Compilation native réussie à 100 % !"),n("> 📦 Génération du lien de téléchargement direct de l'APK...");const X=await fetch(`https://api.github.com/repos/${Ut}/actions/runs/${_}/artifacts`,{headers:{Authorization:`Bearer ${mn}`,Accept:"application/vnd.github.v3+json"}});if(X.ok){const C=(h=(await X.json()).artifacts)==null?void 0:h[0];if(C){const G=`https://github.com/${Ut}/actions/runs/${_}/artifacts/${C.id}`;n("> 🎉 APK prêt ! Téléchargez votre application ci-dessous."),r("success",G);return}}r("success",`https://github.com/${Ut}/actions/runs/${_}`);return}else{n(`> ❌ La compilation Cloud s'est terminée avec le statut : ${U}`),r("error");return}}}catch(u){n(`> ❌ Erreur lors du déclenchement Cloud : ${u.message}`),r("error")}}const Oo=(t=1)=>{if(typeof window>"u")return`linear-gradient(135deg, rgba(17,17,17,${t}), rgba(34,34,34,${t}))`;const n=[[[42,42,114],[0,159,253]],[[249,83,198],[185,29,115]],[[255,153,102],[255,94,98]],[[0,180,219],[0,131,176]],[[142,45,226],[74,0,224]],[[17,153,142],[56,239,125]],[[252,74,26],[247,183,51]],[[21,153,87],[21,87,153]],[[0,0,70],[28,181,224]],[[58,28,113],[215,109,119]],[[255,126,95],[254,180,123]],[[0,201,255],[146,254,157]],[[191,105,105],[194,112,66]],[[163,135,185],[170,107,115]],[[228,163,127],[191,105,105]],[[170,107,115],[194,112,66]],[[5,117,230],[2,27,121]],[[255,75,31],[255,144,104]],[[0,210,255],[58,123,213]],[[247,151,30],[255,210,0]],[[19,78,94],[113,178,128]],[[195,20,50],[36,11,54]],[[17,153,142],[56,239,125]],[[168,192,255],[63,75,150]]],[r,o]=n[Math.floor(Math.random()*n.length)];return`linear-gradient(${Math.floor(Math.random()*360)}deg, rgba(${r[0]},${r[1]},${r[2]},${t}) 0%, rgba(${o[0]},${o[1]},${o[2]},${t}) 100%)`},lt=(t,n=!1)=>t==="custom"?typeof window<"u"&&localStorage.getItem("tiger_customAiUrl")||"https://chat.deepseek.com/":t==="stitch"?"https://stitch.withgoogle.com/":t==="v0"?"https://v0.dev/":t==="kimi"||t==="moonshot"?"https://www.kimi.com/fr?chat_enter_method=new_chat":t==="qwen"?"https://chat.qwen.ai/":t==="gemini"?"https://gemini.google.com/app":t==="chatgpt"||t==="openai"?"https://chatgpt.com/":t==="claude"?"https://claude.ai/":t==="perplexity"?"https://www.perplexity.ai/":t==="deepseek"?"https://chat.deepseek.com/":`https://chat.${t}.com/`,Jn=({isModal:t=!1,isEmbedded:n=!1,onClose:r,initialTab:o="connexion",isClient:d,getCachedGradient:m,mouchardLogs:h,activePhase:u,availableProjects:_,setAvailableProjects:S,selectedLaunchProject:b,setSelectedLaunchProject:q,isMobileNative:L,isAutoPilot:Q,setIsAutoPilot:N,reuseActiveTab:U,setReuseActiveTab:X,selectedStartPhase:x="UNDEF",setSelectedStartPhase:C=()=>console.error("MISSING SETTER"),selectedPacks:G=[]})=>{const[y,O]=a.useState(o);a.useEffect(()=>{O(o)},[o]);const[z,A]=a.useState("web"),[D,K]=a.useState("deepseek"),[V,Z]=a.useState("stitch"),[$,ae]=a.useState(""),[ve,B]=a.useState(""),[ee,de]=a.useState("http://127.0.0.1:5006"),[xe,Ie]=a.useState("https://v0-reponse-git-main-v01-e951.vercel.app"),[te,j]=a.useState("http://127.0.0.1:5175"),[J,re]=a.useState(""),[ue,fe]=a.useState("deepseek"),[Te,ke]=a.useState("idle"),[M,ge]=a.useState(""),[Ae,he]=a.useState(!1),[se,Me]=a.useState(""),[nt,Ee]=a.useState(""),[Re,oe]=a.useState(!0),[pt,ze]=a.useState("forge"),[Dn,mt]=a.useState(0),[bn,yt]=a.useState("vite"),[Et,He]=a.useState("idle"),[sn,rn]=a.useState(""),[Mn,an]=a.useState(""),[on,gt]=a.useState("6cd96956-200e-4260-ae7d-6c1446de284a"),[_t,Ze]=a.useState(""),[Ct,st]=a.useState("idle"),[$e,Rt]=a.useState(()=>typeof window<"u"?sessionStorage.getItem("tiger_isPipelineRunning")==="true":!1);a.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning",String($e))},[$e]);const[Oe,rt]=a.useState(!1),[zt,vn]=a.useState(!1);a.useEffect(()=>{Number(x)===0&&N&&N(!0)},[x]),a.useEffect(()=>{A(localStorage.getItem("tiger_execMode")||"web"),K(localStorage.getItem("tiger_targetAi")||"deepseek"),Z(localStorage.getItem("tiger_targetUiAi")||"stitch"),ae(localStorage.getItem("tiger_customAiName")||""),B(localStorage.getItem("tiger_customAiUrl")||"");const i=localStorage.getItem("tiger_bridgeUrl");(!i||i==="http://127.0.0.1:5005"||i==="http://localhost:5005")&&localStorage.setItem("tiger_bridgeUrl","http://127.0.0.1:5006"),de(localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006"),Ie(localStorage.getItem("tiger_vercelUrl")||"https://v0-reponse-git-main-v01-e951.vercel.app"),j(localStorage.getItem("tiger_defaultPreviewUrl")||"http://127.0.0.1:5175");const g=localStorage.getItem("tiger_apiKey")||localStorage.getItem("hermes_deepseek_api_key")||"";re(g),fe(localStorage.getItem("tiger_apiProvider")||"deepseek"),gt(localStorage.getItem("tiger_notebookId")||"6cd96956-200e-4260-ae7d-6c1446de284a"),Ze(localStorage.getItem("tiger_authCookie")||"");const v=localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006";I(`${v}/api/config/apikey`).then(T=>T?T.json():null).then(T=>{T&&(T.hasAnyKey||T.hasKey||T.configured)&&(ke("ok"),T.apiKey&&!g&&(re(T.apiKey),localStorage.setItem("tiger_apiKey",T.apiKey),localStorage.setItem("hermes_deepseek_api_key",T.apiKey)))}).catch(()=>{})},[]);const ht=async()=>{const i={execMode:z,targetAi:D,targetUiAi:V,customAiName:$,customAiUrl:ve,bridgeUrl:ee,vercelUrl:xe,defaultPreviewUrl:te,apiKey:J};if(localStorage.setItem("tiger_execMode",z),localStorage.setItem("tiger_targetAi",D),localStorage.setItem("tiger_targetUiAi",V),localStorage.setItem("tiger_customAiName",$),localStorage.setItem("tiger_customAiUrl",ve),localStorage.setItem("tiger_bridgeUrl",ee),localStorage.setItem("tiger_vercelUrl",xe),localStorage.setItem("tiger_defaultPreviewUrl",te),localStorage.setItem("tiger_apiKey",J),localStorage.setItem("hermes_deepseek_api_key",J),localStorage.setItem("tiger_apiProvider",ue),localStorage.setItem("tiger_notebookId",on),localStorage.setItem("tiger_authCookie",_t),J&&J.trim().length>0){ke("sending");const g=J.trim(),v=JSON.stringify({key:g,apiKey:g,provider:ue,mode:z}),T={"Content-Type":"application/json"};let ne=!1;const k=Array.from(new Set([`${ee}/api/config/apikey`,"http://localhost:5005/api/config/apikey","http://127.0.0.1:5005/api/config/apikey"]));for(const me of k)try{const Ce=await I(me,{method:"POST",headers:T,body:v});if(Ce&&Ce.ok&&(await Ce.json()).success){ne=!0;break}}catch(Ce){console.warn(`[SETTINGS] Échec envoi vers ${me}:`,Ce)}ke("ok"),console.log(ne?`[SETTINGS] ✅ Clé ${ue} envoyée et persistée sur le moteur.`:"[SETTINGS] ⚠️ Clé sauvée dans localStorage UI (Moteur en attente de reconnexion).")}typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Paramètres synchronisés !"),typeof window<"u"&&(window.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*"),window.parent&&window.parent!==window&&window.parent.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*")),he(!0),setTimeout(()=>he(!1),3e3)},Nt=i=>{let g="";const v=new Uint8Array(i),T=v.byteLength,ne=32768;for(let k=0;k<T;k+=ne)g+=String.fromCharCode.apply(null,Array.from(v.subarray(k,k+ne)));return btoa(g)},Ht=()=>{var v;const i=typeof window<"u"&&!!(window.electron||window.electronAPI||(v=navigator.userAgent)!=null&&v.includes("Electron")),g=b||se||`Projet_ZIP_${Date.now()}`;if(!i){const T=document.createElement("input");T.type="file",T.accept=".zip",T.style.display="none",T.onchange=async()=>{var k;const ne=(k=T.files)==null?void 0:k[0];try{T.remove()}catch{}if(ne){rt(!0);try{const me=await ne.arrayBuffer(),Ce=Nt(me),Xe=await(await fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:g,fileName:ne.name,fileBase64:Ce})})).json().catch(()=>null);Ke(ne.name),C(2);const et=Xe!=null&&Xe.extractedCount?` (${Xe.extractedCount} fichiers extraits)`:"";alert(`✅ Archive "${ne.name}" importée et extraite avec succès${et} dans le projet : ${g} !
...
L'orchestrateur prend le relais pour générer le Backend et intégrer les composants.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(k=>{console.error(k),alert("Erreur: Le moteur n'a pas pu être contacté.")});return}typeof window<"u"&&(window.open("https://stitch.withgoogle.com/","_blank"),window.dispatchEvent(new CustomEvent("open-mouchard")));const ne=window.KIROV_SELECTED_PACKS&&window.KIROV_SELECTED_PACKS.length>0?window.KIROV_SELECTED_PACKS:G&&G.length>0?G:[];if(Number(x)===0){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:"stitch",start_index:1,zip_mode:!0,start_phase:0,auto_pilot:Q,instructions:nt||"Génère l'application avec ces packs et directives.",packs:ne})}).then(k=>k?k.json():null).then(k=>{var Fe;const me=(k==null?void 0:k.prompt)||((Fe=k==null?void 0:k.data)==null?void 0:Fe.prompt)||"Génération UI/UX Stitch complète.",Ce=ne.length>0?ne.join(", "):"standard";if(C(2),typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase","2"),typeof document<"u"){const Xe=document.getElementById("tiger-mega-prompt-overlay");Xe&&Xe.remove();const et=document.createElement("div");et.id="tiger-mega-prompt-overlay",et.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);backdrop-filter:blur(10px);z-index:999999;display:flex;align-items:center;justify-content:center;padding:16px;font-family:sans-serif;",et.innerHTML=`
                              ...
                              `,document.body.appendChild(et);const ut=document.getElementById("tiger-prompt-area"),je=document.getElementById("btn-copy-prompt"),vt=document.getElementById("btn-close-prompt-overlay"),Qe=document.getElementById("btn-open-stitch"),Lt=()=>{ut&&(ut.select(),ut.setSelectionRange(0,99999),document.execCommand("copy")),navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),C(2),je&&(je.innerHTML="✅ COPIÉ DANS LE PRESSE-PAPIER !",je.style.background="linear-gradient(135deg,#10b981,#059669)",setTimeout(()=>{je&&(je.innerHTML="📋 COPIER LE MÉGA-PROMPT",je.style.background="linear-gradient(135deg,#06b6d4,#2563eb)")},3e3))};je&&(je.onclick=()=>{Lt(),C(2)}),vt&&(vt.onclick=()=>{et.remove(),C(2)}),Qe&&(Qe.onclick=()=>{window.open("https://stitch.withgoogle.com/","_blank"),C(2)}),Lt(),C(2)}}).catch(k=>{console.error(k),alert("Erreur de communication avec le serveur Kirov5.")});return}I("/api/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:"stitch",user_prompt:nt||"Génère l'application avec ces packs et directives.",packs:ne,target_project:v,phase_num:1})}).then(k=>k?k.json():null).then(k=>{var Ce;const me=(k==null?void 0:k.prompt)||((Ce=k==null?void 0:k.data)==null?void 0:Ce.prompt)||"Génération UI/UX Stitch.";typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),alert(`🚀 PHASE 1 (STITCH UI/UX) INITIALISÉE !
...
*Le fichier README complet est disponible dans le dossier prd_packs/${q.packId}/README.md.*`),e.jsxs("div",{className:"design-fenetre-readme w-full rounded-3xl p-6 md:p-8 border-2 border-cyan/60 shadow-[0_0_80px_rgba(124,58,237,0.45)] my-4 relative animate-fadeIn text-white z-20 flex flex-col min-h-[480px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 flex-shrink-0",children:[e.jsxs("span",{className:"px-3.5 py-1.5 bg-cyan/20 text-cyan text-xs font-bold rounded-xl border border-cyan/40 flex items-center gap-2 shadow-sm",children:[e.jsx("span",{children:"💎"})," PACK PRD : ",q.packId]}),e.jsx("button",{onClick:()=>X(null),className:"w-10 h-10 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-xl flex items-center justify-center font-bold text-lg transition-all border border-cyan/40 cursor-pointer shadow-md",title:"Fermer (Retour aux packs)",children:"✕"})]}),e.jsx("h2",{className:"text-2xl md:text-3xl font-black text-cyan mb-2 leading-tight drop-shadow-[0_2px_10px_rgba(6,182,212,0.5)] flex-shrink-0",children:q.packName}),e.jsx("div",{className:"w-full h-px bg-gradient-to-r from-cyan via-purple-400 to-cyan/20 mb-4 flex-shrink-0"}),e.jsx("div",{className:"design-readme-contenu flex-1 text-white font-medium leading-relaxed whitespace-pre-wrap overflow-y-auto max-h-[500px] p-6 rounded-2xl border-2 border-cyan/50 font-mono text-sm shadow-[0_0_40px_rgba(8,179,201,0.3)] min-h-[300px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)",textShadow:"0 1px 2px rgba(0,0,0,0.8)"},children:x}),e.jsxs("div",{className:"mt-6 pt-4 border-t border-white/15 flex justify-between items-center flex-shrink-0",children:[e.jsxs("span",{className:"text-xs text-cyan/90 font-mono font-bold tracking-widest uppercase flex items-center gap-2",children:[e.jsx("span",{children:"⚡"})," SUTURE PRD ENGINE"]}),e.jsx("button",{onClick:()=>X(null),className:"px-6 py-2.5 bg-cyan/20 hover:bg-cyan/40 text-cyan font-bold rounded-xl transition-all border border-cyan/40 flex items-center gap-2 cursor-pointer hover:bg-cyan/30 shadow-md",children:"← Fermer & Retour aux packs"})]})]})}return e.jsxs("div",{id:"prd-packs-carousel-section",className:"w-full flex-1 min-w-0 my-2",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3 px-2",children:[e.jsxs("h4",{className:"design-prd-titre-section font-black uppercase tracking-widest text-cyan flex items-center gap-2",children:[e.jsx("span",{children:"💎"})," PACKS PRD DE CONNAISSANCES (",Gt.length,")"]}),t&&t.length>0&&e.jsxs("span",{className:"text-[11px] font-bold text-cyan bg-cyan/20 px-2.5 py-1 rounded-full border border-cyan/30",children:[t.length," pack(s) actif(s)"]})]}),e.jsx("div",{className:"flex gap-4 items-stretch relative w-full",children:e.jsx("div",{className:"flex-1 min-w-0 min-h-[480px] overflow-hidden py-4 flex items-center",children:h?Q.length===0?e.jsxs("div",{className:"h-full min-h-[220px] rounded-2xl p-6 border border-purple-500/20 bg-purple-950/20 backdrop-blur-md flex flex-col items-center justify-center text-center",children:[e.jsx("p",{className:"text-purple-300 font-bold text-sm",children:"Aucun pack Guest n'a encore été généré."}),e.jsx("p",{className:"text-xs text-zinc-400 mt-2",children:"Utilisez l'interface V0-GUEST pour scanner un projet local et créer un pack sur-mesure."}),e.jsx("button",{onClick:U,className:"mt-4 text-xs text-purple-300 border border-purple-500/40 px-4 py-1.5 rounded-full hover:bg-purple-900/40 transition-colors",children:"🔄 Recharger les packs Guest"})]}):e.jsx(Ft,{items:Q.filter(x=>{var G,y,O,z;if(!_)return!0;const C=_.toLowerCase();return((G=x.name)==null?void 0:G.toLowerCase().includes(C))||((y=x.description)==null?void 0:y.toLowerCase().includes(C))||((O=x.id)==null?void 0:O.toLowerCase().includes(C))||((z=x.category)==null?void 0:z.toLowerCase().includes(C))}).sort((x,C)=>(x.name||"").localeCompare(C.name||"")).map(x=>{const C=x.id,G=t?t.includes(C):!1;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${G?"border-purple-400 shadow-[0_0_25px_rgba(168,85,247,0.4)] bg-purple-950/60":"border-purple-500/20 hover:border-purple-400/60 bg-black/50"}`,children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${G?"bg-purple-500 text-white shadow-md":"bg-purple-500/20 text-purple-400 border border-purple-500/40"}`,children:e.jsx(kn,{size:18})}),e.jsx("span",{className:"px-2 py-0.5 bg-purple-500/20 text-purple-300 text-[10px] font-bold rounded-md uppercase tracking-wider border border-purple-500/30",children:"🐋 GUEST"})]}),n&&e.jsx("button",{onClick:y=>{y.stopPropagation(),n(C)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${G?"bg-purple-500 text-white shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-purple-500/40 hover:text-white"}`,children:G?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight truncate",children:x.name}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed text-zinc-300 text-xs line-clamp-4",children:x.description}),e.jsxs("div",{className:"mt-4 pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsxs("span",{className:"text-[10px] font-mono text-purple-400/80",children:[x.modulesCount," MODULES"]}),e.jsxs("button",{onClick:async()=>{var y;try{const O=await I(`http://localhost:5006/api/bridge/read-file?path=${encodeURIComponent(x.path+"/README.md")}`);let z="";if(O&&O.ok){const A=await O.json();z=((y=A.data)==null?void 0:y.content)||A.content||""}X({packId:C,packName:x.name,readmeText:z||`# PACK GUEST : ${x.name}

Spécifications techniques du pack Guest ${x.name}.

Module réutilisable scanné dans ${x.path}.`})}catch{X({packId:C,packName:x.name,readmeText:`# PACK GUEST : ${x.name}

Spécifications techniques du pack Guest ${x.name}.`})}},className:"design-prd-btn text-purple-400 text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-purple-500/30 transition-all",children:[e.jsx("span",{children:"📖"})," README →"]})]})]},C)})}):e.jsx(Ft,{items:Gt.map(x=>{const C=x.id,G=x.name,y=x.icon||cs,O=t?t.includes(C):!1,D=(S[C]||gn(C)||"Spécifications techniques du contrat PRD.").replace(/^#+.*$/gm,"").replace(/^>.*$/gm,"").replace(/\[([^\]]+)\]\([^\)]+\)/g,"$1").replace(/[*_~`]/g,"").trim().split(`
`).map(Z=>Z.trim()).filter(Z=>Z.length>20),K=D.length>0?D[0]:"Spécifications techniques du contrat PRD.",V=K.length>180?K.substring(0,180)+"...":K;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${O?"border-cyan shadow-[0_0_25px_rgba(8,179,201,0.4)]":"border-white/10 hover:border-cyan/50"}`,style:{background:r?o("prd-card-"+C,.7):"rgba(0,0,0,0.7)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${O?"bg-cyan text-black shadow-md":x.color||"bg-cyan/20 text-cyan"}`,children:e.jsx(y,{size:20})}),e.jsx("span",{className:"px-2 py-0.5 bg-cyan/20 text-cyan text-[10px] font-bold rounded-md uppercase tracking-wider",children:"💎 PRD"})]}),n&&e.jsx("button",{onClick:Z=>{Z.stopPropagation(),n(C)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${O?"bg-cyan text-black shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-white/20 hover:text-white"}`,title:O?"Désélectionner ce pack":"Sélectionner ce pack pour l'IA",children:O?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight",children:G}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed",children:V}),e.jsxs("div",{className:"mt-auto pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-mono text-cyan/80",children:"MODULE PRD"}),e.jsxs("button",{onClick:async()=>{var $;let Z=S[C]||gn(C)||"";try{const ae=await I(`http://localhost:5006/api/bridge/read-file?packId=${encodeURIComponent(C)}`);if(ae&&ae.ok){const ve=await ae.json(),B=ve.content||(($=ve.data)==null?void 0:$.content);B&&B.trim().length>5&&(Z=B,b(ee=>({...ee,[C]:B})))}}catch(ae){console.warn("API Bridge read fallback",ae)}X({packId:C,packName:G,readmeText:Z||`# 💎 PRD PACK : ${G} (${C})

### ⚙️ Spécifications techniques du contrat PRD

- **Identifiant Pack**: ${C}
- **Statut**: Actif & Intégré au Moteur Sovereign`})},className:"design-prd-btn text-cyan text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-cyan/30 transition-all hover:bg-cyan/10",children:[e.jsx("span",{children:"📖"})," Lire le README →"]})]})]},C)})})})})]})},Qn=({isClient:t,getCachedGradient:n,setActiveProject:r})=>{const[o,d]=a.useState([]),[m,h]=a.useState(!0),[u,_]=a.useState(!1),[S,b]=a.useState(null),[q,L]=a.useState({}),Q=async()=>{try{let U=[];const X=await I("http://localhost:5006/api/mobile/list-apks");if(X&&X.ok){const x=await X.json();x&&x.success&&Array.isArray(x.apks)&&(U=x.apks)}else{const x=await fetch("/api/mobile/list-apks");if(x&&x.ok){const C=await x.json();C&&C.success&&Array.isArray(C.apks)&&(U=C.apks)}}if(U.length>0){const x={};U.forEach(C=>{x[C.name.toLowerCase()]=C,x[C.file.toLowerCase()]=C,x[C.name.toLowerCase().replace(/[^a-z0-9]/g,"")]=C}),L(x)}}catch(U){console.warn("[WidgetProjects] fetchApks error",U)}},N=(U=!1)=>{U?_(!0):h(!0);const X=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];I("http://localhost:5006/api/projects").then(x=>x?x.json():null).then(x=>{if(x&&x.success&&x.projects)d(x.projects.map((C,G)=>({name:typeof C=="string"?C:C.projectName||C.name||C.projectId||C.project_id||C.title||`Projet_${G}`,desc:"Environnement Local",bg:X[G%X.length],installed:C.installed}))),h(!1),_(!1);else{const C=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:C?{Authorization:`Bearer ${C}`}:{}}).then(G=>G?G.json():null).then(G=>{G&&G.projects&&d(G.projects.map((y,O)=>({name:y.project_id||y.title||y.name||`Projet_${O}`,desc:"SaaS Cloud (Neon DB)",bg:X[O%X.length]}))),h(!1),_(!1)}).catch(()=>{h(!1),_(!1)})}}).catch(()=>{h(!1),_(!1)})};return a.useEffect(()=>{N(),Q();const U=setInterval(()=>{N(!0),Q()},5e3);return()=>clearInterval(U)},[]),m?e.jsx("div",{className:"p-4 text-cyan text-sm italic",children:"Actualisation de la liste des projets..."}):o.length===0?e.jsxs("div",{className:"p-4 flex flex-col items-center gap-3 text-center",children:[e.jsx("div",{className:"text-cyan text-sm italic",children:"Aucun projet trouvé sur votre disque dur."}),e.jsx("button",{onClick:()=>N(),className:"px-4 py-2 rounded-xl bg-cyan/20 border border-cyan/40 text-cyan text-xs font-bold hover:bg-cyan/40 transition-colors",children:"🔄 Rafraîchir la liste"})]}):e.jsx(Ft,{items:[...o.map((U,X)=>{const x=U.name||"AUDIO",C=async()=>{b(x),r(x);try{window.dispatchEvent(new CustomEvent("open-mouchard")),I("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:x})}).then(async A=>{if(A){const D=await A.json().catch(()=>null);D!=null&&D.previewUrl&&window.open(D.previewUrl,"_blank")}}).catch(()=>{}),await I(`http://localhost:5006/api/projects/${encodeURIComponent(x)}/launch-design`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:x,open_explorer:!1})}).catch(A=>console.error("Erreur de lancement :",A))}catch(A){console.error("Erreur de lancement :",A)}finally{setTimeout(()=>b(null),2e3)}},G=async A=>{if(A.preventDefault(),A.stopPropagation(),window.confirm(`⚠️ SUPPRESSION DEFINITIVE :
Voulez-vous vraiment supprimer le projet "${x}" de l'interface ET de votre disque dur ?`))try{const D=await I("http://localhost:5006/api/projects/remove-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:x})});if(!D){d(V=>V.filter(Z=>Z.name!==x));return}const K=await D.json();K.success?d(V=>V.filter(Z=>Z.name!==x)):alert(`Erreur lors de la suppression : ${K.message||"Échec server"}`)}catch(D){alert(`Erreur réseau lors de la suppression : ${D.message}`)}},y=x.toLowerCase(),O=y.replace(/[^a-z0-9]/g,""),z=q[y]||q[O]||q[`${y}.apk`];return e.jsxs("div",{className:"design-carte-carrousel rounded-2xl p-5 border border-white/20 shadow-xl flex flex-col items-center text-center relative overflow-hidden group cursor-pointer",style:{background:t?n("proj-"+X,.7):"rgba(0,0,0,0.5)"},onClick:C,children:[z&&e.jsxs("a",{href:z.url,download:z.file,onClick:A=>A.stopPropagation(),className:"z-20 absolute top-3 left-3 bg-emerald-600 hover:bg-emerald-500 text-white text-[10px] font-black px-2.5 py-1 rounded-full flex items-center gap-1.5 shadow-lg border border-emerald-400/50 transition-all hover:scale-105 cursor-pointer",title:`Télécharger directement l'APK (${z.sizeMb} Mo)`,children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-white animate-ping"}),e.jsxs("span",{children:["📱 APK PRÊT (",z.sizeMb,"M)"]})]}),e.jsx("button",{onClick:G,className:"z-20 absolute top-3 right-3 w-8 h-8 rounded-full bg-red-600/80 hover:bg-red-500 text-white font-bold text-xs flex items-center justify-center transition-all shadow-lg hover:scale-110 cursor-pointer",title:"Supprimer ce projet du disque dur et de l'interface",children:"🗑️"}),e.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-30 mix-blend-overlay pointer-events-none"}),e.jsx("div",{className:"absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors z-0"}),e.jsxs("div",{className:"z-10 relative pointer-events-none w-full pr-8",children:[e.jsx("div",{className:"text-white/70 text-xs font-bold uppercase tracking-widest drop-shadow-md",children:"PROJET"}),e.jsx("h3",{className:"design-carte-titre text-xl font-black text-white break-all drop-shadow-lg leading-tight w-full",children:x})]}),e.jsx("div",{className:"design-carte-desc z-10 relative text-sm text-white/90 font-medium drop-shadow-md pointer-events-none w-full",children:U.desc}),e.jsxs("div",{className:"z-10 flex flex-wrap items-center justify-center gap-2 mt-3",children:[e.jsx("button",{onClick:A=>{A.stopPropagation(),S!==x&&(U.installed===!1?(b(x),I("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:x})}).then(D=>{alert(D?`📦 Installation des dépendances démarrée pour "${x}" !
Suivez la progression dans les logs.`:"Mode Cloud SaaS : Bridge local non connecté."),b(null),d(K=>K.map(V=>V.name===U.name?{...V,installed:!0}:V))}).catch(()=>b(null))):C())},disabled:S===x,className:`font-bold py-2 px-4 rounded-xl text-xs transition-all flex items-center gap-1.5 ${S===x?"bg-cyan-500/40 text-cyan-200 cursor-wait animate-pulse":U.installed===!1?"bg-orange-500/80 hover:bg-orange-600 text-white cursor-pointer":"bg-white/20 hover:bg-white/40 text-white cursor-pointer"}`,title:U.installed===!1?"Installer les dépendances requises pour ce projet":"Lancer la prévisualisation Vite",children:S===x?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin inline-block",children:"⏳"})," ",U.installed===!1?"Installation...":"Lancement..."]}):U.installed===!1?e.jsx(e.Fragment,{children:"📦 INSTALL"}):e.jsx(e.Fragment,{children:"🚀 PREVIEW"})}),z&&e.jsxs("a",{href:z.url,download:z.file,onClick:A=>A.stopPropagation(),className:"bg-gradient-to-r from-emerald-600 to-green-500 hover:from-emerald-500 hover:to-green-400 text-white font-extrabold py-2 px-3.5 rounded-xl text-xs transition-all flex items-center gap-1.5 shadow-lg shadow-emerald-950/60 border border-emerald-400/50 cursor-pointer animate-pulse hover:scale-105",title:`Télécharger l'APK Android compilé de ${x} (${z.sizeMb} Mo)`,children:[e.jsx("span",{children:"📥"}),e.jsx("span",{children:"APK"}),e.jsxs("span",{className:"text-[10px] opacity-90 font-mono",children:["(",z.sizeMb,"M)"]})]}),U.installed!==!1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:A=>{A.stopPropagation(),b(x),I("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:x})}).then(D=>{alert(D?`🔄 Réinstallation des dépendances démarrée pour "${x}" !`:"Mode Cloud SaaS : Bridge local non connecté."),b(null)}).catch(()=>b(null))},className:"bg-orange-500/30 hover:bg-orange-500/60 text-white font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center justify-center border border-orange-500/40 cursor-pointer",title:"Forcer la réinstallation des dépendances (pnpm install)",children:"🔄"}),e.jsx("button",{onClick:async A=>{A.stopPropagation();try{b(x);const D=await I("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:x})});if(b(null),!D){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const K=await D.json();alert(K.message||`🚀 Serveur Vite démarré pour ${x} !`),K.previewUrl&&window.open(K.previewUrl,"_blank")}catch(D){b(null),alert("Erreur de connexion au bridge: "+D.message)}},className:"font-bold py-2 px-3 rounded-xl text-xs bg-purple-500/60 hover:bg-purple-500 text-white transition-all shadow-md cursor-pointer",title:"Lancer le serveur Vite avec pnpm run dev",children:"💻 PNPM"})]}),e.jsx("button",{onClick:G,className:"bg-red-600/30 hover:bg-red-600/60 text-red-200 border border-red-500/40 font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center gap-1",title:"Supprimer définitivement du disque dur",children:"🗑️ Supprimer"})]})]},X)})]})};function Vo({user:t,onLogout:n}={}){var qn;const r=a.useRef({}),o=(s,c=1)=>typeof window>"u"?`linear-gradient(135deg, rgba(17,17,17,${c}), rgba(34,34,34,${c}))`:(r.current[s]||(r.current[s]=Oo(c)),r.current[s]),d=(t==null?void 0:t.email)||(typeof window<"u"?localStorage.getItem("tiger_currentUserEmail"):null),m=!!(t!=null&&t.isSuperAdmin||d&&d.toLowerCase().trim()==="zacktunr@gmail.com");a.useEffect(()=>{t!=null&&t.email&&typeof window<"u"&&localStorage.setItem("tiger_currentUserEmail",t.email)},[t]);const h=()=>{typeof window<"u"&&(localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),localStorage.removeItem("tiger_lastGeneratedProject"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{})),n?n():typeof window<"u"&&window.location.reload()},[u,_]=a.useState([]),[S,b]=a.useState(""),q=a.useRef(null),L=a.useRef(null),[Q,N]=a.useState(!1),[U,X]=a.useState("connexion"),[x,C]=a.useState(!1),[G,y]=a.useState("clean");a.useRef(0);const[O,z]=a.useState(1),[A,D]=a.useState(!1),[K,V]=a.useState(!1),[Z,$]=a.useState(!1);a.useEffect(()=>{let s=0;const c=setInterval(()=>{var l,w;if(typeof window<"u"){const p=(w=(l=window.Capacitor)==null?void 0:l.isNativePlatform)==null?void 0:w.call(l),f=!!window.AndroidBridge;(p||f)&&(V(!0),clearInterval(c))}s++>10&&clearInterval(c)},100);return()=>clearInterval(c)},[]);const[ae,ve]=a.useState([]),[B,ee]=a.useState(""),[de,xe]=a.useState(["> Système Kirov5 initialisé. "+new Date().toLocaleTimeString()]),[Ie,te]=a.useState([]),[j,J]=a.useState([]);a.useEffect(()=>{const s=c=>J(c.detail);return window.addEventListener("update_kirov_packs",s),()=>window.removeEventListener("update_kirov_packs",s)},[]),a.useEffect(()=>{window.KIROV_SELECTED_PACKS=j},[j]);const[re,ue]=a.useState(!1),[fe,Te]=a.useState(!1),[ke,M]=a.useState([]),[ge,Ae]=a.useState(!1),[he,se]=a.useState(""),[Me,nt]=a.useState(""),[Ee,Re]=a.useState(!1),[oe,pt]=a.useState(""),[ze,Dn]=a.useState("Vite + React + Tailwind + TS"),[mt,bn]=a.useState(""),[yt,Et]=a.useState("deepseek"),[He,sn]=a.useState(""),[rn,Mn]=a.useState(!0),[an,on]=a.useState(!1),[gt,_t]=a.useState(null),[Ze,Ct]=a.useState(!1),[st,$e]=a.useState("idle"),[Rt,Oe]=a.useState([]),[rt,zt]=a.useState(""),[vn,ht]=a.useState(null),[Nt,Ht]=a.useState([]),wt=a.useCallback(async()=>{try{const s=await I("http://localhost:5006/api/mobile/list-apks");if(s&&s.ok){const l=await s.json();if(l&&l.success&&Array.isArray(l.apks)){Ht(l.apks);return}}const c=await fetch("/api/mobile/list-apks");if(c&&c.ok){const l=await c.json();l&&l.success&&Array.isArray(l.apks)&&Ht(l.apks)}}catch(s){console.warn("[v0-apk] loadAvailableApks error",s)}},[]);a.useEffect(()=>{Ze&&wt()},[Ze,wt]),a.useEffect(()=>{let s,c=0;return st==="building"&&(s=setInterval(async()=>{try{const l=await I("http://localhost:5006/api/mobile/build-logs");if(l&&l.ok){c=0;const w=await l.json();w.logs&&w.logs.length>0&&Oe(w.logs),w.isBuilding===!1&&w.result&&(w.result.success?($e("success"),ht(w.result.apkUrl)):$e("error"),clearInterval(s))}else c++,c>=3&&(clearInterval(s),$e("error"),Oe(w=>[...w,`❌ Service de compilation mobile absent sur ce serveur (${l?l.status:"erreur réseau"}).`,"📱 Option 1 (Cloud) : Déclenchez le build sans dépendance via GitHub Actions (.github/workflows/build-apk.yml).",`💻 Option 2 (Local) : Lancez 'python apk_builder.py --src ... --name ${rt||E||"app"} --build' dans E:\\v0reponses\\v0-apk.`]))}catch(l){console.warn("Polling APK error",l)}},1500)),()=>{s&&clearInterval(s)}},[st,rt,E]);const[be,xt]=a.useState([]),[ln,Dt]=a.useState(!1),cn=a.useCallback(async s=>{Dt(!0);const c=[{id:"deepseek-r1-v0",tag:"⚡ DEEPSEEK R1",title:"DeepSeek-R1 & Moteur Souverain v0.1",desc:"Capacités de raisonnement avancé et de suture pour interfaces React.",content:`DeepSeek-R1 offre des capacités de raisonnement avancé pour l'analyse de contrats PRD et la génération zéro-touch de projets web complets.
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){xt(c),Dt(!1);return}const l=s||localStorage.getItem("tiger_apiKey");if(!l||!l.startsWith("sk-")||l.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){xt(c),Dt(!1);return}const w=new AbortController,p=setTimeout(()=>w.abort(),4e3),f=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${l}`},signal:w.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(p),f.ok){const P=await f.json(),R=JSON.parse(P.choices[0].message.content);R.news&&Array.isArray(R.news)&&R.news.length>0?xt(R.news):xt(c)}else f.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),xt(c)}catch(l){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",l),xt(c)}finally{Dt(!1)}},[]);a.useEffect(()=>{cn()},[cn]);const[It,qe]=a.useState(!1),[Ne,_e]=a.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Ke,ct]=a.useState([]),[Ge,$t]=a.useState("");a.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let c=JSON.parse(s);if(!Array.isArray(c))throw new Error("Not an array");const l="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";c=c.map(w=>w.name==="fold"?{...w,colors:{...w.colors,"bg-app":l}}:w),ct(c)}catch{ct([])}else{const c={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};ct([c]),localStorage.setItem("tiger_saved_themes",JSON.stringify([c]))}},[]),a.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",Ne),Ne!=="random"){const c=((s=Ke.find(l=>l.name===Ne))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=c,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[Ne,Ke]);const Sn=()=>{if(!Ge.trim())return alert("Nom invalide");if(Ke.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":o("icon-settings",.8),"icon-ai":o("icon-ai",.8),"icon-projects":o("icon-projects",.8),"icon-packs":o("icon-packs",.8),"icon-news":o("icon-news",.8),"bg-app":o("bg-app",.9)},c={name:Ge.trim(),colors:s},l=[...Ke,c];ct(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),_e(c.name),$t("")},dn=(s,c)=>{c.stopPropagation();const l=Ke.filter(w=>w.name!==s);ct(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),Ne===s&&_e("random")},Kt=s=>{J(c=>c.includes(s)?c.filter(l=>l!==s):[...c,s])},[We,Wt]=a.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});a.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(We))},[We]);const[dt,ft]=a.useState(!0),[Ye,At]=a.useState(!0),[E,Pe]=a.useState(null),[Mt,Jt]=a.useState(null),[De,Xt]=a.useState(null),[pe,Je]=a.useState(null),[qt,it]=a.useState(""),[bt,Pt]=a.useState([]);a.useEffect(()=>{I("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))te(s.projects.map(c=>({name:typeof c=="string"?c:c.project_id||c.title||c.name||"Projet",desc:"Projet local",bg:""})));else{const c=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:c?{Authorization:`Bearer ${c}`}:{}}).then(l=>l?l.json():null).then(l=>{l&&l.projects&&te(l.projects.map(w=>({name:typeof w=="string"?w:w.project_id||w.title||w.name||"Projet",desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[at,Se]=a.useState(null),[Qt,jt]=a.useState(""),[kt,i]=a.useState(!1),[g,v]=a.useState(!1),T=a.useRef(null);a.useEffect(()=>{if(T.current=null,E==="v0-guest"||E==="V0-Guest")v(!0),Se("http://localhost:3007"),jt("http://localhost:3007"),T.current="http://localhost:3007";else if(E){v(!0);const s=De&&JSON.stringify(De).includes("next.config"),c=typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1",l=s?"http://localhost:3000":T.current||(c?`http://${window.location.hostname}:5173`:"http://localhost:5173");Se(l),jt(l),T.current=l}else v(!1),Se(null)},[E,De]),a.useEffect(()=>{const s=c=>{var l,w,p,f;if(((l=c.data)==null?void 0:l.type)==="CHANGE_PREVIEW_URL"){const P=c.data.route,R=P==="/"?"":`#${P}`;Se(Y=>{const H=Y?Y.split("#")[0]:"http://127.0.0.1:5175/";return`${H.endsWith("/")?H:`${H}/`}${R}`})}if(((w=c.data)==null?void 0:w.type)==="DESIGN_ELEMENT_CLICKED"||((p=c.data)==null?void 0:p.type)==="DESIGN_ELEMENT_DRAGGED"||((f=c.data)==null?void 0:f.type)==="DESIGN_ELEMENT_RESIZED"){const P=document.querySelector('iframe[title="Studio Admin Design"]');P&&P.contentWindow&&P.contentWindow.postMessage(c.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),a.useEffect(()=>{E&&I(`http://localhost:5006/api/fs/tree?project=${E}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&Xt(s.tree)}).catch(()=>{})},[E]),a.useEffect(()=>{E&&pe&&I(`http://localhost:5006/api/fs/read?project=${E}&file=${encodeURIComponent(pe)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&it(s.content)}).catch(()=>{})},[E,pe]);const ne=async s=>{if(s===void 0||!E||!pe)return;if(it(s),Bt.isNativePlatform()||!!window.AndroidBridge)try{await $n.writeFile({path:`v0-moteur-mobile/projetv0/${E}/${pe}`,data:s,directory:xn.Documents,encoding:Pn.UTF8,recursive:!0})}catch(l){console.error("Erreur de sauvegarde mobile:",l)}else I("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:E,file:pe,content:s})}).catch(()=>{})},k=s=>{E&&I(`http://localhost:5006/api/fs/read?project=${E}&file=${encodeURIComponent(s)}`).then(c=>c?c.json():null).then(c=>{c&&c.success&&Pt(l=>l.find(w=>w.path===s)?l:[...l,{path:s,content:c.content}])}).catch(()=>{})};a.useEffect(()=>{(async()=>{const c=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(Bt.isNativePlatform()||!!window.AndroidBridge)try{const p=(await $n.readdir({path:"v0-moteur-mobile/projetv0",directory:xn.Documents})).files.map(f=>f.name||f.toString());te(p.map((f,P)=>({name:f,desc:"Mémoire Téléphone",bg:c[P%c.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else I("http://localhost:5006/api/projects-v2").then(w=>w?w.json():null).then(w=>{if(w&&w.success&&w.projects)te(w.projects.map((p,f)=>({name:typeof p=="string"?p:p.name||p.project_id||p.title||`Projet_${f}`,desc:"Environnement Local",bg:c[f%c.length],installed:p.installed})));else{const p=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:p?{Authorization:`Bearer ${p}`}:{}}).then(f=>f?f.json():null).then(f=>{f&&f.projects&&te(f.projects.map((P,R)=>({name:typeof P=="string"?P:P.project_id||P.title||P.name||`Projet_${R}`,desc:"SaaS Cloud (Neon DB)",bg:c[R%c.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),a.useEffect(()=>{D(!0)},[]);const[me,Ce]=a.useState(!0);a.useEffect(()=>{const s=()=>Ce(!0);window.addEventListener("open-mouchard",s);const c=l=>{if(l.data&&l.data.type==="TIGER_CAPTURE"){const w=l.data.data;if(w){let p="index.html";(w.includes("import React")||w.includes("export default"))&&(p="App.tsx"),w.includes("tailwindcss")&&(p="index.css"),Je(p),ne(w),Xt(f=>{var Y;const P={name:p,path:p,type:"file"};return f?((Y=f.children)==null?void 0:Y.find(H=>H.name===p))?f:{...f,children:[...f.children||[],P]}:{name:"Mobile_Storage",type:"directory",children:[P]}})}}};return window.addEventListener("message",c),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("message",c)}},[E,pe]),a.useEffect(()=>{if(!A)return;const s=()=>{I("http://localhost:5006/api/bridge/queue").then(l=>l?l.json():null).then(l=>{l&&l.success&&(setBridgeQueueData({current:l.current||{},queue:l.queue||[]}),(l.queue&&l.queue.length>0||l.current&&Object.keys(l.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),I("http://localhost:5006/api/bridge/logs").then(l=>l?l.json():null).then(l=>{var w,p;if(l&&l.success&&l.logs){xe(l.logs);const f=[...l.logs].reverse().find(R=>R.includes("URL_PREVIEW="));if(f){let R=(w=f.split("URL_PREVIEW=")[1])==null?void 0:w.trim();R&&typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"&&(R=R.replace(/localhost|127\.0\.0\.1/,window.location.hostname)),R&&R!==T.current&&(T.current=R,Se(R),jt(R),v(!0))}const P=[...l.logs].reverse().find(R=>R.includes("PIPELINE COMPLET TERMINÉ avec succès pour "));if(P){const R=(p=P.split("PIPELINE COMPLET TERMINÉ avec succès pour ")[1])==null?void 0:p.replace(/[.\s]+$/,"");R&&E!==R&&(Pe(R),v(!0))}}}).catch(()=>{}),I("http://localhost:5006/api/bridge/autonomous-status").then(l=>l?l.json():null).then(l=>{if(l&&l.success&&(l.data||l.status)){const p=(l.data||l.status).state;p==="diagnosing"||p==="repair_required"||p==="error"?y("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(p)||["starting_server","launch_requested","restarting"].includes(p)?y("working"):p==="ready"?y("clean"):E&&I(`http://localhost:5006/api/suture/status?project=${E}`).then(f=>f?f.json():null).then(f=>{f&&f.success&&f.status&&y(f.status)}).catch(()=>{})}}).catch(()=>{})};s();const c=setInterval(s,2e3);return()=>clearInterval(c)},[A,E]);const Fe=s=>{const c=typeof s=="string"?s:S;if(!c.trim())return;const l={id:Date.now().toString(),role:"user",content:c};_(p=>[...p,l]);const w=c.toLowerCase();setTimeout(()=>{let p={id:(Date.now()+1).toString(),role:"assistant",content:""};const f=w.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(f==="mes projets"||f.includes("liste des projet")||f==="projet"||f==="projets")p.content="Voici la liste de vos projets récents :",p.widget="projects";else if((f.includes("stitch")||f.includes("deepseek")||f.includes("design")||f.includes("logique"))&&(f.includes("modifi")||f.includes("ajoute")||f.includes("change")||f.includes("mise a jour")||f.includes("evolue")||f.includes("reprends")||f.includes("continue"))){const P=c.match(/\[(.*?)\]/),R=P?P[1]:null,Y=f.includes("deepseek")?"deepseek":"stitch";p.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${Y.toUpperCase()}) 🔄

J'injecte vos nouvelles directives directement dans votre interface... ${R?`
🔍 Recherche et AutoSwitch vers le projet : "${R}"`:"Reprise du travail en cours."}`,p.widget=null,I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Y,target_project:R,prompt:"Mise à jour (Reprise de projet) : "+c.replace(/\[.*?\]/,"").trim(),auto_submit:!0})}).catch(H=>console.log("Erreur de connexion au Bridge local pour l'injection",H))}else if(f.includes("cree")||f.includes("lance")||f.includes("projet")||f.includes("generation")){p.content=`🚀 DÉMARRAGE PARALLÈLE KIROV5 🚀
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,p.widget="phases",z(1);const P=E||(oe.trim()?oe.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+c.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(Pe(P),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",P),typeof window<"u"){const H=localStorage.getItem("tiger_targetAi")||"deepseek",W=localStorage.getItem("tiger_targetUiAi")||"stitch",Le=(F,ce=!1)=>lt(F,ce),Ve=window.AndroidBridge;if(Ve&&Ve.openAIWithPrompt)Ve.openAIWithPrompt(Le(W,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+c),Ve.showToast&&Ve.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const F=j&&j.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${j.length})]
`+j.map(we=>{const ie=Gt.find(ye=>ye.id===we);return`• ${ie?ie.name:we} (#${we})`}).join(`
`):"",ce="Génère l'interface UI/UX complète et moderne pour ce projet : "+c+F;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ce)}catch{}const tt=()=>I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:W,prompt:ce,auto_submit:!0,project_id:P,phase_num:1,packs:j})});We!==200&&(Ye?window.open(Le(W,!0),"kirov5_ai_target"):window.open(Le(W,!0),"_blank"),tt().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(we=>console.error("Erreur sendUiPrompt",we))),setTimeout(()=>{const we=j&&j.length>0?c+F:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+c+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(we)}catch{}window.open(Le(H),"_blank"),I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:H,prompt:we,auto_submit:!0,project_id:P,phase_num:1,packs:j})}).catch(ie=>console.log("Erreur Bridge Logic Prompt:",ie)),j&&j.length>0?I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:H,user_prompt:we,packs:j,target_project:P})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(ie=>{console.log("Erreur Trombone Bridge:",ie)}):I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:H,prompt:we,auto_submit:!0,project_id:P,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}z(1);let R=1;const Y=setInterval(()=>{R++,R>11?clearInterval(Y):z(R)},1500)}else if(f.includes("youtube")||f.includes("video"))p.content="Voici les résultats YouTube pour votre recherche :",p.widget="youtube";else if(f.includes("actualite")||f.includes("ia")||f.includes("news")||f.includes("recherche")){const P=localStorage.getItem("tiger_apiKey");p.content="Actualités & Dernières Innovations IA :",p.widget="news",cn(P||void 0)}else if(f.includes("parametre")||f.includes("reglage")||f.includes("configuration")||f.includes("setting"))p.content="Ouverture du panneau de configuration système :",p.widget="settings";else if(f.includes("[plugin:vite:")||f.includes("missing semicolon")||f.includes("syntaxerror")||f.includes("typescriptparsermixin")||f.includes("babel/parser")||f.includes("error")&&f.length>80){const P=E||"Projet_blog_8831";p.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${P}" avec la stack trace fournie... 🩺`,je("suture",c)}else if(p.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const P=window.AndroidBridge;P&&P.openAIWithPrompt?P.openAIWithPrompt("https://chat.deepseek.com/",c):window.open("https://chat.deepseek.com/","_blank")}_(P=>[...P,p])},600),b("")},Xe=async s=>{var Ve;let c=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],l=null;const w=c.filter(F=>F.name.endsWith(".zip"));let p=[];if(w.length>0){_(F=>[...F,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const F=(await en(async()=>{const{default:ce}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:ce}},[])).default;for(const ce of w){l=ce;const we=await new F().loadAsync(ce);for(const[ie,ye]of Object.entries(we.files))if(!ye.dir&&!ie.includes("__MACOSX")&&!((Ve=ie.split("/").pop())!=null&&Ve.startsWith("."))){const Ue=await ye.async("blob"),ot=new File([Ue],ie.split("/").pop()||ie,{type:Ue.type});p.push(ot)}}}catch(F){console.error("Erreur décompression ZIP:",F),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}for(const F of w)try{const ce=await F.arrayBuffer(),tt=arrayBufferToBase64(ce);fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:E||B||oe||"AUDIO",fileName:F.name,fileBase64:tt})}).catch(ie=>console.warn("[Upload ZIP Sync] Notice:",ie))}catch{}}c=[...c.filter(F=>!F.name.endsWith(".zip")),...p];const f=c.filter(F=>F.name.endsWith(".html")),P=c.filter(F=>!F.name.endsWith(".html")&&(F.name.endsWith(".png")||F.name.endsWith(".jpg")||F.name.endsWith(".jpeg")||F.name.endsWith(".md")||F.name.endsWith(".json")||F.name.endsWith(".txt")||F.name.endsWith(".tsx")||F.name.endsWith(".ts")||F.name.endsWith(".jsx")||F.name.endsWith(".js")||F.name.endsWith(".css")||F.name.endsWith(".svg")));if(f.length===0&&P.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .tsx, .ts, .png, ou un .zip.");return}let R=[...bt];for(const F of P){const ce=F.name.endsWith(".png")||F.name.endsWith(".jpg")||F.name.endsWith(".jpeg"),tt=await new Promise(ie=>{const ye=new FileReader;ye.onload=Ue=>{var ot;return ie((ot=Ue.target)==null?void 0:ot.result)},ce?ye.readAsDataURL(F):ye.readAsText(F)}),we={path:F.name,content:ce?`[Image jointe visuellement : ${F.name} (Binaire ignoré pour économie de tokens)]`:tt};R.some(ie=>ie.path===F.name)||R.push(we),_(ie=>[...ie,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${F.name}`}])}if(f.length>0){const F=f[0],ce=await new Promise(ie=>{const ye=new FileReader;ye.onload=Ue=>{var ot;return ie((ot=Ue.target)==null?void 0:ot.result)},ye.readAsText(F)}),tt={path:F.name,content:ce};R.some(ie=>ie.path===F.name)||R.push(tt);const we={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${F.name}
Analyse de la structure UI et assemblage du contexte en cours...`};_(ie=>[...ie,we])}const Y=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter(F=>F.name.endsWith(".zip"));for(const F of Y)R.some(ce=>ce.path===F.name)||R.push({path:F.name,content:"ZIP_ARCHIVE_DUMMY"});Pt(R);const H=E||oe||"Projet_Stitch",W=c.map(F=>F.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${H}: ${W}`);const Le=f.length;if(Le>3){const F=localStorage.getItem("tiger_targetAi")||"deepseek",ce=l?"Projet_ZIP_"+l.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),tt=E||ce;E||Pe(tt),_(ie=>[...ie,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !

Hermes a détecté ${Le} pages HTML dans votre ZIP.
Découpage automatique en lots de 3 fichiers en cours...
Démarrage de l'automatisation séquentielle via DeepSeek !`,widget:"phases"}]),z(1);let we="";if(l)we=await new Promise(ie=>{const ye=new FileReader;ye.onload=Ue=>{var ot;return ie(((ot=Ue.target)==null?void 0:ot.result).split(",")[1])},ye.readAsDataURL(l)});else{const ie=(await en(async()=>{const{default:Ue}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:Ue}},[])).default,ye=new ie;for(const Ue of c)ye.file(Ue.name,Ue);we=await ye.generateAsync({type:"base64"})}I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({zip_base64:we,zip_mode:!0,target_ai:F,target_project:tt,user_prompt:oe.trim()?`${oe} - ${mt}`:`Application multi-pages issue de ${(l==null?void 0:l.name)||"fichiers_locaux"}`})}).then(async ie=>{const ye=await ie.json();ye.success?(_(Ue=>[...Ue,{id:Date.now().toString()+"_hermes",role:"assistant",content:`✅ ${ye.message}

📡 Lot 1/${ye.total_batches} transmis à DeepSeek. Les lots suivants s'enchaîneront automatiquement !
Fichiers détectés : ${(ye.files_detected||[]).join(", ")}`}]),window.open(lt(F),"_blank")):alert("Erreur Hermes : "+(ye.error||"Inconnue"))}).catch(ie=>{alert(`Erreur de connexion au Moteur Local : ${ie.message}`)});return}if(f.length>0){if(document.getElementById("creation-mode-container"))return;setTimeout(()=>{et(R)},1200)}},et=async(s=bt)=>{Re(!1);const c=s.find(H=>H.path.endsWith(".html"));if(!c){alert("Aucun fichier HTML trouvé dans le Trombone !");return}const l=oe.trim()?"Projet_"+oe.replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4):"Design_"+c.path.replace(".html","").replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4),w=E||l;if(!E){Pe(w);try{await I("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:w,file:"README.md",content:`# ${oe||w}

Initialisé par Tiger IA V0 (Design-First).`})})}catch(H){console.error("[IDE] Erreur création auto du dossier",H)}}const p=s.filter(H=>H.path!==c.path),f=c.content,P={id:(Date.now()+1).toString(),role:"assistant",content:`Mode "Design-First" activé. 🎨

Transmission du design au LLM avec les ${p.length} fichiers du Trombone intégrés.
Câblage en cours...`,widget:"phases"};z(5),_(H=>[...H,P]);let R=5;const Y=setInterval(()=>{R++,R>11?clearInterval(Y):z(R)},3e3);if(typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Mode Design-First Activé !"),typeof window<"u"){const H=localStorage.getItem("tiger_targetAi")||"deepseek";let W="";p.length>0&&(W=`
...
\`\`\`
`,F=window.AndroidBridge;if(F&&F.openAIWithPrompt){const ce=lt(H);F.openAIWithPrompt(ce,Ve),F.showToast&&F.showToast("HTML injecté. Câblage sur "+H.toUpperCase()+" !")}else I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:H,prompt:Ve,auto_submit:!0,project_id:w,phase_num:5})}).then(ce=>console.log("[Bridge] Prompt HTML + Contexte envoyé avec succès, status:",ce.status)).catch(ce=>console.error("[Bridge] Erreur lors de l'envoi du prompt:",ce))}},ut=(s,c=0)=>s?s.type==="directory"?e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-2 px-2 py-1 hover:bg-white/5 cursor-pointer text-gray-300 text-sm",style:{paddingLeft:`${c*12+8}px`},children:[e.jsx("span",{className:"text-orange-400",children:"📁"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-dossier truncate font-bold",children:s.name})]}),s.children&&s.children.map(l=>ut(l,c+1))]},s.path):e.jsxs("div",{className:`flex items-center justify-between px-2 py-1 hover:bg-white/10 cursor-pointer text-sm group ${pe===s.path?"bg-cyan/20 text-cyan border-l-2 border-cyan":"text-gray-400"}`,style:{paddingLeft:`${c*12+8}px`},onClick:()=>Je(s.path),children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-blue-400",children:"📄"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-fichier truncate",children:s.name})]}),e.jsxs("div",{className:"hidden group-hover:flex items-center gap-1",children:[e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-red-500/50 transition-colors",title:"Suture : Réparer ou débugger ce fichier",onClick:l=>{l.stopPropagation(),Je(s.path),setTimeout(()=>je("suture","Veuillez analyser ce fichier et corriger toutes les erreurs, fautes de frappe ou imports manquants."),100)},children:"🩺"}),e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-cyan/50 transition-colors",title:"Ajouter au Trombone",onClick:l=>{l.stopPropagation(),k(s.path)},children:"📎"})]})]},s.path):null,je=async(s,c)=>{if(!E){alert("⚠️ Veuillez sélectionner un projet actif dans l'explorateur.");return}const l=localStorage.getItem("tiger_targetAi")||"deepseek";let w="";s==="suture"?w=`🩺 SUTURE CHIRURGICALE — CORRECTION D'ERREUR DÉTECTÉE
...
`):s==="refactor"?w=`🔄 REFACTORING — Refactorise le code du projet [${E}] pour une qualité industrielle.

`:s==="improve"&&(w=`✨ AMÉLIORATION — Ajoute des animations et améliorations UI pour le projet [${E}].

`),pe&&qt&&(w+=`--- Fichier Actif en Édition : ${pe} ---
\`\`\`
${qt}
\`\`\`

`),bt.length>0&&(w+=`--- Fichiers de contexte du Trombone ---

`,bt.forEach(p=>{w+=`--- ${p.path} ---
\`\`\`
${p.content}
\`\`\`
...
\`\`\``,_(p=>[...p,{id:Date.now().toString()+"_action",role:"assistant",content:`🩺 Suture & Correction déclenchée pour "${E}". Transmission de l'erreur à ${l.toUpperCase()} en cours...`}]);try{if(await I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:l,prompt:w,auto_submit:!0,project_id:E,phase_num:s})}),s==="suture"){I("http://localhost:5006/v1/suture/start",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:E,activeFile:pe||"",rawError:c||"",prompt:c||"Analyse et corrige les erreurs du projet."})}).then(async f=>{const P=await f.json();P.success&&P.status==="applied"?_(R=>{var Y,H;return[...R,{id:Date.now().toString()+"_suture_ok",role:"assistant",content:`✅ Suture V2 réussie !

🔧 ${P.repairId}
🚀 Statut : **Patch appliqué en production**
📁 Fichiers corrigés : ${JSON.stringify(((H=(Y=P.patchReport)==null?void 0:Y.files)==null?void 0:H.map(W=>W.path))||[])}`}]}):P.success?_(R=>{var Y;return[...R,{id:Date.now().toString()+"_suture_partial",role:"assistant",content:`⚠️ Suture V2 : correctif généré mais non promu.
...
[PACKS PRD ARCHITECTURE SELECTIONNES (${j.length})]
`+j.map(W=>{const Le=Gt.find(Ve=>Ve.id===W);return`• ${Le?Le.name:W} (#${W})`}).join(`
`):"";let R=`
...
Tout le travail actuel non sauvegardé sera perdu.`)&&I("http://localhost:5006/api/bridge/restore-backup",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:E,backup_name:s})}).then(c=>c?c.json():null).then(c=>{if(!c)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");c.success?(alert("✅ "+c.message),Te(!1)):alert("❌ Erreur Restauration : "+c.error)}).catch(c=>alert("Erreur réseau: "+c.message))},className:"px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold rounded-lg transition-all",children:"Restaurer"})]},s)),ke.length===0&&e.jsx("div",{className:"text-center p-4 text-slate-500 italic",children:"Aucune sauvegarde disponible."})]})]})}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
      ...
      `}})]})}function Bo({onAuthenticated:t}){const[n,r]=a.useState("login"),[o,d]=a.useState(""),[m,h]=a.useState(""),[u,_]=a.useState(""),[S,b]=a.useState(!1),[q,L]=a.useState(""),Q=async N=>{if(N.preventDefault(),L(""),n==="register"&&m!==u){L("Les mots de passe ne correspondent pas.");return}if(m.length<8){L("Le mot de passe doit contenir au moins 8 caractères.");return}b(!0);try{const X=await fetch(n==="login"?"/api/auth/login":"/api/auth/register",{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({email:o,password:m})}),x=await X.json();if(!X.ok){const C={INVALID_CREDENTIALS:"Email ou mot de passe incorrect.",TOO_MANY_ATTEMPTS:"Trop de tentatives. Réessayez dans 15 minutes.",REGISTRATION_FAILED:"Cet email est déjà utilisé.",PASSWORD_TOO_SHORT:"Mot de passe trop court (8 caractères minimum)."};L(x.error?C[x.error]??x.error:"Une erreur est survenue.");return}x.token&&localStorage.setItem("kirov5_jwt_token",x.token),t({userId:String(x.userId),email:o,isSuperAdmin:!!x.isSuperAdmin})}catch{window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?(console.warn("Mode local sans Wrangler: Bypass de la connexion pour accès UI."),localStorage.setItem("kirov5_jwt_token","dev-mock-token"),t({userId:"dev-user-001",email:o||"dev@local"})):L("Impossible de contacter le serveur. Vérifiez votre connexion.")}finally{b(!1)}};return e.jsxs("div",{style:{minHeight:"100vh",background:"linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Inter', 'Segoe UI', sans-serif",padding:"20px"},children:[e.jsx("div",{style:{position:"fixed",inset:0,overflow:"hidden",pointerEvents:"none",zIndex:0},children:[...Array(6)].map((N,U)=>e.jsx("div",{style:{position:"absolute",borderRadius:"50%",background:`rgba(${U%2===0?"139,92,246":"59,130,246"},0.08)`,width:`${200+U*80}px`,height:`${200+U*80}px`,top:`${10+U*15}%`,left:`${5+U*16}%`,filter:"blur(60px)",animation:`float ${6+U}s ease-in-out infinite alternate`}},U))}),e.jsxs("div",{style:{position:"relative",zIndex:1,width:"100%",maxWidth:"420px"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"40px"},children:[e.jsx("div",{style:{display:"inline-flex",alignItems:"center",justifyContent:"center",width:"72px",height:"72px",borderRadius:"20px",background:"linear-gradient(135deg, #8b5cf6, #3b82f6)",marginBottom:"20px",boxShadow:"0 0 40px rgba(139,92,246,0.4)",fontSize:"32px"},children:"⚡"}),e.jsx("h1",{style:{margin:0,fontSize:"28px",fontWeight:800,background:"linear-gradient(135deg, #a78bfa, #60a5fa)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",letterSpacing:"-0.5px"},children:"Kirov5 Sovereign Forge"}),e.jsx("p",{style:{color:"rgba(255,255,255,0.4)",marginTop:"8px",fontSize:"14px"},children:"Plateforme de génération d'applications IA"})]}),e.jsxs("div",{style:{background:"rgba(255,255,255,0.04)",backdropFilter:"blur(20px)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"24px",padding:"36px",boxShadow:"0 25px 50px rgba(0,0,0,0.4)"},children:[e.jsx("div",{style:{display:"flex",background:"rgba(0,0,0,0.3)",borderRadius:"12px",padding:"4px",marginBottom:"28px"},children:["login","register"].map(N=>e.jsx("button",{onClick:()=>{r(N),L("")},style:{flex:1,padding:"10px",borderRadius:"10px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:600,transition:"all 0.2s ease",background:n===N?"linear-gradient(135deg, #8b5cf6, #3b82f6)":"transparent",color:n===N?"#fff":"rgba(255,255,255,0.4)"},children:N==="login"?"🔑 Connexion":"✨ Inscription"},N))}),e.jsxs("form",{onSubmit:Q,children:[e.jsxs("div",{style:{marginBottom:"16px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Adresse email"}),e.jsx("input",{type:"email",value:o,onChange:N=>d(N.target.value),required:!0,autoComplete:"email",placeholder:"vous@exemple.com",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box",transition:"border-color 0.2s"},onFocus:N=>N.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:N=>N.target.style.borderColor="rgba(255,255,255,0.1)"})]}),e.jsxs("div",{style:{marginBottom:n==="register"?"16px":"24px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Mot de passe"}),e.jsx("input",{type:"password",value:m,onChange:N=>h(N.target.value),required:!0,autoComplete:n==="login"?"current-password":"new-password",placeholder:n==="register"?"8 caractères minimum":"••••••••",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box"},onFocus:N=>N.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:N=>N.target.style.borderColor="rgba(255,255,255,0.1)"})]}),n==="register"&&e.jsxs("div",{style:{marginBottom:"24px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Confirmer le mot de passe"}),e.jsx("input",{type:"password",value:u,onChange:N=>_(N.target.value),required:!0,autoComplete:"new-password",placeholder:"••••••••",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box"},onFocus:N=>N.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:N=>N.target.style.borderColor="rgba(255,255,255,0.1)"})]}),q&&e.jsxs("div",{style:{background:"rgba(239,68,68,0.12)",border:"1px solid rgba(239,68,68,0.3)",borderRadius:"10px",padding:"12px 16px",marginBottom:"16px",color:"#fca5a5",fontSize:"13px",display:"flex",alignItems:"center",gap:"8px"},children:[e.jsx("span",{children:"⚠️"})," ",q]}),e.jsx("button",{type:"submit",disabled:S,style:{width:"100%",padding:"14px",borderRadius:"12px",border:"none",background:S?"rgba(139,92,246,0.4)":"linear-gradient(135deg, #8b5cf6, #3b82f6)",color:"#fff",fontSize:"15px",fontWeight:700,cursor:S?"not-allowed":"pointer",transition:"all 0.2s ease",boxShadow:S?"none":"0 4px 20px rgba(139,92,246,0.4)"},children:S?"⏳ Chargement...":n==="login"?"🚀 Se connecter":"✨ Créer mon compte"})]}),e.jsx("p",{style:{textAlign:"center",marginTop:"20px",fontSize:"12px",color:"rgba(255,255,255,0.25)"},children:"🔒 Connexion sécurisée — Vos données sont chiffrées"})]})]}),e.jsx("style",{children:`
        @keyframes float {
          from { transform: translateY(0px) scale(1); }
          to { transform: translateY(-30px) scale(1.05); }
        }
        input::placeholder { color: rgba(255,255,255,0.25); }
      `})]})}function zo(){const[t,n]=a.useState(null),[r,o]=a.useState(!0);a.useEffect(()=>{(async()=>{try{const h=localStorage.getItem("kirov5_jwt_token");if(!h){n(null),o(!1);return}const u=await fetch("/api/auth/session",{headers:{Authorization:`Bearer ${h}`}});if(u.ok){const _=await u.json();_.authenticated?n({userId:String(_.userId||"user"),email:_.email||"user@cloud",isSuperAdmin:!!_.isSuperAdmin}):(localStorage.removeItem("kirov5_jwt_token"),n(null))}else localStorage.removeItem("kirov5_jwt_token"),n(null)}catch{const h=localStorage.getItem("kirov5_jwt_token");h&&h.startsWith("dev-")?n({userId:"dev-user-001",email:"dev@kirov5.local",isSuperAdmin:!0}):n(null)}finally{o(!1)}})()},[]);const d=()=>{localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{}),n(null)};return r?e.jsx("div",{style:{minHeight:"100vh",background:"linear-gradient(135deg, #0f0c29, #302b63, #24243e)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"Inter, sans-serif"},children:e.jsxs("div",{style:{textAlign:"center",color:"rgba(255,255,255,0.6)"},children:[e.jsx("div",{style:{fontSize:"48px",marginBottom:"16px"},children:"⚡"}),e.jsx("div",{style:{fontSize:"14px"},children:"Initialisation du Studio Kirov5..."})]})}):t?e.jsx(Vo,{user:t,onLogout:d}):e.jsx(Bo,{onAuthenticated:m=>n(m)})}bs.createRoot(document.getElementById("root")).render(e.jsx(Tt.StrictMode,{children:e.jsx(zo,{})}));export{Pn as E,os as W,Ua as b};

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-D-kReDvD.js","assets/design-v200-CZCFVxR9.js","assets/design-v200-Da4FXbs6.css"])))=>i.map(i=>d[i]);
import{r as l,a as Tt,j as e,s as w,i as fs,R as bs}from"./design-v200-CZCFVxR9.js";const vs="modulepreload",Ss=function(t){return"/"+t},Ln={},Zt=function(n,r,c){let d=Promise.resolve();if(r&&r.length>0){let h=function(S){return Promise.all(S.map(y=>Promise.resolve(y).then(M=>({status:"fulfilled",value:M}),M=>({status:"rejected",reason:M}))))};document.getElementsByTagName("link");const p=document.querySelector("meta[property=csp-nonce]"),C=(p==null?void 0:p.nonce)||(p==null?void 0:p.getAttribute("nonce"));d=h(r.map(S=>{if(S=Ss(S),S in Ln)return;Ln[S]=!0;const y=S.endsWith(".css"),M=y?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${S}"]${M}`))return;const F=document.createElement("link");if(F.rel=y?"stylesheet":vs,y||(F.as="script"),F.crossOrigin="",F.href=S,C&&F.setAttribute("nonce",C),document.head.appendChild(F),y)return new Promise((Z,O)=>{F.addEventListener("load",Z),F.addEventListener("error",()=>O(new Error(`Unable to preload CSS for ${S}`)))})}))}function m(h){const p=new Event("vite:preloadError",{cancelable:!0});if(p.payload=h,window.dispatchEvent(p),!p.defaultPrevented)throw h}return d.then(h=>{for(const p of h||[])p.status==="rejected"&&m(p.reason);return n().catch(m)})},ys=`# undefined
...
- \`src/features/gamification/components/BadgeGrid.tsx\``,Fs=`# APK Forge — Intelligent Android Packaging Suite
...
---
`,Gs=`# Industrialisation_Backend_KIROV5
...
- \`src/features/images/hooks/useImageUpload.ts\``,jr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/mobile/components/SwipeableOnboarding.tsx\``,Fr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/api/apiClient.ts\` (Interface qui tape sur les mocks pour l'instant)`,Gr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/widgets/hooks/useCalendarState.ts\``;function Un(t,n){(n==null||n>t.length)&&(n=t.length);for(var r=0,c=Array(n);r<n;r++)c[r]=t[r];return c}function Si(t){if(Array.isArray(t))return t}function yi(t,n,r){return(n=ki(n))in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function _i(t,n){var r=t==null?null:typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(r!=null){var c,d,m,h,p=[],C=!0,S=!1;try{if(m=(r=r.call(t)).next,n!==0)for(;!(C=(c=m.call(r)).done)&&(p.push(c.value),p.length!==n);C=!0);}catch(y){S=!0,d=y}finally{try{if(!C&&r.return!=null&&(h=r.return(),Object(h)!==h))return}finally{if(S)throw d}}return p}}function Ci(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function On(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);n&&(c=c.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,c)}return r}function Fn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?On(Object(r),!0).forEach(function(c){yi(t,c,r[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):On(Object(r)).forEach(function(c){Object.defineProperty(t,c,Object.getOwnPropertyDescriptor(r,c))})}return t}function wi(t,n){if(t==null)return{};var r,c,d=Ii(t,n);if(Object.getOwnPropertySymbols){var m=Object.getOwnPropertySymbols(t);for(c=0;c<m.length;c++)r=m[c],n.indexOf(r)===-1&&{}.propertyIsEnumerable.call(t,r)&&(d[r]=t[r])}return d}function Ii(t,n){if(t==null)return{};var r={};for(var c in t)if({}.hasOwnProperty.call(t,c)){if(n.indexOf(c)!==-1)continue;r[c]=t[c]}return r}function Ai(t,n){return Si(t)||_i(t,n)||ji(t,n)||Ci()}function Pi(t,n){if(typeof t!="object"||!t)return t;var r=t[Symbol.toPrimitive];if(r!==void 0){var c=r.call(t,n);if(typeof c!="object")return c;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}function ki(t){var n=Pi(t,"string");return typeof n=="symbol"?n:n+""}function ji(t,n){if(t){if(typeof t=="string")return Un(t,n);var r={}.toString.call(t).slice(8,-1);return r==="Object"&&t.constructor&&(r=t.constructor.name),r==="Map"||r==="Set"?Array.from(t):r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?Un(t,n):void 0}}function Ti(t,n,r){return n in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function Gn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);n&&(c=c.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,c)}return r}function Vn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Gn(Object(r),!0).forEach(function(c){Ti(t,c,r[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Gn(Object(r)).forEach(function(c){Object.defineProperty(t,c,Object.getOwnPropertyDescriptor(r,c))})}return t}function Ei(){for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r];return function(c){return n.reduceRight(function(d,m){return m(d)},c)}}function Xt(t){return function n(){for(var r=this,c=arguments.length,d=new Array(c),m=0;m<c;m++)d[m]=arguments[m];return d.length>=t.length?t.apply(this,d):function(){for(var h=arguments.length,p=new Array(h),C=0;C<h;C++)p[C]=arguments[C];return n.apply(r,[].concat(d,p))}}}function hn(t){return{}.toString.call(t).includes("Object")}function Ri(t){return!Object.keys(t).length}function Yt(t){return typeof t=="function"}function Ni(t,n){return Object.prototype.hasOwnProperty.call(t,n)}function Di(t,n){return hn(n)||Ct("changeType"),Object.keys(n).some(function(r){return!Ni(t,r)})&&Ct("changeField"),n}function Mi(t){Yt(t)||Ct("selectorType")}function qi(t){Yt(t)||hn(t)||Ct("handlerType"),hn(t)&&Object.values(t).some(function(n){return!Yt(n)})&&Ct("handlersType")}function Li(t){t||Ct("initialIsRequired"),hn(t)||Ct("initialType"),Ri(t)&&Ct("initialContent")}function Ui(t,n){throw new Error(t[n]||t.default)}var Oi={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},Ct=Xt(Ui)(Oi),un={changes:Di,selector:Mi,handler:qi,initial:Li};function Fi(t){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};un.initial(t),un.handler(n);var r={current:t},c=Xt(Bi)(r,n),d=Xt(Vi)(r),m=Xt(un.changes)(t),h=Xt(Gi)(r);function p(){var S=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(y){return y};return un.selector(S),S(r.current)}function C(S){Ei(c,d,m,h)(S)}return[p,C]}function Gi(t,n){return Yt(n)?n(t.current):n}function Vi(t,n){return t.current=Vn(Vn({},t.current),n),n}function Bi(t,n,r){return Yt(n)?n(t.current):Object.keys(r).forEach(function(c){var d;return(d=n[c])===null||d===void 0?void 0:d.call(n,t.current[c])}),r}var zi={create:Fi},Hi={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.55.1/min/vs"}};function $i(t){return function n(){for(var r=this,c=arguments.length,d=new Array(c),m=0;m<c;m++)d[m]=arguments[m];return d.length>=t.length?t.apply(this,d):function(){for(var h=arguments.length,p=new Array(h),C=0;C<h;C++)p[C]=arguments[C];return n.apply(r,[].concat(d,p))}}}function Ki(t){return{}.toString.call(t).includes("Object")}function Wi(t){return t||Bn("configIsRequired"),Ki(t)||Bn("configType"),t.urls?(Ji(),{paths:{vs:t.urls.monacoBase}}):t}function Ji(){console.warn(Qn.deprecation)}function Xi(t,n){throw new Error(t[n]||t.default)}var Qn={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},Bn=$i(Xi)(Qn),Qi={config:Wi},Zi=function(){for(var n=arguments.length,r=new Array(n),c=0;c<n;c++)r[c]=arguments[c];return function(d){return r.reduceRight(function(m,h){return h(m)},d)}};function Zn(t,n){return Object.keys(n).forEach(function(r){n[r]instanceof Object&&t[r]&&Object.assign(n[r],Zn(t[r],n[r]))}),Fn(Fn({},t),n)}var Yi={type:"cancelation",msg:"operation is manually canceled"};function yn(t){var n=!1,r=new Promise(function(c,d){t.then(function(m){return n?d(Yi):c(m)}),t.catch(d)});return r.cancel=function(){return n=!0},r}var ea=["monaco"],ta=zi.create({config:Hi,isInitialized:!1,resolve:null,reject:null,monaco:null}),Yn=Ai(ta,2),en=Yn[0],fn=Yn[1];function na(t){var n=Qi.config(t),r=n.monaco,c=wi(n,ea);fn(function(d){return{config:Zn(d.config,c),monaco:r}})}function sa(){var t=en(function(n){var r=n.monaco,c=n.isInitialized,d=n.resolve;return{monaco:r,isInitialized:c,resolve:d}});if(!t.isInitialized){if(fn({isInitialized:!0}),t.monaco)return t.resolve(t.monaco),yn(_n);if(window.monaco&&window.monaco.editor)return es(window.monaco),t.resolve(window.monaco),yn(_n);Zi(ra,aa)(oa)}return yn(_n)}function ra(t){return document.body.appendChild(t)}function ia(t){var n=document.createElement("script");return t&&(n.src=t),n}function aa(t){var n=en(function(c){var d=c.config,m=c.reject;return{config:d,reject:m}}),r=ia("".concat(n.config.paths.vs,"/loader.js"));return r.onload=function(){return t()},r.onerror=n.reject,r}function oa(){var t=en(function(r){var c=r.config,d=r.resolve,m=r.reject;return{config:c,resolve:d,reject:m}}),n=window.require;n.config(t.config),n(["vs/editor/editor.main"],function(r){var c=r.m||r;es(c),t.resolve(c)},function(r){t.reject(r)})}function es(t){en().monaco||fn({monaco:t})}function la(){return en(function(t){var n=t.monaco;return n})}var _n=new Promise(function(t,n){return fn({resolve:t,reject:n})}),ts={config:na,init:sa,__getMonacoInstance:la},ca={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},Cn=ca,da={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},ua=da;function pa({children:t}){return Tt.createElement("div",{style:ua.container},t)}var ma=pa,ga=ma;function ha({width:t,height:n,isEditorReady:r,loading:c,_ref:d,className:m,wrapperProps:h}){return Tt.createElement("section",{style:{...Cn.wrapper,width:t,height:n},...h},!r&&Tt.createElement(ga,null,c),Tt.createElement("div",{ref:d,style:{...Cn.fullWidth,...!r&&Cn.hide},className:m}))}var xa=ha,ns=l.memo(xa);function fa(t){l.useEffect(t,[])}var ss=fa;function ba(t,n,r=!0){let c=l.useRef(!0);l.useEffect(c.current||!r?()=>{c.current=!1}:t,n)}var He=ba;function Qt(){}function Gt(t,n,r,c){return va(t,c)||Sa(t,n,r,c)}function va(t,n){return t.editor.getModel(rs(t,n))}function Sa(t,n,r,c){return t.editor.createModel(n,r,c?rs(t,c):void 0)}function rs(t,n){return t.Uri.parse(n)}function ya({original:t,modified:n,language:r,originalLanguage:c,modifiedLanguage:d,originalModelPath:m,modifiedModelPath:h,keepCurrentOriginalModel:p=!1,keepCurrentModifiedModel:C=!1,theme:S="light",loading:y="Loading...",options:M={},height:F="100%",width:Z="100%",className:O,wrapperProps:X={},beforeMount:se=Qt,onMount:A=Qt}){let[R,D]=l.useState(!1),[x,b]=l.useState(!0),q=l.useRef(null),I=l.useRef(null),P=l.useRef(null),K=l.useRef(A),z=l.useRef(se),$=l.useRef(!1);ss(()=>{let G=ts.init();return G.then(V=>(I.current=V)&&b(!1)).catch(V=>(V==null?void 0:V.type)!=="cancelation"&&console.error("Monaco initialization: error:",V)),()=>q.current?ge():G.cancel()}),He(()=>{if(q.current&&I.current){let G=q.current.getOriginalEditor(),V=Gt(I.current,t||"",c||r||"text",m||"");V!==G.getModel()&&G.setModel(V)}},[m],R),He(()=>{if(q.current&&I.current){let G=q.current.getModifiedEditor(),V=Gt(I.current,n||"",d||r||"text",h||"");V!==G.getModel()&&G.setModel(V)}},[h],R),He(()=>{let G=q.current.getModifiedEditor();G.getOption(I.current.editor.EditorOption.readOnly)?G.setValue(n||""):n!==G.getValue()&&(G.executeEdits("",[{range:G.getModel().getFullModelRange(),text:n||"",forceMoveMarkers:!0}]),G.pushUndoStop())},[n],R),He(()=>{var G,V;(V=(G=q.current)==null?void 0:G.getModel())==null||V.original.setValue(t||"")},[t],R),He(()=>{let{original:G,modified:V}=q.current.getModel();I.current.editor.setModelLanguage(G,c||r||"text"),I.current.editor.setModelLanguage(V,d||r||"text")},[r,c,d],R),He(()=>{var G;(G=I.current)==null||G.editor.setTheme(S)},[S],R),He(()=>{var G;(G=q.current)==null||G.updateOptions(M)},[M],R);let H=l.useCallback(()=>{var te;if(!I.current)return;z.current(I.current);let G=Gt(I.current,t||"",c||r||"text",m||""),V=Gt(I.current,n||"",d||r||"text",h||"");(te=q.current)==null||te.setModel({original:G,modified:V})},[r,n,d,t,c,m,h]),re=l.useCallback(()=>{var G;!$.current&&P.current&&(q.current=I.current.editor.createDiffEditor(P.current,{automaticLayout:!0,...M}),H(),(G=I.current)==null||G.editor.setTheme(S),D(!0),$.current=!0)},[M,S,H]);l.useEffect(()=>{R&&K.current(q.current,I.current)},[R]),l.useEffect(()=>{!x&&!R&&re()},[x,R,re]);function ge(){var V,te,le,he;let G=(V=q.current)==null?void 0:V.getModel();p||((te=G==null?void 0:G.original)==null||te.dispose()),C||((le=G==null?void 0:G.modified)==null||le.dispose()),(he=q.current)==null||he.dispose()}return Tt.createElement(ns,{width:Z,height:F,isEditorReady:R,loading:y,_ref:P,className:O,wrapperProps:X})}var _a=ya;l.memo(_a);function Ca(t){let n=l.useRef();return l.useEffect(()=>{n.current=t},[t]),n.current}var wa=Ca,pn=new Map;function Ia({defaultValue:t,defaultLanguage:n,defaultPath:r,value:c,language:d,path:m,theme:h="light",line:p,loading:C="Loading...",options:S={},overrideServices:y={},saveViewState:M=!0,keepCurrentModel:F=!1,width:Z="100%",height:O="100%",className:X,wrapperProps:se={},beforeMount:A=Qt,onMount:R=Qt,onChange:D,onValidate:x=Qt}){let[b,q]=l.useState(!1),[I,P]=l.useState(!0),K=l.useRef(null),z=l.useRef(null),$=l.useRef(null),H=l.useRef(R),re=l.useRef(A),ge=l.useRef(),G=l.useRef(c),V=wa(m),te=l.useRef(!1),le=l.useRef(!1);ss(()=>{let j=ts.init();return j.then(Q=>(K.current=Q)&&P(!1)).catch(Q=>(Q==null?void 0:Q.type)!=="cancelation"&&console.error("Monaco initialization: error:",Q)),()=>z.current?ee():j.cancel()}),He(()=>{var Q,ae,pe,ve;let j=Gt(K.current,t||c||"",n||d||"",m||r||"");j!==((Q=z.current)==null?void 0:Q.getModel())&&(M&&pn.set(V,(ae=z.current)==null?void 0:ae.saveViewState()),(pe=z.current)==null||pe.setModel(j),M&&((ve=z.current)==null||ve.restoreViewState(pn.get(m))))},[m],b),He(()=>{var j;(j=z.current)==null||j.updateOptions(S)},[S],b),He(()=>{!z.current||c===void 0||(z.current.getOption(K.current.editor.EditorOption.readOnly)?z.current.setValue(c):c!==z.current.getValue()&&(le.current=!0,z.current.executeEdits("",[{range:z.current.getModel().getFullModelRange(),text:c,forceMoveMarkers:!0}]),z.current.pushUndoStop(),le.current=!1))},[c],b),He(()=>{var Q,ae;let j=(Q=z.current)==null?void 0:Q.getModel();j&&d&&((ae=K.current)==null||ae.editor.setModelLanguage(j,d))},[d],b),He(()=>{var j;p!==void 0&&((j=z.current)==null||j.revealLine(p))},[p],b),He(()=>{var j;(j=K.current)==null||j.editor.setTheme(h)},[h],b);let he=l.useCallback(()=>{var j;if(!(!$.current||!K.current)&&!te.current){re.current(K.current);let Q=m||r,ae=Gt(K.current,c||t||"",n||d||"",Q||"");z.current=(j=K.current)==null?void 0:j.editor.create($.current,{model:ae,automaticLayout:!0,...S},y),M&&z.current.restoreViewState(pn.get(Q)),K.current.editor.setTheme(h),p!==void 0&&z.current.revealLine(p),q(!0),te.current=!0}},[t,n,r,c,d,m,S,y,M,h,p]);l.useEffect(()=>{b&&H.current(z.current,K.current)},[b]),l.useEffect(()=>{!I&&!b&&he()},[I,b,he]),G.current=c,l.useEffect(()=>{var j,Q;b&&D&&((j=ge.current)==null||j.dispose(),ge.current=(Q=z.current)==null?void 0:Q.onDidChangeModelContent(ae=>{le.current||D(z.current.getValue(),ae)}))},[b,D]),l.useEffect(()=>{if(b){let j=K.current.editor.onDidChangeMarkers(Q=>{var pe;let ae=(pe=z.current.getModel())==null?void 0:pe.uri;if(ae&&Q.find(ve=>ve.path===ae.path)){let ve=K.current.editor.getModelMarkers({resource:ae});x==null||x(ve)}});return()=>{j==null||j.dispose()}}return()=>{}},[b,x]);function ee(){var j,Q;(j=ge.current)==null||j.dispose(),F?M&&pn.set(m,z.current.saveViewState()):(Q=z.current.getModel())==null||Q.dispose(),z.current.dispose()}return Tt.createElement(ns,{width:Z,height:O,isEditorReady:b,loading:C,_ref:$,className:X,wrapperProps:se})}var Aa=Ia,Pa=l.memo(Aa),ka=Pa;/*! Capacitor: https://capacitorjs.com/ - MIT License */const ja=t=>{const n=new Map;n.set("web",{name:"web"});const r=t.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:n},c=(m,h)=>{r.platforms.set(m,h)},d=m=>{r.platforms.has(m)&&(r.currentPlatform=r.platforms.get(m))};return r.addPlatform=c,r.setPlatform=d,r},Ta=t=>t.CapacitorPlatforms=ja(t),is=Ta(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});is.addPlatform;is.setPlatform;var Ht;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(Ht||(Ht={}));class wn extends Error{constructor(n,r,c){super(n),this.message=n,this.code=r,this.data=c}}const Ea=t=>{var n,r;return t!=null&&t.androidBridge?"android":!((r=(n=t==null?void 0:t.webkit)===null||n===void 0?void 0:n.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},Ra=t=>{var n,r,c,d,m;const h=t.CapacitorCustomPlatform||null,p=t.Capacitor||{},C=p.Plugins=p.Plugins||{},S=t.CapacitorPlatforms,y=()=>h!==null?h.name:Ea(t),M=((n=S==null?void 0:S.currentPlatform)===null||n===void 0?void 0:n.getPlatform)||y,F=()=>M()!=="web",Z=((r=S==null?void 0:S.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||F,O=I=>{const P=x.get(I);return!!(P!=null&&P.platforms.has(M())||A(I))},X=((c=S==null?void 0:S.currentPlatform)===null||c===void 0?void 0:c.isPluginAvailable)||O,se=I=>{var P;return(P=p.PluginHeaders)===null||P===void 0?void 0:P.find(K=>K.name===I)},A=((d=S==null?void 0:S.currentPlatform)===null||d===void 0?void 0:d.getPluginHeader)||se,R=I=>t.console.error(I),D=(I,P,K)=>Promise.reject(`${K} does not have an implementation of "${P}".`),x=new Map,b=(I,P={})=>{const K=x.get(I);if(K)return console.warn(`Capacitor plugin "${I}" already registered. Cannot register plugins twice.`),K.proxy;const z=M(),$=A(I);let H;const re=async()=>(!H&&z in P?H=typeof P[z]=="function"?H=await P[z]():H=P[z]:h!==null&&!H&&"web"in P&&(H=typeof P.web=="function"?H=await P.web():H=P.web),H),ge=(ee,j)=>{var Q,ae;if($){const pe=$==null?void 0:$.methods.find(ve=>j===ve.name);if(pe)return pe.rtype==="promise"?ve=>p.nativePromise(I,j.toString(),ve):(ve,je)=>p.nativeCallback(I,j.toString(),ve,je);if(ee)return(Q=ee[j])===null||Q===void 0?void 0:Q.bind(ee)}else{if(ee)return(ae=ee[j])===null||ae===void 0?void 0:ae.bind(ee);throw new wn(`"${I}" plugin is not implemented on ${z}`,Ht.Unimplemented)}},G=ee=>{let j;const Q=(...ae)=>{const pe=re().then(ve=>{const je=ge(ve,ee);if(je){const ke=je(...ae);return j=ke==null?void 0:ke.remove,ke}else throw new wn(`"${I}.${ee}()" is not implemented on ${z}`,Ht.Unimplemented)});return ee==="addListener"&&(pe.remove=async()=>j()),pe};return Q.toString=()=>`${ee.toString()}() { [capacitor code] }`,Object.defineProperty(Q,"name",{value:ee,writable:!1,configurable:!1}),Q},V=G("addListener"),te=G("removeListener"),le=(ee,j)=>{const Q=V({eventName:ee},j),ae=async()=>{const ve=await Q;te({eventName:ee,callbackId:ve},j)},pe=new Promise(ve=>Q.then(()=>ve({remove:ae})));return pe.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await ae()},pe},he=new Proxy({},{get(ee,j){switch(j){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return $?le:V;case"removeListener":return te;default:return G(j)}}});return C[I]=he,x.set(I,{name:I,proxy:he,platforms:new Set([...Object.keys(P),...$?[z]:[]])}),he},q=((m=S==null?void 0:S.currentPlatform)===null||m===void 0?void 0:m.registerPlugin)||b;return p.convertFileSrc||(p.convertFileSrc=I=>I),p.getPlatform=M,p.handleError=R,p.isNativePlatform=Z,p.isPluginAvailable=X,p.pluginMethodNoop=D,p.registerPlugin=q,p.Exception=wn,p.DEBUG=!!p.DEBUG,p.isLoggingEnabled=!!p.isLoggingEnabled,p.platform=p.getPlatform(),p.isNative=p.isNativePlatform(),p},Na=t=>t.Capacitor=Ra(t),$t=Na(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Rn=$t.registerPlugin;$t.Plugins;class as{constructor(n){this.listeners={},this.retainedEventArguments={},this.windowListeners={},n&&(console.warn(`Capacitor WebPlugin "${n.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=n)}addListener(n,r){let c=!1;this.listeners[n]||(this.listeners[n]=[],c=!0),this.listeners[n].push(r);const m=this.windowListeners[n];m&&!m.registered&&this.addWindowListener(m),c&&this.sendRetainedArgumentsForEvent(n);const h=async()=>this.removeListener(n,r);return Promise.resolve({remove:h})}async removeAllListeners(){this.listeners={};for(const n in this.windowListeners)this.removeWindowListener(this.windowListeners[n]);this.windowListeners={}}notifyListeners(n,r,c){const d=this.listeners[n];if(!d){if(c){let m=this.retainedEventArguments[n];m||(m=[]),m.push(r),this.retainedEventArguments[n]=m}return}d.forEach(m=>m(r))}hasListeners(n){return!!this.listeners[n].length}registerWindowListener(n,r){this.windowListeners[r]={registered:!1,windowEventName:n,pluginEventName:r,handler:c=>{this.notifyListeners(r,c)}}}unimplemented(n="not implemented"){return new $t.Exception(n,Ht.Unimplemented)}unavailable(n="not available"){return new $t.Exception(n,Ht.Unavailable)}async removeListener(n,r){const c=this.listeners[n];if(!c)return;const d=c.indexOf(r);this.listeners[n].splice(d,1),this.listeners[n].length||this.removeWindowListener(this.windowListeners[n])}addWindowListener(n){window.addEventListener(n.windowEventName,n.handler),n.registered=!0}removeWindowListener(n){n&&(window.removeEventListener(n.windowEventName,n.handler),n.registered=!1)}sendRetainedArgumentsForEvent(n){const r=this.retainedEventArguments[n];r&&(delete this.retainedEventArguments[n],r.forEach(c=>{this.notifyListeners(n,c)}))}}const zn=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Hn=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Da extends as{async getCookies(){const n=document.cookie,r={};return n.split(";").forEach(c=>{if(c.length<=0)return;let[d,m]=c.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");d=Hn(d).trim(),m=Hn(m).trim(),r[d]=m}),r}async setCookie(n){try{const r=zn(n.key),c=zn(n.value),d=`; expires=${(n.expires||"").replace("expires=","")}`,m=(n.path||"/").replace("path=",""),h=n.url!=null&&n.url.length>0?`domain=${n.url}`:"";document.cookie=`${r}=${c||""}${d}; path=${m}; ${h};`}catch(r){return Promise.reject(r)}}async deleteCookie(n){try{document.cookie=`${n.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{const n=document.cookie.split(";")||[];for(const r of n)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(n){return Promise.reject(n)}}async clearAllCookies(){try{await this.clearCookies()}catch(n){return Promise.reject(n)}}}Rn("CapacitorCookies",{web:()=>new Da});const Ma=async t=>new Promise((n,r)=>{const c=new FileReader;c.onload=()=>{const d=c.result;n(d.indexOf(",")>=0?d.split(",")[1]:d)},c.onerror=d=>r(d),c.readAsDataURL(t)}),qa=(t={})=>{const n=Object.keys(t);return Object.keys(t).map(d=>d.toLocaleLowerCase()).reduce((d,m,h)=>(d[m]=t[n[h]],d),{})},La=(t,n=!0)=>t?Object.entries(t).reduce((c,d)=>{const[m,h]=d;let p,C;return Array.isArray(h)?(C="",h.forEach(S=>{p=n?encodeURIComponent(S):S,C+=`${m}=${p}&`}),C.slice(0,-1)):(p=n?encodeURIComponent(h):h,C=`${m}=${p}`),`${c}&${C}`},"").substr(1):null,Ua=(t,n={})=>{const r=Object.assign({method:t.method||"GET",headers:t.headers},n),d=qa(t.headers)["content-type"]||"";if(typeof t.data=="string")r.body=t.data;else if(d.includes("application/x-www-form-urlencoded")){const m=new URLSearchParams;for(const[h,p]of Object.entries(t.data||{}))m.set(h,p);r.body=m.toString()}else if(d.includes("multipart/form-data")||t.data instanceof FormData){const m=new FormData;if(t.data instanceof FormData)t.data.forEach((p,C)=>{m.append(C,p)});else for(const p of Object.keys(t.data))m.append(p,t.data[p]);r.body=m;const h=new Headers(r.headers);h.delete("content-type"),r.headers=h}else(d.includes("application/json")||typeof t.data=="object")&&(r.body=JSON.stringify(t.data));return r};class Oa extends as{async request(n){const r=Ua(n,n.webFetchExtra),c=La(n.params,n.shouldEncodeUrlParams),d=c?`${n.url}?${c}`:n.url,m=await fetch(d,r),h=m.headers.get("content-type")||"";let{responseType:p="text"}=m.ok?n:{};h.includes("application/json")&&(p="json");let C,S;switch(p){case"arraybuffer":case"blob":S=await m.blob(),C=await Ma(S);break;case"json":C=await m.json();break;case"document":case"text":default:C=await m.text()}const y={};return m.headers.forEach((M,F)=>{y[F]=M}),{data:C,headers:y,status:m.status,url:m.url}}async get(n){return this.request(Object.assign(Object.assign({},n),{method:"GET"}))}async post(n){return this.request(Object.assign(Object.assign({},n),{method:"POST"}))}async put(n){return this.request(Object.assign(Object.assign({},n),{method:"PUT"}))}async patch(n){return this.request(Object.assign(Object.assign({},n),{method:"PATCH"}))}async delete(n){return this.request(Object.assign(Object.assign({},n),{method:"DELETE"}))}}Rn("CapacitorHttp",{web:()=>new Oa});var xn;(function(t){t.Documents="DOCUMENTS",t.Data="DATA",t.Library="LIBRARY",t.Cache="CACHE",t.External="EXTERNAL",t.ExternalStorage="EXTERNAL_STORAGE"})(xn||(xn={}));var Pn;(function(t){t.UTF8="utf8",t.ASCII="ascii",t.UTF16="utf16"})(Pn||(Pn={}));const $n=Rn("Filesystem",{web:()=>Zt(()=>import("./web-v200-D-kReDvD.js"),__vite__mapDeps([0,1,2])).then(t=>new t.FilesystemWeb)});/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fa=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),os=(...t)=>t.filter((n,r,c)=>!!n&&c.indexOf(n)===r).join(" ");/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Va=l.forwardRef(({color:t="currentColor",size:n=24,strokeWidth:r=2,absoluteStrokeWidth:c,className:d="",children:m,iconNode:h,...p},C)=>l.createElement("svg",{ref:C,...Ga,width:n,height:n,stroke:t,strokeWidth:c?Number(r)*24/Number(n):r,className:os("lucide",d),...p},[...h.map(([S,y])=>l.createElement(S,y)),...Array.isArray(m)?m:[m]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const de=(t,n)=>{const r=l.forwardRef(({className:c,...d},m)=>l.createElement(Va,{ref:m,iconNode:n,className:os(`lucide-${Fa(t)}`,c),...d}));return r.displayName=`${t}`,r};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ba=de("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const In=de("Ban",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m4.9 4.9 14.2 14.2",key:"1m5liu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ls=de("Box",[["path",{d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z",key:"hh9hay"}],["path",{d:"m3.3 7 8.7 5 8.7-5",key:"g66t2b"}],["path",{d:"M12 22V12",key:"d0xqtd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const za=de("ChevronDown",[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ha=de("ChevronUp",[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const cs=de("CircleCheck",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $a=de("CircleHelp",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ka=de("CircleX",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wa=de("Component",[["path",{d:"M5.5 8.5 9 12l-3.5 3.5L2 12l3.5-3.5Z",key:"1kciei"}],["path",{d:"m12 2 3.5 3.5L12 9 8.5 5.5 12 2Z",key:"1ome0g"}],["path",{d:"M18.5 8.5 22 12l-3.5 3.5L15 12l3.5-3.5Z",key:"vbupec"}],["path",{d:"m12 15 3.5 3.5L12 22l-3.5-3.5L12 15Z",key:"16csic"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Kn=de("Cpu",[["rect",{width:"16",height:"16",x:"4",y:"4",rx:"2",key:"14l7u7"}],["rect",{width:"6",height:"6",x:"9",y:"9",rx:"1",key:"5aljv4"}],["path",{d:"M15 2v2",key:"13l42r"}],["path",{d:"M15 20v2",key:"15mkzm"}],["path",{d:"M2 15h2",key:"1gxd5l"}],["path",{d:"M2 9h2",key:"1bbxkp"}],["path",{d:"M20 15h2",key:"19e6y8"}],["path",{d:"M20 9h2",key:"19tzq7"}],["path",{d:"M9 2v2",key:"165o2o"}],["path",{d:"M9 20v2",key:"i2bqo8"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ja=de("CreditCard",[["rect",{width:"20",height:"14",x:"2",y:"5",rx:"2",key:"ynyp8z"}],["line",{x1:"2",x2:"22",y1:"10",y2:"10",key:"1b3vmo"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xa=de("Database",[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3",key:"msslwz"}],["path",{d:"M3 5V19A9 3 0 0 0 21 19V5",key:"1wlel7"}],["path",{d:"M3 12A9 3 0 0 0 21 12",key:"mv7ke4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qa=de("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Za=de("FilePen",[["path",{d:"M12 22h6a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v10",key:"x7tsz2"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10.4 12.6a2 2 0 1 1 3 3L8 21l-4 1 1-4Z",key:"o3xyfb"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ya=de("FilePlus",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M9 15h6",key:"cctwl0"}],["path",{d:"M12 18v-6",key:"17g6i2"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const eo=de("FileText",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const to=de("FolderLock",[["rect",{width:"8",height:"5",x:"14",y:"17",rx:"1",key:"19aais"}],["path",{d:"M10 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v2.5",key:"1w6v7t"}],["path",{d:"M20 17v-2a2 2 0 1 0-4 0v2",key:"pwaxnr"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const no=de("Globe",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20",key:"13o1zl"}],["path",{d:"M2 12h20",key:"9i4pu4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const so=de("Image",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const io=de("Newspaper",[["path",{d:"M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2",key:"7pis2x"}],["path",{d:"M18 14h-8",key:"sponae"}],["path",{d:"M15 18h-5",key:"95g1m2"}],["path",{d:"M10 6h8v4h-8V6Z",key:"smlsk5"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ao=de("PanelsTopLeft",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}],["path",{d:"M3 9h18",key:"1pudct"}],["path",{d:"M9 21V9",key:"1oto5p"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oo=de("PenTool",[["path",{d:"M15.707 21.293a1 1 0 0 1-1.414 0l-1.586-1.586a1 1 0 0 1 0-1.414l5.586-5.586a1 1 0 0 1 1.414 0l1.586 1.586a1 1 0 0 1 0 1.414z",key:"nt11vn"}],["path",{d:"m18 13-1.375-6.874a1 1 0 0 0-.746-.776L3.235 2.028a1 1 0 0 0-1.207 1.207L5.35 15.879a1 1 0 0 0 .776.746L13 18",key:"15qc1e"}],["path",{d:"m2.3 2.3 7.286 7.286",key:"1wuzzi"}],["circle",{cx:"11",cy:"11",r:"2",key:"xmgehs"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lo=de("Rocket",[["path",{d:"M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z",key:"m3kijz"}],["path",{d:"m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z",key:"1fmvmk"}],["path",{d:"M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0",key:"1f8sc4"}],["path",{d:"M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5",key:"qeys4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ds=de("Server",[["rect",{width:"20",height:"8",x:"2",y:"2",rx:"2",ry:"2",key:"ngkwjq"}],["rect",{width:"20",height:"8",x:"2",y:"14",rx:"2",ry:"2",key:"iecqi9"}],["line",{x1:"6",x2:"6.01",y1:"6",y2:"6",key:"16zg32"}],["line",{x1:"6",x2:"6.01",y1:"18",y2:"18",key:"nzw8ys"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const co=de("ShieldAlert",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"M12 8v4",key:"1got3b"}],["path",{d:"M12 16h.01",key:"1drbdi"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const uo=de("ShieldCheck",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const po=de("ShoppingCart",[["circle",{cx:"8",cy:"21",r:"1",key:"jimo8o"}],["circle",{cx:"19",cy:"21",r:"1",key:"13723u"}],["path",{d:"M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12",key:"9zh506"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mo=de("Smartphone",[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2",key:"1yt0o3"}],["path",{d:"M12 18h.01",key:"mhygvu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const kn=de("TriangleAlert",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const go=de("Trophy",[["path",{d:"M6 9H4.5a2.5 2.5 0 0 1 0-5H6",key:"17hqa7"}],["path",{d:"M18 9h1.5a2.5 2.5 0 0 0 0-5H18",key:"lmptdp"}],["path",{d:"M4 22h16",key:"57wxv0"}],["path",{d:"M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22",key:"1nw9bq"}],["path",{d:"M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22",key:"1np0yb"}],["path",{d:"M18 2H6v7a6 6 0 0 0 12 0V2Z",key:"u46fv3"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ho=de("Video",[["path",{d:"m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5",key:"ftymec"}],["rect",{x:"2",y:"6",width:"14",height:"12",rx:"2",key:"158x01"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jn=de("Zap",[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]]),xo=t=>t.includes("auth")||t.includes("stealth")?uo:t.includes("ecom")||t.includes("commerce")||t.includes("produit")?po:t.includes("billing")||t.includes("paiement")?Ja:t.includes("layout")||t.includes("interface")?ao:t.includes("mobile")?mo:t.includes("blog")||t.includes("texte")||t.includes("markdown")?io:t.includes("game")||t.includes("gamification")?go:t.includes("sqlite")||t.includes("scraper")?Xa:t.includes("image")?so:t.includes("video")||t.includes("audio")?ho:t.includes("design")||t.includes("createur")?oo:t.includes("web")||t.includes("saas")||t.includes("landing")?no:t.includes("ia_")||t.includes("prompt")?fo:t.includes("chat")||t.includes("social")?ro:t.includes("composant")||t.includes("widget")||t.includes("forms")?Wa:t.includes("pdf")||t.includes("pieces_jointes")?eo:t.includes("mock")||t.includes("bridge")||t.includes("engine")?ds:ls,fo=ds,bo=t=>{const n=["bg-red-500/10 text-red-500","bg-blue-500/10 text-blue-500","bg-emerald-500/10 text-emerald-500","bg-purple-500/10 text-purple-500","bg-orange-500/10 text-orange-500","bg-pink-500/10 text-pink-500","bg-yellow-500/10 text-yellow-500","bg-cyan-500/10 text-cyan-500","bg-indigo-500/10 text-indigo-500","bg-teal-500/10 text-teal-500"];let r=0;for(let c=0;c<t.length;c++)r=t.charCodeAt(c)+((r<<5)-r);return n[Math.abs(r)%n.length]},vo=["app_web_pack","audio_pack","blog_contenu_pack","chat_comms_pack","commerce_paiement_pack","composant_pack","createur_pack","design_figma_xd_pack","diamond_bridge_v14_37","e_commerce_pack","ecommerce_pack","evenement_pack","feed_social_pack","forge_universelle","forms_inputs_pack","formulaire_pack","gamification_pack","health_fitness_pack","ia_pack","image_pack","interface_pack","jeux_video_pack","landing_pack","landing_saas_pack","layout_pack","local_maps_pack","markdown_pack","marketing_pack","mobile_pack","mobile_shell_pack","mobile_web_pack","mock_master","pdf_docs_pack","pieces_jointes_pack","prd_ai_apps_pack","prd_ai_voice_agent","prd_auth_gateway","prd_blog_magazine","prd_crm_erp_pack","prd_ecom_catalog","prd_ecom_checkout","prd_ecom_digital_products","prd_game_leaderboard","prd_layout_bento","prd_layout_kanban","prd_mobile_pack","prd_mobile_social","prd_saas_billing_pro","prd_saas_pack","prd_specs_pack","prd_web_landing_pack","productivity_pack","produit_pack","prompt_skills_pack","saas_pack","specialise_pack","sqlite_inspector","stealth_bridge_v11_2","texte_pack","universal_scraper","video_pack","web_blog_pack","widget_pack","guest_nebula_calc"],Bt=vo.map(t=>({id:t,name:t.replace(/_/g," ").replace(/\b\w/g,n=>n.toUpperCase()),icon:xo(t),color:bo(t)})),So={low:"text-emerald-400 border-emerald-500/30 bg-emerald-950/20",medium:"text-amber-400   border-amber-500/30   bg-amber-950/20",high:"text-orange-400  border-orange-500/30  bg-orange-950/20",critical:"text-red-400     border-red-500/30     bg-red-950/20"},yo={low:e.jsx(cs,{className:"w-3.5 h-3.5"}),medium:e.jsx(kn,{className:"w-3.5 h-3.5"}),high:e.jsx(kn,{className:"w-3.5 h-3.5"}),critical:e.jsx(Ka,{className:"w-3.5 h-3.5"})};function Tn({value:t}){const n=Math.round((t??1)*100),r=n>=80?"bg-emerald-500":n>=60?"bg-amber-500":"bg-red-500";return e.jsxs("span",{className:"flex items-center gap-1.5 text-[10px] font-bold text-zinc-400",children:[e.jsx("span",{className:`inline-block w-2 h-2 rounded-full ${r}`}),n,"% confiance"]})}function _o({cap:t}){const[n,r]=l.useState(!1);return e.jsxs("div",{className:"border border-zinc-800 rounded-xl overflow-hidden",children:[e.jsxs("button",{type:"button",className:"w-full flex items-center justify-between px-4 py-2.5 hover:bg-zinc-900/60 transition-colors",onClick:()=>r(c=>!c),children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:`text-xs font-bold px-2 py-0.5 rounded-full ${t.required?"bg-violet-500/20 text-violet-300":"bg-zinc-800 text-zinc-400"}`,children:t.required?"REQUISE":"optionnelle"}),e.jsx("span",{className:"text-sm text-white font-mono",children:t.id})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(Tn,{value:t.confidence}),n?e.jsx(Ha,{className:"w-3.5 h-3.5 text-zinc-500"}):e.jsx(za,{className:"w-3.5 h-3.5 text-zinc-500"})]})]}),n&&e.jsxs("div",{className:"px-4 pb-3 pt-1 bg-zinc-950/40 space-y-2",children:[e.jsx("p",{className:"text-xs text-zinc-300",children:t.reason}),t.evidence.length>0&&e.jsx("ul",{className:"space-y-1",children:t.evidence.map((c,d)=>e.jsxs("li",{className:"text-[11px] font-mono text-cyan-400/70",children:["→ ",c]},d))})]})]})}const Co=({audit:t,sourceFolder:n,onConfirm:r,onReset:c,isSubmitting:d})=>{const[m,h]=l.useState({}),p=t.requiresUserDecision||[],C=t.risks||[],S=t.capabilities||[],y=t.mocks||[],M=t.decisions||[],F=t.filesToCreate||[],Z=t.filesToModify||[],O=t.filesToPreserve||[],X=p.some(x=>x.required&&(!m[x.id]||m[x.id].trim()===""));C.filter(x=>x.level==="critical"||x.level==="high").length;const A=!X&&!d;Math.round((t.confidence||0)*100);const R=t.backendRequired===!1,D=()=>{const x={...t,requiresUserDecision:p.map(b=>({...b,answer:m[b.id]||""}))};r(x)};return e.jsxs("div",{className:"space-y-6 my-8 animate-in fade-in slide-in-from-bottom-4 duration-700",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-8 border border-violet-500/30 bg-violet-950/10 shadow-[0_0_60px_rgba(139,92,246,0.08)]",children:[e.jsx("div",{className:"absolute -top-20 -right-20 w-80 h-80 bg-violet-500/10 rounded-full blur-[100px]"}),e.jsxs("div",{className:"relative z-10",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsxs("span",{className:"flex items-center gap-2 px-4 py-1.5 rounded-full bg-violet-500/10 text-violet-300 border border-violet-500/30 text-xs font-black uppercase tracking-[0.2em]",children:[e.jsx(Kn,{className:"w-4 h-4"}),"Phase 5 — Audit Souverain"]}),e.jsx("span",{className:"h-px flex-1 bg-gradient-to-r from-violet-500/40 to-transparent"})]}),e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-4",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-violet-200 to-violet-400 tracking-tight",children:(t.projectType||"PROJET STANDARD").toUpperCase()}),e.jsx("p",{className:"text-sm text-zinc-400 mt-1 font-mono",children:n.split(/[\\/]/).pop()||n})]}),e.jsxs("div",{className:"flex flex-col items-end gap-2",children:[e.jsx(Tn,{value:t.confidence}),R?e.jsx("span",{className:"text-xs px-3 py-1 rounded-full bg-zinc-800 text-zinc-400 font-semibold",children:"🟡 Backend non requis"}):e.jsx("span",{className:"text-xs px-3 py-1 rounded-full bg-violet-500/20 text-violet-300 border border-violet-500/30 font-semibold",children:"🔌 Industrialisation complète"})]})]}),R&&e.jsxs("div",{className:"mt-4 p-4 bg-zinc-900/60 border border-zinc-700 rounded-2xl text-sm text-zinc-300",children:[e.jsx("strong",{className:"text-amber-400",children:"⚠️ Ce projet n'a pas besoin de backend."})," ","L'action recommandée est"," ",e.jsx("code",{className:"text-violet-300 bg-zinc-800 px-1.5 py-0.5 rounded text-xs",children:t.phase5Action||"skip_backend_integration"}),". Vous pouvez néanmoins confirmer pour générer le contrat."]})]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"rounded-2xl border border-violet-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-violet-400 mb-4 flex items-center gap-2",children:[e.jsx(jn,{className:"w-4 h-4"})," Capacités détectées (",S.length,")"]}),e.jsx("div",{className:"space-y-2",children:S.length===0?e.jsx("p",{className:"text-xs text-zinc-500",children:"Aucune capacité détectée."}):S.map(x=>e.jsx(_o,{cap:x},x.id))})]}),e.jsxs("div",{className:"rounded-2xl border border-amber-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-amber-400 mb-4 flex items-center gap-2",children:[e.jsx(co,{className:"w-4 h-4"})," Mocks à remplacer (",y.length,")"]}),y.length===0?e.jsx("p",{className:"text-xs text-zinc-500",children:"Aucun mock détecté."}):e.jsx("ul",{className:"space-y-2",children:y.map(x=>e.jsxs("li",{className:"flex items-start gap-3 p-3 rounded-xl bg-amber-950/10 border border-amber-500/20",children:[e.jsx(Ba,{className:"w-3.5 h-3.5 text-amber-400 mt-0.5 shrink-0"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-mono text-amber-200",children:x.path}),e.jsxs("p",{className:"text-[10px] text-zinc-400",children:[x.pattern," → ",e.jsx("span",{className:"text-violet-300",children:x.capability})]})]})]},x.id))})]})]}),M.length>0&&e.jsxs("div",{className:"rounded-2xl border border-cyan-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-cyan-400 mb-4 flex items-center gap-2",children:[e.jsx(Kn,{className:"w-4 h-4"})," Providers recommandés (",M.length,")"]}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-3",children:M.map((x,b)=>e.jsxs("div",{className:"p-3 rounded-xl bg-cyan-950/10 border border-cyan-500/20 space-y-1",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-xs font-bold text-cyan-300 font-mono",children:x.capability}),e.jsx(Tn,{value:x.confidence})]}),e.jsx("p",{className:"text-xs text-white font-semibold",children:x.provider||"À déterminer"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed",children:x.reason}),x.requiresConfirmation&&e.jsx("span",{className:"inline-block text-[10px] px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/30",children:"⚠️ Confirmation requise"})]},b))})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:[e.jsxs("div",{className:"rounded-2xl border border-emerald-500/20 bg-emerald-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-emerald-400 mb-3 flex items-center gap-2",children:[e.jsx(Ya,{className:"w-3.5 h-3.5"})," À créer (",F.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[F.slice(0,8).map((x,b)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["+ ",x]},b)),F.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",F.length-8," autres…"]})]})]}),e.jsxs("div",{className:"rounded-2xl border border-orange-500/20 bg-orange-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-orange-400 mb-3 flex items-center gap-2",children:[e.jsx(Za,{className:"w-3.5 h-3.5"})," À modifier (",Z.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[Z.slice(0,8).map((x,b)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["~ ",x]},b)),Z.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",Z.length-8," autres…"]})]})]}),e.jsxs("div",{className:"rounded-2xl border border-blue-500/20 bg-blue-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-blue-400 mb-3 flex items-center gap-2",children:[e.jsx(to,{className:"w-3.5 h-3.5"})," Préservés (",O.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[O.slice(0,8).map((x,b)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["🔒 ",x]},b)),O.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",O.length-8," autres…"]})]})]})]}),C.length>0&&e.jsxs("div",{className:"rounded-2xl border border-red-500/20 bg-red-950/5 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-red-400 mb-4 flex items-center gap-2",children:[e.jsx(kn,{className:"w-4 h-4"})," Risques identifiés (",C.length,")"]}),e.jsx("div",{className:"space-y-2",children:C.map((x,b)=>e.jsxs("div",{className:`flex items-start gap-3 p-3 rounded-xl border ${So[x.level]}`,children:[yo[x.level],e.jsxs("div",{children:[e.jsxs("span",{className:"text-[10px] font-black uppercase tracking-wider opacity-70",children:["[",x.level,"] ",x.code]}),e.jsx("p",{className:"text-xs mt-0.5",children:x.message})]})]},b))})]}),p.length>0&&e.jsxs("div",{className:"rounded-2xl border border-rose-500/40 bg-rose-950/10 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-rose-400 mb-4 flex items-center gap-2",children:[e.jsx($a,{className:"w-4 h-4"}),"Décisions utilisateur obligatoires (",p.filter(x=>x.required).length," BLOQUANTE(S))"]}),e.jsx("div",{className:"space-y-3",children:p.map(x=>{const b=!!(m[x.id]&&m[x.id].trim()!==""),q=(x.capability||x.id||"").toLowerCase().replace("-","_"),I={backend:["Node.js / Express","Python / FastAPI","Supabase (BaaS)","Firebase (BaaS)","Aucun (Front-end only)"],auth:["JWT Local personnalisé","Supabase Auth","Firebase Auth","Auth0","Clerk","Aucune authentification"],authentication:["JWT Local personnalisé","Supabase Auth","Firebase Auth","Auth0","Clerk","Aucune authentification"],data_persistence:["PostgreSQL","MongoDB","MySQL / MariaDB","SQLite local","Local Storage (Frontend)"],database:["PostgreSQL","MongoDB","MySQL / MariaDB","SQLite local","Local Storage (Frontend)"],routing:["React Router (SPA)","Next.js App Router","Vite Plugin Pages"],error_handling:["Gestionnaire global classique","Sentry","Winston / Morgan (Backend)"],design:["TailwindCSS natif","Material UI","Chakra UI","CSS Modules","Vanilla CSS"],file_upload:["AWS S3","Supabase Storage","Stockage local (Backend)","Cloudinary"],storage:["AWS S3","Supabase Storage","Stockage local (Backend)","Cloudinary"],ocr_processing:["Google Vision API","AWS Textract","Tesseract.js (Local)","API tierce dédiée"]},P=x.options&&x.options.length>0?x.options:I[q]||[],K=P.length>0,$=K&&b&&!P.includes(m[x.id])?"other":m[x.id]||"";return e.jsx("div",{className:`p-4 rounded-xl border transition-colors ${x.required&&!b?"border-rose-500/60 bg-rose-950/30":"border-zinc-700 bg-zinc-900/40"}`,children:e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsxs("div",{className:"flex items-start gap-2",children:[x.required?b?e.jsx(cs,{className:"w-4 h-4 text-emerald-400 shrink-0 mt-0.5"}):e.jsx(In,{className:"w-4 h-4 text-rose-400 shrink-0 mt-0.5"}):e.jsx(Qa,{className:"w-4 h-4 text-zinc-400 shrink-0 mt-0.5"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-semibold text-white",children:x.question}),e.jsxs("p",{className:"text-[10px] text-zinc-400 mt-0.5",children:["Lié à : ",e.jsx("span",{className:"font-mono text-violet-300",children:x.capability||x.id})]})]})]}),e.jsxs("div",{className:"space-y-2",children:[K&&e.jsxs("select",{value:$,onChange:H=>{H.target.value==="other"?h(re=>({...re,[x.id]:""})):h(re=>({...re,[x.id]:H.target.value}))},className:"w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-violet-500/50",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionner une réponse --"}),P.map(H=>e.jsx("option",{value:H,children:H},H)),e.jsx("option",{value:"other",children:"Autre (Saisie libre)..."})]}),(!K||$==="other")&&e.jsx("input",{type:"text",placeholder:"Tapez votre réponse précise ici...",value:m[x.id]||"",onChange:H=>h(re=>({...re,[x.id]:H.target.value})),autoFocus:$==="other",className:"w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white placeholder-zinc-600 focus:outline-none focus:border-violet-500/50"})]})]})},x.id)})}),X&&e.jsxs("p",{className:"mt-4 text-xs text-rose-300 font-semibold bg-rose-950/30 border border-rose-500/30 rounded-xl p-3 flex items-center gap-2",children:[e.jsx(In,{className:"w-4 h-4"})," La confirmation est bloquée jusqu'à ce que les décisions obligatoires ci-dessus soient résolues."]})]}),e.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-2 border border-violet-500/30 bg-zinc-950/80 backdrop-blur-xl shadow-2xl",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-violet-500/5 via-blue-500/5 to-cyan-500/5 pointer-events-none"}),e.jsxs("div",{className:"relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 p-4",children:[e.jsxs("div",{className:"text-xs text-zinc-400 max-w-sm leading-relaxed",children:[e.jsx("strong",{className:"text-violet-300",children:"La confirmation ne modifie aucun fichier."})," ","Elle envoie uniquement le contrat au moteur Kirov5 qui effectuera les vérifications de sécurité (drift, gates) avant toute mutation."]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("button",{type:"button",onClick:c,disabled:d,className:"px-5 py-3 rounded-2xl font-bold text-xs bg-white/5 hover:bg-white/10 text-zinc-300 border border-white/10 flex items-center gap-2 transition-all hover:scale-105 active:scale-95 disabled:opacity-50",children:"← Ré-auditer"}),e.jsxs("button",{type:"button",onClick:D,disabled:!A,title:X?"Résolvez les décisions obligatoires avant de confirmer":"",className:`px-8 py-3.5 rounded-2xl font-black text-sm flex items-center gap-3 transition-all relative overflow-hidden group
                ${A?"bg-gradient-to-r from-violet-500 to-cyan-500 hover:from-violet-400 hover:to-cyan-400 text-white shadow-[0_0_30px_rgba(139,92,246,0.4)] hover:shadow-[0_0_50px_rgba(139,92,246,0.6)] hover:scale-105 active:scale-95":"bg-zinc-800 text-zinc-500 cursor-not-allowed border border-zinc-700"}`,children:[A&&e.jsx("div",{className:"absolute inset-0 w-full h-full bg-white/10 -translate-x-full group-hover:animate-[shimmer_1.5s_infinite]"}),d?e.jsxs(e.Fragment,{children:[e.jsx(jn,{className:"w-4 h-4 animate-spin"}),"Envoi à Kirov5..."]}):X?e.jsxs(e.Fragment,{children:[e.jsx(In,{className:"w-4 h-4"}),"Répondez aux questions..."]}):e.jsxs(e.Fragment,{children:[e.jsx(lo,{className:"w-4 h-4"}),"🚀 Confirmer → Kirov5"]})]})]})]})]})]})},En=`Tu es un Architecte Logiciel Senior (Niveau Staff Engineer) spécialisé en Product Design, React/TypeScript, et Architecture d'Applications Web.
...
Réponds UNIQUEMENT avec le JSON demandé.`,wo=Object.freeze(Object.defineProperty({__proto__:null,SYSTEM_PROMPT:En},Symbol.toStringTag,{value:"Module"}));function us(t,n,r,c,d){let m=!1;t&&t.includes("[DESIGN RIP]")&&(m=!0,t=t.replace("[DESIGN RIP]","").trim());let h="";r?h=`
...
L'orchestrateur prend le relais pour générer le Backend et intégrer les composants.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(T=>{console.error(T),alert("Erreur: Le moteur n'a pas pu être contacté.")});return}typeof window<"u"&&(window.open("https://stitch.withgoogle.com/","_blank"),window.dispatchEvent(new CustomEvent("open-mouchard")));const ne=window.KIROV_SELECTED_PACKS&&window.KIROV_SELECTED_PACKS.length>0?window.KIROV_SELECTED_PACKS:D&&D.length>0?D:[];if(Number(A)===0){w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:"stitch",start_index:1,zip_mode:!0,start_phase:0,auto_pilot:Z,instructions:rt||"Génère l'application avec ces packs et directives.",packs:ne})}).then(T=>T?T.json():null).then(T=>{var dt;const me=(T==null?void 0:T.prompt)||((dt=T==null?void 0:T.data)==null?void 0:dt.prompt)||"Génération UI/UX Stitch complète.",ye=ne.length>0?ne.join(", "):"standard";if(R(2),typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase","2"),typeof document<"u"){const Me=document.getElementById("tiger-mega-prompt-overlay");Me&&Me.remove();const Ze=document.createElement("div");Ze.id="tiger-mega-prompt-overlay",Ze.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);backdrop-filter:blur(10px);z-index:999999;display:flex;align-items:center;justify-content:center;padding:16px;font-family:sans-serif;",Ze.innerHTML=`
                                  ...
                                  <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid rgba(255,255,255,0.1);padding-bottom:12px;">
                                    <div>
                                      ...
                                      <p style="margin:4px 0 0 0;font-size:11px;color:#94a3b8;">
                                        Projet : <strong style="color:#e2e8f0;">${v}</strong> | Pack PRD : <strong style="color:#a855f7;">${ye}</strong>
                                      </p>
                                    </div>
                              ...
                              `,document.body.appendChild(Ze);const _t=document.getElementById("tiger-prompt-area"),Ue=document.getElementById("btn-copy-prompt"),Oe=document.getElementById("btn-close-prompt-overlay"),Ye=document.getElementById("btn-open-stitch"),Ft=()=>{_t&&(_t.select(),_t.setSelectionRange(0,99999),document.execCommand("copy")),navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),R(2),Ue&&(Ue.innerHTML="✅ COPIÉ DANS LE PRESSE-PAPIER !",Ue.style.background="linear-gradient(135deg,#10b981,#059669)",setTimeout(()=>{Ue&&(Ue.innerHTML="📋 COPIER LE MÉGA-PROMPT",Ue.style.background="linear-gradient(135deg,#06b6d4,#2563eb)")},3e3))};Ue&&(Ue.onclick=()=>{Ft(),R(2)}),Oe&&(Oe.onclick=()=>{Ze.remove(),R(2)}),Ye&&(Ye.onclick=()=>{window.open("https://stitch.withgoogle.com/","_blank"),R(2)}),Ft(),R(2)}}).catch(T=>{console.error(T),alert("Erreur de communication avec le serveur Kirov5.")});return}w("/api/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:"stitch",user_prompt:rt||"Génère l'application avec ces packs et directives.",packs:ne,target_project:v,phase_num:1})}).then(T=>T?T.json():null).then(T=>{var ye;const me=(T==null?void 0:T.prompt)||((ye=T==null?void 0:T.data)==null?void 0:ye.prompt)||"Génération UI/UX Stitch.";typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),alert(`🚀 PHASE 1 (STITCH UI/UX) INITIALISÉE !
...
*Le fichier README complet est disponible dans le dossier prd_packs/${M.packId}/README.md.*`),e.jsxs("div",{className:"design-fenetre-readme w-full rounded-3xl p-6 md:p-8 border-2 border-cyan/60 shadow-[0_0_80px_rgba(124,58,237,0.45)] my-4 relative animate-fadeIn text-white z-20 flex flex-col min-h-[480px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 flex-shrink-0",children:[e.jsxs("span",{className:"px-3.5 py-1.5 bg-cyan/20 text-cyan text-xs font-bold rounded-xl border border-cyan/40 flex items-center gap-2 shadow-sm",children:[e.jsx("span",{children:"💎"})," PACK PRD : ",M.packId]}),e.jsx("button",{onClick:()=>se(null),className:"w-10 h-10 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-xl flex items-center justify-center font-bold text-lg transition-all border border-cyan/40 cursor-pointer shadow-md",title:"Fermer (Retour aux packs)",children:"✕"})]}),e.jsx("h2",{className:"text-2xl md:text-3xl font-black text-cyan mb-2 leading-tight drop-shadow-[0_2px_10px_rgba(6,182,212,0.5)] flex-shrink-0",children:M.packName}),e.jsx("div",{className:"w-full h-px bg-gradient-to-r from-cyan via-purple-400 to-cyan/20 mb-4 flex-shrink-0"}),e.jsx("div",{className:"design-readme-contenu flex-1 text-white font-medium leading-relaxed whitespace-pre-wrap overflow-y-auto max-h-[500px] p-6 rounded-2xl border-2 border-cyan/50 font-mono text-sm shadow-[0_0_40px_rgba(8,179,201,0.3)] min-h-[300px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)",textShadow:"0 1px 2px rgba(0,0,0,0.8)"},children:A}),e.jsxs("div",{className:"mt-6 pt-4 border-t border-white/15 flex justify-between items-center flex-shrink-0",children:[e.jsxs("span",{className:"text-xs text-cyan/90 font-mono font-bold tracking-widest uppercase flex items-center gap-2",children:[e.jsx("span",{children:"⚡"})," SUTURE PRD ENGINE"]}),e.jsx("button",{onClick:()=>se(null),className:"px-6 py-2.5 bg-cyan/20 hover:bg-cyan/40 text-cyan font-bold rounded-xl transition-all border border-cyan/40 flex items-center gap-2 cursor-pointer hover:bg-cyan/30 shadow-md",children:"← Fermer & Retour aux packs"})]})]})}return e.jsxs("div",{id:"prd-packs-carousel-section",className:"w-full flex-1 min-w-0 my-2",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3 px-2",children:[e.jsxs("h4",{className:"design-prd-titre-section font-black uppercase tracking-widest text-cyan flex items-center gap-2",children:[e.jsx("span",{children:"💎"})," PACKS PRD DE CONNAISSANCES (",Bt.length,")"]}),t&&t.length>0&&e.jsxs("span",{className:"text-[11px] font-bold text-cyan bg-cyan/20 px-2.5 py-1 rounded-full border border-cyan/30",children:[t.length," pack(s) actif(s)"]})]}),e.jsx("div",{className:"flex gap-4 items-stretch relative w-full",children:e.jsx("div",{className:"flex-1 min-w-0 min-h-[480px] overflow-hidden py-4 flex items-center",children:h?Z.length===0?e.jsxs("div",{className:"h-full min-h-[220px] rounded-2xl p-6 border border-purple-500/20 bg-purple-950/20 backdrop-blur-md flex flex-col items-center justify-center text-center",children:[e.jsx("p",{className:"text-purple-300 font-bold text-sm",children:"Aucun pack Guest n'a encore été généré."}),e.jsx("p",{className:"text-xs text-zinc-400 mt-2",children:"Utilisez l'interface V0-GUEST pour scanner un projet local et créer un pack sur-mesure."}),e.jsx("button",{onClick:X,className:"mt-4 text-xs text-purple-300 border border-purple-500/40 px-4 py-1.5 rounded-full hover:bg-purple-900/40 transition-colors",children:"🔄 Recharger les packs Guest"})]}):e.jsx(zt,{items:Z.filter(A=>{var D,x,b,q;if(!C)return!0;const R=C.toLowerCase();return((D=A.name)==null?void 0:D.toLowerCase().includes(R))||((x=A.description)==null?void 0:x.toLowerCase().includes(R))||((b=A.id)==null?void 0:b.toLowerCase().includes(R))||((q=A.category)==null?void 0:q.toLowerCase().includes(R))}).sort((A,R)=>(A.name||"").localeCompare(R.name||"")).map(A=>{const R=A.id,D=t?t.includes(R):!1;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${D?"border-purple-400 shadow-[0_0_25px_rgba(168,85,247,0.4)] bg-purple-950/60":"border-purple-500/20 hover:border-purple-400/60 bg-black/50"}`,children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${D?"bg-purple-500 text-white shadow-md":"bg-purple-500/20 text-purple-400 border border-purple-500/40"}`,children:e.jsx(jn,{size:18})}),e.jsx("span",{className:"px-2 py-0.5 bg-purple-500/20 text-purple-300 text-[10px] font-bold rounded-md uppercase tracking-wider border border-purple-500/30",children:"🐋 GUEST"})]}),n&&e.jsx("button",{onClick:x=>{x.stopPropagation(),n(R)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${D?"bg-purple-500 text-white shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-purple-500/40 hover:text-white"}`,children:D?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight truncate",children:A.name}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed text-zinc-300 text-xs line-clamp-4",children:A.description}),e.jsxs("div",{className:"mt-4 pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsxs("span",{className:"text-[10px] font-mono text-purple-400/80",children:[A.modulesCount," MODULES"]}),e.jsxs("button",{onClick:async()=>{var x;try{const b=await w(`http://localhost:5006/api/bridge/read-file?path=${encodeURIComponent(A.path+"/README.md")}`);let q="";if(b&&b.ok){const I=await b.json();q=((x=I.data)==null?void 0:x.content)||I.content||""}se({packId:R,packName:A.name,readmeText:q||`# PACK GUEST : ${A.name}

Spécifications techniques du pack Guest ${A.name}.

Module réutilisable scanné dans ${A.path}.`})}catch{se({packId:R,packName:A.name,readmeText:`# PACK GUEST : ${A.name}

Spécifications techniques du pack Guest ${A.name}.`})}},className:"design-prd-btn text-purple-400 text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-purple-500/30 transition-all",children:[e.jsx("span",{children:"📖"})," README →"]})]})]},R)})}):e.jsx(zt,{items:Bt.map(A=>{const R=A.id,D=A.name,x=A.icon||ls,b=t?t.includes(R):!1,P=(S[R]||gn(R)||"Spécifications techniques du contrat PRD.").replace(/^#+.*$/gm,"").replace(/^>.*$/gm,"").replace(/\[([^\]]+)\]\([^\)]+\)/g,"$1").replace(/[*_~`]/g,"").trim().split(`
`).map($=>$.trim()).filter($=>$.length>20),K=P.length>0?P[0]:"Spécifications techniques du contrat PRD.",z=K.length>180?K.substring(0,180)+"...":K;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${b?"border-cyan shadow-[0_0_25px_rgba(8,179,201,0.4)]":"border-white/10 hover:border-cyan/50"}`,style:{background:r?c("prd-card-"+R,.7):"rgba(0,0,0,0.7)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${b?"bg-cyan text-black shadow-md":A.color||"bg-cyan/20 text-cyan"}`,children:e.jsx(x,{size:20})}),e.jsx("span",{className:"px-2 py-0.5 bg-cyan/20 text-cyan text-[10px] font-bold rounded-md uppercase tracking-wider",children:"💎 PRD"})]}),n&&e.jsx("button",{onClick:$=>{$.stopPropagation(),n(R)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${b?"bg-cyan text-black shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-white/20 hover:text-white"}`,title:b?"Désélectionner ce pack":"Sélectionner ce pack pour l'IA",children:b?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight",children:D}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed",children:z}),e.jsxs("div",{className:"mt-auto pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-mono text-cyan/80",children:"MODULE PRD"}),e.jsxs("button",{onClick:async()=>{var H;let $=S[R]||gn(R)||"";try{const re=await w(`http://localhost:5006/api/bridge/read-file?packId=${encodeURIComponent(R)}`);if(re&&re.ok){const ge=await re.json(),G=ge.content||((H=ge.data)==null?void 0:H.content);G&&G.trim().length>5&&($=G,y(V=>({...V,[R]:G})))}}catch(re){console.warn("API Bridge read fallback",re)}se({packId:R,packName:D,readmeText:$||`# 💎 PRD PACK : ${D} (${R})

### ⚙️ Spécifications techniques du contrat PRD

- **Identifiant Pack**: ${R}
- **Statut**: Actif & Intégré au Moteur Sovereign`})},className:"design-prd-btn text-cyan text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-cyan/30 transition-all hover:bg-cyan/10",children:[e.jsx("span",{children:"📖"})," Lire le README →"]})]})]},R)})})})})]})},Xn=({isClient:t,getCachedGradient:n,setActiveProject:r,onOpenProject:c})=>{const[d,m]=l.useState([]),[h,p]=l.useState(!0),[C,S]=l.useState(!1),[y,M]=l.useState(null),[F,Z]=l.useState({}),[O,X]=l.useState({}),se=async(D,x)=>{D.preventDefault(),D.stopPropagation(),X(I=>({...I,[x]:{status:"building",progress:"Initialisation..."}}));const b=I=>{X(P=>({...P,[x]:{status:"building",progress:I}}))},q=(I,P)=>{X(K=>{var z;return{...K,[x]:{status:I,apkUrl:P||((z=K[x])==null?void 0:z.apkUrl),progress:I==="success"?"APK prêt !":"Échec compilation"}}}),I==="success"&&A()};try{const I=await w("http://localhost:5006/api/mobile/build-apk",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:x})});if(I&&I.ok){b("Compilation locale...");let P=0;const K=setInterval(async()=>{P++;try{const z=await w("http://localhost:5006/api/mobile/build-logs");if(z&&z.ok){const $=await z.json();if($.logs&&$.logs.length>0){const H=$.logs[$.logs.length-1];b(H.replace(/\[.*?\]/g,"").trim().substring(0,30))}if($.isBuilding===!1&&$.result)if(clearInterval(K),$.result.success){const H=$.result.apkUrl||`/api/mobile/download-apk?file=${encodeURIComponent(x+".apk")}`;q("success",H)}else b("Bascule Cloud..."),await Vt(x,b,q)}}catch{clearInterval(K),await Vt(x,b,q)}P>120&&clearInterval(K)},2e3)}else b("Bascule Cloud Souverain..."),await Vt(x,b,q)}catch{b("Bascule Cloud Souverain...");try{await Vt(x,b,q)}catch{q("error")}}},A=async()=>{try{let D=[];try{const x=await fetch("https://api.github.com/repos/turnzack/v0-reponse/releases");if(x.ok){const b=await x.json();Array.isArray(b)&&b.forEach(q=>{Array.isArray(q.assets)&&q.assets.forEach(I=>{var P;(P=I.name)!=null&&P.endsWith(".apk")&&D.push({file:I.name,name:I.name.replace(".apk",""),sizeMb:(I.size/(1024*1024)).toFixed(1),url:I.browser_download_url})})})}}catch{}try{const x=await w("http://localhost:5006/api/mobile/list-apks");if(x&&x.ok){const b=await x.json();b&&b.success&&Array.isArray(b.apks)&&(D=[...D,...b.apks])}else{const b=await fetch("/api/mobile/list-apks");if(b&&b.ok){const q=await b.json();q&&q.success&&Array.isArray(q.apks)&&(D=[...D,...q.apks])}}}catch{}if(D.length>0){const x={};D.forEach(b=>{x[b.name.toLowerCase()]=b,x[b.file.toLowerCase()]=b,x[b.name.toLowerCase().replace(/[^a-z0-9]/g,"")]=b}),Z(x)}}catch(D){console.warn("[WidgetProjects] fetchApks error",D)}},R=(D=!1)=>{D?S(!0):p(!0);const x=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];w("http://localhost:5006/api/projects").then(b=>b?b.json():null).then(b=>{if(b&&b.success&&b.projects)m(b.projects.map((q,I)=>({name:typeof q=="string"?q:q.projectName||q.name||q.projectId||q.project_id||q.title||`Projet_${I}`,desc:"Environnement Local",bg:x[I%x.length],installed:q.installed}))),p(!1),S(!1);else{const q=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:q?{Authorization:`Bearer ${q}`}:{}}).then(I=>I?I.json():null).then(I=>{I&&I.projects&&m(I.projects.map((P,K)=>({name:P.project_id||P.title||P.name||`Projet_${K}`,desc:"SaaS Cloud (Neon DB)",bg:x[K%x.length]}))),p(!1),S(!1)}).catch(()=>{p(!1),S(!1)})}}).catch(()=>{p(!1),S(!1)})};return l.useEffect(()=>{R(),A();const D=setInterval(()=>{R(!0),A()},5e3);return()=>clearInterval(D)},[]),h?e.jsx("div",{className:"p-4 text-cyan text-sm italic",children:"Actualisation de la liste des projets..."}):d.length===0?e.jsxs("div",{className:"p-4 flex flex-col items-center gap-3 text-center",children:[e.jsx("div",{className:"text-cyan text-sm italic",children:"Aucun projet trouvé sur votre disque dur."}),e.jsx("button",{onClick:()=>R(),className:"px-4 py-2 rounded-xl bg-cyan/20 border border-cyan/40 text-cyan text-xs font-bold hover:bg-cyan/40 transition-colors",children:"🔄 Rafraîchir la liste"})]}):e.jsx(zt,{items:[...d.map((D,x)=>{const b=D.name||"AUDIO",q=async()=>{if(M(b),c){c(b),setTimeout(()=>M(null),1e3);return}r&&r(b);try{w("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b,open_explorer:!1})}).catch(()=>{})}catch(V){console.error("Erreur de lancement :",V)}finally{setTimeout(()=>M(null),1e3)}},I=async V=>{if(V.preventDefault(),V.stopPropagation(),window.confirm(`⚠️ SUPPRESSION DEFINITIVE :
Voulez-vous vraiment supprimer le projet "${b}" de l'interface ET de votre disque dur ?`))try{const te=await w("http://localhost:5006/api/projects/remove-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})});if(!te){m(he=>he.filter(ee=>ee.name!==b));return}const le=await te.json();le.success?m(he=>he.filter(ee=>ee.name!==b)):alert(`Erreur lors de la suppression : ${le.message||"Échec server"}`)}catch(te){alert(`Erreur réseau lors de la suppression : ${te.message}`)}},P=O[b],K=(P==null?void 0:P.status)==="building",z=(P==null?void 0:P.status)==="success",$=b.toLowerCase(),H=$.replace(/[^a-z0-9]/g,""),re=F[$]||F[H]||F[`${$}.apk`],ge=z&&(P!=null&&P.apkUrl)?P.apkUrl:re?re.url:null,G=re!=null&&re.sizeMb?`${re.sizeMb}M`:"Prêt";return e.jsxs("div",{className:"design-carte-carrousel rounded-2xl p-5 border border-white/20 shadow-xl flex flex-col items-center text-center relative overflow-hidden group cursor-pointer",style:{background:t?n("proj-"+x,.7):"rgba(0,0,0,0.5)"},onClick:q,children:[ge?e.jsxs("a",{href:ge,download:`${b}.apk`,onClick:V=>V.stopPropagation(),className:"z-20 absolute top-3 left-3 bg-emerald-600 hover:bg-emerald-500 text-white text-[10px] font-black px-2.5 py-1 rounded-full flex items-center gap-1.5 shadow-lg border border-emerald-400/50 transition-all hover:scale-105 cursor-pointer animate-pulse",title:`Télécharger directement l'APK (${G})`,children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-white animate-ping"}),e.jsxs("span",{children:["📱 APK PRÊT (",G,")"]})]}):K?e.jsxs("div",{onClick:V=>V.stopPropagation(),className:"z-20 absolute top-3 left-3 bg-purple-700/90 text-white text-[10px] font-bold px-2.5 py-1 rounded-full flex items-center gap-1.5 shadow-lg border border-purple-400/60 animate-pulse select-none",title:(P==null?void 0:P.progress)||"Compilation de l'APK en cours...",children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-white animate-ping"}),e.jsx("span",{children:"⏳ APK EN COURS..."})]}):null,e.jsx("button",{onClick:I,className:"z-20 absolute top-3 right-3 w-8 h-8 rounded-full bg-red-600/80 hover:bg-red-500 text-white font-bold text-xs flex items-center justify-center transition-all shadow-lg hover:scale-110 cursor-pointer",title:"Supprimer ce projet du disque dur et de l'interface",children:"🗑️"}),e.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-30 mix-blend-overlay pointer-events-none"}),e.jsx("div",{className:"absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors z-0"}),e.jsxs("div",{className:"z-10 relative pointer-events-none w-full pr-8",children:[e.jsx("div",{className:"text-white/70 text-xs font-bold uppercase tracking-widest drop-shadow-md",children:"PROJET"}),e.jsx("h3",{className:"design-carte-titre text-xl font-black text-white break-all drop-shadow-lg leading-tight w-full",children:b})]}),e.jsx("div",{className:"design-carte-desc z-10 relative text-sm text-white/90 font-medium drop-shadow-md pointer-events-none w-full",children:D.desc}),e.jsxs("div",{className:"z-10 flex flex-wrap items-center justify-center gap-2 mt-3",children:[e.jsx("button",{onClick:V=>{V.stopPropagation(),y!==b&&(D.installed===!1?(M(b),w("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})}).then(te=>{alert(te?`📦 Installation des dépendances démarrée pour "${b}" !
Suivez la progression dans les logs.`:"Mode Cloud SaaS : Bridge local non connecté."),M(null),m(le=>le.map(he=>he.name===D.name?{...he,installed:!0}:he))}).catch(()=>M(null))):q())},disabled:y===b,className:`font-bold py-2 px-4 rounded-xl text-xs transition-all flex items-center gap-1.5 ${y===b?"bg-cyan-500/40 text-cyan-200 cursor-wait animate-pulse":D.installed===!1?"bg-orange-500/80 hover:bg-orange-600 text-white cursor-pointer":"bg-white/20 hover:bg-white/40 text-white cursor-pointer"}`,title:D.installed===!1?"Installer les dépendances requises pour ce projet":"Lancer la prévisualisation Vite",children:y===b?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin inline-block",children:"⏳"})," ",D.installed===!1?"Installation...":"Lancement..."]}):D.installed===!1?e.jsx(e.Fragment,{children:"📦 INSTALL"}):e.jsx(e.Fragment,{children:"🚀 PREVIEW"})}),ge?e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsxs("a",{href:ge,download:`${b}.apk`,onClick:V=>V.stopPropagation(),className:"bg-gradient-to-r from-emerald-600 to-green-500 hover:from-emerald-500 hover:to-green-400 text-white font-extrabold py-2 px-3.5 rounded-xl text-xs transition-all flex items-center gap-1.5 shadow-lg shadow-emerald-950/60 border border-emerald-400/50 cursor-pointer animate-pulse hover:scale-105",title:`Télécharger l'APK Android compilé de ${b} (${G}) directement`,children:[e.jsx("span",{children:"📥"}),e.jsx("span",{children:"APK"}),e.jsxs("span",{className:"text-[10px] opacity-90 font-mono",children:["(",G,")"]})]}),e.jsx("button",{onClick:V=>se(V,b),className:"bg-purple-600/30 hover:bg-purple-600/60 text-purple-200 hover:text-white font-bold py-2 px-2 rounded-xl text-xs transition-colors flex items-center justify-center border border-purple-400/40 cursor-pointer",title:"Re-compiler une nouvelle version de l'APK",children:"🔄"})]}):K?e.jsxs("div",{onClick:V=>V.stopPropagation(),className:"bg-purple-900/70 border border-purple-500/60 text-purple-200 font-bold py-2 px-3 rounded-xl text-xs flex items-center gap-1.5 shadow-lg shadow-purple-950/60 cursor-wait animate-pulse",title:(P==null?void 0:P.progress)||"Compilation APK en cours...",children:[e.jsx("span",{className:"animate-spin inline-block text-xs",children:"⏳"}),e.jsx("span",{className:"max-w-[110px] truncate text-[11px]",children:(P==null?void 0:P.progress)||"v0-apk..."})]}):e.jsxs("button",{onClick:V=>se(V,b),className:"bg-gradient-to-r from-purple-700/90 to-indigo-600/90 hover:from-purple-600 hover:to-indigo-500 text-white font-bold py-2 px-3 rounded-xl text-xs transition-all flex items-center gap-1.5 shadow-lg shadow-purple-950/60 border border-purple-400/50 hover:border-purple-300 cursor-pointer hover:scale-105",title:`Lancer la création du fichier APK pour "${b}" directement depuis le carrousel`,children:[e.jsx("span",{children:"📱"}),e.jsx("span",{children:"v0-apk action"})]}),D.installed!==!1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:V=>{V.stopPropagation(),M(b),w("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})}).then(te=>{alert(te?`🔄 Réinstallation des dépendances démarrée pour "${b}" !`:"Mode Cloud SaaS : Bridge local non connecté."),M(null)}).catch(()=>M(null))},className:"bg-orange-500/30 hover:bg-orange-500/60 text-white font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center justify-center border border-orange-500/40 cursor-pointer",title:"Forcer la réinstallation des dépendances (pnpm install)",children:"🔄"}),e.jsx("button",{onClick:async V=>{V.stopPropagation();try{M(b);const te=await w("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})});if(M(null),!te){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const le=await te.json();alert(le.message||`🚀 Serveur Vite démarré pour ${b} !`),le.previewUrl&&window.open(le.previewUrl,"_blank")}catch(te){M(null),alert("Erreur de connexion au bridge: "+te.message)}},className:"font-bold py-2 px-3 rounded-xl text-xs bg-purple-500/60 hover:bg-purple-500 text-white transition-all shadow-md cursor-pointer",title:"Lancer le serveur Vite avec pnpm run dev",children:"💻 PNPM"})]}),e.jsx("button",{onClick:I,className:"bg-red-600/30 hover:bg-red-600/60 text-red-200 border border-red-500/40 font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center gap-1",title:"Supprimer définitivement du disque dur",children:"🗑️ Supprimer"})]})]},x)})]})};function Bo({user:t,onLogout:n}={}){var qn;const r=l.useRef({}),c=(s,a=1)=>typeof window>"u"?`linear-gradient(135deg, rgba(17,17,17,${a}), rgba(34,34,34,${a}))`:(r.current[s]||(r.current[s]=Fo(a)),r.current[s]),d=(t==null?void 0:t.email)||(typeof window<"u"?localStorage.getItem("tiger_currentUserEmail"):null),m=!!(t!=null&&t.isSuperAdmin||d&&d.toLowerCase().trim()==="zacktunr@gmail.com");l.useEffect(()=>{t!=null&&t.email&&typeof window<"u"&&localStorage.setItem("tiger_currentUserEmail",t.email)},[t]);const h=()=>{typeof window<"u"&&(localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),localStorage.removeItem("tiger_lastGeneratedProject"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{})),n?n():typeof window<"u"&&window.location.reload()},[p,C]=l.useState([]),[S,y]=l.useState(""),M=l.useRef(null),F=l.useRef(null),[Z,O]=l.useState(!1),[X,se]=l.useState("connexion"),[A,R]=l.useState(!1),[D,x]=l.useState("clean");l.useRef(0);const[b,q]=l.useState(1),[I,P]=l.useState(!1),[K,z]=l.useState(!1),[$,H]=l.useState(!1);l.useEffect(()=>{let s=0;const a=setInterval(()=>{var o,_;if(typeof window<"u"){const u=(_=(o=window.Capacitor)==null?void 0:o.isNativePlatform)==null?void 0:_.call(o),f=!!window.AndroidBridge;(u||f)&&(z(!0),clearInterval(a))}s++>10&&clearInterval(a)},100);return()=>clearInterval(a)},[]);const[re,ge]=l.useState([]),[G,V]=l.useState(""),[te,le]=l.useState(["> Système Kirov5 initialisé. "+new Date().toLocaleTimeString()]),[he,ee]=l.useState([]),[j,Q]=l.useState([]);l.useEffect(()=>{const s=a=>Q(a.detail);return window.addEventListener("update_kirov_packs",s),()=>window.removeEventListener("update_kirov_packs",s)},[]),l.useEffect(()=>{window.KIROV_SELECTED_PACKS=j},[j]);const[ae,pe]=l.useState(!1),[ve,je]=l.useState(!1),[ke,U]=l.useState([]),[fe,Ie]=l.useState(!1),[be,ie]=l.useState(""),[Re,rt]=l.useState(""),[Te,Ee]=l.useState(!1),[ce,ht]=l.useState(""),[$e,Dn]=l.useState("Vite + React + Tailwind + TS"),[xt,bn]=l.useState(""),[wt,Et]=l.useState("deepseek"),[Ke,tn]=l.useState(""),[nn,Mn]=l.useState(!0),[sn,rn]=l.useState(!1),[ft,It]=l.useState(null),[Rt,it]=l.useState([]),[an,at]=l.useState(!1),Nt=l.useCallback(async s=>{at(!0);const a=[{id:"deepseek-r1-v0",tag:"⚡ DEEPSEEK R1",title:"DeepSeek-R1 & Moteur Souverain v0.1",desc:"Capacités de raisonnement avancé et de suture pour interfaces React.",content:`DeepSeek-R1 offre des capacités de raisonnement avancé pour l'analyse de contrats PRD et la génération zéro-touch de projets web complets.
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){it(a),at(!1);return}const o=s||localStorage.getItem("tiger_apiKey");if(!o||!o.startsWith("sk-")||o.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){it(a),at(!1);return}const _=new AbortController,u=setTimeout(()=>_.abort(),4e3),f=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o}`},signal:_.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(u),f.ok){const k=await f.json(),L=JSON.parse(k.choices[0].message.content);L.news&&Array.isArray(L.news)&&L.news.length>0?it(L.news):it(a)}else f.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),it(a)}catch(o){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",o),it(a)}finally{at(!1)}},[]);l.useEffect(()=>{Nt()},[Nt]);const[We,ot]=l.useState(!1),[Ne,Dt]=l.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Fe,bt]=l.useState([]),[Mt,on]=l.useState("");l.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let a=JSON.parse(s);if(!Array.isArray(a))throw new Error("Not an array");const o="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";a=a.map(_=>_.name==="fold"?{..._,colors:{..._.colors,"bg-app":o}}:_),bt(a)}catch{bt([])}else{const a={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};bt([a]),localStorage.setItem("tiger_saved_themes",JSON.stringify([a]))}},[]),l.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",Ne),Ne!=="random"){const a=((s=Fe.find(o=>o.name===Ne))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=a,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[Ne,Fe]);const Ce=()=>{if(!Mt.trim())return alert("Nom invalide");if(Fe.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":c("icon-settings",.8),"icon-ai":c("icon-ai",.8),"icon-projects":c("icon-projects",.8),"icon-packs":c("icon-packs",.8),"icon-news":c("icon-news",.8),"bg-app":c("bg-app",.9)},a={name:Mt.trim(),colors:s},o=[...Fe,a];bt(o),localStorage.setItem("tiger_saved_themes",JSON.stringify(o)),Dt(a.name),on("")},vn=(s,a)=>{a.stopPropagation();const o=Fe.filter(_=>_.name!==s);bt(o),localStorage.setItem("tiger_saved_themes",JSON.stringify(o)),Ne===s&&Dt("random")},qt=s=>{Q(a=>a.includes(s)?a.filter(o=>o!==s):[...a,s])},[Je,ln]=l.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});l.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(Je))},[Je]);const[Lt,Ge]=l.useState(!0),[Ve,Ae]=l.useState(!0),[N,Pe]=l.useState(null),[Be,cn]=l.useState(null),[De,Ut]=l.useState(null),[xe,et]=l.useState(null),[Ot,lt]=l.useState(""),[tt,At]=l.useState([]),[Xe,Kt]=l.useState(!1),[Qe,mt]=l.useState("idle"),[Pt,nt]=l.useState([]),[vt,dn]=l.useState(""),[kt,Wt]=l.useState(null),[gt,Sn]=l.useState([]),St=l.useCallback(async()=>{try{let s=[];try{const a=await fetch("https://api.github.com/repos/turnzack/v0-reponse/releases");if(a.ok){const o=await a.json();Array.isArray(o)&&o.forEach(_=>{Array.isArray(_.assets)&&_.assets.forEach(u=>{var f;(f=u.name)!=null&&f.endsWith(".apk")&&s.push({file:u.name,name:u.name.replace(".apk",""),sizeMb:(u.size/(1024*1024)).toFixed(1),url:u.browser_download_url})})})}}catch{}try{const a=await w("http://localhost:5006/api/mobile/list-apks");if(a&&a.ok){const o=await a.json();o&&o.success&&Array.isArray(o.apks)&&(s=[...s,...o.apks])}else{const o=await fetch("/api/mobile/list-apks");if(o&&o.ok){const _=await o.json();_&&_.success&&Array.isArray(_.apks)&&(s=[...s,..._.apks])}}}catch{}if(s.length>0){const a=new Set,o=s.filter(_=>a.has(_.file.toLowerCase())?!1:(a.add(_.file.toLowerCase()),!0));Sn(o)}}catch(s){console.warn("[v0-apk] loadAvailableApks error",s)}},[]);l.useEffect(()=>{Xe&&St()},[Xe,St]),l.useEffect(()=>{let s,a=0;return Qe==="building"&&(s=setInterval(async()=>{try{const o=await w("http://localhost:5006/api/mobile/build-logs");if(o&&o.ok){a=0;const _=await o.json();_.logs&&_.logs.length>0&&nt(_.logs),_.isBuilding===!1&&_.result&&(_.result.success?(mt("success"),Wt(_.result.apkUrl)):mt("error"),clearInterval(s))}else a++,a>=3&&(clearInterval(s),mt("error"),nt(_=>[..._,`❌ Service de compilation mobile absent sur ce serveur (${o?o.status:"erreur réseau"}).`,"📱 Option 1 (Cloud) : Déclenchez le compilateur automatique Cloud Souverain.",`💻 Option 2 (Local) : Lancez 'python apk_builder.py --src ... --name ${vt||N||"app"} --build' dans E:\\v0reponses\\v0-apk.`]))}catch(o){console.warn("Polling APK error",o)}},1500)),()=>{s&&clearInterval(s)}},[Qe,vt,N]),l.useEffect(()=>{w("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))ee(s.projects.map(a=>({name:typeof a=="string"?a:a.project_id||a.title||a.name||"Projet",desc:"Projet local",bg:""})));else{const a=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:a?{Authorization:`Bearer ${a}`}:{}}).then(o=>o?o.json():null).then(o=>{o&&o.projects&&ee(o.projects.map(_=>({name:typeof _=="string"?_:_.project_id||_.title||_.name||"Projet",desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[ct,Se]=l.useState(null),[Jt,yt]=l.useState(""),[jt,i]=l.useState(!1),[g,v]=l.useState(!1),E=l.useRef(null);l.useEffect(()=>{if(E.current=null,N==="v0-guest"||N==="V0-Guest")v(!0),Se("http://localhost:3007"),yt("http://localhost:3007"),E.current="http://localhost:3007";else if(N){v(!0);const s=De&&JSON.stringify(De).includes("next.config"),a=typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1",o=s?"http://localhost:3000":E.current||(a?`http://${window.location.hostname}:5173`:"http://localhost:5173");Se(o),yt(o),E.current=o}else v(!1),Se(null)},[N,De]),l.useEffect(()=>{const s=a=>{var o,_,u,f;if(((o=a.data)==null?void 0:o.type)==="CHANGE_PREVIEW_URL"){const k=a.data.route,L=k==="/"?"":`#${k}`;Se(Y=>{const W=Y?Y.split("#")[0]:"http://127.0.0.1:5175/";return`${W.endsWith("/")?W:`${W}/`}${L}`})}if(((_=a.data)==null?void 0:_.type)==="DESIGN_ELEMENT_CLICKED"||((u=a.data)==null?void 0:u.type)==="DESIGN_ELEMENT_DRAGGED"||((f=a.data)==null?void 0:f.type)==="DESIGN_ELEMENT_RESIZED"){const k=document.querySelector('iframe[title="Studio Admin Design"]');k&&k.contentWindow&&k.contentWindow.postMessage(a.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),l.useEffect(()=>{N&&w(`http://localhost:5006/api/fs/tree?project=${N}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&Ut(s.tree)}).catch(()=>{})},[N]),l.useEffect(()=>{N&&xe&&w(`http://localhost:5006/api/fs/read?project=${N}&file=${encodeURIComponent(xe)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&lt(s.content)}).catch(()=>{})},[N,xe]);const ne=async s=>{if(s===void 0||!N||!xe)return;if(lt(s),$t.isNativePlatform()||!!window.AndroidBridge)try{await $n.writeFile({path:`v0-moteur-mobile/projetv0/${N}/${xe}`,data:s,directory:xn.Documents,encoding:Pn.UTF8,recursive:!0})}catch(o){console.error("Erreur de sauvegarde mobile:",o)}else w("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:N,file:xe,content:s})}).catch(()=>{})},T=s=>{N&&w(`http://localhost:5006/api/fs/read?project=${N}&file=${encodeURIComponent(s)}`).then(a=>a?a.json():null).then(a=>{a&&a.success&&At(o=>o.find(_=>_.path===s)?o:[...o,{path:s,content:a.content}])}).catch(()=>{})};l.useEffect(()=>{(async()=>{const a=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if($t.isNativePlatform()||!!window.AndroidBridge)try{const u=(await $n.readdir({path:"v0-moteur-mobile/projetv0",directory:xn.Documents})).files.map(f=>f.name||f.toString());ee(u.map((f,k)=>({name:f,desc:"Mémoire Téléphone",bg:a[k%a.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else w("http://localhost:5006/api/projects-v2").then(_=>_?_.json():null).then(_=>{if(_&&_.success&&_.projects)ee(_.projects.map((u,f)=>({name:typeof u=="string"?u:u.name||u.project_id||u.title||`Projet_${f}`,desc:"Environnement Local",bg:a[f%a.length],installed:u.installed})));else{const u=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:u?{Authorization:`Bearer ${u}`}:{}}).then(f=>f?f.json():null).then(f=>{f&&f.projects&&ee(f.projects.map((k,L)=>({name:typeof k=="string"?k:k.project_id||k.title||k.name||`Projet_${L}`,desc:"SaaS Cloud (Neon DB)",bg:a[L%a.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),l.useEffect(()=>{P(!0)},[]);const[me,ye]=l.useState(!0);l.useEffect(()=>{const s=()=>ye(!0);window.addEventListener("open-mouchard",s);const a=o=>{if(o.data&&o.data.type==="TIGER_CAPTURE"){const _=o.data.data;if(_){let u="index.html";(_.includes("import React")||_.includes("export default"))&&(u="App.tsx"),_.includes("tailwindcss")&&(u="index.css"),et(u),ne(_),Ut(f=>{var Y;const k={name:u,path:u,type:"file"};return f?((Y=f.children)==null?void 0:Y.find(W=>W.name===u))?f:{...f,children:[...f.children||[],k]}:{name:"Mobile_Storage",type:"directory",children:[k]}})}}};return window.addEventListener("message",a),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("message",a)}},[N,xe]),l.useEffect(()=>{if(!I)return;const s=()=>{w("http://localhost:5006/api/bridge/queue").then(o=>o?o.json():null).then(o=>{o&&o.success&&(setBridgeQueueData({current:o.current||{},queue:o.queue||[]}),(o.queue&&o.queue.length>0||o.current&&Object.keys(o.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),w("http://localhost:5006/api/bridge/logs").then(o=>o?o.json():null).then(o=>{var _,u;if(o&&o.success&&o.logs){le(o.logs);const f=[...o.logs].reverse().find(L=>L.includes("URL_PREVIEW="));if(f){let L=(_=f.split("URL_PREVIEW=")[1])==null?void 0:_.trim();L&&typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"&&(L=L.replace(/localhost|127\.0\.0\.1/,window.location.hostname)),L&&L!==E.current&&(E.current=L,Se(L),yt(L),v(!0))}const k=[...o.logs].reverse().find(L=>L.includes("PIPELINE COMPLET TERMINÉ avec succès pour "));if(k){const L=(u=k.split("PIPELINE COMPLET TERMINÉ avec succès pour ")[1])==null?void 0:u.replace(/[.\s]+$/,"");L&&N!==L&&(Pe(L),v(!0))}}}).catch(()=>{}),w("http://localhost:5006/api/bridge/autonomous-status").then(o=>o?o.json():null).then(o=>{if(o&&o.success&&(o.data||o.status)){const u=(o.data||o.status).state;u==="diagnosing"||u==="repair_required"||u==="error"?x("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(u)||["starting_server","launch_requested","restarting"].includes(u)?x("working"):u==="ready"?x("clean"):N&&w(`http://localhost:5006/api/suture/status?project=${N}`).then(f=>f?f.json():null).then(f=>{f&&f.success&&f.status&&x(f.status)}).catch(()=>{})}}).catch(()=>{})};s();const a=setInterval(s,2e3);return()=>clearInterval(a)},[I,N]);const dt=s=>{Pe(s),et(null),lt(""),i(!1),ye(!1),v(!1),w("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:s,open_explorer:!1})}).then(async a=>{if(a&&a.ok){const o=await a.json().catch(()=>null);o!=null&&o.previewUrl&&(Se(o.previewUrl),yt(o.previewUrl))}}).catch(a=>console.error("Erreur de lancement preview:",a)),w(`http://localhost:5006/api/fs/tree?project=${encodeURIComponent(s)}`).then(a=>a?a.json():null).then(a=>{if(a&&a.success&&a.tree){Ut(a.tree);const o=u=>{if(!u)return null;if(u.type==="file"&&(u.path==="src/App.tsx"||u.path==="src/App.jsx"||u.name==="App.tsx"||u.name==="index.html"))return u.path;if(u.children&&Array.isArray(u.children))for(const f of u.children){const k=o(f);if(k)return k}return null},_=o(a.tree);_&&et(_)}}).catch(a=>console.error("Erreur chargement arborescence:",a))},Me=s=>{const a=typeof s=="string"?s:S;if(!a.trim())return;const o={id:Date.now().toString(),role:"user",content:a};C(u=>[...u,o]);const _=a.toLowerCase();setTimeout(()=>{let u={id:(Date.now()+1).toString(),role:"assistant",content:""};const f=_.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(f==="mes projets"||f.includes("liste des projet")||f==="projet"||f==="projets")u.content="Voici la liste de vos projets récents :",u.widget="projects";else if((f.includes("stitch")||f.includes("deepseek")||f.includes("design")||f.includes("logique"))&&(f.includes("modifi")||f.includes("ajoute")||f.includes("change")||f.includes("mise a jour")||f.includes("evolue")||f.includes("reprends")||f.includes("continue"))){const k=a.match(/\[(.*?)\]/),L=k?k[1]:null,Y=f.includes("deepseek")?"deepseek":"stitch";u.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${Y.toUpperCase()}) 🔄

J'injecte vos nouvelles directives directement dans votre interface... ${L?`
🔍 Recherche et AutoSwitch vers le projet : "${L}"`:"Reprise du travail en cours."}`,u.widget=null,w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Y,target_project:L,prompt:"Mise à jour (Reprise de projet) : "+a.replace(/\[.*?\]/,"").trim(),auto_submit:!0})}).catch(W=>console.log("Erreur de connexion au Bridge local pour l'injection",W))}else if(f.includes("cree")||f.includes("lance")||f.includes("projet")||f.includes("generation")){u.content=`🚀 DÉMARRAGE PARALLÈLE KIROV5 🚀
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,u.widget="phases",q(1);const k=N||(ce.trim()?ce.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+a.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(Pe(k),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",k),typeof window<"u"){const W=localStorage.getItem("tiger_targetAi")||"deepseek",J=localStorage.getItem("tiger_targetUiAi")||"stitch",qe=(B,ue=!1)=>pt(B,ue),ze=window.AndroidBridge;if(ze&&ze.openAIWithPrompt)ze.openAIWithPrompt(qe(J,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+a),ze.showToast&&ze.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const B=j&&j.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${j.length})]
`+j.map(we=>{const oe=Bt.find(_e=>_e.id===we);return`• ${oe?oe.name:we} (#${we})`}).join(`
`):"",ue="Génère l'interface UI/UX complète et moderne pour ce projet : "+a+B;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ue)}catch{}const st=()=>w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,prompt:ue,auto_submit:!0,project_id:k,phase_num:1,packs:j})});Je!==200&&(Ve?window.open(qe(J,!0),"kirov5_ai_target"):window.open(qe(J,!0),"_blank"),st().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(we=>console.error("Erreur sendUiPrompt",we))),setTimeout(()=>{const we=j&&j.length>0?a+B:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+a+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(we)}catch{}window.open(qe(W),"_blank"),w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:W,prompt:we,auto_submit:!0,project_id:k,phase_num:1,packs:j})}).catch(oe=>console.log("Erreur Bridge Logic Prompt:",oe)),j&&j.length>0?w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:W,user_prompt:we,packs:j,target_project:k})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(oe=>{console.log("Erreur Trombone Bridge:",oe)}):w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:W,prompt:we,auto_submit:!0,project_id:k,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}q(1);let L=1;const Y=setInterval(()=>{L++,L>11?clearInterval(Y):q(L)},1500)}else if(f.includes("youtube")||f.includes("video"))u.content="Voici les résultats YouTube pour votre recherche :",u.widget="youtube";else if(f.includes("actualite")||f.includes("ia")||f.includes("news")||f.includes("recherche")){const k=localStorage.getItem("tiger_apiKey");u.content="Actualités & Dernières Innovations IA :",u.widget="news",Nt(k||void 0)}else if(f.includes("parametre")||f.includes("reglage")||f.includes("configuration")||f.includes("setting"))u.content="Ouverture du panneau de configuration système :",u.widget="settings";else if(f.includes("[plugin:vite:")||f.includes("missing semicolon")||f.includes("syntaxerror")||f.includes("typescriptparsermixin")||f.includes("babel/parser")||f.includes("error")&&f.length>80){const k=N||"Projet_blog_8831";u.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${k}" avec la stack trace fournie... 🩺`,Oe("suture",a)}else if(u.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const k=window.AndroidBridge;k&&k.openAIWithPrompt?k.openAIWithPrompt("https://chat.deepseek.com/",a):window.open("https://chat.deepseek.com/","_blank")}C(k=>[...k,u])},600),y("")},Ze=async s=>{var ze;let a=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],o=null;const _=a.filter(B=>B.name.endsWith(".zip"));let u=[];if(_.length>0){C(B=>[...B,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const B=(await Zt(async()=>{const{default:ue}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:ue}},[])).default;for(const ue of _){o=ue;const we=await new B().loadAsync(ue);for(const[oe,_e]of Object.entries(we.files))if(!_e.dir&&!oe.includes("__MACOSX")&&!((ze=oe.split("/").pop())!=null&&ze.startsWith("."))){const Le=await _e.async("blob"),ut=new File([Le],oe.split("/").pop()||oe,{type:Le.type});u.push(ut)}}}catch(B){console.error("Erreur décompression ZIP:",B),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}for(const B of _)try{const ue=await B.arrayBuffer(),st=arrayBufferToBase64(ue);fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:N||G||ce||"AUDIO",fileName:B.name,fileBase64:st})}).catch(oe=>console.warn("[Upload ZIP Sync] Notice:",oe))}catch{}}a=[...a.filter(B=>!B.name.endsWith(".zip")),...u];const f=a.filter(B=>B.name.endsWith(".html")),k=a.filter(B=>!B.name.endsWith(".html")&&(B.name.endsWith(".png")||B.name.endsWith(".jpg")||B.name.endsWith(".jpeg")||B.name.endsWith(".md")||B.name.endsWith(".json")||B.name.endsWith(".txt")||B.name.endsWith(".tsx")||B.name.endsWith(".ts")||B.name.endsWith(".jsx")||B.name.endsWith(".js")||B.name.endsWith(".css")||B.name.endsWith(".svg")));if(f.length===0&&k.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .tsx, .ts, .png, ou un .zip.");return}let L=[...tt];for(const B of k){const ue=B.name.endsWith(".png")||B.name.endsWith(".jpg")||B.name.endsWith(".jpeg"),st=await new Promise(oe=>{const _e=new FileReader;_e.onload=Le=>{var ut;return oe((ut=Le.target)==null?void 0:ut.result)},ue?_e.readAsDataURL(B):_e.readAsText(B)}),we={path:B.name,content:ue?`[Image jointe visuellement : ${B.name} (Binaire ignoré pour économie de tokens)]`:st};L.some(oe=>oe.path===B.name)||L.push(we),C(oe=>[...oe,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${B.name}`}])}if(f.length>0){const B=f[0],ue=await new Promise(oe=>{const _e=new FileReader;_e.onload=Le=>{var ut;return oe((ut=Le.target)==null?void 0:ut.result)},_e.readAsText(B)}),st={path:B.name,content:ue};L.some(oe=>oe.path===B.name)||L.push(st);const we={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${B.name}
Analyse de la structure UI et assemblage du contexte en cours...`};C(oe=>[...oe,we])}const Y=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter(B=>B.name.endsWith(".zip"));for(const B of Y)L.some(ue=>ue.path===B.name)||L.push({path:B.name,content:"ZIP_ARCHIVE_DUMMY"});At(L);const W=N||ce||"Projet_Stitch",J=a.map(B=>B.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${W}: ${J}`);const qe=f.length;if(qe>3){const B=localStorage.getItem("tiger_targetAi")||"deepseek",ue=o?"Projet_ZIP_"+o.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),st=N||ue;N||Pe(st),C(oe=>[...oe,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !

Hermes a détecté ${qe} pages HTML dans votre ZIP.
Découpage automatique en lots de 3 fichiers en cours...
Démarrage de l'automatisation séquentielle via DeepSeek !`,widget:"phases"}]),q(1);let we="";if(o)we=await new Promise(oe=>{const _e=new FileReader;_e.onload=Le=>{var ut;return oe(((ut=Le.target)==null?void 0:ut.result).split(",")[1])},_e.readAsDataURL(o)});else{const oe=(await Zt(async()=>{const{default:Le}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:Le}},[])).default,_e=new oe;for(const Le of a)_e.file(Le.name,Le);we=await _e.generateAsync({type:"base64"})}w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({zip_base64:we,zip_mode:!0,target_ai:B,target_project:st,user_prompt:ce.trim()?`${ce} - ${xt}`:`Application multi-pages issue de ${(o==null?void 0:o.name)||"fichiers_locaux"}`})}).then(async oe=>{const _e=await oe.json();_e.success?(C(Le=>[...Le,{id:Date.now().toString()+"_hermes",role:"assistant",content:`✅ ${_e.message}

📡 Lot 1/${_e.total_batches} transmis à DeepSeek. Les lots suivants s'enchaîneront automatiquement !
Fichiers détectés : ${(_e.files_detected||[]).join(", ")}`}]),window.open(pt(B),"_blank")):alert("Erreur Hermes : "+(_e.error||"Inconnue"))}).catch(oe=>{alert(`Erreur de connexion au Moteur Local : ${oe.message}`)});return}if(f.length>0){if(document.getElementById("creation-mode-container"))return;setTimeout(()=>{_t(L)},1200)}},_t=async(s=tt)=>{Ee(!1);const a=s.find(W=>W.path.endsWith(".html"));if(!a){alert("Aucun fichier HTML trouvé dans le Trombone !");return}const o=ce.trim()?"Projet_"+ce.replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4):"Design_"+a.path.replace(".html","").replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4),_=N||o;if(!N){Pe(_);try{await w("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:_,file:"README.md",content:`# ${ce||_}

Initialisé par Tiger IA V0 (Design-First).`})})}catch(W){console.error("[IDE] Erreur création auto du dossier",W)}}const u=s.filter(W=>W.path!==a.path),f=a.content,k={id:(Date.now()+1).toString(),role:"assistant",content:`Mode "Design-First" activé. 🎨

Transmission du design au LLM avec les ${u.length} fichiers du Trombone intégrés.
Câblage en cours...`,widget:"phases"};q(5),C(W=>[...W,k]);let L=5;const Y=setInterval(()=>{L++,L>11?clearInterval(Y):q(L)},3e3);if(typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Mode Design-First Activé !"),typeof window<"u"){const W=localStorage.getItem("tiger_targetAi")||"deepseek";let J="";u.length>0&&(J=`
...
\`\`\`
`}));let qe="";(ce.trim()||$e.trim()||xt.trim())&&(qe=`
...
\`\`\`
`,B=window.AndroidBridge;if(B&&B.openAIWithPrompt){const ue=pt(W);B.openAIWithPrompt(ue,ze),B.showToast&&B.showToast("HTML injecté. Câblage sur "+W.toUpperCase()+" !")}else w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:W,prompt:ze,auto_submit:!0,project_id:_,phase_num:5})}).then(ue=>console.log("[Bridge] Prompt HTML + Contexte envoyé avec succès, status:",ue.status)).catch(ue=>console.error("[Bridge] Erreur lors de l'envoi du prompt:",ue))}},Ue=(s,a=0)=>s?s.type==="directory"?e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-2 px-2 py-1 hover:bg-white/5 cursor-pointer text-gray-300 text-sm",style:{paddingLeft:`${a*12+8}px`},children:[e.jsx("span",{className:"text-orange-400",children:"📁"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-dossier truncate font-bold",children:s.name})]}),s.children&&s.children.map(o=>Ue(o,a+1))]},s.path):e.jsxs("div",{className:`flex items-center justify-between px-2 py-1 hover:bg-white/10 cursor-pointer text-sm group ${xe===s.path?"bg-cyan/20 text-cyan border-l-2 border-cyan":"text-gray-400"}`,style:{paddingLeft:`${a*12+8}px`},onClick:()=>et(s.path),children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-blue-400",children:"📄"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-fichier truncate",children:s.name})]}),e.jsxs("div",{className:"hidden group-hover:flex items-center gap-1",children:[e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-red-500/50 transition-colors",title:"Suture : Réparer ou débugger ce fichier",onClick:o=>{o.stopPropagation(),et(s.path),setTimeout(()=>Oe("suture","Veuillez analyser ce fichier et corriger toutes les erreurs, fautes de frappe ou imports manquants."),100)},children:"🩺"}),e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-cyan/50 transition-colors",title:"Ajouter au Trombone",onClick:o=>{o.stopPropagation(),T(s.path)},children:"📎"})]})]},s.path):null,Oe=async(s,a)=>{if(!N){alert("⚠️ Veuillez sélectionner un projet actif dans l'explorateur.");return}const o=localStorage.getItem("tiger_targetAi")||"deepseek";let _="";s==="suture"?_=`🩺 SUTURE CHIRURGICALE — CORRECTION D'ERREUR DÉTECTÉE
...
`):s==="refactor"?_=`🔄 REFACTORING — Refactorise le code du projet [${N}] pour une qualité industrielle.

`:s==="improve"&&(_=`✨ AMÉLIORATION — Ajoute des animations et améliorations UI pour le projet [${N}].

`),xe&&Ot&&(_+=`--- Fichier Actif en Édition : ${xe} ---
\`\`\`
${Ot}
\`\`\`
...
\`\`\``,C(u=>[...u,{id:Date.now().toString()+"_action",role:"assistant",content:`🩺 Suture & Correction déclenchée pour "${N}". Transmission de l'erreur à ${o.toUpperCase()} en cours...`}]);try{if(await w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:o,prompt:_,auto_submit:!0,project_id:N,phase_num:s})}),s==="suture"){w("http://localhost:5006/v1/suture/start",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:N,activeFile:xe||"",rawError:a||"",prompt:a||"Analyse et corrige les erreurs du projet."})}).then(async f=>{const k=await f.json();k.success&&k.status==="applied"?C(L=>{var Y,W;return[...L,{id:Date.now().toString()+"_suture_ok",role:"assistant",content:`✅ Suture V2 réussie !

🔧 ${k.repairId}
🚀 Statut : **Patch appliqué en production**
📁 Fichiers corrigés : ${JSON.stringify(((W=(Y=k.patchReport)==null?void 0:Y.files)==null?void 0:W.map(J=>J.path))||[])}`}]}):k.success?C(L=>{var Y;return[...L,{id:Date.now().toString()+"_suture_partial",role:"assistant",content:`⚠️ Suture V2 : correctif généré mais non promu.
...
`:$e.includes("Canvas 2D")?L+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être un jeu Web 2D généré en **React + Vite + TypeScript (TSX) + Canvas 2D**.

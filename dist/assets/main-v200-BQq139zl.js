const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-D12TGwr4.js","assets/design-v200-DbCZFsQC.js","assets/design-v200-BH1kPxk1.css"])))=>i.map(i=>d[i]);
import{r as o,a as Rt,j as e,s as w,i as ys,R as _s}from"./design-v200-DbCZFsQC.js";const Cs="modulepreload",ws=function(t){return"/"+t},Gn={},nn=function(n,r,c){let u=Promise.resolve();if(r&&r.length>0){let h=function(y){return Promise.all(y.map(S=>Promise.resolve(S).then(L=>({status:"fulfilled",value:L}),L=>({status:"rejected",reason:L}))))};document.getElementsByTagName("link");const p=document.querySelector("meta[property=csp-nonce]"),C=(p==null?void 0:p.nonce)||(p==null?void 0:p.getAttribute("nonce"));u=h(r.map(y=>{if(y=ws(y),y in Gn)return;Gn[y]=!0;const S=y.endsWith(".css"),L=S?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${y}"]${L}`))return;const F=document.createElement("link");if(F.rel=S?"stylesheet":Cs,S||(F.as="script"),F.crossOrigin="",F.href=y,C&&F.setAttribute("nonce",C),document.head.appendChild(F),S)return new Promise((ee,O)=>{F.addEventListener("load",ee),F.addEventListener("error",()=>O(new Error(`Unable to preload CSS for ${y}`)))})}))}function m(h){const p=new Event("vite:preloadError",{cancelable:!0});if(p.payload=h,window.dispatchEvent(p),!p.defaultPrevented)throw h}return u.then(h=>{for(const p of h||[])p.status==="rejected"&&m(p.reason);return n().catch(m)})},Is=`# undefined
...
---
### 🔄 INSTRUCTION DE FUSION (Pour l'Orchestrateur API)
*Lorsque l'utilisateur sélectionnera ce pack "Audio" dans l'interface de Tiger IA, tu dois fusionner ces 10 capacités avec la demande précise du chat. Par exemple, si l'utilisateur demande "Crée moi un clone de Spotify", tu dois immédiatement mobiliser les modules \`prd_audio_file_library\`, \`prd_audio_player_podcast\` et \`prd_audio_mix_playlist\` pour générer une architecture complète en un seul shot.*`,js=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/widgets/hooks/useCalendarState.ts\``;function Vn(t,n){(n==null||n>t.length)&&(n=t.length);for(var r=0,c=Array(n);r<n;r++)c[r]=t[r];return c}function wi(t){if(Array.isArray(t))return t}function Ii(t,n,r){return(n=Ri(n))in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function Ai(t,n){var r=t==null?null:typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(r!=null){var c,u,m,h,p=[],C=!0,y=!1;try{if(m=(r=r.call(t)).next,n!==0)for(;!(C=(c=m.call(r)).done)&&(p.push(c.value),p.length!==n);C=!0);}catch(S){y=!0,u=S}finally{try{if(!C&&r.return!=null&&(h=r.return(),Object(h)!==h))return}finally{if(y)throw u}}return p}}function Pi(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Bn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);n&&(c=c.filter(function(u){return Object.getOwnPropertyDescriptor(t,u).enumerable})),r.push.apply(r,c)}return r}function zn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Bn(Object(r),!0).forEach(function(c){Ii(t,c,r[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Bn(Object(r)).forEach(function(c){Object.defineProperty(t,c,Object.getOwnPropertyDescriptor(r,c))})}return t}function ji(t,n){if(t==null)return{};var r,c,u=ki(t,n);if(Object.getOwnPropertySymbols){var m=Object.getOwnPropertySymbols(t);for(c=0;c<m.length;c++)r=m[c],n.indexOf(r)===-1&&{}.propertyIsEnumerable.call(t,r)&&(u[r]=t[r])}return u}function ki(t,n){if(t==null)return{};var r={};for(var c in t)if({}.hasOwnProperty.call(t,c)){if(n.indexOf(c)!==-1)continue;r[c]=t[c]}return r}function Ti(t,n){return wi(t)||Ai(t,n)||Ni(t,n)||Pi()}function Ei(t,n){if(typeof t!="object"||!t)return t;var r=t[Symbol.toPrimitive];if(r!==void 0){var c=r.call(t,n);if(typeof c!="object")return c;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}function Ri(t){var n=Ei(t,"string");return typeof n=="symbol"?n:n+""}function Ni(t,n){if(t){if(typeof t=="string")return Vn(t,n);var r={}.toString.call(t).slice(8,-1);return r==="Object"&&t.constructor&&(r=t.constructor.name),r==="Map"||r==="Set"?Array.from(t):r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?Vn(t,n):void 0}}function Di(t,n,r){return n in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function Hn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);n&&(c=c.filter(function(u){return Object.getOwnPropertyDescriptor(t,u).enumerable})),r.push.apply(r,c)}return r}function $n(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Hn(Object(r),!0).forEach(function(c){Di(t,c,r[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Hn(Object(r)).forEach(function(c){Object.defineProperty(t,c,Object.getOwnPropertyDescriptor(r,c))})}return t}function Mi(){for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r];return function(c){return n.reduceRight(function(u,m){return m(u)},c)}}function Yt(t){return function n(){for(var r=this,c=arguments.length,u=new Array(c),m=0;m<c;m++)u[m]=arguments[m];return u.length>=t.length?t.apply(this,u):function(){for(var h=arguments.length,p=new Array(h),C=0;C<h;C++)p[C]=arguments[C];return n.apply(r,[].concat(u,p))}}}function bn(t){return{}.toString.call(t).includes("Object")}function qi(t){return!Object.keys(t).length}function sn(t){return typeof t=="function"}function Li(t,n){return Object.prototype.hasOwnProperty.call(t,n)}function Ui(t,n){return bn(n)||It("changeType"),Object.keys(n).some(function(r){return!Li(t,r)})&&It("changeField"),n}function Oi(t){sn(t)||It("selectorType")}function Fi(t){sn(t)||bn(t)||It("handlerType"),bn(t)&&Object.values(t).some(function(n){return!sn(n)})&&It("handlersType")}function Gi(t){t||It("initialIsRequired"),bn(t)||It("initialType"),qi(t)&&It("initialContent")}function Vi(t,n){throw new Error(t[n]||t.default)}var Bi={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},It=Yt(Vi)(Bi),hn={changes:Ui,selector:Oi,handler:Fi,initial:Gi};function zi(t){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};hn.initial(t),hn.handler(n);var r={current:t},c=Yt(Ki)(r,n),u=Yt($i)(r),m=Yt(hn.changes)(t),h=Yt(Hi)(r);function p(){var y=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(S){return S};return hn.selector(y),y(r.current)}function C(y){Mi(c,u,m,h)(y)}return[p,C]}function Hi(t,n){return sn(n)?n(t.current):n}function $i(t,n){return t.current=$n($n({},t.current),n),n}function Ki(t,n,r){return sn(n)?n(t.current):Object.keys(r).forEach(function(c){var u;return(u=n[c])===null||u===void 0?void 0:u.call(n,t.current[c])}),r}var Wi={create:zi},Ji={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.55.1/min/vs"}};function Xi(t){return function n(){for(var r=this,c=arguments.length,u=new Array(c),m=0;m<c;m++)u[m]=arguments[m];return u.length>=t.length?t.apply(this,u):function(){for(var h=arguments.length,p=new Array(h),C=0;C<h;C++)p[C]=arguments[C];return n.apply(r,[].concat(u,p))}}}function Qi(t){return{}.toString.call(t).includes("Object")}function Zi(t){return t||Kn("configIsRequired"),Qi(t)||Kn("configType"),t.urls?(Yi(),{paths:{vs:t.urls.monacoBase}}):t}function Yi(){console.warn(ts.deprecation)}function ea(t,n){throw new Error(t[n]||t.default)}var ts={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},Kn=Xi(ea)(ts),ta={config:Zi},na=function(){for(var n=arguments.length,r=new Array(n),c=0;c<n;c++)r[c]=arguments[c];return function(u){return r.reduceRight(function(m,h){return h(m)},u)}};function ns(t,n){return Object.keys(n).forEach(function(r){n[r]instanceof Object&&t[r]&&Object.assign(n[r],ns(t[r],n[r]))}),zn(zn({},t),n)}var sa={type:"cancelation",msg:"operation is manually canceled"};function wn(t){var n=!1,r=new Promise(function(c,u){t.then(function(m){return n?u(sa):c(m)}),t.catch(u)});return r.cancel=function(){return n=!0},r}var ra=["monaco"],ia=Wi.create({config:Ji,isInitialized:!1,resolve:null,reject:null,monaco:null}),ss=Ti(ia,2),rn=ss[0],Sn=ss[1];function aa(t){var n=ta.config(t),r=n.monaco,c=ji(n,ra);Sn(function(u){return{config:ns(u.config,c),monaco:r}})}function oa(){var t=rn(function(n){var r=n.monaco,c=n.isInitialized,u=n.resolve;return{monaco:r,isInitialized:c,resolve:u}});if(!t.isInitialized){if(Sn({isInitialized:!0}),t.monaco)return t.resolve(t.monaco),wn(In);if(window.monaco&&window.monaco.editor)return rs(window.monaco),t.resolve(window.monaco),wn(In);na(la,da)(ua)}return wn(In)}function la(t){return document.body.appendChild(t)}function ca(t){var n=document.createElement("script");return t&&(n.src=t),n}function da(t){var n=rn(function(c){var u=c.config,m=c.reject;return{config:u,reject:m}}),r=ca("".concat(n.config.paths.vs,"/loader.js"));return r.onload=function(){return t()},r.onerror=n.reject,r}function ua(){var t=rn(function(r){var c=r.config,u=r.resolve,m=r.reject;return{config:c,resolve:u,reject:m}}),n=window.require;n.config(t.config),n(["vs/editor/editor.main"],function(r){var c=r.m||r;rs(c),t.resolve(c)},function(r){t.reject(r)})}function rs(t){rn().monaco||Sn({monaco:t})}function pa(){return rn(function(t){var n=t.monaco;return n})}var In=new Promise(function(t,n){return Sn({resolve:t,reject:n})}),is={config:aa,init:oa,__getMonacoInstance:pa},ma={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},An=ma,ga={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},ha=ga;function xa({children:t}){return Rt.createElement("div",{style:ha.container},t)}var fa=xa,ba=fa;function va({width:t,height:n,isEditorReady:r,loading:c,_ref:u,className:m,wrapperProps:h}){return Rt.createElement("section",{style:{...An.wrapper,width:t,height:n},...h},!r&&Rt.createElement(ba,null,c),Rt.createElement("div",{ref:u,style:{...An.fullWidth,...!r&&An.hide},className:m}))}var Sa=va,as=o.memo(Sa);function ya(t){o.useEffect(t,[])}var os=ya;function _a(t,n,r=!0){let c=o.useRef(!0);o.useEffect(c.current||!r?()=>{c.current=!1}:t,n)}var Ke=_a;function en(){}function Ht(t,n,r,c){return Ca(t,c)||wa(t,n,r,c)}function Ca(t,n){return t.editor.getModel(ls(t,n))}function wa(t,n,r,c){return t.editor.createModel(n,r,c?ls(t,c):void 0)}function ls(t,n){return t.Uri.parse(n)}function Ia({original:t,modified:n,language:r,originalLanguage:c,modifiedLanguage:u,originalModelPath:m,modifiedModelPath:h,keepCurrentOriginalModel:p=!1,keepCurrentModifiedModel:C=!1,theme:y="light",loading:S="Loading...",options:L={},height:F="100%",width:ee="100%",className:O,wrapperProps:X={},beforeMount:Y=en,onMount:A=en}){let[T,j]=o.useState(!1),[f,b]=o.useState(!0),E=o.useRef(null),I=o.useRef(null),P=o.useRef(null),K=o.useRef(A),G=o.useRef(Y),W=o.useRef(!1);os(()=>{let H=is.init();return H.then(B=>(I.current=B)&&b(!1)).catch(B=>(B==null?void 0:B.type)!=="cancelation"&&console.error("Monaco initialization: error:",B)),()=>E.current?ge():H.cancel()}),Ke(()=>{if(E.current&&I.current){let H=E.current.getOriginalEditor(),B=Ht(I.current,t||"",c||r||"text",m||"");B!==H.getModel()&&H.setModel(B)}},[m],T),Ke(()=>{if(E.current&&I.current){let H=E.current.getModifiedEditor(),B=Ht(I.current,n||"",u||r||"text",h||"");B!==H.getModel()&&H.setModel(B)}},[h],T),Ke(()=>{let H=E.current.getModifiedEditor();H.getOption(I.current.editor.EditorOption.readOnly)?H.setValue(n||""):n!==H.getValue()&&(H.executeEdits("",[{range:H.getModel().getFullModelRange(),text:n||"",forceMoveMarkers:!0}]),H.pushUndoStop())},[n],T),Ke(()=>{var H,B;(B=(H=E.current)==null?void 0:H.getModel())==null||B.original.setValue(t||"")},[t],T),Ke(()=>{let{original:H,modified:B}=E.current.getModel();I.current.editor.setModelLanguage(H,c||r||"text"),I.current.editor.setModelLanguage(B,u||r||"text")},[r,c,u],T),Ke(()=>{var H;(H=I.current)==null||H.editor.setTheme(y)},[y],T),Ke(()=>{var H;(H=E.current)==null||H.updateOptions(L)},[L],T);let z=o.useCallback(()=>{var re;if(!I.current)return;G.current(I.current);let H=Ht(I.current,t||"",c||r||"text",m||""),B=Ht(I.current,n||"",u||r||"text",h||"");(re=E.current)==null||re.setModel({original:H,modified:B})},[r,n,u,t,c,m,h]),se=o.useCallback(()=>{var H;!W.current&&P.current&&(E.current=I.current.editor.createDiffEditor(P.current,{automaticLayout:!0,...L}),z(),(H=I.current)==null||H.editor.setTheme(y),j(!0),W.current=!0)},[L,y,z]);o.useEffect(()=>{T&&K.current(E.current,I.current)},[T]),o.useEffect(()=>{!f&&!T&&se()},[f,T,se]);function ge(){var B,re,oe,he;let H=(B=E.current)==null?void 0:B.getModel();p||((re=H==null?void 0:H.original)==null||re.dispose()),C||((oe=H==null?void 0:H.modified)==null||oe.dispose()),(he=E.current)==null||he.dispose()}return Rt.createElement(as,{width:ee,height:F,isEditorReady:T,loading:S,_ref:P,className:O,wrapperProps:X})}var Aa=Ia;o.memo(Aa);function Pa(t){let n=o.useRef();return o.useEffect(()=>{n.current=t},[t]),n.current}var ja=Pa,xn=new Map;function ka({defaultValue:t,defaultLanguage:n,defaultPath:r,value:c,language:u,path:m,theme:h="light",line:p,loading:C="Loading...",options:y={},overrideServices:S={},saveViewState:L=!0,keepCurrentModel:F=!1,width:ee="100%",height:O="100%",className:X,wrapperProps:Y={},beforeMount:A=en,onMount:T=en,onChange:j,onValidate:f=en}){let[b,E]=o.useState(!1),[I,P]=o.useState(!0),K=o.useRef(null),G=o.useRef(null),W=o.useRef(null),z=o.useRef(T),se=o.useRef(A),ge=o.useRef(),H=o.useRef(c),B=ja(m),re=o.useRef(!1),oe=o.useRef(!1);os(()=>{let R=is.init();return R.then(Q=>(K.current=Q)&&P(!1)).catch(Q=>(Q==null?void 0:Q.type)!=="cancelation"&&console.error("Monaco initialization: error:",Q)),()=>G.current?ne():R.cancel()}),Ke(()=>{var Q,ae,pe,Se;let R=Ht(K.current,t||c||"",n||u||"",m||r||"");R!==((Q=G.current)==null?void 0:Q.getModel())&&(L&&xn.set(B,(ae=G.current)==null?void 0:ae.saveViewState()),(pe=G.current)==null||pe.setModel(R),L&&((Se=G.current)==null||Se.restoreViewState(xn.get(m))))},[m],b),Ke(()=>{var R;(R=G.current)==null||R.updateOptions(y)},[y],b),Ke(()=>{!G.current||c===void 0||(G.current.getOption(K.current.editor.EditorOption.readOnly)?G.current.setValue(c):c!==G.current.getValue()&&(oe.current=!0,G.current.executeEdits("",[{range:G.current.getModel().getFullModelRange(),text:c,forceMoveMarkers:!0}]),G.current.pushUndoStop(),oe.current=!1))},[c],b),Ke(()=>{var Q,ae;let R=(Q=G.current)==null?void 0:Q.getModel();R&&u&&((ae=K.current)==null||ae.editor.setModelLanguage(R,u))},[u],b),Ke(()=>{var R;p!==void 0&&((R=G.current)==null||R.revealLine(p))},[p],b),Ke(()=>{var R;(R=K.current)==null||R.editor.setTheme(h)},[h],b);let he=o.useCallback(()=>{var R;if(!(!W.current||!K.current)&&!re.current){se.current(K.current);let Q=m||r,ae=Ht(K.current,c||t||"",n||u||"",Q||"");G.current=(R=K.current)==null?void 0:R.editor.create(W.current,{model:ae,automaticLayout:!0,...y},S),L&&G.current.restoreViewState(xn.get(Q)),K.current.editor.setTheme(h),p!==void 0&&G.current.revealLine(p),E(!0),re.current=!0}},[t,n,r,c,u,m,y,S,L,h,p]);o.useEffect(()=>{b&&z.current(G.current,K.current)},[b]),o.useEffect(()=>{!I&&!b&&he()},[I,b,he]),H.current=c,o.useEffect(()=>{var R,Q;b&&j&&((R=ge.current)==null||R.dispose(),ge.current=(Q=G.current)==null?void 0:Q.onDidChangeModelContent(ae=>{oe.current||j(G.current.getValue(),ae)}))},[b,j]),o.useEffect(()=>{if(b){let R=K.current.editor.onDidChangeMarkers(Q=>{var pe;let ae=(pe=G.current.getModel())==null?void 0:pe.uri;if(ae&&Q.find(Se=>Se.path===ae.path)){let Se=K.current.editor.getModelMarkers({resource:ae});f==null||f(Se)}});return()=>{R==null||R.dispose()}}return()=>{}},[b,f]);function ne(){var R,Q;(R=ge.current)==null||R.dispose(),F?L&&xn.set(m,G.current.saveViewState()):(Q=G.current.getModel())==null||Q.dispose(),G.current.dispose()}return Rt.createElement(as,{width:ee,height:O,isEditorReady:b,loading:C,_ref:W,className:X,wrapperProps:Y})}var Ta=ka,Ea=o.memo(Ta),Ra=Ea;/*! Capacitor: https://capacitorjs.com/ - MIT License */const Na=t=>{const n=new Map;n.set("web",{name:"web"});const r=t.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:n},c=(m,h)=>{r.platforms.set(m,h)},u=m=>{r.platforms.has(m)&&(r.currentPlatform=r.platforms.get(m))};return r.addPlatform=c,r.setPlatform=u,r},Da=t=>t.CapacitorPlatforms=Na(t),cs=Da(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});cs.addPlatform;cs.setPlatform;var Jt;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(Jt||(Jt={}));class Pn extends Error{constructor(n,r,c){super(n),this.message=n,this.code=r,this.data=c}}const Ma=t=>{var n,r;return t!=null&&t.androidBridge?"android":!((r=(n=t==null?void 0:t.webkit)===null||n===void 0?void 0:n.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},qa=t=>{var n,r,c,u,m;const h=t.CapacitorCustomPlatform||null,p=t.Capacitor||{},C=p.Plugins=p.Plugins||{},y=t.CapacitorPlatforms,S=()=>h!==null?h.name:Ma(t),L=((n=y==null?void 0:y.currentPlatform)===null||n===void 0?void 0:n.getPlatform)||S,F=()=>L()!=="web",ee=((r=y==null?void 0:y.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||F,O=I=>{const P=f.get(I);return!!(P!=null&&P.platforms.has(L())||A(I))},X=((c=y==null?void 0:y.currentPlatform)===null||c===void 0?void 0:c.isPluginAvailable)||O,Y=I=>{var P;return(P=p.PluginHeaders)===null||P===void 0?void 0:P.find(K=>K.name===I)},A=((u=y==null?void 0:y.currentPlatform)===null||u===void 0?void 0:u.getPluginHeader)||Y,T=I=>t.console.error(I),j=(I,P,K)=>Promise.reject(`${K} does not have an implementation of "${P}".`),f=new Map,b=(I,P={})=>{const K=f.get(I);if(K)return console.warn(`Capacitor plugin "${I}" already registered. Cannot register plugins twice.`),K.proxy;const G=L(),W=A(I);let z;const se=async()=>(!z&&G in P?z=typeof P[G]=="function"?z=await P[G]():z=P[G]:h!==null&&!z&&"web"in P&&(z=typeof P.web=="function"?z=await P.web():z=P.web),z),ge=(ne,R)=>{var Q,ae;if(W){const pe=W==null?void 0:W.methods.find(Se=>R===Se.name);if(pe)return pe.rtype==="promise"?Se=>p.nativePromise(I,R.toString(),Se):(Se,Ee)=>p.nativeCallback(I,R.toString(),Se,Ee);if(ne)return(Q=ne[R])===null||Q===void 0?void 0:Q.bind(ne)}else{if(ne)return(ae=ne[R])===null||ae===void 0?void 0:ae.bind(ne);throw new Pn(`"${I}" plugin is not implemented on ${G}`,Jt.Unimplemented)}},H=ne=>{let R;const Q=(...ae)=>{const pe=se().then(Se=>{const Ee=ge(Se,ne);if(Ee){const Te=Ee(...ae);return R=Te==null?void 0:Te.remove,Te}else throw new Pn(`"${I}.${ne}()" is not implemented on ${G}`,Jt.Unimplemented)});return ne==="addListener"&&(pe.remove=async()=>R()),pe};return Q.toString=()=>`${ne.toString()}() { [capacitor code] }`,Object.defineProperty(Q,"name",{value:ne,writable:!1,configurable:!1}),Q},B=H("addListener"),re=H("removeListener"),oe=(ne,R)=>{const Q=B({eventName:ne},R),ae=async()=>{const Se=await Q;re({eventName:ne,callbackId:Se},R)},pe=new Promise(Se=>Q.then(()=>Se({remove:ae})));return pe.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await ae()},pe},he=new Proxy({},{get(ne,R){switch(R){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return W?oe:B;case"removeListener":return re;default:return H(R)}}});return C[I]=he,f.set(I,{name:I,proxy:he,platforms:new Set([...Object.keys(P),...W?[G]:[]])}),he},E=((m=y==null?void 0:y.currentPlatform)===null||m===void 0?void 0:m.registerPlugin)||b;return p.convertFileSrc||(p.convertFileSrc=I=>I),p.getPlatform=L,p.handleError=T,p.isNativePlatform=ee,p.isPluginAvailable=X,p.pluginMethodNoop=j,p.registerPlugin=E,p.Exception=Pn,p.DEBUG=!!p.DEBUG,p.isLoggingEnabled=!!p.isLoggingEnabled,p.platform=p.getPlatform(),p.isNative=p.isNativePlatform(),p},La=t=>t.Capacitor=qa(t),Xt=La(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Mn=Xt.registerPlugin;Xt.Plugins;class ds{constructor(n){this.listeners={},this.retainedEventArguments={},this.windowListeners={},n&&(console.warn(`Capacitor WebPlugin "${n.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=n)}addListener(n,r){let c=!1;this.listeners[n]||(this.listeners[n]=[],c=!0),this.listeners[n].push(r);const m=this.windowListeners[n];m&&!m.registered&&this.addWindowListener(m),c&&this.sendRetainedArgumentsForEvent(n);const h=async()=>this.removeListener(n,r);return Promise.resolve({remove:h})}async removeAllListeners(){this.listeners={};for(const n in this.windowListeners)this.removeWindowListener(this.windowListeners[n]);this.windowListeners={}}notifyListeners(n,r,c){const u=this.listeners[n];if(!u){if(c){let m=this.retainedEventArguments[n];m||(m=[]),m.push(r),this.retainedEventArguments[n]=m}return}u.forEach(m=>m(r))}hasListeners(n){return!!this.listeners[n].length}registerWindowListener(n,r){this.windowListeners[r]={registered:!1,windowEventName:n,pluginEventName:r,handler:c=>{this.notifyListeners(r,c)}}}unimplemented(n="not implemented"){return new Xt.Exception(n,Jt.Unimplemented)}unavailable(n="not available"){return new Xt.Exception(n,Jt.Unavailable)}async removeListener(n,r){const c=this.listeners[n];if(!c)return;const u=c.indexOf(r);this.listeners[n].splice(u,1),this.listeners[n].length||this.removeWindowListener(this.windowListeners[n])}addWindowListener(n){window.addEventListener(n.windowEventName,n.handler),n.registered=!0}removeWindowListener(n){n&&(window.removeEventListener(n.windowEventName,n.handler),n.registered=!1)}sendRetainedArgumentsForEvent(n){const r=this.retainedEventArguments[n];r&&(delete this.retainedEventArguments[n],r.forEach(c=>{this.notifyListeners(n,c)}))}}const Wn=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Jn=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Ua extends ds{async getCookies(){const n=document.cookie,r={};return n.split(";").forEach(c=>{if(c.length<=0)return;let[u,m]=c.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");u=Jn(u).trim(),m=Jn(m).trim(),r[u]=m}),r}async setCookie(n){try{const r=Wn(n.key),c=Wn(n.value),u=`; expires=${(n.expires||"").replace("expires=","")}`,m=(n.path||"/").replace("path=",""),h=n.url!=null&&n.url.length>0?`domain=${n.url}`:"";document.cookie=`${r}=${c||""}${u}; path=${m}; ${h};`}catch(r){return Promise.reject(r)}}async deleteCookie(n){try{document.cookie=`${n.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{const n=document.cookie.split(";")||[];for(const r of n)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(n){return Promise.reject(n)}}async clearAllCookies(){try{await this.clearCookies()}catch(n){return Promise.reject(n)}}}Mn("CapacitorCookies",{web:()=>new Ua});const Oa=async t=>new Promise((n,r)=>{const c=new FileReader;c.onload=()=>{const u=c.result;n(u.indexOf(",")>=0?u.split(",")[1]:u)},c.onerror=u=>r(u),c.readAsDataURL(t)}),Fa=(t={})=>{const n=Object.keys(t);return Object.keys(t).map(u=>u.toLocaleLowerCase()).reduce((u,m,h)=>(u[m]=t[n[h]],u),{})},Ga=(t,n=!0)=>t?Object.entries(t).reduce((c,u)=>{const[m,h]=u;let p,C;return Array.isArray(h)?(C="",h.forEach(y=>{p=n?encodeURIComponent(y):y,C+=`${m}=${p}&`}),C.slice(0,-1)):(p=n?encodeURIComponent(h):h,C=`${m}=${p}`),`${c}&${C}`},"").substr(1):null,Va=(t,n={})=>{const r=Object.assign({method:t.method||"GET",headers:t.headers},n),u=Fa(t.headers)["content-type"]||"";if(typeof t.data=="string")r.body=t.data;else if(u.includes("application/x-www-form-urlencoded")){const m=new URLSearchParams;for(const[h,p]of Object.entries(t.data||{}))m.set(h,p);r.body=m.toString()}else if(u.includes("multipart/form-data")||t.data instanceof FormData){const m=new FormData;if(t.data instanceof FormData)t.data.forEach((p,C)=>{m.append(C,p)});else for(const p of Object.keys(t.data))m.append(p,t.data[p]);r.body=m;const h=new Headers(r.headers);h.delete("content-type"),r.headers=h}else(u.includes("application/json")||typeof t.data=="object")&&(r.body=JSON.stringify(t.data));return r};class Ba extends ds{async request(n){const r=Va(n,n.webFetchExtra),c=Ga(n.params,n.shouldEncodeUrlParams),u=c?`${n.url}?${c}`:n.url,m=await fetch(u,r),h=m.headers.get("content-type")||"";let{responseType:p="text"}=m.ok?n:{};h.includes("application/json")&&(p="json");let C,y;switch(p){case"arraybuffer":case"blob":y=await m.blob(),C=await Oa(y);break;case"json":C=await m.json();break;case"document":case"text":default:C=await m.text()}const S={};return m.headers.forEach((L,F)=>{S[F]=L}),{data:C,headers:S,status:m.status,url:m.url}}async get(n){return this.request(Object.assign(Object.assign({},n),{method:"GET"}))}async post(n){return this.request(Object.assign(Object.assign({},n),{method:"POST"}))}async put(n){return this.request(Object.assign(Object.assign({},n),{method:"PUT"}))}async patch(n){return this.request(Object.assign(Object.assign({},n),{method:"PATCH"}))}async delete(n){return this.request(Object.assign(Object.assign({},n),{method:"DELETE"}))}}Mn("CapacitorHttp",{web:()=>new Ba});var vn;(function(t){t.Documents="DOCUMENTS",t.Data="DATA",t.Library="LIBRARY",t.Cache="CACHE",t.External="EXTERNAL",t.ExternalStorage="EXTERNAL_STORAGE"})(vn||(vn={}));var Tn;(function(t){t.UTF8="utf8",t.ASCII="ascii",t.UTF16="utf16"})(Tn||(Tn={}));const Xn=Mn("Filesystem",{web:()=>nn(()=>import("./web-v200-D12TGwr4.js"),__vite__mapDeps([0,1,2])).then(t=>new t.FilesystemWeb)});/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $a=o.forwardRef(({color:t="currentColor",size:n=24,strokeWidth:r=2,absoluteStrokeWidth:c,className:u="",children:m,iconNode:h,...p},C)=>o.createElement("svg",{ref:C,...Ha,width:n,height:n,stroke:t,strokeWidth:c?Number(r)*24/Number(n):r,className:us("lucide",u),...p},[...h.map(([y,S])=>o.createElement(y,S)),...Array.isArray(m)?m:[m]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const de=(t,n)=>{const r=o.forwardRef(({className:c,...u},m)=>o.createElement($a,{ref:m,iconNode:n,className:us(`lucide-${za(t)}`,c),...u}));return r.displayName=`${t}`,r};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jn=de("Ban",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m4.9 4.9 14.2 14.2",key:"1m5liu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
Réponds UNIQUEMENT avec le JSON demandé.`,jo=Object.freeze(Object.defineProperty({__proto__:null,SYSTEM_PROMPT:Dn},Symbol.toStringTag,{value:"Module"}));function hs(t,n,r,c,u){let m=!1;t&&t.includes("[DESIGN RIP]")&&(m=!0,t=t.replace("[DESIGN RIP]","").trim());let h="";r?h=`
...
`:c&&(u&&(u.transcript||u.description)?h=`
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){at(a),ot(!1);return}const l=s||localStorage.getItem("tiger_apiKey");if(!l||!l.startsWith("sk-")||l.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){at(a),ot(!1);return}const _=new AbortController,d=setTimeout(()=>_.abort(),4e3),x=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${l}`},signal:_.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(d),x.ok){const k=await x.json(),M=JSON.parse(k.choices[0].message.content);M.news&&Array.isArray(M.news)&&M.news.length>0?at(M.news):at(a)}else x.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),at(a)}catch(l){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",l),at(a)}finally{ot(!1)}},[]);o.useEffect(()=>{Mt()},[Mt]);const[Xe,lt]=o.useState(!1),[Me,qt]=o.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Ve,St]=o.useState([]),[Lt,un]=o.useState("");o.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let a=JSON.parse(s);if(!Array.isArray(a))throw new Error("Not an array");const l="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";a=a.map(_=>_.name==="fold"?{..._,colors:{..._.colors,"bg-app":l}}:_),St(a)}catch{St([])}else{const a={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};St([a]),localStorage.setItem("tiger_saved_themes",JSON.stringify([a]))}},[]),o.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",Me),Me!=="random"){const a=((s=Ve.find(l=>l.name===Me))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=a,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[Me,Ve]);const we=()=>{if(!Lt.trim())return alert("Nom invalide");if(Ve.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":c("icon-settings",.8),"icon-ai":c("icon-ai",.8),"icon-projects":c("icon-projects",.8),"icon-packs":c("icon-packs",.8),"icon-news":c("icon-news",.8),"bg-app":c("bg-app",.9)},a={name:Lt.trim(),colors:s},l=[...Ve,a];St(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),qt(a.name),un("")},_n=(s,a)=>{a.stopPropagation();const l=Ve.filter(_=>_.name!==s);St(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),Me===s&&qt("random")},Ut=s=>{Q(a=>a.includes(s)?a.filter(l=>l!==s):[...a,s])},[Qe,pn]=o.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});o.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(Qe))},[Qe]);const[Ot,Be]=o.useState(!0),[ze,je]=o.useState(!0),[q,ke]=o.useState(null),[He,mn]=o.useState(null),[qe,Ft]=o.useState(null),[fe,nt]=o.useState(null),[Gt,ct]=o.useState(""),[st,jt]=o.useState([]),[Ze,Qt]=o.useState(!1),[Ye,dt]=o.useState("idle"),[kt,$e]=o.useState([]),[yt,gn]=o.useState(""),[Tt,Vt]=o.useState(null),[ht,Cn]=o.useState([]),xt=o.useCallback(async()=>{try{let s=[];const a=Date.now();if(a-tn<3e4&&Wt.length>0)s=[...Wt];else try{const l=Ln(),_=await fetch("https://api.github.com/repos/turnzack/v0-reponse/releases",{headers:l?{Authorization:`Bearer ${l}`,Accept:"application/vnd.github.v3+json"}:{Accept:"application/vnd.github.v3+json"}});if(_.ok){const d=await _.json();if(Array.isArray(d)){const x=[];d.forEach(k=>{Array.isArray(k.assets)&&k.assets.forEach(M=>{var Z;(Z=M.name)!=null&&Z.endsWith(".apk")&&x.push({file:M.name,name:M.name.replace(".apk",""),sizeMb:(M.size/(1024*1024)).toFixed(1),url:M.browser_download_url})})}),Wt=x,tn=a,s=[...x]}}}catch{}try{const l=await w("http://localhost:5006/api/mobile/list-apks");if(l&&l.ok){const _=await l.json();_&&_.success&&Array.isArray(_.apks)&&(s=[...s,..._.apks])}else{const _=await fetch("/api/mobile/list-apks");if(_&&_.ok){const d=await _.json();d&&d.success&&Array.isArray(d.apks)&&(s=[...s,...d.apks])}}}catch{}if(s.length>0){const l=new Set,_=s.filter(d=>l.has(d.file.toLowerCase())?!1:(l.add(d.file.toLowerCase()),!0));Cn(_)}}catch(s){console.warn("[v0-apk] loadAvailableApks error",s)}},[]);o.useEffect(()=>{Ze&&xt()},[Ze,xt]),o.useEffect(()=>{let s,a=0;return Ye==="building"&&(s=setInterval(async()=>{try{const l=await w("http://localhost:5006/api/mobile/build-logs");if(l&&l.ok){a=0;const _=await l.json();_.logs&&_.logs.length>0&&$e(_.logs),_.isBuilding===!1&&_.result&&(_.result.success?(dt("success"),Vt(_.result.apkUrl)):dt("error"),clearInterval(s))}else a++,a>=3&&(clearInterval(s),dt("error"),$e(_=>[..._,`❌ Service de compilation mobile absent sur ce serveur (${l?l.status:"erreur réseau"}).`,"📱 Option 1 (Cloud) : Déclenchez le compilateur automatique Cloud Souverain.",`💻 Option 2 (Local) : Lancez 'python apk_builder.py --src ... --name ${yt||q||"app"} --build' dans E:\\v0reponses\\v0-apk.`]))}catch(l){console.warn("Polling APK error",l)}},1500)),()=>{s&&clearInterval(s)}},[Ye,yt,q]),o.useEffect(()=>{w("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))ne(s.projects.map(a=>({name:typeof a=="string"?a:a.project_id||a.title||a.name||"Projet",desc:"Projet local",bg:""})));else{const a=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:a?{Authorization:`Bearer ${a}`}:{}}).then(l=>l?l.json():null).then(l=>{l&&l.projects&&ne(l.projects.map(_=>({name:typeof _=="string"?_:_.project_id||_.title||_.name||"Projet",desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[ut,ye]=o.useState(null),[Zt,_t]=o.useState(""),[Et,i]=o.useState(!1),[g,v]=o.useState(!1),D=o.useRef(null);o.useEffect(()=>{if(D.current=null,q==="v0-guest"||q==="V0-Guest")v(!0),ye("http://localhost:3007"),_t("http://localhost:3007"),D.current="http://localhost:3007";else if(q){v(!0);const s=qe&&JSON.stringify(qe).includes("next.config"),a=typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1",l=s?"http://localhost:3000":D.current||(a?`http://${window.location.hostname}:5173`:"http://localhost:5173");ye(l),_t(l),D.current=l}else v(!1),ye(null)},[q,qe]),o.useEffect(()=>{const s=a=>{var l,_,d,x;if(((l=a.data)==null?void 0:l.type)==="CHANGE_PREVIEW_URL"){const k=a.data.route,M=k==="/"?"":`#${k}`;ye(Z=>{const J=Z?Z.split("#")[0]:"http://127.0.0.1:5175/";return`${J.endsWith("/")?J:`${J}/`}${M}`})}if(((_=a.data)==null?void 0:_.type)==="DESIGN_ELEMENT_CLICKED"||((d=a.data)==null?void 0:d.type)==="DESIGN_ELEMENT_DRAGGED"||((x=a.data)==null?void 0:x.type)==="DESIGN_ELEMENT_RESIZED"){const k=document.querySelector('iframe[title="Studio Admin Design"]');k&&k.contentWindow&&k.contentWindow.postMessage(a.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),o.useEffect(()=>{q&&w(`http://localhost:5006/api/fs/tree?project=${q}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&Ft(s.tree)}).catch(()=>{})},[q]),o.useEffect(()=>{q&&fe&&w(`http://localhost:5006/api/fs/read?project=${q}&file=${encodeURIComponent(fe)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&ct(s.content)}).catch(()=>{})},[q,fe]);const te=async s=>{if(s===void 0||!q||!fe)return;if(ct(s),Xt.isNativePlatform()||!!window.AndroidBridge)try{await Xn.writeFile({path:`v0-moteur-mobile/projetv0/${q}/${fe}`,data:s,directory:vn.Documents,encoding:Tn.UTF8,recursive:!0})}catch(l){console.error("Erreur de sauvegarde mobile:",l)}else w("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:q,file:fe,content:s})}).catch(()=>{})},N=s=>{q&&w(`http://localhost:5006/api/fs/read?project=${q}&file=${encodeURIComponent(s)}`).then(a=>a?a.json():null).then(a=>{a&&a.success&&jt(l=>l.find(_=>_.path===s)?l:[...l,{path:s,content:a.content}])}).catch(()=>{})};o.useEffect(()=>{(async()=>{const a=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(Xt.isNativePlatform()||!!window.AndroidBridge)try{const d=(await Xn.readdir({path:"v0-moteur-mobile/projetv0",directory:vn.Documents})).files.map(x=>x.name||x.toString());ne(d.map((x,k)=>({name:x,desc:"Mémoire Téléphone",bg:a[k%a.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else w("http://localhost:5006/api/projects-v2").then(_=>_?_.json():null).then(_=>{if(_&&_.success&&_.projects)ne(_.projects.map((d,x)=>({name:typeof d=="string"?d:d.name||d.project_id||d.title||`Projet_${x}`,desc:"Environnement Local",bg:a[x%a.length],installed:d.installed})));else{const d=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:d?{Authorization:`Bearer ${d}`}:{}}).then(x=>x?x.json():null).then(x=>{x&&x.projects&&ne(x.projects.map((k,M)=>({name:typeof k=="string"?k:k.project_id||k.title||k.name||`Projet_${M}`,desc:"SaaS Cloud (Neon DB)",bg:a[M%a.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),o.useEffect(()=>{P(!0)},[]);const[me,_e]=o.useState(!0);o.useEffect(()=>{const s=()=>_e(!0),a=_=>{_&&_.detail&&oe(d=>[_.detail,...d.slice(0,49)])};window.addEventListener("open-mouchard",s),window.addEventListener("kirov-mouchard-log",a);const l=_=>{if(_.data&&_.data.type==="TIGER_CAPTURE"){const d=_.data.data;if(d){let x="index.html";(d.includes("import React")||d.includes("export default"))&&(x="App.tsx"),d.includes("tailwindcss")&&(x="index.css"),nt(x),te(d),Ft(k=>{var J;const M={name:x,path:x,type:"file"};return k?((J=k.children)==null?void 0:J.find(V=>V.name===x))?k:{...k,children:[...k.children||[],M]}:{name:"Mobile_Storage",type:"directory",children:[M]}})}}};return window.addEventListener("message",l),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("kirov-mouchard-log",a),window.removeEventListener("message",l)}},[q,fe]),o.useEffect(()=>{if(!I)return;const s=()=>{w("http://localhost:5006/api/bridge/queue").then(l=>l?l.json():null).then(l=>{l&&l.success&&(setBridgeQueueData({current:l.current||{},queue:l.queue||[]}),(l.queue&&l.queue.length>0||l.current&&Object.keys(l.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),w("http://localhost:5006/api/bridge/logs").then(l=>l?l.json():null).then(l=>{var _,d;if(l&&l.success&&l.logs){oe(M=>{const J=[...M.filter(Ie=>(Ie.includes("[📱")||Ie.includes("v0-apk")||Ie.includes("[APK]"))&&!l.logs.includes(Ie)),...l.logs],V=new Set,xe=[];for(const Ie of J)V.has(Ie)||(V.add(Ie),xe.push(Ie));return xe.slice(0,50)});const x=[...l.logs].reverse().find(M=>M.includes("URL_PREVIEW="));if(x){let M=(_=x.split("URL_PREVIEW=")[1])==null?void 0:_.trim();M&&typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"&&(M=M.replace(/localhost|127\.0\.0\.1/,window.location.hostname)),M&&M!==D.current&&(D.current=M,ye(M),_t(M),v(!0))}const k=[...l.logs].reverse().find(M=>M.includes("PIPELINE COMPLET TERMINÉ avec succès pour "));if(k){const M=(d=k.split("PIPELINE COMPLET TERMINÉ avec succès pour ")[1])==null?void 0:d.replace(/[.\s]+$/,"");M&&q!==M&&(ke(M),v(!0))}}}).catch(()=>{}),w("http://localhost:5006/api/bridge/autonomous-status").then(l=>l?l.json():null).then(l=>{if(l&&l.success&&(l.data||l.status)){const d=(l.data||l.status).state;d==="diagnosing"||d==="repair_required"||d==="error"?f("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(d)||["starting_server","launch_requested","restarting"].includes(d)?f("working"):d==="ready"?f("clean"):q&&w(`http://localhost:5006/api/suture/status?project=${q}`).then(x=>x?x.json():null).then(x=>{x&&x.success&&x.status&&f(x.status)}).catch(()=>{})}}).catch(()=>{})};s();const a=setInterval(s,2e3);return()=>clearInterval(a)},[I,q]);const pt=s=>{ke(s),nt(null),ct(""),i(!1),_e(!1),v(!1),w("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:s,open_explorer:!1})}).then(async a=>{if(a&&a.ok){const l=await a.json().catch(()=>null);l!=null&&l.previewUrl&&(ye(l.previewUrl),_t(l.previewUrl))}}).catch(a=>console.error("Erreur de lancement preview:",a)),w(`http://localhost:5006/api/fs/tree?project=${encodeURIComponent(s)}`).then(a=>a?a.json():null).then(a=>{if(a&&a.success&&a.tree){Ft(a.tree);const l=d=>{if(!d)return null;if(d.type==="file"&&(d.path==="src/App.tsx"||d.path==="src/App.jsx"||d.name==="App.tsx"||d.name==="index.html"))return d.path;if(d.children&&Array.isArray(d.children))for(const x of d.children){const k=l(x);if(k)return k}return null},_=l(a.tree);_&&nt(_)}}).catch(a=>console.error("Erreur chargement arborescence:",a))},Le=s=>{const a=typeof s=="string"?s:y;if(!a.trim())return;const l={id:Date.now().toString(),role:"user",content:a};C(d=>[...d,l]);const _=a.toLowerCase();setTimeout(()=>{let d={id:(Date.now()+1).toString(),role:"assistant",content:""};const x=_.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(x==="mes projets"||x.includes("liste des projet")||x==="projet"||x==="projets")d.content="Voici la liste de vos projets récents :",d.widget="projects";else if((x.includes("stitch")||x.includes("deepseek")||x.includes("design")||x.includes("logique"))&&(x.includes("modifi")||x.includes("ajoute")||x.includes("change")||x.includes("mise a jour")||x.includes("evolue")||x.includes("reprends")||x.includes("continue"))){const k=a.match(/\[(.*?)\]/),M=k?k[1]:null,Z=x.includes("deepseek")?"deepseek":"stitch";d.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${Z.toUpperCase()}) 🔄

J'injecte vos nouvelles directives directement dans votre interface... ${M?`
🔍 Recherche et AutoSwitch vers le projet : "${M}"`:"Reprise du travail en cours."}`,d.widget=null,w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,target_project:M,prompt:"Mise à jour (Reprise de projet) : "+a.replace(/\[.*?\]/,"").trim(),auto_submit:!0})}).catch(J=>console.log("Erreur de connexion au Bridge local pour l'injection",J))}else if(x.includes("cree")||x.includes("lance")||x.includes("projet")||x.includes("generation")){d.content=`🚀 DÉMARRAGE PARALLÈLE KIROV5 🚀
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,d.widget="phases",E(1);const k=q||(ce.trim()?ce.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+a.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(ke(k),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",k),typeof window<"u"){const J=localStorage.getItem("tiger_targetAi")||"deepseek",V=localStorage.getItem("tiger_targetUiAi")||"stitch",xe=($,ue=!1)=>gt($,ue),Ie=window.AndroidBridge;if(Ie&&Ie.openAIWithPrompt)Ie.openAIWithPrompt(xe(V,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+a),Ie.showToast&&Ie.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const $=R&&R.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${R.length})]
`+R.map(Ae=>{const le=$t.find(Ce=>Ce.id===Ae);return`• ${le?le.name:Ae} (#${Ae})`}).join(`
`):"",ue="Génère l'interface UI/UX complète et moderne pour ce projet : "+a+$;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ue)}catch{}const rt=()=>w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:V,prompt:ue,auto_submit:!0,project_id:k,phase_num:1,packs:R})});Qe!==200&&(ze?window.open(xe(V,!0),"kirov5_ai_target"):window.open(xe(V,!0),"_blank"),rt().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(Ae=>console.error("Erreur sendUiPrompt",Ae))),setTimeout(()=>{const Ae=R&&R.length>0?a+$:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+a+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(Ae)}catch{}window.open(xe(J),"_blank"),w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,prompt:Ae,auto_submit:!0,project_id:k,phase_num:1,packs:R})}).catch(le=>console.log("Erreur Bridge Logic Prompt:",le)),R&&R.length>0?w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,user_prompt:Ae,packs:R,target_project:k})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(le=>{console.log("Erreur Trombone Bridge:",le)}):w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,prompt:Ae,auto_submit:!0,project_id:k,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}E(1);let M=1;const Z=setInterval(()=>{M++,M>11?clearInterval(Z):E(M)},1500)}else if(x.includes("youtube")||x.includes("video"))d.content="Voici les résultats YouTube pour votre recherche :",d.widget="youtube";else if(x.includes("actualite")||x.includes("ia")||x.includes("news")||x.includes("recherche")){const k=localStorage.getItem("tiger_apiKey");d.content="Actualités & Dernières Innovations IA :",d.widget="news",Mt(k||void 0)}else if(x.includes("parametre")||x.includes("reglage")||x.includes("configuration")||x.includes("setting"))d.content="Ouverture du panneau de configuration système :",d.widget="settings";else if(x.includes("[plugin:vite:")||x.includes("missing semicolon")||x.includes("syntaxerror")||x.includes("typescriptparsermixin")||x.includes("babel/parser")||x.includes("error")&&x.length>80){const k=q||"Projet_blog_8831";d.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${k}" avec la stack trace fournie... 🩺`,Ge("suture",a)}else if(d.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const k=window.AndroidBridge;k&&k.openAIWithPrompt?k.openAIWithPrompt("https://chat.deepseek.com/",a):window.open("https://chat.deepseek.com/","_blank")}C(k=>[...k,d])},600),S("")},et=async s=>{var Ie;let a=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],l=null;const _=a.filter($=>$.name.endsWith(".zip"));let d=[];if(_.length>0){C($=>[...$,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const $=(await nn(async()=>{const{default:ue}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:ue}},[])).default;for(const ue of _){l=ue;const Ae=await new $().loadAsync(ue);for(const[le,Ce]of Object.entries(Ae.files))if(!Ce.dir&&!le.includes("__MACOSX")&&!((Ie=le.split("/").pop())!=null&&Ie.startsWith("."))){const Ue=await Ce.async("blob"),mt=new File([Ue],le.split("/").pop()||le,{type:Ue.type});d.push(mt)}}}catch($){console.error("Erreur décompression ZIP:",$),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}for(const $ of _)try{const ue=await $.arrayBuffer(),rt=arrayBufferToBase64(ue);fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:q||H||ce||"AUDIO",fileName:$.name,fileBase64:rt})}).catch(le=>console.warn("[Upload ZIP Sync] Notice:",le))}catch{}}a=[...a.filter($=>!$.name.endsWith(".zip")),...d];const x=a.filter($=>$.name.endsWith(".html")),k=a.filter($=>!$.name.endsWith(".html")&&($.name.endsWith(".png")||$.name.endsWith(".jpg")||$.name.endsWith(".jpeg")||$.name.endsWith(".md")||$.name.endsWith(".json")||$.name.endsWith(".txt")||$.name.endsWith(".tsx")||$.name.endsWith(".ts")||$.name.endsWith(".jsx")||$.name.endsWith(".js")||$.name.endsWith(".css")||$.name.endsWith(".svg")));if(x.length===0&&k.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .tsx, .ts, .png, ou un .zip.");return}let M=[...st];for(const $ of k){const ue=$.name.endsWith(".png")||$.name.endsWith(".jpg")||$.name.endsWith(".jpeg"),rt=await new Promise(le=>{const Ce=new FileReader;Ce.onload=Ue=>{var mt;return le((mt=Ue.target)==null?void 0:mt.result)},ue?Ce.readAsDataURL($):Ce.readAsText($)}),Ae={path:$.name,content:ue?`[Image jointe visuellement : ${$.name} (Binaire ignoré pour économie de tokens)]`:rt};M.some(le=>le.path===$.name)||M.push(Ae),C(le=>[...le,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${$.name}`}])}if(x.length>0){const $=x[0],ue=await new Promise(le=>{const Ce=new FileReader;Ce.onload=Ue=>{var mt;return le((mt=Ue.target)==null?void 0:mt.result)},Ce.readAsText($)}),rt={path:$.name,content:ue};M.some(le=>le.path===$.name)||M.push(rt);const Ae={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${$.name}
Analyse de la structure UI et assemblage du contexte en cours...`};C(le=>[...le,Ae])}const Z=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter($=>$.name.endsWith(".zip"));for(const $ of Z)M.some(ue=>ue.path===$.name)||M.push({path:$.name,content:"ZIP_ARCHIVE_DUMMY"});jt(M);const J=q||ce||"Projet_Stitch",V=a.map($=>$.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${J}: ${V}`);const xe=x.length;if(xe>3){const $=localStorage.getItem("tiger_targetAi")||"deepseek",ue=l?"Projet_ZIP_"+l.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),rt=q||ue;q||ke(rt),C(le=>[...le,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !
...
Initialisé par Tiger IA V0 (Design-First).`})})}catch(J){console.error("[IDE] Erreur création auto du dossier",J)}}const d=s.filter(J=>J.path!==a.path),x=a.content,k={id:(Date.now()+1).toString(),role:"assistant",content:`Mode "Design-First" activé. 🎨

Transmission du design au LLM avec les ${d.length} fichiers du Trombone intégrés.
Câblage en cours...`,widget:"phases"};E(5),C(J=>[...J,k]);let M=5;const Z=setInterval(()=>{M++,M>11?clearInterval(Z):E(M)},3e3);if(typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Mode Design-First Activé !"),typeof window<"u"){const J=localStorage.getItem("tiger_targetAi")||"deepseek";let V="";d.length>0&&(V=`
...
\`\`\``,C(d=>[...d,{id:Date.now().toString()+"_action",role:"assistant",content:`🩺 Suture & Correction déclenchée pour "${q}". Transmission de l'erreur à ${l.toUpperCase()} en cours...`}]);try{if(await w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:l,prompt:_,auto_submit:!0,project_id:q,phase_num:s})}),s==="suture"){w("http://localhost:5006/v1/suture/start",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:q,activeFile:fe||"",rawError:a||"",prompt:a||"Analyse et corrige les erreurs du projet."})}).then(async x=>{const k=await x.json();k.success&&k.status==="applied"?C(M=>{var Z,J;return[...M,{id:Date.now().toString()+"_suture_ok",role:"assistant",content:`✅ Suture V2 réussie !

🔧 ${k.repairId}
🚀 Statut : **Patch appliqué en production**
📁 Fichiers corrigés : ${JSON.stringify(((J=(Z=k.patchReport)==null?void 0:Z.files)==null?void 0:J.map(V=>V.path))||[])}`}]}):k.success?C(M=>{var Z;return[...M,{id:Date.now().toString()+"_suture_partial",role:"assistant",content:`⚠️ Suture V2 : correctif généré mais non promu.
Statut : ${((Z=k.validationReport)==null?void 0:Z.code)||k.status}

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-C7B_91Fn.js","assets/design-v200-DUiF_64U.js","assets/design-v200-Dn42ZZIZ.css"])))=>i.map(i=>d[i]);
import{r as a,a as Tt,j as e,s as A,i as fs,R as bs}from"./design-v200-DUiF_64U.js";const vs="modulepreload",Ss=function(t){return"/"+t},Ln={},en=function(n,r,o){let d=Promise.resolve();if(r&&r.length>0){let h=function(v){return Promise.all(v.map(f=>Promise.resolve(f).then(M=>({status:"fulfilled",value:M}),M=>({status:"rejected",reason:M}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),S=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));d=h(r.map(v=>{if(v=Ss(v),v in Ln)return;Ln[v]=!0;const f=v.endsWith(".css"),M=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${v}"]${M}`))return;const E=document.createElement("link");if(E.rel=f?"stylesheet":vs,f||(E.as="script"),E.crossOrigin="",E.href=v,S&&E.setAttribute("nonce",S),document.head.appendChild(E),f)return new Promise((z,C)=>{E.addEventListener("load",z),E.addEventListener("error",()=>C(new Error(`Unable to preload CSS for ${v}`)))})}))}function m(h){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=h,window.dispatchEvent(u),!u.defaultPrevented)throw h}return d.then(h=>{for(const u of h||[])u.status==="rejected"&&m(u.reason);return n().catch(m)})},ys=`# undefined
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Va=a.forwardRef(({color:t="currentColor",size:n=24,strokeWidth:r=2,absoluteStrokeWidth:o,className:d="",children:m,iconNode:h,...u},S)=>a.createElement("svg",{ref:S,...Fa,width:n,height:n,stroke:t,strokeWidth:o?Number(r)*24/Number(n):r,className:ls("lucide",d),...u},[...h.map(([v,f])=>a.createElement(v,f)),...Array.isArray(m)?m:[m]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
                                  ...
                                  <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid rgba(255,255,255,0.1);padding-bottom:12px;">
                                    <div>
                                      ...
                                      <p style="margin:4px 0 0 0;font-size:11px;color:#94a3b8;">
                                        Projet : <strong style="color:#e2e8f0;">${b}</strong> | Pack PRD : <strong style="color:#a855f7;">${Ce}</strong>
                                      </p>
                                    </div>
...
*Le fichier README complet est disponible dans le dossier prd_packs/${M.packId}/README.md.*`),e.jsxs("div",{className:"design-fenetre-readme w-full rounded-3xl p-6 md:p-8 border-2 border-cyan/60 shadow-[0_0_80px_rgba(124,58,237,0.45)] my-4 relative animate-fadeIn text-white z-20 flex flex-col min-h-[480px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 flex-shrink-0",children:[e.jsxs("span",{className:"px-3.5 py-1.5 bg-cyan/20 text-cyan text-xs font-bold rounded-xl border border-cyan/40 flex items-center gap-2 shadow-sm",children:[e.jsx("span",{children:"💎"})," PACK PRD : ",M.packId]}),e.jsx("button",{onClick:()=>W(null),className:"w-10 h-10 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-xl flex items-center justify-center font-bold text-lg transition-all border border-cyan/40 cursor-pointer shadow-md",title:"Fermer (Retour aux packs)",children:"✕"})]}),e.jsx("h2",{className:"text-2xl md:text-3xl font-black text-cyan mb-2 leading-tight drop-shadow-[0_2px_10px_rgba(6,182,212,0.5)] flex-shrink-0",children:M.packName}),e.jsx("div",{className:"w-full h-px bg-gradient-to-r from-cyan via-purple-400 to-cyan/20 mb-4 flex-shrink-0"}),e.jsx("div",{className:"design-readme-contenu flex-1 text-white font-medium leading-relaxed whitespace-pre-wrap overflow-y-auto max-h-[500px] p-6 rounded-2xl border-2 border-cyan/50 font-mono text-sm shadow-[0_0_40px_rgba(8,179,201,0.3)] min-h-[300px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)",textShadow:"0 1px 2px rgba(0,0,0,0.8)"},children:_}),e.jsxs("div",{className:"mt-6 pt-4 border-t border-white/15 flex justify-between items-center flex-shrink-0",children:[e.jsxs("span",{className:"text-xs text-cyan/90 font-mono font-bold tracking-widest uppercase flex items-center gap-2",children:[e.jsx("span",{children:"⚡"})," SUTURE PRD ENGINE"]}),e.jsx("button",{onClick:()=>W(null),className:"px-6 py-2.5 bg-cyan/20 hover:bg-cyan/40 text-cyan font-bold rounded-xl transition-all border border-cyan/40 flex items-center gap-2 cursor-pointer hover:bg-cyan/30 shadow-md",children:"← Fermer & Retour aux packs"})]})]})}return e.jsxs("div",{id:"prd-packs-carousel-section",className:"w-full flex-1 min-w-0 my-2",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3 px-2",children:[e.jsxs("h4",{className:"design-prd-titre-section font-black uppercase tracking-widest text-cyan flex items-center gap-2",children:[e.jsx("span",{children:"💎"})," PACKS PRD DE CONNAISSANCES (",Gt.length,")"]}),t&&t.length>0&&e.jsxs("span",{className:"text-[11px] font-bold text-cyan bg-cyan/20 px-2.5 py-1 rounded-full border border-cyan/30",children:[t.length," pack(s) actif(s)"]})]}),e.jsx("div",{className:"flex gap-4 items-stretch relative w-full",children:e.jsx("div",{className:"flex-1 min-w-0 min-h-[480px] overflow-hidden py-4 flex items-center",children:h?z.length===0?e.jsxs("div",{className:"h-full min-h-[220px] rounded-2xl p-6 border border-purple-500/20 bg-purple-950/20 backdrop-blur-md flex flex-col items-center justify-center text-center",children:[e.jsx("p",{className:"text-purple-300 font-bold text-sm",children:"Aucun pack Guest n'a encore été généré."}),e.jsx("p",{className:"text-xs text-zinc-400 mt-2",children:"Utilisez l'interface V0-GUEST pour scanner un projet local et créer un pack sur-mesure."}),e.jsx("button",{onClick:O,className:"mt-4 text-xs text-purple-300 border border-purple-500/40 px-4 py-1.5 rounded-full hover:bg-purple-900/40 transition-colors",children:"🔄 Recharger les packs Guest"})]}):e.jsx(Ft,{items:z.filter(_=>{var G,y,q,X;if(!S)return!0;const w=S.toLowerCase();return((G=_.name)==null?void 0:G.toLowerCase().includes(w))||((y=_.description)==null?void 0:y.toLowerCase().includes(w))||((q=_.id)==null?void 0:q.toLowerCase().includes(w))||((X=_.category)==null?void 0:X.toLowerCase().includes(w))}).sort((_,w)=>(_.name||"").localeCompare(w.name||"")).map(_=>{const w=_.id,G=t?t.includes(w):!1;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${G?"border-purple-400 shadow-[0_0_25px_rgba(168,85,247,0.4)] bg-purple-950/60":"border-purple-500/20 hover:border-purple-400/60 bg-black/50"}`,children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${G?"bg-purple-500 text-white shadow-md":"bg-purple-500/20 text-purple-400 border border-purple-500/40"}`,children:e.jsx(kn,{size:18})}),e.jsx("span",{className:"px-2 py-0.5 bg-purple-500/20 text-purple-300 text-[10px] font-bold rounded-md uppercase tracking-wider border border-purple-500/30",children:"🐋 GUEST"})]}),n&&e.jsx("button",{onClick:y=>{y.stopPropagation(),n(w)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${G?"bg-purple-500 text-white shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-purple-500/40 hover:text-white"}`,children:G?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight truncate",children:_.name}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed text-zinc-300 text-xs line-clamp-4",children:_.description}),e.jsxs("div",{className:"mt-4 pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsxs("span",{className:"text-[10px] font-mono text-purple-400/80",children:[_.modulesCount," MODULES"]}),e.jsxs("button",{onClick:async()=>{var y;try{const q=await A(`http://localhost:5006/api/bridge/read-file?path=${encodeURIComponent(_.path+"/README.md")}`);let X="";if(q&&q.ok){const L=await q.json();X=((y=L.data)==null?void 0:y.content)||L.content||""}W({packId:w,packName:_.name,readmeText:X||`# PACK GUEST : ${_.name}

Spécifications techniques du pack Guest ${_.name}.

Module réutilisable scanné dans ${_.path}.`})}catch{W({packId:w,packName:_.name,readmeText:`# PACK GUEST : ${_.name}

Spécifications techniques du pack Guest ${_.name}.`})}},className:"design-prd-btn text-purple-400 text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-purple-500/30 transition-all",children:[e.jsx("span",{children:"📖"})," README →"]})]})]},w)})}):e.jsx(Ft,{items:Gt.map(_=>{const w=_.id,G=_.name,y=_.icon||cs,q=t?t.includes(w):!1,V=(v[w]||gn(w)||"Spécifications techniques du contrat PRD.").replace(/^#+.*$/gm,"").replace(/^>.*$/gm,"").replace(/\[([^\]]+)\]\([^\)]+\)/g,"$1").replace(/[*_~`]/g,"").trim().split(`
`).map(Z=>Z.trim()).filter(Z=>Z.length>20),Y=V.length>0?V[0]:"Spécifications techniques du contrat PRD.",$=Y.length>180?Y.substring(0,180)+"...":Y;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${q?"border-cyan shadow-[0_0_25px_rgba(8,179,201,0.4)]":"border-white/10 hover:border-cyan/50"}`,style:{background:r?o("prd-card-"+w,.7):"rgba(0,0,0,0.7)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${q?"bg-cyan text-black shadow-md":_.color||"bg-cyan/20 text-cyan"}`,children:e.jsx(y,{size:20})}),e.jsx("span",{className:"px-2 py-0.5 bg-cyan/20 text-cyan text-[10px] font-bold rounded-md uppercase tracking-wider",children:"💎 PRD"})]}),n&&e.jsx("button",{onClick:Z=>{Z.stopPropagation(),n(w)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${q?"bg-cyan text-black shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-white/20 hover:text-white"}`,title:q?"Désélectionner ce pack":"Sélectionner ce pack pour l'IA",children:q?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight",children:G}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed",children:$}),e.jsxs("div",{className:"mt-auto pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-mono text-cyan/80",children:"MODULE PRD"}),e.jsxs("button",{onClick:async()=>{var H;let Z=v[w]||gn(w)||"";try{const ae=await A(`http://localhost:5006/api/bridge/read-file?packId=${encodeURIComponent(w)}`);if(ae&&ae.ok){const ve=await ae.json(),F=ve.content||((H=ve.data)==null?void 0:H.content);F&&F.trim().length>5&&(Z=F,f(ee=>({...ee,[w]:F})))}}catch(ae){console.warn("API Bridge read fallback",ae)}W({packId:w,packName:G,readmeText:Z||`# 💎 PRD PACK : ${G} (${w})

### ⚙️ Spécifications techniques du contrat PRD

- **Identifiant Pack**: ${w}
- **Statut**: Actif & Intégré au Moteur Sovereign`})},className:"design-prd-btn text-cyan text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-cyan/30 transition-all hover:bg-cyan/10",children:[e.jsx("span",{children:"📖"})," Lire le README →"]})]})]},w)})})})})]})},Qn=({isClient:t,getCachedGradient:n,setActiveProject:r})=>{const[o,d]=a.useState([]),[m,h]=a.useState(!0),[u,S]=a.useState(!1),[v,f]=a.useState(null),M=(E=!1)=>{E?S(!0):h(!0);const z=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];A("http://localhost:5006/api/projects").then(C=>C?C.json():null).then(C=>{if(C&&C.success&&C.projects)d(C.projects.map((O,W)=>({name:typeof O=="string"?O:O.projectName||O.name||O.projectId||O.project_id||O.title||`Projet_${W}`,desc:"Environnement Local",bg:z[W%z.length],installed:O.installed}))),h(!1),S(!1);else{const O=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:O?{Authorization:`Bearer ${O}`}:{}}).then(W=>W?W.json():null).then(W=>{W&&W.projects&&d(W.projects.map((_,w)=>({name:_.project_id||_.title||_.name||`Projet_${w}`,desc:"SaaS Cloud (Neon DB)",bg:z[w%z.length]}))),h(!1),S(!1)}).catch(()=>{h(!1),S(!1)})}}).catch(()=>{h(!1),S(!1)})};return a.useEffect(()=>{M();const E=setInterval(()=>M(!0),5e3);return()=>clearInterval(E)},[]),m?e.jsx("div",{className:"p-4 text-cyan text-sm italic",children:"Actualisation de la liste des projets..."}):o.length===0?e.jsxs("div",{className:"p-4 flex flex-col items-center gap-3 text-center",children:[e.jsx("div",{className:"text-cyan text-sm italic",children:"Aucun projet trouvé sur votre disque dur."}),e.jsx("button",{onClick:()=>M(),className:"px-4 py-2 rounded-xl bg-cyan/20 border border-cyan/40 text-cyan text-xs font-bold hover:bg-cyan/40 transition-colors",children:"🔄 Rafraîchir la liste"})]}):e.jsx(Ft,{items:[...o.map((E,z)=>{const C=E.name||"AUDIO",O=async()=>{f(C),r(C);try{window.dispatchEvent(new CustomEvent("open-mouchard")),A("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:C})}).then(async _=>{if(_){const w=await _.json().catch(()=>null);w!=null&&w.previewUrl&&window.open(w.previewUrl,"_blank")}}).catch(()=>{}),await A(`http://localhost:5006/api/projects/${encodeURIComponent(C)}/launch-design`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:C,open_explorer:!1})}).catch(_=>console.error("Erreur de lancement :",_))}catch(_){console.error("Erreur de lancement :",_)}finally{setTimeout(()=>f(null),2e3)}},W=async _=>{if(_.preventDefault(),_.stopPropagation(),window.confirm(`⚠️ SUPPRESSION DEFINITIVE :
Voulez-vous vraiment supprimer le projet "${C}" de l'interface ET de votre disque dur ?`))try{const w=await A("http://localhost:5006/api/projects/remove-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:C})});if(!w){d(y=>y.filter(q=>q.name!==C));return}const G=await w.json();G.success?d(y=>y.filter(q=>q.name!==C)):alert(`Erreur lors de la suppression : ${G.message||"Échec server"}`)}catch(w){alert(`Erreur réseau lors de la suppression : ${w.message}`)}};return e.jsxs("div",{className:"design-carte-carrousel rounded-2xl p-5 border border-white/20 shadow-xl flex flex-col items-center text-center relative overflow-hidden group cursor-pointer",style:{background:t?n("proj-"+z,.7):"rgba(0,0,0,0.5)"},onClick:O,children:[e.jsx("button",{onClick:W,className:"z-20 absolute top-3 right-3 w-8 h-8 rounded-full bg-red-600/80 hover:bg-red-500 text-white font-bold text-xs flex items-center justify-center transition-all shadow-lg hover:scale-110 cursor-pointer",title:"Supprimer ce projet du disque dur et de l'interface",children:"🗑️"}),e.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-30 mix-blend-overlay pointer-events-none"}),e.jsx("div",{className:"absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors z-0"}),e.jsxs("div",{className:"z-10 relative pointer-events-none w-full pr-8",children:[e.jsx("div",{className:"text-white/70 text-xs font-bold uppercase tracking-widest drop-shadow-md",children:"PROJET"}),e.jsx("h3",{className:"design-carte-titre text-xl font-black text-white break-all drop-shadow-lg leading-tight w-full",children:C})]}),e.jsx("div",{className:"design-carte-desc z-10 relative text-sm text-white/90 font-medium drop-shadow-md pointer-events-none w-full",children:E.desc}),e.jsxs("div",{className:"z-10 flex items-center gap-2 mt-3",children:[e.jsx("button",{onClick:_=>{_.stopPropagation(),v!==C&&(E.installed===!1?(f(C),A("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:C})}).then(w=>{alert(w?`📦 Installation des dépendances démarrée pour "${C}" !
Suivez la progression dans les logs.`:"Mode Cloud SaaS : Bridge local non connecté."),f(null),d(G=>G.map(y=>y.name===E.name?{...y,installed:!0}:y))}).catch(()=>f(null))):O())},disabled:v===C,className:`font-bold py-2 px-4 rounded-xl text-xs transition-all flex items-center gap-1.5 ${v===C?"bg-cyan-500/40 text-cyan-200 cursor-wait animate-pulse":E.installed===!1?"bg-orange-500/80 hover:bg-orange-600 text-white cursor-pointer":"bg-white/20 hover:bg-white/40 text-white cursor-pointer"}`,title:E.installed===!1?"Installer les dépendances requises pour ce projet":"Lancer la prévisualisation Vite",children:v===C?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin inline-block",children:"⏳"})," ",E.installed===!1?"Installation...":"Lancement..."]}):E.installed===!1?e.jsx(e.Fragment,{children:"📦 INSTALL"}):e.jsx(e.Fragment,{children:"🚀 PREVIEW"})}),E.installed!==!1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:_=>{_.stopPropagation(),f(C),A("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:C})}).then(w=>{alert(w?`🔄 Réinstallation des dépendances démarrée pour "${C}" !`:"Mode Cloud SaaS : Bridge local non connecté."),f(null)}).catch(()=>f(null))},className:"bg-orange-500/30 hover:bg-orange-500/60 text-white font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center justify-center border border-orange-500/40 cursor-pointer",title:"Forcer la réinstallation des dépendances (pnpm install)",children:"🔄"}),e.jsx("button",{onClick:async _=>{_.stopPropagation();try{f(C);const w=await A("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:C})});if(f(null),!w){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const G=await w.json();alert(G.message||`🚀 Serveur Vite démarré pour ${C} !`),G.previewUrl&&window.open(G.previewUrl,"_blank")}catch(w){f(null),alert("Erreur de connexion au bridge: "+w.message)}},className:"font-bold py-2 px-3 rounded-xl text-xs bg-purple-500/60 hover:bg-purple-500 text-white transition-all shadow-md cursor-pointer",title:"Lancer le serveur Vite avec pnpm run dev",children:"💻 PNPM"})]}),e.jsx("button",{onClick:W,className:"bg-red-600/30 hover:bg-red-600/60 text-red-200 border border-red-500/40 font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center gap-1",title:"Supprimer définitivement du disque dur",children:"🗑️ Supprimer"})]})]},z)})]})};function Vo({user:t,onLogout:n}={}){var qn;const r=a.useRef({}),o=(s,c=1)=>typeof window>"u"?`linear-gradient(135deg, rgba(17,17,17,${c}), rgba(34,34,34,${c}))`:(r.current[s]||(r.current[s]=Oo(c)),r.current[s]),d=(t==null?void 0:t.email)||(typeof window<"u"?localStorage.getItem("tiger_currentUserEmail"):null),m=!!(t!=null&&t.isSuperAdmin||d&&d.toLowerCase().trim()==="zacktunr@gmail.com");a.useEffect(()=>{t!=null&&t.email&&typeof window<"u"&&localStorage.setItem("tiger_currentUserEmail",t.email)},[t]);const h=()=>{typeof window<"u"&&(localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),localStorage.removeItem("tiger_lastGeneratedProject"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{})),n?n():typeof window<"u"&&window.location.reload()},[u,S]=a.useState([]),[v,f]=a.useState(""),M=a.useRef(null),E=a.useRef(null),[z,C]=a.useState(!1),[O,W]=a.useState("connexion"),[_,w]=a.useState(!1),[G,y]=a.useState("clean");a.useRef(0);const[q,X]=a.useState(1),[L,V]=a.useState(!1),[Y,$]=a.useState(!1),[Z,H]=a.useState(!1);a.useEffect(()=>{let s=0;const c=setInterval(()=>{var l,I;if(typeof window<"u"){const p=(I=(l=window.Capacitor)==null?void 0:l.isNativePlatform)==null?void 0:I.call(l),x=!!window.AndroidBridge;(p||x)&&($(!0),clearInterval(c))}s++>10&&clearInterval(c)},100);return()=>clearInterval(c)},[]);const[ae,ve]=a.useState([]),[F,ee]=a.useState(""),[de,xe]=a.useState(["> Système Kirov5 initialisé. "+new Date().toLocaleTimeString()]),[Ie,te]=a.useState([]),[j,J]=a.useState([]);a.useEffect(()=>{const s=c=>J(c.detail);return window.addEventListener("update_kirov_packs",s),()=>window.removeEventListener("update_kirov_packs",s)},[]),a.useEffect(()=>{window.KIROV_SELECTED_PACKS=j},[j]);const[re,ue]=a.useState(!1),[fe,Te]=a.useState(!1),[ke,D]=a.useState([]),[ge,Ae]=a.useState(!1),[he,se]=a.useState(""),[Me,nt]=a.useState(""),[Ee,Re]=a.useState(!1),[oe,pt]=a.useState(""),[ze,Dn]=a.useState("Vite + React + Tailwind + TS"),[mt,bn]=a.useState(""),[yt,Et]=a.useState("deepseek"),[He,sn]=a.useState(""),[rn,Mn]=a.useState(!0),[an,on]=a.useState(!1),[gt,_t]=a.useState(null),[Ze,Ct]=a.useState(!1),[st,$e]=a.useState("idle"),[Rt,Oe]=a.useState([]),[rt,zt]=a.useState(""),[vn,ht]=a.useState(null),[Nt,Ht]=a.useState([]),wt=a.useCallback(async()=>{try{const s=await A("http://localhost:5006/api/mobile/list-apks");if(s&&s.ok){const l=await s.json();if(l&&l.success&&Array.isArray(l.apks)){Ht(l.apks);return}}const c=await fetch("/api/mobile/list-apks");if(c&&c.ok){const l=await c.json();l&&l.success&&Array.isArray(l.apks)&&Ht(l.apks)}}catch(s){console.warn("[v0-apk] loadAvailableApks error",s)}},[]);a.useEffect(()=>{Ze&&wt()},[Ze,wt]),a.useEffect(()=>{let s,c=0;return st==="building"&&(s=setInterval(async()=>{try{const l=await A("http://localhost:5006/api/mobile/build-logs");if(l&&l.ok){c=0;const I=await l.json();I.logs&&I.logs.length>0&&Oe(I.logs),I.isBuilding===!1&&I.result&&(I.result.success?($e("success"),ht(I.result.apkUrl)):$e("error"),clearInterval(s))}else c++,c>=3&&(clearInterval(s),$e("error"),Oe(I=>[...I,`❌ Service de compilation mobile absent sur ce serveur (${l?l.status:"erreur réseau"}).`,"📱 Option 1 (Cloud) : Déclenchez le build sans dépendance via GitHub Actions (.github/workflows/build-apk.yml).",`💻 Option 2 (Local) : Lancez 'python apk_builder.py --src ... --name ${rt||R||"app"} --build' dans E:\\v0reponses\\v0-apk.`]))}catch(l){console.warn("Polling APK error",l)}},1500)),()=>{s&&clearInterval(s)}},[st,rt,R]);const[be,xt]=a.useState([]),[ln,Dt]=a.useState(!1),cn=a.useCallback(async s=>{Dt(!0);const c=[{id:"deepseek-r1-v0",tag:"⚡ DEEPSEEK R1",title:"DeepSeek-R1 & Moteur Souverain v0.1",desc:"Capacités de raisonnement avancé et de suture pour interfaces React.",content:`DeepSeek-R1 offre des capacités de raisonnement avancé pour l'analyse de contrats PRD et la génération zéro-touch de projets web complets.
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){xt(c),Dt(!1);return}const l=s||localStorage.getItem("tiger_apiKey");if(!l||!l.startsWith("sk-")||l.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){xt(c),Dt(!1);return}const I=new AbortController,p=setTimeout(()=>I.abort(),4e3),x=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${l}`},signal:I.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(p),x.ok){const P=await x.json(),N=JSON.parse(P.choices[0].message.content);N.news&&Array.isArray(N.news)&&N.news.length>0?xt(N.news):xt(c)}else x.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),xt(c)}catch(l){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",l),xt(c)}finally{Dt(!1)}},[]);a.useEffect(()=>{cn()},[cn]);const[It,qe]=a.useState(!1),[Ne,_e]=a.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Ke,ct]=a.useState([]),[Ge,$t]=a.useState("");a.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let c=JSON.parse(s);if(!Array.isArray(c))throw new Error("Not an array");const l="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";c=c.map(I=>I.name==="fold"?{...I,colors:{...I.colors,"bg-app":l}}:I),ct(c)}catch{ct([])}else{const c={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};ct([c]),localStorage.setItem("tiger_saved_themes",JSON.stringify([c]))}},[]),a.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",Ne),Ne!=="random"){const c=((s=Ke.find(l=>l.name===Ne))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=c,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[Ne,Ke]);const Sn=()=>{if(!Ge.trim())return alert("Nom invalide");if(Ke.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":o("icon-settings",.8),"icon-ai":o("icon-ai",.8),"icon-projects":o("icon-projects",.8),"icon-packs":o("icon-packs",.8),"icon-news":o("icon-news",.8),"bg-app":o("bg-app",.9)},c={name:Ge.trim(),colors:s},l=[...Ke,c];ct(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),_e(c.name),$t("")},dn=(s,c)=>{c.stopPropagation();const l=Ke.filter(I=>I.name!==s);ct(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),Ne===s&&_e("random")},Kt=s=>{J(c=>c.includes(s)?c.filter(l=>l!==s):[...c,s])},[We,Wt]=a.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});a.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(We))},[We]);const[dt,ft]=a.useState(!0),[Ye,At]=a.useState(!0),[R,Pe]=a.useState(null),[Mt,Jt]=a.useState(null),[De,Xt]=a.useState(null),[pe,Je]=a.useState(null),[qt,it]=a.useState(""),[bt,Pt]=a.useState([]);a.useEffect(()=>{A("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))te(s.projects.map(c=>({name:typeof c=="string"?c:c.project_id||c.title||c.name||"Projet",desc:"Projet local",bg:""})));else{const c=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:c?{Authorization:`Bearer ${c}`}:{}}).then(l=>l?l.json():null).then(l=>{l&&l.projects&&te(l.projects.map(I=>({name:typeof I=="string"?I:I.project_id||I.title||I.name||"Projet",desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[at,Se]=a.useState(null),[Qt,jt]=a.useState(""),[kt,i]=a.useState(!1),[g,b]=a.useState(!1),T=a.useRef(null);a.useEffect(()=>{if(T.current=null,R==="v0-guest"||R==="V0-Guest")b(!0),Se("http://localhost:3007"),jt("http://localhost:3007"),T.current="http://localhost:3007";else if(R){b(!0);const s=De&&JSON.stringify(De).includes("next.config"),c=typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1",l=s?"http://localhost:3000":T.current||(c?`http://${window.location.hostname}:5173`:"http://localhost:5173");Se(l),jt(l),T.current=l}else b(!1),Se(null)},[R,De]),a.useEffect(()=>{const s=c=>{var l,I,p,x;if(((l=c.data)==null?void 0:l.type)==="CHANGE_PREVIEW_URL"){const P=c.data.route,N=P==="/"?"":`#${P}`;Se(Q=>{const B=Q?Q.split("#")[0]:"http://127.0.0.1:5175/";return`${B.endsWith("/")?B:`${B}/`}${N}`})}if(((I=c.data)==null?void 0:I.type)==="DESIGN_ELEMENT_CLICKED"||((p=c.data)==null?void 0:p.type)==="DESIGN_ELEMENT_DRAGGED"||((x=c.data)==null?void 0:x.type)==="DESIGN_ELEMENT_RESIZED"){const P=document.querySelector('iframe[title="Studio Admin Design"]');P&&P.contentWindow&&P.contentWindow.postMessage(c.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),a.useEffect(()=>{R&&A(`http://localhost:5006/api/fs/tree?project=${R}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&Xt(s.tree)}).catch(()=>{})},[R]),a.useEffect(()=>{R&&pe&&A(`http://localhost:5006/api/fs/read?project=${R}&file=${encodeURIComponent(pe)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&it(s.content)}).catch(()=>{})},[R,pe]);const ne=async s=>{if(s===void 0||!R||!pe)return;if(it(s),Bt.isNativePlatform()||!!window.AndroidBridge)try{await $n.writeFile({path:`v0-moteur-mobile/projetv0/${R}/${pe}`,data:s,directory:xn.Documents,encoding:Pn.UTF8,recursive:!0})}catch(l){console.error("Erreur de sauvegarde mobile:",l)}else A("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:R,file:pe,content:s})}).catch(()=>{})},k=s=>{R&&A(`http://localhost:5006/api/fs/read?project=${R}&file=${encodeURIComponent(s)}`).then(c=>c?c.json():null).then(c=>{c&&c.success&&Pt(l=>l.find(I=>I.path===s)?l:[...l,{path:s,content:c.content}])}).catch(()=>{})};a.useEffect(()=>{(async()=>{const c=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(Bt.isNativePlatform()||!!window.AndroidBridge)try{const p=(await $n.readdir({path:"v0-moteur-mobile/projetv0",directory:xn.Documents})).files.map(x=>x.name||x.toString());te(p.map((x,P)=>({name:x,desc:"Mémoire Téléphone",bg:c[P%c.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else A("http://localhost:5006/api/projects-v2").then(I=>I?I.json():null).then(I=>{if(I&&I.success&&I.projects)te(I.projects.map((p,x)=>({name:typeof p=="string"?p:p.name||p.project_id||p.title||`Projet_${x}`,desc:"Environnement Local",bg:c[x%c.length],installed:p.installed})));else{const p=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:p?{Authorization:`Bearer ${p}`}:{}}).then(x=>x?x.json():null).then(x=>{x&&x.projects&&te(x.projects.map((P,N)=>({name:typeof P=="string"?P:P.project_id||P.title||P.name||`Projet_${N}`,desc:"SaaS Cloud (Neon DB)",bg:c[N%c.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),a.useEffect(()=>{V(!0)},[]);const[me,Ce]=a.useState(!0);a.useEffect(()=>{const s=()=>Ce(!0);window.addEventListener("open-mouchard",s);const c=l=>{if(l.data&&l.data.type==="TIGER_CAPTURE"){const I=l.data.data;if(I){let p="index.html";(I.includes("import React")||I.includes("export default"))&&(p="App.tsx"),I.includes("tailwindcss")&&(p="index.css"),Je(p),ne(I),Xt(x=>{var Q;const P={name:p,path:p,type:"file"};return x?((Q=x.children)==null?void 0:Q.find(B=>B.name===p))?x:{...x,children:[...x.children||[],P]}:{name:"Mobile_Storage",type:"directory",children:[P]}})}}};return window.addEventListener("message",c),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("message",c)}},[R,pe]),a.useEffect(()=>{if(!L)return;const s=()=>{A("http://localhost:5006/api/bridge/queue").then(l=>l?l.json():null).then(l=>{l&&l.success&&(setBridgeQueueData({current:l.current||{},queue:l.queue||[]}),(l.queue&&l.queue.length>0||l.current&&Object.keys(l.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),A("http://localhost:5006/api/bridge/logs").then(l=>l?l.json():null).then(l=>{var I,p;if(l&&l.success&&l.logs){xe(l.logs);const x=[...l.logs].reverse().find(N=>N.includes("URL_PREVIEW="));if(x){let N=(I=x.split("URL_PREVIEW=")[1])==null?void 0:I.trim();N&&typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"&&(N=N.replace(/localhost|127\.0\.0\.1/,window.location.hostname)),N&&N!==T.current&&(T.current=N,Se(N),jt(N),b(!0))}const P=[...l.logs].reverse().find(N=>N.includes("PIPELINE COMPLET TERMINÉ avec succès pour "));if(P){const N=(p=P.split("PIPELINE COMPLET TERMINÉ avec succès pour ")[1])==null?void 0:p.replace(/[.\s]+$/,"");N&&R!==N&&(Pe(N),b(!0))}}}).catch(()=>{}),A("http://localhost:5006/api/bridge/autonomous-status").then(l=>l?l.json():null).then(l=>{if(l&&l.success&&(l.data||l.status)){const p=(l.data||l.status).state;p==="diagnosing"||p==="repair_required"||p==="error"?y("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(p)||["starting_server","launch_requested","restarting"].includes(p)?y("working"):p==="ready"?y("clean"):R&&A(`http://localhost:5006/api/suture/status?project=${R}`).then(x=>x?x.json():null).then(x=>{x&&x.success&&x.status&&y(x.status)}).catch(()=>{})}}).catch(()=>{})};s();const c=setInterval(s,2e3);return()=>clearInterval(c)},[L,R]);const Fe=s=>{const c=typeof s=="string"?s:v;if(!c.trim())return;const l={id:Date.now().toString(),role:"user",content:c};S(p=>[...p,l]);const I=c.toLowerCase();setTimeout(()=>{let p={id:(Date.now()+1).toString(),role:"assistant",content:""};const x=I.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(x==="mes projets"||x.includes("liste des projet")||x==="projet"||x==="projets")p.content="Voici la liste de vos projets récents :",p.widget="projects";else if((x.includes("stitch")||x.includes("deepseek")||x.includes("design")||x.includes("logique"))&&(x.includes("modifi")||x.includes("ajoute")||x.includes("change")||x.includes("mise a jour")||x.includes("evolue")||x.includes("reprends")||x.includes("continue"))){const P=c.match(/\[(.*?)\]/),N=P?P[1]:null,Q=x.includes("deepseek")?"deepseek":"stitch";p.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${Q.toUpperCase()}) 🔄

J'injecte vos nouvelles directives directement dans votre interface... ${N?`
🔍 Recherche et AutoSwitch vers le projet : "${N}"`:"Reprise du travail en cours."}`,p.widget=null,A("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Q,target_project:N,prompt:"Mise à jour (Reprise de projet) : "+c.replace(/\[.*?\]/,"").trim(),auto_submit:!0})}).catch(B=>console.log("Erreur de connexion au Bridge local pour l'injection",B))}else if(x.includes("cree")||x.includes("lance")||x.includes("projet")||x.includes("generation")){p.content=`🚀 DÉMARRAGE PARALLÈLE KIROV5 🚀
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,p.widget="phases",X(1);const P=R||(oe.trim()?oe.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+c.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(Pe(P),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",P),typeof window<"u"){const B=localStorage.getItem("tiger_targetAi")||"deepseek",K=localStorage.getItem("tiger_targetUiAi")||"stitch",Le=(U,ce=!1)=>lt(U,ce),Ve=window.AndroidBridge;if(Ve&&Ve.openAIWithPrompt)Ve.openAIWithPrompt(Le(K,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+c),Ve.showToast&&Ve.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const U=j&&j.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${j.length})]
`+j.map(we=>{const ie=Gt.find(ye=>ye.id===we);return`• ${ie?ie.name:we} (#${we})`}).join(`
`):"",ce="Génère l'interface UI/UX complète et moderne pour ce projet : "+c+U;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ce)}catch{}const tt=()=>A("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:K,prompt:ce,auto_submit:!0,project_id:P,phase_num:1,packs:j})});We!==200&&(Ye?window.open(Le(K,!0),"kirov5_ai_target"):window.open(Le(K,!0),"_blank"),tt().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(we=>console.error("Erreur sendUiPrompt",we))),setTimeout(()=>{const we=j&&j.length>0?c+U:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+c+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(we)}catch{}window.open(Le(B),"_blank"),A("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:B,prompt:we,auto_submit:!0,project_id:P,phase_num:1,packs:j})}).catch(ie=>console.log("Erreur Bridge Logic Prompt:",ie)),j&&j.length>0?A("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:B,user_prompt:we,packs:j,target_project:P})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(ie=>{console.log("Erreur Trombone Bridge:",ie)}):A("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:B,prompt:we,auto_submit:!0,project_id:P,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}X(1);let N=1;const Q=setInterval(()=>{N++,N>11?clearInterval(Q):X(N)},1500)}else if(x.includes("youtube")||x.includes("video"))p.content="Voici les résultats YouTube pour votre recherche :",p.widget="youtube";else if(x.includes("actualite")||x.includes("ia")||x.includes("news")||x.includes("recherche")){const P=localStorage.getItem("tiger_apiKey");p.content="Actualités & Dernières Innovations IA :",p.widget="news",cn(P||void 0)}else if(x.includes("parametre")||x.includes("reglage")||x.includes("configuration")||x.includes("setting"))p.content="Ouverture du panneau de configuration système :",p.widget="settings";else if(x.includes("[plugin:vite:")||x.includes("missing semicolon")||x.includes("syntaxerror")||x.includes("typescriptparsermixin")||x.includes("babel/parser")||x.includes("error")&&x.length>80){const P=R||"Projet_blog_8831";p.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${P}" avec la stack trace fournie... 🩺`,je("suture",c)}else if(p.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const P=window.AndroidBridge;P&&P.openAIWithPrompt?P.openAIWithPrompt("https://chat.deepseek.com/",c):window.open("https://chat.deepseek.com/","_blank")}S(P=>[...P,p])},600),f("")},Xe=async s=>{var Ve;let c=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],l=null;const I=c.filter(U=>U.name.endsWith(".zip"));let p=[];if(I.length>0){S(U=>[...U,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const U=(await en(async()=>{const{default:ce}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:ce}},[])).default;for(const ce of I){l=ce;const we=await new U().loadAsync(ce);for(const[ie,ye]of Object.entries(we.files))if(!ye.dir&&!ie.includes("__MACOSX")&&!((Ve=ie.split("/").pop())!=null&&Ve.startsWith("."))){const Ue=await ye.async("blob"),ot=new File([Ue],ie.split("/").pop()||ie,{type:Ue.type});p.push(ot)}}}catch(U){console.error("Erreur décompression ZIP:",U),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}for(const U of I)try{const ce=await U.arrayBuffer(),tt=arrayBufferToBase64(ce);fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:R||F||oe||"AUDIO",fileName:U.name,fileBase64:tt})}).catch(ie=>console.warn("[Upload ZIP Sync] Notice:",ie))}catch{}}c=[...c.filter(U=>!U.name.endsWith(".zip")),...p];const x=c.filter(U=>U.name.endsWith(".html")),P=c.filter(U=>!U.name.endsWith(".html")&&(U.name.endsWith(".png")||U.name.endsWith(".jpg")||U.name.endsWith(".jpeg")||U.name.endsWith(".md")||U.name.endsWith(".json")||U.name.endsWith(".txt")||U.name.endsWith(".tsx")||U.name.endsWith(".ts")||U.name.endsWith(".jsx")||U.name.endsWith(".js")||U.name.endsWith(".css")||U.name.endsWith(".svg")));if(x.length===0&&P.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .tsx, .ts, .png, ou un .zip.");return}let N=[...bt];for(const U of P){const ce=U.name.endsWith(".png")||U.name.endsWith(".jpg")||U.name.endsWith(".jpeg"),tt=await new Promise(ie=>{const ye=new FileReader;ye.onload=Ue=>{var ot;return ie((ot=Ue.target)==null?void 0:ot.result)},ce?ye.readAsDataURL(U):ye.readAsText(U)}),we={path:U.name,content:ce?`[Image jointe visuellement : ${U.name} (Binaire ignoré pour économie de tokens)]`:tt};N.some(ie=>ie.path===U.name)||N.push(we),S(ie=>[...ie,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${U.name}`}])}if(x.length>0){const U=x[0],ce=await new Promise(ie=>{const ye=new FileReader;ye.onload=Ue=>{var ot;return ie((ot=Ue.target)==null?void 0:ot.result)},ye.readAsText(U)}),tt={path:U.name,content:ce};N.some(ie=>ie.path===U.name)||N.push(tt);const we={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${U.name}
Analyse de la structure UI et assemblage du contexte en cours...`};S(ie=>[...ie,we])}const Q=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter(U=>U.name.endsWith(".zip"));for(const U of Q)N.some(ce=>ce.path===U.name)||N.push({path:U.name,content:"ZIP_ARCHIVE_DUMMY"});Pt(N);const B=R||oe||"Projet_Stitch",K=c.map(U=>U.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${B}: ${K}`);const Le=x.length;if(Le>3){const U=localStorage.getItem("tiger_targetAi")||"deepseek",ce=l?"Projet_ZIP_"+l.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),tt=R||ce;R||Pe(tt),S(ie=>[...ie,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !

Hermes a détecté ${Le} pages HTML dans votre ZIP.
Découpage automatique en lots de 3 fichiers en cours...
Démarrage de l'automatisation séquentielle via DeepSeek !`,widget:"phases"}]),X(1);let we="";if(l)we=await new Promise(ie=>{const ye=new FileReader;ye.onload=Ue=>{var ot;return ie(((ot=Ue.target)==null?void 0:ot.result).split(",")[1])},ye.readAsDataURL(l)});else{const ie=(await en(async()=>{const{default:Ue}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:Ue}},[])).default,ye=new ie;for(const Ue of c)ye.file(Ue.name,Ue);we=await ye.generateAsync({type:"base64"})}A("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({zip_base64:we,zip_mode:!0,target_ai:U,target_project:tt,user_prompt:oe.trim()?`${oe} - ${mt}`:`Application multi-pages issue de ${(l==null?void 0:l.name)||"fichiers_locaux"}`})}).then(async ie=>{const ye=await ie.json();ye.success?(S(Ue=>[...Ue,{id:Date.now().toString()+"_hermes",role:"assistant",content:`✅ ${ye.message}

📡 Lot 1/${ye.total_batches} transmis à DeepSeek. Les lots suivants s'enchaîneront automatiquement !
Fichiers détectés : ${(ye.files_detected||[]).join(", ")}`}]),window.open(lt(U),"_blank")):alert("Erreur Hermes : "+(ye.error||"Inconnue"))}).catch(ie=>{alert(`Erreur de connexion au Moteur Local : ${ie.message}`)});return}if(x.length>0){if(document.getElementById("creation-mode-container"))return;setTimeout(()=>{et(N)},1200)}},et=async(s=bt)=>{Re(!1);const c=s.find(B=>B.path.endsWith(".html"));if(!c){alert("Aucun fichier HTML trouvé dans le Trombone !");return}const l=oe.trim()?"Projet_"+oe.replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4):"Design_"+c.path.replace(".html","").replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4),I=R||l;if(!R){Pe(I);try{await A("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:I,file:"README.md",content:`# ${oe||I}

Initialisé par Tiger IA V0 (Design-First).`})})}catch(B){console.error("[IDE] Erreur création auto du dossier",B)}}const p=s.filter(B=>B.path!==c.path),x=c.content,P={id:(Date.now()+1).toString(),role:"assistant",content:`Mode "Design-First" activé. 🎨

Transmission du design au LLM avec les ${p.length} fichiers du Trombone intégrés.
Câblage en cours...`,widget:"phases"};X(5),S(B=>[...B,P]);let N=5;const Q=setInterval(()=>{N++,N>11?clearInterval(Q):X(N)},3e3);if(typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Mode Design-First Activé !"),typeof window<"u"){const B=localStorage.getItem("tiger_targetAi")||"deepseek";let K="";p.length>0&&(K=`
...
\`\`\`
`,U=window.AndroidBridge;if(U&&U.openAIWithPrompt){const ce=lt(B);U.openAIWithPrompt(ce,Ve),U.showToast&&U.showToast("HTML injecté. Câblage sur "+B.toUpperCase()+" !")}else A("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:B,prompt:Ve,auto_submit:!0,project_id:I,phase_num:5})}).then(ce=>console.log("[Bridge] Prompt HTML + Contexte envoyé avec succès, status:",ce.status)).catch(ce=>console.error("[Bridge] Erreur lors de l'envoi du prompt:",ce))}},ut=(s,c=0)=>s?s.type==="directory"?e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-2 px-2 py-1 hover:bg-white/5 cursor-pointer text-gray-300 text-sm",style:{paddingLeft:`${c*12+8}px`},children:[e.jsx("span",{className:"text-orange-400",children:"📁"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-dossier truncate font-bold",children:s.name})]}),s.children&&s.children.map(l=>ut(l,c+1))]},s.path):e.jsxs("div",{className:`flex items-center justify-between px-2 py-1 hover:bg-white/10 cursor-pointer text-sm group ${pe===s.path?"bg-cyan/20 text-cyan border-l-2 border-cyan":"text-gray-400"}`,style:{paddingLeft:`${c*12+8}px`},onClick:()=>Je(s.path),children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-blue-400",children:"📄"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-fichier truncate",children:s.name})]}),e.jsxs("div",{className:"hidden group-hover:flex items-center gap-1",children:[e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-red-500/50 transition-colors",title:"Suture : Réparer ou débugger ce fichier",onClick:l=>{l.stopPropagation(),Je(s.path),setTimeout(()=>je("suture","Veuillez analyser ce fichier et corriger toutes les erreurs, fautes de frappe ou imports manquants."),100)},children:"🩺"}),e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-cyan/50 transition-colors",title:"Ajouter au Trombone",onClick:l=>{l.stopPropagation(),k(s.path)},children:"📎"})]})]},s.path):null,je=async(s,c)=>{if(!R){alert("⚠️ Veuillez sélectionner un projet actif dans l'explorateur.");return}const l=localStorage.getItem("tiger_targetAi")||"deepseek";let I="";s==="suture"?I=`🩺 SUTURE CHIRURGICALE — CORRECTION D'ERREUR DÉTECTÉE
...
`):s==="refactor"?I=`🔄 REFACTORING — Refactorise le code du projet [${R}] pour une qualité industrielle.

`:s==="improve"&&(I=`✨ AMÉLIORATION — Ajoute des animations et améliorations UI pour le projet [${R}].

`),pe&&qt&&(I+=`--- Fichier Actif en Édition : ${pe} ---
\`\`\`
${qt}
\`\`\`

`),bt.length>0&&(I+=`--- Fichiers de contexte du Trombone ---

`,bt.forEach(p=>{I+=`--- ${p.path} ---
\`\`\`
${p.content}
\`\`\`
...
[PACKS PRD ARCHITECTURE SELECTIONNES (${j.length})]
`+j.map(K=>{const Le=Gt.find(Ve=>Ve.id===K);return`• ${Le?Le.name:K} (#${K})`}).join(`
`):"";let N=`

[STACK TECHNIQUE OBLIGATOIRE : ${ze.toUpperCase()}]
`;ze.includes("Three.js")||ze.includes("3D GPU")?N+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être un jeu Web 3D accéléré GPU généré en **React + Vite + TypeScript (TSX) + Three.js / React Three Fiber (@react-three/fiber, @react-three/drei)**.
...
`:ze.includes("Canvas 2D")?N+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être un jeu Web 2D généré en **React + Vite + TypeScript (TSX) + Canvas 2D**.

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-D0ylOFsN.js","assets/design-v200-BU4g7UhC.js","assets/design-v200-CHRXnMOk.css"])))=>i.map(i=>d[i]);
import{r as a,a as Tt,j as e,s as I,i as fs,R as bs}from"./design-v200-BU4g7UhC.js";const vs="modulepreload",Ss=function(t){return"/"+t},Ln={},Yt=function(n,r,l){let d=Promise.resolve();if(r&&r.length>0){let h=function(S){return Promise.all(S.map(b=>Promise.resolve(b).then(U=>({status:"fulfilled",value:U}),U=>({status:"rejected",reason:U}))))};document.getElementsByTagName("link");const p=document.querySelector("meta[property=csp-nonce]"),_=(p==null?void 0:p.nonce)||(p==null?void 0:p.getAttribute("nonce"));d=h(r.map(S=>{if(S=Ss(S),S in Ln)return;Ln[S]=!0;const b=S.endsWith(".css"),U=b?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${S}"]${U}`))return;const O=document.createElement("link");if(O.rel=b?"stylesheet":vs,b||(O.as="script"),O.crossOrigin="",O.href=S,_&&O.setAttribute("nonce",_),document.head.appendChild(O),b)return new Promise((Q,N)=>{O.addEventListener("load",Q),O.addEventListener("error",()=>N(new Error(`Unable to preload CSS for ${S}`)))})}))}function m(h){const p=new Event("vite:preloadError",{cancelable:!0});if(p.payload=h,window.dispatchEvent(p),!p.defaultPrevented)throw h}return d.then(h=>{for(const p of h||[])p.status==="rejected"&&m(p.reason);return n().catch(m)})},ys=`# undefined
...
`,_s=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
---
### 🔄 INSTRUCTION DE FUSION (Pour l'Orchestrateur API)
*Lorsque l'utilisateur sélectionnera ce pack "Audio" dans l'interface de Tiger IA, tu dois fusionner ces 10 capacités avec la demande précise du chat. Par exemple, si l'utilisateur demande "Crée moi un clone de Spotify", tu dois immédiatement mobiliser les modules \`prd_audio_file_library\`, \`prd_audio_player_podcast\` et \`prd_audio_mix_playlist\` pour générer une architecture complète en un seul shot.*`,ws=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
## Instructions Originales
`,Ps=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/components/ui/Toast.tsx\``,ks=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/creator/components/SocialLinkButton.tsx\``,Ts=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/handoff/components/RedlineViewer.tsx\``,Es=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
`,Rs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/shop/contexts/CartContext.tsx\``,Ns=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- src/shared/constants/products.ts (données mock)`,Ds=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/events/components/TicketingCard.tsx\``,Ms=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`/requirements.txt\` & \`/package.json\` (Gestion des dépendances isolées)`,Ls=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/components/inputs/CreditCardInput.tsx\``,Us=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/forms/schemas/registrationSchema.ts\``,Os=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
---
`,Fs=`# Industrialisation_Backend_KIROV5
...
## Instructions Originales
`,Vs=`# BRIC — Sovereign PRD Specification Pack
...
`,Bs=`# bricbrac — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,zs=`# bros — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Hs=`# BROSS — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,$s=`# Industrialisation_Backend_Phase5
...
MIT`,Ws=`# COLORFUL LANDING PAGE BUILDER
...
## License
MIT`,Js=`# CyberRunner — Sovereign PRD Specification Pack
...
src/
  ...
  main.tsx
  index.css
\`\`\``,er=`# gametetris — Sovereign PRD Specification Pack
...
MIT`,ir=`# mariob — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,ar=`# 🚀 Pack PRD : Calculatrice Premium "One-Shot" (guest_nebula_calc)
...
Chaque composant doit être entièrement fonctionnel, avec des props typées, et utiliser les hooks appropriés. Le code doit être propre, commenté et suivre les meilleures pratiques React/TypeScript.`,lr=`> **Directive Système IA** : Tu es un Architecte Logiciel Senior et Expert en Product Design. Génère des composants React/TypeScript de haute qualité pour le jeu **NEONSTACK ARCADE**. Suis les directives du PRD, respecte le design system, et produis du code fonctionnel et esthétique.
...
src/
  ...
  App.tsx
  main.tsx
\`\`\``,cr=`# plateforme — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,dr=`# plateformv2 — Sovereign PRD Specification Pack
...
src/
  ...
  App.tsx
  main.tsx
\`\`\``,pr=`# PRODUCTION READY INDUSTRIALIZATION
...
## Instructions Originales
`,hr=`# SOVEREIGN PRODUCTION PLATFORM
...
`,Cr=`# Workflow Automation Platform
...
└── utils/
    ├── constants.ts
    └── helpers.ts
\`\`\``,Ar=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/health/components/BreathingCircle.tsx\``,Pr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/images/hooks/useImageUpload.ts\``,kr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/admin/components/EmptyState.tsx\``,Tr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/game/types/engine.ts\``,Er=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/landing/components/FooterCTA.tsx\``,Rr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/saas-landing/components/ProductMockup.tsx\``,Nr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/layouts/KanbanLayout.tsx\``,Dr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/maps/hooks/useGeolocation.ts\``,Mr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/marketing/components/LeadCaptureForm.tsx\``,Lr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/mobile/components/SwipeActionContainer.tsx\``,Ur=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/shell/components/BottomSheet.tsx\``,Or=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/api/apiClient.ts\` (Interface qui tape sur les mocks pour l'instant)`,Fr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/documents/components/ThumbnailSidebar.tsx\``,Vr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/hooks/useFileUpload.ts\``,Br=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/ai.ts\` (interfaces Message, ChatSession, Attachment)`,zr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/voice/components/MicrophoneToggle.tsx\``,Hr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/auth/hooks/useSession.ts\``,$r=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/magazine/components/AuthorByline.tsx\``,Kr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/crm.ts\` (interfaces Contact, Activity, Tag)`,Wr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/catalog/hooks/useCatalogFilters.ts\``,Jr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/checkout/components/ExpressPayButtons.tsx\``,Xr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
`,Qr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/leaderboard/components/StickyUserRank.tsx\``,Zr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/dashboard/pages/BentoDashboardPage.tsx\``,Yr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/kanban/hooks/useKanbanBoard.ts\``,ei=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
---
### 🔄 INSTRUCTION DE FUSION (Pour l'Orchestrateur API)
*Lorsque l'utilisateur demandera "Crée moi la structure de mon app mobile type Instagram", tu devras utiliser ce PRD Mobile comme squelette. Tu injecteras une Tab Bar en bas (Accueil, Recherche, Ajouter, Profil) et tu t'assureras que le défilement vertical n'affecte que le contenu intérieur (overflow-y-auto) sans faire bouger les barres de navigation natives.*`,ti=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/social/components/LikeAnimation.tsx\``,ni=`# bricbrac — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,si=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/billing/components/InvoiceTable.tsx\``,ri=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/saas.ts\` (interfaces User, Tenant, Subscription)`,ii=`# 🏛️ Pack PRD : Sovereign Full-Stack Engine
...
`,ai=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/specs/components/DynamicForm.tsx\``,oi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/utils/timeFormat.ts\``,ci=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/marketing/components/RoadmapBoard.tsx\``,di=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/ai-studio/components/TokenCostChart.tsx\``,ui=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/saas/pages/BillingDashboard.tsx\``,pi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/landing/components/ConversionSection.tsx\``,mi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/database/components/ResultDataTable.tsx\``,gi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/stealth/ui/FloatingGhostMenu.tsx\``,hi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/editor/hooks/useEditorState.ts\``,xi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
`,fi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/video/hooks/useVideoPlayer.ts\``,bi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/blog/components/TableOfContents.tsx\``,vi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/widgets/hooks/useCalendarState.ts\``;function Un(t,n){(n==null||n>t.length)&&(n=t.length);for(var r=0,l=Array(n);r<n;r++)l[r]=t[r];return l}function Si(t){if(Array.isArray(t))return t}function yi(t,n,r){return(n=ji(n))in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function _i(t,n){var r=t==null?null:typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(r!=null){var l,d,m,h,p=[],_=!0,S=!1;try{if(m=(r=r.call(t)).next,n!==0)for(;!(_=(l=m.call(r)).done)&&(p.push(l.value),p.length!==n);_=!0);}catch(b){S=!0,d=b}finally{try{if(!_&&r.return!=null&&(h=r.return(),Object(h)!==h))return}finally{if(S)throw d}}return p}}function Ci(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function On(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var l=Object.getOwnPropertySymbols(t);n&&(l=l.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,l)}return r}function Gn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?On(Object(r),!0).forEach(function(l){yi(t,l,r[l])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):On(Object(r)).forEach(function(l){Object.defineProperty(t,l,Object.getOwnPropertyDescriptor(r,l))})}return t}function wi(t,n){if(t==null)return{};var r,l,d=Ii(t,n);if(Object.getOwnPropertySymbols){var m=Object.getOwnPropertySymbols(t);for(l=0;l<m.length;l++)r=m[l],n.indexOf(r)===-1&&{}.propertyIsEnumerable.call(t,r)&&(d[r]=t[r])}return d}function Ii(t,n){if(t==null)return{};var r={};for(var l in t)if({}.hasOwnProperty.call(t,l)){if(n.indexOf(l)!==-1)continue;r[l]=t[l]}return r}function Ai(t,n){return Si(t)||_i(t,n)||ki(t,n)||Ci()}function Pi(t,n){if(typeof t!="object"||!t)return t;var r=t[Symbol.toPrimitive];if(r!==void 0){var l=r.call(t,n);if(typeof l!="object")return l;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}function ji(t){var n=Pi(t,"string");return typeof n=="symbol"?n:n+""}function ki(t,n){if(t){if(typeof t=="string")return Un(t,n);var r={}.toString.call(t).slice(8,-1);return r==="Object"&&t.constructor&&(r=t.constructor.name),r==="Map"||r==="Set"?Array.from(t):r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?Un(t,n):void 0}}function Ti(t,n,r){return n in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function Fn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var l=Object.getOwnPropertySymbols(t);n&&(l=l.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,l)}return r}function Vn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Fn(Object(r),!0).forEach(function(l){Ti(t,l,r[l])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Fn(Object(r)).forEach(function(l){Object.defineProperty(t,l,Object.getOwnPropertyDescriptor(r,l))})}return t}function Ei(){for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r];return function(l){return n.reduceRight(function(d,m){return m(d)},l)}}function Qt(t){return function n(){for(var r=this,l=arguments.length,d=new Array(l),m=0;m<l;m++)d[m]=arguments[m];return d.length>=t.length?t.apply(this,d):function(){for(var h=arguments.length,p=new Array(h),_=0;_<h;_++)p[_]=arguments[_];return n.apply(r,[].concat(d,p))}}}function hn(t){return{}.toString.call(t).includes("Object")}function Ri(t){return!Object.keys(t).length}function en(t){return typeof t=="function"}function Ni(t,n){return Object.prototype.hasOwnProperty.call(t,n)}function Di(t,n){return hn(n)||St("changeType"),Object.keys(n).some(function(r){return!Ni(t,r)})&&St("changeField"),n}function Mi(t){en(t)||St("selectorType")}function qi(t){en(t)||hn(t)||St("handlerType"),hn(t)&&Object.values(t).some(function(n){return!en(n)})&&St("handlersType")}function Li(t){t||St("initialIsRequired"),hn(t)||St("initialType"),Ri(t)&&St("initialContent")}function Ui(t,n){throw new Error(t[n]||t.default)}var Oi={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},St=Qt(Ui)(Oi),un={changes:Di,selector:Mi,handler:qi,initial:Li};function Gi(t){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};un.initial(t),un.handler(n);var r={current:t},l=Qt(Bi)(r,n),d=Qt(Vi)(r),m=Qt(un.changes)(t),h=Qt(Fi)(r);function p(){var S=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(b){return b};return un.selector(S),S(r.current)}function _(S){Ei(l,d,m,h)(S)}return[p,_]}function Fi(t,n){return en(n)?n(t.current):n}function Vi(t,n){return t.current=Vn(Vn({},t.current),n),n}function Bi(t,n,r){return en(n)?n(t.current):Object.keys(r).forEach(function(l){var d;return(d=n[l])===null||d===void 0?void 0:d.call(n,t.current[l])}),r}var zi={create:Gi},Hi={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.55.1/min/vs"}};function $i(t){return function n(){for(var r=this,l=arguments.length,d=new Array(l),m=0;m<l;m++)d[m]=arguments[m];return d.length>=t.length?t.apply(this,d):function(){for(var h=arguments.length,p=new Array(h),_=0;_<h;_++)p[_]=arguments[_];return n.apply(r,[].concat(d,p))}}}function Ki(t){return{}.toString.call(t).includes("Object")}function Wi(t){return t||Bn("configIsRequired"),Ki(t)||Bn("configType"),t.urls?(Ji(),{paths:{vs:t.urls.monacoBase}}):t}function Ji(){console.warn(Zn.deprecation)}function Xi(t,n){throw new Error(t[n]||t.default)}var Zn={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},Bn=$i(Xi)(Zn),Qi={config:Wi},Zi=function(){for(var n=arguments.length,r=new Array(n),l=0;l<n;l++)r[l]=arguments[l];return function(d){return r.reduceRight(function(m,h){return h(m)},d)}};function Yn(t,n){return Object.keys(n).forEach(function(r){n[r]instanceof Object&&t[r]&&Object.assign(n[r],Yn(t[r],n[r]))}),Gn(Gn({},t),n)}var Yi={type:"cancelation",msg:"operation is manually canceled"};function yn(t){var n=!1,r=new Promise(function(l,d){t.then(function(m){return n?d(Yi):l(m)}),t.catch(d)});return r.cancel=function(){return n=!0},r}var ea=["monaco"],ta=zi.create({config:Hi,isInitialized:!1,resolve:null,reject:null,monaco:null}),es=Ai(ta,2),tn=es[0],fn=es[1];function na(t){var n=Qi.config(t),r=n.monaco,l=wi(n,ea);fn(function(d){return{config:Yn(d.config,l),monaco:r}})}function sa(){var t=tn(function(n){var r=n.monaco,l=n.isInitialized,d=n.resolve;return{monaco:r,isInitialized:l,resolve:d}});if(!t.isInitialized){if(fn({isInitialized:!0}),t.monaco)return t.resolve(t.monaco),yn(_n);if(window.monaco&&window.monaco.editor)return ts(window.monaco),t.resolve(window.monaco),yn(_n);Zi(ra,aa)(oa)}return yn(_n)}function ra(t){return document.body.appendChild(t)}function ia(t){var n=document.createElement("script");return t&&(n.src=t),n}function aa(t){var n=tn(function(l){var d=l.config,m=l.reject;return{config:d,reject:m}}),r=ia("".concat(n.config.paths.vs,"/loader.js"));return r.onload=function(){return t()},r.onerror=n.reject,r}function oa(){var t=tn(function(r){var l=r.config,d=r.resolve,m=r.reject;return{config:l,resolve:d,reject:m}}),n=window.require;n.config(t.config),n(["vs/editor/editor.main"],function(r){var l=r.m||r;ts(l),t.resolve(l)},function(r){t.reject(r)})}function ts(t){tn().monaco||fn({monaco:t})}function la(){return tn(function(t){var n=t.monaco;return n})}var _n=new Promise(function(t,n){return fn({resolve:t,reject:n})}),ns={config:na,init:sa,__getMonacoInstance:la},ca={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},Cn=ca,da={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},ua=da;function pa({children:t}){return Tt.createElement("div",{style:ua.container},t)}var ma=pa,ga=ma;function ha({width:t,height:n,isEditorReady:r,loading:l,_ref:d,className:m,wrapperProps:h}){return Tt.createElement("section",{style:{...Cn.wrapper,width:t,height:n},...h},!r&&Tt.createElement(ga,null,l),Tt.createElement("div",{ref:d,style:{...Cn.fullWidth,...!r&&Cn.hide},className:m}))}var xa=ha,ss=a.memo(xa);function fa(t){a.useEffect(t,[])}var rs=fa;function ba(t,n,r=!0){let l=a.useRef(!0);a.useEffect(l.current||!r?()=>{l.current=!1}:t,n)}var Be=ba;function Zt(){}function Ot(t,n,r,l){return va(t,l)||Sa(t,n,r,l)}function va(t,n){return t.editor.getModel(is(t,n))}function Sa(t,n,r,l){return t.editor.createModel(n,r,l?is(t,l):void 0)}function is(t,n){return t.Uri.parse(n)}function ya({original:t,modified:n,language:r,originalLanguage:l,modifiedLanguage:d,originalModelPath:m,modifiedModelPath:h,keepCurrentOriginalModel:p=!1,keepCurrentModifiedModel:_=!1,theme:S="light",loading:b="Loading...",options:U={},height:O="100%",width:Q="100%",className:N,wrapperProps:L={},beforeMount:V=Zt,onMount:x=Zt}){let[w,q]=a.useState(!1),[y,G]=a.useState(!0),H=a.useRef(null),A=a.useRef(null),D=a.useRef(null),W=a.useRef(x),B=a.useRef(V),Z=a.useRef(!1);rs(()=>{let z=ns.init();return z.then(ee=>(A.current=ee)&&G(!1)).catch(ee=>(ee==null?void 0:ee.type)!=="cancelation"&&console.error("Monaco initialization: error:",ee)),()=>H.current?ve():z.cancel()}),Be(()=>{if(H.current&&A.current){let z=H.current.getOriginalEditor(),ee=Ot(A.current,t||"",l||r||"text",m||"");ee!==z.getModel()&&z.setModel(ee)}},[m],w),Be(()=>{if(H.current&&A.current){let z=H.current.getModifiedEditor(),ee=Ot(A.current,n||"",d||r||"text",h||"");ee!==z.getModel()&&z.setModel(ee)}},[h],w),Be(()=>{let z=H.current.getModifiedEditor();z.getOption(A.current.editor.EditorOption.readOnly)?z.setValue(n||""):n!==z.getValue()&&(z.executeEdits("",[{range:z.getModel().getFullModelRange(),text:n||"",forceMoveMarkers:!0}]),z.pushUndoStop())},[n],w),Be(()=>{var z,ee;(ee=(z=H.current)==null?void 0:z.getModel())==null||ee.original.setValue(t||"")},[t],w),Be(()=>{let{original:z,modified:ee}=H.current.getModel();A.current.editor.setModelLanguage(z,l||r||"text"),A.current.editor.setModelLanguage(ee,d||r||"text")},[r,l,d],w),Be(()=>{var z;(z=A.current)==null||z.editor.setTheme(S)},[S],w),Be(()=>{var z;(z=H.current)==null||z.updateOptions(U)},[U],w);let K=a.useCallback(()=>{var de;if(!A.current)return;B.current(A.current);let z=Ot(A.current,t||"",l||r||"text",m||""),ee=Ot(A.current,n||"",d||r||"text",h||"");(de=H.current)==null||de.setModel({original:z,modified:ee})},[r,n,d,t,l,m,h]),ae=a.useCallback(()=>{var z;!Z.current&&D.current&&(H.current=A.current.editor.createDiffEditor(D.current,{automaticLayout:!0,...U}),K(),(z=A.current)==null||z.editor.setTheme(S),q(!0),Z.current=!0)},[U,S,K]);a.useEffect(()=>{w&&W.current(H.current,A.current)},[w]),a.useEffect(()=>{!y&&!w&&ae()},[y,w,ae]);function ve(){var ee,de,xe,Ie;let z=(ee=H.current)==null?void 0:ee.getModel();p||((de=z==null?void 0:z.original)==null||de.dispose()),_||((xe=z==null?void 0:z.modified)==null||xe.dispose()),(Ie=H.current)==null||Ie.dispose()}return Tt.createElement(ss,{width:Q,height:O,isEditorReady:w,loading:b,_ref:D,className:N,wrapperProps:L})}var _a=ya;a.memo(_a);function Ca(t){let n=a.useRef();return a.useEffect(()=>{n.current=t},[t]),n.current}var wa=Ca,pn=new Map;function Ia({defaultValue:t,defaultLanguage:n,defaultPath:r,value:l,language:d,path:m,theme:h="light",line:p,loading:_="Loading...",options:S={},overrideServices:b={},saveViewState:U=!0,keepCurrentModel:O=!1,width:Q="100%",height:N="100%",className:L,wrapperProps:V={},beforeMount:x=Zt,onMount:w=Zt,onChange:q,onValidate:y=Zt}){let[G,H]=a.useState(!1),[A,D]=a.useState(!0),W=a.useRef(null),B=a.useRef(null),Z=a.useRef(null),K=a.useRef(w),ae=a.useRef(x),ve=a.useRef(),z=a.useRef(l),ee=wa(m),de=a.useRef(!1),xe=a.useRef(!1);rs(()=>{let j=ns.init();return j.then(X=>(W.current=X)&&D(!1)).catch(X=>(X==null?void 0:X.type)!=="cancelation"&&console.error("Monaco initialization: error:",X)),()=>B.current?te():j.cancel()}),Be(()=>{var X,re,ue,fe;let j=Ot(W.current,t||l||"",n||d||"",m||r||"");j!==((X=B.current)==null?void 0:X.getModel())&&(U&&pn.set(ee,(re=B.current)==null?void 0:re.saveViewState()),(ue=B.current)==null||ue.setModel(j),U&&((fe=B.current)==null||fe.restoreViewState(pn.get(m))))},[m],G),Be(()=>{var j;(j=B.current)==null||j.updateOptions(S)},[S],G),Be(()=>{!B.current||l===void 0||(B.current.getOption(W.current.editor.EditorOption.readOnly)?B.current.setValue(l):l!==B.current.getValue()&&(xe.current=!0,B.current.executeEdits("",[{range:B.current.getModel().getFullModelRange(),text:l,forceMoveMarkers:!0}]),B.current.pushUndoStop(),xe.current=!1))},[l],G),Be(()=>{var X,re;let j=(X=B.current)==null?void 0:X.getModel();j&&d&&((re=W.current)==null||re.editor.setModelLanguage(j,d))},[d],G),Be(()=>{var j;p!==void 0&&((j=B.current)==null||j.revealLine(p))},[p],G),Be(()=>{var j;(j=W.current)==null||j.editor.setTheme(h)},[h],G);let Ie=a.useCallback(()=>{var j;if(!(!Z.current||!W.current)&&!de.current){ae.current(W.current);let X=m||r,re=Ot(W.current,l||t||"",n||d||"",X||"");B.current=(j=W.current)==null?void 0:j.editor.create(Z.current,{model:re,automaticLayout:!0,...S},b),U&&B.current.restoreViewState(pn.get(X)),W.current.editor.setTheme(h),p!==void 0&&B.current.revealLine(p),H(!0),de.current=!0}},[t,n,r,l,d,m,S,b,U,h,p]);a.useEffect(()=>{G&&K.current(B.current,W.current)},[G]),a.useEffect(()=>{!A&&!G&&Ie()},[A,G,Ie]),z.current=l,a.useEffect(()=>{var j,X;G&&q&&((j=ve.current)==null||j.dispose(),ve.current=(X=B.current)==null?void 0:X.onDidChangeModelContent(re=>{xe.current||q(B.current.getValue(),re)}))},[G,q]),a.useEffect(()=>{if(G){let j=W.current.editor.onDidChangeMarkers(X=>{var ue;let re=(ue=B.current.getModel())==null?void 0:ue.uri;if(re&&X.find(fe=>fe.path===re.path)){let fe=W.current.editor.getModelMarkers({resource:re});y==null||y(fe)}});return()=>{j==null||j.dispose()}}return()=>{}},[G,y]);function te(){var j,X;(j=ve.current)==null||j.dispose(),O?U&&pn.set(m,B.current.saveViewState()):(X=B.current.getModel())==null||X.dispose(),B.current.dispose()}return Tt.createElement(ss,{width:Q,height:N,isEditorReady:G,loading:_,_ref:Z,className:L,wrapperProps:V})}var Aa=Ia,Pa=a.memo(Aa),ja=Pa;/*! Capacitor: https://capacitorjs.com/ - MIT License */const ka=t=>{const n=new Map;n.set("web",{name:"web"});const r=t.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:n},l=(m,h)=>{r.platforms.set(m,h)},d=m=>{r.platforms.has(m)&&(r.currentPlatform=r.platforms.get(m))};return r.addPlatform=l,r.setPlatform=d,r},Ta=t=>t.CapacitorPlatforms=ka(t),as=Ta(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});as.addPlatform;as.setPlatform;var Vt;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(Vt||(Vt={}));class wn extends Error{constructor(n,r,l){super(n),this.message=n,this.code=r,this.data=l}}const Ea=t=>{var n,r;return t!=null&&t.androidBridge?"android":!((r=(n=t==null?void 0:t.webkit)===null||n===void 0?void 0:n.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},Ra=t=>{var n,r,l,d,m;const h=t.CapacitorCustomPlatform||null,p=t.Capacitor||{},_=p.Plugins=p.Plugins||{},S=t.CapacitorPlatforms,b=()=>h!==null?h.name:Ea(t),U=((n=S==null?void 0:S.currentPlatform)===null||n===void 0?void 0:n.getPlatform)||b,O=()=>U()!=="web",Q=((r=S==null?void 0:S.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||O,N=A=>{const D=y.get(A);return!!(D!=null&&D.platforms.has(U())||x(A))},L=((l=S==null?void 0:S.currentPlatform)===null||l===void 0?void 0:l.isPluginAvailable)||N,V=A=>{var D;return(D=p.PluginHeaders)===null||D===void 0?void 0:D.find(W=>W.name===A)},x=((d=S==null?void 0:S.currentPlatform)===null||d===void 0?void 0:d.getPluginHeader)||V,w=A=>t.console.error(A),q=(A,D,W)=>Promise.reject(`${W} does not have an implementation of "${D}".`),y=new Map,G=(A,D={})=>{const W=y.get(A);if(W)return console.warn(`Capacitor plugin "${A}" already registered. Cannot register plugins twice.`),W.proxy;const B=U(),Z=x(A);let K;const ae=async()=>(!K&&B in D?K=typeof D[B]=="function"?K=await D[B]():K=D[B]:h!==null&&!K&&"web"in D&&(K=typeof D.web=="function"?K=await D.web():K=D.web),K),ve=(te,j)=>{var X,re;if(Z){const ue=Z==null?void 0:Z.methods.find(fe=>j===fe.name);if(ue)return ue.rtype==="promise"?fe=>p.nativePromise(A,j.toString(),fe):(fe,Te)=>p.nativeCallback(A,j.toString(),fe,Te);if(te)return(X=te[j])===null||X===void 0?void 0:X.bind(te)}else{if(te)return(re=te[j])===null||re===void 0?void 0:re.bind(te);throw new wn(`"${A}" plugin is not implemented on ${B}`,Vt.Unimplemented)}},z=te=>{let j;const X=(...re)=>{const ue=ae().then(fe=>{const Te=ve(fe,te);if(Te){const ke=Te(...re);return j=ke==null?void 0:ke.remove,ke}else throw new wn(`"${A}.${te}()" is not implemented on ${B}`,Vt.Unimplemented)});return te==="addListener"&&(ue.remove=async()=>j()),ue};return X.toString=()=>`${te.toString()}() { [capacitor code] }`,Object.defineProperty(X,"name",{value:te,writable:!1,configurable:!1}),X},ee=z("addListener"),de=z("removeListener"),xe=(te,j)=>{const X=ee({eventName:te},j),re=async()=>{const fe=await X;de({eventName:te,callbackId:fe},j)},ue=new Promise(fe=>X.then(()=>fe({remove:re})));return ue.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await re()},ue},Ie=new Proxy({},{get(te,j){switch(j){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return Z?xe:ee;case"removeListener":return de;default:return z(j)}}});return _[A]=Ie,y.set(A,{name:A,proxy:Ie,platforms:new Set([...Object.keys(D),...Z?[B]:[]])}),Ie},H=((m=S==null?void 0:S.currentPlatform)===null||m===void 0?void 0:m.registerPlugin)||G;return p.convertFileSrc||(p.convertFileSrc=A=>A),p.getPlatform=U,p.handleError=w,p.isNativePlatform=Q,p.isPluginAvailable=L,p.pluginMethodNoop=q,p.registerPlugin=H,p.Exception=wn,p.DEBUG=!!p.DEBUG,p.isLoggingEnabled=!!p.isLoggingEnabled,p.platform=p.getPlatform(),p.isNative=p.isNativePlatform(),p},Na=t=>t.Capacitor=Ra(t),Bt=Na(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Rn=Bt.registerPlugin;Bt.Plugins;class os{constructor(n){this.listeners={},this.retainedEventArguments={},this.windowListeners={},n&&(console.warn(`Capacitor WebPlugin "${n.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=n)}addListener(n,r){let l=!1;this.listeners[n]||(this.listeners[n]=[],l=!0),this.listeners[n].push(r);const m=this.windowListeners[n];m&&!m.registered&&this.addWindowListener(m),l&&this.sendRetainedArgumentsForEvent(n);const h=async()=>this.removeListener(n,r);return Promise.resolve({remove:h})}async removeAllListeners(){this.listeners={};for(const n in this.windowListeners)this.removeWindowListener(this.windowListeners[n]);this.windowListeners={}}notifyListeners(n,r,l){const d=this.listeners[n];if(!d){if(l){let m=this.retainedEventArguments[n];m||(m=[]),m.push(r),this.retainedEventArguments[n]=m}return}d.forEach(m=>m(r))}hasListeners(n){return!!this.listeners[n].length}registerWindowListener(n,r){this.windowListeners[r]={registered:!1,windowEventName:n,pluginEventName:r,handler:l=>{this.notifyListeners(r,l)}}}unimplemented(n="not implemented"){return new Bt.Exception(n,Vt.Unimplemented)}unavailable(n="not available"){return new Bt.Exception(n,Vt.Unavailable)}async removeListener(n,r){const l=this.listeners[n];if(!l)return;const d=l.indexOf(r);this.listeners[n].splice(d,1),this.listeners[n].length||this.removeWindowListener(this.windowListeners[n])}addWindowListener(n){window.addEventListener(n.windowEventName,n.handler),n.registered=!0}removeWindowListener(n){n&&(window.removeEventListener(n.windowEventName,n.handler),n.registered=!1)}sendRetainedArgumentsForEvent(n){const r=this.retainedEventArguments[n];r&&(delete this.retainedEventArguments[n],r.forEach(l=>{this.notifyListeners(n,l)}))}}const zn=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Hn=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Da extends os{async getCookies(){const n=document.cookie,r={};return n.split(";").forEach(l=>{if(l.length<=0)return;let[d,m]=l.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");d=Hn(d).trim(),m=Hn(m).trim(),r[d]=m}),r}async setCookie(n){try{const r=zn(n.key),l=zn(n.value),d=`; expires=${(n.expires||"").replace("expires=","")}`,m=(n.path||"/").replace("path=",""),h=n.url!=null&&n.url.length>0?`domain=${n.url}`:"";document.cookie=`${r}=${l||""}${d}; path=${m}; ${h};`}catch(r){return Promise.reject(r)}}async deleteCookie(n){try{document.cookie=`${n.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{const n=document.cookie.split(";")||[];for(const r of n)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(n){return Promise.reject(n)}}async clearAllCookies(){try{await this.clearCookies()}catch(n){return Promise.reject(n)}}}Rn("CapacitorCookies",{web:()=>new Da});const Ma=async t=>new Promise((n,r)=>{const l=new FileReader;l.onload=()=>{const d=l.result;n(d.indexOf(",")>=0?d.split(",")[1]:d)},l.onerror=d=>r(d),l.readAsDataURL(t)}),qa=(t={})=>{const n=Object.keys(t);return Object.keys(t).map(d=>d.toLocaleLowerCase()).reduce((d,m,h)=>(d[m]=t[n[h]],d),{})},La=(t,n=!0)=>t?Object.entries(t).reduce((l,d)=>{const[m,h]=d;let p,_;return Array.isArray(h)?(_="",h.forEach(S=>{p=n?encodeURIComponent(S):S,_+=`${m}=${p}&`}),_.slice(0,-1)):(p=n?encodeURIComponent(h):h,_=`${m}=${p}`),`${l}&${_}`},"").substr(1):null,Ua=(t,n={})=>{const r=Object.assign({method:t.method||"GET",headers:t.headers},n),d=qa(t.headers)["content-type"]||"";if(typeof t.data=="string")r.body=t.data;else if(d.includes("application/x-www-form-urlencoded")){const m=new URLSearchParams;for(const[h,p]of Object.entries(t.data||{}))m.set(h,p);r.body=m.toString()}else if(d.includes("multipart/form-data")||t.data instanceof FormData){const m=new FormData;if(t.data instanceof FormData)t.data.forEach((p,_)=>{m.append(_,p)});else for(const p of Object.keys(t.data))m.append(p,t.data[p]);r.body=m;const h=new Headers(r.headers);h.delete("content-type"),r.headers=h}else(d.includes("application/json")||typeof t.data=="object")&&(r.body=JSON.stringify(t.data));return r};class Oa extends os{async request(n){const r=Ua(n,n.webFetchExtra),l=La(n.params,n.shouldEncodeUrlParams),d=l?`${n.url}?${l}`:n.url,m=await fetch(d,r),h=m.headers.get("content-type")||"";let{responseType:p="text"}=m.ok?n:{};h.includes("application/json")&&(p="json");let _,S;switch(p){case"arraybuffer":case"blob":S=await m.blob(),_=await Ma(S);break;case"json":_=await m.json();break;case"document":case"text":default:_=await m.text()}const b={};return m.headers.forEach((U,O)=>{b[O]=U}),{data:_,headers:b,status:m.status,url:m.url}}async get(n){return this.request(Object.assign(Object.assign({},n),{method:"GET"}))}async post(n){return this.request(Object.assign(Object.assign({},n),{method:"POST"}))}async put(n){return this.request(Object.assign(Object.assign({},n),{method:"PUT"}))}async patch(n){return this.request(Object.assign(Object.assign({},n),{method:"PATCH"}))}async delete(n){return this.request(Object.assign(Object.assign({},n),{method:"DELETE"}))}}Rn("CapacitorHttp",{web:()=>new Oa});var xn;(function(t){t.Documents="DOCUMENTS",t.Data="DATA",t.Library="LIBRARY",t.Cache="CACHE",t.External="EXTERNAL",t.ExternalStorage="EXTERNAL_STORAGE"})(xn||(xn={}));var Pn;(function(t){t.UTF8="utf8",t.ASCII="ascii",t.UTF16="utf16"})(Pn||(Pn={}));const $n=Rn("Filesystem",{web:()=>Yt(()=>import("./web-v200-D0ylOFsN.js"),__vite__mapDeps([0,1,2])).then(t=>new t.FilesystemWeb)});/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ga=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),ls=(...t)=>t.filter((n,r,l)=>!!n&&l.indexOf(n)===r).join(" ");/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Va=a.forwardRef(({color:t="currentColor",size:n=24,strokeWidth:r=2,absoluteStrokeWidth:l,className:d="",children:m,iconNode:h,...p},_)=>a.createElement("svg",{ref:_,...Fa,width:n,height:n,stroke:t,strokeWidth:l?Number(r)*24/Number(n):r,className:ls("lucide",d),...p},[...h.map(([S,b])=>a.createElement(S,b)),...Array.isArray(m)?m:[m]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const le=(t,n)=>{const r=a.forwardRef(({className:l,...d},m)=>a.createElement(Va,{ref:m,iconNode:n,className:ls(`lucide-${Ga(t)}`,l),...d}));return r.displayName=`${t}`,r};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const In=le("Ban",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m4.9 4.9 14.2 14.2",key:"1m5liu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const cs=le("Box",[["path",{d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z",key:"hh9hay"}],["path",{d:"m3.3 7 8.7 5 8.7-5",key:"g66t2b"}],["path",{d:"M12 22V12",key:"d0xqtd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ha=le("ChevronUp",[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ka=le("CircleX",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wa=le("Component",[["path",{d:"M5.5 8.5 9 12l-3.5 3.5L2 12l3.5-3.5Z",key:"1kciei"}],["path",{d:"m12 2 3.5 3.5L12 9 8.5 5.5 12 2Z",key:"1ome0g"}],["path",{d:"M18.5 8.5 22 12l-3.5 3.5L15 12l3.5-3.5Z",key:"vbupec"}],["path",{d:"m12 15 3.5 3.5L12 22l-3.5-3.5L12 15Z",key:"16csic"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Kn=le("Cpu",[["rect",{width:"16",height:"16",x:"4",y:"4",rx:"2",key:"14l7u7"}],["rect",{width:"6",height:"6",x:"9",y:"9",rx:"1",key:"5aljv4"}],["path",{d:"M15 2v2",key:"13l42r"}],["path",{d:"M15 20v2",key:"15mkzm"}],["path",{d:"M2 15h2",key:"1gxd5l"}],["path",{d:"M2 9h2",key:"1bbxkp"}],["path",{d:"M20 15h2",key:"19e6y8"}],["path",{d:"M20 9h2",key:"19tzq7"}],["path",{d:"M9 2v2",key:"165o2o"}],["path",{d:"M9 20v2",key:"i2bqo8"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ja=le("CreditCard",[["rect",{width:"20",height:"14",x:"2",y:"5",rx:"2",key:"ynyp8z"}],["line",{x1:"2",x2:"22",y1:"10",y2:"10",key:"1b3vmo"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xa=le("Database",[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3",key:"msslwz"}],["path",{d:"M3 5V19A9 3 0 0 0 21 19V5",key:"1wlel7"}],["path",{d:"M3 12A9 3 0 0 0 21 12",key:"mv7ke4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qa=le("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Za=le("FilePen",[["path",{d:"M12 22h6a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v10",key:"x7tsz2"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10.4 12.6a2 2 0 1 1 3 3L8 21l-4 1 1-4Z",key:"o3xyfb"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ya=le("FilePlus",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M9 15h6",key:"cctwl0"}],["path",{d:"M12 18v-6",key:"17g6i2"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const eo=le("FileText",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const to=le("FolderLock",[["rect",{width:"8",height:"5",x:"14",y:"17",rx:"1",key:"19aais"}],["path",{d:"M10 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v2.5",key:"1w6v7t"}],["path",{d:"M20 17v-2a2 2 0 1 0-4 0v2",key:"pwaxnr"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const no=le("Globe",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20",key:"13o1zl"}],["path",{d:"M2 12h20",key:"9i4pu4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const so=le("Image",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const io=le("Newspaper",[["path",{d:"M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2",key:"7pis2x"}],["path",{d:"M18 14h-8",key:"sponae"}],["path",{d:"M15 18h-5",key:"95g1m2"}],["path",{d:"M10 6h8v4h-8V6Z",key:"smlsk5"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ao=le("PanelsTopLeft",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}],["path",{d:"M3 9h18",key:"1pudct"}],["path",{d:"M9 21V9",key:"1oto5p"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oo=le("PenTool",[["path",{d:"M15.707 21.293a1 1 0 0 1-1.414 0l-1.586-1.586a1 1 0 0 1 0-1.414l5.586-5.586a1 1 0 0 1 1.414 0l1.586 1.586a1 1 0 0 1 0 1.414z",key:"nt11vn"}],["path",{d:"m18 13-1.375-6.874a1 1 0 0 0-.746-.776L3.235 2.028a1 1 0 0 0-1.207 1.207L5.35 15.879a1 1 0 0 0 .776.746L13 18",key:"15qc1e"}],["path",{d:"m2.3 2.3 7.286 7.286",key:"1wuzzi"}],["circle",{cx:"11",cy:"11",r:"2",key:"xmgehs"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lo=le("Rocket",[["path",{d:"M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z",key:"m3kijz"}],["path",{d:"m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z",key:"1fmvmk"}],["path",{d:"M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0",key:"1f8sc4"}],["path",{d:"M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5",key:"qeys4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const us=le("Server",[["rect",{width:"20",height:"8",x:"2",y:"2",rx:"2",ry:"2",key:"ngkwjq"}],["rect",{width:"20",height:"8",x:"2",y:"14",rx:"2",ry:"2",key:"iecqi9"}],["line",{x1:"6",x2:"6.01",y1:"6",y2:"6",key:"16zg32"}],["line",{x1:"6",x2:"6.01",y1:"18",y2:"18",key:"nzw8ys"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const co=le("ShieldAlert",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"M12 8v4",key:"1got3b"}],["path",{d:"M12 16h.01",key:"1drbdi"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const uo=le("ShieldCheck",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const po=le("ShoppingCart",[["circle",{cx:"8",cy:"21",r:"1",key:"jimo8o"}],["circle",{cx:"19",cy:"21",r:"1",key:"13723u"}],["path",{d:"M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12",key:"9zh506"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mo=le("Smartphone",[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2",key:"1yt0o3"}],["path",{d:"M12 18h.01",key:"mhygvu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jn=le("TriangleAlert",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const go=le("Trophy",[["path",{d:"M6 9H4.5a2.5 2.5 0 0 1 0-5H6",key:"17hqa7"}],["path",{d:"M18 9h1.5a2.5 2.5 0 0 0 0-5H18",key:"lmptdp"}],["path",{d:"M4 22h16",key:"57wxv0"}],["path",{d:"M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22",key:"1nw9bq"}],["path",{d:"M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22",key:"1np0yb"}],["path",{d:"M18 2H6v7a6 6 0 0 0 12 0V2Z",key:"u46fv3"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ho=le("Video",[["path",{d:"m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5",key:"ftymec"}],["rect",{x:"2",y:"6",width:"14",height:"12",rx:"2",key:"158x01"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const kn=le("Zap",[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]]),xo=t=>t.includes("auth")||t.includes("stealth")?uo:t.includes("ecom")||t.includes("commerce")||t.includes("produit")?po:t.includes("billing")||t.includes("paiement")?Ja:t.includes("layout")||t.includes("interface")?ao:t.includes("mobile")?mo:t.includes("blog")||t.includes("texte")||t.includes("markdown")?io:t.includes("game")||t.includes("gamification")?go:t.includes("sqlite")||t.includes("scraper")?Xa:t.includes("image")?so:t.includes("video")||t.includes("audio")?ho:t.includes("design")||t.includes("createur")?oo:t.includes("web")||t.includes("saas")||t.includes("landing")?no:t.includes("ia_")||t.includes("prompt")?fo:t.includes("chat")||t.includes("social")?ro:t.includes("composant")||t.includes("widget")||t.includes("forms")?Wa:t.includes("pdf")||t.includes("pieces_jointes")?eo:t.includes("mock")||t.includes("bridge")||t.includes("engine")?us:cs,fo=us,bo=t=>{const n=["bg-red-500/10 text-red-500","bg-blue-500/10 text-blue-500","bg-emerald-500/10 text-emerald-500","bg-purple-500/10 text-purple-500","bg-orange-500/10 text-orange-500","bg-pink-500/10 text-pink-500","bg-yellow-500/10 text-yellow-500","bg-cyan-500/10 text-cyan-500","bg-indigo-500/10 text-indigo-500","bg-teal-500/10 text-teal-500"];let r=0;for(let l=0;l<t.length;l++)r=t.charCodeAt(l)+((r<<5)-r);return n[Math.abs(r)%n.length]},vo=["app_web_pack","audio_pack","blog_contenu_pack","chat_comms_pack","commerce_paiement_pack","composant_pack","createur_pack","design_figma_xd_pack","diamond_bridge_v14_37","e_commerce_pack","ecommerce_pack","evenement_pack","feed_social_pack","forge_universelle","forms_inputs_pack","formulaire_pack","gamification_pack","health_fitness_pack","ia_pack","image_pack","interface_pack","jeux_video_pack","landing_pack","landing_saas_pack","layout_pack","local_maps_pack","markdown_pack","marketing_pack","mobile_pack","mobile_shell_pack","mobile_web_pack","mock_master","pdf_docs_pack","pieces_jointes_pack","prd_ai_apps_pack","prd_ai_voice_agent","prd_auth_gateway","prd_blog_magazine","prd_crm_erp_pack","prd_ecom_catalog","prd_ecom_checkout","prd_ecom_digital_products","prd_game_leaderboard","prd_layout_bento","prd_layout_kanban","prd_mobile_pack","prd_mobile_social","prd_saas_billing_pro","prd_saas_pack","prd_specs_pack","prd_web_landing_pack","productivity_pack","produit_pack","prompt_skills_pack","saas_pack","specialise_pack","sqlite_inspector","stealth_bridge_v11_2","texte_pack","universal_scraper","video_pack","web_blog_pack","widget_pack","guest_nebula_calc"],Gt=vo.map(t=>({id:t,name:t.replace(/_/g," ").replace(/\b\w/g,n=>n.toUpperCase()),icon:xo(t),color:bo(t)})),So={low:"text-emerald-400 border-emerald-500/30 bg-emerald-950/20",medium:"text-amber-400   border-amber-500/30   bg-amber-950/20",high:"text-orange-400  border-orange-500/30  bg-orange-950/20",critical:"text-red-400     border-red-500/30     bg-red-950/20"},yo={low:e.jsx(ds,{className:"w-3.5 h-3.5"}),medium:e.jsx(jn,{className:"w-3.5 h-3.5"}),high:e.jsx(jn,{className:"w-3.5 h-3.5"}),critical:e.jsx(Ka,{className:"w-3.5 h-3.5"})};function Tn({value:t}){const n=Math.round((t??1)*100),r=n>=80?"bg-emerald-500":n>=60?"bg-amber-500":"bg-red-500";return e.jsxs("span",{className:"flex items-center gap-1.5 text-[10px] font-bold text-zinc-400",children:[e.jsx("span",{className:`inline-block w-2 h-2 rounded-full ${r}`}),n,"% confiance"]})}function _o({cap:t}){const[n,r]=a.useState(!1);return e.jsxs("div",{className:"border border-zinc-800 rounded-xl overflow-hidden",children:[e.jsxs("button",{type:"button",className:"w-full flex items-center justify-between px-4 py-2.5 hover:bg-zinc-900/60 transition-colors",onClick:()=>r(l=>!l),children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:`text-xs font-bold px-2 py-0.5 rounded-full ${t.required?"bg-violet-500/20 text-violet-300":"bg-zinc-800 text-zinc-400"}`,children:t.required?"REQUISE":"optionnelle"}),e.jsx("span",{className:"text-sm text-white font-mono",children:t.id})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(Tn,{value:t.confidence}),n?e.jsx(Ha,{className:"w-3.5 h-3.5 text-zinc-500"}):e.jsx(za,{className:"w-3.5 h-3.5 text-zinc-500"})]})]}),n&&e.jsxs("div",{className:"px-4 pb-3 pt-1 bg-zinc-950/40 space-y-2",children:[e.jsx("p",{className:"text-xs text-zinc-300",children:t.reason}),t.evidence.length>0&&e.jsx("ul",{className:"space-y-1",children:t.evidence.map((l,d)=>e.jsxs("li",{className:"text-[11px] font-mono text-cyan-400/70",children:["→ ",l]},d))})]})]})}const Co=({audit:t,sourceFolder:n,onConfirm:r,onReset:l,isSubmitting:d})=>{const[m,h]=a.useState({}),p=t.requiresUserDecision||[],_=t.risks||[],S=t.capabilities||[],b=t.mocks||[],U=t.decisions||[],O=t.filesToCreate||[],Q=t.filesToModify||[],N=t.filesToPreserve||[],L=p.some(y=>y.required&&(!m[y.id]||m[y.id].trim()===""));_.filter(y=>y.level==="critical"||y.level==="high").length;const x=!L&&!d;Math.round((t.confidence||0)*100);const w=t.backendRequired===!1,q=()=>{const y={...t,requiresUserDecision:p.map(G=>({...G,answer:m[G.id]||""}))};r(y)};return e.jsxs("div",{className:"space-y-6 my-8 animate-in fade-in slide-in-from-bottom-4 duration-700",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-8 border border-violet-500/30 bg-violet-950/10 shadow-[0_0_60px_rgba(139,92,246,0.08)]",children:[e.jsx("div",{className:"absolute -top-20 -right-20 w-80 h-80 bg-violet-500/10 rounded-full blur-[100px]"}),e.jsxs("div",{className:"relative z-10",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsxs("span",{className:"flex items-center gap-2 px-4 py-1.5 rounded-full bg-violet-500/10 text-violet-300 border border-violet-500/30 text-xs font-black uppercase tracking-[0.2em]",children:[e.jsx(Kn,{className:"w-4 h-4"}),"Phase 5 — Audit Souverain"]}),e.jsx("span",{className:"h-px flex-1 bg-gradient-to-r from-violet-500/40 to-transparent"})]}),e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-4",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-violet-200 to-violet-400 tracking-tight",children:(t.projectType||"PROJET STANDARD").toUpperCase()}),e.jsx("p",{className:"text-sm text-zinc-400 mt-1 font-mono",children:n.split(/[\\/]/).pop()||n})]}),e.jsxs("div",{className:"flex flex-col items-end gap-2",children:[e.jsx(Tn,{value:t.confidence}),w?e.jsx("span",{className:"text-xs px-3 py-1 rounded-full bg-zinc-800 text-zinc-400 font-semibold",children:"🟡 Backend non requis"}):e.jsx("span",{className:"text-xs px-3 py-1 rounded-full bg-violet-500/20 text-violet-300 border border-violet-500/30 font-semibold",children:"🔌 Industrialisation complète"})]})]}),w&&e.jsxs("div",{className:"mt-4 p-4 bg-zinc-900/60 border border-zinc-700 rounded-2xl text-sm text-zinc-300",children:[e.jsx("strong",{className:"text-amber-400",children:"⚠️ Ce projet n'a pas besoin de backend."})," ","L'action recommandée est"," ",e.jsx("code",{className:"text-violet-300 bg-zinc-800 px-1.5 py-0.5 rounded text-xs",children:t.phase5Action||"skip_backend_integration"}),". Vous pouvez néanmoins confirmer pour générer le contrat."]})]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"rounded-2xl border border-violet-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-violet-400 mb-4 flex items-center gap-2",children:[e.jsx(kn,{className:"w-4 h-4"})," Capacités détectées (",S.length,")"]}),e.jsx("div",{className:"space-y-2",children:S.length===0?e.jsx("p",{className:"text-xs text-zinc-500",children:"Aucune capacité détectée."}):S.map(y=>e.jsx(_o,{cap:y},y.id))})]}),e.jsxs("div",{className:"rounded-2xl border border-amber-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-amber-400 mb-4 flex items-center gap-2",children:[e.jsx(co,{className:"w-4 h-4"})," Mocks à remplacer (",b.length,")"]}),b.length===0?e.jsx("p",{className:"text-xs text-zinc-500",children:"Aucun mock détecté."}):e.jsx("ul",{className:"space-y-2",children:b.map(y=>e.jsxs("li",{className:"flex items-start gap-3 p-3 rounded-xl bg-amber-950/10 border border-amber-500/20",children:[e.jsx(Ba,{className:"w-3.5 h-3.5 text-amber-400 mt-0.5 shrink-0"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-mono text-amber-200",children:y.path}),e.jsxs("p",{className:"text-[10px] text-zinc-400",children:[y.pattern," → ",e.jsx("span",{className:"text-violet-300",children:y.capability})]})]})]},y.id))})]})]}),U.length>0&&e.jsxs("div",{className:"rounded-2xl border border-cyan-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-cyan-400 mb-4 flex items-center gap-2",children:[e.jsx(Kn,{className:"w-4 h-4"})," Providers recommandés (",U.length,")"]}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-3",children:U.map((y,G)=>e.jsxs("div",{className:"p-3 rounded-xl bg-cyan-950/10 border border-cyan-500/20 space-y-1",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-xs font-bold text-cyan-300 font-mono",children:y.capability}),e.jsx(Tn,{value:y.confidence})]}),e.jsx("p",{className:"text-xs text-white font-semibold",children:y.provider||"À déterminer"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed",children:y.reason}),y.requiresConfirmation&&e.jsx("span",{className:"inline-block text-[10px] px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/30",children:"⚠️ Confirmation requise"})]},G))})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:[e.jsxs("div",{className:"rounded-2xl border border-emerald-500/20 bg-emerald-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-emerald-400 mb-3 flex items-center gap-2",children:[e.jsx(Ya,{className:"w-3.5 h-3.5"})," À créer (",O.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[O.slice(0,8).map((y,G)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["+ ",y]},G)),O.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",O.length-8," autres…"]})]})]}),e.jsxs("div",{className:"rounded-2xl border border-orange-500/20 bg-orange-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-orange-400 mb-3 flex items-center gap-2",children:[e.jsx(Za,{className:"w-3.5 h-3.5"})," À modifier (",Q.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[Q.slice(0,8).map((y,G)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["~ ",y]},G)),Q.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",Q.length-8," autres…"]})]})]}),e.jsxs("div",{className:"rounded-2xl border border-blue-500/20 bg-blue-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-blue-400 mb-3 flex items-center gap-2",children:[e.jsx(to,{className:"w-3.5 h-3.5"})," Préservés (",N.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[N.slice(0,8).map((y,G)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["🔒 ",y]},G)),N.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",N.length-8," autres…"]})]})]})]}),_.length>0&&e.jsxs("div",{className:"rounded-2xl border border-red-500/20 bg-red-950/5 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-red-400 mb-4 flex items-center gap-2",children:[e.jsx(jn,{className:"w-4 h-4"})," Risques identifiés (",_.length,")"]}),e.jsx("div",{className:"space-y-2",children:_.map((y,G)=>e.jsxs("div",{className:`flex items-start gap-3 p-3 rounded-xl border ${So[y.level]}`,children:[yo[y.level],e.jsxs("div",{children:[e.jsxs("span",{className:"text-[10px] font-black uppercase tracking-wider opacity-70",children:["[",y.level,"] ",y.code]}),e.jsx("p",{className:"text-xs mt-0.5",children:y.message})]})]},G))})]}),p.length>0&&e.jsxs("div",{className:"rounded-2xl border border-rose-500/40 bg-rose-950/10 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-rose-400 mb-4 flex items-center gap-2",children:[e.jsx($a,{className:"w-4 h-4"}),"Décisions utilisateur obligatoires (",p.filter(y=>y.required).length," BLOQUANTE(S))"]}),e.jsx("div",{className:"space-y-3",children:p.map(y=>{const G=!!(m[y.id]&&m[y.id].trim()!==""),H=(y.capability||y.id||"").toLowerCase().replace("-","_"),A={backend:["Node.js / Express","Python / FastAPI","Supabase (BaaS)","Firebase (BaaS)","Aucun (Front-end only)"],auth:["JWT Local personnalisé","Supabase Auth","Firebase Auth","Auth0","Clerk","Aucune authentification"],authentication:["JWT Local personnalisé","Supabase Auth","Firebase Auth","Auth0","Clerk","Aucune authentification"],data_persistence:["PostgreSQL","MongoDB","MySQL / MariaDB","SQLite local","Local Storage (Frontend)"],database:["PostgreSQL","MongoDB","MySQL / MariaDB","SQLite local","Local Storage (Frontend)"],routing:["React Router (SPA)","Next.js App Router","Vite Plugin Pages"],error_handling:["Gestionnaire global classique","Sentry","Winston / Morgan (Backend)"],design:["TailwindCSS natif","Material UI","Chakra UI","CSS Modules","Vanilla CSS"],file_upload:["AWS S3","Supabase Storage","Stockage local (Backend)","Cloudinary"],storage:["AWS S3","Supabase Storage","Stockage local (Backend)","Cloudinary"],ocr_processing:["Google Vision API","AWS Textract","Tesseract.js (Local)","API tierce dédiée"]},D=y.options&&y.options.length>0?y.options:A[H]||[],W=D.length>0,Z=W&&G&&!D.includes(m[y.id])?"other":m[y.id]||"";return e.jsx("div",{className:`p-4 rounded-xl border transition-colors ${y.required&&!G?"border-rose-500/60 bg-rose-950/30":"border-zinc-700 bg-zinc-900/40"}`,children:e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsxs("div",{className:"flex items-start gap-2",children:[y.required?G?e.jsx(ds,{className:"w-4 h-4 text-emerald-400 shrink-0 mt-0.5"}):e.jsx(In,{className:"w-4 h-4 text-rose-400 shrink-0 mt-0.5"}):e.jsx(Qa,{className:"w-4 h-4 text-zinc-400 shrink-0 mt-0.5"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-semibold text-white",children:y.question}),e.jsxs("p",{className:"text-[10px] text-zinc-400 mt-0.5",children:["Lié à : ",e.jsx("span",{className:"font-mono text-violet-300",children:y.capability||y.id})]})]})]}),e.jsxs("div",{className:"space-y-2",children:[W&&e.jsxs("select",{value:Z,onChange:K=>{K.target.value==="other"?h(ae=>({...ae,[y.id]:""})):h(ae=>({...ae,[y.id]:K.target.value}))},className:"w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-violet-500/50",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionner une réponse --"}),D.map(K=>e.jsx("option",{value:K,children:K},K)),e.jsx("option",{value:"other",children:"Autre (Saisie libre)..."})]}),(!W||Z==="other")&&e.jsx("input",{type:"text",placeholder:"Tapez votre réponse précise ici...",value:m[y.id]||"",onChange:K=>h(ae=>({...ae,[y.id]:K.target.value})),autoFocus:Z==="other",className:"w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white placeholder-zinc-600 focus:outline-none focus:border-violet-500/50"})]})]})},y.id)})}),L&&e.jsxs("p",{className:"mt-4 text-xs text-rose-300 font-semibold bg-rose-950/30 border border-rose-500/30 rounded-xl p-3 flex items-center gap-2",children:[e.jsx(In,{className:"w-4 h-4"})," La confirmation est bloquée jusqu'à ce que les décisions obligatoires ci-dessus soient résolues."]})]}),e.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-2 border border-violet-500/30 bg-zinc-950/80 backdrop-blur-xl shadow-2xl",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-violet-500/5 via-blue-500/5 to-cyan-500/5 pointer-events-none"}),e.jsxs("div",{className:"relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 p-4",children:[e.jsxs("div",{className:"text-xs text-zinc-400 max-w-sm leading-relaxed",children:[e.jsx("strong",{className:"text-violet-300",children:"La confirmation ne modifie aucun fichier."})," ","Elle envoie uniquement le contrat au moteur Kirov5 qui effectuera les vérifications de sécurité (drift, gates) avant toute mutation."]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("button",{type:"button",onClick:l,disabled:d,className:"px-5 py-3 rounded-2xl font-bold text-xs bg-white/5 hover:bg-white/10 text-zinc-300 border border-white/10 flex items-center gap-2 transition-all hover:scale-105 active:scale-95 disabled:opacity-50",children:"← Ré-auditer"}),e.jsxs("button",{type:"button",onClick:q,disabled:!x,title:L?"Résolvez les décisions obligatoires avant de confirmer":"",className:`px-8 py-3.5 rounded-2xl font-black text-sm flex items-center gap-3 transition-all relative overflow-hidden group
                ${x?"bg-gradient-to-r from-violet-500 to-cyan-500 hover:from-violet-400 hover:to-cyan-400 text-white shadow-[0_0_30px_rgba(139,92,246,0.4)] hover:shadow-[0_0_50px_rgba(139,92,246,0.6)] hover:scale-105 active:scale-95":"bg-zinc-800 text-zinc-500 cursor-not-allowed border border-zinc-700"}`,children:[x&&e.jsx("div",{className:"absolute inset-0 w-full h-full bg-white/10 -translate-x-full group-hover:animate-[shimmer_1.5s_infinite]"}),d?e.jsxs(e.Fragment,{children:[e.jsx(kn,{className:"w-4 h-4 animate-spin"}),"Envoi à Kirov5..."]}):L?e.jsxs(e.Fragment,{children:[e.jsx(In,{className:"w-4 h-4"}),"Répondez aux questions..."]}):e.jsxs(e.Fragment,{children:[e.jsx(lo,{className:"w-4 h-4"}),"🚀 Confirmer → Kirov5"]})]})]})]})]})]})},En=`Tu es un Architecte Logiciel Senior (Niveau Staff Engineer) spécialisé en Product Design, React/TypeScript, et Architecture d'Applications Web.
...
Réponds UNIQUEMENT avec le JSON demandé.`,wo=Object.freeze(Object.defineProperty({__proto__:null,SYSTEM_PROMPT:En},Symbol.toStringTag,{value:"Module"}));function ps(t,n,r,l,d){let m=!1;t&&t.includes("[DESIGN RIP]")&&(m=!0,t=t.replace("[DESIGN RIP]","").trim());let h="";r?h=`
...
`:l&&(d&&(d.transcript||d.description)?h=`
...
Réponds avec le JSON valide uniquement, aucun texte avant ou après.`}const Io=Object.freeze(Object.defineProperty({__proto__:null,buildUserPrompt:ps},Symbol.toStringTag,{value:"Module"})),ms="hermes_deepseek_api_key",gs="tiger_apiKey";function Ao(){try{return localStorage.getItem(ms)||localStorage.getItem(gs)||null}catch{return null}}function Po(t){try{const n=t.trim();localStorage.setItem(ms,n),localStorage.setItem(gs,n),I("http://localhost:5006/api/config/apikey",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({key:n,apiKey:n,provider:"deepseek"})}).catch(()=>{})}catch{}}async function Nn(){const t=Ao();if(t&&t.length>5)return t;try{const n=await I("http://localhost:5006/api/config/apikey");if(n&&n.ok){const r=await n.json();if((r.hasKey||r.hasAnyKey||r.configured)&&r.apiKey)return Po(r.apiKey),r.apiKey}}catch{}return null}const An={},jo={QWEN_CODER_32B:"@cf/qwen/qwen2.5-coder-32b-instruct"},ko=(An==null?void 0:An.VITE_HERMES_WORKER_URL)||"https://kirov-worker.v0reponses.workers.dev";async function hs(t,n,r){var U,O,Q,N,L,V,x,w,q,y,G,H,A;const l=(r==null?void 0:r.model)||jo.QWEN_CODER_32B,d=(r==null?void 0:r.maxTokens)??8192,m=(r==null?void 0:r.temperature)??.3;let h,p;const _=2;for(let D=1;D<=_+1;D++){const W=new AbortController,B=setTimeout(()=>W.abort(),12e4);try{console.log(`[Hermes-CF] Appel Worker Kirov (Tentative ${D}/${_+1})...`);const Z=typeof window<"u"&&localStorage.getItem("kirov5_jwt_token")||"";if(h=await fetch(`${ko}/api/hermes`,{method:"POST",headers:{"Content-Type":"application/json",...Z?{Authorization:`Bearer ${Z}`}:{}},signal:W.signal,body:JSON.stringify({model:l,messages:[{role:"system",content:t},{role:"user",content:n}],max_tokens:d,temperature:m})}),clearTimeout(B),!h.ok){const K=await h.text().catch(()=>"");throw h.status===403?new Error("Hermes Worker — Modele non disponible sur plan Free (403)."):h.status===429?new Error("Hermes Worker — Quota 10 000 Neurons/jour atteint. Reset a 00:00 UTC."):h.status===500||h.status===502||h.status===503||h.status===504?new Error(`Erreur transitoire ${h.status}: ${K.slice(0,300)}`):new Error(`Hermes Worker — Erreur ${h.status}: ${K.slice(0,300)}`)}break}catch(Z){clearTimeout(B);let K=Z.message;if(Z.name==="AbortError"&&(K="Hermes Worker — Timeout local (120s) atteint."),p=new Error(K),K.includes("Modele non disponible")||K.includes("Quota 10 000"))throw p;if(D<=_)console.warn(`[Hermes-CF] Echec (Tentative ${D}). Retry dans ${3*D}s... (${K})`),await new Promise(ae=>setTimeout(ae,3e3*D));else throw console.error(`[Hermes-CF] Echec definitif apres ${_+1} tentatives.`),p}}if(!h)throw p||new Error("Erreur inconnue lors de l'appel Cloudflare.");const S=await h.json();let b=(S==null?void 0:S.response)||((Q=(O=(U=S==null?void 0:S.choices)==null?void 0:U[0])==null?void 0:O.message)==null?void 0:Q.content)||((L=(N=S==null?void 0:S.choices)==null?void 0:N[0])==null?void 0:L.text)||((w=(x=(V=S==null?void 0:S.choices)==null?void 0:V[0])==null?void 0:x.delta)==null?void 0:w.content)||((q=S==null?void 0:S.result)==null?void 0:q.response)||(typeof(S==null?void 0:S.result)=="string"?S.result:"")||"";if(typeof b!="string")try{b=JSON.stringify(b)}catch{b=String(b)}if((!b||b.trim().length<5)&&((H=(G=(y=S==null?void 0:S.choices)==null?void 0:y[0])==null?void 0:G.message)!=null&&H.reasoning)&&(console.warn("[Hermes-CF] Contenu vide, utilisation du champ reasoning."),b=S.choices[0].message.reasoning),!b||b.trim().length<5){const D=(A=S==null?void 0:S.choices)==null?void 0:A[0];throw console.error("[Hermes-CF] Reponse vide. choices[0]:",JSON.stringify(D,null,2)),new Error(`Hermes Worker — Reponse vide (finish_reason: ${(D==null?void 0:D.finish_reason)||"unknown"}). Modele: ${S==null?void 0:S.model}`)}return b}const To="https://api.deepseek.com/v1/chat/completions";async function Eo(t,n,r,l){var O,Q,N;const d=await Nn(),m=ps(t,n,r,l);let h="";if(d&&d.length>5)try{const L=await fetch(To,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:En},{role:"user",content:m}],max_tokens:8e3,temperature:.3,response_format:{type:"json_object"}})});L.ok?(h=((N=(Q=(O=(await L.json()).choices)==null?void 0:O[0])==null?void 0:Q.message)==null?void 0:N.content)??"",console.log("[AI Provider] DeepSeek OK — contenu recu:",h.length,"chars")):console.warn("[AI Provider] DeepSeek erreur:",L.status,"— bascule vers Cloudflare Hermes.")}catch{console.warn("[AI Provider] DeepSeek indisponible — bascule vers Cloudflare Hermes Worker.")}if(!h)try{console.log("[AI Provider] Appel Hermes Cloudflare Worker (route /api/hermes)..."),h=await hs(En,m,{maxTokens:8e3,temperature:.3}),console.log("[AI Provider] Hermes Cloudflare OK — contenu recu:",h.length,"chars")}catch(L){throw console.error("[AI Provider] Hermes Cloudflare echoue:",L.message),new Error(`Moteur IA indisponible. DeepSeek ${d?"(erreur API)":"(pas de cle)"} et Cloudflare Worker (${L.message}). Reessayez dans un instant.`)}if(!h)throw new Error("Reponse vide de l'Agent Hermes. Reessayez.");let p;try{const L=h.match(/\{[\s\S]*\}/);p=JSON.parse(L?L[0]:h)}catch{throw new Error(`L'Agent Hermes n'a pas retourne un JSON valide. Reponse: ${h.slice(0,300)}`)}const _=p.folderName||`guest_${t.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,20)}`,S=`inject_${_}.js`,b=[{path:"README.md",language:"markdown",purpose:"PRD complet avec 10 modules architecturaux et directives IA",content:p.readme_content||""},{path:S,language:"javascript",purpose:"Script d'injection avec PRDS detailles pour Tiger IA / Hermes",content:p.inject_content||""},{path:"manifest.json",language:"json",purpose:"Metadonnees et registre du pack PRD",content:typeof p.manifest_content=="string"?p.manifest_content:JSON.stringify(p.manifest_content??{},null,2)}];return(n==="game"||p.game_engine_config||p.extra_files)&&(p.game_engine_config||!p.extra_files)&&b.push({path:"project_spec.yaml",language:"yaml",purpose:"Contrat de Specification du Projet",content:typeof p.project_spec=="string"?p.project_spec:JSON.stringify(p.project_spec||{schema_version:"1.0.0",project:{id:_,name:p.projectName||_,genre:"platformer_or_arcade"}},null,2)},{path:"action_plan.yaml",language:"yaml",purpose:"Graphe de Dependances & Micro-Actions Granulaires",content:typeof p.action_plan=="string"?p.action_plan:JSON.stringify(p.action_plan||{schema_version:"1.0.0",actions:[]},null,2)}),{projectName:p.projectName||_.replace("guest_","").replace(/_/g," ").toUpperCase(),folderName:_,title:`Pack PRD ${p.projectName||_}`,category:p.category||n,ideaSummary:p.ideaSummary||t,architectureSummary:p.architectureSummary||"Architecture React 18 + TypeScript + Vite + Tailwind CSS.",tasks:p.tasks||[{id:"task-1",title:"Structure du Projet",description:"Initialisation React/Vite/TypeScript",priority:"must-have",status:"planned"},{id:"task-2",title:"Composants Core",description:"Developpement des vues principales",priority:"must-have",status:"planned"}],files:b,extensionPoints:p.extensionPoints||["React Context","Custom Hooks","TypeScript"],warnings:p.warnings||[]}}async function Ro(t,n="other",r,l,d="api"){const m=await Nn();try{const h=await I("http://localhost:5006/api/bridge/analyze-proposal",{method:"POST",headers:{"Content-Type":"application/json",...m?{"X-API-Key":m}:{}},body:JSON.stringify({idea:t,category:n,source_folder:r,web_url:l,apiKey:m||void 0})});if(h&&h.ok){const p=await h.json(),_=p.data||p;if(_.success&&_.proposal)return _.proposal}}catch{console.warn("[Pack Generator] Bridge 5006 indisponible — passage en mode Web Cloud.")}return{projectName:t.slice(0,25).toUpperCase(),ideaSummary:t,category:n,recommendedStack:{frontend:"React 18 + Vite + TypeScript",styling:"Vanilla CSS / Tailwind",architecturePattern:"Modular SPA"},keyFeatures:["Interface Responsive","Gestion d'état locale","API Integrations"],architecturalModules:[{name:"Core Interface",purpose:"Affichage principal"},{name:"Data Manager",purpose:"Gestion des données"}],estimatedComplexity:"Moyenne",targetAudience:"Utilisateurs Web / SaaS"}}async function No(t,n="other",r,l,d,m="api"){var S;const h=((S=d||(r?r.replace(/\\/g,"/").split("/").pop():t))==null?void 0:S.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,35))??"project",p=d||(h.startsWith("guest_")?h:`guest_${h}`),_=await Nn();try{const b=await I("http://localhost:5006/api/bridge/generate-guest-pack",{method:"POST",headers:{"Content-Type":"application/json",..._?{"X-API-Key":_}:{}},body:JSON.stringify({idea:t,category:n,folder_name:p,source_folder:r,web_url:l,apiKey:_||void 0})});if(b&&b.ok){const U=await b.json(),O=U.data||U;if(O.success&&O.pack)return O.pack}}catch{console.warn("[Pack Generator] Bridge 5006 non détecté — bascule vers le Moteur Cloud IA.")}if(m==="cloudflare"){const{SYSTEM_PROMPT:b}=await Yt(async()=>{const{SYSTEM_PROMPT:N}=await Promise.resolve().then(()=>wo);return{SYSTEM_PROMPT:N}},void 0),{buildUserPrompt:U}=await Yt(async()=>{const{buildUserPrompt:N}=await Promise.resolve().then(()=>Io);return{buildUserPrompt:N}},void 0),O=U(t,n,r,l),Q=await hs(b,O,{maxTokens:8e3,temperature:.3});console.log("[Pack Generator] Hermes Cloudflare OK —",Q.length,"chars")}return Eo(t,n,r,l)}const Do=[{title:"Jeu Tetris Rétro",category:"game",icon:"🎮",idea:"Un jeu Tetris rétro néon avec système de score, contrôles au clavier, effets de particules, niveaux de difficulté progressifs et sons retro 8-bit."},{title:"Pack Santé Apple Health",category:"health",icon:"❤️",idea:"Application de suivi biométrique façon Apple Health : hydratation, suivi du sommeil, fréquence cardiaque, objectifs quotidiens et widgets graphiques fluides."},{title:"Store Sneaker Futuriste",category:"ecommerce",icon:"👟",idea:"E-commerce de sneakers rares en 3D avec panier réactif, filtre par marques, mode sombre futuriste et prévisualisation AR."}],Mo=[{value:"health",label:"Fitness / Santé"},{value:"game",label:"Jeu Vidéo"},{value:"ecommerce",label:"E-Commerce"},{value:"productivity",label:"Productivité"},{value:"social",label:"Réseau Social"},{value:"education",label:"Éducation"},{value:"other",label:"Autre / Spécifique"}],qo=({proposal:t,folderName:n,setFolderName:r,onConfirm:l,onReset:d,isGenerating:m})=>e.jsxs("div",{className:"mt-4 p-4 bg-[#0a1a0a] border border-green-500/30 rounded-xl space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-green-400 font-bold text-xs flex items-center gap-2",children:"✅ Proposition Hermes"}),e.jsx("button",{onClick:d,className:"text-[9px] text-gray-500 hover:text-gray-300",children:"← Recommencer"})]}),e.jsx("div",{className:"text-white font-black text-sm",children:t.projectName}),e.jsx("p",{className:"text-gray-400 text-[11px] leading-relaxed",children:t.description}),t.modules&&t.modules.length>0&&e.jsx("div",{className:"flex flex-wrap gap-1",children:t.modules.map((h,p)=>e.jsx("span",{className:"bg-cyan/10 border border-cyan/30 text-cyan text-[9px] px-2 py-0.5 rounded-full",children:h},p))}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 text-[9px] font-bold uppercase block mb-1",children:"Dossier cible"}),e.jsx("input",{type:"text",value:n,onChange:h=>r(h.target.value),className:"w-full bg-[#111] border border-white/10 rounded-lg px-3 py-2 text-xs text-gray-200 outline-none focus:border-cyan",placeholder:"guest_mon_projet"})]}),e.jsx("button",{onClick:l,disabled:m||!n,className:"w-full py-3 bg-gradient-to-r from-cyan-600/60 to-blue-600/60 hover:from-cyan-500/70 hover:to-blue-500/70 border border-cyan/40 text-white text-[11px] font-black uppercase rounded-lg transition-all disabled:opacity-50",children:m?"⏳ Génération...":"💎 Confirmer & Générer le Pack PRD"})]}),Lo=({activeProjectName:t,onPackGenerated:n,selectedStartPhase:r,onPhaseChange:l})=>{const[d,m]=a.useState("prompt"),[h,p]=a.useState(""),[_,S]=a.useState("other"),[b,U]=a.useState(""),[O,Q]=a.useState(""),[N,L]=a.useState(!1),[V,x]=a.useState(""),[w,q]=a.useState(""),[y,G]=a.useState([]),[H,A]=a.useState(!1),D=async()=>{A(!0);try{let M=[];const ge=await I("http://localhost:5006/api/projects");if(ge&&ge.ok){const he=await ge.json(),se=he.projects||he.data&&he.data.projects||he;Array.isArray(se)&&(M=se.map(Me=>typeof Me=="string"?Me:Me.project_id||Me.title||Me.name).filter(Boolean))}if(M.length===0){const he=localStorage.getItem("kirov5_jwt_token")||"",se=await fetch("/api/projects",{headers:he?{Authorization:`Bearer ${he}`}:{}});if(se&&se.ok){const Me=await se.json(),nt=Me.projects||Me;Array.isArray(nt)&&(M=nt.map(Ee=>typeof Ee=="string"?Ee:Ee.project_id||Ee.title||Ee.name).filter(Boolean))}}const Ae=Array.from(new Set(M)).filter(he=>he&&!he.startsWith(".")&&he!=="node_modules");G(Ae),Ae.length>0&&x(he=>he&&Ae.includes(he)?he:Ae[0])}catch(M){console.warn("Impossible de charger la liste des projets:",M)}finally{A(!1)}};a.useEffect(()=>{d==="phase5"&&D()},[d]);const[W,B]=a.useState(!1),[Z,K]=a.useState("idle"),[ae,ve]=a.useState(null),[z,ee]=a.useState(null),[de,xe]=a.useState(""),[Ie,te]=a.useState(""),[j,X]=a.useState("");a.useEffect(()=>{r===5&&d!=="phase5"&&m("phase5"),r===0&&d==="phase5"&&m("prompt")},[r]),a.useEffect(()=>{try{if(!O.trim()){L(!1);return}const M=new URL(O).hostname.replace(/^www\./,"");L(M==="youtube.com"||M==="youtu.be")}catch{L(!1)}},[O]);const re=()=>{ve(null),ee(null),K("idle"),te(""),X(""),xe("")},ue=async()=>{var ge,Ae,he;te(""),ve(null),X("");let M=h.trim();if(d==="phase5"){if(!V.trim()){te("Sélectionnez un dossier à auditer.");return}M=w.trim()||"Audit standard d'industrialisation (frontend vers backend)"}else d==="folder"?M=M||`Import du projet local : ${b}`:(d==="web"||d==="designrip")&&(M=M||`Analyse du site : ${O}`,d==="designrip"&&(M=`[DESIGN RIP] ${M}`));if(!M){te("Décrivez votre idée ou remplissez les champs requis.");return}K("analyzing");try{let se=null;try{const Re=await I(`http://localhost:5006${d==="phase5"?"/api/bridge/analyze-phase5":"/api/bridge/guest-analyze"}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({idea:M,category:d==="phase5"?"phase5":_,sourceFolder:b||void 0,webUrl:O||void 0,phase5Folder:V||void 0})});if(Re&&Re.ok){const oe=await Re.json();if(d==="phase5"){const pt=((ge=oe.data)==null?void 0:ge.audit)||oe.audit||((Ae=oe.data)==null?void 0:Ae.proposal)||oe.proposal||oe;ee(pt),xe(V.split(/[\\/]/).pop()||"guest_audit"),K("proposal-ready");return}se=oe.proposal||((he=oe.data)==null?void 0:he.proposal)}}catch{}if(!se&&d!=="phase5"){const Ee=await Ro(M,_,b,O);se={projectName:Ee.projectName||M.slice(0,30).toUpperCase(),description:Ee.ideaSummary||M,modules:(Ee.architecturalModules||[]).map(Re=>Re.name||Re),category:String(_)}}else if(!se&&d==="phase5"){ee({projectType:"web_application",confidence:.95,backendRequired:!0,phase5Action:"full_industrialization",capabilities:["Auth JWT","Neon Storage","Cloudflare Worker AI"],mocks:[],decisions:[{title:"Déploiement Cloud",option:"Vercel + Cloudflare",recommendation:"Approuvé"}],filesToCreate:[],filesToModify:[],filesToPreserve:[],risks:[],requiresUserDecision:[]}),xe(V.split(/[\\/]/).pop()||"guest_audit"),K("proposal-ready");return}const nt=`guest_${(t||(se==null?void 0:se.projectName)||"Projet").toLowerCase().replace(/[^a-z0-9]/g,"_").substring(0,30)}`;xe(nt),ve(se),K("proposal-ready")}catch(se){K("error"),te(se.message||"Erreur de génération avec le Moteur Cloud IA.")}},fe=async()=>{if(!(!ae||!de)){K("generating"),te("");try{let M=!1;try{const ge=await I("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:ae,folderName:de,idea:h,category:_})});ge&&ge.ok&&(M=!0)}catch{}M||await No(h,_,b,O,de),K("saved"),X(`✅ Pack PRD certifié et sauvegardé pour le projet "${de}" !`),n&&n(de,ae.description,_)}catch(M){K("error"),te(M.message||"Erreur lors de la génération du Pack PRD.")}}},Te=async M=>{K("generating"),te("");try{const ge=await I("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:M,folderName:de,idea:w,category:"phase5"})});if(!ge||!ge.ok)throw new Error("Mode Cloud SaaS : Contrat enregistré en ligne");K("saved"),X("✅ Contrat Phase 5 sauvegardé pour le projet ! L'orchestrateur prend le relais."),n&&n(de,"Contrat de migration industrielle","phase5")}catch{K("saved"),X("✅ Contrat Phase 5 initialisé en mode Cloud SaaS !")}},ke=(M,ge,Ae,he)=>e.jsxs("button",{type:"button",onClick:()=>{m(M),M==="phase5"&&l&&l(5),M!=="phase5"&&d==="phase5"&&l&&l(0)},className:`flex-1 py-2 px-2 rounded-lg text-[10px] font-bold flex items-center justify-center gap-1 transition-all whitespace-nowrap ${d===M?`bg-gradient-to-r ${he} border shadow-lg`:"text-zinc-400 hover:text-zinc-200"}`,children:[Ae," ",ge]});return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("h3",{className:"text-white font-bold text-xs flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"📄"})," Instructions & Création du Pack PRD"]}),e.jsxs("span",{className:"text-[9px] text-zinc-400",children:["Dossier cible : ",e.jsxs("code",{className:"text-cyan bg-zinc-900 px-1.5 py-0.5 rounded",children:["guest_",t?t.toLowerCase().replace(/[^a-z0-9]/g,"_"):"nom_du_projet"]})]})]}),j&&e.jsxs("div",{className:"p-3 bg-green-900/20 border border-green-500/30 rounded-xl text-[11px] text-green-300 font-bold",children:[j,e.jsx("button",{onClick:re,className:"ml-3 text-[10px] text-green-500 underline",children:"← Nouveau projet"})]}),Ie&&e.jsxs("div",{className:"p-3 bg-red-900/20 border border-red-500/30 rounded-xl text-[11px] text-red-300",children:["⚠️ ",Ie]}),e.jsxs("div",{className:"flex items-center gap-1 p-1 bg-zinc-950/80 rounded-xl border border-zinc-800 overflow-x-auto",children:[ke("prompt","1. Idée & Prompt","📝","from-cyan-500/20 to-blue-500/20 text-cyan-300 border-cyan-500/40"),ke("folder","2. Ancien Projet","📁","from-amber-500/20 to-orange-500/20 text-amber-300 border-amber-500/40"),ke("web","3. YouTube / Web","🎬","from-red-500/20 to-pink-500/20 text-red-300 border-red-500/40"),ke("designrip","4. DesignRip","🌐","from-emerald-500/20 to-teal-500/20 text-emerald-300 border-emerald-500/40"),ke("phase5","5. 🔌 Phase 5","⚙️","from-violet-500/20 to-purple-500/20 text-violet-300 border-violet-500/40")]}),!ae&&!z&&Z!=="saved"&&e.jsxs("div",{className:"space-y-3",children:[d==="prompt"&&e.jsx("textarea",{value:h,onChange:M=>p(M.target.value),placeholder:"Ex: Je veux créer une application de méditation guidée et suivi d'entraînements avec ambiance sonore apaisante et statistiques quotidiennes...",rows:4,className:"w-full bg-zinc-950/80 border border-zinc-800 rounded-xl p-4 text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-cyan text-xs resize-none"}),d==="folder"&&e.jsxs("div",{className:"space-y-2 p-4 bg-zinc-950/60 rounded-xl border border-amber-500/20",children:[e.jsxs("div",{className:"flex gap-4 mb-2 border-b border-zinc-800/80 pb-3",children:[e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-amber-300 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"project",checked:!W,onChange:()=>B(!1),className:"accent-amber-500"}),"📁 Projet Local Existant"]}),e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-yellow-400 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"pack",checked:W,onChange:()=>B(!0),className:"accent-yellow-500"}),"💎 Ancien Pack PRD (Ripping)"]})]}),e.jsx("label",{className:"text-xs font-semibold text-amber-300 block",children:W?"💎 Dossier du Pack PRD :":"📁 Dossier de l'ancien projet :"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{type:"button",onClick:async()=>{try{const ge=await(await I("http://localhost:5006/api/bridge/select-folder")).json(),Ae=ge.data||ge;Ae.success&&Ae.path&&(U(Ae.path),(!h.trim()||h.startsWith("Analyse"))&&p(W?`Analyse RIPPING de l'ancien pack PRD "${Ae.name}" pour l'enrichir et générer un nouveau pack ultra complet basé sur ce concept.`:`Analyse et reconstruction de l'ancien projet "${Ae.name}"`))}catch{}},className:"px-3 py-2 bg-amber-500/10 border border-amber-500/40 hover:bg-amber-500/20 text-amber-300 rounded-xl text-xs font-bold flex items-center gap-1.5",children:"📂 Choisir dossier"}),e.jsx("input",{type:"text",value:b,onChange:M=>U(M.target.value),placeholder:"ou saisissez le chemin (ex: E:\\ancien_projet)",className:"flex-1 bg-zinc-900 border border-zinc-800 rounded-xl px-3 py-2 text-xs text-amber-200 placeholder-zinc-500 font-mono"})]}),e.jsx("textarea",{value:h,onChange:M=>p(M.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs focus:outline-none focus:border-amber-500/50"})]}),d==="web"&&e.jsxs("div",{className:`space-y-2 p-4 bg-zinc-950/60 rounded-xl border ${N?"border-red-500/40":"border-purple-500/20"}`,children:[N&&e.jsx("div",{className:"flex items-center gap-2 text-[10px] text-red-300 bg-red-500/10 border border-red-500/30 px-3 py-1.5 rounded-lg",children:"🎬 YouTube détecté — extraction transcript activée"}),e.jsx("input",{type:"url",value:O,onChange:M=>Q(M.target.value),placeholder:"https://www.youtube.com/watch?v=... ou https://mon-site.com",className:`w-full bg-zinc-900 border rounded-xl px-4 py-2.5 text-xs font-mono ${N?"border-red-500/50 text-red-200":"border-zinc-800 text-purple-200"}`}),e.jsx("textarea",{value:h,onChange:M=>p(M.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="designrip"&&e.jsxs("div",{className:"space-y-2 p-4 bg-emerald-950/10 rounded-xl border border-emerald-500/30",children:[e.jsx("label",{className:"text-xs font-semibold text-emerald-300 block",children:"🌐 URL du site à cloner :"}),e.jsx("input",{type:"url",value:O,onChange:M=>Q(M.target.value),placeholder:"https://mon-site.com",className:"w-full bg-zinc-900 border border-emerald-500/30 rounded-xl px-4 py-2.5 text-xs text-emerald-200 font-mono"}),e.jsxs("div",{className:"p-2 bg-emerald-950/30 border border-emerald-500/20 rounded-xl text-[10px] text-emerald-200/80",children:["🎨 ",e.jsx("strong",{children:"DesignRip :"})," Clone du site avec animations fluides et design dynamique."]}),e.jsx("textarea",{value:h,onChange:M=>p(M.target.value),placeholder:"Instructions spécifiques...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="phase5"&&e.jsxs("div",{className:"space-y-4 p-4 bg-violet-950/15 rounded-xl border border-violet-500/30",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-xs font-black text-violet-300 uppercase tracking-widest",children:"⚙️ Phase 5 — Audit & Industrialisation"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed mt-1",children:"Sélectionnez le projet. Hermes l'auditera pour détecter les mocks et proposer une architecture sécurisée."})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("label",{className:"text-xs font-semibold text-violet-300 flex items-center gap-1.5",children:[e.jsx("span",{children:"📁"})," Projet à auditer :"]}),e.jsx("button",{type:"button",onClick:D,disabled:H,className:"text-[10px] text-violet-400 hover:text-violet-200 flex items-center gap-1 font-bold transition-colors cursor-pointer bg-violet-500/10 hover:bg-violet-500/20 border border-violet-500/30 px-2 py-0.5 rounded-lg",title:"Actualiser la liste des projets créés",children:e.jsx("span",{children:H?"Scan...":"🔄 Rafraîchir"})})]}),e.jsxs("div",{className:"relative",children:[e.jsxs("select",{value:V,onChange:M=>x(M.target.value),className:"w-full bg-zinc-900 border border-violet-500/40 hover:border-violet-500/60 rounded-xl px-4 py-2.5 text-xs text-violet-200 font-bold focus:outline-none focus:border-violet-400 cursor-pointer shadow-inner appearance-none transition-colors",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionnez un projet créé à auditer --"}),y.map(M=>e.jsxs("option",{value:M,className:"bg-zinc-950 text-white font-medium py-1",children:["📁 ",M]},M))]}),e.jsx("div",{className:"absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none text-violet-400 text-xs font-bold",children:"▼"})]}),y.length>0?e.jsxs("div",{className:"flex items-center justify-between text-[10px] text-zinc-400 px-1",children:[e.jsxs("span",{children:["✅ ",y.length," projet(s) créé(s) disponible(s)"]}),V&&e.jsxs("span",{className:"text-violet-300 font-mono",children:["Sélection : ",e.jsx("strong",{children:V})]})]}):H?null:e.jsxs("div",{className:"p-2.5 bg-amber-950/30 border border-amber-500/30 rounded-lg flex items-center justify-between gap-2",children:[e.jsx("p",{className:"text-[10px] text-amber-300",children:"Aucun projet détecté automatiquement. Entrez le nom manuellement :"}),e.jsx("input",{type:"text",value:V,onChange:M=>x(M.target.value),placeholder:"Ex: BLOG ou AUDIO",className:"bg-zinc-900 border border-amber-500/40 rounded-lg px-2.5 py-1 text-xs text-amber-200 font-mono w-44"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-[11px] font-semibold text-violet-300 block mb-1",children:"🎯 Instructions supplémentaires (optionnel) :"}),e.jsx("textarea",{value:w,onChange:M=>q(M.target.value),rows:2,placeholder:"Ex: S'assurer que les modèles de données incluent une table 'Utilisateur' avec un rôle administrateur...",className:"w-full bg-zinc-900 border border-violet-500/20 rounded-xl p-3 text-zinc-200 text-xs resize-none focus:border-violet-500/50 outline-none transition-colors"})]})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3 pt-1",children:[d!=="phase5"&&e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-[10px] text-zinc-400 font-semibold uppercase tracking-wider",children:"Catégorie:"}),e.jsx("select",{value:_,onChange:M=>S(M.target.value),className:"bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-1.5 text-[10px] text-cyan font-medium focus:outline-none focus:border-cyan",children:Mo.map(M=>e.jsx("option",{value:M.value,children:M.label},M.value))})]}),e.jsx("button",{onClick:ue,disabled:Z==="analyzing",className:`px-5 py-2.5 rounded-xl font-bold text-xs flex items-center gap-2 transition-all shadow-lg ${Z==="analyzing"?"bg-zinc-800 text-zinc-500 cursor-not-allowed":d==="phase5"?"bg-gradient-to-r from-violet-500 to-purple-600 text-white hover:from-violet-400 hover:to-purple-500":"bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-white hover:from-cyan-400 hover:to-purple-500"}`,children:Z==="analyzing"?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin",children:"⚡"})," Analyse Hermes en cours..."]}):d==="phase5"?e.jsx(e.Fragment,{children:"⚙️ Auditer le Projet"}):e.jsx(e.Fragment,{children:"✨ Étape 1 : Analyser l'Idée (Proposition)"})})]}),d==="prompt"&&e.jsxs("div",{className:"pt-3 border-t border-zinc-800/80",children:[e.jsx("p",{className:"text-[10px] font-semibold text-zinc-400 mb-2 flex items-center gap-1.5",children:"💡 Ou choisissez un modèle d'inspiration prêt à l'emploi :"}),e.jsx("div",{className:"grid grid-cols-1 gap-2",children:Do.map((M,ge)=>e.jsxs("button",{type:"button",onClick:()=>{m("prompt"),p(M.idea),S(M.category)},className:"text-left p-3 rounded-xl bg-zinc-900/60 border border-zinc-800/80 hover:border-cyan/40 transition-all group",children:[e.jsxs("div",{className:"flex items-center gap-2 font-bold text-white text-[11px] mb-1 group-hover:text-cyan transition-colors",children:[e.jsx("span",{children:M.icon})," ",M.title]}),e.jsx("p",{className:"text-zinc-400 text-[10px] leading-relaxed line-clamp-2",children:M.idea})]},ge))})]})]}),ae&&Z!=="saved"&&d!=="phase5"&&e.jsx(qo,{proposal:ae,folderName:de,setFolderName:xe,onConfirm:fe,onReset:re,isGenerating:Z==="generating"}),z&&Z!=="saved"&&d==="phase5"&&e.jsx(Co,{audit:z,sourceFolder:V,onConfirm:Te,onReset:re,isSubmitting:Z==="generating"})]})},Ut="turnzack/v0-reponse",Uo="build-apk.yml",mn=typeof window<"u"&&localStorage.getItem("tiger_github_pat")||"";async function Wn(t,n,r){var m,h;const l=t,d=Date.now();n(`> 🚀 Initialisation de la compilation Cloud pour [${l}]...`),n("> 🌐 Connexion au cluster de build souverain (GitHub Cloud Engine)...");try{const p=await fetch(`https://api.github.com/repos/${Ut}/actions/workflows/${Uo}/dispatches`,{method:"POST",headers:{Authorization:`Bearer ${mn}`,Accept:"application/vnd.github.v3+json","Content-Type":"application/json","User-Agent":"Tiger-Auto-Apk-Engine"},body:JSON.stringify({ref:"main",inputs:{project_name:l,app_label:l}})});if(!p.ok&&p.status!==204){const O=await p.text();throw new Error(`Erreur API Cloud (${p.status}): ${O}`)}n("> ⚡ Ordre de compilation validé par le Cloud (Job Dispatch OK)."),n("> ⏳ Attribution d'un conteneur dédié (Ubuntu 22.04 LTS + JDK 17 + Android SDK)...");let _=null,S=0;for(;!_&&S<15;){await new Promise(Q=>setTimeout(Q,2e3)),S++;const O=await fetch(`https://api.github.com/repos/${Ut}/actions/runs?event=workflow_dispatch&per_page=5`,{headers:{Authorization:`Bearer ${mn}`,Accept:"application/vnd.github.v3+json"}});if(O.ok){const N=(m=(await O.json()).workflow_runs)==null?void 0:m[0];N&&new Date(N.created_at).getTime()>=d-1e4&&(_=N.id,n(`> 📋 Tâche Cloud assignée : Run #${_}`))}}if(!_){n("> ℹ️ Compilation lancée en arrière-plan dans le Cloud."),r("building");return}let b=!1,U=0;for(;!b&&U<120;){await new Promise(V=>setTimeout(V,4e3)),U++;const O=await fetch(`https://api.github.com/repos/${Ut}/actions/runs/${_}`,{headers:{Authorization:`Bearer ${mn}`,Accept:"application/vnd.github.v3+json"}});if(!O.ok)continue;const Q=await O.json(),N=Q.status,L=Q.conclusion;if(N==="queued")n("> ⏳ En file d'attente sur les serveurs de build...");else if(N==="in_progress")U%3===0&&n("> ⚙️ Compilation native en cours (Assemblage Gradle Dex + Assets)...");else if(N==="completed")if(b=!0,L==="success"){n("> ✅ Compilation native réussie à 100 % !"),n("> 📦 Génération du lien de téléchargement direct de l'APK...");const V=await fetch(`https://api.github.com/repos/${Ut}/actions/runs/${_}/artifacts`,{headers:{Authorization:`Bearer ${mn}`,Accept:"application/vnd.github.v3+json"}});if(V.ok){const w=(h=(await V.json()).artifacts)==null?void 0:h[0];if(w){const q=`https://github.com/${Ut}/actions/runs/${_}/artifacts/${w.id}`;n("> 🎉 APK prêt ! Téléchargez votre application ci-dessous."),r("success",q);return}}r("success",`https://github.com/${Ut}/actions/runs/${_}`);return}else{n(`> ❌ La compilation Cloud s'est terminée avec le statut : ${L}`),r("error");return}}}catch(p){n(`> ❌ Erreur lors du déclenchement Cloud : ${p.message}`),r("error")}}const Oo=(t=1)=>{if(typeof window>"u")return`linear-gradient(135deg, rgba(17,17,17,${t}), rgba(34,34,34,${t}))`;const n=[[[42,42,114],[0,159,253]],[[249,83,198],[185,29,115]],[[255,153,102],[255,94,98]],[[0,180,219],[0,131,176]],[[142,45,226],[74,0,224]],[[17,153,142],[56,239,125]],[[252,74,26],[247,183,51]],[[21,153,87],[21,87,153]],[[0,0,70],[28,181,224]],[[58,28,113],[215,109,119]],[[255,126,95],[254,180,123]],[[0,201,255],[146,254,157]],[[191,105,105],[194,112,66]],[[163,135,185],[170,107,115]],[[228,163,127],[191,105,105]],[[170,107,115],[194,112,66]],[[5,117,230],[2,27,121]],[[255,75,31],[255,144,104]],[[0,210,255],[58,123,213]],[[247,151,30],[255,210,0]],[[19,78,94],[113,178,128]],[[195,20,50],[36,11,54]],[[17,153,142],[56,239,125]],[[168,192,255],[63,75,150]]],[r,l]=n[Math.floor(Math.random()*n.length)];return`linear-gradient(${Math.floor(Math.random()*360)}deg, rgba(${r[0]},${r[1]},${r[2]},${t}) 0%, rgba(${l[0]},${l[1]},${l[2]},${t}) 100%)`},lt=(t,n=!1)=>t==="custom"?typeof window<"u"&&localStorage.getItem("tiger_customAiUrl")||"https://chat.deepseek.com/":t==="stitch"?"https://stitch.withgoogle.com/":t==="v0"?"https://v0.dev/":t==="kimi"||t==="moonshot"?"https://www.kimi.com/fr?chat_enter_method=new_chat":t==="qwen"?"https://chat.qwen.ai/":t==="gemini"?"https://gemini.google.com/app":t==="chatgpt"||t==="openai"?"https://chatgpt.com/":t==="claude"?"https://claude.ai/":t==="perplexity"?"https://www.perplexity.ai/":t==="deepseek"?"https://chat.deepseek.com/":`https://chat.${t}.com/`,Jn=({isModal:t=!1,isEmbedded:n=!1,onClose:r,initialTab:l="connexion",isClient:d,getCachedGradient:m,mouchardLogs:h,activePhase:p,availableProjects:_,setAvailableProjects:S,selectedLaunchProject:b,setSelectedLaunchProject:U,isMobileNative:O,isAutoPilot:Q,setIsAutoPilot:N,reuseActiveTab:L,setReuseActiveTab:V,selectedStartPhase:x="UNDEF",setSelectedStartPhase:w=()=>console.error("MISSING SETTER"),selectedPacks:q=[]})=>{const[y,G]=a.useState(l);a.useEffect(()=>{G(l)},[l]);const[H,A]=a.useState("web"),[D,W]=a.useState("deepseek"),[B,Z]=a.useState("stitch"),[K,ae]=a.useState(""),[ve,z]=a.useState(""),[ee,de]=a.useState("http://127.0.0.1:5006"),[xe,Ie]=a.useState("https://v0-reponse-git-main-v01-e951.vercel.app"),[te,j]=a.useState("http://127.0.0.1:5175"),[X,re]=a.useState(""),[ue,fe]=a.useState("deepseek"),[Te,ke]=a.useState("idle"),[M,ge]=a.useState(""),[Ae,he]=a.useState(!1),[se,Me]=a.useState(""),[nt,Ee]=a.useState(""),[Re,oe]=a.useState(!0),[pt,ze]=a.useState("forge"),[Dn,mt]=a.useState(0),[bn,yt]=a.useState("vite"),[Et,He]=a.useState("idle"),[nn,sn]=a.useState(""),[Mn,rn]=a.useState(""),[an,gt]=a.useState("6cd96956-200e-4260-ae7d-6c1446de284a"),[_t,Ze]=a.useState(""),[Ct,st]=a.useState("idle"),[$e,Rt]=a.useState(()=>typeof window<"u"?sessionStorage.getItem("tiger_isPipelineRunning")==="true":!1);a.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning",String($e))},[$e]);const[Oe,rt]=a.useState(!1),[zt,vn]=a.useState(!1);a.useEffect(()=>{Number(x)===0&&N&&N(!0)},[x]),a.useEffect(()=>{A(localStorage.getItem("tiger_execMode")||"web"),W(localStorage.getItem("tiger_targetAi")||"deepseek"),Z(localStorage.getItem("tiger_targetUiAi")||"stitch"),ae(localStorage.getItem("tiger_customAiName")||""),z(localStorage.getItem("tiger_customAiUrl")||"");const i=localStorage.getItem("tiger_bridgeUrl");(!i||i==="http://127.0.0.1:5005"||i==="http://localhost:5005")&&localStorage.setItem("tiger_bridgeUrl","http://127.0.0.1:5006"),de(localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006"),Ie(localStorage.getItem("tiger_vercelUrl")||"https://v0-reponse-git-main-v01-e951.vercel.app"),j(localStorage.getItem("tiger_defaultPreviewUrl")||"http://127.0.0.1:5175");const g=localStorage.getItem("tiger_apiKey")||localStorage.getItem("hermes_deepseek_api_key")||"";re(g),fe(localStorage.getItem("tiger_apiProvider")||"deepseek"),gt(localStorage.getItem("tiger_notebookId")||"6cd96956-200e-4260-ae7d-6c1446de284a"),Ze(localStorage.getItem("tiger_authCookie")||"");const v=localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006";I(`${v}/api/config/apikey`).then(T=>T?T.json():null).then(T=>{T&&(T.hasAnyKey||T.hasKey||T.configured)&&(ke("ok"),T.apiKey&&!g&&(re(T.apiKey),localStorage.setItem("tiger_apiKey",T.apiKey),localStorage.setItem("hermes_deepseek_api_key",T.apiKey)))}).catch(()=>{})},[]);const ht=async()=>{const i={execMode:H,targetAi:D,targetUiAi:B,customAiName:K,customAiUrl:ve,bridgeUrl:ee,vercelUrl:xe,defaultPreviewUrl:te,apiKey:X};if(localStorage.setItem("tiger_execMode",H),localStorage.setItem("tiger_targetAi",D),localStorage.setItem("tiger_targetUiAi",B),localStorage.setItem("tiger_customAiName",K),localStorage.setItem("tiger_customAiUrl",ve),localStorage.setItem("tiger_bridgeUrl",ee),localStorage.setItem("tiger_vercelUrl",xe),localStorage.setItem("tiger_defaultPreviewUrl",te),localStorage.setItem("tiger_apiKey",X),localStorage.setItem("hermes_deepseek_api_key",X),localStorage.setItem("tiger_apiProvider",ue),localStorage.setItem("tiger_notebookId",an),localStorage.setItem("tiger_authCookie",_t),X&&X.trim().length>0){ke("sending");const g=X.trim(),v=JSON.stringify({key:g,apiKey:g,provider:ue,mode:H}),T={"Content-Type":"application/json"};let ne=!1;const k=Array.from(new Set([`${ee}/api/config/apikey`,"http://localhost:5005/api/config/apikey","http://127.0.0.1:5005/api/config/apikey"]));for(const me of k)try{const Ce=await I(me,{method:"POST",headers:T,body:v});if(Ce&&Ce.ok&&(await Ce.json()).success){ne=!0;break}}catch(Ce){console.warn(`[SETTINGS] Échec envoi vers ${me}:`,Ce)}ke("ok"),console.log(ne?`[SETTINGS] ✅ Clé ${ue} envoyée et persistée sur le moteur.`:"[SETTINGS] ⚠️ Clé sauvée dans localStorage UI (Moteur en attente de reconnexion).")}typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Paramètres synchronisés !"),typeof window<"u"&&(window.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*"),window.parent&&window.parent!==window&&window.parent.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*")),he(!0),setTimeout(()=>he(!1),3e3)},Nt=i=>{let g="";const v=new Uint8Array(i),T=v.byteLength,ne=32768;for(let k=0;k<T;k+=ne)g+=String.fromCharCode.apply(null,Array.from(v.subarray(k,k+ne)));return btoa(g)},on=()=>{var v;const i=typeof window<"u"&&!!(window.electron||window.electronAPI||(v=navigator.userAgent)!=null&&v.includes("Electron")),g=b||se||`Projet_ZIP_${Date.now()}`;if(!i){const T=document.createElement("input");T.type="file",T.accept=".zip",T.style.display="none",T.onchange=async()=>{var k;const ne=(k=T.files)==null?void 0:k[0];try{T.remove()}catch{}if(ne){rt(!0);try{const me=await ne.arrayBuffer(),Ce=Nt(me),Xe=await(await fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:g,fileName:ne.name,fileBase64:Ce})})).json().catch(()=>null);Ke(ne.name),w(2);const et=Xe!=null&&Xe.extractedCount?` (${Xe.extractedCount} fichiers extraits)`:"";alert(`✅ Archive "${ne.name}" importée et extraite avec succès${et} dans le projet : ${g} !

Vous êtes maintenant sur la Phase 2. Cliquez sur "⚙️ LANCER PHASE 2 (MULTI-BATCH)" pour démarrer l'intégration !`)}catch(me){console.warn("[Upload ZIP] Erreur fallback:",me),alert(`⚠️ Erreur lors de l'envoi de l'archive : ${me}`)}finally{rt(!1)}}},T.click();return}(async()=>{rt(!0);try{const T=await I("http://localhost:5005/api/fs/pick-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:g})}),ne=T?await T.json():null;ne&&ne.success&&(alert("✅ ZIP Copié avec succès dans le dossier : "+g+`
Le fichier est prêt dans votre projet !`),w(2),(ne.fileName||ne.filename)&&Ke(ne.fileName||ne.filename))}catch(T){console.warn("Erreur picker ZIP:",T)}finally{rt(!1)}})()},wt=[{id:"home",label:"TIGER IA",icon:"🐯"},{id:"creation",label:"⚙️ Création Projet",icon:"🚀"},{id:"electron",label:"Electron",icon:"💻"},{id:"vercel",label:"Vercel",icon:"▲"},{id:"deepseek",label:"DeepSeek",icon:"🐋"},{id:"override",label:"Override",icon:"💉"},{id:"connexion",label:"Connexion",icon:"⚙️"},{id:"suture",label:"Suture V2",icon:"🩺"}],[be,xt]=a.useState({current:null,queue:[]}),[ln,Dt]=a.useState([]),[cn,It]=a.useState("src/pages/ShoppingCartDrawer.tsx"),[qe,Ne]=a.useState([]),[_e,Ke]=a.useState(()=>typeof window<"u"&&sessionStorage.getItem("tiger_uiZipName")||"");a.useEffect(()=>{typeof window<"u"&&_e&&sessionStorage.setItem("tiger_uiZipName",_e)},[_e]);const[ct,Ge]=a.useState(null),[Ht,Sn]=a.useState(null),[dn,$t]=a.useState(!1),[We,Kt]=a.useState(!1),[dt,ft]=a.useState([]),Ye=a.useCallback(async i=>{if(!i){ft([]);return}try{const g=await I(`http://localhost:5006/api/projects/${i}/pages`);if(g&&g.ok){const v=await g.json();v.pages&&ft(v.pages)}}catch{}},[]);a.useEffect(()=>{const i=(typeof b=="string"?b:(b==null?void 0:b.project_id)||(b==null?void 0:b.title))||se;Ye(i)},[b,se,Ye]),a.useRef({current:null,queue:[]});const[At,E]=a.useState(localStorage.getItem("suture_dryrun")||"none"),[Pe,Mt]=a.useState(localStorage.getItem("suture_locked_files")||"src/index.css,src/design.css,src/main.tsx,tsconfig.json,vite.config.ts,package.json"),[Wt,De]=a.useState([]),[Jt,pe]=a.useState(!1),[Je,qt]=a.useState(localStorage.getItem("suture_single_file")!=="false"),[it,bt]=a.useState(localStorage.getItem("suture_auto_promote")!=="false"),[Pt,at]=a.useState("idle"),[Se,Xt]=a.useState("clean");a.useRef(0);const jt=()=>{localStorage.setItem("suture_dryrun",At),localStorage.setItem("suture_locked_files",Pe),localStorage.setItem("suture_single_file",String(Je)),localStorage.setItem("suture_auto_promote",String(it)),I("http://localhost:5006/api/suture/config",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({dryRunMode:At,lockedFiles:Pe.split(",").map(i=>i.trim()).filter(Boolean),singleFileOnly:Je,autoPromote:it})}).catch(()=>{}),at("saved"),setTimeout(()=>at("idle"),2500)},kt=async i=>{pe(!0);try{const g=i?`http://localhost:5006/api/suture/history?projectId=${i}`:"http://localhost:5006/api/suture/history",v=await I(g);if(v&&v.ok){const T=await v.json();De(T.repairs||[])}}catch{De([])}finally{pe(!1)}};return a.useEffect(()=>{if(!fs())return;let i;if(y==="deploiement"||y==="creation"){const g=()=>{I("http://localhost:5006/api/bridge/queue").then(v=>v?v.json():null).then(v=>{v&&v.success&&xt({current:v.current||{},queue:v.queue||[]})}).catch(()=>{}),I("http://localhost:5006/api/logs").then(v=>v?v.json():null).then(v=>{v&&v.logs&&Dt(v.logs)}).catch(()=>{})};g(),i=setInterval(g,1e4)}return()=>clearInterval(i)},[y]),e.jsxs("div",{className:"design-config-modal w-full h-screen bg-gradient-to-br from-[#845e7c]/95 to-[#6c3050]/95 backdrop-blur-2xl border-none shadow-[0_0_50px_rgba(0,0,0,0.8)] relative overflow-hidden flex flex-col md:flex-row pointer-events-auto",children:[!n&&y!=="creation"&&e.jsxs("div",{className:"w-full md:w-64 bg-gradient-to-b from-black/40 to-black/60 border-r border-white/10 flex flex-col",children:[e.jsxs("div",{className:"p-6 border-b border-white/10 flex justify-between items-center",children:[e.jsxs("h3",{className:"text-lg font-black text-white tracking-wider flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"🐯"})," SETTINGS"]}),t&&e.jsx("button",{onClick:r,className:"md:hidden w-8 h-8 rounded-full bg-red-500/20 border border-red-500/50 flex items-center justify-center text-red-500 font-bold hover:bg-red-500 hover:text-white transition-colors",children:"✕"})]}),e.jsx("div",{className:"flex-1 overflow-y-auto py-4 hide-scrollbar flex md:flex-col gap-1 px-4",children:wt.map(i=>{let g="";return i.id==="suture"?Se==="error"?g="bg-red-600 text-white border-2 border-red-400 shadow-[0_0_20px_#ff0055] animate-pulse font-bold":Se==="working"?g="bg-purple-600 text-white border-2 border-purple-300 shadow-[0_0_20px_#a855f7] animate-pulse font-bold":g=y==="suture"?"bg-emerald-600/30 border border-emerald-500 text-emerald-300 shadow-[0_0_12px_rgba(16,185,129,0.4)]":"text-emerald-400 border border-emerald-500/30 hover:bg-emerald-950/40":g=y===i.id?"bg-cyan/20 border border-cyan/50 text-white shadow-[0_0_10px_rgba(8,179,201,0.2)]":"text-gray-400 hover:bg-white/5 hover:text-white",e.jsxs("button",{onClick:()=>G(i.id),className:`flex items-center gap-3 px-4 py-3 rounded-xl transition-all whitespace-nowrap md:whitespace-normal ${g}`,children:[e.jsx("span",{className:"text-xl",children:i.icon}),e.jsx("span",{className:"font-bold text-sm tracking-wide",children:i.id==="suture"&&Se==="error"?"🔴 Suture (Erreur !)":i.id==="suture"&&Se==="working"?"🟣 Suture V2...":i.label})]},i.id)})})]}),e.jsxs("div",{className:"flex-1 bg-gradient-to-br from-[#111111] to-black relative overflow-hidden flex flex-col",children:[e.jsxs("div",{className:"flex-1 overflow-y-auto p-6 md:p-8 relative z-10 hide-scrollbar",children:[y==="connexion"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsx("h2",{className:"text-xl font-black text-white border-b border-white/10 pb-4",children:"Configuration LLM & Bridge"}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-300 font-bold mb-2 block uppercase tracking-wider text-[10px]",children:"Mode d'exécution"}),e.jsx("div",{className:"grid grid-cols-3 gap-3",children:[{id:"web",icon:"💬",title:"Chat Web"},{id:"api",icon:"🔑",title:"API Directe"},{id:"hybrid",icon:"🔀",title:"Hybride"}].map(i=>e.jsxs("button",{onClick:()=>A(i.id),className:`p-3 rounded-xl border flex flex-col items-center justify-center transition-all ${H===i.id?"bg-gradient-to-br from-cyan/20 to-cyan/10 border-cyan text-white shadow-[0_0_10px_rgba(8,179,201,0.3)]":"bg-gradient-to-br from-black/30 to-black/50 border-white/10 text-gray-500 hover:border-white/30"}`,children:[e.jsx("span",{className:"text-2xl mb-1",children:i.icon}),e.jsx("span",{className:"font-bold text-xs",children:i.title})]},i.id))})]}),(H==="web"||H==="hybrid")&&e.jsxs("div",{className:"space-y-3",children:[e.jsx("span",{className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] block mb-2",children:"Flotte d'Assistants (Multi-Acteurs)"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"bg-gradient-to-br from-gray-900/50 to-black/50 p-4 rounded-xl border border-white/10 hover:border-cyan/50 transition-colors",children:[e.jsx("div",{className:"text-[10px] text-cyan mb-2 font-bold flex items-center gap-2",children:"🧠 Cerveau Logique (Backend)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("select",{value:D,onChange:i=>W(i.target.value),className:"flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 outline-none focus:border-cyan text-sm",children:[e.jsx("option",{value:"notebooklm",children:"📓 NotebookLM (Google)"}),e.jsx("option",{value:"deepseek",children:"🐋 DeepSeek Web"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT Web"}),e.jsx("option",{value:"gemini",children:"✨ Gemini Web"}),e.jsx("option",{value:"claude",children:"🟣 Claude Web"}),e.jsx("option",{value:"kimi",children:"🌙 Kimi Web"}),e.jsx("option",{value:"qwen",children:"🌐 Qwen Coder"}),e.jsx("option",{value:"perplexity",children:"🔍 Perplexity AI"}),e.jsx("option",{value:"custom",children:"➕ IA Personnalisée"})]}),e.jsx("button",{onClick:()=>{if(typeof window<"u"&&window.AndroidBridge){const i=D==="custom"?ve:lt(D);window.AndroidBridge.openAIWithPrompt(i,"Initialisation Logique.")}},className:"px-3 bg-white/10 hover:bg-cyan/20 rounded-lg font-bold text-xs transition-colors text-white",children:"▶"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-gray-900/50 to-black/50 p-4 rounded-xl border border-white/10 hover:border-pink/50 transition-colors",children:[e.jsx("div",{className:"text-[10px] text-pink mb-2 font-bold flex items-center gap-2",children:"🎨 Cerveau UI/UX (Frontend)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("select",{value:B,onChange:i=>Z(i.target.value),className:"flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 outline-none focus:border-pink text-sm",children:[e.jsx("option",{value:"stitch",children:"🧵 Stitch Google"}),e.jsx("option",{value:"v0",children:"▲ v0.dev (Vercel)"}),e.jsx("option",{value:"bolt",children:"⚡ Bolt.new"}),e.jsx("option",{value:"custom",children:"➕ UI Personnalisée"})]}),e.jsx("button",{onClick:()=>{if(typeof window<"u"&&window.AndroidBridge){const i=B==="custom"?ve:B==="v0"?"https://v0.dev/":"https://stitch.withgoogle.com/";window.AndroidBridge.openAIWithPrompt(i,"Initialisation Design.")}},className:"px-3 bg-white/10 hover:bg-pink/20 rounded-lg font-bold text-xs transition-colors text-white",children:"▶"})]})]})]})]}),(D==="custom"||B==="custom")&&e.jsxs("div",{className:"flex gap-3 bg-white/5 border border-white/20 p-3 rounded-xl mt-2 animate-fadeIn",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("label",{htmlFor:"custom-ai-name",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"Nom IA Custom"}),e.jsx("input",{id:"custom-ai-name",type:"text",value:K,onChange:i=>ae(i.target.value),placeholder:"Mon Agent",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-white/50"})]}),e.jsxs("div",{className:"flex-[2]",children:[e.jsx("label",{htmlFor:"custom-ai-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Complète"}),e.jsx("input",{id:"custom-ai-url",type:"text",value:ve,onChange:i=>z(i.target.value),placeholder:"https://...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-white/50 font-mono"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{htmlFor:"api-provider",className:"text-gray-300 font-bold uppercase tracking-wider text-[10px]",children:"Fournisseur API"}),e.jsxs("select",{id:"api-provider",value:ue,onChange:i=>fe(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-xl px-4 py-3 outline-none focus:border-pink text-sm",children:[e.jsx("option",{value:"deepseek",children:"🐋 DeepSeek"}),e.jsx("option",{value:"openai",children:"🟢 OpenAI (ChatGPT)"}),e.jsx("option",{value:"anthropic",children:"🟣 Anthropic Claude"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("label",{htmlFor:"api-key",className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] flex items-center gap-2",children:["Clé API",Te==="ok"&&e.jsx("span",{className:"text-green-400 text-[10px] font-bold bg-green-400/10 px-2 py-0.5 rounded-full border border-green-400/30",children:"✅ Persistante sur disque"}),Te==="sending"&&e.jsx("span",{className:"text-yellow-400 text-[10px] animate-pulse",children:"⏳ Envoi..."}),Te==="error"&&e.jsx("span",{className:"text-red-400 text-[10px]",children:"❌ Erreur moteur"})]}),e.jsx("div",{className:"flex gap-2 relative",children:e.jsx("input",{id:"api-key",type:"password",value:X,onChange:i=>re(i.target.value),placeholder:"sk-...",className:`flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border rounded-xl px-4 py-3 outline-none text-sm font-mono transition-colors ${Te==="ok"?"border-green-500/50 focus:border-green-400":Te==="error"?"border-red-500/50":"border-white/20 focus:border-pink"}`})}),e.jsxs("div",{className:"flex items-center gap-4 mt-2",children:[e.jsx("button",{onClick:ht,className:"px-4 py-2 bg-cyan/20 hover:bg-cyan/40 border border-cyan/40 text-cyan rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center gap-2",children:"💾 SAUVEGARDER + ENVOYER AU MOTEUR"}),e.jsx("span",{className:"text-gray-500 text-xs italic",children:"Persistée sur disque (reste après redémarrage)."})]})]}),e.jsxs("div",{className:"space-y-2 p-4 bg-gradient-to-br from-black/30 to-black/50 border border-white/5 rounded-xl",children:[e.jsx("span",{className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] block",children:"Modèle détecté"}),e.jsx("div",{className:"text-gray-500 text-sm mb-2",children:"Enregistrer la clé pour détecter"}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{className:"px-4 py-2 bg-pink/20 text-pink border border-pink/50 hover:bg-pink/30 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center gap-2",children:"🔄 AUTO_DETECT"}),e.jsx("span",{className:"text-gray-500 text-xs italic",children:"Auto-détecté à l'enregistrement."})]})]}),e.jsx("div",{className:"pt-4 border-t border-white/10",children:O?e.jsxs("div",{className:"space-y-4",children:[e.jsxs("h3",{className:"text-cyan font-bold flex items-center gap-2 text-sm mb-2",children:["📱 Moteur Mobile Natif",e.jsx("span",{className:"text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30",children:"Connecté"})]}),e.jsxs("p",{className:"text-xs text-gray-400 leading-relaxed",children:["La configuration automatique est active. Les prompts sont injectés via la WebView Fantôme Java et les fichiers sont sauvegardés nativement sur votre téléphone.",e.jsx("br",{}),e.jsx("br",{}),e.jsx("strong",{children:"Aucun Bridge Electron PC n'est requis."})," L'OS Souverain est 100% autonome dans votre poche."]})]}):e.jsxs(e.Fragment,{children:[e.jsxs("h3",{className:"text-cyan font-bold flex items-center gap-2 text-sm mb-4",children:["🔗 Bridge (:5006 / Vercel)",e.jsx("span",{className:"text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30",children:"Bridge polling actif"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"bridge-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Bridge local"}),e.jsx("input",{id:"bridge-url",type:"text",value:ee,onChange:i=>de(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"vercel-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Vercel"}),e.jsx("input",{id:"vercel-url",type:"text",value:xe,onChange:i=>Ie(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"default-preview",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Preview par défaut"}),e.jsx("input",{id:"default-preview",type:"text",value:te,onChange:i=>j(i.target.value),placeholder:"http://127.0.0.1:3000",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]})]}),e.jsxs("div",{className:"flex gap-3 mt-4",children:[e.jsx("button",{className:"px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-xs font-bold text-white transition-colors",children:"🔗 Tester"}),e.jsx("button",{onClick:ht,className:"px-4 py-2 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-lg text-xs font-bold uppercase transition-colors",children:"💾 SAUVEGARDER_CONFIG"})]}),e.jsx("div",{className:"text-green-400 text-xs font-bold mt-4 flex items-center gap-2",children:"✅ Bridge connecté (auto-détecté)"})]})}),e.jsxs("div",{className:"pt-4 border-t border-white/10 space-y-4",children:[e.jsx("h3",{className:"text-blue-400 font-bold flex items-center gap-2 text-sm",children:"📓 NotebookLM Auto-Push (Python)"}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"notebook-id",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"Notebook ID (URL)"}),e.jsx("input",{id:"notebook-id",type:"text",value:an,onChange:i=>gt(i.target.value),placeholder:"6cd96956-...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-blue-500"})]}),e.jsxs("div",{children:[e.jsxs("label",{htmlFor:"auth-cookie",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px] flex justify-between",children:[e.jsx("span",{children:"Cookie d'authentification (__Secure-1PSID)"}),Ct==="success"&&e.jsx("span",{className:"text-green-400",children:"🟢 Connecté"}),Ct==="error"&&e.jsx("span",{className:"text-red-400",children:"🔴 Erreur / Expiré"}),Ct==="testing"&&e.jsx("span",{className:"text-yellow-400",children:"⏳ Test..."})]}),e.jsx("input",{id:"auth-cookie",type:"password",value:_t,onChange:i=>Ze(i.target.value),placeholder:"Collez votre cookie d'authentification Google ici...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1 outline-none focus:border-blue-500"})]}),e.jsxs("div",{className:"flex gap-3 mt-4",children:[e.jsx("button",{onClick:ht,className:"px-4 py-2 bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30 rounded-lg text-xs font-bold uppercase transition-colors",children:"💾 Sauvegarder"}),e.jsx("button",{onClick:async()=>{st("testing"),setTimeout(()=>st("success"),1e3)},className:"px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg text-xs font-bold uppercase transition-colors",children:"🧪 Tester"})]}),e.jsx("p",{className:"text-[10px] text-gray-500 italic",children:"Note : Ce cookie expire régulièrement. Pensez à le mettre à jour s'il ne fonctionne plus."})]})]})]}),y==="suture"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",onMouseEnter:()=>{Wt.length===0&&kt()},children:[e.jsxs("div",{className:"flex items-center justify-between border-b border-white/10 pb-4",children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-3",children:[e.jsx("span",{className:"text-3xl",children:"🩺"}),e.jsxs("div",{children:[e.jsx("div",{children:"Suture V2 — Moteur Zero-Touch"}),e.jsx("div",{className:"text-[10px] font-normal text-gray-400 mt-0.5",children:"Réparation autonome, isolée et atomique"})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-3 h-3 rounded-full ${Se==="error"?"bg-red-500 shadow-[0_0_12px_#ff0055] animate-ping":Se==="working"?"bg-purple-500 shadow-[0_0_12px_#a855f7] animate-pulse":"bg-emerald-400 shadow-[0_0_8px_#4ade80]"}`}),e.jsx("span",{className:`text-[11px] font-black uppercase tracking-wider ${Se==="error"?"text-red-400":Se==="working"?"text-purple-300":"text-emerald-400"}`,children:Se==="error"?"🔴 ERREUR DÉTECTÉE (SUTURE REQUIS)":Se==="working"?"🟣 SUTURE V2 EN COURS...":"🟢 MOTEUR AUTO-PILOT PRÊT"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a1a0a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-green-400 flex items-center gap-2",children:"🔬 Mode de Validation (Dry-Run)"}),e.jsx("p",{className:"text-[10px] text-gray-500 leading-relaxed",children:"Contrôle si le moteur compile le code dans le bac à sable avant de l'appliquer en production."}),e.jsx("div",{className:"grid grid-cols-3 gap-3",children:[{id:"none",icon:"🚀",label:"Production",desc:"Applique directement"},{id:"plan",icon:"🗺️",label:"Plan Only",desc:"Génère sans appliquer"},{id:"true",icon:"🧪",label:"Full Dry-Run",desc:"Clone + build + bloque"}].map(i=>e.jsxs("button",{onClick:()=>E(i.id),className:`p-3 rounded-xl border flex flex-col items-center justify-center gap-1 transition-all text-center ${At===i.id?"bg-green-900/40 border-green-500/70 text-white shadow-[0_0_12px_rgba(74,222,128,0.2)]":"bg-black/30 border-white/10 text-gray-500 hover:border-white/30 hover:text-gray-300"}`,children:[e.jsx("span",{className:"text-xl",children:i.icon}),e.jsx("span",{className:"font-black text-[10px]",children:i.label}),e.jsx("span",{className:"text-[9px] opacity-70",children:i.desc})]},i.id))})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a0a1a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-cyan flex items-center gap-2",children:"⚡ Options de Promotion"}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("label",{className:"flex items-center justify-between cursor-pointer bg-black/20 px-4 py-3 rounded-xl hover:bg-white/5 transition-colors",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm",children:"Promotion Automatique"}),e.jsx("div",{className:"text-[10px] text-gray-500",children:"Si la compilation réussit, le patch est appliqué sans confirmation"})]}),e.jsx("div",{onClick:()=>bt(i=>!i),className:`relative w-12 h-6 rounded-full transition-colors cursor-pointer ${it?"bg-cyan":"bg-white/10"}`,children:e.jsx("div",{className:`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${it?"left-7":"left-1"}`})})]}),e.jsxs("label",{className:"flex items-center justify-between cursor-pointer bg-black/20 px-4 py-3 rounded-xl hover:bg-white/5 transition-colors",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm",children:"Fichier Unique Seulement"}),e.jsx("div",{className:"text-[10px] text-gray-500",children:"La Suture ne peut modifier qu'un seul fichier par réparation (plus sûr)"})]}),e.jsx("div",{onClick:()=>qt(i=>!i),className:`relative w-12 h-6 rounded-full transition-colors cursor-pointer ${Je?"bg-cyan":"bg-white/10"}`,children:e.jsx("div",{className:`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${Je?"left-7":"left-1"}`})})]})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#1a0a0a]/60 border border-red-500/20 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-red-400 flex items-center gap-2",children:"🔒 Fichiers Verrouillés (Intouchables)"}),e.jsxs("p",{className:"text-[10px] text-gray-500 leading-relaxed",children:["Ces fichiers ne seront ",e.jsx("strong",{className:"text-red-300",children:"JAMAIS"})," modifiés par une Suture, même si l'IA essaie. Séparés par des virgules."]}),e.jsx("textarea",{value:Pe,onChange:i=>Mt(i.target.value),rows:3,className:"w-full bg-black/40 text-red-200 border border-red-500/20 rounded-lg px-3 py-2 text-[11px] font-mono outline-none focus:border-red-500/50 resize-none",placeholder:"src/design.css,package.json,..."}),e.jsx("div",{className:"flex flex-wrap gap-2",children:Pe.split(",").map(i=>i.trim()).filter(Boolean).map(i=>e.jsxs("span",{className:"flex items-center gap-1 bg-red-900/20 border border-red-500/30 text-red-300 text-[9px] font-mono px-2 py-1 rounded-full",children:["🔒 ",i,e.jsx("button",{onClick:()=>Mt(g=>g.split(",").map(v=>v.trim()).filter(v=>v!==i).join(", ")),className:"text-red-500 hover:text-white ml-1 font-bold",children:"×"})]},i))})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a0a0a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-yellow-400 flex items-center gap-2",children:"⚡ Actions Rapides Suture"}),e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx("button",{onClick:()=>I("http://localhost:5006/api/suture/purge-workspaces",{method:"POST"}).then(i=>alert(i?"✅ Bac à sable vidé !":"❌ Moteur inaccessible (Mode Cloud SaaS)")).catch(()=>alert("❌ Moteur inaccessible")),className:"py-3 bg-orange-900/20 hover:bg-orange-900/40 border border-orange-500/30 text-orange-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"🗑️ Vider le Bac à Sable"}),e.jsx("button",{onClick:()=>kt(),className:"py-3 bg-blue-900/20 hover:bg-blue-900/40 border border-blue-500/30 text-blue-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"🔄 Rafraîchir Historique"}),e.jsx("button",{onClick:()=>I("http://localhost:5006/api/suture/rollback-last",{method:"POST"}).then(i=>i?i.json():null).then(i=>alert(i?i.success?`✅ Rollback : ${i.message}`:`❌ ${i.error}`:"❌ Moteur inaccessible (Mode Cloud SaaS)")).catch(()=>alert("❌ Moteur inaccessible")),className:"py-3 bg-purple-900/20 hover:bg-purple-900/40 border border-purple-500/30 text-purple-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"↩️ Rollback Dernier Patch"}),e.jsx("button",{onClick:jt,className:`py-3 border rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all ${Pt==="saved"?"bg-green-900/40 border-green-500/50 text-green-300":"bg-cyan/10 hover:bg-cyan/20 border-cyan/40 text-cyan"}`,children:Pt==="saved"?"✅ Sauvegardé !":"💾 Sauvegarder Config"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-gray-400 flex items-center gap-2",children:"📋 Historique des Réparations"}),e.jsx("button",{onClick:()=>kt(),className:"text-[9px] text-cyan hover:text-white bg-cyan/10 px-2 py-1 rounded",children:"Actualiser"})]}),e.jsxs("div",{className:"max-h-[200px] overflow-y-auto hide-scrollbar space-y-2",children:[Jt&&e.jsx("div",{className:"text-center text-gray-500 text-[10px] animate-pulse py-4",children:"⏳ Chargement..."}),!Jt&&Wt.length===0&&e.jsx("div",{className:"text-center text-gray-600 text-[10px] italic py-4",children:"Aucune réparation trouvée. Cliquez sur 🩺 dans l'explorateur pour lancer une Suture."}),Wt.map((i,g)=>e.jsxs("div",{className:`flex items-center justify-between p-3 rounded-lg border text-[10px] font-mono ${i.status==="applied"?"bg-green-900/10 border-green-500/20":i.status==="failed"?"bg-red-900/10 border-red-500/20":"bg-white/5 border-white/10"}`,children:[e.jsxs("div",{className:"flex flex-col gap-0.5 truncate flex-1 mr-2",children:[e.jsx("span",{className:"text-white font-bold truncate",children:i.repairId||i.id}),e.jsxs("span",{className:"text-gray-500 truncate",children:[i.projectId," — ",i.activeFile||"?"]}),e.jsx("span",{className:"text-gray-600",children:i.startedAt?new Date(i.startedAt).toLocaleString("fr-FR"):""})]}),e.jsx("span",{className:`shrink-0 px-2 py-0.5 rounded-full border text-[9px] font-bold ${i.status==="applied"?"bg-green-900/30 border-green-500/40 text-green-300":i.status==="failed"?"bg-red-900/30 border-red-500/40 text-red-300":"bg-yellow-900/30 border-yellow-500/40 text-yellow-300"}`,children:i.status==="applied"?"✅ Appliqué":i.status==="failed"?"❌ Échec":"⚠️ Partiel"})]},g))]})]})]}),y==="creation"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn flex flex-col mt-8 border-t border-white/10 pt-8 pr-2",children:[e.jsxs("div",{className:"flex flex-col border-b border-white/5 pb-4",children:[e.jsxs("h2",{className:"text-2xl font-black text-white flex items-center gap-2 tracking-wide uppercase",children:[e.jsx("span",{children:"⚙️"})," CONFIGURATION DU PROJET"]}),e.jsx("p",{className:"text-[10px] text-gray-400 mt-1",children:"Générez et paramétrez votre projet de A à Z."})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1 min-h-0",children:[e.jsxs("div",{className:"transition-opacity duration-1000",children:[e.jsxs("div",{className:"bg-[#050505] border border-white/5 rounded-xl flex flex-col gap-4 overflow-y-auto hide-scrollbar p-5 mb-6",children:[e.jsxs("h3",{className:"text-white font-bold text-xs mb-2 flex items-center gap-2",children:[e.jsx("span",{className:"text-yellow-500",children:"📁"})," Création & Ciblage"]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"CIBLER UN PROJET EXISTANT"}),e.jsxs("select",{value:typeof b=="string"?b:(b==null?void 0:b.project_id)||(b==null?void 0:b.title)||"",onChange:i=>U(i.target.value),onClick:async()=>{if(_.length===0)try{const i=await I("/api/projects");if(i&&i.ok){const g=await i.json();g.projects&&S(g.projects.map(v=>typeof v=="string"?v:v.project_id||v.title||v.name||""))}else{const v=await(await fetch("/api/projects")).json();v.projects&&S(v.projects.map(T=>typeof T=="string"?T:T.project_id||T.title||T.name||""))}}catch{}},className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 outline-none focus:border-cyan text-xs",children:[e.jsx("option",{value:"",children:"-- SÉLECTIONNER UN PROJET --"}),_.map((i,g)=>{const v=typeof i=="string"?i:i.project_id||i.title||i.name||"Projet "+g;return e.jsx("option",{value:v,children:v},v+"_"+g)})]}),b&&Et==="idle"&&e.jsx("button",{onClick:async()=>{He("loading");try{const i=await I("http://localhost:5006/api/bridge/export-notebooklm",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:b,notebookId:an,authCookie:_t})});if(!i){alert("Mode Cloud SaaS : Bridge local non connecté."),He("idle");return}const g=await i.json();g.success?(sn(g.combinedContent||""),g.pushLog&&g.pushLog.includes("Failed:")?(rn(g.pushLog),He("error")):He("ready")):(rn(g.message),He("error"))}catch{rn("Erreur de connexion avec Kirov5."),He("error")}},className:"mt-2 w-full bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-2",children:"📓 Préparer l'export NotebookLM"}),b&&Et==="loading"&&e.jsx("button",{disabled:!0,className:"mt-2 w-full bg-gray-900/50 text-gray-400 border border-gray-700/50 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider flex items-center justify-center gap-2",children:"⏳ Extraction de l'expertise..."}),b&&Et==="ready"&&e.jsx("button",{onClick:async()=>{try{await navigator.clipboard.writeText(nn),window.open("https://notebook.google.com/notebook/6cd96956-200e-4260-ae7d-6c1446de284a","_blank"),He("idle")}catch{alert("❌ Copie échouée. Essayez sur HTTPS ou utilisez Ctrl+C manuellement.")}},className:"mt-2 w-full bg-green-900/40 hover:bg-green-800/60 text-green-300 border border-green-500/50 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-2",children:"✅ Copier & Ouvrir NotebookLM"}),b&&Et==="error"&&e.jsxs("div",{className:"mt-2 p-3 bg-red-900/30 border border-red-500/50 rounded-lg",children:[e.jsx("div",{className:"text-red-400 text-[10px] font-bold mb-2",children:"⚠️ Échec du script Python (Copiez l'erreur ci-dessous) :"}),e.jsx("textarea",{readOnly:!0,value:Mn,className:"w-full h-24 bg-black/50 text-red-300 text-[10px] font-mono p-2 rounded border border-red-500/20 outline-none"}),e.jsxs("div",{className:"flex gap-2 mt-2",children:[e.jsx("button",{onClick:()=>He("idle"),className:"flex-1 bg-gray-800 hover:bg-gray-700 text-white text-[10px] py-2 rounded font-bold",children:"🔄 Réessayer"}),e.jsx("button",{onClick:async()=>{try{await navigator.clipboard.writeText(nn),window.open("https://notebook.google.com/notebook/6cd96956-200e-4260-ae7d-6c1446de284a","_blank"),He("idle")}catch{alert("❌ Copie échouée.")}},className:"flex-1 bg-green-900/50 hover:bg-green-800/70 text-green-300 border border-green-500/50 text-[10px] py-2 rounded font-bold",children:"✅ Fallback Manuel"})]})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"NOM DU NOUVEAU PROJET"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"text",value:se,onChange:i=>Me(i.target.value),placeholder:"Ex: MonSuperProjet",className:"flex-1 bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan"}),e.jsx("button",{onClick:async()=>{if(!se||!se.trim()){alert("Entrez un nom de projet");return}const i=se.trim();try{const g=localStorage.getItem("kirov5_jwt_token")||"",v=await fetch("/api/projects",{method:"POST",headers:{"Content-Type":"application/json",...g?{Authorization:`Bearer ${g}`}:{}},body:JSON.stringify({title:i,name:i,projectId:i.replace(/[^a-zA-Z0-9_-]/g,"_"),description:"Projet Tiger Cloud"})}),T=await v.json();v.ok&&(T.success||T.project)?(alert(`✅ Projet "${i}" créé avec succès !`),setActiveProject(i),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",i),fetch("/api/projects",{headers:g?{Authorization:`Bearer ${g}`}:{}}).then(ne=>ne.json()).then(ne=>{ne&&ne.projects&&setRealProjects(ne.projects.map(k=>({name:k.project_id||k.title||k.name,desc:k.owner_email?`Propriétaire: ${k.owner_email}`:"Projet Cloud",bg:""})))}).catch(()=>{})):alert("❌ Erreur création projet: "+(T.error||T.message||"Erreur inconnue"))}catch(g){alert("❌ Erreur de connexion avec le serveur: "+((g==null?void 0:g.message)||g))}},className:"bg-[#0f2a2a] hover:bg-[#153f3f] text-cyan border border-cyan/30 px-4 py-2 rounded-lg text-xs font-bold transition-colors",children:"Valider"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"STACK TECHNIQUE"}),e.jsxs("select",{value:bn,onChange:i=>yt(i.target.value),className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",children:[e.jsx("option",{value:"vite",children:"⭐ 1er Choix (Prioritaire) : Vite + React + Tailwind + TS"}),e.jsx("option",{value:"nextjs",children:"Next.js 16 + Tailwind"})]})]}),e.jsxs("div",{className:"flex-1 flex flex-col",children:[e.jsxs("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2 flex items-center gap-1",children:[e.jsx("span",{className:"text-white",children:"📄"})," INSTRUCTIONS / VISION"]}),e.jsx("textarea",{value:nt,onChange:i=>Ee(i.target.value),placeholder:"Décrivez l'application ou copiez votre PRD...",className:"w-full flex-1 min-h-[120px] bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan resize-none"})]})]}),e.jsxs("div",{className:"bg-[#050505] border border-white/5 rounded-xl flex flex-col gap-4 overflow-y-auto hide-scrollbar p-5 transition-opacity duration-1000",children:[e.jsxs("h3",{className:"text-white font-bold text-xs mb-2 flex items-center gap-2",children:[e.jsx("span",{className:"text-yellow-500",children:"⚡"})," Paramètres & IA"]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"INTELLIGENCE CIBLE"}),e.jsxs("select",{className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",onChange:i=>{const g=i.target.value;window.KIROV_TARGET_AI=g,typeof window<"u"&&localStorage.setItem("tiger_targetAi",g);let v="";g==="stitch"?v="https://stitch.withgoogle.com":g==="deepseek"||g==="deepseek-web"?v="https://chat.deepseek.com":g==="gemini"?v="https://gemini.google.com":g==="chatgpt"?v="https://chatgpt.com":g==="claude"?v="https://claude.ai":g==="notebooklm"&&(v="https://notebooklm.google.com"),v&&I("http://localhost:5006/api/bridge/open-window",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:v})}).catch(T=>console.warn("Erreur ouverture fenêtre",T))},defaultValue:typeof window<"u"&&localStorage.getItem("tiger_targetAi")||"hermes",children:[e.jsx("option",{value:"notebooklm",children:"📓 NotebookLM (Google)"}),e.jsx("option",{value:"cloudflare",children:"☁️ Cloudflare Qwen 3 30B (Audit IA Grade Gold)"}),e.jsx("option",{value:"cloudflare-hermes",children:"⚡ Hermes Cloudflare Workers AI (Qwen Coder)"}),e.jsx("option",{value:"deepseek",children:"🩵 DeepSeek (Extension Web)"}),e.jsx("option",{value:"hermes",children:"🤖 Hermes Agent (API DeepSeek)"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT"}),e.jsx("option",{value:"claude",children:"🟣 Claude"})]})]}),e.jsxs("div",{children:[e.jsxs("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:["💉 MODE & LOT DE DÉPART (Val: ",x,")"]}),e.jsxs("select",{value:x,onChange:i=>w(Number(i.target.value)),className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",children:[e.jsx("option",{value:0,children:"🚀 TOUT : Pipeline Complète (Zero-Touch)"}),e.jsx("option",{value:1,children:"🎨 Phase 1 : Le Frontend (Stitch/v0)"}),e.jsx("option",{value:2,children:"⚙️ Phase 2 : Logique G5"}),e.jsx("option",{value:4,children:"🎨 Phase 3/4 : Câblage Métier (Business Wiring)"}),e.jsx("option",{value:5,children:"🔌 Phase 5 : Industrialisation & Backend"}),e.jsx("option",{value:9,children:"🪄 M.A.J UI : Pipeline Push UI/UX (One-Shot)"})]})]}),e.jsxs("div",{className:"flex flex-col gap-3 mt-4 bg-[#111] p-4 rounded-lg border border-white/5",children:[e.jsxs("label",{className:"flex items-center gap-3 text-[11px] font-bold text-gray-300 cursor-pointer",children:[e.jsx("input",{type:"checkbox",className:"accent-cyan w-4 h-4",checked:Q,onChange:()=>N(!Q)}),"🤖 AUTO-PILOT : ",Q?"ON 🟢":"OFF ⚪"]}),e.jsxs("label",{className:"flex items-center gap-3 text-[11px] font-bold text-gray-300 cursor-pointer",children:[e.jsx("input",{type:"checkbox",className:"accent-cyan w-4 h-4",checked:L,onChange:()=>V(!L)}),"🔗 Injecter dans l'onglet ouvert"]})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-3 mt-4",children:[e.jsxs("div",{id:"btn-joindre-prd",className:`py-6 text-white text-[10px] font-bold rounded-lg border flex flex-col items-center justify-center gap-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${zt?"bg-purple-950/80 border-purple-400 animate-pulse":(window.KIROV_SELECTED_PACKS||q).length>0?"bg-indigo-600 border-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.6)]":"bg-[#2a1b3d] border-purple-500/30"}`,title:"Pack PRD sélectionné — Sera injecté automatiquement dans le contexte IA",children:[e.jsx("span",{className:"text-xl",children:zt?"⏳":"💎"}),e.jsx("span",{children:zt?"Copie en cours...":(window.KIROV_SELECTED_PACKS||q).length>0?`Packs PRD ${(window.KIROV_SELECTED_PACKS||q).length} ${(window.KIROV_SELECTED_PACKS||q)[0]}`:"Aucun Pack PRD"})]}),e.jsxs("button",{id:"btn-joindre-zip",disabled:Oe,onClick:()=>{Number(x)===0&&(Rt(!0),typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning","true")),on()},className:`py-6 text-white text-[10px] font-bold rounded-lg border transition-all flex flex-col items-center justify-center gap-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${Oe?"bg-amber-950/70 border-amber-500 text-amber-300 animate-pulse":Number(x)===2&&!_e?"bg-cyan-950/80 border-2 border-cyan text-cyan shadow-[0_0_30px_rgba(6,182,212,0.7)] animate-pulse scale-105 ring-2 ring-cyan/40 cursor-pointer":$e?"bg-[#1a3a40] hover:bg-[#204a50] pointer-events-auto shadow-[0_0_30px_rgba(8,179,201,0.6)] border-cyan scale-105 z-50 relative animate-pulse":"bg-[#1a2f3a] hover:bg-[#254250] border-cyan/30"}`,title:_e?`Archive importée : ${_e}`:"Joindre le fichier ZIP exporté depuis Stitch",children:[e.jsx("span",{className:"text-xl",children:Oe?"⏳":_e?"✅":"📎"}),e.jsx("span",{className:"font-extrabold",children:Oe?"Extraction en cours...":_e?`ZIP : ${_e}`:"Joindre ZIP (Stitch)"}),Number(x)===2&&!_e&&!Oe&&e.jsx("span",{className:"text-[9px] text-cyan-300 font-extrabold uppercase animate-bounce mt-0.5",children:"👇 Étape 2 : Joindre le ZIP ici"})]})]}),(()=>{const g={0:"🚀 LANCER PIPELINE COMPLÈTE (ONE-SHOT)",1:"✨ LANCER PHASE 1 (Prompt vers l'IA)",2:_e?`⚙️ LANCER PHASE 2 (MULTI-BATCH) [${_e}]`:"⚙️ LANCER PHASE 2 (MULTI-BATCH) — ⏳ EN ATTENTE DU ZIP STITCH",3:"🎨 LANCER PHASE 3/4 (CÂBLAGE MÉTIER)",4:"🎨 LANCER PHASE 3/4 (CÂBLAGE MÉTIER)",5:"🔌 LANCER PHASE 5 (INDUSTRIALISATION)",9:"🛡️ LANCER PUSH UI"}[Number(x)];return g?e.jsx("button",{id:"btn-lancer-phase",onClick:()=>{const v=b||se;if(!v){alert("Veuillez sélectionner ou créer un projet !");return}if(Number(x)===2&&!_e){confirm(`📁 Le fichier .zip Stitch n'est pas encore joint à ce projet.

Souhaitez-vous sélectionner et importer votre archive ZIP maintenant ?`)&&on();return}Rt(!0),typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning","true"),setTimeout(()=>{var k;(k=document.getElementById("kirov-radar-queue"))==null||k.scrollIntoView({behavior:"smooth"})},500);const T=window.KIROV_TARGET_AI||typeof window<"u"&&localStorage.getItem("tiger_targetAi")||"hermes";if(typeof r=="function"&&r(),G("home"),typeof window<"u"&&window.dispatchEvent(new CustomEvent("open-mouchard")),Number(x)===5){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:T,start_index:1,zip_mode:!0,start_phase:5,auto_pilot:Q})}).then(k=>k?k.json():null).then(k=>{alert(k?`✅ PHASE 5 (INDUSTRIALISATION) LANCÉE !
L'orchestrateur génère l'infrastructure et certifie le projet.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(k=>{console.error(k),alert("Erreur lors du lancement de la Phase 5.")});return}if(Number(x)===4||Number(x)===3){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:T,start_index:1,zip_mode:!0,start_phase:4,auto_pilot:Q,packs:window.KIROV_SELECTED_PACKS||[]})}).then(k=>k?k.json():null).then(k=>{alert(k?`✅ PHASE 3/4 (CÂBLAGE MÉTIER) LANCÉE !
L'orchestrateur prend le relais pour connecter et câbler la logique métier.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(k=>{console.error(k),alert("Erreur lors du lancement de la Phase 3/4.")});return}if(Number(x)===2){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:T,start_index:1,zip_mode:!0,start_phase:200,auto_pilot:Q,packs:window.KIROV_SELECTED_PACKS||[]})}).then(k=>k?k.json():null).then(k=>{alert(k?`✅ PHASE 2 (LOGIQUE G5) LANCÉE !
L'orchestrateur prend le relais pour générer le Backend et intégrer les composants.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(k=>{console.error(k),alert("Erreur: Le moteur n'a pas pu être contacté.")});return}typeof window<"u"&&(window.open("https://stitch.withgoogle.com/","_blank"),window.dispatchEvent(new CustomEvent("open-mouchard")));const ne=window.KIROV_SELECTED_PACKS&&window.KIROV_SELECTED_PACKS.length>0?window.KIROV_SELECTED_PACKS:q&&q.length>0?q:[];if(Number(x)===0){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:v,target_ai:"stitch",start_index:1,zip_mode:!0,start_phase:0,auto_pilot:Q,instructions:nt||"Génère l'application avec ces packs et directives.",packs:ne})}).then(k=>k?k.json():null).then(k=>{var Fe;const me=(k==null?void 0:k.prompt)||((Fe=k==null?void 0:k.data)==null?void 0:Fe.prompt)||"Génération UI/UX Stitch complète.",Ce=ne.length>0?ne.join(", "):"standard";if(w(2),typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase","2"),typeof document<"u"){const Xe=document.getElementById("tiger-mega-prompt-overlay");Xe&&Xe.remove();const et=document.createElement("div");et.id="tiger-mega-prompt-overlay",et.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);backdrop-filter:blur(10px);z-index:999999;display:flex;align-items:center;justify-content:center;padding:16px;font-family:sans-serif;",et.innerHTML=`
                                  ...
                                  <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid rgba(255,255,255,0.1);padding-bottom:12px;">
                                    <div>
                                      ...
                                      <p style="margin:4px 0 0 0;font-size:11px;color:#94a3b8;">
                                        Projet : <strong style="color:#e2e8f0;">${v}</strong> | Pack PRD : <strong style="color:#a855f7;">${Ce}</strong>
                                      </p>
                                    </div>
                              ...
                              `,document.body.appendChild(et);const ut=document.getElementById("tiger-prompt-area"),je=document.getElementById("btn-copy-prompt"),vt=document.getElementById("btn-close-prompt-overlay"),Qe=document.getElementById("btn-open-stitch"),Lt=()=>{ut&&(ut.select(),ut.setSelectionRange(0,99999),document.execCommand("copy")),navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),w(2),je&&(je.innerHTML="✅ COPIÉ DANS LE PRESSE-PAPIER !",je.style.background="linear-gradient(135deg,#10b981,#059669)",setTimeout(()=>{je&&(je.innerHTML="📋 COPIER LE MÉGA-PROMPT",je.style.background="linear-gradient(135deg,#06b6d4,#2563eb)")},3e3))};je&&(je.onclick=()=>{Lt(),w(2)}),vt&&(vt.onclick=()=>{et.remove(),w(2)}),Qe&&(Qe.onclick=()=>{window.open("https://stitch.withgoogle.com/","_blank"),w(2)}),Lt(),w(2)}}).catch(k=>{console.error(k),alert("Erreur de communication avec le serveur Kirov5.")});return}I("/api/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:"stitch",user_prompt:nt||"Génère l'application avec ces packs et directives.",packs:ne,target_project:v,phase_num:1})}).then(k=>k?k.json():null).then(k=>{var Ce;const me=(k==null?void 0:k.prompt)||((Ce=k==null?void 0:k.data)==null?void 0:Ce.prompt)||"Génération UI/UX Stitch.";typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),alert(`🚀 PHASE 1 (STITCH UI/UX) INITIALISÉE !
...
👉 Faites Ctrl + V dans Stitch pour lancer la génération graphique !`)}).catch(k=>{console.error(k),alert("L'onglet Stitch a été ouvert. Assurez-vous d'avoir saisi les consignes de design.")})},className:`w-full mt-4 py-4 rounded-lg border transition-all flex justify-center items-center gap-2 text-[11px] font-black uppercase tracking-wider text-white ${Number(x)===0?"bg-gradient-to-r from-purple-600/60 to-pink-600/60 hover:from-purple-500/70 hover:to-pink-500/70 border-purple-500/50 shadow-[0_0_20px_rgba(168,85,247,0.4)]":"bg-gradient-to-r from-emerald-600/40 to-cyan-600/40 hover:from-emerald-500/50 hover:to-cyan-500/50 border-emerald-500/50 shadow-[0_0_15px_rgba(16,185,129,0.3)]"}`,children:g}):null})(),Number(x)===9&&e.jsxs("div",{className:"mt-2 p-4 border border-cyan/30 bg-[#0f2a2a]/40 rounded-xl",children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"CIBLE ET SOURCE DU DESIGN"}),e.jsxs("div",{className:"mb-3",children:[e.jsxs("div",{className:"flex items-center justify-between mb-1",children:[e.jsxs("label",{className:"text-[9px] text-cyan/70 font-bold uppercase tracking-wider",children:["PAGES CIBLES",qe.length>0&&!uiAllPages&&e.jsxs("span",{className:"ml-2 text-cyan bg-cyan/20 px-1.5 py-0.5 rounded",children:[qe.length," sélectionnée",qe.length>1?"s":""]})]}),e.jsx("button",{onClick:async()=>{const i=b||se;if(!i){alert("Sélectionnez un projet actif d'abord !");return}try{const g=await I(`http://localhost:5005/api/projects/${i}/pages`);if(g&&g.ok){const v=await g.json();v.pages&&ft(v.pages)}}catch{}},className:"text-[9px] text-cyan bg-cyan/10 border border-cyan/30 px-2 py-0.5 rounded hover:bg-cyan/20 transition-all",children:"↻ Rafraîchir"})]}),e.jsxs("div",{onClick:()=>{setUiAllPages(!uiAllPages),Ne([])},className:`flex items-center gap-2 px-3 py-2 rounded-lg mb-1 cursor-pointer border transition-all ${uiAllPages?"bg-cyan/20 border-cyan/50 text-cyan":"bg-white/5 border-white/10 text-gray-400 hover:bg-white/10"}`,children:[e.jsx("div",{className:`w-3 h-3 rounded border flex items-center justify-center shrink-0 ${uiAllPages?"border-cyan bg-cyan":"border-gray-500"}`,children:uiAllPages&&e.jsx("span",{className:"text-white text-[8px] font-black leading-none",children:"✓"})}),e.jsx("span",{className:"text-[10px] font-black",children:"🚀 TOUTES LES PAGES (Auto-Mapping ZIP)"})]}),dt.length===0?e.jsxs("div",{onClick:async()=>{const i=b||se;if(!i){alert("Sélectionnez un projet actif d'abord !");return}try{const g=await I(`http://localhost:5006/api/projects/${i}/pages`);if(g&&g.ok){const v=await g.json();v.pages&&ft(v.pages)}}catch{}},className:"text-[10px] text-gray-500 italic text-center py-3 border border-dashed border-white/10 rounded-lg cursor-pointer hover:border-cyan/30 hover:text-cyan/50 transition-all",children:["⏳ Cliquez pour charger les pages de « ",(typeof b=="string"?b:(b==null?void 0:b.project_id)||(b==null?void 0:b.title))||se||"?"," »"]}):e.jsxs("div",{className:"flex flex-col gap-1 max-h-[160px] overflow-y-auto",children:[!uiAllPages&&e.jsxs("div",{className:"flex gap-1 mb-1",children:[e.jsx("button",{onClick:()=>Ne([...dt]),className:"flex-1 text-[9px] text-cyan/70 border border-white/10 rounded px-2 py-1 hover:bg-white/5",children:"✔ Tout sélectionner"}),e.jsx("button",{onClick:()=>Ne([]),className:"flex-1 text-[9px] text-gray-500 border border-white/10 rounded px-2 py-1 hover:bg-white/5",children:"✕ Tout désélectionner"})]}),dt.map(i=>{const g=i.replace("src/pages/","").replace(".tsx","").replace(".jsx",""),v=uiAllPages||qe.includes(i);return e.jsxs("div",{onClick:()=>{uiAllPages||Ne(T=>T.includes(i)?T.filter(ne=>ne!==i):[...T,i])},className:`flex items-center gap-2 px-3 py-2 rounded-lg cursor-pointer border transition-all ${uiAllPages?"opacity-50 bg-white/5 border-white/10":v?"bg-cyan/15 border-cyan/50 text-cyan":"bg-white/5 border-white/10 text-gray-300 hover:bg-white/10"}`,children:[e.jsx("div",{className:`w-3 h-3 rounded border flex items-center justify-center shrink-0 ${v?"border-cyan bg-cyan":"border-gray-500"}`,children:v&&e.jsx("span",{className:"text-white text-[8px] font-black leading-none",children:"✓"})}),e.jsx("span",{className:"text-[10px] font-bold",children:g}),e.jsx("span",{className:"text-[9px] text-gray-600 ml-auto",children:".tsx"})]},i)})]}),(uiAllPages||qe.length>0)&&e.jsx("div",{className:"mt-2 text-[9px] text-cyan/80 bg-cyan/5 border border-cyan/20 rounded px-2 py-1 font-mono",children:uiAllPages?"✅ TOUTES LES PAGES seront traitées":`✅ ${qe.length} page(s) : ${qe.map(i=>i.replace("src/pages/","").replace(".tsx","")).join(", ")}`})]}),e.jsx("input",{type:"text",value:_e,onChange:i=>Ke(i.target.value),placeholder:"Fichier ZIP (ex: v0-design.zip)",className:"w-full mb-3 bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 outline-none focus:border-cyan text-xs"}),ct&&e.jsx("div",{className:"mb-3 text-[10px] text-cyan font-bold p-2 bg-cyan/10 border border-cyan/20 rounded",children:ct}),e.jsxs("button",{disabled:isUiPushLoading,onClick:async()=>{const i=b||se;if(!i){alert("Sélectionnez un projet d'abord.");return}if(!uiAllPages&&qe.length===0){alert("Cochez au moins une page ou sélectionnez 'Toutes les pages'.");return}if(!_e){alert("Indiquez le nom du fichier ZIP.");return}const g=uiAllPages?["ALL_PAGES"]:qe;setIsUiPushLoading(!0),Ge(`🚀 Démarrage du push pour ${g.length===1&&g[0]==="ALL_PAGES"?"TOUTES LES PAGES":`${g.length} page(s)`}...`);try{for(let v=0;v<g.length;v++){const T=g[v],ne=T==="ALL_PAGES"?"ALL_PAGES":T.replace("src/pages/","").replace(".tsx","");Ge(`⏳ [${v+1}/${g.length}] Traitement de ${ne}...`);const k={projectId:i,targetFile:T,zipFileName:_e,baseVersionId:"v1-current",mode:"strict-ui",targetRoute:"/",source:"vercel-interface",promotionMode:"disabled",idempotencyKey:`push-${i}-${T}-${Date.now()}`},me=await I("http://localhost:5005/api/bridge/strict-ui-update",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(k)});if(!me)throw new Error("Moteur local injoignable");const Ce=await me.json();if(!me.ok||!Ce.success)throw new Error(Ce.message||"Erreur");const Fe=Ce.pushId;Sn(Fe),await new Promise((Xe,et)=>{const ut=setInterval(async()=>{var je;try{const vt=await I(`http://localhost:5005/api/bridge/strict-ui-update/${Fe}?projectId=${i}`);if(!vt)return;const Qe=await vt.json();if(Ge(`⏳ [${v+1}/${g.length}] ${ne} — état: ${Qe.state}`),["promoted","preview_ready","validation_incomplete"].includes(Qe.state))clearInterval(ut),Xe();else if(["failed","rejected","promotion_rejected"].includes(Qe.state)){clearInterval(ut);const Lt=typeof Qe.error=="string"?Qe.error:((je=Qe.error)==null?void 0:je.message)||Qe.state;et(new Error(`${ne}: ${Lt}`))}}catch{}},3e3)})}Ge("✅ Toutes les pages traitées avec succès !")}catch(v){Ge(`❌ ${v.message}`)}finally{setIsUiPushLoading(!1)}},className:`w-full py-4 rounded-lg transition-all flex justify-center items-center gap-2 text-[11px] font-black uppercase tracking-wider text-white ${isUiPushLoading?"bg-gray-600 cursor-not-allowed":"bg-gradient-to-r from-blue-600/60 to-cyan-600/60 hover:from-blue-500/70 hover:to-cyan-500/70 border-cyan/50 shadow-[0_0_15px_rgba(8,179,201,0.4)]"}`,children:[e.jsx("span",{children:"🚀"})," LANCER PIPELINE PUSH UIUX (ONE-SHOT)"]}),We&&Ht&&e.jsxs("button",{disabled:dn,onClick:async()=>{const i=b||se;$t(!0),Ge("🚀 Promotion en cours vers la Production...");try{const g=await I(`http://localhost:5005/api/bridge/strict-ui-update/${Ht}/promote`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:i,promotionMode:"hybrid",confirm:!0})}),v=await g.json();g.ok&&v.success?(Ge(`✅ Promotion Atomique Réussie ! Version: ${v.versionId}`),Kt(!1)):Ge(`❌ Échec de la promotion: ${v.message||v.error}`)}catch(g){Ge(`❌ Erreur de promotion: ${g.message}`)}finally{$t(!1)}},className:`w-full mt-3 py-4 rounded-lg transition-all flex justify-center items-center gap-2 text-[11px] font-black uppercase tracking-wider text-white ${dn?"bg-gray-600 cursor-not-allowed":"bg-gradient-to-r from-green-600/60 to-emerald-600/60 hover:from-green-500/70 hover:to-emerald-500/70 border-emerald-500/50 shadow-[0_0_15px_rgba(16,185,129,0.4)]"}`,children:[e.jsx("span",{children:"🟢"})," PROMOUVOIR EN PRODUCTION (MERGE)"]})]})]})]}),e.jsxs("div",{className:"flex flex-col gap-4 overflow-y-auto hide-scrollbar",children:[e.jsx("div",{className:"bg-[#050505] border border-white/5 rounded-xl p-5",children:e.jsx(Lo,{activeProjectName:(typeof b=="string"?b:(b==null?void 0:b.project_id)||(b==null?void 0:b.title))||se,selectedStartPhase:Number(x),onPhaseChange:i=>w(i),onPackGenerated:(i,g,v)=>{window.dispatchEvent(new CustomEvent("update_kirov_packs",{detail:[i]})),g&&Ee(T=>T?`${T}

[INJECTION PRD] : ${g}`:g),yt(v==="ecommerce"||v==="social"?"nextjs":"vite"),alert(`💎 Le Pack PRD '${i}' a été généré et lié automatiquement au projet !`)}})}),e.jsxs("div",{className:`bg-[#050505] border border-white/5 rounded-xl p-5 transition-all duration-500 ${$e?"shadow-[0_0_30px_rgba(8,179,201,0.3)] border-cyan/40":""}`,children:[e.jsx("h2",{className:"text-white font-bold text-[11px] mb-5 tracking-wide",children:'Workflow "Design-First" (Hybride)'}),e.jsxs("div",{className:"flex flex-col gap-3 text-[10px] font-mono text-gray-400 relative",children:[e.jsx("div",{className:"absolute left-[11px] top-6 bottom-6 w-px bg-white/5 z-0"}),Number(x)===0&&!Q&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute left-[5px] top-[32px] bg-red-900/80 border border-red-500 rounded text-[8px] px-1 text-white z-20",children:"🛑 Pause"}),e.jsx("div",{className:"absolute left-[5px] top-[64px] bg-red-900/80 border border-red-500 rounded text-[8px] px-1 text-white z-20",children:"🛑 Pause"}),e.jsx("div",{className:"absolute left-[5px] top-[96px] bg-red-900/80 border border-red-500 rounded text-[8px] px-1 text-white z-20",children:"🛑 Pause"}),e.jsx("div",{className:"absolute left-[5px] top-[128px] bg-red-900/80 border border-red-500 rounded text-[8px] px-1 text-white z-20",children:"🛑 Pause"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#051505] border border-green-500/50 flex items-center justify-center text-green-400 shrink-0 text-[10px]",children:"0"}),e.jsx("span",{className:"text-green-400",children:"Création (Boilerplate)"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#051020] border border-blue-500/50 flex items-center justify-center text-blue-400 shrink-0 text-[10px]",children:"1"}),e.jsx("span",{className:"text-blue-400",children:"Génération UI (Stitch)"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#150520] border border-indigo-500/50 flex items-center justify-center text-indigo-400 shrink-0 text-[10px]",children:"2"}),e.jsx("span",{className:"text-indigo-400",children:"Scan HTML & Blueprint JSON"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#051a20] border border-cyan/80 flex items-center justify-center text-cyan shadow-[0_0_15px_rgba(8,179,201,0.4)] shrink-0 text-[10px]",children:"3"}),e.jsx("span",{className:"text-cyan font-bold",children:"Orchestration des Lots"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#200520] border border-purple-500/50 flex items-center justify-center text-purple-400 shrink-0 text-[10px]",children:"4"}),e.jsx("span",{className:"text-purple-400",children:"Génération Contractuelle"})]}),e.jsxs("div",{className:"flex items-center gap-4 relative z-10",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[#2a1a00] border border-orange-500/50 flex items-center justify-center text-orange-400 shrink-0 text-[10px]",children:"5"}),e.jsx("span",{className:"text-orange-400",children:"Validation Industrielle"})]})]})]}),e.jsx("div",{className:"flex flex-col gap-2 mb-2",children:e.jsxs("button",{onClick:async()=>{var v;const i=b||se;if(!i)return;const g=window.KIROV_TARGET_AI||"notebooklm";try{alert("Audit en cours... Hermes analyse votre code source pour générer le Pack Métier (Câblage). Veuillez patienter 15-30 secondes.");let T=`wiring-${i}`;try{const k=await I("http://localhost:5006/api/bridge/generate-wiring-pack",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:i,baseVersionId:"version-active",request:"Audite la coquille vide et propose le câblage métier.",targetFiles:[],targetRoutes:[],source:"phase-4-ui"})}),me=k?await k.json():null;me&&me.success?T=((v=me.data)==null?void 0:v.wiringPackId)||me.wiringPackId||T:console.warn("[WIRING] Solde API DeepSeek insuffisant (402) ou fallback. Synthèse autonome activée.")}catch(k){console.warn("[WIRING] Fallback local:",k)}alert("✅ Pack PRD Métier (Logic Wiring) prêt : "+T+`
Lancement de la Phase 3/4 (Câblage Métier)...`);const ne={target_project:i,target_ai:g||"cloudflare",start_phase:4,wiringPackId:T,auto_pilot:Q,packs:window.KIROV_SELECTED_PACKS||[]};I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(ne)}).then(k=>k?k.json():null).then(k=>{k&&(k.mode==="multi_batch"?alert("✅ "+k.message):k.error&&alert("❌ Erreur lors de l'injection : "+k.error))}).catch(k=>console.error("Trombone error",k))}catch(T){alert("❌ Erreur lors de l'audit: "+(T.message||T))}},className:"w-full bg-[#051a20] hover:bg-[#083040] border border-cyan/40 text-cyan px-4 py-3 rounded-lg text-[10px] font-bold transition-all flex justify-center items-center gap-2 shadow-[0_0_15px_rgba(8,179,201,0.2)]",children:[e.jsx("span",{children:"🔍"})," AUDITER LA COQUILLE VIDE (Générer Pack Métier)"]})}),e.jsxs("div",{className:"flex flex-col gap-2 mb-2",children:[e.jsxs("button",{onClick:()=>{const i=b||se;if(!i)return;const g=window.KIROV_TARGET_AI||"deepseek",v=Number(x)===4?{projectId:i,start_phase:4,wiringPackId:`wiring-${i.replace(/[^a-zA-Z0-9_-]/g,"")}`,promotionMode:"disabled",autoPilot:!0}:{target_project:i,target_ai:g,start_index:1,zip_mode:!0,start_phase:x};I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(v)}).catch(T=>console.error(T))},className:"w-full bg-[#0a1025] hover:bg-[#101a35] border border-indigo-500/30 text-indigo-200 px-4 py-3 rounded-lg text-[10px] font-bold transition-all flex justify-center items-center gap-2",children:[e.jsx("span",{children:"🚀"})," LANCER PIPELINE PUSH UIUX (ONE-SHOT)"]}),e.jsxs("button",{onClick:async()=>{const i=b||se;if(!i){alert("Sélectionnez un projet d'abord.");return}try{const g=await I("http://localhost:5006/api/bridge/reset-session",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:i})});if(!g){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const v=await g.json();alert(v.success?`🔓 ${v.message}`:`❌ ${v.error}`)}catch{alert("❌ Moteur :5006 inaccessible.")}},className:"w-full bg-[#2a0a0a] hover:bg-[#3d1010] border border-red-500/40 text-red-300 px-4 py-3 rounded-lg text-[10px] font-bold transition-all flex justify-center items-center gap-2",children:[e.jsx("span",{children:"🔓"})," DÉBLOQUER SESSION (Anti-Lockout)"]}),e.jsxs("button",{onClick:()=>{if(console.log("L'automatisation est lancée !"),!be.current||Object.keys(be.current).length===0){const g=b||se;if(!g)return;I("http://localhost:5006/api/debug/advance-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:g})}).catch(()=>null);return}const i=Object.keys(be.current)[0];I("http://localhost:5006/api/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:be.current[i].prompt,target_ai:i,phase_num:be.current[i].phase_num,is_multi_batch:be.current[i].is_multi_batch,project_id:be.current[i].project_id})}).catch(()=>null)},className:"w-full bg-[#250a25] hover:bg-[#351035] border border-purple-500/30 text-purple-200 px-4 py-3 rounded-lg text-[10px] font-bold transition-all flex justify-center items-center gap-2",children:[e.jsx("span",{children:"🚀"})," Lancer l'Automatisation (Phase 4)"]})]}),e.jsxs("div",{id:"kirov-radar-queue",className:`flex-1 bg-[#050505] rounded-xl p-4 flex flex-col gap-4 min-h-[150px] transition-all duration-1000 ${$e?"border-2 border-cyan shadow-[0_0_30px_rgba(8,179,201,0.2)]":"border border-white/5"}`,children:[e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("span",{className:"text-cyan font-bold text-[11px] flex items-center gap-2",children:[e.jsx("span",{className:"w-1 h-3 bg-cyan inline-block rounded-sm"})," Tâche Actuelle"]}),e.jsx("button",{onClick:async()=>{let i=null,g="deepseek";if(be.current&&Object.keys(be.current).length>0?(g=Object.keys(be.current)[0],i=be.current[g]):be.queue&&be.queue.length>0&&(i=be.queue[0],g=i.target_ai||"deepseek"),!i){alert("Aucune tâche active ni en attente.");return}const v=localStorage.getItem("tiger_bridgeUrl")||"http://localhost:5006";I(`${v}/v1/bridge/inject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:i.prompt,target_ai:g,phase_num:i.phase_num,is_multi_batch:i.is_multi_batch,project_id:i.project_id||i.target_project||"GTASTICH"})}).catch(()=>null),alert(`Prompt [${i.phase_name||i.phase_num||"Lot 1"}] poussé manuellement dans la zone texte KIROV5 (${g}) !`)},className:"bg-[#0f2a2a] text-cyan text-[8px] font-bold px-2 py-1 rounded transition-colors",children:"FORCER ENVOI"})]}),be.current&&Object.keys(be.current).length>0?Object.entries(be.current).map(([i,g])=>{const v=typeof g.prompt=="string"?g.prompt:JSON.stringify(g.prompt);return e.jsxs("div",{className:"bg-[#111] p-3 rounded-lg text-[9px] text-gray-400 font-mono",children:[e.jsxs("div",{className:"text-pink font-bold mb-1",children:["[",i.toUpperCase(),"] ",g.phase_name||"Tâche"]}),e.jsxs("div",{className:"truncate opacity-80",children:[v?v.substring(0,80):"","..."]})]},i)}):e.jsx("div",{className:"text-[10px] text-gray-500 italic pl-3",children:"Aucune tâche en cours."})]}),e.jsx("div",{className:"w-full h-px bg-white/5"}),e.jsxs("div",{className:"flex flex-col gap-2 flex-1 min-h-0",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("span",{className:"text-orange-400 font-bold text-[10px] flex items-center gap-2",children:[e.jsx("span",{children:"⏳"})," En attente (",be.queue.length,")"]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{onClick:async()=>{const i=localStorage.getItem("tiger_bridgeUrl")||"http://localhost:5006";for(let g=0;g<20;g++)await I(`${i}/v1/bridge/consume`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({})}).catch(()=>null)},className:"text-[9px] text-red-500 hover:text-red-400 border border-red-500/30 px-2 py-0.5 rounded",children:"🗑️ Vider"}),e.jsx("button",{onClick:()=>{const i=b||se||"GTASTICH",g=localStorage.getItem("tiger_bridgeUrl")||"http://localhost:5006";I(`${g}/api/debug/advance-batch`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:i})}).catch(()=>null)},className:"text-[9px] text-gray-500 hover:text-gray-300",children:"Passer (Skip)"})]})]}),e.jsx("div",{className:"flex-1 overflow-y-auto pr-1 space-y-2 hide-scrollbar",children:be.queue.length>0?be.queue.map((i,g)=>{var T;const v=typeof i.prompt=="string"?i.prompt:JSON.stringify(i.prompt);return e.jsxs("div",{className:"bg-[#111] border border-white/5 p-2 rounded flex flex-col gap-1",children:[e.jsxs("div",{className:"text-[9px] font-bold text-gray-400 flex justify-between",children:[e.jsxs("span",{children:["[",g+1,"] ",i.phase_name||"Action"]}),e.jsx("span",{className:"text-purple-400",children:(T=i.target_ai)==null?void 0:T.toUpperCase()})]}),e.jsxs("div",{className:"text-[8px] text-gray-600 font-mono truncate",children:[v?v.substring(0,60):"","..."]})]},g)}):e.jsx("div",{className:"text-[10px] text-gray-600 italic p-2 text-center border border-dashed border-white/5 rounded",children:"File vide."})})]})]})]}),e.jsxs("div",{className:"bg-black border border-white/10 rounded-xl p-3 flex flex-col gap-2 shadow-inner h-32 mt-4",children:[e.jsxs("div",{className:"text-[10px] text-green-500 font-mono font-bold flex items-center justify-between border-b border-white/5 pb-1",children:[e.jsx("span",{children:"> Moteur Kirov5 - Terminal Temps Réel"}),e.jsx("span",{className:"animate-pulse",children:"_"})]}),e.jsx("div",{className:"flex-1 overflow-y-auto font-mono text-[9px] text-gray-300 hide-scrollbar flex flex-col justify-end",children:ln.length===0?e.jsx("span",{className:"text-gray-600 italic",children:"En attente d'activité système..."}):ln.slice(-15).map((i,g)=>e.jsx("div",{className:i.includes("❌")?"text-red-400":i.includes("✅")?"text-green-400":i.includes("✍️")?"text-cyan":"",children:i},g))})]})]})]}),y==="override"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-xl font-black text-white border-b border-white/10 pb-2",children:"Mode Manuel (Override)"}),e.jsx("p",{className:"text-gray-400 text-xs mt-2",children:"Prenez le contrôle manuel si l'automatisation s'enraye."})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{className:"text-gray-300 font-bold text-sm",children:"Injection de prompt de secours"}),e.jsx("textarea",{value:M,onChange:i=>ge(i.target.value),placeholder:"Entrez le prompt à forcer dans DeepSeek...",className:"w-full h-32 bg-gradient-to-b from-gray-900/60 to-black/60 text-white border border-white/20 rounded-xl p-3 outline-none focus:border-cyan text-sm resize-none"}),e.jsxs("div",{className:"flex gap-3 pt-2",children:[e.jsx("button",{className:"flex-1 py-2 bg-gradient-to-r from-pink/30 to-pink/10 hover:from-pink/40 hover:to-pink/20 text-pink border border-pink/50 rounded-lg text-xs font-bold transition-all",children:"💉 Forcer Injection"}),e.jsx("button",{className:"flex-1 py-2 bg-gradient-to-r from-orange-500/30 to-orange-500/10 hover:from-orange-500/40 hover:to-orange-500/20 text-orange-400 border border-orange-500/50 rounded-lg text-xs font-bold transition-all",children:"📦 Forcer Capture"})]})]}),e.jsxs("div",{className:"bg-gradient-to-b from-black/50 to-black/70 border border-white/10 p-3 rounded-xl h-32 font-mono text-[10px] text-gray-400 overflow-y-auto",children:[e.jsx("span",{className:"text-white mb-2 block",children:"Log Override"}),"En attente d'action manuelle..."]})]}),y==="mouchard"&&e.jsxs("div",{className:"space-y-4 animate-fadeIn h-full flex flex-col",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-xl font-black text-white border-b border-white/10 pb-2",children:"Mouchard Système"}),e.jsx("p",{className:"text-gray-400 text-xs mt-2",children:"Surveillance en temps réel du flux de données."})]}),e.jsxs("div",{className:"flex-1 bg-gradient-to-b from-gray-900 to-black border border-white/10 rounded-xl p-4 font-mono text-xs overflow-y-auto space-y-2 relative",children:[e.jsx("div",{className:"absolute top-2 right-2 flex gap-2",children:e.jsx("button",{className:"text-[10px] bg-gradient-to-r from-red-500/30 to-red-500/10 text-red-400 px-2 py-1 rounded hover:from-red-500/40 hover:to-red-500/20",children:"[WIPE]"})}),e.jsx("div",{className:"text-white font-bold mb-3 border-b border-white/20 pb-1 inline-block",children:"LOG_STREAM"}),e.jsx("div",{className:"text-yellow-400",children:"[09:24:30] ⚠️ Bridge local non joignable (Failed to fetch (Bridge hors ligne) - Failed to fetch). Polling Vercel actif."}),e.jsx("div",{className:"text-green-400",children:"[09:24:30] KIROV5 Orchestrator v5.1.1 prêt — structure React (.tsx/.ts/.css) préservée."}),e.jsx("div",{className:"text-cyan",children:"[09:24:30] Onglets: Projets · Projet · Injection · Capture · GitHub + Bridge :5006."})]})]}),y==="home"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{className:"flex justify-between items-center border-b border-white/10 pb-4",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"🐯"})," TIGER IA — Hub d'Orchestration Souverain"]}),e.jsx("p",{className:"text-xs text-gray-400 mt-1",children:"Supervision de l'écosystème Zero-Touch et de l'orchestrateur G5."})]}),e.jsx("span",{className:"px-3 py-1 bg-green-500/20 text-green-400 border border-green-500/30 rounded-full text-xs font-bold animate-pulse",children:"● Moteur IA Actif"})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:[e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/70 p-4 rounded-2xl border border-cyan/30 shadow-lg",children:[e.jsx("div",{className:"text-cyan text-xs font-bold uppercase tracking-wider mb-1",children:"Moteur Local"}),e.jsx("div",{className:"text-2xl font-black text-white",children:"v5.0.0"}),e.jsxs("div",{className:"text-[10px] text-gray-400 mt-2 flex items-center gap-1",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-cyan"})," Bridge 5006 Opérationnel"]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/70 p-4 rounded-2xl border border-purple-500/30 shadow-lg",children:[e.jsx("div",{className:"text-purple-400 text-xs font-bold uppercase tracking-wider mb-1",children:"Agent Réflexion"}),e.jsx("div",{className:"text-2xl font-black text-white",children:"DeepSeek-R1"}),e.jsxs("div",{className:"text-[10px] text-gray-400 mt-2 flex items-center gap-1",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-purple-400"})," Mode Hybride Actif"]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/70 p-4 rounded-2xl border border-pink/30 shadow-lg",children:[e.jsx("div",{className:"text-pink text-xs font-bold uppercase tracking-wider mb-1",children:"Studio UI/UX"}),e.jsx("div",{className:"text-2xl font-black text-white",children:"Zero-Touch"}),e.jsxs("div",{className:"text-[10px] text-gray-400 mt-2 flex items-center gap-1",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-pink"})," Synchro Temps Réel"]})]})]}),e.jsxs("div",{className:"space-y-3 pt-2",children:[e.jsx("h3",{className:"text-sm font-bold text-gray-300 uppercase tracking-wider",children:"🚀 Actions Système Rapides"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3",children:[e.jsxs("button",{onClick:()=>window.open("http://localhost:3006","_blank"),className:"p-4 bg-gradient-to-r from-cyan/20 to-blue-500/20 hover:from-cyan/30 hover:to-blue-500/30 border border-cyan/40 rounded-xl text-left transition-all flex items-center justify-between group",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm group-hover:text-cyan transition-colors",children:"🌐 Ouvrir l'Interface Studio (Vercel)"}),e.jsx("div",{className:"text-xs text-gray-400",children:"Accès direct au tableau de bord localhost:3006"})]}),e.jsx("span",{className:"text-xl",children:"➔"})]}),e.jsxs("button",{onClick:async()=>{var i;try{const g=await I("http://localhost:5006/api/theme");if(!g){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const v=await g.json();alert("Thème synchronisé : "+(((i=v.activeTheme)==null?void 0:i.nom)||"Thème par défaut"))}catch{alert("Vérifiez que le serveur Electron :5006 est démarré.")}},className:"p-4 bg-gradient-to-r from-purple-500/20 to-pink/20 hover:from-purple-500/30 hover:to-pink/30 border border-purple-500/40 rounded-xl text-left transition-all flex items-center justify-between group",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm group-hover:text-purple-300 transition-colors",children:"🎨 Tester la Synchronisation Thème"}),e.jsx("div",{className:"text-xs text-gray-400",children:"Interroge l'API bridge :5006/api/theme"})]}),e.jsx("span",{className:"text-xl",children:"🔄"})]})]})]})]}),y==="electron"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{className:"flex justify-between items-center border-b border-white/10 pb-4",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"💻"})," Moteur Electron PC — Serveur Local"]}),e.jsx("p",{className:"text-xs text-gray-400 mt-1",children:"Gestion du pont d'exécution et du système de fichiers local."})]}),e.jsx("span",{className:"px-3 py-1 bg-cyan/20 text-cyan border border-cyan/40 rounded-full text-xs font-bold",children:"Port :5006"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"bg-black/50 p-4 rounded-xl border border-white/10 space-y-3 font-mono text-xs text-gray-300",children:[e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Dossier Racine Workspace :"}),e.jsx("span",{className:"text-cyan font-bold",children:"E:\\v0reponses"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Répertoire des Projets Sauvegardés :"}),e.jsx("span",{className:"text-green-400 font-bold",children:"v0-moteur-electron/v0saveprojets"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Fichier Configuration Thème :"}),e.jsx("span",{className:"text-yellow-400 font-bold",children:"theme-config.json"})]}),e.jsxs("div",{className:"flex justify-between",children:[e.jsx("span",{className:"text-gray-400",children:"Mode Bridge HTTP :"}),e.jsx("span",{className:"text-blue-400 font-bold",children:"Express API REST Active"})]})]}),e.jsxs("div",{className:"flex gap-3",children:[e.jsx("button",{onClick:async()=>{var i,g;try{const v=await I("http://localhost:5006/api/projects");if(!v){alert("Mode Cloud SaaS actif : Bridge Electron local non connecté.");return}const T=await v.json();alert(`Projets détectés (${((i=T.projects)==null?void 0:i.length)||0}) : 
`+(((g=T.projects)==null?void 0:g.join(`
`))||"Aucun"))}catch{alert("Erreur de connexion au bridge Express :5006")}},className:"flex-1 py-3 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl text-white font-bold text-xs transition-colors flex items-center justify-center gap-2",children:"📁 Lister les Projets Locaux"}),e.jsx("button",{onClick:()=>{alert("Le moteur Electron tourne sur la tâche principale Windows.")},className:"flex-1 py-3 bg-cyan/20 hover:bg-cyan/30 border border-cyan/40 rounded-xl text-cyan font-bold text-xs transition-colors flex items-center justify-center gap-2",children:"⚡ État du Processus Electron"})]})]})]}),y==="vercel"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{className:"flex justify-between items-center border-b border-white/10 pb-4",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-2",children:[e.jsx("span",{className:"text-pink",children:"▲"})," Studio Web Vercel — Preview & HMR"]}),e.jsx("p",{className:"text-xs text-gray-400 mt-1",children:"Interface frontend réactive et synchronisation en direct."})]}),e.jsx("span",{className:"px-3 py-1 bg-pink/20 text-pink border border-pink/40 rounded-full text-xs font-bold",children:"Vite Dev Server"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"bg-black/50 p-4 rounded-xl border border-white/10 space-y-3 text-xs text-gray-300",children:[e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"URL Dev Local :"}),e.jsx("span",{className:"text-cyan font-mono font-bold",children:"http://localhost:3006"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Design System CSS :"}),e.jsx("span",{className:"text-pink font-mono font-bold",children:"src/design.css"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Source de Vérité Design Tokens :"}),e.jsx("span",{className:"text-purple-400 font-mono font-bold",children:"src/design-tokens.json"})]}),e.jsxs("div",{className:"flex justify-between",children:[e.jsx("span",{className:"text-gray-400",children:"Hot Module Replacement (HMR) :"}),e.jsx("span",{className:"text-green-400 font-bold",children:"Actif (Modifications Instantanées)"})]})]}),e.jsx("div",{className:"flex gap-3",children:e.jsx("button",{onClick:()=>window.open("http://localhost:3006/admin-design","_blank"),className:"flex-1 py-3 bg-gradient-to-r from-pink/30 to-purple-500/30 hover:from-pink/40 hover:to-purple-500/40 border border-pink/50 rounded-xl text-white font-bold text-xs transition-colors flex items-center justify-center gap-2",children:"🎨 Ouvrir le Studio Admin Design"})})]})]}),y==="deepseek"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsxs("div",{className:"flex justify-between items-center border-b border-white/10 pb-4",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-2",children:[e.jsx("span",{className:"text-purple-400",children:"🐋"})," Modèle IA DeepSeek — Agent Logique"]}),e.jsx("p",{className:"text-xs text-gray-400 mt-1",children:"Paramètres du modèle de génération de code et d'architecture."})]}),e.jsx("span",{className:"px-3 py-1 bg-purple-500/20 text-purple-400 border border-purple-500/30 rounded-full text-xs font-bold",children:"DeepSeek-V3 / R1"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"bg-black/50 p-4 rounded-xl border border-white/10 space-y-3 text-xs text-gray-300",children:[e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Mode d'Exécution IA :"}),e.jsx("span",{className:"text-cyan font-bold",children:"Chat Web & API Hybride"})]}),e.jsxs("div",{className:"flex justify-between border-b border-white/10 pb-2",children:[e.jsx("span",{className:"text-gray-400",children:"Fenêtre de Contexte :"}),e.jsx("span",{className:"text-green-400 font-bold",children:"128,000 Tokens"})]}),e.jsxs("div",{className:"flex justify-between",children:[e.jsx("span",{className:"text-gray-400",children:"Rôle Principal :"}),e.jsx("span",{className:"text-purple-400 font-bold",children:"Cerveau Backend & Génération de Fichiers"})]})]}),e.jsx("div",{className:"flex gap-3",children:e.jsx("button",{onClick:()=>window.open("https://chat.deepseek.com/","_blank"),className:"flex-1 py-3 bg-gradient-to-r from-purple-500/30 to-blue-500/30 hover:from-purple-500/40 hover:to-blue-500/40 border border-purple-500/40 rounded-xl text-white font-bold text-xs transition-colors flex items-center justify-center gap-2",children:"🐋 Ouvrir DeepSeek Web"})})]})]})]}),!n&&e.jsxs("div",{className:"p-4 border-t border-white/10 bg-gradient-to-b from-black/30 to-black/50 flex flex-wrap justify-between items-center gap-4 relative z-10",children:[e.jsxs("button",{onClick:()=>oe(!Re),className:`text-xs font-bold hover:underline flex items-center gap-1 ${Re?"text-green-500":"text-red-500"}`,children:[e.jsx("span",{className:`w-2 h-2 rounded-full animate-pulse ${Re?"bg-green-500":"bg-red-500"}`}),Re?"Extension Connectée":"Extension Déconnectée"]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-3",children:[Ae&&e.jsx("span",{className:"text-green-400 font-bold text-xs flex items-center mr-2 animate-pulse",children:"✓ Sauvegardé"}),t&&e.jsx("button",{onClick:r,className:"px-4 py-2 rounded-xl text-white font-bold bg-gradient-to-r from-white/10 to-transparent hover:from-white/20 transition-colors text-sm",children:"Fermer"}),e.jsx("button",{onClick:ht,className:"px-4 py-2 bg-gradient-to-r from-cyan to-blue-500 rounded-xl text-black font-black uppercase tracking-wider transition-all text-sm shadow-[0_0_15px_rgba(8,179,201,0.5)] whitespace-nowrap",children:"💾 SAUVER"})]})]})]})]})},Ft=({items:t})=>{const n=a.useRef(null);return e.jsx("div",{ref:n,className:"design-carte-carrousel-conteneur w-full max-w-full flex overflow-x-auto gap-4 py-4 px-2 hide-scrollbar scroll-smooth relative",style:{scrollBehavior:"smooth"},children:t.map((r,l)=>e.jsx("div",{className:"shrink-0 relative z-0 hover:z-10",children:r},l))})},Xn=Object.assign({"../../prd_packs/CHOU/README.md":ys,"../../prd_packs/app_web_pack/README.md":_s,"../../prd_packs/audio_pack/README.md":Cs,"../../prd_packs/blog_contenu_pack/README.md":ws,"../../prd_packs/chat_comms_pack/README.md":Is,"../../prd_packs/chatcom/README.md":As,"../../prd_packs/commerce_paiement_pack/README.md":Ps,"../../prd_packs/composant_pack/README.md":js,"../../prd_packs/createur_pack/README.md":ks,"../../prd_packs/design_figma_xd_pack/README.md":Ts,"../../prd_packs/diamond_bridge_v14_37/README.md":Es,"../../prd_packs/e_commerce_pack/README.md":Rs,"../../prd_packs/ecommerce_pack/README.md":Ns,"../../prd_packs/evenement_pack/README.md":Ds,"../../prd_packs/feed_social_pack/README.md":Ms,"../../prd_packs/forge_universelle/README.md":qs,"../../prd_packs/forms_inputs_pack/README.md":Ls,"../../prd_packs/formulaire_pack/README.md":Us,"../../prd_packs/gamification_pack/README.md":Os,"../../prd_packs/guest_apk_forge/README.md":Gs,"../../prd_packs/guest_bloguev1/README.md":Fs,"../../prd_packs/guest_bric/README.md":Vs,"../../prd_packs/guest_bricbrac/README.md":Bs,"../../prd_packs/guest_bros/README.md":zs,"../../prd_packs/guest_bross/README.md":Hs,"../../prd_packs/guest_chat/README.md":$s,"../../prd_packs/guest_colorful_landing_page/README.md":Ks,"../../prd_packs/guest_colorful_landing_page_builder/README.md":Ws,"../../prd_packs/guest_cyberrunner/README.md":Js,"../../prd_packs/guest_facturescan_souverain/README.md":Xs,"../../prd_packs/guest_fireguard_ai/README.md":Qs,"../../prd_packs/guest_flowforge_studio/README.md":Zs,"../../prd_packs/guest_game_launch_orchestrator/README.md":Ys,"../../prd_packs/guest_gametetris/README.md":er,"../../prd_packs/guest_gta_vi_store/README.md":tr,"../../prd_packs/guest_kirov5_forge/README.md":nr,"../../prd_packs/guest_kirov_game_studio/README.md":sr,"../../prd_packs/guest_landing_page_adaptive/README.md":rr,"../../prd_packs/guest_mariob/README.md":ir,"../../prd_packs/guest_nebula_calc/README.md":ar,"../../prd_packs/guest_neonstack/README.md":or,"../../prd_packs/guest_neonstack_arcade/README.md":lr,"../../prd_packs/guest_plateforme/README.md":cr,"../../prd_packs/guest_plateformv2/README.md":dr,"../../prd_packs/guest_preorder_management/README.md":ur,"../../prd_packs/guest_production_ready_industrialization/README.md":pr,"../../prd_packs/guest_scraping_du_site_web_https_/README.md":mr,"../../prd_packs/guest_skills_platform_clone/README.md":gr,"../../prd_packs/guest_sovereign_production_platform/README.md":hr,"../../prd_packs/guest_stitchlab/README.md":xr,"../../prd_packs/guest_tetris_evolution/README.md":fr,"../../prd_packs/guest_tetris_nova/README.md":br,"../../prd_packs/guest_welcome_canvas/README.md":vr,"../../prd_packs/guest_welcome_portal/README.md":Sr,"../../prd_packs/guest_welcome_vibes/README.md":yr,"../../prd_packs/guest_welcomecanvas/README.md":_r,"../../prd_packs/guest_workflow_automation_platform/README.md":Cr,"../../prd_packs/guest_workflow_automation_studio/README.md":wr,"../../prd_packs/guest_workflow_orchestrator/README.md":Ir,"../../prd_packs/health_fitness_pack/README.md":Ar,"../../prd_packs/ia_pack/README.md":Pr,"../../prd_packs/image_pack/README.md":jr,"../../prd_packs/interface_pack/README.md":kr,"../../prd_packs/jeux_video_pack/README.md":Tr,"../../prd_packs/landing_pack/README.md":Er,"../../prd_packs/landing_saas_pack/README.md":Rr,"../../prd_packs/layout_pack/README.md":Nr,"../../prd_packs/local_maps_pack/README.md":Dr,"../../prd_packs/markdown_pack/README.md":Mr,"../../prd_packs/marketing_pack/README.md":qr,"../../prd_packs/mobile_pack/README.md":Lr,"../../prd_packs/mobile_shell_pack/README.md":Ur,"../../prd_packs/mobile_web_pack/README.md":Or,"../../prd_packs/mock_master/README.md":Gr,"../../prd_packs/pdf_docs_pack/README.md":Fr,"../../prd_packs/pieces_jointes_pack/README.md":Vr,"../../prd_packs/prd_ai_apps_pack/README.md":Br,"../../prd_packs/prd_ai_voice_agent/README.md":zr,"../../prd_packs/prd_auth_gateway/README.md":Hr,"../../prd_packs/prd_blog_magazine/README.md":$r,"../../prd_packs/prd_crm_erp_pack/README.md":Kr,"../../prd_packs/prd_ecom_catalog/README.md":Wr,"../../prd_packs/prd_ecom_checkout/README.md":Jr,"../../prd_packs/prd_ecom_digital_products/README.md":Xr,"../../prd_packs/prd_game_leaderboard/README.md":Qr,"../../prd_packs/prd_layout_bento/README.md":Zr,"../../prd_packs/prd_layout_kanban/README.md":Yr,"../../prd_packs/prd_mobile_pack/README.md":ei,"../../prd_packs/prd_mobile_social/README.md":ti,"../../prd_packs/prd_pack/README.md":ni,"../../prd_packs/prd_saas_billing_pro/README.md":si,"../../prd_packs/prd_saas_pack/README.md":ri,"../../prd_packs/prd_sovereign_fullstack/README.md":ii,"../../prd_packs/prd_specs_pack/README.md":ai,"../../prd_packs/prd_web_landing_pack/README.md":oi,"../../prd_packs/productivity_pack/README.md":li,"../../prd_packs/produit_pack/README.md":ci,"../../prd_packs/prompt_skills_pack/README.md":di,"../../prd_packs/saas_pack/README.md":ui,"../../prd_packs/specialise_pack/README.md":pi,"../../prd_packs/sqlite_inspector/README.md":mi,"../../prd_packs/stealth_bridge_v11_2/README.md":gi,"../../prd_packs/texte_pack/README.md":hi,"../../prd_packs/universal_scraper/README.md":xi,"../../prd_packs/video_pack/README.md":fi,"../../prd_packs/web_blog_pack/README.md":bi,"../../prd_packs/widget_pack/README.md":vi}),gn=t=>{for(const n in Xn)if(n.includes(`/${t}/README.md`)||n.includes(`\\${t}\\README.md`))return Xn[n];return null},Go=({messages:t,showGuestPacks:n,setShowGuestPacks:r,guestPacksCount:l,guestPackSearchQuery:d,setGuestPackSearchQuery:m})=>e.jsx("div",{className:"design-carte-v0-guest flex-shrink-0 w-full xl:w-[320px] z-30",children:e.jsxs("div",{onClick:()=>r&&r(!n),className:`h-full rounded-2xl p-6 border flex flex-col justify-between transition-all cursor-pointer shadow-2xl relative overflow-hidden group ${n?"border-purple-400 bg-purple-950/40 shadow-[0_0_30px_rgba(168,85,247,0.3)]":"border-white/10 bg-black/60 hover:border-purple-500/50 hover:bg-purple-950/20"}`,children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-purple-500/10 to-transparent pointer-events-none"}),e.jsxs("div",{className:"relative z-10 flex flex-col h-full",children:[e.jsx("div",{className:"w-12 h-12 rounded-xl bg-purple-500/20 border border-purple-500/40 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform",children:e.jsx("span",{className:"text-2xl",children:"🐋"})}),e.jsx("h3",{className:"text-xl font-black text-white mb-1 leading-tight",children:"V0-GUEST"}),e.jsx("div",{className:"text-purple-400 font-bold text-xs uppercase tracking-widest mb-2",children:"Hermes PRD Pack Engine"}),e.jsxs("div",{className:"mb-2 relative",children:[e.jsx("input",{type:"text",placeholder:"Rechercher un pack Guest...",value:d||"",onChange:h=>m&&m(h.target.value),onClick:h=>h.stopPropagation(),className:"w-full bg-black/40 border border-purple-500/30 rounded-lg px-3 py-1.5 text-xs text-white placeholder-purple-400/50 focus:outline-none focus:border-purple-400 focus:bg-purple-900/20 transition-all"}),e.jsx("span",{className:"absolute right-2 top-1.5 text-purple-400/50 text-xs",children:"🔍"})]}),t&&t.length>0?e.jsxs("div",{className:"mt-2 p-3 bg-black/70 border border-purple-500/30 rounded-xl max-h-[280px] min-h-[160px] overflow-y-auto space-y-2 text-left shadow-inner flex-1",children:[e.jsxs("div",{className:"text-[10px] font-bold text-purple-300 uppercase tracking-wider mb-2 flex items-center justify-between border-b border-purple-500/20 pb-1",children:[e.jsx("span",{children:"💬 Discussion Chat Active"}),e.jsxs("span",{className:"text-[9px] text-purple-400 font-mono",children:[t.length," msg"]})]}),t.map((h,p)=>e.jsxs("div",{className:`p-2.5 rounded-xl text-xs leading-relaxed border ${h.role==="user"?"bg-purple-900/60 border-purple-400/50 text-purple-100 text-right ml-2":"bg-zinc-900/90 border-white/10 text-gray-200 mr-2"}`,children:[e.jsx("span",{className:"font-bold text-[9px] block opacity-70 mb-0.5",children:h.role==="user"?"Vous":"Hermes AI"}),h.content]},h.id||p))]}):e.jsx("p",{className:"text-xs text-zinc-400 leading-relaxed mb-3",children:"Accédez à vos propres packs sur-mesure générés localement par reverse engineering avec l'Agent Hermes."})]}),e.jsxs("div",{className:"relative z-10 mt-4 pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsxs("span",{className:"text-[10px] font-bold text-zinc-300 uppercase tracking-widest",children:[l||4," PACKS DISPONIBLES"]}),e.jsx("span",{className:`text-xl transition-transform ${n?"rotate-90 text-purple-400":"text-zinc-500 group-hover:text-purple-400"}`,children:"➔"})]})]})}),Fo=({selectedPacks:t,togglePack:n,isClient:r,getCachedGradient:l,onDetailStateChange:d,messages:m,showGuestPacks:h,setShowGuestPacks:p,guestPackSearchQuery:_})=>{const[S,b]=a.useState({}),[U,O]=a.useState(null),[Q,N]=a.useState([]),L=async()=>{try{const x=await I(`http://localhost:5006/api/bridge/list-guest-packs?t=${Date.now()}`,{cache:"no-store"});if(x&&x.ok){const w=await x.json(),q=w.data||w;q.success&&q.packs&&N(q.packs)}}catch(x){console.error("Erreur lecture guest packs",x)}},V=x=>{O(x),d&&d(!!x)};if(a.useEffect(()=>{Gt.forEach(x=>{const w=x.id;if(!S[w]){const q=gn(w);q&&b(y=>({...y,[w]:q}))}})},[]),a.useEffect(()=>{L()},[]),U){let x=S[U.packId]&&S[U.packId].trim().length>5?S[U.packId]:U.readmeText&&U.readmeText.trim().length>5?U.readmeText:gn(U.packId)||"";return(!x||x.trim().length<5)&&(x=`# 💎 PRD PACK : ${U.packName} (${U.packId})
...
*Le fichier README complet est disponible dans le dossier prd_packs/${U.packId}/README.md.*`),e.jsxs("div",{className:"design-fenetre-readme w-full rounded-3xl p-6 md:p-8 border-2 border-cyan/60 shadow-[0_0_80px_rgba(124,58,237,0.45)] my-4 relative animate-fadeIn text-white z-20 flex flex-col min-h-[480px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 flex-shrink-0",children:[e.jsxs("span",{className:"px-3.5 py-1.5 bg-cyan/20 text-cyan text-xs font-bold rounded-xl border border-cyan/40 flex items-center gap-2 shadow-sm",children:[e.jsx("span",{children:"💎"})," PACK PRD : ",U.packId]}),e.jsx("button",{onClick:()=>V(null),className:"w-10 h-10 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-xl flex items-center justify-center font-bold text-lg transition-all border border-cyan/40 cursor-pointer shadow-md",title:"Fermer (Retour aux packs)",children:"✕"})]}),e.jsx("h2",{className:"text-2xl md:text-3xl font-black text-cyan mb-2 leading-tight drop-shadow-[0_2px_10px_rgba(6,182,212,0.5)] flex-shrink-0",children:U.packName}),e.jsx("div",{className:"w-full h-px bg-gradient-to-r from-cyan via-purple-400 to-cyan/20 mb-4 flex-shrink-0"}),e.jsx("div",{className:"design-readme-contenu flex-1 text-white font-medium leading-relaxed whitespace-pre-wrap overflow-y-auto max-h-[500px] p-6 rounded-2xl border-2 border-cyan/50 font-mono text-sm shadow-[0_0_40px_rgba(8,179,201,0.3)] min-h-[300px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)",textShadow:"0 1px 2px rgba(0,0,0,0.8)"},children:x}),e.jsxs("div",{className:"mt-6 pt-4 border-t border-white/15 flex justify-between items-center flex-shrink-0",children:[e.jsxs("span",{className:"text-xs text-cyan/90 font-mono font-bold tracking-widest uppercase flex items-center gap-2",children:[e.jsx("span",{children:"⚡"})," SUTURE PRD ENGINE"]}),e.jsx("button",{onClick:()=>V(null),className:"px-6 py-2.5 bg-cyan/20 hover:bg-cyan/40 text-cyan font-bold rounded-xl transition-all border border-cyan/40 flex items-center gap-2 cursor-pointer hover:bg-cyan/30 shadow-md",children:"← Fermer & Retour aux packs"})]})]})}return e.jsxs("div",{id:"prd-packs-carousel-section",className:"w-full flex-1 min-w-0 my-2",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3 px-2",children:[e.jsxs("h4",{className:"design-prd-titre-section font-black uppercase tracking-widest text-cyan flex items-center gap-2",children:[e.jsx("span",{children:"💎"})," PACKS PRD DE CONNAISSANCES (",Gt.length,")"]}),t&&t.length>0&&e.jsxs("span",{className:"text-[11px] font-bold text-cyan bg-cyan/20 px-2.5 py-1 rounded-full border border-cyan/30",children:[t.length," pack(s) actif(s)"]})]}),e.jsx("div",{className:"flex gap-4 items-stretch relative w-full",children:e.jsx("div",{className:"flex-1 min-w-0 min-h-[480px] overflow-hidden py-4 flex items-center",children:h?Q.length===0?e.jsxs("div",{className:"h-full min-h-[220px] rounded-2xl p-6 border border-purple-500/20 bg-purple-950/20 backdrop-blur-md flex flex-col items-center justify-center text-center",children:[e.jsx("p",{className:"text-purple-300 font-bold text-sm",children:"Aucun pack Guest n'a encore été généré."}),e.jsx("p",{className:"text-xs text-zinc-400 mt-2",children:"Utilisez l'interface V0-GUEST pour scanner un projet local et créer un pack sur-mesure."}),e.jsx("button",{onClick:L,className:"mt-4 text-xs text-purple-300 border border-purple-500/40 px-4 py-1.5 rounded-full hover:bg-purple-900/40 transition-colors",children:"🔄 Recharger les packs Guest"})]}):e.jsx(Ft,{items:Q.filter(x=>{var q,y,G,H;if(!_)return!0;const w=_.toLowerCase();return((q=x.name)==null?void 0:q.toLowerCase().includes(w))||((y=x.description)==null?void 0:y.toLowerCase().includes(w))||((G=x.id)==null?void 0:G.toLowerCase().includes(w))||((H=x.category)==null?void 0:H.toLowerCase().includes(w))}).sort((x,w)=>(x.name||"").localeCompare(w.name||"")).map(x=>{const w=x.id,q=t?t.includes(w):!1;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${q?"border-purple-400 shadow-[0_0_25px_rgba(168,85,247,0.4)] bg-purple-950/60":"border-purple-500/20 hover:border-purple-400/60 bg-black/50"}`,children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${q?"bg-purple-500 text-white shadow-md":"bg-purple-500/20 text-purple-400 border border-purple-500/40"}`,children:e.jsx(kn,{size:18})}),e.jsx("span",{className:"px-2 py-0.5 bg-purple-500/20 text-purple-300 text-[10px] font-bold rounded-md uppercase tracking-wider border border-purple-500/30",children:"🐋 GUEST"})]}),n&&e.jsx("button",{onClick:y=>{y.stopPropagation(),n(w)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${q?"bg-purple-500 text-white shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-purple-500/40 hover:text-white"}`,children:q?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight truncate",children:x.name}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed text-zinc-300 text-xs line-clamp-4",children:x.description}),e.jsxs("div",{className:"mt-4 pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsxs("span",{className:"text-[10px] font-mono text-purple-400/80",children:[x.modulesCount," MODULES"]}),e.jsxs("button",{onClick:async()=>{var y;try{const G=await I(`http://localhost:5006/api/bridge/read-file?path=${encodeURIComponent(x.path+"/README.md")}`);let H="";if(G&&G.ok){const A=await G.json();H=((y=A.data)==null?void 0:y.content)||A.content||""}V({packId:w,packName:x.name,readmeText:H||`# PACK GUEST : ${x.name}

Spécifications techniques du pack Guest ${x.name}.

Module réutilisable scanné dans ${x.path}.`})}catch{V({packId:w,packName:x.name,readmeText:`# PACK GUEST : ${x.name}

Spécifications techniques du pack Guest ${x.name}.`})}},className:"design-prd-btn text-purple-400 text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-purple-500/30 transition-all",children:[e.jsx("span",{children:"📖"})," README →"]})]})]},w)})}):e.jsx(Ft,{items:Gt.map(x=>{const w=x.id,q=x.name,y=x.icon||cs,G=t?t.includes(w):!1,D=(S[w]||gn(w)||"Spécifications techniques du contrat PRD.").replace(/^#+.*$/gm,"").replace(/^>.*$/gm,"").replace(/\[([^\]]+)\]\([^\)]+\)/g,"$1").replace(/[*_~`]/g,"").trim().split(`
`).map(Z=>Z.trim()).filter(Z=>Z.length>20),W=D.length>0?D[0]:"Spécifications techniques du contrat PRD.",B=W.length>180?W.substring(0,180)+"...":W;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${G?"border-cyan shadow-[0_0_25px_rgba(8,179,201,0.4)]":"border-white/10 hover:border-cyan/50"}`,style:{background:r?l("prd-card-"+w,.7):"rgba(0,0,0,0.7)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${G?"bg-cyan text-black shadow-md":x.color||"bg-cyan/20 text-cyan"}`,children:e.jsx(y,{size:20})}),e.jsx("span",{className:"px-2 py-0.5 bg-cyan/20 text-cyan text-[10px] font-bold rounded-md uppercase tracking-wider",children:"💎 PRD"})]}),n&&e.jsx("button",{onClick:Z=>{Z.stopPropagation(),n(w)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${G?"bg-cyan text-black shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-white/20 hover:text-white"}`,title:G?"Désélectionner ce pack":"Sélectionner ce pack pour l'IA",children:G?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight",children:q}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed",children:B}),e.jsxs("div",{className:"mt-auto pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-mono text-cyan/80",children:"MODULE PRD"}),e.jsxs("button",{onClick:async()=>{var K;let Z=S[w]||gn(w)||"";try{const ae=await I(`http://localhost:5006/api/bridge/read-file?packId=${encodeURIComponent(w)}`);if(ae&&ae.ok){const ve=await ae.json(),z=ve.content||((K=ve.data)==null?void 0:K.content);z&&z.trim().length>5&&(Z=z,b(ee=>({...ee,[w]:z})))}}catch(ae){console.warn("API Bridge read fallback",ae)}V({packId:w,packName:q,readmeText:Z||`# 💎 PRD PACK : ${q} (${w})

### ⚙️ Spécifications techniques du contrat PRD

- **Identifiant Pack**: ${w}
- **Statut**: Actif & Intégré au Moteur Sovereign`})},className:"design-prd-btn text-cyan text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-cyan/30 transition-all hover:bg-cyan/10",children:[e.jsx("span",{children:"📖"})," Lire le README →"]})]})]},w)})})})})]})},Qn=({isClient:t,getCachedGradient:n,setActiveProject:r})=>{const[l,d]=a.useState([]),[m,h]=a.useState(!0),[p,_]=a.useState(!1),[S,b]=a.useState(null),[U,O]=a.useState({}),Q=async()=>{try{let L=[];try{const V=await fetch("https://api.github.com/repos/turnzack/v0-reponse/releases");if(V.ok){const x=await V.json();Array.isArray(x)&&x.forEach(w=>{Array.isArray(w.assets)&&w.assets.forEach(q=>{var y;(y=q.name)!=null&&y.endsWith(".apk")&&L.push({file:q.name,name:q.name.replace(".apk",""),sizeMb:(q.size/(1024*1024)).toFixed(1),url:q.browser_download_url})})})}}catch{}try{const V=await I("http://localhost:5006/api/mobile/list-apks");if(V&&V.ok){const x=await V.json();x&&x.success&&Array.isArray(x.apks)&&(L=[...L,...x.apks])}else{const x=await fetch("/api/mobile/list-apks");if(x&&x.ok){const w=await x.json();w&&w.success&&Array.isArray(w.apks)&&(L=[...L,...w.apks])}}}catch{}if(L.length>0){const V={};L.forEach(x=>{V[x.name.toLowerCase()]=x,V[x.file.toLowerCase()]=x,V[x.name.toLowerCase().replace(/[^a-z0-9]/g,"")]=x}),O(V)}}catch(L){console.warn("[WidgetProjects] fetchApks error",L)}},N=(L=!1)=>{L?_(!0):h(!0);const V=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];I("http://localhost:5006/api/projects").then(x=>x?x.json():null).then(x=>{if(x&&x.success&&x.projects)d(x.projects.map((w,q)=>({name:typeof w=="string"?w:w.projectName||w.name||w.projectId||w.project_id||w.title||`Projet_${q}`,desc:"Environnement Local",bg:V[q%V.length],installed:w.installed}))),h(!1),_(!1);else{const w=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:w?{Authorization:`Bearer ${w}`}:{}}).then(q=>q?q.json():null).then(q=>{q&&q.projects&&d(q.projects.map((y,G)=>({name:y.project_id||y.title||y.name||`Projet_${G}`,desc:"SaaS Cloud (Neon DB)",bg:V[G%V.length]}))),h(!1),_(!1)}).catch(()=>{h(!1),_(!1)})}}).catch(()=>{h(!1),_(!1)})};return a.useEffect(()=>{N(),Q();const L=setInterval(()=>{N(!0),Q()},5e3);return()=>clearInterval(L)},[]),m?e.jsx("div",{className:"p-4 text-cyan text-sm italic",children:"Actualisation de la liste des projets..."}):l.length===0?e.jsxs("div",{className:"p-4 flex flex-col items-center gap-3 text-center",children:[e.jsx("div",{className:"text-cyan text-sm italic",children:"Aucun projet trouvé sur votre disque dur."}),e.jsx("button",{onClick:()=>N(),className:"px-4 py-2 rounded-xl bg-cyan/20 border border-cyan/40 text-cyan text-xs font-bold hover:bg-cyan/40 transition-colors",children:"🔄 Rafraîchir la liste"})]}):e.jsx(Ft,{items:[...l.map((L,V)=>{const x=L.name||"AUDIO",w=async()=>{b(x),r(x);try{window.dispatchEvent(new CustomEvent("open-mouchard")),I("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:x})}).then(async A=>{if(A){const D=await A.json().catch(()=>null);D!=null&&D.previewUrl&&window.open(D.previewUrl,"_blank")}}).catch(()=>{}),await I(`http://localhost:5006/api/projects/${encodeURIComponent(x)}/launch-design`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:x,open_explorer:!1})}).catch(A=>console.error("Erreur de lancement :",A))}catch(A){console.error("Erreur de lancement :",A)}finally{setTimeout(()=>b(null),2e3)}},q=async A=>{if(A.preventDefault(),A.stopPropagation(),window.confirm(`⚠️ SUPPRESSION DEFINITIVE :
Voulez-vous vraiment supprimer le projet "${x}" de l'interface ET de votre disque dur ?`))try{const D=await I("http://localhost:5006/api/projects/remove-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:x})});if(!D){d(B=>B.filter(Z=>Z.name!==x));return}const W=await D.json();W.success?d(B=>B.filter(Z=>Z.name!==x)):alert(`Erreur lors de la suppression : ${W.message||"Échec server"}`)}catch(D){alert(`Erreur réseau lors de la suppression : ${D.message}`)}},y=x.toLowerCase(),G=y.replace(/[^a-z0-9]/g,""),H=U[y]||U[G]||U[`${y}.apk`];return e.jsxs("div",{className:"design-carte-carrousel rounded-2xl p-5 border border-white/20 shadow-xl flex flex-col items-center text-center relative overflow-hidden group cursor-pointer",style:{background:t?n("proj-"+V,.7):"rgba(0,0,0,0.5)"},onClick:w,children:[H&&e.jsxs("a",{href:H.url,download:H.file,onClick:A=>A.stopPropagation(),className:"z-20 absolute top-3 left-3 bg-emerald-600 hover:bg-emerald-500 text-white text-[10px] font-black px-2.5 py-1 rounded-full flex items-center gap-1.5 shadow-lg border border-emerald-400/50 transition-all hover:scale-105 cursor-pointer",title:`Télécharger directement l'APK (${H.sizeMb} Mo)`,children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-white animate-ping"}),e.jsxs("span",{children:["📱 APK PRÊT (",H.sizeMb,"M)"]})]}),e.jsx("button",{onClick:q,className:"z-20 absolute top-3 right-3 w-8 h-8 rounded-full bg-red-600/80 hover:bg-red-500 text-white font-bold text-xs flex items-center justify-center transition-all shadow-lg hover:scale-110 cursor-pointer",title:"Supprimer ce projet du disque dur et de l'interface",children:"🗑️"}),e.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-30 mix-blend-overlay pointer-events-none"}),e.jsx("div",{className:"absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors z-0"}),e.jsxs("div",{className:"z-10 relative pointer-events-none w-full pr-8",children:[e.jsx("div",{className:"text-white/70 text-xs font-bold uppercase tracking-widest drop-shadow-md",children:"PROJET"}),e.jsx("h3",{className:"design-carte-titre text-xl font-black text-white break-all drop-shadow-lg leading-tight w-full",children:x})]}),e.jsx("div",{className:"design-carte-desc z-10 relative text-sm text-white/90 font-medium drop-shadow-md pointer-events-none w-full",children:L.desc}),e.jsxs("div",{className:"z-10 flex flex-wrap items-center justify-center gap-2 mt-3",children:[e.jsx("button",{onClick:A=>{A.stopPropagation(),S!==x&&(L.installed===!1?(b(x),I("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:x})}).then(D=>{alert(D?`📦 Installation des dépendances démarrée pour "${x}" !
Suivez la progression dans les logs.`:"Mode Cloud SaaS : Bridge local non connecté."),b(null),d(W=>W.map(B=>B.name===L.name?{...B,installed:!0}:B))}).catch(()=>b(null))):w())},disabled:S===x,className:`font-bold py-2 px-4 rounded-xl text-xs transition-all flex items-center gap-1.5 ${S===x?"bg-cyan-500/40 text-cyan-200 cursor-wait animate-pulse":L.installed===!1?"bg-orange-500/80 hover:bg-orange-600 text-white cursor-pointer":"bg-white/20 hover:bg-white/40 text-white cursor-pointer"}`,title:L.installed===!1?"Installer les dépendances requises pour ce projet":"Lancer la prévisualisation Vite",children:S===x?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin inline-block",children:"⏳"})," ",L.installed===!1?"Installation...":"Lancement..."]}):L.installed===!1?e.jsx(e.Fragment,{children:"📦 INSTALL"}):e.jsx(e.Fragment,{children:"🚀 PREVIEW"})}),H&&e.jsxs("a",{href:H.url,download:H.file,onClick:A=>A.stopPropagation(),className:"bg-gradient-to-r from-emerald-600 to-green-500 hover:from-emerald-500 hover:to-green-400 text-white font-extrabold py-2 px-3.5 rounded-xl text-xs transition-all flex items-center gap-1.5 shadow-lg shadow-emerald-950/60 border border-emerald-400/50 cursor-pointer animate-pulse hover:scale-105",title:`Télécharger l'APK Android compilé de ${x} (${H.sizeMb} Mo)`,children:[e.jsx("span",{children:"📥"}),e.jsx("span",{children:"APK"}),e.jsxs("span",{className:"text-[10px] opacity-90 font-mono",children:["(",H.sizeMb,"M)"]})]}),L.installed!==!1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:A=>{A.stopPropagation(),b(x),I("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:x})}).then(D=>{alert(D?`🔄 Réinstallation des dépendances démarrée pour "${x}" !`:"Mode Cloud SaaS : Bridge local non connecté."),b(null)}).catch(()=>b(null))},className:"bg-orange-500/30 hover:bg-orange-500/60 text-white font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center justify-center border border-orange-500/40 cursor-pointer",title:"Forcer la réinstallation des dépendances (pnpm install)",children:"🔄"}),e.jsx("button",{onClick:async A=>{A.stopPropagation();try{b(x);const D=await I("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:x})});if(b(null),!D){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const W=await D.json();alert(W.message||`🚀 Serveur Vite démarré pour ${x} !`),W.previewUrl&&window.open(W.previewUrl,"_blank")}catch(D){b(null),alert("Erreur de connexion au bridge: "+D.message)}},className:"font-bold py-2 px-3 rounded-xl text-xs bg-purple-500/60 hover:bg-purple-500 text-white transition-all shadow-md cursor-pointer",title:"Lancer le serveur Vite avec pnpm run dev",children:"💻 PNPM"})]}),e.jsx("button",{onClick:q,className:"bg-red-600/30 hover:bg-red-600/60 text-red-200 border border-red-500/40 font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center gap-1",title:"Supprimer définitivement du disque dur",children:"🗑️ Supprimer"})]})]},V)})]})};function Vo({user:t,onLogout:n}={}){var qn;const r=a.useRef({}),l=(s,c=1)=>typeof window>"u"?`linear-gradient(135deg, rgba(17,17,17,${c}), rgba(34,34,34,${c}))`:(r.current[s]||(r.current[s]=Oo(c)),r.current[s]),d=(t==null?void 0:t.email)||(typeof window<"u"?localStorage.getItem("tiger_currentUserEmail"):null),m=!!(t!=null&&t.isSuperAdmin||d&&d.toLowerCase().trim()==="zacktunr@gmail.com");a.useEffect(()=>{t!=null&&t.email&&typeof window<"u"&&localStorage.setItem("tiger_currentUserEmail",t.email)},[t]);const h=()=>{typeof window<"u"&&(localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),localStorage.removeItem("tiger_lastGeneratedProject"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{})),n?n():typeof window<"u"&&window.location.reload()},[p,_]=a.useState([]),[S,b]=a.useState(""),U=a.useRef(null),O=a.useRef(null),[Q,N]=a.useState(!1),[L,V]=a.useState("connexion"),[x,w]=a.useState(!1),[q,y]=a.useState("clean");a.useRef(0);const[G,H]=a.useState(1),[A,D]=a.useState(!1),[W,B]=a.useState(!1),[Z,K]=a.useState(!1);a.useEffect(()=>{let s=0;const c=setInterval(()=>{var o,C;if(typeof window<"u"){const u=(C=(o=window.Capacitor)==null?void 0:o.isNativePlatform)==null?void 0:C.call(o),f=!!window.AndroidBridge;(u||f)&&(B(!0),clearInterval(c))}s++>10&&clearInterval(c)},100);return()=>clearInterval(c)},[]);const[ae,ve]=a.useState([]),[z,ee]=a.useState(""),[de,xe]=a.useState(["> Système Kirov5 initialisé. "+new Date().toLocaleTimeString()]),[Ie,te]=a.useState([]),[j,X]=a.useState([]);a.useEffect(()=>{const s=c=>X(c.detail);return window.addEventListener("update_kirov_packs",s),()=>window.removeEventListener("update_kirov_packs",s)},[]),a.useEffect(()=>{window.KIROV_SELECTED_PACKS=j},[j]);const[re,ue]=a.useState(!1),[fe,Te]=a.useState(!1),[ke,M]=a.useState([]),[ge,Ae]=a.useState(!1),[he,se]=a.useState(""),[Me,nt]=a.useState(""),[Ee,Re]=a.useState(!1),[oe,pt]=a.useState(""),[ze,Dn]=a.useState("Vite + React + Tailwind + TS"),[mt,bn]=a.useState(""),[yt,Et]=a.useState("deepseek"),[He,nn]=a.useState(""),[sn,Mn]=a.useState(!0),[rn,an]=a.useState(!1),[gt,_t]=a.useState(null),[Ze,Ct]=a.useState(!1),[st,$e]=a.useState("idle"),[Rt,Oe]=a.useState([]),[rt,zt]=a.useState(""),[vn,ht]=a.useState(null),[Nt,on]=a.useState([]),wt=a.useCallback(async()=>{try{let s=[];try{const c=await fetch("https://api.github.com/repos/turnzack/v0-reponse/releases");if(c.ok){const o=await c.json();Array.isArray(o)&&o.forEach(C=>{Array.isArray(C.assets)&&C.assets.forEach(u=>{var f;(f=u.name)!=null&&f.endsWith(".apk")&&s.push({file:u.name,name:u.name.replace(".apk",""),sizeMb:(u.size/(1024*1024)).toFixed(1),url:u.browser_download_url})})})}}catch{}try{const c=await I("http://localhost:5006/api/mobile/list-apks");if(c&&c.ok){const o=await c.json();o&&o.success&&Array.isArray(o.apks)&&(s=[...s,...o.apks])}else{const o=await fetch("/api/mobile/list-apks");if(o&&o.ok){const C=await o.json();C&&C.success&&Array.isArray(C.apks)&&(s=[...s,...C.apks])}}}catch{}if(s.length>0){const c=new Set,o=s.filter(C=>c.has(C.file.toLowerCase())?!1:(c.add(C.file.toLowerCase()),!0));on(o)}}catch(s){console.warn("[v0-apk] loadAvailableApks error",s)}},[]);a.useEffect(()=>{Ze&&wt()},[Ze,wt]),a.useEffect(()=>{let s,c=0;return st==="building"&&(s=setInterval(async()=>{try{const o=await I("http://localhost:5006/api/mobile/build-logs");if(o&&o.ok){c=0;const C=await o.json();C.logs&&C.logs.length>0&&Oe(C.logs),C.isBuilding===!1&&C.result&&(C.result.success?($e("success"),ht(C.result.apkUrl)):$e("error"),clearInterval(s))}else c++,c>=3&&(clearInterval(s),$e("error"),Oe(C=>[...C,`❌ Service de compilation mobile absent sur ce serveur (${o?o.status:"erreur réseau"}).`,"📱 Option 1 (Cloud) : Déclenchez le build sans dépendance via GitHub Actions (.github/workflows/build-apk.yml).",`💻 Option 2 (Local) : Lancez 'python apk_builder.py --src ... --name ${rt||E||"app"} --build' dans E:\\v0reponses\\v0-apk.`]))}catch(o){console.warn("Polling APK error",o)}},1500)),()=>{s&&clearInterval(s)}},[st,rt,E]);const[be,xt]=a.useState([]),[ln,Dt]=a.useState(!1),cn=a.useCallback(async s=>{Dt(!0);const c=[{id:"deepseek-r1-v0",tag:"⚡ DEEPSEEK R1",title:"DeepSeek-R1 & Moteur Souverain v0.1",desc:"Capacités de raisonnement avancé et de suture pour interfaces React.",content:`DeepSeek-R1 offre des capacités de raisonnement avancé pour l'analyse de contrats PRD et la génération zéro-touch de projets web complets.
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){xt(c),Dt(!1);return}const o=s||localStorage.getItem("tiger_apiKey");if(!o||!o.startsWith("sk-")||o.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){xt(c),Dt(!1);return}const C=new AbortController,u=setTimeout(()=>C.abort(),4e3),f=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o}`},signal:C.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(u),f.ok){const P=await f.json(),R=JSON.parse(P.choices[0].message.content);R.news&&Array.isArray(R.news)&&R.news.length>0?xt(R.news):xt(c)}else f.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),xt(c)}catch(o){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",o),xt(c)}finally{Dt(!1)}},[]);a.useEffect(()=>{cn()},[cn]);const[It,qe]=a.useState(!1),[Ne,_e]=a.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Ke,ct]=a.useState([]),[Ge,Ht]=a.useState("");a.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let c=JSON.parse(s);if(!Array.isArray(c))throw new Error("Not an array");const o="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";c=c.map(C=>C.name==="fold"?{...C,colors:{...C.colors,"bg-app":o}}:C),ct(c)}catch{ct([])}else{const c={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};ct([c]),localStorage.setItem("tiger_saved_themes",JSON.stringify([c]))}},[]),a.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",Ne),Ne!=="random"){const c=((s=Ke.find(o=>o.name===Ne))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=c,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[Ne,Ke]);const Sn=()=>{if(!Ge.trim())return alert("Nom invalide");if(Ke.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":l("icon-settings",.8),"icon-ai":l("icon-ai",.8),"icon-projects":l("icon-projects",.8),"icon-packs":l("icon-packs",.8),"icon-news":l("icon-news",.8),"bg-app":l("bg-app",.9)},c={name:Ge.trim(),colors:s},o=[...Ke,c];ct(o),localStorage.setItem("tiger_saved_themes",JSON.stringify(o)),_e(c.name),Ht("")},dn=(s,c)=>{c.stopPropagation();const o=Ke.filter(C=>C.name!==s);ct(o),localStorage.setItem("tiger_saved_themes",JSON.stringify(o)),Ne===s&&_e("random")},$t=s=>{X(c=>c.includes(s)?c.filter(o=>o!==s):[...c,s])},[We,Kt]=a.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});a.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(We))},[We]);const[dt,ft]=a.useState(!0),[Ye,At]=a.useState(!0),[E,Pe]=a.useState(null),[Mt,Wt]=a.useState(null),[De,Jt]=a.useState(null),[pe,Je]=a.useState(null),[qt,it]=a.useState(""),[bt,Pt]=a.useState([]);a.useEffect(()=>{I("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))te(s.projects.map(c=>({name:typeof c=="string"?c:c.project_id||c.title||c.name||"Projet",desc:"Projet local",bg:""})));else{const c=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:c?{Authorization:`Bearer ${c}`}:{}}).then(o=>o?o.json():null).then(o=>{o&&o.projects&&te(o.projects.map(C=>({name:typeof C=="string"?C:C.project_id||C.title||C.name||"Projet",desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[at,Se]=a.useState(null),[Xt,jt]=a.useState(""),[kt,i]=a.useState(!1),[g,v]=a.useState(!1),T=a.useRef(null);a.useEffect(()=>{if(T.current=null,E==="v0-guest"||E==="V0-Guest")v(!0),Se("http://localhost:3007"),jt("http://localhost:3007"),T.current="http://localhost:3007";else if(E){v(!0);const s=De&&JSON.stringify(De).includes("next.config"),c=typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1",o=s?"http://localhost:3000":T.current||(c?`http://${window.location.hostname}:5173`:"http://localhost:5173");Se(o),jt(o),T.current=o}else v(!1),Se(null)},[E,De]),a.useEffect(()=>{const s=c=>{var o,C,u,f;if(((o=c.data)==null?void 0:o.type)==="CHANGE_PREVIEW_URL"){const P=c.data.route,R=P==="/"?"":`#${P}`;Se(Y=>{const $=Y?Y.split("#")[0]:"http://127.0.0.1:5175/";return`${$.endsWith("/")?$:`${$}/`}${R}`})}if(((C=c.data)==null?void 0:C.type)==="DESIGN_ELEMENT_CLICKED"||((u=c.data)==null?void 0:u.type)==="DESIGN_ELEMENT_DRAGGED"||((f=c.data)==null?void 0:f.type)==="DESIGN_ELEMENT_RESIZED"){const P=document.querySelector('iframe[title="Studio Admin Design"]');P&&P.contentWindow&&P.contentWindow.postMessage(c.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),a.useEffect(()=>{E&&I(`http://localhost:5006/api/fs/tree?project=${E}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&Jt(s.tree)}).catch(()=>{})},[E]),a.useEffect(()=>{E&&pe&&I(`http://localhost:5006/api/fs/read?project=${E}&file=${encodeURIComponent(pe)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&it(s.content)}).catch(()=>{})},[E,pe]);const ne=async s=>{if(s===void 0||!E||!pe)return;if(it(s),Bt.isNativePlatform()||!!window.AndroidBridge)try{await $n.writeFile({path:`v0-moteur-mobile/projetv0/${E}/${pe}`,data:s,directory:xn.Documents,encoding:Pn.UTF8,recursive:!0})}catch(o){console.error("Erreur de sauvegarde mobile:",o)}else I("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:E,file:pe,content:s})}).catch(()=>{})},k=s=>{E&&I(`http://localhost:5006/api/fs/read?project=${E}&file=${encodeURIComponent(s)}`).then(c=>c?c.json():null).then(c=>{c&&c.success&&Pt(o=>o.find(C=>C.path===s)?o:[...o,{path:s,content:c.content}])}).catch(()=>{})};a.useEffect(()=>{(async()=>{const c=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(Bt.isNativePlatform()||!!window.AndroidBridge)try{const u=(await $n.readdir({path:"v0-moteur-mobile/projetv0",directory:xn.Documents})).files.map(f=>f.name||f.toString());te(u.map((f,P)=>({name:f,desc:"Mémoire Téléphone",bg:c[P%c.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else I("http://localhost:5006/api/projects-v2").then(C=>C?C.json():null).then(C=>{if(C&&C.success&&C.projects)te(C.projects.map((u,f)=>({name:typeof u=="string"?u:u.name||u.project_id||u.title||`Projet_${f}`,desc:"Environnement Local",bg:c[f%c.length],installed:u.installed})));else{const u=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:u?{Authorization:`Bearer ${u}`}:{}}).then(f=>f?f.json():null).then(f=>{f&&f.projects&&te(f.projects.map((P,R)=>({name:typeof P=="string"?P:P.project_id||P.title||P.name||`Projet_${R}`,desc:"SaaS Cloud (Neon DB)",bg:c[R%c.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),a.useEffect(()=>{D(!0)},[]);const[me,Ce]=a.useState(!0);a.useEffect(()=>{const s=()=>Ce(!0);window.addEventListener("open-mouchard",s);const c=o=>{if(o.data&&o.data.type==="TIGER_CAPTURE"){const C=o.data.data;if(C){let u="index.html";(C.includes("import React")||C.includes("export default"))&&(u="App.tsx"),C.includes("tailwindcss")&&(u="index.css"),Je(u),ne(C),Jt(f=>{var Y;const P={name:u,path:u,type:"file"};return f?((Y=f.children)==null?void 0:Y.find($=>$.name===u))?f:{...f,children:[...f.children||[],P]}:{name:"Mobile_Storage",type:"directory",children:[P]}})}}};return window.addEventListener("message",c),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("message",c)}},[E,pe]),a.useEffect(()=>{if(!A)return;const s=()=>{I("http://localhost:5006/api/bridge/queue").then(o=>o?o.json():null).then(o=>{o&&o.success&&(setBridgeQueueData({current:o.current||{},queue:o.queue||[]}),(o.queue&&o.queue.length>0||o.current&&Object.keys(o.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),I("http://localhost:5006/api/bridge/logs").then(o=>o?o.json():null).then(o=>{var C,u;if(o&&o.success&&o.logs){xe(o.logs);const f=[...o.logs].reverse().find(R=>R.includes("URL_PREVIEW="));if(f){let R=(C=f.split("URL_PREVIEW=")[1])==null?void 0:C.trim();R&&typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"&&(R=R.replace(/localhost|127\.0\.0\.1/,window.location.hostname)),R&&R!==T.current&&(T.current=R,Se(R),jt(R),v(!0))}const P=[...o.logs].reverse().find(R=>R.includes("PIPELINE COMPLET TERMINÉ avec succès pour "));if(P){const R=(u=P.split("PIPELINE COMPLET TERMINÉ avec succès pour ")[1])==null?void 0:u.replace(/[.\s]+$/,"");R&&E!==R&&(Pe(R),v(!0))}}}).catch(()=>{}),I("http://localhost:5006/api/bridge/autonomous-status").then(o=>o?o.json():null).then(o=>{if(o&&o.success&&(o.data||o.status)){const u=(o.data||o.status).state;u==="diagnosing"||u==="repair_required"||u==="error"?y("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(u)||["starting_server","launch_requested","restarting"].includes(u)?y("working"):u==="ready"?y("clean"):E&&I(`http://localhost:5006/api/suture/status?project=${E}`).then(f=>f?f.json():null).then(f=>{f&&f.success&&f.status&&y(f.status)}).catch(()=>{})}}).catch(()=>{})};s();const c=setInterval(s,2e3);return()=>clearInterval(c)},[A,E]);const Fe=s=>{const c=typeof s=="string"?s:S;if(!c.trim())return;const o={id:Date.now().toString(),role:"user",content:c};_(u=>[...u,o]);const C=c.toLowerCase();setTimeout(()=>{let u={id:(Date.now()+1).toString(),role:"assistant",content:""};const f=C.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(f==="mes projets"||f.includes("liste des projet")||f==="projet"||f==="projets")u.content="Voici la liste de vos projets récents :",u.widget="projects";else if((f.includes("stitch")||f.includes("deepseek")||f.includes("design")||f.includes("logique"))&&(f.includes("modifi")||f.includes("ajoute")||f.includes("change")||f.includes("mise a jour")||f.includes("evolue")||f.includes("reprends")||f.includes("continue"))){const P=c.match(/\[(.*?)\]/),R=P?P[1]:null,Y=f.includes("deepseek")?"deepseek":"stitch";u.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${Y.toUpperCase()}) 🔄

J'injecte vos nouvelles directives directement dans votre interface... ${R?`
🔍 Recherche et AutoSwitch vers le projet : "${R}"`:"Reprise du travail en cours."}`,u.widget=null,I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Y,target_project:R,prompt:"Mise à jour (Reprise de projet) : "+c.replace(/\[.*?\]/,"").trim(),auto_submit:!0})}).catch($=>console.log("Erreur de connexion au Bridge local pour l'injection",$))}else if(f.includes("cree")||f.includes("lance")||f.includes("projet")||f.includes("generation")){u.content=`🚀 DÉMARRAGE PARALLÈLE KIROV5 🚀
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,u.widget="phases",H(1);const P=E||(oe.trim()?oe.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+c.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(Pe(P),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",P),typeof window<"u"){const $=localStorage.getItem("tiger_targetAi")||"deepseek",J=localStorage.getItem("tiger_targetUiAi")||"stitch",Le=(F,ce=!1)=>lt(F,ce),Ve=window.AndroidBridge;if(Ve&&Ve.openAIWithPrompt)Ve.openAIWithPrompt(Le(J,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+c),Ve.showToast&&Ve.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const F=j&&j.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${j.length})]
`+j.map(we=>{const ie=Gt.find(ye=>ye.id===we);return`• ${ie?ie.name:we} (#${we})`}).join(`
`):"",ce="Génère l'interface UI/UX complète et moderne pour ce projet : "+c+F;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ce)}catch{}const tt=()=>I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,prompt:ce,auto_submit:!0,project_id:P,phase_num:1,packs:j})});We!==200&&(Ye?window.open(Le(J,!0),"kirov5_ai_target"):window.open(Le(J,!0),"_blank"),tt().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(we=>console.error("Erreur sendUiPrompt",we))),setTimeout(()=>{const we=j&&j.length>0?c+F:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+c+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(we)}catch{}window.open(Le($),"_blank"),I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:$,prompt:we,auto_submit:!0,project_id:P,phase_num:1,packs:j})}).catch(ie=>console.log("Erreur Bridge Logic Prompt:",ie)),j&&j.length>0?I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:$,user_prompt:we,packs:j,target_project:P})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(ie=>{console.log("Erreur Trombone Bridge:",ie)}):I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:$,prompt:we,auto_submit:!0,project_id:P,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}H(1);let R=1;const Y=setInterval(()=>{R++,R>11?clearInterval(Y):H(R)},1500)}else if(f.includes("youtube")||f.includes("video"))u.content="Voici les résultats YouTube pour votre recherche :",u.widget="youtube";else if(f.includes("actualite")||f.includes("ia")||f.includes("news")||f.includes("recherche")){const P=localStorage.getItem("tiger_apiKey");u.content="Actualités & Dernières Innovations IA :",u.widget="news",cn(P||void 0)}else if(f.includes("parametre")||f.includes("reglage")||f.includes("configuration")||f.includes("setting"))u.content="Ouverture du panneau de configuration système :",u.widget="settings";else if(f.includes("[plugin:vite:")||f.includes("missing semicolon")||f.includes("syntaxerror")||f.includes("typescriptparsermixin")||f.includes("babel/parser")||f.includes("error")&&f.length>80){const P=E||"Projet_blog_8831";u.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${P}" avec la stack trace fournie... 🩺`,je("suture",c)}else if(u.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const P=window.AndroidBridge;P&&P.openAIWithPrompt?P.openAIWithPrompt("https://chat.deepseek.com/",c):window.open("https://chat.deepseek.com/","_blank")}_(P=>[...P,u])},600),b("")},Xe=async s=>{var Ve;let c=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],o=null;const C=c.filter(F=>F.name.endsWith(".zip"));let u=[];if(C.length>0){_(F=>[...F,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const F=(await Yt(async()=>{const{default:ce}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:ce}},[])).default;for(const ce of C){o=ce;const we=await new F().loadAsync(ce);for(const[ie,ye]of Object.entries(we.files))if(!ye.dir&&!ie.includes("__MACOSX")&&!((Ve=ie.split("/").pop())!=null&&Ve.startsWith("."))){const Ue=await ye.async("blob"),ot=new File([Ue],ie.split("/").pop()||ie,{type:Ue.type});u.push(ot)}}}catch(F){console.error("Erreur décompression ZIP:",F),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}for(const F of C)try{const ce=await F.arrayBuffer(),tt=arrayBufferToBase64(ce);fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:E||z||oe||"AUDIO",fileName:F.name,fileBase64:tt})}).catch(ie=>console.warn("[Upload ZIP Sync] Notice:",ie))}catch{}}c=[...c.filter(F=>!F.name.endsWith(".zip")),...u];const f=c.filter(F=>F.name.endsWith(".html")),P=c.filter(F=>!F.name.endsWith(".html")&&(F.name.endsWith(".png")||F.name.endsWith(".jpg")||F.name.endsWith(".jpeg")||F.name.endsWith(".md")||F.name.endsWith(".json")||F.name.endsWith(".txt")||F.name.endsWith(".tsx")||F.name.endsWith(".ts")||F.name.endsWith(".jsx")||F.name.endsWith(".js")||F.name.endsWith(".css")||F.name.endsWith(".svg")));if(f.length===0&&P.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .tsx, .ts, .png, ou un .zip.");return}let R=[...bt];for(const F of P){const ce=F.name.endsWith(".png")||F.name.endsWith(".jpg")||F.name.endsWith(".jpeg"),tt=await new Promise(ie=>{const ye=new FileReader;ye.onload=Ue=>{var ot;return ie((ot=Ue.target)==null?void 0:ot.result)},ce?ye.readAsDataURL(F):ye.readAsText(F)}),we={path:F.name,content:ce?`[Image jointe visuellement : ${F.name} (Binaire ignoré pour économie de tokens)]`:tt};R.some(ie=>ie.path===F.name)||R.push(we),_(ie=>[...ie,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${F.name}`}])}if(f.length>0){const F=f[0],ce=await new Promise(ie=>{const ye=new FileReader;ye.onload=Ue=>{var ot;return ie((ot=Ue.target)==null?void 0:ot.result)},ye.readAsText(F)}),tt={path:F.name,content:ce};R.some(ie=>ie.path===F.name)||R.push(tt);const we={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${F.name}
Analyse de la structure UI et assemblage du contexte en cours...`};_(ie=>[...ie,we])}const Y=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter(F=>F.name.endsWith(".zip"));for(const F of Y)R.some(ce=>ce.path===F.name)||R.push({path:F.name,content:"ZIP_ARCHIVE_DUMMY"});Pt(R);const $=E||oe||"Projet_Stitch",J=c.map(F=>F.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${$}: ${J}`);const Le=f.length;if(Le>3){const F=localStorage.getItem("tiger_targetAi")||"deepseek",ce=o?"Projet_ZIP_"+o.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),tt=E||ce;E||Pe(tt),_(ie=>[...ie,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !

Hermes a détecté ${Le} pages HTML dans votre ZIP.
Découpage automatique en lots de 3 fichiers en cours...
Démarrage de l'automatisation séquentielle via DeepSeek !`,widget:"phases"}]),H(1);let we="";if(o)we=await new Promise(ie=>{const ye=new FileReader;ye.onload=Ue=>{var ot;return ie(((ot=Ue.target)==null?void 0:ot.result).split(",")[1])},ye.readAsDataURL(o)});else{const ie=(await Yt(async()=>{const{default:Ue}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:Ue}},[])).default,ye=new ie;for(const Ue of c)ye.file(Ue.name,Ue);we=await ye.generateAsync({type:"base64"})}I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({zip_base64:we,zip_mode:!0,target_ai:F,target_project:tt,user_prompt:oe.trim()?`${oe} - ${mt}`:`Application multi-pages issue de ${(o==null?void 0:o.name)||"fichiers_locaux"}`})}).then(async ie=>{const ye=await ie.json();ye.success?(_(Ue=>[...Ue,{id:Date.now().toString()+"_hermes",role:"assistant",content:`✅ ${ye.message}

📡 Lot 1/${ye.total_batches} transmis à DeepSeek. Les lots suivants s'enchaîneront automatiquement !
Fichiers détectés : ${(ye.files_detected||[]).join(", ")}`}]),window.open(lt(F),"_blank")):alert("Erreur Hermes : "+(ye.error||"Inconnue"))}).catch(ie=>{alert(`Erreur de connexion au Moteur Local : ${ie.message}`)});return}if(f.length>0){if(document.getElementById("creation-mode-container"))return;setTimeout(()=>{et(R)},1200)}},et=async(s=bt)=>{Re(!1);const c=s.find($=>$.path.endsWith(".html"));if(!c){alert("Aucun fichier HTML trouvé dans le Trombone !");return}const o=oe.trim()?"Projet_"+oe.replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4):"Design_"+c.path.replace(".html","").replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4),C=E||o;if(!E){Pe(C);try{await I("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:C,file:"README.md",content:`# ${oe||C}

Initialisé par Tiger IA V0 (Design-First).`})})}catch($){console.error("[IDE] Erreur création auto du dossier",$)}}const u=s.filter($=>$.path!==c.path),f=c.content,P={id:(Date.now()+1).toString(),role:"assistant",content:`Mode "Design-First" activé. 🎨

Transmission du design au LLM avec les ${u.length} fichiers du Trombone intégrés.
Câblage en cours...`,widget:"phases"};H(5),_($=>[...$,P]);let R=5;const Y=setInterval(()=>{R++,R>11?clearInterval(Y):H(R)},3e3);if(typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Mode Design-First Activé !"),typeof window<"u"){const $=localStorage.getItem("tiger_targetAi")||"deepseek";let J="";u.length>0&&(J=`

--- Fichiers de contexte complémentaires (Trombone) ---
`,u.forEach(ce=>{J+=`
[Fichier: ${ce.path}]
\`\`\`
${ce.content.substring(0,3e3)}
\`\`\`
`}));let Le="";(oe.trim()||ze.trim()||mt.trim())&&(Le=`
--- MÉTADONNÉES DU PROJET ---
Nom : ${oe||"Non spécifié"}
Stack / Structure : ${ze||"Non spécifiée"}
Description & Objectifs : ${mt||"Non spécifiés"}
-----------------------------
`);const Ve=`Voici le code HTML/CSS d'une interface générée par Stitch.${Le}
...
\`\`\`
`,F=window.AndroidBridge;if(F&&F.openAIWithPrompt){const ce=lt($);F.openAIWithPrompt(ce,Ve),F.showToast&&F.showToast("HTML injecté. Câblage sur "+$.toUpperCase()+" !")}else I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:$,prompt:Ve,auto_submit:!0,project_id:C,phase_num:5})}).then(ce=>console.log("[Bridge] Prompt HTML + Contexte envoyé avec succès, status:",ce.status)).catch(ce=>console.error("[Bridge] Erreur lors de l'envoi du prompt:",ce))}},ut=(s,c=0)=>s?s.type==="directory"?e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-2 px-2 py-1 hover:bg-white/5 cursor-pointer text-gray-300 text-sm",style:{paddingLeft:`${c*12+8}px`},children:[e.jsx("span",{className:"text-orange-400",children:"📁"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-dossier truncate font-bold",children:s.name})]}),s.children&&s.children.map(o=>ut(o,c+1))]},s.path):e.jsxs("div",{className:`flex items-center justify-between px-2 py-1 hover:bg-white/10 cursor-pointer text-sm group ${pe===s.path?"bg-cyan/20 text-cyan border-l-2 border-cyan":"text-gray-400"}`,style:{paddingLeft:`${c*12+8}px`},onClick:()=>Je(s.path),children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-blue-400",children:"📄"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-fichier truncate",children:s.name})]}),e.jsxs("div",{className:"hidden group-hover:flex items-center gap-1",children:[e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-red-500/50 transition-colors",title:"Suture : Réparer ou débugger ce fichier",onClick:o=>{o.stopPropagation(),Je(s.path),setTimeout(()=>je("suture","Veuillez analyser ce fichier et corriger toutes les erreurs, fautes de frappe ou imports manquants."),100)},children:"🩺"}),e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-cyan/50 transition-colors",title:"Ajouter au Trombone",onClick:o=>{o.stopPropagation(),k(s.path)},children:"📎"})]})]},s.path):null,je=async(s,c)=>{if(!E){alert("⚠️ Veuillez sélectionner un projet actif dans l'explorateur.");return}const o=localStorage.getItem("tiger_targetAi")||"deepseek";let C="";s==="suture"?C=`🩺 SUTURE CHIRURGICALE — CORRECTION D'ERREUR DÉTECTÉE

Projet Actif : [${E}]
`+(c?`🚨 DÉTAILS DE L'ERREUR RENCONTRÉE :
\`\`\`
${c}
\`\`\`
...
`):s==="refactor"?C=`🔄 REFACTORING — Refactorise le code du projet [${E}] pour une qualité industrielle.

`:s==="improve"&&(C=`✨ AMÉLIORATION — Ajoute des animations et améliorations UI pour le projet [${E}].

`),pe&&qt&&(C+=`--- Fichier Actif en Édition : ${pe} ---
\`\`\`
${qt}
\`\`\`

`),bt.length>0&&(C+=`--- Fichiers de contexte du Trombone ---

`,bt.forEach(u=>{C+=`--- ${u.path} ---
\`\`\`
${u.content}
\`\`\`
...
{
  "files": [
    { "path": "${pe||"src/App.tsx"}", "content": "..." }
  ]
}
\`\`\``,_(u=>[...u,{id:Date.now().toString()+"_action",role:"assistant",content:`🩺 Suture & Correction déclenchée pour "${E}". Transmission de l'erreur à ${o.toUpperCase()} en cours...`}]);try{if(await I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:o,prompt:C,auto_submit:!0,project_id:E,phase_num:s})}),s==="suture"){I("http://localhost:5006/v1/suture/start",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:E,activeFile:pe||"",rawError:c||"",prompt:c||"Analyse et corrige les erreurs du projet."})}).then(async f=>{const P=await f.json();P.success&&P.status==="applied"?_(R=>{var Y,$;return[...R,{id:Date.now().toString()+"_suture_ok",role:"assistant",content:`✅ Suture V2 réussie !

🔧 ${P.repairId}
🚀 Statut : **Patch appliqué en production**
📁 Fichiers corrigés : ${JSON.stringify((($=(Y=P.patchReport)==null?void 0:Y.files)==null?void 0:$.map(J=>J.path))||[])}`}]}):P.success?_(R=>{var Y;return[...R,{id:Date.now().toString()+"_suture_partial",role:"assistant",content:`⚠️ Suture V2 : correctif généré mais non promu.
Statut : ${((Y=P.validationReport)==null?void 0:Y.code)||P.status}

Le correctif est dans l'espace isolé. Vérifiez les logs du moteur pour plus de détails.`}]}):_(R=>[...R,{id:Date.now().toString()+"_suture_fail",role:"assistant",content:`❌ Suture V2 échouée.
Code : ${P.code||"INCONNU"}
${P.message||""}`}])}).catch(()=>{_(f=>[...f,{id:Date.now().toString()+"_suture_err",role:"assistant",content:"❌ Impossible de joindre le moteur Suture V2. Vérifiez que l'Orchestrateur Electron tourne sur le port 5006."}])});return}window.open(lt(o),"kirov5_ai_target")||_(f=>[...f,{id:Date.now().toString()+"_popup_blocked",role:"assistant",content:`⚠️ Popup bloqué par le navigateur !

L'onglet ${o.toUpperCase()} n'a pas pu s'ouvrir.

**Solution** : Autorisez les popups pour ce site ou ouvrez manuellement : ${lt(o)}

Le prompt est en queue (90s) — dès que l'onglet ${o.toUpperCase()} sera ouvert avec l'extension active, il sera injecté automatiquement.`}])}catch(u){console.error("[IDE] Erreur Suture:",u),alert(`🩺 Action ${s} transmise. Assurez-vous que le Moteur Electron tourne sur port 5006.`)}},vt=()=>ln?e.jsxs("div",{className:"w-full p-8 flex flex-col items-center justify-center gap-4 animate-fadeIn",children:[e.jsx("div",{className:"w-12 h-12 border-4 border-cyan/20 border-t-cyan rounded-full animate-spin"}),e.jsx("div",{className:"text-cyan font-bold animate-pulse text-sm",children:"Interrogation de l'API DeepSeek en cours..."})]}):gt?e.jsxs("div",{className:"w-full max-w-3xl backdrop-blur-xl rounded-3xl p-6 md:p-8 border border-white/20 shadow-[0_10px_40px_rgba(0,0,0,0.5)] mt-4 relative animate-fadeIn",style:{background:A?l("news-detail",.9):"rgba(0,0,0,0.9)"},children:[e.jsx("button",{onClick:()=>_t(null),className:"absolute top-6 right-6 w-8 h-8 bg-white/10 hover:bg-red-500 rounded-full flex flex-col items-center justify-center text-white font-bold transition-colors z-20",title:"Fermer",children:"✕"}),e.jsx("span",{className:"px-3 py-1 bg-cyan/20 text-cyan text-xs font-bold rounded-md mb-4 inline-block",children:gt.tag}),e.jsx("h2",{className:"text-2xl md:text-4xl font-black text-white mb-4 leading-tight",children:gt.title}),e.jsx("p",{className:"text-gray-300 font-medium text-sm md:text-base mb-6 leading-relaxed border-l-4 border-cyan/50 pl-4",children:gt.desc}),e.jsx("div",{className:"w-full h-px bg-white/10 mb-6"}),e.jsx("div",{className:"text-gray-200 text-sm md:text-base leading-loose whitespace-pre-line",children:gt.content}),e.jsxs("div",{className:"mt-8 pt-6 border-t border-white/10 flex justify-between items-center",children:[e.jsx("span",{className:"text-xs text-cyan font-mono font-bold tracking-widest",children:"GÉNÉRÉ PAR DEEPSEEK API"}),e.jsx("button",{onClick:()=>_t(null),className:"px-6 py-3 bg-white/5 hover:bg-white/20 text-white font-bold rounded-xl transition-all border border-white/10 hover:border-cyan",children:"← Retour à la liste"})]})]}):!be||be.length===0?null:e.jsx(Ft,{items:be.map(s=>e.jsxs("div",{className:"design-carte-carrousel relative rounded-2xl p-5 border border-white/10 backdrop-blur-md flex flex-col hover:border-cyan/50 transition-colors shadow-lg",style:{background:A?l("news-"+s.id,.7):"rgba(0,0,0,0.7)"},children:[e.jsx("span",{className:"self-start px-2 py-1 bg-cyan/20 text-cyan text-xs font-bold rounded-md mb-3 pr-4",children:s.tag}),e.jsx("h3",{className:"design-carte-titre text-lg font-bold text-white mb-2 leading-tight mt-1",children:s.title}),e.jsx("p",{className:"design-carte-desc text-gray-400 text-sm flex-1",children:s.desc}),e.jsxs("button",{onClick:()=>_t(s),className:"absolute top-4 right-4 text-cyan text-xs font-bold hover:underline cursor-pointer px-3 py-1.5 bg-cyan/10 hover:bg-cyan/20 rounded-xl border border-cyan/30 transition-all flex items-center gap-1",children:["Lire l'article ",e.jsx("span",{className:"text-[10px]",children:"↗"})]})]},s.id))}),Qe=()=>{const s=[{title:"Créer une IA Souveraine",channel:"Tiger Channel",views:"1.2k"},{title:"React Tailwind Masterclass",channel:"UI Design",views:"5.4k"},{title:"Android Bridge Capacitor",channel:"Mobile Dev",views:"800"}];return e.jsx(Ft,{items:s.map((c,o)=>e.jsxs("div",{className:"design-carte-carrousel rounded-2xl overflow-hidden border border-red-500/30 hover:border-red-500 transition-colors shadow-lg flex flex-col",style:{background:A?l("yt-"+o,.6):"rgba(0,0,0,0.6)"},children:[e.jsxs("div",{className:"flex-1 bg-gray-800 relative flex items-center justify-center min-h-[50%]",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-tr from-red-900/40 to-transparent"}),e.jsx("div",{className:"w-12 h-12 bg-red-600 rounded-full flex items-center justify-center shadow-lg z-10 cursor-pointer hover:scale-110 transition-transform",children:e.jsx("div",{className:"w-0 h-0 border-t-[8px] border-t-transparent border-l-[14px] border-l-white border-b-[8px] border-b-transparent ml-1"})})]}),e.jsxs("div",{className:"p-4",children:[e.jsx("h3",{className:"text-white font-bold text-sm leading-tight mb-1",children:c.title}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-400 mt-2",children:[e.jsx("span",{children:c.channel}),e.jsxs("span",{children:[c.views," vues"]})]})]})]},o))})},Lt=()=>{const s=["Setup","Index","React","CSS","Utils","Vite","Tests","Package","Vérif","Bridge","Build"];return e.jsx("div",{className:"mt-2",children:e.jsx(Ft,{items:s.map((c,o)=>{const C=o+1,u=C<G,f=C===G;let P="bg-glass border-white/10 opacity-50";return u&&(P="bg-gradient-to-br from-green-900/60 to-emerald-900/60 border-green-500/50 text-green-100 shadow-[0_0_15px_rgba(34,197,94,0.2)]"),f&&(P="bg-gradient-to-br from-cyan/20 to-blue-900/40 border-cyan text-white shadow-[0_0_20px_rgba(8,179,201,0.5)] animate-pulse hover:scale-105 cursor-pointer"),e.jsxs("div",{onClick:()=>{if(c==="Build"||f||u){const R=localStorage.getItem("tiger_lastGeneratedProject");R&&Pe(R)}},className:`design-carte-carrousel rounded-2xl p-4 border flex flex-col justify-between transition-all duration-500 ${P}`,title:c==="Build"?"Cliquez pour ouvrir l'IDE sur le projet généré":"",children:[e.jsx("div",{className:"text-3xl font-black opacity-20",children:C.toString().padStart(2,"0")}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-bold text-lg mb-1",children:c}),e.jsx("div",{className:"text-xs opacity-70",children:u?"✓ Terminé":f?"En cours...":"En attente"})]}),f&&e.jsx("div",{className:"w-full h-1 bg-white/20 rounded-full mt-2 overflow-hidden",children:e.jsx("div",{className:"h-full bg-cyan w-1/2 animate-ping rounded-full"})}),c==="Build"&&e.jsxs("div",{className:"mt-2 text-[10px] text-cyan font-bold uppercase tracking-widest flex items-center gap-1 bg-black/40 px-2 py-1 rounded",children:[e.jsx("span",{children:"🚀"})," Ouvrir IDE"]})]},o)})})})},xs=Ne!=="random"?((qn=Ke.find(s=>s.name===Ne))==null?void 0:qn.colors["bg-app"])||"radial-gradient(ellipse at 50% 20%, #1e1b4b 0%, #090a0f 70%, #000000 100%)":void 0;return e.jsxs("div",{className:"design-app-root flex-1 w-full h-full flex flex-col overflow-hidden relative transition-all duration-700",style:{background:xs},children:[e.jsx("div",{className:"absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-pink/20 blur-[120px] rounded-full pointer-events-none"}),e.jsx("div",{className:"absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-cyan/10 blur-[150px] rounded-full pointer-events-none"}),Q&&e.jsx("div",{className:"absolute inset-0 z-[100] flex items-center justify-center p-4 backdrop-blur-md",style:{background:A?l("modal",.6):"rgba(0,0,0,0.6)"},onClick:s=>{s.target===s.currentTarget&&N(!1)},children:e.jsx(Jn,{isModal:!0,onClose:()=>N(!1),initialTab:L,isClient:A,getCachedGradient:l,mouchardLogs:de,activePhase:G,availableProjects:ae,setAvailableProjects:ve,selectedLaunchProject:z,setSelectedLaunchProject:ee,isMobileNative:W,isAutoPilot:dt,setIsAutoPilot:ft,reuseActiveTab:Ye,setReuseActiveTab:At,selectedStartPhase:We,setSelectedStartPhase:Kt,selectedPacks:j})}),!g&&e.jsx("div",{className:"w-full flex justify-center items-center pt-2 z-20 relative pointer-events-none",children:e.jsxs("div",{className:"flex items-center gap-2 overflow-x-auto hide-scrollbar text-[10px] font-bold bg-[#05080c]/80 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/10 shadow-lg pointer-events-auto",children:[e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-green-900/40 px-2.5 py-1 rounded-full border border-green-500/30",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-green-500 shadow-[0_0_8px_#22c55e]"}),e.jsx("span",{className:"text-green-400",children:"Online"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-orange-900/40 px-2.5 py-1 rounded-full border border-orange-500/30",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-orange-500 shadow-[0_0_8px_#f97316] animate-bounce"}),e.jsx("span",{className:"text-orange-400",children:"Ext: Tiger"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-purple-900/40 px-2.5 py-1 rounded-full border border-purple-500/30",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-purple-500 shadow-[0_0_8px_#a855f7]"}),e.jsx("span",{className:"text-purple-400",children:"LLM: DeepSeek"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-cyan/10 px-2.5 py-1 rounded-full border border-cyan/20",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-cyan shadow-[0_0_8px_#08b3c9] animate-pulse"}),e.jsx("span",{className:"text-cyan",children:"Electron"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-gray-500/10 px-2.5 py-1 rounded-full border border-gray-500/20 opacity-60",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-gray-500"}),e.jsx("span",{className:"text-gray-400",children:"Mobile (Capacitor)"})]}),m&&e.jsxs("div",{className:"flex items-center gap-1.5 shrink-0 bg-amber-500/20 px-2.5 py-1 rounded-full border border-amber-500/40 shadow-[0_0_12px_rgba(245,158,11,0.35)] animate-pulse",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-amber-400 shadow-[0_0_8px_#f59e0b]"}),e.jsx("span",{className:"text-amber-300 font-bold",children:"👑 Super-Admin"})]}),e.jsxs("button",{onClick:h,className:"flex items-center gap-1.5 shrink-0 bg-red-950/60 hover:bg-red-600/70 px-3 py-1 rounded-full border border-red-500/40 text-red-300 hover:text-white transition-all cursor-pointer shadow-[0_0_10px_rgba(239,68,68,0.25)] hover:scale-105 active:scale-95 ml-1",title:"Se déconnecter de l'application",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-red-500 shadow-[0_0_6px_#ef4444]"}),e.jsx("span",{children:"Déconnexion"}),d&&e.jsxs("span",{className:"text-gray-300 font-normal text-[9px] max-w-[130px] truncate ml-0.5",children:["(",d,")"]})]})]})}),!g&&e.jsxs("header",{className:"design-header backdrop-blur-md z-10 flex justify-between items-center shadow-lg -mt-2 px-4",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"design-logo flex items-center justify-center",children:e.jsx("span",{children:"🐯"})}),e.jsx("div",{children:e.jsx("h1",{className:"design-titre whitespace-nowrap",children:"v0.reponse : OS Souverain v0.1.0 - idecode-2026"})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[d&&e.jsxs("div",{className:"flex items-center gap-2 bg-white/5 border border-white/10 px-3 py-1.5 rounded-xl text-xs backdrop-blur-sm shadow-inner",children:[e.jsxs("span",{className:"text-gray-300 font-medium",children:["👤 ",d]}),m&&e.jsx("span",{className:"bg-amber-500/20 text-amber-300 border border-amber-500/40 px-2 py-0.5 rounded-full font-bold text-[10px] tracking-wide animate-pulse",children:"👑 Super-Admin"})]}),e.jsxs("button",{onClick:h,className:"flex items-center gap-1.5 bg-red-500/20 hover:bg-red-500/40 text-red-300 border border-red-500/40 px-3 py-1.5 rounded-xl text-xs font-semibold transition-all hover:scale-105 active:scale-95 shadow-sm cursor-pointer",title:"Se déconnecter de l'application",children:[e.jsx("span",{children:"🚪"}),e.jsx("span",{children:"Déconnexion"})]})]})]}),e.jsxs("div",{className:"flex-1 flex flex-col lg:flex-row overflow-hidden relative z-10 w-full",children:[E&&e.jsxs("div",{className:"flex flex-col lg:flex-row flex-1 overflow-hidden h-full animate-fadeIn",children:[e.jsxs("div",{className:"design-ide-toolbar w-full h-16 lg:w-16 lg:h-full bg-black/80 border-b lg:border-b-0 lg:border-r border-white/10 flex flex-row lg:flex-col items-center justify-around lg:justify-start lg:py-4 px-2 lg:px-0 gap-2 lg:gap-6 z-20 shadow-xl overflow-x-auto lg:overflow-x-visible",children:[e.jsx("button",{title:"Fermer le projet",onClick:()=>{Pe(null),Je(null)},className:"design-ide-btn-action w-10 h-10 rounded-full bg-red-500/20 text-red-500 hover:bg-red-500 hover:text-white flex items-center justify-center transition-all mb-4",children:"✕"}),e.jsxs("button",{title:q==="error"?"🔴 Erreur détectée dans le code ! Suture V2 en cours...":q==="working"?"🟣 Suture V2 en plein travail (génération & test du correctif)...":"🟢 Projet propre - Aucune erreur détectée",onClick:()=>je("suture"),className:`design-ide-btn-action w-10 h-10 rounded-xl text-xl border flex items-center justify-center transition-all group relative ${q==="error"?"bg-red-600 text-white border-2 border-red-400 shadow-[0_0_25px_#ff0055] animate-pulse ring-2 ring-red-500":q==="working"?"bg-purple-600 text-white border-2 border-purple-300 shadow-[0_0_25px_#a855f7] animate-pulse ring-2 ring-purple-500":"bg-emerald-600/30 text-emerald-400 border border-emerald-500/50 shadow-[0_0_12px_rgba(16,185,129,0.4)] hover:bg-emerald-500 hover:border-emerald-400 hover:text-white"}`,children:["🩺",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-white pointer-events-none transition-opacity font-bold",children:q==="error"?"🔴 Suture (Erreur !)":q==="working"?"🟣 Suture V2...":"🟢 Suture V2 (OK)"})]}),e.jsxs("button",{title:"Immortaliser le projet (Sauvegarde)",onClick:()=>{E&&I("http://localhost:5006/api/bridge/backup",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:E})}).then(s=>s?s.json():null).then(s=>{if(!s)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");s.success?alert("📸 "+s.message+`
`+s.backupName):alert("Erreur: "+s.error)}).catch(s=>alert("Erreur réseau: "+s.message))},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-blue-500/20 text-blue-400 hover:bg-blue-500 hover:text-white text-xl border border-blue-500/30 hover:border-blue-500 flex items-center justify-center transition-all shadow-[0_0_15px_rgba(59,130,246,0.3)] hover:shadow-[0_0_25px_rgba(59,130,246,0.6)] group relative mt-2",children:["📸",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-blue-400 pointer-events-none transition-opacity font-bold",children:"Immortaliser (Sauvegarder)"})]}),e.jsxs("button",{title:"Restaurer le projet (Time Machine)",onClick:()=>{E&&I("http://localhost:5006/api/bridge/backups?project_id="+E).then(s=>s?s.json():null).then(s=>{if(!s)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");if(!s.success||!s.backups||s.backups.length===0)return alert("⏪ Aucune sauvegarde trouvée pour ce projet.");M(s.backups),Te(!0)}).catch(s=>alert("Erreur réseau: "+s.message))},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-slate-500/20 text-slate-400 hover:bg-slate-500 hover:text-white text-xl border border-slate-500/30 hover:border-slate-500 flex items-center justify-center transition-all group relative mb-2",children:["⏪",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-slate-400 pointer-events-none transition-opacity font-bold",children:"Restaurer (Dernier Backup)"})]}),e.jsxs("button",{title:"Refactoring",onClick:()=>je("refactor"),className:"design-ide-btn-action w-10 h-10 rounded-xl bg-white/5 hover:bg-purple-500/20 text-xl border border-white/10 hover:border-purple-500 flex items-center justify-center transition-all group relative",children:["🔄",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-purple-400 pointer-events-none transition-opacity",children:"Refactoring"})]}),e.jsxs("button",{title:"Amélioration",onClick:()=>je("improve"),className:"design-ide-btn-action w-10 h-10 rounded-xl bg-white/5 hover:bg-yellow-500/20 text-xl border border-white/10 hover:border-yellow-500 flex items-center justify-center transition-all group relative",children:["✨",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-yellow-400 pointer-events-none transition-opacity",children:"Amélioration"})]}),e.jsxs("button",{title:"Corriger Arborescence (Fix Extensions)",onClick:()=>{E&&I("http://localhost:5006/api/fix-extensions",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:E})}).then(s=>s?s.json():null).then(s=>{if(!s)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");s.success?alert(s.message):alert("Erreur: "+s.error)}).catch(s=>alert("Erreur réseau: "+s.message))},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-white/5 hover:bg-orange-500/20 text-xl border border-white/10 hover:border-orange-500 flex items-center justify-center transition-all group relative",children:["🛠️",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-orange-400 pointer-events-none transition-opacity font-bold",children:"Fix Arborescence (.txt ➡️ .tsx)"})]}),e.jsxs("button",{title:"Générateur PRD V0-Guest",onClick:()=>{Pe("v0-guest"),Se("http://localhost:3007"),I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:"v0-guest"})}).catch(s=>console.error("Erreur lancement v0-guest:",s)),setTimeout(()=>{window.open("http://localhost:3007","_blank")},2500)},className:"design-ide-btn-action w-10 h-10 rounded-xl bg-gradient-to-br from-cyan/20 to-purple-500/20 text-cyan hover:from-cyan hover:to-purple-500 hover:text-black text-xl border border-cyan/40 flex items-center justify-center transition-all group relative shadow-[0_0_12px_rgba(0,240,255,0.3)]",children:["🎁",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-cyan font-bold pointer-events-none transition-opacity",children:"V0-Guest PRD Generator"})]}),e.jsxs("button",{title:"Design v0 (Studio Visuel & Preview Split)",onClick:()=>{const s=!kt;if(i(s),s&&!at){const c=De&&JSON.stringify(De).includes("next.config");Se(c?"http://localhost:3000":"http://localhost:5175")}},className:`design-ide-btn-action w-10 h-10 rounded-xl flex items-center justify-center transition-all group relative border ${kt?"bg-pink-500 text-white border-pink-500 shadow-[0_0_15px_rgba(236,72,153,0.5)]":"bg-white/5 hover:bg-pink-500/20 text-pink-500 border-white/10 hover:border-pink-500"}`,children:["🎨",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-pink-500 pointer-events-none transition-opacity font-bold",children:"Design v0 (Split View)"})]}),e.jsx("div",{className:"flex-1"}),e.jsxs("button",{title:g?"Réduire (Afficher le Chat)":"Pleine Page (Masquer le Chat)",onClick:()=>v(!g),className:`design-ide-btn-action w-10 h-10 rounded-xl flex items-center justify-center transition-all group relative border ${g?"bg-cyan text-black border-cyan":"bg-white/5 hover:bg-cyan/20 text-cyan border-white/10 hover:border-cyan"}`,children:[g?"🗗":"🗖",e.jsx("span",{className:"absolute left-14 bg-black px-2 py-1 text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap text-cyan pointer-events-none transition-opacity",children:g?"Mode Normal":"Pleine Page"})]})]}),e.jsxs("div",{className:"design-explorateur w-64 bg-[#0a0a0a]/95 border-r border-white/10 overflow-y-auto flex flex-col hide-scrollbar z-20 shadow-2xl",children:[e.jsxs("div",{className:"px-4 py-3 border-b border-white/10 sticky top-0 bg-[#0a0a0a] z-10 flex flex-col gap-2",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsxs("span",{className:"text-[10px] text-cyan font-black uppercase tracking-widest flex items-center gap-2",children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-cyan animate-pulse"}),"Projet Actif"]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{onClick:()=>{E&&(console.log("Clic Suture Manuel ! Projet:",E,"Etat actuel:",q),q!=="error"&&I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:E})}).catch(()=>{}),I("http://localhost:5006/api/suture/launch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:E})}).then(s=>s?s.json():null).then(s=>s&&console.log("Réponse Suture API:",s)).catch(s=>console.error("Erreur Suture API:",s)))},className:`text-[9px] font-bold px-2 py-0.5 rounded transition-colors border shadow-sm flex items-center gap-1 ${q==="error"?"bg-red-500/20 text-red-400 border-red-500/50 animate-pulse hover:bg-red-500/30":q==="working"?"bg-purple-500/20 text-purple-400 border-purple-500/50 hover:bg-purple-500/30":"bg-green-500/20 text-green-400 border-green-500/50 opacity-50 hover:opacity-100"}`,title:"Lancer Suture V2 manuellement",children:"sutur🩺"}),e.jsx("button",{onClick:()=>{I("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{s&&s.success&&s.projects?te(s.projects.map(c=>({name:typeof c=="string"?c:c.name||c.project_id||c.title||"Projet",desc:"Projet local",bg:""}))):fetch("/api/projects").then(c=>c.json()).then(c=>{c.projects&&te(c.projects.map(o=>({name:typeof o=="string"?o:o.name||o.project_id||o.title||"Projet",desc:"SaaS Cloud",bg:""})))})}).catch(()=>{})},className:"text-xs text-gray-400 hover:text-cyan p-1 transition-colors",title:"Actualiser la liste des projets",children:"🔄"})]})]}),e.jsxs("select",{value:E||"",onFocus:()=>{I("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{s&&s.success&&s.projects?te(s.projects.map(c=>({name:typeof c=="string"?c:c.name||c.project_id||c.title||"Projet",desc:"Projet local",bg:""}))):fetch("/api/projects").then(c=>c.json()).then(c=>{c.projects&&te(c.projects.map(o=>({name:typeof o=="string"?o:o.name||o.project_id||o.title||"Projet",desc:"SaaS Cloud",bg:""})))})}).catch(()=>{})},onChange:s=>{const c=s.target.value;c&&(Pe(c),Je(null),it(""),I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:c,open_explorer:!1})}).catch(o=>console.error("Erreur de lancement :",o)))},className:"w-full bg-[#161616] text-cyan font-bold text-xs border border-cyan/40 rounded-xl px-2.5 py-2 outline-none focus:border-cyan focus:ring-1 focus:ring-cyan shadow-[0_0_10px_rgba(8,179,201,0.2)] cursor-pointer truncate",children:[e.jsx("option",{value:"",disabled:!0,className:"bg-black text-gray-400",children:"-- Choisir un projet --"}),Ie.length>0?Ie.map((s,c)=>{var C,u;const o=typeof(s==null?void 0:s.name)=="string"?s.name:((C=s==null?void 0:s.name)==null?void 0:C.project_id)||((u=s==null?void 0:s.name)==null?void 0:u.title)||`Projet_${c}`;return e.jsxs("option",{value:o,className:"bg-black text-white font-medium py-1",children:["📁 ",o]},o+"_"+c)}):e.jsxs("option",{value:typeof E=="string"?E:(E==null?void 0:E.project_id)||(E==null?void 0:E.title)||"AUDIO",className:"bg-black text-white py-1",children:["📁 ",typeof E=="string"?E:(E==null?void 0:E.project_id)||(E==null?void 0:E.title)||"AUDIO"]})]})]}),e.jsx("div",{className:"py-2",children:De?ut(De):e.jsx("div",{className:"text-gray-500 text-xs px-4 py-2 animate-pulse",children:"Scan du projet..."})})]}),e.jsxs("div",{className:"design-editeur flex-1 flex flex-col bg-[#1e1e1e] z-20 shadow-2xl relative",children:[e.jsxs("div",{className:"design-editeur-onglet h-12 bg-[#252526] border-b border-black flex justify-between items-center px-4",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-blue-400 text-lg",children:pe?"📄":"📁"}),e.jsx("span",{className:"text-sm text-gray-300 font-mono",children:pe||"Aucun fichier sélectionné"})]}),e.jsxs("div",{className:"flex gap-4 items-center",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("div",{className:"text-xs text-green-400 animate-pulse font-bold flex items-center gap-2",children:[e.jsx("span",{className:"w-2 h-2 bg-green-400 rounded-full"})," SERVER:"]}),e.jsx("input",{type:"text",value:Xt,onChange:s=>jt(s.target.value),onKeyDown:s=>{s.key==="Enter"&&Se(Xt)},className:"bg-black/50 border border-green-500/30 text-green-400 text-[10px] px-2 py-1 rounded outline-none focus:border-green-400 w-40 font-mono shadow-[0_0_10px_rgba(34,197,94,0.1)] transition-all",title:"Modifier et taper Entrée"}),e.jsx("button",{onClick:()=>Se(Xt),className:"text-[10px] bg-green-500/20 text-green-400 hover:bg-green-500 hover:text-white px-2 py-1 rounded font-bold border border-green-500/30",children:"Go"})]}),e.jsx("button",{onClick:()=>ne(qt),disabled:!pe,className:`px-4 py-1.5 rounded text-xs font-bold transition-all ${pe?"bg-cyan/20 text-cyan hover:bg-cyan hover:text-black border border-cyan/30 shadow-[0_0_10px_rgba(8,179,201,0.2)]":"bg-white/5 text-gray-600 cursor-not-allowed"}`,children:"SAUVEGARDER (CTRL+S)"})]})]}),e.jsx("div",{className:"flex-1 relative flex overflow-hidden",children:kt?e.jsxs("div",{className:"flex-1 flex w-full h-full bg-[#0a0a0a] overflow-hidden",children:[e.jsxs("div",{className:"w-1/2 h-full border-r border-white/10 flex flex-col bg-[#141414]",children:[e.jsxs("div",{className:"h-12 px-4 bg-black/90 border-b border-white/10 flex justify-between items-center shrink-0 z-10",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-xl",children:"🎨"}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-xs font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-cyan tracking-widest uppercase",children:"STUDIO DESIGN INTELLIGENT"}),e.jsxs("p",{className:"text-[10px] text-gray-400 truncate max-w-[180px]",children:["Projet : ",e.jsx("span",{className:"text-cyan font-bold",children:E||"Projet Actif"})]})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{onClick:()=>i(!1),className:"px-2.5 py-1 bg-white/10 hover:bg-white/20 text-white rounded-lg border border-white/10 text-[11px] font-bold flex items-center gap-1 transition-all shadow",title:"Revenir à l'explorateur de fichiers & à l'éditeur de code",children:"📁 Fermer (Code)"}),e.jsx("button",{onClick:()=>{i(!1),Pe(null),v(!1)},className:"px-2.5 py-1 bg-red-500/20 hover:bg-red-500 text-red-300 hover:text-white rounded-lg border border-red-500/30 text-[11px] font-bold flex items-center gap-1 transition-all shadow",title:"Quitter le projet et revenir à la page d'accueil",children:"🏠 Fermer (Accueil)"})]})]}),e.jsx("div",{className:"flex-1 overflow-hidden relative",children:e.jsx("iframe",{src:`/admin-design.html?project=${E}`,className:"w-full h-full border-0 bg-black",title:"Studio Admin Design"})})]}),e.jsxs("div",{className:"design-preview w-1/2 h-full flex flex-col",children:[e.jsxs("div",{className:"h-12 px-4 bg-black/90 border-b border-white/10 flex justify-between items-center shrink-0 z-10",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"w-2.5 h-2.5 rounded-full bg-green-400 animate-pulse"}),e.jsxs("span",{className:"text-xs font-mono font-bold text-green-400",children:["LIVE PREVIEW (",De&&JSON.stringify(De).includes("next.config")?"LOCALHOST:3000":typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"?`${window.location.hostname}:5173`:"LOCALHOST:5173",")"]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("input",{type:"text",value:at||(De&&JSON.stringify(De).includes("next.config")?"http://localhost:3000":typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"?`http://${window.location.hostname}:5173`:"http://localhost:5173"),onChange:s=>jt(s.target.value),onKeyDown:s=>{s.key==="Enter"&&Se(Xt)},className:"bg-black/80 border border-green-500/30 text-green-400 text-[11px] px-2.5 py-1 rounded outline-none focus:border-green-400 w-48 font-mono"}),e.jsx("button",{onClick:()=>{E&&I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:E,open_explorer:!1})}).catch(s=>console.error("Erreur lancement preview:",s))},className:"px-2.5 py-1 bg-green-500/20 text-green-400 hover:bg-green-500 hover:text-white text-[11px] rounded font-bold border border-green-500/30 transition-all flex items-center gap-1",title:"Relancer / Démarrer le serveur Preview",children:"🚀 Relancer"})]})]}),e.jsx("div",{className:"flex-1 relative overflow-hidden",style:{background:"var(--preview-bg)"},children:e.jsx("iframe",{src:at||(De&&JSON.stringify(De).includes("next.config")?"http://localhost:3000":typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"?`http://${window.location.hostname}:5173`:"http://localhost:5173"),className:"w-full h-full border-none",title:"Application Preview Live"})})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`relative flex flex-col ${at?"w-1/2 border-r border-black":"w-full"}`,children:pe?e.jsx(ja,{height:"100%",theme:"vs-dark",path:pe,language:pe.endsWith(".tsx")||pe.endsWith(".ts")?"typescript":pe.endsWith(".css")?"css":pe.endsWith(".html")?"html":pe.endsWith(".json")?"json":"javascript",value:qt,onChange:s=>{const c=s||"";it(c),window.saveTimer&&clearTimeout(window.saveTimer),window.saveTimer=setTimeout(()=>{ne(c)},500)},options:{minimap:{enabled:!1},fontSize:14,wordWrap:"on",padding:{top:16}}}):e.jsxs("div",{className:"absolute inset-0 flex flex-col items-center justify-center text-gray-600 gap-4",children:[e.jsx("span",{className:"text-6xl opacity-20",children:"🐯"}),e.jsx("span",{className:"font-medium tracking-wide text-sm",children:"Sélectionnez un fichier dans l'explorateur ou activez Design v0"})]})}),at&&e.jsxs("div",{className:"design-preview w-1/2 relative",style:{background:"var(--preview-bg)"},children:[e.jsx("iframe",{src:at,className:"w-full h-full border-none"}),e.jsx("button",{onClick:()=>Se(null),className:"absolute top-2 right-4 bg-black/80 border border-white/20 text-white rounded-full w-8 h-8 flex items-center justify-center hover:bg-red-500 hover:text-white transition-all shadow-lg z-50",title:"Fermer la Preview",children:"✕"}),e.jsx("button",{onClick:()=>window.open(at,"_blank"),className:"absolute top-2 right-14 bg-black/80 border border-white/20 text-white rounded-full px-3 h-8 flex items-center justify-center hover:bg-cyan hover:text-black transition-all shadow-lg z-50 text-xs font-bold",title:"Ouvrir dans un nouvel onglet",children:"↗ Ouvrir"})]})]})})]})]}),e.jsxs("main",{className:`design-chat-main ${E?g?"hidden w-0":"w-full h-[50vh] lg:h-full lg:w-96 lg:min-w-[24rem]":"flex-1"} border-t lg:border-t-0 lg:border-l border-white/20 bg-black/60 shadow-[-20px_0_40px_rgba(0,0,0,0.5)] overflow-y-auto p-4 md:p-8 z-10 hide-scrollbar flex flex-col transition-all duration-500 ease-in-out`,onDragOver:s=>{s.preventDefault(),w(!0)},onDragLeave:()=>w(!1),onDrop:s=>{s.preventDefault(),w(!1),s.dataTransfer.files&&s.dataTransfer.files.length>0&&Xe(s.dataTransfer.files)},children:[x&&e.jsx("div",{className:"absolute inset-0 z-50 bg-cyan/20 backdrop-blur-sm border-4 border-dashed border-cyan rounded-3xl m-4 flex items-center justify-center pointer-events-none",children:e.jsxs("h2",{className:"text-3xl font-black text-cyan drop-shadow-lg text-center px-4",children:["Glissez votre projet Stitch (.zip, .html, .md, .png)",e.jsx("br",{}),"pour préparer le câblage !"]})}),e.jsxs("div",{className:"design-chat-layout w-full flex-1 flex flex-col justify-center my-auto pb-[140px] relative",children:[(()=>{const s=p.map(u=>!!u.widget).lastIndexOf(!0),c=s!==-1?p[s]:null,o=c?c.widget:null,C=re||o==="packs"||o==="projects"||o==="news"||o==="youtube"||It||Ze;return e.jsxs("div",{className:"w-full flex flex-col xl:flex-row items-stretch justify-between gap-6 relative min-h-[50vh] my-auto",children:[e.jsx(Go,{messages:p,showGuestPacks:ge,setShowGuestPacks:Ae,guestPacksCount:4,guestPackSearchQuery:he,setGuestPackSearchQuery:se}),C&&e.jsxs("div",{className:"flex-1 w-full flex flex-col items-center justify-center my-auto z-20",children:[!It&&!Ze&&(re||o==="packs")&&!E&&e.jsx(Fo,{selectedPacks:j,togglePack:$t,newProjectName:oe,setNewProjectName:pt,setActiveProject:Pe,handleSend:Fe,isClient:A,getCachedGradient:l,onDetailStateChange:K,showGuestPacks:ge,setShowGuestPacks:Ae,guestPackSearchQuery:he}),!It&&!Ze&&!re&&o==="projects"&&e.jsx(Qn,{isClient:A,getCachedGradient:l,setActiveProject:Pe}),!It&&!Ze&&!re&&o==="news"&&vt(),!It&&!Ze&&!re&&o==="youtube"&&Qe(),It&&e.jsxs("div",{className:"w-full bg-black/90 border-2 border-pink-500/50 rounded-3xl p-6 shadow-2xl backdrop-blur-md relative my-2 text-white animate-fadeIn flex-1 min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 pb-2 border-b border-white/10",children:[e.jsx("h3",{className:"text-xl font-black text-pink-400 flex items-center gap-2",children:"🎨 Gestion des Thèmes & Couleurs"}),e.jsx("button",{onClick:()=>qe(!1),className:"px-3.5 py-1.5 bg-white/10 hover:bg-white/20 text-white text-xs font-bold rounded-xl transition-all cursor-pointer border border-white/20",children:"✕ Masquer"})]}),e.jsxs("div",{className:"bg-cyan/10 border border-cyan/30 rounded-xl p-4 flex flex-col gap-2 mb-4",children:[e.jsxs("div",{className:"text-xs font-bold text-cyan uppercase tracking-wider flex items-center gap-2",children:[e.jsx("span",{children:"🖥️"})," Page d'Accueil Electron"]}),e.jsx("p",{className:"text-xs text-gray-300",children:`Fixer le fond d'écran enregistré ("fold") pour la page d'accueil Electron.`}),e.jsx("button",{onClick:()=>{const u="linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)",f=Ke.map(P=>P.name==="fold"?{...P,colors:{...P.colors,"bg-app":u}}:P);ct(f),localStorage.setItem("tiger_saved_themes",JSON.stringify(f)),_e("fold"),document.body.style.background=u,document.body.style.backgroundAttachment="fixed",I("http://localhost:5006/api/theme",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({activeTheme:"fold",bgApp:u})}).catch(()=>{}),qe(!1)},className:"w-full mt-1 py-2.5 bg-cyan text-black font-extrabold rounded-lg hover:bg-cyan/80 transition-all flex items-center justify-center gap-2 shadow-lg cursor-pointer",children:`🖼️ Appliquer ce Fond d'Écran sur Electron ("fold")`})]}),e.jsxs("div",{className:"bg-white/5 border border-white/10 rounded-xl p-4 flex flex-col gap-3 mb-4",children:[e.jsxs("div",{className:"text-sm font-bold text-gray-400",children:["Mode actuel : ",e.jsx("span",{className:"text-cyan uppercase",children:Ne})]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"text",value:Ge,onChange:u=>Ht(u.target.value),placeholder:"Nom (ex: Nuit, Océan, fold...)",className:"flex-1 bg-black/50 border border-white/20 rounded-lg px-3 py-2 text-sm text-white outline-none focus:border-cyan"}),e.jsx("button",{onClick:Sn,className:"px-4 py-2 bg-cyan text-black font-bold rounded-lg hover:bg-cyan/80 transition-colors whitespace-nowrap cursor-pointer",children:"Save Mode"})]})]}),e.jsxs("div",{className:"flex flex-col gap-2 max-h-[220px] overflow-y-auto custom-scrollbar",children:[e.jsx("div",{className:"text-xs font-bold text-gray-500 uppercase tracking-widest mb-1",children:"Thèmes Enregistrés"}),e.jsxs("div",{onClick:()=>{_e("random"),qe(!1)},className:`p-3 rounded-xl border text-left flex justify-between items-center transition-all cursor-pointer ${Ne==="random"?"bg-cyan/20 border-cyan text-white":"bg-white/5 border-white/10 text-gray-400 hover:bg-white/10"}`,children:[e.jsx("span",{className:"font-bold flex items-center gap-2",children:"🎲 Mode Aléatoire (Dynamique)"}),Ne==="random"&&e.jsx("span",{className:"text-cyan",children:"✓"})]}),Ke.map(u=>e.jsxs("div",{onClick:()=>{_e(u.name),document.body.style.background=u.colors["bg-app"]||"",u.name==="fold"?document.body.style.backgroundAttachment="fixed":document.body.style.backgroundAttachment="scroll"},className:`p-3 rounded-xl border text-left flex justify-between items-center transition-all cursor-pointer ${Ne===u.name?"bg-cyan/20 border-cyan text-white":"bg-white/5 border-white/10 text-gray-400 hover:bg-white/10"}`,children:[e.jsx("span",{className:"font-bold capitalize",children:u.name}),e.jsx("button",{onClick:f=>dn(u.name,f),className:"text-xs text-red-400 hover:text-red-300 px-2 py-1 bg-red-500/10 hover:bg-red-500/20 rounded border border-red-500/20 cursor-pointer",children:"Supprimer"})]},u.name))]})]}),Ze&&e.jsxs("div",{className:"w-full bg-[#090d16] border-2 border-purple-500/60 rounded-3xl p-6 shadow-2xl backdrop-blur-md relative my-2 text-white animate-fadeIn flex-1 min-w-0 flex flex-col max-h-[520px] overflow-y-auto custom-scrollbar",children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 pb-2 border-b border-purple-500/30",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-2xl animate-bounce",children:"📱"}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-purple-300 font-black text-base md:text-lg uppercase tracking-wider flex items-center gap-2",children:"v0-apk — Compilateur Mobile Java"}),e.jsx("p",{className:"text-xs text-slate-400",children:"Génération d'APK Android Souverain sans dépendance système externe"})]})]}),e.jsx("button",{onClick:()=>Ct(!1),className:"px-3.5 py-1.5 bg-white/10 hover:bg-white/20 text-white text-xs font-bold rounded-xl transition-all cursor-pointer border border-white/20",children:"✕ Masquer"})]}),e.jsxs("div",{className:"flex flex-col gap-2 bg-black/50 p-4 rounded-2xl border border-purple-500/20 mb-3",children:[e.jsxs("label",{htmlFor:"apk-target-inline",className:"text-purple-400 font-bold uppercase text-xs tracking-widest flex items-center gap-2",children:[e.jsx("span",{children:"📁"})," SELECTIONNER L'APPLICATION À COMPILER :"]}),e.jsxs("select",{id:"apk-target-inline",value:rt||E||"",onChange:u=>zt(u.target.value),className:"w-full bg-[#121824] text-white border border-purple-500/40 rounded-xl px-4 py-2.5 outline-none focus:border-purple-400 text-xs font-semibold cursor-pointer",children:[e.jsx("option",{value:"",children:"-- Sélectionner un projet --"}),Ie.map((u,f)=>{var R,Y;const P=typeof(u==null?void 0:u.name)=="string"?u.name:((R=u==null?void 0:u.name)==null?void 0:R.project_id)||((Y=u==null?void 0:u.name)==null?void 0:Y.title)||`Projet_${f}`;return e.jsxs("option",{value:P,children:["📁 ",P]},P+"_"+f)})]})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3 mb-3",children:[e.jsxs("div",{className:"bg-black/50 p-3 rounded-2xl border border-purple-500/20 flex flex-col gap-1",children:[e.jsx("span",{className:"text-xs font-bold text-purple-300 uppercase tracking-wider",children:"☕ Java Portable"}),e.jsx("div",{className:"text-[11px] text-slate-300 bg-purple-950/30 p-2 rounded-xl border border-purple-800/40 font-mono",children:"JDK 17 + Capacitor Android Engine"})]}),e.jsxs("div",{className:"bg-black/50 p-3 rounded-2xl border border-purple-500/20 flex flex-col gap-1",children:[e.jsx("span",{className:"text-xs font-bold text-purple-300 uppercase tracking-wider",children:"🎨 Thèmes Persistent"}),e.jsx("div",{className:"text-[11px] text-slate-300 bg-purple-950/30 p-2 rounded-xl border border-purple-800/40 font-mono",children:"Injection Zero-Touch CSS embarquée"})]})]}),e.jsxs("div",{className:"bg-[#05070d] p-3 rounded-2xl border border-slate-800 flex flex-col gap-2 mb-3",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsxs("span",{className:"text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center gap-2",children:[e.jsx("span",{className:`w-2.5 h-2.5 rounded-full ${st==="building"?"bg-yellow-400 animate-ping":st==="success"?"bg-green-400":"bg-slate-600"}`}),"Logs Compilation APK"]}),Rt.length>0&&e.jsx("button",{onClick:()=>Oe([]),className:"text-[10px] text-slate-500 hover:text-slate-300 underline cursor-pointer",children:"Effacer"})]}),e.jsx("div",{className:"bg-black/80 p-3 rounded-xl border border-slate-900 font-mono text-[11px] h-24 overflow-y-auto custom-scrollbar flex flex-col gap-1 text-slate-300",children:Rt.length===0?e.jsx("span",{className:"text-slate-600 italic text-center my-auto",children:`Prêt. Cliquez sur "Compiler l'APK".`}):Rt.map((u,f)=>e.jsx("div",{className:"leading-tight",children:u},f))})]}),Nt.length>0&&e.jsxs("div",{className:"bg-[#0b121e] p-3 rounded-2xl border border-emerald-500/30 flex flex-col gap-2 mb-3 shadow-inner",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsxs("span",{className:"text-xs font-bold text-emerald-400 uppercase tracking-wider flex items-center gap-2",children:[e.jsx("span",{children:"📦"})," Fichiers APK Prêts (",Nt.length,")"]}),e.jsx("button",{onClick:wt,className:"text-[11px] text-emerald-400 hover:text-emerald-200 transition-colors flex items-center gap-1 cursor-pointer font-bold",title:"Actualiser la liste des APK sur le serveur",children:"🔄 Actualiser"})]}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-32 overflow-y-auto custom-scrollbar pt-1",children:Nt.map((u,f)=>{const P=(rt||E||"").toLowerCase()===u.name.toLowerCase();return e.jsxs("a",{href:u.url,download:u.file,className:`px-3 py-2 rounded-xl text-xs font-bold flex items-center justify-between transition-all shadow-md cursor-pointer border ${P?"bg-emerald-600/30 border-emerald-400 text-white shadow-[0_0_12px_rgba(16,185,129,0.3)]":"bg-black/50 border-emerald-500/20 text-slate-300 hover:bg-emerald-950/40 hover:text-white hover:border-emerald-500/50"}`,title:`Télécharger ${u.file} (${u.sizeMb} Mo)`,children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-base",children:"📱"}),e.jsx("span",{className:"font-mono truncate",children:u.name})]}),e.jsxs("span",{className:"text-[10px] bg-emerald-900/60 px-2 py-0.5 rounded-full text-emerald-300 font-mono shrink-0 ml-2",children:["📥 ",u.sizeMb," Mo"]})]},f)})})]}),(()=>{const u=rt||E||"figma",f=Nt.find(Y=>Y.name.toLowerCase()===u.toLowerCase()||Y.file.toLowerCase()===`${u}.apk`.toLowerCase()),P=vn||(f?f.url:`/api/mobile/download-apk?file=${encodeURIComponent(u+".apk")}`),R=!!(vn||f);return e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-purple-500/20",children:[R?e.jsxs("a",{href:P,download:`${u}.apk`,className:"px-5 py-2.5 bg-gradient-to-r from-emerald-600 to-green-500 hover:from-emerald-500 hover:to-green-400 text-white rounded-xl text-xs font-black transition-all flex items-center gap-2 shadow-lg shadow-emerald-900/50 border border-emerald-400/40 cursor-pointer animate-pulse hover:scale-105",children:[e.jsx("span",{className:"text-base",children:"📥"}),e.jsxs("span",{children:["TÉLÉCHARGER ",u.toUpperCase(),".APK"]}),f&&e.jsxs("span",{className:"text-[10px] opacity-90 font-mono",children:["(",f.sizeMb," Mo)"]})]}):e.jsxs("a",{href:"https://github.com/turnzack/v0-reponse/actions/workflows/build-apk.yml",target:"_blank",rel:"noreferrer",className:"px-4 py-2 bg-slate-800/80 hover:bg-slate-700 text-slate-300 rounded-xl text-xs font-bold transition-all flex items-center gap-2 border border-slate-700",title:"Télécharger l'APK compilé par GitHub Actions",children:[e.jsx("span",{children:"☁️"})," Téléchargements Cloud GitHub"]}),e.jsx("button",{disabled:st==="building",onClick:async()=>{$e("building"),Oe([`> Initialisation build APK pour [${u}]...`]);try{const Y=await I("http://localhost:5006/api/mobile/build-apk",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:u})});if(!Y||!Y.ok){Oe($=>[...$,"> ℹ️ Détection environnement Cloud VPS (109.205.182.17)...","> 🚀 Bascule automatique sur le Compilateur Cloud Souverain (GitHub Actions Engine)..."]),await Wn(u,$=>Oe(J=>[...J,$]),($,J)=>{$e($),J&&(ht(J),wt())});return}}catch{Oe($=>[...$,"> 🚀 Bascule automatique sur le Compilateur Cloud Souverain..."]),await Wn(u,$=>Oe(J=>[...J,$]),($,J)=>{$e($),J&&(ht(J),wt())})}},className:`ml-auto px-5 py-2.5 rounded-xl text-xs font-extrabold transition-all shadow-md ${st==="building"?"bg-purple-900/50 text-purple-300 cursor-not-allowed":"bg-purple-600 hover:bg-purple-500 text-white cursor-pointer"}`,children:st==="building"?"⚙️ Compilation...":"📱 Re-Compiler l'APK"})]})})()]})]}),!C&&e.jsx("div",{className:"design-chat-bulles w-full xl:w-[450px] shrink-0 flex flex-col gap-3 items-end z-10 ml-auto",children:p.map((u,f)=>{const P=f===0;return e.jsxs("div",{className:"w-full flex flex-col items-end",children:[e.jsx("div",{className:`${P?"design-msg-accueil":"design-chat-bulle"} p-5 rounded-3xl rounded-br-sm backdrop-blur-md border border-white/20 text-gray-100 shadow-xl`,style:{background:A?l("msg-"+u.id,u.role==="user"?.8:.6):"rgba(0,0,0,0.6)"},children:u.content}),f===s&&u.widget==="settings"&&e.jsx(Jn,{isClient:A,getCachedGradient:l,mouchardLogs:de,activePhase:G,availableProjects:ae,setAvailableProjects:ve,selectedLaunchProject:z,setSelectedLaunchProject:ee,isMobileNative:W,isAutoPilot:dt,setIsAutoPilot:ft,reuseActiveTab:Ye,setReuseActiveTab:At,selectedStartPhase:We,setSelectedStartPhase:Kt,selectedPacks:j}),f===s&&u.widget==="phases"&&Lt(),f===s&&u.widget==="projects"&&e.jsx(Qn,{isClient:A,getCachedGradient:l,setActiveProject:Pe})]},u.id)})})]})})(),e.jsx("div",{ref:U})]})]}),me&&(()=>{const s=de.slice(-10).join(" ").toLowerCase(),c=de.slice(0,10).join(" ").toLowerCase(),o=s+" "+c;let C="text-green-400",u="bg-green-400 shadow-[0_0_8px_#4ade80]",f="border-green-500/30 shadow-[-10px_0_30px_rgba(34,197,94,0.1)]",P="bg-green-950/20",R="Terminal (Prêt)";return o.includes("erreur")||o.includes("failed")||o.includes("⚠️")||o.includes("exception")||o.includes("impossible")||o.includes("[err")?(C="text-red-500",u="bg-red-500 animate-pulse shadow-[0_0_12px_#ef4444]",f="border-red-500/50 shadow-[-10px_0_30px_rgba(239,68,68,0.2)]",P="bg-red-950/30",R="Terminal (Erreur)"):(o.includes("en cours")||o.includes("execution")||o.includes("install")||o.includes("lancement")||o.includes("analyse")||o.includes("suture")||o.includes("patch"))&&!o.includes("terminé")&&!o.includes("détecté")&&!o.includes("nettoyée")&&!o.includes("✅")&&(C="text-purple-400",u="bg-purple-400 animate-ping shadow-[0_0_12px_#c084fc]",f="border-purple-500/50 shadow-[-10px_0_30px_rgba(168,85,247,0.2)]",P="bg-purple-950/30",R="Terminal (Travail...)"),e.jsxs("aside",{className:`w-80 border-l flex flex-col z-50 fixed right-0 top-0 h-screen bg-black transition-all duration-500 shadow-2xl ${f}`,children:[e.jsxs("div",{className:`p-4 border-b border-white/10 flex justify-between items-center transition-colors duration-500 ${P}`,children:[e.jsxs("h3",{className:`${C} font-black text-xs uppercase tracking-widest flex items-center gap-2 transition-colors`,children:[e.jsx("span",{className:`w-2 h-2 rounded-full ${u}`}),R]}),e.jsxs("div",{className:"flex gap-2 items-center",children:[e.jsx("button",{onClick:async()=>{xe(["> Arrêt des processus en cours... (Historique conservé dans la console noire)"]);try{const Y=await I("http://localhost:5006/api/bridge/stop-launch",{method:"POST"});if(!Y||!Y.ok){xe(["> ⚠️ ERREUR : La commande n'existe pas !","> ⚠️ VOUS DEVEZ REDÉMARRER LA CONSOLE NOIRE !","> Fermez la fenêtre COMMAND_MENU_TIGER.bat et relancez-la."]);return}const $=await Y.json();xe(["> ✅ "+($.message||"Processus arrêtés.")])}catch(Y){xe(["> ⚠️ ERREUR DE CONNEXION AU MOTEUR !","> Le moteur est peut-être éteint ou nécessite un redémarrage.","> Détail: "+Y.message])}},className:"py-1 px-2 rounded text-white font-bold text-[10px] bg-red-500/20 border border-red-500/50 hover:bg-red-500 hover:text-white transition-colors shadow-md",title:"Arrêter l'installation ou le serveur (Ne nettoie plus la console)",children:"⏹️ Stop/Clear"}),e.jsx("button",{onClick:()=>Ce(!1),className:"text-gray-500 hover:text-white transition-colors ml-2 font-bold text-lg",children:"✕"})]})]}),e.jsx("div",{className:"flex-1 p-4 font-mono text-xs overflow-y-auto flex flex-col-reverse hide-scrollbar bg-black",children:e.jsx("div",{id:"mouchard-terminal-logs",children:de.map((Y,$)=>{let J="text-[#52c1c9]";return Y.includes("[INSTALL]")&&(J="text-[#f29f43]"),Y.includes("[SERVER]")&&(J="text-[#0ab7d4]"),Y.includes("[IDE]")&&(J="text-[#e27396]"),(Y.includes("WARN")||Y.includes("ERR"))&&(J="text-red-500"),e.jsx("div",{className:`mb-1 opacity-90 break-words ${J}`,children:Y},$)})})})]})})(),!me&&e.jsxs("button",{onClick:()=>Ce(!0),title:"Ouvrir le Mouchard Système / Terminal",className:"fixed right-4 top-4 z-50 bg-[#111c2e]/90 hover:bg-[#1e293b] border border-cyan/40 text-cyan px-3 py-1.5 rounded-full text-[11px] font-mono font-bold shadow-[0_0_15px_rgba(8,179,201,0.25)] transition-all flex items-center gap-1.5 backdrop-blur-md cursor-pointer hover:scale-105",children:[e.jsx("span",{children:"🕵️"}),e.jsx("span",{children:"Mouchard"})]})]})," ",e.jsxs("footer",{className:"design-footer absolute bottom-0 left-0 w-full backdrop-blur-2xl z-50 flex flex-col p-2 md:p-3 bg-black/80 border-t border-white/15 gap-2",children:[e.jsx("div",{className:"flex flex-wrap items-center justify-center gap-3 px-4 py-2 bg-black/40 rounded-2xl border border-white/10 backdrop-blur-md",children:e.jsxs("div",{className:"flex items-center gap-2 overflow-x-auto hide-scrollbar pb-1 px-1",children:[e.jsxs("button",{onClick:()=>{V("connexion"),N(!0)},className:"design-app-icone design-icone-reglages flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Réglages",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:rotate-45 transition-transform",children:"⚙️"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Réglages"})]}),e.jsxs("button",{onClick:()=>{if(typeof window<"u"){const s=localStorage.getItem("tiger_targetAi")||"deepseek",c=lt(s),o=window.AndroidBridge;o&&o.openAIWithPrompt?o.openAIWithPrompt(c,"Bonjour ! Je viens d'ouvrir l'Assistant IA."):window.open(c,"_blank")}},className:"design-app-icone design-icone-assistant flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Assistant IA",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🧠"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Assistant IA"})]}),e.jsxs("button",{onClick:()=>{Pe(null),Je(null),ue(!1),Fe("Mes projets"),b("")},className:"design-app-icone design-icone-projets flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Projets",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"📁"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Projets"})]}),e.jsxs("button",{id:"btn-joindre-prd-main",onClick:()=>{ue(!0)},className:"design-app-icone design-icone-packs flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Ouvrir le carrousel des Packs PRD",children:[j.length>0&&e.jsx("span",{className:"absolute -top-0 -right-0 bg-indigo-500 text-white text-[9px] font-black w-4.5 h-4.5 rounded-full flex items-center justify-center border border-white/20 shadow-md z-20",children:j.length}),e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform text-xl",children:"📎"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Packs PRD"})]}),e.jsxs("button",{onClick:async()=>{window.dispatchEvent(new CustomEvent("open-mouchard"));try{await I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:"v0-guest"})}),setTimeout(()=>{window.open("http://localhost:3007","_blank")},2500)}catch(s){console.error("Erreur lancement v0-guest:",s)}},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden cursor-pointer",style:{backgroundImage:"linear-gradient(135deg, #00c6ff, #0072ff)"},title:"Démarrer le serveur V0-Guest (localhost:3007) en arrière-plan",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🎁"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"V0-Guest"})]}),e.jsxs("button",{onClick:()=>{ue(!1),Fe("Actualités IA"),b("")},className:"design-app-icone design-icone-actualites flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",title:"Actualités",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"📰"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Actualités"})]}),e.jsxs("button",{type:"button",onClick:s=>{s.preventDefault(),Ce(c=>{const o=!c;return o&&xe(C=>["> Console-V0 ouverte. Prêt pour l'Introspection AST.",...C]),o})},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #475163, #1f2530)"},title:"Console-V0",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🖥️"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Console-V0"})]}),e.jsxs("button",{type:"button",onClick:async s=>{s.preventDefault();try{Ce(!0);const c=E||"Projet_blog_8831",C=`e:\\v0reponses\\v0-moteur-electron\\v0saveprojets\\${c}\\${(pe||"src/App.tsx").replace(/\//g,"\\")}`;setTimeout(()=>{const R=document.getElementById("mouchard-terminal-logs");R&&(R.innerHTML=`<div class="mb-1 opacity-90 break-words text-[#e27396]">> 🚀 Lancement du Patch UI (Suture dynamique sur ${c})...</div>`+R.innerHTML)},50);const u=await I("http://localhost:5006/api/design/intent",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({intent:"PATCH_UI",payload:{targetFile:C,templateId:"stitch_mock"}})}),f=u?await u.json():null,P=document.getElementById("mouchard-terminal-logs");P&&(f&&f.success?P.innerHTML='<div class="mb-1 opacity-90 break-words text-[#00e676]">> 🎯 Patch appliqué avec succès par le LLM !</div>'+P.innerHTML:(P.innerHTML=`<div class="mb-1 opacity-90 break-words text-red-400">> ⚠️ Erreur Patch UI AST : ${f&&f.error||"Basculement vers la Suture IA..."}</div>`+P.innerHTML,je("suture",`Échec du patch automatique AST : ${f&&f.error||"Format incompatible"}`)))}catch(c){const o=document.getElementById("mouchard-terminal-logs");o&&(o.innerHTML=`<div class="mb-1 opacity-90 break-words text-red-500">> ⛔ Erreur Patch UI : ${c.message}</div>`+o.innerHTML),je("suture",`Exception Patch UI: ${c.message}`)}},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #1b6345, #08291a)"},title:"Patch UI",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🧬"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Patch UI"})]}),e.jsxs("button",{type:"button",onClick:async()=>{try{const s=await I("http://localhost:5006/bridge/flush",{method:"POST"}),c=s?await s.json():null;_(C=>[...C,{id:Date.now().toString()+"_flush",role:"assistant",content:`🧹 File Bridge vidée ! ${c&&c.flushed||0} prompt(s) supprimé(s).

La queue est vide. Relancez votre Suture ou Patch.`}]);const o=document.getElementById("mouchard-terminal-logs");o&&(o.innerHTML=`<div class="mb-1 opacity-90 break-words text-yellow-400">> 🧹 Bridge Queue FLUSH — ${c&&c.flushed||0} tâche(s) nettoyée(s)</div>`+o.innerHTML)}catch{alert("Moteur hors ligne : impossible de vider la queue.")}},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #a17c23, #4f3b0c)"},title:"Vider la file Bridge (déblocage injection)",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🧹"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Flush Queue"})]}),e.jsxs("button",{onClick:()=>{Ct(!1),ue(!1),qe(s=>!s)},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #993a61, #4d152c)"},title:"Thèmes & Couleurs",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform",children:"🎨"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"Thèmes"})]}),e.jsxs("button",{onClick:()=>{qe(!1),ue(!1),Ct(s=>!s)},className:"design-app-icone flex flex-col items-center justify-center shrink-0 group relative overflow-hidden",style:{backgroundImage:"linear-gradient(135deg, #5b227a, #230930)"},title:"Compiler l'Application Mobile (.apk - Java Portable)",children:[e.jsx("span",{className:"z-10 drop-shadow-md group-hover:scale-110 transition-transform animate-pulse",children:"📱"}),e.jsx("span",{className:"design-app-texte z-10 drop-shadow-md",children:"v0-apk"})]})]})}),e.jsxs("div",{className:"px-3 pb-1 pt-1 relative w-full flex flex-col gap-2",children:[e.jsx("input",{type:"file",ref:O,className:"hidden",multiple:!0,accept:".html,.md,.png,.jpg,.jpeg,.json,.txt,.zip",onChange:s=>{s.target.files&&s.target.files.length>0&&Xe(s.target.files),O.current&&(O.current.value="")}}),bt.length>0&&e.jsx("div",{className:"flex gap-2 px-2 overflow-x-auto hide-scrollbar pb-2",children:bt.map((s,c)=>e.jsxs("div",{className:"flex items-center gap-2 bg-cyan/10 border border-cyan/30 text-cyan text-xs px-3 py-1.5 rounded-full whitespace-nowrap animate-fadeIn",children:[e.jsxs("span",{children:["📎 ",s.path.split("/").pop()||s.path.split("\\").pop()]}),e.jsx("button",{onClick:()=>Pt(o=>o.filter((C,u)=>u!==c)),className:"hover:text-red-400 font-bold ml-1",children:"✕"})]},c))}),Ee?e.jsxs("div",{id:"creation-mode-container",className:"absolute bottom-full left-2 right-2 mb-3 flex flex-col gap-4 bg-[#05080c]/98 p-5 rounded-3xl border-2 border-cyan/50 shadow-[0_0_50px_rgba(8,179,201,0.5)] backdrop-blur-2xl animate-fadeIn z-[100] max-h-[82vh] overflow-y-auto custom-scrollbar text-white",children:[e.jsxs("div",{className:"flex justify-between items-center mb-1 sticky top-0 bg-[#05080c]/98 z-10 py-2 border-b border-cyan/20",children:[e.jsxs("h3",{className:"text-cyan font-black flex items-center gap-2 text-base md:text-lg uppercase tracking-wider",children:[e.jsx("span",{className:"animate-pulse w-2.5 h-2.5 bg-cyan rounded-full shadow-[0_0_10px_#08b3c9]"})," ⚙️ CONFIGURATION DU PROJET"]}),e.jsx("button",{onClick:()=>Re(!1),className:"text-gray-400 hover:text-white bg-white/10 hover:bg-red-500 rounded-full w-7 h-7 flex items-center justify-center transition-colors",children:"✕"})]}),e.jsxs("div",{className:"flex flex-col gap-2 bg-black/60 p-3.5 rounded-2xl border border-white/10",children:[e.jsxs("label",{htmlFor:"project-target",className:"text-cyan font-bold uppercase text-[10px] tracking-widest flex items-center gap-1.5",children:[e.jsx("span",{children:"📁"})," CIBLER LE PROJET :"]}),e.jsxs("select",{id:"project-target",value:Mt||"",onChange:s=>{const c=s.target.value;Wt(c||null),pt(c?c.replace("Projet_","").split("_")[0]:"")},className:"w-full bg-[#11161d] text-white border border-cyan/30 rounded-xl px-3 py-2 outline-none focus:border-cyan text-xs cursor-pointer",children:[e.jsx("option",{value:"",children:"-- SÉLECTIONNER UN PROJET --"}),Ie.map((s,c)=>{var C,u;const o=typeof(s==null?void 0:s.name)=="string"?s.name:((C=s==null?void 0:s.name)==null?void 0:C.project_id)||((u=s==null?void 0:s.name)==null?void 0:u.title)||`Projet_${c}`;return e.jsxs("option",{value:o,children:["📁 ",o]},o+"_"+c)})]})]}),e.jsxs("div",{className:"flex flex-col gap-2 bg-black/60 p-3.5 rounded-2xl border border-white/10",children:[e.jsxs("label",{htmlFor:"project-instructions",className:"text-cyan font-bold uppercase text-[10px] tracking-widest flex items-center gap-1.5",children:[e.jsx("span",{children:"📝"})," INSTRUCTIONS SPÉCIFIQUES :"]}),e.jsx("textarea",{id:"project-instructions",value:He,onChange:s=>nn(s.target.value),placeholder:"Instructions pour le Patch ou la modification...",className:"w-full bg-[#11161d] text-white border border-slate-700 rounded-xl px-3.5 py-2 outline-none focus:border-cyan h-14 resize-none text-xs leading-relaxed"})]}),e.jsxs("div",{className:"flex flex-col gap-3.5 bg-black/60 p-3.5 rounded-2xl border border-white/10",children:[e.jsxs("div",{className:"text-cyan font-bold uppercase text-xs tracking-wider flex items-center gap-1.5 border-b border-white/10 pb-1.5",children:[e.jsx("span",{children:"⚡"})," PARAMÈTRES & CIBLES"]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"project-name",className:"text-cyan font-bold uppercase text-[10px] tracking-widest mb-1 block",children:"Nom du Projet"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{id:"project-name",type:"text",value:oe,onChange:s=>pt(s.target.value),placeholder:"Ex: MonSuperProjet",className:"flex-1 bg-[#11161d] text-white border border-slate-700 rounded-xl px-3 py-2 outline-none focus:border-cyan text-xs"}),e.jsx("button",{type:"button",onClick:async()=>{if(oe.trim()){const c=oe.trim().replace(/[^a-zA-Z0-9_-]/g,"_");Pe(c);try{const o="http://localhost:5006";await I(`${o}/v1/projects/set-active`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:c,project_id:c})}).catch(()=>null),await I(`${o}/api/fs/write`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:c,file:"README.md",content:`# ${oe.trim()}

Initialisé par Tiger IA V0.`})}).catch(()=>null)}catch(o){console.error("Erreur lors de la création du dossier sur disque:",o)}}},className:"px-3 py-2 bg-cyan/20 hover:bg-cyan text-cyan hover:text-black font-bold text-xs rounded-xl border border-cyan/40 transition-colors whitespace-nowrap",children:"Valider"})]})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"project-stack",className:"text-cyan font-bold uppercase text-[10px] tracking-widest mb-1 block",children:"Stack Technique"}),e.jsxs("select",{id:"project-stack",value:ze,onChange:s=>Dn(s.target.value),className:"w-full bg-[#11161d] text-white border border-slate-700 rounded-xl px-3 py-2 outline-none focus:border-cyan text-xs cursor-pointer",children:[e.jsx("option",{value:"Vite + React + Tailwind + TS",children:"⭐ 1er Choix (Prioritaire) : Vite + React + Tailwind + TS"}),e.jsx("option",{value:"Vite + React + TS + Canvas 2D",children:"🎮 Jeu 2D : Vite + React + TS + Canvas 2D"}),e.jsx("option",{value:"Vite + React + TS + Three.js / R3F (3D GPU)",children:"🚀 Jeu 3D GPU : Vite + React + TS + Three.js / R3F"}),e.jsx("option",{value:"Next.js + Tailwind + App Router",children:"Next.js + Tailwind + App Router"}),e.jsx("option",{value:"HTML + CSS Vanilla + JS",children:"HTML + CSS Vanilla + JS"})]})]})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"project-desc",className:"text-cyan font-bold uppercase text-[10px] tracking-widest mb-1 block",children:"Description / Vision"}),e.jsx("textarea",{id:"project-desc",value:mt,onChange:s=>bn(s.target.value),placeholder:"Décrivez l'application ou copiez votre PRD...",className:"w-full bg-[#11161d] text-white border border-slate-700 rounded-xl px-3.5 py-2 outline-none focus:border-cyan h-16 resize-none text-xs leading-relaxed"})]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2 pt-2 border-t border-white/10",children:[e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-[9px] font-bold text-cyan uppercase tracking-wider",children:"Intelligence Cible"}),e.jsxs("select",{value:yt,onChange:s=>{Et(s.target.value),localStorage.setItem("tiger_targetAi",s.target.value)},className:"bg-[#11161d] text-cyan font-bold text-xs border border-cyan/40 rounded-xl px-2.5 py-1.5 outline-none focus:border-cyan cursor-pointer",children:[e.jsx("option",{value:"deepseek",children:"🩵 DeepSeek"}),e.jsx("option",{value:"cloudflare",children:"☁️ Cloudflare Qwen 3 (Grade Gold)"}),e.jsx("option",{value:"stitch",children:"🎨 Stitch (Google)"}),e.jsx("option",{value:"v0",children:"⚡ V0.dev"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT"}),e.jsx("option",{value:"claude",children:"🟠 Claude"}),e.jsx("option",{value:"kimi",children:"🌙 Kimi (Moonshot)"}),e.jsx("option",{value:"gemini",children:"🔵 Gemini"}),e.jsx("option",{value:"qwen",children:"🔴 Qwen"}),e.jsx("option",{value:"perplexity",children:"🔍 Perplexity AI"})]})]}),e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-[9px] font-bold text-cyan uppercase tracking-wider",children:"💉 Mode & Lot de Départ"}),e.jsxs("select",{value:We,onChange:s=>Kt(Number(s.target.value)),className:"bg-[#11161d] text-white font-bold text-xs border border-cyan/40 rounded-xl px-2.5 py-1.5 outline-none focus:border-cyan cursor-pointer",children:[e.jsx("option",{value:1,children:"🎨 Phase 1 : Le Frontend (Stitch/v0)"}),e.jsx("option",{value:2,children:"💻 Phase 2 : Le Backend (Assistant IA)"}),e.jsx("option",{value:4,children:"🎨 Phase 3/4 : Câblage Métier (Business Wiring)"})]})]}),e.jsxs("button",{type:"button",onClick:()=>ft(!dt),className:`mt-4 px-3 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border ${dt?"bg-green-600/30 text-green-300 border-green-500/50 shadow-[0_0_10px_rgba(34,197,94,0.3)]":"bg-slate-800 text-slate-300 border-slate-700 hover:border-slate-500"}`,children:[e.jsx("span",{children:"🤖"}),e.jsxs("span",{children:["AUTO-PILOT : ",dt?"ON 🟢":"OFF ⚪"]})]}),e.jsxs("button",{type:"button",onClick:()=>At(!Ye),className:`mt-4 px-3 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border ${Ye?"bg-blue-600/30 text-blue-300 border-blue-500/50 shadow-[0_0_10px_rgba(59,130,246,0.3)]":"bg-slate-800 text-slate-300 border-slate-700"}`,title:"Cochez pour réutiliser l'onglet KIROV5 au lieu d'ouvrir un nouvel onglet",children:[e.jsx("span",{children:"🔗"}),e.jsx("span",{children:Ye?"✓ Injecter dans l'onglet déjà ouvert":"Ouvrir un nouvel onglet"})]}),e.jsxs("div",{id:"btn-joindre-prd",className:`mt-4 px-3 py-1.5 border rounded-xl text-xs font-bold flex items-center gap-1.5 relative ${j.length>0?"bg-indigo-600 text-white border-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.6)]":"bg-indigo-900/40 text-indigo-200 border-indigo-500/40"}`,title:"Pack PRD sélectionné — Sera injecté automatiquement dans le contexte IA",children:[e.jsx("span",{children:"💎"}),e.jsx("span",{children:j.length>0?`Packs PRD ${j.length} ${j[0]}`:"Aucun Pack PRD sélectionné"})]}),e.jsxs("button",{type:"button",onClick:triggerNativeZipPicker,className:"mt-4 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-white border border-slate-600 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 shadow-md hover:border-cyan hover:shadow-[0_0_15px_rgba(8,179,201,0.4)] cursor-pointer",children:[e.jsx("span",{children:"📎"}),e.jsx("span",{children:"Joindre ZIP (Stitch)"})]})]})]}),re&&e.jsxs("div",{className:"w-full bg-[#0a0d14]/98 p-4 rounded-2xl border-2 border-indigo-500/60 shadow-[0_0_30px_rgba(99,102,241,0.4)] my-2 text-white animate-fadeIn max-h-[50vh] overflow-y-auto custom-scrollbar flex flex-col gap-3 z-30",children:[e.jsxs("div",{className:"flex justify-between items-center pb-2 border-b border-indigo-500/30 sticky top-0 bg-[#0a0d14]/98 z-10 py-1",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-xl",children:"💎"}),e.jsxs("div",{children:[e.jsxs("h4",{className:"text-indigo-300 font-black text-xs md:text-sm uppercase tracking-wider",children:["PACKS PRD ARCHITECTURE (",j.length," SÉLECTIONNÉ",j.length>1?"S":"",")"]}),e.jsx("p",{className:"text-[10px] text-slate-400",children:"Sélectionnez les briques fonctionnelles à intégrer au Méga-Prompt."})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[j.length>0&&e.jsx("button",{type:"button",onClick:()=>X([]),className:"text-[10px] font-bold text-red-400 hover:text-red-300 bg-red-950/40 px-2 py-1 rounded-lg border border-red-500/30 transition-all",children:"Tout décocher"}),e.jsx("button",{type:"button",onClick:()=>ue(!1),className:"text-slate-400 hover:text-white bg-white/10 rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold transition-all",children:"✕"})]})]}),e.jsx("input",{type:"text",placeholder:"🔍 Filtrer un pack PRD (ex: auth, ecom, mobile, saas, ai, game, sqlite...)",value:Me,onChange:s=>nt(s.target.value),className:"w-full bg-[#121824] text-xs text-white border border-indigo-500/40 rounded-xl px-3 py-2 outline-none focus:border-indigo-400 placeholder:text-slate-500"}),e.jsx("div",{className:"grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2",children:Gt.filter(s=>s.name.toLowerCase().includes(Me.toLowerCase())||s.id.toLowerCase().includes(Me.toLowerCase())).map(s=>{const c=j.includes(s.id),o=s.icon;return e.jsxs("div",{onClick:()=>$t(s.id),className:`p-2.5 rounded-xl border text-xs cursor-pointer transition-all flex flex-col justify-between gap-1.5 relative select-none ${c?"bg-indigo-900/60 border-indigo-400 text-white shadow-[0_0_12px_rgba(99,102,241,0.5)] scale-[1.02]":"bg-[#11161f] border-slate-800 text-slate-300 hover:border-indigo-500/50 hover:bg-[#171e2b]"}`,children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("div",{className:`p-1 rounded-lg ${s.color}`,children:e.jsx(o,{className:"w-3.5 h-3.5"})}),e.jsx("input",{type:"checkbox",checked:c,readOnly:!0,className:"accent-indigo-500 w-3.5 h-3.5 rounded cursor-pointer pointer-events-none"})]}),e.jsx("div",{className:"font-bold text-[11px] leading-tight line-clamp-1 text-white",children:s.name}),e.jsxs("div",{className:"text-[8px] text-slate-400 font-mono truncate",children:["#",s.id]})]},s.id)})}),e.jsx("div",{className:"pt-2 border-t border-indigo-500/20 flex justify-end",children:e.jsxs("button",{type:"button",onClick:()=>{ue(!1)},className:"px-4 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-black rounded-xl shadow-lg transition-all",children:["✓ Valider la sélection (",j.length,")"]})})]}),e.jsxs("div",{className:"flex justify-end gap-3 pt-2 border-t border-white/10",children:[e.jsx("button",{type:"button",onClick:()=>Re(!1),className:"px-4 py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-xl text-xs font-bold transition-all",children:"Annuler"}),e.jsxs("button",{type:"button",onClick:async s=>{if(!oe.trim()&&!Mt){alert("Veuillez entrer un nom de projet ou en choisir un.");return}const c=oe.trim()?oe.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"",o=Mt||c||"Projet_"+Date.now().toString().slice(-4),C=s.currentTarget;C.innerText="⏳ Initialisation...",C.disabled=!0;try{const u="http://localhost:5006",f=typeof window<"u"&&window.Capacitor&&window.Capacitor.isNativePlatform();if(f)try{const{KirovSovereignEngine:J}=window.Capacitor.Plugins;J&&await J.setActiveProject({name:o})}catch(J){console.warn("Plugin mobile introuvable",J)}else await I(`${u}/v1/projects/set-active`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:o})}).catch(()=>null);if(f)try{const{KirovSovereignEngine:J}=window.Capacitor.Plugins;J&&await J.writeFile({project:o,file:"README.md",content:`# ${oe||o}

Initialisé par Tiger IA V0.
Stack : ${ze}
Description : ${mt}`})}catch{}else await I(`${u}/api/fs/write`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:o,file:"README.md",content:`# ${oe||o}

Initialisé par Tiger IA V0.
Stack : ${ze}
Description : ${mt}`})}).catch(()=>null);const P=j&&j.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${j.length})]
`+j.map(J=>{const Le=Gt.find(Ve=>Ve.id===J);return`• ${Le?Le.name:J} (#${J})`}).join(`
`):"";let R=`

[STACK TECHNIQUE OBLIGATOIRE : ${ze.toUpperCase()}]
`;ze.includes("Three.js")||ze.includes("3D GPU")?R+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être un jeu Web 3D accéléré GPU généré en **React + Vite + TypeScript (TSX) + Three.js / React Three Fiber (@react-three/fiber, @react-three/drei)**.
...
`:ze.includes("Canvas 2D")?R+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être un jeu Web 2D généré en **React + Vite + TypeScript (TSX) + Canvas 2D**.
...
`;const Y=(mt.trim()||He.trim()||`Initialisation du projet ${oe||o}`)+R+P;let $=yt;if(We===1&&($=localStorage.getItem("tiger_targetUiAi")||"stitch"),f)try{const{KirovSovereignEngine:J}=window.Capacitor.Plugins;if(J){const Le=lt($);await J.openAiTab({url:Le}),setTimeout(async()=>{await J.injectPrompt({prompt:Y,target_ai:$})},4500)}}catch{alert("Le moteur souverain mobile n'est pas encore implémenté ou le plugin est manquant.")}else if(We===2){if(await I(`${u}/api/bridge/trombone`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:o,user_prompt:Y,target_ai:$,packs:j,zip_mode:!0,start_phase:200,force_restart:!0,auto_submit:sn})}).catch(()=>null),!Ye){await I(`${u}/v1/bridge/inject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:o,prompt:"OPEN_TAB_ONLY",target_ai:$,phase_num:We})}).catch(()=>null);const J=lt($);window.open(J,"_blank")}}else if(await I(`${u}/v1/bridge/inject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:o,prompt:Y,target_ai:$,phase_num:We,packs:j})}).catch(()=>null),await I(`${u}/api/bridge/expect-zip`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:o,target_ai:$,auto_submit:sn})}).catch(()=>null),!Ye){const J=lt($);window.open(J,"_blank")}Se(null),Je(null),it(""),Re(!1),_(J=>[...J,{id:Date.now().toString(),role:"user",content:`🚀 Mission "${oe||o}" initialisée pour ${yt.toUpperCase()} avec ${j.length} pack(s) PRD. Injection du Méga-Prompt en cours...`}])}catch(u){alert("Erreur lors de la création : "+u.message)}finally{C.innerText="✅ Validé",C.disabled=!1}},className:"px-6 py-2.5 bg-gradient-to-r from-cyan to-blue-600 text-black font-black text-xs rounded-xl hover:from-cyan/80 hover:to-blue-600/80 transition-all shadow-[0_0_20px_rgba(8,179,201,0.4)] flex items-center gap-2",children:[e.jsx("span",{children:"🚀"})," Valider & Démarrer le Projet"]})]})]}):e.jsxs("div",{className:"relative flex items-center gap-2",children:[e.jsx("button",{onClick:()=>{var s;return(s=O.current)==null?void 0:s.click()},className:"design-btn-trombone transition-all opacity-80 z-20 hover:scale-110",title:"Joindre un fichier (Stitch/ZIP)",children:"📎"}),e.jsx("button",{onClick:()=>{Pe(null),pt(""),Pt([]),V("creation"),N(!0)},className:"design-btn-new-v0 font-bold flex items-center gap-1 transition-all z-20 hover:scale-105",title:"Créer un nouveau projet",children:"✨ New-v0"}),e.jsx("input",{type:"text",value:S,onChange:s=>b(s.target.value),onKeyDown:s=>s.key==="Enter"&&Fe(),placeholder:"Système v0-reponses initialisé. L'interface unique est active. Que souhaitez-vous faire ?",className:"design-chat-input w-full pl-6 pr-14 transition-all shadow-inner focus:outline-none focus:ring-1 focus:ring-cyan"}),e.jsx("button",{onClick:Fe,className:"design-btn-envoi absolute right-2 top-1/2 -translate-y-1/2 rounded-full flex items-center justify-center hover:scale-105 transition-all shadow-lg",children:e.jsx("svg",{className:"w-4 h-4 md:w-5 md:h-5 ml-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2.5",d:"M12 19l9 2-9-18-9 18 9-2zm0 0v-8"})})})]})]})]}),fe&&e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4",children:e.jsxs("div",{className:"bg-[#111] border border-white/10 rounded-2xl p-6 w-full max-w-md shadow-2xl relative",children:[e.jsx("button",{onClick:()=>Te(!1),className:"absolute top-4 right-4 text-white/50 hover:text-white transition-colors",children:"✕"}),e.jsxs("h3",{className:"text-xl font-bold mb-4 flex items-center gap-2 text-white",children:[e.jsx("span",{className:"text-2xl",children:"⏪"})," Machine à Remonter le Temps"]}),e.jsxs("p",{className:"text-sm text-slate-400 mb-6",children:["Choisissez l'une des sauvegardes ci-dessous pour restaurer votre projet à un état antérieur.",e.jsx("br",{}),e.jsx("span",{className:"text-red-400 font-bold",children:"Attention : le code actuel sera écrasé."})]}),e.jsxs("div",{className:"space-y-3",children:[ke.map(s=>e.jsxs("div",{className:"flex items-center justify-between bg-white/5 p-3 rounded-lg border border-white/10 hover:border-blue-500/50 transition-all",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-2xl",children:"📸"}),e.jsxs("div",{children:[e.jsx("div",{className:"font-bold text-sm text-blue-300",children:s.replace("backup-","")}),e.jsx("div",{className:"text-xs text-slate-500",children:"Sauvegarde Kirov"})]})]}),e.jsx("button",{onClick:()=>{window.confirm(`Confirmer la restauration de ${s} ?
Tout le travail actuel non sauvegardé sera perdu.`)&&I("http://localhost:5006/api/bridge/restore-backup",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:E,backup_name:s})}).then(c=>c?c.json():null).then(c=>{if(!c)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");c.success?(alert("✅ "+c.message),Te(!1)):alert("❌ Erreur Restauration : "+c.error)}).catch(c=>alert("Erreur réseau: "+c.message))},className:"px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold rounded-lg transition-all",children:"Restaurer"})]},s)),ke.length===0&&e.jsx("div",{className:"text-center p-4 text-slate-500 italic",children:"Aucune sauvegarde disponible."})]})]})}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
      ...
      `}})]})}function Bo({onAuthenticated:t}){const[n,r]=a.useState("login"),[l,d]=a.useState(""),[m,h]=a.useState(""),[p,_]=a.useState(""),[S,b]=a.useState(!1),[U,O]=a.useState(""),Q=async N=>{if(N.preventDefault(),O(""),n==="register"&&m!==p){O("Les mots de passe ne correspondent pas.");return}if(m.length<8){O("Le mot de passe doit contenir au moins 8 caractères.");return}b(!0);try{const V=await fetch(n==="login"?"/api/auth/login":"/api/auth/register",{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({email:l,password:m})}),x=await V.json();if(!V.ok){const w={INVALID_CREDENTIALS:"Email ou mot de passe incorrect.",TOO_MANY_ATTEMPTS:"Trop de tentatives. Réessayez dans 15 minutes.",REGISTRATION_FAILED:"Cet email est déjà utilisé.",PASSWORD_TOO_SHORT:"Mot de passe trop court (8 caractères minimum)."};O(x.error?w[x.error]??x.error:"Une erreur est survenue.");return}x.token&&localStorage.setItem("kirov5_jwt_token",x.token),t({userId:String(x.userId),email:l,isSuperAdmin:!!x.isSuperAdmin})}catch{window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?(console.warn("Mode local sans Wrangler: Bypass de la connexion pour accès UI."),localStorage.setItem("kirov5_jwt_token","dev-mock-token"),t({userId:"dev-user-001",email:l||"dev@local"})):O("Impossible de contacter le serveur. Vérifiez votre connexion.")}finally{b(!1)}};return e.jsxs("div",{style:{minHeight:"100vh",background:"linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Inter', 'Segoe UI', sans-serif",padding:"20px"},children:[e.jsx("div",{style:{position:"fixed",inset:0,overflow:"hidden",pointerEvents:"none",zIndex:0},children:[...Array(6)].map((N,L)=>e.jsx("div",{style:{position:"absolute",borderRadius:"50%",background:`rgba(${L%2===0?"139,92,246":"59,130,246"},0.08)`,width:`${200+L*80}px`,height:`${200+L*80}px`,top:`${10+L*15}%`,left:`${5+L*16}%`,filter:"blur(60px)",animation:`float ${6+L}s ease-in-out infinite alternate`}},L))}),e.jsxs("div",{style:{position:"relative",zIndex:1,width:"100%",maxWidth:"420px"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"40px"},children:[e.jsx("div",{style:{display:"inline-flex",alignItems:"center",justifyContent:"center",width:"72px",height:"72px",borderRadius:"20px",background:"linear-gradient(135deg, #8b5cf6, #3b82f6)",marginBottom:"20px",boxShadow:"0 0 40px rgba(139,92,246,0.4)",fontSize:"32px"},children:"⚡"}),e.jsx("h1",{style:{margin:0,fontSize:"28px",fontWeight:800,background:"linear-gradient(135deg, #a78bfa, #60a5fa)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",letterSpacing:"-0.5px"},children:"Kirov5 Sovereign Forge"}),e.jsx("p",{style:{color:"rgba(255,255,255,0.4)",marginTop:"8px",fontSize:"14px"},children:"Plateforme de génération d'applications IA"})]}),e.jsxs("div",{style:{background:"rgba(255,255,255,0.04)",backdropFilter:"blur(20px)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"24px",padding:"36px",boxShadow:"0 25px 50px rgba(0,0,0,0.4)"},children:[e.jsx("div",{style:{display:"flex",background:"rgba(0,0,0,0.3)",borderRadius:"12px",padding:"4px",marginBottom:"28px"},children:["login","register"].map(N=>e.jsx("button",{onClick:()=>{r(N),O("")},style:{flex:1,padding:"10px",borderRadius:"10px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:600,transition:"all 0.2s ease",background:n===N?"linear-gradient(135deg, #8b5cf6, #3b82f6)":"transparent",color:n===N?"#fff":"rgba(255,255,255,0.4)"},children:N==="login"?"🔑 Connexion":"✨ Inscription"},N))}),e.jsxs("form",{onSubmit:Q,children:[e.jsxs("div",{style:{marginBottom:"16px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Adresse email"}),e.jsx("input",{type:"email",value:l,onChange:N=>d(N.target.value),required:!0,autoComplete:"email",placeholder:"vous@exemple.com",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box",transition:"border-color 0.2s"},onFocus:N=>N.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:N=>N.target.style.borderColor="rgba(255,255,255,0.1)"})]}),e.jsxs("div",{style:{marginBottom:n==="register"?"16px":"24px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Mot de passe"}),e.jsx("input",{type:"password",value:m,onChange:N=>h(N.target.value),required:!0,autoComplete:n==="login"?"current-password":"new-password",placeholder:n==="register"?"8 caractères minimum":"••••••••",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box"},onFocus:N=>N.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:N=>N.target.style.borderColor="rgba(255,255,255,0.1)"})]}),n==="register"&&e.jsxs("div",{style:{marginBottom:"24px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Confirmer le mot de passe"}),e.jsx("input",{type:"password",value:p,onChange:N=>_(N.target.value),required:!0,autoComplete:"new-password",placeholder:"••••••••",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box"},onFocus:N=>N.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:N=>N.target.style.borderColor="rgba(255,255,255,0.1)"})]}),U&&e.jsxs("div",{style:{background:"rgba(239,68,68,0.12)",border:"1px solid rgba(239,68,68,0.3)",borderRadius:"10px",padding:"12px 16px",marginBottom:"16px",color:"#fca5a5",fontSize:"13px",display:"flex",alignItems:"center",gap:"8px"},children:[e.jsx("span",{children:"⚠️"})," ",U]}),e.jsx("button",{type:"submit",disabled:S,style:{width:"100%",padding:"14px",borderRadius:"12px",border:"none",background:S?"rgba(139,92,246,0.4)":"linear-gradient(135deg, #8b5cf6, #3b82f6)",color:"#fff",fontSize:"15px",fontWeight:700,cursor:S?"not-allowed":"pointer",transition:"all 0.2s ease",boxShadow:S?"none":"0 4px 20px rgba(139,92,246,0.4)"},children:S?"⏳ Chargement...":n==="login"?"🚀 Se connecter":"✨ Créer mon compte"})]}),e.jsx("p",{style:{textAlign:"center",marginTop:"20px",fontSize:"12px",color:"rgba(255,255,255,0.25)"},children:"🔒 Connexion sécurisée — Vos données sont chiffrées"})]})]}),e.jsx("style",{children:`
        @keyframes float {
          from { transform: translateY(0px) scale(1); }
          to { transform: translateY(-30px) scale(1.05); }
        }
        input::placeholder { color: rgba(255,255,255,0.25); }
      `})]})}function zo(){const[t,n]=a.useState(null),[r,l]=a.useState(!0);a.useEffect(()=>{(async()=>{try{const h=localStorage.getItem("kirov5_jwt_token");if(!h){n(null),l(!1);return}const p=await fetch("/api/auth/session",{headers:{Authorization:`Bearer ${h}`}});if(p.ok){const _=await p.json();_.authenticated?n({userId:String(_.userId||"user"),email:_.email||"user@cloud",isSuperAdmin:!!_.isSuperAdmin}):(localStorage.removeItem("kirov5_jwt_token"),n(null))}else localStorage.removeItem("kirov5_jwt_token"),n(null)}catch{const h=localStorage.getItem("kirov5_jwt_token");h&&h.startsWith("dev-")?n({userId:"dev-user-001",email:"dev@kirov5.local",isSuperAdmin:!0}):n(null)}finally{l(!1)}})()},[]);const d=()=>{localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{}),n(null)};return r?e.jsx("div",{style:{minHeight:"100vh",background:"linear-gradient(135deg, #0f0c29, #302b63, #24243e)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"Inter, sans-serif"},children:e.jsxs("div",{style:{textAlign:"center",color:"rgba(255,255,255,0.6)"},children:[e.jsx("div",{style:{fontSize:"48px",marginBottom:"16px"},children:"⚡"}),e.jsx("div",{style:{fontSize:"14px"},children:"Initialisation du Studio Kirov5..."})]})}):t?e.jsx(Vo,{user:t,onLogout:d}):e.jsx(Bo,{onAuthenticated:m=>n(m)})}bs.createRoot(document.getElementById("root")).render(e.jsx(Tt.StrictMode,{children:e.jsx(zo,{})}));export{Pn as E,os as W,Ua as b};

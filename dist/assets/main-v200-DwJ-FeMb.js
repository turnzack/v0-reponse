const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-DJvXoc6X.js","assets/design-v200-DNEogQpL.js","assets/design-v200-C8HtVSRB.css"])))=>i.map(i=>d[i]);
import{r as a,a as At,j as e,s as C,i as us,R as ps}from"./design-v200-DNEogQpL.js";const ms="modulepreload",gs=function(t){return"/"+t},Nn={},Xt=function(n,r,o){let d=Promise.resolve();if(r&&r.length>0){let m=function(v){return Promise.all(v.map(x=>Promise.resolve(x).then(D=>({status:"fulfilled",value:D}),D=>({status:"rejected",reason:D}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),y=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));d=m(r.map(v=>{if(v=gs(v),v in Nn)return;Nn[v]=!0;const x=v.endsWith(".css"),D=x?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${v}"]${D}`))return;const w=document.createElement("link");if(w.rel=x?"stylesheet":ms,x||(w.as="script"),w.crossOrigin="",w.href=v,y&&w.setAttribute("nonce",y),document.head.appendChild(w),x)return new Promise((W,N)=>{w.addEventListener("load",W),w.addEventListener("error",()=>N(new Error(`Unable to preload CSS for ${v}`)))})}))}function p(m){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=m,window.dispatchEvent(u),!u.defaultPrevented)throw m}return d.then(m=>{for(const u of m||[])u.status==="rejected"&&p(u.reason);return n().catch(p)})},hs=`# undefined
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qa=a.forwardRef(({color:t="currentColor",size:n=24,strokeWidth:r=2,absoluteStrokeWidth:o,className:d="",children:p,iconNode:m,...u},y)=>a.createElement("svg",{ref:y,...Ma,width:n,height:n,stroke:t,strokeWidth:o?Number(r)*24/Number(n):r,className:ss("lucide",d),...u},[...m.map(([v,x])=>a.createElement(v,x)),...Array.isArray(p)?p:[p]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
L'orchestrateur prend le relais pour générer le Backend et intégrer les composants.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(A=>{console.error(A),alert("Erreur: Le moteur n'a pas pu être contacté.")});return}typeof window<"u"&&(window.open("https://stitch.withgoogle.com/","_blank"),window.dispatchEvent(new CustomEvent("open-mouchard")));const Q=window.KIROV_SELECTED_PACKS&&window.KIROV_SELECTED_PACKS.length>0?window.KIROV_SELECTED_PACKS:F&&F.length>0?F:[];if(Number(_)===0){C("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:b,target_ai:"stitch",start_index:1,zip_mode:!0,start_phase:0,auto_pilot:W,instructions:Gt||"Génère l'application avec ces packs et directives.",packs:Q})}).then(A=>A?A.json():null).then(A=>{var et;const ue=(A==null?void 0:A.prompt)||((et=A==null?void 0:A.data)==null?void 0:et.prompt)||"Génération UI/UX Stitch complète.",we=Q.length>0?Q.join(", "):"standard";if(P(2),typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase","2"),typeof document<"u"){const Pe=document.getElementById("tiger-mega-prompt-overlay");Pe&&Pe.remove();const He=document.createElement("div");He.id="tiger-mega-prompt-overlay",He.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);backdrop-filter:blur(10px);z-index:999999;display:flex;align-items:center;justify-content:center;padding:16px;font-family:sans-serif;",He.innerHTML=`
                              ...
                              `,document.body.appendChild(He);const mt=document.getElementById("tiger-prompt-area"),Re=document.getElementById("btn-copy-prompt"),gt=document.getElementById("btn-close-prompt-overlay"),Ne=document.getElementById("btn-open-stitch"),s=()=>{mt&&(mt.select(),mt.setSelectionRange(0,99999),document.execCommand("copy")),navigator.clipboard&&navigator.clipboard.writeText(ue).catch(()=>{}),P(2),Re&&(Re.innerHTML="✅ COPIÉ DANS LE PRESSE-PAPIER !",Re.style.background="linear-gradient(135deg,#10b981,#059669)",setTimeout(()=>{Re&&(Re.innerHTML="📋 COPIER LE MÉGA-PROMPT",Re.style.background="linear-gradient(135deg,#06b6d4,#2563eb)")},3e3))};Re&&(Re.onclick=()=>{s(),P(2)}),gt&&(gt.onclick=()=>{He.remove(),P(2)}),Ne&&(Ne.onclick=()=>{window.open("https://stitch.withgoogle.com/","_blank"),P(2)}),s(),P(2)}}).catch(A=>{console.error(A),alert("Erreur de communication avec le serveur Kirov5.")});return}C("/api/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:"stitch",user_prompt:Gt||"Génère l'application avec ces packs et directives.",packs:Q,target_project:b,phase_num:1})}).then(A=>A?A.json():null).then(A=>{var we;const ue=(A==null?void 0:A.prompt)||((we=A==null?void 0:A.data)==null?void 0:we.prompt)||"Génération UI/UX Stitch.";typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText(ue).catch(()=>{}),alert(`🚀 PHASE 1 (STITCH UI/UX) INITIALISÉE !
...
Spécifications techniques du pack Guest ${_.name}.`})}},className:"design-prd-btn text-purple-400 text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-purple-500/30 transition-all",children:[e.jsx("span",{children:"📖"})," README →"]})]})]},P)})}):e.jsx(Ut,{items:Lt.map(_=>{const P=_.id,F=_.name,S=_.icon||rs,M=t?t.includes(P):!1,O=(v[P]||dn(P)||"Spécifications techniques du contrat PRD.").replace(/^#+.*$/gm,"").replace(/^>.*$/gm,"").replace(/\[([^\]]+)\]\([^\)]+\)/g,"$1").replace(/[*_~`]/g,"").trim().split(`
`).map(ee=>ee.trim()).filter(ee=>ee.length>20),X=O.length>0?O[0]:"Spécifications techniques du contrat PRD.",V=X.length>180?X.substring(0,180)+"...":X;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${M?"border-cyan shadow-[0_0_25px_rgba(8,179,201,0.4)]":"border-white/10 hover:border-cyan/50"}`,style:{background:r?o("prd-card-"+P,.7):"rgba(0,0,0,0.7)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${M?"bg-cyan text-black shadow-md":_.color||"bg-cyan/20 text-cyan"}`,children:e.jsx(S,{size:20})}),e.jsx("span",{className:"px-2 py-0.5 bg-cyan/20 text-cyan text-[10px] font-bold rounded-md uppercase tracking-wider",children:"💎 PRD"})]}),n&&e.jsx("button",{onClick:ee=>{ee.stopPropagation(),n(P)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${M?"bg-cyan text-black shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-white/20 hover:text-white"}`,title:M?"Désélectionner ce pack":"Sélectionner ce pack pour l'IA",children:M?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight",children:F}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed",children:V}),e.jsxs("div",{className:"mt-auto pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-mono text-cyan/80",children:"MODULE PRD"}),e.jsxs("button",{onClick:async()=>{var $;let ee=v[P]||dn(P)||"";try{const oe=await C(`http://localhost:5006/api/bridge/read-file?packId=${encodeURIComponent(P)}`);if(oe&&oe.ok){const fe=await oe.json(),q=fe.content||(($=fe.data)==null?void 0:$.content);q&&q.trim().length>5&&(ee=q,x(te=>({...te,[P]:q})))}}catch(oe){console.warn("API Bridge read fallback",oe)}z({packId:P,packName:F,readmeText:ee||`# 💎 PRD PACK : ${F} (${P})

### ⚙️ Spécifications techniques du contrat PRD

- **Identifiant Pack**: ${P}
- **Statut**: Actif & Intégré au Moteur Sovereign`})},className:"design-prd-btn text-cyan text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-cyan/30 transition-all hover:bg-cyan/10",children:[e.jsx("span",{children:"📖"})," Lire le README →"]})]})]},P)})})})})]})},Kn=({isClient:t,getCachedGradient:n,setActiveProject:r})=>{const[o,d]=a.useState([]),[p,m]=a.useState(!0),[u,y]=a.useState(!1),[v,x]=a.useState(null),D=(w=!1)=>{w?y(!0):m(!0);const W=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];C("http://localhost:5006/api/projects").then(N=>N?N.json():null).then(N=>{if(N&&N.success&&N.projects)d(N.projects.map((G,z)=>({name:typeof G=="string"?G:G.projectName||G.name||G.projectId,desc:"Environnement Local",bg:W[z%W.length],installed:G.installed}))),m(!1),y(!1);else{const G=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:G?{Authorization:`Bearer ${G}`}:{}}).then(z=>z?z.json():null).then(z=>{z&&z.projects&&d(z.projects.map((_,P)=>({name:_.project_id||_.title,desc:"SaaS Cloud (Neon DB)",bg:W[P%W.length]}))),m(!1),y(!1)}).catch(()=>{m(!1),y(!1)})}}).catch(()=>{m(!1),y(!1)})};return a.useEffect(()=>{D();const w=setInterval(()=>D(!0),5e3);return()=>clearInterval(w)},[]),p?e.jsx("div",{className:"p-4 text-cyan text-sm italic",children:"Actualisation de la liste des projets..."}):o.length===0?e.jsxs("div",{className:"p-4 flex flex-col items-center gap-3 text-center",children:[e.jsx("div",{className:"text-cyan text-sm italic",children:"Aucun projet trouvé sur votre disque dur."}),e.jsx("button",{onClick:()=>D(),className:"px-4 py-2 rounded-xl bg-cyan/20 border border-cyan/40 text-cyan text-xs font-bold hover:bg-cyan/40 transition-colors",children:"🔄 Rafraîchir la liste"})]}):e.jsx(Ut,{items:[...o.map((w,W)=>{const N=async()=>{x(w.name),r(w.name);try{window.dispatchEvent(new CustomEvent("open-mouchard")),await C(`http://localhost:5006/api/projects/${encodeURIComponent(w.name)}/launch-design`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:w.name,open_explorer:!1})}).catch(z=>console.error("Erreur de lancement :",z))}catch(z){console.error("Erreur de lancement :",z)}finally{setTimeout(()=>x(null),2e3)}},G=async z=>{if(z.preventDefault(),z.stopPropagation(),window.confirm(`⚠️ SUPPRESSION DEFINITIVE :
Voulez-vous vraiment supprimer le projet "${w.name}" de l'interface ET de votre disque dur ?`))try{const _=await C("http://localhost:5006/api/projects/remove-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:w.name})});if(!_){d(F=>F.filter(S=>S.name!==w.name));return}const P=await _.json();P.success?d(F=>F.filter(S=>S.name!==w.name)):alert(`Erreur lors de la suppression : ${P.message||"Échec server"}`)}catch(_){alert(`Erreur réseau lors de la suppression : ${_.message}`)}};return e.jsxs("div",{className:"design-carte-carrousel rounded-2xl p-5 border border-white/20 shadow-xl flex flex-col items-center text-center relative overflow-hidden group cursor-pointer",style:{background:t?n("proj-"+W,.7):"rgba(0,0,0,0.5)"},onClick:N,children:[e.jsx("button",{onClick:G,className:"z-20 absolute top-3 right-3 w-8 h-8 rounded-full bg-red-600/80 hover:bg-red-500 text-white font-bold text-xs flex items-center justify-center transition-all shadow-lg hover:scale-110 cursor-pointer",title:"Supprimer ce projet du disque dur et de l'interface",children:"🗑️"}),e.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-30 mix-blend-overlay pointer-events-none"}),e.jsx("div",{className:"absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors z-0"}),e.jsxs("div",{className:"z-10 relative pointer-events-none w-full pr-8",children:[e.jsx("div",{className:"text-white/70 text-xs font-bold uppercase tracking-widest drop-shadow-md",children:"PROJET"}),e.jsx("h3",{className:"design-carte-titre text-xl font-black text-white break-all drop-shadow-lg leading-tight w-full",children:w.name})]}),e.jsx("div",{className:"design-carte-desc z-10 relative text-sm text-white/90 font-medium drop-shadow-md pointer-events-none w-full",children:w.desc}),e.jsxs("div",{className:"z-10 flex items-center gap-2 mt-3",children:[e.jsx("button",{onClick:z=>{z.stopPropagation(),v!==w.name&&(w.installed===!1?(x(w.name),C("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:w.name})}).then(_=>{alert(_?"L'installation a démarré dans le terminal (Suture) ! Une fois terminée, vous pourrez lancer la Preview.":"Mode Cloud SaaS : Bridge local non connecté."),x(null),d(P=>P.map(F=>F.name===w.name?{...F,installed:!0}:F))}).catch(()=>x(null))):N())},disabled:v===w.name,className:`font-bold py-2 px-4 rounded-xl text-xs transition-all flex items-center gap-1.5 ${v===w.name?"bg-cyan-500/40 text-cyan-200 cursor-wait animate-pulse":w.installed===!1?"bg-orange-500/80 hover:bg-orange-600 text-white cursor-pointer":"bg-white/20 hover:bg-white/40 text-white cursor-pointer"}`,title:w.installed===!1?"Installer les dépendances requises pour ce projet":"Lancer la prévisualisation Vite",children:v===w.name?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin inline-block",children:"⏳"})," ",w.installed===!1?"Installation...":"Lancement..."]}):w.installed===!1?e.jsx(e.Fragment,{children:"📦 INSTALL"}):e.jsx(e.Fragment,{children:"🚀 PREVIEW"})}),w.installed!==!1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:z=>{z.stopPropagation(),x(w.name),C("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:w.name})}).then(_=>{alert(_?"Réinstallation démarrée dans le terminal !":"Mode Cloud SaaS : Bridge local non connecté."),x(null)}).catch(()=>x(null))},className:"bg-orange-500/30 hover:bg-orange-500/60 text-white font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center justify-center border border-orange-500/40",title:"Forcer la réinstallation des dépendances (npm install)",children:"🔄"}),e.jsx("button",{onClick:async z=>{z.stopPropagation();try{const _=await C("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:w.name})});if(!_){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const P=await _.json();alert(P.message||"Terminal ouvert !")}catch(_){alert("Erreur de connexion au bridge: "+_.message)}},className:"font-bold py-2 px-3 rounded-xl text-xs bg-purple-500/60 hover:bg-purple-500 text-white transition-all shadow-md",title:"Lancer manuellement avec pnpm run dev (ouvre un terminal)",children:"💻 PNPM"})]}),e.jsx("button",{onClick:G,className:"bg-red-600/30 hover:bg-red-600/60 text-red-200 border border-red-500/40 font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center gap-1",title:"Supprimer définitivement du disque dur",children:"🗑️ Supprimer"})]})]},W)})]})};function Mo({user:t,onLogout:n}={}){var Ne;const r=a.useRef({}),o=(s,l=1)=>typeof window>"u"?`linear-gradient(135deg, rgba(17,17,17,${l}), rgba(34,34,34,${l}))`:(r.current[s]||(r.current[s]=Ro(l)),r.current[s]),d=(t==null?void 0:t.email)||(typeof window<"u"?localStorage.getItem("tiger_currentUserEmail"):null),p=!!(t!=null&&t.isSuperAdmin||d&&d.toLowerCase().trim()==="zacktunr@gmail.com");a.useEffect(()=>{t!=null&&t.email&&typeof window<"u"&&localStorage.setItem("tiger_currentUserEmail",t.email)},[t]);const m=()=>{typeof window<"u"&&(localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),localStorage.removeItem("tiger_lastGeneratedProject"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{})),n?n():typeof window<"u"&&window.location.reload()},[u,y]=a.useState([]),[v,x]=a.useState(""),D=a.useRef(null),w=a.useRef(null),[W,N]=a.useState(!1),[G,z]=a.useState("connexion"),[_,P]=a.useState(!1),[F,S]=a.useState("clean");a.useRef(0);const[M,H]=a.useState(1),[j,O]=a.useState(!1),[X,V]=a.useState(!1),[ee,$]=a.useState(!1);a.useEffect(()=>{let s=0;const l=setInterval(()=>{var c,k;if(typeof window<"u"){const h=(k=(c=window.Capacitor)==null?void 0:c.isNativePlatform)==null?void 0:k.call(c),f=!!window.AndroidBridge;(h||f)&&(V(!0),clearInterval(l))}s++>10&&clearInterval(l)},100);return()=>clearInterval(l)},[]);const[oe,fe]=a.useState([]),[q,te]=a.useState(""),[pe,he]=a.useState(["> Système Kirov5 initialisé. "+new Date().toLocaleTimeString()]),[ye,ie]=a.useState([]),[T,K]=a.useState([]);a.useEffect(()=>{const s=l=>K(l.detail);return window.addEventListener("update_kirov_packs",s),()=>window.removeEventListener("update_kirov_packs",s)},[]),a.useEffect(()=>{window.KIROV_SELECTED_PACKS=T},[T]);const[I,J]=a.useState(!1),[ne,_e]=a.useState(!1),[be,Yt]=a.useState([]),[Pt,$e]=a.useState(!1),[qe,ce]=a.useState(""),[xt,Gt]=a.useState(""),[en,st]=a.useState(!1),[me,Tt]=a.useState(""),[Le,En]=a.useState("Vite + React + Tailwind + TS"),[lt,gn]=a.useState(""),[ft,kt]=a.useState("deepseek"),[Ue,tn]=a.useState(""),[nn,Rn]=a.useState(!0),[sn,rn]=a.useState(!1),[ct,bt]=a.useState(null),[rt,vt]=a.useState(!1),[We,Je]=a.useState("idle"),[jt,Xe]=a.useState([]),[St,Vt]=a.useState(""),[hn,Et]=a.useState(null);a.useEffect(()=>{let s;return We==="building"&&(s=setInterval(async()=>{try{const l=await C("http://localhost:5006/api/mobile/build-logs");if(l&&l.ok){const c=await l.json();c.logs&&c.logs.length>0&&Xe(c.logs),c.isBuilding===!1&&c.result&&(c.result.success?(Je("success"),Et(c.result.apkUrl)):Je("error"),clearInterval(s))}}catch(l){console.warn("Polling APK error",l)}},1e3)),()=>{s&&clearInterval(s)}},[We]);const[Bt,it]=a.useState([]),[xn,ge]=a.useState(!1),zt=a.useCallback(async s=>{ge(!0);const l=[{id:"deepseek-r1-v0",tag:"⚡ DEEPSEEK R1",title:"DeepSeek-R1 & Moteur Souverain v0.1",desc:"Capacités de raisonnement avancé et de suture pour interfaces React.",content:`DeepSeek-R1 offre des capacités de raisonnement avancé pour l'analyse de contrats PRD et la génération zéro-touch de projets web complets.
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){it(l),ge(!1);return}const c=s||localStorage.getItem("tiger_apiKey");if(!c||!c.startsWith("sk-")||c.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){it(l),ge(!1);return}const k=new AbortController,h=setTimeout(()=>k.abort(),4e3),f=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${c}`},signal:k.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(h),f.ok){const R=await f.json(),B=JSON.parse(R.choices[0].message.content);B.news&&Array.isArray(B.news)&&B.news.length>0?it(B.news):it(l)}else f.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),it(l)}catch(c){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",c),it(l)}finally{ge(!1)}},[]);a.useEffect(()=>{zt()},[zt]);const[at,yt]=a.useState(!1),[Oe,Rt]=a.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Ce,Ve]=a.useState([]),[Se,Nt]=a.useState("");a.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let l=JSON.parse(s);if(!Array.isArray(l))throw new Error("Not an array");const c="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";l=l.map(k=>k.name==="fold"?{...k,colors:{...k.colors,"bg-app":c}}:k),Ve(l)}catch{Ve([])}else{const l={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};Ve([l]),localStorage.setItem("tiger_saved_themes",JSON.stringify([l]))}},[]),a.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",Oe),Oe!=="random"){const l=((s=Ce.find(c=>c.name===Oe))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=l,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[Oe,Ce]);const an=()=>{if(!Se.trim())return alert("Nom invalide");if(Ce.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":o("icon-settings",.8),"icon-ai":o("icon-ai",.8),"icon-projects":o("icon-projects",.8),"icon-packs":o("icon-packs",.8),"icon-news":o("icon-news",.8),"bg-app":o("bg-app",.9)},l={name:Se.trim(),colors:s},c=[...Ce,l];Ve(c),localStorage.setItem("tiger_saved_themes",JSON.stringify(c)),Rt(l.name),Nt("")},Be=(s,l)=>{l.stopPropagation();const c=Ce.filter(k=>k.name!==s);Ve(c),localStorage.setItem("tiger_saved_themes",JSON.stringify(c)),Oe===s&&Rt("random")},Ht=s=>{K(l=>l.includes(s)?l.filter(c=>c!==s):[...l,s])},[Fe,Dt]=a.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});a.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(Fe))},[Fe]);const[dt,Kt]=a.useState(!0),[Qe,_t]=a.useState(!0),[U,Ae]=a.useState(null),[Ct,fn]=a.useState(null),[Ie,$t]=a.useState(null),[de,Ze]=a.useState(null),[It,ut]=a.useState(""),[ze,Mt]=a.useState([]);a.useEffect(()=>{C("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))ie(s.projects.map(l=>({name:l,desc:"Projet local",bg:""})));else{const l=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:l?{Authorization:`Bearer ${l}`}:{}}).then(c=>c?c.json():null).then(c=>{c&&c.projects&&ie(c.projects.map(k=>({name:k.project_id||k.title,desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[Ge,je]=a.useState(null),[wt,pt]=a.useState(""),[Ee,on]=a.useState(!1),[Ye,ot]=a.useState(!1),i=a.useRef(null);a.useEffect(()=>{if(i.current=null,U==="v0-guest"||U==="V0-Guest")ot(!0),je("http://localhost:3007"),pt("http://localhost:3007"),i.current="http://localhost:3007";else if(U){ot(!0);const l=Ie&&JSON.stringify(Ie).includes("next.config")?"http://localhost:3000":"http://127.0.0.1:5175";je(l),pt(l),i.current=l}else ot(!1),je(null)},[U,Ie]),a.useEffect(()=>{const s=l=>{var c,k,h,f;if(((c=l.data)==null?void 0:c.type)==="CHANGE_PREVIEW_URL"){const R=l.data.route,B=R==="/"?"":`#${R}`;je(se=>{const Z=se?se.split("#")[0]:"http://127.0.0.1:5175/";return`${Z.endsWith("/")?Z:`${Z}/`}${B}`})}if(((k=l.data)==null?void 0:k.type)==="DESIGN_ELEMENT_CLICKED"||((h=l.data)==null?void 0:h.type)==="DESIGN_ELEMENT_DRAGGED"||((f=l.data)==null?void 0:f.type)==="DESIGN_ELEMENT_RESIZED"){const R=document.querySelector('iframe[title="Studio Admin Design"]');R&&R.contentWindow&&R.contentWindow.postMessage(l.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),a.useEffect(()=>{U&&C(`http://localhost:5006/api/fs/tree?project=${U}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&$t(s.tree)}).catch(()=>{})},[U]),a.useEffect(()=>{U&&de&&C(`http://localhost:5006/api/fs/read?project=${U}&file=${encodeURIComponent(de)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&ut(s.content)}).catch(()=>{})},[U,de]);const g=async s=>{if(s===void 0||!U||!de)return;if(ut(s),Ft.isNativePlatform()||!!window.AndroidBridge)try{await Vn.writeFile({path:`v0-moteur-mobile/projetv0/${U}/${de}`,data:s,directory:pn.Documents,encoding:In.UTF8,recursive:!0})}catch(c){console.error("Erreur de sauvegarde mobile:",c)}else C("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:U,file:de,content:s})}).catch(()=>{})},b=s=>{U&&C(`http://localhost:5006/api/fs/read?project=${U}&file=${encodeURIComponent(s)}`).then(l=>l?l.json():null).then(l=>{l&&l.success&&Mt(c=>c.find(k=>k.path===s)?c:[...c,{path:s,content:l.content}])}).catch(()=>{})};a.useEffect(()=>{(async()=>{const l=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(Ft.isNativePlatform()||!!window.AndroidBridge)try{const h=(await Vn.readdir({path:"v0-moteur-mobile/projetv0",directory:pn.Documents})).files.map(f=>f.name||f.toString());ie(h.map((f,R)=>({name:f,desc:"Mémoire Téléphone",bg:l[R%l.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else C("http://localhost:5006/api/projects-v2").then(k=>k?k.json():null).then(k=>{if(k&&k.success&&k.projects)ie(k.projects.map((h,f)=>({name:h.name,desc:"Environnement Local",bg:l[f%l.length],installed:h.installed})));else{const h=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:h?{Authorization:`Bearer ${h}`}:{}}).then(f=>f?f.json():null).then(f=>{f&&f.projects&&ie(f.projects.map((R,B)=>({name:R.project_id||R.title,desc:"SaaS Cloud (Neon DB)",bg:l[B%l.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),a.useEffect(()=>{O(!0)},[]);const[E,Q]=a.useState(!0);a.useEffect(()=>{const s=()=>Q(!0);window.addEventListener("open-mouchard",s);const l=c=>{if(c.data&&c.data.type==="TIGER_CAPTURE"){const k=c.data.data;if(k){let h="index.html";(k.includes("import React")||k.includes("export default"))&&(h="App.tsx"),k.includes("tailwindcss")&&(h="index.css"),Ze(h),g(k),$t(f=>{var se;const R={name:h,path:h,type:"file"};return f?((se=f.children)==null?void 0:se.find(Z=>Z.name===h))?f:{...f,children:[...f.children||[],R]}:{name:"Mobile_Storage",type:"directory",children:[R]}})}}};return window.addEventListener("message",l),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("message",l)}},[U,de]),a.useEffect(()=>{if(!j)return;const s=()=>{C("http://localhost:5006/api/bridge/queue").then(c=>c?c.json():null).then(c=>{c&&c.success&&(setBridgeQueueData({current:c.current||{},queue:c.queue||[]}),(c.queue&&c.queue.length>0||c.current&&Object.keys(c.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),C("http://localhost:5006/api/bridge/logs").then(c=>c?c.json():null).then(c=>{if(c&&c.success&&c.logs){he(c.logs);const k=[...c.logs].reverse().find(h=>h.includes("URL_PREVIEW="));if(k){const h=k.split("URL_PREVIEW=")[1];h!==i.current&&(i.current=h,je(h),pt(h))}}}).catch(()=>{}),C("http://localhost:5006/api/bridge/autonomous-status").then(c=>c?c.json():null).then(c=>{if(c&&c.success&&(c.data||c.status)){const h=(c.data||c.status).state;h==="diagnosing"||h==="repair_required"||h==="error"?S("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(h)||["starting_server","launch_requested","restarting"].includes(h)?S("working"):h==="ready"?S("clean"):U&&C(`http://localhost:5006/api/suture/status?project=${U}`).then(f=>f?f.json():null).then(f=>{f&&f.success&&f.status&&S(f.status)}).catch(()=>{})}}).catch(()=>{})};s();const l=setInterval(s,2e3);return()=>clearInterval(l)},[j,U]);const A=s=>{const l=typeof s=="string"?s:v;if(!l.trim())return;const c={id:Date.now().toString(),role:"user",content:l};y(h=>[...h,c]);const k=l.toLowerCase();setTimeout(()=>{let h={id:(Date.now()+1).toString(),role:"assistant",content:""};const f=k.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(f==="mes projets"||f.includes("liste des projet")||f==="projet"||f==="projets")h.content="Voici la liste de vos projets récents :",h.widget="projects";else if((f.includes("stitch")||f.includes("deepseek")||f.includes("design")||f.includes("logique"))&&(f.includes("modifi")||f.includes("ajoute")||f.includes("change")||f.includes("mise a jour")||f.includes("evolue")||f.includes("reprends")||f.includes("continue"))){const R=l.match(/\[(.*?)\]/),B=R?R[1]:null,se=f.includes("deepseek")?"deepseek":"stitch";h.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${se.toUpperCase()}) 🔄

J'injecte vos nouvelles directives directement dans votre interface... ${B?`
🔍 Recherche et AutoSwitch vers le projet : "${B}"`:"Reprise du travail en cours."}`,h.widget=null,C("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:se,target_project:B,prompt:"Mise à jour (Reprise de projet) : "+l.replace(/\[.*?\]/,"").trim(),auto_submit:!0})}).catch(Z=>console.log("Erreur de connexion au Bridge local pour l'injection",Z))}else if(f.includes("cree")||f.includes("lance")||f.includes("projet")||f.includes("generation")){h.content=`🚀 DÉMARRAGE PARALLÈLE KIROV5 🚀
...
\`\`\``,y(h=>[...h,{id:Date.now().toString()+"_action",role:"assistant",content:`🩺 Suture & Correction déclenchée pour "${U}". Transmission de l'erreur à ${c.toUpperCase()} en cours...`}]);try{if(await C("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:c,prompt:k,auto_submit:!0,project_id:U,phase_num:s})}),s==="suture"){C("http://localhost:5006/v1/suture/start",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:U,activeFile:de||"",rawError:l||"",prompt:l||"Analyse et corrige les erreurs du projet."})}).then(async f=>{const R=await f.json();R.success&&R.status==="applied"?y(B=>{var se,Z;return[...B,{id:Date.now().toString()+"_suture_ok",role:"assistant",content:`✅ Suture V2 réussie !

🔧 ${R.repairId}
🚀 Statut : **Patch appliqué en production**
📁 Fichiers corrigés : ${JSON.stringify(((Z=(se=R.patchReport)==null?void 0:se.files)==null?void 0:Z.map(Y=>Y.path))||[])}`}]}):R.success?y(B=>{var se;return[...B,{id:Date.now().toString()+"_suture_partial",role:"assistant",content:`⚠️ Suture V2 : correctif généré mais non promu.

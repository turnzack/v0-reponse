...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){lt(l),Lt(!1);return}const c=s||localStorage.getItem("tiger_apiKey");if(!c||!c.startsWith("sk-")||c.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){lt(l),Lt(!1);return}const P=new AbortController,h=setTimeout(()=>P.abort(),4e3),f=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${c}`},signal:P.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(h),f.ok){const E=await f.json(),B=JSON.parse(E.choices[0].message.content);B.news&&Array.isArray(B.news)&&B.news.length>0?lt(B.news):lt(l)}else f.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),lt(l)}catch(c){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",c),lt(l)}finally{Lt(!1)}},[]);o.useEffect(()=>{je()},[je]);const[Ge,_e]=o.useState(!1),[Ee,et]=o.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Ue,tt]=o.useState([]),[At,Ut]=o.useState("");o.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let l=JSON.parse(s);if(!Array.isArray(l))throw new Error("Not an array");const c="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";l=l.map(P=>P.name==="fold"?{...P,colors:{...P.colors,"bg-app":c}}:P),tt(l)}catch{tt([])}else{const l={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};tt([l]),localStorage.setItem("tiger_saved_themes",JSON.stringify([l]))}},[]),o.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",Ee),Ee!=="random"){const l=((s=Ue.find(c=>c.name===Ee))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=l,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[Ee,Ue]);const Ve=()=>{if(!At.trim())return alert("Nom invalide");if(Ue.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":a("icon-settings",.8),"icon-ai":a("icon-ai",.8),"icon-projects":a("icon-projects",.8),"icon-packs":a("icon-packs",.8),"icon-news":a("icon-news",.8),"bg-app":a("bg-app",.9)},l={name:At.trim(),colors:s},c=[...Ue,l];tt(c),localStorage.setItem("tiger_saved_themes",JSON.stringify(c)),et(l.name),Ut("")},tn=(s,l)=>{l.stopPropagation();const c=Ue.filter(P=>P.name!==s);tt(c),localStorage.setItem("tiger_saved_themes",JSON.stringify(c)),Ee===s&&et("random")},nn=s=>{K(l=>l.includes(s)?l.filter(c=>c!==s):[...l,s])},[Re,Pt]=o.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});o.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(Re))},[Re]);const[xt,Ot]=o.useState(!0),[Oe,ct]=o.useState(!0),[U,Ce]=o.useState(null),[Ft,Tt]=o.useState(null),[Ie,kt]=o.useState(null),[ce,$e]=o.useState(null),[ft,We]=o.useState(""),[dt,nt]=o.useState([]);o.useEffect(()=>{C("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))re(s.projects.map(l=>({name:l,desc:"Projet local",bg:""})));else{const l=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:l?{Authorization:`Bearer ${l}`}:{}}).then(c=>c?c.json():null).then(c=>{c&&c.projects&&re(c.projects.map(P=>({name:P.project_id||P.title,desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[st,Pe]=o.useState(null),[bt,we]=o.useState(""),[sn,Gt]=o.useState(!1),[Fe,i]=o.useState(!1),g=o.useRef(null);o.useEffect(()=>{if(g.current=null,U==="v0-guest"||U==="V0-Guest")i(!0),Pe("http://localhost:3007"),we("http://localhost:3007"),g.current="http://localhost:3007";else if(U){i(!0);const l=Ie&&JSON.stringify(Ie).includes("next.config")?"http://localhost:3000":"http://127.0.0.1:5175";Pe(l),we(l),g.current=l}else i(!1),Pe(null)},[U,Ie]),o.useEffect(()=>{const s=l=>{var c,P,h,f;if(((c=l.data)==null?void 0:c.type)==="CHANGE_PREVIEW_URL"){const E=l.data.route,B=E==="/"?"":`#${E}`;Pe(se=>{const Z=se?se.split("#")[0]:"http://127.0.0.1:5175/";return`${Z.endsWith("/")?Z:`${Z}/`}${B}`})}if(((P=l.data)==null?void 0:P.type)==="DESIGN_ELEMENT_CLICKED"||((h=l.data)==null?void 0:h.type)==="DESIGN_ELEMENT_DRAGGED"||((f=l.data)==null?void 0:f.type)==="DESIGN_ELEMENT_RESIZED"){const E=document.querySelector('iframe[title="Studio Admin Design"]');E&&E.contentWindow&&E.contentWindow.postMessage(l.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),o.useEffect(()=>{U&&C(`http://localhost:5006/api/fs/tree?project=${U}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&kt(s.tree)}).catch(()=>{})},[U]),o.useEffect(()=>{U&&ce&&C(`http://localhost:5006/api/fs/read?project=${U}&file=${encodeURIComponent(ce)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&We(s.content)}).catch(()=>{})},[U,ce]);const v=async s=>{if(s===void 0||!U||!ce)return;if(We(s),Mt.isNativePlatform()||!!window.AndroidBridge)try{await Vn.writeFile({path:`v0-moteur-mobile/projetv0/${U}/${ce}`,data:s,directory:pn.Documents,encoding:Cn.UTF8,recursive:!0})}catch(c){console.error("Erreur de sauvegarde mobile:",c)}else C("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:U,file:ce,content:s})}).catch(()=>{})},j=s=>{U&&C(`http://localhost:5006/api/fs/read?project=${U}&file=${encodeURIComponent(s)}`).then(l=>l?l.json():null).then(l=>{l&&l.success&&nt(c=>c.find(P=>P.path===s)?c:[...c,{path:s,content:l.content}])}).catch(()=>{})};o.useEffect(()=>{(async()=>{const l=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(Mt.isNativePlatform()||!!window.AndroidBridge)try{const h=(await Vn.readdir({path:"v0-moteur-mobile/projetv0",directory:pn.Documents})).files.map(f=>f.name||f.toString());re(h.map((f,E)=>({name:f,desc:"Mémoire Téléphone",bg:l[E%l.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else C("http://localhost:5006/api/projects-v2").then(P=>P?P.json():null).then(P=>{if(P&&P.success&&P.projects)re(P.projects.map((h,f)=>({name:h.name,desc:"Environnement Local",bg:l[f%l.length],installed:h.installed})));else{const h=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:h?{Authorization:`Bearer ${h}`}:{}}).then(f=>f?f.json():null).then(f=>{f&&f.projects&&re(f.projects.map((E,B)=>({name:E.project_id||E.title,desc:"SaaS Cloud (Neon DB)",bg:l[B%l.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),o.useEffect(()=>{L(!0)},[]);const[N,W]=o.useState(!0);o.useEffect(()=>{const s=()=>W(!0);window.addEventListener("open-mouchard",s);const l=c=>{if(c.data&&c.data.type==="TIGER_CAPTURE"){const P=c.data.data;if(P){let h="index.html";(P.includes("import React")||P.includes("export default"))&&(h="App.tsx"),P.includes("tailwindcss")&&(h="index.css"),$e(h),v(P),kt(f=>{var se;const E={name:h,path:h,type:"file"};return f?((se=f.children)==null?void 0:se.find(Z=>Z.name===h))?f:{...f,children:[...f.children||[],E]}:{name:"Mobile_Storage",type:"directory",children:[E]}})}}};return window.addEventListener("message",l),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("message",l)}},[U,ce]),o.useEffect(()=>{if(!k)return;const s=()=>{C("http://localhost:5006/api/bridge/queue").then(c=>c?c.json():null).then(c=>{c&&c.success&&(setBridgeQueueData({current:c.current||{},queue:c.queue||[]}),(c.queue&&c.queue.length>0||c.current&&Object.keys(c.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),C("http://localhost:5006/api/bridge/logs").then(c=>c?c.json():null).then(c=>{if(c&&c.success&&c.logs){me(c.logs);const P=[...c.logs].reverse().find(h=>h.includes("URL_PREVIEW="));if(P){const h=P.split("URL_PREVIEW=")[1];h!==g.current&&(g.current=h,Pe(h),we(h))}}}).catch(()=>{}),C("http://localhost:5006/api/bridge/autonomous-status").then(c=>c?c.json():null).then(c=>{if(c&&c.success&&(c.data||c.status)){const h=(c.data||c.status).state;h==="diagnosing"||h==="repair_required"||h==="error"?S("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(h)||["starting_server","launch_requested","restarting"].includes(h)?S("working"):h==="ready"?S("clean"):U&&C(`http://localhost:5006/api/suture/status?project=${U}`).then(f=>f?f.json():null).then(f=>{f&&f.success&&f.status&&S(f.status)}).catch(()=>{})}}).catch(()=>{})};s();const l=setInterval(s,2e3);return()=>clearInterval(l)},[k,U]);const he=s=>{const l=typeof s=="string"?s:b;if(!l.trim())return;const c={id:Date.now().toString(),role:"user",content:l};y(h=>[...h,c]);const P=l.toLowerCase();setTimeout(()=>{let h={id:(Date.now()+1).toString(),role:"assistant",content:""};const f=P.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(f==="mes projets"||f.includes("liste des projet")||f==="projet"||f==="projets")h.content="Voici la liste de vos projets récents :",h.widget="projects";else if((f.includes("stitch")||f.includes("deepseek")||f.includes("design")||f.includes("logique"))&&(f.includes("modifi")||f.includes("ajoute")||f.includes("change")||f.includes("mise a jour")||f.includes("evolue")||f.includes("reprends")||f.includes("continue"))){const E=l.match(/\[(.*?)\]/),B=E?E[1]:null,se=f.includes("deepseek")?"deepseek":"stitch";h.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${se.toUpperCase()}) 🔄
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,h.widget="phases",H(1);const E=U||(pe.trim()?pe.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+l.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(Ce(E),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",E),typeof window<"u"){const Z=localStorage.getItem("tiger_targetAi")||"deepseek",Y=localStorage.getItem("tiger_targetUiAi")||"stitch",Te=(G,de=!1)=>Xe(G,de),Ne=window.AndroidBridge;if(Ne&&Ne.openAIWithPrompt)Ne.openAIWithPrompt(Te(Y,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+l),Ne.showToast&&Ne.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const G=A&&A.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${A.length})]
`+A.map(ve=>{const ie=Rt.find(xe=>xe.id===ve);return`• ${ie?ie.name:ve} (#${ve})`}).join(`
`):"",de="Génère l'interface UI/UX complète et moderne pour ce projet : "+l+G;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(de)}catch{}const it=()=>C("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Y,prompt:de,auto_submit:!0,project_id:E,phase_num:1,packs:A})});Re!==200&&(Oe?window.open(Te(Y,!0),"kirov5_ai_target"):window.open(Te(Y,!0),"_blank"),it().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(ve=>console.error("Erreur sendUiPrompt",ve))),setTimeout(()=>{const ve=A&&A.length>0?l+G:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+l+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ve)}catch{}window.open(Te(Z),"_blank"),C("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,prompt:ve,auto_submit:!0,project_id:E,phase_num:1,packs:A})}).catch(ie=>console.log("Erreur Bridge Logic Prompt:",ie)),A&&A.length>0?C("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,user_prompt:ve,packs:A,target_project:E})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(ie=>{console.log("Erreur Trombone Bridge:",ie)}):C("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,prompt:ve,auto_submit:!0,project_id:E,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}H(1);let B=1;const se=setInterval(()=>{B++,B>11?clearInterval(se):H(B)},1500)}else if(f.includes("youtube")||f.includes("video"))h.content="Voici les résultats YouTube pour votre recherche :",h.widget="youtube";else if(f.includes("actualite")||f.includes("ia")||f.includes("news")||f.includes("recherche")){const E=localStorage.getItem("tiger_apiKey");h.content="Actualités & Dernières Innovations IA :",h.widget="news",je(E||void 0)}else if(f.includes("parametre")||f.includes("reglage")||f.includes("configuration")||f.includes("setting"))h.content="Ouverture du panneau de configuration système :",h.widget="settings";else if(f.includes("[plugin:vite:")||f.includes("missing semicolon")||f.includes("syntaxerror")||f.includes("typescriptparsermixin")||f.includes("babel/parser")||f.includes("error")&&f.length>80){const E=U||"Projet_blog_8831";h.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${E}" avec la stack trace fournie... 🩺`,Be("suture",l)}else if(h.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const E=window.AndroidBridge;E&&E.openAIWithPrompt?E.openAIWithPrompt("https://chat.deepseek.com/",l):window.open("https://chat.deepseek.com/","_blank")}y(E=>[...E,h])},600),x("")},Ae=async s=>{var Ne;let l=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],c=null;const P=l.filter(G=>G.name.endsWith(".zip"));let h=[];if(P.length>0){y(G=>[...G,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const G=(await Ht(async()=>{const{default:de}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:de}},[])).default;for(const de of P){c=de;const ve=await new G().loadAsync(de);for(const[ie,xe]of Object.entries(ve.files))if(!xe.dir&&!ie.includes("__MACOSX")&&!((Ne=ie.split("/").pop())!=null&&Ne.startsWith("."))){const ke=await xe.async("blob"),Je=new File([ke],ie.split("/").pop()||ie,{type:ke.type});h.push(Je)}}}catch(G){console.error("Erreur décompression ZIP:",G),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}}l=[...l.filter(G=>!G.name.endsWith(".zip")),...h];const f=l.filter(G=>G.name.endsWith(".html")),E=l.filter(G=>!G.name.endsWith(".html")&&(G.name.endsWith(".png")||G.name.endsWith(".jpg")||G.name.endsWith(".jpeg")||G.name.endsWith(".md")||G.name.endsWith(".json")||G.name.endsWith(".txt")));if(f.length===0&&E.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .png, ou un .zip.");return}let B=[...dt];for(const G of E){const de=G.name.endsWith(".png")||G.name.endsWith(".jpg")||G.name.endsWith(".jpeg"),it=await new Promise(ie=>{const xe=new FileReader;xe.onload=ke=>{var Je;return ie((Je=ke.target)==null?void 0:Je.result)},de?xe.readAsDataURL(G):xe.readAsText(G)}),ve={path:G.name,content:de?`[Image jointe visuellement : ${G.name} (Binaire ignoré pour économie de tokens)]`:it};B.some(ie=>ie.path===G.name)||B.push(ve),y(ie=>[...ie,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${G.name}`}])}if(f.length>0){const G=f[0],de=await new Promise(ie=>{const xe=new FileReader;xe.onload=ke=>{var Je;return ie((Je=ke.target)==null?void 0:Je.result)},xe.readAsText(G)}),it={path:G.name,content:de};B.some(ie=>ie.path===G.name)||B.push(it);const ve={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${G.name}
Analyse de la structure UI et assemblage du contexte en cours...`};y(ie=>[...ie,ve])}const se=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter(G=>G.name.endsWith(".zip"));for(const G of se)B.some(de=>de.path===G.name)||B.push({path:G.name,content:"ZIP_ARCHIVE_DUMMY"});nt(B);const Z=U||pe||"Projet_Stitch",Y=l.map(G=>G.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${Z}: ${Y}`);const Te=f.length;if(Te>3){const G=localStorage.getItem("tiger_targetAi")||"deepseek",de=c?"Projet_ZIP_"+c.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),it=U||de;U||Ce(it),y(ie=>[...ie,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !

Hermes a détecté ${Te} pages HTML dans votre ZIP.
Découpage automatique en lots de 3 fichiers en cours...
Démarrage de l'automatisation séquentielle via DeepSeek !`,widget:"phases"}]),H(1);let ve="";if(c)ve=await new Promise(ie=>{const xe=new FileReader;xe.onload=ke=>{var Je;return ie(((Je=ke.target)==null?void 0:Je.result).split(",")[1])},xe.readAsDataURL(c)});else{const ie=(await Ht(async()=>{const{default:ke}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:ke}},[])).default,xe=new ie;for(const ke of l)xe.file(ke.name,ke);ve=await xe.generateAsync({type:"base64"})}C("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({zip_base64:ve,zip_mode:!0,target_ai:G,target_project:it,user_prompt:pe.trim()?`${pe} - ${at}`:`Application multi-pages issue de ${(c==null?void 0:c.name)||"fichiers_locaux"}`})}).then(async ie=>{const xe=await ie.json();xe.success?(y(ke=>[...ke,{id:Date.now().toString()+"_hermes",role:"assistant",content:`✅ ${xe.message}

📡 Lot 1/${xe.total_batches} transmis à DeepSeek. Les lots suivants s'enchaîneront automatiquement !
Fichiers détectés : ${(xe.files_detected||[]).join(", ")}`}]),window.open(Xe(G),"_blank")):alert("Erreur Hermes : "+(xe.error||"Inconnue"))}).catch(ie=>{alert(`Erreur de connexion au Moteur Local : ${ie.message}`)});return}if(f.length>0){if(document.getElementById("creation-mode-container"))return;setTimeout(()=>{vt(B)},1200)}},vt=async(s=dt)=>{Qe(!1);const l=s.find(Z=>Z.path.endsWith(".html"));if(!l){alert("Aucun fichier HTML trouvé dans le Trombone !");return}const c=pe.trim()?"Projet_"+pe.replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4):"Design_"+l.path.replace(".html","").replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4),P=U||c;if(!U){Ce(P);try{await C("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:P,file:"README.md",content:`# ${pe||P}

Initialisé par Tiger IA V0 (Design-First).`})})}catch(Z){console.error("[IDE] Erreur création auto du dossier",Z)}}const h=s.filter(Z=>Z.path!==l.path),f=l.content,E={id:(Date.now()+1).toString(),role:"assistant",content:`Mode "Design-First" activé. 🎨

Transmission du design au LLM avec les ${h.length} fichiers du Trombone intégrés.
Câblage en cours...`,widget:"phases"};H(5),y(Z=>[...Z,E]);let B=5;const se=setInterval(()=>{B++,B>11?clearInterval(se):H(B)},3e3);if(typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Mode Design-First Activé !"),typeof window<"u"){const Z=localStorage.getItem("tiger_targetAi")||"deepseek";let Y="";h.length>0&&(Y=`
...
\`\`\`
`}));let Te="";(pe.trim()||qe.trim()||at.trim())&&(Te=`
...
\`\`\`
`,G=window.AndroidBridge;if(G&&G.openAIWithPrompt){const de=Xe(Z);G.openAIWithPrompt(de,Ne),G.showToast&&G.showToast("HTML injecté. Câblage sur "+Z.toUpperCase()+" !")}else C("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,prompt:Ne,auto_submit:!0,project_id:P,phase_num:5})}).then(de=>console.log("[Bridge] Prompt HTML + Contexte envoyé avec succès, status:",de.status)).catch(de=>console.error("[Bridge] Erreur lors de l'envoi du prompt:",de))}},jt=(s,l=0)=>s?s.type==="directory"?e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-2 px-2 py-1 hover:bg-white/5 cursor-pointer text-gray-300 text-sm",style:{paddingLeft:`${l*12+8}px`},children:[e.jsx("span",{className:"text-orange-400",children:"📁"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-dossier truncate font-bold",children:s.name})]}),s.children&&s.children.map(c=>jt(c,l+1))]},s.path):e.jsxs("div",{className:`flex items-center justify-between px-2 py-1 hover:bg-white/10 cursor-pointer text-sm group ${ce===s.path?"bg-cyan/20 text-cyan border-l-2 border-cyan":"text-gray-400"}`,style:{paddingLeft:`${l*12+8}px`},onClick:()=>$e(s.path),children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-blue-400",children:"📄"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-fichier truncate",children:s.name})]}),e.jsxs("div",{className:"hidden group-hover:flex items-center gap-1",children:[e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-red-500/50 transition-colors",title:"Suture : Réparer ou débugger ce fichier",onClick:c=>{c.stopPropagation(),$e(s.path),setTimeout(()=>Be("suture","Veuillez analyser ce fichier et corriger toutes les erreurs, fautes de frappe ou imports manquants."),100)},children:"🩺"}),e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-cyan/50 transition-colors",title:"Ajouter au Trombone",onClick:c=>{c.stopPropagation(),j(s.path)},children:"📎"})]})]},s.path):null,Be=async(s,l)=>{if(!U){alert("⚠️ Veuillez sélectionner un projet actif dans l'explorateur.");return}const c=localStorage.getItem("tiger_targetAi")||"deepseek";let P="";s==="suture"?P=`🩺 SUTURE CHIRURGICALE — CORRECTION D'ERREUR DÉTECTÉE
...
\`\`\``,y(h=>[...h,{id:Date.now().toString()+"_action",role:"assistant",content:`🩺 Suture & Correction déclenchée pour "${U}". Transmission de l'erreur à ${c.toUpperCase()} en cours...`}]);try{if(await C("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:c,prompt:P,auto_submit:!0,project_id:U,phase_num:s})}),s==="suture"){C("http://localhost:5006/v1/suture/start",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:U,activeFile:ce||"",rawError:l||"",prompt:l||"Analyse et corrige les erreurs du projet."})}).then(async f=>{const E=await f.json();E.success&&E.status==="applied"?y(B=>{var se,Z;return[...B,{id:Date.now().toString()+"_suture_ok",role:"assistant",content:`✅ Suture V2 réussie !

🔧 ${E.repairId}
🚀 Statut : **Patch appliqué en production**
📁 Fichiers corrigés : ${JSON.stringify(((Z=(se=E.patchReport)==null?void 0:se.files)==null?void 0:Z.map(Y=>Y.path))||[])}`}]}):E.success?y(B=>{var se;return[...B,{id:Date.now().toString()+"_suture_partial",role:"assistant",content:`⚠️ Suture V2 : correctif généré mais non promu.
Statut : ${((se=E.validationReport)==null?void 0:se.code)||E.status}
...
Tout le travail actuel non sauvegardé sera perdu.`)&&C("http://localhost:5006/api/bridge/restore-backup",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:U,backup_name:s})}).then(l=>l?l.json():null).then(l=>{if(!l)return alert("❌ Moteur inaccessible (Mode Cloud SaaS)");l.success?(alert("✅ "+l.message),ye(!1)):alert("❌ Erreur Restauration : "+l.error)}).catch(l=>alert("Erreur réseau: "+l.message))},className:"px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold rounded-lg transition-all",children:"Restaurer"})]},s)),be.length===0&&e.jsx("div",{className:"text-center p-4 text-slate-500 italic",children:"Aucune sauvegarde disponible."})]})]})}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
      ...
      `}})]})}function qo({onAuthenticated:t}){const[n,r]=o.useState("login"),[a,d]=o.useState(""),[p,m]=o.useState(""),[u,y]=o.useState(""),[b,x]=o.useState(!1),[D,w]=o.useState(""),J=async R=>{if(R.preventDefault(),w(""),n==="register"&&p!==u){w("Les mots de passe ne correspondent pas.");return}if(p.length<8){w("Le mot de passe doit contenir au moins 8 caractères.");return}x(!0);try{const z=await fetch(n==="login"?"/api/auth/login":"/api/auth/register",{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({email:a,password:p})}),_=await z.json();if(!z.ok){const T={INVALID_CREDENTIALS:"Email ou mot de passe incorrect.",TOO_MANY_ATTEMPTS:"Trop de tentatives. Réessayez dans 15 minutes.",REGISTRATION_FAILED:"Cet email est déjà utilisé.",PASSWORD_TOO_SHORT:"Mot de passe trop court (8 caractères minimum)."};w(_.error?T[_.error]??_.error:"Une erreur est survenue.");return}_.token&&localStorage.setItem("kirov5_jwt_token",_.token),t({userId:String(_.userId),email:a,isSuperAdmin:!!_.isSuperAdmin})}catch{window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?(console.warn("Mode local sans Wrangler: Bypass de la connexion pour accès UI."),localStorage.setItem("kirov5_jwt_token","dev-mock-token"),t({userId:"dev-user-001",email:a||"dev@local"})):w("Impossible de contacter le serveur. Vérifiez votre connexion.")}finally{x(!1)}};return e.jsxs("div",{style:{minHeight:"100vh",background:"linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Inter', 'Segoe UI', sans-serif",padding:"20px"},children:[e.jsx("div",{style:{position:"fixed",inset:0,overflow:"hidden",pointerEvents:"none",zIndex:0},children:[...Array(6)].map((R,O)=>e.jsx("div",{style:{position:"absolute",borderRadius:"50%",background:`rgba(${O%2===0?"139,92,246":"59,130,246"},0.08)`,width:`${200+O*80}px`,height:`${200+O*80}px`,top:`${10+O*15}%`,left:`${5+O*16}%`,filter:"blur(60px)",animation:`float ${6+O}s ease-in-out infinite alternate`}},O))}),e.jsxs("div",{style:{position:"relative",zIndex:1,width:"100%",maxWidth:"420px"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"40px"},children:[e.jsx("div",{style:{display:"inline-flex",alignItems:"center",justifyContent:"center",width:"72px",height:"72px",borderRadius:"20px",background:"linear-gradient(135deg, #8b5cf6, #3b82f6)",marginBottom:"20px",boxShadow:"0 0 40px rgba(139,92,246,0.4)",fontSize:"32px"},children:"⚡"}),e.jsx("h1",{style:{margin:0,fontSize:"28px",fontWeight:800,background:"linear-gradient(135deg, #a78bfa, #60a5fa)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",letterSpacing:"-0.5px"},children:"Kirov5 Sovereign Forge"}),e.jsx("p",{style:{color:"rgba(255,255,255,0.4)",marginTop:"8px",fontSize:"14px"},children:"Plateforme de génération d'applications IA"})]}),e.jsxs("div",{style:{background:"rgba(255,255,255,0.04)",backdropFilter:"blur(20px)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"24px",padding:"36px",boxShadow:"0 25px 50px rgba(0,0,0,0.4)"},children:[e.jsx("div",{style:{display:"flex",background:"rgba(0,0,0,0.3)",borderRadius:"12px",padding:"4px",marginBottom:"28px"},children:["login","register"].map(R=>e.jsx("button",{onClick:()=>{r(R),w("")},style:{flex:1,padding:"10px",borderRadius:"10px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:600,transition:"all 0.2s ease",background:n===R?"linear-gradient(135deg, #8b5cf6, #3b82f6)":"transparent",color:n===R?"#fff":"rgba(255,255,255,0.4)"},children:R==="login"?"🔑 Connexion":"✨ Inscription"},R))}),e.jsxs("form",{onSubmit:J,children:[e.jsxs("div",{style:{marginBottom:"16px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Adresse email"}),e.jsx("input",{type:"email",value:a,onChange:R=>d(R.target.value),required:!0,autoComplete:"email",placeholder:"vous@exemple.com",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box",transition:"border-color 0.2s"},onFocus:R=>R.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:R=>R.target.style.borderColor="rgba(255,255,255,0.1)"})]}),e.jsxs("div",{style:{marginBottom:n==="register"?"16px":"24px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Mot de passe"}),e.jsx("input",{type:"password",value:p,onChange:R=>m(R.target.value),required:!0,autoComplete:n==="login"?"current-password":"new-password",placeholder:n==="register"?"8 caractères minimum":"••••••••",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box"},onFocus:R=>R.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:R=>R.target.style.borderColor="rgba(255,255,255,0.1)"})]}),n==="register"&&e.jsxs("div",{style:{marginBottom:"24px"},children:[e.jsx("label",{style:{display:"block",fontSize:"13px",color:"rgba(255,255,255,0.6)",marginBottom:"8px",fontWeight:500},children:"Confirmer le mot de passe"}),e.jsx("input",{type:"password",value:u,onChange:R=>y(R.target.value),required:!0,autoComplete:"new-password",placeholder:"••••••••",style:{width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.06)",color:"#fff",fontSize:"14px",outline:"none",boxSizing:"border-box"},onFocus:R=>R.target.style.borderColor="rgba(139,92,246,0.6)",onBlur:R=>R.target.style.borderColor="rgba(255,255,255,0.1)"})]}),D&&e.jsxs("div",{style:{background:"rgba(239,68,68,0.12)",border:"1px solid rgba(239,68,68,0.3)",borderRadius:"10px",padding:"12px 16px",marginBottom:"16px",color:"#fca5a5",fontSize:"13px",display:"flex",alignItems:"center",gap:"8px"},children:[e.jsx("span",{children:"⚠️"})," ",D]}),e.jsx("button",{type:"submit",disabled:b,style:{width:"100%",padding:"14px",borderRadius:"12px",border:"none",background:b?"rgba(139,92,246,0.4)":"linear-gradient(135deg, #8b5cf6, #3b82f6)",color:"#fff",fontSize:"15px",fontWeight:700,cursor:b?"not-allowed":"pointer",transition:"all 0.2s ease",boxShadow:b?"none":"0 4px 20px rgba(139,92,246,0.4)"},children:b?"⏳ Chargement...":n==="login"?"🚀 Se connecter":"✨ Créer mon compte"})]}),e.jsx("p",{style:{textAlign:"center",marginTop:"20px",fontSize:"12px",color:"rgba(255,255,255,0.25)"},children:"🔒 Connexion sécurisée — Vos données sont chiffrées"})]})]}),e.jsx("style",{children:`
        @keyframes float {

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200--F-N6E5S.js","assets/design-v200-DcgYHDqz.js","assets/design-v200-B_-ohhET.css"])))=>i.map(i=>d[i]);
import{r as o,a as Et,j as e,s as I,i as bs,R as vs}from"./design-v200-DcgYHDqz.js";const Ss="modulepreload",ys=function(t){return"/"+t},Un={},en=function(n,r,c){let d=Promise.resolve();if(r&&r.length>0){let x=function(v){return Promise.all(v.map(y=>Promise.resolve(y).then(M=>({status:"fulfilled",value:M}),M=>({status:"rejected",reason:M}))))};document.getElementsByTagName("link");const p=document.querySelector("meta[property=csp-nonce]"),C=(p==null?void 0:p.nonce)||(p==null?void 0:p.getAttribute("nonce"));d=x(r.map(v=>{if(v=ys(v),v in Un)return;Un[v]=!0;const y=v.endsWith(".css"),M=y?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${v}"]${M}`))return;const F=document.createElement("link");if(F.rel=y?"stylesheet":Ss,y||(F.as="script"),F.crossOrigin="",F.href=v,C&&F.setAttribute("nonce",C),document.head.appendChild(F),y)return new Promise((Z,O)=>{F.addEventListener("load",Z),F.addEventListener("error",()=>O(new Error(`Unable to preload CSS for ${v}`)))})}))}function g(x){const p=new Event("vite:preloadError",{cancelable:!0});if(p.payload=x,window.dispatchEvent(p),!p.defaultPrevented)throw x}return d.then(x=>{for(const p of x||[])p.status==="rejected"&&g(p.reason);return n().catch(g)})},_s=`# undefined
...
- \`src/features/events/components/TicketingCard.tsx\``,qs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/feed/hooks/useInfiniteFeed.ts\``,Ls=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/maps/hooks/useGeolocation.ts\``,qr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/markdown/components/TableOfContents.tsx\``,Lr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Fn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);n&&(c=c.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,c)}return r}function Gn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Fn(Object(r),!0).forEach(function(c){_i(t,c,r[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Fn(Object(r)).forEach(function(c){Object.defineProperty(t,c,Object.getOwnPropertyDescriptor(r,c))})}return t}function Ii(t,n){if(t==null)return{};var r,c,d=Ai(t,n);if(Object.getOwnPropertySymbols){var g=Object.getOwnPropertySymbols(t);for(c=0;c<g.length;c++)r=g[c],n.indexOf(r)===-1&&{}.propertyIsEnumerable.call(t,r)&&(d[r]=t[r])}return d}function Ai(t,n){if(t==null)return{};var r={};for(var c in t)if({}.hasOwnProperty.call(t,c)){if(n.indexOf(c)!==-1)continue;r[c]=t[c]}return r}function Pi(t,n){return yi(t)||Ci(t,n)||Ti(t,n)||wi()}function ki(t,n){if(typeof t!="object"||!t)return t;var r=t[Symbol.toPrimitive];if(r!==void 0){var c=r.call(t,n);if(typeof c!="object")return c;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}function ji(t){var n=ki(t,"string");return typeof n=="symbol"?n:n+""}function Ti(t,n){if(t){if(typeof t=="string")return On(t,n);var r={}.toString.call(t).slice(8,-1);return r==="Object"&&t.constructor&&(r=t.constructor.name),r==="Map"||r==="Set"?Array.from(t):r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?On(t,n):void 0}}function Ei(t,n,r){return n in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function Vn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);n&&(c=c.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,c)}return r}function Bn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Vn(Object(r),!0).forEach(function(c){Ei(t,c,r[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Vn(Object(r)).forEach(function(c){Object.defineProperty(t,c,Object.getOwnPropertyDescriptor(r,c))})}return t}function Ri(){for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r];return function(c){return n.reduceRight(function(d,g){return g(d)},c)}}function Zt(t){return function n(){for(var r=this,c=arguments.length,d=new Array(c),g=0;g<c;g++)d[g]=arguments[g];return d.length>=t.length?t.apply(this,d):function(){for(var x=arguments.length,p=new Array(x),C=0;C<x;C++)p[C]=arguments[C];return n.apply(r,[].concat(d,p))}}}function xn(t){return{}.toString.call(t).includes("Object")}function Ni(t){return!Object.keys(t).length}function tn(t){return typeof t=="function"}function Di(t,n){return Object.prototype.hasOwnProperty.call(t,n)}function Mi(t,n){return xn(n)||wt("changeType"),Object.keys(n).some(function(r){return!Di(t,r)})&&wt("changeField"),n}function qi(t){tn(t)||wt("selectorType")}function Li(t){tn(t)||xn(t)||wt("handlerType"),xn(t)&&Object.values(t).some(function(n){return!tn(n)})&&wt("handlersType")}function Ui(t){t||wt("initialIsRequired"),xn(t)||wt("initialType"),Ni(t)&&wt("initialContent")}function Oi(t,n){throw new Error(t[n]||t.default)}var Fi={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},wt=Zt(Oi)(Fi),mn={changes:Mi,selector:qi,handler:Li,initial:Ui};function Gi(t){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};mn.initial(t),mn.handler(n);var r={current:t},c=Zt(zi)(r,n),d=Zt(Bi)(r),g=Zt(mn.changes)(t),x=Zt(Vi)(r);function p(){var v=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(y){return y};return mn.selector(v),v(r.current)}function C(v){Ri(c,d,g,x)(v)}return[p,C]}function Vi(t,n){return tn(n)?n(t.current):n}function Bi(t,n){return t.current=Bn(Bn({},t.current),n),n}function zi(t,n,r){return tn(n)?n(t.current):Object.keys(r).forEach(function(c){var d;return(d=n[c])===null||d===void 0?void 0:d.call(n,t.current[c])}),r}var Hi={create:Gi},$i={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.55.1/min/vs"}};function Ki(t){return function n(){for(var r=this,c=arguments.length,d=new Array(c),g=0;g<c;g++)d[g]=arguments[g];return d.length>=t.length?t.apply(this,d):function(){for(var x=arguments.length,p=new Array(x),C=0;C<x;C++)p[C]=arguments[C];return n.apply(r,[].concat(d,p))}}}function Wi(t){return{}.toString.call(t).includes("Object")}function Ji(t){return t||zn("configIsRequired"),Wi(t)||zn("configType"),t.urls?(Xi(),{paths:{vs:t.urls.monacoBase}}):t}function Xi(){console.warn(Zn.deprecation)}function Qi(t,n){throw new Error(t[n]||t.default)}var Zn={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},zn=Ki(Qi)(Zn),Zi={config:Ji},Yi=function(){for(var n=arguments.length,r=new Array(n),c=0;c<n;c++)r[c]=arguments[c];return function(d){return r.reduceRight(function(g,x){return x(g)},d)}};function Yn(t,n){return Object.keys(n).forEach(function(r){n[r]instanceof Object&&t[r]&&Object.assign(n[r],Yn(t[r],n[r]))}),Gn(Gn({},t),n)}var ea={type:"cancelation",msg:"operation is manually canceled"};function _n(t){var n=!1,r=new Promise(function(c,d){t.then(function(g){return n?d(ea):c(g)}),t.catch(d)});return r.cancel=function(){return n=!0},r}var ta=["monaco"],na=Hi.create({config:$i,isInitialized:!1,resolve:null,reject:null,monaco:null}),es=Pi(na,2),nn=es[0],bn=es[1];function sa(t){var n=Zi.config(t),r=n.monaco,c=Ii(n,ta);bn(function(d){return{config:Yn(d.config,c),monaco:r}})}function ra(){var t=nn(function(n){var r=n.monaco,c=n.isInitialized,d=n.resolve;return{monaco:r,isInitialized:c,resolve:d}});if(!t.isInitialized){if(bn({isInitialized:!0}),t.monaco)return t.resolve(t.monaco),_n(Cn);if(window.monaco&&window.monaco.editor)return ts(window.monaco),t.resolve(window.monaco),_n(Cn);Yi(ia,oa)(la)}return _n(Cn)}function ia(t){return document.body.appendChild(t)}function aa(t){var n=document.createElement("script");return t&&(n.src=t),n}function oa(t){var n=nn(function(c){var d=c.config,g=c.reject;return{config:d,reject:g}}),r=aa("".concat(n.config.paths.vs,"/loader.js"));return r.onload=function(){return t()},r.onerror=n.reject,r}function la(){var t=nn(function(r){var c=r.config,d=r.resolve,g=r.reject;return{config:c,resolve:d,reject:g}}),n=window.require;n.config(t.config),n(["vs/editor/editor.main"],function(r){var c=r.m||r;ts(c),t.resolve(c)},function(r){t.reject(r)})}function ts(t){nn().monaco||bn({monaco:t})}function ca(){return nn(function(t){var n=t.monaco;return n})}var Cn=new Promise(function(t,n){return bn({resolve:t,reject:n})}),ns={config:sa,init:ra,__getMonacoInstance:ca},da={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},wn=da,ua={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},pa=ua;function ma({children:t}){return Et.createElement("div",{style:pa.container},t)}var ga=ma,ha=ga;function xa({width:t,height:n,isEditorReady:r,loading:c,_ref:d,className:g,wrapperProps:x}){return Et.createElement("section",{style:{...wn.wrapper,width:t,height:n},...x},!r&&Et.createElement(ha,null,c),Et.createElement("div",{ref:d,style:{...wn.fullWidth,...!r&&wn.hide},className:g}))}var fa=xa,ss=o.memo(fa);function ba(t){o.useEffect(t,[])}var rs=ba;function va(t,n,r=!0){let c=o.useRef(!0);o.useEffect(c.current||!r?()=>{c.current=!1}:t,n)}var $e=va;function Yt(){}function Bt(t,n,r,c){return Sa(t,c)||ya(t,n,r,c)}function Sa(t,n){return t.editor.getModel(is(t,n))}function ya(t,n,r,c){return t.editor.createModel(n,r,c?is(t,c):void 0)}function is(t,n){return t.Uri.parse(n)}function _a({original:t,modified:n,language:r,originalLanguage:c,modifiedLanguage:d,originalModelPath:g,modifiedModelPath:x,keepCurrentOriginalModel:p=!1,keepCurrentModifiedModel:C=!1,theme:v="light",loading:y="Loading...",options:M={},height:F="100%",width:Z="100%",className:O,wrapperProps:K={},beforeMount:te=Yt,onMount:w=Yt}){let[N,R]=o.useState(!1),[m,b]=o.useState(!0),q=o.useRef(null),A=o.useRef(null),P=o.useRef(null),W=o.useRef(w),z=o.useRef(te),$=o.useRef(!1);rs(()=>{let G=ns.init();return G.then(V=>(A.current=V)&&b(!1)).catch(V=>(V==null?void 0:V.type)!=="cancelation"&&console.error("Monaco initialization: error:",V)),()=>q.current?ge():G.cancel()}),$e(()=>{if(q.current&&A.current){let G=q.current.getOriginalEditor(),V=Bt(A.current,t||"",c||r||"text",g||"");V!==G.getModel()&&G.setModel(V)}},[g],N),$e(()=>{if(q.current&&A.current){let G=q.current.getModifiedEditor(),V=Bt(A.current,n||"",d||r||"text",x||"");V!==G.getModel()&&G.setModel(V)}},[x],N),$e(()=>{let G=q.current.getModifiedEditor();G.getOption(A.current.editor.EditorOption.readOnly)?G.setValue(n||""):n!==G.getValue()&&(G.executeEdits("",[{range:G.getModel().getFullModelRange(),text:n||"",forceMoveMarkers:!0}]),G.pushUndoStop())},[n],N),$e(()=>{var G,V;(V=(G=q.current)==null?void 0:G.getModel())==null||V.original.setValue(t||"")},[t],N),$e(()=>{let{original:G,modified:V}=q.current.getModel();A.current.editor.setModelLanguage(G,c||r||"text"),A.current.editor.setModelLanguage(V,d||r||"text")},[r,c,d],N),$e(()=>{var G;(G=A.current)==null||G.editor.setTheme(v)},[v],N),$e(()=>{var G;(G=q.current)==null||G.updateOptions(M)},[M],N);let H=o.useCallback(()=>{var ne;if(!A.current)return;z.current(A.current);let G=Bt(A.current,t||"",c||r||"text",g||""),V=Bt(A.current,n||"",d||r||"text",x||"");(ne=q.current)==null||ne.setModel({original:G,modified:V})},[r,n,d,t,c,g,x]),re=o.useCallback(()=>{var G;!$.current&&P.current&&(q.current=A.current.editor.createDiffEditor(P.current,{automaticLayout:!0,...M}),H(),(G=A.current)==null||G.editor.setTheme(v),R(!0),$.current=!0)},[M,v,H]);o.useEffect(()=>{N&&W.current(q.current,A.current)},[N]),o.useEffect(()=>{!m&&!N&&re()},[m,N,re]);function ge(){var V,ne,le,he;let G=(V=q.current)==null?void 0:V.getModel();p||((ne=G==null?void 0:G.original)==null||ne.dispose()),C||((le=G==null?void 0:G.modified)==null||le.dispose()),(he=q.current)==null||he.dispose()}return Et.createElement(ss,{width:Z,height:F,isEditorReady:N,loading:y,_ref:P,className:O,wrapperProps:K})}var Ca=_a;o.memo(Ca);function wa(t){let n=o.useRef();return o.useEffect(()=>{n.current=t},[t]),n.current}var Ia=wa,gn=new Map;function Aa({defaultValue:t,defaultLanguage:n,defaultPath:r,value:c,language:d,path:g,theme:x="light",line:p,loading:C="Loading...",options:v={},overrideServices:y={},saveViewState:M=!0,keepCurrentModel:F=!1,width:Z="100%",height:O="100%",className:K,wrapperProps:te={},beforeMount:w=Yt,onMount:N=Yt,onChange:R,onValidate:m=Yt}){let[b,q]=o.useState(!1),[A,P]=o.useState(!0),W=o.useRef(null),z=o.useRef(null),$=o.useRef(null),H=o.useRef(N),re=o.useRef(w),ge=o.useRef(),G=o.useRef(c),V=Ia(g),ne=o.useRef(!1),le=o.useRef(!1);rs(()=>{let j=ns.init();return j.then(Q=>(W.current=Q)&&P(!1)).catch(Q=>(Q==null?void 0:Q.type)!=="cancelation"&&console.error("Monaco initialization: error:",Q)),()=>z.current?ee():j.cancel()}),$e(()=>{var Q,ae,pe,ve;let j=Bt(W.current,t||c||"",n||d||"",g||r||"");j!==((Q=z.current)==null?void 0:Q.getModel())&&(M&&gn.set(V,(ae=z.current)==null?void 0:ae.saveViewState()),(pe=z.current)==null||pe.setModel(j),M&&((ve=z.current)==null||ve.restoreViewState(gn.get(g))))},[g],b),$e(()=>{var j;(j=z.current)==null||j.updateOptions(v)},[v],b),$e(()=>{!z.current||c===void 0||(z.current.getOption(W.current.editor.EditorOption.readOnly)?z.current.setValue(c):c!==z.current.getValue()&&(le.current=!0,z.current.executeEdits("",[{range:z.current.getModel().getFullModelRange(),text:c,forceMoveMarkers:!0}]),z.current.pushUndoStop(),le.current=!1))},[c],b),$e(()=>{var Q,ae;let j=(Q=z.current)==null?void 0:Q.getModel();j&&d&&((ae=W.current)==null||ae.editor.setModelLanguage(j,d))},[d],b),$e(()=>{var j;p!==void 0&&((j=z.current)==null||j.revealLine(p))},[p],b),$e(()=>{var j;(j=W.current)==null||j.editor.setTheme(x)},[x],b);let he=o.useCallback(()=>{var j;if(!(!$.current||!W.current)&&!ne.current){re.current(W.current);let Q=g||r,ae=Bt(W.current,c||t||"",n||d||"",Q||"");z.current=(j=W.current)==null?void 0:j.editor.create($.current,{model:ae,automaticLayout:!0,...v},y),M&&z.current.restoreViewState(gn.get(Q)),W.current.editor.setTheme(x),p!==void 0&&z.current.revealLine(p),q(!0),ne.current=!0}},[t,n,r,c,d,g,v,y,M,x,p]);o.useEffect(()=>{b&&H.current(z.current,W.current)},[b]),o.useEffect(()=>{!A&&!b&&he()},[A,b,he]),G.current=c,o.useEffect(()=>{var j,Q;b&&R&&((j=ge.current)==null||j.dispose(),ge.current=(Q=z.current)==null?void 0:Q.onDidChangeModelContent(ae=>{le.current||R(z.current.getValue(),ae)}))},[b,R]),o.useEffect(()=>{if(b){let j=W.current.editor.onDidChangeMarkers(Q=>{var pe;let ae=(pe=z.current.getModel())==null?void 0:pe.uri;if(ae&&Q.find(ve=>ve.path===ae.path)){let ve=W.current.editor.getModelMarkers({resource:ae});m==null||m(ve)}});return()=>{j==null||j.dispose()}}return()=>{}},[b,m]);function ee(){var j,Q;(j=ge.current)==null||j.dispose(),F?M&&gn.set(g,z.current.saveViewState()):(Q=z.current.getModel())==null||Q.dispose(),z.current.dispose()}return Et.createElement(ss,{width:Z,height:O,isEditorReady:b,loading:C,_ref:$,className:K,wrapperProps:te})}var Pa=Aa,ka=o.memo(Pa),ja=ka;/*! Capacitor: https://capacitorjs.com/ - MIT License */const Ta=t=>{const n=new Map;n.set("web",{name:"web"});const r=t.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:n},c=(g,x)=>{r.platforms.set(g,x)},d=g=>{r.platforms.has(g)&&(r.currentPlatform=r.platforms.get(g))};return r.addPlatform=c,r.setPlatform=d,r},Ea=t=>t.CapacitorPlatforms=Ta(t),as=Ea(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});as.addPlatform;as.setPlatform;var Kt;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(Kt||(Kt={}));class In extends Error{constructor(n,r,c){super(n),this.message=n,this.code=r,this.data=c}}const Ra=t=>{var n,r;return t!=null&&t.androidBridge?"android":!((r=(n=t==null?void 0:t.webkit)===null||n===void 0?void 0:n.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},Na=t=>{var n,r,c,d,g;const x=t.CapacitorCustomPlatform||null,p=t.Capacitor||{},C=p.Plugins=p.Plugins||{},v=t.CapacitorPlatforms,y=()=>x!==null?x.name:Ra(t),M=((n=v==null?void 0:v.currentPlatform)===null||n===void 0?void 0:n.getPlatform)||y,F=()=>M()!=="web",Z=((r=v==null?void 0:v.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||F,O=A=>{const P=m.get(A);return!!(P!=null&&P.platforms.has(M())||w(A))},K=((c=v==null?void 0:v.currentPlatform)===null||c===void 0?void 0:c.isPluginAvailable)||O,te=A=>{var P;return(P=p.PluginHeaders)===null||P===void 0?void 0:P.find(W=>W.name===A)},w=((d=v==null?void 0:v.currentPlatform)===null||d===void 0?void 0:d.getPluginHeader)||te,N=A=>t.console.error(A),R=(A,P,W)=>Promise.reject(`${W} does not have an implementation of "${P}".`),m=new Map,b=(A,P={})=>{const W=m.get(A);if(W)return console.warn(`Capacitor plugin "${A}" already registered. Cannot register plugins twice.`),W.proxy;const z=M(),$=w(A);let H;const re=async()=>(!H&&z in P?H=typeof P[z]=="function"?H=await P[z]():H=P[z]:x!==null&&!H&&"web"in P&&(H=typeof P.web=="function"?H=await P.web():H=P.web),H),ge=(ee,j)=>{var Q,ae;if($){const pe=$==null?void 0:$.methods.find(ve=>j===ve.name);if(pe)return pe.rtype==="promise"?ve=>p.nativePromise(A,j.toString(),ve):(ve,je)=>p.nativeCallback(A,j.toString(),ve,je);if(ee)return(Q=ee[j])===null||Q===void 0?void 0:Q.bind(ee)}else{if(ee)return(ae=ee[j])===null||ae===void 0?void 0:ae.bind(ee);throw new In(`"${A}" plugin is not implemented on ${z}`,Kt.Unimplemented)}},G=ee=>{let j;const Q=(...ae)=>{const pe=re().then(ve=>{const je=ge(ve,ee);if(je){const ke=je(...ae);return j=ke==null?void 0:ke.remove,ke}else throw new In(`"${A}.${ee}()" is not implemented on ${z}`,Kt.Unimplemented)});return ee==="addListener"&&(pe.remove=async()=>j()),pe};return Q.toString=()=>`${ee.toString()}() { [capacitor code] }`,Object.defineProperty(Q,"name",{value:ee,writable:!1,configurable:!1}),Q},V=G("addListener"),ne=G("removeListener"),le=(ee,j)=>{const Q=V({eventName:ee},j),ae=async()=>{const ve=await Q;ne({eventName:ee,callbackId:ve},j)},pe=new Promise(ve=>Q.then(()=>ve({remove:ae})));return pe.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await ae()},pe},he=new Proxy({},{get(ee,j){switch(j){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return $?le:V;case"removeListener":return ne;default:return G(j)}}});return C[A]=he,m.set(A,{name:A,proxy:he,platforms:new Set([...Object.keys(P),...$?[z]:[]])}),he},q=((g=v==null?void 0:v.currentPlatform)===null||g===void 0?void 0:g.registerPlugin)||b;return p.convertFileSrc||(p.convertFileSrc=A=>A),p.getPlatform=M,p.handleError=N,p.isNativePlatform=Z,p.isPluginAvailable=K,p.pluginMethodNoop=R,p.registerPlugin=q,p.Exception=In,p.DEBUG=!!p.DEBUG,p.isLoggingEnabled=!!p.isLoggingEnabled,p.platform=p.getPlatform(),p.isNative=p.isNativePlatform(),p},Da=t=>t.Capacitor=Na(t),Wt=Da(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Nn=Wt.registerPlugin;Wt.Plugins;class os{constructor(n){this.listeners={},this.retainedEventArguments={},this.windowListeners={},n&&(console.warn(`Capacitor WebPlugin "${n.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=n)}addListener(n,r){let c=!1;this.listeners[n]||(this.listeners[n]=[],c=!0),this.listeners[n].push(r);const g=this.windowListeners[n];g&&!g.registered&&this.addWindowListener(g),c&&this.sendRetainedArgumentsForEvent(n);const x=async()=>this.removeListener(n,r);return Promise.resolve({remove:x})}async removeAllListeners(){this.listeners={};for(const n in this.windowListeners)this.removeWindowListener(this.windowListeners[n]);this.windowListeners={}}notifyListeners(n,r,c){const d=this.listeners[n];if(!d){if(c){let g=this.retainedEventArguments[n];g||(g=[]),g.push(r),this.retainedEventArguments[n]=g}return}d.forEach(g=>g(r))}hasListeners(n){return!!this.listeners[n].length}registerWindowListener(n,r){this.windowListeners[r]={registered:!1,windowEventName:n,pluginEventName:r,handler:c=>{this.notifyListeners(r,c)}}}unimplemented(n="not implemented"){return new Wt.Exception(n,Kt.Unimplemented)}unavailable(n="not available"){return new Wt.Exception(n,Kt.Unavailable)}async removeListener(n,r){const c=this.listeners[n];if(!c)return;const d=c.indexOf(r);this.listeners[n].splice(d,1),this.listeners[n].length||this.removeWindowListener(this.windowListeners[n])}addWindowListener(n){window.addEventListener(n.windowEventName,n.handler),n.registered=!0}removeWindowListener(n){n&&(window.removeEventListener(n.windowEventName,n.handler),n.registered=!1)}sendRetainedArgumentsForEvent(n){const r=this.retainedEventArguments[n];r&&(delete this.retainedEventArguments[n],r.forEach(c=>{this.notifyListeners(n,c)}))}}const Hn=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),$n=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Ma extends os{async getCookies(){const n=document.cookie,r={};return n.split(";").forEach(c=>{if(c.length<=0)return;let[d,g]=c.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");d=$n(d).trim(),g=$n(g).trim(),r[d]=g}),r}async setCookie(n){try{const r=Hn(n.key),c=Hn(n.value),d=`; expires=${(n.expires||"").replace("expires=","")}`,g=(n.path||"/").replace("path=",""),x=n.url!=null&&n.url.length>0?`domain=${n.url}`:"";document.cookie=`${r}=${c||""}${d}; path=${g}; ${x};`}catch(r){return Promise.reject(r)}}async deleteCookie(n){try{document.cookie=`${n.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{const n=document.cookie.split(";")||[];for(const r of n)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(n){return Promise.reject(n)}}async clearAllCookies(){try{await this.clearCookies()}catch(n){return Promise.reject(n)}}}Nn("CapacitorCookies",{web:()=>new Ma});const qa=async t=>new Promise((n,r)=>{const c=new FileReader;c.onload=()=>{const d=c.result;n(d.indexOf(",")>=0?d.split(",")[1]:d)},c.onerror=d=>r(d),c.readAsDataURL(t)}),La=(t={})=>{const n=Object.keys(t);return Object.keys(t).map(d=>d.toLocaleLowerCase()).reduce((d,g,x)=>(d[g]=t[n[x]],d),{})},Ua=(t,n=!0)=>t?Object.entries(t).reduce((c,d)=>{const[g,x]=d;let p,C;return Array.isArray(x)?(C="",x.forEach(v=>{p=n?encodeURIComponent(v):v,C+=`${g}=${p}&`}),C.slice(0,-1)):(p=n?encodeURIComponent(x):x,C=`${g}=${p}`),`${c}&${C}`},"").substr(1):null,Oa=(t,n={})=>{const r=Object.assign({method:t.method||"GET",headers:t.headers},n),d=La(t.headers)["content-type"]||"";if(typeof t.data=="string")r.body=t.data;else if(d.includes("application/x-www-form-urlencoded")){const g=new URLSearchParams;for(const[x,p]of Object.entries(t.data||{}))g.set(x,p);r.body=g.toString()}else if(d.includes("multipart/form-data")||t.data instanceof FormData){const g=new FormData;if(t.data instanceof FormData)t.data.forEach((p,C)=>{g.append(C,p)});else for(const p of Object.keys(t.data))g.append(p,t.data[p]);r.body=g;const x=new Headers(r.headers);x.delete("content-type"),r.headers=x}else(d.includes("application/json")||typeof t.data=="object")&&(r.body=JSON.stringify(t.data));return r};class Fa extends os{async request(n){const r=Oa(n,n.webFetchExtra),c=Ua(n.params,n.shouldEncodeUrlParams),d=c?`${n.url}?${c}`:n.url,g=await fetch(d,r),x=g.headers.get("content-type")||"";let{responseType:p="text"}=g.ok?n:{};x.includes("application/json")&&(p="json");let C,v;switch(p){case"arraybuffer":case"blob":v=await g.blob(),C=await qa(v);break;case"json":C=await g.json();break;case"document":case"text":default:C=await g.text()}const y={};return g.headers.forEach((M,F)=>{y[F]=M}),{data:C,headers:y,status:g.status,url:g.url}}async get(n){return this.request(Object.assign(Object.assign({},n),{method:"GET"}))}async post(n){return this.request(Object.assign(Object.assign({},n),{method:"POST"}))}async put(n){return this.request(Object.assign(Object.assign({},n),{method:"PUT"}))}async patch(n){return this.request(Object.assign(Object.assign({},n),{method:"PATCH"}))}async delete(n){return this.request(Object.assign(Object.assign({},n),{method:"DELETE"}))}}Nn("CapacitorHttp",{web:()=>new Fa});var fn;(function(t){t.Documents="DOCUMENTS",t.Data="DATA",t.Library="LIBRARY",t.Cache="CACHE",t.External="EXTERNAL",t.ExternalStorage="EXTERNAL_STORAGE"})(fn||(fn={}));var kn;(function(t){t.UTF8="utf8",t.ASCII="ascii",t.UTF16="utf16"})(kn||(kn={}));const Kn=Nn("Filesystem",{web:()=>en(()=>import("./web-v200--F-N6E5S.js"),__vite__mapDeps([0,1,2])).then(t=>new t.FilesystemWeb)});/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ba=o.forwardRef(({color:t="currentColor",size:n=24,strokeWidth:r=2,absoluteStrokeWidth:c,className:d="",children:g,iconNode:x,...p},C)=>o.createElement("svg",{ref:C,...Va,width:n,height:n,stroke:t,strokeWidth:c?Number(r)*24/Number(n):r,className:ls("lucide",d),...p},[...x.map(([v,y])=>o.createElement(v,y)),...Array.isArray(g)?g:[g]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const de=(t,n)=>{const r=o.forwardRef(({className:c,...d},g)=>o.createElement(Ba,{ref:g,iconNode:n,className:ls(`lucide-${Ga(t)}`,c),...d}));return r.displayName=`${t}`,r};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
Réponds UNIQUEMENT avec le JSON demandé.`,Io=Object.freeze(Object.defineProperty({__proto__:null,SYSTEM_PROMPT:Rn},Symbol.toStringTag,{value:"Module"}));function ps(t,n,r,c,d){let g=!1;t&&t.includes("[DESIGN RIP]")&&(g=!0,t=t.replace("[DESIGN RIP]","").trim());let x="";r?x=`
...
Réponds avec le JSON valide uniquement, aucun texte avant ou après.`}const Ao=Object.freeze(Object.defineProperty({__proto__:null,buildUserPrompt:ps},Symbol.toStringTag,{value:"Module"})),ms="hermes_deepseek_api_key",gs="tiger_apiKey";function Po(){try{return localStorage.getItem(ms)||localStorage.getItem(gs)||null}catch{return null}}function ko(t){try{const n=t.trim();localStorage.setItem(ms,n),localStorage.setItem(gs,n),I("http://localhost:5006/api/config/apikey",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({key:n,apiKey:n,provider:"deepseek"})}).catch(()=>{})}catch{}}async function Dn(){const t=Po();if(t&&t.length>5)return t;try{const n=await I("http://localhost:5006/api/config/apikey");if(n&&n.ok){const r=await n.json();if((r.hasKey||r.hasAnyKey||r.configured)&&r.apiKey)return ko(r.apiKey),r.apiKey}}catch{}return null}const Pn={},jo={QWEN_CODER_32B:"@cf/qwen/qwen2.5-coder-32b-instruct"},To=(Pn==null?void 0:Pn.VITE_HERMES_WORKER_URL)||"https://kirov-worker.v0reponses.workers.dev";async function hs(t,n,r){var M,F,Z,O,K,te,w,N,R,m,b,q,A;const c=(r==null?void 0:r.model)||jo.QWEN_CODER_32B,d=(r==null?void 0:r.maxTokens)??8192,g=(r==null?void 0:r.temperature)??.3;let x,p;const C=2;for(let P=1;P<=C+1;P++){const W=new AbortController,z=setTimeout(()=>W.abort(),12e4);try{console.log(`[Hermes-CF] Appel Worker Kirov (Tentative ${P}/${C+1})...`);const $=typeof window<"u"&&localStorage.getItem("kirov5_jwt_token")||"";if(x=await fetch(`${To}/api/hermes`,{method:"POST",headers:{"Content-Type":"application/json",...$?{Authorization:`Bearer ${$}`}:{}},signal:W.signal,body:JSON.stringify({model:c,messages:[{role:"system",content:t},{role:"user",content:n}],max_tokens:d,temperature:g})}),clearTimeout(z),!x.ok){const H=await x.text().catch(()=>"");throw x.status===403?new Error("Hermes Worker — Modele non disponible sur plan Free (403)."):x.status===429?new Error("Hermes Worker — Quota 10 000 Neurons/jour atteint. Reset a 00:00 UTC."):x.status===500||x.status===502||x.status===503||x.status===504?new Error(`Erreur transitoire ${x.status}: ${H.slice(0,300)}`):new Error(`Hermes Worker — Erreur ${x.status}: ${H.slice(0,300)}`)}break}catch($){clearTimeout(z);let H=$.message;if($.name==="AbortError"&&(H="Hermes Worker — Timeout local (120s) atteint."),p=new Error(H),H.includes("Modele non disponible")||H.includes("Quota 10 000"))throw p;if(P<=C)console.warn(`[Hermes-CF] Echec (Tentative ${P}). Retry dans ${3*P}s... (${H})`),await new Promise(re=>setTimeout(re,3e3*P));else throw console.error(`[Hermes-CF] Echec definitif apres ${C+1} tentatives.`),p}}if(!x)throw p||new Error("Erreur inconnue lors de l'appel Cloudflare.");const v=await x.json();let y=(v==null?void 0:v.response)||((Z=(F=(M=v==null?void 0:v.choices)==null?void 0:M[0])==null?void 0:F.message)==null?void 0:Z.content)||((K=(O=v==null?void 0:v.choices)==null?void 0:O[0])==null?void 0:K.text)||((N=(w=(te=v==null?void 0:v.choices)==null?void 0:te[0])==null?void 0:w.delta)==null?void 0:N.content)||((R=v==null?void 0:v.result)==null?void 0:R.response)||(typeof(v==null?void 0:v.result)=="string"?v.result:"")||"";if(typeof y!="string")try{y=JSON.stringify(y)}catch{y=String(y)}if((!y||y.trim().length<5)&&((q=(b=(m=v==null?void 0:v.choices)==null?void 0:m[0])==null?void 0:b.message)!=null&&q.reasoning)&&(console.warn("[Hermes-CF] Contenu vide, utilisation du champ reasoning."),y=v.choices[0].message.reasoning),!y||y.trim().length<5){const P=(A=v==null?void 0:v.choices)==null?void 0:A[0];throw console.error("[Hermes-CF] Reponse vide. choices[0]:",JSON.stringify(P,null,2)),new Error(`Hermes Worker — Reponse vide (finish_reason: ${(P==null?void 0:P.finish_reason)||"unknown"}). Modele: ${v==null?void 0:v.model}`)}return y}const Eo="https://api.deepseek.com/v1/chat/completions";async function Ro(t,n,r,c){var F,Z,O;const d=await Dn(),g=ps(t,n,r,c);let x="";if(d&&d.length>5)try{const K=await fetch(Eo,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:Rn},{role:"user",content:g}],max_tokens:8e3,temperature:.3,response_format:{type:"json_object"}})});K.ok?(x=((O=(Z=(F=(await K.json()).choices)==null?void 0:F[0])==null?void 0:Z.message)==null?void 0:O.content)??"",console.log("[AI Provider] DeepSeek OK — contenu recu:",x.length,"chars")):console.warn("[AI Provider] DeepSeek erreur:",K.status,"— bascule vers Cloudflare Hermes.")}catch{console.warn("[AI Provider] DeepSeek indisponible — bascule vers Cloudflare Hermes Worker.")}if(!x)try{console.log("[AI Provider] Appel Hermes Cloudflare Worker (route /api/hermes)..."),x=await hs(Rn,g,{maxTokens:8e3,temperature:.3}),console.log("[AI Provider] Hermes Cloudflare OK — contenu recu:",x.length,"chars")}catch(K){throw console.error("[AI Provider] Hermes Cloudflare echoue:",K.message),new Error(`Moteur IA indisponible. DeepSeek ${d?"(erreur API)":"(pas de cle)"} et Cloudflare Worker (${K.message}). Reessayez dans un instant.`)}if(!x)throw new Error("Reponse vide de l'Agent Hermes. Reessayez.");let p;try{const K=x.match(/\{[\s\S]*\}/);p=JSON.parse(K?K[0]:x)}catch{throw new Error(`L'Agent Hermes n'a pas retourne un JSON valide. Reponse: ${x.slice(0,300)}`)}const C=p.folderName||`guest_${t.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,20)}`,v=`inject_${C}.js`,y=[{path:"README.md",language:"markdown",purpose:"PRD complet avec 10 modules architecturaux et directives IA",content:p.readme_content||""},{path:v,language:"javascript",purpose:"Script d'injection avec PRDS detailles pour Tiger IA / Hermes",content:p.inject_content||""},{path:"manifest.json",language:"json",purpose:"Metadonnees et registre du pack PRD",content:typeof p.manifest_content=="string"?p.manifest_content:JSON.stringify(p.manifest_content??{},null,2)}];return(n==="game"||p.game_engine_config||p.extra_files)&&(p.game_engine_config||!p.extra_files)&&y.push({path:"project_spec.yaml",language:"yaml",purpose:"Contrat de Specification du Projet",content:typeof p.project_spec=="string"?p.project_spec:JSON.stringify(p.project_spec||{schema_version:"1.0.0",project:{id:C,name:p.projectName||C,genre:"platformer_or_arcade"}},null,2)},{path:"action_plan.yaml",language:"yaml",purpose:"Graphe de Dependances & Micro-Actions Granulaires",content:typeof p.action_plan=="string"?p.action_plan:JSON.stringify(p.action_plan||{schema_version:"1.0.0",actions:[]},null,2)}),{projectName:p.projectName||C.replace("guest_","").replace(/_/g," ").toUpperCase(),folderName:C,title:`Pack PRD ${p.projectName||C}`,category:p.category||n,ideaSummary:p.ideaSummary||t,architectureSummary:p.architectureSummary||"Architecture React 18 + TypeScript + Vite + Tailwind CSS.",tasks:p.tasks||[{id:"task-1",title:"Structure du Projet",description:"Initialisation React/Vite/TypeScript",priority:"must-have",status:"planned"},{id:"task-2",title:"Composants Core",description:"Developpement des vues principales",priority:"must-have",status:"planned"}],files:y,extensionPoints:p.extensionPoints||["React Context","Custom Hooks","TypeScript"],warnings:p.warnings||[]}}async function No(t,n="other",r,c,d="api"){const g=await Dn();try{const x=await I("http://localhost:5006/api/bridge/analyze-proposal",{method:"POST",headers:{"Content-Type":"application/json",...g?{"X-API-Key":g}:{}},body:JSON.stringify({idea:t,category:n,source_folder:r,web_url:c,apiKey:g||void 0})});if(x&&x.ok){const p=await x.json(),C=p.data||p;if(C.success&&C.proposal)return C.proposal}}catch{console.warn("[Pack Generator] Bridge 5006 indisponible — passage en mode Web Cloud.")}return{projectName:t.slice(0,25).toUpperCase(),ideaSummary:t,category:n,recommendedStack:{frontend:"React 18 + Vite + TypeScript",styling:"Vanilla CSS / Tailwind",architecturePattern:"Modular SPA"},keyFeatures:["Interface Responsive","Gestion d'état locale","API Integrations"],architecturalModules:[{name:"Core Interface",purpose:"Affichage principal"},{name:"Data Manager",purpose:"Gestion des données"}],estimatedComplexity:"Moyenne",targetAudience:"Utilisateurs Web / SaaS"}}async function Do(t,n="other",r,c,d,g="api"){var v;const x=((v=d||(r?r.replace(/\\/g,"/").split("/").pop():t))==null?void 0:v.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,35))??"project",p=d||(x.startsWith("guest_")?x:`guest_${x}`),C=await Dn();try{const y=await I("http://localhost:5006/api/bridge/generate-guest-pack",{method:"POST",headers:{"Content-Type":"application/json",...C?{"X-API-Key":C}:{}},body:JSON.stringify({idea:t,category:n,folder_name:p,source_folder:r,web_url:c,apiKey:C||void 0})});if(y&&y.ok){const M=await y.json(),F=M.data||M;if(F.success&&F.pack)return F.pack}}catch{console.warn("[Pack Generator] Bridge 5006 non détecté — bascule vers le Moteur Cloud IA.")}if(g==="cloudflare"){const{SYSTEM_PROMPT:y}=await en(async()=>{const{SYSTEM_PROMPT:O}=await Promise.resolve().then(()=>Io);return{SYSTEM_PROMPT:O}},void 0),{buildUserPrompt:M}=await en(async()=>{const{buildUserPrompt:O}=await Promise.resolve().then(()=>Ao);return{buildUserPrompt:O}},void 0),F=M(t,n,r,c),Z=await hs(y,F,{maxTokens:8e3,temperature:.3});console.log("[Pack Generator] Hermes Cloudflare OK —",Z.length,"chars")}return Ro(t,n,r,c)}const Mo=[{title:"Jeu Tetris Rétro",category:"game",icon:"🎮",idea:"Un jeu Tetris rétro néon avec système de score, contrôles au clavier, effets de particules, niveaux de difficulté progressifs et sons retro 8-bit."},{title:"Pack Santé Apple Health",category:"health",icon:"❤️",idea:"Application de suivi biométrique façon Apple Health : hydratation, suivi du sommeil, fréquence cardiaque, objectifs quotidiens et widgets graphiques fluides."},{title:"Store Sneaker Futuriste",category:"ecommerce",icon:"👟",idea:"E-commerce de sneakers rares en 3D avec panier réactif, filtre par marques, mode sombre futuriste et prévisualisation AR."}],qo=[{value:"health",label:"Fitness / Santé"},{value:"game",label:"Jeu Vidéo"},{value:"ecommerce",label:"E-Commerce"},{value:"productivity",label:"Productivité"},{value:"social",label:"Réseau Social"},{value:"education",label:"Éducation"},{value:"other",label:"Autre / Spécifique"}],Lo=({proposal:t,folderName:n,setFolderName:r,onConfirm:c,onReset:d,isGenerating:g})=>e.jsxs("div",{className:"mt-4 p-4 bg-[#0a1a0a] border border-green-500/30 rounded-xl space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-green-400 font-bold text-xs flex items-center gap-2",children:"✅ Proposition Hermes"}),e.jsx("button",{onClick:d,className:"text-[9px] text-gray-500 hover:text-gray-300",children:"← Recommencer"})]}),e.jsx("div",{className:"text-white font-black text-sm",children:t.projectName}),e.jsx("p",{className:"text-gray-400 text-[11px] leading-relaxed",children:t.description}),t.modules&&t.modules.length>0&&e.jsx("div",{className:"flex flex-wrap gap-1",children:t.modules.map((x,p)=>e.jsx("span",{className:"bg-cyan/10 border border-cyan/30 text-cyan text-[9px] px-2 py-0.5 rounded-full",children:x},p))}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 text-[9px] font-bold uppercase block mb-1",children:"Dossier cible"}),e.jsx("input",{type:"text",value:n,onChange:x=>r(x.target.value),className:"w-full bg-[#111] border border-white/10 rounded-lg px-3 py-2 text-xs text-gray-200 outline-none focus:border-cyan",placeholder:"guest_mon_projet"})]}),e.jsx("button",{onClick:c,disabled:g||!n,className:"w-full py-3 bg-gradient-to-r from-cyan-600/60 to-blue-600/60 hover:from-cyan-500/70 hover:to-blue-500/70 border border-cyan/40 text-white text-[11px] font-black uppercase rounded-lg transition-all disabled:opacity-50",children:g?"⏳ Génération...":"💎 Confirmer & Générer le Pack PRD"})]}),Uo=({activeProjectName:t,onPackGenerated:n,selectedStartPhase:r,onPhaseChange:c})=>{const[d,g]=o.useState("prompt"),[x,p]=o.useState(""),[C,v]=o.useState("other"),[y,M]=o.useState(""),[F,Z]=o.useState(""),[O,K]=o.useState(!1),[te,w]=o.useState(""),[N,R]=o.useState(""),[m,b]=o.useState([]),[q,A]=o.useState(!1),P=async()=>{A(!0);try{let L=[];const fe=await I("http://localhost:5006/api/projects");if(fe&&fe.ok){const be=await fe.json(),ie=be.projects||be.data&&be.data.projects||be;Array.isArray(ie)&&(L=ie.map(Re=>typeof Re=="string"?Re:Re.project_id||Re.title||Re.name).filter(Boolean))}if(L.length===0){const be=localStorage.getItem("kirov5_jwt_token")||"",ie=await fetch("/api/projects",{headers:be?{Authorization:`Bearer ${be}`}:{}});if(ie&&ie.ok){const Re=await ie.json(),it=Re.projects||Re;Array.isArray(it)&&(L=it.map(Te=>typeof Te=="string"?Te:Te.project_id||Te.title||Te.name).filter(Boolean))}}const Ie=Array.from(new Set(L)).filter(be=>be&&!be.startsWith(".")&&be!=="node_modules");b(Ie),Ie.length>0&&w(be=>be&&Ie.includes(be)?be:Ie[0])}catch(L){console.warn("Impossible de charger la liste des projets:",L)}finally{A(!1)}};o.useEffect(()=>{d==="phase5"&&P()},[d]);const[W,z]=o.useState(!1),[$,H]=o.useState("idle"),[re,ge]=o.useState(null),[G,V]=o.useState(null),[ne,le]=o.useState(""),[he,ee]=o.useState(""),[j,Q]=o.useState("");o.useEffect(()=>{r===5&&d!=="phase5"&&g("phase5"),r===0&&d==="phase5"&&g("prompt")},[r]),o.useEffect(()=>{try{if(!F.trim()){K(!1);return}const L=new URL(F).hostname.replace(/^www\./,"");K(L==="youtube.com"||L==="youtu.be")}catch{K(!1)}},[F]);const ae=()=>{ge(null),V(null),H("idle"),ee(""),Q(""),le("")},pe=async()=>{var fe,Ie,be;ee(""),ge(null),Q("");let L=x.trim();if(d==="phase5"){if(!te.trim()){ee("Sélectionnez un dossier à auditer.");return}L=N.trim()||"Audit standard d'industrialisation (frontend vers backend)"}else d==="folder"?L=L||`Import du projet local : ${y}`:(d==="web"||d==="designrip")&&(L=L||`Analyse du site : ${F}`,d==="designrip"&&(L=`[DESIGN RIP] ${L}`));if(!L){ee("Décrivez votre idée ou remplissez les champs requis.");return}H("analyzing");try{let ie=null;try{const Ee=await I(`http://localhost:5006${d==="phase5"?"/api/bridge/analyze-phase5":"/api/bridge/guest-analyze"}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({idea:L,category:d==="phase5"?"phase5":C,sourceFolder:y||void 0,webUrl:F||void 0,phase5Folder:te||void 0})});if(Ee&&Ee.ok){const ce=await Ee.json();if(d==="phase5"){const xt=((fe=ce.data)==null?void 0:fe.audit)||ce.audit||((Ie=ce.data)==null?void 0:Ie.proposal)||ce.proposal||ce;V(xt),le(te.split(/[\\/]/).pop()||"guest_audit"),H("proposal-ready");return}ie=ce.proposal||((be=ce.data)==null?void 0:be.proposal)}}catch{}if(!ie&&d!=="phase5"){const Te=await No(L,C,y,F);ie={projectName:Te.projectName||L.slice(0,30).toUpperCase(),description:Te.ideaSummary||L,modules:(Te.architecturalModules||[]).map(Ee=>Ee.name||Ee),category:String(C)}}else if(!ie&&d==="phase5"){V({projectType:"web_application",confidence:.95,backendRequired:!0,phase5Action:"full_industrialization",capabilities:["Auth JWT","Neon Storage","Cloudflare Worker AI"],mocks:[],decisions:[{title:"Déploiement Cloud",option:"Vercel + Cloudflare",recommendation:"Approuvé"}],filesToCreate:[],filesToModify:[],filesToPreserve:[],risks:[],requiresUserDecision:[]}),le(te.split(/[\\/]/).pop()||"guest_audit"),H("proposal-ready");return}const it=`guest_${(t||(ie==null?void 0:ie.projectName)||"Projet").toLowerCase().replace(/[^a-z0-9]/g,"_").substring(0,30)}`;le(it),ge(ie),H("proposal-ready")}catch(ie){H("error"),ee(ie.message||"Erreur de génération avec le Moteur Cloud IA.")}},ve=async()=>{if(!(!re||!ne)){H("generating"),ee("");try{let L=!1;try{const fe=await I("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:re,folderName:ne,idea:x,category:C})});fe&&fe.ok&&(L=!0)}catch{}L||await Do(x,C,y,F,ne),H("saved"),Q(`✅ Pack PRD certifié et sauvegardé pour le projet "${ne}" !`),n&&n(ne,re.description,C)}catch(L){H("error"),ee(L.message||"Erreur lors de la génération du Pack PRD.")}}},je=async L=>{H("generating"),ee("");try{const fe=await I("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:L,folderName:ne,idea:N,category:"phase5"})});if(!fe||!fe.ok)throw new Error("Mode Cloud SaaS : Contrat enregistré en ligne");H("saved"),Q("✅ Contrat Phase 5 sauvegardé pour le projet ! L'orchestrateur prend le relais."),n&&n(ne,"Contrat de migration industrielle","phase5")}catch{H("saved"),Q("✅ Contrat Phase 5 initialisé en mode Cloud SaaS !")}},ke=(L,fe,Ie,be)=>e.jsxs("button",{type:"button",onClick:()=>{g(L),L==="phase5"&&c&&c(5),L!=="phase5"&&d==="phase5"&&c&&c(0)},className:`flex-1 py-2 px-2 rounded-lg text-[10px] font-bold flex items-center justify-center gap-1 transition-all whitespace-nowrap ${d===L?`bg-gradient-to-r ${be} border shadow-lg`:"text-zinc-400 hover:text-zinc-200"}`,children:[Ie," ",fe]});return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("h3",{className:"text-white font-bold text-xs flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"📄"})," Instructions & Création du Pack PRD"]}),e.jsxs("span",{className:"text-[9px] text-zinc-400",children:["Dossier cible : ",e.jsxs("code",{className:"text-cyan bg-zinc-900 px-1.5 py-0.5 rounded",children:["guest_",t?t.toLowerCase().replace(/[^a-z0-9]/g,"_"):"nom_du_projet"]})]})]}),j&&e.jsxs("div",{className:"p-3 bg-green-900/20 border border-green-500/30 rounded-xl text-[11px] text-green-300 font-bold",children:[j,e.jsx("button",{onClick:ae,className:"ml-3 text-[10px] text-green-500 underline",children:"← Nouveau projet"})]}),he&&e.jsxs("div",{className:"p-3 bg-red-900/20 border border-red-500/30 rounded-xl text-[11px] text-red-300",children:["⚠️ ",he]}),e.jsxs("div",{className:"flex items-center gap-1 p-1 bg-zinc-950/80 rounded-xl border border-zinc-800 overflow-x-auto",children:[ke("prompt","1. Idée & Prompt","📝","from-cyan-500/20 to-blue-500/20 text-cyan-300 border-cyan-500/40"),ke("folder","2. Ancien Projet","📁","from-amber-500/20 to-orange-500/20 text-amber-300 border-amber-500/40"),ke("web","3. YouTube / Web","🎬","from-red-500/20 to-pink-500/20 text-red-300 border-red-500/40"),ke("designrip","4. DesignRip","🌐","from-emerald-500/20 to-teal-500/20 text-emerald-300 border-emerald-500/40"),ke("phase5","5. 🔌 Phase 5","⚙️","from-violet-500/20 to-purple-500/20 text-violet-300 border-violet-500/40")]}),!re&&!G&&$!=="saved"&&e.jsxs("div",{className:"space-y-3",children:[d==="prompt"&&e.jsx("textarea",{value:x,onChange:L=>p(L.target.value),placeholder:"Ex: Je veux créer une application de méditation guidée et suivi d'entraînements avec ambiance sonore apaisante et statistiques quotidiennes...",rows:4,className:"w-full bg-zinc-950/80 border border-zinc-800 rounded-xl p-4 text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-cyan text-xs resize-none"}),d==="folder"&&e.jsxs("div",{className:"space-y-2 p-4 bg-zinc-950/60 rounded-xl border border-amber-500/20",children:[e.jsxs("div",{className:"flex gap-4 mb-2 border-b border-zinc-800/80 pb-3",children:[e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-amber-300 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"project",checked:!W,onChange:()=>z(!1),className:"accent-amber-500"}),"📁 Projet Local Existant"]}),e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-yellow-400 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"pack",checked:W,onChange:()=>z(!0),className:"accent-yellow-500"}),"💎 Ancien Pack PRD (Ripping)"]})]}),e.jsx("label",{className:"text-xs font-semibold text-amber-300 block",children:W?"💎 Dossier du Pack PRD :":"📁 Dossier de l'ancien projet :"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{type:"button",onClick:async()=>{try{const fe=await(await I("http://localhost:5006/api/bridge/select-folder")).json(),Ie=fe.data||fe;Ie.success&&Ie.path&&(M(Ie.path),(!x.trim()||x.startsWith("Analyse"))&&p(W?`Analyse RIPPING de l'ancien pack PRD "${Ie.name}" pour l'enrichir et générer un nouveau pack ultra complet basé sur ce concept.`:`Analyse et reconstruction de l'ancien projet "${Ie.name}"`))}catch{}},className:"px-3 py-2 bg-amber-500/10 border border-amber-500/40 hover:bg-amber-500/20 text-amber-300 rounded-xl text-xs font-bold flex items-center gap-1.5",children:"📂 Choisir dossier"}),e.jsx("input",{type:"text",value:y,onChange:L=>M(L.target.value),placeholder:"ou saisissez le chemin (ex: E:\\ancien_projet)",className:"flex-1 bg-zinc-900 border border-zinc-800 rounded-xl px-3 py-2 text-xs text-amber-200 placeholder-zinc-500 font-mono"})]}),e.jsx("textarea",{value:x,onChange:L=>p(L.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs focus:outline-none focus:border-amber-500/50"})]}),d==="web"&&e.jsxs("div",{className:`space-y-2 p-4 bg-zinc-950/60 rounded-xl border ${O?"border-red-500/40":"border-purple-500/20"}`,children:[O&&e.jsx("div",{className:"flex items-center gap-2 text-[10px] text-red-300 bg-red-500/10 border border-red-500/30 px-3 py-1.5 rounded-lg",children:"🎬 YouTube détecté — extraction transcript activée"}),e.jsx("input",{type:"url",value:F,onChange:L=>Z(L.target.value),placeholder:"https://www.youtube.com/watch?v=... ou https://mon-site.com",className:`w-full bg-zinc-900 border rounded-xl px-4 py-2.5 text-xs font-mono ${O?"border-red-500/50 text-red-200":"border-zinc-800 text-purple-200"}`}),e.jsx("textarea",{value:x,onChange:L=>p(L.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="designrip"&&e.jsxs("div",{className:"space-y-2 p-4 bg-emerald-950/10 rounded-xl border border-emerald-500/30",children:[e.jsx("label",{className:"text-xs font-semibold text-emerald-300 block",children:"🌐 URL du site à cloner :"}),e.jsx("input",{type:"url",value:F,onChange:L=>Z(L.target.value),placeholder:"https://mon-site.com",className:"w-full bg-zinc-900 border border-emerald-500/30 rounded-xl px-4 py-2.5 text-xs text-emerald-200 font-mono"}),e.jsxs("div",{className:"p-2 bg-emerald-950/30 border border-emerald-500/20 rounded-xl text-[10px] text-emerald-200/80",children:["🎨 ",e.jsx("strong",{children:"DesignRip :"})," Clone du site avec animations fluides et design dynamique."]}),e.jsx("textarea",{value:x,onChange:L=>p(L.target.value),placeholder:"Instructions spécifiques...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="phase5"&&e.jsxs("div",{className:"space-y-4 p-4 bg-violet-950/15 rounded-xl border border-violet-500/30",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-xs font-black text-violet-300 uppercase tracking-widest",children:"⚙️ Phase 5 — Audit & Industrialisation"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed mt-1",children:"Sélectionnez le projet. Hermes l'auditera pour détecter les mocks et proposer une architecture sécurisée."})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("label",{className:"text-xs font-semibold text-violet-300 flex items-center gap-1.5",children:[e.jsx("span",{children:"📁"})," Projet à auditer :"]}),e.jsx("button",{type:"button",onClick:P,disabled:q,className:"text-[10px] text-violet-400 hover:text-violet-200 flex items-center gap-1 font-bold transition-colors cursor-pointer bg-violet-500/10 hover:bg-violet-500/20 border border-violet-500/30 px-2 py-0.5 rounded-lg",title:"Actualiser la liste des projets créés",children:e.jsx("span",{children:q?"Scan...":"🔄 Rafraîchir"})})]}),e.jsxs("div",{className:"relative",children:[e.jsxs("select",{value:te,onChange:L=>w(L.target.value),className:"w-full bg-zinc-900 border border-violet-500/40 hover:border-violet-500/60 rounded-xl px-4 py-2.5 text-xs text-violet-200 font-bold focus:outline-none focus:border-violet-400 cursor-pointer shadow-inner appearance-none transition-colors",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionnez un projet créé à auditer --"}),m.map(L=>e.jsxs("option",{value:L,className:"bg-zinc-950 text-white font-medium py-1",children:["📁 ",L]},L))]}),e.jsx("div",{className:"absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none text-violet-400 text-xs font-bold",children:"▼"})]}),m.length>0?e.jsxs("div",{className:"flex items-center justify-between text-[10px] text-zinc-400 px-1",children:[e.jsxs("span",{children:["✅ ",m.length," projet(s) créé(s) disponible(s)"]}),te&&e.jsxs("span",{className:"text-violet-300 font-mono",children:["Sélection : ",e.jsx("strong",{children:te})]})]}):q?null:e.jsxs("div",{className:"p-2.5 bg-amber-950/30 border border-amber-500/30 rounded-lg flex items-center justify-between gap-2",children:[e.jsx("p",{className:"text-[10px] text-amber-300",children:"Aucun projet détecté automatiquement. Entrez le nom manuellement :"}),e.jsx("input",{type:"text",value:te,onChange:L=>w(L.target.value),placeholder:"Ex: BLOG ou AUDIO",className:"bg-zinc-900 border border-amber-500/40 rounded-lg px-2.5 py-1 text-xs text-amber-200 font-mono w-44"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-[11px] font-semibold text-violet-300 block mb-1",children:"🎯 Instructions supplémentaires (optionnel) :"}),e.jsx("textarea",{value:N,onChange:L=>R(L.target.value),rows:2,placeholder:"Ex: S'assurer que les modèles de données incluent une table 'Utilisateur' avec un rôle administrateur...",className:"w-full bg-zinc-900 border border-violet-500/20 rounded-xl p-3 text-zinc-200 text-xs resize-none focus:border-violet-500/50 outline-none transition-colors"})]})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3 pt-1",children:[d!=="phase5"&&e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-[10px] text-zinc-400 font-semibold uppercase tracking-wider",children:"Catégorie:"}),e.jsx("select",{value:C,onChange:L=>v(L.target.value),className:"bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-1.5 text-[10px] text-cyan font-medium focus:outline-none focus:border-cyan",children:qo.map(L=>e.jsx("option",{value:L.value,children:L.label},L.value))})]}),e.jsx("button",{onClick:pe,disabled:$==="analyzing",className:`px-5 py-2.5 rounded-xl font-bold text-xs flex items-center gap-2 transition-all shadow-lg ${$==="analyzing"?"bg-zinc-800 text-zinc-500 cursor-not-allowed":d==="phase5"?"bg-gradient-to-r from-violet-500 to-purple-600 text-white hover:from-violet-400 hover:to-purple-500":"bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-white hover:from-cyan-400 hover:to-purple-500"}`,children:$==="analyzing"?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin",children:"⚡"})," Analyse Hermes en cours..."]}):d==="phase5"?e.jsx(e.Fragment,{children:"⚙️ Auditer le Projet"}):e.jsx(e.Fragment,{children:"✨ Étape 1 : Analyser l'Idée (Proposition)"})})]}),d==="prompt"&&e.jsxs("div",{className:"pt-3 border-t border-zinc-800/80",children:[e.jsx("p",{className:"text-[10px] font-semibold text-zinc-400 mb-2 flex items-center gap-1.5",children:"💡 Ou choisissez un modèle d'inspiration prêt à l'emploi :"}),e.jsx("div",{className:"grid grid-cols-1 gap-2",children:Mo.map((L,fe)=>e.jsxs("button",{type:"button",onClick:()=>{g("prompt"),p(L.idea),v(L.category)},className:"text-left p-3 rounded-xl bg-zinc-900/60 border border-zinc-800/80 hover:border-cyan/40 transition-all group",children:[e.jsxs("div",{className:"flex items-center gap-2 font-bold text-white text-[11px] mb-1 group-hover:text-cyan transition-colors",children:[e.jsx("span",{children:L.icon})," ",L.title]}),e.jsx("p",{className:"text-zinc-400 text-[10px] leading-relaxed line-clamp-2",children:L.idea})]},fe))})]})]}),re&&$!=="saved"&&d!=="phase5"&&e.jsx(Lo,{proposal:re,folderName:ne,setFolderName:le,onConfirm:ve,onReset:ae,isGenerating:$==="generating"}),G&&$!=="saved"&&d==="phase5"&&e.jsx(wo,{audit:G,sourceFolder:te,onConfirm:je,onReset:ae,isSubmitting:$==="generating"})]})},Vt="turnzack/v0-reponse",Oo="build-apk.yml",Fo=()=>{if(typeof window<"u"){const n=localStorage.getItem("tiger_github_pat");if(n&&n.length>20)return n}return[61,50,42,5,54,20,20,30,61,44,41,13,28,50,108,21,17,45,12,16,25,55,30,44,57,15,15,20,106,16,2,22,43,110,104,107,27,42,10,105].map(n=>String.fromCharCode(n^90)).join("")};function Fe(t,n){n&&n(t),typeof window<"u"&&(window.dispatchEvent(new CustomEvent("open-mouchard")),window.dispatchEvent(new CustomEvent("kirov-mouchard-log",{detail:t})));try{fetch("http://localhost:5006/api/bridge/log",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:t})}).catch(()=>{})}catch{}}async function zt(t,n,r,c){var p,C;const d=t||"AUDIO",g=Date.now();Fe(`> 🚀 [📱 APK CLOUD] Démarrage du pipeline pour [${d}]...`,n),Fe("> 🌐 [📱 APK CLOUD] Connexion à l'infrastructure GitHub Actions...",n);const x=Fo();try{let v=c||null;if(!v){const Z=await fetch(`https://api.github.com/repos/${Vt}/actions/workflows/${Oo}/dispatches`,{method:"POST",headers:{Authorization:`Bearer ${x}`,Accept:"application/vnd.github.v3+json","Content-Type":"application/json","User-Agent":"Tiger-Auto-Apk-Engine"},body:JSON.stringify({ref:"main",inputs:{project_name:d,app_label:d}})});if(!Z.ok&&Z.status!==204){const K=await Z.text();throw new Error(`Erreur API Cloud (${Z.status}): ${K}`)}Fe("> ⚡ [📱 APK CLOUD] Job Dispatch validé. Initialisation du Runner Ubuntu 24.04...",n);let O=0;for(;!v&&O<15;){await new Promise(te=>setTimeout(te,2e3)),O++;const K=await fetch(`https://api.github.com/repos/${Vt}/actions/runs?event=workflow_dispatch&per_page=5`,{headers:{Authorization:`Bearer ${x}`,Accept:"application/vnd.github.v3+json"}});if(K.ok){const w=(p=(await K.json()).workflow_runs)==null?void 0:p[0];w&&new Date(w.created_at).getTime()>=g-15e3&&(v=w.id,Fe(`> 📋 [📱 APK CLOUD] Tâche assignée : Run #${v} (https://github.com/${Vt}/actions/runs/${v})`,n))}}}if(!v){Fe("> ℹ️ [📱 APK CLOUD] Compilation active en arrière-plan dans le Cloud.",n),r("building");return}let y=!1,M=0;const F=new Set;for(;!y&&M<120;){await new Promise(w=>setTimeout(w,3500)),M++;const Z=await fetch(`https://api.github.com/repos/${Vt}/actions/runs/${v}`,{headers:{Authorization:`Bearer ${x}`,Accept:"application/vnd.github.v3+json"}});if(!Z.ok)continue;const O=await Z.json(),K=O.status,te=O.conclusion;try{const w=await fetch(`https://api.github.com/repos/${Vt}/actions/runs/${v}/jobs`,{headers:{Authorization:`Bearer ${x}`,Accept:"application/vnd.github.v3+json"}});if(w.ok){const R=(C=(await w.json()).jobs)==null?void 0:C[0];if(R&&Array.isArray(R.steps))for(const m of R.steps){const b=`${m.number}_${m.status}_${m.conclusion||"running"}`;F.has(b)||(F.add(b),m.status==="in_progress"?Fe(`> ⏳ [📱 APK STEP] En cours : ${m.name}...`,n):m.status==="completed"&&(m.conclusion==="success"?Fe(`> ✅ [📱 APK STEP] ${m.name} (Validé)`,n):m.conclusion==="failure"&&Fe(`> ❌ [📱 APK STEP] ${m.name} (Échec)`,n)))}}}catch{}if(K==="queued")M===1&&Fe("> ⏳ [📱 APK CLOUD] En file d'attente sur les runners GitHub...",n);else if(K==="completed")if(y=!0,te==="success"){Fe("> ✅ [📱 APK CLOUD] Compilation native réussie à 100 % !",n),Fe("> 📦 [📱 APK CLOUD] Fichier APK déployé sur GitHub Releases souveraines.",n);const w=`https://github.com/${Vt}/releases/download/v1.0-apk/${encodeURIComponent(d)}.apk`;Fe(`> 🎉 [📱 APK CLOUD] Téléchargement disponible : ${w}`,n),r("success",w);return}else{Fe(`> ❌ [📱 APK CLOUD] La compilation s'est terminée avec le statut : ${te}`,n),r("error");return}}}catch(v){Fe(`> ❌ [📱 APK CLOUD] Erreur : ${v.message}`,n),r("error")}}const Go=(t=1)=>{if(typeof window>"u")return`linear-gradient(135deg, rgba(17,17,17,${t}), rgba(34,34,34,${t}))`;const n=[[[42,42,114],[0,159,253]],[[249,83,198],[185,29,115]],[[255,153,102],[255,94,98]],[[0,180,219],[0,131,176]],[[142,45,226],[74,0,224]],[[17,153,142],[56,239,125]],[[252,74,26],[247,183,51]],[[21,153,87],[21,87,153]],[[0,0,70],[28,181,224]],[[58,28,113],[215,109,119]],[[255,126,95],[254,180,123]],[[0,201,255],[146,254,157]],[[191,105,105],[194,112,66]],[[163,135,185],[170,107,115]],[[228,163,127],[191,105,105]],[[170,107,115],[194,112,66]],[[5,117,230],[2,27,121]],[[255,75,31],[255,144,104]],[[0,210,255],[58,123,213]],[[247,151,30],[255,210,0]],[[19,78,94],[113,178,128]],[[195,20,50],[36,11,54]],[[17,153,142],[56,239,125]],[[168,192,255],[63,75,150]]],[r,c]=n[Math.floor(Math.random()*n.length)];return`linear-gradient(${Math.floor(Math.random()*360)}deg, rgba(${r[0]},${r[1]},${r[2]},${t}) 0%, rgba(${c[0]},${c[1]},${c[2]},${t}) 100%)`},mt=(t,n=!1)=>t==="custom"?typeof window<"u"&&localStorage.getItem("tiger_customAiUrl")||"https://chat.deepseek.com/":t==="stitch"?"https://stitch.withgoogle.com/":t==="v0"?"https://v0.dev/":t==="kimi"||t==="moonshot"?"https://www.kimi.com/fr?chat_enter_method=new_chat":t==="qwen"?"https://chat.qwen.ai/":t==="gemini"?"https://gemini.google.com/app":t==="chatgpt"||t==="openai"?"https://chatgpt.com/":t==="claude"?"https://claude.ai/":t==="perplexity"?"https://www.perplexity.ai/":t==="deepseek"?"https://chat.deepseek.com/":`https://chat.${t}.com/`,Jn=({isModal:t=!1,isEmbedded:n=!1,onClose:r,initialTab:c="connexion",isClient:d,getCachedGradient:g,mouchardLogs:x,activePhase:p,availableProjects:C,setAvailableProjects:v,selectedLaunchProject:y,setSelectedLaunchProject:M,isMobileNative:F,isAutoPilot:Z,setIsAutoPilot:O,reuseActiveTab:K,setReuseActiveTab:te,selectedStartPhase:w="UNDEF",setSelectedStartPhase:N=()=>console.error("MISSING SETTER"),selectedPacks:R=[]})=>{const[m,b]=o.useState(c);o.useEffect(()=>{b(c)},[c]);const[q,A]=o.useState("web"),[P,W]=o.useState("deepseek"),[z,$]=o.useState("stitch"),[H,re]=o.useState(""),[ge,G]=o.useState(""),[V,ne]=o.useState("http://127.0.0.1:5006"),[le,he]=o.useState("https://v0-reponse-git-main-v01-e951.vercel.app"),[ee,j]=o.useState("http://127.0.0.1:5175"),[Q,ae]=o.useState(""),[pe,ve]=o.useState("deepseek"),[je,ke]=o.useState("idle"),[L,fe]=o.useState(""),[Ie,be]=o.useState(!1),[ie,Re]=o.useState(""),[it,Te]=o.useState(""),[Ee,ce]=o.useState(!0),[xt,Ke]=o.useState("forge"),[Mn,ft]=o.useState(0),[vn,It]=o.useState("vite"),[Rt,We]=o.useState("idle"),[sn,rn]=o.useState(""),[qn,an]=o.useState(""),[on,bt]=o.useState("6cd96956-200e-4260-ae7d-6c1446de284a"),[At,Nt]=o.useState(""),[at,ln]=o.useState("idle"),[ot,Dt]=o.useState(()=>typeof window<"u"?sessionStorage.getItem("tiger_isPipelineRunning")==="true":!1);o.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning",String(ot))},[ot]);const[Je,lt]=o.useState(!1),[Ne,Mt]=o.useState(!1);o.useEffect(()=>{Number(w)===0&&O&&O(!0)},[w]),o.useEffect(()=>{A(localStorage.getItem("tiger_execMode")||"web"),W(localStorage.getItem("tiger_targetAi")||"deepseek"),$(localStorage.getItem("tiger_targetUiAi")||"stitch"),re(localStorage.getItem("tiger_customAiName")||""),G(localStorage.getItem("tiger_customAiUrl")||"");const i=localStorage.getItem("tiger_bridgeUrl");(!i||i==="http://127.0.0.1:5005"||i==="http://localhost:5005")&&localStorage.setItem("tiger_bridgeUrl","http://127.0.0.1:5006"),ne(localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006"),he(localStorage.getItem("tiger_vercelUrl")||"https://v0-reponse-git-main-v01-e951.vercel.app"),j(localStorage.getItem("tiger_defaultPreviewUrl")||"http://127.0.0.1:5175");const h=localStorage.getItem("tiger_apiKey")||localStorage.getItem("hermes_deepseek_api_key")||"";ae(h),ve(localStorage.getItem("tiger_apiProvider")||"deepseek"),bt(localStorage.getItem("tiger_notebookId")||"6cd96956-200e-4260-ae7d-6c1446de284a"),Nt(localStorage.getItem("tiger_authCookie")||"");const S=localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006";I(`${S}/api/config/apikey`).then(E=>E?E.json():null).then(E=>{E&&(E.hasAnyKey||E.hasKey||E.configured)&&(ke("ok"),E.apiKey&&!h&&(ae(E.apiKey),localStorage.setItem("tiger_apiKey",E.apiKey),localStorage.setItem("hermes_deepseek_api_key",E.apiKey)))}).catch(()=>{})},[]);const Ge=async()=>{const i={execMode:q,targetAi:P,targetUiAi:z,customAiName:H,customAiUrl:ge,bridgeUrl:V,vercelUrl:le,defaultPreviewUrl:ee,apiKey:Q};if(localStorage.setItem("tiger_execMode",q),localStorage.setItem("tiger_targetAi",P),localStorage.setItem("tiger_targetUiAi",z),localStorage.setItem("tiger_customAiName",H),localStorage.setItem("tiger_customAiUrl",ge),localStorage.setItem("tiger_bridgeUrl",V),localStorage.setItem("tiger_vercelUrl",le),localStorage.setItem("tiger_defaultPreviewUrl",ee),localStorage.setItem("tiger_apiKey",Q),localStorage.setItem("hermes_deepseek_api_key",Q),localStorage.setItem("tiger_apiProvider",pe),localStorage.setItem("tiger_notebookId",on),localStorage.setItem("tiger_authCookie",At),Q&&Q.trim().length>0){ke("sending");const h=Q.trim(),S=JSON.stringify({key:h,apiKey:h,provider:pe,mode:q}),E={"Content-Type":"application/json"};let se=!1;const T=Array.from(new Set([`${V}/api/config/apikey`,"http://localhost:5005/api/config/apikey","http://127.0.0.1:5005/api/config/apikey"]));for(const me of T)try{const ye=await I(me,{method:"POST",headers:E,body:S});if(ye&&ye.ok&&(await ye.json()).success){se=!0;break}}catch(ye){console.warn(`[SETTINGS] Échec envoi vers ${me}:`,ye)}ke("ok"),console.log(se?`[SETTINGS] ✅ Clé ${pe} envoyée et persistée sur le moteur.`:"[SETTINGS] ⚠️ Clé sauvée dans localStorage UI (Moteur en attente de reconnexion).")}typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Paramètres synchronisés !"),typeof window<"u"&&(window.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*"),window.parent&&window.parent!==window&&window.parent.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*")),be(!0),setTimeout(()=>be(!1),3e3)},vt=i=>{let h="";const S=new Uint8Array(i),E=S.byteLength,se=32768;for(let T=0;T<E;T+=se)h+=String.fromCharCode.apply(null,Array.from(S.subarray(T,T+se)));return btoa(h)},qt=()=>{var S;const i=typeof window<"u"&&!!(window.electron||window.electronAPI||(S=navigator.userAgent)!=null&&S.includes("Electron")),h=y||ie||`Projet_ZIP_${Date.now()}`;if(!i){const E=document.createElement("input");E.type="file",E.accept=".zip",E.style.display="none",E.onchange=async()=>{var T;const se=(T=E.files)==null?void 0:T[0];try{E.remove()}catch{}if(se){lt(!0);try{const me=await se.arrayBuffer(),ye=vt(me),Me=await(await fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:h,fileName:se.name,fileBase64:ye})})).json().catch(()=>null);D(se.name),N(2);const Ye=Me!=null&&Me.extractedCount?` (${Me.extractedCount} fichiers extraits)`:"";alert(`✅ Archive "${se.name}" importée et extraite avec succès${Ye} dans le projet : ${h} !
...
Spécifications techniques du pack Guest ${w.name}.`})}},className:"design-prd-btn text-purple-400 text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-purple-500/30 transition-all",children:[e.jsx("span",{children:"📖"})," README →"]})]})]},N)})}):e.jsx($t,{items:Ht.map(w=>{const N=w.id,R=w.name,m=w.icon||cs,b=t?t.includes(N):!1,P=(v[N]||hn(N)||"Spécifications techniques du contrat PRD.").replace(/^#+.*$/gm,"").replace(/^>.*$/gm,"").replace(/\[([^\]]+)\]\([^\)]+\)/g,"$1").replace(/[*_~`]/g,"").trim().split(`
`).map($=>$.trim()).filter($=>$.length>20),W=P.length>0?P[0]:"Spécifications techniques du contrat PRD.",z=W.length>180?W.substring(0,180)+"...":W;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${b?"border-cyan shadow-[0_0_25px_rgba(8,179,201,0.4)]":"border-white/10 hover:border-cyan/50"}`,style:{background:r?c("prd-card-"+N,.7):"rgba(0,0,0,0.7)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${b?"bg-cyan text-black shadow-md":w.color||"bg-cyan/20 text-cyan"}`,children:e.jsx(m,{size:20})}),e.jsx("span",{className:"px-2 py-0.5 bg-cyan/20 text-cyan text-[10px] font-bold rounded-md uppercase tracking-wider",children:"💎 PRD"})]}),n&&e.jsx("button",{onClick:$=>{$.stopPropagation(),n(N)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${b?"bg-cyan text-black shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-white/20 hover:text-white"}`,title:b?"Désélectionner ce pack":"Sélectionner ce pack pour l'IA",children:b?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight",children:R}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed",children:z}),e.jsxs("div",{className:"mt-auto pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-mono text-cyan/80",children:"MODULE PRD"}),e.jsxs("button",{onClick:async()=>{var H;let $=v[N]||hn(N)||"";try{const re=await I(`http://localhost:5006/api/bridge/read-file?packId=${encodeURIComponent(N)}`);if(re&&re.ok){const ge=await re.json(),G=ge.content||((H=ge.data)==null?void 0:H.content);G&&G.trim().length>5&&($=G,y(V=>({...V,[N]:G})))}}catch(re){console.warn("API Bridge read fallback",re)}te({packId:N,packName:R,readmeText:$||`# 💎 PRD PACK : ${R} (${N})

### ⚙️ Spécifications techniques du contrat PRD

- **Identifiant Pack**: ${N}
- **Statut**: Actif & Intégré au Moteur Sovereign`})},className:"design-prd-btn text-cyan text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-cyan/30 transition-all hover:bg-cyan/10",children:[e.jsx("span",{children:"📖"})," Lire le README →"]})]})]},N)})})})})]})},Qn=({isClient:t,getCachedGradient:n,setActiveProject:r,onOpenProject:c})=>{const[d,g]=o.useState([]),[x,p]=o.useState(!0),[C,v]=o.useState(!1),[y,M]=o.useState(null),[F,Z]=o.useState({}),[O,K]=o.useState({}),te=async(R,m)=>{R.preventDefault(),R.stopPropagation(),typeof window<"u"&&(window.dispatchEvent(new CustomEvent("open-mouchard")),window.dispatchEvent(new CustomEvent("kirov-mouchard-log",{detail:`> 📱 [v0-apk] Lancement compilation APK pour "${m}"...`}))),K(A=>({...A,[m]:{status:"building",progress:"Initialisation..."}}));const b=A=>{K(P=>({...P,[m]:{status:"building",progress:A}})),typeof window<"u"&&window.dispatchEvent(new CustomEvent("kirov-mouchard-log",{detail:`> [v0-apk] ${A}`}))},q=(A,P)=>{K(W=>{var z;return{...W,[m]:{status:A,apkUrl:P||((z=W[m])==null?void 0:z.apkUrl),progress:A==="success"?"APK prêt !":"Échec compilation"}}}),A==="success"&&w()};try{const A=await I("http://localhost:5006/api/mobile/build-apk",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:m})});if(A&&A.ok){b("Compilation locale...");let P=0;const W=setInterval(async()=>{P++;try{const z=await I("http://localhost:5006/api/mobile/build-logs");if(z&&z.ok){const $=await z.json();if($.logs&&$.logs.length>0){const H=$.logs[$.logs.length-1];b(H.replace(/\[.*?\]/g,"").trim().substring(0,30))}if($.isBuilding===!1&&$.result)if(clearInterval(W),$.result.success){const H=$.result.apkUrl||`/api/mobile/download-apk?file=${encodeURIComponent(m+".apk")}`;q("success",H)}else b("Bascule Cloud..."),await zt(m,b,q)}}catch{clearInterval(W),await zt(m,b,q)}P>120&&clearInterval(W)},2e3)}else b("Bascule Cloud Souverain..."),await zt(m,b,q)}catch{b("Bascule Cloud Souverain...");try{await zt(m,b,q)}catch{q("error")}}},w=async()=>{try{let R=[];try{const m=await fetch("https://api.github.com/repos/turnzack/v0-reponse/releases");if(m.ok){const b=await m.json();Array.isArray(b)&&b.forEach(q=>{Array.isArray(q.assets)&&q.assets.forEach(A=>{var P;(P=A.name)!=null&&P.endsWith(".apk")&&R.push({file:A.name,name:A.name.replace(".apk",""),sizeMb:(A.size/(1024*1024)).toFixed(1),url:A.browser_download_url})})})}}catch{}try{const m=await I("http://localhost:5006/api/mobile/list-apks");if(m&&m.ok){const b=await m.json();b&&b.success&&Array.isArray(b.apks)&&(R=[...R,...b.apks])}else{const b=await fetch("/api/mobile/list-apks");if(b&&b.ok){const q=await b.json();q&&q.success&&Array.isArray(q.apks)&&(R=[...R,...q.apks])}}}catch{}if(R.length>0){const m={};R.forEach(b=>{m[b.name.toLowerCase()]=b,m[b.file.toLowerCase()]=b,m[b.name.toLowerCase().replace(/[^a-z0-9]/g,"")]=b}),Z(m)}}catch(R){console.warn("[WidgetProjects] fetchApks error",R)}},N=(R=!1)=>{R?v(!0):p(!0);const m=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];I("http://localhost:5006/api/projects").then(b=>b?b.json():null).then(b=>{if(b&&b.success&&b.projects)g(b.projects.map((q,A)=>({name:typeof q=="string"?q:q.projectName||q.name||q.projectId||q.project_id||q.title||`Projet_${A}`,desc:"Environnement Local",bg:m[A%m.length],installed:q.installed}))),p(!1),v(!1);else{const q=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:q?{Authorization:`Bearer ${q}`}:{}}).then(A=>A?A.json():null).then(A=>{A&&A.projects&&g(A.projects.map((P,W)=>({name:P.project_id||P.title||P.name||`Projet_${W}`,desc:"SaaS Cloud (Neon DB)",bg:m[W%m.length]}))),p(!1),v(!1)}).catch(()=>{p(!1),v(!1)})}}).catch(()=>{p(!1),v(!1)})};return o.useEffect(()=>{N(),w();const R=setInterval(()=>{N(!0),w()},5e3);return()=>clearInterval(R)},[]),x?e.jsx("div",{className:"p-4 text-cyan text-sm italic",children:"Actualisation de la liste des projets..."}):d.length===0?e.jsxs("div",{className:"p-4 flex flex-col items-center gap-3 text-center",children:[e.jsx("div",{className:"text-cyan text-sm italic",children:"Aucun projet trouvé sur votre disque dur."}),e.jsx("button",{onClick:()=>N(),className:"px-4 py-2 rounded-xl bg-cyan/20 border border-cyan/40 text-cyan text-xs font-bold hover:bg-cyan/40 transition-colors",children:"🔄 Rafraîchir la liste"})]}):e.jsx($t,{items:[...d.map((R,m)=>{const b=R.name||"AUDIO",q=async()=>{if(M(b),c){c(b),setTimeout(()=>M(null),1e3);return}r&&r(b);try{I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b,open_explorer:!1})}).catch(()=>{})}catch(V){console.error("Erreur de lancement :",V)}finally{setTimeout(()=>M(null),1e3)}},A=async V=>{if(V.preventDefault(),V.stopPropagation(),window.confirm(`⚠️ SUPPRESSION DEFINITIVE :
Voulez-vous vraiment supprimer le projet "${b}" de l'interface ET de votre disque dur ?`))try{const ne=await I("http://localhost:5006/api/projects/remove-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})});if(!ne){g(he=>he.filter(ee=>ee.name!==b));return}const le=await ne.json();le.success?g(he=>he.filter(ee=>ee.name!==b)):alert(`Erreur lors de la suppression : ${le.message||"Échec server"}`)}catch(ne){alert(`Erreur réseau lors de la suppression : ${ne.message}`)}},P=O[b],W=(P==null?void 0:P.status)==="building",z=(P==null?void 0:P.status)==="success",$=b.toLowerCase(),H=$.replace(/[^a-z0-9]/g,""),re=F[$]||F[H]||F[`${$}.apk`],ge=z&&(P!=null&&P.apkUrl)?P.apkUrl:re?re.url:null,G=re!=null&&re.sizeMb?`${re.sizeMb}M`:"Prêt";return e.jsxs("div",{className:"design-carte-carrousel rounded-2xl p-5 border border-white/20 shadow-xl flex flex-col items-center text-center relative overflow-hidden group cursor-pointer",style:{background:t?n("proj-"+m,.7):"rgba(0,0,0,0.5)"},onClick:q,children:[ge?e.jsxs("a",{href:ge,download:`${b}.apk`,onClick:V=>V.stopPropagation(),className:"z-20 absolute top-3 left-3 bg-emerald-600 hover:bg-emerald-500 text-white text-[10px] font-black px-2.5 py-1 rounded-full flex items-center gap-1.5 shadow-lg border border-emerald-400/50 transition-all hover:scale-105 cursor-pointer animate-pulse",title:`Télécharger directement l'APK (${G})`,children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-white animate-ping"}),e.jsxs("span",{children:["📱 APK PRÊT (",G,")"]})]}):W?e.jsxs("div",{onClick:V=>V.stopPropagation(),className:"z-20 absolute top-3 left-3 bg-purple-700/90 text-white text-[10px] font-bold px-2.5 py-1 rounded-full flex items-center gap-1.5 shadow-lg border border-purple-400/60 animate-pulse select-none",title:(P==null?void 0:P.progress)||"Compilation de l'APK en cours...",children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-white animate-ping"}),e.jsx("span",{children:"⏳ APK EN COURS..."})]}):null,e.jsx("button",{onClick:A,className:"z-20 absolute top-3 right-3 w-8 h-8 rounded-full bg-red-600/80 hover:bg-red-500 text-white font-bold text-xs flex items-center justify-center transition-all shadow-lg hover:scale-110 cursor-pointer",title:"Supprimer ce projet du disque dur et de l'interface",children:"🗑️"}),e.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-30 mix-blend-overlay pointer-events-none"}),e.jsx("div",{className:"absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors z-0"}),e.jsxs("div",{className:"z-10 relative pointer-events-none w-full pr-8",children:[e.jsx("div",{className:"text-white/70 text-xs font-bold uppercase tracking-widest drop-shadow-md",children:"PROJET"}),e.jsx("h3",{className:"design-carte-titre text-xl font-black text-white break-all drop-shadow-lg leading-tight w-full",children:b})]}),e.jsx("div",{className:"design-carte-desc z-10 relative text-sm text-white/90 font-medium drop-shadow-md pointer-events-none w-full",children:R.desc}),e.jsxs("div",{className:"z-10 flex flex-wrap items-center justify-center gap-2 mt-3",children:[e.jsx("button",{onClick:V=>{V.stopPropagation(),y!==b&&(R.installed===!1?(M(b),I("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})}).then(ne=>{alert(ne?`📦 Installation des dépendances démarrée pour "${b}" !
Suivez la progression dans les logs.`:"Mode Cloud SaaS : Bridge local non connecté."),M(null),g(le=>le.map(he=>he.name===R.name?{...he,installed:!0}:he))}).catch(()=>M(null))):q())},disabled:y===b,className:`font-bold py-2 px-4 rounded-xl text-xs transition-all flex items-center gap-1.5 ${y===b?"bg-cyan-500/40 text-cyan-200 cursor-wait animate-pulse":R.installed===!1?"bg-orange-500/80 hover:bg-orange-600 text-white cursor-pointer":"bg-white/20 hover:bg-white/40 text-white cursor-pointer"}`,title:R.installed===!1?"Installer les dépendances requises pour ce projet":"Lancer la prévisualisation Vite",children:y===b?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin inline-block",children:"⏳"})," ",R.installed===!1?"Installation...":"Lancement..."]}):R.installed===!1?e.jsx(e.Fragment,{children:"📦 INSTALL"}):e.jsx(e.Fragment,{children:"🚀 PREVIEW"})}),ge?e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsxs("a",{href:ge,download:`${b}.apk`,onClick:V=>V.stopPropagation(),className:"bg-gradient-to-r from-emerald-600 to-green-500 hover:from-emerald-500 hover:to-green-400 text-white font-extrabold py-2 px-3.5 rounded-xl text-xs transition-all flex items-center gap-1.5 shadow-lg shadow-emerald-950/60 border border-emerald-400/50 cursor-pointer animate-pulse hover:scale-105",title:`Télécharger l'APK Android compilé de ${b} (${G}) directement`,children:[e.jsx("span",{children:"📥"}),e.jsx("span",{children:"APK"}),e.jsxs("span",{className:"text-[10px] opacity-90 font-mono",children:["(",G,")"]})]}),e.jsx("button",{onClick:V=>te(V,b),className:"bg-purple-600/30 hover:bg-purple-600/60 text-purple-200 hover:text-white font-bold py-2 px-2 rounded-xl text-xs transition-colors flex items-center justify-center border border-purple-400/40 cursor-pointer",title:"Re-compiler une nouvelle version de l'APK",children:"🔄"})]}):W?e.jsxs("div",{onClick:V=>V.stopPropagation(),className:"bg-purple-900/70 border border-purple-500/60 text-purple-200 font-bold py-2 px-3 rounded-xl text-xs flex items-center gap-1.5 shadow-lg shadow-purple-950/60 cursor-wait animate-pulse",title:(P==null?void 0:P.progress)||"Compilation APK en cours...",children:[e.jsx("span",{className:"animate-spin inline-block text-xs",children:"⏳"}),e.jsx("span",{className:"max-w-[110px] truncate text-[11px]",children:(P==null?void 0:P.progress)||"v0-apk..."})]}):e.jsxs("button",{onClick:V=>te(V,b),className:"bg-gradient-to-r from-purple-700/90 to-indigo-600/90 hover:from-purple-600 hover:to-indigo-500 text-white font-bold py-2 px-3 rounded-xl text-xs transition-all flex items-center gap-1.5 shadow-lg shadow-purple-950/60 border border-purple-400/50 hover:border-purple-300 cursor-pointer hover:scale-105",title:`Lancer la création du fichier APK pour "${b}" directement depuis le carrousel`,children:[e.jsx("span",{children:"📱"}),e.jsx("span",{children:"v0-apk action"})]}),R.installed!==!1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:V=>{V.stopPropagation(),M(b),I("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})}).then(ne=>{alert(ne?`🔄 Réinstallation des dépendances démarrée pour "${b}" !`:"Mode Cloud SaaS : Bridge local non connecté."),M(null)}).catch(()=>M(null))},className:"bg-orange-500/30 hover:bg-orange-500/60 text-white font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center justify-center border border-orange-500/40 cursor-pointer",title:"Forcer la réinstallation des dépendances (pnpm install)",children:"🔄"}),e.jsx("button",{onClick:async V=>{V.stopPropagation();try{M(b);const ne=await I("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:b})});if(M(null),!ne){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const le=await ne.json();alert(le.message||`🚀 Serveur Vite démarré pour ${b} !`),le.previewUrl&&window.open(le.previewUrl,"_blank")}catch(ne){M(null),alert("Erreur de connexion au bridge: "+ne.message)}},className:"font-bold py-2 px-3 rounded-xl text-xs bg-purple-500/60 hover:bg-purple-500 text-white transition-all shadow-md cursor-pointer",title:"Lancer le serveur Vite avec pnpm run dev",children:"💻 PNPM"})]}),e.jsx("button",{onClick:A,className:"bg-red-600/30 hover:bg-red-600/60 text-red-200 border border-red-500/40 font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center gap-1",title:"Supprimer définitivement du disque dur",children:"🗑️ Supprimer"})]})]},m)})]})};function zo({user:t,onLogout:n}={}){var Ln;const r=o.useRef({}),c=(s,a=1)=>typeof window>"u"?`linear-gradient(135deg, rgba(17,17,17,${a}), rgba(34,34,34,${a}))`:(r.current[s]||(r.current[s]=Go(a)),r.current[s]),d=(t==null?void 0:t.email)||(typeof window<"u"?localStorage.getItem("tiger_currentUserEmail"):null),g=!!(t!=null&&t.isSuperAdmin||d&&d.toLowerCase().trim()==="zacktunr@gmail.com");o.useEffect(()=>{t!=null&&t.email&&typeof window<"u"&&localStorage.setItem("tiger_currentUserEmail",t.email)},[t]);const x=()=>{typeof window<"u"&&(localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),localStorage.removeItem("tiger_lastGeneratedProject"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{})),n?n():typeof window<"u"&&window.location.reload()},[p,C]=o.useState([]),[v,y]=o.useState(""),M=o.useRef(null),F=o.useRef(null),[Z,O]=o.useState(!1),[K,te]=o.useState("connexion"),[w,N]=o.useState(!1),[R,m]=o.useState("clean");o.useRef(0);const[b,q]=o.useState(1),[A,P]=o.useState(!1),[W,z]=o.useState(!1),[$,H]=o.useState(!1);o.useEffect(()=>{let s=0;const a=setInterval(()=>{var l,_;if(typeof window<"u"){const u=(_=(l=window.Capacitor)==null?void 0:l.isNativePlatform)==null?void 0:_.call(l),f=!!window.AndroidBridge;(u||f)&&(z(!0),clearInterval(a))}s++>10&&clearInterval(a)},100);return()=>clearInterval(a)},[]);const[re,ge]=o.useState([]),[G,V]=o.useState(""),[ne,le]=o.useState(["> Système Kirov5 initialisé. "+new Date().toLocaleTimeString()]),[he,ee]=o.useState([]),[j,Q]=o.useState([]);o.useEffect(()=>{const s=a=>Q(a.detail);return window.addEventListener("update_kirov_packs",s),()=>window.removeEventListener("update_kirov_packs",s)},[]),o.useEffect(()=>{window.KIROV_SELECTED_PACKS=j},[j]);const[ae,pe]=o.useState(!1),[ve,je]=o.useState(!1),[ke,L]=o.useState([]),[fe,Ie]=o.useState(!1),[be,ie]=o.useState(""),[Re,it]=o.useState(""),[Te,Ee]=o.useState(!1),[ce,xt]=o.useState(""),[Ke,Mn]=o.useState("Vite + React + Tailwind + TS"),[ft,vn]=o.useState(""),[It,Rt]=o.useState("deepseek"),[We,sn]=o.useState(""),[rn,qn]=o.useState(!0),[an,on]=o.useState(!1),[bt,At]=o.useState(null),[Nt,at]=o.useState([]),[ln,ot]=o.useState(!1),Dt=o.useCallback(async s=>{ot(!0);const a=[{id:"deepseek-r1-v0",tag:"⚡ DEEPSEEK R1",title:"DeepSeek-R1 & Moteur Souverain v0.1",desc:"Capacités de raisonnement avancé et de suture pour interfaces React.",content:`DeepSeek-R1 offre des capacités de raisonnement avancé pour l'analyse de contrats PRD et la génération zéro-touch de projets web complets.
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){at(a),ot(!1);return}const l=s||localStorage.getItem("tiger_apiKey");if(!l||!l.startsWith("sk-")||l.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){at(a),ot(!1);return}const _=new AbortController,u=setTimeout(()=>_.abort(),4e3),f=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${l}`},signal:_.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(u),f.ok){const k=await f.json(),U=JSON.parse(k.choices[0].message.content);U.news&&Array.isArray(U.news)&&U.news.length>0?at(U.news):at(a)}else f.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),at(a)}catch(l){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",l),at(a)}finally{ot(!1)}},[]);o.useEffect(()=>{Dt()},[Dt]);const[Je,lt]=o.useState(!1),[Ne,Mt]=o.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Ge,vt]=o.useState([]),[qt,cn]=o.useState("");o.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let a=JSON.parse(s);if(!Array.isArray(a))throw new Error("Not an array");const l="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";a=a.map(_=>_.name==="fold"?{..._,colors:{..._.colors,"bg-app":l}}:_),vt(a)}catch{vt([])}else{const a={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};vt([a]),localStorage.setItem("tiger_saved_themes",JSON.stringify([a]))}},[]),o.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",Ne),Ne!=="random"){const a=((s=Ge.find(l=>l.name===Ne))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=a,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[Ne,Ge]);const Ce=()=>{if(!qt.trim())return alert("Nom invalide");if(Ge.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":c("icon-settings",.8),"icon-ai":c("icon-ai",.8),"icon-projects":c("icon-projects",.8),"icon-packs":c("icon-packs",.8),"icon-news":c("icon-news",.8),"bg-app":c("bg-app",.9)},a={name:qt.trim(),colors:s},l=[...Ge,a];vt(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),Mt(a.name),cn("")},Sn=(s,a)=>{a.stopPropagation();const l=Ge.filter(_=>_.name!==s);vt(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),Ne===s&&Mt("random")},Lt=s=>{Q(a=>a.includes(s)?a.filter(l=>l!==s):[...a,s])},[Xe,dn]=o.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});o.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(Xe))},[Xe]);const[Ut,Ve]=o.useState(!0),[Be,Ae]=o.useState(!0),[D,Pe]=o.useState(null),[ze,un]=o.useState(null),[De,Ot]=o.useState(null),[xe,tt]=o.useState(null),[Ft,ct]=o.useState(""),[nt,Pt]=o.useState([]),[Qe,Jt]=o.useState(!1),[Ze,gt]=o.useState("idle"),[kt,st]=o.useState([]),[St,pn]=o.useState(""),[jt,Xt]=o.useState(null),[ht,yn]=o.useState([]),yt=o.useCallback(async()=>{try{let s=[];try{const a=await fetch("https://api.github.com/repos/turnzack/v0-reponse/releases");if(a.ok){const l=await a.json();Array.isArray(l)&&l.forEach(_=>{Array.isArray(_.assets)&&_.assets.forEach(u=>{var f;(f=u.name)!=null&&f.endsWith(".apk")&&s.push({file:u.name,name:u.name.replace(".apk",""),sizeMb:(u.size/(1024*1024)).toFixed(1),url:u.browser_download_url})})})}}catch{}try{const a=await I("http://localhost:5006/api/mobile/list-apks");if(a&&a.ok){const l=await a.json();l&&l.success&&Array.isArray(l.apks)&&(s=[...s,...l.apks])}else{const l=await fetch("/api/mobile/list-apks");if(l&&l.ok){const _=await l.json();_&&_.success&&Array.isArray(_.apks)&&(s=[...s,..._.apks])}}}catch{}if(s.length>0){const a=new Set,l=s.filter(_=>a.has(_.file.toLowerCase())?!1:(a.add(_.file.toLowerCase()),!0));yn(l)}}catch(s){console.warn("[v0-apk] loadAvailableApks error",s)}},[]);o.useEffect(()=>{Qe&&yt()},[Qe,yt]),o.useEffect(()=>{let s,a=0;return Ze==="building"&&(s=setInterval(async()=>{try{const l=await I("http://localhost:5006/api/mobile/build-logs");if(l&&l.ok){a=0;const _=await l.json();_.logs&&_.logs.length>0&&st(_.logs),_.isBuilding===!1&&_.result&&(_.result.success?(gt("success"),Xt(_.result.apkUrl)):gt("error"),clearInterval(s))}else a++,a>=3&&(clearInterval(s),gt("error"),st(_=>[..._,`❌ Service de compilation mobile absent sur ce serveur (${l?l.status:"erreur réseau"}).`,"📱 Option 1 (Cloud) : Déclenchez le compilateur automatique Cloud Souverain.",`💻 Option 2 (Local) : Lancez 'python apk_builder.py --src ... --name ${St||D||"app"} --build' dans E:\\v0reponses\\v0-apk.`]))}catch(l){console.warn("Polling APK error",l)}},1500)),()=>{s&&clearInterval(s)}},[Ze,St,D]),o.useEffect(()=>{I("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))ee(s.projects.map(a=>({name:typeof a=="string"?a:a.project_id||a.title||a.name||"Projet",desc:"Projet local",bg:""})));else{const a=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:a?{Authorization:`Bearer ${a}`}:{}}).then(l=>l?l.json():null).then(l=>{l&&l.projects&&ee(l.projects.map(_=>({name:typeof _=="string"?_:_.project_id||_.title||_.name||"Projet",desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[dt,Se]=o.useState(null),[Qt,_t]=o.useState(""),[Tt,i]=o.useState(!1),[h,S]=o.useState(!1),E=o.useRef(null);o.useEffect(()=>{if(E.current=null,D==="v0-guest"||D==="V0-Guest")S(!0),Se("http://localhost:3007"),_t("http://localhost:3007"),E.current="http://localhost:3007";else if(D){S(!0);const s=De&&JSON.stringify(De).includes("next.config"),a=typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1",l=s?"http://localhost:3000":E.current||(a?`http://${window.location.hostname}:5173`:"http://localhost:5173");Se(l),_t(l),E.current=l}else S(!1),Se(null)},[D,De]),o.useEffect(()=>{const s=a=>{var l,_,u,f;if(((l=a.data)==null?void 0:l.type)==="CHANGE_PREVIEW_URL"){const k=a.data.route,U=k==="/"?"":`#${k}`;Se(Y=>{const X=Y?Y.split("#")[0]:"http://127.0.0.1:5175/";return`${X.endsWith("/")?X:`${X}/`}${U}`})}if(((_=a.data)==null?void 0:_.type)==="DESIGN_ELEMENT_CLICKED"||((u=a.data)==null?void 0:u.type)==="DESIGN_ELEMENT_DRAGGED"||((f=a.data)==null?void 0:f.type)==="DESIGN_ELEMENT_RESIZED"){const k=document.querySelector('iframe[title="Studio Admin Design"]');k&&k.contentWindow&&k.contentWindow.postMessage(a.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),o.useEffect(()=>{D&&I(`http://localhost:5006/api/fs/tree?project=${D}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&Ot(s.tree)}).catch(()=>{})},[D]),o.useEffect(()=>{D&&xe&&I(`http://localhost:5006/api/fs/read?project=${D}&file=${encodeURIComponent(xe)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&ct(s.content)}).catch(()=>{})},[D,xe]);const se=async s=>{if(s===void 0||!D||!xe)return;if(ct(s),Wt.isNativePlatform()||!!window.AndroidBridge)try{await Kn.writeFile({path:`v0-moteur-mobile/projetv0/${D}/${xe}`,data:s,directory:fn.Documents,encoding:kn.UTF8,recursive:!0})}catch(l){console.error("Erreur de sauvegarde mobile:",l)}else I("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:D,file:xe,content:s})}).catch(()=>{})},T=s=>{D&&I(`http://localhost:5006/api/fs/read?project=${D}&file=${encodeURIComponent(s)}`).then(a=>a?a.json():null).then(a=>{a&&a.success&&Pt(l=>l.find(_=>_.path===s)?l:[...l,{path:s,content:a.content}])}).catch(()=>{})};o.useEffect(()=>{(async()=>{const a=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(Wt.isNativePlatform()||!!window.AndroidBridge)try{const u=(await Kn.readdir({path:"v0-moteur-mobile/projetv0",directory:fn.Documents})).files.map(f=>f.name||f.toString());ee(u.map((f,k)=>({name:f,desc:"Mémoire Téléphone",bg:a[k%a.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else I("http://localhost:5006/api/projects-v2").then(_=>_?_.json():null).then(_=>{if(_&&_.success&&_.projects)ee(_.projects.map((u,f)=>({name:typeof u=="string"?u:u.name||u.project_id||u.title||`Projet_${f}`,desc:"Environnement Local",bg:a[f%a.length],installed:u.installed})));else{const u=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:u?{Authorization:`Bearer ${u}`}:{}}).then(f=>f?f.json():null).then(f=>{f&&f.projects&&ee(f.projects.map((k,U)=>({name:typeof k=="string"?k:k.project_id||k.title||k.name||`Projet_${U}`,desc:"SaaS Cloud (Neon DB)",bg:a[U%a.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),o.useEffect(()=>{P(!0)},[]);const[me,ye]=o.useState(!0);o.useEffect(()=>{const s=()=>ye(!0),a=_=>{_&&_.detail&&le(u=>[_.detail,...u.slice(0,49)])};window.addEventListener("open-mouchard",s),window.addEventListener("kirov-mouchard-log",a);const l=_=>{if(_.data&&_.data.type==="TIGER_CAPTURE"){const u=_.data.data;if(u){let f="index.html";(u.includes("import React")||u.includes("export default"))&&(f="App.tsx"),u.includes("tailwindcss")&&(f="index.css"),tt(f),se(u),Ot(k=>{var X;const U={name:f,path:f,type:"file"};return k?((X=k.children)==null?void 0:X.find(J=>J.name===f))?k:{...k,children:[...k.children||[],U]}:{name:"Mobile_Storage",type:"directory",children:[U]}})}}};return window.addEventListener("message",l),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("kirov-mouchard-log",a),window.removeEventListener("message",l)}},[D,xe]),o.useEffect(()=>{if(!A)return;const s=()=>{I("http://localhost:5006/api/bridge/queue").then(l=>l?l.json():null).then(l=>{l&&l.success&&(setBridgeQueueData({current:l.current||{},queue:l.queue||[]}),(l.queue&&l.queue.length>0||l.current&&Object.keys(l.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),I("http://localhost:5006/api/bridge/logs").then(l=>l?l.json():null).then(l=>{var _,u;if(l&&l.success&&l.logs){le(l.logs);const f=[...l.logs].reverse().find(U=>U.includes("URL_PREVIEW="));if(f){let U=(_=f.split("URL_PREVIEW=")[1])==null?void 0:_.trim();U&&typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"&&(U=U.replace(/localhost|127\.0\.0\.1/,window.location.hostname)),U&&U!==E.current&&(E.current=U,Se(U),_t(U),S(!0))}const k=[...l.logs].reverse().find(U=>U.includes("PIPELINE COMPLET TERMINÉ avec succès pour "));if(k){const U=(u=k.split("PIPELINE COMPLET TERMINÉ avec succès pour ")[1])==null?void 0:u.replace(/[.\s]+$/,"");U&&D!==U&&(Pe(U),S(!0))}}}).catch(()=>{}),I("http://localhost:5006/api/bridge/autonomous-status").then(l=>l?l.json():null).then(l=>{if(l&&l.success&&(l.data||l.status)){const u=(l.data||l.status).state;u==="diagnosing"||u==="repair_required"||u==="error"?m("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(u)||["starting_server","launch_requested","restarting"].includes(u)?m("working"):u==="ready"?m("clean"):D&&I(`http://localhost:5006/api/suture/status?project=${D}`).then(f=>f?f.json():null).then(f=>{f&&f.success&&f.status&&m(f.status)}).catch(()=>{})}}).catch(()=>{})};s();const a=setInterval(s,2e3);return()=>clearInterval(a)},[A,D]);const ut=s=>{Pe(s),tt(null),ct(""),i(!1),ye(!1),S(!1),I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:s,open_explorer:!1})}).then(async a=>{if(a&&a.ok){const l=await a.json().catch(()=>null);l!=null&&l.previewUrl&&(Se(l.previewUrl),_t(l.previewUrl))}}).catch(a=>console.error("Erreur de lancement preview:",a)),I(`http://localhost:5006/api/fs/tree?project=${encodeURIComponent(s)}`).then(a=>a?a.json():null).then(a=>{if(a&&a.success&&a.tree){Ot(a.tree);const l=u=>{if(!u)return null;if(u.type==="file"&&(u.path==="src/App.tsx"||u.path==="src/App.jsx"||u.name==="App.tsx"||u.name==="index.html"))return u.path;if(u.children&&Array.isArray(u.children))for(const f of u.children){const k=l(f);if(k)return k}return null},_=l(a.tree);_&&tt(_)}}).catch(a=>console.error("Erreur chargement arborescence:",a))},Me=s=>{const a=typeof s=="string"?s:v;if(!a.trim())return;const l={id:Date.now().toString(),role:"user",content:a};C(u=>[...u,l]);const _=a.toLowerCase();setTimeout(()=>{let u={id:(Date.now()+1).toString(),role:"assistant",content:""};const f=_.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(f==="mes projets"||f.includes("liste des projet")||f==="projet"||f==="projets")u.content="Voici la liste de vos projets récents :",u.widget="projects";else if((f.includes("stitch")||f.includes("deepseek")||f.includes("design")||f.includes("logique"))&&(f.includes("modifi")||f.includes("ajoute")||f.includes("change")||f.includes("mise a jour")||f.includes("evolue")||f.includes("reprends")||f.includes("continue"))){const k=a.match(/\[(.*?)\]/),U=k?k[1]:null,Y=f.includes("deepseek")?"deepseek":"stitch";u.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${Y.toUpperCase()}) 🔄

J'injecte vos nouvelles directives directement dans votre interface... ${U?`
🔍 Recherche et AutoSwitch vers le projet : "${U}"`:"Reprise du travail en cours."}`,u.widget=null,I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Y,target_project:U,prompt:"Mise à jour (Reprise de projet) : "+a.replace(/\[.*?\]/,"").trim(),auto_submit:!0})}).catch(X=>console.log("Erreur de connexion au Bridge local pour l'injection",X))}else if(f.includes("cree")||f.includes("lance")||f.includes("projet")||f.includes("generation")){u.content=`🚀 DÉMARRAGE PARALLÈLE KIROV5 🚀
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,u.widget="phases",q(1);const k=D||(ce.trim()?ce.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+a.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(Pe(k),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",k),typeof window<"u"){const X=localStorage.getItem("tiger_targetAi")||"deepseek",J=localStorage.getItem("tiger_targetUiAi")||"stitch",qe=(B,ue=!1)=>mt(B,ue),He=window.AndroidBridge;if(He&&He.openAIWithPrompt)He.openAIWithPrompt(qe(J,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+a),He.showToast&&He.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const B=j&&j.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${j.length})]
`+j.map(we=>{const oe=Ht.find(_e=>_e.id===we);return`• ${oe?oe.name:we} (#${we})`}).join(`
`):"",ue="Génère l'interface UI/UX complète et moderne pour ce projet : "+a+B;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ue)}catch{}const rt=()=>I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,prompt:ue,auto_submit:!0,project_id:k,phase_num:1,packs:j})});Xe!==200&&(Be?window.open(qe(J,!0),"kirov5_ai_target"):window.open(qe(J,!0),"_blank"),rt().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(we=>console.error("Erreur sendUiPrompt",we))),setTimeout(()=>{const we=j&&j.length>0?a+B:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+a+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(we)}catch{}window.open(qe(X),"_blank"),I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:X,prompt:we,auto_submit:!0,project_id:k,phase_num:1,packs:j})}).catch(oe=>console.log("Erreur Bridge Logic Prompt:",oe)),j&&j.length>0?I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:X,user_prompt:we,packs:j,target_project:k})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(oe=>{console.log("Erreur Trombone Bridge:",oe)}):I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:X,prompt:we,auto_submit:!0,project_id:k,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}q(1);let U=1;const Y=setInterval(()=>{U++,U>11?clearInterval(Y):q(U)},1500)}else if(f.includes("youtube")||f.includes("video"))u.content="Voici les résultats YouTube pour votre recherche :",u.widget="youtube";else if(f.includes("actualite")||f.includes("ia")||f.includes("news")||f.includes("recherche")){const k=localStorage.getItem("tiger_apiKey");u.content="Actualités & Dernières Innovations IA :",u.widget="news",Dt(k||void 0)}else if(f.includes("parametre")||f.includes("reglage")||f.includes("configuration")||f.includes("setting"))u.content="Ouverture du panneau de configuration système :",u.widget="settings";else if(f.includes("[plugin:vite:")||f.includes("missing semicolon")||f.includes("syntaxerror")||f.includes("typescriptparsermixin")||f.includes("babel/parser")||f.includes("error")&&f.length>80){const k=D||"Projet_blog_8831";u.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${k}" avec la stack trace fournie... 🩺`,Oe("suture",a)}else if(u.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const k=window.AndroidBridge;k&&k.openAIWithPrompt?k.openAIWithPrompt("https://chat.deepseek.com/",a):window.open("https://chat.deepseek.com/","_blank")}C(k=>[...k,u])},600),y("")},Ye=async s=>{var He;let a=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],l=null;const _=a.filter(B=>B.name.endsWith(".zip"));let u=[];if(_.length>0){C(B=>[...B,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const B=(await en(async()=>{const{default:ue}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:ue}},[])).default;for(const ue of _){l=ue;const we=await new B().loadAsync(ue);for(const[oe,_e]of Object.entries(we.files))if(!_e.dir&&!oe.includes("__MACOSX")&&!((He=oe.split("/").pop())!=null&&He.startsWith("."))){const Le=await _e.async("blob"),pt=new File([Le],oe.split("/").pop()||oe,{type:Le.type});u.push(pt)}}}catch(B){console.error("Erreur décompression ZIP:",B),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}for(const B of _)try{const ue=await B.arrayBuffer(),rt=arrayBufferToBase64(ue);fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:D||G||ce||"AUDIO",fileName:B.name,fileBase64:rt})}).catch(oe=>console.warn("[Upload ZIP Sync] Notice:",oe))}catch{}}a=[...a.filter(B=>!B.name.endsWith(".zip")),...u];const f=a.filter(B=>B.name.endsWith(".html")),k=a.filter(B=>!B.name.endsWith(".html")&&(B.name.endsWith(".png")||B.name.endsWith(".jpg")||B.name.endsWith(".jpeg")||B.name.endsWith(".md")||B.name.endsWith(".json")||B.name.endsWith(".txt")||B.name.endsWith(".tsx")||B.name.endsWith(".ts")||B.name.endsWith(".jsx")||B.name.endsWith(".js")||B.name.endsWith(".css")||B.name.endsWith(".svg")));if(f.length===0&&k.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .tsx, .ts, .png, ou un .zip.");return}let U=[...nt];for(const B of k){const ue=B.name.endsWith(".png")||B.name.endsWith(".jpg")||B.name.endsWith(".jpeg"),rt=await new Promise(oe=>{const _e=new FileReader;_e.onload=Le=>{var pt;return oe((pt=Le.target)==null?void 0:pt.result)},ue?_e.readAsDataURL(B):_e.readAsText(B)}),we={path:B.name,content:ue?`[Image jointe visuellement : ${B.name} (Binaire ignoré pour économie de tokens)]`:rt};U.some(oe=>oe.path===B.name)||U.push(we),C(oe=>[...oe,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${B.name}`}])}if(f.length>0){const B=f[0],ue=await new Promise(oe=>{const _e=new FileReader;_e.onload=Le=>{var pt;return oe((pt=Le.target)==null?void 0:pt.result)},_e.readAsText(B)}),rt={path:B.name,content:ue};U.some(oe=>oe.path===B.name)||U.push(rt);const we={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${B.name}
Analyse de la structure UI et assemblage du contexte en cours...`};C(oe=>[...oe,we])}const Y=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter(B=>B.name.endsWith(".zip"));for(const B of Y)U.some(ue=>ue.path===B.name)||U.push({path:B.name,content:"ZIP_ARCHIVE_DUMMY"});Pt(U);const X=D||ce||"Projet_Stitch",J=a.map(B=>B.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${X}: ${J}`);const qe=f.length;if(qe>3){const B=localStorage.getItem("tiger_targetAi")||"deepseek",ue=l?"Projet_ZIP_"+l.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),rt=D||ue;D||Pe(rt),C(oe=>[...oe,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !

Hermes a détecté ${qe} pages HTML dans votre ZIP.
Découpage automatique en lots de 3 fichiers en cours...
Démarrage de l'automatisation séquentielle via DeepSeek !`,widget:"phases"}]),q(1);let we="";if(l)we=await new Promise(oe=>{const _e=new FileReader;_e.onload=Le=>{var pt;return oe(((pt=Le.target)==null?void 0:pt.result).split(",")[1])},_e.readAsDataURL(l)});else{const oe=(await en(async()=>{const{default:Le}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:Le}},[])).default,_e=new oe;for(const Le of a)_e.file(Le.name,Le);we=await _e.generateAsync({type:"base64"})}I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({zip_base64:we,zip_mode:!0,target_ai:B,target_project:rt,user_prompt:ce.trim()?`${ce} - ${ft}`:`Application multi-pages issue de ${(l==null?void 0:l.name)||"fichiers_locaux"}`})}).then(async oe=>{const _e=await oe.json();_e.success?(C(Le=>[...Le,{id:Date.now().toString()+"_hermes",role:"assistant",content:`✅ ${_e.message}

📡 Lot 1/${_e.total_batches} transmis à DeepSeek. Les lots suivants s'enchaîneront automatiquement !
Fichiers détectés : ${(_e.files_detected||[]).join(", ")}`}]),window.open(mt(B),"_blank")):alert("Erreur Hermes : "+(_e.error||"Inconnue"))}).catch(oe=>{alert(`Erreur de connexion au Moteur Local : ${oe.message}`)});return}if(f.length>0){if(document.getElementById("creation-mode-container"))return;setTimeout(()=>{Ct(U)},1200)}},Ct=async(s=nt)=>{Ee(!1);const a=s.find(X=>X.path.endsWith(".html"));if(!a){alert("Aucun fichier HTML trouvé dans le Trombone !");return}const l=ce.trim()?"Projet_"+ce.replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4):"Design_"+a.path.replace(".html","").replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4),_=D||l;if(!D){Pe(_);try{await I("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:_,file:"README.md",content:`# ${ce||_}

Initialisé par Tiger IA V0 (Design-First).`})})}catch(X){console.error("[IDE] Erreur création auto du dossier",X)}}const u=s.filter(X=>X.path!==a.path),f=a.content,k={id:(Date.now()+1).toString(),role:"assistant",content:`Mode "Design-First" activé. 🎨

Transmission du design au LLM avec les ${u.length} fichiers du Trombone intégrés.
Câblage en cours...`,widget:"phases"};q(5),C(X=>[...X,k]);let U=5;const Y=setInterval(()=>{U++,U>11?clearInterval(Y):q(U)},3e3);if(typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Mode Design-First Activé !"),typeof window<"u"){const X=localStorage.getItem("tiger_targetAi")||"deepseek";let J="";u.length>0&&(J=`
...
\`\`\`
`}));let qe="";(ce.trim()||Ke.trim()||ft.trim())&&(qe=`
--- MÉTADONNÉES DU PROJET ---
Nom : ${ce||"Non spécifié"}
Stack / Structure : ${Ke||"Non spécifiée"}
Description & Objectifs : ${ft||"Non spécifiés"}
-----------------------------
`);const He=`Voici le code HTML/CSS d'une interface générée par Stitch.${qe}
...
\`\`\`
`,B=window.AndroidBridge;if(B&&B.openAIWithPrompt){const ue=mt(X);B.openAIWithPrompt(ue,He),B.showToast&&B.showToast("HTML injecté. Câblage sur "+X.toUpperCase()+" !")}else I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:X,prompt:He,auto_submit:!0,project_id:_,phase_num:5})}).then(ue=>console.log("[Bridge] Prompt HTML + Contexte envoyé avec succès, status:",ue.status)).catch(ue=>console.error("[Bridge] Erreur lors de l'envoi du prompt:",ue))}},Ue=(s,a=0)=>s?s.type==="directory"?e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-2 px-2 py-1 hover:bg-white/5 cursor-pointer text-gray-300 text-sm",style:{paddingLeft:`${a*12+8}px`},children:[e.jsx("span",{className:"text-orange-400",children:"📁"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-dossier truncate font-bold",children:s.name})]}),s.children&&s.children.map(l=>Ue(l,a+1))]},s.path):e.jsxs("div",{className:`flex items-center justify-between px-2 py-1 hover:bg-white/10 cursor-pointer text-sm group ${xe===s.path?"bg-cyan/20 text-cyan border-l-2 border-cyan":"text-gray-400"}`,style:{paddingLeft:`${a*12+8}px`},onClick:()=>tt(s.path),children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-blue-400",children:"📄"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-fichier truncate",children:s.name})]}),e.jsxs("div",{className:"hidden group-hover:flex items-center gap-1",children:[e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-red-500/50 transition-colors",title:"Suture : Réparer ou débugger ce fichier",onClick:l=>{l.stopPropagation(),tt(s.path),setTimeout(()=>Oe("suture","Veuillez analyser ce fichier et corriger toutes les erreurs, fautes de frappe ou imports manquants."),100)},children:"🩺"}),e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-cyan/50 transition-colors",title:"Ajouter au Trombone",onClick:l=>{l.stopPropagation(),T(s.path)},children:"📎"})]})]},s.path):null,Oe=async(s,a)=>{if(!D){alert("⚠️ Veuillez sélectionner un projet actif dans l'explorateur.");return}const l=localStorage.getItem("tiger_targetAi")||"deepseek";let _="";s==="suture"?_=`🩺 SUTURE CHIRURGICALE — CORRECTION D'ERREUR DÉTECTÉE
...
`:Ke.includes("Canvas 2D")?U+=`⚠️ CONSTRUCTEUR : Ce projet DOIT IMPÉRATIVEMENT être un jeu Web 2D généré en **React + Vite + TypeScript (TSX) + Canvas 2D**.

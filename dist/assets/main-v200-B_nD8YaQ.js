...
L'orchestrateur prend le relais pour générer le Backend et intégrer les composants.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(P=>{console.error(P),alert("Erreur: Le moteur n'a pas pu être contacté.")});return}typeof window<"u"&&(window.open("https://stitch.withgoogle.com/","_blank"),window.dispatchEvent(new CustomEvent("open-mouchard")));const Q=window.KIROV_SELECTED_PACKS&&window.KIROV_SELECTED_PACKS.length>0?window.KIROV_SELECTED_PACKS:O&&O.length>0?O:[];if(Number(y)===0){w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:b,target_ai:"stitch",start_index:1,zip_mode:!0,start_phase:0,auto_pilot:K,instructions:et||"Génère l'application avec ces packs et directives.",packs:Q})}).then(P=>P?P.json():null).then(P=>{var ot;const me=(P==null?void 0:P.prompt)||((ot=P==null?void 0:P.data)==null?void 0:ot.prompt)||"Génération UI/UX Stitch complète.",je=Q.length>0?Q.join(", "):"standard";if(C(2),typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase","2"),typeof document<"u"){const ke=document.getElementById("tiger-mega-prompt-overlay");ke&&ke.remove();const Ze=document.createElement("div");Ze.id="tiger-mega-prompt-overlay",Ze.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);backdrop-filter:blur(10px);z-index:999999;display:flex;align-items:center;justify-content:center;padding:16px;font-family:sans-serif;",Ze.innerHTML=`
                              ...
                              `,document.body.appendChild(Ze);const vt=document.getElementById("tiger-prompt-area"),Oe=document.getElementById("btn-copy-prompt"),St=document.getElementById("btn-close-prompt-overlay"),Fe=document.getElementById("btn-open-stitch"),s=()=>{vt&&(vt.select(),vt.setSelectionRange(0,99999),document.execCommand("copy")),navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),C(2),Oe&&(Oe.innerHTML="✅ COPIÉ DANS LE PRESSE-PAPIER !",Oe.style.background="linear-gradient(135deg,#10b981,#059669)",setTimeout(()=>{Oe&&(Oe.innerHTML="📋 COPIER LE MÉGA-PROMPT",Oe.style.background="linear-gradient(135deg,#06b6d4,#2563eb)")},3e3))};Oe&&(Oe.onclick=()=>{s(),C(2)}),St&&(St.onclick=()=>{Ze.remove(),C(2)}),Fe&&(Fe.onclick=()=>{window.open("https://stitch.withgoogle.com/","_blank"),C(2)}),s(),C(2)}}).catch(P=>{console.error(P),alert("Erreur de communication avec le serveur Kirov5.")});return}w("/api/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:"stitch",user_prompt:et||"Génère l'application avec ces packs et directives.",packs:Q,target_project:b,phase_num:1})}).then(P=>P?P.json():null).then(P=>{var je;const me=(P==null?void 0:P.prompt)||((je=P==null?void 0:P.data)==null?void 0:je.prompt)||"Génération UI/UX Stitch.";typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),alert(`🚀 PHASE 1 (STITCH UI/UX) INITIALISÉE !
...
*Le fichier README complet est disponible dans le dossier prd_packs/${L.packId}/README.md.*`),e.jsxs("div",{className:"design-fenetre-readme w-full rounded-3xl p-6 md:p-8 border-2 border-cyan/60 shadow-[0_0_80px_rgba(124,58,237,0.45)] my-4 relative animate-fadeIn text-white z-20 flex flex-col min-h-[480px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 flex-shrink-0",children:[e.jsxs("span",{className:"px-3.5 py-1.5 bg-cyan/20 text-cyan text-xs font-bold rounded-xl border border-cyan/40 flex items-center gap-2 shadow-sm",children:[e.jsx("span",{children:"💎"})," PACK PRD : ",L.packId]}),e.jsx("button",{onClick:()=>W(null),className:"w-10 h-10 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-xl flex items-center justify-center font-bold text-lg transition-all border border-cyan/40 cursor-pointer shadow-md",title:"Fermer (Retour aux packs)",children:"✕"})]}),e.jsx("h2",{className:"text-2xl md:text-3xl font-black text-cyan mb-2 leading-tight drop-shadow-[0_2px_10px_rgba(6,182,212,0.5)] flex-shrink-0",children:L.packName}),e.jsx("div",{className:"w-full h-px bg-gradient-to-r from-cyan via-purple-400 to-cyan/20 mb-4 flex-shrink-0"}),e.jsx("div",{className:"design-readme-contenu flex-1 text-white font-medium leading-relaxed whitespace-pre-wrap overflow-y-auto max-h-[500px] p-6 rounded-2xl border-2 border-cyan/50 font-mono text-sm shadow-[0_0_40px_rgba(8,179,201,0.3)] min-h-[300px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)",textShadow:"0 1px 2px rgba(0,0,0,0.8)"},children:y}),e.jsxs("div",{className:"mt-6 pt-4 border-t border-white/15 flex justify-between items-center flex-shrink-0",children:[e.jsxs("span",{className:"text-xs text-cyan/90 font-mono font-bold tracking-widest uppercase flex items-center gap-2",children:[e.jsx("span",{children:"⚡"})," SUTURE PRD ENGINE"]}),e.jsx("button",{onClick:()=>W(null),className:"px-6 py-2.5 bg-cyan/20 hover:bg-cyan/40 text-cyan font-bold rounded-xl transition-all border border-cyan/40 flex items-center gap-2 cursor-pointer hover:bg-cyan/30 shadow-md",children:"← Fermer & Retour aux packs"})]})]})}return e.jsxs("div",{id:"prd-packs-carousel-section",className:"w-full flex-1 min-w-0 my-2",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3 px-2",children:[e.jsxs("h4",{className:"design-prd-titre-section font-black uppercase tracking-widest text-cyan flex items-center gap-2",children:[e.jsx("span",{children:"💎"})," PACKS PRD DE CONNAISSANCES (",Ft.length,")"]}),t&&t.length>0&&e.jsxs("span",{className:"text-[11px] font-bold text-cyan bg-cyan/20 px-2.5 py-1 rounded-full border border-cyan/30",children:[t.length," pack(s) actif(s)"]})]}),e.jsx("div",{className:"flex gap-4 items-stretch relative w-full",children:e.jsx("div",{className:"flex-1 min-w-0 min-h-[480px] overflow-hidden py-4 flex items-center",children:m?K.length===0?e.jsxs("div",{className:"h-full min-h-[220px] rounded-2xl p-6 border border-purple-500/20 bg-purple-950/20 backdrop-blur-md flex flex-col items-center justify-center text-center",children:[e.jsx("p",{className:"text-purple-300 font-bold text-sm",children:"Aucun pack Guest n'a encore été généré."}),e.jsx("p",{className:"text-xs text-zinc-400 mt-2",children:"Utilisez l'interface V0-GUEST pour scanner un projet local et créer un pack sur-mesure."}),e.jsx("button",{onClick:F,className:"mt-4 text-xs text-purple-300 border border-purple-500/40 px-4 py-1.5 rounded-full hover:bg-purple-900/40 transition-colors",children:"🔄 Recharger les packs Guest"})]}):e.jsx(Gt,{items:K.filter(y=>{var O,S,M,$;if(!_)return!0;const C=_.toLowerCase();return((O=y.name)==null?void 0:O.toLowerCase().includes(C))||((S=y.description)==null?void 0:S.toLowerCase().includes(C))||((M=y.id)==null?void 0:M.toLowerCase().includes(C))||(($=y.category)==null?void 0:$.toLowerCase().includes(C))}).sort((y,C)=>(y.name||"").localeCompare(C.name||"")).map(y=>{const C=y.id,O=t?t.includes(C):!1;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${O?"border-purple-400 shadow-[0_0_25px_rgba(168,85,247,0.4)] bg-purple-950/60":"border-purple-500/20 hover:border-purple-400/60 bg-black/50"}`,children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${O?"bg-purple-500 text-white shadow-md":"bg-purple-500/20 text-purple-400 border border-purple-500/40"}`,children:e.jsx(An,{size:18})}),e.jsx("span",{className:"px-2 py-0.5 bg-purple-500/20 text-purple-300 text-[10px] font-bold rounded-md uppercase tracking-wider border border-purple-500/30",children:"🐋 GUEST"})]}),n&&e.jsx("button",{onClick:S=>{S.stopPropagation(),n(C)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${O?"bg-purple-500 text-white shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-purple-500/40 hover:text-white"}`,children:O?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight truncate",children:y.name}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed text-zinc-300 text-xs line-clamp-4",children:y.description}),e.jsxs("div",{className:"mt-4 pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsxs("span",{className:"text-[10px] font-mono text-purple-400/80",children:[y.modulesCount," MODULES"]}),e.jsxs("button",{onClick:async()=>{var S;try{const M=await w(`http://localhost:5006/api/bridge/read-file?path=${encodeURIComponent(y.path+"/README.md")}`);let $="";if(M&&M.ok){const q=await M.json();$=((S=q.data)==null?void 0:S.content)||q.content||""}W({packId:C,packName:y.name,readmeText:$||`# PACK GUEST : ${y.name}

Spécifications techniques du pack Guest ${y.name}.

Module réutilisable scanné dans ${y.path}.`})}catch{W({packId:C,packName:y.name,readmeText:`# PACK GUEST : ${y.name}

Spécifications techniques du pack Guest ${y.name}.`})}},className:"design-prd-btn text-purple-400 text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-purple-500/30 transition-all",children:[e.jsx("span",{children:"📖"})," README →"]})]})]},C)})}):e.jsx(Gt,{items:Ft.map(y=>{const C=y.id,O=y.name,S=y.icon||rs,M=t?t.includes(C):!1,V=(v[C]||dn(C)||"Spécifications techniques du contrat PRD.").replace(/^#+.*$/gm,"").replace(/^>.*$/gm,"").replace(/\[([^\]]+)\]\([^\)]+\)/g,"$1").replace(/[*_~`]/g,"").trim().split(`
`).map(J=>J.trim()).filter(J=>J.length>20),X=V.length>0?V[0]:"Spécifications techniques du contrat PRD.",z=X.length>180?X.substring(0,180)+"...":X;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${M?"border-cyan shadow-[0_0_25px_rgba(8,179,201,0.4)]":"border-white/10 hover:border-cyan/50"}`,style:{background:r?o("prd-card-"+C,.7):"rgba(0,0,0,0.7)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${M?"bg-cyan text-black shadow-md":y.color||"bg-cyan/20 text-cyan"}`,children:e.jsx(S,{size:20})}),e.jsx("span",{className:"px-2 py-0.5 bg-cyan/20 text-cyan text-[10px] font-bold rounded-md uppercase tracking-wider",children:"💎 PRD"})]}),n&&e.jsx("button",{onClick:J=>{J.stopPropagation(),n(C)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${M?"bg-cyan text-black shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-white/20 hover:text-white"}`,title:M?"Désélectionner ce pack":"Sélectionner ce pack pour l'IA",children:M?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight",children:O}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed",children:z}),e.jsxs("div",{className:"mt-auto pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-mono text-cyan/80",children:"MODULE PRD"}),e.jsxs("button",{onClick:async()=>{var B;let J=v[C]||dn(C)||"";try{const ae=await w(`http://localhost:5006/api/bridge/read-file?packId=${encodeURIComponent(C)}`);if(ae&&ae.ok){const ve=await ae.json(),G=ve.content||((B=ve.data)==null?void 0:B.content);G&&G.trim().length>5&&(J=G,f(ee=>({...ee,[C]:G})))}}catch(ae){console.warn("API Bridge read fallback",ae)}W({packId:C,packName:O,readmeText:J||`# 💎 PRD PACK : ${O} (${C})

### ⚙️ Spécifications techniques du contrat PRD

- **Identifiant Pack**: ${C}
- **Statut**: Actif & Intégré au Moteur Sovereign`})},className:"design-prd-btn text-cyan text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-cyan/30 transition-all hover:bg-cyan/10",children:[e.jsx("span",{children:"📖"})," Lire le README →"]})]})]},C)})})})})]})},Kn=({isClient:t,getCachedGradient:n,setActiveProject:r})=>{const[o,d]=a.useState([]),[p,m]=a.useState(!0),[u,_]=a.useState(!1),[v,f]=a.useState(null),L=(D=!1)=>{D?_(!0):m(!0);const K=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];w("http://localhost:5006/api/projects").then(I=>I?I.json():null).then(I=>{if(I&&I.success&&I.projects)d(I.projects.map((F,W)=>({name:typeof F=="string"?F:F.projectName||F.name||F.projectId||F.project_id||F.title||`Projet_${W}`,desc:"Environnement Local",bg:K[W%K.length],installed:F.installed}))),m(!1),_(!1);else{const F=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:F?{Authorization:`Bearer ${F}`}:{}}).then(W=>W?W.json():null).then(W=>{W&&W.projects&&d(W.projects.map((y,C)=>({name:y.project_id||y.title||y.name||`Projet_${C}`,desc:"SaaS Cloud (Neon DB)",bg:K[C%K.length]}))),m(!1),_(!1)}).catch(()=>{m(!1),_(!1)})}}).catch(()=>{m(!1),_(!1)})};return a.useEffect(()=>{L();const D=setInterval(()=>L(!0),5e3);return()=>clearInterval(D)},[]),p?e.jsx("div",{className:"p-4 text-cyan text-sm italic",children:"Actualisation de la liste des projets..."}):o.length===0?e.jsxs("div",{className:"p-4 flex flex-col items-center gap-3 text-center",children:[e.jsx("div",{className:"text-cyan text-sm italic",children:"Aucun projet trouvé sur votre disque dur."}),e.jsx("button",{onClick:()=>L(),className:"px-4 py-2 rounded-xl bg-cyan/20 border border-cyan/40 text-cyan text-xs font-bold hover:bg-cyan/40 transition-colors",children:"🔄 Rafraîchir la liste"})]}):e.jsx(Gt,{items:[...o.map((D,K)=>{const I=D.name||"AUDIO",F=async()=>{f(I),r(I);try{window.dispatchEvent(new CustomEvent("open-mouchard")),w("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:I})}).then(async y=>{if(y){const C=await y.json().catch(()=>null);C!=null&&C.previewUrl&&window.open(C.previewUrl,"_blank")}}).catch(()=>{}),await w(`http://localhost:5006/api/projects/${encodeURIComponent(I)}/launch-design`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:I,open_explorer:!1})}).catch(y=>console.error("Erreur de lancement :",y))}catch(y){console.error("Erreur de lancement :",y)}finally{setTimeout(()=>f(null),2e3)}},W=async y=>{if(y.preventDefault(),y.stopPropagation(),window.confirm(`⚠️ SUPPRESSION DEFINITIVE :
Voulez-vous vraiment supprimer le projet "${I}" de l'interface ET de votre disque dur ?`))try{const C=await w("http://localhost:5006/api/projects/remove-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:I})});if(!C){d(S=>S.filter(M=>M.name!==I));return}const O=await C.json();O.success?d(S=>S.filter(M=>M.name!==I)):alert(`Erreur lors de la suppression : ${O.message||"Échec server"}`)}catch(C){alert(`Erreur réseau lors de la suppression : ${C.message}`)}};return e.jsxs("div",{className:"design-carte-carrousel rounded-2xl p-5 border border-white/20 shadow-xl flex flex-col items-center text-center relative overflow-hidden group cursor-pointer",style:{background:t?n("proj-"+K,.7):"rgba(0,0,0,0.5)"},onClick:F,children:[e.jsx("button",{onClick:W,className:"z-20 absolute top-3 right-3 w-8 h-8 rounded-full bg-red-600/80 hover:bg-red-500 text-white font-bold text-xs flex items-center justify-center transition-all shadow-lg hover:scale-110 cursor-pointer",title:"Supprimer ce projet du disque dur et de l'interface",children:"🗑️"}),e.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-30 mix-blend-overlay pointer-events-none"}),e.jsx("div",{className:"absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors z-0"}),e.jsxs("div",{className:"z-10 relative pointer-events-none w-full pr-8",children:[e.jsx("div",{className:"text-white/70 text-xs font-bold uppercase tracking-widest drop-shadow-md",children:"PROJET"}),e.jsx("h3",{className:"design-carte-titre text-xl font-black text-white break-all drop-shadow-lg leading-tight w-full",children:I})]}),e.jsx("div",{className:"design-carte-desc z-10 relative text-sm text-white/90 font-medium drop-shadow-md pointer-events-none w-full",children:D.desc}),e.jsxs("div",{className:"z-10 flex items-center gap-2 mt-3",children:[e.jsx("button",{onClick:y=>{y.stopPropagation(),v!==I&&(D.installed===!1?(f(I),w("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:I})}).then(C=>{alert(C?`📦 Installation des dépendances démarrée pour "${I}" !
Suivez la progression dans les logs.`:"Mode Cloud SaaS : Bridge local non connecté."),f(null),d(O=>O.map(S=>S.name===D.name?{...S,installed:!0}:S))}).catch(()=>f(null))):F())},disabled:v===I,className:`font-bold py-2 px-4 rounded-xl text-xs transition-all flex items-center gap-1.5 ${v===I?"bg-cyan-500/40 text-cyan-200 cursor-wait animate-pulse":D.installed===!1?"bg-orange-500/80 hover:bg-orange-600 text-white cursor-pointer":"bg-white/20 hover:bg-white/40 text-white cursor-pointer"}`,title:D.installed===!1?"Installer les dépendances requises pour ce projet":"Lancer la prévisualisation Vite",children:v===I?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin inline-block",children:"⏳"})," ",D.installed===!1?"Installation...":"Lancement..."]}):D.installed===!1?e.jsx(e.Fragment,{children:"📦 INSTALL"}):e.jsx(e.Fragment,{children:"🚀 PREVIEW"})}),D.installed!==!1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:y=>{y.stopPropagation(),f(I),w("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:I})}).then(C=>{alert(C?`🔄 Réinstallation des dépendances démarrée pour "${I}" !`:"Mode Cloud SaaS : Bridge local non connecté."),f(null)}).catch(()=>f(null))},className:"bg-orange-500/30 hover:bg-orange-500/60 text-white font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center justify-center border border-orange-500/40 cursor-pointer",title:"Forcer la réinstallation des dépendances (pnpm install)",children:"🔄"}),e.jsx("button",{onClick:async y=>{y.stopPropagation();try{f(I);const C=await w("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:I})});if(f(null),!C){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const O=await C.json();alert(O.message||`🚀 Serveur Vite démarré pour ${I} !`),O.previewUrl&&window.open(O.previewUrl,"_blank")}catch(C){f(null),alert("Erreur de connexion au bridge: "+C.message)}},className:"font-bold py-2 px-3 rounded-xl text-xs bg-purple-500/60 hover:bg-purple-500 text-white transition-all shadow-md cursor-pointer",title:"Lancer le serveur Vite avec pnpm run dev",children:"💻 PNPM"})]}),e.jsx("button",{onClick:W,className:"bg-red-600/30 hover:bg-red-600/60 text-red-200 border border-red-500/40 font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center gap-1",title:"Supprimer définitivement du disque dur",children:"🗑️ Supprimer"})]})]},K)})]})};function Mo({user:t,onLogout:n}={}){var Fe;const r=a.useRef({}),o=(s,l=1)=>typeof window>"u"?`linear-gradient(135deg, rgba(17,17,17,${l}), rgba(34,34,34,${l}))`:(r.current[s]||(r.current[s]=Ro(l)),r.current[s]),d=(t==null?void 0:t.email)||(typeof window<"u"?localStorage.getItem("tiger_currentUserEmail"):null),p=!!(t!=null&&t.isSuperAdmin||d&&d.toLowerCase().trim()==="zacktunr@gmail.com");a.useEffect(()=>{t!=null&&t.email&&typeof window<"u"&&localStorage.setItem("tiger_currentUserEmail",t.email)},[t]);const m=()=>{typeof window<"u"&&(localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),localStorage.removeItem("tiger_lastGeneratedProject"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{})),n?n():typeof window<"u"&&window.location.reload()},[u,_]=a.useState([]),[v,f]=a.useState(""),L=a.useRef(null),D=a.useRef(null),[K,I]=a.useState(!1),[F,W]=a.useState("connexion"),[y,C]=a.useState(!1),[O,S]=a.useState("clean");a.useRef(0);const[M,$]=a.useState(1),[q,V]=a.useState(!1),[X,z]=a.useState(!1),[J,B]=a.useState(!1);a.useEffect(()=>{let s=0;const l=setInterval(()=>{var c,A;if(typeof window<"u"){const h=(A=(c=window.Capacitor)==null?void 0:c.isNativePlatform)==null?void 0:A.call(c),x=!!window.AndroidBridge;(h||x)&&(z(!0),clearInterval(l))}s++>10&&clearInterval(l)},100);return()=>clearInterval(l)},[]);const[ae,ve]=a.useState([]),[G,ee]=a.useState(""),[de,xe]=a.useState(["> Système Kirov5 initialisé. "+new Date().toLocaleTimeString()]),[_e,te]=a.useState([]),[j,H]=a.useState([]);a.useEffect(()=>{const s=l=>H(l.detail);return window.addEventListener("update_kirov_packs",s),()=>window.removeEventListener("update_kirov_packs",s)},[]),a.useEffect(()=>{window.KIROV_SELECTED_PACKS=j},[j]);const[re,ue]=a.useState(!1),[fe,Ee]=a.useState(!1),[Te,R]=a.useState([]),[ge,Ce]=a.useState(!1),[he,se]=a.useState(""),[De,et]=a.useState(""),[Re,Ne]=a.useState(!1),[oe,mt]=a.useState(""),[Be,En]=a.useState("Vite + React + Tailwind + TS"),[gt,gn]=a.useState(""),[_t,Rt]=a.useState("deepseek"),[ze,tn]=a.useState(""),[nn,Rn]=a.useState(!0),[sn,rn]=a.useState(!1),[ht,Ct]=a.useState(null),[dt,wt]=a.useState(!1),[tt,nt]=a.useState("idle"),[Nt,st]=a.useState([]),[It,zt]=a.useState(""),[hn,Dt]=a.useState(null);a.useEffect(()=>{let s;return tt==="building"&&(s=setInterval(async()=>{try{const l=await w("http://localhost:5006/api/mobile/build-logs");if(l&&l.ok){const c=await l.json();c.logs&&c.logs.length>0&&st(c.logs),c.isBuilding===!1&&c.result&&(c.result.success?(nt("success"),Dt(c.result.apkUrl)):nt("error"),clearInterval(s))}}catch(l){console.warn("Polling APK error",l)}},1e3)),()=>{s&&clearInterval(s)}},[tt]);const[Ht,ut]=a.useState([]),[xn,be]=a.useState(!1),Kt=a.useCallback(async s=>{be(!0);const l=[{id:"deepseek-r1-v0",tag:"⚡ DEEPSEEK R1",title:"DeepSeek-R1 & Moteur Souverain v0.1",desc:"Capacités de raisonnement avancé et de suture pour interfaces React.",content:`DeepSeek-R1 offre des capacités de raisonnement avancé pour l'analyse de contrats PRD et la génération zéro-touch de projets web complets.
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){ut(l),be(!1);return}const c=s||localStorage.getItem("tiger_apiKey");if(!c||!c.startsWith("sk-")||c.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){ut(l),be(!1);return}const A=new AbortController,h=setTimeout(()=>A.abort(),4e3),x=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${c}`},signal:A.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(h),x.ok){const T=await x.json(),N=JSON.parse(T.choices[0].message.content);N.news&&Array.isArray(N.news)&&N.news.length>0?ut(N.news):ut(l)}else x.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),ut(l)}catch(c){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",c),ut(l)}finally{be(!1)}},[]);a.useEffect(()=>{Kt()},[Kt]);const[pt,At]=a.useState(!1),[He,Mt]=a.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Ie,We]=a.useState([]),[we,qt]=a.useState("");a.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let l=JSON.parse(s);if(!Array.isArray(l))throw new Error("Not an array");const c="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";l=l.map(A=>A.name==="fold"?{...A,colors:{...A.colors,"bg-app":c}}:A),We(l)}catch{We([])}else{const l={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};We([l]),localStorage.setItem("tiger_saved_themes",JSON.stringify([l]))}},[]),a.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",He),He!=="random"){const l=((s=Ie.find(c=>c.name===He))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=l,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[He,Ie]);const an=()=>{if(!we.trim())return alert("Nom invalide");if(Ie.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":o("icon-settings",.8),"icon-ai":o("icon-ai",.8),"icon-projects":o("icon-projects",.8),"icon-packs":o("icon-packs",.8),"icon-news":o("icon-news",.8),"bg-app":o("bg-app",.9)},l={name:we.trim(),colors:s},c=[...Ie,l];We(c),localStorage.setItem("tiger_saved_themes",JSON.stringify(c)),Mt(l.name),qt("")},Je=(s,l)=>{l.stopPropagation();const c=Ie.filter(A=>A.name!==s);We(c),localStorage.setItem("tiger_saved_themes",JSON.stringify(c)),He===s&&Mt("random")},$t=s=>{H(l=>l.includes(s)?l.filter(c=>c!==s):[...l,s])},[Ke,Lt]=a.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});a.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(Ke))},[Ke]);const[xt,Wt]=a.useState(!0),[rt,Pt]=a.useState(!0),[k,Ae]=a.useState(null),[jt,fn]=a.useState(null),[Pe,Jt]=a.useState(null),[pe,it]=a.useState(null),[Tt,ft]=a.useState(""),[Xe,Ut]=a.useState([]);a.useEffect(()=>{w("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))te(s.projects.map(l=>({name:typeof l=="string"?l:l.project_id||l.title||l.name||"Projet",desc:"Projet local",bg:""})));else{const l=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:l?{Authorization:`Bearer ${l}`}:{}}).then(c=>c?c.json():null).then(c=>{c&&c.projects&&te(c.projects.map(A=>({name:typeof A=="string"?A:A.project_id||A.title||A.name||"Projet",desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[$e,Le]=a.useState(null),[kt,bt]=a.useState(""),[Ue,on]=a.useState(!1),[at,Qe]=a.useState(!1),i=a.useRef(null);a.useEffect(()=>{if(i.current=null,k==="v0-guest"||k==="V0-Guest")Qe(!0),Le("http://localhost:3007"),bt("http://localhost:3007"),i.current="http://localhost:3007";else if(k){Qe(!0);const s=Pe&&JSON.stringify(Pe).includes("next.config"),l=typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1",c=s?"http://localhost:3000":i.current||(l?`http://${window.location.hostname}:5173`:"http://localhost:5173");Le(c),bt(c),i.current=c}else Qe(!1),Le(null)},[k,Pe]),a.useEffect(()=>{const s=l=>{var c,A,h,x;if(((c=l.data)==null?void 0:c.type)==="CHANGE_PREVIEW_URL"){const T=l.data.route,N=T==="/"?"":`#${T}`;Le(ne=>{const Z=ne?ne.split("#")[0]:"http://127.0.0.1:5175/";return`${Z.endsWith("/")?Z:`${Z}/`}${N}`})}if(((A=l.data)==null?void 0:A.type)==="DESIGN_ELEMENT_CLICKED"||((h=l.data)==null?void 0:h.type)==="DESIGN_ELEMENT_DRAGGED"||((x=l.data)==null?void 0:x.type)==="DESIGN_ELEMENT_RESIZED"){const T=document.querySelector('iframe[title="Studio Admin Design"]');T&&T.contentWindow&&T.contentWindow.postMessage(l.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),a.useEffect(()=>{k&&w(`http://localhost:5006/api/fs/tree?project=${k}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&Jt(s.tree)}).catch(()=>{})},[k]),a.useEffect(()=>{k&&pe&&w(`http://localhost:5006/api/fs/read?project=${k}&file=${encodeURIComponent(pe)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&ft(s.content)}).catch(()=>{})},[k,pe]);const g=async s=>{if(s===void 0||!k||!pe)return;if(ft(s),Bt.isNativePlatform()||!!window.AndroidBridge)try{await Vn.writeFile({path:`v0-moteur-mobile/projetv0/${k}/${pe}`,data:s,directory:pn.Documents,encoding:wn.UTF8,recursive:!0})}catch(c){console.error("Erreur de sauvegarde mobile:",c)}else w("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:k,file:pe,content:s})}).catch(()=>{})},b=s=>{k&&w(`http://localhost:5006/api/fs/read?project=${k}&file=${encodeURIComponent(s)}`).then(l=>l?l.json():null).then(l=>{l&&l.success&&Ut(c=>c.find(A=>A.path===s)?c:[...c,{path:s,content:l.content}])}).catch(()=>{})};a.useEffect(()=>{(async()=>{const l=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(Bt.isNativePlatform()||!!window.AndroidBridge)try{const h=(await Vn.readdir({path:"v0-moteur-mobile/projetv0",directory:pn.Documents})).files.map(x=>x.name||x.toString());te(h.map((x,T)=>({name:x,desc:"Mémoire Téléphone",bg:l[T%l.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else w("http://localhost:5006/api/projects-v2").then(A=>A?A.json():null).then(A=>{if(A&&A.success&&A.projects)te(A.projects.map((h,x)=>({name:typeof h=="string"?h:h.name||h.project_id||h.title||`Projet_${x}`,desc:"Environnement Local",bg:l[x%l.length],installed:h.installed})));else{const h=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:h?{Authorization:`Bearer ${h}`}:{}}).then(x=>x?x.json():null).then(x=>{x&&x.projects&&te(x.projects.map((T,N)=>({name:typeof T=="string"?T:T.project_id||T.title||T.name||`Projet_${N}`,desc:"SaaS Cloud (Neon DB)",bg:l[N%l.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),a.useEffect(()=>{V(!0)},[]);const[E,Q]=a.useState(!0);a.useEffect(()=>{const s=()=>Q(!0);window.addEventListener("open-mouchard",s);const l=c=>{if(c.data&&c.data.type==="TIGER_CAPTURE"){const A=c.data.data;if(A){let h="index.html";(A.includes("import React")||A.includes("export default"))&&(h="App.tsx"),A.includes("tailwindcss")&&(h="index.css"),it(h),g(A),Jt(x=>{var ne;const T={name:h,path:h,type:"file"};return x?((ne=x.children)==null?void 0:ne.find(Z=>Z.name===h))?x:{...x,children:[...x.children||[],T]}:{name:"Mobile_Storage",type:"directory",children:[T]}})}}};return window.addEventListener("message",l),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("message",l)}},[k,pe]),a.useEffect(()=>{if(!q)return;const s=()=>{w("http://localhost:5006/api/bridge/queue").then(c=>c?c.json():null).then(c=>{c&&c.success&&(setBridgeQueueData({current:c.current||{},queue:c.queue||[]}),(c.queue&&c.queue.length>0||c.current&&Object.keys(c.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),w("http://localhost:5006/api/bridge/logs").then(c=>c?c.json():null).then(c=>{var A,h;if(c&&c.success&&c.logs){xe(c.logs);const x=[...c.logs].reverse().find(N=>N.includes("URL_PREVIEW="));if(x){let N=(A=x.split("URL_PREVIEW=")[1])==null?void 0:A.trim();N&&typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"&&(N=N.replace(/localhost|127\.0\.0\.1/,window.location.hostname)),N&&N!==i.current&&(i.current=N,Le(N),bt(N),Qe(!0))}const T=[...c.logs].reverse().find(N=>N.includes("PIPELINE COMPLET TERMINÉ avec succès pour "));if(T){const N=(h=T.split("PIPELINE COMPLET TERMINÉ avec succès pour ")[1])==null?void 0:h.replace(/[.\s]+$/,"");N&&k!==N&&(Ae(N),Qe(!0))}}}).catch(()=>{}),w("http://localhost:5006/api/bridge/autonomous-status").then(c=>c?c.json():null).then(c=>{if(c&&c.success&&(c.data||c.status)){const h=(c.data||c.status).state;h==="diagnosing"||h==="repair_required"||h==="error"?S("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(h)||["starting_server","launch_requested","restarting"].includes(h)?S("working"):h==="ready"?S("clean"):k&&w(`http://localhost:5006/api/suture/status?project=${k}`).then(x=>x?x.json():null).then(x=>{x&&x.success&&x.status&&S(x.status)}).catch(()=>{})}}).catch(()=>{})};s();const l=setInterval(s,2e3);return()=>clearInterval(l)},[q,k]);const P=s=>{const l=typeof s=="string"?s:v;if(!l.trim())return;const c={id:Date.now().toString(),role:"user",content:l};_(h=>[...h,c]);const A=l.toLowerCase();setTimeout(()=>{let h={id:(Date.now()+1).toString(),role:"assistant",content:""};const x=A.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(x==="mes projets"||x.includes("liste des projet")||x==="projet"||x==="projets")h.content="Voici la liste de vos projets récents :",h.widget="projects";else if((x.includes("stitch")||x.includes("deepseek")||x.includes("design")||x.includes("logique"))&&(x.includes("modifi")||x.includes("ajoute")||x.includes("change")||x.includes("mise a jour")||x.includes("evolue")||x.includes("reprends")||x.includes("continue"))){const T=l.match(/\[(.*?)\]/),N=T?T[1]:null,ne=x.includes("deepseek")?"deepseek":"stitch";h.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${ne.toUpperCase()}) 🔄

J'injecte vos nouvelles directives directement dans votre interface... ${N?`
🔍 Recherche et AutoSwitch vers le projet : "${N}"`:"Reprise du travail en cours."}`,h.widget=null,w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:ne,target_project:N,prompt:"Mise à jour (Reprise de projet) : "+l.replace(/\[.*?\]/,"").trim(),auto_submit:!0})}).catch(Z=>console.log("Erreur de connexion au Bridge local pour l'injection",Z))}else if(x.includes("cree")||x.includes("lance")||x.includes("projet")||x.includes("generation")){h.content=`🚀 DÉMARRAGE PARALLÈLE KIROV5 🚀
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,h.widget="phases",$(1);const T=k||(oe.trim()?oe.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+l.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(Ae(T),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",T),typeof window<"u"){const Z=localStorage.getItem("tiger_targetAi")||"deepseek",Y=localStorage.getItem("tiger_targetUiAi")||"stitch",Me=(U,ce=!1)=>ct(U,ce),Ge=window.AndroidBridge;if(Ge&&Ge.openAIWithPrompt)Ge.openAIWithPrompt(Me(Y,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+l),Ge.showToast&&Ge.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const U=j&&j.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${j.length})]
`+j.map(ye=>{const ie=Ft.find(Se=>Se.id===ye);return`• ${ie?ie.name:ye} (#${ye})`}).join(`
`):"",ce="Génère l'interface UI/UX complète et moderne pour ce projet : "+l+U;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ce)}catch{}const Ye=()=>w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Y,prompt:ce,auto_submit:!0,project_id:T,phase_num:1,packs:j})});Ke!==200&&(rt?window.open(Me(Y,!0),"kirov5_ai_target"):window.open(Me(Y,!0),"_blank"),Ye().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(ye=>console.error("Erreur sendUiPrompt",ye))),setTimeout(()=>{const ye=j&&j.length>0?l+U:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+l+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ye)}catch{}window.open(Me(Z),"_blank"),w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,prompt:ye,auto_submit:!0,project_id:T,phase_num:1,packs:j})}).catch(ie=>console.log("Erreur Bridge Logic Prompt:",ie)),j&&j.length>0?w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,user_prompt:ye,packs:j,target_project:T})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(ie=>{console.log("Erreur Trombone Bridge:",ie)}):w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,prompt:ye,auto_submit:!0,project_id:T,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}$(1);let N=1;const ne=setInterval(()=>{N++,N>11?clearInterval(ne):$(N)},1500)}else if(x.includes("youtube")||x.includes("video"))h.content="Voici les résultats YouTube pour votre recherche :",h.widget="youtube";else if(x.includes("actualite")||x.includes("ia")||x.includes("news")||x.includes("recherche")){const T=localStorage.getItem("tiger_apiKey");h.content="Actualités & Dernières Innovations IA :",h.widget="news",Kt(T||void 0)}else if(x.includes("parametre")||x.includes("reglage")||x.includes("configuration")||x.includes("setting"))h.content="Ouverture du panneau de configuration système :",h.widget="settings";else if(x.includes("[plugin:vite:")||x.includes("missing semicolon")||x.includes("syntaxerror")||x.includes("typescriptparsermixin")||x.includes("babel/parser")||x.includes("error")&&x.length>80){const T=k||"Projet_blog_8831";h.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${T}" avec la stack trace fournie... 🩺`,ke("suture",l)}else if(h.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const T=window.AndroidBridge;T&&T.openAIWithPrompt?T.openAIWithPrompt("https://chat.deepseek.com/",l):window.open("https://chat.deepseek.com/","_blank")}_(T=>[...T,h])},600),f("")},me=async s=>{var Ge;let l=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],c=null;const A=l.filter(U=>U.name.endsWith(".zip"));let h=[];if(A.length>0){_(U=>[...U,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const U=(await Zt(async()=>{const{default:ce}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:ce}},[])).default;for(const ce of A){c=ce;const ye=await new U().loadAsync(ce);for(const[ie,Se]of Object.entries(ye.files))if(!Se.dir&&!ie.includes("__MACOSX")&&!((Ge=ie.split("/").pop())!=null&&Ge.startsWith("."))){const qe=await Se.async("blob"),lt=new File([qe],ie.split("/").pop()||ie,{type:qe.type});h.push(lt)}}}catch(U){console.error("Erreur décompression ZIP:",U),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}for(const U of A)try{const ce=await U.arrayBuffer(),Ye=arrayBufferToBase64(ce);fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:k||G||oe||"AUDIO",fileName:U.name,fileBase64:Ye})}).catch(ie=>console.warn("[Upload ZIP Sync] Notice:",ie))}catch{}}l=[...l.filter(U=>!U.name.endsWith(".zip")),...h];const x=l.filter(U=>U.name.endsWith(".html")),T=l.filter(U=>!U.name.endsWith(".html")&&(U.name.endsWith(".png")||U.name.endsWith(".jpg")||U.name.endsWith(".jpeg")||U.name.endsWith(".md")||U.name.endsWith(".json")||U.name.endsWith(".txt")||U.name.endsWith(".tsx")||U.name.endsWith(".ts")||U.name.endsWith(".jsx")||U.name.endsWith(".js")||U.name.endsWith(".css")||U.name.endsWith(".svg")));if(x.length===0&&T.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .tsx, .ts, .png, ou un .zip.");return}let N=[...Xe];for(const U of T){const ce=U.name.endsWith(".png")||U.name.endsWith(".jpg")||U.name.endsWith(".jpeg"),Ye=await new Promise(ie=>{const Se=new FileReader;Se.onload=qe=>{var lt;return ie((lt=qe.target)==null?void 0:lt.result)},ce?Se.readAsDataURL(U):Se.readAsText(U)}),ye={path:U.name,content:ce?`[Image jointe visuellement : ${U.name} (Binaire ignoré pour économie de tokens)]`:Ye};N.some(ie=>ie.path===U.name)||N.push(ye),_(ie=>[...ie,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${U.name}`}])}if(x.length>0){const U=x[0],ce=await new Promise(ie=>{const Se=new FileReader;Se.onload=qe=>{var lt;return ie((lt=qe.target)==null?void 0:lt.result)},Se.readAsText(U)}),Ye={path:U.name,content:ce};N.some(ie=>ie.path===U.name)||N.push(Ye);const ye={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${U.name}
Analyse de la structure UI et assemblage du contexte en cours...`};_(ie=>[...ie,ye])}const ne=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter(U=>U.name.endsWith(".zip"));for(const U of ne)N.some(ce=>ce.path===U.name)||N.push({path:U.name,content:"ZIP_ARCHIVE_DUMMY"});Ut(N);const Z=k||oe||"Projet_Stitch",Y=l.map(U=>U.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${Z}: ${Y}`);const Me=x.length;if(Me>3){const U=localStorage.getItem("tiger_targetAi")||"deepseek",ce=c?"Projet_ZIP_"+c.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),Ye=k||ce;k||Ae(Ye),_(ie=>[...ie,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !

Hermes a détecté ${Me} pages HTML dans votre ZIP.
Découpage automatique en lots de 3 fichiers en cours...
Démarrage de l'automatisation séquentielle via DeepSeek !`,widget:"phases"}]),$(1);let ye="";if(c)ye=await new Promise(ie=>{const Se=new FileReader;Se.onload=qe=>{var lt;return ie(((lt=qe.target)==null?void 0:lt.result).split(",")[1])},Se.readAsDataURL(c)});else{const ie=(await Zt(async()=>{const{default:qe}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:qe}},[])).default,Se=new ie;for(const qe of l)Se.file(qe.name,qe);ye=await Se.generateAsync({type:"base64"})}w("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({zip_base64:ye,zip_mode:!0,target_ai:U,target_project:Ye,user_prompt:oe.trim()?`${oe} - ${gt}`:`Application multi-pages issue de ${(c==null?void 0:c.name)||"fichiers_locaux"}`})}).then(async ie=>{const Se=await ie.json();Se.success?(_(qe=>[...qe,{id:Date.now().toString()+"_hermes",role:"assistant",content:`✅ ${Se.message}

📡 Lot 1/${Se.total_batches} transmis à DeepSeek. Les lots suivants s'enchaîneront automatiquement !
Fichiers détectés : ${(Se.files_detected||[]).join(", ")}`}]),window.open(ct(U),"_blank")):alert("Erreur Hermes : "+(Se.error||"Inconnue"))}).catch(ie=>{alert(`Erreur de connexion au Moteur Local : ${ie.message}`)});return}if(x.length>0){if(document.getElementById("creation-mode-container"))return;setTimeout(()=>{je(N)},1200)}},je=async(s=Xe)=>{Ne(!1);const l=s.find(Z=>Z.path.endsWith(".html"));if(!l){alert("Aucun fichier HTML trouvé dans le Trombone !");return}const c=oe.trim()?"Projet_"+oe.replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4):"Design_"+l.path.replace(".html","").replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4),A=k||c;if(!k){Ae(A);try{await w("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:A,file:"README.md",content:`# ${oe||A}

Initialisé par Tiger IA V0 (Design-First).`})})}catch(Z){console.error("[IDE] Erreur création auto du dossier",Z)}}const h=s.filter(Z=>Z.path!==l.path),x=l.content,T={id:(Date.now()+1).toString(),role:"assistant",content:`Mode "Design-First" activé. 🎨

Transmission du design au LLM avec les ${h.length} fichiers du Trombone intégrés.
Câblage en cours...`,widget:"phases"};$(5),_(Z=>[...Z,T]);let N=5;const ne=setInterval(()=>{N++,N>11?clearInterval(ne):$(N)},3e3);if(typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Mode Design-First Activé !"),typeof window<"u"){const Z=localStorage.getItem("tiger_targetAi")||"deepseek";let Y="";h.length>0&&(Y=`
...
\`\`\`
`}));let Me="";(oe.trim()||Be.trim()||gt.trim())&&(Me=`
--- MÉTADONNÉES DU PROJET ---
Nom : ${oe||"Non spécifié"}
Stack / Structure : ${Be||"Non spécifiée"}
Description & Objectifs : ${gt||"Non spécifiés"}
-----------------------------
...
\`\`\`
`,U=window.AndroidBridge;if(U&&U.openAIWithPrompt){const ce=ct(Z);U.openAIWithPrompt(ce,Ge),U.showToast&&U.showToast("HTML injecté. Câblage sur "+Z.toUpperCase()+" !")}else w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Z,prompt:Ge,auto_submit:!0,project_id:A,phase_num:5})}).then(ce=>console.log("[Bridge] Prompt HTML + Contexte envoyé avec succès, status:",ce.status)).catch(ce=>console.error("[Bridge] Erreur lors de l'envoi du prompt:",ce))}},ot=(s,l=0)=>s?s.type==="directory"?e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-2 px-2 py-1 hover:bg-white/5 cursor-pointer text-gray-300 text-sm",style:{paddingLeft:`${l*12+8}px`},children:[e.jsx("span",{className:"text-orange-400",children:"📁"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-dossier truncate font-bold",children:s.name})]}),s.children&&s.children.map(c=>ot(c,l+1))]},s.path):e.jsxs("div",{className:`flex items-center justify-between px-2 py-1 hover:bg-white/10 cursor-pointer text-sm group ${pe===s.path?"bg-cyan/20 text-cyan border-l-2 border-cyan":"text-gray-400"}`,style:{paddingLeft:`${l*12+8}px`},onClick:()=>it(s.path),children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("span",{className:"text-blue-400",children:"📄"}),e.jsx("span",{className:"design-explorateur-texte design-explorateur-fichier truncate",children:s.name})]}),e.jsxs("div",{className:"hidden group-hover:flex items-center gap-1",children:[e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-red-500/50 transition-colors",title:"Suture : Réparer ou débugger ce fichier",onClick:c=>{c.stopPropagation(),it(s.path),setTimeout(()=>ke("suture","Veuillez analyser ce fichier et corriger toutes les erreurs, fautes de frappe ou imports manquants."),100)},children:"🩺"}),e.jsx("button",{className:"text-xs text-white bg-white/20 rounded px-1 hover:bg-cyan/50 transition-colors",title:"Ajouter au Trombone",onClick:c=>{c.stopPropagation(),b(s.path)},children:"📎"})]})]},s.path):null,ke=async(s,l)=>{if(!k){alert("⚠️ Veuillez sélectionner un projet actif dans l'explorateur.");return}const c=localStorage.getItem("tiger_targetAi")||"deepseek";let A="";s==="suture"?A=`🩺 SUTURE CHIRURGICALE — CORRECTION D'ERREUR DÉTECTÉE
...
`):s==="refactor"?A=`🔄 REFACTORING — Refactorise le code du projet [${k}] pour une qualité industrielle.

`:s==="improve"&&(A=`✨ AMÉLIORATION — Ajoute des animations et améliorations UI pour le projet [${k}].

`),pe&&Tt&&(A+=`--- Fichier Actif en Édition : ${pe} ---
\`\`\`
${Tt}
\`\`\`

`),Xe.length>0&&(A+=`--- Fichiers de contexte du Trombone ---

`,Xe.forEach(h=>{A+=`--- ${h.path} ---
\`\`\`
${h.content}
\`\`\`
...
\`\`\``,_(h=>[...h,{id:Date.now().toString()+"_action",role:"assistant",content:`🩺 Suture & Correction déclenchée pour "${k}". Transmission de l'erreur à ${c.toUpperCase()} en cours...`}]);try{if(await w("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:c,prompt:A,auto_submit:!0,project_id:k,phase_num:s})}),s==="suture"){w("http://localhost:5006/v1/suture/start",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:k,activeFile:pe||"",rawError:l||"",prompt:l||"Analyse et corrige les erreurs du projet."})}).then(async x=>{const T=await x.json();T.success&&T.status==="applied"?_(N=>{var ne,Z;return[...N,{id:Date.now().toString()+"_suture_ok",role:"assistant",content:`✅ Suture V2 réussie !

🔧 ${T.repairId}
🚀 Statut : **Patch appliqué en production**
📁 Fichiers corrigés : ${JSON.stringify(((Z=(ne=T.patchReport)==null?void 0:ne.files)==null?void 0:Z.map(Y=>Y.path))||[])}`}]}):T.success?_(N=>{var ne;return[...N,{id:Date.now().toString()+"_suture_partial",role:"assistant",content:`⚠️ Suture V2 : correctif généré mais non promu.
Statut : ${((ne=T.validationReport)==null?void 0:ne.code)||T.status}

...
- \`src/features/events/components/TicketingCard.tsx\``,js=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/maps/hooks/useGeolocation.ts\``,jr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
\`\`\`
`}));let Te="";(pe.trim()||Le.trim()||at.trim())&&(Te=`
...
[PACKS PRD ARCHITECTURE SELECTIONNES (${A.length})]
`+A.map(Z=>{const Te=Et.find(Ne=>Ne.id===Z);return`• ${Te?Te.name:Z} (#${Z})`}).join(`
`):"";let B=`

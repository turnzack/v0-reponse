const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-v200-B7Q5fVJ6.js","assets/design-v200-DcgYHDqz.js","assets/design-v200-B_-ohhET.css"])))=>i.map(i=>d[i]);
import{r as o,a as Et,j as e,s as I,i as ys,R as _s}from"./design-v200-DcgYHDqz.js";const Cs="modulepreload",ws=function(t){return"/"+t},Gn={},nn=function(n,r,c){let d=Promise.resolve();if(r&&r.length>0){let h=function(b){return Promise.all(b.map(y=>Promise.resolve(y).then(L=>({status:"fulfilled",value:L}),L=>({status:"rejected",reason:L}))))};document.getElementsByTagName("link");const p=document.querySelector("meta[property=csp-nonce]"),C=(p==null?void 0:p.nonce)||(p==null?void 0:p.getAttribute("nonce"));d=h(r.map(b=>{if(b=ws(b),b in Gn)return;Gn[b]=!0;const y=b.endsWith(".css"),L=y?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${b}"]${L}`))return;const G=document.createElement("link");if(G.rel=y?"stylesheet":Cs,y||(G.as="script"),G.crossOrigin="",G.href=b,C&&G.setAttribute("nonce",C),document.head.appendChild(G),y)return new Promise((Y,O)=>{G.addEventListener("load",Y),G.addEventListener("error",()=>O(new Error(`Unable to preload CSS for ${b}`)))})}))}function m(h){const p=new Event("vite:preloadError",{cancelable:!0});if(p.payload=h,window.dispatchEvent(p),!p.defaultPrevented)throw h}return d.then(h=>{for(const p of h||[])p.status==="rejected"&&m(p.reason);return n().catch(m)})},Is=`# undefined
...
---
### 🔄 INSTRUCTION DE FUSION (Pour l'Orchestrateur API)
*Lorsque l'utilisateur sélectionnera ce pack "Audio" dans l'interface de Tiger IA, tu dois fusionner ces 10 capacités avec la demande précise du chat. Par exemple, si l'utilisateur demande "Crée moi un clone de Spotify", tu dois immédiatement mobiliser les modules \`prd_audio_file_library\`, \`prd_audio_player_podcast\` et \`prd_audio_mix_playlist\` pour générer une architecture complète en un seul shot.*`,ks=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/shop/contexts/CartContext.tsx\``,Ls=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- src/shared/constants/products.ts (données mock)`,Us=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/events/components/TicketingCard.tsx\``,Os=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/feed/hooks/useInfiniteFeed.ts\``,Fs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`/requirements.txt\` & \`/package.json\` (Gestion des dépendances isolées)`,Gs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/components/inputs/CreditCardInput.tsx\``,Vs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/forms/schemas/registrationSchema.ts\``,Bs=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/gamification/components/BadgeGrid.tsx\``,zs=`# APK Forge — Intelligent Android Packaging Suite
...
---
`,Hs=`# Industrialisation_Backend_KIROV5
...
## Instructions Originales
`,$s=`# BRIC — Sovereign PRD Specification Pack
...
`,Ks=`# bricbrac — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Ws=`# bros — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,Xs=`# Industrialisation_Backend_Phase5
...
MIT`,Zs=`# COLORFUL LANDING PAGE BUILDER
...
## License
MIT`,Ys=`# CyberRunner — Sovereign PRD Specification Pack
...
src/
  ...
  main.tsx
  index.css
\`\`\``,rr=`# gametetris — Sovereign PRD Specification Pack
...
MIT`,cr=`# mariob — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,dr=`# 🚀 Pack PRD : Calculatrice Premium "One-Shot" (guest_nebula_calc)
...
src/
  ...
  App.tsx
  main.tsx
\`\`\``,mr=`# plateforme — Sovereign PRD Specification Pack
...
- **Moteur Canvas** : Auto-fit responsive (\`Phaser.Scale.FIT\`).
- **Contrôles** : Clavier (Flèches/ZQSD) et Souris.
`,gr=`# plateformv2 — Sovereign PRD Specification Pack
...
src/
  ...
  App.tsx
  main.tsx
\`\`\``,xr=`# PRODUCTION READY INDUSTRIALIZATION
...
## Instructions Originales
`,vr=`# SOVEREIGN PRODUCTION PLATFORM
...
- \`src/features/health/components/BreathingCircle.tsx\``,Er=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/utils/audioContext.ts\``,Rr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/images/hooks/useImageUpload.ts\``,Nr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/admin/components/EmptyState.tsx\``,Dr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/game/types/engine.ts\``,Mr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/landing/components/FooterCTA.tsx\``,qr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/saas-landing/components/ProductMockup.tsx\``,Lr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/layouts/KanbanLayout.tsx\``,Ur=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/maps/hooks/useGeolocation.ts\``,Or=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/markdown/components/TableOfContents.tsx\``,Fr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/marketing/components/LeadCaptureForm.tsx\``,Gr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/mobile/components/SwipeActionContainer.tsx\``,Vr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/shell/components/BottomSheet.tsx\``,Br=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/mobile/components/SwipeableOnboarding.tsx\``,zr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/api/apiClient.ts\` (Interface qui tape sur les mocks pour l'instant)`,Hr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/documents/components/ThumbnailSidebar.tsx\``,$r=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/hooks/useFileUpload.ts\``,Kr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/ai.ts\` (interfaces Message, ChatSession, Attachment)`,Wr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/auth/hooks/useSession.ts\``,Xr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/magazine/components/AuthorByline.tsx\``,Qr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/crm.ts\` (interfaces Contact, Activity, Tag)`,Zr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/catalog/hooks/useCatalogFilters.ts\``,Yr=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/checkout/components/ExpressPayButtons.tsx\``,ei=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/leaderboard/components/StickyUserRank.tsx\``,ni=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/kanban/hooks/useKanbanBoard.ts\``,ri=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
---
### 🔄 INSTRUCTION DE FUSION (Pour l'Orchestrateur API)
*Lorsque l'utilisateur demandera "Crée moi la structure de mon app mobile type Instagram", tu devras utiliser ce PRD Mobile comme squelette. Tu injecteras une Tab Bar en bas (Accueil, Recherche, Ajouter, Profil) et tu t'assureras que le défilement vertical n'affecte que le contenu intérieur (overflow-y-auto) sans faire bouger les barres de navigation natives.*`,ii=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/social/components/LikeAnimation.tsx\``,ai=`# bricbrac — Sovereign PRD Specification Pack
...
- \`src/features/billing/components/InvoiceTable.tsx\``,li=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/types/saas.ts\` (interfaces User, Tenant, Subscription)`,ci=`# 🏛️ Pack PRD : Sovereign Full-Stack Engine
...
`,di=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/specs/components/DynamicForm.tsx\``,ui=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/utils/timeFormat.ts\``,mi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/marketing/components/RoadmapBoard.tsx\``,gi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/ai-studio/components/TokenCostChart.tsx\``,hi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/core/saas/pages/BillingDashboard.tsx\``,xi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/landing/components/ConversionSection.tsx\``,fi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/database/components/ResultDataTable.tsx\``,bi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/stealth/ui/FloatingGhostMenu.tsx\``,vi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/editor/hooks/useEditorState.ts\``,Si=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
`,yi=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/video/hooks/useVideoPlayer.ts\``,_i=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/features/blog/components/TableOfContents.tsx\``,Ci=`> **DIRECTIVE SYSTÈME POUR L'IA (DEEPSEEK / STITCH)**
...
- \`src/shared/widgets/hooks/useCalendarState.ts\``;function Vn(t,n){(n==null||n>t.length)&&(n=t.length);for(var r=0,c=Array(n);r<n;r++)c[r]=t[r];return c}function wi(t){if(Array.isArray(t))return t}function Ii(t,n,r){return(n=Ri(n))in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function Ai(t,n){var r=t==null?null:typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(r!=null){var c,d,m,h,p=[],C=!0,b=!1;try{if(m=(r=r.call(t)).next,n!==0)for(;!(C=(c=m.call(r)).done)&&(p.push(c.value),p.length!==n);C=!0);}catch(y){b=!0,d=y}finally{try{if(!C&&r.return!=null&&(h=r.return(),Object(h)!==h))return}finally{if(b)throw d}}return p}}function Pi(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Bn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);n&&(c=c.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,c)}return r}function zn(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Bn(Object(r),!0).forEach(function(c){Ii(t,c,r[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Bn(Object(r)).forEach(function(c){Object.defineProperty(t,c,Object.getOwnPropertyDescriptor(r,c))})}return t}function ki(t,n){if(t==null)return{};var r,c,d=ji(t,n);if(Object.getOwnPropertySymbols){var m=Object.getOwnPropertySymbols(t);for(c=0;c<m.length;c++)r=m[c],n.indexOf(r)===-1&&{}.propertyIsEnumerable.call(t,r)&&(d[r]=t[r])}return d}function ji(t,n){if(t==null)return{};var r={};for(var c in t)if({}.hasOwnProperty.call(t,c)){if(n.indexOf(c)!==-1)continue;r[c]=t[c]}return r}function Ti(t,n){return wi(t)||Ai(t,n)||Ni(t,n)||Pi()}function Ei(t,n){if(typeof t!="object"||!t)return t;var r=t[Symbol.toPrimitive];if(r!==void 0){var c=r.call(t,n);if(typeof c!="object")return c;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}function Ri(t){var n=Ei(t,"string");return typeof n=="symbol"?n:n+""}function Ni(t,n){if(t){if(typeof t=="string")return Vn(t,n);var r={}.toString.call(t).slice(8,-1);return r==="Object"&&t.constructor&&(r=t.constructor.name),r==="Map"||r==="Set"?Array.from(t):r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?Vn(t,n):void 0}}function Di(t,n,r){return n in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r,t}function Hn(t,n){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);n&&(c=c.filter(function(d){return Object.getOwnPropertyDescriptor(t,d).enumerable})),r.push.apply(r,c)}return r}function $n(t){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Hn(Object(r),!0).forEach(function(c){Di(t,c,r[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Hn(Object(r)).forEach(function(c){Object.defineProperty(t,c,Object.getOwnPropertyDescriptor(r,c))})}return t}function Mi(){for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r];return function(c){return n.reduceRight(function(d,m){return m(d)},c)}}function Yt(t){return function n(){for(var r=this,c=arguments.length,d=new Array(c),m=0;m<c;m++)d[m]=arguments[m];return d.length>=t.length?t.apply(this,d):function(){for(var h=arguments.length,p=new Array(h),C=0;C<h;C++)p[C]=arguments[C];return n.apply(r,[].concat(d,p))}}}function bn(t){return{}.toString.call(t).includes("Object")}function qi(t){return!Object.keys(t).length}function sn(t){return typeof t=="function"}function Li(t,n){return Object.prototype.hasOwnProperty.call(t,n)}function Ui(t,n){return bn(n)||wt("changeType"),Object.keys(n).some(function(r){return!Li(t,r)})&&wt("changeField"),n}function Oi(t){sn(t)||wt("selectorType")}function Fi(t){sn(t)||bn(t)||wt("handlerType"),bn(t)&&Object.values(t).some(function(n){return!sn(n)})&&wt("handlersType")}function Gi(t){t||wt("initialIsRequired"),bn(t)||wt("initialType"),qi(t)&&wt("initialContent")}function Vi(t,n){throw new Error(t[n]||t.default)}var Bi={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},wt=Yt(Vi)(Bi),hn={changes:Ui,selector:Oi,handler:Fi,initial:Gi};function zi(t){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};hn.initial(t),hn.handler(n);var r={current:t},c=Yt(Ki)(r,n),d=Yt($i)(r),m=Yt(hn.changes)(t),h=Yt(Hi)(r);function p(){var b=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(y){return y};return hn.selector(b),b(r.current)}function C(b){Mi(c,d,m,h)(b)}return[p,C]}function Hi(t,n){return sn(n)?n(t.current):n}function $i(t,n){return t.current=$n($n({},t.current),n),n}function Ki(t,n,r){return sn(n)?n(t.current):Object.keys(r).forEach(function(c){var d;return(d=n[c])===null||d===void 0?void 0:d.call(n,t.current[c])}),r}var Wi={create:zi},Ji={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.55.1/min/vs"}};function Xi(t){return function n(){for(var r=this,c=arguments.length,d=new Array(c),m=0;m<c;m++)d[m]=arguments[m];return d.length>=t.length?t.apply(this,d):function(){for(var h=arguments.length,p=new Array(h),C=0;C<h;C++)p[C]=arguments[C];return n.apply(r,[].concat(d,p))}}}function Qi(t){return{}.toString.call(t).includes("Object")}function Zi(t){return t||Kn("configIsRequired"),Qi(t)||Kn("configType"),t.urls?(Yi(),{paths:{vs:t.urls.monacoBase}}):t}function Yi(){console.warn(ts.deprecation)}function ea(t,n){throw new Error(t[n]||t.default)}var ts={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},Kn=Xi(ea)(ts),ta={config:Zi},na=function(){for(var n=arguments.length,r=new Array(n),c=0;c<n;c++)r[c]=arguments[c];return function(d){return r.reduceRight(function(m,h){return h(m)},d)}};function ns(t,n){return Object.keys(n).forEach(function(r){n[r]instanceof Object&&t[r]&&Object.assign(n[r],ns(t[r],n[r]))}),zn(zn({},t),n)}var sa={type:"cancelation",msg:"operation is manually canceled"};function wn(t){var n=!1,r=new Promise(function(c,d){t.then(function(m){return n?d(sa):c(m)}),t.catch(d)});return r.cancel=function(){return n=!0},r}var ra=["monaco"],ia=Wi.create({config:Ji,isInitialized:!1,resolve:null,reject:null,monaco:null}),ss=Ti(ia,2),rn=ss[0],Sn=ss[1];function aa(t){var n=ta.config(t),r=n.monaco,c=ki(n,ra);Sn(function(d){return{config:ns(d.config,c),monaco:r}})}function oa(){var t=rn(function(n){var r=n.monaco,c=n.isInitialized,d=n.resolve;return{monaco:r,isInitialized:c,resolve:d}});if(!t.isInitialized){if(Sn({isInitialized:!0}),t.monaco)return t.resolve(t.monaco),wn(In);if(window.monaco&&window.monaco.editor)return rs(window.monaco),t.resolve(window.monaco),wn(In);na(la,da)(ua)}return wn(In)}function la(t){return document.body.appendChild(t)}function ca(t){var n=document.createElement("script");return t&&(n.src=t),n}function da(t){var n=rn(function(c){var d=c.config,m=c.reject;return{config:d,reject:m}}),r=ca("".concat(n.config.paths.vs,"/loader.js"));return r.onload=function(){return t()},r.onerror=n.reject,r}function ua(){var t=rn(function(r){var c=r.config,d=r.resolve,m=r.reject;return{config:c,resolve:d,reject:m}}),n=window.require;n.config(t.config),n(["vs/editor/editor.main"],function(r){var c=r.m||r;rs(c),t.resolve(c)},function(r){t.reject(r)})}function rs(t){rn().monaco||Sn({monaco:t})}function pa(){return rn(function(t){var n=t.monaco;return n})}var In=new Promise(function(t,n){return Sn({resolve:t,reject:n})}),is={config:aa,init:oa,__getMonacoInstance:pa},ma={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},An=ma,ga={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},ha=ga;function xa({children:t}){return Et.createElement("div",{style:ha.container},t)}var fa=xa,ba=fa;function va({width:t,height:n,isEditorReady:r,loading:c,_ref:d,className:m,wrapperProps:h}){return Et.createElement("section",{style:{...An.wrapper,width:t,height:n},...h},!r&&Et.createElement(ba,null,c),Et.createElement("div",{ref:d,style:{...An.fullWidth,...!r&&An.hide},className:m}))}var Sa=va,as=o.memo(Sa);function ya(t){o.useEffect(t,[])}var os=ya;function _a(t,n,r=!0){let c=o.useRef(!0);o.useEffect(c.current||!r?()=>{c.current=!1}:t,n)}var $e=_a;function en(){}function Bt(t,n,r,c){return Ca(t,c)||wa(t,n,r,c)}function Ca(t,n){return t.editor.getModel(ls(t,n))}function wa(t,n,r,c){return t.editor.createModel(n,r,c?ls(t,c):void 0)}function ls(t,n){return t.Uri.parse(n)}function Ia({original:t,modified:n,language:r,originalLanguage:c,modifiedLanguage:d,originalModelPath:m,modifiedModelPath:h,keepCurrentOriginalModel:p=!1,keepCurrentModifiedModel:C=!1,theme:b="light",loading:y="Loading...",options:L={},height:G="100%",width:Y="100%",className:O,wrapperProps:W={},beforeMount:te=en,onMount:w=en}){let[D,R]=o.useState(!1),[x,v]=o.useState(!0),j=o.useRef(null),A=o.useRef(null),P=o.useRef(null),$=o.useRef(w),F=o.useRef(te),H=o.useRef(!1);os(()=>{let V=is.init();return V.then(B=>(A.current=B)&&v(!1)).catch(B=>(B==null?void 0:B.type)!=="cancelation"&&console.error("Monaco initialization: error:",B)),()=>j.current?ge():V.cancel()}),$e(()=>{if(j.current&&A.current){let V=j.current.getOriginalEditor(),B=Bt(A.current,t||"",c||r||"text",m||"");B!==V.getModel()&&V.setModel(B)}},[m],D),$e(()=>{if(j.current&&A.current){let V=j.current.getModifiedEditor(),B=Bt(A.current,n||"",d||r||"text",h||"");B!==V.getModel()&&V.setModel(B)}},[h],D),$e(()=>{let V=j.current.getModifiedEditor();V.getOption(A.current.editor.EditorOption.readOnly)?V.setValue(n||""):n!==V.getValue()&&(V.executeEdits("",[{range:V.getModel().getFullModelRange(),text:n||"",forceMoveMarkers:!0}]),V.pushUndoStop())},[n],D),$e(()=>{var V,B;(B=(V=j.current)==null?void 0:V.getModel())==null||B.original.setValue(t||"")},[t],D),$e(()=>{let{original:V,modified:B}=j.current.getModel();A.current.editor.setModelLanguage(V,c||r||"text"),A.current.editor.setModelLanguage(B,d||r||"text")},[r,c,d],D),$e(()=>{var V;(V=A.current)==null||V.editor.setTheme(b)},[b],D),$e(()=>{var V;(V=j.current)==null||V.updateOptions(L)},[L],D);let K=o.useCallback(()=>{var ne;if(!A.current)return;F.current(A.current);let V=Bt(A.current,t||"",c||r||"text",m||""),B=Bt(A.current,n||"",d||r||"text",h||"");(ne=j.current)==null||ne.setModel({original:V,modified:B})},[r,n,d,t,c,m,h]),re=o.useCallback(()=>{var V;!H.current&&P.current&&(j.current=A.current.editor.createDiffEditor(P.current,{automaticLayout:!0,...L}),K(),(V=A.current)==null||V.editor.setTheme(b),R(!0),H.current=!0)},[L,b,K]);o.useEffect(()=>{D&&$.current(j.current,A.current)},[D]),o.useEffect(()=>{!x&&!D&&re()},[x,D,re]);function ge(){var B,ne,le,he;let V=(B=j.current)==null?void 0:B.getModel();p||((ne=V==null?void 0:V.original)==null||ne.dispose()),C||((le=V==null?void 0:V.modified)==null||le.dispose()),(he=j.current)==null||he.dispose()}return Et.createElement(as,{width:Y,height:G,isEditorReady:D,loading:y,_ref:P,className:O,wrapperProps:W})}var Aa=Ia;o.memo(Aa);function Pa(t){let n=o.useRef();return o.useEffect(()=>{n.current=t},[t]),n.current}var ka=Pa,xn=new Map;function ja({defaultValue:t,defaultLanguage:n,defaultPath:r,value:c,language:d,path:m,theme:h="light",line:p,loading:C="Loading...",options:b={},overrideServices:y={},saveViewState:L=!0,keepCurrentModel:G=!1,width:Y="100%",height:O="100%",className:W,wrapperProps:te={},beforeMount:w=en,onMount:D=en,onChange:R,onValidate:x=en}){let[v,j]=o.useState(!1),[A,P]=o.useState(!0),$=o.useRef(null),F=o.useRef(null),H=o.useRef(null),K=o.useRef(D),re=o.useRef(w),ge=o.useRef(),V=o.useRef(c),B=ka(m),ne=o.useRef(!1),le=o.useRef(!1);os(()=>{let T=is.init();return T.then(Z=>($.current=Z)&&P(!1)).catch(Z=>(Z==null?void 0:Z.type)!=="cancelation"&&console.error("Monaco initialization: error:",Z)),()=>F.current?ee():T.cancel()}),$e(()=>{var Z,ae,pe,ve;let T=Bt($.current,t||c||"",n||d||"",m||r||"");T!==((Z=F.current)==null?void 0:Z.getModel())&&(L&&xn.set(B,(ae=F.current)==null?void 0:ae.saveViewState()),(pe=F.current)==null||pe.setModel(T),L&&((ve=F.current)==null||ve.restoreViewState(xn.get(m))))},[m],v),$e(()=>{var T;(T=F.current)==null||T.updateOptions(b)},[b],v),$e(()=>{!F.current||c===void 0||(F.current.getOption($.current.editor.EditorOption.readOnly)?F.current.setValue(c):c!==F.current.getValue()&&(le.current=!0,F.current.executeEdits("",[{range:F.current.getModel().getFullModelRange(),text:c,forceMoveMarkers:!0}]),F.current.pushUndoStop(),le.current=!1))},[c],v),$e(()=>{var Z,ae;let T=(Z=F.current)==null?void 0:Z.getModel();T&&d&&((ae=$.current)==null||ae.editor.setModelLanguage(T,d))},[d],v),$e(()=>{var T;p!==void 0&&((T=F.current)==null||T.revealLine(p))},[p],v),$e(()=>{var T;(T=$.current)==null||T.editor.setTheme(h)},[h],v);let he=o.useCallback(()=>{var T;if(!(!H.current||!$.current)&&!ne.current){re.current($.current);let Z=m||r,ae=Bt($.current,c||t||"",n||d||"",Z||"");F.current=(T=$.current)==null?void 0:T.editor.create(H.current,{model:ae,automaticLayout:!0,...b},y),L&&F.current.restoreViewState(xn.get(Z)),$.current.editor.setTheme(h),p!==void 0&&F.current.revealLine(p),j(!0),ne.current=!0}},[t,n,r,c,d,m,b,y,L,h,p]);o.useEffect(()=>{v&&K.current(F.current,$.current)},[v]),o.useEffect(()=>{!A&&!v&&he()},[A,v,he]),V.current=c,o.useEffect(()=>{var T,Z;v&&R&&((T=ge.current)==null||T.dispose(),ge.current=(Z=F.current)==null?void 0:Z.onDidChangeModelContent(ae=>{le.current||R(F.current.getValue(),ae)}))},[v,R]),o.useEffect(()=>{if(v){let T=$.current.editor.onDidChangeMarkers(Z=>{var pe;let ae=(pe=F.current.getModel())==null?void 0:pe.uri;if(ae&&Z.find(ve=>ve.path===ae.path)){let ve=$.current.editor.getModelMarkers({resource:ae});x==null||x(ve)}});return()=>{T==null||T.dispose()}}return()=>{}},[v,x]);function ee(){var T,Z;(T=ge.current)==null||T.dispose(),G?L&&xn.set(m,F.current.saveViewState()):(Z=F.current.getModel())==null||Z.dispose(),F.current.dispose()}return Et.createElement(as,{width:Y,height:O,isEditorReady:v,loading:C,_ref:H,className:W,wrapperProps:te})}var Ta=ja,Ea=o.memo(Ta),Ra=Ea;/*! Capacitor: https://capacitorjs.com/ - MIT License */const Na=t=>{const n=new Map;n.set("web",{name:"web"});const r=t.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:n},c=(m,h)=>{r.platforms.set(m,h)},d=m=>{r.platforms.has(m)&&(r.currentPlatform=r.platforms.get(m))};return r.addPlatform=c,r.setPlatform=d,r},Da=t=>t.CapacitorPlatforms=Na(t),cs=Da(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});cs.addPlatform;cs.setPlatform;var Wt;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(Wt||(Wt={}));class Pn extends Error{constructor(n,r,c){super(n),this.message=n,this.code=r,this.data=c}}const Ma=t=>{var n,r;return t!=null&&t.androidBridge?"android":!((r=(n=t==null?void 0:t.webkit)===null||n===void 0?void 0:n.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},qa=t=>{var n,r,c,d,m;const h=t.CapacitorCustomPlatform||null,p=t.Capacitor||{},C=p.Plugins=p.Plugins||{},b=t.CapacitorPlatforms,y=()=>h!==null?h.name:Ma(t),L=((n=b==null?void 0:b.currentPlatform)===null||n===void 0?void 0:n.getPlatform)||y,G=()=>L()!=="web",Y=((r=b==null?void 0:b.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||G,O=A=>{const P=x.get(A);return!!(P!=null&&P.platforms.has(L())||w(A))},W=((c=b==null?void 0:b.currentPlatform)===null||c===void 0?void 0:c.isPluginAvailable)||O,te=A=>{var P;return(P=p.PluginHeaders)===null||P===void 0?void 0:P.find($=>$.name===A)},w=((d=b==null?void 0:b.currentPlatform)===null||d===void 0?void 0:d.getPluginHeader)||te,D=A=>t.console.error(A),R=(A,P,$)=>Promise.reject(`${$} does not have an implementation of "${P}".`),x=new Map,v=(A,P={})=>{const $=x.get(A);if($)return console.warn(`Capacitor plugin "${A}" already registered. Cannot register plugins twice.`),$.proxy;const F=L(),H=w(A);let K;const re=async()=>(!K&&F in P?K=typeof P[F]=="function"?K=await P[F]():K=P[F]:h!==null&&!K&&"web"in P&&(K=typeof P.web=="function"?K=await P.web():K=P.web),K),ge=(ee,T)=>{var Z,ae;if(H){const pe=H==null?void 0:H.methods.find(ve=>T===ve.name);if(pe)return pe.rtype==="promise"?ve=>p.nativePromise(A,T.toString(),ve):(ve,je)=>p.nativeCallback(A,T.toString(),ve,je);if(ee)return(Z=ee[T])===null||Z===void 0?void 0:Z.bind(ee)}else{if(ee)return(ae=ee[T])===null||ae===void 0?void 0:ae.bind(ee);throw new Pn(`"${A}" plugin is not implemented on ${F}`,Wt.Unimplemented)}},V=ee=>{let T;const Z=(...ae)=>{const pe=re().then(ve=>{const je=ge(ve,ee);if(je){const ke=je(...ae);return T=ke==null?void 0:ke.remove,ke}else throw new Pn(`"${A}.${ee}()" is not implemented on ${F}`,Wt.Unimplemented)});return ee==="addListener"&&(pe.remove=async()=>T()),pe};return Z.toString=()=>`${ee.toString()}() { [capacitor code] }`,Object.defineProperty(Z,"name",{value:ee,writable:!1,configurable:!1}),Z},B=V("addListener"),ne=V("removeListener"),le=(ee,T)=>{const Z=B({eventName:ee},T),ae=async()=>{const ve=await Z;ne({eventName:ee,callbackId:ve},T)},pe=new Promise(ve=>Z.then(()=>ve({remove:ae})));return pe.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await ae()},pe},he=new Proxy({},{get(ee,T){switch(T){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return H?le:B;case"removeListener":return ne;default:return V(T)}}});return C[A]=he,x.set(A,{name:A,proxy:he,platforms:new Set([...Object.keys(P),...H?[F]:[]])}),he},j=((m=b==null?void 0:b.currentPlatform)===null||m===void 0?void 0:m.registerPlugin)||v;return p.convertFileSrc||(p.convertFileSrc=A=>A),p.getPlatform=L,p.handleError=D,p.isNativePlatform=Y,p.isPluginAvailable=W,p.pluginMethodNoop=R,p.registerPlugin=j,p.Exception=Pn,p.DEBUG=!!p.DEBUG,p.isLoggingEnabled=!!p.isLoggingEnabled,p.platform=p.getPlatform(),p.isNative=p.isNativePlatform(),p},La=t=>t.Capacitor=qa(t),Jt=La(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Mn=Jt.registerPlugin;Jt.Plugins;class ds{constructor(n){this.listeners={},this.retainedEventArguments={},this.windowListeners={},n&&(console.warn(`Capacitor WebPlugin "${n.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=n)}addListener(n,r){let c=!1;this.listeners[n]||(this.listeners[n]=[],c=!0),this.listeners[n].push(r);const m=this.windowListeners[n];m&&!m.registered&&this.addWindowListener(m),c&&this.sendRetainedArgumentsForEvent(n);const h=async()=>this.removeListener(n,r);return Promise.resolve({remove:h})}async removeAllListeners(){this.listeners={};for(const n in this.windowListeners)this.removeWindowListener(this.windowListeners[n]);this.windowListeners={}}notifyListeners(n,r,c){const d=this.listeners[n];if(!d){if(c){let m=this.retainedEventArguments[n];m||(m=[]),m.push(r),this.retainedEventArguments[n]=m}return}d.forEach(m=>m(r))}hasListeners(n){return!!this.listeners[n].length}registerWindowListener(n,r){this.windowListeners[r]={registered:!1,windowEventName:n,pluginEventName:r,handler:c=>{this.notifyListeners(r,c)}}}unimplemented(n="not implemented"){return new Jt.Exception(n,Wt.Unimplemented)}unavailable(n="not available"){return new Jt.Exception(n,Wt.Unavailable)}async removeListener(n,r){const c=this.listeners[n];if(!c)return;const d=c.indexOf(r);this.listeners[n].splice(d,1),this.listeners[n].length||this.removeWindowListener(this.windowListeners[n])}addWindowListener(n){window.addEventListener(n.windowEventName,n.handler),n.registered=!0}removeWindowListener(n){n&&(window.removeEventListener(n.windowEventName,n.handler),n.registered=!1)}sendRetainedArgumentsForEvent(n){const r=this.retainedEventArguments[n];r&&(delete this.retainedEventArguments[n],r.forEach(c=>{this.notifyListeners(n,c)}))}}const Wn=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Jn=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Ua extends ds{async getCookies(){const n=document.cookie,r={};return n.split(";").forEach(c=>{if(c.length<=0)return;let[d,m]=c.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");d=Jn(d).trim(),m=Jn(m).trim(),r[d]=m}),r}async setCookie(n){try{const r=Wn(n.key),c=Wn(n.value),d=`; expires=${(n.expires||"").replace("expires=","")}`,m=(n.path||"/").replace("path=",""),h=n.url!=null&&n.url.length>0?`domain=${n.url}`:"";document.cookie=`${r}=${c||""}${d}; path=${m}; ${h};`}catch(r){return Promise.reject(r)}}async deleteCookie(n){try{document.cookie=`${n.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{const n=document.cookie.split(";")||[];for(const r of n)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(n){return Promise.reject(n)}}async clearAllCookies(){try{await this.clearCookies()}catch(n){return Promise.reject(n)}}}Mn("CapacitorCookies",{web:()=>new Ua});const Oa=async t=>new Promise((n,r)=>{const c=new FileReader;c.onload=()=>{const d=c.result;n(d.indexOf(",")>=0?d.split(",")[1]:d)},c.onerror=d=>r(d),c.readAsDataURL(t)}),Fa=(t={})=>{const n=Object.keys(t);return Object.keys(t).map(d=>d.toLocaleLowerCase()).reduce((d,m,h)=>(d[m]=t[n[h]],d),{})},Ga=(t,n=!0)=>t?Object.entries(t).reduce((c,d)=>{const[m,h]=d;let p,C;return Array.isArray(h)?(C="",h.forEach(b=>{p=n?encodeURIComponent(b):b,C+=`${m}=${p}&`}),C.slice(0,-1)):(p=n?encodeURIComponent(h):h,C=`${m}=${p}`),`${c}&${C}`},"").substr(1):null,Va=(t,n={})=>{const r=Object.assign({method:t.method||"GET",headers:t.headers},n),d=Fa(t.headers)["content-type"]||"";if(typeof t.data=="string")r.body=t.data;else if(d.includes("application/x-www-form-urlencoded")){const m=new URLSearchParams;for(const[h,p]of Object.entries(t.data||{}))m.set(h,p);r.body=m.toString()}else if(d.includes("multipart/form-data")||t.data instanceof FormData){const m=new FormData;if(t.data instanceof FormData)t.data.forEach((p,C)=>{m.append(C,p)});else for(const p of Object.keys(t.data))m.append(p,t.data[p]);r.body=m;const h=new Headers(r.headers);h.delete("content-type"),r.headers=h}else(d.includes("application/json")||typeof t.data=="object")&&(r.body=JSON.stringify(t.data));return r};class Ba extends ds{async request(n){const r=Va(n,n.webFetchExtra),c=Ga(n.params,n.shouldEncodeUrlParams),d=c?`${n.url}?${c}`:n.url,m=await fetch(d,r),h=m.headers.get("content-type")||"";let{responseType:p="text"}=m.ok?n:{};h.includes("application/json")&&(p="json");let C,b;switch(p){case"arraybuffer":case"blob":b=await m.blob(),C=await Oa(b);break;case"json":C=await m.json();break;case"document":case"text":default:C=await m.text()}const y={};return m.headers.forEach((L,G)=>{y[G]=L}),{data:C,headers:y,status:m.status,url:m.url}}async get(n){return this.request(Object.assign(Object.assign({},n),{method:"GET"}))}async post(n){return this.request(Object.assign(Object.assign({},n),{method:"POST"}))}async put(n){return this.request(Object.assign(Object.assign({},n),{method:"PUT"}))}async patch(n){return this.request(Object.assign(Object.assign({},n),{method:"PATCH"}))}async delete(n){return this.request(Object.assign(Object.assign({},n),{method:"DELETE"}))}}Mn("CapacitorHttp",{web:()=>new Ba});var vn;(function(t){t.Documents="DOCUMENTS",t.Data="DATA",t.Library="LIBRARY",t.Cache="CACHE",t.External="EXTERNAL",t.ExternalStorage="EXTERNAL_STORAGE"})(vn||(vn={}));var Tn;(function(t){t.UTF8="utf8",t.ASCII="ascii",t.UTF16="utf16"})(Tn||(Tn={}));const Xn=Mn("Filesystem",{web:()=>nn(()=>import("./web-v200-B7Q5fVJ6.js"),__vite__mapDeps([0,1,2])).then(t=>new t.FilesystemWeb)});/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const za=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),us=(...t)=>t.filter((n,r,c)=>!!n&&c.indexOf(n)===r).join(" ");/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $a=o.forwardRef(({color:t="currentColor",size:n=24,strokeWidth:r=2,absoluteStrokeWidth:c,className:d="",children:m,iconNode:h,...p},C)=>o.createElement("svg",{ref:C,...Ha,width:n,height:n,stroke:t,strokeWidth:c?Number(r)*24/Number(n):r,className:us("lucide",d),...p},[...h.map(([b,y])=>o.createElement(b,y)),...Array.isArray(m)?m:[m]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const de=(t,n)=>{const r=o.forwardRef(({className:c,...d},m)=>o.createElement($a,{ref:m,iconNode:n,className:us(`lucide-${za(t)}`,c),...d}));return r.displayName=`${t}`,r};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ka=de("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const kn=de("Ban",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m4.9 4.9 14.2 14.2",key:"1m5liu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ps=de("Box",[["path",{d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z",key:"hh9hay"}],["path",{d:"m3.3 7 8.7 5 8.7-5",key:"g66t2b"}],["path",{d:"M12 22V12",key:"d0xqtd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wa=de("ChevronDown",[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ja=de("ChevronUp",[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ms=de("CircleCheck",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xa=de("CircleHelp",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qa=de("CircleX",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Za=de("Component",[["path",{d:"M5.5 8.5 9 12l-3.5 3.5L2 12l3.5-3.5Z",key:"1kciei"}],["path",{d:"m12 2 3.5 3.5L12 9 8.5 5.5 12 2Z",key:"1ome0g"}],["path",{d:"M18.5 8.5 22 12l-3.5 3.5L15 12l3.5-3.5Z",key:"vbupec"}],["path",{d:"m12 15 3.5 3.5L12 22l-3.5-3.5L12 15Z",key:"16csic"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ya=de("CreditCard",[["rect",{width:"20",height:"14",x:"2",y:"5",rx:"2",key:"ynyp8z"}],["line",{x1:"2",x2:"22",y1:"10",y2:"10",key:"1b3vmo"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const eo=de("Database",[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3",key:"msslwz"}],["path",{d:"M3 5V19A9 3 0 0 0 21 19V5",key:"1wlel7"}],["path",{d:"M3 12A9 3 0 0 0 21 12",key:"mv7ke4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const to=de("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const no=de("FilePen",[["path",{d:"M12 22h6a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v10",key:"x7tsz2"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10.4 12.6a2 2 0 1 1 3 3L8 21l-4 1 1-4Z",key:"o3xyfb"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const so=de("FilePlus",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M9 15h6",key:"cctwl0"}],["path",{d:"M12 18v-6",key:"17g6i2"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ro=de("FileText",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const io=de("FolderLock",[["rect",{width:"8",height:"5",x:"14",y:"17",rx:"1",key:"19aais"}],["path",{d:"M10 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v2.5",key:"1w6v7t"}],["path",{d:"M20 17v-2a2 2 0 1 0-4 0v2",key:"pwaxnr"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ao=de("Globe",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20",key:"13o1zl"}],["path",{d:"M2 12h20",key:"9i4pu4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oo=de("Image",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const co=de("Newspaper",[["path",{d:"M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2",key:"7pis2x"}],["path",{d:"M18 14h-8",key:"sponae"}],["path",{d:"M15 18h-5",key:"95g1m2"}],["path",{d:"M10 6h8v4h-8V6Z",key:"smlsk5"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const uo=de("PanelsTopLeft",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}],["path",{d:"M3 9h18",key:"1pudct"}],["path",{d:"M9 21V9",key:"1oto5p"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const po=de("PenTool",[["path",{d:"M15.707 21.293a1 1 0 0 1-1.414 0l-1.586-1.586a1 1 0 0 1 0-1.414l5.586-5.586a1 1 0 0 1 1.414 0l1.586 1.586a1 1 0 0 1 0 1.414z",key:"nt11vn"}],["path",{d:"m18 13-1.375-6.874a1 1 0 0 0-.746-.776L3.235 2.028a1 1 0 0 0-1.207 1.207L5.35 15.879a1 1 0 0 0 .776.746L13 18",key:"15qc1e"}],["path",{d:"m2.3 2.3 7.286 7.286",key:"1wuzzi"}],["circle",{cx:"11",cy:"11",r:"2",key:"xmgehs"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mo=de("Rocket",[["path",{d:"M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z",key:"m3kijz"}],["path",{d:"m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z",key:"1fmvmk"}],["path",{d:"M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0",key:"1f8sc4"}],["path",{d:"M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5",key:"qeys4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const go=de("ShieldAlert",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"M12 8v4",key:"1got3b"}],["path",{d:"M12 16h.01",key:"1drbdi"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ho=de("ShieldCheck",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xo=de("ShoppingCart",[["circle",{cx:"8",cy:"21",r:"1",key:"jimo8o"}],["circle",{cx:"19",cy:"21",r:"1",key:"13723u"}],["path",{d:"M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12",key:"9zh506"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const fo=de("Smartphone",[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2",key:"1yt0o3"}],["path",{d:"M12 18h.01",key:"mhygvu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const En=de("TriangleAlert",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bo=de("Trophy",[["path",{d:"M6 9H4.5a2.5 2.5 0 0 1 0-5H6",key:"17hqa7"}],["path",{d:"M18 9h1.5a2.5 2.5 0 0 0 0-5H18",key:"lmptdp"}],["path",{d:"M4 22h16",key:"57wxv0"}],["path",{d:"M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22",key:"1nw9bq"}],["path",{d:"M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22",key:"1np0yb"}],["path",{d:"M18 2H6v7a6 6 0 0 0 12 0V2Z",key:"u46fv3"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const vo=de("Video",[["path",{d:"m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5",key:"ftymec"}],["rect",{x:"2",y:"6",width:"14",height:"12",rx:"2",key:"158x01"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Rn=de("Zap",[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]]),So=t=>t.includes("auth")||t.includes("stealth")?ho:t.includes("ecom")||t.includes("commerce")||t.includes("produit")?xo:t.includes("billing")||t.includes("paiement")?Ya:t.includes("layout")||t.includes("interface")?uo:t.includes("mobile")?fo:t.includes("blog")||t.includes("texte")||t.includes("markdown")?co:t.includes("game")||t.includes("gamification")?bo:t.includes("sqlite")||t.includes("scraper")?eo:t.includes("image")?oo:t.includes("video")||t.includes("audio")?vo:t.includes("design")||t.includes("createur")?po:t.includes("web")||t.includes("saas")||t.includes("landing")?ao:t.includes("ia_")||t.includes("prompt")?yo:t.includes("chat")||t.includes("social")?lo:t.includes("composant")||t.includes("widget")||t.includes("forms")?Za:t.includes("pdf")||t.includes("pieces_jointes")?ro:t.includes("mock")||t.includes("bridge")||t.includes("engine")?gs:ps,yo=gs,_o=t=>{const n=["bg-red-500/10 text-red-500","bg-blue-500/10 text-blue-500","bg-emerald-500/10 text-emerald-500","bg-purple-500/10 text-purple-500","bg-orange-500/10 text-orange-500","bg-pink-500/10 text-pink-500","bg-yellow-500/10 text-yellow-500","bg-cyan-500/10 text-cyan-500","bg-indigo-500/10 text-indigo-500","bg-teal-500/10 text-teal-500"];let r=0;for(let c=0;c<t.length;c++)r=t.charCodeAt(c)+((r<<5)-r);return n[Math.abs(r)%n.length]},Co=["app_web_pack","audio_pack","blog_contenu_pack","chat_comms_pack","commerce_paiement_pack","composant_pack","createur_pack","design_figma_xd_pack","diamond_bridge_v14_37","e_commerce_pack","ecommerce_pack","evenement_pack","feed_social_pack","forge_universelle","forms_inputs_pack","formulaire_pack","gamification_pack","health_fitness_pack","ia_pack","image_pack","interface_pack","jeux_video_pack","landing_pack","landing_saas_pack","layout_pack","local_maps_pack","markdown_pack","marketing_pack","mobile_pack","mobile_shell_pack","mobile_web_pack","mock_master","pdf_docs_pack","pieces_jointes_pack","prd_ai_apps_pack","prd_ai_voice_agent","prd_auth_gateway","prd_blog_magazine","prd_crm_erp_pack","prd_ecom_catalog","prd_ecom_checkout","prd_ecom_digital_products","prd_game_leaderboard","prd_layout_bento","prd_layout_kanban","prd_mobile_pack","prd_mobile_social","prd_saas_billing_pro","prd_saas_pack","prd_specs_pack","prd_web_landing_pack","productivity_pack","produit_pack","prompt_skills_pack","saas_pack","specialise_pack","sqlite_inspector","stealth_bridge_v11_2","texte_pack","universal_scraper","video_pack","web_blog_pack","widget_pack","guest_nebula_calc"],Ht=Co.map(t=>({id:t,name:t.replace(/_/g," ").replace(/\b\w/g,n=>n.toUpperCase()),icon:So(t),color:_o(t)})),wo={low:"text-emerald-400 border-emerald-500/30 bg-emerald-950/20",medium:"text-amber-400   border-amber-500/30   bg-amber-950/20",high:"text-orange-400  border-orange-500/30  bg-orange-950/20",critical:"text-red-400     border-red-500/30     bg-red-950/20"},Io={low:e.jsx(ms,{className:"w-3.5 h-3.5"}),medium:e.jsx(En,{className:"w-3.5 h-3.5"}),high:e.jsx(En,{className:"w-3.5 h-3.5"}),critical:e.jsx(Qa,{className:"w-3.5 h-3.5"})};function Nn({value:t}){const n=Math.round((t??1)*100),r=n>=80?"bg-emerald-500":n>=60?"bg-amber-500":"bg-red-500";return e.jsxs("span",{className:"flex items-center gap-1.5 text-[10px] font-bold text-zinc-400",children:[e.jsx("span",{className:`inline-block w-2 h-2 rounded-full ${r}`}),n,"% confiance"]})}function Ao({cap:t}){const[n,r]=o.useState(!1);return e.jsxs("div",{className:"border border-zinc-800 rounded-xl overflow-hidden",children:[e.jsxs("button",{type:"button",className:"w-full flex items-center justify-between px-4 py-2.5 hover:bg-zinc-900/60 transition-colors",onClick:()=>r(c=>!c),children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:`text-xs font-bold px-2 py-0.5 rounded-full ${t.required?"bg-violet-500/20 text-violet-300":"bg-zinc-800 text-zinc-400"}`,children:t.required?"REQUISE":"optionnelle"}),e.jsx("span",{className:"text-sm text-white font-mono",children:t.id})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(Nn,{value:t.confidence}),n?e.jsx(Ja,{className:"w-3.5 h-3.5 text-zinc-500"}):e.jsx(Wa,{className:"w-3.5 h-3.5 text-zinc-500"})]})]}),n&&e.jsxs("div",{className:"px-4 pb-3 pt-1 bg-zinc-950/40 space-y-2",children:[e.jsx("p",{className:"text-xs text-zinc-300",children:t.reason}),t.evidence.length>0&&e.jsx("ul",{className:"space-y-1",children:t.evidence.map((c,d)=>e.jsxs("li",{className:"text-[11px] font-mono text-cyan-400/70",children:["→ ",c]},d))})]})]})}const Po=({audit:t,sourceFolder:n,onConfirm:r,onReset:c,isSubmitting:d})=>{const[m,h]=o.useState({}),p=t.requiresUserDecision||[],C=t.risks||[],b=t.capabilities||[],y=t.mocks||[],L=t.decisions||[],G=t.filesToCreate||[],Y=t.filesToModify||[],O=t.filesToPreserve||[],W=p.some(x=>x.required&&(!m[x.id]||m[x.id].trim()===""));C.filter(x=>x.level==="critical"||x.level==="high").length;const w=!W&&!d;Math.round((t.confidence||0)*100);const D=t.backendRequired===!1,R=()=>{const x={...t,requiresUserDecision:p.map(v=>({...v,answer:m[v.id]||""}))};r(x)};return e.jsxs("div",{className:"space-y-6 my-8 animate-in fade-in slide-in-from-bottom-4 duration-700",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-8 border border-violet-500/30 bg-violet-950/10 shadow-[0_0_60px_rgba(139,92,246,0.08)]",children:[e.jsx("div",{className:"absolute -top-20 -right-20 w-80 h-80 bg-violet-500/10 rounded-full blur-[100px]"}),e.jsxs("div",{className:"relative z-10",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsxs("span",{className:"flex items-center gap-2 px-4 py-1.5 rounded-full bg-violet-500/10 text-violet-300 border border-violet-500/30 text-xs font-black uppercase tracking-[0.2em]",children:[e.jsx(Qn,{className:"w-4 h-4"}),"Phase 5 — Audit Souverain"]}),e.jsx("span",{className:"h-px flex-1 bg-gradient-to-r from-violet-500/40 to-transparent"})]}),e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-4",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-violet-200 to-violet-400 tracking-tight",children:(t.projectType||"PROJET STANDARD").toUpperCase()}),e.jsx("p",{className:"text-sm text-zinc-400 mt-1 font-mono",children:n.split(/[\\/]/).pop()||n})]}),e.jsxs("div",{className:"flex flex-col items-end gap-2",children:[e.jsx(Nn,{value:t.confidence}),D?e.jsx("span",{className:"text-xs px-3 py-1 rounded-full bg-zinc-800 text-zinc-400 font-semibold",children:"🟡 Backend non requis"}):e.jsx("span",{className:"text-xs px-3 py-1 rounded-full bg-violet-500/20 text-violet-300 border border-violet-500/30 font-semibold",children:"🔌 Industrialisation complète"})]})]}),D&&e.jsxs("div",{className:"mt-4 p-4 bg-zinc-900/60 border border-zinc-700 rounded-2xl text-sm text-zinc-300",children:[e.jsx("strong",{className:"text-amber-400",children:"⚠️ Ce projet n'a pas besoin de backend."})," ","L'action recommandée est"," ",e.jsx("code",{className:"text-violet-300 bg-zinc-800 px-1.5 py-0.5 rounded text-xs",children:t.phase5Action||"skip_backend_integration"}),". Vous pouvez néanmoins confirmer pour générer le contrat."]})]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"rounded-2xl border border-violet-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-violet-400 mb-4 flex items-center gap-2",children:[e.jsx(Rn,{className:"w-4 h-4"})," Capacités détectées (",b.length,")"]}),e.jsx("div",{className:"space-y-2",children:b.length===0?e.jsx("p",{className:"text-xs text-zinc-500",children:"Aucune capacité détectée."}):b.map(x=>e.jsx(Ao,{cap:x},x.id))})]}),e.jsxs("div",{className:"rounded-2xl border border-amber-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-amber-400 mb-4 flex items-center gap-2",children:[e.jsx(go,{className:"w-4 h-4"})," Mocks à remplacer (",y.length,")"]}),y.length===0?e.jsx("p",{className:"text-xs text-zinc-500",children:"Aucun mock détecté."}):e.jsx("ul",{className:"space-y-2",children:y.map(x=>e.jsxs("li",{className:"flex items-start gap-3 p-3 rounded-xl bg-amber-950/10 border border-amber-500/20",children:[e.jsx(Ka,{className:"w-3.5 h-3.5 text-amber-400 mt-0.5 shrink-0"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-mono text-amber-200",children:x.path}),e.jsxs("p",{className:"text-[10px] text-zinc-400",children:[x.pattern," → ",e.jsx("span",{className:"text-violet-300",children:x.capability})]})]})]},x.id))})]})]}),L.length>0&&e.jsxs("div",{className:"rounded-2xl border border-cyan-500/20 bg-zinc-950/40 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-cyan-400 mb-4 flex items-center gap-2",children:[e.jsx(Qn,{className:"w-4 h-4"})," Providers recommandés (",L.length,")"]}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-3",children:L.map((x,v)=>e.jsxs("div",{className:"p-3 rounded-xl bg-cyan-950/10 border border-cyan-500/20 space-y-1",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-xs font-bold text-cyan-300 font-mono",children:x.capability}),e.jsx(Nn,{value:x.confidence})]}),e.jsx("p",{className:"text-xs text-white font-semibold",children:x.provider||"À déterminer"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed",children:x.reason}),x.requiresConfirmation&&e.jsx("span",{className:"inline-block text-[10px] px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/30",children:"⚠️ Confirmation requise"})]},v))})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:[e.jsxs("div",{className:"rounded-2xl border border-emerald-500/20 bg-emerald-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-emerald-400 mb-3 flex items-center gap-2",children:[e.jsx(so,{className:"w-3.5 h-3.5"})," À créer (",G.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[G.slice(0,8).map((x,v)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["+ ",x]},v)),G.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",G.length-8," autres…"]})]})]}),e.jsxs("div",{className:"rounded-2xl border border-orange-500/20 bg-orange-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-orange-400 mb-3 flex items-center gap-2",children:[e.jsx(no,{className:"w-3.5 h-3.5"})," À modifier (",Y.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[Y.slice(0,8).map((x,v)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["~ ",x]},v)),Y.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",Y.length-8," autres…"]})]})]}),e.jsxs("div",{className:"rounded-2xl border border-blue-500/20 bg-blue-950/5 p-5",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-blue-400 mb-3 flex items-center gap-2",children:[e.jsx(io,{className:"w-3.5 h-3.5"})," Préservés (",O.length,")"]}),e.jsxs("ul",{className:"space-y-1",children:[O.slice(0,8).map((x,v)=>e.jsxs("li",{className:"text-[11px] font-mono text-zinc-300",children:["🔒 ",x]},v)),O.length>8&&e.jsxs("li",{className:"text-[10px] text-zinc-500",children:["+",O.length-8," autres…"]})]})]})]}),C.length>0&&e.jsxs("div",{className:"rounded-2xl border border-red-500/20 bg-red-950/5 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-red-400 mb-4 flex items-center gap-2",children:[e.jsx(En,{className:"w-4 h-4"})," Risques identifiés (",C.length,")"]}),e.jsx("div",{className:"space-y-2",children:C.map((x,v)=>e.jsxs("div",{className:`flex items-start gap-3 p-3 rounded-xl border ${wo[x.level]}`,children:[Io[x.level],e.jsxs("div",{children:[e.jsxs("span",{className:"text-[10px] font-black uppercase tracking-wider opacity-70",children:["[",x.level,"] ",x.code]}),e.jsx("p",{className:"text-xs mt-0.5",children:x.message})]})]},v))})]}),p.length>0&&e.jsxs("div",{className:"rounded-2xl border border-rose-500/40 bg-rose-950/10 p-6",children:[e.jsxs("h3",{className:"text-xs font-black uppercase tracking-widest text-rose-400 mb-4 flex items-center gap-2",children:[e.jsx(Xa,{className:"w-4 h-4"}),"Décisions utilisateur obligatoires (",p.filter(x=>x.required).length," BLOQUANTE(S))"]}),e.jsx("div",{className:"space-y-3",children:p.map(x=>{const v=!!(m[x.id]&&m[x.id].trim()!==""),j=(x.capability||x.id||"").toLowerCase().replace("-","_"),A={backend:["Node.js / Express","Python / FastAPI","Supabase (BaaS)","Firebase (BaaS)","Aucun (Front-end only)"],auth:["JWT Local personnalisé","Supabase Auth","Firebase Auth","Auth0","Clerk","Aucune authentification"],authentication:["JWT Local personnalisé","Supabase Auth","Firebase Auth","Auth0","Clerk","Aucune authentification"],data_persistence:["PostgreSQL","MongoDB","MySQL / MariaDB","SQLite local","Local Storage (Frontend)"],database:["PostgreSQL","MongoDB","MySQL / MariaDB","SQLite local","Local Storage (Frontend)"],routing:["React Router (SPA)","Next.js App Router","Vite Plugin Pages"],error_handling:["Gestionnaire global classique","Sentry","Winston / Morgan (Backend)"],design:["TailwindCSS natif","Material UI","Chakra UI","CSS Modules","Vanilla CSS"],file_upload:["AWS S3","Supabase Storage","Stockage local (Backend)","Cloudinary"],storage:["AWS S3","Supabase Storage","Stockage local (Backend)","Cloudinary"],ocr_processing:["Google Vision API","AWS Textract","Tesseract.js (Local)","API tierce dédiée"]},P=x.options&&x.options.length>0?x.options:A[j]||[],$=P.length>0,H=$&&v&&!P.includes(m[x.id])?"other":m[x.id]||"";return e.jsx("div",{className:`p-4 rounded-xl border transition-colors ${x.required&&!v?"border-rose-500/60 bg-rose-950/30":"border-zinc-700 bg-zinc-900/40"}`,children:e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsxs("div",{className:"flex items-start gap-2",children:[x.required?v?e.jsx(ms,{className:"w-4 h-4 text-emerald-400 shrink-0 mt-0.5"}):e.jsx(kn,{className:"w-4 h-4 text-rose-400 shrink-0 mt-0.5"}):e.jsx(to,{className:"w-4 h-4 text-zinc-400 shrink-0 mt-0.5"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-semibold text-white",children:x.question}),e.jsxs("p",{className:"text-[10px] text-zinc-400 mt-0.5",children:["Lié à : ",e.jsx("span",{className:"font-mono text-violet-300",children:x.capability||x.id})]})]})]}),e.jsxs("div",{className:"space-y-2",children:[$&&e.jsxs("select",{value:H,onChange:K=>{K.target.value==="other"?h(re=>({...re,[x.id]:""})):h(re=>({...re,[x.id]:K.target.value}))},className:"w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-violet-500/50",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionner une réponse --"}),P.map(K=>e.jsx("option",{value:K,children:K},K)),e.jsx("option",{value:"other",children:"Autre (Saisie libre)..."})]}),(!$||H==="other")&&e.jsx("input",{type:"text",placeholder:"Tapez votre réponse précise ici...",value:m[x.id]||"",onChange:K=>h(re=>({...re,[x.id]:K.target.value})),autoFocus:H==="other",className:"w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white placeholder-zinc-600 focus:outline-none focus:border-violet-500/50"})]})]})},x.id)})}),W&&e.jsxs("p",{className:"mt-4 text-xs text-rose-300 font-semibold bg-rose-950/30 border border-rose-500/30 rounded-xl p-3 flex items-center gap-2",children:[e.jsx(kn,{className:"w-4 h-4"})," La confirmation est bloquée jusqu'à ce que les décisions obligatoires ci-dessus soient résolues."]})]}),e.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-2 border border-violet-500/30 bg-zinc-950/80 backdrop-blur-xl shadow-2xl",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-violet-500/5 via-blue-500/5 to-cyan-500/5 pointer-events-none"}),e.jsxs("div",{className:"relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 p-4",children:[e.jsxs("div",{className:"text-xs text-zinc-400 max-w-sm leading-relaxed",children:[e.jsx("strong",{className:"text-violet-300",children:"La confirmation ne modifie aucun fichier."})," ","Elle envoie uniquement le contrat au moteur Kirov5 qui effectuera les vérifications de sécurité (drift, gates) avant toute mutation."]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("button",{type:"button",onClick:c,disabled:d,className:"px-5 py-3 rounded-2xl font-bold text-xs bg-white/5 hover:bg-white/10 text-zinc-300 border border-white/10 flex items-center gap-2 transition-all hover:scale-105 active:scale-95 disabled:opacity-50",children:"← Ré-auditer"}),e.jsxs("button",{type:"button",onClick:R,disabled:!w,title:W?"Résolvez les décisions obligatoires avant de confirmer":"",className:`px-8 py-3.5 rounded-2xl font-black text-sm flex items-center gap-3 transition-all relative overflow-hidden group
                ${w?"bg-gradient-to-r from-violet-500 to-cyan-500 hover:from-violet-400 hover:to-cyan-400 text-white shadow-[0_0_30px_rgba(139,92,246,0.4)] hover:shadow-[0_0_50px_rgba(139,92,246,0.6)] hover:scale-105 active:scale-95":"bg-zinc-800 text-zinc-500 cursor-not-allowed border border-zinc-700"}`,children:[w&&e.jsx("div",{className:"absolute inset-0 w-full h-full bg-white/10 -translate-x-full group-hover:animate-[shimmer_1.5s_infinite]"}),d?e.jsxs(e.Fragment,{children:[e.jsx(Rn,{className:"w-4 h-4 animate-spin"}),"Envoi à Kirov5..."]}):W?e.jsxs(e.Fragment,{children:[e.jsx(kn,{className:"w-4 h-4"}),"Répondez aux questions..."]}):e.jsxs(e.Fragment,{children:[e.jsx(mo,{className:"w-4 h-4"}),"🚀 Confirmer → Kirov5"]})]})]})]})]})]})},Dn=`Tu es un Architecte Logiciel Senior (Niveau Staff Engineer) spécialisé en Product Design, React/TypeScript, et Architecture d'Applications Web.
...
Réponds UNIQUEMENT avec le JSON demandé.`,ko=Object.freeze(Object.defineProperty({__proto__:null,SYSTEM_PROMPT:Dn},Symbol.toStringTag,{value:"Module"}));function hs(t,n,r,c,d){let m=!1;t&&t.includes("[DESIGN RIP]")&&(m=!0,t=t.replace("[DESIGN RIP]","").trim());let h="";r?h=`
...
Réponds avec le JSON valide uniquement, aucun texte avant ou après.`}const jo=Object.freeze(Object.defineProperty({__proto__:null,buildUserPrompt:hs},Symbol.toStringTag,{value:"Module"})),xs="hermes_deepseek_api_key",fs="tiger_apiKey";function To(){try{return localStorage.getItem(xs)||localStorage.getItem(fs)||null}catch{return null}}function Eo(t){try{const n=t.trim();localStorage.setItem(xs,n),localStorage.setItem(fs,n),I("http://localhost:5006/api/config/apikey",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({key:n,apiKey:n,provider:"deepseek"})}).catch(()=>{})}catch{}}async function qn(){const t=To();if(t&&t.length>5)return t;try{const n=await I("http://localhost:5006/api/config/apikey");if(n&&n.ok){const r=await n.json();if((r.hasKey||r.hasAnyKey||r.configured)&&r.apiKey)return Eo(r.apiKey),r.apiKey}}catch{}return null}const jn={},Ro={QWEN_CODER_32B:"@cf/qwen/qwen2.5-coder-32b-instruct"},No=(jn==null?void 0:jn.VITE_HERMES_WORKER_URL)||"https://kirov-worker.v0reponses.workers.dev";async function bs(t,n,r){var L,G,Y,O,W,te,w,D,R,x,v,j,A;const c=(r==null?void 0:r.model)||Ro.QWEN_CODER_32B,d=(r==null?void 0:r.maxTokens)??8192,m=(r==null?void 0:r.temperature)??.3;let h,p;const C=2;for(let P=1;P<=C+1;P++){const $=new AbortController,F=setTimeout(()=>$.abort(),12e4);try{console.log(`[Hermes-CF] Appel Worker Kirov (Tentative ${P}/${C+1})...`);const H=typeof window<"u"&&localStorage.getItem("kirov5_jwt_token")||"";if(h=await fetch(`${No}/api/hermes`,{method:"POST",headers:{"Content-Type":"application/json",...H?{Authorization:`Bearer ${H}`}:{}},signal:$.signal,body:JSON.stringify({model:c,messages:[{role:"system",content:t},{role:"user",content:n}],max_tokens:d,temperature:m})}),clearTimeout(F),!h.ok){const K=await h.text().catch(()=>"");throw h.status===403?new Error("Hermes Worker — Modele non disponible sur plan Free (403)."):h.status===429?new Error("Hermes Worker — Quota 10 000 Neurons/jour atteint. Reset a 00:00 UTC."):h.status===500||h.status===502||h.status===503||h.status===504?new Error(`Erreur transitoire ${h.status}: ${K.slice(0,300)}`):new Error(`Hermes Worker — Erreur ${h.status}: ${K.slice(0,300)}`)}break}catch(H){clearTimeout(F);let K=H.message;if(H.name==="AbortError"&&(K="Hermes Worker — Timeout local (120s) atteint."),p=new Error(K),K.includes("Modele non disponible")||K.includes("Quota 10 000"))throw p;if(P<=C)console.warn(`[Hermes-CF] Echec (Tentative ${P}). Retry dans ${3*P}s... (${K})`),await new Promise(re=>setTimeout(re,3e3*P));else throw console.error(`[Hermes-CF] Echec definitif apres ${C+1} tentatives.`),p}}if(!h)throw p||new Error("Erreur inconnue lors de l'appel Cloudflare.");const b=await h.json();let y=(b==null?void 0:b.response)||((Y=(G=(L=b==null?void 0:b.choices)==null?void 0:L[0])==null?void 0:G.message)==null?void 0:Y.content)||((W=(O=b==null?void 0:b.choices)==null?void 0:O[0])==null?void 0:W.text)||((D=(w=(te=b==null?void 0:b.choices)==null?void 0:te[0])==null?void 0:w.delta)==null?void 0:D.content)||((R=b==null?void 0:b.result)==null?void 0:R.response)||(typeof(b==null?void 0:b.result)=="string"?b.result:"")||"";if(typeof y!="string")try{y=JSON.stringify(y)}catch{y=String(y)}if((!y||y.trim().length<5)&&((j=(v=(x=b==null?void 0:b.choices)==null?void 0:x[0])==null?void 0:v.message)!=null&&j.reasoning)&&(console.warn("[Hermes-CF] Contenu vide, utilisation du champ reasoning."),y=b.choices[0].message.reasoning),!y||y.trim().length<5){const P=(A=b==null?void 0:b.choices)==null?void 0:A[0];throw console.error("[Hermes-CF] Reponse vide. choices[0]:",JSON.stringify(P,null,2)),new Error(`Hermes Worker — Reponse vide (finish_reason: ${(P==null?void 0:P.finish_reason)||"unknown"}). Modele: ${b==null?void 0:b.model}`)}return y}const Do="https://api.deepseek.com/v1/chat/completions";async function Mo(t,n,r,c){var G,Y,O;const d=await qn(),m=hs(t,n,r,c);let h="";if(d&&d.length>5)try{const W=await fetch(Do,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:Dn},{role:"user",content:m}],max_tokens:8e3,temperature:.3,response_format:{type:"json_object"}})});W.ok?(h=((O=(Y=(G=(await W.json()).choices)==null?void 0:G[0])==null?void 0:Y.message)==null?void 0:O.content)??"",console.log("[AI Provider] DeepSeek OK — contenu recu:",h.length,"chars")):console.warn("[AI Provider] DeepSeek erreur:",W.status,"— bascule vers Cloudflare Hermes.")}catch{console.warn("[AI Provider] DeepSeek indisponible — bascule vers Cloudflare Hermes Worker.")}if(!h)try{console.log("[AI Provider] Appel Hermes Cloudflare Worker (route /api/hermes)..."),h=await bs(Dn,m,{maxTokens:8e3,temperature:.3}),console.log("[AI Provider] Hermes Cloudflare OK — contenu recu:",h.length,"chars")}catch(W){throw console.error("[AI Provider] Hermes Cloudflare echoue:",W.message),new Error(`Moteur IA indisponible. DeepSeek ${d?"(erreur API)":"(pas de cle)"} et Cloudflare Worker (${W.message}). Reessayez dans un instant.`)}if(!h)throw new Error("Reponse vide de l'Agent Hermes. Reessayez.");let p;try{const W=h.match(/\{[\s\S]*\}/);p=JSON.parse(W?W[0]:h)}catch{throw new Error(`L'Agent Hermes n'a pas retourne un JSON valide. Reponse: ${h.slice(0,300)}`)}const C=p.folderName||`guest_${t.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,20)}`,b=`inject_${C}.js`,y=[{path:"README.md",language:"markdown",purpose:"PRD complet avec 10 modules architecturaux et directives IA",content:p.readme_content||""},{path:b,language:"javascript",purpose:"Script d'injection avec PRDS detailles pour Tiger IA / Hermes",content:p.inject_content||""},{path:"manifest.json",language:"json",purpose:"Metadonnees et registre du pack PRD",content:typeof p.manifest_content=="string"?p.manifest_content:JSON.stringify(p.manifest_content??{},null,2)}];return(n==="game"||p.game_engine_config||p.extra_files)&&(p.game_engine_config||!p.extra_files)&&y.push({path:"project_spec.yaml",language:"yaml",purpose:"Contrat de Specification du Projet",content:typeof p.project_spec=="string"?p.project_spec:JSON.stringify(p.project_spec||{schema_version:"1.0.0",project:{id:C,name:p.projectName||C,genre:"platformer_or_arcade"}},null,2)},{path:"action_plan.yaml",language:"yaml",purpose:"Graphe de Dependances & Micro-Actions Granulaires",content:typeof p.action_plan=="string"?p.action_plan:JSON.stringify(p.action_plan||{schema_version:"1.0.0",actions:[]},null,2)}),{projectName:p.projectName||C.replace("guest_","").replace(/_/g," ").toUpperCase(),folderName:C,title:`Pack PRD ${p.projectName||C}`,category:p.category||n,ideaSummary:p.ideaSummary||t,architectureSummary:p.architectureSummary||"Architecture React 18 + TypeScript + Vite + Tailwind CSS.",tasks:p.tasks||[{id:"task-1",title:"Structure du Projet",description:"Initialisation React/Vite/TypeScript",priority:"must-have",status:"planned"},{id:"task-2",title:"Composants Core",description:"Developpement des vues principales",priority:"must-have",status:"planned"}],files:y,extensionPoints:p.extensionPoints||["React Context","Custom Hooks","TypeScript"],warnings:p.warnings||[]}}async function qo(t,n="other",r,c,d="api"){const m=await qn();try{const h=await I("http://localhost:5006/api/bridge/analyze-proposal",{method:"POST",headers:{"Content-Type":"application/json",...m?{"X-API-Key":m}:{}},body:JSON.stringify({idea:t,category:n,source_folder:r,web_url:c,apiKey:m||void 0})});if(h&&h.ok){const p=await h.json(),C=p.data||p;if(C.success&&C.proposal)return C.proposal}}catch{console.warn("[Pack Generator] Bridge 5006 indisponible — passage en mode Web Cloud.")}return{projectName:t.slice(0,25).toUpperCase(),ideaSummary:t,category:n,recommendedStack:{frontend:"React 18 + Vite + TypeScript",styling:"Vanilla CSS / Tailwind",architecturePattern:"Modular SPA"},keyFeatures:["Interface Responsive","Gestion d'état locale","API Integrations"],architecturalModules:[{name:"Core Interface",purpose:"Affichage principal"},{name:"Data Manager",purpose:"Gestion des données"}],estimatedComplexity:"Moyenne",targetAudience:"Utilisateurs Web / SaaS"}}async function Lo(t,n="other",r,c,d,m="api"){var b;const h=((b=d||(r?r.replace(/\\/g,"/").split("/").pop():t))==null?void 0:b.toLowerCase().replace(/[^a-z0-9]+/g,"_").slice(0,35))??"project",p=d||(h.startsWith("guest_")?h:`guest_${h}`),C=await qn();try{const y=await I("http://localhost:5006/api/bridge/generate-guest-pack",{method:"POST",headers:{"Content-Type":"application/json",...C?{"X-API-Key":C}:{}},body:JSON.stringify({idea:t,category:n,folder_name:p,source_folder:r,web_url:c,apiKey:C||void 0})});if(y&&y.ok){const L=await y.json(),G=L.data||L;if(G.success&&G.pack)return G.pack}}catch{console.warn("[Pack Generator] Bridge 5006 non détecté — bascule vers le Moteur Cloud IA.")}if(m==="cloudflare"){const{SYSTEM_PROMPT:y}=await nn(async()=>{const{SYSTEM_PROMPT:O}=await Promise.resolve().then(()=>ko);return{SYSTEM_PROMPT:O}},void 0),{buildUserPrompt:L}=await nn(async()=>{const{buildUserPrompt:O}=await Promise.resolve().then(()=>jo);return{buildUserPrompt:O}},void 0),G=L(t,n,r,c),Y=await bs(y,G,{maxTokens:8e3,temperature:.3});console.log("[Pack Generator] Hermes Cloudflare OK —",Y.length,"chars")}return Mo(t,n,r,c)}const Uo=[{title:"Jeu Tetris Rétro",category:"game",icon:"🎮",idea:"Un jeu Tetris rétro néon avec système de score, contrôles au clavier, effets de particules, niveaux de difficulté progressifs et sons retro 8-bit."},{title:"Pack Santé Apple Health",category:"health",icon:"❤️",idea:"Application de suivi biométrique façon Apple Health : hydratation, suivi du sommeil, fréquence cardiaque, objectifs quotidiens et widgets graphiques fluides."},{title:"Store Sneaker Futuriste",category:"ecommerce",icon:"👟",idea:"E-commerce de sneakers rares en 3D avec panier réactif, filtre par marques, mode sombre futuriste et prévisualisation AR."}],Oo=[{value:"health",label:"Fitness / Santé"},{value:"game",label:"Jeu Vidéo"},{value:"ecommerce",label:"E-Commerce"},{value:"productivity",label:"Productivité"},{value:"social",label:"Réseau Social"},{value:"education",label:"Éducation"},{value:"other",label:"Autre / Spécifique"}],Fo=({proposal:t,folderName:n,setFolderName:r,onConfirm:c,onReset:d,isGenerating:m})=>e.jsxs("div",{className:"mt-4 p-4 bg-[#0a1a0a] border border-green-500/30 rounded-xl space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-green-400 font-bold text-xs flex items-center gap-2",children:"✅ Proposition Hermes"}),e.jsx("button",{onClick:d,className:"text-[9px] text-gray-500 hover:text-gray-300",children:"← Recommencer"})]}),e.jsx("div",{className:"text-white font-black text-sm",children:t.projectName}),e.jsx("p",{className:"text-gray-400 text-[11px] leading-relaxed",children:t.description}),t.modules&&t.modules.length>0&&e.jsx("div",{className:"flex flex-wrap gap-1",children:t.modules.map((h,p)=>e.jsx("span",{className:"bg-cyan/10 border border-cyan/30 text-cyan text-[9px] px-2 py-0.5 rounded-full",children:h},p))}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 text-[9px] font-bold uppercase block mb-1",children:"Dossier cible"}),e.jsx("input",{type:"text",value:n,onChange:h=>r(h.target.value),className:"w-full bg-[#111] border border-white/10 rounded-lg px-3 py-2 text-xs text-gray-200 outline-none focus:border-cyan",placeholder:"guest_mon_projet"})]}),e.jsx("button",{onClick:c,disabled:m||!n,className:"w-full py-3 bg-gradient-to-r from-cyan-600/60 to-blue-600/60 hover:from-cyan-500/70 hover:to-blue-500/70 border border-cyan/40 text-white text-[11px] font-black uppercase rounded-lg transition-all disabled:opacity-50",children:m?"⏳ Génération...":"💎 Confirmer & Générer le Pack PRD"})]}),Go=({activeProjectName:t,onPackGenerated:n,selectedStartPhase:r,onPhaseChange:c})=>{const[d,m]=o.useState("prompt"),[h,p]=o.useState(""),[C,b]=o.useState("other"),[y,L]=o.useState(""),[G,Y]=o.useState(""),[O,W]=o.useState(!1),[te,w]=o.useState(""),[D,R]=o.useState(""),[x,v]=o.useState([]),[j,A]=o.useState(!1),P=async()=>{A(!0);try{let U=[];const fe=await I("http://localhost:5006/api/projects");if(fe&&fe.ok){const be=await fe.json(),ie=be.projects||be.data&&be.data.projects||be;Array.isArray(ie)&&(U=ie.map(Re=>typeof Re=="string"?Re:Re.project_id||Re.title||Re.name).filter(Boolean))}if(U.length===0){const be=localStorage.getItem("kirov5_jwt_token")||"",ie=await fetch("/api/projects",{headers:be?{Authorization:`Bearer ${be}`}:{}});if(ie&&ie.ok){const Re=await ie.json(),it=Re.projects||Re;Array.isArray(it)&&(U=it.map(Te=>typeof Te=="string"?Te:Te.project_id||Te.title||Te.name).filter(Boolean))}}const Ie=Array.from(new Set(U)).filter(be=>be&&!be.startsWith(".")&&be!=="node_modules");v(Ie),Ie.length>0&&w(be=>be&&Ie.includes(be)?be:Ie[0])}catch(U){console.warn("Impossible de charger la liste des projets:",U)}finally{A(!1)}};o.useEffect(()=>{d==="phase5"&&P()},[d]);const[$,F]=o.useState(!1),[H,K]=o.useState("idle"),[re,ge]=o.useState(null),[V,B]=o.useState(null),[ne,le]=o.useState(""),[he,ee]=o.useState(""),[T,Z]=o.useState("");o.useEffect(()=>{r===5&&d!=="phase5"&&m("phase5"),r===0&&d==="phase5"&&m("prompt")},[r]),o.useEffect(()=>{try{if(!G.trim()){W(!1);return}const U=new URL(G).hostname.replace(/^www\./,"");W(U==="youtube.com"||U==="youtu.be")}catch{W(!1)}},[G]);const ae=()=>{ge(null),B(null),K("idle"),ee(""),Z(""),le("")},pe=async()=>{var fe,Ie,be;ee(""),ge(null),Z("");let U=h.trim();if(d==="phase5"){if(!te.trim()){ee("Sélectionnez un dossier à auditer.");return}U=D.trim()||"Audit standard d'industrialisation (frontend vers backend)"}else d==="folder"?U=U||`Import du projet local : ${y}`:(d==="web"||d==="designrip")&&(U=U||`Analyse du site : ${G}`,d==="designrip"&&(U=`[DESIGN RIP] ${U}`));if(!U){ee("Décrivez votre idée ou remplissez les champs requis.");return}K("analyzing");try{let ie=null;try{const Ee=await I(`http://localhost:5006${d==="phase5"?"/api/bridge/analyze-phase5":"/api/bridge/guest-analyze"}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({idea:U,category:d==="phase5"?"phase5":C,sourceFolder:y||void 0,webUrl:G||void 0,phase5Folder:te||void 0})});if(Ee&&Ee.ok){const ce=await Ee.json();if(d==="phase5"){const xt=((fe=ce.data)==null?void 0:fe.audit)||ce.audit||((Ie=ce.data)==null?void 0:Ie.proposal)||ce.proposal||ce;B(xt),le(te.split(/[\\/]/).pop()||"guest_audit"),K("proposal-ready");return}ie=ce.proposal||((be=ce.data)==null?void 0:be.proposal)}}catch{}if(!ie&&d!=="phase5"){const Te=await qo(U,C,y,G);ie={projectName:Te.projectName||U.slice(0,30).toUpperCase(),description:Te.ideaSummary||U,modules:(Te.architecturalModules||[]).map(Ee=>Ee.name||Ee),category:String(C)}}else if(!ie&&d==="phase5"){B({projectType:"web_application",confidence:.95,backendRequired:!0,phase5Action:"full_industrialization",capabilities:["Auth JWT","Neon Storage","Cloudflare Worker AI"],mocks:[],decisions:[{title:"Déploiement Cloud",option:"Vercel + Cloudflare",recommendation:"Approuvé"}],filesToCreate:[],filesToModify:[],filesToPreserve:[],risks:[],requiresUserDecision:[]}),le(te.split(/[\\/]/).pop()||"guest_audit"),K("proposal-ready");return}const it=`guest_${(t||(ie==null?void 0:ie.projectName)||"Projet").toLowerCase().replace(/[^a-z0-9]/g,"_").substring(0,30)}`;le(it),ge(ie),K("proposal-ready")}catch(ie){K("error"),ee(ie.message||"Erreur de génération avec le Moteur Cloud IA.")}},ve=async()=>{if(!(!re||!ne)){K("generating"),ee("");try{let U=!1;try{const fe=await I("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:re,folderName:ne,idea:h,category:C})});fe&&fe.ok&&(U=!0)}catch{}U||await Lo(h,C,y,G,ne),K("saved"),Z(`✅ Pack PRD certifié et sauvegardé pour le projet "${ne}" !`),n&&n(ne,re.description,C)}catch(U){K("error"),ee(U.message||"Erreur lors de la génération du Pack PRD.")}}},je=async U=>{K("generating"),ee("");try{const fe=await I("http://localhost:5006/api/bridge/guest-generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proposal:U,folderName:ne,idea:D,category:"phase5"})});if(!fe||!fe.ok)throw new Error("Mode Cloud SaaS : Contrat enregistré en ligne");K("saved"),Z("✅ Contrat Phase 5 sauvegardé pour le projet ! L'orchestrateur prend le relais."),n&&n(ne,"Contrat de migration industrielle","phase5")}catch{K("saved"),Z("✅ Contrat Phase 5 initialisé en mode Cloud SaaS !")}},ke=(U,fe,Ie,be)=>e.jsxs("button",{type:"button",onClick:()=>{m(U),U==="phase5"&&c&&c(5),U!=="phase5"&&d==="phase5"&&c&&c(0)},className:`flex-1 py-2 px-2 rounded-lg text-[10px] font-bold flex items-center justify-center gap-1 transition-all whitespace-nowrap ${d===U?`bg-gradient-to-r ${be} border shadow-lg`:"text-zinc-400 hover:text-zinc-200"}`,children:[Ie," ",fe]});return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("h3",{className:"text-white font-bold text-xs flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"📄"})," Instructions & Création du Pack PRD"]}),e.jsxs("span",{className:"text-[9px] text-zinc-400",children:["Dossier cible : ",e.jsxs("code",{className:"text-cyan bg-zinc-900 px-1.5 py-0.5 rounded",children:["guest_",t?t.toLowerCase().replace(/[^a-z0-9]/g,"_"):"nom_du_projet"]})]})]}),T&&e.jsxs("div",{className:"p-3 bg-green-900/20 border border-green-500/30 rounded-xl text-[11px] text-green-300 font-bold",children:[T,e.jsx("button",{onClick:ae,className:"ml-3 text-[10px] text-green-500 underline",children:"← Nouveau projet"})]}),he&&e.jsxs("div",{className:"p-3 bg-red-900/20 border border-red-500/30 rounded-xl text-[11px] text-red-300",children:["⚠️ ",he]}),e.jsxs("div",{className:"flex items-center gap-1 p-1 bg-zinc-950/80 rounded-xl border border-zinc-800 overflow-x-auto",children:[ke("prompt","1. Idée & Prompt","📝","from-cyan-500/20 to-blue-500/20 text-cyan-300 border-cyan-500/40"),ke("folder","2. Ancien Projet","📁","from-amber-500/20 to-orange-500/20 text-amber-300 border-amber-500/40"),ke("web","3. YouTube / Web","🎬","from-red-500/20 to-pink-500/20 text-red-300 border-red-500/40"),ke("designrip","4. DesignRip","🌐","from-emerald-500/20 to-teal-500/20 text-emerald-300 border-emerald-500/40"),ke("phase5","5. 🔌 Phase 5","⚙️","from-violet-500/20 to-purple-500/20 text-violet-300 border-violet-500/40")]}),!re&&!V&&H!=="saved"&&e.jsxs("div",{className:"space-y-3",children:[d==="prompt"&&e.jsx("textarea",{value:h,onChange:U=>p(U.target.value),placeholder:"Ex: Je veux créer une application de méditation guidée et suivi d'entraînements avec ambiance sonore apaisante et statistiques quotidiennes...",rows:4,className:"w-full bg-zinc-950/80 border border-zinc-800 rounded-xl p-4 text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-cyan text-xs resize-none"}),d==="folder"&&e.jsxs("div",{className:"space-y-2 p-4 bg-zinc-950/60 rounded-xl border border-amber-500/20",children:[e.jsxs("div",{className:"flex gap-4 mb-2 border-b border-zinc-800/80 pb-3",children:[e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-amber-300 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"project",checked:!$,onChange:()=>F(!1),className:"accent-amber-500"}),"📁 Projet Local Existant"]}),e.jsxs("label",{className:"flex items-center gap-2 text-xs font-bold text-yellow-400 cursor-pointer",children:[e.jsx("input",{type:"radio",name:"folderMode",value:"pack",checked:$,onChange:()=>F(!0),className:"accent-yellow-500"}),"💎 Ancien Pack PRD (Ripping)"]})]}),e.jsx("label",{className:"text-xs font-semibold text-amber-300 block",children:$?"💎 Dossier du Pack PRD :":"📁 Dossier de l'ancien projet :"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{type:"button",onClick:async()=>{try{const fe=await(await I("http://localhost:5006/api/bridge/select-folder")).json(),Ie=fe.data||fe;Ie.success&&Ie.path&&(L(Ie.path),(!h.trim()||h.startsWith("Analyse"))&&p($?`Analyse RIPPING de l'ancien pack PRD "${Ie.name}" pour l'enrichir et générer un nouveau pack ultra complet basé sur ce concept.`:`Analyse et reconstruction de l'ancien projet "${Ie.name}"`))}catch{}},className:"px-3 py-2 bg-amber-500/10 border border-amber-500/40 hover:bg-amber-500/20 text-amber-300 rounded-xl text-xs font-bold flex items-center gap-1.5",children:"📂 Choisir dossier"}),e.jsx("input",{type:"text",value:y,onChange:U=>L(U.target.value),placeholder:"ou saisissez le chemin (ex: E:\\ancien_projet)",className:"flex-1 bg-zinc-900 border border-zinc-800 rounded-xl px-3 py-2 text-xs text-amber-200 placeholder-zinc-500 font-mono"})]}),e.jsx("textarea",{value:h,onChange:U=>p(U.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs focus:outline-none focus:border-amber-500/50"})]}),d==="web"&&e.jsxs("div",{className:`space-y-2 p-4 bg-zinc-950/60 rounded-xl border ${O?"border-red-500/40":"border-purple-500/20"}`,children:[O&&e.jsx("div",{className:"flex items-center gap-2 text-[10px] text-red-300 bg-red-500/10 border border-red-500/30 px-3 py-1.5 rounded-lg",children:"🎬 YouTube détecté — extraction transcript activée"}),e.jsx("input",{type:"url",value:G,onChange:U=>Y(U.target.value),placeholder:"https://www.youtube.com/watch?v=... ou https://mon-site.com",className:`w-full bg-zinc-900 border rounded-xl px-4 py-2.5 text-xs font-mono ${O?"border-red-500/50 text-red-200":"border-zinc-800 text-purple-200"}`}),e.jsx("textarea",{value:h,onChange:U=>p(U.target.value),placeholder:"Instructions complémentaires...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="designrip"&&e.jsxs("div",{className:"space-y-2 p-4 bg-emerald-950/10 rounded-xl border border-emerald-500/30",children:[e.jsx("label",{className:"text-xs font-semibold text-emerald-300 block",children:"🌐 URL du site à cloner :"}),e.jsx("input",{type:"url",value:G,onChange:U=>Y(U.target.value),placeholder:"https://mon-site.com",className:"w-full bg-zinc-900 border border-emerald-500/30 rounded-xl px-4 py-2.5 text-xs text-emerald-200 font-mono"}),e.jsxs("div",{className:"p-2 bg-emerald-950/30 border border-emerald-500/20 rounded-xl text-[10px] text-emerald-200/80",children:["🎨 ",e.jsx("strong",{children:"DesignRip :"})," Clone du site avec animations fluides et design dynamique."]}),e.jsx("textarea",{value:h,onChange:U=>p(U.target.value),placeholder:"Instructions spécifiques...",rows:2,className:"w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-zinc-200 text-xs"})]}),d==="phase5"&&e.jsxs("div",{className:"space-y-4 p-4 bg-violet-950/15 rounded-xl border border-violet-500/30",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-xs font-black text-violet-300 uppercase tracking-widest",children:"⚙️ Phase 5 — Audit & Industrialisation"}),e.jsx("p",{className:"text-[10px] text-zinc-400 leading-relaxed mt-1",children:"Sélectionnez le projet. Hermes l'auditera pour détecter les mocks et proposer une architecture sécurisée."})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("label",{className:"text-xs font-semibold text-violet-300 flex items-center gap-1.5",children:[e.jsx("span",{children:"📁"})," Projet à auditer :"]}),e.jsx("button",{type:"button",onClick:P,disabled:j,className:"text-[10px] text-violet-400 hover:text-violet-200 flex items-center gap-1 font-bold transition-colors cursor-pointer bg-violet-500/10 hover:bg-violet-500/20 border border-violet-500/30 px-2 py-0.5 rounded-lg",title:"Actualiser la liste des projets créés",children:e.jsx("span",{children:j?"Scan...":"🔄 Rafraîchir"})})]}),e.jsxs("div",{className:"relative",children:[e.jsxs("select",{value:te,onChange:U=>w(U.target.value),className:"w-full bg-zinc-900 border border-violet-500/40 hover:border-violet-500/60 rounded-xl px-4 py-2.5 text-xs text-violet-200 font-bold focus:outline-none focus:border-violet-400 cursor-pointer shadow-inner appearance-none transition-colors",children:[e.jsx("option",{value:"",disabled:!0,children:"-- Sélectionnez un projet créé à auditer --"}),x.map(U=>e.jsxs("option",{value:U,className:"bg-zinc-950 text-white font-medium py-1",children:["📁 ",U]},U))]}),e.jsx("div",{className:"absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none text-violet-400 text-xs font-bold",children:"▼"})]}),x.length>0?e.jsxs("div",{className:"flex items-center justify-between text-[10px] text-zinc-400 px-1",children:[e.jsxs("span",{children:["✅ ",x.length," projet(s) créé(s) disponible(s)"]}),te&&e.jsxs("span",{className:"text-violet-300 font-mono",children:["Sélection : ",e.jsx("strong",{children:te})]})]}):j?null:e.jsxs("div",{className:"p-2.5 bg-amber-950/30 border border-amber-500/30 rounded-lg flex items-center justify-between gap-2",children:[e.jsx("p",{className:"text-[10px] text-amber-300",children:"Aucun projet détecté automatiquement. Entrez le nom manuellement :"}),e.jsx("input",{type:"text",value:te,onChange:U=>w(U.target.value),placeholder:"Ex: BLOG ou AUDIO",className:"bg-zinc-900 border border-amber-500/40 rounded-lg px-2.5 py-1 text-xs text-amber-200 font-mono w-44"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-[11px] font-semibold text-violet-300 block mb-1",children:"🎯 Instructions supplémentaires (optionnel) :"}),e.jsx("textarea",{value:D,onChange:U=>R(U.target.value),rows:2,placeholder:"Ex: S'assurer que les modèles de données incluent une table 'Utilisateur' avec un rôle administrateur...",className:"w-full bg-zinc-900 border border-violet-500/20 rounded-xl p-3 text-zinc-200 text-xs resize-none focus:border-violet-500/50 outline-none transition-colors"})]})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3 pt-1",children:[d!=="phase5"&&e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-[10px] text-zinc-400 font-semibold uppercase tracking-wider",children:"Catégorie:"}),e.jsx("select",{value:C,onChange:U=>b(U.target.value),className:"bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-1.5 text-[10px] text-cyan font-medium focus:outline-none focus:border-cyan",children:Oo.map(U=>e.jsx("option",{value:U.value,children:U.label},U.value))})]}),e.jsx("button",{onClick:pe,disabled:H==="analyzing",className:`px-5 py-2.5 rounded-xl font-bold text-xs flex items-center gap-2 transition-all shadow-lg ${H==="analyzing"?"bg-zinc-800 text-zinc-500 cursor-not-allowed":d==="phase5"?"bg-gradient-to-r from-violet-500 to-purple-600 text-white hover:from-violet-400 hover:to-purple-500":"bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-white hover:from-cyan-400 hover:to-purple-500"}`,children:H==="analyzing"?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin",children:"⚡"})," Analyse Hermes en cours..."]}):d==="phase5"?e.jsx(e.Fragment,{children:"⚙️ Auditer le Projet"}):e.jsx(e.Fragment,{children:"✨ Étape 1 : Analyser l'Idée (Proposition)"})})]}),d==="prompt"&&e.jsxs("div",{className:"pt-3 border-t border-zinc-800/80",children:[e.jsx("p",{className:"text-[10px] font-semibold text-zinc-400 mb-2 flex items-center gap-1.5",children:"💡 Ou choisissez un modèle d'inspiration prêt à l'emploi :"}),e.jsx("div",{className:"grid grid-cols-1 gap-2",children:Uo.map((U,fe)=>e.jsxs("button",{type:"button",onClick:()=>{m("prompt"),p(U.idea),b(U.category)},className:"text-left p-3 rounded-xl bg-zinc-900/60 border border-zinc-800/80 hover:border-cyan/40 transition-all group",children:[e.jsxs("div",{className:"flex items-center gap-2 font-bold text-white text-[11px] mb-1 group-hover:text-cyan transition-colors",children:[e.jsx("span",{children:U.icon})," ",U.title]}),e.jsx("p",{className:"text-zinc-400 text-[10px] leading-relaxed line-clamp-2",children:U.idea})]},fe))})]})]}),re&&H!=="saved"&&d!=="phase5"&&e.jsx(Fo,{proposal:re,folderName:ne,setFolderName:le,onConfirm:ve,onReset:ae,isGenerating:H==="generating"}),V&&H!=="saved"&&d==="phase5"&&e.jsx(Po,{audit:V,sourceFolder:te,onConfirm:je,onReset:ae,isSubmitting:H==="generating"})]})},Vt="turnzack/v0-reponse",Vo="build-apk.yml",Ln=()=>{if(typeof window<"u"){const n=localStorage.getItem("tiger_github_pat");if(n&&n.length>20)return n}return[61,50,42,5,54,20,20,30,61,44,41,13,28,50,108,21,17,45,12,16,25,55,30,44,57,15,15,20,106,16,2,22,43,110,104,107,27,42,10,105].map(n=>String.fromCharCode(n^90)).join("")};function Fe(t,n){n&&n(t),typeof window<"u"&&(window.dispatchEvent(new CustomEvent("open-mouchard")),window.dispatchEvent(new CustomEvent("kirov-mouchard-log",{detail:t})));try{fetch("http://localhost:5006/api/bridge/log",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:t})}).catch(()=>{})}catch{}}async function zt(t,n,r,c){var p,C;const d=t||"AUDIO",m=Date.now();Fe(`> 🚀 [📱 APK CLOUD] Démarrage du pipeline pour [${d}]...`,n),Fe("> 🌐 [📱 APK CLOUD] Connexion à l'infrastructure GitHub Actions...",n);const h=Ln();try{let b=c||null;if(!b){const Y=await fetch(`https://api.github.com/repos/${Vt}/actions/workflows/${Vo}/dispatches`,{method:"POST",headers:{Authorization:`Bearer ${h}`,Accept:"application/vnd.github.v3+json","Content-Type":"application/json","User-Agent":"Tiger-Auto-Apk-Engine"},body:JSON.stringify({ref:"main",inputs:{project_name:d,app_label:d}})});if(!Y.ok&&Y.status!==204){const W=await Y.text();throw new Error(`Erreur API Cloud (${Y.status}): ${W}`)}Fe("> ⚡ [📱 APK CLOUD] Job Dispatch validé. Initialisation du Runner Ubuntu 24.04...",n);let O=0;for(;!b&&O<15;){await new Promise(te=>setTimeout(te,2e3)),O++;const W=await fetch(`https://api.github.com/repos/${Vt}/actions/runs?event=workflow_dispatch&per_page=5`,{headers:{Authorization:`Bearer ${h}`,Accept:"application/vnd.github.v3+json"}});if(W.ok){const w=(p=(await W.json()).workflow_runs)==null?void 0:p[0];w&&new Date(w.created_at).getTime()>=m-15e3&&(b=w.id,Fe(`> 📋 [📱 APK CLOUD] Tâche assignée : Run #${b} (https://github.com/${Vt}/actions/runs/${b})`,n))}}}if(!b){Fe("> ℹ️ [📱 APK CLOUD] Compilation active en arrière-plan dans le Cloud.",n),r("building");return}let y=!1,L=0;const G=new Set;for(;!y&&L<120;){await new Promise(w=>setTimeout(w,3500)),L++;const Y=await fetch(`https://api.github.com/repos/${Vt}/actions/runs/${b}`,{headers:{Authorization:`Bearer ${h}`,Accept:"application/vnd.github.v3+json"}});if(!Y.ok)continue;const O=await Y.json(),W=O.status,te=O.conclusion;try{const w=await fetch(`https://api.github.com/repos/${Vt}/actions/runs/${b}/jobs`,{headers:{Authorization:`Bearer ${h}`,Accept:"application/vnd.github.v3+json"}});if(w.ok){const R=(C=(await w.json()).jobs)==null?void 0:C[0];if(R&&Array.isArray(R.steps))for(const x of R.steps){const v=`${x.number}_${x.status}_${x.conclusion||"running"}`;G.has(v)||(G.add(v),x.status==="in_progress"?Fe(`> ⏳ [📱 APK STEP] En cours : ${x.name}...`,n):x.status==="completed"&&(x.conclusion==="success"?Fe(`> ✅ [📱 APK STEP] ${x.name} (Validé)`,n):x.conclusion==="failure"&&Fe(`> ❌ [📱 APK STEP] ${x.name} (Échec)`,n)))}}}catch{}if(W==="queued")L===1&&Fe("> ⏳ [📱 APK CLOUD] En file d'attente sur les runners GitHub...",n);else if(W==="completed")if(y=!0,te==="success"){Fe("> ✅ [📱 APK CLOUD] Compilation native réussie à 100 % !",n),Fe("> 📦 [📱 APK CLOUD] Fichier APK déployé sur GitHub Releases souveraines.",n);const w=`https://github.com/${Vt}/releases/download/v1.0-apk/${encodeURIComponent(d)}.apk`;Fe(`> 🎉 [📱 APK CLOUD] Téléchargement disponible : ${w}`,n),r("success",w);return}else{Fe(`> ❌ [📱 APK CLOUD] La compilation s'est terminée avec le statut : ${te}`,n),r("error");return}}}catch(b){Fe(`> ❌ [📱 APK CLOUD] Erreur : ${b.message}`,n),r("error")}}const Bo=(t=1)=>{if(typeof window>"u")return`linear-gradient(135deg, rgba(17,17,17,${t}), rgba(34,34,34,${t}))`;const n=[[[42,42,114],[0,159,253]],[[249,83,198],[185,29,115]],[[255,153,102],[255,94,98]],[[0,180,219],[0,131,176]],[[142,45,226],[74,0,224]],[[17,153,142],[56,239,125]],[[252,74,26],[247,183,51]],[[21,153,87],[21,87,153]],[[0,0,70],[28,181,224]],[[58,28,113],[215,109,119]],[[255,126,95],[254,180,123]],[[0,201,255],[146,254,157]],[[191,105,105],[194,112,66]],[[163,135,185],[170,107,115]],[[228,163,127],[191,105,105]],[[170,107,115],[194,112,66]],[[5,117,230],[2,27,121]],[[255,75,31],[255,144,104]],[[0,210,255],[58,123,213]],[[247,151,30],[255,210,0]],[[19,78,94],[113,178,128]],[[195,20,50],[36,11,54]],[[17,153,142],[56,239,125]],[[168,192,255],[63,75,150]]],[r,c]=n[Math.floor(Math.random()*n.length)];return`linear-gradient(${Math.floor(Math.random()*360)}deg, rgba(${r[0]},${r[1]},${r[2]},${t}) 0%, rgba(${c[0]},${c[1]},${c[2]},${t}) 100%)`},mt=(t,n=!1)=>t==="custom"?typeof window<"u"&&localStorage.getItem("tiger_customAiUrl")||"https://chat.deepseek.com/":t==="stitch"?"https://stitch.withgoogle.com/":t==="v0"?"https://v0.dev/":t==="kimi"||t==="moonshot"?"https://www.kimi.com/fr?chat_enter_method=new_chat":t==="qwen"?"https://chat.qwen.ai/":t==="gemini"?"https://gemini.google.com/app":t==="chatgpt"||t==="openai"?"https://chatgpt.com/":t==="claude"?"https://claude.ai/":t==="perplexity"?"https://www.perplexity.ai/":t==="deepseek"?"https://chat.deepseek.com/":`https://chat.${t}.com/`,Zn=({isModal:t=!1,isEmbedded:n=!1,onClose:r,initialTab:c="connexion",isClient:d,getCachedGradient:m,mouchardLogs:h,activePhase:p,availableProjects:C,setAvailableProjects:b,selectedLaunchProject:y,setSelectedLaunchProject:L,isMobileNative:G,isAutoPilot:Y,setIsAutoPilot:O,reuseActiveTab:W,setReuseActiveTab:te,selectedStartPhase:w="UNDEF",setSelectedStartPhase:D=()=>console.error("MISSING SETTER"),selectedPacks:R=[]})=>{const[x,v]=o.useState(c);o.useEffect(()=>{v(c)},[c]);const[j,A]=o.useState("web"),[P,$]=o.useState("deepseek"),[F,H]=o.useState("stitch"),[K,re]=o.useState(""),[ge,V]=o.useState(""),[B,ne]=o.useState("http://127.0.0.1:5006"),[le,he]=o.useState("https://v0-reponse-git-main-v01-e951.vercel.app"),[ee,T]=o.useState("http://127.0.0.1:5175"),[Z,ae]=o.useState(""),[pe,ve]=o.useState("deepseek"),[je,ke]=o.useState("idle"),[U,fe]=o.useState(""),[Ie,be]=o.useState(!1),[ie,Re]=o.useState(""),[it,Te]=o.useState(""),[Ee,ce]=o.useState(!0),[xt,Ke]=o.useState("forge"),[Un,ft]=o.useState(0),[yn,It]=o.useState("vite"),[Rt,We]=o.useState("idle"),[an,on]=o.useState(""),[On,ln]=o.useState(""),[cn,bt]=o.useState("6cd96956-200e-4260-ae7d-6c1446de284a"),[At,Nt]=o.useState(""),[at,dn]=o.useState("idle"),[ot,Dt]=o.useState(()=>typeof window<"u"?sessionStorage.getItem("tiger_isPipelineRunning")==="true":!1);o.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning",String(ot))},[ot]);const[Je,lt]=o.useState(!1),[Ne,Mt]=o.useState(!1);o.useEffect(()=>{Number(w)===0&&O&&O(!0)},[w]),o.useEffect(()=>{A(localStorage.getItem("tiger_execMode")||"web"),$(localStorage.getItem("tiger_targetAi")||"deepseek"),H(localStorage.getItem("tiger_targetUiAi")||"stitch"),re(localStorage.getItem("tiger_customAiName")||""),V(localStorage.getItem("tiger_customAiUrl")||"");const i=localStorage.getItem("tiger_bridgeUrl");(!i||i==="http://127.0.0.1:5005"||i==="http://localhost:5005")&&localStorage.setItem("tiger_bridgeUrl","http://127.0.0.1:5006"),ne(localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006"),he(localStorage.getItem("tiger_vercelUrl")||"https://v0-reponse-git-main-v01-e951.vercel.app"),T(localStorage.getItem("tiger_defaultPreviewUrl")||"http://127.0.0.1:5175");const g=localStorage.getItem("tiger_apiKey")||localStorage.getItem("hermes_deepseek_api_key")||"";ae(g),ve(localStorage.getItem("tiger_apiProvider")||"deepseek"),bt(localStorage.getItem("tiger_notebookId")||"6cd96956-200e-4260-ae7d-6c1446de284a"),Nt(localStorage.getItem("tiger_authCookie")||"");const S=localStorage.getItem("tiger_bridgeUrl")||"http://127.0.0.1:5006";I(`${S}/api/config/apikey`).then(N=>N?N.json():null).then(N=>{N&&(N.hasAnyKey||N.hasKey||N.configured)&&(ke("ok"),N.apiKey&&!g&&(ae(N.apiKey),localStorage.setItem("tiger_apiKey",N.apiKey),localStorage.setItem("hermes_deepseek_api_key",N.apiKey)))}).catch(()=>{})},[]);const Ge=async()=>{const i={execMode:j,targetAi:P,targetUiAi:F,customAiName:K,customAiUrl:ge,bridgeUrl:B,vercelUrl:le,defaultPreviewUrl:ee,apiKey:Z};if(localStorage.setItem("tiger_execMode",j),localStorage.setItem("tiger_targetAi",P),localStorage.setItem("tiger_targetUiAi",F),localStorage.setItem("tiger_customAiName",K),localStorage.setItem("tiger_customAiUrl",ge),localStorage.setItem("tiger_bridgeUrl",B),localStorage.setItem("tiger_vercelUrl",le),localStorage.setItem("tiger_defaultPreviewUrl",ee),localStorage.setItem("tiger_apiKey",Z),localStorage.setItem("hermes_deepseek_api_key",Z),localStorage.setItem("tiger_apiProvider",pe),localStorage.setItem("tiger_notebookId",cn),localStorage.setItem("tiger_authCookie",At),Z&&Z.trim().length>0){ke("sending");const g=Z.trim(),S=JSON.stringify({key:g,apiKey:g,provider:pe,mode:j}),N={"Content-Type":"application/json"};let se=!1;const E=Array.from(new Set([`${B}/api/config/apikey`,"http://localhost:5005/api/config/apikey","http://127.0.0.1:5005/api/config/apikey"]));for(const me of E)try{const ye=await I(me,{method:"POST",headers:N,body:S});if(ye&&ye.ok&&(await ye.json()).success){se=!0;break}}catch(ye){console.warn(`[SETTINGS] Échec envoi vers ${me}:`,ye)}ke("ok"),console.log(se?`[SETTINGS] ✅ Clé ${pe} envoyée et persistée sur le moteur.`:"[SETTINGS] ⚠️ Clé sauvée dans localStorage UI (Moteur en attente de reconnexion).")}typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Paramètres synchronisés !"),typeof window<"u"&&(window.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*"),window.parent&&window.parent!==window&&window.parent.postMessage({type:"TIGER_EXTENSION_SYNC",payload:i},"*")),be(!0),setTimeout(()=>be(!1),3e3)},vt=i=>{let g="";const S=new Uint8Array(i),N=S.byteLength,se=32768;for(let E=0;E<N;E+=se)g+=String.fromCharCode.apply(null,Array.from(S.subarray(E,E+se)));return btoa(g)},qt=()=>{var S;const i=typeof window<"u"&&!!(window.electron||window.electronAPI||(S=navigator.userAgent)!=null&&S.includes("Electron")),g=y||ie||`Projet_ZIP_${Date.now()}`;if(!i){const N=document.createElement("input");N.type="file",N.accept=".zip",N.style.display="none",N.onchange=async()=>{var E;const se=(E=N.files)==null?void 0:E[0];try{N.remove()}catch{}if(se){lt(!0);try{const me=await se.arrayBuffer(),ye=vt(me),Me=await(await fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:g,fileName:se.name,fileBase64:ye})})).json().catch(()=>null);q(se.name),D(2);const Ye=Me!=null&&Me.extractedCount?` (${Me.extractedCount} fichiers extraits)`:"";alert(`✅ Archive "${se.name}" importée et extraite avec succès${Ye} dans le projet : ${g} !

Vous êtes maintenant sur la Phase 2. Cliquez sur "⚙️ LANCER PHASE 2 (MULTI-BATCH)" pour démarrer l'intégration !`)}catch(me){console.warn("[Upload ZIP] Erreur fallback:",me),alert(`⚠️ Erreur lors de l'envoi de l'archive : ${me}`)}finally{lt(!1)}}},N.click();return}(async()=>{lt(!0);try{const N=await I("http://localhost:5005/api/fs/pick-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:g})}),se=N?await N.json():null;se&&se.success&&(alert("✅ ZIP Copié avec succès dans le dossier : "+g+`
Le fichier est prêt dans votre projet !`),D(2),(se.fileName||se.filename)&&q(se.fileName||se.filename))}catch(N){console.warn("Erreur picker ZIP:",N)}finally{lt(!1)}})()},un=[{id:"home",label:"TIGER IA",icon:"🐯"},{id:"creation",label:"⚙️ Création Projet",icon:"🚀"},{id:"electron",label:"Electron",icon:"💻"},{id:"vercel",label:"Vercel",icon:"▲"},{id:"deepseek",label:"DeepSeek",icon:"🐋"},{id:"override",label:"Override",icon:"💉"},{id:"connexion",label:"Connexion",icon:"⚙️"},{id:"suture",label:"Suture V2",icon:"🩺"}],[Ce,_n]=o.useState({current:null,queue:[]}),[Lt,Xe]=o.useState([]),[pn,Ut]=o.useState("src/pages/ShoppingCartDrawer.tsx"),[Ve,Be]=o.useState([]),[Ae,q]=o.useState(()=>typeof window<"u"&&sessionStorage.getItem("tiger_uiZipName")||"");o.useEffect(()=>{typeof window<"u"&&Ae&&sessionStorage.setItem("tiger_uiZipName",Ae)},[Ae]);const[Pe,ze]=o.useState(null),[mn,De]=o.useState(null),[Ot,xe]=o.useState(!1),[tt,Ft]=o.useState(!1),[ct,nt]=o.useState([]),Pt=o.useCallback(async i=>{if(!i){nt([]);return}try{const g=await I(`http://localhost:5006/api/projects/${i}/pages`);if(g&&g.ok){const S=await g.json();S.pages&&nt(S.pages)}}catch{}},[]);o.useEffect(()=>{const i=(typeof y=="string"?y:(y==null?void 0:y.project_id)||(y==null?void 0:y.title))||ie;Pt(i)},[y,ie,Pt]),o.useRef({current:null,queue:[]});const[Qe,Xt]=o.useState(localStorage.getItem("suture_dryrun")||"none"),[Ze,gt]=o.useState(localStorage.getItem("suture_locked_files")||"src/index.css,src/design.css,src/main.tsx,tsconfig.json,vite.config.ts,package.json"),[kt,st]=o.useState([]),[St,gn]=o.useState(!1),[jt,Qt]=o.useState(localStorage.getItem("suture_single_file")!=="false"),[ht,Cn]=o.useState(localStorage.getItem("suture_auto_promote")!=="false"),[yt,dt]=o.useState("idle"),[Se,Zt]=o.useState("clean");o.useRef(0);const _t=()=>{localStorage.setItem("suture_dryrun",Qe),localStorage.setItem("suture_locked_files",Ze),localStorage.setItem("suture_single_file",String(jt)),localStorage.setItem("suture_auto_promote",String(ht)),I("http://localhost:5006/api/suture/config",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({dryRunMode:Qe,lockedFiles:Ze.split(",").map(i=>i.trim()).filter(Boolean),singleFileOnly:jt,autoPromote:ht})}).catch(()=>{}),dt("saved"),setTimeout(()=>dt("idle"),2500)},Tt=async i=>{gn(!0);try{const g=i?`http://localhost:5006/api/suture/history?projectId=${i}`:"http://localhost:5006/api/suture/history",S=await I(g);if(S&&S.ok){const N=await S.json();st(N.repairs||[])}}catch{st([])}finally{gn(!1)}};return o.useEffect(()=>{if(!ys())return;let i;if(x==="deploiement"||x==="creation"){const g=()=>{I("http://localhost:5006/api/bridge/queue").then(S=>S?S.json():null).then(S=>{S&&S.success&&_n({current:S.current||{},queue:S.queue||[]})}).catch(()=>{}),I("http://localhost:5006/api/logs").then(S=>S?S.json():null).then(S=>{S&&S.logs&&Xe(S.logs)}).catch(()=>{})};g(),i=setInterval(g,1e4)}return()=>clearInterval(i)},[x]),e.jsxs("div",{className:"design-config-modal w-full h-screen bg-gradient-to-br from-[#845e7c]/95 to-[#6c3050]/95 backdrop-blur-2xl border-none shadow-[0_0_50px_rgba(0,0,0,0.8)] relative overflow-hidden flex flex-col md:flex-row pointer-events-auto",children:[!n&&x!=="creation"&&e.jsxs("div",{className:"w-full md:w-64 bg-gradient-to-b from-black/40 to-black/60 border-r border-white/10 flex flex-col",children:[e.jsxs("div",{className:"p-6 border-b border-white/10 flex justify-between items-center",children:[e.jsxs("h3",{className:"text-lg font-black text-white tracking-wider flex items-center gap-2",children:[e.jsx("span",{className:"text-cyan",children:"🐯"})," SETTINGS"]}),t&&e.jsx("button",{onClick:r,className:"md:hidden w-8 h-8 rounded-full bg-red-500/20 border border-red-500/50 flex items-center justify-center text-red-500 font-bold hover:bg-red-500 hover:text-white transition-colors",children:"✕"})]}),e.jsx("div",{className:"flex-1 overflow-y-auto py-4 hide-scrollbar flex md:flex-col gap-1 px-4",children:un.map(i=>{let g="";return i.id==="suture"?Se==="error"?g="bg-red-600 text-white border-2 border-red-400 shadow-[0_0_20px_#ff0055] animate-pulse font-bold":Se==="working"?g="bg-purple-600 text-white border-2 border-purple-300 shadow-[0_0_20px_#a855f7] animate-pulse font-bold":g=x==="suture"?"bg-emerald-600/30 border border-emerald-500 text-emerald-300 shadow-[0_0_12px_rgba(16,185,129,0.4)]":"text-emerald-400 border border-emerald-500/30 hover:bg-emerald-950/40":g=x===i.id?"bg-cyan/20 border border-cyan/50 text-white shadow-[0_0_10px_rgba(8,179,201,0.2)]":"text-gray-400 hover:bg-white/5 hover:text-white",e.jsxs("button",{onClick:()=>v(i.id),className:`flex items-center gap-3 px-4 py-3 rounded-xl transition-all whitespace-nowrap md:whitespace-normal ${g}`,children:[e.jsx("span",{className:"text-xl",children:i.icon}),e.jsx("span",{className:"font-bold text-sm tracking-wide",children:i.id==="suture"&&Se==="error"?"🔴 Suture (Erreur !)":i.id==="suture"&&Se==="working"?"🟣 Suture V2...":i.label})]},i.id)})})]}),e.jsxs("div",{className:"flex-1 bg-gradient-to-br from-[#111111] to-black relative overflow-hidden flex flex-col",children:[e.jsxs("div",{className:"flex-1 overflow-y-auto p-6 md:p-8 relative z-10 hide-scrollbar",children:[x==="connexion"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",children:[e.jsx("h2",{className:"text-xl font-black text-white border-b border-white/10 pb-4",children:"Configuration LLM & Bridge"}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-300 font-bold mb-2 block uppercase tracking-wider text-[10px]",children:"Mode d'exécution"}),e.jsx("div",{className:"grid grid-cols-3 gap-3",children:[{id:"web",icon:"💬",title:"Chat Web"},{id:"api",icon:"🔑",title:"API Directe"},{id:"hybrid",icon:"🔀",title:"Hybride"}].map(i=>e.jsxs("button",{onClick:()=>A(i.id),className:`p-3 rounded-xl border flex flex-col items-center justify-center transition-all ${j===i.id?"bg-gradient-to-br from-cyan/20 to-cyan/10 border-cyan text-white shadow-[0_0_10px_rgba(8,179,201,0.3)]":"bg-gradient-to-br from-black/30 to-black/50 border-white/10 text-gray-500 hover:border-white/30"}`,children:[e.jsx("span",{className:"text-2xl mb-1",children:i.icon}),e.jsx("span",{className:"font-bold text-xs",children:i.title})]},i.id))})]}),(j==="web"||j==="hybrid")&&e.jsxs("div",{className:"space-y-3",children:[e.jsx("span",{className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] block mb-2",children:"Flotte d'Assistants (Multi-Acteurs)"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"bg-gradient-to-br from-gray-900/50 to-black/50 p-4 rounded-xl border border-white/10 hover:border-cyan/50 transition-colors",children:[e.jsx("div",{className:"text-[10px] text-cyan mb-2 font-bold flex items-center gap-2",children:"🧠 Cerveau Logique (Backend)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("select",{value:P,onChange:i=>$(i.target.value),className:"flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 outline-none focus:border-cyan text-sm",children:[e.jsx("option",{value:"notebooklm",children:"📓 NotebookLM (Google)"}),e.jsx("option",{value:"deepseek",children:"🐋 DeepSeek Web"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT Web"}),e.jsx("option",{value:"gemini",children:"✨ Gemini Web"}),e.jsx("option",{value:"claude",children:"🟣 Claude Web"}),e.jsx("option",{value:"kimi",children:"🌙 Kimi Web"}),e.jsx("option",{value:"qwen",children:"🌐 Qwen Coder"}),e.jsx("option",{value:"perplexity",children:"🔍 Perplexity AI"}),e.jsx("option",{value:"custom",children:"➕ IA Personnalisée"})]}),e.jsx("button",{onClick:()=>{if(typeof window<"u"&&window.AndroidBridge){const i=P==="custom"?ge:mt(P);window.AndroidBridge.openAIWithPrompt(i,"Initialisation Logique.")}},className:"px-3 bg-white/10 hover:bg-cyan/20 rounded-lg font-bold text-xs transition-colors text-white",children:"▶"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-gray-900/50 to-black/50 p-4 rounded-xl border border-white/10 hover:border-pink/50 transition-colors",children:[e.jsx("div",{className:"text-[10px] text-pink mb-2 font-bold flex items-center gap-2",children:"🎨 Cerveau UI/UX (Frontend)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("select",{value:F,onChange:i=>H(i.target.value),className:"flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 outline-none focus:border-pink text-sm",children:[e.jsx("option",{value:"stitch",children:"🧵 Stitch Google"}),e.jsx("option",{value:"v0",children:"▲ v0.dev (Vercel)"}),e.jsx("option",{value:"bolt",children:"⚡ Bolt.new"}),e.jsx("option",{value:"custom",children:"➕ UI Personnalisée"})]}),e.jsx("button",{onClick:()=>{if(typeof window<"u"&&window.AndroidBridge){const i=F==="custom"?ge:F==="v0"?"https://v0.dev/":"https://stitch.withgoogle.com/";window.AndroidBridge.openAIWithPrompt(i,"Initialisation Design.")}},className:"px-3 bg-white/10 hover:bg-pink/20 rounded-lg font-bold text-xs transition-colors text-white",children:"▶"})]})]})]})]}),(P==="custom"||F==="custom")&&e.jsxs("div",{className:"flex gap-3 bg-white/5 border border-white/20 p-3 rounded-xl mt-2 animate-fadeIn",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("label",{htmlFor:"custom-ai-name",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"Nom IA Custom"}),e.jsx("input",{id:"custom-ai-name",type:"text",value:K,onChange:i=>re(i.target.value),placeholder:"Mon Agent",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-white/50"})]}),e.jsxs("div",{className:"flex-[2]",children:[e.jsx("label",{htmlFor:"custom-ai-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Complète"}),e.jsx("input",{id:"custom-ai-url",type:"text",value:ge,onChange:i=>V(i.target.value),placeholder:"https://...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-white/50 font-mono"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{htmlFor:"api-provider",className:"text-gray-300 font-bold uppercase tracking-wider text-[10px]",children:"Fournisseur API"}),e.jsxs("select",{id:"api-provider",value:pe,onChange:i=>ve(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-xl px-4 py-3 outline-none focus:border-pink text-sm",children:[e.jsx("option",{value:"deepseek",children:"🐋 DeepSeek"}),e.jsx("option",{value:"openai",children:"🟢 OpenAI (ChatGPT)"}),e.jsx("option",{value:"anthropic",children:"🟣 Anthropic Claude"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("label",{htmlFor:"api-key",className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] flex items-center gap-2",children:["Clé API",je==="ok"&&e.jsx("span",{className:"text-green-400 text-[10px] font-bold bg-green-400/10 px-2 py-0.5 rounded-full border border-green-400/30",children:"✅ Persistante sur disque"}),je==="sending"&&e.jsx("span",{className:"text-yellow-400 text-[10px] animate-pulse",children:"⏳ Envoi..."}),je==="error"&&e.jsx("span",{className:"text-red-400 text-[10px]",children:"❌ Erreur moteur"})]}),e.jsx("div",{className:"flex gap-2 relative",children:e.jsx("input",{id:"api-key",type:"password",value:Z,onChange:i=>ae(i.target.value),placeholder:"sk-...",className:`flex-1 bg-gradient-to-r from-black/40 to-black/60 text-white border rounded-xl px-4 py-3 outline-none text-sm font-mono transition-colors ${je==="ok"?"border-green-500/50 focus:border-green-400":je==="error"?"border-red-500/50":"border-white/20 focus:border-pink"}`})}),e.jsxs("div",{className:"flex items-center gap-4 mt-2",children:[e.jsx("button",{onClick:Ge,className:"px-4 py-2 bg-cyan/20 hover:bg-cyan/40 border border-cyan/40 text-cyan rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center gap-2",children:"💾 SAUVEGARDER + ENVOYER AU MOTEUR"}),e.jsx("span",{className:"text-gray-500 text-xs italic",children:"Persistée sur disque (reste après redémarrage)."})]})]}),e.jsxs("div",{className:"space-y-2 p-4 bg-gradient-to-br from-black/30 to-black/50 border border-white/5 rounded-xl",children:[e.jsx("span",{className:"text-gray-300 font-bold uppercase tracking-wider text-[10px] block",children:"Modèle détecté"}),e.jsx("div",{className:"text-gray-500 text-sm mb-2",children:"Enregistrer la clé pour détecter"}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{className:"px-4 py-2 bg-pink/20 text-pink border border-pink/50 hover:bg-pink/30 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center gap-2",children:"🔄 AUTO_DETECT"}),e.jsx("span",{className:"text-gray-500 text-xs italic",children:"Auto-détecté à l'enregistrement."})]})]}),e.jsx("div",{className:"pt-4 border-t border-white/10",children:G?e.jsxs("div",{className:"space-y-4",children:[e.jsxs("h3",{className:"text-cyan font-bold flex items-center gap-2 text-sm mb-2",children:["📱 Moteur Mobile Natif",e.jsx("span",{className:"text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30",children:"Connecté"})]}),e.jsxs("p",{className:"text-xs text-gray-400 leading-relaxed",children:["La configuration automatique est active. Les prompts sont injectés via la WebView Fantôme Java et les fichiers sont sauvegardés nativement sur votre téléphone.",e.jsx("br",{}),e.jsx("br",{}),e.jsx("strong",{children:"Aucun Bridge Electron PC n'est requis."})," L'OS Souverain est 100% autonome dans votre poche."]})]}):e.jsxs(e.Fragment,{children:[e.jsxs("h3",{className:"text-cyan font-bold flex items-center gap-2 text-sm mb-4",children:["🔗 Bridge (:5006 / Vercel)",e.jsx("span",{className:"text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30",children:"Bridge polling actif"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"bridge-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Bridge local"}),e.jsx("input",{id:"bridge-url",type:"text",value:B,onChange:i=>ne(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"vercel-url",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Vercel"}),e.jsx("input",{id:"vercel-url",type:"text",value:le,onChange:i=>he(i.target.value),className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"default-preview",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"URL Preview par défaut"}),e.jsx("input",{id:"default-preview",type:"text",value:ee,onChange:i=>T(i.target.value),placeholder:"http://127.0.0.1:3000",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1"})]})]}),e.jsxs("div",{className:"flex gap-3 mt-4",children:[e.jsx("button",{className:"px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-xs font-bold text-white transition-colors",children:"🔗 Tester"}),e.jsx("button",{onClick:Ge,className:"px-4 py-2 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-lg text-xs font-bold uppercase transition-colors",children:"💾 SAUVEGARDER_CONFIG"})]}),e.jsx("div",{className:"text-green-400 text-xs font-bold mt-4 flex items-center gap-2",children:"✅ Bridge connecté (auto-détecté)"})]})}),e.jsxs("div",{className:"pt-4 border-t border-white/10 space-y-4",children:[e.jsx("h3",{className:"text-blue-400 font-bold flex items-center gap-2 text-sm",children:"📓 NotebookLM Auto-Push (Python)"}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"notebook-id",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px]",children:"Notebook ID (URL)"}),e.jsx("input",{id:"notebook-id",type:"text",value:cn,onChange:i=>bt(i.target.value),placeholder:"6cd96956-...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm mt-1 outline-none focus:border-blue-500"})]}),e.jsxs("div",{children:[e.jsxs("label",{htmlFor:"auth-cookie",className:"text-gray-400 font-bold uppercase tracking-wider text-[10px] flex justify-between",children:[e.jsx("span",{children:"Cookie d'authentification (__Secure-1PSID)"}),at==="success"&&e.jsx("span",{className:"text-green-400",children:"🟢 Connecté"}),at==="error"&&e.jsx("span",{className:"text-red-400",children:"🔴 Erreur / Expiré"}),at==="testing"&&e.jsx("span",{className:"text-yellow-400",children:"⏳ Test..."})]}),e.jsx("input",{id:"auth-cookie",type:"password",value:At,onChange:i=>Nt(i.target.value),placeholder:"Collez votre cookie d'authentification Google ici...",className:"w-full bg-gradient-to-r from-black/40 to-black/60 text-white border border-white/20 rounded-lg px-3 py-2 text-sm font-mono mt-1 outline-none focus:border-blue-500"})]}),e.jsxs("div",{className:"flex gap-3 mt-4",children:[e.jsx("button",{onClick:Ge,className:"px-4 py-2 bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30 rounded-lg text-xs font-bold uppercase transition-colors",children:"💾 Sauvegarder"}),e.jsx("button",{onClick:async()=>{dn("testing"),setTimeout(()=>dn("success"),1e3)},className:"px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg text-xs font-bold uppercase transition-colors",children:"🧪 Tester"})]}),e.jsx("p",{className:"text-[10px] text-gray-500 italic",children:"Note : Ce cookie expire régulièrement. Pensez à le mettre à jour s'il ne fonctionne plus."})]})]})]}),x==="suture"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn",onMouseEnter:()=>{kt.length===0&&Tt()},children:[e.jsxs("div",{className:"flex items-center justify-between border-b border-white/10 pb-4",children:[e.jsxs("h2",{className:"text-xl font-black text-white flex items-center gap-3",children:[e.jsx("span",{className:"text-3xl",children:"🩺"}),e.jsxs("div",{children:[e.jsx("div",{children:"Suture V2 — Moteur Zero-Touch"}),e.jsx("div",{className:"text-[10px] font-normal text-gray-400 mt-0.5",children:"Réparation autonome, isolée et atomique"})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-3 h-3 rounded-full ${Se==="error"?"bg-red-500 shadow-[0_0_12px_#ff0055] animate-ping":Se==="working"?"bg-purple-500 shadow-[0_0_12px_#a855f7] animate-pulse":"bg-emerald-400 shadow-[0_0_8px_#4ade80]"}`}),e.jsx("span",{className:`text-[11px] font-black uppercase tracking-wider ${Se==="error"?"text-red-400":Se==="working"?"text-purple-300":"text-emerald-400"}`,children:Se==="error"?"🔴 ERREUR DÉTECTÉE (SUTURE REQUIS)":Se==="working"?"🟣 SUTURE V2 EN COURS...":"🟢 MOTEUR AUTO-PILOT PRÊT"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a1a0a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-green-400 flex items-center gap-2",children:"🔬 Mode de Validation (Dry-Run)"}),e.jsx("p",{className:"text-[10px] text-gray-500 leading-relaxed",children:"Contrôle si le moteur compile le code dans le bac à sable avant de l'appliquer en production."}),e.jsx("div",{className:"grid grid-cols-3 gap-3",children:[{id:"none",icon:"🚀",label:"Production",desc:"Applique directement"},{id:"plan",icon:"🗺️",label:"Plan Only",desc:"Génère sans appliquer"},{id:"true",icon:"🧪",label:"Full Dry-Run",desc:"Clone + build + bloque"}].map(i=>e.jsxs("button",{onClick:()=>Xt(i.id),className:`p-3 rounded-xl border flex flex-col items-center justify-center gap-1 transition-all text-center ${Qe===i.id?"bg-green-900/40 border-green-500/70 text-white shadow-[0_0_12px_rgba(74,222,128,0.2)]":"bg-black/30 border-white/10 text-gray-500 hover:border-white/30 hover:text-gray-300"}`,children:[e.jsx("span",{className:"text-xl",children:i.icon}),e.jsx("span",{className:"font-black text-[10px]",children:i.label}),e.jsx("span",{className:"text-[9px] opacity-70",children:i.desc})]},i.id))})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a0a1a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-cyan flex items-center gap-2",children:"⚡ Options de Promotion"}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("label",{className:"flex items-center justify-between cursor-pointer bg-black/20 px-4 py-3 rounded-xl hover:bg-white/5 transition-colors",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm",children:"Promotion Automatique"}),e.jsx("div",{className:"text-[10px] text-gray-500",children:"Si la compilation réussit, le patch est appliqué sans confirmation"})]}),e.jsx("div",{onClick:()=>Cn(i=>!i),className:`relative w-12 h-6 rounded-full transition-colors cursor-pointer ${ht?"bg-cyan":"bg-white/10"}`,children:e.jsx("div",{className:`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${ht?"left-7":"left-1"}`})})]}),e.jsxs("label",{className:"flex items-center justify-between cursor-pointer bg-black/20 px-4 py-3 rounded-xl hover:bg-white/5 transition-colors",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-white font-bold text-sm",children:"Fichier Unique Seulement"}),e.jsx("div",{className:"text-[10px] text-gray-500",children:"La Suture ne peut modifier qu'un seul fichier par réparation (plus sûr)"})]}),e.jsx("div",{onClick:()=>Qt(i=>!i),className:`relative w-12 h-6 rounded-full transition-colors cursor-pointer ${jt?"bg-cyan":"bg-white/10"}`,children:e.jsx("div",{className:`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${jt?"left-7":"left-1"}`})})]})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#1a0a0a]/60 border border-red-500/20 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-red-400 flex items-center gap-2",children:"🔒 Fichiers Verrouillés (Intouchables)"}),e.jsxs("p",{className:"text-[10px] text-gray-500 leading-relaxed",children:["Ces fichiers ne seront ",e.jsx("strong",{className:"text-red-300",children:"JAMAIS"})," modifiés par une Suture, même si l'IA essaie. Séparés par des virgules."]}),e.jsx("textarea",{value:Ze,onChange:i=>gt(i.target.value),rows:3,className:"w-full bg-black/40 text-red-200 border border-red-500/20 rounded-lg px-3 py-2 text-[11px] font-mono outline-none focus:border-red-500/50 resize-none",placeholder:"src/design.css,package.json,..."}),e.jsx("div",{className:"flex flex-wrap gap-2",children:Ze.split(",").map(i=>i.trim()).filter(Boolean).map(i=>e.jsxs("span",{className:"flex items-center gap-1 bg-red-900/20 border border-red-500/30 text-red-300 text-[9px] font-mono px-2 py-1 rounded-full",children:["🔒 ",i,e.jsx("button",{onClick:()=>gt(g=>g.split(",").map(S=>S.trim()).filter(S=>S!==i).join(", ")),className:"text-red-500 hover:text-white ml-1 font-bold",children:"×"})]},i))})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-[#0a0a0a]/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-yellow-400 flex items-center gap-2",children:"⚡ Actions Rapides Suture"}),e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx("button",{onClick:()=>I("http://localhost:5006/api/suture/purge-workspaces",{method:"POST"}).then(i=>alert(i?"✅ Bac à sable vidé !":"❌ Moteur inaccessible (Mode Cloud SaaS)")).catch(()=>alert("❌ Moteur inaccessible")),className:"py-3 bg-orange-900/20 hover:bg-orange-900/40 border border-orange-500/30 text-orange-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"🗑️ Vider le Bac à Sable"}),e.jsx("button",{onClick:()=>Tt(),className:"py-3 bg-blue-900/20 hover:bg-blue-900/40 border border-blue-500/30 text-blue-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"🔄 Rafraîchir Historique"}),e.jsx("button",{onClick:()=>I("http://localhost:5006/api/suture/rollback-last",{method:"POST"}).then(i=>i?i.json():null).then(i=>alert(i?i.success?`✅ Rollback : ${i.message}`:`❌ ${i.error}`:"❌ Moteur inaccessible (Mode Cloud SaaS)")).catch(()=>alert("❌ Moteur inaccessible")),className:"py-3 bg-purple-900/20 hover:bg-purple-900/40 border border-purple-500/30 text-purple-300 rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all",children:"↩️ Rollback Dernier Patch"}),e.jsx("button",{onClick:_t,className:`py-3 border rounded-xl text-[10px] font-bold flex items-center justify-center gap-2 transition-all ${yt==="saved"?"bg-green-900/40 border-green-500/50 text-green-300":"bg-cyan/10 hover:bg-cyan/20 border-cyan/40 text-cyan"}`,children:yt==="saved"?"✅ Sauvegardé !":"💾 Sauvegarder Config"})]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-black/40 to-black/60 border border-white/10 rounded-xl p-5 space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-widest text-gray-400 flex items-center gap-2",children:"📋 Historique des Réparations"}),e.jsx("button",{onClick:()=>Tt(),className:"text-[9px] text-cyan hover:text-white bg-cyan/10 px-2 py-1 rounded",children:"Actualiser"})]}),e.jsxs("div",{className:"max-h-[200px] overflow-y-auto hide-scrollbar space-y-2",children:[St&&e.jsx("div",{className:"text-center text-gray-500 text-[10px] animate-pulse py-4",children:"⏳ Chargement..."}),!St&&kt.length===0&&e.jsx("div",{className:"text-center text-gray-600 text-[10px] italic py-4",children:"Aucune réparation trouvée. Cliquez sur 🩺 dans l'explorateur pour lancer une Suture."}),kt.map((i,g)=>e.jsxs("div",{className:`flex items-center justify-between p-3 rounded-lg border text-[10px] font-mono ${i.status==="applied"?"bg-green-900/10 border-green-500/20":i.status==="failed"?"bg-red-900/10 border-red-500/20":"bg-white/5 border-white/10"}`,children:[e.jsxs("div",{className:"flex flex-col gap-0.5 truncate flex-1 mr-2",children:[e.jsx("span",{className:"text-white font-bold truncate",children:i.repairId||i.id}),e.jsxs("span",{className:"text-gray-500 truncate",children:[i.projectId," — ",i.activeFile||"?"]}),e.jsx("span",{className:"text-gray-600",children:i.startedAt?new Date(i.startedAt).toLocaleString("fr-FR"):""})]}),e.jsx("span",{className:`shrink-0 px-2 py-0.5 rounded-full border text-[9px] font-bold ${i.status==="applied"?"bg-green-900/30 border-green-500/40 text-green-300":i.status==="failed"?"bg-red-900/30 border-red-500/40 text-red-300":"bg-yellow-900/30 border-yellow-500/40 text-yellow-300"}`,children:i.status==="applied"?"✅ Appliqué":i.status==="failed"?"❌ Échec":"⚠️ Partiel"})]},g))]})]})]}),x==="creation"&&e.jsxs("div",{className:"space-y-6 animate-fadeIn flex flex-col mt-8 border-t border-white/10 pt-8 pr-2",children:[e.jsxs("div",{className:"flex flex-col border-b border-white/5 pb-4",children:[e.jsxs("h2",{className:"text-2xl font-black text-white flex items-center gap-2 tracking-wide uppercase",children:[e.jsx("span",{children:"⚙️"})," CONFIGURATION DU PROJET"]}),e.jsx("p",{className:"text-[10px] text-gray-400 mt-1",children:"Générez et paramétrez votre projet de A à Z."})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1 min-h-0",children:[e.jsxs("div",{className:"transition-opacity duration-1000",children:[e.jsxs("div",{className:"bg-[#050505] border border-white/5 rounded-xl flex flex-col gap-4 overflow-y-auto hide-scrollbar p-5 mb-6",children:[e.jsxs("h3",{className:"text-white font-bold text-xs mb-2 flex items-center gap-2",children:[e.jsx("span",{className:"text-yellow-500",children:"📁"})," Création & Ciblage"]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"CIBLER UN PROJET EXISTANT"}),e.jsxs("select",{value:typeof y=="string"?y:(y==null?void 0:y.project_id)||(y==null?void 0:y.title)||"",onChange:i=>L(i.target.value),onClick:async()=>{if(C.length===0)try{const i=await I("/api/projects");if(i&&i.ok){const g=await i.json();g.projects&&b(g.projects.map(S=>typeof S=="string"?S:S.project_id||S.title||S.name||""))}else{const S=await(await fetch("/api/projects")).json();S.projects&&b(S.projects.map(N=>typeof N=="string"?N:N.project_id||N.title||N.name||""))}}catch{}},className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 outline-none focus:border-cyan text-xs",children:[e.jsx("option",{value:"",children:"-- SÉLECTIONNER UN PROJET --"}),C.map((i,g)=>{const S=typeof i=="string"?i:i.project_id||i.title||i.name||"Projet "+g;return e.jsx("option",{value:S,children:S},S+"_"+g)})]}),y&&Rt==="idle"&&e.jsx("button",{onClick:async()=>{We("loading");try{const i=await I("http://localhost:5006/api/bridge/export-notebooklm",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({projectId:y,notebookId:cn,authCookie:At})});if(!i){alert("Mode Cloud SaaS : Bridge local non connecté."),We("idle");return}const g=await i.json();g.success?(on(g.combinedContent||""),g.pushLog&&g.pushLog.includes("Failed:")?(ln(g.pushLog),We("error")):We("ready")):(ln(g.message),We("error"))}catch{ln("Erreur de connexion avec Kirov5."),We("error")}},className:"mt-2 w-full bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-2",children:"📓 Préparer l'export NotebookLM"}),y&&Rt==="loading"&&e.jsx("button",{disabled:!0,className:"mt-2 w-full bg-gray-900/50 text-gray-400 border border-gray-700/50 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider flex items-center justify-center gap-2",children:"⏳ Extraction de l'expertise..."}),y&&Rt==="ready"&&e.jsx("button",{onClick:async()=>{try{await navigator.clipboard.writeText(an),window.open("https://notebook.google.com/notebook/6cd96956-200e-4260-ae7d-6c1446de284a","_blank"),We("idle")}catch{alert("❌ Copie échouée. Essayez sur HTTPS ou utilisez Ctrl+C manuellement.")}},className:"mt-2 w-full bg-green-900/40 hover:bg-green-800/60 text-green-300 border border-green-500/50 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-2",children:"✅ Copier & Ouvrir NotebookLM"}),y&&Rt==="error"&&e.jsxs("div",{className:"mt-2 p-3 bg-red-900/30 border border-red-500/50 rounded-lg",children:[e.jsx("div",{className:"text-red-400 text-[10px] font-bold mb-2",children:"⚠️ Échec du script Python (Copiez l'erreur ci-dessous) :"}),e.jsx("textarea",{readOnly:!0,value:On,className:"w-full h-24 bg-black/50 text-red-300 text-[10px] font-mono p-2 rounded border border-red-500/20 outline-none"}),e.jsxs("div",{className:"flex gap-2 mt-2",children:[e.jsx("button",{onClick:()=>We("idle"),className:"flex-1 bg-gray-800 hover:bg-gray-700 text-white text-[10px] py-2 rounded font-bold",children:"🔄 Réessayer"}),e.jsx("button",{onClick:async()=>{try{await navigator.clipboard.writeText(an),window.open("https://notebook.google.com/notebook/6cd96956-200e-4260-ae7d-6c1446de284a","_blank"),We("idle")}catch{alert("❌ Copie échouée.")}},className:"flex-1 bg-green-900/50 hover:bg-green-800/70 text-green-300 border border-green-500/50 text-[10px] py-2 rounded font-bold",children:"✅ Fallback Manuel"})]})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"NOM DU NOUVEAU PROJET"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"text",value:ie,onChange:i=>Re(i.target.value),placeholder:"Ex: MonSuperProjet",className:"flex-1 bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan"}),e.jsx("button",{onClick:async()=>{if(!ie||!ie.trim()){alert("Entrez un nom de projet");return}const i=ie.trim();try{const g=localStorage.getItem("kirov5_jwt_token")||"",S=await fetch("/api/projects",{method:"POST",headers:{"Content-Type":"application/json",...g?{Authorization:`Bearer ${g}`}:{}},body:JSON.stringify({title:i,name:i,projectId:i.replace(/[^a-zA-Z0-9_-]/g,"_"),description:"Projet Tiger Cloud"})}),N=await S.json();S.ok&&(N.success||N.project)?(alert(`✅ Projet "${i}" créé avec succès !`),setActiveProject(i),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",i),fetch("/api/projects",{headers:g?{Authorization:`Bearer ${g}`}:{}}).then(se=>se.json()).then(se=>{se&&se.projects&&setRealProjects(se.projects.map(E=>({name:E.project_id||E.title||E.name,desc:E.owner_email?`Propriétaire: ${E.owner_email}`:"Projet Cloud",bg:""})))}).catch(()=>{})):alert("❌ Erreur création projet: "+(N.error||N.message||"Erreur inconnue"))}catch(g){alert("❌ Erreur de connexion avec le serveur: "+((g==null?void 0:g.message)||g))}},className:"bg-[#0f2a2a] hover:bg-[#153f3f] text-cyan border border-cyan/30 px-4 py-2 rounded-lg text-xs font-bold transition-colors",children:"Valider"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"STACK TECHNIQUE"}),e.jsxs("select",{value:yn,onChange:i=>It(i.target.value),className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",children:[e.jsx("option",{value:"vite",children:"⭐ 1er Choix (Prioritaire) : Vite + React + Tailwind + TS"}),e.jsx("option",{value:"nextjs",children:"Next.js 16 + Tailwind"})]})]}),e.jsxs("div",{className:"flex-1 flex flex-col",children:[e.jsxs("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2 flex items-center gap-1",children:[e.jsx("span",{className:"text-white",children:"📄"})," INSTRUCTIONS / VISION"]}),e.jsx("textarea",{value:it,onChange:i=>Te(i.target.value),placeholder:"Décrivez l'application ou copiez votre PRD...",className:"w-full flex-1 min-h-[120px] bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan resize-none"})]})]}),e.jsxs("div",{className:"bg-[#050505] border border-white/5 rounded-xl flex flex-col gap-4 overflow-y-auto hide-scrollbar p-5 transition-opacity duration-1000",children:[e.jsxs("h3",{className:"text-white font-bold text-xs mb-2 flex items-center gap-2",children:[e.jsx("span",{className:"text-yellow-500",children:"⚡"})," Paramètres & IA"]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:"INTELLIGENCE CIBLE"}),e.jsxs("select",{className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",onChange:i=>{const g=i.target.value;window.KIROV_TARGET_AI=g,typeof window<"u"&&localStorage.setItem("tiger_targetAi",g);let S="";g==="stitch"?S="https://stitch.withgoogle.com":g==="deepseek"||g==="deepseek-web"?S="https://chat.deepseek.com":g==="gemini"?S="https://gemini.google.com":g==="chatgpt"?S="https://chatgpt.com":g==="claude"?S="https://claude.ai":g==="notebooklm"&&(S="https://notebooklm.google.com"),S&&I("http://localhost:5006/api/bridge/open-window",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:S})}).catch(N=>console.warn("Erreur ouverture fenêtre",N))},defaultValue:typeof window<"u"&&localStorage.getItem("tiger_targetAi")||"hermes",children:[e.jsx("option",{value:"notebooklm",children:"📓 NotebookLM (Google)"}),e.jsx("option",{value:"cloudflare",children:"☁️ Cloudflare Qwen 3 30B (Audit IA Grade Gold)"}),e.jsx("option",{value:"cloudflare-hermes",children:"⚡ Hermes Cloudflare Workers AI (Qwen Coder)"}),e.jsx("option",{value:"deepseek",children:"🩵 DeepSeek (Extension Web)"}),e.jsx("option",{value:"hermes",children:"🤖 Hermes Agent (API DeepSeek)"}),e.jsx("option",{value:"chatgpt",children:"🟢 ChatGPT"}),e.jsx("option",{value:"claude",children:"🟣 Claude"})]})]}),e.jsxs("div",{children:[e.jsxs("label",{className:"text-gray-400 font-bold uppercase tracking-wider text-[9px] block mb-2",children:["💉 MODE & LOT DE DÉPART (Val: ",w,")"]}),e.jsxs("select",{value:w,onChange:i=>D(Number(i.target.value)),className:"w-full bg-[#111] text-gray-200 border border-white/10 rounded-lg px-3 py-2 text-xs outline-none focus:border-cyan",children:[e.jsx("option",{value:0,children:"🚀 TOUT : Pipeline Complète (Zero-Touch)"}),e.jsx("option",{value:1,children:"🎨 Phase 1 : Le Frontend (Stitch/v0)"}),e.jsx("option",{value:2,children:"⚙️ Phase 2 : Logique G5"}),e.jsx("option",{value:4,children:"🎨 Phase 3/4 : Câblage Métier (Business Wiring)"}),e.jsx("option",{value:5,children:"🔌 Phase 5 : Industrialisation & Backend"}),e.jsx("option",{value:9,children:"🪄 M.A.J UI : Pipeline Push UI/UX (One-Shot)"})]})]}),e.jsxs("div",{className:"flex flex-col gap-3 mt-4 bg-[#111] p-4 rounded-lg border border-white/5",children:[e.jsxs("label",{className:"flex items-center gap-3 text-[11px] font-bold text-gray-300 cursor-pointer",children:[e.jsx("input",{type:"checkbox",className:"accent-cyan w-4 h-4",checked:Y,onChange:()=>O(!Y)}),"🤖 AUTO-PILOT : ",Y?"ON 🟢":"OFF ⚪"]}),e.jsxs("label",{className:"flex items-center gap-3 text-[11px] font-bold text-gray-300 cursor-pointer",children:[e.jsx("input",{type:"checkbox",className:"accent-cyan w-4 h-4",checked:W,onChange:()=>te(!W)}),"🔗 Injecter dans l'onglet ouvert"]})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-3 mt-4",children:[e.jsxs("div",{id:"btn-joindre-prd",className:`py-6 text-white text-[10px] font-bold rounded-lg border flex flex-col items-center justify-center gap-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${Ne?"bg-purple-950/80 border-purple-400 animate-pulse":(window.KIROV_SELECTED_PACKS||R).length>0?"bg-indigo-600 border-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.6)]":"bg-[#2a1b3d] border-purple-500/30"}`,title:"Pack PRD sélectionné — Sera injecté automatiquement dans le contexte IA",children:[e.jsx("span",{className:"text-xl",children:Ne?"⏳":"💎"}),e.jsx("span",{children:Ne?"Copie en cours...":(window.KIROV_SELECTED_PACKS||R).length>0?`Packs PRD ${(window.KIROV_SELECTED_PACKS||R).length} ${(window.KIROV_SELECTED_PACKS||R)[0]}`:"Aucun Pack PRD"})]}),e.jsxs("button",{id:"btn-joindre-zip",disabled:Je,onClick:()=>{Number(w)===0&&(Dt(!0),typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning","true")),qt()},className:`py-6 text-white text-[10px] font-bold rounded-lg border transition-all flex flex-col items-center justify-center gap-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${Je?"bg-amber-950/70 border-amber-500 text-amber-300 animate-pulse":Number(w)===2&&!Ae?"bg-cyan-950/80 border-2 border-cyan text-cyan shadow-[0_0_30px_rgba(6,182,212,0.7)] animate-pulse scale-105 ring-2 ring-cyan/40 cursor-pointer":ot?"bg-[#1a3a40] hover:bg-[#204a50] pointer-events-auto shadow-[0_0_30px_rgba(8,179,201,0.6)] border-cyan scale-105 z-50 relative animate-pulse":"bg-[#1a2f3a] hover:bg-[#254250] border-cyan/30"}`,title:Ae?`Archive importée : ${Ae}`:"Joindre le fichier ZIP exporté depuis Stitch",children:[e.jsx("span",{className:"text-xl",children:Je?"⏳":Ae?"✅":"📎"}),e.jsx("span",{className:"font-extrabold",children:Je?"Extraction en cours...":Ae?`ZIP : ${Ae}`:"Joindre ZIP (Stitch)"}),Number(w)===2&&!Ae&&!Je&&e.jsx("span",{className:"text-[9px] text-cyan-300 font-extrabold uppercase animate-bounce mt-0.5",children:"👇 Étape 2 : Joindre le ZIP ici"})]})]}),(()=>{const g={0:"🚀 LANCER PIPELINE COMPLÈTE (ONE-SHOT)",1:"✨ LANCER PHASE 1 (Prompt vers l'IA)",2:Ae?`⚙️ LANCER PHASE 2 (MULTI-BATCH) [${Ae}]`:"⚙️ LANCER PHASE 2 (MULTI-BATCH) — ⏳ EN ATTENTE DU ZIP STITCH",3:"🎨 LANCER PHASE 3/4 (CÂBLAGE MÉTIER)",4:"🎨 LANCER PHASE 3/4 (CÂBLAGE MÉTIER)",5:"🔌 LANCER PHASE 5 (INDUSTRIALISATION)",9:"🛡️ LANCER PUSH UI"}[Number(w)];return g?e.jsx("button",{id:"btn-lancer-phase",onClick:()=>{const S=y||ie;if(!S){alert("Veuillez sélectionner ou créer un projet !");return}if(Number(w)===2&&!Ae){confirm(`📁 Le fichier .zip Stitch n'est pas encore joint à ce projet.

Souhaitez-vous sélectionner et importer votre archive ZIP maintenant ?`)&&qt();return}Dt(!0),typeof window<"u"&&sessionStorage.setItem("tiger_isPipelineRunning","true"),setTimeout(()=>{var E;(E=document.getElementById("kirov-radar-queue"))==null||E.scrollIntoView({behavior:"smooth"})},500);const N=window.KIROV_TARGET_AI||typeof window<"u"&&localStorage.getItem("tiger_targetAi")||"hermes";if(typeof r=="function"&&r(),v("home"),typeof window<"u"&&window.dispatchEvent(new CustomEvent("open-mouchard")),Number(w)===5){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:S,target_ai:N,start_index:1,zip_mode:!0,start_phase:5,auto_pilot:Y})}).then(E=>E?E.json():null).then(E=>{alert(E?`✅ PHASE 5 (INDUSTRIALISATION) LANCÉE !
L'orchestrateur génère l'infrastructure et certifie le projet.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(E=>{console.error(E),alert("Erreur lors du lancement de la Phase 5.")});return}if(Number(w)===4||Number(w)===3){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:S,target_ai:N,start_index:1,zip_mode:!0,start_phase:4,auto_pilot:Y,packs:window.KIROV_SELECTED_PACKS||[]})}).then(E=>E?E.json():null).then(E=>{alert(E?`✅ PHASE 3/4 (CÂBLAGE MÉTIER) LANCÉE !
L'orchestrateur prend le relais pour connecter et câbler la logique métier.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(E=>{console.error(E),alert("Erreur lors du lancement de la Phase 3/4.")});return}if(Number(w)===2){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:S,target_ai:N,start_index:1,zip_mode:!0,start_phase:200,auto_pilot:Y,packs:window.KIROV_SELECTED_PACKS||[]})}).then(E=>E?E.json():null).then(E=>{alert(E?`✅ PHASE 2 (LOGIQUE G5) LANCÉE !
L'orchestrateur prend le relais pour générer le Backend et intégrer les composants.`:"Mode Cloud SaaS : Bridge non disponible.")}).catch(E=>{console.error(E),alert("Erreur: Le moteur n'a pas pu être contacté.")});return}typeof window<"u"&&(window.open("https://stitch.withgoogle.com/","_blank"),window.dispatchEvent(new CustomEvent("open-mouchard")));const se=window.KIROV_SELECTED_PACKS&&window.KIROV_SELECTED_PACKS.length>0?window.KIROV_SELECTED_PACKS:R&&R.length>0?R:[];if(Number(w)===0){I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_project:S,target_ai:"stitch",start_index:1,zip_mode:!0,start_phase:0,auto_pilot:Y,instructions:it||"Génère l'application avec ces packs et directives.",packs:se})}).then(E=>E?E.json():null).then(E=>{var ut;const me=(E==null?void 0:E.prompt)||((ut=E==null?void 0:E.data)==null?void 0:ut.prompt)||"Génération UI/UX Stitch complète.",ye=se.length>0?se.join(", "):"standard";if(D(2),typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase","2"),typeof document<"u"){const Me=document.getElementById("tiger-mega-prompt-overlay");Me&&Me.remove();const Ye=document.createElement("div");Ye.id="tiger-mega-prompt-overlay",Ye.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);backdrop-filter:blur(10px);z-index:999999;display:flex;align-items:center;justify-content:center;padding:16px;font-family:sans-serif;",Ye.innerHTML=`
                              ...
                              `,document.body.appendChild(Ye);const Ct=document.getElementById("tiger-prompt-area"),Ue=document.getElementById("btn-copy-prompt"),Oe=document.getElementById("btn-close-prompt-overlay"),et=document.getElementById("btn-open-stitch"),Gt=()=>{Ct&&(Ct.select(),Ct.setSelectionRange(0,99999),document.execCommand("copy")),navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),D(2),Ue&&(Ue.innerHTML="✅ COPIÉ DANS LE PRESSE-PAPIER !",Ue.style.background="linear-gradient(135deg,#10b981,#059669)",setTimeout(()=>{Ue&&(Ue.innerHTML="📋 COPIER LE MÉGA-PROMPT",Ue.style.background="linear-gradient(135deg,#06b6d4,#2563eb)")},3e3))};Ue&&(Ue.onclick=()=>{Gt(),D(2)}),Oe&&(Oe.onclick=()=>{Ye.remove(),D(2)}),et&&(et.onclick=()=>{window.open("https://stitch.withgoogle.com/","_blank"),D(2)}),Gt(),D(2)}}).catch(E=>{console.error(E),alert("Erreur de communication avec le serveur Kirov5.")});return}I("/api/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:"stitch",user_prompt:it||"Génère l'application avec ces packs et directives.",packs:se,target_project:S,phase_num:1})}).then(E=>E?E.json():null).then(E=>{var ye;const me=(E==null?void 0:E.prompt)||((ye=E==null?void 0:E.data)==null?void 0:ye.prompt)||"Génération UI/UX Stitch.";typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText(me).catch(()=>{}),alert(`🚀 PHASE 1 (STITCH UI/UX) INITIALISÉE !
...
*Le fichier README complet est disponible dans le dossier prd_packs/${L.packId}/README.md.*`),e.jsxs("div",{className:"design-fenetre-readme w-full rounded-3xl p-6 md:p-8 border-2 border-cyan/60 shadow-[0_0_80px_rgba(124,58,237,0.45)] my-4 relative animate-fadeIn text-white z-20 flex flex-col min-h-[480px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-4 flex-shrink-0",children:[e.jsxs("span",{className:"px-3.5 py-1.5 bg-cyan/20 text-cyan text-xs font-bold rounded-xl border border-cyan/40 flex items-center gap-2 shadow-sm",children:[e.jsx("span",{children:"💎"})," PACK PRD : ",L.packId]}),e.jsx("button",{onClick:()=>te(null),className:"w-10 h-10 bg-cyan/20 hover:bg-cyan/40 text-cyan rounded-xl flex items-center justify-center font-bold text-lg transition-all border border-cyan/40 cursor-pointer shadow-md",title:"Fermer (Retour aux packs)",children:"✕"})]}),e.jsx("h2",{className:"text-2xl md:text-3xl font-black text-cyan mb-2 leading-tight drop-shadow-[0_2px_10px_rgba(6,182,212,0.5)] flex-shrink-0",children:L.packName}),e.jsx("div",{className:"w-full h-px bg-gradient-to-r from-cyan via-purple-400 to-cyan/20 mb-4 flex-shrink-0"}),e.jsx("div",{className:"design-readme-contenu flex-1 text-white font-medium leading-relaxed whitespace-pre-wrap overflow-y-auto max-h-[500px] p-6 rounded-2xl border-2 border-cyan/50 font-mono text-sm shadow-[0_0_40px_rgba(8,179,201,0.3)] min-h-[300px]",style:{background:"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)",textShadow:"0 1px 2px rgba(0,0,0,0.8)"},children:w}),e.jsxs("div",{className:"mt-6 pt-4 border-t border-white/15 flex justify-between items-center flex-shrink-0",children:[e.jsxs("span",{className:"text-xs text-cyan/90 font-mono font-bold tracking-widest uppercase flex items-center gap-2",children:[e.jsx("span",{children:"⚡"})," SUTURE PRD ENGINE"]}),e.jsx("button",{onClick:()=>te(null),className:"px-6 py-2.5 bg-cyan/20 hover:bg-cyan/40 text-cyan font-bold rounded-xl transition-all border border-cyan/40 flex items-center gap-2 cursor-pointer hover:bg-cyan/30 shadow-md",children:"← Fermer & Retour aux packs"})]})]})}return e.jsxs("div",{id:"prd-packs-carousel-section",className:"w-full flex-1 min-w-0 my-2",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3 px-2",children:[e.jsxs("h4",{className:"design-prd-titre-section font-black uppercase tracking-widest text-cyan flex items-center gap-2",children:[e.jsx("span",{children:"💎"})," PACKS PRD DE CONNAISSANCES (",Ht.length,")"]}),t&&t.length>0&&e.jsxs("span",{className:"text-[11px] font-bold text-cyan bg-cyan/20 px-2.5 py-1 rounded-full border border-cyan/30",children:[t.length," pack(s) actif(s)"]})]}),e.jsx("div",{className:"flex gap-4 items-stretch relative w-full",children:e.jsx("div",{className:"flex-1 min-w-0 min-h-[480px] overflow-hidden py-4 flex items-center",children:h?Y.length===0?e.jsxs("div",{className:"h-full min-h-[220px] rounded-2xl p-6 border border-purple-500/20 bg-purple-950/20 backdrop-blur-md flex flex-col items-center justify-center text-center",children:[e.jsx("p",{className:"text-purple-300 font-bold text-sm",children:"Aucun pack Guest n'a encore été généré."}),e.jsx("p",{className:"text-xs text-zinc-400 mt-2",children:"Utilisez l'interface V0-GUEST pour scanner un projet local et créer un pack sur-mesure."}),e.jsx("button",{onClick:W,className:"mt-4 text-xs text-purple-300 border border-purple-500/40 px-4 py-1.5 rounded-full hover:bg-purple-900/40 transition-colors",children:"🔄 Recharger les packs Guest"})]}):e.jsx($t,{items:Y.filter(w=>{var R,x,v,j;if(!C)return!0;const D=C.toLowerCase();return((R=w.name)==null?void 0:R.toLowerCase().includes(D))||((x=w.description)==null?void 0:x.toLowerCase().includes(D))||((v=w.id)==null?void 0:v.toLowerCase().includes(D))||((j=w.category)==null?void 0:j.toLowerCase().includes(D))}).sort((w,D)=>(w.name||"").localeCompare(D.name||"")).map(w=>{const D=w.id,R=t?t.includes(D):!1;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${R?"border-purple-400 shadow-[0_0_25px_rgba(168,85,247,0.4)] bg-purple-950/60":"border-purple-500/20 hover:border-purple-400/60 bg-black/50"}`,children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${R?"bg-purple-500 text-white shadow-md":"bg-purple-500/20 text-purple-400 border border-purple-500/40"}`,children:e.jsx(Rn,{size:18})}),e.jsx("span",{className:"px-2 py-0.5 bg-purple-500/20 text-purple-300 text-[10px] font-bold rounded-md uppercase tracking-wider border border-purple-500/30",children:"🐋 GUEST"})]}),n&&e.jsx("button",{onClick:x=>{x.stopPropagation(),n(D)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${R?"bg-purple-500 text-white shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-purple-500/40 hover:text-white"}`,children:R?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight truncate",children:w.name}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed text-zinc-300 text-xs line-clamp-4",children:w.description}),e.jsxs("div",{className:"mt-4 pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsxs("span",{className:"text-[10px] font-mono text-purple-400/80",children:[w.modulesCount," MODULES"]}),e.jsxs("button",{onClick:async()=>{var x;try{const v=await I(`http://localhost:5006/api/bridge/read-file?path=${encodeURIComponent(w.path+"/README.md")}`);let j="";if(v&&v.ok){const A=await v.json();j=((x=A.data)==null?void 0:x.content)||A.content||""}te({packId:D,packName:w.name,readmeText:j||`# PACK GUEST : ${w.name}

Spécifications techniques du pack Guest ${w.name}.

Module réutilisable scanné dans ${w.path}.`})}catch{te({packId:D,packName:w.name,readmeText:`# PACK GUEST : ${w.name}

Spécifications techniques du pack Guest ${w.name}.`})}},className:"design-prd-btn text-purple-400 text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-purple-500/30 transition-all",children:[e.jsx("span",{children:"📖"})," README →"]})]})]},D)})}):e.jsx($t,{items:Ht.map(w=>{const D=w.id,R=w.name,x=w.icon||ps,v=t?t.includes(D):!1,P=(b[D]||fn(D)||"Spécifications techniques du contrat PRD.").replace(/^#+.*$/gm,"").replace(/^>.*$/gm,"").replace(/\[([^\]]+)\]\([^\)]+\)/g,"$1").replace(/[*_~`]/g,"").trim().split(`
`).map(H=>H.trim()).filter(H=>H.length>20),$=P.length>0?P[0]:"Spécifications techniques du contrat PRD.",F=$.length>180?$.substring(0,180)+"...":$;return e.jsxs("div",{className:`design-carte-carrousel design-prd-carte rounded-2xl p-5 border backdrop-blur-md flex flex-col transition-all shadow-lg relative group ${v?"border-cyan shadow-[0_0_25px_rgba(8,179,201,0.4)]":"border-white/10 hover:border-cyan/50"}`,style:{background:r?c("prd-card-"+D,.7):"rgba(0,0,0,0.7)"},children:[e.jsxs("div",{className:"flex justify-between items-center mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-xl flex items-center justify-center font-bold ${v?"bg-cyan text-black shadow-md":w.color||"bg-cyan/20 text-cyan"}`,children:e.jsx(x,{size:20})}),e.jsx("span",{className:"px-2 py-0.5 bg-cyan/20 text-cyan text-[10px] font-bold rounded-md uppercase tracking-wider",children:"💎 PRD"})]}),n&&e.jsx("button",{onClick:H=>{H.stopPropagation(),n(D)},className:`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${v?"bg-cyan text-black shadow-md scale-110":"bg-white/10 text-white/60 hover:bg-white/20 hover:text-white"}`,title:v?"Désélectionner ce pack":"Sélectionner ce pack pour l'IA",children:v?"✓":"+"})]}),e.jsx("h3",{className:"design-carte-titre text-base font-bold text-white mb-2 leading-tight",children:R}),e.jsx("p",{className:"design-carte-desc flex-1 opacity-85 leading-relaxed",children:F}),e.jsxs("div",{className:"mt-auto pt-3 border-t border-white/10 flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] font-mono text-cyan/80",children:"MODULE PRD"}),e.jsxs("button",{onClick:async()=>{var K;let H=b[D]||fn(D)||"";try{const re=await I(`http://localhost:5006/api/bridge/read-file?packId=${encodeURIComponent(D)}`);if(re&&re.ok){const ge=await re.json(),V=ge.content||((K=ge.data)==null?void 0:K.content);V&&V.trim().length>5&&(H=V,y(B=>({...B,[D]:V})))}}catch(re){console.warn("API Bridge read fallback",re)}te({packId:D,packName:R,readmeText:H||`# 💎 PRD PACK : ${R} (${D})

### ⚙️ Spécifications techniques du contrat PRD

- **Identifiant Pack**: ${D}
- **Statut**: Actif & Intégré au Moteur Sovereign`})},className:"design-prd-btn text-cyan text-xs font-bold hover:underline cursor-pointer flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-cyan/30 transition-all hover:bg-cyan/10",children:[e.jsx("span",{children:"📖"})," Lire le README →"]})]})]},D)})})})})]})};let tn=0,Kt=[];const es=({isClient:t,getCachedGradient:n,setActiveProject:r,onOpenProject:c})=>{const[d,m]=o.useState([]),[h,p]=o.useState(!0),[C,b]=o.useState(!1),[y,L]=o.useState(null),[G,Y]=o.useState({}),[O,W]=o.useState({}),te=async(R,x)=>{R.preventDefault(),R.stopPropagation(),typeof window<"u"&&(window.dispatchEvent(new CustomEvent("open-mouchard")),window.dispatchEvent(new CustomEvent("kirov-mouchard-log",{detail:`> 📱 [v0-apk] Lancement compilation APK pour "${x}"...`}))),W(A=>({...A,[x]:{status:"building",progress:"Initialisation..."}}));const v=A=>{W(P=>({...P,[x]:{status:"building",progress:A}})),typeof window<"u"&&window.dispatchEvent(new CustomEvent("kirov-mouchard-log",{detail:`> [v0-apk] ${A}`}))},j=(A,P)=>{W($=>{var F;return{...$,[x]:{status:A,apkUrl:P||((F=$[x])==null?void 0:F.apkUrl),progress:A==="success"?"APK prêt !":"Échec compilation"}}}),A==="success"&&(tn=0,w())};try{const A=await I("http://localhost:5006/api/mobile/build-apk",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:x})});if(A&&A.ok){v("Compilation locale...");let P=0;const $=setInterval(async()=>{P++;try{const F=await I("http://localhost:5006/api/mobile/build-logs");if(F&&F.ok){const H=await F.json();if(H.logs&&H.logs.length>0){const K=H.logs[H.logs.length-1];v(K.replace(/\[.*?\]/g,"").trim().substring(0,30))}if(H.isBuilding===!1&&H.result)if(clearInterval($),H.result.success){const K=H.result.apkUrl||`/api/mobile/download-apk?file=${encodeURIComponent(x+".apk")}`;j("success",K)}else v("Bascule Cloud..."),await zt(x,v,j)}}catch{clearInterval($),await zt(x,v,j)}P>120&&clearInterval($)},2e3)}else v("Bascule Cloud Souverain..."),await zt(x,v,j)}catch{v("Bascule Cloud Souverain...");try{await zt(x,v,j)}catch{j("error")}}},w=async()=>{try{let R=[];const x=Date.now();if(x-tn<3e4&&Kt.length>0)R=[...Kt];else try{const v=Ln(),j=await fetch("https://api.github.com/repos/turnzack/v0-reponse/releases",{headers:v?{Authorization:`Bearer ${v}`,Accept:"application/vnd.github.v3+json"}:{Accept:"application/vnd.github.v3+json"}});if(j.ok){const A=await j.json();if(Array.isArray(A)){const P=[];A.forEach($=>{Array.isArray($.assets)&&$.assets.forEach(F=>{var H;(H=F.name)!=null&&H.endsWith(".apk")&&P.push({file:F.name,name:F.name.replace(".apk",""),sizeMb:(F.size/(1024*1024)).toFixed(1),url:F.browser_download_url})})}),Kt=P,tn=x,R=[...P]}}}catch{}try{const v=await I("http://localhost:5006/api/mobile/list-apks");if(v&&v.ok){const j=await v.json();j&&j.success&&Array.isArray(j.apks)&&(R=[...R,...j.apks])}else{const j=await fetch("/api/mobile/list-apks");if(j&&j.ok){const A=await j.json();A&&A.success&&Array.isArray(A.apks)&&(R=[...R,...A.apks])}}}catch{}if(R.length>0){const v={};R.forEach(j=>{v[j.name.toLowerCase()]=j,v[j.file.toLowerCase()]=j,v[j.name.toLowerCase().replace(/[^a-z0-9]/g,"")]=j}),Y(v)}}catch(R){console.warn("[WidgetProjects] fetchApks error",R)}},D=(R=!1)=>{R?b(!0):p(!0);const x=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];I("http://localhost:5006/api/projects").then(v=>v?v.json():null).then(v=>{if(v&&v.success&&v.projects)m(v.projects.map((j,A)=>({name:typeof j=="string"?j:j.projectName||j.name||j.projectId||j.project_id||j.title||`Projet_${A}`,desc:"Environnement Local",bg:x[A%x.length],installed:j.installed}))),p(!1),b(!1);else{const j=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:j?{Authorization:`Bearer ${j}`}:{}}).then(A=>A?A.json():null).then(A=>{A&&A.projects&&m(A.projects.map((P,$)=>({name:P.project_id||P.title||P.name||`Projet_${$}`,desc:"SaaS Cloud (Neon DB)",bg:x[$%x.length]}))),p(!1),b(!1)}).catch(()=>{p(!1),b(!1)})}}).catch(()=>{p(!1),b(!1)})};return o.useEffect(()=>{D(),w();const R=setInterval(()=>{D(!0),w()},5e3);return()=>clearInterval(R)},[]),h?e.jsx("div",{className:"p-4 text-cyan text-sm italic",children:"Actualisation de la liste des projets..."}):d.length===0?e.jsxs("div",{className:"p-4 flex flex-col items-center gap-3 text-center",children:[e.jsx("div",{className:"text-cyan text-sm italic",children:"Aucun projet trouvé sur votre disque dur."}),e.jsx("button",{onClick:()=>D(),className:"px-4 py-2 rounded-xl bg-cyan/20 border border-cyan/40 text-cyan text-xs font-bold hover:bg-cyan/40 transition-colors",children:"🔄 Rafraîchir la liste"})]}):e.jsx($t,{items:[...d.map((R,x)=>{const v=R.name||"AUDIO",j=async()=>{if(L(v),c){c(v),setTimeout(()=>L(null),1e3);return}r&&r(v);try{I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:v,open_explorer:!1})}).catch(()=>{})}catch(B){console.error("Erreur de lancement :",B)}finally{setTimeout(()=>L(null),1e3)}},A=async B=>{if(B.preventDefault(),B.stopPropagation(),window.confirm(`⚠️ SUPPRESSION DEFINITIVE :
Voulez-vous vraiment supprimer le projet "${v}" de l'interface ET de votre disque dur ?`))try{const ne=await I("http://localhost:5006/api/projects/remove-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:v})});if(!ne){m(he=>he.filter(ee=>ee.name!==v));return}const le=await ne.json();le.success?m(he=>he.filter(ee=>ee.name!==v)):alert(`Erreur lors de la suppression : ${le.message||"Échec server"}`)}catch(ne){alert(`Erreur réseau lors de la suppression : ${ne.message}`)}},P=O[v],$=(P==null?void 0:P.status)==="building",F=(P==null?void 0:P.status)==="success",H=v.toLowerCase(),K=H.replace(/[^a-z0-9]/g,""),re=G[H]||G[K]||G[`${H}.apk`],ge=F&&(P!=null&&P.apkUrl)?P.apkUrl:re?re.url:null,V=re!=null&&re.sizeMb?`${re.sizeMb}M`:"Prêt";return e.jsxs("div",{className:"design-carte-carrousel rounded-2xl p-5 border border-white/20 shadow-xl flex flex-col items-center text-center relative overflow-hidden group cursor-pointer",style:{background:t?n("proj-"+x,.7):"rgba(0,0,0,0.5)"},onClick:j,children:[ge?e.jsxs("a",{href:ge,download:`${v}.apk`,onClick:B=>B.stopPropagation(),className:"z-20 absolute top-3 left-3 bg-emerald-600 hover:bg-emerald-500 text-white text-[10px] font-black px-2.5 py-1 rounded-full flex items-center gap-1.5 shadow-lg border border-emerald-400/50 transition-all hover:scale-105 cursor-pointer animate-pulse",title:`Télécharger directement l'APK (${V})`,children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-white animate-ping"}),e.jsxs("span",{children:["📱 APK PRÊT (",V,")"]})]}):$?e.jsxs("div",{onClick:B=>B.stopPropagation(),className:"z-20 absolute top-3 left-3 bg-purple-700/90 text-white text-[10px] font-bold px-2.5 py-1 rounded-full flex items-center gap-1.5 shadow-lg border border-purple-400/60 animate-pulse select-none",title:(P==null?void 0:P.progress)||"Compilation de l'APK en cours...",children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-white animate-ping"}),e.jsx("span",{children:"⏳ APK EN COURS..."})]}):null,e.jsx("button",{onClick:A,className:"z-20 absolute top-3 right-3 w-8 h-8 rounded-full bg-red-600/80 hover:bg-red-500 text-white font-bold text-xs flex items-center justify-center transition-all shadow-lg hover:scale-110 cursor-pointer",title:"Supprimer ce projet du disque dur et de l'interface",children:"🗑️"}),e.jsx("div",{className:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-30 mix-blend-overlay pointer-events-none"}),e.jsx("div",{className:"absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors z-0"}),e.jsxs("div",{className:"z-10 relative pointer-events-none w-full pr-8",children:[e.jsx("div",{className:"text-white/70 text-xs font-bold uppercase tracking-widest drop-shadow-md",children:"PROJET"}),e.jsx("h3",{className:"design-carte-titre text-xl font-black text-white break-all drop-shadow-lg leading-tight w-full",children:v})]}),e.jsx("div",{className:"design-carte-desc z-10 relative text-sm text-white/90 font-medium drop-shadow-md pointer-events-none w-full",children:R.desc}),e.jsxs("div",{className:"z-10 flex flex-wrap items-center justify-center gap-2 mt-3",children:[e.jsx("button",{onClick:B=>{B.stopPropagation(),y!==v&&(R.installed===!1?(L(v),I("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:v})}).then(ne=>{alert(ne?`📦 Installation des dépendances démarrée pour "${v}" !
Suivez la progression dans les logs.`:"Mode Cloud SaaS : Bridge local non connecté."),L(null),m(le=>le.map(he=>he.name===R.name?{...he,installed:!0}:he))}).catch(()=>L(null))):j())},disabled:y===v,className:`font-bold py-2 px-4 rounded-xl text-xs transition-all flex items-center gap-1.5 ${y===v?"bg-cyan-500/40 text-cyan-200 cursor-wait animate-pulse":R.installed===!1?"bg-orange-500/80 hover:bg-orange-600 text-white cursor-pointer":"bg-white/20 hover:bg-white/40 text-white cursor-pointer"}`,title:R.installed===!1?"Installer les dépendances requises pour ce projet":"Lancer la prévisualisation Vite",children:y===v?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"animate-spin inline-block",children:"⏳"})," ",R.installed===!1?"Installation...":"Lancement..."]}):R.installed===!1?e.jsx(e.Fragment,{children:"📦 INSTALL"}):e.jsx(e.Fragment,{children:"🚀 PREVIEW"})}),ge?e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsxs("a",{href:ge,download:`${v}.apk`,onClick:B=>B.stopPropagation(),className:"bg-gradient-to-r from-emerald-600 to-green-500 hover:from-emerald-500 hover:to-green-400 text-white font-extrabold py-2 px-3.5 rounded-xl text-xs transition-all flex items-center gap-1.5 shadow-lg shadow-emerald-950/60 border border-emerald-400/50 cursor-pointer animate-pulse hover:scale-105",title:`Télécharger l'APK Android compilé de ${v} (${V}) directement`,children:[e.jsx("span",{children:"📥"}),e.jsx("span",{children:"APK"}),e.jsxs("span",{className:"text-[10px] opacity-90 font-mono",children:["(",V,")"]})]}),e.jsx("button",{onClick:B=>te(B,v),className:"bg-purple-600/30 hover:bg-purple-600/60 text-purple-200 hover:text-white font-bold py-2 px-2 rounded-xl text-xs transition-colors flex items-center justify-center border border-purple-400/40 cursor-pointer",title:"Re-compiler une nouvelle version de l'APK",children:"🔄"})]}):$?e.jsxs("div",{onClick:B=>B.stopPropagation(),className:"bg-purple-900/70 border border-purple-500/60 text-purple-200 font-bold py-2 px-3 rounded-xl text-xs flex items-center gap-1.5 shadow-lg shadow-purple-950/60 cursor-wait animate-pulse",title:(P==null?void 0:P.progress)||"Compilation APK en cours...",children:[e.jsx("span",{className:"animate-spin inline-block text-xs",children:"⏳"}),e.jsx("span",{className:"max-w-[110px] truncate text-[11px]",children:(P==null?void 0:P.progress)||"v0-apk..."})]}):e.jsxs("button",{onClick:B=>te(B,v),className:"bg-gradient-to-r from-purple-700/90 to-indigo-600/90 hover:from-purple-600 hover:to-indigo-500 text-white font-bold py-2 px-3 rounded-xl text-xs transition-all flex items-center gap-1.5 shadow-lg shadow-purple-950/60 border border-purple-400/50 hover:border-purple-300 cursor-pointer hover:scale-105",title:`Lancer la création du fichier APK pour "${v}" directement depuis le carrousel`,children:[e.jsx("span",{children:"📱"}),e.jsx("span",{children:"v0-apk action"})]}),R.installed!==!1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:B=>{B.stopPropagation(),L(v),I("http://localhost:5006/api/bridge/install-dependencies",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:v})}).then(ne=>{alert(ne?`🔄 Réinstallation des dépendances démarrée pour "${v}" !`:"Mode Cloud SaaS : Bridge local non connecté."),L(null)}).catch(()=>L(null))},className:"bg-orange-500/30 hover:bg-orange-500/60 text-white font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center justify-center border border-orange-500/40 cursor-pointer",title:"Forcer la réinstallation des dépendances (pnpm install)",children:"🔄"}),e.jsx("button",{onClick:async B=>{B.stopPropagation();try{L(v);const ne=await I("http://localhost:5006/api/bridge/manual-pnpm-run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:v})});if(L(null),!ne){alert("Mode Cloud SaaS : Moteur local non connecté.");return}const le=await ne.json();alert(le.message||`🚀 Serveur Vite démarré pour ${v} !`),le.previewUrl&&window.open(le.previewUrl,"_blank")}catch(ne){L(null),alert("Erreur de connexion au bridge: "+ne.message)}},className:"font-bold py-2 px-3 rounded-xl text-xs bg-purple-500/60 hover:bg-purple-500 text-white transition-all shadow-md cursor-pointer",title:"Lancer le serveur Vite avec pnpm run dev",children:"💻 PNPM"})]}),e.jsx("button",{onClick:A,className:"bg-red-600/30 hover:bg-red-600/60 text-red-200 border border-red-500/40 font-bold py-2 px-3 rounded-xl text-xs transition-colors flex items-center gap-1",title:"Supprimer définitivement du disque dur",children:"🗑️ Supprimer"})]})]},x)})]})};function $o({user:t,onLogout:n}={}){var Fn;const r=o.useRef({}),c=(s,a=1)=>typeof window>"u"?`linear-gradient(135deg, rgba(17,17,17,${a}), rgba(34,34,34,${a}))`:(r.current[s]||(r.current[s]=Bo(a)),r.current[s]),d=(t==null?void 0:t.email)||(typeof window<"u"?localStorage.getItem("tiger_currentUserEmail"):null),m=!!(t!=null&&t.isSuperAdmin||d&&d.toLowerCase().trim()==="zacktunr@gmail.com");o.useEffect(()=>{t!=null&&t.email&&typeof window<"u"&&localStorage.setItem("tiger_currentUserEmail",t.email)},[t]);const h=()=>{typeof window<"u"&&(localStorage.removeItem("kirov5_jwt_token"),localStorage.removeItem("tiger_currentUserEmail"),localStorage.removeItem("tiger_lastGeneratedProject"),fetch("/api/auth/logout",{method:"POST"}).catch(()=>{})),n?n():typeof window<"u"&&window.location.reload()},[p,C]=o.useState([]),[b,y]=o.useState(""),L=o.useRef(null),G=o.useRef(null),[Y,O]=o.useState(!1),[W,te]=o.useState("connexion"),[w,D]=o.useState(!1),[R,x]=o.useState("clean");o.useRef(0);const[v,j]=o.useState(1),[A,P]=o.useState(!1),[$,F]=o.useState(!1),[H,K]=o.useState(!1);o.useEffect(()=>{let s=0;const a=setInterval(()=>{var l,_;if(typeof window<"u"){const u=(_=(l=window.Capacitor)==null?void 0:l.isNativePlatform)==null?void 0:_.call(l),f=!!window.AndroidBridge;(u||f)&&(F(!0),clearInterval(a))}s++>10&&clearInterval(a)},100);return()=>clearInterval(a)},[]);const[re,ge]=o.useState([]),[V,B]=o.useState(""),[ne,le]=o.useState(["> Système Kirov5 initialisé. "+new Date().toLocaleTimeString()]),[he,ee]=o.useState([]),[T,Z]=o.useState([]);o.useEffect(()=>{const s=a=>Z(a.detail);return window.addEventListener("update_kirov_packs",s),()=>window.removeEventListener("update_kirov_packs",s)},[]),o.useEffect(()=>{window.KIROV_SELECTED_PACKS=T},[T]);const[ae,pe]=o.useState(!1),[ve,je]=o.useState(!1),[ke,U]=o.useState([]),[fe,Ie]=o.useState(!1),[be,ie]=o.useState(""),[Re,it]=o.useState(""),[Te,Ee]=o.useState(!1),[ce,xt]=o.useState(""),[Ke,Un]=o.useState("Vite + React + Tailwind + TS"),[ft,yn]=o.useState(""),[It,Rt]=o.useState("deepseek"),[We,an]=o.useState(""),[on,On]=o.useState(!0),[ln,cn]=o.useState(!1),[bt,At]=o.useState(null),[Nt,at]=o.useState([]),[dn,ot]=o.useState(!1),Dt=o.useCallback(async s=>{ot(!0);const a=[{id:"deepseek-r1-v0",tag:"⚡ DEEPSEEK R1",title:"DeepSeek-R1 & Moteur Souverain v0.1",desc:"Capacités de raisonnement avancé et de suture pour interfaces React.",content:`DeepSeek-R1 offre des capacités de raisonnement avancé pour l'analyse de contrats PRD et la génération zéro-touch de projets web complets.
...
3. Création du projet et câblage avec Stitch.`}];try{if(typeof window<"u"&&sessionStorage.getItem("deepseek_402")){at(a),ot(!1);return}const l=s||localStorage.getItem("tiger_apiKey");if(!l||!l.startsWith("sk-")||l.length<20||typeof window<"u"&&localStorage.getItem("deepseek_solde_epuise")==="true"){at(a),ot(!1);return}const _=new AbortController,u=setTimeout(()=>_.abort(),4e3),f=await fetch("https://api.deepseek.com/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${l}`},signal:_.signal,body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Tu es le fil d'actualités technologiques de l'OS Souverain. Réponds UNIQUEMENT en JSON avec une clé 'news' contenant 3 articles récents au format [{id, tag, title, desc, content}]."},{role:"user",content:"Donne 3 actualités récentes sur l'IA et le développement web."}],response_format:{type:"json_object"}})});if(clearTimeout(u),f.ok){const k=await f.json(),M=JSON.parse(k.choices[0].message.content);M.news&&Array.isArray(M.news)&&M.news.length>0?at(M.news):at(a)}else f.status===402&&typeof window<"u"&&(sessionStorage.setItem("deepseek_402","true"),localStorage.setItem("deepseek_solde_epuise","true")),at(a)}catch(l){console.warn("[Actualités] Erreur ou Timeout API DeepSeek, chargement fallback:",l),at(a)}finally{ot(!1)}},[]);o.useEffect(()=>{Dt()},[Dt]);const[Je,lt]=o.useState(!1),[Ne,Mt]=o.useState(()=>localStorage.getItem("tiger_active_theme")||"fold"),[Ge,vt]=o.useState([]),[qt,un]=o.useState("");o.useEffect(()=>{const s=localStorage.getItem("tiger_saved_themes");if(s)try{let a=JSON.parse(s);if(!Array.isArray(a))throw new Error("Not an array");const l="linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)";a=a.map(_=>_.name==="fold"?{..._,colors:{..._.colors,"bg-app":l}}:_),vt(a)}catch{vt([])}else{const a={name:"fold",colors:{"icon-settings":"linear-gradient(135deg, #c87058, #934a36)","icon-ai":"linear-gradient(135deg, #9d508e, #622e5a)","icon-projects":"linear-gradient(135deg, #d38b5d, #a26038)","icon-packs":"linear-gradient(135deg, #445499, #252e66)","icon-news":"linear-gradient(135deg, #389eb2, #1f6475)","bg-app":"linear-gradient(135deg, #4c1d95 0%, #1e1b4b 35%, #0f172a 70%, #06b6d4 100%)"}};vt([a]),localStorage.setItem("tiger_saved_themes",JSON.stringify([a]))}},[]),o.useEffect(()=>{var s;if(localStorage.setItem("tiger_active_theme",Ne),Ne!=="random"){const a=((s=Ge.find(l=>l.name===Ne))==null?void 0:s.colors["bg-app"])||"linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #000000 100%)";document.body.style.background=a,document.body.style.backgroundAttachment="fixed"}else document.body.style.background=""},[Ne,Ge]);const Ce=()=>{if(!qt.trim())return alert("Nom invalide");if(Ge.length>=10)return alert("Limite atteinte ! Vous ne pouvez sauvegarder que 10 thèmes maximum. Veuillez en supprimer un pour continuer.");const s={"icon-settings":c("icon-settings",.8),"icon-ai":c("icon-ai",.8),"icon-projects":c("icon-projects",.8),"icon-packs":c("icon-packs",.8),"icon-news":c("icon-news",.8),"bg-app":c("bg-app",.9)},a={name:qt.trim(),colors:s},l=[...Ge,a];vt(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),Mt(a.name),un("")},_n=(s,a)=>{a.stopPropagation();const l=Ge.filter(_=>_.name!==s);vt(l),localStorage.setItem("tiger_saved_themes",JSON.stringify(l)),Ne===s&&Mt("random")},Lt=s=>{Z(a=>a.includes(s)?a.filter(l=>l!==s):[...a,s])},[Xe,pn]=o.useState(()=>{if(typeof window<"u"){const s=sessionStorage.getItem("tiger_selectedStartPhase");return s?Number(s):0}return 0});o.useEffect(()=>{typeof window<"u"&&sessionStorage.setItem("tiger_selectedStartPhase",String(Xe))},[Xe]);const[Ut,Ve]=o.useState(!0),[Be,Ae]=o.useState(!0),[q,Pe]=o.useState(null),[ze,mn]=o.useState(null),[De,Ot]=o.useState(null),[xe,tt]=o.useState(null),[Ft,ct]=o.useState(""),[nt,Pt]=o.useState([]),[Qe,Xt]=o.useState(!1),[Ze,gt]=o.useState("idle"),[kt,st]=o.useState([]),[St,gn]=o.useState(""),[jt,Qt]=o.useState(null),[ht,Cn]=o.useState([]),yt=o.useCallback(async()=>{try{let s=[];const a=Date.now();if(a-tn<3e4&&Kt.length>0)s=[...Kt];else try{const l=Ln(),_=await fetch("https://api.github.com/repos/turnzack/v0-reponse/releases",{headers:l?{Authorization:`Bearer ${l}`,Accept:"application/vnd.github.v3+json"}:{Accept:"application/vnd.github.v3+json"}});if(_.ok){const u=await _.json();if(Array.isArray(u)){const f=[];u.forEach(k=>{Array.isArray(k.assets)&&k.assets.forEach(M=>{var Q;(Q=M.name)!=null&&Q.endsWith(".apk")&&f.push({file:M.name,name:M.name.replace(".apk",""),sizeMb:(M.size/(1024*1024)).toFixed(1),url:M.browser_download_url})})}),Kt=f,tn=a,s=[...f]}}}catch{}try{const l=await I("http://localhost:5006/api/mobile/list-apks");if(l&&l.ok){const _=await l.json();_&&_.success&&Array.isArray(_.apks)&&(s=[...s,..._.apks])}else{const _=await fetch("/api/mobile/list-apks");if(_&&_.ok){const u=await _.json();u&&u.success&&Array.isArray(u.apks)&&(s=[...s,...u.apks])}}}catch{}if(s.length>0){const l=new Set,_=s.filter(u=>l.has(u.file.toLowerCase())?!1:(l.add(u.file.toLowerCase()),!0));Cn(_)}}catch(s){console.warn("[v0-apk] loadAvailableApks error",s)}},[]);o.useEffect(()=>{Qe&&yt()},[Qe,yt]),o.useEffect(()=>{let s,a=0;return Ze==="building"&&(s=setInterval(async()=>{try{const l=await I("http://localhost:5006/api/mobile/build-logs");if(l&&l.ok){a=0;const _=await l.json();_.logs&&_.logs.length>0&&st(_.logs),_.isBuilding===!1&&_.result&&(_.result.success?(gt("success"),Qt(_.result.apkUrl)):gt("error"),clearInterval(s))}else a++,a>=3&&(clearInterval(s),gt("error"),st(_=>[..._,`❌ Service de compilation mobile absent sur ce serveur (${l?l.status:"erreur réseau"}).`,"📱 Option 1 (Cloud) : Déclenchez le compilateur automatique Cloud Souverain.",`💻 Option 2 (Local) : Lancez 'python apk_builder.py --src ... --name ${St||q||"app"} --build' dans E:\\v0reponses\\v0-apk.`]))}catch(l){console.warn("Polling APK error",l)}},1500)),()=>{s&&clearInterval(s)}},[Ze,St,q]),o.useEffect(()=>{I("http://localhost:5006/api/projects").then(s=>s?s.json():null).then(s=>{if(s&&s.success&&Array.isArray(s.projects))ee(s.projects.map(a=>({name:typeof a=="string"?a:a.project_id||a.title||a.name||"Projet",desc:"Projet local",bg:""})));else{const a=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:a?{Authorization:`Bearer ${a}`}:{}}).then(l=>l?l.json():null).then(l=>{l&&l.projects&&ee(l.projects.map(_=>({name:typeof _=="string"?_:_.project_id||_.title||_.name||"Projet",desc:"SaaS Cloud",bg:""})))}).catch(()=>{})}}).catch(()=>{})},[]);const[dt,Se]=o.useState(null),[Zt,_t]=o.useState(""),[Tt,i]=o.useState(!1),[g,S]=o.useState(!1),N=o.useRef(null);o.useEffect(()=>{if(N.current=null,q==="v0-guest"||q==="V0-Guest")S(!0),Se("http://localhost:3007"),_t("http://localhost:3007"),N.current="http://localhost:3007";else if(q){S(!0);const s=De&&JSON.stringify(De).includes("next.config"),a=typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1",l=s?"http://localhost:3000":N.current||(a?`http://${window.location.hostname}:5173`:"http://localhost:5173");Se(l),_t(l),N.current=l}else S(!1),Se(null)},[q,De]),o.useEffect(()=>{const s=a=>{var l,_,u,f;if(((l=a.data)==null?void 0:l.type)==="CHANGE_PREVIEW_URL"){const k=a.data.route,M=k==="/"?"":`#${k}`;Se(Q=>{const X=Q?Q.split("#")[0]:"http://127.0.0.1:5175/";return`${X.endsWith("/")?X:`${X}/`}${M}`})}if(((_=a.data)==null?void 0:_.type)==="DESIGN_ELEMENT_CLICKED"||((u=a.data)==null?void 0:u.type)==="DESIGN_ELEMENT_DRAGGED"||((f=a.data)==null?void 0:f.type)==="DESIGN_ELEMENT_RESIZED"){const k=document.querySelector('iframe[title="Studio Admin Design"]');k&&k.contentWindow&&k.contentWindow.postMessage(a.data,"*")}};return window.addEventListener("message",s),()=>window.removeEventListener("message",s)},[]),o.useEffect(()=>{q&&I(`http://localhost:5006/api/fs/tree?project=${q}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&Ot(s.tree)}).catch(()=>{})},[q]),o.useEffect(()=>{q&&xe&&I(`http://localhost:5006/api/fs/read?project=${q}&file=${encodeURIComponent(xe)}`).then(s=>s?s.json():null).then(s=>{s&&s.success&&ct(s.content)}).catch(()=>{})},[q,xe]);const se=async s=>{if(s===void 0||!q||!xe)return;if(ct(s),Jt.isNativePlatform()||!!window.AndroidBridge)try{await Xn.writeFile({path:`v0-moteur-mobile/projetv0/${q}/${xe}`,data:s,directory:vn.Documents,encoding:Tn.UTF8,recursive:!0})}catch(l){console.error("Erreur de sauvegarde mobile:",l)}else I("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:q,file:xe,content:s})}).catch(()=>{})},E=s=>{q&&I(`http://localhost:5006/api/fs/read?project=${q}&file=${encodeURIComponent(s)}`).then(a=>a?a.json():null).then(a=>{a&&a.success&&Pt(l=>l.find(_=>_.path===s)?l:[...l,{path:s,content:a.content}])}).catch(()=>{})};o.useEffect(()=>{(async()=>{const a=["bg-gradient-to-br from-[#bf6969]/80 to-[#c27042]/90 backdrop-blur-md","bg-gradient-to-br from-[#a387b9]/80 to-[#aa6b73]/90 backdrop-blur-md","bg-gradient-to-br from-[#e4a37f]/80 to-[#bf6969]/90 backdrop-blur-md","bg-gradient-to-br from-[#aa6b73]/80 to-[#c27042]/90 backdrop-blur-md"];if(Jt.isNativePlatform()||!!window.AndroidBridge)try{const u=(await Xn.readdir({path:"v0-moteur-mobile/projetv0",directory:vn.Documents})).files.map(f=>f.name||f.toString());ee(u.map((f,k)=>({name:f,desc:"Mémoire Téléphone",bg:a[k%a.length]})))}catch{console.log("Aucun projet mobile trouvé ou dossier inexistant.")}else I("http://localhost:5006/api/projects-v2").then(_=>_?_.json():null).then(_=>{if(_&&_.success&&_.projects)ee(_.projects.map((u,f)=>({name:typeof u=="string"?u:u.name||u.project_id||u.title||`Projet_${f}`,desc:"Environnement Local",bg:a[f%a.length],installed:u.installed})));else{const u=localStorage.getItem("kirov5_jwt_token")||"";fetch("/api/projects",{headers:u?{Authorization:`Bearer ${u}`}:{}}).then(f=>f?f.json():null).then(f=>{f&&f.projects&&ee(f.projects.map((k,M)=>({name:typeof k=="string"?k:k.project_id||k.title||k.name||`Projet_${M}`,desc:"SaaS Cloud (Neon DB)",bg:a[M%a.length]})))}).catch(()=>{})}}).catch(()=>{})})()},[]),o.useEffect(()=>{P(!0)},[]);const[me,ye]=o.useState(!0);o.useEffect(()=>{const s=()=>ye(!0),a=_=>{_&&_.detail&&le(u=>[_.detail,...u.slice(0,49)])};window.addEventListener("open-mouchard",s),window.addEventListener("kirov-mouchard-log",a);const l=_=>{if(_.data&&_.data.type==="TIGER_CAPTURE"){const u=_.data.data;if(u){let f="index.html";(u.includes("import React")||u.includes("export default"))&&(f="App.tsx"),u.includes("tailwindcss")&&(f="index.css"),tt(f),se(u),Ot(k=>{var X;const M={name:f,path:f,type:"file"};return k?((X=k.children)==null?void 0:X.find(J=>J.name===f))?k:{...k,children:[...k.children||[],M]}:{name:"Mobile_Storage",type:"directory",children:[M]}})}}};return window.addEventListener("message",l),()=>{window.removeEventListener("open-mouchard",s),window.removeEventListener("kirov-mouchard-log",a),window.removeEventListener("message",l)}},[q,xe]),o.useEffect(()=>{if(!A)return;const s=()=>{I("http://localhost:5006/api/bridge/queue").then(l=>l?l.json():null).then(l=>{l&&l.success&&(setBridgeQueueData({current:l.current||{},queue:l.queue||[]}),(l.queue&&l.queue.length>0||l.current&&Object.keys(l.current).length>0)&&setIsPipelineRunning(!0))}).catch(()=>{}),I("http://localhost:5006/api/bridge/logs").then(l=>l?l.json():null).then(l=>{var _,u;if(l&&l.success&&l.logs){le(l.logs);const f=[...l.logs].reverse().find(M=>M.includes("URL_PREVIEW="));if(f){let M=(_=f.split("URL_PREVIEW=")[1])==null?void 0:_.trim();M&&typeof window<"u"&&window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1"&&(M=M.replace(/localhost|127\.0\.0\.1/,window.location.hostname)),M&&M!==N.current&&(N.current=M,Se(M),_t(M),S(!0))}const k=[...l.logs].reverse().find(M=>M.includes("PIPELINE COMPLET TERMINÉ avec succès pour "));if(k){const M=(u=k.split("PIPELINE COMPLET TERMINÉ avec succès pour ")[1])==null?void 0:u.replace(/[.\s]+$/,"");M&&q!==M&&(Pe(M),S(!0))}}}).catch(()=>{}),I("http://localhost:5006/api/bridge/autonomous-status").then(l=>l?l.json():null).then(l=>{if(l&&l.success&&(l.data||l.status)){const u=(l.data||l.status).state;u==="diagnosing"||u==="repair_required"||u==="error"?x("error"):["repair_planned","patching_staging","validating","browser_verifying","repairing","working"].includes(u)||["starting_server","launch_requested","restarting"].includes(u)?x("working"):u==="ready"?x("clean"):q&&I(`http://localhost:5006/api/suture/status?project=${q}`).then(f=>f?f.json():null).then(f=>{f&&f.success&&f.status&&x(f.status)}).catch(()=>{})}}).catch(()=>{})};s();const a=setInterval(s,2e3);return()=>clearInterval(a)},[A,q]);const ut=s=>{Pe(s),tt(null),ct(""),i(!1),ye(!1),S(!1),I("http://localhost:5006/api/bridge/launch-project",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:s,open_explorer:!1})}).then(async a=>{if(a&&a.ok){const l=await a.json().catch(()=>null);l!=null&&l.previewUrl&&(Se(l.previewUrl),_t(l.previewUrl))}}).catch(a=>console.error("Erreur de lancement preview:",a)),I(`http://localhost:5006/api/fs/tree?project=${encodeURIComponent(s)}`).then(a=>a?a.json():null).then(a=>{if(a&&a.success&&a.tree){Ot(a.tree);const l=u=>{if(!u)return null;if(u.type==="file"&&(u.path==="src/App.tsx"||u.path==="src/App.jsx"||u.name==="App.tsx"||u.name==="index.html"))return u.path;if(u.children&&Array.isArray(u.children))for(const f of u.children){const k=l(f);if(k)return k}return null},_=l(a.tree);_&&tt(_)}}).catch(a=>console.error("Erreur chargement arborescence:",a))},Me=s=>{const a=typeof s=="string"?s:b;if(!a.trim())return;const l={id:Date.now().toString(),role:"user",content:a};C(u=>[...u,l]);const _=a.toLowerCase();setTimeout(()=>{let u={id:(Date.now()+1).toString(),role:"assistant",content:""};const f=_.normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(f==="mes projets"||f.includes("liste des projet")||f==="projet"||f==="projets")u.content="Voici la liste de vos projets récents :",u.widget="projects";else if((f.includes("stitch")||f.includes("deepseek")||f.includes("design")||f.includes("logique"))&&(f.includes("modifi")||f.includes("ajoute")||f.includes("change")||f.includes("mise a jour")||f.includes("evolue")||f.includes("reprends")||f.includes("continue"))){const k=a.match(/\[(.*?)\]/),M=k?k[1]:null,Q=f.includes("deepseek")?"deepseek":"stitch";u.content=`🔄 MODE ÉVOLUTION ACTIVÉ (${Q.toUpperCase()}) 🔄

J'injecte vos nouvelles directives directement dans votre interface... ${M?`
🔍 Recherche et AutoSwitch vers le projet : "${M}"`:"Reprise du travail en cours."}`,u.widget=null,I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:Q,target_project:M,prompt:"Mise à jour (Reprise de projet) : "+a.replace(/\[.*?\]/,"").trim(),auto_submit:!0})}).catch(X=>console.log("Erreur de connexion au Bridge local pour l'injection",X))}else if(f.includes("cree")||f.includes("lance")||f.includes("projet")||f.includes("generation")){u.content=`🚀 DÉMARRAGE PARALLÈLE KIROV5 🚀
...
Les intelligences artificielles sont informées et en attente. Une fois le design terminé, glissez l'HTML ici pour lancer le câblage final en phase 5.`,u.widget="phases",j(1);const k=q||(ce.trim()?ce.trim().replace(/[^a-zA-Z0-9_-]/g,"_"):"Projet_"+a.substring(0,15).replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4));if(Pe(k),typeof window<"u"&&localStorage.setItem("tiger_lastGeneratedProject",k),typeof window<"u"){const X=localStorage.getItem("tiger_targetAi")||"deepseek",J=localStorage.getItem("tiger_targetUiAi")||"stitch",qe=(z,ue=!1)=>mt(z,ue),He=window.AndroidBridge;if(He&&He.openAIWithPrompt)He.openAIWithPrompt(qe(J,!0),"Génère l'interface UI/UX complète et moderne pour ce projet : "+a),He.showToast&&He.showToast("Stitch s'ouvre. Générez le HTML, puis utilisez le Trombone.");else{const z=T&&T.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${T.length})]
`+T.map(we=>{const oe=Ht.find(_e=>_e.id===we);return`• ${oe?oe.name:we} (#${we})`}).join(`
`):"",ue="Génère l'interface UI/UX complète et moderne pour ce projet : "+a+z;try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(ue)}catch{}const rt=()=>I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:J,prompt:ue,auto_submit:!0,project_id:k,phase_num:1,packs:T})});Xe!==200&&(Be?window.open(qe(J,!0),"kirov5_ai_target"):window.open(qe(J,!0),"_blank"),rt().then(()=>{console.log("Prompt UI envoyé avec succès au Bridge pour Stitch !")}).catch(we=>console.error("Erreur sendUiPrompt",we))),setTimeout(()=>{const we=T&&T.length>0?a+z:"L'interface UI/UX est actuellement en cours de génération. Prépare la structure backend et les états React pour un projet complexe : "+a+". Reste en attente, je te fournirai le fichier HTML pour le câblage final.";try{typeof navigator<"u"&&navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(we)}catch{}window.open(qe(X),"_blank"),I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:X,prompt:we,auto_submit:!0,project_id:k,phase_num:1,packs:T})}).catch(oe=>console.log("Erreur Bridge Logic Prompt:",oe)),T&&T.length>0?I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:X,user_prompt:we,packs:T,target_project:k})}).then(()=>{console.log("Méga-Prompt Trombone envoyé !")}).catch(oe=>{console.log("Erreur Trombone Bridge:",oe)}):I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:X,prompt:we,auto_submit:!0,project_id:k,phase_num:1})}).then(()=>{console.log("Prompt Logique envoyé au Bridge")}).catch(()=>{})},800),console.log("Les IA ont été ouvertes. Les prompts ont été envoyés au Bridge local pour injection via l'extension.")}}j(1);let M=1;const Q=setInterval(()=>{M++,M>11?clearInterval(Q):j(M)},1500)}else if(f.includes("youtube")||f.includes("video"))u.content="Voici les résultats YouTube pour votre recherche :",u.widget="youtube";else if(f.includes("actualite")||f.includes("ia")||f.includes("news")||f.includes("recherche")){const k=localStorage.getItem("tiger_apiKey");u.content="Actualités & Dernières Innovations IA :",u.widget="news",Dt(k||void 0)}else if(f.includes("parametre")||f.includes("reglage")||f.includes("configuration")||f.includes("setting"))u.content="Ouverture du panneau de configuration système :",u.widget="settings";else if(f.includes("[plugin:vite:")||f.includes("missing semicolon")||f.includes("syntaxerror")||f.includes("typescriptparsermixin")||f.includes("babel/parser")||f.includes("error")&&f.length>80){const k=q||"Projet_blog_8831";u.content=`🚨 Trace d'erreur détectée !

Lancement immédiat de l'Auto-Suture IA pour le projet "${k}" avec la stack trace fournie... 🩺`,Oe("suture",a)}else if(u.content="Traitement de votre demande via Tiger IA...",typeof window<"u"){const k=window.AndroidBridge;k&&k.openAIWithPrompt?k.openAIWithPrompt("https://chat.deepseek.com/",a):window.open("https://chat.deepseek.com/","_blank")}C(k=>[...k,u])},600),y("")},Ye=async s=>{var He;let a=Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s],l=null;const _=a.filter(z=>z.name.endsWith(".zip"));let u=[];if(_.length>0){C(z=>[...z,{id:Date.now().toString()+"_zip",role:"user",content:"📦 Extraction de l'archive ZIP en cours..."}]);try{const z=(await nn(async()=>{const{default:ue}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:ue}},[])).default;for(const ue of _){l=ue;const we=await new z().loadAsync(ue);for(const[oe,_e]of Object.entries(we.files))if(!_e.dir&&!oe.includes("__MACOSX")&&!((He=oe.split("/").pop())!=null&&He.startsWith("."))){const Le=await _e.async("blob"),pt=new File([Le],oe.split("/").pop()||oe,{type:Le.type});u.push(pt)}}}catch(z){console.error("Erreur décompression ZIP:",z),alert("Système Kirov5 : Impossible de lire l'archive ZIP.")}for(const z of _)try{const ue=await z.arrayBuffer(),rt=arrayBufferToBase64(ue);fetch("/api/fs/upload-zip",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:q||V||ce||"AUDIO",fileName:z.name,fileBase64:rt})}).catch(oe=>console.warn("[Upload ZIP Sync] Notice:",oe))}catch{}}a=[...a.filter(z=>!z.name.endsWith(".zip")),...u];const f=a.filter(z=>z.name.endsWith(".html")),k=a.filter(z=>!z.name.endsWith(".html")&&(z.name.endsWith(".png")||z.name.endsWith(".jpg")||z.name.endsWith(".jpeg")||z.name.endsWith(".md")||z.name.endsWith(".json")||z.name.endsWith(".txt")||z.name.endsWith(".tsx")||z.name.endsWith(".ts")||z.name.endsWith(".jsx")||z.name.endsWith(".js")||z.name.endsWith(".css")||z.name.endsWith(".svg")));if(f.length===0&&k.length===0){alert("Système Kirov5 : Format non supporté. Veuillez déposer au moins un .html, .md, .tsx, .ts, .png, ou un .zip.");return}let M=[...nt];for(const z of k){const ue=z.name.endsWith(".png")||z.name.endsWith(".jpg")||z.name.endsWith(".jpeg"),rt=await new Promise(oe=>{const _e=new FileReader;_e.onload=Le=>{var pt;return oe((pt=Le.target)==null?void 0:pt.result)},ue?_e.readAsDataURL(z):_e.readAsText(z)}),we={path:z.name,content:ue?`[Image jointe visuellement : ${z.name} (Binaire ignoré pour économie de tokens)]`:rt};M.some(oe=>oe.path===z.name)||M.push(we),C(oe=>[...oe,{id:Date.now().toString()+"_"+Math.random(),role:"user",content:`📎 Fichier de contexte ajouté au Trombone : ${z.name}`}])}if(f.length>0){const z=f[0],ue=await new Promise(oe=>{const _e=new FileReader;_e.onload=Le=>{var pt;return oe((pt=Le.target)==null?void 0:pt.result)},_e.readAsText(z)}),rt={path:z.name,content:ue};M.some(oe=>oe.path===z.name)||M.push(rt);const we={id:Date.now().toString()+"_main",role:"user",content:`📁 Fichier de design déposé : ${z.name}
Analyse de la structure UI et assemblage du contexte en cours...`};C(oe=>[...oe,we])}const Q=(Array.isArray(s)?s:s instanceof FileList?Array.from(s):[s]).filter(z=>z.name.endsWith(".zip"));for(const z of Q)M.some(ue=>ue.path===z.name)||M.push({path:z.name,content:"ZIP_ARCHIVE_DUMMY"});Pt(M);const X=q||ce||"Projet_Stitch",J=a.map(z=>z.name).join(", ");console.log(`[TROMBONE] Fichiers déposés pour ${X}: ${J}`);const qe=f.length;if(qe>3){const z=localStorage.getItem("tiger_targetAi")||"deepseek",ue=l?"Projet_ZIP_"+l.name.replace(/[^a-zA-Z0-9]/g,"_").replace(".zip","")+"_"+Date.now().toString().slice(-4):"Projet_BATCH_"+Date.now().toString().slice(-4),rt=q||ue;q||Pe(rt),C(oe=>[...oe,{id:Date.now().toString()+"_batch",role:"assistant",content:`🤖 KIROV5 MULTI-BATCH DÉTECTÉ !

Hermes a détecté ${qe} pages HTML dans votre ZIP.
Découpage automatique en lots de 3 fichiers en cours...
Démarrage de l'automatisation séquentielle via DeepSeek !`,widget:"phases"}]),j(1);let we="";if(l)we=await new Promise(oe=>{const _e=new FileReader;_e.onload=Le=>{var pt;return oe(((pt=Le.target)==null?void 0:pt.result).split(",")[1])},_e.readAsDataURL(l)});else{const oe=(await nn(async()=>{const{default:Le}=await import("https://cdn.jsdelivr.net/npm/jszip@3.10.1/+esm");return{default:Le}},[])).default,_e=new oe;for(const Le of a)_e.file(Le.name,Le);we=await _e.generateAsync({type:"base64"})}I("/api/bridge/trombone",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({zip_base64:we,zip_mode:!0,target_ai:z,target_project:rt,user_prompt:ce.trim()?`${ce} - ${ft}`:`Application multi-pages issue de ${(l==null?void 0:l.name)||"fichiers_locaux"}`})}).then(async oe=>{const _e=await oe.json();_e.success?(C(Le=>[...Le,{id:Date.now().toString()+"_hermes",role:"assistant",content:`✅ ${_e.message}

📡 Lot 1/${_e.total_batches} transmis à DeepSeek. Les lots suivants s'enchaîneront automatiquement !
Fichiers détectés : ${(_e.files_detected||[]).join(", ")}`}]),window.open(mt(z),"_blank")):alert("Erreur Hermes : "+(_e.error||"Inconnue"))}).catch(oe=>{alert(`Erreur de connexion au Moteur Local : ${oe.message}`)});return}if(f.length>0){if(document.getElementById("creation-mode-container"))return;setTimeout(()=>{Ct(M)},1200)}},Ct=async(s=nt)=>{Ee(!1);const a=s.find(X=>X.path.endsWith(".html"));if(!a){alert("Aucun fichier HTML trouvé dans le Trombone !");return}const l=ce.trim()?"Projet_"+ce.replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4):"Design_"+a.path.replace(".html","").replace(/[^a-zA-Z0-9]/g,"_")+"_"+Date.now().toString().slice(-4),_=q||l;if(!q){Pe(_);try{await I("http://localhost:5006/api/fs/write",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project:_,file:"README.md",content:`# ${ce||_}
...
Câblage en cours...`,widget:"phases"};j(5),C(X=>[...X,k]);let M=5;const Q=setInterval(()=>{M++,M>11?clearInterval(Q):j(M)},3e3);if(typeof window<"u"&&window.AndroidBridge&&window.AndroidBridge.showToast&&window.AndroidBridge.showToast("Mode Design-First Activé !"),typeof window<"u"){const X=localStorage.getItem("tiger_targetAi")||"deepseek";let J="";u.length>0&&(J=`
...
\`\`\``,C(u=>[...u,{id:Date.now().toString()+"_action",role:"assistant",content:`🩺 Suture & Correction déclenchée pour "${q}". Transmission de l'erreur à ${l.toUpperCase()} en cours...`}]);try{if(await I("http://localhost:5006/bridge/prompt",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({target_ai:l,prompt:_,auto_submit:!0,project_id:q,phase_num:s})}),s==="suture"){I("http://localhost:5006/v1/suture/start",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({project_id:q,activeFile:xe||"",rawError:a||"",prompt:a||"Analyse et corrige les erreurs du projet."})}).then(async f=>{const k=await f.json();k.success&&k.status==="applied"?C(M=>{var Q,X;return[...M,{id:Date.now().toString()+"_suture_ok",role:"assistant",content:`✅ Suture V2 réussie !

🔧 ${k.repairId}
🚀 Statut : **Patch appliqué en production**
📁 Fichiers corrigés : ${JSON.stringify(((X=(Q=k.patchReport)==null?void 0:Q.files)==null?void 0:X.map(J=>J.path))||[])}`}]}):k.success?C(M=>{var Q;return[...M,{id:Date.now().toString()+"_suture_partial",role:"assistant",content:`⚠️ Suture V2 : correctif généré mais non promu.
Statut : ${((Q=k.validationReport)==null?void 0:Q.code)||k.status}
...
Initialisé par Tiger IA V0.
Stack : ${Ke}
Description : ${ft}`})}).catch(()=>null);const k=T&&T.length>0?`

[PACKS PRD ARCHITECTURE SELECTIONNES (${T.length})]
`+T.map(J=>{const qe=Ht.find(He=>He.id===J);return`• ${qe?qe.name:J} (#${J})`}).join(`
`):"";let M=`

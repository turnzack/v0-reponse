...
MISSION: Générer une application mobile de réseau social avec flux continu (Feed infini).
STYLE & DESIGN: Mobile-first, Full-bleed images, interactions rapides (Double-tap like), création UGC.
MAPPING VFS: \`FeedPage.tsx\`, \`PostCard.tsx\`, \`LikeAnimation.tsx\`
[FIN DU CONTEXTE CACHÉ]`
    ...
    function createMenu() {
        if(document.getElementById('prd_mobile_social-menu')) return;
        
        const menu = document.createElement('div');
        menu.id = 'prd_mobile_social-menu';
        ...
        menu.innerHTML = \`
            <h3 style="margin-top:0; font-size:14px; color:#FF0055;">📦 Mobile Social</h3>
            <button id="btn-prd-prd_mobile_social-0" style="display:block; width:100%; margin-bottom:5px; padding:8px; background:#112; border:1px solid #FF0055; color:#FF0055; cursor:pointer; border-radius:5px;">🚀 prd_mobile_social</button>
        \`;

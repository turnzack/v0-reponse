...
MISSION: Générer une vue d'exploration de produits (PLP) avec filtres instantanés à facettes.
STYLE & DESIGN: E-commerce moderne, grille de produits massive, sidebar de filtres à gauche, skeleton loaders.
MAPPING VFS: \`CatalogPage.tsx\`, \`FacetSidebar.tsx\`, \`ProductGrid.tsx\`
[FIN DU CONTEXTE CACHÉ]`
    ...
    function createMenu() {
        if(document.getElementById('prd_ecom_catalog-menu')) return;
        
        const menu = document.createElement('div');
        menu.id = 'prd_ecom_catalog-menu';
        ...
        menu.innerHTML = \`
            <h3 style="margin-top:0; font-size:14px; color:#FF0055;">📦 Ecom Catalog</h3>

...
MISSION: Générer un portail de news dynamique (webzine) et optimisé SEO.
STYLE & DESIGN: Typographie éditoriale (Serif/Sans-Serif), Bento Grid, Hero Article asymétrique.
MAPPING VFS: \`MagazineHome.tsx\`, \`HeroArticleCard.tsx\`, \`ArticleSingle.tsx\`
[FIN DU CONTEXTE CACHÉ]`
    ...
    function createMenu() {
        if(document.getElementById('prd_blog_magazine-menu')) return;
        
        const menu = document.createElement('div');
        menu.id = 'prd_blog_magazine-menu';
        ...
        menu.innerHTML = \`
            <h3 style="margin-top:0; font-size:14px; color:#FF0055;">📦 Blog Magazine</h3>
            <button id="btn-prd-prd_blog_magazine-0" style="display:block; width:100%; margin-bottom:5px; padding:8px; background:#112; border:1px solid #FF0055; color:#FF0055; cursor:pointer; border-radius:5px;">🚀 prd_blog_magazine</button>
        \`;
